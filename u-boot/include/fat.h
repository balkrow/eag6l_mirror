...
void fat_close(void);
#if 1/*add by balkrow*/
#define HFR_STATUS_BOOT_UIMAGE 		0x01
#define HFR_STATUS_BOOT_SUPPLANT	0x02

#define HFR_STATUS_BOOT_ACTING 		0x10
#define HFR_STATUS_BOOT_FAILED 		0x20
#define HFR_STATUS_BOOT_CHECK_FAIL 	0x40
...
struct hfr_img_info {
	hfr_img_info_file_t huif[16];
	hfr_img_info_file_t uimage_info;
	hfr_img_info_file_t supplant_info;
	int file_count;
	int uimage_lnk;
	int uimage_filenum;
	int supplant_lnk;
	int supplant_filenum;
};
#endif
#endif /* _FAT_H_ */

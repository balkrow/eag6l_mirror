...
#define CONFIG_SYS_CPLD_BASE		0x70000000
...
/* IFC FPGA*/
#define CONFIG_SYS_FPGA_BASE		0x60000000
...
#define CONFIG_SYS_FPGA_CSPR		(CSPR_PHYS_ADDR(FPGA_BASE_PHYS) | \
					...
					CSPR_V)
#if 1
#define CONFIG_SYS_FPGA_CSOR		CSOR_NOR_ADM_SHIFT(6)
#else
#define CONFIG_SYS_FPGA_CSOR            (CSOR_NOR_ADM_SHIFT(12) | \
                                        CSOR_NOR_NOR_MODE_AVD_NOR | \
                                        CSOR_NOR_TRHZ_60)
...
#define DDR_SDRAM_CFG			0x452C0000
#define DDR_CS0_BNDS			0x008000FF
#define DDR_CS0_CONFIG			0x80010412
#define DDR_TIMING_CFG_0		0x4055000C
#define DDR_TIMING_CFG_1		0xBCB40C52
#define DDR_TIMING_CFG_2		0x0048D11C
#define DDR_TIMING_CFG_3		0x01111000
#define DDR_TIMING_CFG_4		0x00000001
#define DDR_TIMING_CFG_5		0x04401400
#define DDR_SDRAM_CFG_2			0x00401010
#define DDR_SDRAM_MODE			0x01010210
#define DDR_SDRAM_MODE_2		0x0
#define DDR_SDRAM_INTERVAL		0x18600618
#define DDR_DDR_WRLVL_CNTL		0x8675F609
#define DDR_DDR_WRLVL_CNTL_2		0x090A0A0B
#define DDR_DDR_WRLVL_CNTL_3		0x0B0C0C00
#define DDR_DDR_CDR1			0x80040000
#define DDR_DDR_CDR2			0xA101
#define DDR_SDRAM_CLK_CNTL		0x02000000
#define DDR_DDR_ZQ_CNTL			0x8A090705
#define DDR_CS0_CONFIG_2		0
#define DDR_SDRAM_CFG_MEM_EN		0
#define SDRAM_CFG2_D_INIT		0
#define DDR_CDR2_VREF_TRAIN_EN		0
#define SDRAM_CFG2_FRC_SR		0
#define SDRAM_CFG_BI			0
#else
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	"bootargs=root=/dev/ram0 rw console=ttyS0,115200 panic=60 ${blkdevparts}\0"		\
	"initrd_high=0x8f000000\0"					\
	"fdt_high=0x88000000\0"						\
	"bootup=tftp 0x82000000 balkrow/u-boot-with-spl-pbl.bin && mmc rescan && mmc dev 0 && mmc erase 8 0x800 && mmc write 0x82000000 8 0x800\0"						\
	"blkdevparts=mmcblk0:128M@100M(boot),1M(ubootenv),128M(factory),128M(pm),128M(config),128M(log),-(flash)\0" \
	"ethact=eTSEC2\0"						\
...
#define CONFIG_SYS_QE_FW_ADDR     0x40340000
#else
#define CONFIG_SYS_QE_FW_ADDR     0x200000
#endif
...
//#define CONFIG_SYS_MMC_ENV_PART		1	/* boot area */
#define CONFIG_ENV_SIZE			0x20000
#define CONFIG_HFR_USE_EMMC_FLASH	1

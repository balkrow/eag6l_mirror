...
#if 1/*[#146] fix compile time between image header and cli, balkrow, 2022-08-10 */
	while ((opt = getopt(argc, argv,
			     "a:A:b:c:C:d:D:e:Ef:Fk:i:K:ln:N:p:O:rR:qsT:vVxt:")) != -1) {
#else
	while ((opt = getopt(argc, argv,
...
#if 1/*[#146] fix compile time between image header and cli, balkrow, 2022-08-10 */
		case 't':
			params.build_time = strtoull(optarg, &ptr, 10);

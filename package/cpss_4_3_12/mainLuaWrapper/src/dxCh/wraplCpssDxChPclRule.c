...
static GT_U32 multiPclTcamIndexData[(PRV_CPSS_MAX_PP_DEVICES_CNS + 3) / 4] = {0};
...
/*******************************************************************************
* wrlCpssDxChPclNumLookups
*
* DESCRIPTION:
*   The function gets the number of iPCL lookups (2 or 3)
*
* APPLICABLE DEVICES:
*        DxCh1; DxCh1_Diamond; DxCh2; DxCh3; xCat; xCat3; AC5; Lion; xCat2; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
...
)
{
    ...
    {
        lua_pushinteger(L, (lua_Integer)status);
        return 1;/* 1 (single) parameter returned */
    }
    ...
    return 2;/* 2 parameters returned */
}

...
extern GT_STATUS prvCpssDxChCaelumPortResourceConfigGet
(
    IN  GT_U8                                       devNum,
...
)
{
    ...
    status = prvCpssDxChCaelumPortResourceConfigGet(devNum, portNum, &resource);   
    ...
    lua_pushinteger(L, resource.txdmaTxfifoHeaderCounterThresholdScdma);
    lua_pushinteger(L, resource.txdmaTxfifoPayloadCounterThresholdScdma);

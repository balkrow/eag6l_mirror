...
static BOOLEAN util_xml_get_signature(
...
/*****************************************************************************
* FUNCTION NAME: util_print_log
*
* DESCRIPTION:  implementation of print log for MPD
*
*
*****************************************************************************/
static MPD_RESULT_ENT util_print_log(
...
)
{
        ...
        phy_callbacks.logging_PTR        = util_print_log;
...
)
{
    ...
    callbacks.pdLibCallbacks.freePtr               = free;
    ...
    callbacks.pdLibCallbacks.getXmlSignatureClbk = util_xml_get_signature;

...
/*******************************************************************************
* wraplCompressedJsonReceive: lua function
*
* DESCRIPTION:
*       Receive a data 
*
...
*
*******************************************************************************/
int wraplCompressedJsonReceive(lua_State *L)
{
    IOStreamPTR IOStream;
    int ret;
    char buf[512];
    ...
    while (IOStream->connected(IOStream))
    {
        ...
        ret = IOStream->readChar(IOStream, buf+p, 0);
    }
    if (p > 0)
    {
        lua_pushlstring(L, buf, p);
...
/*******************************************************************************
* wraplCompressedJsonSend: lua function
*
* DESCRIPTION:
*       Receive a data 
*
...
*
*******************************************************************************/
int wraplCompressedJsonSend(lua_State *L)
{
    IOStreamPTR IOStream;
    ...
    IOStream->setTtyMode(IOStream, 2);
    IOStream->write(IOStream, (char*)data, len);
    IOStream->setTtyMode(IOStream, 1);

...
int mgmType_to_c_MV_HWS_SERDES_PRESET_OVERRIDE_UNT_comphyC28GP4PresetOverride(
    lua_State *L
)
{
    MV_HWS_SERDES_PRESET_OVERRIDE_UNT *val = NULL;
    lua_newuserdata(L, sizeof(MV_HWS_SERDES_PRESET_OVERRIDE_UNT));

    val = (MV_HWS_SERDES_PRESET_OVERRIDE_UNT*)lua_touserdata(L, -1);
    cmdOsMemSet(val, 0, sizeof(MV_HWS_SERDES_PRESET_OVERRIDE_UNT));
    if (lua_isnil(L, 1))
    {
        return 1;
    }
    lua_pushvalue(L, 1);
    prv_lua_to_c_MV_HWS_SERDES_PRESET_OVERRIDE_UNT(L, val);
    lua_pop(L, 1);
...
int mgmType_to_c_MV_HWS_SERDES_EOM_IN_PARAMS_UNT_comphyC12GP41P2VEomInParams(
    lua_State *L
)
{
    MV_HWS_SERDES_EOM_IN_PARAMS_UNT *val = NULL;
    lua_newuserdata(L, sizeof(MV_HWS_SERDES_EOM_IN_PARAMS_UNT));

    val = (MV_HWS_SERDES_EOM_IN_PARAMS_UNT*)lua_touserdata(L, -1);
    cmdOsMemSet(val, 0, sizeof(MV_HWS_SERDES_EOM_IN_PARAMS_UNT));
    if (lua_isnil(L, 1))
    {
        return 1;
    }
    lua_pushvalue(L, 1);
    prv_lua_to_c_MV_HWS_SERDES_EOM_IN_PARAMS_UNT(L, val);
    lua_pop(L, 1);

    return 1;
}

int mgmType_to_c_MV_HWS_SERDES_EOM_IN_PARAMS_UNT_comphyC28GP4EomInParams(
    lua_State *L
)
{
    MV_HWS_SERDES_EOM_IN_PARAMS_UNT *val = NULL;
...
int mgmType_to_c_MV_HWS_SERDES_EOM_IN_PARAMS_UNT_comphyC112GEomInParams(
    lua_State *L
)
{
    MV_HWS_SERDES_EOM_IN_PARAMS_UNT *val = NULL;
...
int mgmType_to_c_MV_HWS_SERDES_EOM_IN_PARAMS_UNT_comphyC56GEomInParams(
    lua_State *L
)
{
    MV_HWS_SERDES_EOM_IN_PARAMS_UNT *val = NULL;
...
int mgmType_to_c_MV_HWS_SERDES_EOM_OUT_PARAMS_UNT_comphyC12GP41P2VEomOutParams(
    lua_State *L
)
{
    MV_HWS_SERDES_EOM_OUT_PARAMS_UNT *val = NULL;
    lua_newuserdata(L, sizeof(MV_HWS_SERDES_EOM_OUT_PARAMS_UNT));

    val = (MV_HWS_SERDES_EOM_OUT_PARAMS_UNT*)lua_touserdata(L, -1);
    cmdOsMemSet(val, 0, sizeof(MV_HWS_SERDES_EOM_OUT_PARAMS_UNT));
    if (lua_isnil(L, 1))
    {
        return 1;
    }
    lua_pushvalue(L, 1);
    prv_lua_to_c_MV_HWS_SERDES_EOM_OUT_PARAMS_UNT(L, val);
    lua_pop(L, 1);

    return 1;
}

int mgmType_to_c_MV_HWS_SERDES_EOM_OUT_PARAMS_UNT_comphyC28GP4EomOutParams(
    lua_State *L
)
{
    MV_HWS_SERDES_EOM_OUT_PARAMS_UNT *val = NULL;
...
int mgmType_to_c_MV_HWS_SERDES_EOM_OUT_PARAMS_UNT_comphyC112GEomOutParams(
    lua_State *L
)
{
    MV_HWS_SERDES_EOM_OUT_PARAMS_UNT *val = NULL;
...
int mgmType_to_c_MV_HWS_SERDES_EOM_OUT_PARAMS_UNT_comphyC56GEomOutParams(
    lua_State *L
)
{
    MV_HWS_SERDES_EOM_OUT_PARAMS_UNT *val = NULL;

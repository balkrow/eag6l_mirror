/*************************************************************************
* /local/store/cpss_regression/cpss_4.3.12_NIGHT_RUN/tmp/all_px_lua_c_type_wrappers.c
*
* DESCRIPTION:
*       A lua type wrapper
...
*
* COMMENTS:
*       Generated at Fri Sep  1 00:00:00 2023
*       /local/store/cpss_regression/cpss_4.3.12_NIGHT_RUN/cpss/mainLuaWrapper/scripts/make_type_wrapper.py -i /local/store/cpss_regression/cpss_4.3.12_NIGHT_RUN/tmp/type_info_file_px -p /local/store/cpss_regression/cpss_4.3.12_NIGHT_RUN/cpss/mainLuaWrapper/scripts/already_implemented.lst -X /local/store/cpss_regression/cpss_4.3.12_NIGHT_RUN/cpss/mainLuaWrapper/scripts/excludelist -C /local/store/cpss_regression/cpss_4.3.12_NIGHT_RUN/cpss -M /local/store/cpss_regression/cpss_4.3.12_NIGHT_RUN/cpss/mainLuaWrapper/scripts/lua_C_mapping -N -F px -o /local/store/cpss_regression/cpss_4.3.12_NIGHT_RUN/tmp/all_px_lua_c_type_wrappers.c
*
...
add_mgm_enum(CPSS_PX_PORT_UNITS_ID_ENT);

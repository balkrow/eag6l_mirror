...
)
{
    ...
    CPSS_DXCH_EXACT_MATCH_CLIENT_ENT                  firstLookupClientType;
...
/* define default action */
    ...
    {
        rc = cpssDxChExactMatchExpandedActionSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, expandedActionIndex,
                                                 actionType,
                                                 &actionData,
        ...
        rc = cpssDxChExactMatchClientLookupSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, exactMatchLookupNum, firstLookupClientType);
        if (GT_OK != rc)
            return rc;
        ...
        rc = cpssDxChExactMatchProfileKeyParamsSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, profileIndex, &keyParams);
        if (GT_OK != rc)
            return rc;

        rc = cpssDxChExactMatchProfileDefaultActionSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                       profileIndex,
                                                       actionType,
                                                       &actionDefault,
                                                       GT_TRUE);
        ...
        rc = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                               &exactMatchEntry.key,

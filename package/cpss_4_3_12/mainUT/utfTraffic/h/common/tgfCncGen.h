...
/**
* @enum PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT
 *
...
typedef enum{
     ...
     */
    PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CMD_AND_CODE_E,

    /** @brief Mask the packet command portion of the index,
     * index = {8'b0, cpu/drop code[7:0]}.
     */
    PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CODE_ONLY_E

} PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT;
...
typedef enum{
     ...
     *  (APPLICABLE DEVICES: Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    PRV_TGF_CNC_COUNTER_FORMAT_MODE_3_E,
     ...
     *  (APPLICABLE DEVICES: Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    PRV_TGF_CNC_COUNTER_FORMAT_MODE_4_E,
...
/**
* @struct PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC
 *
...
typedef struct{
    ...
    PRV_TGF_CNC_CLIENT_ENT clientSelect;
...
} PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC;

...
/**
 * @struct PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_ENHANCED_SFLOW_STC
 *
...
} PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_ENHANCED_SFLOW_STC;
/**
...
/**
 * @struct PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_IFA_STC
 *
...
*/
typedef struct{
    /** @brief IFA flow indexes used in PHA shared memory access
     *  (APPLICABLE RANGE: 0..511)
    */
    GT_U32  flowId;
}PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_IFA_STC ;

/**
 * @struct PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_ROUTER_SA_MODIFICATION_STC
 *
...
typedef struct{
     ...
     */
    GT_U32 macSaLsb;
} PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_ROUTER_SA_MODIFICATION_STC;

/**
 * @struct PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_VXLAN_DCI_VNI_REMAP_STC
 *
...
typedef struct{
     ...
     */
    GT_U32 vxlanVni;
} PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_VXLAN_DCI_VNI_REMAP_STC;
...
typedef union{
    ...
    /** @brief EPCL info for thread to handle SFLOW packets in the system */
    PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_ENHANCED_SFLOW_STC epclEnhancedSflow;

    /** @brief EPCL info for thread to handle IFA packets in the system */
    PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_IFA_STC epclIfaFlow;

    /** @brief EPCL info for thread to handle Router SA MAC in the system */
    PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_ROUTER_SA_MODIFICATION_STC epclRouterSaModification;

    /** @brief EPCL info for thread to handle VXLAN DCI VNI REMAP in the system */
    PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_VXLAN_DCI_VNI_REMAP_STC epclVxlanVni;
...
typedef enum{
    ...
    */
    ...
    PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_ENHANCED_SFLOW_E,

    /** @brief type for thread to handle IFA packets */
    PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_IFA_E,

    /** @brief type for thread to handle Router SA Modification */
    PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_ROUTER_SA_MODIFICATION_E,

    /** @brief type for thread to handle VXLAN DCI VNI Remapping */
    PRV_TGF_PCL_ACTION_EGRESS_PHA_THREAD_VXLAN_DCI_VNI_REMAP_E,
...
/* used by prvTgfPclDefPortInitExtGeneric caller to skip access mode configuration */
#define PRV_TGF_PCL_PORT_LOOKUP_CFG_TAB_ACC_MODE_DONT_CARE_E (PRV_TGF_PCL_PORT_LOOKUP_CFG_TAB_ACC_MODE_ENT)0xFF

...
/**
* @enum PRV_TGF_PTP_REF_CLOCK_SELECT_ENT
*
...
typedef enum{
    ...
    PRV_TGF_PTP_REF_CLOCK_SELECT_MAIN_25_MHZ_E,

    /** Using the dedicated PTP PLL.
     */
    PRV_TGF_PTP_REF_CLOCK_SELECT_DEDICATED_PTP_REF_CLK_E,

    /** Using the SerDes differential clock.
     */
    PRV_TGF_PTP_REF_CLOCK_SELECT_SD_DIFFRENTIAL_REF_CLK_E

} PRV_TGF_PTP_REF_CLOCK_SELECT_ENT;

/**
* @enum PRV_TGF_PTP_TAI_CLOCK_FREQ_ENT
 *
 * @brief This enum defines PTP clock frequency in Mhz.
*/
typedef enum{

    PRV_TGF_PTP_10_FREQ_E,

    PRV_TGF_PTP_20_FREQ_E,

    PRV_TGF_PTP_25_FREQ_E,

    PRV_TGF_PTP_156_25_FREQ_E

}PRV_TGF_PTP_TAI_CLOCK_FREQ_ENT;

/**
* @struct PRV_TGF_PTP_MANAGER_REF_CLOCK_CFG_STC
*
...
typedef struct{
     ...
     */
    PRV_TGF_PTP_REF_CLOCK_SELECT_ENT      refClockSource;

    /** @brief reference clock frequency.
     */
    PRV_TGF_PTP_TAI_CLOCK_FREQ_ENT        refClockFrequency;

} PRV_TGF_PTP_MANAGER_REF_CLOCK_CFG_STC;

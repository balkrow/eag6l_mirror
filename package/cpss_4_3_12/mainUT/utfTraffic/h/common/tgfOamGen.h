...
/**
* @enum PRV_TGF_OAM_EXCEPTION_STATUS_ENT
 *
...
typedef enum{
    ...
    PRV_TGF_OAM_EXCEPTION_STATUS_PASS_E,

    /** Exception detected */
    PRV_TGF_OAM_EXCEPTION_STATUS_FAIL_E

} PRV_TGF_OAM_EXCEPTION_STATUS_ENT;
...
typedef struct{
     ...
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL ignoreBadKeepAliveInAgingEnable;         /* When disabled, keepalive processing is skiped for bad hash */

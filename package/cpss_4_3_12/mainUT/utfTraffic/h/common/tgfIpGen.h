...
typedef struct{
   ...
   /** epgAssignedToLeafNode  - Valid if EntryType="Leaf"
...
typedef struct{
    ...
    /** @brief Defines the length of the SIP prefix - 1
     *  (APPLICABLE RANGE: 1..32)
     *  (APPLICABLE DEVICES: Ironman)
     */
    GT_U32 sipPrefixLen;
    /** @brief Defines the length of the DIP prefix - 1
     *  (APPLICABLE RANGE: 1..32)
     *  (APPLICABLE DEVICES: Ironman)
     */
    GT_U32 dipPrefixLen;
...
typedef struct{
    ...
    GT_U32    natPtr;
} PRV_TGF_IP_NAT_L2_PORT_CONFIG_STC;

/**
* @struct CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC
 *
 * @brief Struct for L2 NAT Global configuration
*/
typedef struct{
    /** The number of Src-ID bits used for representing
     *  the ingress port group for L2NAT */
    GT_U32     l2NatSrcIdSize;
    /** The LSB of the Src-ID used for representing
     *  the ingress port group for L2NAT */
    GT_U32     l2NatSrcIdLsb;
} PRV_TGF_IP_NAT_L2_GLOBAL_CONFIG_STC;

#define PRV_TGF_LPM_RAM_BLOCKS_ALLOCATION_METHOD_DYNAMIC_WITHOUT_BLOCK_SHARING_E  CPSS_DXCH_LPM_RAM_BLOCKS_ALLOCATION_METHOD_DYNAMIC_WITHOUT_BLOCK_SHARING_E
#define PRV_TGF_LPM_RAM_BLOCKS_ALLOCATION_METHOD_DYNAMIC_WITH_BLOCK_SHARING_E     CPSS_DXCH_LPM_RAM_BLOCKS_ALLOCATION_METHOD_DYNAMIC_WITH_BLOCK_SHARING_E
#define PRV_TGF_LPM_RAM_BLOCKS_ALLOCATION_METHOD_LAST_E (PRV_TGF_LPM_RAM_BLOCKS_ALLOCATION_METHOD_DYNAMIC_WITH_BLOCK_SHARING_E+1)
#define PRV_TGF_LPM_RAM_BLOCKS_ALLOCATION_METHOD_ENT CPSS_DXCH_LPM_RAM_BLOCKS_ALLOCATION_METHOD_ENT

#define PRV_TGF_LPM_RAM_MEM_MODE_FULL_MEM_SIZE_E CPSS_DXCH_LPM_RAM_MEM_MODE_FULL_MEM_SIZE_E
#define PRV_TGF_LPM_RAM_MEM_MODE_HALF_MEM_SIZE_E CPSS_DXCH_LPM_RAM_MEM_MODE_HALF_MEM_SIZE_E
#define PRV_TGF_LPM_RAM_MEM_MODE_LAST_E (PRV_TGF_LPM_RAM_MEM_MODE_HALF_MEM_SIZE_E+1)
#define PRV_TGF_LPM_RAM_MEM_MODE_ENT    CPSS_DXCH_LPM_RAM_MEM_MODE_ENT

#define     PRV_TGF_CFG_SHARED_TABLE_MODE_MAX_L3_MIN_L2_NO_EM_E                 CPSS_DXCH_CFG_SHARED_TABLE_MODE_MAX_L3_MIN_L2_NO_EM_E
#define     PRV_TGF_CFG_SHARED_TABLE_MODE_MIN_L3_MAX_L2_NO_EM_E                 CPSS_DXCH_CFG_SHARED_TABLE_MODE_MIN_L3_MAX_L2_NO_EM_E
#define     PRV_TGF_CFG_SHARED_TABLE_MODE_MID_L3_MID_L2_MIN_EM_E                CPSS_DXCH_CFG_SHARED_TABLE_MODE_MID_L3_MID_L2_MIN_EM_E
#define     PRV_TGF_CFG_SHARED_TABLE_MODE_MID_L3_MIN_L2_MAX_EM_E                CPSS_DXCH_CFG_SHARED_TABLE_MODE_MID_L3_MIN_L2_MAX_EM_E
#define     PRV_TGF_CFG_SHARED_TABLE_MODE_MID_LOW_L3_MID_LOW_L2_MAX_EM_E        CPSS_DXCH_CFG_SHARED_TABLE_MODE_MID_LOW_L3_MID_LOW_L2_MAX_EM_E
#define     PRV_TGF_CFG_SHARED_TABLE_MODE_MID_L3_MID_L2_NO_EM_E                 CPSS_DXCH_CFG_SHARED_TABLE_MODE_MID_L3_MID_L2_NO_EM_E
#define     PRV_TGF_CFG_SHARED_TABLE_MODE_MID_LOW_L3_MID_L2_MID_EM_E            CPSS_DXCH_CFG_SHARED_TABLE_MODE_MID_LOW_L3_MID_L2_MID_EM_E
#define     PRV_TGF_CFG_SHARED_TABLE_MODE_MID_L3_MID_LOW_L2_MID_EM_MAX_ARP_E    CPSS_DXCH_CFG_SHARED_TABLE_MODE_MID_L3_MID_LOW_L2_MID_EM_MAX_ARP_E

#include <cpss/dxCh/dxChxGen/lpm/cpssDxChLpmTypes.h>
typedef CPSS_DXCH_LPM_RAM_CONFIG_INFO_STC   PRV_TGF_CFG_LPM_RAM_CONFIG_INFO_STC;
typedef CPSS_DXCH_LPM_RAM_CONFIG_STC        PRV_TGF_LPM_RAM_CONFIG_STC;

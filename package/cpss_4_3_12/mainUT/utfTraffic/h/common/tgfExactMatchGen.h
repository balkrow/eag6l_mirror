...
#define PRV_TGF_EXACT_MATCH_MAX_KEY_SIZE_CNS    53

/* Support for 53B keysize is not yet provided for Exact Match manager in AAS
 * Will remove this macro once the support is given */
#define PRV_TGF_EXACT_MATCH_MANAGER_MAX_KEY_SIZE_CNS    47
...
typedef enum{
    ...
    PRV_TGF_EXACT_MATCH_KEY_SIZE_21B_E,

    /** Exact Match key size 37 Bytes (APPLICABLE DEVICES: AAS) */
    PRV_TGF_EXACT_MATCH_KEY_SIZE_37B_E,

    /** Exact Match key size 53 Bytes (APPLICABLE DEVICES: AAS) */
    PRV_TGF_EXACT_MATCH_KEY_SIZE_53B_E,

    /* TBD: will update this once the Exact Manager support is provided for AAS*/
    PRV_TGF_EXACT_MATCH_KEY_SIZE_LAST_E = PRV_TGF_EXACT_MATCH_KEY_SIZE_21B_E
...
typedef enum{
    ...
    /** EM client tunnel termination (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman; AAS) */
    ...
    /** EM client ingress policy 1 (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman; AAS) */
    PRV_TGF_EXACT_MATCH_CLIENT_IPCL_1_E,

    /** EM client ingress policy 2 (APPLICABLE DEVICES: AC5P; AC5X; Harrier; Ironman; AAS) */
    PRV_TGF_EXACT_MATCH_CLIENT_IPCL_2_E,

    /** EM client egress policy (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman; AAS) */
    PRV_TGF_EXACT_MATCH_CLIENT_EPCL_E,

    /** EXACT MATCH client egress policy (APPLICABLE DEVICES: AAS) */
    PRV_TGF_EXACT_MATCH_CLIENT_MPCL_E,

    /** EXACT MATCH client egress policy (APPLICABLE DEVICES: AAS) */
    PRV_TGF_EXACT_MATCH_CLIENT_IPE_E,

    /** EXACT MATCH client egress policy (APPLICABLE DEVICES: AAS) */
    PRV_TGF_EXACT_MATCH_CLIENT_TTI_SERIAL_EM_E,
...
/**
* @enum PRV_TGF_EXACT_MATCH_UNIT_NUM_ENT
 *
 * @brief Exact Match unit numbers.
*/
typedef enum{
    PRV_TGF_EXACT_MATCH_UNIT_0_E,
    PRV_TGF_EXACT_MATCH_UNIT_1_E,
    PRV_TGF_EXACT_MATCH_UNIT_2_E,
    PRV_TGF_EXACT_MATCH_UNIT_3_E,
    PRV_TGF_EXACT_MATCH_UNIT_REDUCED_E,
    PRV_TGF_EXACT_MATCH_UNIT_LAST_E
} PRV_TGF_EXACT_MATCH_UNIT_NUM_ENT;
...
*/
typedef enum{
    /** Exact Match first lookup (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman; AAS) */
    PRV_TGF_EXACT_MATCH_LOOKUP_FIRST_E,

    /** Exact Match second lookup (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman; AAS) */
...
/**
* @enum PRV_TGF_EXACT_MATCH_SERIAL_EM_TYPE_ENT
 *
...
typedef enum{
    ...
    PRV_TGF_EXACT_MATCH_SERIAL_EM_LAST_E
} PRV_TGF_EXACT_MATCH_SERIAL_EM_TYPE_ENT;
...
*/
typedef enum{
    PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_VLAN_TAG_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_MPLS_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_20_24_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_25_29_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_LAST_E
} PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_ENT;

/**
* @struct PRV_TGF_EXACT_MATCH_SERIAL_EM_ENTRY_STC
 *
...
typedef struct{
    ...
    PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_ENT  serialEmKeyType;
...
/**
* @enum PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT
* @brief Packet types.
*/
typedef enum{
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_TCP_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_UDP_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_MPLS_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_FRAGMENT_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_OTHER_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_ETHERNET_OTHER_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV6_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV6_TCP_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV6_UDP_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE1_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE2_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE3_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE4_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE5_E,
    PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE6_E
} PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT;

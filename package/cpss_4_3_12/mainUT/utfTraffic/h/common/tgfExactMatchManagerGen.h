...
typedef struct{
    ...
    GT_U8          pattern[PRV_TGF_EXACT_MATCH_MANAGER_MAX_KEY_SIZE_CNS];

    /** @brief indicates the pattern mask bits */
    GT_U8          mask[PRV_TGF_EXACT_MATCH_MANAGER_MAX_KEY_SIZE_CNS];

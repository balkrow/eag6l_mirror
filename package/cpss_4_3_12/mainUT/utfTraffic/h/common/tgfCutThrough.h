...
typedef struct
{
    ...
    GT_BOOL bypassMll;
    GT_BOOL bypassFdbLookup;
    GT_BOOL bypassMidwayPcl;
    GT_BOOL bypassIpe;
...
{
    GT_U32               numOfPorts;
    GT_PHYSICAL_PORT_NUM portNumArr[CPSS_MAX_SDMA_CPU_PORTS_CNS];
    GT_BOOL              ctEnableArr[CPSS_MAX_SDMA_CPU_PORTS_CNS];
    GT_BOOL              untaggedCtEnableArr[CPSS_MAX_SDMA_CPU_PORTS_CNS];
} PRV_TGF_CUT_THROUGH_SDMA_PORTS_STATUS_STC;

...
/**
* @enum PRV_TGF_TTI_QOS_MODEL_ENT
*
* @brief TTI QoS Model.
...
typedef enum{
    /* Uniform model */
    PRV_TGF_TTI_QOS_UNIFORM_MODEL_E,
    /* Pipe model */
    PRV_TGF_TTI_QOS_PIPE_MODEL_E,
    /* Short Pipe model */
    PRV_TGF_TTI_QOS_SHORT_PIPE_MODEL_E
} PRV_TGF_TTI_QOS_MODEL_ENT;

/**
* @enum PRV_TGF_TTI_TTL_MODEL_ENT
*
* @brief TTI TTL Model.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Uniform model */
    PRV_TGF_TTI_TTL_UNIFORM_MODEL_E,
    /* Pipe model */
    PRV_TGF_TTI_TTL_PIPE_MODEL_E,
    /* Short Pipe model */
    PRV_TGF_TTI_TTL_SHORT_PIPE_MODEL_E
} PRV_TGF_TTI_TTL_MODEL_ENT;

/**
* @enum PRV_TGF_TTI_QOS_MAPPING_MODE_ENT
*
...
typedef enum{
    ...
    PRV_TGF_TTI_QOS_PROFILE_MODE_E,
    /* TC-DP Mode
     * Map QoS Field to TC_DP*/
    PRV_TGF_TTI_TC_DP_MODE_E
} PRV_TGF_TTI_QOS_MAPPING_MODE_ENT;
...
typedef struct
{
    ...
    PRV_TGF_TTI_QOS_MODEL_ENT                   qosModel;
    PRV_TGF_TTI_TTL_MODEL_ENT                   ttlModel;
    PRV_TGF_TTI_QOS_MAPPING_MODE_ENT            qosMappingMode;

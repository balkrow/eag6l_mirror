...
* @brief : the test will start with 2 ports in the trunk , and will add third port as disabled.
...
*/
void tgfTrunkAddDisabledMember
(
    void
);
...
/**
* @internal prvTgfTrunkPrngSeedTestConfig function
* @endinternal
*
* @brief   Trunk PRNG seed test configuration
*/
void prvTgfHLTrunkPrngSeedTestConfig
(
);

/**
* @internal prvTgfTrunkPrngSeedTestConfigTrafficGenerate function
* @endinternal
*
* @brief   Trunk PRNG seed test configuration traffic check
*/
void prvTgfHLTrunkPrngSeedTestConfigTrafficGenerate
(
);

/**
* @internal prvTgfTrunkPrngSeedTestConfigRestore function
* @endinternal
*
* @brief   Trunk PRNG seed test configuration restore
*/
void prvTgfHLTrunkPrngSeedTestConfigRestore
(
);

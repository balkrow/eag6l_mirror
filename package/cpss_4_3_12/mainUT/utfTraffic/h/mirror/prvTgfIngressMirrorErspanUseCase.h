...
*
* @brief
*           Test the captures for the configs for ERSPAN I.
*           RX:
*               L2 pkt for Vlan5
*           TX:
*               2 pkts on 2 Egr analyzer ports.
...
*    send traffic and verify expected mirrored traffic on analyzer port;
*/
GT_VOID prvTgfFalconErspanISameDevMirrorIpv4ConfigurationSet();
...
*    send traffic and verify expected mirrored traffic on analyzer port;
*/
GT_VOID prvTgfFalconErspanISameDevMirrorIpv6ConfigurationSet();

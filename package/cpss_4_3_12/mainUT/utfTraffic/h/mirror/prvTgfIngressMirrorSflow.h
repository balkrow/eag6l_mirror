...
*
*/
void prvTgfMirrorEgressEnhancedSflowConfig(CPSS_IP_PROTOCOL_STACK_ENT protocol);
...
*/
void prvTgfMirrorEgressEnhancedSflowConfigReset(CPSS_IP_PROTOCOL_STACK_ENT protocol);
...
*    E2phy and IPv4 TS for eport
*    configure EPCL rule to trigger IPv4 PHA thread, and pha metadata
*    send UC traffic and verify expected Sflow mirrored traffic on analyzer port;
*/
...
* @endinternal
*
* @brief  Traffic test for ingress mirroring functionality with sflow v5 encapsulation
*           RX port #1
*           TX analyzer port #2
*           Check in the SFLOW header for
*           1. agent IPv4 address

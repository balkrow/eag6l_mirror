...
#define PRV_TGF_RX_MIRROR_AND_NO_TS 0
#define PRV_TGF_TX_MIRROR_AND_TS    1
#define PRV_TGF_TX_MIRROR_AND_NO_TS 2
...
/**
* @internal prvTgfEgressVlanMirroringTest_cpss_17642 function
* @endinternal
*
* @brief   Basic test to validate egress VLAN mirroring in FALCON with
*          egress VLAN attribute table entry write config
*/

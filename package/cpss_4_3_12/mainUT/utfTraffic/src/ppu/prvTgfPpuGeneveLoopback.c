...
)
{
    ...
    ppuActionProfile.rotActionEntry[0].shiftLeftRightSel = GT_FALSE /*SHIFT_LEFT*/;
    ppuActionProfile.rotActionEntry[0].shiftNum          = 2;
    ppuActionProfile.rotActionEntry[0].addSubConstSel    = GT_FALSE /*ADD_SEL*/;
    ...
    ppuActionProfile.rotActionEntry[0].target            = GT_FALSE/*SP_BUS*/;
    ...
    ppuActionProfile.rotActionEntry[1].shiftLeftRightSel = GT_FALSE /*SHIFT_LEFT*/;
    ppuActionProfile.rotActionEntry[1].shiftNum          = 2;
    ppuActionProfile.rotActionEntry[1].addSubConstSel    = GT_FALSE /*ADD_SEL*/;
    ppuActionProfile.rotActionEntry[1].addSubConst       = 4;
    ppuActionProfile.rotActionEntry[1].func              = CPSS_DXCH_PPU_KSTG_ROT_FUNC_NONE_E;
    ppuActionProfile.rotActionEntry[1].target            = GT_TRUE/*HD_SHIFT*/;
    ...
    ppuActionProfile.rotActionEntry[2].target            = GT_FALSE/*SP_BUS*/;
...
)
{
    ...
    GT_U32                  dauProfileIdx = prvTgfDauProfIdx;
    GT_U32                  protWinIdx = 4;
    GT_U32                  protWinIdxGet = 0;
    GT_U32                  errorLatchData = 0;
    GT_U32                  spByteIndex = 0;
    CPSS_DXCH_PPU_DAU_PROFILE_ENTRY_STC dauProfile;
    ...
    /* write up0 field. SP Bus : 3rd byte*/
    ...
    /* Verify the DAU protection window error latched data */
    rc = cpssDxChPpuDauProtectedWindowErrorLatchDataGet(prvTgfDevNum, &protWinIdxGet,
                                                        &errorLatchData, &spByteIndex);
    UTF_VERIFY_EQUAL1_PARAM_MAC(protWinIdx, protWinIdxGet, prvTgfDevNum);
    UTF_VERIFY_EQUAL1_PARAM_MAC(7, errorLatchData, prvTgfDevNum);
    UTF_VERIFY_EQUAL1_PARAM_MAC(6, spByteIndex, prvTgfDevNum);
...
)
{
    ...
    GT_U32                  origHwTtiActionArray[12];  /* TTI_ACTION_TYPE_2_SIZE_CNS = 12 */
    CPSS_DXCH_PPU_PROFILE_ENTRY_STC profileEntry;

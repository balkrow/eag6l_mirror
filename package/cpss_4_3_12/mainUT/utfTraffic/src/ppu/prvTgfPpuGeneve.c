...
)
{
    ...
    ppuActionProfile.rotActionEntry[1].target            = GT_FALSE/*SP_BUS*/;
    ...
    ppuActionProfile.rotActionEntry[3].shiftLeftRightSel = GT_FALSE /*SHIFT_LEFT*/;
    ppuActionProfile.rotActionEntry[3].shiftNum          = 2;
    ppuActionProfile.rotActionEntry[3].addSubConstSel    = GT_FALSE /*ADD_SEL*/;
    ppuActionProfile.rotActionEntry[3].addSubConst       = 4;
    ppuActionProfile.rotActionEntry[3].func              = CPSS_DXCH_PPU_KSTG_ROT_FUNC_NONE_E;
    ppuActionProfile.rotActionEntry[3].target            = GT_TRUE/*HD_SHIFT*/;
    ...
    ppuActionProfile.rotActionEntry[4].target            = GT_FALSE/*SP_BUS*/;

...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugUcTraffic)
{
    ...
    */
    ...
    PRV_TGF_SUPPORTED_DEV_DECLARE_MAC((UTF_ALDRIN_E|UTF_ALDRIN2_E|UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E ))

    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(
        prvTgfDevNum, (~(UTF_ALDRIN_E|UTF_ALDRIN2_E|UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E )) )
...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugUcTrafficTwoStages)
{
    ...
    */
    ...
    PRV_TGF_SUPPORTED_DEV_DECLARE_MAC( (UTF_ALDRIN_E|UTF_ALDRIN2_E|UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E| UTF_IRONMAN_L_E) )

    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(
        prvTgfDevNum, (~(UTF_ALDRIN_E|UTF_ALDRIN2_E|UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E| UTF_IRONMAN_L_E)) )
...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugEgress)
{
    ...
    PRV_TGF_SUPPORTED_DEV_DECLARE_MAC((UTF_ALDRIN_E|UTF_ALDRIN2_E|UTF_FALCON_E|UTF_AC5X_E | UTF_HARRIER_E | UTF_AC5P_E| UTF_IRONMAN_L_E))

    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(
        prvTgfDevNum, (~(UTF_ALDRIN_E|UTF_ALDRIN2_E|UTF_FALCON_E|UTF_AC5X_E | UTF_HARRIER_E|UTF_AC5P_E| UTF_IRONMAN_L_E)))
    ...
    /*remove E_OAM (mux)and E_POLICER (no support) from list */
    if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E )
    {
        requiredStages[4] = requiredStages[6];
        requiredStages[5] = requiredStages[7];
        numberOfStages -= 2;
    }
    ...
    if(stagesArr&&fieldsArr&&fieldsValueArr&&matchedStages&&numOfHitsArr&&numOfSampleFieldsArr&&sampleFieldsValueArr&&sampleFieldsValue)
    {
        ...
        if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E )
        {
            prvTgfPacketAnalyzerGeneralSwitchMuxStages(CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_MLL_E,
                                                       CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_TRANSMIT_QUEUE_E);
        }
...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugPacketCommand)
{
    ...
    /*remove E_OAM,I_POLICER and I_QUEUE (mux)and E_POLICER (no support) from list */
    if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E )
    {
        requiredStages[4] = requiredStages[5];
        requiredStages[5] = requiredStages[7];
        requiredStages[6] = requiredStages[8];
        requiredStages[7] = requiredStages[9];
        requiredStages[8] = requiredStages[10];
        requiredStages[9] = requiredStages[13];
        requiredStages[10] = requiredStages[14];
...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugManagerReset)
{
    ...
    */
    ...
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, (~(UTF_ALDRIN_E|UTF_ALDRIN2_E|UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E| UTF_IRONMAN_L_E)) )
...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugUds)
{
    ...
    */
    ...
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, (~(UTF_ALDRIN_E|UTF_ALDRIN2_E|UTF_FALCON_E|UTF_AC5X_E | UTF_HARRIER_E|UTF_AC5P_E| UTF_IRONMAN_L_E)) )
...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugConcatinatedUds)
{
    ...
    */
    ...
    PRV_TGF_SUPPORTED_DEV_DECLARE_MAC(UTF_FALCON_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_AC5P_E| UTF_IRONMAN_L_E)

    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, (~(UTF_FALCON_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_AC5P_E| UTF_IRONMAN_L_E)))
...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugEgressMuxStagesCheck)
{
    ...
    */
    ...
    if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
    {
        stagesArr[2]=stagesArr[3];
        stagesArr[3]=stagesArr[4];
        stagesArr[4]=stagesArr[5];
        numOfFieldPerStage[3] = 0;
    }
    ...
    case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
        ...
        numOfHitPerStageArr[1] = 0;
        numOfHitPerStageArr[2] = 1; /*not mux*/
        numOfHitPerStageArr[3] = 4; /*not mux*/
        numOfHitPerStageArr[4] = 0;
        break;
    default:
        break;
    ...
    prvTgfPacketAnalyzerUnknownUcTrafficGenerate(GT_FALSE, GT_TRUE, 1);
        ...
        case CPSS_PP_FAMILY_DXCH_FALCON_E:
            ...
            break;
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            prvTgfPacketAnalyzerGeneralSwitchMuxStages(CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_TRANSMIT_QUEUE_E,
                                                       CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_PHA_E);
            break;
        case CPSS_PP_FAMILY_DXCH_AC5X_E:
        case CPSS_PP_FAMILY_DXCH_AC5P_E:
        ...
        if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
        {
            numOfHitPerStageArr[stageIndex-1] = 1;
            numOfHitPerStageArr[stageIndex] = 1;
            stageIndex += 2;
        }
        numOfHitPerStageArr[stageIndex] = 1;
...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugNoFields)
{
    ...
    case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
        ...
        stagesArr[3]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_ROUTER_E;
        stagesArr[4]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_OAM_E;
        stagesArr[5]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_MLL_E;
        stagesArr[6]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_FILTER_E;
        stagesArr[7]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_HEADER_ALTERATION_E;
        stagesArr[8]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_PCL_E;
        stagesArr[9]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_TIMESTAMP_E;
        stagesArr[10]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_MAC_E;
        stagesArr[11]=CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_TRANSMIT_QUEUE_E;
        numOfStages = 12;
        break;
    default:
        break;
...
UTF_TEST_CASE_MAC(tgfPacketAnalyzerDebugPacketTrace)
{
    ...
    */
    ...
    CPSS_DXCH_PACKET_ANALYZER_FIELD_VALUE_STC     **fieldsValuePerStageArr=NULL;
    GT_CHAR_PTR                                   ruleName="egress mux rule";
    GT_U32                                        stageWithMoreHitsIndex = 0;

    PRV_TGF_SUPPORTED_DEV_DECLARE_MAC(UTF_FALCON_E|UTF_AC5X_E | UTF_HARRIER_E|UTF_AC5P_E| UTF_IRONMAN_L_E)

    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(
        prvTgfDevNum, (~(UTF_FALCON_E|UTF_AC5X_E | UTF_HARRIER_E|UTF_AC5P_E| UTF_IRONMAN_L_E)))
    ...
    if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
    {
        maxNumOfStage = numOfStages = 8;
    } 
    stageWithMoreHitsIndex= stageWithMoreHitsIndex;
    TGF_ARRAY_ALLOCATION
    ...
    if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
    {
        stagesArr[4]=stagesArr[6];
        stagesArr[5]=stagesArr[7];
        stagesArr[6]=stagesArr[8];
        stagesArr[7]=stagesArr[10];
    }
    ...
    stageWithMoreHitsIndex = 7;
    if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
    {
        stageWithMoreHitsIndex = 5;
    }
    for (ii = 3; ii < stageWithMoreHitsIndex; ii++)            numOfHitPerStageArr[ii] = 2;
    for (ii = stageWithMoreHitsIndex; ii < numOfStages; ii++)  numOfHitPerStageArr[ii] = 4;
#else
    for (ii = 0; ii < numOfStages; ii++) numOfHitPerStageArr[ii] = 0;
#endif
    ...
    for (ii = 0; ii < stageWithMoreHitsIndex; ii++)
    {
        numOfFieldPerStage[ii] = 1;
        numOfHitPerStageArr[ii] = 2;
    }
    for (ii = stageWithMoreHitsIndex; ii < numOfStages; ii++)
    {
        numOfFieldPerStage[ii] = 1;
        numOfHitPerStageArr[ii] = 4;
    }

...
)
{
    ...
    PRV_TGF_SUPPORTED_DEV_DECLARE_MAC((UTF_ALDRIN_E |UTF_ALDRIN2_E | UTF_FALCON_E | UTF_AC5X_E | UTF_AC5P_E | UTF_HARRIER_E| UTF_IRONMAN_L_E))

    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(
        prvTgfDevNum, (~(UTF_ALDRIN_E |UTF_ALDRIN2_E | UTF_FALCON_E | UTF_AC5X_E | UTF_AC5P_E | UTF_HARRIER_E| UTF_IRONMAN_L_E)) )
...
)
{
    ...
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, (~(UTF_ALDRIN_E |UTF_ALDRIN2_E | UTF_FALCON_E | UTF_AC5X_E | UTF_AC5P_E | UTF_HARRIER_E| UTF_IRONMAN_L_E)))

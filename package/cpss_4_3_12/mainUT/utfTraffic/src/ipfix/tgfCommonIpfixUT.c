...
********************************************************************/
    ...
    /* test was written for Lion/Lion2 (probably) */
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, UTF_BOBCAT3_E | UTF_FALCON_E | UTF_AAS_E/* multi-pipe , need to debug to open it */);

...
static GT_U32 ipfixBaseFlowId;
static GT_U32 ipfixBaseFlowIdRestore;
...
)
{
    ...
    rc = prvTgfIpfixEntrySet(prvTgfDevNum, testedStage,
                             ipfixIndex - ipfixBaseFlowId, &ipfixEntry);
    UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, rc, "prvTgfIpfixEntrySet: %d, %d, %d",
                                 prvTgfDevNum, testedStage, ipfixIndex);
    ...
    rc = cpssDxChPolicerTrappedPacketsBillingEnableSet(
        prvTgfDevNum, CPSS_DXCH_POLICER_STAGE_INGRESS_0_E, GT_TRUE);
...
)
{
    ...
    ipfixBaseFlowId = 1;
    rc = prvTgfIpfixBaseFlowIdGet(prvTgfDevNum, testedStage, &ipfixBaseFlowIdRestore);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfIpfixBaseFlowIdGet");
    rc = prvTgfIpfixBaseFlowIdSet(prvTgfDevNum, testedStage, ipfixBaseFlowId);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfIpfixBaseFlowIdSet");

    basicTestConf[0].ruleIndex  = 1;
    basicTestConf[0].ipfixIndex = 1;
    basicTestConf[0].burstCount = 5;
    basicTestConf[0].payloadLen = 44;
    rc = prvTgfIpfixFirstPacketsMirrorEnableSet(prvTgfDevNum, testedStage, basicTestConf[0].ipfixIndex - ipfixBaseFlowId, GT_TRUE);
    UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, rc, "prvTgfIpfixFirstPacketsMirrorEnableSet: %d ipfixIndex %d",
    ...
    rc = prvTgfIpfixFirstPacketsMirrorEnableSet(prvTgfDevNum, testedStage, basicTestConf[1].ipfixIndex - ipfixBaseFlowId, GT_TRUE);
    UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, rc, "prvTgfIpfixFirstPacketsMirrorEnableSet: %d ipfixIndex %d",
    ...
    rc = prvTgfIpfixFirstPacketsMirrorEnableSet(prvTgfDevNum, testedStage, basicTestConf[2].ipfixIndex - ipfixBaseFlowId, GT_TRUE);
    UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, rc, "prvTgfIpfixFirstPacketsMirrorEnableSet: %d ipfixIndex %d",
...
)
{
    ...
    ipfixIndex = basicTestConf[0].ipfixIndex;
    rc = prvTgfIpfixEntryGet(prvTgfDevNum, testedStage,
                             ipfixIndex - ipfixBaseFlowId, GT_FALSE, &ipfixEntry);
    UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, rc, "prvTgfIpfixEntryGet: %d, %d, %d",
                                 prvTgfDevNum, testedStage, ipfixIndex);
    ...
    /* check IPFIX counters again with reset flag enabled */
    rc = prvTgfIpfixEntryGet(prvTgfDevNum, testedStage,
                             ipfixIndex - ipfixBaseFlowId, GT_TRUE, &ipfixEntry);
    UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, rc, "prvTgfIpfixEntryGet: %d, %d, %d",
                                 prvTgfDevNum, testedStage, ipfixIndex);
...
)
{
    ...
    rc = prvTgfIpfixBaseFlowIdSet(prvTgfDevNum, testedStage, ipfixBaseFlowIdRestore);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfIpfixBaseFlowIdSet");

...
/* memories for HARRIER error injection */
static MEMORY_DESC_STC memoriesArrHarrierErrInjection[] =
{
    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IA_OS_MEM_E,                                    /* IA_OS - SINGLE_ECC - HW_INDEX */
        1, 6),
...
/* memories for Ironman error injection */
static MEMORY_DESC_STC memoriesArrIronmanErrInjection[] =
{
    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_BMA_MC_CLEAR_SHIFTER_E,                         /* BMA_MC_CLEAR_SHIFTER - SINGLE_ECC - HW_INDEX */
        1, 1),
    ...
    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDSL_LL_NEXT_DESC_E,                            /* PDSL_LL_NEXT_DESC - SINGLE_ECC - HW_INDEX */
        1, 1),

    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDSL_LL_NEXT_DESC_E,                            /* PDSL_LL_NEXT_DESC - SINGLE_ECC - LOGICAL_INDEX */
        1, 1),

    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDSL_LL_NEXT_DESC_E,                            /* PDSL_LL_NEXT_DESC - SINGLE_ECC - RAM_INDEX */
        1, 1),
    ...
    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_SEL_LIST_E,                                 /* SDQ_SEL_LIST - SINGLE_ECC - HW_INDEX */
        1, 1),

    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_SEL_LIST_E,                                 /* SDQ_SEL_LIST - SINGLE_ECC - LOGICAL_INDEX */
        1, 1),

    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_SEL_LIST_E,                                 /* SDQ_SEL_LIST - SINGLE_ECC - RAM_INDEX */
        1, 1),

    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_CREDIT_BALANCE_E,                           /* SDQ_CREDIT_BALANCE - SINGLE_ECC - HW_INDEX */
        1, 1),

    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_CREDIT_BALANCE_E,                           /* SDQ_CREDIT_BALANCE - SINGLE_ECC - LOGICAL_INDEX */
        1, 1),

    MEMORY_ENTRY_PASSED_MAC(
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_CREDIT_BALANCE_E,                           /* SDQ_CREDIT_BALANCE - SINGLE_ECC - RAM_INDEX */
        1, 1),
};
...
/* memories for harrier */
static MEMORY_DESC_STC memoriesArrHarrier[] =
{
    MEMORY_ENTRY_PASSED_MAC(
            CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXF_WORD_BUFFER_MEM_E,   /* TXF_WORD - PARITY     - HW_INDEX         */
            1, 1),
...
/* memories for harrier */
static MEMORY_DESC_STC memoriesArrIronman[] =
{
    MEMORY_ENTRY_PASSED_MAC(
            CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TX_CELL_BUFFER_MEM_E,   /* TX_CELL - PARITY     - HW_INDEX         */
            1, 1),

    MEMORY_ENTRY_PASSED_MAC(
            CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TX_CELL_BUFFER_MEM_E,   /* TX_CELL - PARITY     - LOGICAL_INDEX    */
            1, 1),

    MEMORY_ENTRY_PASSED_MAC(
            CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TX_CELL_BUFFER_MEM_E,   /* TX_CELL - PARITY     - RAM_INDEX        */
            1, 1),
...
)
{
    ...
    else if (PRV_CPSS_DXCH_HARRIER_CHECK_MAC(prvTgfDevNum))
    {
        memArr = memoriesArrHarrierErrInjection;
        memArrLen = sizeof(memoriesArrHarrierErrInjection)/sizeof(memoriesArrHarrierErrInjection[0]);
    }
    else if (PRV_CPSS_DXCH_IRONMAN_CHECK_MAC(prvTgfDevNum))
    {
        memArr = memoriesArrIronmanErrInjection;
        memArrLen = sizeof(memoriesArrIronmanErrInjection)/sizeof(memoriesArrIronmanErrInjection[0]);
    }
    else
    {
        memArr = memoriesArr;
...
)
{
    ...
    {
        memArrayPtr = memoriesArrHarrier;
        memArrLen = sizeof(memoriesArrHarrier) / sizeof(memoriesArrHarrier[0]);
    }
    else if (PRV_CPSS_DXCH_IRONMAN_CHECK_MAC(prvTgfDevNum))
    {
        memArrayPtr = memoriesArrIronman;
        memArrLen = sizeof(memoriesArrHarrier) / sizeof(memoriesArrHarrier[0]);
    }
    else
    {

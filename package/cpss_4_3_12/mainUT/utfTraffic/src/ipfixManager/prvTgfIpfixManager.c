...
#define PRV_TGF_JUMBO_PKT_PAYLOAD_SIZE   1970
...
/**
 * @internal prvTgfIpfixManagerVlanConfigSet function
 * @endinternal
 *
...
GT_VOID prvTgfIpfixManager4KFlowsTrafficGenerate
(
    GT_VOID
)
{
     ...
     * 2. Generating Traffic
     */
    for (i=0; i<PRV_TGF_FULL_CAPACITY_FLOWS_NUM_CNS; i++)
    {

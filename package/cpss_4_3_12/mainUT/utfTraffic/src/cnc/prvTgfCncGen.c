...
/* CNC Shared Client Indexes */
#define PRV_TGF_CNC_SHARED_CLIENT_INDEX_0        0
#define PRV_TGF_CNC_SHARED_CLIENT_INDEX_1        1
#define PRV_TGF_CNC_SHARED_CLIENT_INDEX_2        2

/* CNC Shared Client Offsets */
#define PRV_TGF_CNC_SHARED_CLIENT_INDEX_0_OFFSET 0
#define PRV_TGF_CNC_SHARED_CLIENT_INDEX_1_OFFSET 128
#define PRV_TGF_CNC_SHARED_CLIENT_INDEX_2_OFFSET 256
...
/* saved CNC Shared Clients Configuration */
static PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC cncSharedClientsCfgGet1;
static PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC cncSharedClientsCfgGet2;
static PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC cncSharedClientsCfgGet3;

/* saved PCL rule index */
static GT_U32 pclRuleIndexGet;
/* saved cnc counter */
static PRV_TGF_CNC_COUNTER_STC counterGet;
/* saved cnc counter format */
static PRV_TGF_CNC_COUNTER_FORMAT_ENT counterFormatGet;
/* saved enable state */
static GT_BOOL enableGet;
...
/******************************* Ethernet packet **********************************/
/* Data of packet (long version) */
static GT_U8 prvTgfPacketPayloadArr[] =
{
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
    0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
...
/* Payload part (long version) */
static TGF_PACKET_PAYLOAD_STC prvTgfPacketPayloadDataPart =
{
    sizeof(prvTgfPacketPayloadArr), /* dataLength */
    prvTgfPacketPayloadArr          /* dataPtr */
};

/* ethertype part of packet */
static TGF_PACKET_ETHERTYPE_STC prvTgfPacketEthEtherTypePart =
{0x8100};
...
static TGF_PACKET_PART_STC prvTgfEthPacketPartArray[] =
{
    ...
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketPayloadDataPart}
};
...
)
{
    ...
    rc = prvTgfTtiRuleSet(
        PRV_TGF_CNC_GEN_TTI_RULE_INDEX_CNS, PRV_TGF_TTI_RULE_ETH_E,
...
/**
* @internal prvTgfCncSharingTrafficGenerateAndCheck function
* @endinternal
*
* @brief   Generate traffic:
*         Send to device's port given packet:
*         Check counters.
*/
GT_VOID prvTgfCncSharingTrafficGenerateAndCheck
(
    GT_VOID
)
{
    ...
    PRV_TGF_PCL_ACTION_STC                      action;
    CPSS_PCL_LOOKUP_NUMBER_ENT                  lookup;
    PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC cncSharedClientsCfg;
    PRV_TGF_CNC_COUNTER_STC                     counter;

    rc = prvTgfCncTestVidDefConfigurationSet();
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncTestVidDefConfigurationSet");

    lookup = CPSS_PCL_LOOKUP_NUMBER_0_E;
    pclRuleIndexGet = prvTgfIpclTcamAbsoluteIndexWithinTheLookupGet(0, PRV_TGF_CNC_GEN_PCL_RULE_INDEX_CNS);
    ...
    rc = prvTgfPclRuleSet(
        PRV_TGF_PCL_RULE_FORMAT_INGRESS_STD_NOT_IP_E,
        pclRuleIndexGet, &mask, &pattern, &action);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfPclRuleSet");

    rc = prvTgfCncCounterFormatGet(PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), &counterFormatGet);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "cpssDxChCncCounterFormatGet");
    rc = prvTgfCncCounterFormatSet(PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "cpssDxChCncCounterFormatSet");

    /* AUTODOC: enable clear by read mode of CNC counters read operation */
    rc = prvTgfCncCounterClearByReadEnableGet(&enableGet);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncCounterClearByReadEnableGet");
    ...
    /* AUTODOC: for FORMAT_MODE_0 set counter clear value 0 */
    rc = prvTgfCncCounterClearByReadValueGet(PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E, &counterGet);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncCounterClearByReadValueGet");
    rc = prvTgfCncCounterClearByReadValueSet(PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E, &counter);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncCounterClearByReadValueSet");

    /* CNC Shared Clients Configuration */
    rc = prvTgfCncBlockSharedClientConfigGet(prvTgfDevNum, PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_SHARED_CLIENT_INDEX_0, &cncSharedClientsCfgGet1);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncBlockSharedClientConfigGet");
    rc = prvTgfCncBlockSharedClientConfigGet(prvTgfDevNum, PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_SHARED_CLIENT_INDEX_1, &cncSharedClientsCfgGet2);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncBlockSharedClientConfigGet");
    rc = prvTgfCncBlockSharedClientConfigGet(prvTgfDevNum, PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_SHARED_CLIENT_INDEX_2, &cncSharedClientsCfgGet3);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncBlockSharedClientConfigGet");

    cpssOsMemSet(&cncSharedClientsCfg, 0, sizeof(cncSharedClientsCfg));

    cncSharedClientsCfg.clientEnable        = GT_TRUE;
    cncSharedClientsCfg.clientSelect        = PRV_TGF_CNC_CLIENT_EGRESS_PACKET_TYPE_PASS_DROP_E;
    cncSharedClientsCfg.clientOffset        = PRV_TGF_CNC_SHARED_CLIENT_INDEX_0_OFFSET;
    cncSharedClientsCfg.indexRangesBmp.l[0] = 1; /* range of indexes 0 - 1023 */

    rc = prvTgfCncBlockSharedClientConfigSet(prvTgfDevNum, PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_SHARED_CLIENT_INDEX_0, &cncSharedClientsCfg);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncBlockSharedClientConfigSet");

    cncSharedClientsCfg.clientEnable        = GT_TRUE;
    cncSharedClientsCfg.clientSelect        = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_0_E;
    cncSharedClientsCfg.clientOffset        = PRV_TGF_CNC_SHARED_CLIENT_INDEX_1_OFFSET;
    cncSharedClientsCfg.indexRangesBmp.l[0] = 1;/* range of indexes 0 - 1023 */

    rc = prvTgfCncBlockSharedClientConfigSet(prvTgfDevNum, PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_SHARED_CLIENT_INDEX_1, &cncSharedClientsCfg);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncBlockSharedClientConfigSet");

    cncSharedClientsCfg.clientEnable        = GT_TRUE;
    cncSharedClientsCfg.clientSelect        = PRV_TGF_CNC_CLIENT_EGRESS_VLAN_PASS_DROP_E;
    cncSharedClientsCfg.clientOffset        = PRV_TGF_CNC_SHARED_CLIENT_INDEX_2_OFFSET;
    cncSharedClientsCfg.indexRangesBmp.l[0] = 1;/* range of indexes 0 - 1023 */

    rc = prvTgfCncBlockSharedClientConfigSet(prvTgfDevNum, PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_SHARED_CLIENT_INDEX_2, &cncSharedClientsCfg);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncBlockSharedClientConfigSet");


    /* clear counters by read to avoid trash from previous tests. */
    rc = prvTgfCncCounterGet(PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(),
            PRV_TGF_CNC_SHARED_CLIENT_INDEX_0_OFFSET,
            PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E,
            &(cncCheck.counterValue));
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncCounterGet\n");
    rc = prvTgfCncCounterGet(PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(),
            PRV_TGF_CNC_SHARED_CLIENT_INDEX_1_OFFSET,
            PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E,
            &(cncCheck.counterValue));
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncCounterGet\n");
    rc = prvTgfCncCounterGet(PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(),
            PRV_TGF_CNC_SHARED_CLIENT_INDEX_2_OFFSET + 0xA,
            PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E,
            &(cncCheck.counterValue));
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncCounterGet\n");
    ...
    cpssOsMemSet(&cncCheck, 0, sizeof(cncCheck));
    /* common parameters */
    cncCheck.blockNum      = PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC();
    cncCheck.counterNum    = PRV_TGF_CNC_SHARED_CLIENT_INDEX_0_OFFSET;
    cncCheck.counterFormat = PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E;
    /* prvTgfCncCounterGet */
    cncCheck.compareCounterValue = GT_TRUE;

    cncCheck.counterValue.packetCount.l[0] =
        PRV_TGF_CNC_GEN_BURST_COUNT_CNS * 4;
    cncCheck.counterValue.byteCount.l[0] =
        (PRV_TGF_CNC_GEN_BURST_COUNT_CNS * (numOfBytesInBuff + 4 /*check sum*/)) * 4;
    ...
    /* common parameters */
    cncCheck.blockNum      = PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC();
    cncCheck.counterNum    = PRV_TGF_CNC_SHARED_CLIENT_INDEX_1_OFFSET;
    cncCheck.counterFormat = PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E;
    /* prvTgfCncCounterGet */
    cncCheck.compareCounterValue = GT_TRUE;
    ...
    /* common parameters */
    cncCheck.blockNum      = PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC();
    cncCheck.counterNum    = PRV_TGF_CNC_SHARED_CLIENT_INDEX_2_OFFSET + 0xA;
    cncCheck.counterFormat = PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E;
    /* prvTgfCncCounterGet */
    cncCheck.compareCounterValue = GT_TRUE;

    cncCheck.counterValue.packetCount.l[0] =
        PRV_TGF_CNC_GEN_BURST_COUNT_CNS * 3;
    cncCheck.counterValue.byteCount.l[0] =
        (PRV_TGF_CNC_GEN_BURST_COUNT_CNS * (numOfBytesInBuff + 4 /*check sum*/)) * 3;
...
/**
* @internal prvTgfCncSharingTestRestore function
* @endinternal
*
* @brief Restore Configuration.
*/
GT_VOID prvTgfCncSharingTestRestore
(
    GT_VOID
)
{
    GT_STATUS rc = GT_OK;
     ...
     /* disable ingress policy on port 1 */
    rc = prvTgfPclPortIngressPolicyEnable(
        prvTgfPortsArray[PRV_TGF_CNC_GEN_SEND_PORT_INDEX_CNS], GT_FALSE);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfPclPortIngressPolicyEnable");

    /* invalidate PCL rules */
    rc = prvTgfPclRuleValidStatusSet(
            CPSS_PCL_RULE_SIZE_STD_E, pclRuleIndexGet, GT_FALSE);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfPclRuleValidStatusSet");

    prvTgfPclPortsRestore(CPSS_PCL_DIRECTION_INGRESS_E, CPSS_PCL_LOOKUP_NUMBER_0_E);

    rc = prvTgfCncGenVidAndFdbDefCfgRestore();
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncGenVidAndFdbDefCfgRestore");
    ...
    rc = prvTgfCncCounterFormatSet(PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), counterFormatGet);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "cpssDxChCncCounterFormatSet");

    /* AUTODOC: enable clear by read mode of CNC counters read operation */
    rc = prvTgfCncCounterClearByReadEnableSet(enableGet);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncCounterClearByReadEnableSet");

    /* AUTODOC: for FORMAT_MODE_0 set counter clear value 0 */
    rc = prvTgfCncCounterClearByReadValueSet(PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E, &counterGet);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncCounterClearByReadValueSet");

    /* CNC Shared Clients Configuration */
    rc = prvTgfCncBlockSharedClientConfigSet(prvTgfDevNum, PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_SHARED_CLIENT_INDEX_0, &cncSharedClientsCfgGet1);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncBlockSharedClientConfigGet");
    rc = prvTgfCncBlockSharedClientConfigSet(prvTgfDevNum, PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_SHARED_CLIENT_INDEX_1, &cncSharedClientsCfgGet2);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncBlockSharedClientConfigGet");
    rc = prvTgfCncBlockSharedClientConfigSet(prvTgfDevNum, PRV_TGF_CNC_TESTED_BLOCK_NUM_MAC(), PRV_TGF_CNC_SHARED_CLIENT_INDEX_2, &cncSharedClientsCfgGet3);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncBlockSharedClientConfigGet");
}

/**
* @internal prvTgfCncIngPacketTypeClientConfigTest function
* @endinternal
*
* @brief CNC ingress packet type client for FROM_CPU packetType test
*        configurations, traffic transmission and CNC counter result validation.
*/
GT_VOID prvTgfCncIngPacketTypeClientConfigTest
(
    GT_VOID
)
{
    GT_STATUS                              rc;
    PRV_TGF_CNC_COUNTER_STC                counter, counterCheck;
    GT_U32                                 blockSize;
    GT_U32                                 index = 0;
    GT_U32                                 numOfBytesInBuff;
    ...
    /* AUTODOC: Test CNC with Packet type PASS client */
    /* AUTODOC: calculate index  for FROM_CPU pktType and for PASS traffic */
    index |= (1 << 11);
    index |=  63 /* CPU port */;
    ...
    rc = prvTgfCncTestCncBlockConfigure(
        ...
        PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfCncTestCncBlockConfigure");
    ...
    /* AUTODOC: for PACKET_TYPE_PASS_DROP CNC client set BYTE_COUNT_MODE_L2 mode */
    ...
    /* Check results */
    rc = prvTgfPacketSizeGet(
        prvTgfEthPacketInfo.partsArray,
        prvTgfEthPacketInfo.numOfParts,
        &numOfBytesInBuff);
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfPacketSizeGet");

    numOfBytesInBuff += PRV_CPSS_SIP_6_30_CHECK_MAC(prvTgfDevNum)? 16 /* DSA tag */ : 20 /* 16B DSA tag + 4B CRC */;

    /* AUTODOC: Get cnc counters */
    rc = prvTgfCncCounterGet(0/*blockNum*/, (index % blockSize),
        PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E, &counterCheck);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfCncCounterGet");

    PRV_UTF_LOG4_MAC("CncBlock[%d] Index[%d]: packets[%d] bytes[%d]\n",
                    0 /*blockNum*/, index, counterCheck.packetCount.l[0], counterCheck.byteCount.l[0]);

    UTF_VERIFY_EQUAL2_STRING_MAC(1, counterCheck.packetCount.l[0],
        "packet counter blockNum: %d counterIdx %d", 0 /*blockNum*/, index);

    UTF_VERIFY_EQUAL2_STRING_MAC((1 /*burst count */ * numOfBytesInBuff), counterCheck.byteCount.l[0],
        "packet counter blockNum: %d counterIdx %d", 0 /*blockNum*/, index);
};

/**
* @internal prvTgfCncIngPacketTypeClientRestoreTest function
* @endinternal
*
* @brief Restore configuration for ingress packet type client test
*/
GT_VOID prvTgfCncIngPacketTypeClientRestoreTest
(
    GT_VOID
)
{
    ...
    /* AUTODOC: Block size and index  */
    blockSize = prvTgfCncFineTuningBlockSizeGet();
    index |= (1 << 11);
    index |=  63 /* CPU port */;

    /* Restore VLAN and FDB Config */
    prvTgfCncGenVidAndFdbDefCfgRestore();

    /* Restore CNC config */
    cncCfg.clientType    = PRV_TGF_CNC_CLIENT_PACKET_TYPE_PASS_DROP_E;
    cncCfg.blockNum      = 0;
    cncCfg.counterNum    = (index % blockSize);
    cncCfg.counterFormat = PRV_TGF_CNC_COUNTER_FORMAT_MODE_0_E;
    cncCfg.configureCountingUnitEnable = GT_TRUE;
    cncCfg.countingUnitEnable          = GT_FALSE;

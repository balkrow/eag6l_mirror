...
)
{
    ...
    prvTgfVlanId = 2 + cpssOsRand() % (((UTF_CPSS_PP_MAX_VLAN_INDEX_CNS(prvTgfDevNum) > _4K) ? _4K : UTF_CPSS_PP_MAX_VLAN_INDEX_CNS(prvTgfDevNum))-2);
    ...
    while ((prvTgfVidxNew == prvTgfVidx) || (prvTgfVidxNew <= FWDTOLB_TX_PORT_CNS));
}

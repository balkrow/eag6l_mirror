...
#define PRV_TGF_E_VLANID_4_CNS        ((ALIGN_EVID_TO_4K_TILL_MAX_DEV_MAC(8191)) > _4K) ? \
                                      ((GT_U16)(ALIGN_EVID_TO_4K_TILL_MAX_DEV_MAC(8191))) :         \
...
#define PRV_TGF_SEND_EPORT_VALUES_MAC(arr) \
    SET_ARR_3_MAC(arr ,                               \
                ALIGN_EPORT_TO_512_TILL_MAX_DEV_MAC(600)     % PRV_CPSS_DXCH_MAX_DEFAULT_EPORT_NUMBER_MAC(prvTgfDevNum%PRV_CPSS_MAX_PP_DEVICES_CNS),    \
                ALIGN_EPORT_TO_512_TILL_MAX_DEV_MAC(5005)    % PRV_CPSS_DXCH_MAX_DEFAULT_EPORT_NUMBER_MAC(prvTgfDevNum%PRV_CPSS_MAX_PP_DEVICES_CNS),  \
                ALIGN_EPORT_TO_512_TILL_MAX_DEV_MAC(8191)    % PRV_CPSS_DXCH_MAX_DEFAULT_EPORT_NUMBER_MAC(prvTgfDevNum%PRV_CPSS_MAX_PP_DEVICES_CNS))
...
)
{
    ...
    rc = prvTgfTtiRuleSet(PRV_TGF_TTI_RULE_INDEX_CNS, PRV_TGF_TTI_RULE_ETH_E,
...
)
{
    ...
    rc = prvTgfBrgVlanPortTranslationEnableSet(prvTgfDevNum,
                                 prvTgfPortsArray[PRV_TGF_RECEIVE_PORT_IDX_CNS],
                                 CPSS_DIRECTION_EGRESS_E, PRV_TGF_BRG_VLAN_TRANSLATION_VID0_E);
    UTF_VERIFY_EQUAL0_STRING_MAC( GT_OK, rc,

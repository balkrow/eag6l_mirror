...
/* packet's IPv6 */
static TGF_PACKET_IPV6_STC prvTgfPacketIpv6WithHop2HopIpPart =
{
    6,                                  /* version */
    0,                                  /* trafficClass */
    1,                                  /* flowLabel */
    (8 + 8  + sizeof(prvTgfPacketPayloadDataArr)),    /* payloadLen */
    0,                                  /* Hop to hop */
    0x40,                               /* hopLimit */
    {10, 11, 12, 12, 14, 15, 16, 17},   /* srcAddr */
    {11, 21, 31, 41, 51, 61, 71, 81}    /* dstAddr */
...
/* Hop to Hop, the next is Encap Sequre Payload (protocol id - 50)*/
static GT_U8 prvTgfPacketHop2HopData[] =
{50, 0 ,0 ,0, 0 ,0 ,0 ,0};

/* payload */
static TGF_PACKET_PAYLOAD_STC  prvTgfPacketHop2HopPart =
{
    sizeof(prvTgfPacketHop2HopData),                       /* dataLength */
    prvTgfPacketHop2HopData                                /* dataPtr */
};

/* Encap Sequre Payload, the next is Unknown (protocol id - 41)    */
/* this format is wrong and copies generic extension format        */
/* the real format is comlicated, has variable size and not parsed */
/* by our devices because it presedes the sequre coded data        */
static GT_U8 prvTgfPacketEspData[] =
{41, 0 ,0 ,0, 0 ,0 ,0 ,0};

/* payload */
static TGF_PACKET_PAYLOAD_STC  prvTgfPacketEspPart =
{
    sizeof(prvTgfPacketEspData),                       /* dataLength */
    prvTgfPacketEspData                                /* dataPtr */
};


/* PARTS of packet2 IPv6 */
static TGF_PACKET_PART_STC prvTgfIpv6WithH2hEspPartArray[] =
{
    {TGF_PACKET_PART_L2_E,        &prvTgfKey11Packet1L2Part},
    {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacketIpv6EtherTypePart},
    {TGF_PACKET_PART_IPV6_E,      &prvTgfPacketIpv6WithHop2HopIpPart},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketHop2HopPart},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketEspPart},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketPayloadPart}
};

/* IPv6 packet1 to send */
static TGF_PACKET_STC prvTgfIpv6WithH2hEspPacketInfo =
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,                 /* totalLen */
    (sizeof(prvTgfIpv6WithH2hEspPartArray)
        / sizeof(prvTgfIpv6WithH2hEspPartArray[0])), /* numOfParts */
    prvTgfIpv6WithH2hEspPartArray                    /* partsArray */
};

/* packet's IPv6 */
static TGF_PACKET_IPV6_STC prvTgfPacketIpv6NoExtIpPart =
{
    6,                                  /* version */
    0,                                  /* trafficClass */
    1,                                  /* flowLabel */
...
/* PARTS of packet2 IPv6 */
static TGF_PACKET_PART_STC prvTgfIpv6NoExtPartArray[] =
{
    {TGF_PACKET_PART_L2_E,        &prvTgfKey11Packet1L2Part},
    {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacketIpv6EtherTypePart},
    {TGF_PACKET_PART_IPV6_E,      &prvTgfPacketIpv6NoExtIpPart},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketPayloadPart}
};

/* IPv6 packet1 to send */
static TGF_PACKET_STC prvTgfIpv6NoExtPacketInfo =
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,                       /* totalLen */
    (sizeof(prvTgfIpv6NoExtPartArray)
        / sizeof(prvTgfIpv6NoExtPartArray[0])), /* numOfParts */
    prvTgfIpv6NoExtPartArray                    /* partsArray */
};

/* PARTS of packet UDP */

/* packet's IPv6 */
static TGF_PACKET_IPV6_STC prvTgfPacketIpv6UdpIpPart =
{
    6,                                  /* version */
    0,                                  /* trafficClass */
    1,                                  /* flowLabel */
    (8 + sizeof(prvTgfPacketPayloadDataArr)),    /* payloadLen */
    17,                                  /* UDP */
    0x40,                               /* hopLimit */
    {16, 17, 18, 19, 20, 21, 22, 23},   /* srcAddr */
    {48, 49, 50, 51, 52, 53, 54, 55}    /* dstAddr */
};

/* packet's UDP part */
static TGF_PACKET_UDP_STC prvTgfPacketUdpPart_ipv6 =
{
    9,                                        /* src port */
    11,                                       /* dst port */
    (8 + sizeof(prvTgfPacketPayloadDataArr)), /* length */
    TGF_PACKET_AUTO_CALC_CHECKSUM_CNS         /* csum */
};

static TGF_PACKET_PART_STC prvTgIpv6fUdpPacketPartArray[] =
{
    {TGF_PACKET_PART_L2_E,        &prvTgfPacketL2Part},
    {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacketIpv6EtherTypePart},
    {TGF_PACKET_PART_IPV6_E,      &prvTgfPacketIpv6UdpIpPart},
    {TGF_PACKET_PART_UDP_E,       &prvTgfPacketUdpPart_ipv6},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketPayloadPart}
};
/* UDP packet to send */
...
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,              /* totalLen */
    (sizeof(prvTgIpv6fUdpPacketPartArray) /
        sizeof(prvTgIpv6fUdpPacketPartArray[0])), /* numOfParts */
    prvTgIpv6fUdpPacketPartArray                  /* partsArray */
};

/* packet's IPv6 */
static TGF_PACKET_IPV6_STC prvTgfPacketIpv6WithEspIpPart =
{
    6,                                  /* version */
    0,                                  /* trafficClass */
    1,                                  /* flowLabel */
...
/* PARTS of packet2 IPv6 */
static TGF_PACKET_PART_STC prvTgfIpv6EspPartArray[] =
{
    {TGF_PACKET_PART_L2_E,        &prvTgfKey11Packet1L2Part},
    {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacketIpv6EtherTypePart},
    {TGF_PACKET_PART_IPV6_E,      &prvTgfPacketIpv6WithEspIpPart},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketEspPart},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketPayloadPart}
};

/* IPv6 packet1 to send */
static TGF_PACKET_STC prvTgfIpv6WithEspPacketInfo =
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,                 /* totalLen */
    (sizeof(prvTgfIpv6EspPartArray)
        / sizeof(prvTgfIpv6EspPartArray[0])), /* numOfParts */
    prvTgfIpv6EspPartArray                    /* partsArray */
};
...
)
{
    ...
    rc = prvTgfTtiRule2Set(
        PRV_PCL_KEY11_TTI_RULE_INDEX_CNS,
        PRV_TGF_TTI_KEY_UDB_IPV6_E, /* any not legacy keytype converted to UDB30 */
...
/**
* @internal prvTgfPclTcpUdpPortEgressMetadataTrafficGen function
* @endinternal
*
* @brief   Generate traffic and counter check for Egress PCL
*/
GT_VOID prvTgfPclTcpUdpPortEgressMetadataTrafficGen
(
     IN  TGF_PACKET_STC    *packetInfoPtr,
     IN  GT_U32            expectedPacketsNum
)
{
    GT_STATUS                           rc;
    CPSS_PORT_MAC_COUNTER_SET_STC       portCntrs;
    ...
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfResetCountersEth");
    rc = prvTgfResetCountersEth(prvTgfDevNum, prvTgfPortsArray[PRV_TGF_RECEIVE_PORT_IDX_CNS]);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfResetCountersEth");
    ...
    rc = prvTgfReadPortCountersEth(
        prvTgfDevNum, prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS], GT_TRUE, &portCntrs);
    UTF_VERIFY_EQUAL2_STRING_MAC(
        GT_OK, rc, "prvTgfReadPortCountersEth: %d, %d",
        prvTgfDevNum, prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS]);
    UTF_VERIFY_EQUAL1_STRING_MAC
        (1, portCntrs.goodPktsSent.l[0],
        "get another goodPktsSent counter than expected on port %d",
        prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS]);

    rc = prvTgfReadPortCountersEth(
        prvTgfDevNum, prvTgfPortsArray[PRV_TGF_RECEIVE_PORT_IDX_CNS], GT_TRUE, &portCntrs);
    UTF_VERIFY_EQUAL2_STRING_MAC(
        GT_OK, rc, "prvTgfReadPortCountersEth: %d, %d",
        prvTgfDevNum, prvTgfPortsArray[PRV_TGF_RECEIVE_PORT_IDX_CNS]);
    UTF_VERIFY_EQUAL1_STRING_MAC
        (expectedPacketsNum, portCntrs.goodPktsSent.l[0],
        "get another goodPktsSent counter than expected on port %d",
        prvTgfPortsArray[PRV_TGF_RECEIVE_PORT_IDX_CNS]);
}

/**
* @internal prvTgfPclTcpUdpPortMetadataTestEgressConfigurationSet function
* @endinternal
*
* @brief   Test Configurations for EPCL L4 port comparators.
*/
GT_VOID prvTgfPclTcpUdpPortMetadataTestEgressConfigurationSet
(
     void
)
{
    ...
    GT_U32                              ii;
    PRV_TGF_PCL_UDB_SELECT_STC          udbSelect;
    GT_U32                              udbAnchorIndexArr[] = {
        0,0,0,0,0,0,
        32,33,34,35, /* IPV4 SIP */
        36,37,38,39, /* IPV4 DIP */
        107,108,109,110,111,112,113 /* l4 port comparators 8-63 */};
    GT_U16                              saveSrcPort;
    GT_U16                              saveDstPort;
    ...
    rc = prvTgfPclDefPortInit(
            ...
            CPSS_PCL_LOOKUP_0_E,
            PRV_TGF_PCL_RULE_FORMAT_EGRESS_UDB_60_NO_FIXED_FIELDS_E /*nonIpKey*/,
            PRV_TGF_PCL_RULE_FORMAT_EGRESS_UDB_60_NO_FIXED_FIELDS_E /*ipv4Key*/,
            PRV_TGF_PCL_RULE_FORMAT_EGRESS_UDB_60_NO_FIXED_FIELDS_E /*ipv6Key*/);
    UTF_VERIFY_EQUAL3_STRING_MAC(
            GT_OK, rc, "prvTgfPclDefPortInit: %d, %d, %d",
            prvTgfDevNum,
            prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],
    ...
    for (ii = 0; ii < 63; ii ++)
    {
        rc = prvTgfPclTcpUdpPortComparatorSet(
            CPSS_PCL_DIRECTION_EGRESS_E, CPSS_L4_PROTOCOL_TCP_E, ii,
            CPSS_L4_PROTOCOL_PORT_SRC_E, CPSS_COMPARE_OPERATOR_INVALID_E, 0);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfPclTcpUdpPortComparatorGet: %d", ii);
    }
    ...
    for (ii = 8; ii < 16; ii += 2)
    {
        rc = prvTgfPclTcpUdpPortComparatorSet(
            CPSS_PCL_DIRECTION_EGRESS_E, CPSS_L4_PROTOCOL_TCP_E, ii,
            CPSS_L4_PROTOCOL_PORT_SRC_E, CPSS_COMPARE_OPERATOR_LTE, 0x25);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfPclTcpUdpPortComparatorGet: %d", ii);
    }
    ...
    for (ii = 57; ii < 64; ii +=2)
    {
        rc = prvTgfPclTcpUdpPortComparatorSet(
            CPSS_PCL_DIRECTION_EGRESS_E, CPSS_L4_PROTOCOL_TCP_E, ii,
            CPSS_L4_PROTOCOL_PORT_DST_E, CPSS_COMPARE_OPERATOR_NEQ, 0x32);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfPclTcpUdpPortComparatorGet: %d", ii);
    }
    ...
    rc = prvTgfPclUserDefinedBytesSelectSet(
        ...
        &udbSelect);
    UTF_VERIFY_EQUAL2_STRING_MAC(
        GT_OK, rc, "prvTgfPclUserDefinedBytesSelectSet: %d, %d",
        PRV_TGF_PCL_PACKET_TYPE_IPV4_TCP_E, CPSS_PCL_LOOKUP_0_E);
    ...
    for (ii = 0; ii <= 5; ii++)
    {
        mask.ruleEgrUdbOnly.udb[ii] = 0;
        pattern.ruleEgrUdbOnly.udb[ii] = 0;
    }
    for (ii = 6; ii <= 20; ii++)
    {
        mask.ruleIngrUdbOnly.udb[ii] = 0xFF;
    ...
    pattern.ruleEgrUdbOnly.udb[6]  = prvTgfPacketTcpIpPart.srcAddr[3];
    pattern.ruleEgrUdbOnly.udb[7]  = prvTgfPacketTcpIpPart.srcAddr[2];
    pattern.ruleEgrUdbOnly.udb[8]  = prvTgfPacketTcpIpPart.srcAddr[1];
    pattern.ruleEgrUdbOnly.udb[9]  = prvTgfPacketTcpIpPart.srcAddr[0];

    pattern.ruleEgrUdbOnly.udb[10] = prvTgfPacketTcpIpPart.dstAddr[3];
    pattern.ruleEgrUdbOnly.udb[11] = prvTgfPacketTcpIpPart.dstAddr[2];
    pattern.ruleEgrUdbOnly.udb[12] = prvTgfPacketTcpIpPart.dstAddr[1];
    pattern.ruleEgrUdbOnly.udb[13] = prvTgfPacketTcpIpPart.dstAddr[0];

    /* TCP port comparator value */
    pattern.ruleEgrUdbOnly.udb[14] = 0x55;
    pattern.ruleEgrUdbOnly.udb[15] = 0;
    pattern.ruleEgrUdbOnly.udb[16] = 0;
    pattern.ruleEgrUdbOnly.udb[17] = 0;
    pattern.ruleEgrUdbOnly.udb[18] = 0;
    pattern.ruleEgrUdbOnly.udb[19] = 0;
    pattern.ruleEgrUdbOnly.udb[20] = 0xAA;

    rc = prvTgfPclRuleSet(
            PRV_TGF_PCL_RULE_FORMAT_EGRESS_UDB_60_NO_FIXED_FIELDS_E,
            EPCL_RULE_INDEX_CNS, &mask, &pattern, &action);
    UTF_VERIFY_EQUAL2_STRING_MAC(
        GT_OK, rc, "prvTgfPclRuleSet: %d, %d",
        PRV_TGF_PCL_RULE_FORMAT_EGRESS_UDB_60_NO_FIXED_FIELDS_E,
        EPCL_RULE_INDEX_CNS);

    saveSrcPort = prvTgfPacketTcpPart.srcPort;
    saveDstPort = prvTgfPacketTcpPart.dstPort;

    prvTgfPacketTcpPart.srcPort = 8;
    prvTgfPacketTcpPart.dstPort = 9;

    /* Send packet and check counters */
    /* Expect: Rule match, packet will be dropped */
    prvTgfPclTcpUdpPortEgressMetadataTrafficGen(&prvTgfTcpPacketInfo, 0);

    prvTgfPacketTcpPart.srcPort = 0x33;
    prvTgfPacketTcpPart.dstPort = 0x32;

    /* Send packet such that SrcPort < dstPort and check counters */
    /* Expect: Rule mismatch, packet will be forwarded */
    prvTgfPclTcpUdpPortEgressMetadataTrafficGen(&prvTgfTcpPacketInfo, 1);

    prvTgfPacketTcpPart.srcPort = saveSrcPort;
    prvTgfPacketTcpPart.dstPort = saveDstPort;
...
/**
* @internal prvTgfPclTcpUdpPortMetadataTestEgressConfigurationRestore function
* @endinternal
*
* @brief   Test restore configurations for EPCL L4 port comparators.
*/
GT_VOID prvTgfPclTcpUdpPortMetadataTestEgressConfigurationRestore
(
    void
)
{
    ...
    rc = prvTgfPclRuleValidStatusSet(
        ...
        EPCL_RULE_INDEX_CNS, GT_FALSE);
    UTF_VERIFY_EQUAL3_STRING_MAC(
        GT_OK, rc, "prvTgfPclRuleValidStatusSet: %d, %d, %d",
        CPSS_PCL_RULE_SIZE_60_BYTES_E,
        EPCL_RULE_INDEX_CNS, GT_FALSE);
    ...
    UTF_VERIFY_EQUAL1_STRING_MAC(
        GT_OK, rc, "prvTgfPclEgressPolicyEnable: %d", GT_FALSE);

    /* AUTODOC: flush FDB include static entries */
    rc = prvTgfBrgFdbFlush(GT_TRUE);
    UTF_VERIFY_EQUAL1_STRING_MAC(
        GT_OK, rc, "prvTgfBrgFdbFlush: %d", GT_TRUE);
...
/**
* @internal prvTgfPclIpv6ExtBmpMetadataTestConfigurationSet function
* @endinternal
*
* @brief   Test Configurations - IPV6 Header Extensions Bitmap in IPCL metedata
*/
GT_VOID prvTgfPclIpv6ExtBmpMetadataTestConfigurationSet
(
     void
)
{
    ...
    rc = prvTgfPclDefPortInit(
            ...
            CPSS_PCL_DIRECTION_INGRESS_E,
            CPSS_PCL_LOOKUP_0_E,
            PRV_TGF_PCL_RULE_FORMAT_INGRESS_UDB_60_NO_FIXED_FIELDS_E /*nonIpKey*/,
            PRV_TGF_PCL_RULE_FORMAT_INGRESS_UDB_60_NO_FIXED_FIELDS_E /*ipv4Key*/,
            PRV_TGF_PCL_RULE_FORMAT_INGRESS_UDB_60_NO_FIXED_FIELDS_E /*ipv6Key*/);
    UTF_VERIFY_EQUAL3_STRING_MAC(
            GT_OK, rc, "prvTgfPclDefPortInit: %d, %d, %d",
            prvTgfDevNum,
            prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],
    ...
    /* UDB mapping */
    for (ii = 0; (ii < PRV_TGF_PCL_UDB_MAX_NUMBER_CNS); ii++)
    {
    ...
    for (ii = 0; (ii < 12); ii++)
    {
        ...
        UTF_VERIFY_EQUAL2_STRING_MAC(
            ...
            PRV_TGF_PCL_RULE_FORMAT_INGRESS_UDB_60_NO_FIXED_FIELDS_E, CPSS_PCL_LOOKUP_0_E);
    }
    ...
    /*  IPv6 detected with the following EH                 */
    ...
    /*  Anchor offset : 165 bit offset 2:0                  */
    /*  Anchor offset : 164 bit offset 7:0                  */

    for (ii = 0; (ii < 6); ii++)
    {
        mask.ruleIngrUdbOnly.udb[ii]     = 0xFF;
        pattern.ruleIngrUdbOnly.udb[ii] = prvTgfKey11Packet1L2Part.daMac[ii];
    }
    for (ii = 0; (ii < 6); ii++)
    {
        mask.ruleIngrUdbOnly.udb[6 + ii]    = 0xFF;
        pattern.ruleIngrUdbOnly.udb[6 + ii] = prvTgfKey11Packet1L2Part.saMac[ii];
    }
    ...
    /* Configure Mask and pattern */
    /* The bitmap bits 9 and 10 not checked */
    /* Trere are configured valued with default value 50 as used in thei test */
    mask.ruleIngrUdbOnly.udb[udbBase]     = 0xFF;
    mask.ruleIngrUdbOnly.udb[udbBase + 1] = 0x01; /* instead of 0x07 */
    pattern.ruleIngrUdbOnly.udb[udbBase]     = 0x09;
    pattern.ruleIngrUdbOnly.udb[udbBase + 1] = 0x00;
    ...
    /* Send packet and check counters */
    /* Expect: Rule match, packet will be dropped */
    prvTgfPclTcpUdpPortEgressMetadataTrafficGen(
        &prvTgfIpv6WithH2hEspPacketInfo,
        0 /*expectedPacketsNum*/);

    /* Send packet and check counters */
    /* Expect: no Rule match, packet will be forwarded */
    prvTgfPclTcpUdpPortEgressMetadataTrafficGen(
        &prvTgfIpv6NoExtPacketInfo,
        1 /*expectedPacketsNum*/);
}

/**
* @internal prvTgfPclIpv6ExtBmpMetadataTestConfigurationRestore function
* @endinternal
*
* @brief   Test restore configurations
*/
GT_VOID prvTgfPclIpv6ExtBmpMetadataTestConfigurationRestore
(
    void
)
{
...
/**
* @internal prvTgfPclIpv6MinMaxL4PortMetadataTestConfigurationSet function
* @endinternal
*
* @brief   Test Configurations - IPV6 Min and Max L4 Port data in IPCL metedata
*/
GT_VOID prvTgfPclIpv6MinMaxL4PortMetadataTestConfigurationSet
(
     void
)
{
    ...
    for (ii = 0; (ii < 12); ii++)
    {
        ...
        UTF_VERIFY_EQUAL2_STRING_MAC(
            GT_OK, rc, "prvTgfPclUserDefinedByteSet: %d, %d",
            PRV_TGF_PCL_RULE_FORMAT_INGRESS_UDB_80_E, CPSS_PCL_LOOKUP_0_E);
    }

    /* 121 - 138 Min L4 port, 139 - 156 - Max L4 port */
    for (ii = 0; (ii <= (156 - 121)); ii++)
    {
        rc = prvTgfPclUserDefinedByteSet(
            PRV_TGF_PCL_RULE_FORMAT_INGRESS_UDB_80_E,
            PRV_TGF_PCL_PACKET_TYPE_IPV6_UDP_E,
    ...
    rc = prvTgfPclUserDefinedBytesSelectSet(
        PRV_TGF_PCL_RULE_FORMAT_INGRESS_UDB_80_E,
        PRV_TGF_PCL_PACKET_TYPE_IPV6_UDP_E, CPSS_PCL_LOOKUP_0_E,
        &udbSelect);
    UTF_VERIFY_EQUAL2_STRING_MAC(
        GT_OK, rc, "prvTgfPclUserDefinedBytesSelectSet: %d, %d",
        PRV_TGF_PCL_RULE_FORMAT_INGRESS_UDB_80_E, CPSS_PCL_LOOKUP_0_E);
    ...
    {
        mask.ruleIngrUdbOnly.udb[ii]    = 0xFF;
        pattern.ruleIngrUdbOnly.udb[ii] = prvTgfPacketL2Part.daMac[ii];
    }
    for (ii = 0; (ii < 6); ii++)
    {
        mask.ruleIngrUdbOnly.udb[6 + ii]    = 0xFF;
        pattern.ruleIngrUdbOnly.udb[6 + ii] = prvTgfPacketL2Part.saMac[ii];
    }
    ...
    /* Configure Mask and pattern */
    if (prvTgfPacketUdpPart_ipv6.dstPort > prvTgfPacketUdpPart_ipv6.srcPort)
    {
        srcUdbBase = udbBase;      /*Min*/
        dstUdbBase = udbBase + 18; /*Max*/
    }
    else
    {
        srcUdbBase = udbBase + 18; /*Max*/
        dstUdbBase = udbBase;      /*Min*/
    }

    /* 121 - 138 Min L4 port, 139 - 156 - Max L4 port */
    for (ii = 0; (ii <= (156 - 121)); ii++)
    {
        mask.ruleIngrUdbOnly.udb[udbBase + ii]     = 0xFF;
    }

    for (ii = 0; (ii < 8); ii++)
    {
        pattern.ruleIngrUdbOnly.udb[srcUdbBase + 15 - (2 * ii)]     =
             (GT_U8)((prvTgfPacketIpv6UdpIpPart.srcAddr[ii] >> 8) & 0xFF);
        pattern.ruleIngrUdbOnly.udb[srcUdbBase + 14 - (2 * ii)] =
            (GT_U8)(prvTgfPacketIpv6UdpIpPart.srcAddr[ii] & 0xFF);
    }
    pattern.ruleIngrUdbOnly.udb[srcUdbBase + 16] =
        (GT_U8)(prvTgfPacketUdpPart_ipv6.srcPort & 0xFF);
    pattern.ruleIngrUdbOnly.udb[srcUdbBase + 17]     =
        (GT_U8)((prvTgfPacketUdpPart_ipv6.srcPort >> 8) & 0xFF);

    for (ii = 0; (ii < 8); ii++)
    {
        pattern.ruleIngrUdbOnly.udb[dstUdbBase + 15 - (2 * ii)]     =
            (GT_U8)((prvTgfPacketIpv6UdpIpPart.dstAddr[ii] >> 8) & 0xFF);
        pattern.ruleIngrUdbOnly.udb[dstUdbBase + 14 - (2 * ii)] =
            (GT_U8)(prvTgfPacketIpv6UdpIpPart.dstAddr[ii] & 0xFF);
    }
    pattern.ruleIngrUdbOnly.udb[dstUdbBase + 16] =
        (GT_U8)(prvTgfPacketUdpPart_ipv6.dstPort & 0xFF);
    pattern.ruleIngrUdbOnly.udb[dstUdbBase + 17]     =
        (GT_U8)((prvTgfPacketUdpPart_ipv6.dstPort >> 8) & 0xFF);
    ...
    for (ii = 0; (ii <= (156 - 121)); ii++)
    {
        pattern.ruleIngrUdbOnly.udb[udbBase + ii]     = 0x00;
    }
...
/**
* @internal prvTgfPclIpv6EspExtNoL4TestConfigurationSet function
* @endinternal
*
* @brief   Test Configurations - IPV6 L4 Valid in IPCL metadata
*          For IPV6 packet with ESP extension header L4 must be invalid because L4 secure coded.
*/
GT_VOID prvTgfPclIpv6EspExtNoL4TestConfigurationSet
(
     void
)
{
    ...
    static const struct
    {
        GT_U8 metadataByteOffset;
        GT_U8 metadataByteMask;
        GT_U8 metadataBytePattern;
    } checkFieldsArr[] =
    {
        /* 247-240 IPx Protocol, Anchor offset: 30 Bit offset: 7:0     */
        {30, 0xFF, 50},
        /* 358-358 IPv6 EH Exist, Anchor offset: 44 Bit offset: 6:6    */
        {44, 0x40, 0x40},
        /* 408-408 L4 Offset Invalid, Anchor offset: 51 Bit offset: 0:0   */
        /* 409-409 L4 Valid, Anchor offset: 51 Bit offset: 1:1         */
        {51, 0x03, 0x01},
        /* 1322-1312 IPV6 EH Detection Bitmap, Anchor offset : 165 bit offset 2:0, Anchor offset 164 bit offset : 7:0 */
        /* • Bit 3 - EH Type 50 found - ESP header                                                                 */
        /* • Bit 9,10 - EH Type Configurable Value1 and Value2                                                     */
        {164, 0xFF, 0x08}, /*check bits 0-7*/
        {165, 0x01, 0x00}  /*check bit 8 */
    };
    GT_U32 checkFieldsAmount = sizeof(checkFieldsArr) / sizeof(checkFieldsArr[0]);
    ...
    for (ii = 0; (ii < 12); ii++)
    {
        rc = prvTgfPclUserDefinedByteSet(
            ...
            ii/*offset*/);
        UTF_VERIFY_EQUAL3_STRING_MAC(
            GT_OK, rc, "prvTgfPclUserDefinedByteSet: index %d, anchor %d offset %d",
            ii, PRV_TGF_PCL_OFFSET_L2_E, ii);
    }

    for (ii = 0; (ii < checkFieldsAmount); ii++)
    {
        rc = prvTgfPclUserDefinedByteSet(
            PRV_TGF_PCL_RULE_FORMAT_INGRESS_UDB_60_NO_FIXED_FIELDS_E,
            PRV_TGF_PCL_PACKET_TYPE_IPV6_OTHER_E,
            ...
            (udbBase + ii),
            PRV_TGF_PCL_OFFSET_METADATA_E,
            (checkFieldsArr[ii].metadataByteOffset));
        UTF_VERIFY_EQUAL3_STRING_MAC(
            GT_OK, rc, "prvTgfPclUserDefinedByteSet: index %d, anchor %d offset %d",
            (udbBase + ii), PRV_TGF_PCL_OFFSET_METADATA_E, (checkFieldsArr[ii].metadataByteOffset));
    }
    ...
    for (ii = 0; (ii < checkFieldsAmount); ii++)
    {
        mask.ruleIngrUdbOnly.udb[udbBase + ii]    = checkFieldsArr[ii].metadataByteMask;
        pattern.ruleIngrUdbOnly.udb[udbBase + ii] = checkFieldsArr[ii].metadataBytePattern;
    }

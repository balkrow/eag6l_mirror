...
*        Common configurations for AC5 Port List tests
*
* INPUTS:
*       None
*
...
*
*******************************************************************************/
GT_VOID prvTgfPclPortListConfig
(
    GT_VOID
)
{
...
*        Common restore logic for AC5 Port List tests
*
* INPUTS:
*       None
*
...
*
*******************************************************************************/
GT_VOID prvTgfPclPortListRestore
(
    GT_VOID
)
{

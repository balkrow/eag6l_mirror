...
/* packet's IPv4 */
static TGF_PACKET_IPV4_STC prvTgfPacketIpv4FragFirstPart =
{
    4,                  /* version */
    5,                  /* headerLen */
    0,                  /* typeOfService */
...
/* PARTS of packet IPv4 - IPV4 FRAGMENT */
static TGF_PACKET_PART_STC prvTgfIpv4FragFirstPacketPartArray[] =
{
    {TGF_PACKET_PART_L2_E,        &prvTgfPacketL2Part},
    {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacketIpv4EtherTypePart},
    {TGF_PACKET_PART_IPV4_E,      &prvTgfPacketIpv4FragFirstPart},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketPayloadPart}
};

/* IPv4 Fragment packet to send */
static TGF_PACKET_STC prvTgfIpv4FragFirstPacketInfo =
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,                         /* totalLen */
    (sizeof(prvTgfIpv4FragFirstPacketPartArray)
        / sizeof(prvTgfIpv4FragFirstPacketPartArray[0])), /* numOfParts */
    prvTgfIpv4FragFirstPacketPartArray                    /* partsArray */
};

static TGF_PACKET_IPV4_STC prvTgfPacketIpv4FragMiddlePart =
{
    4,                  /* version */
    5,                  /* headerLen */
    0,                  /* typeOfService */
    ...
    0,                  /* id */
    1,                  /* flags */    /* more fragments     */
    0x100,              /* offset */   /* not first fragment */
    0x40,               /* timeToLive */
    4,                  /* protocol */
    TGF_PACKET_AUTO_CALC_CHECKSUM_CNS,             /* csum */
    {22, 22, 22, 22},   /* srcAddr */
...
/* PARTS of packet IPv4 - IPV4 FRAGMENT */
static TGF_PACKET_PART_STC prvTgfIpv4FragMiddlePacketPartArray[] =
{
    {TGF_PACKET_PART_L2_E,        &prvTgfPacketL2Part},
    {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacketIpv4EtherTypePart},
    {TGF_PACKET_PART_IPV4_E,      &prvTgfPacketIpv4FragMiddlePart},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketPayloadPart}
};

/* IPv4 Fragment packet to send */
static TGF_PACKET_STC prvTgfIpv4FragMiddlePacketInfo =
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,                         /* totalLen */
    (sizeof(prvTgfIpv4FragMiddlePacketPartArray)
        / sizeof(prvTgfIpv4FragMiddlePacketPartArray[0])), /* numOfParts */
    prvTgfIpv4FragMiddlePacketPartArray                    /* partsArray */
};

static TGF_PACKET_IPV4_STC prvTgfPacketIpv4FragLastPart =
{
    4,                  /* version */
    5,                  /* headerLen */
    0,                  /* typeOfService */
...
/* PARTS of packet IPv4 - IPV4 FRAGMENT */
static TGF_PACKET_PART_STC prvTgfIpv4FragLastPacketPartArray[] =
{
    {TGF_PACKET_PART_L2_E,        &prvTgfPacketL2Part},
    {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacketIpv4EtherTypePart},
    {TGF_PACKET_PART_IPV4_E,      &prvTgfPacketIpv4FragLastPart},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacketPayloadPart}
};

/* IPv4 Fragment packet to send */
static TGF_PACKET_STC prvTgfIpv4FragLastPacketInfo =
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,                         /* totalLen */
    (sizeof(prvTgfIpv4FragLastPacketPartArray)
        / sizeof(prvTgfIpv4FragLastPacketPartArray[0])), /* numOfParts */
    prvTgfIpv4FragLastPacketPartArray                    /* partsArray */
};

/**
* @internal prvTgfPclMetadataPacketIpv4FragTest function
* @endinternal
*
* @brief   IPCL Metadata Ingress UDB IPV4 Fragment Packet test
*/
GT_VOID prvTgfPclMetadataPacketIpv4FragTest
(
    GT_VOID
)
{
    ...
    rc = prvTgfPclUserDefinedByteSet(
        ...
        PRV_TGF_PCL_PACKET_TYPE_IPV4_OTHER_E, 
        CPSS_PCL_DIRECTION_INGRESS_E, 30/*udbAbsIndex*/,
        PRV_TGF_PCL_OFFSET_METADATA_E, 42/*bits343:336*/);
    UTF_VERIFY_EQUAL0_STRING_MAC( GT_OK, rc,
        "prvTgfPclUserDefinedByteSet: failed");

    /* for middle an last fragment */
    rc = prvTgfPclUserDefinedByteSet(
        PRV_TGF_PCL_RULE_FORMAT_INGRESS_STD_IP_L2_QOS_E, 
        PRV_TGF_PCL_PACKET_TYPE_IPV4_FRAGMENT_E, 
        CPSS_PCL_DIRECTION_INGRESS_E, 30/*udbAbsIndex*/,
    ...
    UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_OK, rc, "prvTgfPclDefPortInit: failed");
    ...
    /* bits 343:336 of metadata in UDB30 */
    /* bits 338:339 (1- first, 2 - middle, 3 - last) */
    /* bit 340 (fragmented) */
    mask.ruleStdIpL2Qos.udb[30] = ((1 << 4) | (3 << 2));

    /* first fragment */
    PRV_UTF_LOG0_MAC("=== FIRST fragment to match ===\n");
    pattern.ruleStdIpL2Qos.udb[30] = ((1 << 4) | (1 << 2));
    rc = prvTgfPclRuleSet(
        PRV_TGF_PCL_RULE_FORMAT_INGRESS_STD_IP_L2_QOS_E, 
    ...
    rc = prvTgfTransmitPackets(
        prvTgfDevNum, prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],
        &prvTgfIpv4FragFirstPacketInfo,
        1/*burstCount*/, 0/*numVfd*/, NULL/*vfdArray*/);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfTransmitPackets failed");

    rc = prvTgfReadPortCountersEth(
        prvTgfDevNum,
        prvTgfPortsArray[PRV_TGF_RECEIVE_PORT_IDX_CNS],
        GT_TRUE, &portCntrs);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfReadPortCountersEth: failed");
    UTF_VERIFY_EQUAL0_STRING_MAC(1, portCntrs.goodPktsSent.l[0], "unexpected sent packets count");

    /* middle fragment */
    PRV_UTF_LOG0_MAC("=== MIDDLE fragment to match ===\n");
    pattern.ruleStdIpL2Qos.udb[30] = ((1 << 4) | (2 << 2));
    rc = prvTgfPclRuleSet(
        PRV_TGF_PCL_RULE_FORMAT_INGRESS_STD_IP_L2_QOS_E, 
        IPCL_MATCH_INDEX, &mask, &pattern, &action);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfPclRuleSet: %d", IPCL_MATCH_INDEX);
    ...
    rc = prvTgfTransmitPackets(
        prvTgfDevNum, prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],
        &prvTgfIpv4FragMiddlePacketInfo,
        1/*burstCount*/, 0/*numVfd*/, NULL/*vfdArray*/);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfTransmitPackets failed");
    ...
    /* last fragment */
    PRV_UTF_LOG0_MAC("=== LAST fragment to match ===\n");
    pattern.ruleStdIpL2Qos.udb[30] = ((1 << 4) | (3 << 2));
    rc = prvTgfPclRuleSet(
        PRV_TGF_PCL_RULE_FORMAT_INGRESS_STD_IP_L2_QOS_E, 
        IPCL_MATCH_INDEX, &mask, &pattern, &action);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfPclRuleSet: %d", IPCL_MATCH_INDEX);
    ...
    /* first fragment not to be matched */
    PRV_UTF_LOG0_MAC("=== FIRST fragment not to match ===\n");
    prvTgfEthCountersReset(prvTgfDevNum);
    ...
    rc = prvTgfReadPortCountersEth(
        ...
        GT_TRUE, &portCntrs);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfReadPortCountersEth: failed");
    UTF_VERIFY_EQUAL0_STRING_MAC(0, portCntrs.goodPktsSent.l[0], "unexpected sent packets count");
}

/**
* @internal prvTgfPclMetadataPacketIpv4FragTestRestore function
* @endinternal
*
* @brief   Restore after IPCL Metadata Ingress UDB IPV4 Fragment Packet test
*/
GT_VOID prvTgfPclMetadataPacketIpv4FragTestRestore
(
    GT_VOID
)
{
    ...
    prvTgfPclRuleValidStatusSet(
        CPSS_PCL_RULE_SIZE_STD_E, IPCL_MATCH_INDEX, GT_FALSE);

    /* AUTODOC: Clear IPCL Engine configuration tables */
    prvTgfPclRestore();

    /* AUTODOC: Disables PCL ingress Policy */
    prvTgfPclIngressPolicyEnable(GT_FALSE);

...
********************************************************************/
    ...
    /* Remove skip after PCL rule fix  in AAS, The test fail and fails other tests */
...
UTF_TEST_CASE_MAC(prvTgfLcMirrorSourceFalconIngressErspan)
{
    ...
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, UTF_CH1_E |
        ...
        UTF_ALDRIN_E | UTF_AC3X_E | UTF_BOBCAT3_E | UTF_ALDRIN2_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E | UTF_AC5P_E);
...
UTF_TEST_CASE_MAC (prvTgfFalconErspanSameDevMirrorIpv4Ingress)
{
    ...
    /*config set*/
    prvTgfFalconErspanSameDevMirrorIpv4ConfigurationSet(CPSS_DIRECTION_INGRESS_E, PRV_TGF_ERSPAN_TYPE_II_CNS, GT_FALSE);
    /*Test with traffic*/
    prvTgfFalconErspanSameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_II_CNS, CPSS_DIRECTION_INGRESS_E);
    /*config reset*/
    prvTgfFalconErspanSameDevMirrorConfigurationReset(CPSS_DIRECTION_INGRESS_E, PRV_TGF_ERSPAN_TYPE_II_CNS, CPSS_IP_PROTOCOL_IPV4_E);
}
...
UTF_TEST_CASE_MAC (prvTgfFalconErspanSameDevMirrorIpv6Ingress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E) );
    /*config set*/
    prvTgfFalconErspanSameDevMirrorIpv6ConfigurationSet(CPSS_DIRECTION_INGRESS_E, PRV_TGF_ERSPAN_TYPE_II_CNS, GT_FALSE);
    /*Test with traffic*/
    prvTgfFalconErspanSameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV6_E, PRV_TGF_ERSPAN_TYPE_II_CNS, CPSS_DIRECTION_INGRESS_E);
    /*config reset*/
    prvTgfFalconErspanSameDevMirrorIpv6ConfigurationReset(CPSS_DIRECTION_INGRESS_E, PRV_TGF_ERSPAN_TYPE_II_CNS, CPSS_IP_PROTOCOL_IPV6_E);
}
...
UTF_TEST_CASE_MAC (prvTgfFalconErspanSameDevMirrorIpv4Egress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E) );
    /*config set*/
    prvTgfFalconErspanSameDevMirrorIpv4ConfigurationSet(CPSS_DIRECTION_EGRESS_E, PRV_TGF_ERSPAN_TYPE_II_CNS, GT_FALSE);
    /*Test with traffic*/
    prvTgfFalconErspanSameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_II_CNS, CPSS_DIRECTION_EGRESS_E);
    /*config reset*/
    prvTgfFalconErspanSameDevMirrorConfigurationReset(CPSS_DIRECTION_EGRESS_E, PRV_TGF_ERSPAN_TYPE_II_CNS, CPSS_IP_PROTOCOL_IPV4_E);
}
/** AUTODOC: Test egress Mirroring with IPv4+ERPSAN type II
*            header encapsulation for Falcon device.
*   1) Enable the TX mirroring and trigger PHA.
...
UTF_TEST_CASE_MAC (prvTgfFalconErspanSameDevMirrorIpv6Egress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E) );
    /*config set*/
    prvTgfFalconErspanSameDevMirrorIpv6ConfigurationSet(CPSS_DIRECTION_EGRESS_E, PRV_TGF_ERSPAN_TYPE_II_CNS, GT_FALSE);
    /*Test with traffic*/
    prvTgfFalconErspanSameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV6_E, PRV_TGF_ERSPAN_TYPE_II_CNS, CPSS_DIRECTION_EGRESS_E);
    /*config reset*/
    prvTgfFalconErspanSameDevMirrorIpv6ConfigurationReset(CPSS_DIRECTION_EGRESS_E, PRV_TGF_ERSPAN_TYPE_II_CNS, CPSS_IP_PROTOCOL_IPV6_E);
}

/* AUTODOC: Test egress Mirroring with enhanced SFLOW headers
   1) Enable the mirroring with PHA.
   2) Generate traffic.
   3) check mirrored packet's SFLOW header fields for IPV4 tunnel encapsulation.
 */
UTF_TEST_CASE_MAC (prvTgfMirrorEgressEnhancedSflowIpv4)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E|UTF_AC5X_E|UTF_AC5P_E));
    /*config set*/
    prvTgfMirrorEgressEnhancedSflowConfig(CPSS_IP_PROTOCOL_IPV4_E);
    /*Test with traffic*/
    prvTgfMirrorEgressEnhancedSflowTrafficSend(CPSS_IP_PROTOCOL_IPV4_E);
    /*config reset*/
    prvTgfMirrorEgressEnhancedSflowConfigReset(CPSS_IP_PROTOCOL_IPV4_E);
}
...
/* AUTODOC: Test egress Mirroring with enhanced SFLOW headers
   ...
   3) check mirrored packet's SFLOW header fields for IPV4 tunnel encapsulation.
 */
UTF_TEST_CASE_MAC (prvTgfMirrorEgressEnhancedSflowIpv6)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E|UTF_AC5X_E|UTF_AC5P_E));
    /*config set*/
    prvTgfMirrorEgressEnhancedSflowConfig(CPSS_IP_PROTOCOL_IPV6_E);
    /*Test with traffic*/
    prvTgfMirrorEgressEnhancedSflowTrafficSend(CPSS_IP_PROTOCOL_IPV6_E);
    /*config reset*/
    prvTgfMirrorEgressEnhancedSflowConfigReset(CPSS_IP_PROTOCOL_IPV6_E);
}

/* AUTODOC: Test ingress Mirroring with SFLOWV5 for Falcon device.
   1) Enable the mirroring with PHA.
   2) Generate traffic.
   3) check packet's SFLOW header fields for IPV4-UDP tunnel encapsulation.
 */
UTF_TEST_CASE_MAC (prvTgfFalconMirrorIngressSflowV5)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~UTF_FALCON_E);

    /*config set*/
    prvTgfFalconMirrorIngressSflowV5ConfigurationSet(CPSS_PACKET_CMD_FORWARD_E);

    /*Test with traffic*/
    prvTgfFalconMirrorIngressSflowV5TrafficSend(CPSS_PACKET_CMD_FORWARD_E);

    /*config restore */
    prvTgfFalconMirrorIngressSflowV5ConfigurationRestore();

    /*config set*/
    prvTgfFalconMirrorIngressSflowV5ConfigurationSet(CPSS_PACKET_CMD_DROP_SOFT_E);

    /*Test with traffic*/
    prvTgfFalconMirrorIngressSflowV5TrafficSend(CPSS_PACKET_CMD_DROP_SOFT_E);

    /*config restore */
    prvTgfFalconMirrorIngressSflowV5ConfigurationRestore();
}

/** AUTODOC: Test ingress Mirroring with IPv4+ERPSAN type I header encapsulation.
*    configure VLAN;
...
*    Verify:
*    check mirrored packet's IPv4+GRE header encapsulation and raw frame fields.
**/
UTF_TEST_CASE_MAC (prvTgfFalconErspanISameDevMirrorIpv4Ingress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E) );
    /*config set*/
    prvTgfFalconErspanISameDevMirrorIpv4ConfigurationSet(CPSS_DIRECTION_INGRESS_E);
    /*Test with traffic*/
    prvTgfFalconErspanISameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV4_E);
    /*config reset*/
    prvTgfFalconErspanISameDevMirrorConfigurationReset(CPSS_DIRECTION_INGRESS_E);
}

/** AUTODOC: Test ingress Mirroring with IPv6+ERPSAN type I header encapsulation.
*    configure VLAN;
*    configure an analyzer index, sampling rate and eport;
*    enable Rx mirroring for ingress port;
...
*    send traffic and verify expected mirrored traffic on analyzer port;
*    Verify:
*    check mirrored packet's IPv6+GRE header encapsulation and raw frame fields.
**/
UTF_TEST_CASE_MAC (prvTgfFalconErspanISameDevMirrorIpv6Ingress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E) );
    /*config set*/
    prvTgfFalconErspanISameDevMirrorIpv6ConfigurationSet(CPSS_DIRECTION_INGRESS_E);
    /*Test with traffic*/
    prvTgfFalconErspanISameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV6_E);
    /*config reset*/
    prvTgfFalconErspanISameDevMirrorIpv6ConfigurationReset(CPSS_DIRECTION_INGRESS_E, PRV_TGF_ERSPAN_TYPE_I_CNS, CPSS_IP_PROTOCOL_IPV6_E);
}

/** AUTODOC: Test egress Mirroring with IPv4+ERPSAN type I header encapsulation.
*    configure VLAN;
*    configure an analyzer index, sampling rate and eport;
*    enable Tx mirroring for egress port;
*    E2phy and IPv4 TS for eport
*    Configure OAM, EPLR & ERMRK for other fields of ERSPAN header
*    configure EPCL rule to trigger IPv4 PHA thread, and pha metadata
*    send traffic and verify expected mirrored traffic on analyzer port;
...
*    check mirrored packet's IPv4+GRE header encapsulation and raw frame fields.
**/
UTF_TEST_CASE_MAC (prvTgfFalconErspanISameDevMirrorIpv4Egress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E) );
    /*config set*/
    prvTgfFalconErspanISameDevMirrorIpv4ConfigurationSet(CPSS_DIRECTION_EGRESS_E);
    /*Test with traffic*/
    prvTgfFalconErspanISameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV4_E);
    /*config reset*/
    prvTgfFalconErspanISameDevMirrorConfigurationReset(CPSS_DIRECTION_EGRESS_E);
}

/** AUTODOC: Test egress Mirroring with IPv6+ERPSAN type I header encapsulation.
*    configure VLAN;
*    configure an analyzer index, sampling rate and eport;
*    enable Tx mirroring for egress port;
*    E2phy and IPv6 TS for eport
...
*    check mirrored packet's IPv6+GRE header encapsulation and raw frame fields.
**/
UTF_TEST_CASE_MAC (prvTgfFalconErspanISameDevMirrorIpv6Egress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E) );
    /*config set*/
    prvTgfFalconErspanISameDevMirrorIpv6ConfigurationSet(CPSS_DIRECTION_EGRESS_E);
    /*Test with traffic*/
    prvTgfFalconErspanISameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV6_E);
    /*config reset*/
    prvTgfFalconErspanISameDevMirrorIpv6ConfigurationReset(CPSS_DIRECTION_EGRESS_E, PRV_TGF_ERSPAN_TYPE_I_CNS, CPSS_IP_PROTOCOL_IPV6_E);
}

/*----------------------------------------------------------------------------*/
/*
    prvTgfMirrorAndTunnelStartTest
*/
UTF_TEST_CASE_MAC(prvTgfMirrorAndTunnelStartTest)
{
/** AUTODOCIngress/Egress mirroring functionality With/Without TS and
*    With/Without Treat Egress Mirror as Ingress Mirror
*
*    1. Set configuration
*    2. Generate traffic
*    3. Restore configuration
*    We perform 3 tests here
*    Case I: Do Rx Port Mirroring and validate egress packet has no TS
*    Case II: Do Tx Port Mirroring and validate egress packet has TS
*    Case III: Do Tx Port Mirroring with TreatEgressMirrorAsIngressMirror and
*    validate egress packet has no TS
*    For all tests, we send packet from Rx to Tx and TTI redirects the egress
*    packet to some other port with tunnel attributes assigned as action
**/
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~UTF_CPSS_PP_ALL_SIP6_10_CNS);

    /* Set configuration */
    prvTgfMirrorAndTunnelStartTestConfigurationSet(PRV_TGF_RX_MIRROR_AND_NO_TS);

    /* Generate traffic */
    prvTgfMirrorAndTunnelStartTestTrafficGenerate(PRV_TGF_RX_MIRROR_AND_NO_TS);

    /* Restore configuration */
    prvTgfMirrorAndTunnelStartTestConfigurationRestore(PRV_TGF_RX_MIRROR_AND_NO_TS);

    /* Set configuration */
    prvTgfMirrorAndTunnelStartTestConfigurationSet(PRV_TGF_TX_MIRROR_AND_TS);

    /* Generate traffic */
    prvTgfMirrorAndTunnelStartTestTrafficGenerate(PRV_TGF_TX_MIRROR_AND_TS);

    /* Restore configuration */
    prvTgfMirrorAndTunnelStartTestConfigurationRestore(PRV_TGF_TX_MIRROR_AND_TS);

    /* Set configuration */
    prvTgfMirrorAndTunnelStartTestConfigurationSet(PRV_TGF_TX_MIRROR_AND_NO_TS);

    /* Generate traffic */
    prvTgfMirrorAndTunnelStartTestTrafficGenerate(PRV_TGF_TX_MIRROR_AND_NO_TS);

    /* Restore configuration */
    prvTgfMirrorAndTunnelStartTestConfigurationRestore(PRV_TGF_TX_MIRROR_AND_NO_TS);
}

/** AUTODOC: Test ingress Mirroring with IPv4+ERPSAN type III
*            header encapsulation for Falcon, AC5P, AC5X and Harrier devices.
*   1) Enable the RX mirroring and trigger PHA.
*   2) Generate traffic.
*   3) check mirrored packet's GRE+ERSPAN header fields for IPV4 encapsulation.
**/
UTF_TEST_CASE_MAC (prvTgfFalconErspanIIISameDevMirrorIpv4Ingress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /*config set*/
    prvTgfFalconErspanSameDevMirrorIpv4ConfigurationSet(CPSS_DIRECTION_INGRESS_E, PRV_TGF_ERSPAN_TYPE_III_CNS, GT_FALSE);
    /*Test with traffic*/
    prvTgfFalconErspanSameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_INGRESS_E);
    /*config reset*/
    prvTgfFalconErspanSameDevMirrorConfigurationReset(CPSS_DIRECTION_INGRESS_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_IP_PROTOCOL_IPV4_E);
}

/** AUTODOC: Test egress Mirroring with IPv4+ERPSAN type III
*            header encapsulation for Falcon, AC5P, AC5X and Harrier devices.
*   1) Enable the TX mirroring and trigger PHA.
*   2) Generate traffic.
*   3) check mirrored packet's GRE+ERSPAN header fields for IPV4 encapsulation.
**/
UTF_TEST_CASE_MAC (prvTgfFalconErspanIIISameDevMirrorIpv4Egress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /*config set*/
    prvTgfFalconErspanSameDevMirrorIpv4ConfigurationSet(CPSS_DIRECTION_EGRESS_E, PRV_TGF_ERSPAN_TYPE_III_CNS, GT_FALSE);
    /*Test with traffic*/
    prvTgfFalconErspanSameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_EGRESS_E);
    /*config reset*/
    prvTgfFalconErspanSameDevMirrorConfigurationReset(CPSS_DIRECTION_EGRESS_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_IP_PROTOCOL_IPV4_E);
}

/** AUTODOC: Test ingress Mirroring with IPv6+ERPSAN type III
*            header encapsulation for Falcon, AC5P, AC5X and Harrier devices.
*   1) Enable the RX mirroring and trigger PHA.
*   2) Generate traffic.
*   3) check mirrored packet's GRE+ERSPAN header fields for IPV6 encapsulation.
**/
UTF_TEST_CASE_MAC (prvTgfFalconErspanIIISameDevMirrorIpv6Ingress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /*config set */
    prvTgfFalconErspanSameDevMirrorIpv6ConfigurationSet(CPSS_DIRECTION_INGRESS_E, PRV_TGF_ERSPAN_TYPE_III_CNS, GT_TRUE);
    /*Test with traffic*/
    prvTgfFalconErspanSameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV6_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_INGRESS_E);
    /*config reset*/
    prvTgfFalconErspanSameDevMirrorIpv6ConfigurationReset(CPSS_DIRECTION_INGRESS_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_IP_PROTOCOL_IPV6_E);
}

/** AUTODOC: Test egress Mirroring with IPv6+ERPSAN type III
*            header encapsulation for Falcon, AC5P, AC5X and Harrier devices.
*   1) Enable the TX mirroring and trigger PHA.
*   2) Generate traffic.
*   3) check mirrored packet's GRE+ERSPAN header fields for IPV6 encapsulation.
**/
UTF_TEST_CASE_MAC (prvTgfFalconErspanIIISameDevMirrorIpv6Egress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /*config set*/
    prvTgfFalconErspanSameDevMirrorIpv6ConfigurationSet(CPSS_DIRECTION_EGRESS_E, PRV_TGF_ERSPAN_TYPE_III_CNS, GT_TRUE);
    /*Test with traffic*/
    prvTgfFalconErspanSameDevMirrorTraffic(CPSS_IP_PROTOCOL_IPV6_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_EGRESS_E);
    /*config reset*/
    prvTgfFalconErspanSameDevMirrorIpv6ConfigurationReset(CPSS_DIRECTION_EGRESS_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_IP_PROTOCOL_IPV6_E);
}

/*----------------------------------------------------------------------------------*/
/* AUTODOC: Test Ingress mirroring on Original device using ERSPAN Type III encapsulation

    1.  Packet enters the device via ingress port.
    2.  Port mirroring is triggered based on ingress port and global ePort with hwDevNum != ownDevNum
        is assigned target port for analyzer.
    3.  configure cascading map for analyzer's hwDevNum to redirect to cascade port
    4.  EPCL lookup on Original Device based on Analyzer eport with egress marvell tagged triggers OrgDevMirroring Thread in PHA.
    5.  PHA FW threads adds ERSPAN III header to outgoing TO_ANALYZER eDSA mirror packet.
    6.  Mirror packet exits the device via physical cascade port which is a cascde link in device map table to Target Device.
    7.  The final output packet from source Device(#2) is then treated as input to target Device (#0).
*/

UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIIOrigDevMirrorIngress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_TRUE, GT_FALSE, CPSS_DIRECTION_INGRESS_E, CPSS_IP_PROTOCOL_IPV4_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_TRUE, GT_FALSE, CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_INGRESS_E);

    /* Restore configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigReset(GT_TRUE, CPSS_DIRECTION_INGRESS_E);
}

/*----------------------------------------------------------------------------------*/
/* AUTODOC: Test Egress mirroring on Original device using ERSPAN Type III encapsulation

    1.  Packet enters the device via ingress port.
    2.  Port mirroring is triggered based on egress port and global ePort with hwDevNum != ownDevNum
        is assigned target port for analyzer.
    3.  configure cascading map for analyzer's hwDevNum to redirect to cascade port
    4.  EPCL lookup on Original Device based on Analyzer eport with egress marvell tagged triggers OrgDevMirroring Thread in PHA.
    5.  PHA FW threads adds ERSPAN III header to outgoing TO_ANALYZER eDSA mirror packet.
...
UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIIOrigDevMirrorEgress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_TRUE, GT_FALSE, CPSS_DIRECTION_EGRESS_E, CPSS_IP_PROTOCOL_IPV4_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_TRUE, GT_FALSE, CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_EGRESS_E);

    /* Restore configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigReset(GT_TRUE, CPSS_DIRECTION_EGRESS_E);
}

/*----------------------------------------------------------------------------------*/
/* AUTODOC: Test Ingress mirroring on Target device using ERSPAN Type III encapsulation
            for IPv4 Untagged thread

    1.  The final output packet from source Device(#2) is then treated as input to target Device (#0).
    2.  modify hwDevNum to analyzer's hwDevNum above.
    3.  Packet(untagged) enters the device via cascade ingress port.
    4.  Map analyzer eport to physical port
    5.  EPCL lookup on Target Device based on Analyzer eport with ingress marvell tagged
        triggers TrgDevMirroring IPv4 untagged Thread in PHA.
    6.  PHA FW threads adds GRE header to outgoing TO_ANALYZER mirror packet.
    7.  Mirror packet exits the device via physical port which mapped to analyzer eport.
*/

UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv4UntaggedIngress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_FALSE, GT_FALSE, CPSS_DIRECTION_INGRESS_E, CPSS_IP_PROTOCOL_IPV4_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_FALSE, GT_FALSE, CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_INGRESS_E);

    /* Restore configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigReset(GT_FALSE, CPSS_DIRECTION_INGRESS_E);
}

/*----------------------------------------------------------------------------------*/
/* AUTODOC: Test Egress mirroring on Target Device using ERSPAN Type III encapsulation
            for IPv4 Untagged thread
...
UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv4UntaggedEgress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_FALSE, GT_FALSE, CPSS_DIRECTION_EGRESS_E, CPSS_IP_PROTOCOL_IPV4_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_FALSE, GT_FALSE, CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_EGRESS_E);

    /* Restore configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigReset(GT_FALSE, CPSS_DIRECTION_EGRESS_E);
}

/*----------------------------------------------------------------------------------*/
/* AUTODOC: Test Ingress mirroring on Target device using ERSPAN Type III encapsulation
            for IPv6 Untagged thread
    ...
    4.  Map analyzer eport to physical port
    5.  EPCL lookup on Target Device based on Analyzer eport with ingress marvell tagged
        triggers TrgDevMirroring IPv6 untagged Thread in PHA.
    6.  PHA FW threads adds GRE header to outgoing TO_ANALYZER mirror packet.
    7.  Mirror packet exits the device via physical port which mapped to analyzer eport.
*/

UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv6UntaggedIngress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_FALSE, GT_FALSE, CPSS_DIRECTION_INGRESS_E, CPSS_IP_PROTOCOL_IPV6_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_FALSE, GT_FALSE, CPSS_IP_PROTOCOL_IPV6_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_INGRESS_E);
...
UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv6UntaggedEgress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_FALSE, GT_FALSE, CPSS_DIRECTION_EGRESS_E, CPSS_IP_PROTOCOL_IPV6_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_FALSE, GT_FALSE, CPSS_IP_PROTOCOL_IPV6_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_EGRESS_E);
...
/* AUTODOC: Test Ingress mirroring on Target device using ERSPAN Type III encapsulation
    ...
    4.  Map analyzer eport to physical port
    5.  EPCL lookup on Target Device based on Analyzer eport with ingress marvell tagged
        triggers TrgDevMirroring IPv4 tagged Thread in PHA.
    6.  PHA FW threads adds GRE header to outgoing TO_ANALYZER mirror packet.
    7.  Mirror packet exits the device via physical port which mapped to analyzer eport.
*/

UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv4TaggedIngress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_FALSE, GT_TRUE, CPSS_DIRECTION_INGRESS_E, CPSS_IP_PROTOCOL_IPV4_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_FALSE, GT_TRUE, CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_INGRESS_E);
...
UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv4TaggedEgress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_FALSE, GT_TRUE, CPSS_DIRECTION_EGRESS_E, CPSS_IP_PROTOCOL_IPV4_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_FALSE, GT_TRUE, CPSS_IP_PROTOCOL_IPV4_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_EGRESS_E);
...
/* AUTODOC: Test Ingress mirroring on Target device using ERSPAN Type III encapsulation
    ...
    4.  Map analyzer eport to physical port
    5.  EPCL lookup on Target Device based on Analyzer eport with ingress marvell tagged
        triggers TrgDevMirroring IPv6 tagged Thread in PHA.
    6.  PHA FW threads adds GRE header to outgoing TO_ANALYZER mirror packet.
    7.  Mirror packet exits the device via physical port which mapped to analyzer eport.
*/

UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv6TaggedIngress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_FALSE, GT_TRUE, CPSS_DIRECTION_INGRESS_E, CPSS_IP_PROTOCOL_IPV6_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_FALSE, GT_TRUE, CPSS_IP_PROTOCOL_IPV6_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_INGRESS_E);
...
UTF_TEST_CASE_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv6TaggedEgress)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E));
    /* Set configuration */
    prvTgfFalconCCErspanIIIOrigDevMirroringConfigSet(GT_FALSE, GT_TRUE, CPSS_DIRECTION_EGRESS_E, CPSS_IP_PROTOCOL_IPV6_E);

    /* Generate traffic */
    prvTgfFalconCCErspanIIIMirrorTraffic(GT_FALSE, GT_TRUE, CPSS_IP_PROTOCOL_IPV6_E, PRV_TGF_ERSPAN_TYPE_III_CNS, CPSS_DIRECTION_EGRESS_E);
...
/*----------------------------------------------------------------------------------*/
/* AUTODOC: Test Vlan based egress mirroring with egress VLAN attribute table write
            Validate JIRA CPSS-16742
*/
UTF_TEST_CASE_MAC(prvTgfFalconEgressVlanMirroring)
{
    /* Applicable device: FALCON */
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~UTF_FALCON_E);

    prvTgfFalconEgressVlanMirroringConfig();
}
...
UTF_SUIT_BEGIN_TESTS_MAC(tgfMirror)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfMirrorEgressEnhancedSflowIpv4)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfMirrorEgressEnhancedSflowIpv6)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconMirrorIngressSflowV5)

    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconErspanISameDevMirrorIpv4Ingress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconErspanISameDevMirrorIpv4Egress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconErspanISameDevMirrorIpv6Ingress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconErspanISameDevMirrorIpv6Egress)

    UTF_SUIT_DECLARE_TEST_MAC(prvTgfMirrorAndTunnelStartTest)

    /* Ingress & Egress ERSPAN mirroring Type III Pizza box use cases */
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconErspanIIISameDevMirrorIpv4Ingress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconErspanIIISameDevMirrorIpv4Egress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconErspanIIISameDevMirrorIpv6Ingress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconErspanIIISameDevMirrorIpv6Egress)

    /* Ingress & Egress ERSPAN mirroring Type III Centralized Chassis use cases */
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIIOrigDevMirrorIngress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIIOrigDevMirrorEgress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv4UntaggedIngress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv4UntaggedEgress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv6UntaggedIngress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv6UntaggedEgress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv4TaggedIngress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv4TaggedEgress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv6TaggedIngress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconCCErspanIIITrgDevMirrorIpv6TaggedEgress)
    UTF_SUIT_DECLARE_TEST_MAC(prvTgfFalconEgressVlanMirroring)

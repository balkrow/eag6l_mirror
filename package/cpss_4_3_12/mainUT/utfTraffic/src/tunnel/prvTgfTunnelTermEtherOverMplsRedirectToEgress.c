...
)
{
    ...
    rc = prvTgfTtiRuleSet(prvTgfTtiRuleIndex, PRV_TGF_TTI_RULE_MPLS_E,
...
)
{
    ...
    rc = prvTgfTransmitPacketsWithCapture(prvTgfDevNum,
                    ...
                    &prvTgfEthernetOverMplsPacketInfo, 1, 0, NULL,
                    prvTgfDevNum,
...
)
{
    ...
    rc = prvTgfTtiRuleSet(prvTgfTtiRuleIndex,PRV_TGF_TTI_RULE_UDB_30_E, &ttiPattern_forUdbs, &ttiMask_forUdbs, &ruleAction);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfTtiRuleSet");
...
*         - Set Udb
*
*         if testNum>=1 set TTI Generic Range configurations
*/
...
)
{
    ...
    /* src port profileId */
    #define PRV_TGF_SRC_PORT_PROFILE_ID_CNS             3
    /* range classification index in table */
    #define PRV_TGF_RANGE_CLASSIFICATION_INDEX_CNS      8
    ...
    if (testNum == 1)
    {
        ttiPattern.udbArray.udb[28] = 0x99;
        ttiPattern.udbArray.udb[29] = 0x55;
    }
    if (testNum == 2)
    {
        ttiPattern.udbArray.udb[28] = 0x30;
        ttiPattern.udbArray.udb[29] = 0x33;
    }
    ...
    /* AUTODOC:   DA=00:01:02:03:34:02 */
     ...
     rc = prvTgfTtiRuleSet(prvTgfTtiRuleIndex,PRV_TGF_TTI_RULE_UDB_30_E, &ttiPattern, &ttiMask, &ruleAction);
     UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfTtiRuleSet");
    ...
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "p1rvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    ...
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,20,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,21,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,22,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,23,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,24,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,25,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,26,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,27,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,28,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,29,PRV_TGFH_TTI_OFFSET_INVALID_E,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);
    ...
    /* TTI configuration for Generic Range classification according to port profile */
    if (testNum == 1)
    {
        /* Set the Generic Range Source Port Profile ID for specific port */
        rc = cpssDxChTtiGenericRangeSrcPortProfileIdSet(prvTgfDevNum,prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],PRV_TGF_SRC_PORT_PROFILE_ID_CNS);
        ...
        bytePairCfg.anchorType = CPSS_DXCH_TTI_OFFSET_MPLS_MINUS_2_E;
        bytePairCfg.byteOffset = 2; /* outer MPLS lable */
        bytePairCfg.mask[0] = 0xFF;
        bytePairCfg.mask[1] = 0xFF;

        /* Set Generic Range Byte Pair Configuration for byte pair index 0 */
        rc = cpssDxChTtiGenericRangeBytePairCfgSet(prvTgfDevNum,0,&bytePairCfg);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericRangeBytePairCfgSet: %d", prvTgfDevNum);
        ...
        rangeClassifictionParams.profileId = PRV_TGF_SRC_PORT_PROFILE_ID_CNS;
        rangeClassifictionParams.minValue = 0;
        rangeClassifictionParams.maxValue = 0xB;
        rangeClassifictionParams.matchId = 0x55;

        /* Sets the Generic Range Classifiction parameters */
        rc = cpssDxChTtiGenericRangeParamsSet(prvTgfDevNum,PRV_TGF_RANGE_CLASSIFICATION_INDEX_CNS,&rangeClassifictionParams);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericRangeParamsSet: %d", prvTgfDevNum);

        bytePairCfg.enable = GT_TRUE;
        bytePairCfg.anchorType = CPSS_DXCH_TTI_OFFSET_MPLS_MINUS_2_E;
        bytePairCfg.byteOffset = 4; /* inner MPLS lable */
        bytePairCfg.mask[0] = 0xFF;
        bytePairCfg.mask[1] = 0xFF;

        /* Set Generic Range Byte Pair Configuration for byte pair index 1 */
        rc = cpssDxChTtiGenericRangeBytePairCfgSet(prvTgfDevNum,1,&bytePairCfg);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericRangeBytePairCfgSet: %d", prvTgfDevNum);
        ...
        rangeClassifictionParams.profileMode = CPSS_DXCH_GENERIC_RANGE_PROFILE_MODE_PORT_PROFILE_E;
        rangeClassifictionParams.profileId = PRV_TGF_SRC_PORT_PROFILE_ID_CNS;
        rangeClassifictionParams.minValue = 0xB114;
        rangeClassifictionParams.maxValue = 0xC000;
        rangeClassifictionParams.matchId = 0x99;

        /* Sets the Generic Range Classifiction parameters */
        rc = cpssDxChTtiGenericRangeParamsSet(prvTgfDevNum,PRV_TGF_RANGE_CLASSIFICATION_INDEX_CNS+1,&rangeClassifictionParams);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericRangeParamsSet: %d", prvTgfDevNum);
    }
    /* TTI configuration for Generic Range classification according to generic classification default field */
    if (testNum == 2)
    {
        /* restore privious setting */

        /* Set the Generic Range Source Port Profile ID for specific port */
        rc = cpssDxChTtiGenericRangeSrcPortProfileIdSet(prvTgfDevNum,prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],0);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericRangeSrcPortProfileIdSet: %d", prvTgfDevNum);

        bytePairCfg.enable = GT_FALSE;
        bytePairCfg.anchorType = 0;
        bytePairCfg.byteOffset = 0;
        bytePairCfg.mask[0] = 0;
        bytePairCfg.mask[1] = 0;

        /* Set Generic Range Byte Pair Configuration for byte pair index 0 */
        rc = cpssDxChTtiGenericRangeBytePairCfgSet(prvTgfDevNum,0,&bytePairCfg);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericRangeBytePairCfgSet: %d", prvTgfDevNum);

        rangeClassifictionParams.valid = GT_FALSE;
        rangeClassifictionParams.lookupIndex = 0;
        rangeClassifictionParams.profileMode = CPSS_DXCH_GENERIC_RANGE_PROFILE_MODE_NOT_USED_E;
        rangeClassifictionParams.profileId = 0;
        rangeClassifictionParams.minValue = 0;
        rangeClassifictionParams.maxValue = 0;
        rangeClassifictionParams.matchId = 0;
        ...
        /* metadata field generic classification bits 0..7 */
        rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,28,PRV_TGF_TTI_OFFSET_METADATA_E,38);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);

        /* metadata field generic classification bits 8..15 */
        rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,PRV_TGF_TTI_KEY_UDB_MPLS_E,29,PRV_TGF_TTI_OFFSET_METADATA_E,39);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);

        /* set the lsb location in the Generic Classification field of the 10 bits default value */
        rc = cpssDxChTtiGenericClassificationLsbLocationSet(prvTgfDevNum,4);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericClassificationLsbLocationSet: %d", prvTgfDevNum);

        /* set the default value assigned into 10 bits of the Generic Classification field for specific port */
        rc = cpssDxChTtiGenericClassificationDefaultValueSet(prvTgfDevNum,prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],0x333);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericClassificationDefaultValueSet: %d", prvTgfDevNum);
    }
}
...
/**
* @internal prvTgfTunnelTermEtherOverMplsRedirectToEgressGenericClassificationConfigRestore function
* @endinternal
*
* @brief   Restore configuration
*
*/
GT_VOID prvTgfTunnelTermEtherOverMplsRedirectToEgressGenericClassificationConfigRestore
(
    GT_VOID
)
{
    ...
    PRV_UTF_LOG0_MAC("======= Restoring Generic Classification Configuration =======\n");

    /* AUTODOC: unset the lsb location in the Generic Classification field of the 10 bits default value */
    rc = cpssDxChTtiGenericClassificationLsbLocationSet(prvTgfDevNum,0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericClassificationLsbLocationSet: %d", prvTgfDevNum);

    /* AUTODOC: unset the default value assigned into 10 bits of the Generic Classification field for specific port */
    rc = cpssDxChTtiGenericClassificationDefaultValueSet(prvTgfDevNum,prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChTtiGenericClassificationDefaultValueSet: %d", prvTgfDevNum);
}

...
)
{
    ...
    rc = prvTgfTtiRuleSet(ruleIndex, PRV_TGF_TTI_RULE_ETH_E, &pattern, &mask, &ruleAction);
...
)
{
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))
    {
        ...
        cpssDxChTtiQosActionResolutionTableEntrySet(prvTgfDevNum, CPSS_DXCH_TTI_PARALLEL_LOOKUP_E,
                                                    CPSS_DXCH_TTI_LOOKUP_NUM_0_E, 0, &qosActionResolutionParams);
        ...
        cpssDxChTtiTtlActionResolutionTableEntrySet(prvTgfDevNum, CPSS_DXCH_TTI_PARALLEL_LOOKUP_E,
                                                    CPSS_DXCH_TTI_LOOKUP_NUM_0_E, 0, &ttlActionResolutionParams);
    }
    ...
    /* set TTI rule */
    rc = prvTgfTtiRuleSet(ruleIndex, PRV_TGF_TTI_RULE_MPLS_E, &pattern, &mask, &ruleAction);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiRuleSet: %d", prvTgfDevNum);
...
)
{
    ...
    /* set TTI rule */
    rc = prvTgfTtiRuleSet(ruleIndex, PRV_TGF_TTI_RULE_IPV4_E,
...
GT_VOID prvTgfTunnelTermTag1VlanCommandUdbConfigurationSet(GT_VOID)
{
    ...
    /* add taggs for ports */
    rc = prvTgfBrgVlanTagMemberAdd(PRV_TGF_VLANID_5_CNS,prvTgfPortsArray[0],PRV_TGF_BRG_VLAN_PORT_OUTER_TAG1_INNER_TAG0_CMD_E);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgVlanTagMemberAdd: %d", prvTgfDevNum);

    rc = prvTgfBrgVlanTagMemberAdd(PRV_TGF_VLANID_5_CNS,prvTgfPortsArray[1],PRV_TGF_BRG_VLAN_PORT_OUTER_TAG1_INNER_TAG0_CMD_E);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgVlanTagMemberAdd: %d", prvTgfDevNum);

    rc = prvTgfBrgVlanTagMemberAdd(PRV_TGF_VLANID_6_CNS,prvTgfPortsArray[2],PRV_TGF_BRG_VLAN_PORT_OUTER_TAG1_INNER_TAG0_CMD_E);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgVlanTagMemberAdd: %d", prvTgfDevNum);

    rc = prvTgfBrgVlanTagMemberAdd(PRV_TGF_VLANID_6_CNS,prvTgfPortsArray[3],PRV_TGF_BRG_VLAN_PORT_OUTER_TAG1_INNER_TAG0_CMD_E);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgVlanTagMemberAdd: %d", prvTgfDevNum);
    ...
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum, PRV_TGF_TTI_KEY_UDB_ETHERNET_OTHER_E, 1,
                                     PRV_TGF_TTI_OFFSET_METADATA_E, 11);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiUserDefinedByteSet: %d", prvTgfDevNum);

...
/**
********************************************************************************
* @file prvTgfTunnelTermEtherOverIpv4NoRedirectBridging.c
*
...
/* packet's ethertype */
static TGF_PACKET_ETHERTYPE_STC prvTgfPacketEtherTypePartInt = {TGF_ETHERTYPE_0800_IPV4_TAG_CNS};

/* packet's IPv4 */
static TGF_PACKET_IPV4_STC prvTgfPacketIpv4PartInt =
{
    4,                  /* version */
    5,                  /* headerLen */
    0,                  /* typeOfService */
...
static TGF_PACKET_PART_STC prvTgfPacketPartArray[] =
{
    ...
    {TGF_PACKET_PART_IPV4_E,      &prvTgfPacketIpv4PartInt},
...
*         - Enable port 0 for IPv4 lookup
*         - Set IPv4 key lookup MAC mode to Mac DA
*         - Set TTI rule action
*         - Set TTI rule
*
...
)
{
    ...
    GT_U32                      ethType0 = 0x6558;
    GT_U32                      ethTypeGet0 = 0;
    ...
    else
    {
        ...
        rc = prvTgfTtiEthernetTypeSet(prvTgfDevNum, PRV_TGF_TUNNEL_ETHERTYPE_TYPE_IPV4_GRE0_E, ethType0);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfTtiEthernetTypeSet");

        /* get gre ethernet type 0 */
        rc = prvTgfTtiEthernetTypeGet(prvTgfDevNum, PRV_TGF_TUNNEL_ETHERTYPE_TYPE_IPV4_GRE0_E,
                                      &ethTypeGet0);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfTtiEthernetTypeGet");

        /* AUTODOC: read and verify ethType 0 */
        UTF_VERIFY_EQUAL0_STRING_MAC(ethType0, ethTypeGet0, "wrong ethType0 get");
    ...
    /* AUTODOC:   key TTI_KEY_IPV4, cmd FORWARD, redirectCmd TTI_NO_REDIRECT */
    ...
    rc = prvTgfTtiRuleSet(PRV_TGF_TTI_INDEX_CNS, PRV_TGF_TTI_RULE_IPV4_E,
...
)
{
    ...
    /* AUTODOC:   passenger DA=00:00:00:00:34:05, SA=00:00:00:00:00:55, VID=5 */
    ...
    /* AUTODOC: verify to get 3 IPv4 packets on port 1 with: */
    /* AUTODOC:   DA=00:00:00:00:34:05, SA=00:00:00:00:00:55, VID=5 */
...
)
{
    ...
    {
        /* AUTODOC: restore GRE ethernet type 0 */
        rc = prvTgfTtiEthernetTypeSet(prvTgfDevNum, PRV_TGF_TUNNEL_ETHERTYPE_TYPE_IPV4_GRE0_E, prvTgfRestoreCfg.ethType0);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiEthernetTypeSet: %d", prvTgfDevNum);
    }

...
********************************************************************************
* tgfTunnelIpv6CapWap.c
*
* DESCRIPTION:
*       Tunnel Start: Ipv6 Capwap test
*
...
static TGF_PACKET_STC prvTgfGenericIpv6CapwapPacketInfo;
...
)
{
   ...
   /* check is mac entry created */
    ...
    /* use L2 part */
    l2PartPtr = prvTgfGenericIpv6CapwapPacketInfo.partsArray[6].partPtr;
...
/**
* @internal prvTgfTunnelCapwapIpv6TunnelStartConfigurationSet function
* @endinternal
*
* @brief   Set Tunnel Configuration
*/
static GT_VOID prvTgfTunnelCapwapIpv6TunnelStartConfigurationSet
(
    GT_VOID
)
{
    ...
    rc = prvTgfPacketHeaderPartGet(TGF_PACKET_PART_L2_E, &prvTgfGenericIpv6CapwapPacketInfo, (GT_VOID *)&l2PartPtr);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfPacketHeaderPartGet");

    rc = prvTgfPacketHeaderPartGet(TGF_PACKET_PART_IPV6_E, &prvTgfGenericIpv6CapwapPacketInfo, (GT_VOID *)&prvTgfPacketIpv6PartPtr);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfPacketHeaderPartGet");
...
)
{
    ...
    rc = prvTgfPacketGenericIpv6Template8DefaultPacketGet(ip_header_protocol,&prvTgfGenericIpv6CapwapPacketInfo.numOfParts, &prvTgfGenericIpv6CapwapPacketInfo.partsArray);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfPacketGenericIpv6UdpTemplateDefaultPacketGet");
    prvTgfPacketUdpPartPtr = prvTgfGenericIpv6CapwapPacketInfo.partsArray[4].partPtr;
    prvTgfPacketUdpPartPtr->dstPort = 5247;
    prvTgfPacketUdpPartPtr->length = 0x60;
    prvTgfPacketIpv6PartPtr = prvTgfGenericIpv6CapwapPacketInfo.partsArray[3].partPtr;
    prvTgfPacketIpv6PartPtr->payloadLen = 0x60;

    prvTgfPacketVlanTagPtr = prvTgfGenericIpv6CapwapPacketInfo.partsArray[1].partPtr;
    prvTgfPacketVlanTagPtr->vid = PRV_TGF_VLANID_200_CNS;
    prvTgfPacketVlanTagPtr = prvTgfGenericIpv6CapwapPacketInfo.partsArray[7].partPtr;
    prvTgfPacketVlanTagPtr->vid = PRV_TGF_VLANID_10_CNS;
    prvTgfGenericIpv6CapwapPacketInfo.totalLen = TGF_PACKET_AUTO_CALC_LENGTH_CNS;
}
...
)
{
    ...
    /* build expected packet */
     l2PartPtr = prvTgfGenericIpv6CapwapPacketInfo.partsArray[0].partPtr;
     ...
     prvTgfPacketTemplate8PartPtr = prvTgfGenericIpv6CapwapPacketInfo.partsArray[5].partPtr;
    ...
    expectedPacketInfo.numOfParts = prvTgfGenericIpv6CapwapPacketInfo.numOfParts;
    expectedPacketInfo.totalLen = prvTgfGenericIpv6CapwapPacketInfo.totalLen;
    ...
    {
        expectedPacketInfo.partsArray[ii] = prvTgfGenericIpv6CapwapPacketInfo.partsArray[ii];
    }
...
)
{
    ...
    rc = prvTgfTransmitPacketsWithCapture(prvTgfDevNum,
                    ...
                    &prvTgfGenericIpv6CapwapPacketInfo, prvTgfBurstCount, 0, NULL,
                    prvTgfDevNum,
                    prvTgfPortsArray[PRV_TGF_EGR_PORT_IDX_CNS],
...
/**
* @internal prvTgfTunnelIpv6CapwapTest function
* @endinternal
*
* @brief   Capwap test main function
*/
GT_VOID prvTgfTunnelIpv6CapwapTest
(
    GT_VOID
)
{
    ...
    prvTgfTunnelCapwapIpv6TunnelStartConfigurationSet();

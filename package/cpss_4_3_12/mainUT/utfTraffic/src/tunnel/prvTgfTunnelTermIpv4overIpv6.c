...
/**
********************************************************************************
* @file prvTgfTunnelTermIpv4overIpv6.c
*
...
/* packet's IPv4 */
static TGF_PACKET_IPV4_STC prvTgfPacketIpv4OverIpv6Part = {
    4,                  /* version */
    5,                  /* headerLen */
    0,                  /* typeOfService */
    0x2A,               /* totalLen */
...
static TGF_PACKET_PART_STC prvTgfPacketPartArray[] = {
    ...
    {TGF_PACKET_PART_IPV4_E,      &prvTgfPacketIpv4OverIpv6Part},
...
/**
* @internal prvTgfTunnelTermIpv4overIpv6LttRouteConfigurationSet function
* @endinternal
*
...
*                                       None
*/
static GT_VOID prvTgfTunnelTermIpv4overIpv6LttRouteConfigurationSet
(
    GT_U32      prvUtfVrfId
)
{
    ...
    cpssOsMemCpy(ipAddr.arIP, prvTgfPacketIpv4OverIpv6Part.dstAddr, sizeof(ipAddr.arIP));

    /* AUTODOC: add IPv4 UC prefix */
...
/**
* @internal prvTgfTunnelTermIpv4overIpv6PbrConfigurationSet function
* @endinternal
*
...
*                                       None
*/
static GT_VOID prvTgfTunnelTermIpv4overIpv6PbrConfigurationSet
(
    GT_U32      prvUtfVrfId
)
{
    ...
    rc = prvTgfPclDefPortInitExt1(
        ...
        PRV_TGF_PCL_RULE_FORMAT_INGRESS_STD_IPV4_L4_E /*ipv6Key*/,
        PRV_TGF_PCL_RULE_FORMAT_INGRESS_STD_IPV6_DIP_E /*ipv4Key*/);
...
)
{
    ...
    switch(routingMode)
    {
        case PRV_TGF_IP_ROUTING_MODE_PCL_ACTION_E:
            ...
            prvTgfTunnelTermIpv4overIpv6PbrConfigurationSet(prvUtfVrfId);
            break;

        case PRV_TGF_IP_ROUTING_MODE_IP_LTT_ENTRY_E:

            prvTgfTunnelTermIpv4overIpv6LttRouteConfigurationSet(prvUtfVrfId);
            break;
...
)
{
    ...
    ttiPattern.udbArray.udb[0] = (GT_U8)prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS];
    ttiMask.udbArray.udb[0]    = 0xFF;

    /* AUTODOC: set UDB byte for the key keyType: anchor Metadata, offset 22 */
    rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum, PRV_TGF_TTI_KEY_UDB_IPV6_E, 0, PRV_TGF_TTI_OFFSET_METADATA_E, 26);
    ...
    rc = prvTgfTtiRule2Set(prvTgfTtiRuleIndex, PRV_TGF_TTI_KEY_UDB_IPV6_E,
    ...
    for (portIter = 0; portIter < PRV_TGF_PORT_COUNT_CNS; portIter++)
    {
        ...
        switch (portIter)
        {
            ...
            case PRV_TGF_NEXTHOPE_PORT_IDX_CNS:
                ...
                expectedPacketSize = (packetSize - TGF_VLAN_TAG_SIZE_CNS - TGF_IPV6_HEADER_SIZE_CNS + TGF_CRC_LEN_CNS);
...
)
{
    ...
    rc = prvTgfTtiRuleGet(prvTgfDevNum, prvTgfTtiRuleIndex, PRV_TGF_TTI_RULE_IPV4_E,
                          &ttiPattern, &ttiMask, &ttiAction);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiRuleGet: %d", prvTgfDevNum);

    ttiAction.vrfId = 0;

    rc = prvTgfTtiRuleSet(prvTgfTtiRuleIndex, PRV_TGF_TTI_RULE_IPV4_E,
                          &ttiPattern, &ttiMask, &ttiAction);

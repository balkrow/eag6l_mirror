...
)
{
    ...
    rc = cpssDxChBrgVlanPortTranslationEnableSet(prvTgfDevNum, eport1, CPSS_DIRECTION_EGRESS_E, CPSS_DXCH_BRG_VLAN_TRANSLATION_VID0_E);
...
)
{
    ...
    rc = cpssDxChBrgVlanPortTranslationEnableSet(prvTgfDevNum, eport1, CPSS_DIRECTION_EGRESS_E, CPSS_DXCH_BRG_VLAN_TRANSLATION_DISABLE_E);

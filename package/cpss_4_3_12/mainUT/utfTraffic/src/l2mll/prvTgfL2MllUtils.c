        ...
        for(j=0;j<numOfValidMllInPair;j++)
        {
            ...
            if(j==0)
            {
                ...
                case CPSS_INTERFACE_VIDX_E:
                    mllPairEntry.firstMllNode.egressInterface.vidx = testMllDbArr[ii+j].egressInterfaceValue;
                    break;
                default:
                    break;
                }
            ...
            else
            {
                ...
                case CPSS_INTERFACE_TRUNK_E:
                    ...
                    break;
                case CPSS_INTERFACE_VIDX_E:
                    mllPairEntry.secondMllNode.egressInterface.vidx = testMllDbArr[ii+j].egressInterfaceValue;
                    break;
                default:
                    break;
                }

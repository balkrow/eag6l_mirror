...
)
{
    ...
    */
    ...
    {
        rc =  prvTgfBrgFdbBankCounterUpdate(prvTgfDevNum, prvTgfIpv4McFdbEntryIndex%fdbHashNumOfBanks,GT_TRUE);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbBankCounterUpdate: %d", prvTgfIpv4McFdbEntryIndex%fdbHashNumOfBanks);
    }

...
/**
********************************************************************************
* @file prvTgfIpv6UcRpfFailCheck.c
*
...
/**
* @internal prvTgfIpv6UcRpfFailCheckConfig function
* @endinternal
*
...
*/
GT_VOID prvTgfIpv6UcRpfFailCheckConfig
(
    GT_VOID
)
{
...
/**
* @internal prvTgfIpv6UcRpfFailCheckGenerate function
* @endinternal
*
...
*         UC RPF Fail check disabled, nexthopvlanID != packet vlan - packet passed
*/
GT_VOID prvTgfIpv6UcRpfFailCheckGenerate
(
    GT_VOID
)
{
   ...
   /* Transmit packet */
    ...
    /* AUTODOC: Case with UC RPF Fail check disabled and nexthopvlanID != packet_vlan
       since we will not have UC RPF Fail we expect the packet to be bridged */
...
/**
* @internal prvTgfIpv6UcRpfFailCheckRestore function
* @endinternal
*
...
*         8. Invalidate VLANs
*/
GT_VOID prvTgfIpv6UcRpfFailCheckRestore
(
    GT_VOID
)
{

...
)
{
    ...
    cpssOsMemCpy((GT_VOID*) &(lookupInfo.profileEntryParamsArray[TGF_EXACT_MATCH_PROFILE_ID_CNS].keyParams.mask[0]), mask.ruleIngrUdbOnly.udb, sizeof(GT_U8)*PRV_TGF_EXACT_MATCH_MANAGER_MAX_KEY_SIZE_CNS);

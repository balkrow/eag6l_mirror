...
/**
********************************************************************************
* @file prvTgfExactMatchManagerDefaultActionUdbPcl.c
*
...
)
{
    ...
    /* configure profileId=5 for IPCL client */
    lookupInfo.profileEntryParamsArray[TGF_EXACT_MATCH_PROFILE_ID_CNS].defaultActionType=PRV_TGF_EXACT_MATCH_ACTION_PCL_E;
    ...
    lookupInfo.profileEntryParamsArray[TGF_EXACT_MATCH_PROFILE_ID_CNS].defaultAction.pclAction.egressPolicy = GT_FALSE;

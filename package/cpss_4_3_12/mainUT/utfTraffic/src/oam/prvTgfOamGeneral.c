...
GT_BOOL prvTgfEoamSupportedGet(GT_VOID)
{
    return (PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->hwInfo.oam.notSupportEgressOam)  ? GT_FALSE : GT_TRUE;
}
...
)
{
    ...
    static TGF_TCAM_CLIENTS_PCL_SUB_FIELD_CONDITION_STC    subFieldConditionArr[] =
    {
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L2_SRC_MAC_E,
            (8 * (5 - PRV_TGF_OAM_SRC_MAC_BYTE_INDEX_STC)), 8}, 0xFF, 0/*update*/},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L3_ETHERTYPE_E,
            0, 16}, 0xFFFF, TGF_ETHERTYPE_8902_CFM_TAG_CNS},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_STAMP_LIST_END_E, 0, 0}, 0, 0}
    };
    GT_U32 subFieldStartIdx;
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))
    {
        ...
        rc = prvTgfPclDefPortInitSip7(
            ...
            0/*cfgIndex - don't care*/,
            GT_TRUE /*enableLookup*/,
            PRV_TGF_SEND_PORT_IDX_CNS/*pclId*/,
            1/*pclCfgProfileId*/);
        ...
        rc = prvTgfPclDefPortInitSip7(
            ...
            0/*cfgIndex - don't care*/,
            GT_TRUE /*enableLookup*/,
            PRV_TGF_RECEIVE_PORT_IDX_CNS/*pclId*/,
            1/*pclCfgProfileId*/);
        UTF_VERIFY_EQUAL0_NO_RETURN_MAC(GT_OK, rc);
        ...
        rc = prvTgfPclDefPortInitSip7(
            ...
            0/*cfgIndex - don't care*/,
            GT_TRUE /*enableLookup*/,
            PRV_TGF_FDB_PORT_0_IDX_CNS/*pclId*/,
            1/*pclCfgProfileId*/);
        UTF_VERIFY_EQUAL0_NO_RETURN_MAC(GT_OK, rc);
        ...
        for(ruleIndex = 0; ruleIndex < PRV_TGF_IOAM_PCL_RULE_NUM_STC; ruleIndex++)
        {
            ...
            if (testUseTtiForOam == GT_FALSE)
            {
                ...
                cpssAction.oam.oamProfile =
                    PRV_TGF_OAM_PROFILE_INDEX_CNS;
            }
            cpssAction.flowId =
                PRV_TGF_PCL_ACTION_FLOW_ID_CNS + ruleIndex;
            cpssAction.policer.policerEnable =
                CPSS_DXCH_PCL_POLICER_ENABLE_COUNTER_ONLY_E;
            cpssAction.policer.policerId =
                PRV_TGF_CNC_GEN_IPCL_RULE_INDEX_CNS + ruleIndex;

            /* PCL ID */
            commonKeyHeaderMask = 0x3FF;
            commonKeyHeaderPattern =
                (oamIPclRuleInfo[ruleIndex].srcPortTrunk & 0x3FF);
            ...
            devRuleIndex = prvWrAppDxChTcamPclConvertedIndexGet_fromUT(
                prvTgfDevNum, (PRV_TGF_CNC_GEN_IPCL_RULE_INDEX_CNS + (ruleIndex * 3)),
            ...
            rc = tgfTcamClientsPclRuleSet(
                ...
                &(subFieldConditionArr[subFieldStartIdx]), &cpssAction);
            UTF_VERIFY_EQUAL0_NO_RETURN_MAC(GT_OK, rc);
...
)
{
    ...
    static TGF_TCAM_CLIENTS_PCL_SUB_FIELD_CONDITION_STC    subFieldConditionArr[] =
    {
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L2_SRC_MAC_E,
            (8 * (5 - PRV_TGF_OAM_SRC_MAC_BYTE_INDEX_STC)), 8}, 0xFF, 0/*update*/},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_EMETA_EGR_PKT_CMD_E, 0, 2}, 3, 0/*update*/},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L3_ETHERTYPE_E,
            0, 16}, 0xFFFF, TGF_ETHERTYPE_8902_CFM_TAG_CNS},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_STAMP_LIST_END_E, 0, 0}, 0, 0}
    };
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))
    {
        ...
        rc = prvTgfPclDefPortInitSip7(
            ...
            0/*cfgIndex - don't care*/,
            GT_TRUE /*enableLookup*/,
            (PRV_TGF_EPCL_PCL_ID_0_CNS + PRV_TGF_FROM_CPU0_EGRESS_PORT_IDX_CNS)/*pclId*/,
            1/*pclCfgProfileId*/);
        UTF_VERIFY_EQUAL0_NO_RETURN_MAC(GT_OK, rc);
        ...
        rc = prvTgfPclDefPortInitSip7(
            ...
            0/*cfgIndex - don't care*/,
            GT_TRUE /*enableLookup*/,
            (PRV_TGF_EPCL_PCL_ID_0_CNS + PRV_TGF_FROM_CPU1_EGRESS_PORT_IDX_CNS)/*pclId*/,
            1/*pclCfgProfileId*/);
        UTF_VERIFY_EQUAL0_NO_RETURN_MAC(GT_OK, rc);

        /*PRV_TGF_CPU_PORT_IDX_CNS*/
        rc = prvTgfPclDefPortInitSip7(
            ...
            0/*cfgIndex - don't care*/,
            GT_TRUE /*enableLookup*/,
            (PRV_TGF_EPCL_PCL_ID_0_CNS + PRV_TGF_CPU_PORT_IDX_CNS)/*pclId*/,
            1/*pclCfgProfileId*/);
        UTF_VERIFY_EQUAL0_NO_RETURN_MAC(GT_OK, rc);
        ...
        for(ruleIndex = 0; ruleIndex < PRV_TGF_IOAM_PCL_RULE_NUM_STC; ruleIndex++)
        {
            ...
            cpssAction.pktCmd = CPSS_PACKET_CMD_FORWARD_E;
            cpssAction.oam.oamProcessEnable = GT_TRUE;
            cpssAction.oam.oamProfile = PRV_TGF_OAM_PROFILE_INDEX_CNS;
            cpssAction.oam.timeStampEnable =
                (ruleIndex < PRV_TGF_EOAM_DM_PCL_RULE_NUM_STC) ?
                GT_TRUE : GT_FALSE;
            cpssAction.oam.offsetIndex = ruleIndex;
            cpssAction.flowId = PRV_TGF_EPCL_ACTION_FLOW_ID_CNS + ruleIndex;
            cpssAction.policer.policerEnable =
                CPSS_DXCH_PCL_POLICER_ENABLE_COUNTER_ONLY_E;
            cpssAction.policer.policerId =
                POLICER_MASK(PRV_TGF_CNC_GEN_EPCL_RULE_INDEX_CNS + ruleIndex);
            ...
            commonKeyHeaderMask = 0x3FF;
            commonKeyHeaderPattern =
                ((PRV_TGF_EPCL_PCL_ID_0_CNS + oamEPclRuleInfo[ruleIndex].trgPortTrunk) & 0x3FF);
            ...
            switch(oamEPclRuleInfo[ruleIndex].pktType)
            {
                ...
                case PRV_TGF_PCL_EGRESS_PKT_FROM_CPU_DATA_E:
                    subFieldConditionArr[1].pattern = PRV_TGF_PKT_CMD_FROM_CPU_CNS;
                    break;
                case PRV_TGF_PCL_EGRESS_PKT_TO_CPU_E:
                default:
                    subFieldConditionArr[1].pattern = PRV_TGF_PKT_CMD_TO_CPU_CNS;
                    break;
            }

            devRuleIndex = prvWrAppDxChTcamPclConvertedIndexGet_fromUT(
                prvTgfDevNum, (PRV_TGF_CNC_GEN_EPCL_RULE_INDEX_CNS + (ruleIndex * 3)),
                CPSS_DXCH_TCAM_RULE_SIZE_30_B_E);
            rc = tgfTcamClientsPclRuleSet(
                prvTgfDevNum, prvTgfTcamClientCommomHandlersHandleGet(0),
                1 /*pclCfgProfileId*/,
                ...
                GT_TRUE /*writeValidRule*/,
                &commonKeyHeaderMask, &commonKeyHeaderPattern,
                &(subFieldConditionArr[0]), &cpssAction);
            UTF_VERIFY_EQUAL0_NO_RETURN_MAC(GT_OK, rc);
...
{
    GT_STATUS rc;
    GT_U32  ipclReservedUdbBmpArr[2] =
    {
        /* 1,3,5,7,PRV_TGF_PCL_UDE_UDB_INDEX_CNS*/
        ((1 << 1) | (1 << 3) | (1 << 5) | (1 << 7) | (1 << PRV_TGF_PCL_UDE_UDB_INDEX_CNS)), 0
    };
    GT_U32  epclReservedUdbBmpArr[2] = {0, 0};
    static const TGF_TCAM_CLIENTS_PCL_RULE_SUB_FIELD_STC ipclSubFieldArr[] =
    {
        /*MAC_SA, etherType, pclId*/
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L2_SRC_MAC_E,
            (8 * (5 - PRV_TGF_OAM_SRC_MAC_BYTE_INDEX_STC)), 8},
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L3_ETHERTYPE_E, 0, 16},
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_STAMP_LIST_END_E, 0, 0}
    };
    static const TGF_TCAM_CLIENTS_PCL_RULE_SUB_FIELD_STC epclSubFieldArr[] =
    {
        /*MAC_SA, etherType, pacet_command, pclId*/
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L2_SRC_MAC_E,
            (8 * (5 - PRV_TGF_OAM_SRC_MAC_BYTE_INDEX_STC)), 8},
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L3_ETHERTYPE_E, 0, 16},
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_EMETA_EGR_PKT_CMD_E, 0, 2},
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_STAMP_LIST_END_E, 0, 0}
    };
    ...
    {
        prvTgfSip7TcamClientsDbHandleDelete();
        rc = prvTgfSip7TcamClientsIngressAndEgressPclLookupsDevInit(
            prvTgfDevNum, TGF_TCAM_CLIENTS_PCL_LOOKUP_IPCL0_E,
            ipclReservedUdbBmpArr, epclReservedUdbBmpArr,
            CPSS_DXCH_TCAM_RULE_SIZE_30_B_E /*ipclTcamKeySize*/,
            CPSS_DXCH_TCAM_RULE_SIZE_30_B_E /*epclTcamKeySize*/,
            ipclSubFieldArr, epclSubFieldArr);
        UTF_VERIFY_EQUAL0_STRING_MAC(
            GT_OK, rc, "prvTgfSip7TcamClientsIngressAndEgressPclLookupsDevInit");
    }
...
)
{
    ...
    GT_U8     firstMegLevel;
    PRV_TGF_OAM_COMMON_CONFIG_STC oamConfig;    /* OAM configuration */
    CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC  exceptionConfig;
    ...
    if(PRV_CPSS_IS_MULTI_PORT_GROUPS_DEVICE_MAC(prvTgfDevNum))
    {
        ...
        rc = cpssDxChPortPhysicalPortDetailedMapGet(prvTgfDevNum,
                prvTgfPortsArray[PRV_TGF_SEND_PORT_IDX_CNS],
                &portMapShadow);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "cpssDxChPortPhysicalPortDetailedMapGet");
        currPortGroupsBmp = (1 << portMapShadow.portMap.portGroup);
    }
    ...
    /* Validate meg level status - As no Exception occured */
    cpssOsMemSet(&oamConfig, 0, sizeof(oamConfig));
    oamConfig.oamEntryIndex = 3;
    prvTgfOamConfigurationGet(&oamConfig);

    if (PRV_CPSS_SIP_5_15_CHECK_MAC(prvTgfDevNum))
    {
        UTF_VERIFY_EQUAL1_STRING_MAC(PRV_TGF_OAM_EXCEPTION_STATUS_PASS_E,
                oamConfig.oamEntry.megLevelStatus,
                "prvTgfOamConfigurationGet: %d", prvTgfDevNum);

        /* Set exception suppress packet command */
        exceptionConfig.command = CPSS_PACKET_CMD_TRAP_TO_CPU_E;
        exceptionConfig.cpuCode = CPSS_NET_FIRST_USER_DEFINED_E + PRV_TGF_OAM_EXCEPTION_TYPE_MEG_LEVEL_E;
        rc = cpssDxChOamExceptionSuppressConfigSet(
                prvTgfDevNum,
                CPSS_DXCH_OAM_STAGE_TYPE_INGRESS_E,
                CPSS_DXCH_OAM_EXCEPTION_TYPE_MEG_LEVEL_E,
                &exceptionConfig);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc,
                "prvTgfOamExceptionSuppressConfigSet: %d", prvTgfDevNum);

        /* Set exception recovery packet command */
        rc = cpssDxChOamExceptionRecoveryConfigSet(
                prvTgfDevNum,
                CPSS_DXCH_OAM_STAGE_TYPE_INGRESS_E,
                CPSS_DXCH_OAM_EXCEPTION_TYPE_MEG_LEVEL_E,
                &exceptionConfig);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc,
                "cpssDxChOamExceptionRecoveryConfigSet: %d", prvTgfDevNum);
        oamConfig.oamEntry.megLevel = 4;
    }

    /* AUTODOC: Set OAM PDU header MEL = 0, 1, 2, 4
     * 0 - Exception generated
     * 1 - Exception Generated
     * 2 - Enable suppress,
     *      Exception Suppressed, verify suppress command (Status will be FAIL, due to previous exception)
     *      Disable Suppress
     * 4 - Exception Recovered, Verify recovered command.
     */
    for(pduHeaderData.megLevel = 0; pduHeaderData.megLevel < 5; pduHeaderData.megLevel++)
    {
        ...
        oamConfig.oamEntry.megLevelStormSuppressEnable =
            (pduHeaderData.megLevel == 2)?GT_TRUE:GT_FALSE;
        prvTgfOamConfigurationSet(&oamConfig);
        ...
        /* Validate meg level status - As exception occured */
        prvTgfOamConfigurationGet(&oamConfig);
        if(PRV_CPSS_SIP_5_15_CHECK_MAC(prvTgfDevNum) &&
                ((pduHeaderData.megLevel == 2) ||
            (pduHeaderData.megLevel == 4)))
        {
            /* Case to validate suppress */
            ...
            if(pduHeaderData.megLevel == 4)
            {
                /* megLevel == 4, is recovered */
                UTF_VERIFY_EQUAL1_STRING_MAC(PRV_TGF_OAM_EXCEPTION_STATUS_PASS_E,
                        oamConfig.oamEntry.megLevelStatus,
                        "prvTgfOamConfigurationGet: %d", prvTgfDevNum);
            }
            ...
            {
                /* megLevel == 2, is suppressed */
                UTF_VERIFY_EQUAL1_STRING_MAC(PRV_TGF_OAM_EXCEPTION_STATUS_FAIL_E,
                        oamConfig.oamEntry.megLevelStatus,
                        "prvTgfOamConfigurationGet: %d", prvTgfDevNum);
            }
        }
    ...
    /* MEL = 5 use EOAM, skip it if EOAM not supported */
    firstMegLevel = prvTgfEoamSupportedGet() ? 5 : 6;

    for(pduHeaderData.megLevel = firstMegLevel; pduHeaderData.megLevel < 8; pduHeaderData.megLevel++)
    {
        /* AUTODOC: Set source mac address byte */
        prvTgfOamPacketHeaderSrcMacByteSet(
                    PRV_TGF_OAM_SRC_MAC_BYTE_INDEX_STC,
...
)
{
    ...
    if (PRV_CPSS_SIP_5_15_CHECK_MAC(prvTgfDevNum))
    {
        /* AUTODOC: Validate source interface status - As Exception occured */
        prvTgfOamConfigurationGet(&oamConfig);
        UTF_VERIFY_EQUAL1_STRING_MAC(PRV_TGF_OAM_EXCEPTION_STATUS_FAIL_E,
                oamConfig.oamEntry.sourceInterfaceStatus,
                "prvTgfOamConfigurationGet: %d", prvTgfDevNum);
    }
   ...
   /* AUTODOC: Source Interface Match/Source Interface Port */
    ...
    if (PRV_CPSS_SIP_5_15_CHECK_MAC(prvTgfDevNum))
    {
        ...
        /* AUTODOC: Validate source interface status - As no exception occured */
        UTF_VERIFY_EQUAL1_STRING_MAC(PRV_TGF_OAM_EXCEPTION_STATUS_PASS_E,
                oamConfig.oamEntry.sourceInterfaceStatus,
                "prvTgfOamConfigurationGet: %d", prvTgfDevNum);
        ...
        /* Set exception suppress packet command */
        exceptionConfig.command = CPSS_PACKET_CMD_TRAP_TO_CPU_E;
        exceptionConfig.cpuCode = CPSS_NET_FIRST_USER_DEFINED_E + PRV_TGF_OAM_EXCEPTION_TYPE_SOURCE_INTERFACE_E;
        rc = cpssDxChOamExceptionSuppressConfigSet(
                prvTgfDevNum,
                CPSS_DXCH_OAM_STAGE_TYPE_INGRESS_E,
        ...
        /* AUTODOC: Enable suppress */
        oamConfig.oamEntry.sourceInterfaceStormSuppressEnable   = GT_TRUE;
        oamConfig.oamEntry.sourceInterfaceStatus                = 1;
        prvTgfOamConfigurationSet(&oamConfig);
        ...
        /* AUTODOC: Validate source interface status - As no Exception occured (Previous state is fail)*/
        prvTgfOamConfigurationGet(&oamConfig);
        UTF_VERIFY_EQUAL1_STRING_MAC(PRV_TGF_OAM_EXCEPTION_STATUS_PASS_E,
                oamConfig.oamEntry.sourceInterfaceStatus,
                "prvTgfOamConfigurationGet: %d", prvTgfDevNum);
    ...
    /* AUTODOC: clear the event status */
    oamConfig.oamEntry.sourceInterfaceStormSuppressEnable = GT_FALSE;

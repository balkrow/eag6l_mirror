...
UTF_TEST_CASE_MAC(tgfOamDelayMeasurementVerification)
{
 /*
    ...
    3. Restore VLAN and IPCL configuration
 */
    /* for AAS PCL code updated, test fails - debugging needed */
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, UTF_XCAT3_E | UTF_AC5_E | UTF_LION2_E | UTF_IRONMAN_L_E | UTF_AAS_E);
 ...
 */
    /* for AAS PCL code updated, test fails - debugging needed */
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, UTF_XCAT3_E | UTF_AC5_E | UTF_LION2_E | UTF_AAS_E);
...
UTF_TEST_CASE_MAC(tgfEOamKeepAliveFlowHashVerificationBitSelection)
{
    /*
        ...
        start start bit
    */
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, UTF_XCAT3_E | UTF_AC5_E | UTF_LION2_E | UTF_BOBCAT2_E | UTF_IRONMAN_L_E);
...
UTF_TEST_CASE_MAC(tgfSrv6OneSegmentUseCaseVerification)
{
    ...
    */
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, UTF_XCAT3_E | UTF_AC5_E | UTF_LION2_E | UTF_BOBCAT2_E | UTF_CAELUM_E |
        UTF_ALDRIN_E | UTF_AC3X_E | UTF_BOBCAT3_E | UTF_ALDRIN2_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E);
...
UTF_TEST_CASE_MAC(tgfEgressMirroringMetadataVerification)
{
    ...
    */
    ...
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, UTF_XCAT3_E | UTF_AC5_E | UTF_LION2_E | UTF_BOBCAT2_E | UTF_CAELUM_E |
        UTF_ALDRIN_E | UTF_AC3X_E | UTF_BOBCAT3_E | UTF_ALDRIN2_E | UTF_FALCON_E | UTF_IRONMAN_L_E | UTF_AAS_E);
...
UTF_TEST_CASE_MAC(tgfSrv6BestEffortTunnelParseOnLeafNodeVerification)
{
    ...
    */
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, UTF_XCAT3_E | UTF_AC5_E | UTF_LION2_E | UTF_BOBCAT2_E | UTF_CAELUM_E |
        UTF_ALDRIN_E | UTF_AC3X_E | UTF_BOBCAT3_E | UTF_ALDRIN2_E | UTF_IRONMAN_L_E | UTF_AAS_E | UTF_FALCON_E);

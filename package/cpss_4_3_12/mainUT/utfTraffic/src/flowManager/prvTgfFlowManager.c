...
)
{
    ...
    prvTgfFlowManagerQinQEnableSet(GT_FALSE);
}
...
)
{
    ...
    UTF_VERIFY_EQUAL2_STRING_MAC(flowMngDbPtr->flowCounterDb[flowId[2]].packetCount, 0x2, "Existing flow packet count %d"
                                    "different than in DB %d",0x2, flowMngDbPtr->flowCounterDb[0].packetCount);
    UTF_VERIFY_EQUAL2_STRING_MAC(flowMngDbPtr->flowCounterDb[flowId[2]].byteCount, 0xB2, "Existing flow byte count %d"
                                    "different than in DB %d",0xB2, flowMngDbPtr->flowCounterDb[0].byteCount);
    UTF_VERIFY_EQUAL2_STRING_MAC(flowMngDbPtr->flowCounterDb[flowId[2]].dropCount, 0x0, "Existing flow drop count %d"
                                 "different than in DB %d",0x0, flowMngDbPtr->flowCounterDb[0].dropCount);

    /* Validate IPV4-UDP flows */
    UTF_VERIFY_EQUAL2_STRING_MAC(flowMngDbPtr->flowCounterDb[flowId[1]].flowId, flowId[1], "Existing flow id %d"
                                 "different than in DB %d", flowId[1], flowMngDbPtr->flowCounterDb[flowId[1]].flowId);
    UTF_VERIFY_EQUAL2_STRING_MAC(flowMngDbPtr->flowCounterDb[1].packetCount, 0x2, "Existing flow packet count %d"
                                    "different than in DB %d",0x2, flowMngDbPtr->flowCounterDb[1].packetCount);
...
)
{
    ...
    UTF_VERIFY_EQUAL2_STRING_MAC(flowMngDbPtr->flowCounterDb[0].packetCount, 0x2, "Existing flow packet count %d"
                                    "different than in DB %d",0x2, flowMngDbPtr->flowCounterDb[0].packetCount);
    UTF_VERIFY_EQUAL2_STRING_MAC(flowMngDbPtr->flowCounterDb[0].byteCount, 0xB2, "Existing flow byte count %d"
                                    "different than in DB %d",0xB2, flowMngDbPtr->flowCounterDb[0].byteCount);
    UTF_VERIFY_EQUAL2_STRING_MAC(flowMngDbPtr->flowCounterDb[0].dropCount, 0x0, "Existing flow drop count %d"
                                 "different than in DB %d",0x0, flowMngDbPtr->flowCounterDb[0].dropCount);
    ...
    UTF_VERIFY_EQUAL0_STRING_MAC(isEqual,
        0x1, "flow dst ip different than expected");
    UTF_VERIFY_EQUAL0_STRING_MAC(prvTgfPacket1UdpPart.srcPort,
        flowMngDbPtr->flowDataDb[flowId[1]].keyData[13], "flow udp src port different than expected");
    UTF_VERIFY_EQUAL0_STRING_MAC(prvTgfPacket1UdpPart.dstPort,
        flowMngDbPtr->flowDataDb[flowId[1]].keyData[15], "flow udp dst port different than expected");
    ...
    UTF_VERIFY_EQUAL0_STRING_MAC(isEqual,
        0x1, "flow dst ip different than expected");
    UTF_VERIFY_EQUAL0_STRING_MAC(prvTgfPacket1TcpPart.srcPort,
        flowMngDbPtr->flowDataDb[flowId[2]].keyData[13], "flow tcp src port different than expected");
    UTF_VERIFY_EQUAL0_STRING_MAC(prvTgfPacket1TcpPart.dstPort,
        flowMngDbPtr->flowDataDb[flowId[2]].keyData[15], "flow tcp dst port different than expected");

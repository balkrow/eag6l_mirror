...
/* Functions to convert CPSS_DXCH_CNC_ to PRV_TGF_CNC_ */

void cnvCNC_CLIENT_ENT_dxch2tgf
(
    IN   CPSS_DXCH_CNC_CLIENT_ENT  dxchCncClient,
    OUT  PRV_TGF_CNC_CLIENT_ENT    *tgfCncClientPtr
)
{
    switch (dxchCncClient)
    {
        case CPSS_DXCH_CNC_CLIENT_L2L3_INGRESS_VLAN_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_L2L3_INGRESS_VLAN_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_1_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_1_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_VLAN_PASS_DROP_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_VLAN_PASS_DROP_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_VLAN_PASS_DROP_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_VLAN_PASS_DROP_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_QUEUE_PASS_DROP_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_QUEUE_PASS_DROP_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_PCL_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_ARP_TABLE_ACCESS_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_ARP_TABLE_ACCESS_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_TUNNEL_START_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_TUNNEL_START_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_TTI_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_TTI_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_SRC_EPORT_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_SRC_EPORT_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_TRG_EPORT_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_TRG_EPORT_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_0_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_TTI_PARALLEL_0_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_1_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_TTI_PARALLEL_1_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_0_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_0_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_1_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_1_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_2_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_2_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_3_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_3_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_0_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_0_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_1_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_1_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_2_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_2_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_3_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_3_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_2_PARALLEL_0_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_2_PARALLEL_0_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_2_PARALLEL_1_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_2_PARALLEL_1_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_2_PARALLEL_2_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_2_PARALLEL_2_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_2_PARALLEL_3_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_INGRESS_PCL_LOOKUP_2_PARALLEL_3_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_0_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_PCL_PARALLEL_0_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_1_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_PCL_PARALLEL_1_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_2_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_PCL_PARALLEL_2_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_3_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_PCL_PARALLEL_3_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_PACKET_TYPE_PASS_DROP_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_PACKET_TYPE_PASS_DROP_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_TM_PASS_DROP_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_TM_PASS_DROP_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_2_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_TTI_PARALLEL_2_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_3_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_TTI_PARALLEL_3_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_VLAN_EGRESS_FILTER_PASS_DROP_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_VLAN_EGRESS_FILTER_PASS_DROP_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_PACKET_TYPE_PASS_DROP_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_EGRESS_PACKET_TYPE_PASS_DROP_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_PHA_E:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_PHA_E;
            break;
        default:
            *tgfCncClientPtr = PRV_TGF_CNC_CLIENT_LAST_E;
            break;
    }
}
    ...
    switch (tgfCncCounterFormat)
    {
        ...
        case PRV_TGF_CNC_COUNTER_FORMAT_MODE_2_E:
            *dxchCncCounterFormatPtr =
            ...
            break;
        case PRV_TGF_CNC_COUNTER_FORMAT_MODE_3_E:
            *dxchCncCounterFormatPtr =
                CPSS_DXCH_CNC_COUNTER_FORMAT_MODE_3_E;
            break;
        case PRV_TGF_CNC_COUNTER_FORMAT_MODE_4_E:
            *dxchCncCounterFormatPtr =
...
static void cnvCNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT_tgf2dxch
(
    IN  PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT   tgfCncEgrPacketTypeIndexMode,
    OUT CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT *dxchCncEgrPacketTypeModePtr
)
{
    switch (tgfCncEgrPacketTypeIndexMode)
    {
        case PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CMD_AND_CODE_E:
            *dxchCncEgrPacketTypeModePtr = CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CMD_AND_CODE_E;
            break;
        case PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CODE_ONLY_E:
            *dxchCncEgrPacketTypeModePtr = CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CODE_ONLY_E;
            break;
        default:
            /* wrong value */
            *dxchCncEgrPacketTypeModePtr = CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CODE_ONLY_E + 1;
            break;
    }
}

static void cnvCNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT_dxch2tgf
(
    IN  CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT dxchCncEgrPacketTypeMode,
    OUT PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT   *tgfCncEgrPacketTypeIndexModePtr
)
{
    switch (dxchCncEgrPacketTypeMode)
    {
        case CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CMD_AND_CODE_E:
            *tgfCncEgrPacketTypeIndexModePtr = PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CMD_AND_CODE_E;
            break;
        case CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CODE_ONLY_E:
            *tgfCncEgrPacketTypeIndexModePtr = PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CODE_ONLY_E;
            break;
        default:
            /* wrong value */
            *tgfCncEgrPacketTypeIndexModePtr = PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CODE_ONLY_E + 1;
            break;
    }
}

static void cnvCNC_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC_tgf2dxch
(
    IN  PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC       *tgfCncSharedClientsConfigPtr,
    OUT CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC     *dxchCncSharedClientsConfigPtr
)
{
    CPSS_DXCH_CNC_CLIENT_ENT dxchClient;

    cnvCNC_CLIENT_ENT_tgf2dxch(tgfCncSharedClientsConfigPtr->clientSelect, &dxchClient);
    dxchCncSharedClientsConfigPtr->clientEnable        = tgfCncSharedClientsConfigPtr->clientEnable;
    dxchCncSharedClientsConfigPtr->clientSelect        = dxchClient;
    dxchCncSharedClientsConfigPtr->clientOffset        = tgfCncSharedClientsConfigPtr->clientOffset;
    dxchCncSharedClientsConfigPtr->indexRangesBmp.l[0] = tgfCncSharedClientsConfigPtr->indexRangesBmp.l[0];
}

static void cnvCNC_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC_dxch2tgf
(
    IN  CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC     *dxchCncSharedClientsConfigPtr,
    OUT PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC       *tgfCncSharedClientsConfigPtr
)
{
    PRV_TGF_CNC_CLIENT_ENT tgfClient;

    cnvCNC_CLIENT_ENT_dxch2tgf(dxchCncSharedClientsConfigPtr->clientSelect, &tgfClient);
    tgfCncSharedClientsConfigPtr->clientEnable        = dxchCncSharedClientsConfigPtr->clientEnable;
    tgfCncSharedClientsConfigPtr->clientSelect        = tgfClient;
    tgfCncSharedClientsConfigPtr->clientOffset        = dxchCncSharedClientsConfigPtr->clientOffset;
    tgfCncSharedClientsConfigPtr->indexRangesBmp.l[0] = dxchCncSharedClientsConfigPtr->indexRangesBmp.l[0];
}
...
)
{
    ...
    CPSS_DXCH_CNC_COUNTER_STC           dxchCounter;
    GT_BOOL                             enableClear;
    CPSS_DXCH_CNC_COUNTER_STC           dxchClearByReadValue;
    GT_BOOL                             setNonZeroValue;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        if(PRV_CPSS_SIP_5_20_CHECK_MAC(devNum))
        {
            ...
            /* do not call cpssDxChCncCounterSet(...) because it generate ERROR
                into the 'error LOG' */
            if ((counterPtr->packetCount.l[0]) || (counterPtr->packetCount.l[1]) ||
                (counterPtr->byteCount.l[0]) || (counterPtr->byteCount.l[1]))
            {
                setNonZeroValue = GT_TRUE;
            }
        ...
        if (GT_OK != rc)
        {
            if (rc == GT_NOT_APPLICABLE_DEVICE)
            {
                ...
                if(setNonZeroValue)
                {
                    /* save Clear By Read value */
                    rc = cpssDxChCncCounterClearByReadValueGet(devNum,dxchCounterFormat, &dxchClearByReadValue);
                    if (GT_OK != rc)
                    {
                        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChCncCounterClearByReadValueGet FAILED, rc = [%d]\n", rc);
                    }

                    /* set Clear By Read value by value of counter */
                    rc = cpssDxChCncCounterClearByReadValueSet(devNum,dxchCounterFormat, &dxchCounter);
                    if (GT_OK != rc)
                    {
                        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChCncCounterClearByReadValueSet FAILED, rc = [%d]\n", rc);
                    }
                ...
                if(setNonZeroValue)
                {
                    /* restore Clear By Read value */
                    rc = cpssDxChCncCounterClearByReadValueSet(devNum,dxchCounterFormat, &dxchClearByReadValue);
                    if (GT_OK != rc)
                    {
                        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChCncCounterClearByReadValueSet FAILED, rc = [%d]\n", rc);
                    }
...
/**
* @internal prvTgfCncEgressPacketTypePassDropClientIndexModeSet function
* @endinternal
*
...
*
*/
GT_STATUS prvTgfCncEgressPacketTypePassDropClientIndexModeSet
(
    IN  GT_U8                                                       devNum,
    IN  PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT        indexMode
)
{
#if (defined CHX_FAMILY)
    GT_STATUS                rc, rc1 = GT_OK;
...
#ifdef CHX_FAMILY
    CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT dxchCncEgrPktTypeIndexMode;

    cnvCNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT_tgf2dxch(indexMode, &dxchCncEgrPktTypeIndexMode);
    ...
    {
        /* call device specific API */
        rc = cpssDxChCncEgressPacketTypePassDropClientIndexModeSet(
            devNum, dxchCncEgrPktTypeIndexMode);
        if (GT_OK != rc)
        {
            PRV_UTF_LOG1_MAC("[TGF]: cpssDxChCncEgressPacketTypePassDropClientIndexModeSet FAILED, rc = [%d]\n", rc);
...
/**
* @internal prvTgfCncEgressPacketTypePassDropClientIndexModeGet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvTgfCncEgressPacketTypePassDropClientIndexModeGet
(
    IN  GT_U8                                                       devNum,
    OUT PRV_TGF_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT        *indexModePtr
)
{
#if (defined CHX_FAMILY)
    GT_STATUS                rc, rc1 = GT_OK;
    ...
    devNum  = prvTgfDevNum;
    /* call device specific API */
    rc = cpssDxChCncEgressPacketTypePassDropClientIndexModeGet(
        devNum, &dxchCncEgrPktTypeIndexMode);
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChCncEgressPacketTypePassDropClientIndexModeGet FAILED, rc = [%d]\n", rc);
        rc1 = rc;
    }
    cnvCNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT_dxch2tgf(dxchCncEgrPktTypeIndexMode, indexModePtr);
    return rc1;
#endif /* CHX_FAMILY */
}

/**
* @internal prvTgfCncBlockSharedClientConfigSet function
* @endinternal
*
...
*
*/
GT_STATUS prvTgfCncBlockSharedClientConfigSet
(
    IN  GT_U8                                          devNum,
    IN  GT_U32                                         blockNum,
    IN  GT_U32                                         clientIndex,
    IN  PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC    *clientsConfigPtr
)
{
#if (defined CHX_FAMILY)
    GT_STATUS                rc, rc1 = GT_OK;
...
#ifdef CHX_FAMILY
    CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC sharedClientsConfigPtr;

    cnvCNC_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC_tgf2dxch(clientsConfigPtr, &sharedClientsConfigPtr);
    ...
    {
        /* call device specific API */
        rc = cpssDxChCncBlockSharedClientConfigSet(
            devNum, blockNum, clientIndex,
            &sharedClientsConfigPtr);
        if (GT_OK != rc)
        {
            PRV_UTF_LOG1_MAC("[TGF]: cpssDxChCncBlockSharedClientConfigSet FAILED, rc = [%d]\n", rc);
...
/**
* @internal prvTgfCncBlockSharedClientConfigGet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvTgfCncBlockSharedClientConfigGet
(
    IN  GT_U8                                          devNum,
    IN  GT_U32                                         blockNum,
    IN  GT_U32                                         clientIndex,
    OUT PRV_TGF_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC   *clientsConfigPtr
)
{
#if (defined CHX_FAMILY)
    GT_STATUS                rc, rc1 = GT_OK;
    ...
    {
        /* call device specific API */
        rc = cpssDxChCncBlockSharedClientConfigGet(
            devNum, blockNum, clientIndex,
            &sharedClientsConfigPtr);
        if (GT_OK != rc)
        {
            PRV_UTF_LOG1_MAC("[TGF]: cpssDxChCncBlockSharedClientConfigGet FAILED, rc = [%d]\n", rc);

            rc1 = rc;
        }
    }
    cnvCNC_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC_dxch2tgf(&sharedClientsConfigPtr, clientsConfigPtr);
    return rc1;

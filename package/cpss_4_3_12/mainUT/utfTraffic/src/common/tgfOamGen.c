...
#define PRV_TGF_S2D_OAM_EXCEPTION_STATUS_CONVERT(dstStcPtr, srcStcPtr, field)   \
    {                                                                           \
        switch(srcStcPtr->field)                                                \
        {                                                                       \
            case PRV_TGF_OAM_EXCEPTION_STATUS_PASS_E:                           \
                (dstStcPtr)->field = CPSS_DXCH_OAM_EXCEPTION_STATUS_PASS_E;     \
                break;                                                          \
            case PRV_TGF_OAM_EXCEPTION_STATUS_FAIL_E:                           \
                (dstStcPtr)->field = CPSS_DXCH_OAM_EXCEPTION_STATUS_FAIL_E;     \
                break;                                                          \
            default:                                                            \
                return GT_BAD_PARAM;                                            \
        }                                                                       \
...
#define PRV_TGF_D2S_OAM_EXCEPTION_STATUS_CONVERT(dstStcPtr, srcStcPtr, field)   \
    {                                                                           \
        switch(dstStcPtr->field)                                                \
        {                                                                       \
            case CPSS_DXCH_OAM_EXCEPTION_STATUS_PASS_E:                         \
                (srcStcPtr)->field = PRV_TGF_OAM_EXCEPTION_STATUS_PASS_E;       \
                break;                                                          \
            case CPSS_DXCH_OAM_EXCEPTION_STATUS_FAIL_E:                         \
                (srcStcPtr)->field = PRV_TGF_OAM_EXCEPTION_STATUS_FAIL_E;       \
                break;                                                          \
            default:                                                            \
                return GT_BAD_PARAM;                                            \
        }                                                                       \
...
)
{
    ...
    cpssOsMemSet(dxChOamEntryPtr, 0, sizeof(CPSS_DXCH_OAM_ENTRY_STC));
    ...
    switch (dxChOamEntryPtr->sourceInterface.type)
    {
        case CPSS_INTERFACE_PORT_E:
            rc = prvUtfHwDeviceNumberGet(oamEntryPtr->sourceInterface.devPort.hwDevNum,
    ...
    PRV_TGF_STC_S2D_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, keepaliveAgingStormSuppressEnable);
    PRV_TGF_STC_S2D_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, invalidHashKeepaliveStormSuppressEnable);
    PRV_TGF_STC_S2D_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, megLevelStormSuppressEnable);
    PRV_TGF_STC_S2D_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, sourceInterfaceStormSuppressEnable);
    PRV_TGF_STC_S2D_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, txPeriodStormSuppressEnable);
    PRV_TGF_STC_S2D_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, ignoreBadKeepAliveInAgingEnable);
    PRV_TGF_STC_S2D_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, protectionRdiState);
    PRV_TGF_STC_S2D_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, protectionOnRdiEnable);
    PRV_TGF_STC_S2D_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, locDetectionDisable);

    PRV_TGF_S2D_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, keepaliveAgingStatus);
    PRV_TGF_S2D_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, megLevelStatus);
    PRV_TGF_S2D_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, sourceInterfaceStatus);
    PRV_TGF_S2D_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, txPeriodStatus);
    PRV_TGF_S2D_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, hashVerificationStatus);
    return GT_OK;
}
...
)
{
    ...
    PRV_TGF_STC_D2S_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, keepaliveAgingStormSuppressEnable);
    PRV_TGF_STC_D2S_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, invalidHashKeepaliveStormSuppressEnable);
    PRV_TGF_STC_D2S_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, megLevelStormSuppressEnable);
    PRV_TGF_STC_D2S_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, sourceInterfaceStormSuppressEnable);
    PRV_TGF_STC_D2S_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, txPeriodStormSuppressEnable);
    PRV_TGF_STC_D2S_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, ignoreBadKeepAliveInAgingEnable);
    PRV_TGF_STC_D2S_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, protectionRdiState);
    PRV_TGF_STC_D2S_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, protectionOnRdiEnable);
    PRV_TGF_STC_D2S_FIELD_COPY_MAC(dxChOamEntryPtr, oamEntryPtr, locDetectionDisable);

    PRV_TGF_D2S_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, keepaliveAgingStatus);
    PRV_TGF_D2S_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, megLevelStatus);
    PRV_TGF_D2S_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, sourceInterfaceStatus);
    PRV_TGF_D2S_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, txPeriodStatus);
    PRV_TGF_D2S_OAM_EXCEPTION_STATUS_CONVERT(dxChOamEntryPtr, oamEntryPtr, hashVerificationStatus);
    return GT_OK;
}

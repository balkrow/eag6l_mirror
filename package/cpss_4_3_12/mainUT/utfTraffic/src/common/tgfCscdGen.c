...
)
{
    ...
    {
        case PRV_TGF_NET_DSA_CMD_FORWARD_E:
            tcDpRemapping.dsaTagCmd = CPSS_DXCH_NET_DSA_CMD_FORWARD_E;
            break;
        case PRV_TGF_NET_DSA_CMD_FROM_CPU_E:
            tcDpRemapping.dsaTagCmd = CPSS_DXCH_NET_DSA_CMD_FROM_CPU_E;
            break;
        case PRV_TGF_NET_DSA_CMD_TO_ANALYZER_E:
            tcDpRemapping.dsaTagCmd = CPSS_DXCH_NET_DSA_CMD_TO_ANALYZER_E;
            break;
        case PRV_TGF_NET_DSA_CMD_TO_CPU_E:
            tcDpRemapping.dsaTagCmd = CPSS_DXCH_NET_DSA_CMD_TO_CPU_E;
            break;

...
)
{
    ...
    if (actionPtr->trustUp == GT_TRUE)
    {
        dxChTtiActionPtr->trustUp = CPSS_DXCH_TTI_TRUST_L2_UP_E;
    }
    else
    {
        dxChTtiActionPtr->trustUp = CPSS_DXCH_TTI_DO_NOT_TRUST_L2_UP_E;
    }
    ...
    {
        rc = prvUtfHwDeviceNumberGet(actionPtr->egressInterface.devPort.hwDevNum,
...
)
{
    ...
    switch (actionPtr->qosModel)
    {
    case PRV_TGF_TTI_QOS_UNIFORM_MODEL_E:
        dxChTtiActionPtr->qosModel  = CPSS_DXCH_TTI_QOS_UNIFORM_MODEL_E;
        break;
    case PRV_TGF_TTI_QOS_PIPE_MODEL_E:
        dxChTtiActionPtr->qosModel  = CPSS_DXCH_TTI_QOS_PIPE_MODEL_E;
        break;
    case PRV_TGF_TTI_QOS_SHORT_PIPE_MODEL_E:
        dxChTtiActionPtr->qosModel  = CPSS_DXCH_TTI_QOS_SHORT_PIPE_MODEL_E;
        break;
    default:
        return GT_BAD_STATE;
    }
    ...
    switch (actionPtr->ttlModel)
    {
    case PRV_TGF_TTI_TTL_UNIFORM_MODEL_E:
        dxChTtiActionPtr->ttlModel  = CPSS_DXCH_TTI_TTL_UNIFORM_MODEL_E;
        break;
    case PRV_TGF_TTI_TTL_PIPE_MODEL_E:
        dxChTtiActionPtr->ttlModel  = CPSS_DXCH_TTI_TTL_PIPE_MODEL_E;
        break;
    case PRV_TGF_TTI_TTL_SHORT_PIPE_MODEL_E:
        dxChTtiActionPtr->ttlModel  = CPSS_DXCH_TTI_TTL_SHORT_PIPE_MODEL_E;
        break;
    default:
        return GT_BAD_STATE;
    }

    switch (actionPtr->qosMappingMode)
    {
    case PRV_TGF_TTI_QOS_PROFILE_MODE_E:
        dxChTtiActionPtr->qosMappingMode  = CPSS_DXCH_TTI_QOS_PROFILE_MODE_E;
        break;
    case PRV_TGF_TTI_TC_DP_MODE_E:
        dxChTtiActionPtr->qosMappingMode  = CPSS_DXCH_TTI_TC_DP_MODE_E;
        break;
    default:
        return GT_BAD_STATE;
    }
    ...
    if(( PRV_TGF_TTI_REDIRECT_TO_EGRESS_E == actionPtr->redirectCommand &&
       ...
       (PRV_TGF_TTI_LOGICAL_PORT_ASSIGN_E == actionPtr->redirectCommand &&
        CPSS_INTERFACE_PORT_E == actionPtr->interfaceInfo.type))
    {
        rc = prvUtfHwDeviceNumberGet(actionPtr->interfaceInfo.devPort.hwDevNum,
                                     &dxChTtiActionPtr->egressInterface.devPort.hwDevNum);
        if(GT_OK != rc)
            return rc;
    }
...
)
{
    ...
    if (dxChTtiActionPtr->trustUp == CPSS_DXCH_TTI_TRUST_L2_UP_E)
    {
        actionPtr->trustUp = GT_TRUE;
    }
    else
    {
        actionPtr->trustUp = GT_FALSE;
    }
    ...
    switch (dxChTtiActionPtr->tag1UpCommand)
    {
        ...
        case CPSS_DXCH_TTI_TAG1_UP_ASSIGN_VLAN0_UNTAGGED_E:
            actionPtr->tag1UpCommand = PRV_TGF_TTI_TAG1_UP_ASSIGN_VLAN0_UNTAGGED_E;
            break;

        case CPSS_DXCH_TTI_TAG1_UP_ASSIGN_ALL_E:
            actionPtr->tag1UpCommand = PRV_TGF_TTI_TAG1_UP_ASSIGN_ALL_E;
            break;
    ...
    switch (dxChTtiActionPtr->pcl0OverrideConfigIndex)
    {
        ...
        case CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E:
            actionPtr->pcl0OverrideConfigIndex = PRV_TGF_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E;
            break;
    ...
    switch (dxChTtiActionPtr->pcl0_1OverrideConfigIndex)
    {
        ...
        case CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E:
            actionPtr->pcl0_1OverrideConfigIndex = PRV_TGF_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E;
            break;
    ...
    switch (dxChTtiActionPtr->pcl1OverrideConfigIndex)
    {
        ...
        case CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E:
            actionPtr->pcl1OverrideConfigIndex = PRV_TGF_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E;
            break;
...
)
{
    ...
    /* convert mplsEthertypeSelect  into device specific format */
    switch (mplsEntryPtr->mplsEthertypeSelect)
    {
        case PRV_TGF_TUNNEL_START_MPLS_ETHER_TYPE_UC_E:
            dxChMplsEntryPtr->mplsEthertypeSelect = CPSS_DXCH_TUNNEL_START_MPLS_ETHER_TYPE_UC_E;
            break;
        case PRV_TGF_TUNNEL_START_MPLS_ETHER_TYPE_MC_E:
            dxChMplsEntryPtr->mplsEthertypeSelect = CPSS_DXCH_TUNNEL_START_MPLS_ETHER_TYPE_MC_E;
            break;
        default:
            return GT_BAD_PARAM;
    }
...
)
{
    ...
    /* convert mplsEthertypeSelect  into device specific format */
    switch (dxChMplsEntryPtr->mplsEthertypeSelect)
    {
        case CPSS_DXCH_TUNNEL_START_MPLS_ETHER_TYPE_UC_E:
            mplsEntryPtr->mplsEthertypeSelect = PRV_TGF_TUNNEL_START_MPLS_ETHER_TYPE_UC_E;
            break;
        case CPSS_DXCH_TUNNEL_START_MPLS_ETHER_TYPE_MC_E:
            mplsEntryPtr->mplsEthertypeSelect = PRV_TGF_TUNNEL_START_MPLS_ETHER_TYPE_MC_E;
            break;
        default:
            return GT_BAD_PARAM;
    }
...
)
{
    ...
    switch (genEntryPtr->genericType)
    {
    case PRV_TGF_TUNNEL_START_GENERIC_SHORT_TYPE_E:
        dxChGenEntryPtr->genericType = CPSS_DXCH_TUNNEL_START_GENERIC_SHORT_TYPE_E;
        break;
    case PRV_TGF_TUNNEL_START_GENERIC_MEDIUM_TYPE_E:
        dxChGenEntryPtr->genericType = CPSS_DXCH_TUNNEL_START_GENERIC_MEDIUM_TYPE_E;
        break;
    case PRV_TGF_TUNNEL_START_GENERIC_LONG_TYPE_E:
        dxChGenEntryPtr->genericType = CPSS_DXCH_TUNNEL_START_GENERIC_LONG_TYPE_E;
        break;
    default:
        return GT_BAD_PARAM;
    }
...
)
{
    ...
    case CPSS_DXCH_TUNNEL_START_GENERIC_SHORT_TYPE_E:
        genEntryPtr->genericType = PRV_TGF_TUNNEL_START_GENERIC_SHORT_TYPE_E;
        break;
    case CPSS_DXCH_TUNNEL_START_GENERIC_MEDIUM_TYPE_E:
        genEntryPtr->genericType = PRV_TGF_TUNNEL_START_GENERIC_MEDIUM_TYPE_E;
        break;
    case CPSS_DXCH_TUNNEL_START_GENERIC_LONG_TYPE_E:
        genEntryPtr->genericType = PRV_TGF_TUNNEL_START_GENERIC_LONG_TYPE_E;
        break;
    default:
        return GT_BAD_PARAM;
    }
...
)
{
    ...
    CPSS_DXCH_TTI_ACTION_STC        dxChTtiAction;
    GT_U32                          newRuleIndex=0;
    CPSS_DXCH_TTI_RULE_TYPE_ENT     ruleType1;
#endif /* CHX_FAMILY */
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        {
        case PRV_TGF_TTI_RULE_IPV4_E:
            ruleType1 = CPSS_DXCH_TTI_RULE_IPV4_E;
            break;
        case PRV_TGF_TTI_RULE_MPLS_E:
            ruleType1 = CPSS_DXCH_TTI_RULE_MPLS_E;
            break;
        case PRV_TGF_TTI_RULE_ETH_E:
            ruleType1 = CPSS_DXCH_TTI_RULE_ETH_E;
            break;
        case PRV_TGF_TTI_RULE_MIM_E:
             ruleType1 = CPSS_DXCH_TTI_RULE_MIM_E;
            break;
        case PRV_TGF_TTI_RULE_UDB_10_E:
            ruleType1 = CPSS_DXCH_TTI_RULE_UDB_10_E;
            break;
        case PRV_TGF_TTI_RULE_UDB_20_E:
            ruleType1 = CPSS_DXCH_TTI_RULE_UDB_20_E;
            break;
        case PRV_TGF_TTI_RULE_UDB_30_E:
            ruleType1 = CPSS_DXCH_TTI_RULE_UDB_30_E;
            break;
        default:
            return GT_BAD_PARAM;
        }
        /* call device specific API */
        rc = cpssDxChTtiRuleSet(devNum, newRuleIndex,  ruleType1,
...
)
{
    ...
    /* call device specific API */
    rc = cpssDxChTtiRuleGet(devNum, ruleIndex, ruleType1,
                            &dxChPattern, &dxChMask, &dxChTtiAction);
    if (GT_OK != rc)
    {
    ...
    if (ttiIndexIsRelative == GT_TRUE)
    {
     ...
     switch (keyType)
        ...
        case PRV_TGF_TTI_RULE_IPV4_E:
            ...
            break;
        case PRV_TGF_TTI_RULE_MPLS_E:
            ruleType = CPSS_DXCH_TTI_RULE_MPLS_E;
            break;
        case PRV_TGF_TTI_RULE_ETH_E:
            ruleType = CPSS_DXCH_TTI_RULE_ETH_E;
            break;
        case PRV_TGF_TTI_RULE_MIM_E:
             ruleType = CPSS_DXCH_TTI_RULE_MIM_E;
            break;
        case PRV_TGF_TTI_RULE_UDB_10_E:
...
)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        /* call device specific API */
        rc = cpssDxChTtiPortGroupRuleSet(devNum, portGroupsBmp, newRuleIndex,  ruleType1,
                                &dxChPattern, &dxChMask, &dxChTtiAction);
        if (GT_OK != rc)
        {
            PRV_UTF_LOG1_MAC("[TGF]: cpssDxChTtiRuleSet FAILED, rc = [%d]", rc);
...
)
{
    ...
    /* call device specific API */
    rc = cpssDxChTtiPortGroupRuleGet(devNum, portGroupsBmp, ruleIndex, ruleType1,
                            &dxChPattern, &dxChMask, &dxChTtiAction);
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChTtiRuleGet FAILED, rc = [%d]", rc);

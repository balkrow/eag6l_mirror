...
)
{
    ...
    rc = prvUtfHwDeviceNumberGet(l2MllPairEntryPtr->firstMllNode.egressInterface.devPort.hwDevNum,
    ...
    rc = prvUtfHwDeviceNumberGet(l2MllPairEntryPtr->secondMllNode.egressInterface.devPort.hwDevNum,

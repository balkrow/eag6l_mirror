    ...
    switch(netTxPacketPtr->dsaParam.dsaCommand)
    {
        case TGF_DSA_CMD_FROM_CPU_E:
            ...
            else if( CPSS_INTERFACE_VIDX_E == dsaFromCpuInfoPtr->dstInterface.type )
            {
                ...
                switch (dsaFromCpuInfoPtr->extDestInfo.multiDest.srcIsTagged)
                {
                    case PRV_TGF_BRG_VLAN_PORT_UNTAGGED_CMD_E:
                        dxChDsaFromCpuInfoPtr->extDestInfo.multiDest.srcIsTagged =
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfSdmaTxGeneratorEnable FAILED, rc = [%d]\n", rc);
        return rc;
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfSdmaTxGeneratorDisable FAILED, rc = [%d]\n", rc);
        return rc;
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfSdmaTxGeneratorRateSet FAILED, rc = [%d]\n", rc);
        return rc;
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfSdmaTxGeneratorBurstStatusGet FAILED, rc = [%d]\n", rc);
        return rc;
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfSdmaTxGeneratorPacketRemove FAILED, rc = [%d]\n", rc);
        return rc;
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: prvTgfConvertGenericToDxChNetTxParams FAILED, rc = [%d]\n", rc);
        return rc;
    }
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfSdmaTxGeneratorPacketAdd FAILED, rc = [%d]\n", rc);
        return rc;
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfSdmaTxGeneratorPacketUpdate FAILED, rc = [%d]\n", rc);
        return rc;
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfSdmaTxQueueEnableGet FAILED, rc = [%d]\n", rc);
        return rc;
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfSdmaTxGeneratorMemCheck FAILED, rc = [%d]\n", rc);
        return rc;
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: prvTgfConvertTgfToCpssNetCpuCodeTableParams FAILED, rc = [%d]\n", rc);
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfCpuCodeTableSet FAILED, rc = [%d]\n", rc);
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfCpuCodeTableGet FAILED, rc = [%d]\n", rc);
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: prvTgfConvertCpssToTgfNetCpuCodeTableParams FAILED, rc = [%d]\n", rc);
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfCpuCodeDesignatedDeviceTableSet FAILED, rc = [%d]\n", rc);
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfCpuCodeDesignatedDeviceTableGet FAILED, rc = [%d]\n", rc);
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: prvTgfConvertTgfToCpssNetAppSpecificCpuCodeParams FAILED, rc = [%d]\n", rc);
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfAppSpecificCpuCodeTcpUdpDestPortRangeSet FAILED, rc = [%d]\n", rc);
    }
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChNetIfAppSpecificCpuCodeTcpUdpDestPortRangeGet FAILED, rc = [%d]\n", rc);
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: prvTgfConvertCpssToTgfNetAppSpecificCpuCodeParams FAILED, rc = [%d]\n", rc);
    }

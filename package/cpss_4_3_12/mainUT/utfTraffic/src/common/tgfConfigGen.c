...
/* Convert PRV_TGF_CFG_GLOBAL_EPORT_CONFG_ENT to DXCH value */
#define PRV_TGF_CONVERT_DXCH_TO_GENERIC_GLOBAL_EPORT_CFG_MODE(dxChValue, genericValue) \
    switch (dxChValue)                                                                 \
    {                                                                                  \
        case CPSS_DXCH_CFG_GLOBAL_EPORT_CONFG_DISABLE_E:                               \
            genericValue = PRV_TGF_CFG_GLOBAL_EPORT_CONFG_DISABLE_E;                   \
            break;                                                                     \
        case CPSS_DXCH_CFG_GLOBAL_EPORT_CONFG_ENABLE_PATTERN_MASK_E:                   \
            genericValue = PRV_TGF_CFG_GLOBAL_EPORT_CONFG_ENABLE_PATTERN_MASK_E;       \
            break;                                                                     \
        case CPSS_DXCH_CFG_GLOBAL_EPORT_CONFG_ENABLE_RANGE_E:                          \
            genericValue = PRV_TGF_CFG_GLOBAL_EPORT_CONFG_ENABLE_RANGE_E;              \
            break;                                                                     \
        default:                                                                       \
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);             \
     }
...
)
{
    ...
    PRV_TGF_CONVERT_DXCH_TO_GENERIC_GLOBAL_EPORT_CFG_MODE(dxChEcmp.enable, l2EcmpPtr->enable);
    ...
    PRV_TGF_CONVERT_DXCH_TO_GENERIC_GLOBAL_EPORT_CFG_MODE(dxChGlobal.enable, globalPtr->enable);
    ...
    PRV_TGF_CONVERT_DXCH_TO_GENERIC_GLOBAL_EPORT_CFG_MODE(dxChDlb.enable, l2DlbPtr->enable);
...
)
{
    ...
    CPSS_DXCH_CFG_INGRESS_DROP_COUNTER_MODE_ENT cpssMode;

    switch (mode)
    {
        case PRV_TGF_CFG_INGRESS_DROP_COUNTER_MODE_ALL_E:
            cpssMode = CPSS_DXCH_CFG_INGRESS_DROP_COUNTER_MODE_ALL_E;
            break;
        case PRV_TGF_CFG_INGRESS_DROP_COUNTER_MODE_PORT_E:
            cpssMode = CPSS_DXCH_CFG_INGRESS_DROP_COUNTER_MODE_PORT_E;
            break;
        case PRV_TGF_CFG_INGRESS_DROP_COUNTER_MODE_VLAN_E:
            cpssMode = CPSS_DXCH_CFG_INGRESS_DROP_COUNTER_MODE_VLAN_E;
            break;
    ...
    {
        /* call device specific API */
        rc = cpssDxChCfgIngressDropCntrModeSet(
            devNum, cpssMode, portNum, vlan);
        if (GT_OK != rc)
        {

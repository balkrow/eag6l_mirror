    ...
    {                                                                          \
        ...
        {                                                                      \
            ...
            case PRV_TGF_EXACT_MATCH_KEY_SIZE_47B_E:                           \
                ...
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_KEY_SIZE_21B_E:                           \
                dstKeySize = CPSS_DXCH_EXACT_MATCH_KEY_SIZE_21B_E;             \
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_KEY_SIZE_37B_E:                           \
                dstKeySize = CPSS_DXCH_EXACT_MATCH_KEY_SIZE_37B_E;             \
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_KEY_SIZE_53B_E:                           \
                dstKeySize = CPSS_DXCH_EXACT_MATCH_KEY_SIZE_53B_E;             \
                break;                                                         \
                                                                               \
            default:                                                           \
                return GT_BAD_PARAM;                                           \
    ...
    {                                                                          \
        ...
        {                                                                      \
            ...
            case PRV_TGF_EXACT_MATCH_CLIENT_EPCL_E:                            \
                ...
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_CLIENT_MPCL_E:                            \
                dstClientType = CPSS_DXCH_EXACT_MATCH_CLIENT_MPCL_E;           \
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_CLIENT_IPE_E:                             \
                dstClientType = CPSS_DXCH_EXACT_MATCH_CLIENT_IPE_E;            \
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_CLIENT_TTI_SERIAL_EM_E:                   \
                dstClientType = CPSS_DXCH_EXACT_MATCH_CLIENT_TTI_ILM_E;        \
                break;                                                         \
                                                                               \
            default:                                                           \
                return GT_BAD_PARAM;                                           \
...
/* convert ExactMatch unit number into device specific format */
#define PRV_TGF_S2D_UNIT_NUM_CONVERT_MAC(dstUnitNum, srcClientUnitNum)         \
    do                                                                         \
    {                                                                          \
        switch (srcClientUnitNum)                                              \
        {                                                                      \
            case PRV_TGF_EXACT_MATCH_UNIT_0_E:                                 \
                dstUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E;                   \
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_UNIT_1_E:                                 \
                dstUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_1_E;                   \
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_UNIT_2_E:                                 \
                dstUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_2_E;                   \
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_UNIT_3_E:                                 \
                dstUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_3_E;                   \
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_UNIT_REDUCED_E:                           \
                dstUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_REDUCED_E;             \
                break;                                                         \
                                                                               \
            case PRV_TGF_EXACT_MATCH_UNIT_LAST_E:                              \
                dstUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_LAST_E;                \
                break;                                                         \
            default:                                                           \
                return GT_BAD_PARAM;                                           \
        }                                                                      \
...
/* convert ExactMatch unit number into device specific format */
#define PRV_TGF_S2D_EM_SERIAL_TYPE_CONVERT_MAC(dstEmSerialType, srcEmSerialType) \
    do                                                                           \
    {                                                                            \
        switch (srcEmSerialType)                                                 \
        {                                                                        \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM0_E:                               \
                dstEmSerialType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM0_E;            \
                break;                                                           \
                                                                                 \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM1_E:                               \
                dstEmSerialType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM1_E;            \
                break;                                                           \
                                                                                 \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM2_E:                               \
                dstEmSerialType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM2_E;            \
                break;                                                           \
                                                                                 \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_LAST_E:                           \
                dstEmSerialType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_LAST_E;        \
                break;                                                           \
            default:                                                             \
                return GT_BAD_PARAM;                                             \
        }                                                                        \
...
#define PRV_TGF_D2S_ACTION_TYPE_CONVERT_MAC(dstActionType, srcActionType)       \
    ...
    {                                                                           \
        ...
        case CPSS_DXCH_EXACT_MATCH_ACTION_TTI_E:                                \
            srcActionType=PRV_TGF_EXACT_MATCH_ACTION_TTI_E;                     \
            break;                                                              \
        case CPSS_DXCH_EXACT_MATCH_ACTION_PCL_E:                                \
            srcActionType=PRV_TGF_EXACT_MATCH_ACTION_PCL_E;                     \
            break;                                                              \
        case CPSS_DXCH_EXACT_MATCH_ACTION_EPCL_E:                               \
            srcActionType=PRV_TGF_EXACT_MATCH_ACTION_EPCL_E;                    \
            break;                                                              \
        default:                                                                \
            return GT_BAD_PARAM;                                                \
        }                                                                       \
...
/* convert ExactMatch packet type into device specific format */
#define PRV_TGF_S2D_EM_PACKET_TYPE_CONVERT_MAC(dstPacketType, srcPacketType)                         \
    do                                                                                               \
    {                                                                                                \
        switch (srcPacketType)                                                                       \
        {                                                                                            \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_TCP_E:                           \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_TCP_E;          \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_UDP_E:                           \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_UDP_E;          \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_MPLS_E:                               \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_MPLS_E;              \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_FRAGMENT_E:                      \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_FRAGMENT_E;     \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_OTHER_E:                         \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV4_OTHER_E;        \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_ETHERNET_OTHER_E:                     \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_ETHERNET_OTHER_E;    \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV6_E:                               \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV6_E;              \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV6_TCP_E:                           \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV6_TCP_E;          \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV6_UDP_E:                           \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_IPV6_UDP_E;          \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE_E:                                \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE_E;               \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE1_E:                               \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE1_E;              \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE2_E:                               \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE2_E;              \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE3_E:                               \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE3_E;              \
                break;                                                                               \
                                                                                                     \
            case  PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE4_E:                              \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE4_E;              \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE5_E:                               \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE5_E;              \
                break;                                                                               \
            case PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE6_E:                               \
                dstPacketType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE6_E;              \
                break;                                                                               \
            default:                                                                                 \
                return GT_BAD_PARAM;                                                                 \
        }                                                                                            \
...
)
{
    ...
    rc = cpssDxChExactMatchTtiProfileIdModePacketTypeSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
...
)
{
    ...
    rc = cpssDxChExactMatchPclProfileIdSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, direction,
                                           dxChPacketType,subProfileId,
...
*                                   Other devices = 0 (PRV_TGF_EXACT_MATCH_UNIT_0_E))
...
(
    IN  GT_U8                                     devNum,
    IN  PRV_TGF_EXACT_MATCH_UNIT_NUM_ENT          emUnitNum,
...
)
{
    ...
    CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT          dxChExactMatchUnitNum;

    PRV_TGF_S2D_UNIT_NUM_CONVERT_MAC(dxChExactMatchUnitNum, emUnitNum);
    ...
    rc = cpssDxChExactMatchClientLookupSet(devNum, dxChExactMatchUnitNum, dxChExactMatchLookupNum, dxChClientType);
    if (GT_OK != rc)
    {
...
)
{
    ...
    rc = cpssDxChExactMatchClientLookupGet(devNum, dxChExactMatchUnitNum, dxChExactMatchLookupNum, &dxChClientType);
    if (GT_OK != rc)
    {
...
#ifdef CHX_FAMILY
    GT_STATUS rc;
    rc = cpssDxChExactMatchActivityBitEnableSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E, enable);
    if (GT_OK != rc)
    {
...
)
{
    ...
    rc = cpssDxChExactMatchActivityBitEnableGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E, enablePtr);
    if (GT_OK != rc)
    {
...
)
{
    ...
    rc = cpssDxChExactMatchActivityStatusGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                             CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E, portGroupsBmp, exactMatchEntryIndex,
...
)
{
    ...
    rc = cpssDxChExactMatchProfileKeyParamsSet(devNum, dxChExactMatchUnitNum, exactMatchProfileIndex, &dxChKeyParams);
    if (GT_OK != rc)
    {
...
)
{
    ...
    rc = cpssDxChExactMatchProfileKeyParamsGet(devNum,dxChExactMatchUnitNum,exactMatchProfileIndex,&dxChKeyParams);
    if (GT_OK != rc)
    {
...
)
{
    ...
    rc = cpssDxChExactMatchProfileDefaultActionSet(devNum, dxChExactMatchUnitNum, exactMatchProfileIndex,
...
)
{
    ...
    rc = cpssDxChExactMatchProfileDefaultActionGet(devNum,dxChExactMatchUnitNum,
...
)
{
    ...
    case PRV_TGF_EXACT_MATCH_ACTION_TTI_E:
        ...
        PRV_TGF_STC_S2D_FIELD_COPY_MAC(&dxChExpandedActionOriginPtr->ttiExpandedActionOrigin, &expandedActionOriginPtr->ttiExpandedActionOrigin, overwriteExpandedActionGenericAction);
        PRV_TGF_STC_S2D_FIELD_COPY_MAC(&dxChExpandedActionOriginPtr->ttiExpandedActionOrigin, &expandedActionOriginPtr->ttiExpandedActionOrigin, genericActionMask);
    ...
    case PRV_TGF_EXACT_MATCH_ACTION_EPCL_E:
        ...
        PRV_TGF_STC_S2D_FIELD_COPY_MAC(&dxChExpandedActionOriginPtr->pclExpandedActionOrigin, &expandedActionOriginPtr->pclExpandedActionOrigin, overwriteExpandedActionGenericAction);
        PRV_TGF_STC_S2D_FIELD_COPY_MAC(&dxChExpandedActionOriginPtr->pclExpandedActionOrigin, &expandedActionOriginPtr->pclExpandedActionOrigin, genericActionMask);
...
)
{
    ...
    case PRV_TGF_EXACT_MATCH_ACTION_TTI_E:
        ...
        PRV_TGF_STC_D2S_FIELD_COPY_MAC(&dxChExpandedActionOriginPtr->ttiExpandedActionOrigin, &expandedActionOriginPtr->ttiExpandedActionOrigin, overwriteExpandedActionGenericAction);
        PRV_TGF_STC_D2S_FIELD_COPY_MAC(&dxChExpandedActionOriginPtr->ttiExpandedActionOrigin, &expandedActionOriginPtr->ttiExpandedActionOrigin, genericActionMask);
    ...
    case PRV_TGF_EXACT_MATCH_ACTION_EPCL_E:
        ...
        PRV_TGF_STC_D2S_FIELD_COPY_MAC(&dxChExpandedActionOriginPtr->pclExpandedActionOrigin, &expandedActionOriginPtr->pclExpandedActionOrigin, overwriteExpandedActionVrfId);
        PRV_TGF_STC_D2S_FIELD_COPY_MAC(&dxChExpandedActionOriginPtr->pclExpandedActionOrigin, &expandedActionOriginPtr->pclExpandedActionOrigin, genericActionMask);
...
)
{
    ...
    rc = cpssDxChExactMatchExpandedActionSet(devNum, dxChExactMatchUnitNum, expandedActionIndex,
                                             dxChActionType, &dxChActionData,
...
)
{
    ...
    rc = cpssDxChExactMatchExpandedActionGet(devNum, dxChExactMatchUnitNum,
                                             expandedActionIndex,
                                             dxChActionType,
                                             &dxChActionData,
                                             &dxChExpandedActionOrigin);
...
)
{
    ...
    case PRV_TGF_EXACT_MATCH_KEY_SIZE_47B_E:
        ...
        break;
    case PRV_TGF_EXACT_MATCH_KEY_SIZE_21B_E:
        dxChEntryPtr->key.keySize = CPSS_DXCH_EXACT_MATCH_KEY_SIZE_21B_E;
        break;
    case PRV_TGF_EXACT_MATCH_KEY_SIZE_37B_E:
        dxChEntryPtr->key.keySize = CPSS_DXCH_EXACT_MATCH_KEY_SIZE_37B_E;
        break;
    case PRV_TGF_EXACT_MATCH_KEY_SIZE_53B_E:
        dxChEntryPtr->key.keySize = CPSS_DXCH_EXACT_MATCH_KEY_SIZE_53B_E;
        break;
    default:
        return GT_BAD_PARAM;
    }
...
*                           Other devices = 0 (PRV_TGF_EXACT_MATCH_LOOKUP_FIRST_E))
* @param[in] portGroupsBmp- bitmap of Port Groups.
*                                      NOTEs:
*                                      1. for non multi-port groups device this parameter is IGNORED.
*                                      2. for multi-port groups device :
...
(
    IN GT_U8                                  devNum,
    IN PRV_TGF_EXACT_MATCH_UNIT_NUM_ENT       emUnitNum,
    IN PRV_TGF_EXACT_MATCH_LOOKUP_ENT         lookupNum,
    IN GT_PORT_GROUPS_BMP                     portGroupsBmp,
    IN GT_U32                                 index,
    IN GT_U32                                 expandedActionIndex,
    IN PRV_TGF_EXACT_MATCH_ENTRY_STC          *entryPtr,
...
)
{
    ...
    PRV_TGF_S2D_ACTION_TYPE_CONVERT_MAC(dxChActionType, actionType);
    PRV_TGF_S2D_LOOKUP_NUM_CONVERT_MAC(dxChExactMatchLookupNum, lookupNum);
    ...
    rc = cpssDxChExactMatchPortGroupEntrySet(devNum,
                                             dxChExactMatchUnitNum,
                                             dxChExactMatchLookupNum,
                                             portGroupsBmp,
                                             index,
                                             expandedActionIndex,
                                             &dxChEntryData,
...
)
{
    ...
    rc = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum, dxChExactMatchUnitNum,
                                                           &dxChEntryKey, numberOfElemInCrcMultiHashArrPtr,
...
)
{
    ...
    rc = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(prvTgfDevNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
...
/**
* @internal prvTgfExactMatchProfileMuxTableLineSet function
* @endinternal
*
...
*
*/
GT_STATUS prvTgfExactMatchProfileMuxTableLineSet
(
    IN GT_U8                                         devNum,
    IN PRV_TGF_EXACT_MATCH_UNIT_NUM_ENT              emUnitNum,
    IN GT_U32                                        emProfileId,
    IN PRV_TGF_EXACT_MATCH_KEY_SIZE_ENT              keySize
)
{
#ifdef CHX_FAMILY
    GT_STATUS rc;
    CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC     dxChEmMuxTableLineCfg;
    GT_U32                                           muxBytes;
    GT_U32                                           bytePair;
    CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT               dxChExactMatchUnitNum;
    ...
    /* reset variables */
    cpssOsMemSet((GT_VOID*) &dxChEmMuxTableLineCfg, 0, sizeof(dxChEmMuxTableLineCfg));
    ...
    switch(keySize)
    {
        ...
        case PRV_TGF_EXACT_MATCH_KEY_SIZE_53B_E:
            ...
            break;
        default:
            cpssOsPrintf("prvTgfExactMatchProfileMuxTableLineSet : Invaid key size \n");
            rc = GT_FAIL;
            return rc;
    }

    for(bytePair = 0; bytePair < muxBytes; bytePair++)
    {
        dxChEmMuxTableLineCfg.superKeyTwoByteUnitsOffsets[bytePair] = bytePair;
    }

    rc = cpssDxChExactMatchProfileMuxTableLineSet(devNum, dxChExactMatchUnitNum, emProfileId, &dxChEmMuxTableLineCfg);
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChExactMatchProfileMuxTableLineSet FAILED, rc = [%d]", rc);
    }
    return rc;
#endif /* CHX_FAMILY */
    ...
    TGF_PARAM_NOT_USED(devNum);
    TGF_PARAM_NOT_USED(emUnitNum);
    TGF_PARAM_NOT_USED(emProfileId);
    TGF_PARAM_NOT_USED(keySize);
    return GT_BAD_STATE;
#endif
}

/**
* @internal prvTgfExactMatchSerialPortProfileIdSet function
* @endinternal
*
...
*
*/
GT_STATUS  prvTgfExactMatchSerialPortProfileIdSet
(
    IN  GT_U8                          devNum,
...
)
{
    ...
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChExactMatchSerialEmPortProfileIdSet FAILED, rc = [%d]", rc);
    }
    return rc;
#endif /* CHX_FAMILY */
    ...
    TGF_PARAM_NOT_USED(portProfileId);
    return GT_BAD_STATE;
#endif
}

/**
* @internal prvTgfConvertGenericExactMatchSerialEmEntryToDxChExactMatchSerialEmEntry function
* @endinternal
*
* @brief   Convert generic exact match into device specific
*          exact match
...
* @retval GT_BAD_PARAM             - on wrong parameters
*/
GT_STATUS prvTgfConvertGenericExactMatchSerialEmEntryToDxChExactMatchSerialEmEntry
(
    IN  PRV_TGF_EXACT_MATCH_SERIAL_EM_ENTRY_STC       *serialEmEntryPtr,
    OUT CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC     *dxChSerialEmEntryPtr
)
{
    cpssOsMemSet((GT_VOID*) dxChSerialEmEntryPtr, 0, sizeof(*dxChSerialEmEntryPtr));

    dxChSerialEmEntryPtr->serialEmProfileId             = serialEmEntryPtr->serialEmProfileId;
    dxChSerialEmEntryPtr->serialEmEnableUDB28VlanTagKey = serialEmEntryPtr->serialEmEnableUDB28VlanTagKey;
    dxChSerialEmEntryPtr->serialEmEnableUDB29VlanTagKey = serialEmEntryPtr->serialEmEnableUDB29VlanTagKey;
    dxChSerialEmEntryPtr->serialEmPclId                 = serialEmEntryPtr->serialEmPclId;

    switch (serialEmEntryPtr->serialEmKeyType)
    {
    case PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_VLAN_TAG_E:
        dxChSerialEmEntryPtr->serialEmKeyType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_VLAN_TAG_E;
        break;
    case PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_MPLS_E:
        dxChSerialEmEntryPtr->serialEmKeyType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_MPLS_E;
        break;
    case PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_20_24_E:
        dxChSerialEmEntryPtr->serialEmKeyType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_20_24_E;
        break;
    case PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_25_29_E:
        dxChSerialEmEntryPtr->serialEmKeyType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_25_29_E;
        break;
    default:
        return GT_BAD_PARAM;
    }
...
/**
* @internal prvTgfConvertDxChExactMatchSerialEmEntryToGenericExactMatchSerialEmEntry function
* @endinternal
*
* @brief   Convert device specific exact match to
*          generic exact match into
*
* @param[in] dxChEntryPtr - (pointer to) dxCh exact match entry
* @param[out] entryPtr    - (pointer to) exact match entry
*
...
* @retval GT_BAD_PARAM             - on wrong parameters
*/
GT_STATUS prvTgfConvertDxChExactMatchSerialEmEntryToGenericExactMatchSerialEmEntry
(
    IN   CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC     *dxChSerialEmEntryPtr,
    OUT  PRV_TGF_EXACT_MATCH_SERIAL_EM_ENTRY_STC       *serialEmEntryPtr
)
{
    cpssOsMemSet((GT_VOID*) serialEmEntryPtr, 0, sizeof(*serialEmEntryPtr));

    serialEmEntryPtr->serialEmProfileId             = dxChSerialEmEntryPtr->serialEmProfileId;
    serialEmEntryPtr->serialEmEnableUDB28VlanTagKey = dxChSerialEmEntryPtr->serialEmEnableUDB28VlanTagKey;
    serialEmEntryPtr->serialEmEnableUDB29VlanTagKey = dxChSerialEmEntryPtr->serialEmEnableUDB29VlanTagKey;
    serialEmEntryPtr->serialEmPclId                 = dxChSerialEmEntryPtr->serialEmPclId;

    switch (dxChSerialEmEntryPtr->serialEmKeyType)
    {
    case CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_VLAN_TAG_E:
        serialEmEntryPtr->serialEmKeyType = PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_VLAN_TAG_E;
        break;
    case CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_MPLS_E:
        serialEmEntryPtr->serialEmKeyType = PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_MPLS_E;
        break;
    case CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_20_24_E:
        serialEmEntryPtr->serialEmKeyType = PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_20_24_E;
        break;
    case CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_25_29_E:
        serialEmEntryPtr->serialEmKeyType = PRV_TGF_EXACT_MATCH_SERIAL_EM_KEY_TYPE_UDB_25_29_E;
        break;
    default:
        return GT_BAD_PARAM;
    }
...
/**
* @internal prvTgfExactMatchSerialEmProfileIdMappingTableEntrySet function
* @endinternal
*
...
*                                       (PRV_TGF_EXACT_MATCH_SERIAL_EM_ENTRY_STC)
* @retval GT_OK                - on success
* @retval GT_HW_ERROR          - on hardware error
* @retval GT_BAD_PARAM         - on wrong param
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*
*/
GT_STATUS prvTgfExactMatchSerialEmProfileIdMappingTableEntrySet
(
    IN GT_U8                                          devNum,
    IN PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT  packetType,
    IN GT_U32                                         portProfileId,
    IN PRV_TGF_EXACT_MATCH_SERIAL_EM_TYPE_ENT         serialEmType,
    IN PRV_TGF_EXACT_MATCH_SERIAL_EM_ENTRY_STC        *serialEmProfileParamsPtr
)
{
#ifdef CHX_FAMILY
    GT_STATUS rc;
    CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC        dxChSerialEmProfileParams;
    CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT         dstSerialEmType;
    CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT  dstPacketType;
    PRV_TGF_S2D_EM_PACKET_TYPE_CONVERT_MAC(dstPacketType,packetType);
    PRV_TGF_S2D_EM_SERIAL_TYPE_CONVERT_MAC(dstSerialEmType,serialEmType);
    rc = prvTgfConvertGenericExactMatchSerialEmEntryToDxChExactMatchSerialEmEntry(serialEmProfileParamsPtr,
                                                                                  &dxChSerialEmProfileParams);
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: prvTgfConvertGenericExactMatchSerialEmEntryToDxChExactMatchSerialEmEntry FAILED, rc = [%d]", rc);
        return rc;
    }

    rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet(devNum, dstPacketType, portProfileId,
                                                                 dstSerialEmType, &dxChSerialEmProfileParams);
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet FAILED, rc = [%d]", rc);
    }
    return rc;
#endif /* CHX_FAMILY */
    ...
    TGF_PARAM_NOT_USED(packetType);
    TGF_PARAM_NOT_USED(portProfileId);
    TGF_PARAM_NOT_USED(serialEmType);
    TGF_PARAM_NOT_USED(serialEmProfileParamsPtr);
    return GT_BAD_STATE;
#endif
}

/**
* @internal prvTgfExactMatchSerialEmProfileIdMappingTableEntryGet function
* @endinternal
*
...
*
*/
GT_STATUS prvTgfExactMatchSerialEmProfileIdMappingTableEntryGet
(
    IN  GT_U8                                          devNum,
    IN  PRV_TGF_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT  packetType,
    IN  GT_U32                                         portProfileId,
    IN  PRV_TGF_EXACT_MATCH_SERIAL_EM_TYPE_ENT         serialEmType,
    OUT PRV_TGF_EXACT_MATCH_SERIAL_EM_ENTRY_STC        *serialEmProfileParamsPtr
)
{
#ifdef CHX_FAMILY
    GT_STATUS rc;
    ...
    PRV_TGF_S2D_EM_PACKET_TYPE_CONVERT_MAC(dstPacketType,packetType);
    PRV_TGF_S2D_EM_SERIAL_TYPE_CONVERT_MAC(dstSerialEmType,serialEmType);
    rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet(devNum, dstPacketType, portProfileId,
                                                                 dstSerialEmType, &dxChSerialEmProfileParams);
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet FAILED, rc = [%d]\n", rc);
    }

    rc = prvTgfConvertDxChExactMatchSerialEmEntryToGenericExactMatchSerialEmEntry(&dxChSerialEmProfileParams,
                                                                                  serialEmProfileParamsPtr);
    if (GT_OK != rc)
    {
        PRV_UTF_LOG1_MAC("[TGF]: prvTgfConvertDxChExactMatchSerialEmEntryToGenericExactMatchSerialEmEntry FAILED, rc = [%d]\n", rc);
        return rc;
    }
    return rc;
#endif /* CHX_FAMILY */

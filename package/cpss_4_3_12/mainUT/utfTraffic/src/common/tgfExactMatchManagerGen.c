...
/* convert ExactMatch client key type into device specific format */
#define PRV_TGF_STC_S2D_KEY_TYPE_CONVERT_MAC(dstKeyType, srcKeyType) \
    do                                                               \
    {                                                                \
        switch (srcKeyType)                                           \
        {                                                            \
...
/* convert pcl packet type into device specific format */
#define PRV_TGF_S2D_PCL_PACKET_TYPE_CONVERT_MAC(dstPacketType, srcPacketType)                        \
    do                                                                                               \
    {                                                                                                \
        switch (srcPacketType)                                                                       \
        {                                                                                            \
            case PRV_TGF_PCL_PACKET_TYPE_IPV4_TCP_E:                                                 \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_IPV4_TCP_E;                                \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_IPV4_UDP_E:                                                 \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_IPV4_UDP_E;                                \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_MPLS_E:                                                     \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_MPLS_E;                                    \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_IPV4_FRAGMENT_E:                                            \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_IPV4_FRAGMENT_E;                           \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_IPV4_OTHER_E:                                               \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_IPV4_OTHER_E;                              \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_ETHERNET_OTHER_E:                                           \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_ETHERNET_OTHER_E;                          \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_UDE_E:                                                      \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_UDE_E;                                     \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_IPV6_E:                                                     \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_IPV6_E;                                    \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_UDE_1_E:                                                    \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_UDE1_E;                                    \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_UDE_2_E:                                                    \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_UDE2_E;                                    \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_UDE_3_E:                                                    \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_UDE3_E;                                    \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_UDE_4_E:                                                    \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_UDE4_E;                                    \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_IPV6_TCP_E:                                                 \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_IPV6_TCP_E;                                \
                break;                                                                               \
                                                                                                     \
            case  PRV_TGF_PCL_PACKET_TYPE_IPV6_UDP_E:                                                \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_IPV6_UDP_E;                                \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_PCL_PACKET_TYPE_IPV6_OTHER_E:                                               \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_IPV6_OTHER_E;                              \
                break;                                                                               \
            case PRV_TGF_PCL_PACKET_TYPE_UDE5_E:                                                     \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_UDE5_E;                                    \
                break;                                                                               \
            case PRV_TGF_PCL_PACKET_TYPE_UDE6_E:                                                     \
                dstPacketType = CPSS_DXCH_PCL_PACKET_TYPE_UDE6_E;                                    \
                break;                                                                               \
            default:                                                                                 \
                return GT_BAD_PARAM;                                                                 \
        }                                                                                            \
...
#define PRV_TGF_S2D_DEFAULT_ACTION_TYPE_CONVERT_MAC(dstDefaultActionType, srcDefaultActionType)      \
    do                                                                                               \
    {                                                                                                \
        switch (srcDefaultActionType)                                                                \
        {                                                                                            \
            case PRV_TGF_EXACT_MATCH_ACTION_TTI_E:                                                   \
                dstDefaultActionType = CPSS_DXCH_EXACT_MATCH_ACTION_TTI_E;                           \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_ACTION_PCL_E:                                                   \
                dstDefaultActionType = CPSS_DXCH_EXACT_MATCH_ACTION_PCL_E;                           \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_ACTION_EPCL_E:                                                  \
                dstDefaultActionType = CPSS_DXCH_EXACT_MATCH_ACTION_EPCL_E;                          \
                break;                                                                               \
                                                                                                     \
            case PRV_TGF_EXACT_MATCH_ACTION_LAST_E:                                                  \
                dstDefaultActionType = CPSS_DXCH_EXACT_MATCH_ACTION_LAST_E;                          \
                break;                                                                               \
            default:                                                                                 \
                return GT_BAD_PARAM;                                                                 \
        }                                                                                            \
...
)
{
    ...
    for (i=0; i<PRV_TGF_EXACT_MATCH_LOOKUP_LAST_E; i++)
    {
        ...
        case PRV_TGF_EXACT_MATCH_CLIENT_TTI_E:
            for (j=0; j<PRV_TGF_EXACT_MATCH_MANAGER_MAX_NUM_PROFILE_ID_MAPPING_ENTRIES_CNS; j++)
            {
                ...
                PRV_TGF_STC_S2D_KEY_TYPE_CONVERT_MAC(dxChLookupPtr->lookupsArray[i].lookupClientMappingsArray[j].ttiMappingElem.keyType,
        ...
        case PRV_TGF_EXACT_MATCH_CLIENT_EPCL_E:
            for (j=0; j<PRV_TGF_EXACT_MATCH_MANAGER_MAX_NUM_PROFILE_ID_MAPPING_ENTRIES_CNS; j++)
            {
                ...
                PRV_TGF_S2D_PCL_PACKET_TYPE_CONVERT_MAC(dxChLookupPtr->lookupsArray[i].lookupClientMappingsArray[j].pclMappingElem.packetType,
    ...
    for (i=0; i<PRV_TGF_EXACT_MATCH_MANAGER_MAX_PROFILES_NUM_CNS; i++)
    {
        ...
        PRV_TGF_S2D_DEFAULT_ACTION_TYPE_CONVERT_MAC(dxChLookupPtr->profileEntryParamsArray[i].defaultActionType, lookupPtr->profileEntryParamsArray[i].defaultActionType);
...
)
{
    ...
    if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_FALCON_E)
        dxChCapacity.actionMatchWaEnable = GT_TRUE;
...
)
{
    ...
    checks.dbHashFreeListCheckEnable = checksPtr->dbHashFreeListCheckEnable;
    checks.dbHashIndexArrayCheckEnable = checksPtr->dbHashIndexArrayCheckEnable;
    ...
    {
        resultArray[i] = (PRV_TGF_EXACT_MATCH_MANAGER_DB_CHECKS_RESULT_ENT)dxChResultArray[i];
    }
#endif /* CHX_FAMILY */
...
)
{
    ...
    {
       entriesAgedOutArray[i].updateType = (PRV_TGF_EXACT_MATCH_MANAGER_ENTRY_UPDATE_EVENT_TYPE_ENT)dxChEntriesdAgeoutArray[i].updateType;

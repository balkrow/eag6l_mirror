...
/* target device */
#define PRV_TGF_TRG_DEV_CNS         7

/* HW Device IDs of remote devices */
static GT_U32  remoteHwDeviceNum = PRV_TGF_TRG_DEV_CNS;


/* Vidx field. Will be initialized later */
static GT_U32 prvTgfVidx;
...
)
{
    ...
    if ((prvTgfSavedHwDevNum == remoteHwDeviceNum) ||
        ((prvTgfSavedHwDevNum + 1) == remoteHwDeviceNum) ||
        (prvTgfDevNum == remoteHwDeviceNum))
    {
        remoteHwDeviceNum -= 2;
    }
    ...
    rc = prvTgfCscdDevMapTableGet(prvTgfDevNum, remoteHwDeviceNum,
                                  0,
                                  0,
    ...
    rc = prvTgfCscdDevMapTableSet(prvTgfDevNum,remoteHwDeviceNum,
                                  0, 0,
    ...
    prvTgfBrgDefFdbMacEntryOnPortSet( prvTgfPacketL2Part.daMac, PRV_TGF_VLANID_CNS,
         remoteHwDeviceNum, prvTgfPortsArray[EGR_CASCADE_PORT_IDX_CNS], GT_TRUE);

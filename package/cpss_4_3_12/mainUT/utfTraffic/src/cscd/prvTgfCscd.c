...
/* default value of HW Device#1,2 */
#define PRV_TGF_CSCD_ORIG_HW_DEV_1_CNS 13
#define PRV_TGF_CSCD_ORIG_HW_DEV_2_CNS 31

/* target device number array*/
static GT_U8 targetDevNumArr[PRV_TGF_CSCD_TRG_ARRAY_SIZE_CNS] = {0/*set in runtime to prvTgfDevNum*/,
                                                                 PRV_TGF_CSCD_ORIG_HW_DEV_1_CNS,
                                                                 PRV_TGF_CSCD_ORIG_HW_DEV_2_CNS};
...
/* HW Device IDs of remote devices */
static GT_U32  remoteHwDeviceNum_1 = REMOTE_DEVICE1_NUMBER_CNS;
static GT_U32  remoteHwDeviceNum_2 = REMOTE_DEVICE2_NUMBER_CNS;
...
)
{
    ...
    if ( (hwDevNum == (targetDevNumArr[1])) || (prvTgfDevNum == targetDevNumArr[1]) )
    {
...
)
{
    ...
    {
        targetDevNumArr[1] = PRV_TGF_CSCD_ORIG_HW_DEV_1_CNS;
        targetDevNumArr[2] = PRV_TGF_CSCD_ORIG_HW_DEV_2_CNS;
    }
...
)
{
    ...
    if ((remoteHwDeviceNum_1 == prvTgfDevNum) ||
        (remoteHwDeviceNum_1 == hwDevNum))
    {
        remoteHwDeviceNum_1--;
    }

    if ((remoteHwDeviceNum_2 == prvTgfDevNum) ||
        (remoteHwDeviceNum_2 == hwDevNum))
    {
        remoteHwDeviceNum_2--;
    }
    ...
    devTableArr[0] |= (1 << remoteHwDeviceNum_1);

    rc = prvTgfBrgFdbDeviceTableSet(devTableArr);
    UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, rc);

    devTableArr[0] |= (1 << remoteHwDeviceNum_2);
    rc = prvTgfBrgFdbDeviceTableSet(devTableArr);
    UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, rc);
    ...
    macEntry1.dstInterface.devPort.hwDevNum = remoteHwDeviceNum_1;
    ...
    macEntry2.dstInterface.devPort.hwDevNum = remoteHwDeviceNum_2;
    ...
    rc = prvTgfCscdDevMapTableGet(prvTgfDevNum,remoteHwDeviceNum_1,
            REMOTE_DEVICE1_PORT_NUM_CNS,0,
            &(prvTgfRestoreCfg.cascadeLinkArr[0]),&(prvTgfRestoreCfg.srcPortTrunkHashEnArr[0]));
    UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, rc);

    rc = prvTgfCscdDevMapTableGet(prvTgfDevNum,remoteHwDeviceNum_2,
    ...
    rc = prvTgfCscdDevMapTableSet(prvTgfDevNum,remoteHwDeviceNum_1,
    ...
    rc = prvTgfCscdDevMapTableSet(prvTgfDevNum,remoteHwDeviceNum_2,

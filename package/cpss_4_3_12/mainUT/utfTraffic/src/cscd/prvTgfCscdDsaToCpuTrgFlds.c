...
static GT_U8 prvTgfTrgHwDevNum = PRV_TGF_ORIG_HW_DEVICE_NUMBER_CNS;
...
)
{
    ...
    if ((prvTgfSavedHwDevNum == prvTgfTrgHwDevNum) ||
        (prvTgfDevNum == prvTgfTrgHwDevNum) ||
        ((prvTgfSavedHwDevNum + 1) == prvTgfTrgHwDevNum))
    {
    ...
    {
        prvTgfTrunkId = cpssOsRand() % ((GT_TRUNK_ID)(UTF_CPSS_PP_MAX_TRUNK_ECMP_INDEX_CNS(prvTgfDevNum) / 16) - 1) + 1;
    }

...
)
{
    ...
    rc = cpssDxChPolicerMeteringAnalyzerIndexGet(
        prvTgfDevNum, cpssStage, CPSS_DP_RED_E, &orig_enable, &orig_index);
    UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, rc,
                                 "cpssDxChPolicerMeteringAnalyzerIndexGet: %d, %d",
                                  prvTgfDevNum,
                                  PRV_TGF_ANALYZER_INDEX_CNS);
    rc = cpssDxChPolicerMeteringAnalyzerIndexSet(
        prvTgfDevNum, cpssStage, CPSS_DP_RED_E, GT_TRUE, PRV_TGF_ANALYZER_INDEX_CNS);
    UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, rc,

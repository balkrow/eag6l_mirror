...
)
{
    ...
    ttiAction.pcl0OverrideConfigIndex                   = PRV_TGF_PCL_LOOKUP_CONFIG_INDEX_RETAIN_E;
    ttiAction.bridgeBypass                              = GT_TRUE;
    ttiAction.ingressPipeBypass                         = GT_TRUE;

    rc = prvTgfTtiRuleSet(prvTgfTtiRuleIndex, PRV_TGF_TTI_RULE_ETH_E,
    ...
    rc = prvTgfTtiRuleGet(prvTgfDevNum, prvTgfTtiRuleIndex, PRV_TGF_TTI_RULE_ETH_E,
                          &ttiPattern, &ttiMask, &ttiAction);
...
)
{
    ...
    for (stage = PRV_TGF_POLICER_STAGE_INGRESS_0_E; stage < PRV_TGF_POLICER_STAGE_NUM; stage++)
    {
        ...
        else
        {
            if (policerInfo.countMode != PRV_TGF_POLICER_COUNTING_DISABLE_E)
            {
                ...
                rc = prvTgfPolicerCountingModeSet(
                    prvTgfDevNum, stage, PRV_TGF_POLICER_COUNTING_DISABLE_E);
        ...
        tmpMeterEntry.modifyDscp = PRV_TGF_POLICER_MODIFY_DSCP_DISABLE_E;
        tmpMeterEntry.modifyUp = PRV_TGF_POLICER_MODIFY_UP_DISABLE_E;
        /* Set maximal values */
...
)
{
    ...
    static TGF_TCAM_CLIENTS_PCL_RULE_SUB_FIELD_STC ipclSubFieldArr[] =
    {
        ...
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_IMETA_VID0_E, 0, 16},
    ...
    static TGF_TCAM_CLIENTS_PCL_SUB_FIELD_CONDITION_STC    ipclSubFieldConditionArr[] =
    {
        ...
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_IMETA_VID0_E, 0, 16}  , 0x0000FFFF, 0/*update*/},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_STAMP_LIST_END_E, 0, 0}, 0, 0}
    };

    pclId     = PRV_TGF_IPCL_PCL_ID_CNS;
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))
    {
        ...
        devRuleIndex = prvWrAppDxChTcamPclConvertedIndexGet_fromUT(
            prvTgfDevNum, PRV_TGF_IPCL_RULE_INDEX_CNS, CPSS_DXCH_TCAM_RULE_SIZE_30_B_E);
            ...
            ipclSubFieldConditionArr[0].pattern =
                (prvTgfUcastUnknownMac[5]         & 0xFF) |
                ((prvTgfUcastUnknownMac[4] <<  8) & 0xFF) |
                ((prvTgfUcastUnknownMac[3] << 16) & 0xFF) |
                ((prvTgfUcastUnknownMac[2] << 24) & 0xFF);
            ipclSubFieldConditionArr[1].pattern =
                (prvTgfUcastUnknownMac[1]         & 0xFF) |
                ((prvTgfUcastUnknownMac[2] <<  8) & 0xFF);
            ipclSubFieldConditionArr[2].pattern = PRV_TGF_VLANID_5_CNS;

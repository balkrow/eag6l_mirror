...
)
{
    ...
    static TGF_TCAM_CLIENTS_PCL_RULE_SUB_FIELD_STC ipclSubFieldArr[] =
    {
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_STAMP_LIST_END_E, 0, 0}
    };
    static TGF_TCAM_CLIENTS_PCL_RULE_SUB_FIELD_STC epclSubFieldArr[] =
    {
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L2_DST_MAC_E, 0, 48},
        {TGF_TCAM_CLIENTS_PCL_RULE_FIELD_STAMP_LIST_END_E, 0, 0}
    };
    static TGF_TCAM_CLIENTS_PCL_SUB_FIELD_CONDITION_STC    ipclSubFieldConditionArr[] =
    {
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_IFIX_MAC_DA_E, 0,  32}, 0xFFFFFFFF, 0/*update*/},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_IFIX_MAC_DA_E, 32, 16}, 0x0000FFFF, 0/*update*/},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_STAMP_LIST_END_E, 0, 0}, 0, 0}
    };
    static TGF_TCAM_CLIENTS_PCL_SUB_FIELD_CONDITION_STC    epclSubFieldConditionArr[] =
    {
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L2_DST_MAC_E, 0,  32}, 0xFFFFFFFF, 0/*update*/},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_L2_DST_MAC_E, 32, 16}, 0x0000FFFF, 0/*update*/},
        {{TGF_TCAM_CLIENTS_PCL_RULE_FIELD_STAMP_LIST_END_E, 0, 0}, 0, 0}
    };
    ...
    policerId = prvTgfPortsArray[PRV_TGF_SEND_PORT_NUM_CNS];
    pclId     = PRV_TGF_PCL_DEFAULT_ID_MAC(pclDirection, CPSS_PCL_LOOKUP_0_E, portNum);
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))
    {
        ...
        devRuleIndex = prvWrAppDxChTcamPclConvertedIndexGet_fromUT(
            prvTgfDevNum, prvTgfPclRuleIndex, CPSS_DXCH_TCAM_RULE_SIZE_30_B_E);

        if (pclDirection == CPSS_PCL_DIRECTION_INGRESS_E)
        {
            rc = prvTgfSip7TcamClientsOneLookupDevInit(
                prvTgfDevNum, TGF_TCAM_CLIENTS_PCL_LOOKUP_IPCL0_E,
                CPSS_DXCH_TCAM_RULE_SIZE_30_B_E, ipclSubFieldArr);
            UTF_VERIFY_EQUAL0_STRING_MAC(
                GT_OK, rc, "prvTgfSip7TcamClientsOneLookupDevInit");
            ...
            cpssAction.policer.policerEnable = CPSS_DXCH_PCL_POLICER_ENABLE_METER_AND_COUNTER_E;
            cpssAction.policer.policerId     = policerId;

            ipclSubFieldConditionArr[0].pattern =
                (prvTgfPacketL2Part.daMac[5]         & 0xFF) |
                ((prvTgfPacketL2Part.daMac[4] <<  8) & 0xFF) |
                ((prvTgfPacketL2Part.daMac[3] << 16) & 0xFF) |
                ((prvTgfPacketL2Part.daMac[2] << 24) & 0xFF);
            ipclSubFieldConditionArr[1].pattern =
                (prvTgfPacketL2Part.daMac[1]         & 0xFF) |
                ((prvTgfPacketL2Part.daMac[2] <<  8) & 0xFF);
            ...
            rc = tgfTcamClientsPclRuleSet(
                ...
                ipclSubFieldConditionArr, &cpssAction);
        ...
        else
        {
            ...
            epclSubFieldConditionArr[0].pattern =
                (prvTgfPacketL2Part.daMac[5]         & 0xFF) |
                ((prvTgfPacketL2Part.daMac[4] <<  8) & 0xFF) |
                ((prvTgfPacketL2Part.daMac[3] << 16) & 0xFF) |
                ((prvTgfPacketL2Part.daMac[2] << 24) & 0xFF);
            epclSubFieldConditionArr[1].pattern =
                (prvTgfPacketL2Part.daMac[1]         & 0xFF) |
                ((prvTgfPacketL2Part.daMac[2] <<  8) & 0xFF);
            ...
            rc = tgfTcamClientsPclRuleSet(
                ...
                GT_TRUE /*writeValidRule*/,
                &commonKeyHeaderMask, &commonKeyHeaderPattern,
                epclSubFieldConditionArr, &cpssAction);
            UTF_VERIFY_EQUAL0_NO_RETURN_MAC(GT_OK, rc);
        }
    }
    else
    {
        ...
        else
        {
            ...
            patt.ruleEgrStdNotIp.common.pclId = (GT_U16)pclId;
        ...
        action.policer.policerEnable = PRV_TGF_PCL_POLICER_ENABLE_METER_AND_COUNTER_E;
...
)
{
    ...
    metteringEntry.modifyUp           = PRV_TGF_POLICER_MODIFY_UP_ENABLE_E;
    metteringEntry.modifyDscp         = PRV_TGF_POLICER_MODIFY_DSCP_ENABLE_E;
...
)
{
    ...
    meteringEntry.modifyUp           = PRV_TGF_POLICER_MODIFY_UP_DISABLE_E;
    meteringEntry.modifyDscp         = PRV_TGF_POLICER_MODIFY_DSCP_DISABLE_E;

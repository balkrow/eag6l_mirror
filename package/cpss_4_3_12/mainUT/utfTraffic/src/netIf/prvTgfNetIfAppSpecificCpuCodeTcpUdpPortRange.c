...
)
{
    ...
    {
        rc = prvTgfNetIfAppSpecificCpuCodeTcpUdpPortRangeGet(prvTgfDevNum, index, &valid, &l4TypeInfoArr[index-1]);
...
)
{
    ...
    for(index = 1; index <= 3; index++)
    {
        rc = prvTgfNetIfAppSpecificCpuCodeTcpUdpPortRangeSet(prvTgfDevNum, index, &l4TypeInfoArr[index-1]);

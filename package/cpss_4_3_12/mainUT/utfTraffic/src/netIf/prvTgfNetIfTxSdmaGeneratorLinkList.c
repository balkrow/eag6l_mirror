...
GT_U8  prvTgfTxSdmaGenQueueNum = 3;

/* debug function to set TX Gen queue number */
GT_U8  prvTgfTxSdmaGenQueueNumSet(GT_U8 newQueue)
{
    GT_U8 oldQueue = prvTgfTxSdmaGenQueueNum;
    prvTgfTxSdmaGenQueueNum = newQueue;
    return oldQueue;
}

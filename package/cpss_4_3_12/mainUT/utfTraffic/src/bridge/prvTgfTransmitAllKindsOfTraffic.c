...
)
{
    ...
    GT_STATUS   rc = GT_OK;
    PRV_TGF_MAC_HASH_FUNC_MODE_ENT  mode;

    mode = prvFdbManagerLegacyHashModeForSip6DevicesGet() ? PRV_TGF_MAC_HASH_FUNC_XOR_E : PRV_TGF_MAC_HASH_FUNC_CRC_MULTI_HASH_E; 

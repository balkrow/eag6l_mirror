...
)
{
    ...
    /* emulator's clock is approximately 0.001 portion of real clock.
       and aging time 1 second takes ~1000 seconds on emulator.
       Need to skip automatic aging check on emulator. */

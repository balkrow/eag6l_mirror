...
)
{
    ...
    rc =  prvTgfBrgFdbBankCounterUpdate(prvTgfDevNum, (prvTgfIpv6UcFdbEntryIndex % fdbHashNumOfBanks), GT_TRUE);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbBankCounterUpdate: %d", (prvTgfIpv6UcFdbEntryIndex)%fdbHashNumOfBanks);

...
)
{
    ...
    GT_U32                       fdbHashNumOfBanks;

    fdbHashNumOfBanks = (PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->bridge.fdbHashParams.numOfBanks);
    ...
    if (routingByIndex == GT_TRUE)
    {
        ...
        {
            rc =  prvTgfBrgFdbBankCounterUpdate(prvTgfDevNum, prvTgfIpv4UcFdbEntryIndex%fdbHashNumOfBanks,GT_TRUE);
            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbBankCounterUpdate: %d", prvTgfIpv4UcFdbEntryIndex%fdbHashNumOfBanks);
        }

        rc =  prvTgfBrgFdbBankCounterValueGet(prvTgfDevNum, prvTgfIpv4UcFdbEntryIndex%fdbHashNumOfBanks,&counterVal);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfBrgFdbBankCounterValueGet: %d", prvTgfIpv4UcFdbEntryIndex%fdbHashNumOfBanks);
    ...
    {
        /* counter Set is moved to global config */
        rc = cpssDxChIpFdbRouteCounterSetIndexSet(prvTgfDevNum, macEntryPtr->fdbRoutingInfo.countSet);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChIpFdbRouteCounterSetIndexSet: %d", prvTgfDevNum);
    }
}
...
/**
* @internal prvTgfFdbBasicIpv4UcRoutingRouteConfigurationWithVrfIdSet function
* @endinternal
*
* @brief   Set FDB Route Configuration
*
...
*                                       None
*/
GT_VOID prvTgfFdbBasicIpv4UcRoutingRouteConfigurationWithVrfIdSet
(
    GT_BOOL routingByIndex,
    GT_U32  vrfId
)
{
    ...
    /* AUTODOC: update VRF Id in vlan[PRV_TGF_SEND_VLANID_CNS] */
    rc = prvTgfBrgVlanVrfIdSet(PRV_TGF_SEND_VLANID_CNS, vrfId);/* not prvUtfVrfId */
    UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, rc, "prvTgfBrgVlanVrfIdSet: %d %d",
                             prvTgfDevNum, PRV_TGF_SEND_VLANID_CNS);
    ...
    /* Set TTI configuration - set redirectCommand = VRF_ID, prvUtfVrfId=1 */
    PRV_UTF_LOG0_MAC("======= Setting TTI Configuration =======\n");

    prvTgfTtiTcamIndexIsRelativeSet(GT_TRUE);

    /* AUTODOC: enable TTI lookup for port 0, key PRV_TGF_TTI_KEY_UDB_IPV4_OTHER_E */
    rc = prvTgfTtiPortLookupEnableSet(prvTgfPortsArray[0],
    ...
    {
        ttiPattern.udbArray.udb[ii] = prvTgfPayloadDataArr[ii];
    ...
    for(ii = 0; ii < PRV_TGF_NUM_OF_UDB_CNS ; ii++)
    {
        rc = prvTgfTtiUserDefinedByteSet(prvTgfDevNum,
                        PRV_TGF_TTI_KEY_UDB_IPV4_OTHER_E, ii,
                        PRV_TGF_TTI_OFFSET_L4_E,(GT_U8) ii);
    }
...
/**
* @internal prvTgfFdbBasicIpv4UcRoutingConfigurationWithVrfIdRestore function
* @endinternal
*
* @brief   Restore test configuration
*/
GT_VOID prvTgfFdbBasicIpv4UcRoutingConfigurationWithVrfIdRestore
(
    GT_VOID
)
{
    ...
    /* clean TTI configuration */

    /* AUTODOC: disable TTI lookup for port 0, key PRV_TGF_TTI_KEY_UDB_IPV4_OTHER_E */
    rc = prvTgfTtiPortLookupEnableSet(prvTgfPortsArray[0],
                                PRV_TGF_TTI_KEY_UDB_IPV4_OTHER_E,GT_FALSE);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfTtiPortLookupEnableSet: %d", prvTgfDevNum);

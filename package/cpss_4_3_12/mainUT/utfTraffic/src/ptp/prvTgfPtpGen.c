...
/* Data of packet (default version) */
static GT_U8 prvTgfPacket3PayloadDataArr[] =
{
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
    0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
...
{
    sizeof(prvTgfPacket3PayloadDataArr), /* dataLength */
    prvTgfPacket3PayloadDataArr          /* dataPtr */
};

/* Data of packet (default version) */
static GT_U8 prvTgfPacket4PayloadDataArr[] =
{
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
    0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17
...
{
    sizeof(prvTgfPacket4PayloadDataArr), /* dataLength */
    prvTgfPacket4PayloadDataArr          /* dataPtr */
};
...
/* packet's IPv4 */
static TGF_PACKET_IPV4_STC prvTgfPacket3Ipv4Part = {
    4,                                          /* version */
    5,                                          /* headerLen */
    0,                                          /* typeOfService */
    0x76,                                       /* totalLen */
...
/* packet's IPv4 */
static TGF_PACKET_IPV4_STC prvTgfPacket4Ipv4Part = {
    4,                                          /* version */
    5,                                          /* headerLen */
    0,                                          /* typeOfService */
    0x56,                                       /* totalLen */
...
/* PARTS of PTP over UDP packet */
 static TGF_PACKET_PART_STC prvTgfPtpV2Packet3PartArray[] =
 {
     {TGF_PACKET_PART_L2_E,        &prvTgfPacketL2Part},
     {TGF_PACKET_PART_VLAN_TAG_E,  &prvTgfPacketVlanPart},
     {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacket2Ipv4EtherTypePart},
     {TGF_PACKET_PART_IPV4_E,      &prvTgfPacket3Ipv4Part},
...
/* PARTS of PTP over UDP packet */
 static TGF_PACKET_PART_STC prvTgfPtpV2Packet4PartArray[] =
 {
     {TGF_PACKET_PART_L2_E,        &prvTgfPacketL2Part},
     {TGF_PACKET_PART_VLAN_TAG_E,  &prvTgfPacketVlanPart},
     {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacket2Ipv4EtherTypePart},
     {TGF_PACKET_PART_IPV4_E,      &prvTgfPacket4Ipv4Part},
     {TGF_PACKET_PART_UDP_E,       &prvTgfPacketUdpPart},
     {TGF_PACKET_PART_PTP_V2_E,    &prvTgfPacketPtpV2Part},
...
/* PTP over UDP packet to send */
static TGF_PACKET_STC prvTgfPtpV2Packet3Info =
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,               /* totalLen */
    (sizeof(prvTgfPtpV2Packet3PartArray)
        / sizeof(prvTgfPtpV2Packet3PartArray[0])), /* numOfParts */
    prvTgfPtpV2Packet3PartArray                    /* partsArray */
};

/* PTP over UDP packet to send */
static TGF_PACKET_STC prvTgfPtpV2Packet4Info =
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,               /* totalLen */
    (sizeof(prvTgfPtpV2Packet4PartArray)
        / sizeof(prvTgfPtpV2Packet4PartArray[0])), /* numOfParts */
    prvTgfPtpV2Packet4PartArray                    /* partsArray */
};
...
/* packet's IPv6 */
static TGF_PACKET_IPV6_STC prvTgfPacket1Ipv6Part =
{
    6,                                      /* version */
    0,                                      /* trafficClass */
    0,                                      /* flowLabel */
...
/* PARTS of IpV6 UDP packet */
static TGF_PACKET_PART_STC prvTgfPacket1Ipv6UdpPartArray[] = {
    {TGF_PACKET_PART_L2_E,        &prvTgfPacketL2Part}, /* type, partPtr */
    {TGF_PACKET_PART_VLAN_TAG_E,  &prvTgfPacketVlanPart},
    {TGF_PACKET_PART_ETHERTYPE_E, &prvTgfPacketEtherTypePartIpv6},
    {TGF_PACKET_PART_IPV6_E,      &prvTgfPacket1Ipv6Part},
    {TGF_PACKET_PART_UDP_E,       &prvTgfPacketUdpPart},
    {TGF_PACKET_PART_PTP_V2_E,    &prvTgfPacketPtpV2Part},
    {TGF_PACKET_PART_PAYLOAD_E,   &prvTgfPacket3PayloadPart}
};
...
/* PTP over UDP packet to send */
static TGF_PACKET_STC prvTgfPacket1Ipv6UdpInfo =
{
    TGF_PACKET_AUTO_CALC_LENGTH_CNS,               /* totalLen */
    (sizeof(prvTgfPacket1Ipv6UdpPartArray)
        / sizeof(prvTgfPacket1Ipv6UdpPartArray[0])), /* numOfParts */
    prvTgfPacket1Ipv6UdpPartArray                    /* partsArray */
};
...
static GT_STATUS printToLogAllRelatedTai(void)
{
    ...
    taiId.taiNumber = CPSS_DXCH_PTP_TAI_NUMBER_0_E;
    rc = cpssDxChPtpTaiTodGet(0,&taiId,CPSS_DXCH_PTP_TAI_TOD_TYPE_CAPTURE_VALUE0_E,&todValue);
...
* @param[in] ingressPortNanosec       - nanoseconds value for ingress port TOD
*
*/
GT_STATUS prvTgfPtpGenAddCorrectedTimeTodSet
(
    GT_U32 egressPortNanosec,
    GT_U32 ingressPortNanosec
)
{
    GT_STATUS                             rc = GT_OK;
    PRV_TGF_PTP_TAI_ID_STC                tgfTaiId;
    ...
    cpssOsMemSet(&tgfTodValue, 0, sizeof(tgfTodValue));
    tgfTodValue.nanoSeconds = ingressPortNanosec;
    tgfTaiId.taiInstance = PRV_TGF_PTP_TAI_INSTANCE_PORT_E;
    tgfTaiId.taiNumber   = PRV_TGF_PTP_TAI_NUMBER_0_E;
    tgfTaiId.portNum     =
...
)
{
    ...
    if (setTodTime)
    {
        ...
        prvTgfPtpGenAddCorrectedTimeTodSet(PRV_TGF_PTP_GEN_TOD_NANOSEC_INGRESS_USED_CNS,PRV_TGF_PTP_GEN_TOD_NANOSEC_INGRESS_USED_CNS);
    }
    ...
    if (0 == prvTgfPtpIsSingleTaiSystem() && !(PRV_CPSS_SIP_6_30_CHECK_MAC(prvTgfDevNum)))
    {
...
)
{
     ...
     if (GT_TRUE == expected_valid)
    {
        ...
        PRV_UTF_LOG3_MAC("[TGF]: cpssDxChPtpTsEgressTimestampQueueEntryRead: valid entry [%d] queueEntryId [%d] portNum [%d]\n",tgfTsQueueEntry.entryValid, tgfTsQueueEntry.queueEntryId, tgfTsQueueEntry.portNum);
    }
    else
    {
        ...
        rc = cpssDxChPtpTsuTxTimestampQueueRead(prvTgfDevNum,prvTgfPortsArray[receive_port_index],1,&tgfTsPortEntry);
        UTF_VERIFY_EQUAL1_STRING_MAC(
            GT_OK, rc, "cpssDxChPtpTsuTxTimestampQueueRead, rc is %d queue 1",rc);

        UTF_VERIFY_EQUAL0_STRING_MAC(
        GT_FALSE, tgfTsPortEntry.entryValid, "entryValid");

        PRV_UTF_LOG2_MAC("[TGF]: cpssDxChPtpTsEgressTimestampQueueEntryRead: valid entry [%d] portNum [%d]\n",tgfTsQueueEntry.entryValid, prvTgfPortsArray[receive_port_index]);
    ...
    if(PRV_CPSS_PP_MAC(prvTgfDevNum) && PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum)&& tgfTsQueueEntry.entryValid)
    {
        ...
        UTF_VERIFY_EQUAL0_STRING_MAC(
            tgfTsQueueEntry.queueEntryId  , tgfTsPortEntry.queueEntryId, "queueEntryId");

        PRV_UTF_LOG3_MAC("[TGF]: cpssDxChPtpTsuTxTimestampQueueRead: valid entry [%d] queueEntryId [%d] portNum [%d]\n",tgfTsPortEntry.entryValid, tgfTsPortEntry.queueEntryId, tgfTsQueueEntry.portNum);
        PRV_UTF_LOG2_MAC("Egress Timestamp Port Queue Entry: nano 0x%08X port %d\n",tgfTsPortEntry.timestamp,tgfTsQueueEntry.portNum);
    }


    PRV_UTF_LOG2_MAC("[TGF]: prvTgfPtpGenEgressCaptureQueue1Check end. valid entries: %d %d\n",tgfTsQueueEntry.entryValid,tgfTsPortEntry.entryValid);
}
...
)
{
    ...
    *correctFieldValuePtr = ((packetBuff[correctFieldOffset] << 8) +
                            (packetBuff[correctFieldOffset+1]))* 4294967296.00 + /*equal << 32*/
...
)
{
    ...
    prvTgfPtpGenAddCorrectedTimeTodSet(PRV_TGF_PTP_GEN_TOD_NANOSEC_EGRESS_USED_CNS,PRV_TGF_PTP_GEN_TOD_NANOSEC_INGRESS_USED_CNS);
    ...
    else
    {
        ...
        if (correctFieldValueDiff < 0)
        {
            correctFieldValueDiff *= -1;
        }
...
/**
* @internal prvTgfPtpGenAddCorrectionTimeTodStepZeroTrafficCheck function
* @endinternal
*
* @brief   Send traffic and check results
*/
GT_VOID prvTgfPtpGenAddCorrectionTimeTodStepZeroTrafficCheck
(
    GT_VOID
)
{
    ...
    CPSS_DXCH_PTP_TAI_TOD_STEP_STC todStepRestore[CPSS_DXCH_PTP_TAI_NUMBER_ALL_E];
    GT_U32  taiNumber;
    GT_STATUS rc;

    for (taiNumber=0 ; taiNumber<PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->hwInfo.ptpInfo.maxNumOfTais ;taiNumber++)
    {
        taiId.taiNumber = taiNumber;
        rc = cpssDxChPtpTaiTodStepGet(prvTgfDevNum, &taiId, &todStepRestore[taiNumber]);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "cpssDxChPtpTaiTodStepGet");
    }

    /* AUTODOC: Set TAI TOD Step '0' for all TAIs */
    taiId.taiNumber = CPSS_DXCH_PTP_TAI_NUMBER_ALL_E;
    todStep.nanoSeconds = 0;
    todStep.fracNanoSeconds = 0;
    rc = cpssDxChPtpTaiTodStepSet(prvTgfDevNum, &taiId, &todStep);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "cpssDxChPtpTaiTodStepSet");

    for (taiNumber=0 ; taiNumber<PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->hwInfo.ptpInfo.maxNumOfTais ;taiNumber++)
    {
        rc = cpssDxChPtpTaiTodStepDbgSet(prvTgfDevNum,taiNumber,&todStep);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "cpssDxChPtpTaiTodStepDbgSet");
    }

    /* AUTODOC: Set TOD value to be '0' for all TAIs */
    prvTgfPtpGenAddCorrectedTimeTodSet(0,0);

    prvTgfPtpGenAddCorrectionTimeTrafficSendAndFieldGet(&correctFieldValueInNs);

    UTF_VERIFY_EQUAL1_STRING_MAC(0, (GT_U32)correctFieldValueInNs, "correctField is not zero [%f]\n",correctFieldValueInNs);
    ...
    {
        taiId.taiNumber = taiNumber;
        rc = cpssDxChPtpTaiTodStepSet(prvTgfDevNum, &taiId, &todStepRestore[taiNumber]);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "cpssDxChPtpTaiTodStepSet");
    }
}
...
)
{
    ...
    if (!(PRV_CPSS_SIP_6_30_CHECK_MAC(prvTgfDevNum)))
    {
        ...
        rc = prvTgfPtpTsDelayEgressTimeCorrTaiSelectModeSet(
            prvTgfPortsArray[PRV_TGF_PTP_GEN_SEND_PORT_INDEX_CNS],
            PRV_TGF_PTP_TS_DELAY_TAI_SEL_MODE_INGRESS_E);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfPtpTsDelayEgressTimeCorrTaiSelectModeSet");
...
/**
* @internal prvTgfPtpGenTrafficAndCheckCpuGetTimeStampTag
*           function
* @endinternal
*
...
/**
* @internal prvTgfPtpGenTrafficAndCheckTimestampTagging function
* @endinternal
*
* @brief   send traffic , get packet from the cpu and check the timestamp tag.
*/
GT_VOID prvTgfPtpGenTrafficAndCheckTimestampTagging
(
...
)
{
    ...
    if (tagMode == PRV_TGF_PTP_TS_TAG_MODE_NON_EXTENDED_E)
    {
        if ((packetBuff[12] != ((PRV_TGF_PTP_TS_TAG_ETHERTYPE_CNS >> 8) & 0xFF)) ||
        (packetBuff[13] != (PRV_TGF_PTP_TS_TAG_ETHERTYPE_CNS & 0xFF)) ||
        (packetBuff[20] != 0x81) || ((packetBuff[14] >> 7) != 0))
        {
            rc = GT_FAIL;
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, rc, "packetBuff[12] =  %2.2x (expected 0xfe), packetBuff[13] =  %2.2x (expected 0xdc), "
                                                    "E bit (MSB in packetBuff[13]) =  %d (expected 0, non-extended), packetBuff[20] =  %2.2x (expected 0x81)",
                                         packetBuff[12], packetBuff[13], (packetBuff[14] >> 7), packetBuff[20]);
        }
    }
    if (tagMode == PRV_TGF_PTP_TS_TAG_MODE_ALL_EXTENDED_E)
    {
        if ((packetBuff[12] != ((PRV_TGF_PTP_TS_TAG_ETHERTYPE_CNS >> 8) & 0xFF)) ||
        (packetBuff[13] != (PRV_TGF_PTP_TS_TAG_ETHERTYPE_CNS & 0xFF)) ||
        (packetBuff[28] != 0x81) || ((packetBuff[14] >> 7) != 1))
        {
            rc = GT_FAIL;
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, rc, "packetBuff[12] =  %2.2x (expected 0xfe), packetBuff[13] =  %2.2x (expected 0xdc), "
                                                    "E bit (MSB in packetBuff[13]) =  %d (expected 1, extended), packetBuff[28] =  %2.2x (expected 0x81)",
                                         packetBuff[12], packetBuff[13], (packetBuff[14] >> 7), packetBuff[28]);
        }
    }
}
...
)
{
     ...
     * should not be more than 3 milisec, ideal case should be 0 */
    /* AUTODOC: Compare two values of ingress delay and egress delay. Difference should be less than 3 miliseconds */

    /* check for a WA in the nanoSec */
    if(egressTime[1] >= egressTime[0])
    {
        egressDelay = egressTime[1] - egressTime[0];
    }
    else
    {
        egressDelay = 1000000000 - (egressTime[1] - egressTime[0]);
    }

    /* check for a WA in the nanoSec */
    if(ingressTime[1] >= ingressTime[0])
    {
        ingressDelay = ingressTime[1] - ingressTime[0];
    }
    else
    {
        ingressDelay = 1000000000 - (ingressTime[1] - ingressTime[0]);
    }

    /* if we had WA in the ingress time; run traffic again. */
    if ((iteration < 2) && (ingressTime[1] < ingressTime[0]))
    {
        PRV_UTF_LOG2_MAC("[TGF] - ingress time WA; run the test again. ingressTime[0] = 0x%08X, ingressTime[1] = 0x%08X",
            ingressTime[0], ingressTime[1]);
        *statusPtr = GT_FAIL;
        return;
    }

    /* if we had WA in the engress time; run traffic again. */
    if ((iteration < 2) && (egressTime[1] < egressTime[0]))
    {
        PRV_UTF_LOG2_MAC("[TGF] - egress time WA; run the test again. egressTime[0] = 0x%08X, egressTime[1] = 0x%08X",
            egressTime[0], egressTime[1]);
        *statusPtr = GT_FAIL;
        return;
    }

    rc = GT_OK;
    PRV_UTF_LOG2_MAC("[TGF] - egressTime diff = 0x%08X, ingressTime diff = 0x%08X\n",
            egressDelay, ingressDelay);
    PRV_UTF_LOG2_MAC("[TGF] - abs(egressDelay - ingressDelay) = 0x%08X ; %d\n",
            abs(egressDelay - ingressDelay),abs(egressDelay - ingressDelay));
    if(abs(egressDelay - ingressDelay) > 3000000)
    {
        rc = GT_FAIL;
    }

        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "prvTgfPtpGenAddIngressEgressTrafficGenerateAndCheck; abs(egressDelay - ingressDelay) > 3000000");
...
/**
* @internal
*           prvTgfPtpManagerPtpOverIpv4UDPTrafficGenerateAndCheck
*           function
* @endinternal
*
* @brief   Generate traffic:
...
)
{
    ...
    GT_U8           queue    = 0;
    GT_U8           receiveDevNum;
    GT_U32          tsOffset,trailerOffset,payloadOffset;
    GT_32           memCmpRc;
    GT_U8           checksum[2] = {0};
    ...
    if (isIpv6 == GT_TRUE)
    {
         if (longPacket == GT_TRUE)
         {
             PRV_UTF_LOG0_MAC("\nSending IPv6 Long Packet.\n\n");

            /* Traffic with capture */
            rc = prvTgfTransmitPacketsWithCapture(
                prvTgfDevsArray[PRV_TGF_PTP_GEN_SEND_PORT_INDEX_CNS],
                prvTgfPortsArray[PRV_TGF_PTP_GEN_SEND_PORT_INDEX_CNS],
                &prvTgfPacket1Ipv6UdpInfo,
                1      /*burstCount*/,
                0      /*numVfd*/,
                NULL   /*vfdArray*/,
                prvTgfDevsArray[PRV_TGF_PTP_GEN_RECEIVE_PORT_INDEX_CNS],
         ...
         {
             PRV_UTF_LOG0_MAC("\nSending IPv6 Short Packet.\n\n");

             /* Traffic with capture */
            rc = prvTgfTransmitPacketsWithCapture(
                prvTgfDevsArray[PRV_TGF_PTP_GEN_SEND_PORT_INDEX_CNS],
                prvTgfPortsArray[PRV_TGF_PTP_GEN_SEND_PORT_INDEX_CNS],
                &prvTgfPacketIpv6UdpInfo,
                1      /*burstCount*/,
                0      /*numVfd*/,
                NULL   /*vfdArray*/,
                prvTgfDevsArray[PRV_TGF_PTP_GEN_RECEIVE_PORT_INDEX_CNS],
    ...
    else /* ipv4 packet */
    {
        if (longPacket == GT_TRUE)
        {
            PRV_UTF_LOG0_MAC("\nSending IPv4 Long Packet.\n\n");

            /* Traffic with capture */
            rc = prvTgfTransmitPacketsWithCapture(
                prvTgfDevsArray[PRV_TGF_PTP_GEN_SEND_PORT_INDEX_CNS],
                prvTgfPortsArray[PRV_TGF_PTP_GEN_SEND_PORT_INDEX_CNS],
                &prvTgfPtpV2Packet3Info,
                1      /*burstCount*/,
                0      /*numVfd*/,
                NULL   /*vfdArray*/,
                prvTgfDevsArray[PRV_TGF_PTP_GEN_RECEIVE_PORT_INDEX_CNS],
        ...
        {
            PRV_UTF_LOG0_MAC("\nSending IPv4 Short Packet.\n\n");

            /* Traffic with capture */
            rc = prvTgfTransmitPacketsWithCapture(
                prvTgfDevsArray[PRV_TGF_PTP_GEN_SEND_PORT_INDEX_CNS],
                prvTgfPortsArray[PRV_TGF_PTP_GEN_SEND_PORT_INDEX_CNS],
                &prvTgfPtpV2Packet4Info,
                1      /*burstCount*/,
                0      /*numVfd*/,
                NULL   /*vfdArray*/,
                prvTgfDevsArray[PRV_TGF_PTP_GEN_RECEIVE_PORT_INDEX_CNS],
   ...
   buffLen  = sizeof(packetBuff);
    ...
    if (ptpAction == PRV_TGF_PTP_TS_ACTION_ADD_CORRECTED_TIME_E)
    {
        ...
        memCmpRc = cpssOsMemCmp(&(packetBuff[tsOffset]), prvTgfPacketPtpV2Part.correctionField, 8);
        UTF_VERIFY_NOT_EQUAL0_STRING_MAC(
            0, memCmpRc, "correctionField updated check");
    }

    if (ptpAction == PRV_TGF_PTP_TS_ACTION_ADD_TIME_E)
    {
        ...
        memCmpRc = cpssOsMemCmp(&(packetBuff[tsOffset]), prvTgfPacket3PayloadPart.dataPtr, 10);
        UTF_VERIFY_NOT_EQUAL0_STRING_MAC(
            0, memCmpRc, "timestamp updated check");
    }

    if (checksumMode == PRV_TGF_PTP_TS_UDP_CHECKSUM_UPDATE_MODE_KEEP_E)
    {
        /* check that UDP checksum trailer was not updated in udp payload */
        memCmpRc = cpssOsMemCmp(&(packetBuff[trailerOffset /* last 2 header bytes */]), &prvTgfPacket3PayloadPart.dataPtr[payloadOffset], 2);
        UTF_VERIFY_EQUAL0_STRING_MAC(
            0, memCmpRc, "udp checksum trailer updated check");

    }
    else if (checksumMode == PRV_TGF_PTP_TS_UDP_CHECKSUM_UPDATE_MODE_CLEAR_E)
    {
        /* check that UDP checksum trailer was not update in udp payload */
        memCmpRc = cpssOsMemCmp(&(packetBuff[trailerOffset /* last 2 header bytes */]), &prvTgfPacket3PayloadPart.dataPtr[payloadOffset], 2);
        UTF_VERIFY_EQUAL0_STRING_MAC(
            0, memCmpRc, "udp checksum trailer updated check");

        /* check that UDP checksum was cleared in udp header */
        if (isIpv6 == GT_TRUE)
        {
            memCmpRc = cpssOsMemCmp(&(packetBuff[64]), &checksum[0], 2);
        }
        else
        {
            memCmpRc = cpssOsMemCmp(&(packetBuff[44]), &checksum[0], 2);
        }
        UTF_VERIFY_EQUAL0_STRING_MAC(
            0, memCmpRc, "udp checksum updated check");

    }
    if (checksumMode == PRV_TGF_PTP_TS_UDP_CHECKSUM_UPDATE_MODE_RECALCULATE_E)
    {
        /* check that UDP checksum trailer was updated in udp payload */
        memCmpRc = cpssOsMemCmp(&(packetBuff[trailerOffset /* last 2 header bytes */]), &prvTgfPacket3PayloadPart.dataPtr[payloadOffset], 2);
        UTF_VERIFY_NOT_EQUAL0_STRING_MAC(
            0, memCmpRc, "udp checksum trailer updated check");
...
)
{
    ...
    if (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_AC5X_E || PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
    {
        PRV_CPSS_DXCH_PTP_PORT_NUM_CHECK_AND_MAC_NUM_GET_MAC(prvTgfDevNum,ingressPortNum,portMacNum);

        if (PRV_CPSS_DXCH_PORT_TYPE_MAC(prvTgfDevNum, portMacNum) == PRV_CPSS_PORT_MTI_USX_E)
        {
            mtipRegAddr[0] = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->GOP.MTI[portMacNum].MTI_USX_EXT.portTsxControl2;
            mtipRegAddr[1] = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->GOP.MTI[portMacNum].MTI_USX_EXT.portTsxControl3;
            mtipRegAddr[2] = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->GOP.MTI[portMacNum].MTI_USX_EXT.portTsxControl4;
        }
        else /*(PRV_CPSS_DXCH_PORT_TYPE_MAC(devNum, portMacNum) == PRV_CPSS_PORT_MTI_CPU_E)*/
        {
            mtipRegAddr[0] = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->GOP.MTI[portMacNum].MTI_CPU_EXT.portTsxControl2;
            mtipRegAddr[1] = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->GOP.MTI[portMacNum].MTI_CPU_EXT.portTsxControl3;
            mtipRegAddr[2] = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->GOP.MTI[portMacNum].MTI_CPU_EXT.portTsxControl4;
        }
        ...
        PRV_CPSS_DXCH_PTP_PORT_NUM_CHECK_AND_MAC_NUM_GET_MAC(prvTgfDevNum,egressPortNum,portMacNum);
    ...
    else if ((PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_AC5P_E) || (PRV_CPSS_PP_MAC(prvTgfDevNum)->devFamily == CPSS_PP_FAMILY_DXCH_HARRIER_E))
    {
        ...
        /* configure TXS disable */
        rc = prvCpssHwPpSetRegField(prvTgfDevNum, mtipRegAddr[0], 0, 2, 3);
        PRV_UTF_VERIFY_GT_OK(rc, "prvTgfPtpGenTsxDisable");
    }

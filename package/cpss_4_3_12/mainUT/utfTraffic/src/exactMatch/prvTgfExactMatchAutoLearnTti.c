...
)
{
    ...
    keyParams.keySize           =PRV_TGF_EXACT_MATCH_KEY_SIZE_33B_E;
    ...
    rc = cpssDxChExactMatchPortGroupAutoLearnFlowIdParamGet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&prvTgfExactMatchRestoreCfg.exactMatchAutoLearnFlowIdConfiguration);
    ...
    rc = prvTgfExactMatchClientLookupSet(prvTgfDevNum, PRV_TGF_EXACT_MATCH_UNIT_0_E, lookupNum, firstLookupClientType);
    ...
    rc = prvTgfExactMatchExpandedActionSet(prvTgfDevNum, PRV_TGF_EXACT_MATCH_UNIT_0_E,
                                           PRV_TGF_EXACT_MATCH_EXPANDER_ID_CNS,
    ...
    rc = cpssDxChExactMatchAutoLearnProfileDefaultActionSet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
    ...
    rc = cpssDxChExactMatchPortGroupAutoLearnFlowIdAllocStatusGet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,
...
)
{
    ...
    rc = cpssDxChExactMatchPortGroupAutoLearnEntryRecycleGet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
...
)
{
    ...
    rc = cpssDxChExactMatchPortGroupAutoLearnEntryGetNext(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                          CPSS_PORT_GROUP_UNAWARE_MODE_CNS,
                                                          &autoLearnFlowId,
    ...
    rc = prvTgfExactMatchPortGroupEntryInvalidate(prvTgfDevNum, PRV_TGF_EXACT_MATCH_UNIT_0_E, PRV_TGF_EXACT_MATCH_LOOKUP_FIRST_E,
                                                  portGroupsBmp,autoLearnOldestExactMatchIndex);
    ...
    rc = cpssDxChExactMatchPortGroupAutoLearnFailCountersGet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                             CPSS_PORT_GROUP_UNAWARE_MODE_CNS,
...
)
{
    ...
    for( k=0; k<numberOfTigger; k++)
    {
        ...
        rc = cpssDxChExactMatchPortGroupAutoLearnEntryRecycleTrigger(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS);
        if (rc!=GT_OK && rc!=GT_EMPTY)
        {
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "cpssDxChExactMatchPortGroupAutoLearnEntryRecycleTrigger");
        }
    ...
    /* AUTODOC: return fail counters for debug */
    rc = cpssDxChExactMatchPortGroupAutoLearnFailCountersGet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,
                                                             &autoLearnFailCounters);
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "cpssDxChExactMatchPortGroupAutoLearnFailCountersGet");
    UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "cpssDxChExactMatchPortGroupAutoLearnFailCountersGet");
    UTF_VERIFY_EQUAL1_STRING_MAC(0, autoLearnFailCounters.flowIdFailCounter,
...
)
{
    ...
    rc = cpssDxChExactMatchAutoLearnLookupGet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,&prvTgfExactMatchRestoreCfg.exactMatchAutoLearnLookupNum);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChExactMatchAutoLearnLookupGet FAILED: %d", prvTgfDevNum);

    /* AUTODOC: keep flow id configuration, for restore */
    rc = cpssDxChExactMatchPortGroupAutoLearnFlowIdParamGet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,
    ...
    rc = cpssDxChExactMatchAutoLearnProfileDefaultActionEnableGet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                                  exactMatchAutoLearnProfileIndex,
    ...
    rc = cpssDxChExactMatchAutoLearnLookupSet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
    ...
    rc = cpssDxChExactMatchAutoLearnProfileDefaultActionEnableSet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                                  exactMatchAutoLearnProfileIndex,
                                                                  GT_FALSE);
    ...
    rc = cpssDxChExactMatchPortGroupAutoLearnFlowIdParamSet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,
...
)
{
    ...
    rc = cpssDxChExactMatchAutoLearnLookupSet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                              prvTgfExactMatchRestoreCfg.exactMatchAutoLearnLookupNum);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChExactMatchAutoLearnLookupSet FAILED: %d", prvTgfDevNum);
    ...
    rc = cpssDxChExactMatchAutoLearnProfileDefaultActionEnableSet(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchAutoLearnProfileIndex,
                                                                  prvTgfExactMatchRestoreCfg.exactMatchAutoLearnDefaultEnable);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChExactMatchAutoLearnProfileDefaultActionEnableSet FAILED: %d", prvTgfDevNum);
...
)
{
    ...
    rc = prvTgfExactMatchClientLookupGet(prvTgfDevNum, PRV_TGF_EXACT_MATCH_UNIT_0_E,
                                         exactMatchLookupNum,&prvTgfExactMatchRestoreCfg.firstLookupClientType);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfExactMatchClientLookupGet FAILED: %d", prvTgfDevNum);
    ...
    rc = prvTgfExactMatchClientLookupSet(prvTgfDevNum, PRV_TGF_EXACT_MATCH_UNIT_0_E,
                                         exactMatchLookupNum, firstLookupClientType);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfExactMatchClientLookupSet FAILED: %d", prvTgfDevNum);
    ...
    /* AUTODOC: set Profile Key Params */
    rc =  prvTgfExactMatchProfileKeyParamsSet(prvTgfDevNum, PRV_TGF_EXACT_MATCH_UNIT_0_E,
                                              PRV_TGF_EXACT_MATCH_PROFILE_ID_CNS, &keyParams);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfExactMatchProfileKeyParamsSet FAILED: %d", prvTgfDevNum);
    ...
    exactMatchAutoLearnProfileIndex = PRV_TGF_EXACT_MATCH_PROFILE_ID_CNS;/* set the autoLearn profile id to be the same as the expanded profile index */
    exactMatchAutoLearnActionType = CPSS_DXCH_EXACT_MATCH_ACTION_PCL_E;
    cpssOsMemSet((GT_VOID*) &exactMatchAutoLearnDefaulActionData, 0, sizeof(exactMatchAutoLearnDefaulActionData));
    ...
    if(pktCmd==CPSS_PACKET_CMD_FORWARD_E)
    {
        ...
        exactMatchAutoLearnDefaulActionData.pclAction.redirect.data.outIf.outInterface.type=CPSS_INTERFACE_PORT_E;
        rc = prvUtfHwDeviceNumberGet(prvTgfDevNum,&hwDevNumVal);
...
)
{
    ...
    rc = cpssDxChExactMatchPortGroupEntryInvalidate(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                    CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                    CPSS_PORT_GROUP_UNAWARE_MODE_CNS,exactMatchIndex[0]);
    ...
    regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->EM[CPSS_DXCH_EXACT_MATCH_UNIT_0_E].EMAutoLearning.EMFlowIdAllocationStatus2;
    ...
    regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->EM[CPSS_DXCH_EXACT_MATCH_UNIT_0_E].EMAutoLearning.EMFlowIdAllocationStatus3;
    rc = prvCpssHwPpPortGroupGetRegField(prvTgfDevNum,portGroupId,regAddr,0,16,&nextFlowId);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvCpssHwPpPortGroupGetRegField FAILED: %d", prvTgfDevNum);

    /* Read the value of allocated FlowIDs */
    regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->EM[CPSS_DXCH_EXACT_MATCH_UNIT_0_E].EMAutoLearning.EMFlowIdAllocationStatus1;
    ...
    for (k=1; k<maxNumber; k++)
    {
        ...
        if (k>=4)
        {
            /* Gets the oldest entry from the current auto-learned
               Exact Match entries and its assosiated Flow ID. */
           rc = cpssDxChExactMatchPortGroupAutoLearnEntryGetNext(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,
                                                                 &(flowIdIndex[k]),
                                                                 &(exactMatchIndex[k]));
           UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChExactMatchPortGroupAutoLearnEntryGetNext FAILED: %d", prvTgfDevNum);
        }
        ...
        rc = cpssDxChExactMatchPortGroupEntryInvalidate(prvTgfDevNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                        CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                        CPSS_PORT_GROUP_UNAWARE_MODE_CNS,exactMatchIndex[k]);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChExactMatchPortGroupEntryInvalidate FAILED: %d", prvTgfDevNum);
...
)
{
    ...
    {
        rc = cpssDxChExactMatchPortGroupAutoLearnFlowIdParamGet(prvTgfDevNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, &flowIdConfiguration);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "cpssDxChExactMatchPortGroupAutoLearnFlowIdParamGet FAILED: %d", prvTgfDevNum);
...
)
{
    ...
    for (bank = 0;bank < prvTgfExactMatchRestoreCfg.numberOfElementsInExactMatchEntryIndexArr ;bank++)
   {
        ...
        if (prvTgfExactMatchRestoreCfg.exactMatchEntryIndexArr[bank]!=0xFFFFFFFF)
        {
            ...
            rc = prvTgfExactMatchPortGroupEntryInvalidate(prvTgfDevNum, PRV_TGF_EXACT_MATCH_UNIT_0_E, PRV_TGF_EXACT_MATCH_LOOKUP_FIRST_E,
                                                          portGroupsBmp,prvTgfExactMatchRestoreCfg.exactMatchEntryIndexArr[bank]);
            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc, "prvTgfExactMatchPortGroupEntryInvalidate FAILED: %d", prvTgfDevNum);
        }
    }
...
GT_STATUS prvTgfExactMatchAutoLearnDebugPrint(GT_VOID)
{
    ...
    regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(prvTgfDevNum)->EM[CPSS_DXCH_EXACT_MATCH_UNIT_0_E].EMAutoLearning.EMFlowIdAllocationConfiguration2;

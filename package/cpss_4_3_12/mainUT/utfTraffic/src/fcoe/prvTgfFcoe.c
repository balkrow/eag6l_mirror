...
)
{
    ...
    defaultFcoeForwardingNextHopInfo.ipLttEntry.routeType                  = PRV_TGF_IP_REGULAR_ROUTE_ENTRY_GROUP_E;
...
)
{
    ...
    PRV_TGF_LPM_RAM_CONFIG_STC              ramDbCfg;
    PRV_TGF_IP_TCAM_ROUTE_ENTRY_INFO_UNT    defaultFcoeForwardingNextHopInfo;
    PRV_TGF_IP_ROUTE_ENTRY_METHOD_ENT       routeType = PRV_TGF_IP_ECMP_ROUTE_ENTRY_GROUP_E;
    ...
    routeType = PRV_TGF_IP_REGULAR_ROUTE_ENTRY_GROUP_MAC;

    cpssOsMemSet(&nextHopInfo, 0, sizeof(nextHopInfo));
    if (routeType == PRV_TGF_IP_REGULAR_ROUTE_ENTRY_GROUP_E)
    {
        nextHopInfo.ipLttEntry.routeType = CPSS_DXCH_IP_ROUTE_ENTRY_METHOD_REGULAR_E;
    }
    else
        if (routeType == PRV_TGF_IP_ECMP_ROUTE_ENTRY_GROUP_E)
        {

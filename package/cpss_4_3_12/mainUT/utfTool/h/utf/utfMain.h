...
/*
 * Description: This macro checks if received value is equal to expected value.
 *      It is used when there are eight arguments in output string.
 *
 * Parameters:
 *      e                                               -    expected value
 *      r                                               -    received value
 ...
 *      Output string has format accordingly to "CPSS Unit Test SDD":[CPSS_UT_0130]
 */
#define UTF_VERIFY_EQUAL8_PARAM_MAC(e, r, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)     \
    do {                                                                                \
        GT_BOOL err = utfEqualVerify(e, r, __LINE__, __FILE__);                         \
        if (GT_FALSE == err) {                                                          \
            UTF_ARGVP_ARR_8_MAC(argvp,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8);         \
            err = utfFailureMsgLog(NULL, argvp, 8);                                     \
            if (GT_FALSE == err) return;                                                \
        }                                                                               \
    } while(0)
/*
...
*
*/
GT_U32 utfMemoryHeapLeakageToleranceSet
(
    IN GT_U32 toleranceInBytes
);

...
UTF_MAIN_BEGIN_SUITS_MAC()
    ...
    UTF_MAIN_DECLARE_SUIT_MAC(cpssDxChBrgHEcmp)
    ...
    UTF_MAIN_DECLARE_SUIT_MAC(cpssDxChIpfixFw)
    ...
    UTF_MAIN_DECLARE_SUIT_MAC(cpssDxChStreamGateControl)
    ...
    UTF_MAIN_DECLARE_SUIT_MAC(cpssDxChTam)
    ...
    /* DMA manager tests may corrupt data in AUQ and other DBs.
       Need to run suite after all other DMA based tests done. */
    UTF_MAIN_DECLARE_SUIT_MAC(cpssDmaLayer)
    ...
    UTF_MAIN_DECLARE_SUIT_MAC(tgfIpfixFw)
    UTF_MAIN_DECLARE_SUIT_MAC(tgfStream)
    UTF_MAIN_DECLARE_SUIT_MAC(tgfTam)
...
#if defined (INCLUDE_TM)
#if !defined(CPSS_APP_PLATFORM_REFERENCE) || defined(MIXED_MODE) /*not supported in CAP - UTs have appDemo references */
    UTF_MAIN_DECLARE_SUIT_MAC(tgfTm)
#endif
#endif
#endif

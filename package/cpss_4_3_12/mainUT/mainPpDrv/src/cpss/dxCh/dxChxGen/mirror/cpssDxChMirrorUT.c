    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        while (GT_OK == prvUtfNextVirtPortGet(&mirrPort, GT_TRUE))
        {
            ...
            */
            ...
            st = cpssDxChMirrorRxPortSet(dev, mirrPort, GT_FALSE, state, analyzerIndex);
            ...
            */
            ...
            UTF_VERIFY_EQUAL1_STRING_MAC(analyzerIndex, index,
                                         "get another enable than was set: %d", dev);
            /*
                1.1. Call function with mirrPort [0],
                                        enable [GT_FALSE / GT_TRUE].
        ...
        while (GT_OK == prvUtfNextPhyPortGet(&mirrPort, GT_TRUE))
        {
            ...
            */
            ...
            st = cpssDxChMirrorRxPortSet(dev, mirrPort, GT_TRUE, state, analyzerIndex);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, dev, mirrPort, state);
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        while (GT_OK == prvUtfNextTxqPortGet(&mirrPort, GT_TRUE))
        {
            ...
            */
            ...
            {
                index = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 64 : 7;
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        /*call with index [7]*/
        index = PRV_CPSS_SIP_7_CHECK_MAC(dev) ? 63 : 7;
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        /*call with index [1]*/
        index= PRV_CPSS_SIP_7_CHECK_MAC(dev)? 8 : 1;

        st = cpssDxChMirrorAnalyzerInterfaceGet(dev, index, &interface);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);

        /*call with index [6] */
        index = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 62 : 6;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        /*
            ...
            Expected: GT_BAD_PARAM.
        */
        index = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 63 : 8;
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        index = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 8 : 0;
        ...
        for(index = 0; index < 7; index++)
        {
            ...
            */
            ...
            /*
                ...
                Expected: GT_BAD_PARAM.
            */
            index = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 64 : 8;
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                   "cpssDxChMirrorTreatEgressMirroredAsIngressMirroredEnableGet: %d", dev);
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        for(mode = CPSS_DXCH_MIRROR_ON_DROP_MODE_DISABLE_E; mode < CPSS_DXCH_MIRROR_ON_DROP_MODE_MIRROR_TO_ANALYZER_E+1; mode++)
        {
            ...
            if (mode == CPSS_DXCH_MIRROR_ON_DROP_MODE_MIRROR_TO_ANALYZER_E)
            {
                ...
                config.mode = mode;
                config.analyzerIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 63 : 0x7;
                st = cpssDxChMirrorOnDropConfigSet(dev, &config);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet)
{
/*
    ITERATE_DEVICES Falcon)
    1.1. Call function with index [1 / 6], enable [GT_FALSE / GT_TRUE] and ratio [1].
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            */
            ...
            st = cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet(
                dev, portGroupsBmp, index, enable, ratio);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
            ...
            */
            ...
            st = cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet(
                dev, portGroupsBmp, index, &enableGet, &ratioGet);

            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                       "cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet: %d, %d", dev);
            UTF_VERIFY_EQUAL1_STRING_MAC(enable, enableGet,
                                       "get another enable than was set: %d, %d", dev);
            UTF_VERIFY_EQUAL1_STRING_MAC(ratio, ratioGet,
                                        "get another ratio than was set: %d, %d", dev);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet)
{
/*
    ITERATE_DEVICES (Falcon)
    1.1. Call with not null pointers.
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            */
            ...
            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                       "cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet: %d", dev);
            ...
            */
            st = cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet(
                dev, portGroupsBmp, index, NULL, &ratioGet);
            ...
            */
            st = cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet(
                dev, portGroupsBmp, index, &enableGet, NULL);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet)
{
/*
    ITERATE_DEVICES Falcon)
    1.1. Call function with index [0 / 6], and ratio [1].
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            */
            ...
            st = cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet(
                dev, portGroupsBmp, index, ratio);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);

            /*
                1.2. Call cpssDxChMirrorPortGroupTxGlobalAnalyzerInterfaceIndexGet function.
                Expected: GT_OK and the same value.
            */

            st = cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet(
                dev, portGroupsBmp, index, &ratioGet);

            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                       "cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet: %d, %d", dev);
            UTF_VERIFY_EQUAL1_STRING_MAC(ratio, ratioGet,
                                        "get another ratio than was set: %d, %d", dev);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet)
{
/*
    ITERATE_DEVICES (Falcon)
    1.1. Call with not null pointers.
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            for(index = 0; index < 7; index++)
            {
                ...
                */
                ...
                UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                           "cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet: %d", dev);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupToAnalyzerTruncateSet)
{
/*
    ITERATE_DEVICES Falcon)
    1.1. Call function with index [1 / 6], truncate [GT_FALSE / GT_TRUE].
    Expected: GT_OK.
    1.2. Call cpssDxChMirrorPortGroupToAnalyzerTruncateGet function.
    Expected: GT_OK and the same value.
    1.3. Call function with out of range index [7].
    Expected: GT_BAD_PARAM.
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            */
            ...
            st = cpssDxChMirrorPortGroupToAnalyzerTruncateSet(
                dev, portGroupsBmp, index, truncate);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);

            /*
                1.2. Call internal_cpssDxChMirrorPortGroupToAnalyzerTruncateGet function.
                Expected: GT_OK and the same value.
            */

            st = cpssDxChMirrorPortGroupToAnalyzerTruncateGet(
                dev, portGroupsBmp, index, &truncateGet);

            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                       "cpssDxChMirrorPortGroupToAnalyzerTruncateGet: %d, %d", dev);
            UTF_VERIFY_EQUAL1_STRING_MAC(truncate, truncateGet,
                                       "get another enable than was set: %d, %d", dev);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupToAnalyzerTruncateGet)
{
/*
    ITERATE_DEVICES (Falcon)
    1.1. Call with not null pointers.
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            */
            ...
            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                       "cpssDxChMirrorPortGroupToAnalyzerTruncateGet: %d", dev);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupAnalyzerInterfaceSet)
{
/*
    ITERATE_DEVICES (xCat and above)
    1.1. Call function with index [1 / 6].
    Expected: GT_OK.
    1.2. Call cpssDxChMirrorPortGroupAnalyzerInterfaceGet with the same parameters.
    Expected: GT_OK and the same value.
    1.3. Call function with out of range index [7].
    Expected: GT_BAD_PARAM.
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            */
            ...
            st = cpssDxChMirrorPortGroupAnalyzerInterfaceSet(
                dev, portGroupsBmp, index, &interface);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
            ...
            /*
                ...
                Expected: GT_OK and the same value.
            */
            st = cpssDxChMirrorPortGroupAnalyzerInterfaceGet(
                dev, portGroupsBmp, index, &interfaceGet);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupAnalyzerInterfaceGet)
{
/*
    ITERATE_DEVICES (xCat and above)
    1.1. Call function with index [1 / 6].
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet)
{
/*
    ITERATE_DEVICES Falcon)
    1.1. Call function with index [1 / 6], enable [GT_FALSE / GT_TRUE].
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            */
            ...
            st = cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet(
                dev, portGroupsBmp, index, enable);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);

            /*
                1.2. Call cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet function.
                Expected: GT_OK and the same value.
            */

            st = cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet(
                dev, portGroupsBmp, index, &enableGet);

            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                       "cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet: %d, %d", dev);
            UTF_VERIFY_EQUAL1_STRING_MAC(enable, enableGet,
                                       "get another enable than was set: %d, %d", dev);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet)
{
/*
    ITERATE_DEVICES (Falcon)
    1.1. Call with not null pointers.
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            */
            ...
            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                       "cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet: %d", dev);
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssDxChMirror)
    ...
    /*PortGroup*/
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupToAnalyzerTruncateSet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupToAnalyzerTruncateGet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupAnalyzerInterfaceSet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupAnalyzerInterfaceGet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet)

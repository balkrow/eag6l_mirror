...
*/
    ...
    GT_U8       dev;
    CPSS_DXCH_PORT_CN_MODE_ENT enable = CPSS_DXCH_PORT_CN_MODE_DISABLE_E;
    CPSS_DXCH_PORT_CN_MODE_ENT state  = CPSS_DXCH_PORT_CN_MODE_DISABLE_E;
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
             ...
             */
            availableBuff =
                ((PRV_CPSS_SIP_7_CHECK_MAC(dev)) ? 0x10000000 : 0x100000) +
                PRV_CPSS_DXCH_PP_MAC(dev)->port.initialAllocatedBuffers;
            st = cpssDxChPortCnDbaAvailableBuffSet(dev, availableBuff);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OUT_OF_RANGE, st, dev);
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
             ...
             * Expected: GT_OK.
             */
            poolNum = (PRV_CPSS_SIP_7_CHECK_MAC(dev)) ? 4 : 2;
             ...
             * Expected: GT_OK.
             */
            availableBuff = (PRV_CPSS_SIP_7_CHECK_MAC(dev)) ? 0x10000000 : 0x100000;
            st = cpssDxChPortCnDbaPoolAvailableBuffSet(dev, 0, availableBuff);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OUT_OF_RANGE, st, dev);

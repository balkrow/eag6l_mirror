...
/*
    ...
    1.1.3 Call with stage CPSS_DXCH_POLICER_STAGE_INGRESS_0_E
                    reset CPSS_DXCH_IPFIX_RESET_MODE_IPFIX_DISABLED_E.

    for SIP 6.10 and above Expected: GT_OK.
    for other devices Expected: GT_BAD_PARAM.

    1.1.4 Call with stage [CPSS_DXCH_POLICER_STAGE_INGRESS_1_E /
                           CPSS_DXCH_POLICER_STAGE_EGRESS_E],
                    reset CPSS_DXCH_IPFIX_RESET_MODE_DISABLED_E,
    Expected: GT_OK.
...
#define IPFIX_AAS_MEM_SIZE_CNS _256K

#define MAGIC_VALUE 0xdeadbeef
/* calculate IPFIX memory size in words for biggest memory of IPFIX - AAS */
#define  IPFIX_BMP_SIZE_CNS (sizeof(GT_U32) * (IPFIX_AAS_MEM_SIZE_CNS/32))
...
*/
    ...
    bmpPtr = cpssOsMalloc(IPFIX_BMP_SIZE_CNS+sizeof(GT_U32)/*4 bytes for MAGIC_VALUE*/);
    if (bmpPtr == NULL)
    {
    ...
    bmpPtr[IPFIX_BMP_SIZE_CNS/sizeof(GT_U32)] = MAGIC_VALUE;
    ...
    if(bmpPtr[IPFIX_BMP_SIZE_CNS/sizeof(GT_U32)] != MAGIC_VALUE)
    {
        cpssOsPrintf("ERROR : stack overflow , the CPSS overrun the magic value after the expected size \n");
    }
...
*/
    ...
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_CH1_E | UTF_CH1_DIAMOND_E | UTF_CH2_E | UTF_CH3_E |
                                     ...
                                     UTF_CAELUM_E | UTF_ALDRIN_E | UTF_AC3X_E | UTF_BOBCAT3_E | UTF_ALDRIN2_E | UTF_FALCON_E | UTF_AAS_E);

...
#define PRV_TGF_EXACT_MATCH_MAX_EM_UNITS_CNS(devNum)                                \
        (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?CPSS_DXCH_EXACT_MATCH_UNIT_LAST_E:1

#define PRV_TGF_EXACT_MATCH_MAX_KEY_SIZE_CNS(devNum)                                 \
        (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?CPSS_DXCH_EXACT_MATCH_MAX_KEY_SIZE_CNS:   \
...
*/
    ...
    {
        maxEmUnits = PRV_TGF_EXACT_MATCH_MAX_EM_UNITS_CNS(devNum);

        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            if (emUnitNum == CPSS_DXCH_EXACT_MATCH_UNIT_REDUCED_E)
            {
                break;
            }
            PRV_UTF_LOG1_MAC("Testing for EM unit %u\n", emUnitNum);
            /* define clients lookup to be TTI*/
            ttiLookupNum=CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E;
            st = cpssDxChExactMatchClientLookupSet(devNum, emUnitNum, ttiLookupNum, CPSS_DXCH_EXACT_MATCH_CLIENT_TTI_E);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, devNum, emUnitNum, ttiLookupNum);
            ...
            */
            ...
            st = cpssDxChExactMatchTtiProfileIdModePacketTypeSet(devNum, emUnitNum, keyType, ttiLookupNum,
                                                                 enableExactMatchLookup, profileId);
            UTF_VERIFY_EQUAL6_PARAM_MAC(GT_OK, st, devNum, emUnitNum, keyType, ttiLookupNum,
                                        enableExactMatchLookup, profileId);
            /*
            ...
            */
            ...
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st,
                "cpssDxChExactMatchTtiProfileIdModePacketTypeGet: %d, %d , %d, %d", devNum, emUnitNum, keyType,ttiLookupNum);
            ...
            if (enableExactMatchLookup==enableExactMatchLookupGet)
            {
                if(enableExactMatchLookupGet==GT_TRUE)
                {
                    UTF_VERIFY_EQUAL2_STRING_MAC(profileId, profileIdGet,
                                                "got other profileId then was set: %d, %d", devNum, emUnitNum);
                }
                else
                {
                    UTF_VERIFY_EQUAL2_STRING_MAC(0, profileIdGet,
                                                "got other profileId then was set: %d, %d", devNum, emUnitNum);
                }
            }
            ...
            */
            ...
            ttiLookupNum=CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E;
            profileId   = 15;
            st = cpssDxChExactMatchTtiProfileIdModePacketTypeSet(devNum, emUnitNum, keyType, ttiLookupNum ,enableExactMatchLookup, profileId);
            UTF_VERIFY_EQUAL6_PARAM_MAC(GT_OK, st, devNum, emUnitNum, keyType, ttiLookupNum ,enableExactMatchLookup, profileId);
            /*
            ...
            */
            ...
            enableExactMatchLookup = GT_TRUE;
            st = cpssDxChExactMatchTtiProfileIdModePacketTypeSet(devNum, emUnitNum, keyType, ttiLookupNum ,enableExactMatchLookup, profileId);
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, keyType, ttiLookupNum ,profileId);
            /*
                1.4. Call with wrong profileId [16]
                Expected: GT_OUT_OF_RANGE.
            */
            ...
            enableExactMatchLookup = GT_TRUE;
            st = cpssDxChExactMatchTtiProfileIdModePacketTypeSet(devNum, emUnitNum, keyType, ttiLookupNum ,enableExactMatchLookup, profileId);
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_OUT_OF_RANGE, st, devNum, emUnitNum, keyType, ttiLookupNum ,profileId);
            ...
            */
            ...
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_BAD_PTR, st, "%d, %d, %d, profileId = NULL",
                                        devNum, emUnitNum, keyType,ttiLookupNum);
            /*
                1.6 Call cpssDxChExactMatchTtiProfileIdModePacketTypeSet with legacy keyType vlaue.
                Expected: GT_OK.
            */
        ...
        } /* end of for EM units loop */
        if ((PRV_CPSS_SIP_7_CHECK_MAC(devNum)))
        {
            emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_REDUCED_E;
            st = cpssDxChExactMatchClientLookupSet(devNum, emUnitNum, ttiLookupNum,CPSS_DXCH_EXACT_MATCH_CLIENT_TTI_E);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, ttiLookupNum);
        }
    }
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        ...
        profileId   = 1;
        enableExactMatchLookup = GT_TRUE;
        st = cpssDxChExactMatchTtiProfileIdModePacketTypeSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, keyType, ttiLookupNum ,enableExactMatchLookup, profileId);
        UTF_VERIFY_EQUAL6_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum, emUnitNum, keyType, ttiLookupNum ,enableExactMatchLookup, profileId);
        st = cpssDxChExactMatchTtiProfileIdModePacketTypeGet(devNum, keyType, ttiLookupNum ,&enableExactMatchLookupGet, &profileIdGet);
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            ...
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, devNum, emUnitNum, keyType);
            ...
            */
            ...
            st = cpssDxChExactMatchTtiProfileIdModePacketTypeGet(devNum, keyType, ttiLookupNum ,&enableExactMatchLookup, &profileId);
            UTF_VERIFY_NOT_EQUAL3_PARAM_MAC(GT_OK, st, devNum, emUnitNum, keyType);
            ...
            */
            st = cpssDxChExactMatchTtiProfileIdModePacketTypeGet(devNum, keyType, ttiLookupNum ,&enableExactMatchLookup, NULL);
            UTF_VERIFY_EQUAL3_STRING_MAC(GT_BAD_PTR, st, "%d, %d, %d, profileIdPtr = NULL",
                                        devNum, emUnitNum, keyType);
            ...
            */
            ...
            UTF_VERIFY_EQUAL3_STRING_MAC(GT_BAD_PTR, st, "%d, %d, %d, enableExactMatchLookup = NULL",
                                        devNum, emUnitNum, keyType);
        }
     }
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            while (GT_OK == prvUtfNextDefaultEPortGet(&portNum, GT_TRUE))
            {
                    ...
                    ttiLookupNum<CPSS_DXCH_EXACT_MATCH_LOOKUP_LAST_E; ttiLookupNum++)
                {
                    ...
                    */
                    profileId   = 1;
                    enableExactMatchLookup = GT_TRUE;
                    st = cpssDxChExactMatchTtiPortProfileIdModePortSet(devNum, emUnitNum, portNum, ttiLookupNum,
                                                                       enableExactMatchLookup, profileId);
                    UTF_VERIFY_EQUAL6_PARAM_MAC(GT_OK, st, devNum, emUnitNum, portNum, ttiLookupNum, enableExactMatchLookup,
                                                profileId);
                ...
                */
                ...
                st = cpssDxChExactMatchTtiPortProfileIdModePortSet(devNum, emUnitNum, portNum, ttiLookupNum,
                                                                   enableExactMatchLookup, profileId);
                UTF_VERIFY_EQUAL6_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, portNum, ttiLookupNum,
                                            enableExactMatchLookup, profileId);
                ...
                */
                ...
                st = cpssDxChExactMatchTtiPortProfileIdModePortSet(devNum, emUnitNum, portNum, ttiLookupNum,
                                                                   enableExactMatchLookup, profileId);
                UTF_VERIFY_EQUAL6_PARAM_MAC(GT_OUT_OF_RANGE, st, devNum, emUnitNum, portNum, ttiLookupNum,
                                            enableExactMatchLookup, profileId);
            ...
            st = cpssDxChExactMatchTtiPortProfileIdModePortSet(devNum, emUnitNum, portNum, ttiLookupNum,
                                                               enableExactMatchLookup, profileId);
            UTF_VERIFY_EQUAL6_PARAM_MAC(GT_OK, st, devNum, emUnitNum, portNum, ttiLookupNum,
                                        enableExactMatchLookup, profileId);
        }
    }
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchTtiPortProfileIdModePortSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, portNum, ttiLookupNum,
                                                           enableExactMatchLookup, profileId);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            while (GT_OK == prvUtfNextDefaultEPortGet(&portNum, GT_TRUE))
            {
                     ...
                     ttiLookupNum<CPSS_DXCH_EXACT_MATCH_LOOKUP_LAST_E; ttiLookupNum++)
                {
                    ...
                    */
                    ...
                    enableExactMatchLookup = GT_TRUE;
                    keyType = CPSS_DXCH_TTI_KEY_UDB_IPV4_TCP_E;
                    st = cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet(devNum, emUnitNum, portNum, keyType,
                                                                                ttiLookupNum, enableExactMatchLookup, profileId);
                    UTF_VERIFY_EQUAL7_PARAM_MAC(GT_OK, st, devNum, portNum, emUnitNum, keyType,
                                                ttiLookupNum, enableExactMatchLookup, profileId);
                    ...
                    /*
                        ...
                        Expected: GT_OK and the same profileId.
                    */
                    st = cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeGet(devNum, portNum, keyType, ttiLookupNum,
                                                                                &enableExactMatchLookupGet, &profileIdGet);
                    UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeGet: %d, %d, %d, %d",
                                                devNum, portNum, keyType, ttiLookupNum);
                    UTF_VERIFY_EQUAL4_STRING_MAC(profileId, profileIdGet, "got another profileIdMode then was set: %d, %d, %d, %d",
                                                devNum, portNum, keyType, ttiLookupNum);
                    if (enableExactMatchLookup==enableExactMatchLookupGet)
                    {
                        if(enableExactMatchLookupGet==GT_TRUE)
                        {
                            UTF_VERIFY_EQUAL4_STRING_MAC(profileId, profileIdGet,
                                                        "got other profileId then was set: %d, %d, %d, %d",
                                                        devNum, portNum, keyType, ttiLookupNum);
                        }
                        else
                        {
                    ...
                    */
                    ...
                    enableExactMatchLookup = GT_TRUE;
                    st = cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet(devNum, emUnitNum, portNum, keyType,
                                                                                ttiLookupNum, enableExactMatchLookup,
                                                                                profileId);
                    UTF_VERIFY_EQUAL7_PARAM_MAC(GT_OK, st, devNum, portNum, emUnitNum, keyType,
                                                ttiLookupNum, enableExactMatchLookup, profileId);
                    /*
                ...
                */
                ...
                st = cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet(devNum, emUnitNum, portNum, keyType,
                                                                            ttiLookupNum, enableExactMatchLookup, profileId);
                UTF_VERIFY_EQUAL7_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, portNum, keyType, ttiLookupNum,
                                            enableExactMatchLookup, profileId);
                ...
                */
                ...
                st = cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet(devNum, emUnitNum, portNum, keyType,
                                                                            ttiLookupNum, enableExactMatchLookup, profileId);
                UTF_VERIFY_EQUAL7_PARAM_MAC(GT_OUT_OF_RANGE, st, devNum, emUnitNum, portNum, keyType, ttiLookupNum,
                                            enableExactMatchLookup, profileId);
                ...
                */
                ...
                st = cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet(devNum, emUnitNum, portNum, keyType,
                                                                            ttiLookupNum, enableExactMatchLookup, profileId);
                UTF_VERIFY_NOT_EQUAL7_PARAM_MAC(GT_OK, st, devNum, emUnitNum, portNum, keyType, ttiLookupNum,
                                                enableExactMatchLookup, profileId);
            }
            ...
            st = cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet(devNum, emUnitNum, portNum, keyType,
                                                                        ttiLookupNum, enableExactMatchLookup, profileId);
            UTF_VERIFY_EQUAL7_PARAM_MAC(GT_OK, st, devNum, emUnitNum, portNum, keyType, ttiLookupNum,
                                        enableExactMatchLookup, profileId);
        } /* end of EM units for loop */
    }
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, portNum, keyType,
                                                                     ttiLookupNum, enableExactMatchLookup, profileId);
        UTF_VERIFY_EQUAL6_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum, portNum, keyType, ttiLookupNum,
                                    enableExactMatchLookup, profileId);
    }
    ...
    st = cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, portNum, keyType,
                                                                 ttiLookupNum, enableExactMatchLookup, profileId);
    UTF_VERIFY_EQUAL6_PARAM_MAC(GT_BAD_PARAM, st, devNum, portNum, keyType, ttiLookupNum,
                                enableExactMatchLookup, profileId);
}
   ...
   CPSS_DXCH_EXACT_MATCH_CLIENT_ENT    emClientType;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            /* IPCL_0 is not applicable for AAS */
            emClientType = (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?CPSS_DXCH_EXACT_MATCH_CLIENT_IPCL_1_E:
                                                              CPSS_DXCH_EXACT_MATCH_CLIENT_IPCL_0_E;
            st = cpssDxChExactMatchClientLookupSet(devNum, emUnitNum, pclLookupNum, emClientType);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, devNum, emUnitNum, pclLookupNum);
            pclLookupNum=CPSS_DXCH_EXACT_MATCH_LOOKUP_SECOND_E;
            st = cpssDxChExactMatchClientLookupSet(devNum, emUnitNum, pclLookupNum, CPSS_DXCH_EXACT_MATCH_CLIENT_EPCL_E);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, devNum, emUnitNum, pclLookupNum);
            ...
            */
            ...
            profileId   = 15;
            enableExactMatchLookup = GT_TRUE;
            st = cpssDxChExactMatchPclProfileIdSet(devNum, emUnitNum, direction ,packetType, subProfileId,
                                                   pclLookupNum, enableExactMatchLookup, profileId);
            UTF_VERIFY_EQUAL8_PARAM_MAC(GT_OK, st, devNum, emUnitNum, direction, packetType, subProfileId,
                                        pclLookupNum ,enableExactMatchLookup, profileId);
            /*
            ...
            */
            ...
            st = cpssDxChExactMatchPclProfileIdSet(devNum, emUnitNum, direction ,packetType, subProfileId,
                                                   pclLookupNum ,enableExactMatchLookup, profileId);
            UTF_VERIFY_EQUAL8_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, direction ,packetType, subProfileId,
                                        pclLookupNum ,enableExactMatchLookup, profileId);
            /*
                3.2 Call with wrong profileId [17]
                Expected: GT_OUT_OF_RANGE.
            */
            ...
            st = cpssDxChExactMatchPclProfileIdSet(devNum, emUnitNum, direction ,packetType, subProfileId,
                                                   pclLookupNum ,enableExactMatchLookup, profileId);
            UTF_VERIFY_EQUAL8_PARAM_MAC(GT_OUT_OF_RANGE, st, devNum, emUnitNum, direction ,packetType, subProfileId,
                                        pclLookupNum ,enableExactMatchLookup, profileId);
            /*
                3.3. Call with wrong subProfileId [8]
                Expected: GT_BAD_PARAM.
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        ...
        profileId   = 15;
        enableExactMatchLookup = GT_TRUE;
        st = cpssDxChExactMatchPclProfileIdSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, direction, packetType, subProfileId,
                                               pclLookupNum ,enableExactMatchLookup, profileId);
        UTF_VERIFY_EQUAL7_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum, direction, packetType, subProfileId, pclLookupNum,
                                    enableExactMatchLookup, profileId);
    }
}
/*
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            ...
            st = cpssDxChExactMatchClientLookupSet(devNum, emUnitNum, exactMatchLookupNum, clientType);
            UTF_VERIFY_EQUAL4_PARAM_MAC(GT_OK, st, devNum, emUnitNum, exactMatchLookupNum, clientType);

            st = cpssDxChExactMatchClientLookupGet(devNum, emUnitNum, exactMatchLookupNum, &clientTypeGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchClientLookupGet: %d, %d", devNum, emUnitNum);
            ...
            */
            ...
            /* verifying values */
            UTF_VERIFY_EQUAL2_STRING_MAC(clientType, clientTypeGet,
                        "get another clientTypeGet than was set: %d, %d", devNum, emUnitNum);
            ...
            */
            ...
            st = cpssDxChExactMatchClientLookupSet(devNum, emUnitNum, exactMatchLookupNum, clientType);
            UTF_VERIFY_EQUAL4_PARAM_MAC(GT_BAD_VALUE, st, devNum, emUnitNum, exactMatchLookupNum, clientType);

            st = cpssDxChExactMatchClientLookupGet(devNum, emUnitNum, exactMatchLookupNum, &clientTypeGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchClientLookupGet: %d, %d", devNum, emUnitNum);

            /* verifying values */
            UTF_VERIFY_EQUAL2_STRING_MAC(CPSS_DXCH_EXACT_MATCH_CLIENT_EPCL_E, clientTypeGet,
                        "get another emFirstLookupClientGet than was set: %d, %d", devNum, emUnitNum);
            ...
            */
            ...
            st = cpssDxChExactMatchClientLookupSet(devNum, emUnitNum, exactMatchLookupNum, clientType);
            UTF_VERIFY_EQUAL4_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, exactMatchLookupNum, clientType);
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchClientLookupSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                               exactMatchLookupNum, clientType);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum, emUnitNum);
    }
    ...
    st = cpssDxChExactMatchClientLookupSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                           exactMatchLookupNum, clientType);
    UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum);
}
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            exactMatchLookupNum=CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E;
            st = cpssDxChExactMatchClientLookupGet(devNum, emUnitNum, exactMatchLookupNum, &clientTypeGet);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, st, devNum, emUnitNum);
            ...
            */
            exactMatchLookupNum=CPSS_DXCH_EXACT_MATCH_LOOKUP_SECOND_E;
            st = cpssDxChExactMatchClientLookupGet(devNum, emUnitNum, exactMatchLookupNum, NULL);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PTR, st, "%d,%d, clientTypeGet = NULL", devNum, emUnitNum);
        }
        if ((PRV_CPSS_SIP_7_CHECK_MAC(devNum)))
        {
            emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_REDUCED_E;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchClientLookupGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                               exactMatchLookupNum, &clientTypeGet);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum, emUnitNum);
    }
...
*/
    ...
    {
        /*maxEmUnits = PRV_TGF_EXACT_MATCH_MAX_EM_UNITS_CNS(devNum);*/
        maxEmUnits = (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?2:1;
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            ...
            st = cpssDxChExactMatchActivityBitEnableSet(devNum, emUnitNum, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E, exactMatchActivityBitEnable);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchActivityBitEnableSet: %d, %d", devNum, emUnitNum);

            st = cpssDxChExactMatchActivityBitEnableGet(devNum, emUnitNum, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E, &exactMatchActivityBitEnableGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchActivityBitEnableGet: %d", devNum, emUnitNum);

            /* verifying values */
            UTF_VERIFY_EQUAL2_STRING_MAC(exactMatchActivityBitEnable, exactMatchActivityBitEnableGet,
                        "get another exactMatchActivityBitEnable than was set: %d, %d", devNum, emUnitNum);
            ...
            */
            ...
            st = cpssDxChExactMatchActivityBitEnableGet(devNum, emUnitNum, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E, &exactMatchActivityBitEnableGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchActivityBitEnableGet: %d, %d", devNum, emUnitNum);
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchActivityBitEnableSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                    CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                    exactMatchActivityBitEnable);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum, emUnitNum);
    }
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            /*
                ...
                Expected: GT_OK.
            */
            st = cpssDxChExactMatchActivityBitEnableGet(devNum, emUnitNum, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                        &exactMatchActivityBitEnableGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchActivityBitEnableGet: %d, %d", devNum, emUnitNum);
            ...
            */
            st = cpssDxChExactMatchActivityBitEnableGet(devNum, emUnitNum, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                        NULL);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PTR, st, devNum, emUnitNum);
        }
    }
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchActivityBitEnableGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                    CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                    &exactMatchActivityBitEnableGet);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum, emUnitNum);
    }
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        /* TBD: Will enable after multi unit memory allocation is done */
        /*maxEmUnits = PRV_TGF_EXACT_MATCH_MAX_EM_UNITS_CNS(devNum);*/
        maxEmUnits = (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?2:1;
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            /*
                ...
                */
                ...
                st = cpssDxChExactMatchActivityStatusGet(devNum, emUnitNum,
                                                         CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                         portGroupsBmp,
                                                         exactMatchEntryIndex,
                                                         exactMatchClearActivity,
                                                         &exactMatchActivityStatus);
                UTF_VERIFY_EQUAL2_STRING_MAC(GT_NOT_FOUND, st,"cpssDxChExactMatchActivityStatusGet: %d, %d",
                                             devNum, emUnitNum);
                ...
                */
                ...
                st = cpssDxChExactMatchActivityStatusGet(devNum, emUnitNum,
                                                         ...
                                                         exactMatchClearActivity,
                                                         NULL);
                UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PTR, st,"cpssDxChExactMatchActivityStatusGet: %d, %d",
                                             devNum, emUnitNum);
            }
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(devNum, portGroupId)
        {
            ...
            st = cpssDxChExactMatchActivityStatusGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                     CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                     portGroupsBmp,
                                                     exactMatchEntryIndex,
                                                     exactMatchClearActivity,
...
*/
    ...
    {
        maxEmUnits = PRV_TGF_EXACT_MATCH_MAX_EM_UNITS_CNS(devNum);
        maxKeySize = PRV_TGF_EXACT_MATCH_MAX_KEY_SIZE_CNS(devNum);
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            ...
            if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                if (emUnitNum == CPSS_DXCH_EXACT_MATCH_UNIT_REDUCED_E)
                {
                    ...
                    maxKeySize        = CPSS_DXCH_EXACT_MATCH_REDUCED_MAX_KEY_SIZE_CNS;
                }
                else
                {
                    keyParams.keySize = CPSS_DXCH_EXACT_MATCH_KEY_SIZE_37B_E;
                }
            ...
            st = cpssDxChExactMatchProfileKeyParamsSet(devNum, emUnitNum,
                                                       exactMatchProfileIndex, &keyParams);
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_OK, st, devNum, emUnitNum, exactMatchProfileIndex,
                                        keyParams.keySize, keyParams.keyStart);

            st = cpssDxChExactMatchProfileKeyParamsGet(devNum, emUnitNum,
                                                       exactMatchProfileIndex, &keyParamsGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchProfileKeyParamsGet: %d %d",
                                         devNum, emUnitNum);
            /* verifying values */
            UTF_VERIFY_EQUAL2_STRING_MAC(keyParams.keySize, keyParamsGet.keySize,
                                         "get another keyParams.keySize than was set: %d, %d",
                                         devNum, emUnitNum);

            UTF_VERIFY_EQUAL2_STRING_MAC(keyParams.keyStart, keyParamsGet.keyStart,
                                         "get another keyParams.keyStart than was set: %d %d",
                                         devNum, emUnitNum);

            for (i = 0;i < maxKeySize;i++)
            {
                UTF_VERIFY_EQUAL2_STRING_MAC(keyParams.mask[i], keyParamsGet.mask[i],
                                             "get another keyParams.mask than was set: %d %d",
                                             devNum, emUnitNum);
            }
            ...
            */
            ...
            st = cpssDxChExactMatchProfileKeyParamsSet(devNum, emUnitNum,
                                                       exactMatchProfileIndex, &keyParams);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, exactMatchProfileIndex);
            ...
            */
            ...
            st = cpssDxChExactMatchProfileKeyParamsSet(devNum, emUnitNum,
                                                       exactMatchProfileIndex, NULL);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_BAD_PTR, st, devNum, emUnitNum, exactMatchProfileIndex);
        }
    }
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchProfileKeyParamsSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, exactMatchProfileIndex, &keyParams);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum);
    }
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E;emUnitNum < maxEmUnits;emUnitNum++)
        {
            ...
            */
            ...
            st = cpssDxChExactMatchProfileKeyParamsGet(devNum, emUnitNum, exactMatchProfileIndex, &keyParamsGet);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, st, devNum, emUnitNum);
            ...
            */
            exactMatchProfileIndex=16;
            st = cpssDxChExactMatchProfileKeyParamsGet(devNum, emUnitNum, exactMatchProfileIndex, &keyParamsGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PARAM, st, "%d, %d, EM LookupClientsGet = NULL", devNum, emUnitNum);
            ...
            */
            ...
            st = cpssDxChExactMatchProfileKeyParamsGet(devNum, emUnitNum, exactMatchProfileIndex, NULL);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PTR, st, "%d,%d, EM LookupClientsGet = NULL", devNum, emUnitNum);
        }
    }
    ...
    exactMatchProfileIndex = 2;
    emUnitNum              = CPSS_DXCH_EXACT_MATCH_UNIT_0_E;
    /* Go over all non active devices. */
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchProfileKeyParamsGet(devNum, emUnitNum,
...
)
{
    ...
    case CPSS_DXCH_EXACT_MATCH_ACTION_TTI_E:
        ...
        actionPtr->ttiAction.trustUp                            = CPSS_DXCH_TTI_DO_NOT_TRUST_L2_UP_E;
    ...
    case CPSS_DXCH_EXACT_MATCH_ACTION_PCL_E:
        ...
        actionPtr->pclAction.policer.policerEnable = CPSS_DXCH_PCL_POLICER_DISABLE_ALL_E;
    ...
    case CPSS_DXCH_EXACT_MATCH_ACTION_EPCL_E:
        actionPtr->pclAction.pktCmd       = CPSS_PACKET_CMD_FORWARD_E;
        actionPtr->pclAction.actionStop   = GT_FALSE;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E;emUnitNum < maxEmUnits;emUnitNum++)
        {
            ...
            */
            ...
            st = cpssDxChExactMatchProfileDefaultActionSet(devNum, emUnitNum, exactMatchProfileIndex,
                                                           actionType, &defaultActionData, defActionEn);
            UTF_VERIFY_EQUAL5_STRING_MAC(GT_OK, st, "cpssDxChExactMatchProfileDefaultActionSet: %d, %d, %d, %d, %d",
                                            devNum, emUnitNum, exactMatchProfileIndex, actionType, defActionEn);

            st = cpssDxChExactMatchProfileDefaultActionGet(devNum, emUnitNum, exactMatchProfileIndex,
                                                           actionType, &defaultActionDataGet, &defActionEnGet);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchProfileDefaultActionGet: %d, %d, %d, %d",
                                         devNum, emUnitNum, exactMatchProfileIndex,actionType);
            /* validation values */
            st = prvCompareExactMatchActionStructs(devNum, "action", actionType, &defaultActionData,
                                                   &defaultActionDataGet);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st,"action != actionGet: %d, %d, %d, %d, %d",
                                        devNum, emUnitNum, exactMatchProfileIndex, actionType);

            /* verifying values */
            UTF_VERIFY_EQUAL2_STRING_MAC(defActionEn, defActionEnGet,
                                         "get another defActionEnGet than was set: %d, %d",
                                         emUnitNum, devNum);
            ...
            */
            ...
            st = cpssDxChExactMatchProfileDefaultActionSet(devNum, emUnitNum, exactMatchProfileIndex,
                                                           actionType,&defaultActionData,defActionEn);
            UTF_VERIFY_EQUAL4_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, exactMatchProfileIndex, actionType);
            ...
            */
            ...
            UTF_ENUMS_CHECK_MAC(cpssDxChExactMatchProfileDefaultActionSet
                                (devNum, emUnitNum, exactMatchProfileIndex, actionType, &defaultActionData, defActionEn),
                                actionType);
            ...
            */
            st = cpssDxChExactMatchProfileDefaultActionSet(devNum, emUnitNum, exactMatchProfileIndex,
                                                           actionType, NULL, defActionEn);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_BAD_PTR, st, "%d,%d, defaultActionData = NULL", devNum, emUnitNum);
            ...
            */
            ...
            /* verifying values */
            UTF_VERIFY_EQUAL2_STRING_MAC(defActionEn, defActionEnGet, "get another defActionEnGet than was set: %d %d",
                                         devNum, emUnitNum);
            ...
            */
            ...
            defaultActionData.pclAction.egressPolicy = CPSS_PCL_DIRECTION_INGRESS_E;
            ...
            defaultActionData.pclAction.egressPolicy = CPSS_PCL_DIRECTION_EGRESS_E;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E;emUnitNum < maxEmUnits;emUnitNum++)
        {
            ...
            */
            ...
            st = cpssDxChExactMatchProfileDefaultActionGet(devNum, emUnitNum, exactMatchProfileIndex,
                                                           actionType, NULL, &defActionEnGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PTR, st, "%d,%d, cpssDxChExactMatchProfileDefaultActionGet = NULL",
                                         devNum, emUnitNum);
            ...
            */
            exactMatchProfileIndex=15;
            st = cpssDxChExactMatchProfileDefaultActionGet(devNum, emUnitNum, exactMatchProfileIndex,
                                                           actionType, &defaultActionDataGet, NULL);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PTR, st, "%d,%d cpssDxChExactMatchProfileDefaultActionGet = NULL",
                                         devNum, emUnitNum);
        }
    }
...
)
{
    ...
    case CPSS_DXCH_EXACT_MATCH_ACTION_TTI_E:
        ...
        if(firstActionPtr->ttiExpandedActionOrigin.overwriteExpandedActionGenericAction != secondActionPtr->ttiExpandedActionOrigin.overwriteExpandedActionGenericAction)
        {
            PRV_UTF_LOG3_MAC("get another %s.ttiExpandedActionOrigin.overwriteExpandedActionGenericAction than was set, expected = %d, received = %d\n",
                             name, firstActionPtr->ttiExpandedActionOrigin.overwriteExpandedActionGenericAction,
                             secondActionPtr->ttiExpandedActionOrigin.overwriteExpandedActionGenericAction);
            st = GT_FAIL;
        }
    ...
    case CPSS_DXCH_EXACT_MATCH_ACTION_EPCL_E:
        ...
        if(firstActionPtr->pclExpandedActionOrigin.overwriteExpandedActionGenericAction != secondActionPtr->pclExpandedActionOrigin.overwriteExpandedActionGenericAction)
        {
            PRV_UTF_LOG3_MAC("get another %s.pclExpandedActionOrigin.overwriteExpandedActionGenericAction than was set, expected = %d, received = %d\n",
                             name, firstActionPtr->pclExpandedActionOrigin.overwriteExpandedActionGenericAction,
                             secondActionPtr->pclExpandedActionOrigin.overwriteExpandedActionGenericAction);
            st = GT_FAIL;
        }
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            ...
            st = cpssDxChExactMatchExpandedActionSet(devNum, emUnitNum, expandedActionIndex,actionType,
                                                     &actionData, &expandedActionOriginData);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchExpandedActionSet: %d, %d, %d, %d",
                                         devNum, emUnitNum, expandedActionIndex, actionType);

            st = cpssDxChExactMatchExpandedActionGet(devNum, emUnitNum, expandedActionIndex,
                                                     actionType, &actionDataGet, &expandedActionOriginDataGet);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchExpandedActionGet: %d, %d, %d, %d",
                                         devNum, emUnitNum, expandedActionIndex,actionType);
            /* validation values */
            ...
            st = prvCompareExactMatchExpandedStructs("expandedActionOriginData", actionType,
                                                     &expandedActionOriginData, &expandedActionOriginDataGet);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st,"expandedActionOriginData != expandedActionOriginDataGet: %d, %d, %d, %d",
                                         devNum, emUnitNum, expandedActionIndex, actionType);
            ...
            */
            ...
            st = cpssDxChExactMatchExpandedActionSet(devNum, emUnitNum, expandedActionIndex, actionType,
                                                     &actionData, &expandedActionOriginData);
            UTF_VERIFY_EQUAL4_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, expandedActionIndex, actionType);
            ...
            */
            ...
            UTF_ENUMS_CHECK_MAC(cpssDxChExactMatchExpandedActionSet
                                (devNum, emUnitNum, expandedActionIndex, actionType, &actionData,
                                &expandedActionOriginDataGet), actionType);
            ...
            */
            st = cpssDxChExactMatchExpandedActionSet(devNum, emUnitNum, expandedActionIndex, actionType,
                                                     NULL, &expandedActionOriginData);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_BAD_PTR, st, "%d, %d actionData = NULL", devNum, emUnitNum);

            st = cpssDxChExactMatchExpandedActionSet(devNum, emUnitNum, expandedActionIndex,
                                                     actionType, &actionData, NULL);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_BAD_PTR, st, "%d,%d expandedActionOriginData = NULL", devNum, emUnitNum);
            ...
            */
            ...
            st = cpssDxChExactMatchExpandedActionGet(devNum, emUnitNum, expandedActionIndex, actionType,
                                                     &actionDataGet, &expandedActionOriginDataGet);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchExpandedActionGet: %d, %d, %d, %d",
                                         devNum, emUnitNum, expandedActionIndex,actionType);
            /* validation values */
            st = prvCompareExactMatchActionStructs(devNum, "action", actionType, &actionData, &actionDataGet);
            ...
            */
            ...
            actionData.pclAction.egressPolicy = CPSS_PCL_DIRECTION_INGRESS_E;
            ...
            st = prvCompareExactMatchExpandedStructs("expandedActionOriginData", actionType,
                                                     &expandedActionOriginData, &expandedActionOriginDataGet);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st,"expandedActionOriginData != expandedActionOriginDataGet: %d, %d, %d, %d, %d",
                                         devNum, emUnitNum, expandedActionIndex, actionType);
            ...
            actionData.pclAction.egressPolicy = CPSS_PCL_DIRECTION_EGRESS_E;
            ...
            if (!PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                /* TBD: Skipping this check for now. Once the PCL action overite code
                 * is available for SIP7 will enable this */
            st = cpssDxChExactMatchExpandedActionSet(devNum, emUnitNum, expandedActionIndex, actionType,
                                                     &actionData, &expandedActionOriginData);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_BAD_PARAM, st, "cpssDxChExactMatchExpandedActionSet: %d, %d, %d, %d",
                                         devNum, emUnitNum, expandedActionIndex, actionType);
            }
...
/*
    ...
    */
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            ...
            actionData.ttiAction.tag0VlanCmd=CPSS_DXCH_TTI_VLAN_MODIFY_UNTAGGED_E;
            ...
            if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteQosModel = GT_TRUE;
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteTtlModel = GT_TRUE;
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteQosMappingMode = GT_TRUE;
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteStopMpls = GT_TRUE;
            }

            /* expect GT_BAD_PARAM - to many fields to overwrite */
            st = cpssDxChExactMatchExpandedActionSet(devNum,emUnitNum,expandedActionIndex,actionType,&actionData,&expandedActionOriginData);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_BAD_PARAM, st, "cpssDxChExactMatchExpandedActionSet: %d, %d, %d, %d",
                                            devNum, emUnitNum, expandedActionIndex, actionType);
            ...
            st = cpssDxChExactMatchExpandedActionGet(devNum,emUnitNum,expandedActionIndex,actionType,&actionDataGet,&expandedActionOriginDataGet);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchExpandedActionGet: %d, %d, %d, %d", devNum, emUnitNum, expandedActionIndex,actionType);
            /* validation values */
            st = prvCompareExactMatchActionStructs(devNum, "action", actionType, &actionData, &actionDataGet);
            ...
            */
            ...
            if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteExpandedActionSourceId=GT_FALSE;
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteExpandedActionTag0VlanId=GT_FALSE;
            }
            st = cpssDxChExactMatchExpandedActionSet(devNum,emUnitNum,expandedActionIndex,actionType,&actionData,&expandedActionOriginData);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchExpandedActionSet: %d, %d, %d, %d",
                                            devNum, emUnitNum, expandedActionIndex, actionType);
            ...
            */
            ...
            {
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteExpandedActionSourceIdSetEnable = GT_FALSE;
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteExpandedActionPolicerIndex = GT_FALSE;
            }
            st = cpssDxChExactMatchExpandedActionSet(devNum,emUnitNum,expandedActionIndex,actionType,&actionData,&expandedActionOriginData);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchExpandedActionSet: %d, %d, %d, %d",
                                            devNum, emUnitNum, expandedActionIndex, actionType);
            ...
            if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteQosModel = GT_FALSE;
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteTtlModel = GT_FALSE;
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteQosMappingMode = GT_FALSE;
                expandedActionOriginData.ttiExpandedActionOrigin.overwriteStopMpls = GT_FALSE;
            }
            st = cpssDxChExactMatchExpandedActionSet(devNum,emUnitNum,expandedActionIndex,actionType,&actionData,&expandedActionOriginData);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchExpandedActionSet: %d, %d, %d, %d",
                                            devNum, emUnitNum, expandedActionIndex, actionType);
            ...
            */
            ...
            /* TBD: Skipping this check for SIP7 now. Once the PCL action overite code
             * is available for SIP7 will enable this */
            if (!PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
            /* expect GT_BAD_PARAM - to many fields to overwrite */
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchExpandedActionSet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,expandedActionIndex,actionType,&actionData,&expandedActionOriginData);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum);
    }
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E;emUnitNum < maxEmUnits;emUnitNum++)
        {
            ...
            /*
                ...
                Expected: GT_BAD_VALUE - the entry was not defined yet.
            */
            expandedActionIndex=13;
            st = cpssDxChExactMatchExpandedActionGet(devNum, emUnitNum, expandedActionIndex, actionType,
                                                     &actionDataGet, &expandedActionOriginDataGet);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_VALUE, st, devNum, emUnitNum);
            ...
            */
            ...
            st = cpssDxChExactMatchExpandedActionGet(devNum, emUnitNum, expandedActionIndex, actionType, NULL,
                                                     &expandedActionOriginDataGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PTR, st, "%d,%d, cpssDxChExactMatchProfileDefaultActionGet = NULL",
                                        devNum, emUnitNum);
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchExpandedActionGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,expandedActionIndex,
                                                 actionType,&actionDataGet,&expandedActionOriginDataGet);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum);
    }
...
/*
    ...
    GT_BOOL                                  set_and_invalidate_done;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            ...
            st = cpssDxChExactMatchPortGroupEntrySet(devNum, emUnitNum, exactMatchEntry.lookupNum,
                                                     CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,
                                                     expandedActionIndex,&exactMatchEntry,actionType,&actionData);
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_OK, st, devNum, emUnitNum, index, expandedActionIndex, actionType);

            st = cpssDxChExactMatchPortGroupEntryGet(devNum,emUnitNum, exactMatchEntry.lookupNum,
                                                     CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,&valid,
                                                     &actionTypeGet,&actionDataGet,&exactMatchEntryGet,&expandedActionIndex);
            UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, st, "cpssDxChExactMatchPortGroupEntryGet: %d, %d, %d\n", devNum, emUnitNum, index);
            /* validation values */
            ...
            st = cpssDxChExactMatchActivityStatusGet(devNum, emUnitNum,
                                                     ...
                                                     GT_FALSE,
                                                     &exactMatchActivityStatus);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchActivityStatusGet: %d, %d", devNum, emUnitNum);
            ...
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, index, expandedActionIndex,CPSS_DXCH_EXACT_MATCH_ACTION_LAST_E);
            ...
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, index, expandedActionIndex,CPSS_DXCH_EXACT_MATCH_ACTION_PCL_E);
            ...
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, index, expandedActionIndex,actionType);

            /* 1.6. Call with wrong value index - that do not fit the keyType, other params same as in 1.2.
                Expected: GT_BAD_PARAM.*/
            expandedActionIndex=2;
            index=1;/* index must be %2==0 for SIZE_19B_E*/
            exactMatchEntry.key.keySize=(PRV_CPSS_SIP_7_CHECK_MAC(devNum))?
            ...
            st = cpssDxChExactMatchPortGroupEntrySet(devNum, emUnitNum, exactMatchEntry.lookupNum,
                                                     ...
                                                     actionType,&actionData);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_BAD_PTR, st, "%d,%d, exactMatchEntry = NULL", devNum, emUnitNum);
        ...
        /* 1.9. Call with actionPtr [NULL], other params same as in 1.2.
            ...
            */
            ...
            /* Execute 1.11-SET and 1.12-INVALIDATE twice to check the INVALIDATE works properly */
            set_and_invalidate_done = GT_FALSE;
set_and_invalidate_check:
            /*
            ...
            /* This is channel num configurations.
             * Other than SIP7 other legacy devices doesn't support channel num */
            lookupNum = (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?
                        CPSS_DXCH_EXACT_MATCH_LOOKUP_SECOND_E:
                        CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E;
            st = cpssDxChExactMatchPortGroupEntrySet(devNum, emUnitNum, lookupNum,
                                                     CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,
                                                     expandedActionIndex,&exactMatchEntry,
                                                     actionType,&actionData);
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_OK, st, devNum, emUnitNum, index, expandedActionIndex,actionType);

            st = cpssDxChExactMatchPortGroupEntryGet(devNum,emUnitNum,lookupNum,
                                                     CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,&valid,
                                                     &actionTypeGet,&actionDataGet,&exactMatchEntryGet,&expandedActionIndex);
            UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, st, "cpssDxChExactMatchPortGroupEntryGet: %d, %d, %d\n", devNum, emUnitNum, index);
            /* validation values */
            ...
            /* Check GT_NO_RESOURCE for the "Exact Match entry is not empty" case */
            st = cpssDxChExactMatchPortGroupEntrySet(devNum, emUnitNum, lookupNum,
                                                     CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,
                                                     expandedActionIndex,&exactMatchEntry,
                                                     actionType,&actionData);
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_NO_RESOURCE, st, devNum, emUnitNum, index, expandedActionIndex,actionType);
            ...
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_BAD_PARAM, st, devNum, emUnitNum, index, expandedActionIndex,CPSS_DXCH_EXACT_MATCH_ACTION_TTI_E);


            /*  1.12. invalidate entries defined
                Expected: GT_TRUE.*/
            index = 0;
            st = cpssDxChExactMatchPortGroupEntryInvalidate(devNum,emUnitNum,exactMatchEntry.lookupNum,
                                                            CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, devNum, emUnitNum, index);

            index = 28;
            st = cpssDxChExactMatchPortGroupEntryInvalidate(devNum,emUnitNum, lookupNum,
                                                            CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index);
            UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, devNum, emUnitNum, index);
            if (set_and_invalidate_done == GT_FALSE)
            {
                set_and_invalidate_done = GT_TRUE;
                goto set_and_invalidate_check; /* repeat to check invalidate really works */
            }
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
         st = cpssDxChExactMatchPortGroupEntrySet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                  CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                  CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,
                                                  expandedActionIndex,&exactMatchEntry,
                                                  actionType,&actionData);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            index=4;
            st = cpssDxChExactMatchPortGroupEntryGet(devNum,emUnitNum,CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                     CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,&valid,
            ...
            Expected: GT_BAD_PARAM.*/
            st = cpssDxChExactMatchPortGroupEntryGet(devNum,emUnitNum,CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                     CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,NULL,
                                                     &actionTypeGet,&actionDataGet,&exactMatchEntryGet,&expandedActionIndexGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PTR, st, "%d,%d cpssDxChExactMatchPortGroupEntryGet = NULL", devNum, emUnitNum);
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
         st = cpssDxChExactMatchPortGroupEntryGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                  CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                  CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,&valid,
                                                  &actionTypeGet,&actionDataGet,&exactMatchEntryGet,
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            index=4;
            st = cpssDxChExactMatchPortGroupEntryStatusGet(devNum, emUnitNum, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                           CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,&valid);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, st, devNum, emUnitNum);
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_FALSE, valid,"error - entry is valid, expected non valid\n");
            ...
            st = cpssDxChExactMatchPortGroupEntryStatusGet(devNum, emUnitNum, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                           CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,NULL);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PTR, st, "%d,%d, cpssDxChExactMatchPortGroupEntryStatusGet = NULL",
                                         devNum, emUnitNum);
        }
    }
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
         st = cpssDxChExactMatchPortGroupEntryStatusGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                        CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                        CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,&valid);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum);
    }
...
*/
    ...
    /*expectedBankIndex for CPSS_EXACT_MATCH_TABLE_SIZE_64KB and CPSS_EXACT_MATCH_MHT_4_E */
    GT_U32 CPSS_EXACT_MATCH_TABLE_SIZE_128KB__CPSS_EXACT_MATCH_MHT_4_E__expectedBankIndex[CPSS_DXCH_EXACT_MATCH_MAX_NUM_BANKS_CNS] =
        {0x0001f194,0x00012479,0x0001f80e,0x0001c92b,
         GT_NA,GT_NA,GT_NA,GT_NA,
         GT_NA,GT_NA,GT_NA,GT_NA,
         GT_NA,GT_NA,GT_NA,GT_NA};
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                               &entryKey, &numberOfElemInCrcMultiHash ,&exactMatchCrcMultiHashArr[0]);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);
        if PRV_CPSS_SIP_7_CHECK_MAC(devNum)
        {
            if (numberOfElemInCrcMultiHash == 4 && emTableSize == _128K)
            {
                expectedBankIndex = &CPSS_EXACT_MATCH_TABLE_SIZE_128KB__CPSS_EXACT_MATCH_MHT_4_E__expectedBankIndex[0];
            }
            else /* TBD : Update other combinations */
            {
        ...
        /*
           ...
           Expected: GT_OK.
        */
        entryKey.keySize = (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?
                            CPSS_DXCH_EXACT_MATCH_KEY_SIZE_53B_E:
                            CPSS_DXCH_EXACT_MATCH_KEY_SIZE_47B_E;
        st = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                               &entryKey, &numberOfElemInCrcMultiHash, &exactMatchCrcMultiHashArr[0]);
        ...
        */
        ...
        /* max keySize is 47B */
        maxKeySize = (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?
                      CPSS_DXCH_EXACT_MATCH_MAX_KEY_SIZE_CNS:
                      (CPSS_DXCH_EXACT_MATCH_MAX_KEY_SIZE_CNS - 6);

        for (ii = 0;ii < maxKeySize;ii++)
        {
        ...
        */
        st = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                               NULL, &numberOfElemInCrcMultiHash, &exactMatchCrcMultiHashArr[0]);
        ...
        */
        st = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                               &entryKey, NULL, &exactMatchCrcMultiHashArr[0]);
        ...
        */
        st = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                               &entryKey, &numberOfElemInCrcMultiHash, NULL);
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        ...
        st = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, &entryKey,
                                                               &numberOfElemInCrcMultiHash, &exactMatchCrcMultiHashArr[0]);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum);
    }
...
/**
* @internal prvConvertExactMatchKeySizeToBytes function
* @endinternal
*
* @brief   This functions converts the keySize macro to
*          the appropriate size in bytes
*
* @param[in] keySize                   - Exact Match key size
* @param[out] sizePtr                   - (pointer to )keysize in bytes
*/
static GT_VOID prvConvertExactMatchKeySizeToBytes
(
    ...
    switch(keySize)
    {
        ...
        case CPSS_DXCH_EXACT_MATCH_KEY_SIZE_53B_E:
            *sizePtr = 53;
            break;
        default:
            cpssOsPrintf("prvConvertExactMatchKeySizeToBytes : Invaid key size \n");
    }
}
...
/*
    ...
    */
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        /* SIP6 : max keySize is 47B
         * SIP7 : max keySize is 53B */
        maxKeySize = PRV_TGF_EXACT_MATCH_MAX_KEY_SIZE_CNS(devNum);
        /*maxEmUnits = PRV_TGF_EXACT_MATCH_MAX_EM_UNITS_CNS(devNum);*/
        maxEmUnits = (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?2:1;
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            */
            ...
            st = cpssDxChExactMatchProfileKeyParamsSet(devNum, emUnitNum, expandedActionIndex, &keyParams);
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_OK, st, devNum, emUnitNum, expandedActionIndex, keyParams.keySize, keyParams.keyStart);


            st = cpssDxChExactMatchProfileKeyParamsGet(devNum, emUnitNum, expandedActionIndex, &keyParamsGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchProfileKeyParamsGet: %d", devNum, emUnitNum);
            ...
            exactMatchEntry.key.keySize=CPSS_DXCH_EXACT_MATCH_KEY_SIZE_5B_E;
            prvConvertExactMatchKeySizeToBytes(exactMatchEntry.key.keySize, &keySizeBytes);
            /* 5 bytes in CPSS_DXCH_EXACT_MATCH_KEY_SIZE_5B_E */
            ...
            st = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum, emUnitNum, &exactMatchEntry.key,
                                                                   &numberOfElemInCrcMultiHash ,&exactMatchCrcMultiHashArr[0]);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);
            ...
            st = cpssDxChExactMatchPortGroupEntrySet(devNum, emUnitNum, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                     CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,
                                                     expandedActionIndex,&exactMatchEntry,actionType,&actionData);
            UTF_VERIFY_EQUAL5_PARAM_MAC(GT_OK, st, devNum, emUnitNum, index, expandedActionIndex,actionType);
            ...
            st = cpssDxChExactMatchPortGroupEntryGet(devNum,emUnitNum,CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                     CPSS_PORT_GROUP_UNAWARE_MODE_CNS,index,&valid,
                                                     &actionTypeGet,&actionDataGet,&exactMatchEntryGet,&expandedActionIndex);
            UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, st, "cpssDxChExactMatchPortGroupEntryGet: %d, %d, %d, %d\n",
                                         devNum, emUnitNum, index);
            /* validation values */
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_TRUE, valid,"error - entry is not valid\n");
            UTF_VERIFY_EQUAL1_STRING_MAC(actionType, actionTypeGet,"get another actionTypeGet than was set: %d\n", devNum);
            ...
            exactMatchEntry.key.keySize=(PRV_CPSS_SIP_7_CHECK_MAC(devNum))?
                                         ...
                                         CPSS_DXCH_EXACT_MATCH_KEY_SIZE_19B_E;
            prvConvertExactMatchKeySizeToBytes(exactMatchEntry.key.keySize, &keySizeBytes);
            /* SIP7: 21 bytes in CPSS_DXCH_EXACT_MATCH_KEY_SIZE_21B_E
               SIP6: 19 bytes in CPSS_DXCH_EXACT_MATCH_KEY_SIZE_19B_E
               */
            for (i=0;i<keySizeBytes;i++)
            {
                exactMatchEntry.key.pattern[i] = i;
            ...
            st = cpssDxChExactMatchHashCrcMultiResultsByParamsCalc(devNum, emUnitNum,
                                                                   &exactMatchEntry.key, &numberOfElemInCrcMultiHash,
                                                                   &exactMatchCrcMultiHashArr[0]);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);
            ...
            st = prvCompareExactMatchActionStructs(devNum, "action", actionType, &actionData, &actionDataGet);
            UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, st,"action != actionGet: %d, %d, %d\n",devNum, expandedActionIndex, actionType);
            ...
            prvConvertExactMatchKeySizeToBytes(exactMatchEntry.key.keySize, &keySizeBytes);
            /* SIP7: 37 bytes in CPSS_DXCH_EXACT_MATCH_KEY_SIZE_37B_E
               SIP6: 33 bytes in CPSS_DXCH_EXACT_MATCH_KEY_SIZE_33B_E
            */
            for (i=0;i<keySizeBytes;i++)
            {
                exactMatchEntry.key.pattern[i] = i;
            ...
            exactMatchEntry.key.keySize=(PRV_CPSS_SIP_7_CHECK_MAC(devNum))?
                                         ...
                                         CPSS_DXCH_EXACT_MATCH_KEY_SIZE_47B_E;
            prvConvertExactMatchKeySizeToBytes(exactMatchEntry.key.keySize, &keySizeBytes);
            /* SIP7: 53 bytes in CPSS_DXCH_EXACT_MATCH_KEY_SIZE_53B_E
               SIP6: 47 bytes in CPSS_DXCH_EXACT_MATCH_KEY_SIZE_47B_E
            */
            for (i=0;i<keySizeBytes;i++)
            {
                exactMatchEntry.key.pattern[i] = i;
            ...
            */
            ...
            st = cpssDxChExactMatchExpandedActionSet(devNum,emUnitNum,expandedActionIndex,actionType,&actionData,&expandedActionOriginData);
            UTF_VERIFY_EQUAL4_STRING_MAC(GT_OK, st, "cpssDxChExactMatchExpandedActionSet: %d, %d, %d",
                                            devNum, emUnitNum, expandedActionIndex, actionType);
            ...
            keyParams.keySize=(PRV_CPSS_SIP_7_CHECK_MAC(devNum))?
                               CPSS_DXCH_EXACT_MATCH_KEY_SIZE_21B_E:
                               CPSS_DXCH_EXACT_MATCH_KEY_SIZE_19B_E;
            ...
            {
                st = cpssDxChExactMatchProfileKeyParamsSet(devNum, emUnitNum, expandedActionIndex, &keyParams);
                UTF_VERIFY_EQUAL4_PARAM_MAC(GT_OK, st, devNum, emUnitNum, expandedActionIndex, keyParams.keySize);
            }
            else
            {
                st = cpssDxChExactMatchProfileKeyParamsSet(devNum, emUnitNum, expandedActionIndex, &keyParams);
            ...
            st = cpssDxChExactMatchProfileKeyParamsGet(devNum, emUnitNum, expandedActionIndex, &keyParamsGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st,"cpssDxChExactMatchProfileKeyParamsGet: %d, %d", devNum, emUnitNum);
            ...
            exactMatchEntry.lookupNum = CPSS_DXCH_EXACT_MATCH_LOOKUP_SECOND_E;
            prvConvertExactMatchKeySizeToBytes(exactMatchEntry.key.keySize, &keySizeBytes);
            for (i=0;i<keySizeBytes;i++)/* 5 bytes in CPSS_DXCH_EXACT_MATCH_KEY_SIZE_5B_E*/
            {
            ...
            */
            ...
            st = cpssDxChExactMatchRulesDump(devNum,emUnitNum,lookupNum,
                                             CPSS_PORT_GROUP_UNAWARE_MODE_CNS,0,100);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st, "cpssDxChExactMatchRulesDump: %d, %d\n", devNum, emUnitNum);

            /* dump last 100 entries */
            st = cpssDxChExactMatchRulesDump(devNum,emUnitNum,lookupNum,
                                             CPSS_PORT_GROUP_UNAWARE_MODE_CNS,(emTableSize-100)-1,100);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st, "cpssDxChExactMatchRulesDump: %d, %d\n", devNum, emUnitNum);

            /*1.12. Call cpssDxChExactMatchRulesDump startIndex=32K,numOfRules=5,
            Expected: GT_OUT_OF_RANGE */
            st = cpssDxChExactMatchRulesDump(devNum,emUnitNum,lookupNum,
                                             CPSS_PORT_GROUP_UNAWARE_MODE_CNS,emTableSize,5);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_OUT_OF_RANGE, st, "cpssDxChExactMatchRulesDump: %d, %d\n", devNum, emUnitNum);

            /*  1.13. invalidate 8 entries that were defined
                Expected: GT_OK.*/
            for (i=0;i<8;i++)
            {
                st = cpssDxChExactMatchPortGroupEntryInvalidate(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                                CPSS_PORT_GROUP_UNAWARE_MODE_CNS, indexToInvalidate[i]);
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        st = cpssDxChExactMatchRulesDump(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                         CPSS_PORT_GROUP_UNAWARE_MODE_CNS,0,5);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, st, devNum);
    }
...
*/
    ...
    PRV_TGF_APPLIC_DEV_RESET_MAC(&devNum,(UTF_CPSS_PP_ALL_SIP6_10_CNS&(~UTF_CPSS_PP_ALL_SIP7_CNS)));
    PRV_TGF_NON_EM_APPLIC_DEV_RESET_MAC;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChExactMatchAutoLearnLookupSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                  exactMatchAutoLearnLookupNum);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, st, devNum, exactMatchAutoLearnLookupNum);

        st = cpssDxChExactMatchAutoLearnLookupGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                  &exactMatchAutoLearnLookupNumGet);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChExactMatchAutoLearnLookupGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, &exactMatchAutoLearnLookupNumGet);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);
         ...
         /*
            1.2. Call with exactMatchAutoLearnLookupNumPtr [NULL].
                Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchAutoLearnLookupGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, NULL);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChExactMatchExpandedActionSet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,expandedActionIndex,actionType,&defaultActionData,&expandedActionOriginData);
        UTF_VERIFY_EQUAL3_STRING_MAC(GT_OK, st, "cpssDxChExactMatchExpandedActionSet: %d, %d, %d", devNum, expandedActionIndex, actionType);

        st = cpssDxChExactMatchExpandedActionGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,expandedActionIndex,actionType,&defaultActionDataGet,&expandedActionOriginDataGet);
        ...
        */
        ...
        st = cpssDxChExactMatchAutoLearnProfileDefaultActionSet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,expandedActionIndex,actionType,&defaultActionData,actionEn);
        ...
        st = cpssDxChExactMatchAutoLearnProfileDefaultActionGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,&expandedActionIndexGet,&actionTypeGet,&defaultActionDataGet,&actionEnGet);
        ...
        */
        UTF_ENUMS_CHECK_MAC(cpssDxChExactMatchAutoLearnProfileDefaultActionSet
                            (devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, exactMatchProfileIndex, expandedActionIndex, actionType, &defaultActionData, actionEn),
                            actionType);
        ...
        /*
            ...
            Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchAutoLearnProfileDefaultActionSet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,expandedActionIndex,actionType,NULL,actionEn);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        exactMatchProfileIndex=15;
        st = cpssDxChExactMatchAutoLearnProfileDefaultActionGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,NULL,&actionTypeGet,&defaultActionDataGet,&actionEnGet);
        ...
        /*
            ...
            Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchAutoLearnProfileDefaultActionGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,&expandedActionIndexGet,NULL,&defaultActionDataGet,&actionEnGet);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PTR, st, devNum);
        ...
        /*
            ...
            Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchAutoLearnProfileDefaultActionGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,&expandedActionIndexGet,&actionTypeGet,NULL,&actionEnGet);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PTR, st, devNum);
        ...
        */
        exactMatchProfileIndex=15;
        st = cpssDxChExactMatchAutoLearnProfileDefaultActionGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,&expandedActionIndexGet,&actionTypeGet,&defaultActionDataGet,NULL);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PTR, st, devNum);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        {
            st = cpssDxChExactMatchAutoLearnProfileDefaultActionEnableSet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,i,GT_FALSE);
       ...
       st = cpssDxChExactMatchPortGroupAutoLearnFlowIdParamSet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&conf);
       UTF_VERIFY_EQUAL4_PARAM_MAC(GT_OK, st, devNum, conf.baseFlowId, conf.maxNum, conf.threshold);

       st = cpssDxChExactMatchPortGroupAutoLearnFlowIdParamGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&confGet);
        ...
        */
        st = cpssDxChExactMatchPortGroupAutoLearnFlowIdParamSet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,NULL);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PTR, st, devNum);
    }
       ...
       UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,"cpssDxChExactMatchPortGroupAutoLearnFlowIdParamGet: %d", devNum);
        ...
        /*
            1.2. Call with confPtr [NULL].
                Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchPortGroupAutoLearnFlowIdParamGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,NULL);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
       ...
       st = cpssDxChExactMatchAutoLearnProfileDefaultActionEnableSet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,actionEn);
       UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, devNum, exactMatchProfileIndex, actionEn);

       st = cpssDxChExactMatchAutoLearnProfileDefaultActionEnableGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,&actionEnGet);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        exactMatchProfileIndex=1;
        st = cpssDxChExactMatchAutoLearnProfileDefaultActionEnableGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,exactMatchProfileIndex,NULL);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        /*
            ...
            Expected: GT_OK.
        */
        st = cpssDxChExactMatchPortGroupAutoLearnFlowIdAllocStatusGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&statusGet);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);
         ...
         /*
            1.2. Call with statusPtr [NULL].
                Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchPortGroupAutoLearnFlowIdAllocStatusGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,NULL);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        st = cpssDxChExactMatchPortGroupAutoLearnEntryGetNext(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&flowIdGet,&exactMatchIndexGet);
        if (st != GT_OK && st != GT_NO_MORE)
         ...
         /*
            1.2. Call with flowIdGet [NULL].
                Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchPortGroupAutoLearnEntryGetNext(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,NULL,&exactMatchIndexGet);
        ...
        /*
            1.3. Call with exactMatchIndexGet [NULL].
                Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchPortGroupAutoLearnEntryGetNext(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&flowIdGet,NULL);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st, "%d, cpssDxChExactMatchPortGroupAutoLearnEntryGetNext = NULL", devNum);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
       /*
            ...
            Expected: GT_FAIL; no collision entry to read..
       */
       st = cpssDxChExactMatchPortGroupAutoLearnCollisionKeyParamsGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&keyParamsGet);
       UTF_VERIFY_EQUAL1_STRING_MAC(GT_FAIL, st,"cpssDxChExactMatchPortGroupAutoLearnCollisionKeyParamsGet: %d", devNum);
        ...
        /*
            1.2. Call with keyParamsPtr [NULL].
                Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchPortGroupAutoLearnCollisionKeyParamsGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,NULL);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        st = cpssDxChExactMatchPortGroupAutoLearnEntryRecycleGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&flowIdGet,&exactMatchIndexGet);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_EMPTY, st, devNum);
         ...
         /*
            1.2. Call with flowIdGet [NULL].
                Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchPortGroupAutoLearnEntryRecycleGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,NULL,&exactMatchIndexGet);
        ...
        /*
            1.3. Call with exactMatchIndexGet [NULL].
                Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchPortGroupAutoLearnEntryRecycleGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&flowIdGet,NULL);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st, "%d, cpssDxChExactMatchPortGroupAutoLearnEntryRecycleGet = NULL", devNum);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        st = cpssDxChExactMatchPortGroupAutoLearnEntryRecycleTrigger(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_EMPTY, st, devNum);
    }
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
       /*
            ...
            Expected: GT_OK.
       */
       st = cpssDxChExactMatchPortGroupAutoLearnFailCountersGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,&failCounterGet);
       UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,"cpssDxChExactMatchPortGroupAutoLearnFailCountersGet: %d", devNum);
        ...
        /*
            1.2. Call with failCounterPtr [NULL].
                Expected: GT_BAD_PTR.
        */
        st = cpssDxChExactMatchPortGroupAutoLearnFailCountersGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_PORT_GROUP_UNAWARE_MODE_CNS,NULL);
...
UTF_TEST_CASE_MAC(cpssDxChExactMatchSerialEmPortProfileIdSet)
{
    GT_STATUS                           rc;
    GT_U8                               devNum;
    GT_PORT_NUM                         portNum;
    GT_U32                              portProfileId;
    GT_U32                              portProfileIdGet;

    /* this feature is on AAS devices */
    PRV_TGF_APPLIC_DEV_RESET_MAC(&devNum, UTF_CPSS_PP_ALL_SIP7_CNS);
    PRV_TGF_NON_EM_APPLIC_DEV_RESET_MAC;
    /* 1. Go over all active devices. */
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        rc = prvUtfNextDefaultEPortReset(&portNum, devNum);
        ...
        {
            portProfileId = 1;
            rc = cpssDxChExactMatchSerialEmPortProfileIdSet(devNum, portNum, portProfileId);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, rc, devNum);
            rc = cpssDxChExactMatchSerialEmPortProfileIdGet(devNum, portNum, &portProfileIdGet);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, rc, devNum);
            UTF_VERIFY_EQUAL1_PARAM_MAC(portProfileId, portProfileIdGet, devNum);
    ...
    {
        rc = cpssDxChExactMatchSerialEmPortProfileIdSet(devNum, portNum, portProfileId);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, rc, devNum, portNum);
    }
...
(
    IN   GT_U8                          devNum,
    IN   GT_PHYSICAL_PORT_NUM           portNum,
    OUT  GT_U32                         portProfileId
)*/
UTF_TEST_CASE_MAC(cpssDxChExactMatchSerialEmPortProfileIdGet)
{
    GT_STATUS                           rc;
    GT_U8                               devNum;
    GT_PORT_NUM                         portNum;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        while (GT_OK == prvUtfNextDefaultEPortGet(&portNum, GT_TRUE))
        {
            ...
            rc = cpssDxChExactMatchSerialEmPortProfileIdGet(devNum, portNum, NULL);
            UTF_VERIFY_EQUAL2_STRING_MAC(GT_BAD_PTR, rc, "%d, %d, profileIdModePtr = NULL",devNum, portNum);
...
(
    ...
    IN CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC        serialEmProfileParams
)*/
UTF_TEST_CASE_MAC(cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet)
{
    GT_STATUS                           rc;
    GT_U8                               devNum;
    GT_U32                              portProfileId;
    CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT    packetType;
    CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT           serialEmType;
    CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC          serialEmProfileParams;
    CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC          serialEmProfileParamsGet;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        for (serialEmType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM0_E;
             serialEmType < CPSS_DXCH_EXACT_MATCH_SERIAL_EM_LAST_E; serialEmType++)
        {
            portProfileId                                       = 1;
            packetType                                          = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_MPLS_E;
            serialEmProfileParams.serialEmProfileId             = 3;
            serialEmProfileParams.serialEmKeyType               = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_MPLS_E;
            serialEmProfileParams.serialEmEnableUDB28VlanTagKey = GT_TRUE;
            serialEmProfileParams.serialEmEnableUDB29VlanTagKey = GT_TRUE;
            serialEmProfileParams.serialEmPclId                 = 2;
            rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet(devNum, packetType, portProfileId,
                                                                         serialEmType, &serialEmProfileParams);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, rc, devNum);
            rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet(devNum, packetType, portProfileId,
                                                                         serialEmType, &serialEmProfileParamsGet);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, rc, devNum, serialEmType);
            UTF_VERIFY_EQUAL2_PARAM_MAC(serialEmProfileParams.serialEmProfileId, serialEmProfileParamsGet.serialEmProfileId, devNum, serialEmType);
            UTF_VERIFY_EQUAL2_PARAM_MAC(serialEmProfileParams.serialEmKeyType, serialEmProfileParamsGet.serialEmKeyType, devNum, serialEmType);
            UTF_VERIFY_EQUAL2_PARAM_MAC(serialEmProfileParams.serialEmEnableUDB28VlanTagKey, serialEmProfileParamsGet.serialEmEnableUDB28VlanTagKey, devNum, serialEmType);
            UTF_VERIFY_EQUAL2_PARAM_MAC(serialEmProfileParams.serialEmEnableUDB29VlanTagKey, serialEmProfileParamsGet.serialEmEnableUDB29VlanTagKey, devNum, serialEmType);
            UTF_VERIFY_EQUAL2_PARAM_MAC(serialEmProfileParams.serialEmPclId, serialEmProfileParamsGet.serialEmPclId, devNum, serialEmType);

            /* Negative Scenarios */
            packetType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_UDB_UDE6_E+1;
            rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet(devNum, packetType, portProfileId,
                                                                         serialEmType, &serialEmProfileParams);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PARAM, rc, devNum, serialEmType);
            ...
            serialEmProfileParams.serialEmProfileId = 16;
            rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet(devNum, packetType, portProfileId,
                                                                         serialEmType, &serialEmProfileParams);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PARAM, rc, devNum, serialEmType);
            serialEmProfileParams.serialEmProfileId  = 5;

            serialEmProfileParams.serialEmPclId = 4;
            rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet(devNum, packetType, portProfileId,
                                                                         serialEmType, &serialEmProfileParams);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PARAM, rc, devNum, serialEmType);
            serialEmProfileParams.serialEmPclId = 2;

            serialEmProfileParams.serialEmKeyType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_LAST_E;
            rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet(devNum, packetType, portProfileId,
                                                                         serialEmType, &serialEmProfileParams);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PARAM, rc, devNum, serialEmType);
            serialEmProfileParams.serialEmKeyType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_MPLS_E;
    ...
    serialEmType = CPSS_DXCH_EXACT_MATCH_SERIAL_EM0_E;
    /* prepare device iterator */
    PRV_TGF_APPLIC_DEV_RESET_MAC(&devNum, UTF_CPSS_PP_ALL_SIP7_CNS);
    PRV_TGF_NON_EM_APPLIC_DEV_RESET_MAC;
    /* 1. Go over all active devices. */
...
(
    ...
    IN  GT_U32                                           portProfileId,
    IN  CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT         serialEmType,
    OUT GT_U32                                           *emProfileIdPtr
)*/
UTF_TEST_CASE_MAC(cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet)
{
    GT_STATUS                           rc;
    GT_U8                               devNum;
    GT_U32                              portProfileId;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
             ...
             serialEmType < CPSS_DXCH_EXACT_MATCH_SERIAL_EM_LAST_E; serialEmType++)
        {
            ...
            portProfileId   = 5;
            rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet(devNum, packetType, portProfileId, serialEmType, NULL);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PTR, rc, devNum, serialEmType);
        }
        rc = cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet(devNum, packetType, portProfileId,
                                                                    serialEmType, &serialEmProfileParamsGet);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PARAM, rc, devNum, serialEmType);
...
UTF_TEST_CASE_MAC(cpssDxChExactMatchProfileMuxTableLineSet)
{
    GT_STATUS                                       rc;
    GT_U8                                           devNum;
    GT_U32                                          emProfileId;
    CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC    emMuxTableLineCfg;
    CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC    emMuxTableLineCfgGet;
    GT_U32                                          index;
    GT_U32                                          emUnitNum;
    GT_U32                                          maxEmUnits;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            {
                emMuxTableLineCfg.superKeyTwoByteUnitsOffsets[index] = index;
            }
            rc = cpssDxChExactMatchProfileMuxTableLineSet(devNum, emUnitNum, emProfileId, &emMuxTableLineCfg);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, rc, devNum, emUnitNum);
            rc = cpssDxChExactMatchProfileMuxTableLineGet(devNum, emUnitNum, emProfileId, &emMuxTableLineCfgGet);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, rc, devNum, emUnitNum);
            for (index = 0; (index < 30); index++)
            {
                UTF_VERIFY_EQUAL3_PARAM_MAC(
                    emMuxTableLineCfg.superKeyTwoByteUnitsOffsets[index],
                    emMuxTableLineCfgGet.superKeyTwoByteUnitsOffsets[index],
                    devNum, emUnitNum, index);
            }

            emProfileId   = 16;
            rc = cpssDxChExactMatchProfileMuxTableLineSet(devNum, emUnitNum, emProfileId, &emMuxTableLineCfg);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PARAM, rc, devNum, emUnitNum);

            emProfileId   = 5;
            rc = cpssDxChExactMatchProfileMuxTableLineSet(devNum, emUnitNum, emProfileId, NULL);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PTR, rc, devNum, emUnitNum);

            emMuxTableLineCfg.superKeyTwoByteUnitsOffsets[1] = 60;
            rc = cpssDxChExactMatchProfileMuxTableLineSet(devNum, emUnitNum, emProfileId, &emMuxTableLineCfg);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OUT_OF_RANGE, rc, devNum, emUnitNum);
            emMuxTableLineCfg.superKeyTwoByteUnitsOffsets[1] = 1;
        } /* end of EM units for loop */
        emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_REDUCED_E;
        rc = cpssDxChExactMatchProfileMuxTableLineSet(devNum, emUnitNum, emProfileId, &emMuxTableLineCfg);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PARAM, rc, devNum, emUnitNum);
    ...
    {
        rc = cpssDxChExactMatchProfileMuxTableLineSet(devNum, emUnitNum, emProfileId, &emMuxTableLineCfg);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, rc, devNum, emUnitNum);
    }
...
UTF_TEST_CASE_MAC(cpssDxChExactMatchProfileMuxTableLineGet)
{
    GT_STATUS                                       rc;
    GT_U8                                           devNum;
    GT_U32                                          emProfileId;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (emUnitNum = CPSS_DXCH_EXACT_MATCH_UNIT_0_E; emUnitNum < maxEmUnits; emUnitNum++)
        {
            ...
            emProfileId   = 5;
            rc = cpssDxChExactMatchProfileMuxTableLineGet(devNum, emUnitNum, emProfileId, NULL);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_BAD_PTR, rc, devNum, emUnitNum);
        } /* end of EM units for loop */
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_FALSE))
    {
        rc = cpssDxChExactMatchProfileMuxTableLineGet(devNum, emUnitNum,
                                                      emProfileId, &emMuxTableLineCfgGet);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_NOT_APPLICABLE_DEVICE, rc, devNum, emUnitNum);
    }
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssDxChExactMatch)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChExactMatchSerialEmPortProfileIdSet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChExactMatchSerialEmPortProfileIdGet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChExactMatchProfileMuxTableLineSet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChExactMatchProfileMuxTableLineGet)

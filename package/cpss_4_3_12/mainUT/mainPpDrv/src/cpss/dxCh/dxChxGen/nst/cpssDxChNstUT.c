...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Only SIP5 devices supports MIRROR/TRAP to CPU commands */
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        st = cpssDxChNstRouterAccessMatrixCmdSet(dev, sipAccessLevel, dipAccessLevel, CPSS_IP_PROTOCOL_ALL_E, command);
        UTF_VERIFY_EQUAL4_PARAM_MAC(GT_OK, st, dev, sipAccessLevel, dipAccessLevel, command);

        st = cpssDxChNstRouterAccessMatrixCmdGet(dev, sipAccessLevel, dipAccessLevel, CPSS_IP_PROTOCOL_ALL_E, &retCommand);
        ...
        */
        ...
        UTF_ENUMS_CHECK_MAC(cpssDxChNstRouterAccessMatrixCmdSet
                            (dev, sipAccessLevel, dipAccessLevel, CPSS_IP_PROTOCOL_ALL_E, command),
                            command);
    }
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        st = cpssDxChNstRouterAccessMatrixCmdGet(dev, sipAccessLevel, dipAccessLevel, CPSS_IP_PROTOCOL_ALL_E, NULL);

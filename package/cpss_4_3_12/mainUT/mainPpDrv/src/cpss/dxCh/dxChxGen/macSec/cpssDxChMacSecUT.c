    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        while(GT_OK == prvUtfNextMACSecPortGet(&port, GT_TRUE))
        {
            ...
            */
            ...
            {
                classifyPortCfg.policyMode     = CPSS_DXCH_MACSEC_POLICY_MODE_SHOULD_SECURE_E;
            }
            ...
            */
            ...
            if(PRV_CPSS_SIP_6_30_CHECK_MAC(dev))
            {
                UTF_VERIFY_EQUAL1_PARAM_MAC(classifyPortCfg.policyMode     , classifyPortCfgGet.policyMode         , dev);
            }
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        while(GT_OK == prvUtfNextMACSecPortGet(&port, GT_TRUE))
        {
            ...
            */
            ...
            if(PRV_CPSS_SIP_6_30_CHECK_MAC(dev))
            {
                secyPortCfg.policyMode = CPSS_DXCH_MACSEC_POLICY_MODE_SHOULD_SECURE_E;
            }
            ...
            if(PRV_CPSS_SIP_6_30_CHECK_MAC(dev))
            {
                UTF_VERIFY_EQUAL1_PARAM_MAC(secyPortCfg.policyMode                   , secyPortCfgGet.policyMode                       , dev);
            }
            ...
            */
            ...
            if(PRV_CPSS_SIP_6_30_CHECK_MAC(dev))
            {
                secyPortCfg.policyMode   = CPSS_DXCH_MACSEC_POLICY_MODE_MUST_SECURE_E;
            }
...
*/
    ...
    GT_BOOL                                          syncEnable;
    GT_BOOL                                          initDone;
    CPSS_PORT_PREEMPTION_CLASS_ENT                   preemptionClass = CPSS_PORT_PREEMPTION_CLASS_EXPRESS_E;
        ...
        while(GT_OK == prvUtfNextMACSecPortGet(&port, GT_TRUE))
        {
            ...
            */
            ...
            /*
               ...
               Expected: GT_BAD_PARAM.
            */
            UTF_ENUMS_CHECK_MAC(cpssDxChMacSecPortClassifyStatisticsGet(dev, port, direction, syncEnable, preemptionClass, &portStatistics), direction);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMacSecSecyStatisticsSaClear)
{
/*
    1.1.1 Call cpssDxChMacSecSecyStatisticsSaClear before cpssDxChMacSecInit (before MACSec initialization).
          Expected: GT_NOT_INITIALIZED.

    1.1.2 Call cpssDxChMacSecSecyStatisticsSaClear with valid values
          Expected: GT_OK.

    1.1.3 Call cpssDxChMacSecSecyStatisticsSaClear with wrong direction [wrong enum values].
          Expected: GT_BAD_PARAM.

    1.1.4 Call cpssDxChMacSecSecyStatisticsSaClear with invalid unitBmp.
          unitBmp [6]                                                             .
          Expected: GT_BAD_PARAM.

    1.1.5 Call cpssDxChMacSecSecyStatisticsSaClear with invalid saHandle.
          Expected: GT_BAD_PARAM.

    2.1   Call cpssDxChMacSecSecyStatisticsSaClear and go over all non active devices
          Expected: GT_NOT_APPLICABLE_DEVICE.

    3.1   Call cpssDxChMacSecSecyStatisticsSaClear with out of bound value for device id
          Expected: GT_BAD_PARAM.
*/
    GT_STATUS                               st = GT_OK;
    GT_U8                                   dev;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChMacSecSecyStatisticsSaClear(dev,
                                               unitBmp,
                                               direction,
                                               saHandle);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_NOT_INITIALIZED, st, dev);
        ...
        */
        ...
        /* Call cpssDxChMacSecSecyStatisticsSaClear with valid values
           Set syncEnable as GT_TRUE */
        st = cpssDxChMacSecSecyStatisticsSaClear(dev,
                                               unitBmp,
                                               direction,
        ...
        /*
           ...
           Expected: GT_BAD_PARAM.
        */
        UTF_ENUMS_CHECK_MAC(cpssDxChMacSecSecyStatisticsSaClear(dev, unitBmp, direction, saHandle), direction);
    ...
    /*
        2.1. Call cpssDxChMacSecSecyStatisticsSaClear for none active devices.
        Expected: GT_NOT_APPLICABLE_DEVICE.
    */
    saHandle = 0;
    /* prepare device iterator */
    ...
    /*
        3.1. Call cpssDxChMacSecSecyStatisticsSaClear with out of bound device id.
        Expected: GT_BAD_PARAM.
    */
    dev = PRV_CPSS_MAX_PP_DEVICES_CNS;
...
*/
    ...
    GT_MACSEC_UNIT_BMP                      unitBmp;
    CPSS_DXCH_MACSEC_SECY_SA_STC            saParams;
    CPSS_DXCH_MACSEC_SECY_SA_HANDLE         activeSaHandle[CPSS_DXCH_MACSEC_SECY_MAX_ACTIVE_SA_CNS];
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        if (prvCpssMacSecSecySaHandlesCompare(saHandles[saParams.params.ingress.an],activeSaHandle[0]))
        {
            st = GT_OK;
        }
        else
        ...
        while(GT_OK == prvUtfNextMACSecPortGet(&port, GT_TRUE))
        {
            ...
            */
            ...
            /*
               ...
               Expected: GT_BAD_PARAM.
            */
            UTF_ENUMS_CHECK_MAC(cpssDxChMacSecPortSecyDump(dev, unitBmp, direction, port, preemptionClass, allPorts), direction);
        }
        ...
        while(GT_OK == prvUtfNextMACSecPortGet(&port, GT_TRUE))
        {
            ...
            */
            ...
            /*
               ...
               Expected: GT_BAD_PARAM.
            */
            UTF_ENUMS_CHECK_MAC(cpssDxChMacSecPortClassifyDump(dev, unitBmp, direction, port, preemptionClass, allPorts), direction);
        }
...
*/
UTF_TEST_CASE_MAC(cpssDxChMacSecSecySaSwitch)
{
/*
    1.1.1 Call cpssDxChMacSecSecySaSwitch before cpssDxChMacSecInit (before MACSec initialization).
          Expected: GT_NOT_INITIALIZED.

    1.1.2 Call cpssDxChMacSecSecySaSwitch with valid values
          Expected: GT_OK.

    1.1.3 Call cpssDxChMacSecSecySaSwitch with invalid unitBmp.
          unitBmp [6]
          Expected: GT_BAD_PARAM.
          NOTE: Skip Phoenix since it is a single DP device and therefore unitBmp parameter is ignored

    1.1.4 Call cpssDxChMacSecSecySaSwitch with invalid activeSaHandle.
          Expected: GT_BAD_PARAM.

    1.1.5 Call cpssDxChMacSecSecySaSwitch with invalid newSaHandle.
          Expected: GT_BAD_PARAM.

    2.1. Call cpssDxChMacSecSecySaSwitch for none active devices.
    Expected: GT_NOT_APPLICABLE_DEVICE.

    3.1. Call cpssDxChMacSecSecySaSwitch with out of bound device id.
    Expected: GT_BAD_PARAM.
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChMacSecSecySaSwitch(dev,
                                        BIT_0,
                                        activeSaHandle,
                                        newSaHandle);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_NOT_INITIALIZED, st, dev);
        ...
        */
        ...
        /* Chain new SA to current active SA */
        st = cpssDxChMacSecSecySaChainSet(dev,
                                          BIT_0,
                                          activeSaHandle,
                                          &newTrRecParams,
        ...
        /* Call cpssDxChMacSecSecySaSwitch to manually switch SA from active to new */
        st = cpssDxChMacSecSecySaSwitch(dev,
                                        BIT_0,
                                        activeSaHandle,
                                        newSaHandle);
        ...
        */
        ...
        /*
           1.1.4 Call api with invalid activeSaHandle.
           Expected: GT_BAD_PARAM.
        */
        st = cpssDxChMacSecSecySaSwitch(dev,
                                        BIT_0,
        ...
        /*
           1.1.5 Call api with invalid newSaHandle.
           Expected: GT_BAD_PARAM.
        */
        st = cpssDxChMacSecSecySaSwitch(dev,
                                        BIT_0,
        ...
        /* Remove vPort and SAs for proper exit behaviour */

        /* Remove this vPort to return to previous state */
        st = cpssDxChMacSecClassifyVportRemove(dev,
                                               unitBmp,
                                               direction,
                                               vPortHandle);
        ...
        /* Remove first SA to return to previous state */
        st = cpssDxChMacSecSecySaRemove(dev,
                                        unitBmp,
                                        direction,
                                        activeSaHandle);
        ...
        /* Remove new SA to return to previous state */
        st = cpssDxChMacSecSecySaRemove(dev,
                                        unitBmp,
                                        direction,
                                        newSaHandle);
...
*/
UTF_TEST_CASE_MAC(cpssDxChMacSecClassifyRuleAddIndex)
{
/*
    1.1.1 Call cpssDxChMacSecClassifyRuleAddIndex before cpssDxChMacSecInit (before MACSec initialization).
          Expected: GT_NOT_INITIALIZED.

    1.1.2 Call cpssDxChMacSecClassifyRuleAddIndex and try to add rule when ruleIndex is more than allowed                                                                        .
          Expected: GT_BAD_PARAM.

    1.1.3 Call cpssDxChMacSecClassifyRuleAddIndex with valid values.
          Expected: GT_OK.

    1.1.4 Call cpssDxChMacSecClassifyRuleAddIndex and try to add rule when rule index is not free to be used                                                                        .
          Expected: GT_BAD_PARAM.

    1.1.5 Call cpssDxChMacSecClassifyRuleAddIndex with invalid unitBmp.
          unitBmp [6]                                                             .
          Expected: GT_BAD_PARAM.
    ...
    1.1.7 Call cpssDxChMacSecClassifyRuleAddIndex with invalid vPortHandle.
          vPortHandle [0]                                                                 .
          Expected: GT_BAD_PARAM.

    1.1.8 Call API with ruleParams as NULL pointer.
          Expected: GT_BAD_PTR.

    1.1.9 Call API with ruleHandle as NULL pointer.
          Expected: GT_BAD_PTR.

    2.1. Call cpssDxChMacSecClassifyRuleAddIndex for none active devices.
    Expected: GT_NOT_APPLICABLE_DEVICE.

    3.1. Call cpssDxChMacSecClassifyRuleAddIndex with out of bound device id.
    Expected: GT_BAD_PARAM.
*/
    GT_STATUS                               st = GT_OK;
    GT_U8                                   dev;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        vPortHandle = 1;
        ruleIndex   = 0;
        st = cpssDxChMacSecClassifyRuleAddIndex(dev,
                                                BIT_0,
                                                CPSS_DXCH_MACSEC_DIRECTION_EGRESS_E,
                                                vPortHandle,
                                                &ruleParams,
        ...
        */
        ...
        /*
           ...
           Expected: GT_BAD_PARAM.
        */
        UTF_ENUMS_CHECK_MAC(cpssDxChMacSecClassifyRuleAddIndex(dev, unitBmp, direction, vPortHandle, &ruleParams, ruleIndex, &ruleHandle), direction);
...
#if 0
/*----------------------------------------------------------------------------*/
/* Case to validate CPSS-16268
 * SA Add and Remove, makes wrong vPort assignment
 *
 * Involved 3 ports (and their peers ports):
 *    port 2, port 3 and port 7,
 *    enable macsec on the 3 ports one by one with strict order, i.e., first port 2, second port 3, third port 7.
 *    Please notice on each port,
 *    there are 2 macsec vports,
 *      - One for control traffic with bypass type SA
 *      - Another for data traffic.
 *
 *    After macsec sessions setup done on the 3 ports,
 *    Disable/Enable macsec on port 2 multiple times to trigger internal macsec resource index rotate
 *
*/
UTF_TEST_CASE_MAC(cpssDxChMacSecClassifyRule_wrap_around)
{
    GT_STATUS                               st = GT_OK;
    GT_U8                                   dev;
    CPSS_DXCH_MACSEC_DIRECTION_ENT          direction;
    ...
    /* Set SA parameters */
    saParams.actionType                         = CPSS_DXCH_MACSEC_SECY_SA_ACTION_BYPASS_E;
    saParams.destPort                           = CPSS_DXCH_MACSEC_SECY_PORT_UNCONTROLLED_E;
    saParams.params.egress.protectFrames        = GT_TRUE;
    saParams.params.egress.confProtect          = GT_TRUE;
    saParams.params.egress.controlledPortEnable = GT_TRUE;
    saParams.params.egress.preSecTagAuthLength  = 12;  /* MAC DA,SA */
    ...
    /* Add Egress SA Handle */
    direction = CPSS_DXCH_MACSEC_DIRECTION_EGRESS_E;
    st = cpssDxChMacSecClassifyVportAdd(dev, unitBmp, direction, &vPortParams, &vPortHandle);
    UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
    PRV_UTF_LOG1_MAC("******* Added [Egress] vPortHnadle = [0x%x] ", vPortHandle);

    /* Get the associated vPort index */
    st = cpssDxChMacSecClassifyVportIndexGet(dev, vPortHandle, &vPortIndex);
    UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
    PRV_UTF_LOG1_MAC("vPortIndex = [%d] ", vPortIndex);

    /* Add SA */
    st = cpssDxChMacSecSecySaAdd(dev, unitBmp, direction, vPortIndex, &saParams, &trRecParams, &saHandle);
    UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
    PRV_UTF_LOG1_MAC(" saHandle = [0x%x]\n", saHandle);
    ...
    for(i=0; i<66; i++)
    {
        st = cpssDxChMacSecClassifyVportAdd(dev, unitBmp, direction, &vPortParams, &vPortHandle);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
        PRV_UTF_LOG1_MAC("******* Added vPortHnadle = [0x%x] ", vPortHandle);
        ...
        st = cpssDxChMacSecSecySaRemove(dev, unitBmp, direction, saHandle);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
        PRV_UTF_LOG1_MAC("Removed saHandle = [0x%x]", saHandle);

        st = cpssDxChMacSecClassifyVportRemove(dev, unitBmp, direction, vPortHandle);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
        PRV_UTF_LOG1_MAC("vPortHnadle = [0x%x]\n", vPortHandle);
    }
}
#endif
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssDxChMacSec)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMacSecSecySaSwitch)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMacSecClassifyRuleAddIndex)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMacSecSecyStatisticsSaClear)
#if 0
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChMacSecClassifyRule_wrap_around)
#endif

...
{                                                                               \
    ...
    st = cpssDxChPtpManagerPtpInit(devNum,&outputInterfaceConf,&ptpOverEthernetConf,\
               &ptpOverIpUdpConf,&ptpTsTagGlobalConf,&ptpRefClockConf,cpuCode); \
    /* restore orig value */                                                    \
    fieldName = origValue;                                                      \
...
{                                                                               \
    ...
    paramPtr = NULL;                                                            \
                                                                                \
    st = cpssDxChPtpManagerPtpInit(devNum,ptr1,ptr2,ptr3,ptr4,ptr5,cpuCode);    \
    /* restore orig value */                                                    \
    paramPtr = origPtr;                                                         \
...
)
{
    ...
    ptpRefClockConfPtr->refClockSource = CPSS_DXCH_PTP_REF_CLOCK_SELECT_MAIN_25_MHZ_E;
    ptpRefClockConfPtr->refClockFrequency = CPSS_DXCH_PTP_25_FREQ_E;
...
UTF_TEST_CASE_MAC(cpssDxChPtpManagerPtpInit)
{
    ...
    CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC          *ptpRefClockConfPtr;
    ...
    ptpRefClockConfPtr      = &ptpRefClockConf;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        /* set default setting */
        prvCpssDxChPtpManagerPtpInitDefaultValues(outputInterfaceConfPtr,ptpOverEthernetConfPtr,ptpOverIpUdpConfPtr,ptpTsTagGlobalConfPtr,ptpRefClockConfPtr,&cpuCode);

        st = cpssDxChPtpManagerPtpInit(devNum,outputInterfaceConfPtr,ptpOverEthernetConfPtr,ptpOverIpUdpConfPtr,ptpTsTagGlobalConfPtr,ptpRefClockConfPtr,cpuCode);
        ...
        outputInterfaceConfPtr,ptpOverEthernetConfPtr,ptpOverIpUdpConfPtr,ptpTsTagGlobalConfPtr,ptpRefClockConfPtr);
        ...
        FAIL_NULL_PTR_cpssDxChPtpManagerPtpInit(ptpRefClockConfPtr/*checked for NULL*/,
        outputInterfaceConfPtr,ptpOverEthernetConfPtr,ptpOverIpUdpConfPtr,ptpTsTagGlobalConfPtr,ptpRefClockConfPtr);
    }
...
UTF_TEST_CASE_MAC(cpssDxChPtpManagerCaptureTodValueSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        taiNumber = (isAc5y == GT_FALSE) ? CPSS_DXCH_PTP_TAI_NUMBER_1_E : CPSS_DXCH_PTP_TAI_NUMBER_0_E;
        st = cpssDxChPtpManagerTodValueGet(devNum,taiNumber,&todValueEntry0,&todValueEntry1);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st,"cpssDxChPtpManagerTodValueGet");
        ...
        {
            if(isAc5y && taiNumber >= CPSS_DXCH_PTP_TAI_NUMBER_1_E && taiNumber <= CPSS_DXCH_PTP_TAI_NUMBER_3_E)
                continue;
...
UTF_TEST_CASE_MAC(cpssDxChPtpManagerTodValueFrequencyUpdate)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for (taiNumber = CPSS_DXCH_PTP_TAI_NUMBER_0_E; taiNumber <= taiNumberEnd; taiNumber++)
        {
            ...
            st = prvCpssDxChPtpManagerConvertFloatToBinary(fUpdateValue,&bUpdateValue);
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st,"prvCpssDxChPtpManagerConvertFloatToBinary");

            UTF_VERIFY_EQUAL0_PARAM_MAC(bUpdateValue,todValueGet.fracNanoSeconds);
        }
...
UTF_TEST_CASE_MAC(cpssDxChPtpManagerTodValueUpdate)
{
    ...
    GT_U8                                            devNum;
    CPSS_DXCH_PTP_TAI_NUMBER_ENT                     taiNumber,taiNumberEnd;
    CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC              updateValue;
    CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC              *updateValuePtr;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        updateValue.fracNanoSeconds = 0x1FFFFFFF;
        fUpdateValue = 0.125;
        capturePrevTodValueEnable = GT_TRUE;
...
UTF_TEST_CASE_MAC(cpssDxChPtpManagerTriggerGenerate)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        st = cpssDxChPtpManagerTriggerGenerate(devNum,taiNumber,extPulseWidth,&triggerTime,&maskValue);
...
UTF_TEST_CASE_MAC(cpssDxChPtpManagerPortTimestampingModeConfig)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        portNum = 2;
        tsMode = CPSS_DXCH_PTP_ENHANCED_TIMESTAMPING_MODE_STANDARD_E;
        operationMode = CPSS_DXCH_PTP_MANAGER_OPERATION_MODE_ONE_OR_TWO_STEP_IN_SWITCH_E;
        st = cpssDxChPtpManagerPortTimestampingModeConfig(devNum,portNum,tsMode,operationMode);
        ...
        FAIL_SPECIFIC_VALUE_NUMERIC_FIELD_cpssDxChPtpManagerPortTimestampingModeConfig(
            operationMode,
            CPSS_DXCH_PTP_MANAGER_OPERATION_MODE_ONE_OR_TWO_STEP_IN_MAC_E+1);
    }
...
UTF_TEST_CASE_MAC(cpssDxChPtpManager8021AsMsgSelectionEnableSet)
{
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        if (isAc5y == GT_TRUE)
        {
            taiNumberEnd = CPSS_DXCH_PTP_TAI_NUMBER_1_E;
        }
        else
        {
            taiNumberEnd = CPSS_DXCH_PTP_TAI_NUMBER_4_E;
        }
        ...
        */
        taiNumber = (isAc5y == GT_FALSE) ? CPSS_DXCH_PTP_TAI_NUMBER_3_E : CPSS_DXCH_PTP_TAI_NUMBER_0_E;
...
*/
UTF_TEST_CASE_MAC(cpssDxChPtpManagerPortMacTsQueueSigatureSet)
{
    GT_STATUS st;
    GT_U8 devNum;
    GT_PHYSICAL_PORT_NUM portNum;
    CPSS_DXCH_PTP_MANAGER_SIGNATURE_MODE_ENT signatureMode,signatureModeGet;
    GT_U32 signatureValue,signatureValueGet;
    ...
    {
        /*
            1.1. For all active devices call cpssDxChPtpManagerPortMacTsQueueSigatureSet with valid params.
            Expected: GT_OK.
        */
        portNum = 2;
        signatureMode = CPSS_DXCH_PTP_MANAGER_SIGNATURE_MODE_QUEUE_ENTRY_ID_E;
        st = cpssDxChPtpManagerPortMacTsQueueSigatureSet(devNum,portNum,signatureMode,signatureValue);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);

        /*
            1.2. Call cpssDxChPtpManagerPortMacTsQueueSigatureGet with the same parameters.
            Expected: GT_OK and the same values than was set.
        */
        st = cpssDxChPtpManagerPortMacTsQueueSigatureGet(devNum,portNum,&signatureModeGet,&signatureValueGet);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);

        /* Verifying values */
        UTF_VERIFY_EQUAL1_STRING_MAC(signatureMode,signatureModeGet,
                                     "got another signature mode then was set: %d", devNum);

        /*
            1.3. For all active devices call cpssDxChPtpManagerPortMacTsQueueSigatureSet with valid params.
            Expected: GT_OK.
        */
        portNum = 5;
        signatureMode = CPSS_DXCH_PTP_MANAGER_SIGNATURE_MODE_COUNTER_E;
        signatureValue = 0x3333;
        st = cpssDxChPtpManagerPortMacTsQueueSigatureSet(devNum,portNum,signatureMode,signatureValue);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);

        /*
            1.4. Call cpssDxChPtpManagerPortMacTsQueueSigatureGet with the same parameters.
            Expected: GT_OK and the same values than was set.
        */
        st = cpssDxChPtpManagerPortMacTsQueueSigatureGet(devNum,portNum,&signatureModeGet,&signatureValueGet);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);
        ...
        /* Verifying values */
        UTF_VERIFY_EQUAL1_STRING_MAC(signatureValue,signatureValueGet,
                                     "got another signature value then was set: %d", devNum);

        /*
            1.5. Call api with out of range signatureValue.
            Expected: GT_OUT_OF_RANGE.
        */
        signatureValue = 0x1FFFF;
        st = cpssDxChPtpManagerPortMacTsQueueSigatureSet(devNum,portNum,signatureMode,signatureValue);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OUT_OF_RANGE, st, devNum);

        /*
            1.5. Call api with out of range signatureMode.
            Expected: GT_OUT_OF_RANGE.
        */
        signatureMode = CPSS_DXCH_PTP_MANAGER_SIGNATURE_MODE_COUNTER_E+1;
        st = cpssDxChPtpManagerPortMacTsQueueSigatureSet(devNum,portNum,signatureMode,signatureValue);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PARAM, st, devNum);
...
*/
UTF_TEST_CASE_MAC(cpssDxChPtpManagerPortMacTsQueueSigatureGet)
{
    GT_STATUS st;
    GT_U8 devNum;
    GT_PHYSICAL_PORT_NUM portNum;
    CPSS_DXCH_PTP_MANAGER_SIGNATURE_MODE_ENT signatureMode;
    GT_U32 signatureValue;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        /*
            1.1 Call with non-null parameters
            Expected: GT_OK.
        */
        portNum = 2;
        st = cpssDxChPtpManagerPortMacTsQueueSigatureGet(devNum,portNum,&signatureMode,&signatureValue);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);

        /*
            1.2 Call api with wrong signatureModePtr [NULL].
            Expected: GT_BAD_PTR.
        */
        st = cpssDxChPtpManagerPortMacTsQueueSigatureGet(devNum,portNum,NULL,&signatureValue);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PTR, st, devNum);

        /*
            1.3 Call api with wrong signatureValuePtr [NULL].
            Expected: GT_BAD_PTR.
        */
        st = cpssDxChPtpManagerPortMacTsQueueSigatureGet(devNum,portNum,&signatureMode,NULL);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PTR, st, devNum);
...
*/
UTF_TEST_CASE_MAC(cpssDxChPtpManagerMacEgressTimestampPortQueueEntryRead)
{

    GT_STATUS                                      st      =  GT_OK;
    GT_U8                                          devNum  =  0;
    UTF_PHYSICAL_PORT_NUM                          port;
    CPSS_DXCH_PTP_MANAGER_MAC_TX_TIMESTAMP_QUEUE_ENTRY_STC entry;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        {
            /*
                1.1.1 Call cpssDxChPtpManagerMacEgressTimestampPortQueueEntryRead with valid parameters
                Expected: GT_OK
            */
            if(prvCpssDxChPortRemotePortCheck(devNum, port))
            {
                st = cpssDxChPtpManagerMacEgressTimestampPortQueueEntryRead(devNum,port,&entry);
                UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PARAM, st, devNum);
                continue;
            }
            ...
            /*
                ...
                Expected: GT_BAD_PTR
            */
            st = cpssDxChPtpManagerMacEgressTimestampPortQueueEntryRead(devNum,port,NULL);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PTR, st, devNum);
        }
        /*
...
UTF_TEST_CASE_MAC(cpssDxChPtpManagerPhyTodValueGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        /*** set valid values ***/
            ...
            /* simulation not support capture TOD by the internal phy */
            skip = GT_TRUE;
        #endif  /*ASIC_SIMULATION*/
        if(skip == GT_FALSE)
        {
            /* read twice to invalidate privious entries (COR) */
            st = cpssDxChPtpManagerPhyTodValueGet(devNum,&todValueEntry0,&todValueEntry1);
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st,"cpssDxChPtpManagerTodValueGet");
            st = cpssDxChPtpManagerPhyTodValueGet(devNum,&todValueEntry0,&todValueEntry1);
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st,"cpssDxChPtpManagerTodValueGet");
            UTF_VERIFY_EQUAL0_PARAM_MAC(GT_FALSE, todValueEntry0.todValueIsValid);
            ...
            st = cpssDxChPtpManagerPhyCaptureTodValueSet(devNum); /* capture to entry0 */
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st,"cpssDxChPtpManagerPhyCaptureTodValueSet");
            st = cpssDxChPtpManagerPhyCaptureTodValueSet(devNum); /* capture to entry1 */
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st,"cpssDxChPtpManagerPhyCaptureTodValueSet");
        ...
        /* check NULL pointers */
        st = cpssDxChPtpManagerPhyTodValueGet(devNum,NULL,&todValueEntry1);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st, "%d, valuePtr = NULL",devNum);
        st = cpssDxChPtpManagerPhyTodValueGet(devNum,&todValueEntry0,NULL);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st, "%d, valuePtr = NULL",devNum);
    }
    ...
    {
        st = cpssDxChPtpManagerPhyTodValueGet(devNum,&todValueEntry0,&todValueEntry1);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_NOT_APPLICABLE_DEVICE, st,"cpssDxChPtpManagerPhyTodValueGet");
    }
...
/* check specific value of numeric field , and high values (31,32 bits value) :
expected to fail */
#define FAIL_SPECIFIC_VALUE_NUMERIC_FIELD_cpssDxChPtpManagerMasterSerActivate(  \
    fieldName,                                                                  \
    testedField_Value                                                           \
)                                                                               \
{                                                                               \
    GT_U32  origValue = fieldName;                                              \
                                                                                \
    fieldName = (testedField_Value);                                            \
    st = cpssDxChPtpManagerMasterSerActivate(devNum,taiNumber);                 \
    /* restore orig value */                                                    \
    fieldName = origValue;                                                      \
    UTF_VERIFY_NOT_EQUAL2_STRING_MAC(GT_OK, st,                                 \
        "cpssDxChPtpManagerMasterSerActivate: %s expected NOT to be GT_OK on value [%d]", \
        #fieldName,                                                             \
        (testedField_Value));                                                   \
}
...
*/
UTF_TEST_CASE_MAC(cpssDxChPtpManagerMasterSerActivate)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        taiNumber = CPSS_DXCH_PTP_TAI_NUMBER_ALL_E;
        st = cpssDxChPtpManagerMasterSerActivate(devNum,taiNumber);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st,"cpssDxChPtpManagerMasterSerActivate");

        /*** check not valid values ***/

        FAIL_SPECIFIC_VALUE_NUMERIC_FIELD_cpssDxChPtpManagerMasterSerActivate(
            taiNumber,
            CPSS_DXCH_PTP_TAI_NUMBER_ALL_E+1);
    }
    ...
    {
        st = cpssDxChPtpManagerMasterSerActivate(devNum,taiNumber);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_NOT_APPLICABLE_DEVICE, st,"cpssDxChPtpManagerMasterSerActivate");
    }
}

/* check specific value of numeric field , and high values (31,32 bits value) :
expected to fail */
#define FAIL_SPECIFIC_VALUE_NUMERIC_FIELD_cpssDxChPtpManagerSlaveSerActivate(   \
    fieldName,                                                                  \
    testedField_Value                                                           \
)                                                                               \
{                                                                               \
    GT_U32  origValue = fieldName;                                              \
                                                                                \
    fieldName = (testedField_Value);                                            \
    st = cpssDxChPtpManagerSlaveSerActivate(devNum,taiNumber,nanoSeconds,fracNanoSeconds);\
    /* restore orig value */                                                    \
    fieldName = origValue;                                                      \
    UTF_VERIFY_NOT_EQUAL2_STRING_MAC(GT_OK, st,                                 \
        "cpssDxChPtpManagerSlaveSerActivate: %s expected NOT to be GT_OK on value [%d]", \
        #fieldName,                                                             \
        (testedField_Value));                                                   \
}
...
*/
UTF_TEST_CASE_MAC(cpssDxChPtpManagerSlaveSerActivate)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        taiNumber = CPSS_DXCH_PTP_TAI_NUMBER_ALL_E;
        fracNanoSeconds = 0x1FFFFFFF; /* 0.125 */
        nanoSeconds = 0xFF;
        st = cpssDxChPtpManagerSlaveSerActivate(devNum,taiNumber,nanoSeconds,fracNanoSeconds);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st,"cpssDxChPtpManagerSlaveSerActivate");

        /*** check not valid values ***/

        FAIL_SPECIFIC_VALUE_NUMERIC_FIELD_cpssDxChPtpManagerSlaveSerActivate(
            taiNumber,
            CPSS_DXCH_PTP_TAI_NUMBER_ALL_E+1);
    ...
    {
        st = cpssDxChPtpManagerSlaveSerActivate(devNum,taiNumber,nanoSeconds,fracNanoSeconds);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_NOT_APPLICABLE_DEVICE, st,"cpssDxChPtpManagerSlaveSerActivate");
    }
}
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssDxChPtpManager)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChPtpManagerPortMacTsQueueSigatureSet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChPtpManagerPortMacTsQueueSigatureGet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChPtpManagerMacEgressTimestampPortQueueEntryRead)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChPtpManagerPhyTodValueGet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChPtpManagerMasterSerActivate)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChPtpManagerSlaveSerActivate)

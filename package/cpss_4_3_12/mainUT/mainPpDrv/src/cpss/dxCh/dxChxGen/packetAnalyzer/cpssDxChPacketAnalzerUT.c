...
#ifndef GM_USED
#define UTF_PA_E (UTF_ALDRIN2_E | UTF_FALCON_E | UTF_ALDRIN_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E) /*WM*/
#else /*GM*/
#define UTF_PA_E (UTF_ALDRIN2_E )
#endif

#else /*BM*/
#define UTF_PA_E (UTF_ALDRIN2_E | UTF_FALCON_E | UTF_ALDRIN_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E)
#endif

#define SIZE_OF_TEST_ARR         27
#define SIZE_OF_TEST_UDS_ARR     6
...
#define FALCON_SKIPPED_TEST\
    ...
    static CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_ENT utPaIronManDefaultValidStages[]={
        CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_TTI_E,
        CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_PCL_E,
        CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_BRIDGE_E,
        CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_ROUTER_E,
    ...
    static CPSS_DXCH_PACKET_ANALYZER_STAGE_INTERFACE_STC  ironManUds[SIZE_OF_TEST_UDS_ARR] =
    {
        {"iml_l2i_ipvx_macro_mt_or_shm","L2I_2_MT_LEARN",5},
        {"iml_txq_macro_pds","pds2tx_desc",3},
        {"iml_txq_macro_sdq","SDQ_2_PSI_PORT_BP",4},
        {"iml_pca_tx_163_macro_eip163he","SH_FIFO_iDEBUG",3},
        {"iml_epcl_ha_macro_shm_arp","SHM_2_ARP_READ_DATA",4},
        {"iml_mng_periph_macro_mng","SDMA_2_RX",1}
    };

    static CPSS_DXCH_PACKET_ANALYZER_STAGE_INTERFACE_STC  harrierUds[SIZE_OF_TEST_UDS_ARR] =
    {
        {"har_tx_macro_i0_cell_req0","tx2pds_fifo_state",0},
        {"har_epi_mac_macro_i0_mif2mti_app","MIF_2_MTI_TX_PKT_32B",3},
        {"har_txqp_macro_sdq","SDQ_2_PSI_PORT_BP",0},
        {"har_pca_163e_macro_i1_sff_lmu_egr","SH_FIFO_iDEBUG",1},
        {"har_pca_brg_macro_i1_pca_brg_app","SDB_PCH_TX",1},
        {"har_pcl_macro_tcam_lookup","PCL_2_TCAM_LOOKUP",0},
    };

    static CPSS_DXCH_PACKET_ANALYZER_STAGE_INTERFACE_STC  ac5xUds[SIZE_OF_TEST_UDS_ARR] =
    {
        {"pnx_txd_macro_cell_req0","tx2pds_fifo_state",0},
        {"pnx_epi_100g_macro_mif2mti_app","MIF_2_MTI_TX_PKT_32B",3},
        {"pnx_txq_macro_qfc0","PFC_MSG",0},
        {"pnx_pca_eip163_macro_eip163hi","crdt_bkwd_tx",4},
        {"pnx_pca_eip163_macro_sff_lmu_egr","SDB_PCH_TX",0},
        {"pnx_pcl_macro_tcam_lookup","PCL_2_TCAM_LOOKUP",0}
    };

    static CPSS_DXCH_PACKET_ANALYZER_STAGE_INTERFACE_STC  ac5pUds[SIZE_OF_TEST_UDS_ARR] =
    {
        {"tile0_tx_0_macro_cell_req0","tx2pds_fifo_state",0},
        {"tile0_hawk_epi_400g_mac_macro_i2_mif2mti_app","MIF_2_MTI_TX_PKT_32B",3},
        {"tile0_hawk_txqs_0_macro_sdq0","SDQ_2_PSI_PORT_BP",0},
        {"tile0_hawk_pca_macro_i0_sff_lmu_ctsu","SH_FIFO_iDEBUG",1},
        {"tile0_hawk_pca_macro_i0_sff_lmu_ctsu","SDB_PCH_TX",0},
        {"tile0_pcl_macro_tcam_lookup","PCL_2_TCAM_LOOKUP",0}
    };

    static CPSS_DXCH_PACKET_ANALYZER_STAGE_INTERFACE_STC  falconUds[SIZE_OF_TEST_UDS_ARR] =
    {
        {"tile0_pipe0_eagle_l2i_ipvx_0_macro_mt_or_shm","L2I_2_MT_LEARN",1},
        {"tile0_pipe0_rx_macro_i0_ia_desc1","rxing2iaing_desc",0},
        {"tile0_pipe0_eagle_l2i_ipvx_0_macro_mt_or_shm","L2I_2_MT_LEARN",1},
        {"tile0_pipe0_eagle_ia_0_macro_rx_desc3","iaegr2rxegr_desc",0},
        {"tile0_pipe0_eagle_egf_0_macro_eft","eft2qag_desc",4},
        {"tile0_pipe1_eagle_pcl_1_macro_tcam_lookup","PCL_2_TCAM_LOOKUP",0}
    };

    static CPSS_DXCH_PACKET_ANALYZER_STAGE_INTERFACE_STC  aldrin2Uds[SIZE_OF_TEST_UDS_ARR] =
    {
        {"l2i_ipvx_desc_or_debug_buses_0_8","l2i2mt_na_bus",2},
        {"mbus_x_u10_buses_1_21","xbar2u_rd",1},
        {"mbus_x_u10_buses_1_21","xbar2u",0},
        {"mbus_x_u10_buses_1_21","u2xbar",2},
        {"mbus_x_u10_buses_1_21","u2xbar_rd",3},
        {"queue2dq_q_main_read_buses_2_7","txq_q2txq_dq_q_main_rd_add",0}
    };

    static CPSS_DXCH_PACKET_ANALYZER_STAGE_INTERFACE_STC  aldrinUds[SIZE_OF_TEST_UDS_ARR] =
    {
        {"txq_queue_flow","txq_ll2eq_desc",1},
        {"txdma0_hdr","TXDMA_2_HA_HEADER",0},
        {"rxdma0_desc_in_1","PORT2MEM",5},
        {"egress_hdr","ERMRK_2_TXFIFO_HEADER_CTRL_BUS",1},
        {"egress_hdr","HA_2_ERMRK_HEADER_CTRL_BUS",0},
        {"egress_hdr","OAM_2_EQ_LOC_UPDATE",2}
    };



static GT_STATUS genericPacketAnalyzerUserDefinedStageAdd
(
    GT_U32      managerId,
    GT_U32      numberOfStagesToMake,
    GT_U32      offset,
    GT_U32      *lastUdsIdPtr
)
{
    ...
    CPSS_DXCH_PACKET_ANALYZER_UDS_ATTRIBUTES_STC         udsAttr[SIZE_OF_TEST_UDS_ARR]={{"uds_Gen"},{"uds 0"},{"uds 1"},{"uds 2"},{"uds 3"},{"uds 4"}};

    if (offset + numberOfStagesToMake > SIZE_OF_TEST_UDS_ARR)
    {
        return GT_BAD_PARAM;
    }
    ...
    switch(paMngDbPtr->devFamily)
    {
     case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
         interfaceAttributes = ironManUds;
        break;
     case CPSS_PP_FAMILY_DXCH_HARRIER_E:
         interfaceAttributes = harrierUds;
        break;
     case CPSS_PP_FAMILY_DXCH_AC5P_E:
         interfaceAttributes = ac5pUds;
        break;
     case CPSS_PP_FAMILY_DXCH_AC5X_E:
         interfaceAttributes = ac5xUds;
        break;
     case CPSS_PP_FAMILY_DXCH_FALCON_E:
         interfaceAttributes = falconUds;
        break;
     case CPSS_PP_FAMILY_DXCH_ALDRIN2_E:
         interfaceAttributes = aldrin2Uds;
        break;
      case CPSS_PP_FAMILY_DXCH_ALDRIN_E:
         interfaceAttributes = aldrinUds;
        break;
    default:
    ...
    for (ii=offset;ii < (offset + numberOfStagesToMake);ii++)
    {
        st = cpssDxChPacketAnalyzerUserDefinedStageAdd(managerId,&udsAttr[ii],&interfaceAttributes[ii],&udsId);
        if (st != GT_OK)
        {
            return st ;
        }
...
)
{
    ...
    cpssOsStrCpy(udsAttr.udsNameArr,"uds_Gen");
    ...
    if (valid == GT_FALSE)
    {
        rc = genericPacketAnalyzerUserDefinedStageAdd(managerId,1,0,&udsId);
        if (rc != GT_OK)
        {
            return rc ;
        }
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        ...
        /*ironMan doesn't has pre e-policer stage */
        if (paMngDbPtr->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
        {
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        cpssOsMemCpy(expValidStages, utPaIronManDefaultValidStages, sizeof(utPaIronManDefaultValidStages));
        ...
        */
        ...
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            numOfValidStagesGet=12;
            expNumOfValidStages=12;
            expValidStages[8] = CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_OAM_E;
            break;
        case CPSS_PP_FAMILY_DXCH_HARRIER_E:
            numOfValidStagesGet=15;
            expNumOfValidStages=15;
        ...
        /*
            ...
            Expected: GT_OK and number of valid stages [11] and valid stages as expected.
        */
        st = genericPacketAnalyzerUserDefinedStageAdd(managerId,3,1,&udsId);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);
        ...
        */
        ...
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            ...
            numOfValidStagesGet=12;
            expNumOfValidStages=12;
            expValidStages[7]= expValidStages[8];
            expValidStages[8]= expValidStages[9];
            expValidStages[9]= expValidStages[10];
            expValidStages[10]= expValidStages[11];
            expValidStages[11]= udsId;
            break;
        case CPSS_PP_FAMILY_DXCH_HARRIER_E:
            numOfApplicStagesGet=19;
            expNumOfApplicStages=19;
...
/*
    ITERATE_DEVICES (UTF_ALDRIN2_E | UTF_FALCON_E | UTF_ALDRIN_E)
    1.1. Call function with udsId [0-4]
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        /*
            ...
            Expected: GT_OK.
        */
        st = genericPacketAnalyzerUserDefinedStageAdd(managerId,5,1,&udsId);
        ...
        */
        ...
        switch(paMngDbPtr->devFamily)
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            ...
            cpssOsStrCpy(interfaceAttributes.instanceId,"iml_eq_mll_macro_eft_desc");
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            cpssOsStrCpy(interfaceAttributes.interfaceId,"pcl2cnc_update");
            cpssOsStrCpy(interfaceAttributes.instanceId,"iml_tcam_tti_pcl_macro_pcl_desc");
            break;
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
        ...
        /* 1.5. Call function with uds interface already set
           Expected: GT_ALREADY_EXIST
        */
        st = genericPacketAnalyzerUserDefinedStageAdd(managerId,1,1,&udsId);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_ALREADY_EXIST, st, devNum, udsId);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        st = genericPacketAnalyzerUserDefinedStageAdd(managerId,2,1,&udsId);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st,"error at genericPacketAnalyzerUserDefinedStageAdd ");
        /*
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
             UTF_VERIFY_EQUAL1_STRING_MAC(188, numOfFieldsGet,
                           "got other numOfFieldsGet than expected: %d", numOfFieldsGet );
            break;
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
         case CPSS_PP_FAMILY_DXCH_AC5X_E:
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
             UTF_VERIFY_EQUAL1_STRING_MAC(142, numOfFieldsGet,
                           "got other numOfFieldsGet than expected: %d", numOfFieldsGet );
            break;
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
         case CPSS_PP_FAMILY_DXCH_AC5X_E:
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
             UTF_VERIFY_EQUAL1_STRING_MAC(22, numOfFieldsGet,
                           "got other numOfFieldsGet than expected: %d", numOfFieldsGet );
            break;
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
         case CPSS_PP_FAMILY_DXCH_AC5X_E:
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE)) {
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            cpssOsStrCpy(instanceId,"iml_eq_mll_macro_eft_desc");
            break;
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
        ...
        */
        ...
        {
          case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            cpssOsStrCpy(instanceId,"iml_eq_mll_macro_mll_eq_desc");
            break;
          case CPSS_PP_FAMILY_DXCH_HARRIER_E:
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE)) {
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
             UTF_VERIFY_EQUAL1_STRING_MAC(193, numOfInterfaces,
                                     "got other numOfInterfaces than expected: %d", numOfInterfaces);
             break;
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
...
/*
    ITERATE_DEVICES (UTF_ALDRIN2_E | UTF_FALCON_E | UTF_ALDRIN_E)
    1.1. Call function with interfaceName  [mll2eq_desc\
                                            eq2eft_desc\
                                            pcl2l2i_desc]
    Expected: GT_OK and same values as set.
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE)) {
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
             cpssOsStrCpy(expInstanceId,"iml_eq_mll_macro_mll_eq_desc");
             break;
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            cpssOsStrCpy(expInstanceId,"iml_eq_mll_macro_eft_desc");
            break;
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            cpssOsStrCpy(expInstanceId,"iml_tcam_tti_pcl_macro_pcl_desc");
            break;
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE)) {
        ...
        */
        ...
        {
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
             UTF_VERIFY_EQUAL1_STRING_MAC( 143 , numOfFields,
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE)) {
        ...
        */
        ...
        {
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            UTF_VERIFY_EQUAL1_STRING_MAC( 188 , numOfFields,
                                         "got other numOfFields than expected: %d", numOfFields);
           break;
        case CPSS_PP_FAMILY_DXCH_HARRIER_E:
        case CPSS_PP_FAMILY_DXCH_AC5X_E:
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        ...
        if (paMngDbPtr->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
        {
            keyStagesArr[0] = CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_TIMESTAMP_E;
        }
        st = cpssDxChPacketAnalyzerLogicalKeyCreate(managerId, keyId, &keyAttr, keyNumOfStages,
                                                    keyStagesArr, keyFieldMode, keyNumOfFields, keyFieldsArr);
        UTF_VERIFY_EQUAL3_PARAM_MAC(GT_OK, st, managerId, devNum, keyId);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        /*
            1.1.1 Call function after select stage that is muxed
            Expected: GT_OK and number of valid stages [10] and valid stages as expected.
        */
        ...
        if (paMngDbPtr->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
        {
            stagesArr[3]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_POLICER_E ;
        }
        ...
        case CPSS_PP_FAMILY_DXCH_ALDRIN_E:
            ...
            break;
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            st = cpssDxChPacketAnalyzerMuxStageUnbind(managerId, CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_FILTER_E);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);
            st = cpssDxChPacketAnalyzerMuxStageBind(managerId,CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_POLICER_E);
            UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, devNum);
       ...
       CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_PCL_E,
        ...
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            expNumOfApplicStages = 16;
            expNumOfValidStages=12;
            expValidStages[5]=CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_POLICER_E;
            expValidStages[6]=CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_MLL_E;
            expValidStages[8]=CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_OAM_E;
            break;
        case CPSS_PP_FAMILY_DXCH_HARRIER_E:
        ...
        */
        ...
        {
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            st = cpssDxChPacketAnalyzerMuxStageBind(managerId,CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_PCL_E);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE)) {
        ...
        */
        ...
        if (paMngDbPtr->devFamily == CPSS_PP_FAMILY_DXCH_ALDRIN_E || paMngDbPtr->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E )
        ...
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            expNumOfValidStages=9;
            for (ii=6;ii<expNumOfValidStages;ii++)
            {
                expValidStages[ii]=expValidStages[ii+1];
            }
            break;
        ...
        */
        ...
        st = genericPacketAnalyzerUserDefinedStageAdd(managerId,1,5,&udsId);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, st, devNum, udsId);
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        */
        ...
        {
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            expStagesArr[0]= CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_FILTER_E;
            expNumOfStages = 1;
            break;
        case CPSS_PP_FAMILY_DXCH_HARRIER_E:
        case CPSS_PP_FAMILY_DXCH_AC5X_E:

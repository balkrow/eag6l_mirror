...
#include <cpss/dxCh/dxChxGen/virtualTcam/cpssDxChVirtualTcamCliUtil.h>
...
GT_STATUS recalculateVtcamInfoClientGroupAndHitNumber
(
    IN GT_U32 vTcamMngId,
...
)
{
    ...
    {
        PRV_UTF_LOG1_MAC(
            "recalculateVtcamInfoClientGroupAndHitNumber vTcamMngId %d not found\n", vTcamMngId);
        return GT_FAIL;
    }

    /* get first devNum iterator */
    st = prvCpssDxChVirtualTcamDbDeviceIteratorGetFirst(vTcamMngDBPtr, &devNum);
    if (st != GT_OK)
    {
        PRV_UTF_LOG1_MAC(
            "recalculateVtcamInfoClientGroupAndHitNumber vTcamMngId %d no devices\n", vTcamMngId);
        return GT_FAIL;
    }

    if (PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
    {
        if ((vTcamInfoPtr->clientGroup > 0) || (vTcamInfoPtr->hitNumber > 1))
        {
            vTcamInfoPtr->clientGroup       = 0;
            vTcamInfoPtr->hitNumber         = 1;
        }
    }
    return GT_OK;
}

GT_STATUS vtcamMngFirstDevNumGet
(
    IN GT_U32 vTcamMngId,
    OUT GT_U8  *devNumPtr
)
{
    ...
    {
        PRV_UTF_LOG1_MAC(
            "vtcamMngFirstDevNumGet vTcamMngId %d not found\n", vTcamMngId);
        return GT_FAIL;
    }

    /* get first devNum iterator */
    st = prvCpssDxChVirtualTcamDbDeviceIteratorGetFirst(vTcamMngDBPtr, devNumPtr);
    if (st != GT_OK)
    {
        PRV_UTF_LOG1_MAC(
            "vtcamMngFirstDevNumGet vTcamMngId %d no devices\n", vTcamMngId);
        return GT_FAIL;
    }
...
)
{
    ...
    isSip7 = 0;
    rc = vtcamMngFirstDevNumGet(vTcamMngId, &devNum);
    if ((rc == GT_OK) && PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        isSip7 = 1;
    }
    return isSip7;
...
CPSS_DXCH_PCL_RULE_FORMAT_TYPE_ENT vtcamMngIpclRuleFormatBySizeGet
(
    IN GT_U32 vTcamMngId,
...
)
{
    ...
    switch(ruleSize)
    {
        ...
        case CPSS_DXCH_VIRTUAL_TCAM_RULE_SIZE_10_B_E:
            return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_10_E;
        case CPSS_DXCH_VIRTUAL_TCAM_RULE_SIZE_20_B_E:
            return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_20_E;
        case CPSS_DXCH_VIRTUAL_TCAM_RULE_SIZE_30_B_E:
            if (isSip7)
            {
                return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_30_E;
            }
            return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_STD_NOT_IP_E;
        case CPSS_DXCH_VIRTUAL_TCAM_RULE_SIZE_40_B_E:
            return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_40_E;
            break;
        case CPSS_DXCH_VIRTUAL_TCAM_RULE_SIZE_50_B_E:
            return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_50_E;
        case CPSS_DXCH_VIRTUAL_TCAM_RULE_SIZE_60_B_E:
            if (isSip7)
            {
                return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_60_E;
            }
            return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_EXT_NOT_IPV6_E;
        case CPSS_DXCH_VIRTUAL_TCAM_RULE_SIZE_80_B_E:
            if (isSip7)
            {
                return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_80_E;
            }
            return CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_ULTRA_IPV6_PORT_VLAN_QOS_E;
    }
    return GT_OK;
}
...
)
{
    ...
    PRV_UTF_LOG3_MAC(
        "cpssDxChVirtualTcamSpaceLayoutGet vTcamId %d segments %d unitsPerRule %d\n",
...
)
{
    ...
    *returnCodePtr = GT_NOT_READY;
    ...
    cpssOsMemCpy(&vTcamInfo, vTcamInfoPtr, sizeof(vTcamInfo));
    st = recalculateVtcamInfoClientGroupAndHitNumber(
        vTcamMngId, &vTcamInfo);
    if (st != GT_OK)
    {
        UTF_VERIFY_EQUAL0_STRING_MAC(
            GT_OK, st, "recalculateVtcamInfoClientGroupAndHitNumber failed");
    }
...
)
{
    ...
    if ((vTcamInfo.clientGroup == CG_PCL) || (vTcamInfo.clientGroup == CG_PCL_TCAM1))
    {
        ...
        TcamRuleType.rule.pcl.ruleFormat =
            vtcamMngIpclRuleFormatBySizeGet(vTcamMngId, vTcamInfo.ruleSize);
    ...
    CPSS_DXCH_VIRTUAL_TCAM_RULE_ATTRIBUTES_STC  *ruleAttributesPtr)
{
    ...
    if (tcamRuleType.ruleType == CPSS_DXCH_VIRTUAL_TCAM_RULE_TYPE_PCL_E)
    {
        ...
        if (vtcamMngFirstDevIsSip7(vTcamMngId))
        {
            tcamRuleType.rule.pcl.ruleFormat =
                (vTcamInfo.ruleSize == CPSS_DXCH_VIRTUAL_TCAM_RULE_SIZE_80_B_E) ?
...
)
{
    ...
    RuleData_forRead.rule.pcl.actionPtr     = &pclAction_forRead;
    pclAction_forRead.egressPolicy = CPSS_PCL_DIRECTION_INGRESS_E;
    RuleData_forRead.rule.pcl.maskPtr       = &mask_forRead;
    RuleData_forRead.rule.pcl.patternPtr    = &pattern_forRead;
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_checkValidInvalidLogicalIndex)
{
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        {
            if (PRV_CPSS_SIP_6_30_CHECK_MAC(devListArr[0]) == GT_FALSE)
            {
            ...
            {
                vTcamInfo.clientGroup          = 0; /* group0 only supported */
                vTcamInfo.hitNumber            = 1;
                profileIndexMask = 0x7F;
            }
        }
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_decreaseVtcamSizeByResizing)
{
    ...
    CPSS_TBD_BOOKMARK
        ...
        */
        ...
        TcamRuleType.rule.pcl.ruleFormat =
            (vtcamMngFirstDevIsSip7(vTcamMngId))
...
static VT_SEQUENCE ironman_sequence[] =
{
    {VT_KEEP_FREE_BLOCKS,   99, CG_G0_H1,  RS_30,    0, GT_OK, (char*)&hawk_sequence_keep_free_blocks},
    {VT_CREATE,    5, CG_G0_H1,  RS_20,  252, GT_OK, NULL},
    {VT_CREATE,    6, CG_G0_H1,  RS_30,  250, GT_OK, NULL},
    {VT_COMPLETE,  7, CG_G0_H1,  RS_NONE,  0, GT_OK, NULL}, /* 342 */
    {VT_CREATE,    8, CG_PCL,    RS_20,  252, GT_OK, NULL},
    {VT_CREATE,    9, CG_PCL,    RS_40,  500, GT_OK, NULL},
    {VT_CREATE,   10, CG_PCL,    RS_50,  250, GT_OK, NULL},
    {VT_CREATE,   11, CG_PCL,    RS_10, 1050, GT_OK, NULL},
    ...
    {VT_CREATE,   15, CG_PCL,    RS_10,  207, GT_OK, NULL},
    {VT_COMPLETE, 16, CG_PCL,    RS_NONE,  0, GT_OK, NULL},
    {VT_CREATE,   50, CG_G0_H1,  RS_10,    1, GT_FULL, NULL},
    {VT_CREATE,   51, CG_PCL,    RS_10,    1, GT_FULL, NULL},
    {VT_REMOVE,    6, CG_NONE,   RS_NONE,  0, GT_OK, NULL},
    {VT_REMOVE,    8, CG_NONE,   RS_NONE,  0, GT_OK, NULL},
    {VT_REMOVE,   10, CG_NONE,   RS_NONE,  0, GT_OK, NULL},
    {VT_REMOVE,   13, CG_NONE,   RS_NONE,  0, GT_OK, NULL},
    {VT_REMOVE,   15, CG_NONE,   RS_NONE,  0, GT_OK, NULL},
    {VT_CREATE,   40, CG_G0_H1,  RS_30,  250, GT_OK, NULL},
    {VT_CREATE,   31, CG_PCL,    RS_50,  225, GT_OK, NULL}, /*RS_40*/ /* no defrag */
    {VT_CREATE,   32, CG_PCL,    RS_50,   25, GT_OK, NULL}, /* amount was 100 *//* no defrag */
    {VT_CREATE,   34, CG_PCL,    RS_30,  150, GT_OK, NULL},
    {VT_COMPLETE, 41, CG_G0_H1,  RS_NONE,  0, GT_OK, NULL}, /* (47 * (6 + 6)) */
    {VT_COMPLETE, 35, CG_PCL,    RS_NONE,  0, GT_OK, NULL},
    {VT_CREATE,   50, CG_G0_H1,  RS_10,    1, GT_FULL, NULL},
    {VT_CREATE,   51, CG_PCL,    RS_10,    1, GT_FULL, NULL},
};
...
static VT_SEQUENCE ironman_sequence_memoryAvailabilityCheck_fromFullWithUpdates[] =
{
    {VT_DECREASE,    5, CG_G0_H1,  RS_20,   /*minus*/  140, GT_OK, NULL},
    {VT_DECREASE,    6, CG_G0_H1,  RS_30,   /*minus*/   94, GT_OK, NULL},
    {VT_DECREASE,    7, CG_G0_H1,  RS_10,   /*minus*/   33, GT_OK, NULL},
    ...
    {VT_CREATE,    50, CG_G0_H1,   RS_50,               100, GT_OK, NULL},
    {VT_CREATE,    52, CG_G0_H1,   RS_10,               111, GT_OK, NULL},
    ...
    {VT_CREATE,    56, CG_G0_H1,   RS_10,                 1, GT_FULL, NULL},
...
)
{
    ...
    for (vTcamId1 = 0; (vTcamId1 < maxVTcamId); vTcamId1++)
    {
        ...
        if ((info.clientGroup != clientGroup) || (info.hitNumber != hitNumber)) continue;
        st = cpssDxChVirtualTcamUsageGet(
...
)
{
    ...
    if (PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
    {
        sip6_10_GetUsedBlockRowsAndFree10byteRulesPlaces(
            vTcamMngId, clientGroup, hitNumber, &neededBlockRows, &unused_10_space);
        /* results */
...
)
{
    ...
    GT_U32                                rulesAmount;
    CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_TYPE_ENT saveUnmovableFlag;
    ...
    vTcamInfoPtr->ruleSize          = (GT_U32)sequencePtr[idx].ruleSize;
    vTcamInfoPtr->guaranteedNumOfRules = sequencePtr[idx].rulesAmount;
    st = recalculateVtcamInfoClientGroupAndHitNumber(
        vTcamMngId, vTcamInfoPtr);
    if (st != GT_OK)
    {
        return GT_FAIL;
    }
    ...
    switch (sequencePtr[idx].operation)
    {
        ...
        case VT_CREATE_UNMOVABLE:
            ...
            PRV_UTF_LOG4_MAC(
                ...
                (sequencePtr[idx].ruleSize + 1),
                sequencePtr[idx].rulesAmount);
            vTcamInfoPtr->tcamSpaceUnmovable = CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_CPSS_ALLOCATED_E;
            st = cpssDxChVirtualTcamCreate(vTcamMngId, vTcamId, vTcamInfoPtr);
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_autoresize)
{
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        if(GT_OK == st)
        {
            ...
            pclActionGet.egressPolicy = CPSS_PCL_DIRECTION_INGRESS_E;
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_fragmentation)
{
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        switch (utfFamilyBit)
        {
            ...
            case UTF_AAS_E:
                sequencePtr = ironman_sequence;
                sequenceSize = sizeof(ironman_sequence) / sizeof(ironman_sequence[0]);
                break;
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_column_fragmentation_one_block)
{
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        vTcamInfo.ruleSize    = (GT_U32)RS_30;
        if (PRV_CPSS_SIP_6_30_CHECK_MAC(devListArr[0]) == GT_FALSE)
        {
            vTcamInfo.clientGroup          = CG_TTI; /* TTI */
            vTcamInfo.hitNumber            = 0;
...
)
{
    ...
    CPSS_DXCH_PCL_RULE_FORMAT_TYPE_ENT      pclRuleFormatSip5[] =
    {
    ...
    CPSS_DXCH_PCL_RULE_FORMAT_TYPE_ENT          pclRuleFormatSip7[] =
    {
        CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_10_E,
        CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_20_E,
        CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_30_E,
    ...
    pclRuleFormat =
        (vtcamMngFirstDevIsSip7(vTcamMngId))
            ? pclRuleFormatSip7 : pclRuleFormatSip5;
...
#define TTI_RULE_SIZE(vtcam_rule_size) (((vtcam_rule_size) == RS_NONE) ? CPSS_DXCH_TTI_RULE_UDB_10_E : (ttiRuleFormat[(vtcam_rule_size) % 3]))
    ...
    if (sequencePtr[idx].clientGroup == CG_G0_H1)
    {/* override for ironman */
        tcamRuleType.ruleType = CPSS_DXCH_VIRTUAL_TCAM_RULE_TYPE_TTI_E;
        tcamRuleType.rule.tti.ruleFormat = TTI_RULE_SIZE(sequencePtr[idx].ruleSize);
        UNIQUE_TTI_RULE_SET_MAC(&tcamRuleType, ttiPatternPtr, ruleId);
        ruleData.rule.tti.actionPtr     = ttiActionPtr;
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        for (iteration = 0; iteration < 100; iteration++)
        {
            ...
            if ((sequencePtr[vTcamIdx].clientGroup == CG_PCL) || (sequencePtr[vTcamIdx].clientGroup == CG_PCL_TCAM1))
            {
                ...
                tcamRuleType.rule.pcl.ruleFormat =
                    vtcamMngIpclRuleFormatBySizeGet(
                        vTcamMngId, (GT_U32)sequencePtr[vTcamIdx].ruleSize);
            }
            else
            {
                tcamRuleType.ruleType = CPSS_DXCH_VIRTUAL_TCAM_RULE_TYPE_TTI_E;
        ...
        if (vTcamAdded)
        {
            ...
            for (ruleIdx = 0, loopCounter = 0; ruleIdx < 100 && loopCounter < 200; loopCounter++)
            {
                    ...
                    (sequencePtr[vTcamIdx].rc == GT_OK))
                {
                    ...
                    /* for ironman TTI - Group==0, hit==1 */
                    if ((vTcamInfo.clientGroup == CG_TTI) || (vTcamInfo.hitNumber != 0))
                    {
                        TcamRuleType.ruleType            = CPSS_DXCH_VIRTUAL_TCAM_RULE_TYPE_TTI_E;
            ...
            for (idx = 0; idx < sequenceSize; idx++)
            {
                ...
                else
                {
                    ...
                    default:
                        ...
                        tcamRuleType.ruleType = CPSS_DXCH_VIRTUAL_TCAM_RULE_TYPE_PCL_E;
                        tcamRuleType.rule.pcl.ruleFormat =
                            (dstSequencePtr[idx].vTcamSeqId == 9) ?
                            CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_40_E :
...
#define FILL_MEMORY_AVAILABILITY_INFO_MAC(vTcamMngId,memCheckPtr,sequencePtr)  \
    ...
    {                                                           \
        if ((sequencePtr)->clientGroup & (~ 0x0F))                                         \
        {                                                                                  \
            (memCheckPtr)->vTcamInfo.clientGroup = ((sequencePtr)->clientGroup & 0x0F);    \
            (memCheckPtr)->vTcamInfo.hitNumber = ((sequencePtr)->clientGroup >> 4);        \
        }                                                                                  \
        else                                                                               \
        {                                                                                  \
        ...
        (memCheckPtr)->vTcamInfo.ruleSize = (GT_U32)(sequencePtr)->ruleSize;\
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_memoryAvailabilityCheck_fromEmptyAndGrow)
{
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        switch (utfFamilyBit)
        {
            ...
            case UTF_AAS_E:
            case UTF_IRONMAN_L_E:
                origSequencePtr = ironman_sequence;
                sequenceSize = sizeof(ironman_sequence) / sizeof(ironman_sequence[0]);
                break;
...
)
{
    ...
    {
        sip6_10_GetUsedBlockRowsAndFree10byteRulesPlaces(
            vTcamMngId, 0 /*PCL clientGroup*/, 0/*hitNumber*/, &pclUsedRows, &pclFree10byteRulePlaces);
        sip6_10_GetUsedBlockRowsAndFree10byteRulesPlaces(
            vTcamMngId, 1 /*TTI clientGroup*/, 0/*hitNumber*/, &ttiUsedRows, &ttiFree10byteRulePlaces);
        {
            /* for Ironman */
            GT_U32 ttiFree10byteRulePlaces_g0h1;
            sip6_10_GetUsedBlockRowsAndFree10byteRulesPlaces(
                vTcamMngId, 1 /*TTI clientGroup*/, 0/*hitNumber*/, &ttiUsedRows, &ttiFree10byteRulePlaces_g0h1);
            ttiFree10byteRulePlaces += ttiFree10byteRulePlaces_g0h1;
        }
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_createAndUpdate_fromFullWithUpdates)
{
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        switch (utfFamilyBit)
        {
            ...
            case UTF_AAS_E:
            case UTF_IRONMAN_L_E:
                sequenceArrPtr = &ironman_sequence_memoryAvailabilityCheck_fromFullWithUpdates[0];
                fillTable_sequenceArrPtr = ironman_sequence;
                break;
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_releaseBlocksCheck)
{
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        if (PRV_CPSS_SIP_6_30_CHECK_MAC(devListArr[0]))
        {
            vTcamInfo.clientGroup = 0;
            vTcamInfo.hitNumber = 1;
        }
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_bc2_sequence_creation_order_ok)
{
    ...
    notAppFamilyBmp |= UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E;
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_DevListAdd_toExistingDeviceWithRules)
{
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        /* check error when try add the first device again */
        st = cpssDxChVirtualTcamManagerDevListAdd(vTcamMngId,single_devListArr,1);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_ALREADY_EXIST, st, "cpssDxChVirtualTcamManagerDevListAdd failed\n");
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_priority_autoresize_full_tcam)
{
    ...
    for (utfFamilyBit = (UTF_PP_FAMILY_BIT__END_OF_DEVICES___E - 1); utfFamilyBit != UTF_NONE_FAMILY_E; utfFamilyBit >>= 1)
    {
        ...
        else if (PRV_CPSS_PP_MAC(devListArr[0])->devFamily == CPSS_PP_FAMILY_DXCH_ALDRIN2_E)
        {
            ...
            st = cpssEventDeviceMaskSet(devListArr[0],
                                   CPSS_PP_PORT_MMPCS_SIGNAL_DETECT_CHANGE_E,
                                   CPSS_EVENT_MASK_E);
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cpssEventDeviceMaskSet failed!\n");
...
)
{
    ...
    /* create vTcam 100 occupying all blocks beside two to TTI */
    vTcamInfo.ruleSize    = (GT_U32)RS_60;
    internal_ut_cpssDxChVirtualTcamTotalRulesAllowedPerDevGet(
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_priority_grouped_fill_3072X60B_time_measure)
{
    ...
    /* provide time to finish loging of previouse test */
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        else if (PRV_CPSS_PP_MAC(dev)->devFamily == CPSS_PP_FAMILY_DXCH_AC5_E)
        {
            ...
            if (numOfTestedDevices == 2)
            {
                /* AC5 Back To Back board. Timing are for first device only,
                   skip second device. */
                break;
            }
        }
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_manager_per_port_group_ret_code)
{
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        st = cpssDxChVirtualTcamManagerPortGroupListAdd(
            vTcamMngId1, &devPortGroupsBmp, 1);
        UTF_VERIFY_EQUAL0_STRING_MAC(
            GT_ALREADY_EXIST, st, "cpssDxChVirtualTcamManagerPortGroupListAdd wrong RC\n");
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_80B_and_priority_autoresize_40B)
{
    ...
    appFamilyBmp = (UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E);
...
/*CPSS-14472*/
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_priority_autoresize_decrease_6_10x8)
{
    GT_STATUS                                     st   = GT_OK;
    GT_U8                                         dev;
    GT_U32                                        idx;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* total cleanup by VTCAM DB */
        st = cliWrapCpssDxChVirtualTcamCleanupAll();
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamCleanupAll failed\n");

        st = cliWrapCpssDxChVirtualTcamManagerCreate(vTcamMngId, 0/*haSupportEnabled*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamManagerCreate failed\n");

        st = cliWrapCpssDxChVirtualTcamManagerDevAdd(vTcamMngId, dev);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamManagerDevAdd failed\n");

        st = cliWrapCpssDxChVirtualTcamCreate(
            vTcamMngId, vTcamId, 0/*clientGroup*/, 0/*hitNumber*/,
            "std"/*ruleSize*/, 0/*tcamSpaceUnmovable*/, 1/*autoResize*/,
             0/*guaranteedNumOfRules*/, "priority"/*ruleAdditionMethod*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamCreate failed\n");

        /* 6 high-priority(1) rules ids 1000-1005 - never deleted */
        st = cliWrapCpssDxChVirtualTcamRuleWrite(
            vTcamMngId, vTcamId, 6/*numOfRules*/, 1000/*ruleIdBase*/, 1/*ruleIdInc*/,
            1/*priorityBase*/, 0/*priorityInc*/, "pcl"/*ruleType*/,
            1000/*ruleStampBase*/, 1/*ruleStampInc*/, 1000,/*actionStampBase*/ 1/*actionStampInc*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleWrite failed\n");

        /* 80 low-priority(10) rules ids 0-79 - will be deleted */
        st = cliWrapCpssDxChVirtualTcamRuleWrite(
            vTcamMngId, vTcamId, 80/*numOfRules*/, 0/*ruleIdBase*/, 1/*ruleIdInc*/,
            10/*priorityBase*/, 0/*priorityInc*/, "pcl"/*ruleType*/,
            0/*ruleStampBase*/, 1/*ruleStampInc*/, 0,/*actionStampBase*/ 1/*actionStampInc*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleWrite failed\n");

        for (idx = 0; (idx < 10); idx++)
        {
            /* delete rule7 from each 8 */
            st = cliWrapCpssDxChVirtualTcamRuleDelete(
                vTcamMngId, vTcamId, 1/*numOfRules*/, ((idx * 8) + 7)/*ruleIdBase*/, 1/*ruleIdInc*/);
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleDelete failed\n");

            /* delete rules0-6 from each 8 */
            st = cliWrapCpssDxChVirtualTcamRuleDelete(
                vTcamMngId, vTcamId, 7/*numOfRules*/, (idx * 8)/*ruleIdBase*/, 1/*ruleIdInc*/);
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleDelete failed\n");
        }

        /* full cleanup of VTCAM Manager - deletes rules, vTCAMs, devices */
        st = cliWrapCpssDxChVirtualTcamCleanupVtmgrRemove(vTcamMngId);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamCleanupVtmgrRemove failed\n");
    }
}

UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_priority_decrease_by_one)
{
    GT_STATUS                                     st   = GT_OK;
    GT_U8                                         dev;
    GT_U32                                        idx;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* add 1000 rules - causing autoresize */
        st = cliWrapCpssDxChVirtualTcamRuleWrite(
            vTcamMngId, vTcamId, 1000/*numOfRules*/, 1/*ruleIdBase*/, 1/*ruleIdInc*/,
            1/*priorityBase*/, 1/*priorityInc*/, "pcl"/*ruleType*/,
            1/*ruleStampBase*/, 1/*ruleStampInc*/, 1,/*actionStampBase*/ 1/*actionStampInc*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleWrite failed\n");

        /* disable autoresize */
        st = cpssDxChVirtualTcamAutoResizeEnable(
            vTcamMngId, vTcamId, GT_FALSE /*enable*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cpssDxChVirtualTcamAutoResizeEnable failed\n");
        ...
        st = cpssDxChVirtualTcamResize(
            vTcamMngId, vTcamId, 0/*rulePlace*/,
            GT_FALSE/*toInsert*/, vTcamUsage.rulesFree/*sizeInRules*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cpssDxChVirtualTcamResize failed\n");

        /* get allocation granularity */
        vTcamInfoPtr = prvCpssDxChVirtualTcamDbVTcamGet(vTcamMngId,vTcamId);
        UTF_VERIFY_NOT_EQUAL0_STRING_MAC(
            (GT_UINTPTR)NULL, (GT_UINTPTR)vTcamInfoPtr,
            "prvCpssDxChVirtualTcamDbVTcamGet failed\n");

        rulesAmountGranularity =
            prvCpssDxChVirtualTcamDbSegmentTableVTcamRuleAmountGranularity(
                vTcamInfoPtr->tcamSegCfgPtr, vTcamInfoPtr->tcamInfo.ruleSize);

        /* delete rules an decrease space */
        for (idx = 0; (idx < 1000); idx++)
        {
            st = cpssDxChVirtualTcamRuleDelete(
                vTcamMngId, vTcamId, (idx + 1)/*ruleId*/);
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cpssDxChVirtualTcamRuleDelete failed\n");

            st = cpssDxChVirtualTcamResize(
                vTcamMngId, vTcamId, 0/*rulePlace*/,
                GT_FALSE/*toInsert*/, 1/*sizeInRules*/);
            UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cpssDxChVirtualTcamResize failed\n");
            ...
            if (vTcamUsage.rulesFree > rulesAmountGranularity)
            {
                UTF_VERIFY_EQUAL2_STRING_MAC(
                    1, 0, "rulesFree[%d] > rulesAmountGranularity[%d]\n",
                    vTcamUsage.rulesFree, rulesAmountGranularity);
            }
        }
        st = cpssDxChVirtualTcamUsageGet(
            vTcamMngId, vTcamId, &vTcamUsage);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cpssDxChVirtualTcamUsageGet failed\n");
        PRV_UTF_LOG3_MAC(
            "rulesUsed %d rulesFree %d rulesAmountGranularity %d\n",
            vTcamUsage.rulesUsed, vTcamUsage.rulesFree, rulesAmountGranularity);
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_unmovable_app_allocated)
{
    GT_STATUS                                     st   = GT_OK;
    GT_U8                                         dev;
    GT_U32                                        vTcamMngId = 1;
    GT_U32                                        vTcamId0 = 2;
    GT_U32                                        vTcamId1 = 5;
    CPSS_DXCH_VIRTUAL_TCAM_SPACE_SEGMENT_STC      seg0 = {0, 10, 0x0FFF};
    CPSS_DXCH_VIRTUAL_TCAM_SPACE_SEGMENT_STC      seg0Get;
    CPSS_DXCH_VIRTUAL_TCAM_SPACE_SEGMENT_STC      seg1 = {256, 20, 0x003F};
    CPSS_DXCH_VIRTUAL_TCAM_SPACE_SEGMENT_STC      seg1Get;
    GT_U32                                        numOfSegments;

    /* prepare iterator for go over all active devices */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, (UTF_LION2_E | UTF_XCAT3_E | UTF_AC5_E | UTF_IRONMAN_L_E | UTF_AAS_E));
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* application defined allocation */
        cliWrapCpssDxChVirtualTcamAppAllocationSet(
            0/*entyIdx*/, seg0.startRowIndex, seg0.numOfRows, seg0.columnsBitmap);
        st = cliWrapCpssDxChVirtualTcamCreate(
            vTcamMngId, vTcamId0, 1/*clientGroup*/, 0/*hitNumber*/,
            "std"/*ruleSize*/, CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_APP_ALLOCATED_E/*tcamSpaceUnmovable*/,
            0/*autoResize*/, 0/*guaranteedNumOfRules*/, "index"/*ruleAdditionMethod*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamCreate failed\n");

        st = cpssDxChVirtualTcamSpaceLayoutGet(
            vTcamMngId, vTcamId0, 1/*maxNumOfSegments*/,
            &numOfSegments, &seg0Get);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cpssDxChVirtualTcamSpaceLayoutGet failed\n");
        UTF_VERIFY_EQUAL0_STRING_MAC(seg0.startRowIndex, seg0Get.startRowIndex, "startRowIndex\n");
        UTF_VERIFY_EQUAL0_STRING_MAC(seg0.numOfRows, seg0Get.numOfRows, "numOfRows\n");
        UTF_VERIFY_EQUAL0_STRING_MAC(seg0.columnsBitmap, seg0Get.columnsBitmap, "columnsBitmap\n");

        /* fill by 40 rules */
        st = cliWrapCpssDxChVirtualTcamRuleWrite(
            vTcamMngId, vTcamId0, 40/*numOfRules*/, 0/*ruleIdBase*/, 1/*ruleIdInc*/,
            0/*priorityBase*/, 1/*priorityInc*/, "pcl"/*ruleType*/,
            100/*ruleStampBase*/, 1/*ruleStampInc*/, 200,/*actionStampBase*/ 1/*actionStampInc*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleWrite failed\n");

        /* check 40 rules */
        st = cliWrapCpssDxChVirtualTcamRuleCheck(
            vTcamMngId, vTcamId0, 40/*numOfRules*/, 0/*ruleIdBase*/, 1/*ruleIdInc*/, "pcl"/*ruleType*/,
           100/*ruleStampBase*/, 1/*ruleStampInc*/, 200,/*actionStampBase*/ 1/*actionStampInc*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleCheck failed\n");

        /* application defined allocation */
        cliWrapCpssDxChVirtualTcamAppAllocationSet(
            0/*entyIdx*/, seg1.startRowIndex, seg1.numOfRows, seg1.columnsBitmap);
        st = cliWrapCpssDxChVirtualTcamCreate(
            vTcamMngId, vTcamId1, 1/*clientGroup*/, 0/*hitNumber*/,
            "std"/*ruleSize*/, CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_APP_ALLOCATED_E/*tcamSpaceUnmovable*/,
            0/*autoResize*/, 0/*guaranteedNumOfRules*/, "index"/*ruleAdditionMethod*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamCreate failed\n");

        st = cpssDxChVirtualTcamSpaceLayoutGet(
            vTcamMngId, vTcamId1, 1/*maxNumOfSegments*/,
            &numOfSegments, &seg1Get);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cpssDxChVirtualTcamSpaceLayoutGet failed\n");
        UTF_VERIFY_EQUAL0_STRING_MAC(seg1.startRowIndex, seg1Get.startRowIndex, "startRowIndex\n");
        UTF_VERIFY_EQUAL0_STRING_MAC(seg1.numOfRows, seg1Get.numOfRows, "numOfRows\n");
        UTF_VERIFY_EQUAL0_STRING_MAC(seg1.columnsBitmap, seg1Get.columnsBitmap, "columnsBitmap\n");

        /* fill by 40 rules */
        st = cliWrapCpssDxChVirtualTcamRuleWrite(
            vTcamMngId, vTcamId1, 40/*numOfRules*/, 0/*ruleIdBase*/, 1/*ruleIdInc*/,
            0/*priorityBase*/, 1/*priorityInc*/, "pcl"/*ruleType*/,
            400/*ruleStampBase*/, 1/*ruleStampInc*/, 500,/*actionStampBase*/ 1/*actionStampInc*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleWrite failed\n");

        /* check 40 rules */
        st = cliWrapCpssDxChVirtualTcamRuleCheck(
            vTcamMngId, vTcamId1, 40/*numOfRules*/, 0/*ruleIdBase*/, 1/*ruleIdInc*/, "pcl"/*ruleType*/,
            400/*ruleStampBase*/, 1/*ruleStampInc*/, 500,/*actionStampBase*/ 1/*actionStampInc*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleCheck failed\n");
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_unmovable_app_allocated_ha_with_rules)
{
    GT_STATUS                                     st   = GT_OK;
    GT_U8                                         dev;
    GT_U32                                        vTcamMngId = 1;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        st = cliWrapCpssDxChVirtualTcamManagerCreate(vTcamMngId, 1/*haSupportEnabled*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamManagerCreate failed\n");
        ...
        /* vTCAMs created, rules written - erase DB and simulate HA */

        /* total cleanup by VTCAM DB - no changes in HW */
        st = prvCpssDxChVirtualTcamLibraryShutdown();
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "prvCpssDxChVirtualTcamLibraryShutdown failed\n");

        /* all reply action on CATCHUP stage */
        cpssOsMemSet(&systemRecoveryInfo, 0, sizeof(systemRecoveryInfo));
        systemRecoveryInfo.systemRecoveryMode.ha2phasesInitPhase = CPSS_SYSTEM_RECOVERY_HA_2_PHASES_INIT_NONE_E;
        systemRecoveryInfo.systemRecoveryMode.haReadWriteState = CPSS_SYSTEM_RECOVERY_HA_STATE_READ_ENABLE_WRITE_DISABLE_E;
        ...
        cpssOsMemSet(&systemRecoveryInfo, 0, sizeof(systemRecoveryInfo));
        systemRecoveryInfo.systemRecoveryMode.ha2phasesInitPhase = CPSS_SYSTEM_RECOVERY_HA_2_PHASES_INIT_PHASE1_E;
        systemRecoveryInfo.systemRecoveryMode.haReadWriteState = CPSS_SYSTEM_RECOVERY_HA_STATE_READ_ENABLE_WRITE_ENABLE_E;
        systemRecoveryInfo.systemRecoveryProcess = CPSS_SYSTEM_RECOVERY_PROCESS_HA_E;
        systemRecoveryInfo.systemRecoveryState   = CPSS_SYSTEM_RECOVERY_COMPLETION_STATE_E;
        prvCpssSystemRecoveryStateUpdate(&systemRecoveryInfo);

        st = prvCpssDxChVirtualTcamCatchupForHa();
        ...
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "prvCpssDxChVirtualTcamCatchupForHa failed\n");
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_unmovable_app_allocated_ha_no_rules)
{
    GT_STATUS                                     st   = GT_OK;
    GT_U8                                         dev;
    GT_U32                                        vTcamMngId = 1;
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_unmovable_app_allocated_fill_tcam_no_rules)
{
    GT_STATUS                                     st   = GT_OK;
    GT_U8                                         dev;
    GT_U32                                        vTcamMngId = 1;
    GT_U32                                        vTcamId;
    CPSS_DXCH_VIRTUAL_TCAM_SPACE_SEGMENT_STC      seg[2];
    GT_U32                                        numOfFloors;
    GT_U32                                        floor;
    PRV_CPSS_DXCH_VIRTUAL_TCAM_MNG_STC            *vTcamMngDBPtr;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        vTcamMngDBPtr = prvCpssDxChVirtualTcamDbVTcamMngGet(vTcamMngId);
        numOfFloors =
            vTcamMngDBPtr->tcamSegCfg.tcamRowsAmount
            / vTcamMngDBPtr->tcamSegCfg.lookupRowAlignment;

        for (floor = 0; (floor < numOfFloors); floor++)
        {
            seg[0].numOfRows     = vTcamMngDBPtr->tcamSegCfg.lookupRowAlignment;
            seg[0].columnsBitmap = 0x003F;
            seg[0].startRowIndex = floor * vTcamMngDBPtr->tcamSegCfg.lookupRowAlignment;
            seg[1].numOfRows     = vTcamMngDBPtr->tcamSegCfg.lookupRowAlignment;
            seg[1].columnsBitmap = 0x0FC0;
            seg[1].startRowIndex = floor * vTcamMngDBPtr->tcamSegCfg.lookupRowAlignment;
            /* application defined allocation */
            cliWrapCpssDxChVirtualTcamAppAllocationSet( /*reset*/
                0xFFFFFFFF/*entyIdx*/, 0, 0, 0);
            cliWrapCpssDxChVirtualTcamAppAllocationSet(
                0/*entyIdx*/, seg[0].startRowIndex, seg[0].numOfRows, seg[0].columnsBitmap);
            vTcamId = 2 * floor;
            st = cliWrapCpssDxChVirtualTcamCreate(
                vTcamMngId, vTcamId, 0/*clientGroup*/, 0/*hitNumber*/,
                "std"/*ruleSize*/, CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_APP_ALLOCATED_E/*tcamSpaceUnmovable*/,
            ...
            cliWrapCpssDxChVirtualTcamAppAllocationSet(
                0/*entyIdx*/, seg[1].startRowIndex, seg[1].numOfRows, seg[1].columnsBitmap);
            vTcamId = (2 * floor) + 1;
            st = cliWrapCpssDxChVirtualTcamCreate(
                vTcamMngId, vTcamId, 0/*clientGroup*/, 0/*hitNumber*/,
                "std"/*ruleSize*/, CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_APP_ALLOCATED_E/*tcamSpaceUnmovable*/,
        ...
        for (floor = 0; (floor < numOfFloors); floor++)
        {
            ...
            cliWrapCpssDxChVirtualTcamAppAllocationSet(
                0/*entyIdx*/, seg[0].startRowIndex, seg[0].numOfRows, seg[0].columnsBitmap);
            cliWrapCpssDxChVirtualTcamAppAllocationSet(
                1/*entyIdx*/, seg[1].startRowIndex, seg[1].numOfRows, seg[1].columnsBitmap);
            vTcamId = floor;
            st = cliWrapCpssDxChVirtualTcamCreate(
                vTcamMngId, vTcamId, 0/*clientGroup*/, 0/*hitNumber*/,
                "std"/*ruleSize*/, CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_APP_ALLOCATED_E/*tcamSpaceUnmovable*/,
...
static GT_U32 cpssDxChVirtualTcam_80bytes_autoresize_repeat_num = 1;
int cpssDxChVirtualTcam_80bytes_autoresize_repeat_num_set(GT_U32 num)
{
    cpssDxChVirtualTcam_80bytes_autoresize_repeat_num = num;
    return 0;
}
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_80bytes_autoresize)
{
    GT_STATUS                                     st   = GT_OK;
    GT_U8                                         dev;
    GT_U32                                        vTcamMngId = 1;
    ...
    cpssOsMemSet(&action, 0, sizeof(action));
    action.pktCmd = CPSS_PACKET_CMD_FORWARD_E;
    action.egressPolicy = CPSS_PCL_DIRECTION_INGRESS_E;
    action.mirror.cpuCode = CPSS_NET_FIRST_USER_DEFINED_E;
    cpssOsMemSet(&ruleType, 0, sizeof(ruleType));
    ruleType.ruleType = CPSS_DXCH_VIRTUAL_TCAM_RULE_TYPE_PCL_E;
    ruleType.rule.pcl.ruleFormat = CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_ULTRA_IPV6_PORT_VLAN_QOS_E;
    cpssOsMemSet(&ruleData, 0, sizeof(ruleData));
    ruleData.valid = GT_TRUE;
    ruleData.rule.pcl.actionPtr  = &action;
    ruleData.rule.pcl.maskPtr    = &mask;
    ...
    /* prepare iterator for go over all active devices */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, (UTF_LION2_E | UTF_XCAT3_E | UTF_AC5_E | UTF_AAS_E));
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        osMemSet(&vTcamInfo, 0, sizeof(vTcamInfo));
        vTcamInfo.ruleSize = CPSS_DXCH_VIRTUAL_TCAM_RULE_SIZE_20_B_E;
        vTcamInfo.clientGroup = 0;
        vTcamInfo.hitNumber = 0;
        vTcamInfo.ruleAdditionMethod = CPSS_DXCH_VIRTUAL_TCAM_RULE_ADDITION_METHOD_LOGICAL_INDEX_E;
        ...
        /* create vtcam */
        st = cpssDxChVirtualTcamCreate(vTcamMngId, vTcamId0, &vTcamInfo);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamCleanupAll failed\n");
        ...
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamCleanupAll failed\n");
        for (repeatCnt = 0;
              (repeatCnt < cpssDxChVirtualTcam_80bytes_autoresize_repeat_num);
              repeatCnt++)
        {
            PRV_UTF_LOG1_MAC("Write/delete cycle %d \n", repeatCnt);
            ruleId = 0;
            while (1)
            {
                ruleData.valid = GT_TRUE;
                ...
                {
                    PRV_UTF_LOG2_MAC(
                        "Write vTcam rule failed: ruleId %d, rc=%d \n", ruleId, st);
                    PRV_UTF_LOG0_MAC(
                        "This fail planned to occur at fulfilling all the TCAM \n");
                    break;
                }
        ...
        /* remove vtcam */
        st = cpssDxChVirtualTcamRemove(vTcamMngId, vTcamId0);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cpssDxChVirtualTcamRemove failed\n");
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_ha_autoresize_no_guarantied_with_rules)
{
    GT_STATUS                                     st   = GT_OK;
    GT_U8                                         dev;
    GT_U32                                        vTcamMngId = 10;
    GT_U32                                        vTcamId0 = 5;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        st = cliWrapCpssDxChVirtualTcamCreate(
            vTcamMngId, vTcamId0, 0/*clientGroup*/, 0/*hitNumber*/,
            "std"/*ruleSize*/, 0/*tcamSpaceUnmovable*/,
            1/*autoResize*/, 0/*guaranteedNumOfRules*/, "priority"/*ruleAdditionMethod*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamCreate failed\n");

        /* write one rule */
        st = cliWrapCpssDxChVirtualTcamRuleWrite(
            vTcamMngId, vTcamId0, 1/*numOfRules*/, 300/*ruleIdBase*/, 1/*ruleIdInc*/,
            1/*priorityBase*/, 1/*priorityInc*/, "pcl"/*ruleType*/,
            100/*ruleStampBase*/, 1/*ruleStampInc*/, 200,/*actionStampBase*/ 1/*actionStampInc*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleWrite failed\n");
        ...
        /* all reply action on INIT stage */
        st = cliWrapPrvCpssSystemRecoveryStateUpdate("init","ha","read_no_write");
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapPrvCpssSystemRecoveryStateUpdate failed\n");
        ...
        /*  CATCH_UP stage */
        st = cliWrapPrvCpssSystemRecoveryStateUpdate("catch_up","ha","read_write");
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapPrvCpssSystemRecoveryStateUpdate failed\n");

        st = prvCpssDxChVirtualTcamCatchupForHa();
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "prvCpssDxChVirtualTcamCatchupForHa failed\n");

        /* COMPLETION stage and check */
        st = cliWrapPrvCpssSystemRecoveryStateUpdate("completion","ha","read_write");
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapPrvCpssSystemRecoveryStateUpdate failed\n");

        st = cliWrapPrvCpssSystemRecoveryStateUpdate("completion","not_active","read_write");
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapPrvCpssSystemRecoveryStateUpdate failed\n");

        st = cliWrapCpssDxChVirtualTcamRuleCheck(
            vTcamMngId, vTcamId0, 1/*numOfRules*/, 300/*ruleIdBase*/, 1/*ruleIdInc*/, "pcl"/*ruleType*/,
            100/*ruleStampBase*/, 1/*ruleStampInc*/, 200,/*actionStampBase*/ 1/*actionStampInc*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleCheck failed\n");

        st = cliWrapCpssDxChVirtualTcamRuleRead(
            vTcamMngId, vTcamId0, 1/*numOfRules*/, 300/*ruleIdBase*/, 1/*ruleIdInc*/, "pcl"/*ruleType*/);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, st, "cliWrapCpssDxChVirtualTcamRuleRead failed\n");
...
UTF_TEST_CASE_MAC(cpssDxChVirtualTcam_ha_autoresize_no_guarantied_no_rules)
{
    GT_STATUS                                     st   = GT_OK;
    GT_U8                                         dev;
    GT_U32                                        vTcamMngId = 10;
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssDxChVirtualTcam)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChVirtualTcam_priority_autoresize_decrease_6_10x8)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChVirtualTcam_priority_decrease_by_one)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChVirtualTcam_unmovable_app_allocated)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChVirtualTcam_unmovable_app_allocated_ha_with_rules)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChVirtualTcam_unmovable_app_allocated_ha_no_rules)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChVirtualTcam_unmovable_app_allocated_fill_tcam_no_rules)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChVirtualTcam_80bytes_autoresize)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChVirtualTcam_ha_autoresize_no_guarantied_with_rules)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChVirtualTcam_ha_autoresize_no_guarantied_no_rules)

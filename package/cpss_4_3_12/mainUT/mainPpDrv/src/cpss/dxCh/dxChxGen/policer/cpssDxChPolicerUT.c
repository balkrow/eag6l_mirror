...
{
/*
    ITERATE_DEVICES (APPLICABLE DEVICES: Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
    Expected: GT_OK.
...
*/
    ...
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_XCAT3_E | UTF_LION2_E | UTF_AC5_E);

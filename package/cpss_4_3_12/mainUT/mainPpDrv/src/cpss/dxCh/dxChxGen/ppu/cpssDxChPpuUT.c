...
UTF_TEST_CASE_MAC(cpssDxChPpuActionTableEntrySet)
{
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        index = 4;
        cpssOsMemSet(&actionEntry, 0, sizeof(CPSS_DXCH_PPU_KSTG_ACTION_ENTRY_STC));
        actionEntry.rotActionEntry[3].target          = GT_FALSE /*CPSS_DXCH_PPU_KSTG_ROT_TARGET_SEL_SP_BUS_E*/;
        actionEntry.rotActionEntry[3].ldSpBusOffset   = 10;
        actionEntry.rotActionEntry[3].ldSpBusNumBytes = 3;

        actionEntry.rotActionEntry[4].target          = GT_FALSE /*CPSS_DXCH_PPU_KSTG_ROT_TARGET_SEL_SP_BUS_E*/;
        ...
        cpssOsMemSet(&actionEntry, 0, sizeof(CPSS_DXCH_PPU_KSTG_ACTION_ENTRY_STC));
        actionEntry.rotActionEntry[0].target          = GT_FALSE /*CPSS_DXCH_PPU_KSTG_ROT_TARGET_SEL_SP_BUS_E*/;

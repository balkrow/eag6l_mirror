...
static GT_CHAR test_client_1_Name[CPSS_DXCH_TCAM_MANAGER_CLIENT_NAME_NAX_LENGTH_CNS] = "Client1";
static GT_CHAR test_client_2_Name[CPSS_DXCH_TCAM_MANAGER_CLIENT_NAME_NAX_LENGTH_CNS] = "Client2";
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChTcamManagerClientRegister(tcamManagerHandlerPtr,
                                                test_client_1_Name, &clientFunc, &clientId);
        UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, st);
        ...
        */
        ...
        st = cpssDxChTcamManagerClientRegister(NULL, test_client_1_Name, &clientFunc, &clientId);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_BAD_PTR, st, "%d, tcamManagerHandlerPtr = NULL");
        ...
        */
        st = cpssDxChTcamManagerClientRegister(tcamManagerHandlerPtr,
                                                test_client_1_Name, NULL, &clientId);
        ...
        */
        st = cpssDxChTcamManagerClientRegister(tcamManagerHandlerPtr,
                                                test_client_1_Name, &clientFunc, NULL);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        clientFunc.checkIfDefaultLocationFuncPtr = prvClientCheckIfDefaultLocation;
        st = cpssDxChTcamManagerClientRegister(tcamManagerHandlerPtr,
                            test_client_2_Name, &clientFunc, &clientId2);
        UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, st);

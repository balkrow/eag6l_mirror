...
#define BRG_VLAN_MIRROR_TO_ANALYZER_MAX_INDEX_CNS(_devNum)  \
         (((PRV_CPSS_PP_MAC(_devNum)->appDevFamily) == CPSS_AAS_E)? 62 : 6)
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        vlanInfo.mirrToRxAnalyzerIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 63 : 7;
        ...
        */
        ...
        /*
            ...
            Expected: NON GT_OK for Bobcat2; Caelum; Bobcat3 and GT_OK for others.
        */
        vlanInfo.mirrToTxAnalyzerIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 63 : 7;
        vlanInfo.mirrToTxAnalyzerEn = GT_TRUE;
        ...
        */
        ...
        /*
            ...
            Expected: NON GT_OK for Bobcat2; Caelum; Bobcat3 and GT_OK.
        */
        vlanInfo.ipv4McBcMirrToAnalyzerIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 63 : 7;
        vlanInfo.ipv4McBcMirrToAnalyzerEn = GT_TRUE;
        ...
        */
        ...
        /*
            ...
            Expected: NON GT_OK for Bobcat2; Caelum; Bobcat3 and GT_OK for others.
        */
        vlanInfo.ipv6McMirrToAnalyzerIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 63 : 7;
        vlanInfo.ipv6McMirrToAnalyzerEn = GT_TRUE;
        ...
        for(direction = CPSS_DIRECTION_INGRESS_E ; direction <= CPSS_DIRECTION_EGRESS_E; direction++)
        {
            ...
            while(GT_OK == prvUtfNextGenericPortGet(&port, GT_TRUE))
            {
                ...
                */
                ...
                maxVlanId = UTF_CPSS_PP_MAX_VLAN_NUM_CNS(dev);
                if (maxVlanId>BIT_16)
                {
                    /* vlanId is configured as GT_U16, can not check more the 16 bits */
                    UTF_VERIFY_EQUAL0_PARAM_MAC(GT_BAD_PARAM, GT_OK);
        ...
        while(GT_OK == prvUtfNextDefaultEPortGet(&tmpPort, GT_TRUE))
        {
            ...
            */
            ...
            else
            {
                ...
                if (maxVlanId!=BIT_16)
                {
                    vlanCfg.vlanId = (GT_U16)maxVlanId;
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        /* Call with enable [GT_FALSE] */
        vlanId = BRG_VLAN_TESTED_VLAN_ID_CNS;
        index = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 7 : 0;
        status = GT_FALSE;
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        /*
            1.3. Call with vlanId [100] and vrfId [32K or 4096]
            Expected: non GT_OK.
        */
        vrfId = PRV_CPSS_SIP_7_CHECK_MAC(dev) ? _32K : 4096;
...
*/
    ...
    CPSS_DXCH_BRG_VLAN_TRANSLATION_ENT enable    = CPSS_DXCH_BRG_VLAN_TRANSLATION_DISABLE_E;
    CPSS_DXCH_BRG_VLAN_TRANSLATION_ENT enableGet = CPSS_DXCH_BRG_VLAN_TRANSLATION_DISABLE_E;
                ...
                else
                {
                    ...
                    */
                    UTF_ENUMS_CHECK_MAC(
                        ...
                        (dev, port, direction, CPSS_DXCH_BRG_VLAN_TRANSLATION_DISABLE_E),
                        direction);
                }
            }
        }
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChBrgVlanTpidEntrySet(dev, CPSS_DXCH_ETHERTYPE_TABLE_EGRESS_E, 0, etherType);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);

        /* Get value of etherType*/
        st = cpssDxChBrgVlanTpidEntryGet(dev, CPSS_DXCH_ETHERTYPE_TABLE_EGRESS_E, 0, &etherTypeGet);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        for(iTemp = 0; iTemp < numEntries; iTemp+=step)
        {
            ...
            /* iTemp is GT_U16 numEntries is GT_U32. we need to
               prevent infinite loop when numEntries get to 64K */
            if ((iTemp+step) >= BIT_16)
            {
                break;
            }
        }
        ...
        */
        ...
        for(iTemp = 0; iTemp < numEntries; iTemp+=step)
        {
            ...
            if (GT_TRUE == isValid)
            {
                /* SIP 7 support only 4K port members and tagging info */
                if(!(PRV_CPSS_SIP_7_CHECK_MAC(dev) && iTemp >= PRV_CPSS_MAX_NUM_VLANS_CNS/*4K*/))
                {
                    /* Verifying portsMembersPtr */
                    isEqual = (0 == cpssOsMemCmp((GT_VOID*) &portsMembers,
                                                 (GT_VOID*) &portsMembersGet,
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        else
        {
            ...
            {
                vlanId = (GT_U16)maxVlanId;
                st = cpssDxChBrgVlanIpv4McBcMirrorToAnalyzerIndexGet(dev,vlanId, &enable, &index);
                UTF_VERIFY_NOT_EQUAL1_PARAM_MAC(GT_OK, st, dev);
            }
        }
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /*
            1.1. Call with vlanId
                 [BIT_MASK_MAC(PRV_CPSS_DXCH_PP_MAC(dev)->hwInfo.flexFieldNumBitsSupport.vid)],
                           enable[GT_TRUE / GT_FALSE],
                           index[0 - CPSS_DXCH_MIRROR_ANALYZER_MAX_INDEX_MAC(devNum)],
            Expected: GT_OK.
        */
        ...
        */
        vlanId = (GT_U16) (UTF_CPSS_PP_MAX_VLAN_INDEX_CNS(dev) - 1);
        enable = GT_TRUE;
        index = BRG_VLAN_MIRROR_TO_ANALYZER_MAX_INDEX_CNS(dev);
        ...
        */
        ...
        else
        {
            ...
            {
                vlanId = (GT_U16)maxVlanId;
                st = cpssDxChBrgVlanIpv4McBcMirrorToAnalyzerIndexSet(dev,vlanId, enable, index);
                UTF_VERIFY_NOT_EQUAL1_PARAM_MAC(GT_OK, st, dev);
            }
        }
        ...
        /*
            ...
            Expected: NOT GT_OK.
        */
        index = BRG_VLAN_MIRROR_TO_ANALYZER_MAX_INDEX_CNS(dev) + 1;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        else
        {
            ...
            {
                vlanId = (GT_U16)maxVlanId;
                st = cpssDxChBrgVlanIpv6McMirrorToAnalyzerIndexGet(dev, vlanId, &enable, &index);
                UTF_VERIFY_NOT_EQUAL1_PARAM_MAC(GT_OK, st, dev);
            }
        }
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        else
        {
            ...
            {
                vlanId = (GT_U16)maxVlanId;
                st = cpssDxChBrgVlanIpv6McMirrorToAnalyzerIndexSet(dev,vlanId, enable, index);
                UTF_VERIFY_NOT_EQUAL1_PARAM_MAC(GT_OK, st, dev);
            }
        }
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        vlanId = 0;
        txAnalyzerIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 7 : 0;
        enable = GT_FALSE;
        ...
        */
        vlanId = 100;
        txAnalyzerIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 35 : 3;
        enable = GT_TRUE;
        ...
        */
        vlanId = UTF_CPSS_PP_MAX_VLAN_INDEX_CNS(dev)-1;
        txAnalyzerIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 62 : 6;
        enable = GT_TRUE;
        ...
        */
        ...
        else
        {
            ...
            {
                vlanId = (GT_U16)maxVlanId;
                st = cpssDxChBrgVlanMirrorToTxAnalyzerSet(dev, vlanId, enable,txAnalyzerIndex);
                UTF_VERIFY_NOT_EQUAL4_PARAM_MAC(GT_OK, st, dev, vlanId, enable,txAnalyzerIndex);
            }
        }
        ...
        */
        vlanId = 100;
        txAnalyzerIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 63 : 7;
        enable = GT_TRUE;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        else
        {
            ...
            {
                vlanId = (GT_U16)maxVlanId;
                st = cpssDxChBrgVlanUnregisteredIpmEVidxSet(dev, vlanId,unregIpmEVidxMode, unregIpmEVidx);
                UTF_VERIFY_NOT_EQUAL4_PARAM_MAC(GT_OK, st, dev, vlanId,unregIpmEVidxMode, unregIpmEVidx);
            }
        }
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        if (!UTF_CPSS_SIP5_0_ONLY_CHECK_MAC(devNum))
        {
            ...
            /* 1.2 */
            maxVlanId = UTF_CPSS_PP_MAX_VLAN_INDEX_CNS(devNum);
            if (maxVlanId>BIT_16)
            {
                /* vlanId is configured as GT_U16, can not check more the 16 bits */
                UTF_VERIFY_EQUAL0_PARAM_MAC(GT_BAD_PARAM, GT_OK);
...
/*----------------------------------------------------------------------------*/
/*
GT_STATUS cpssDxChBrgVlanClassifyInnerTagAsTag0EnableSet
(
    IN GT_U8    devNum,
    IN GT_BOOL  enable
)
*/
UTF_TEST_CASE_MAC(cpssDxChBrgVlanClassifyInnerTagAsTag0EnableSet)
{
/*
    ITERATE_DEVICES : sip7 devices
    1.1. Call function with enable [GT_FALSE / GT_TRUE].
    Expected: GT_OK.
    1.2. Call cpssDxChBrgVlanClassifyInnerTagAsTag0Get
    Expected: GT_OK and the same enablePtr.
*/
    GT_STATUS   st = GT_OK;
    GT_U8       dev;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        st = cpssDxChBrgVlanClassifyInnerTagAsTag0EnableSet(dev, state);
        UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, st, dev, state);

        /*
            1.2. Call cpssDxChBrgVlanClassifyInnerTagAsTag0EnableGet
            Expected: GT_OK and the same enablePtr.
        */
        st = cpssDxChBrgVlanClassifyInnerTagAsTag0EnableGet(dev, &stateGet);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                       "cpssDxChBrgVlanClassifyInnerTagAsTag0EnableGet: %d", dev);
        UTF_VERIFY_EQUAL1_STRING_MAC(state, stateGet,
                       "get another enable than was set: %d", dev);
...
/*----------------------------------------------------------------------------*/
/*
GT_STATUS cpssDxChBrgVlanClassifyInnerTagAsTag0EnableGet
(
    IN  GT_U8    devNum,
    OUT GT_BOOL  *enablePtr
)
*/
UTF_TEST_CASE_MAC(cpssDxChBrgVlanClassifyInnerTagAsTag0EnableGet)
{
/*
    ITERATE_DEVICES : sip7 devices
    1.1. Call with non-null enablePtr.
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /*
            ...
            Expected: GT_OK.
        */
        st = cpssDxChBrgVlanClassifyInnerTagAsTag0EnableGet(dev, &state);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
        ...
        /*
            ...
            Expected: GT_BAD_PTR.
        */
        st = cpssDxChBrgVlanClassifyInnerTagAsTag0EnableGet(dev, NULL);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st, "%d, enablePtr = NULL", dev);
    }
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssDxChBrgVlan)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChBrgVlanClassifyInnerTagAsTag0EnableSet)
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChBrgVlanClassifyInnerTagAsTag0EnableGet)

...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        dscp = 32;
        profile = 1;
        mappingTableIndex = PRV_CPSS_SIP_7_CHECK_MAC(dev) ? 72 : 12;
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        mappingTableIndexBound = (PRV_CPSS_SIP_7_CHECK_MAC(dev)) ? 72 : 12;
        ...
        while(GT_OK == prvUtfNextGenericPortGet(&port, GT_TRUE))
        {
            ...
            */
            ...
            useUpAsIndex = GT_FALSE;
            mappingTableIndex = mappingTableIndexBound - 1;
            ...
            */
            useUpAsIndex = GT_TRUE;
            mappingTableIndex = mappingTableIndexBound;

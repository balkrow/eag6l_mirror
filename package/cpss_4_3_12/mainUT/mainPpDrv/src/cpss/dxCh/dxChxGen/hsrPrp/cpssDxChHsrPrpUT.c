...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpExceptionCommandSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpExceptionCommandSet
                                         (dev, type, command));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpExceptionCommandGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpExceptionCommandGet
                                         (dev, type ,&commandGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpExceptionCpuCodeSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpExceptionCpuCodeSet
                                         (dev, type ,cpuCode));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpExceptionCpuCodeGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpExceptionCpuCodeGet
                                         (dev, type ,&cpuCodeGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpEnableSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpEnableSet
                                         (dev, portNum, enable));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpEnableGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpEnableGet
                                         (dev, portNum, &enableGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpLanIdSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpLanIdSet
                                         (dev, portNum, direction, lanId));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpLanIdGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpLanIdGet
                                         (dev, portNum, direction, &lanIdGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpTreatWrongLanIdAsRctExistsSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpTreatWrongLanIdAsRctExistsSet
                                         (dev, portNum, enable));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpTreatWrongLanIdAsRctExistsGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpTreatWrongLanIdAsRctExistsGet
                                         (dev, portNum, &enableGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpHPortSrcEPortBaseSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpHPortSrcEPortBaseSet
                                         (dev, portNum));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpHPortSrcEPortBaseGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpHPortSrcEPortBaseGet
                                         (dev, &portNumGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPntNumOfReadyEntriesThresholdSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPntNumOfReadyEntriesThresholdSet
                                         (dev, threshold));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPntNumOfReadyEntriesThresholdGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPntNumOfReadyEntriesThresholdGet
                                         (dev, &thresholdGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpHPortEntryGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpHPortEntryGet
                                         (dev, hPort , &infoGet , &firstCounterGet , &secondCounterGet , &thirdCounterGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPntEntrySet)
{
    ...
    {
        index = 0;
        operation = CPSS_DXCH_HSR_PRP_PNT_OPER_SET_READY_E;
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPntEntrySet
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPntEntryGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPntEntryGet
                                         (dev, index , &stateGet , &infoGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPntAgingApply)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPntAgingApply
                                         (dev, index , numOfEntries , &numOfEntriesDeleted));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpLreInstanceEntrySet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpLreInstanceEntrySet
                                         (dev, index , &info));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpLreInstanceEntryGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpLreInstanceEntryGet
                                         (dev, index, &infoGet , &lreADiscardCounter , &lreBDiscardCounter));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpFdbPartitionModeSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpFdbPartitionModeSet
                                         (dev, mode));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpFdbPartitionModeGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpFdbPartitionModeGet
                                         (dev, &modeGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpDdeTimerGranularityModeGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpDdeTimerGranularityModeGet
                                         (dev, &modeGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpTrailerActionSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpTrailerActionSet
                                         (dev, portNum, action));
        ...
        /* test GT_BAD_PARAM cases on enum for param : type */
        UTF_ENUMS_CHECK_MAC(cpssDxChHsrPrpPortPrpTrailerActionSet
                            (dev, portNum ,action),
                            action);
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpTrailerActionGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpTrailerActionGet
                                         (dev, portNum, &actionGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpPaddingModeSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpPaddingModeSet
                                         (dev, portNum, mode));
        ...
        /* test GT_BAD_PARAM cases on enum for param : type */
        UTF_ENUMS_CHECK_MAC(cpssDxChHsrPrpPortPrpPaddingModeSet
                            (dev, portNum ,mode),
                            mode);
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortPrpPaddingModeGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortPrpPaddingModeGet
                                         (dev, portNum, &modeGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpDdeEntryInvalidate)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpDdeEntryInvalidate
                                         (dev, index));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpDdeEntryRead)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpDdeEntryRead
                                         (dev, index , &infoGet , &isValid));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpDdeAgingApply)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpDdeAgingApply
                                         (dev, index, age_numOfEntries, &age_numOfEntriesDeleted));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpDdeHashCalc)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpDdeHashCalc
                                         (dev, &entryKey, 0, 16, &hashArr[0]));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortTrgPrpBaseLsduOffsetSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortTrgPrpBaseLsduOffsetSet
                                         (dev, portNum, lsduOffset));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortTrgPrpBaseLsduOffsetGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortTrgPrpBaseLsduOffsetGet
                                         (dev, portNum, &lsduOffsetGet));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortSrcHsrBaseLsduOffsetSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortSrcHsrBaseLsduOffsetSet
                                         (dev, portNum, lsduOffset));
...
UTF_TEST_CASE_MAC(cpssDxChHsrPrpPortSrcHsrBaseLsduOffsetGet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        /* Checks TSN features for not applicable device */
        UTF_CPSS_DXCH_TSN_SUPPORTED_MAC(dev,
                                         cpssDxChHsrPrpPortSrcHsrBaseLsduOffsetGet
                                         (dev, portNum, &lsduOffsetGet));

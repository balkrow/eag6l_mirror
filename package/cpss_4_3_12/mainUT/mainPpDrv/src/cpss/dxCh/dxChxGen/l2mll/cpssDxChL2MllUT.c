...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        mllPairEntry.firstMllNode.egressInterface.type = CPSS_INTERFACE_PORT_E;
        mllPairEntry.firstMllNode.egressInterface.devPort.portNum = PRV_CPSS_SIP_7_CHECK_MAC(dev) ? BIT_15 :
            PRV_CPSS_SIP_5_20_CHECK_MAC(dev) ? BIT_14 : BIT_13;/*UTF_CPSS_PP_MAX_PORT_NUM_CNS(dev) + 1;*/
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        lttEntry.mllPointer = (maxL2MllEntries / 2)-1;/* max valid mllPointer is the max number of lines in the IP/L2 MLL table minus 1 */

...
/* Check if shadow type is SIP_6 or SIP_7 */
#define PRV_TGF_FDB_MANAGER_IS_SHADOW_SIP6_MAC(_shadowType)                        \
    ((_shadowType == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP6_E) ||              \
     (_shadowType == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP7_E))

extern GT_BOOL prvFdbManagerLegacyHashModeForSip6DevicesGet
(
    GT_VOID
);

/* Is XOR hash mode for SIP6 devices is set */
#define is_sip6_xor \
    prvFdbManagerLegacyHashModeForSip6DevicesGet()

static const CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_ENT fdbEntryType_valid_arr[] =
{
...
static const  CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_ENT fdbEntryType_valid_legacy_hash_arr[] =
{
    CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_MAC_ADDR_E
    , CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV4_MC_E
    , CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_MC_E
...
static const CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_ENT * fdbEntryType_valid_arr_ptr;
...
extern GT_STATUS prvCpssDxChBrgFdbHashCrcMultiResultsByParamsCalc_maxFidValue_Set(IN GT_U32    maxFidValue);
...
#define FDB_SIZE_FULL_INIT()                                                        \
    ...
    {                                                                               \
        prvCpssDxChBrgFdbHashCrcMultiResultsByParamsCalc_maxFidValue_Set(_64K-1);   \
    }
...
#define SIP6_HASH_AS_PER_DEVICE(num) ((num) > PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->bridge.fdbHashParams.numOfBanks ? \
                                              PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->bridge.fdbHashParams.numOfBanks : \
                                             (num))

#define SIP5_BANK_AS_PER_DEVICE(bank) ((bank) >= PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->bridge.fdbHashParams.numOfBanks ? \
                                              (PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->bridge.fdbHashParams.numOfBanks - 1) : \
                                             (bank))

#define HASH_AS_PER_DEVICE(num)         ((is_sip6_xor) ? 1 : ((PRV_CPSS_SIP_6_CHECK_MAC(prvTgfDevNum))?SIP6_HASH_AS_PER_DEVICE(num):(PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))?16:1))
#define HASH_MODE_AS_PER_DEVICE(mode)   ((is_sip6_xor) ? CPSS_MAC_HASH_FUNC_XOR_E : (PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))?CPSS_MAC_HASH_FUNC_CRC_MULTI_HASH_E:mode)
#define SHADOW_TYPE_PER_DEVICE()        ((userDefinedShadowType)?(globalShadowType):\
                        ((PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))?CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP7_E:\
                         (PRV_CPSS_SIP_6_CHECK_MAC(prvTgfDevNum))?CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP6_E:\
                         (PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))?CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_E:\
                         CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP4_E))
#define BANK_AS_PER_DEVICE(bank)        ((is_sip6_xor) ? (bank % 3) : (PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))?SIP5_BANK_AS_PER_DEVICE(bank):bank%3)
#define FID_MASK_AS_PER_DEVICE()        ((PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))?(0xFFFF):(PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))?(0x1FFF):(0xFFF))
#define DEV_ID_MASK_AS_PER_DEVICE()     ((PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))?(0x3FF ):(0x1F ))
#define PORT_MASK_AS_PER_DEVICE()       ((PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->vportInfo.useVPortMode) ? VPORT_MASK_AS_PER_DEVICE() : \
                                         (PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))?(0x1FFF):(0x3F ))
#define TRUNK_MASK_AS_PER_DEVICE()      ((PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))?(0xFFF ):(0x7F ))
#define VIDX_MASK_AS_PER_DEVICE()       ((PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))?(0x1FFFF):(PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))?(0xFFFF):(0xFFF))
...
#define IS_SIP7                         (SHADOW_TYPE_PER_DEVICE() == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP7_E)
...
#define VPORT_MASK_AS_PER_DEVICE()      (BIT_18-1)

#define CLEAR_VAR_MAC(var)  \
    cpssOsMemSet(&var,0,sizeof(var))

#define IS_IPV6_IN_HYBRID_SHADOW(_entryPtr) ((SHADOW_TYPE_PER_DEVICE() == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_E) && (_entryPtr->fdbEntryType == CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_UC_E))
...
/*13    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_INVALID_E           */     \
/*14    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_MISMATCH_E          */     \
/*15*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_INDEX_POINT_INVALID_ENTRY_E                   \
/*16*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_ENTRY_HW_INDEX_MISMATCH_E                     \
/*17  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_INDEXES_DIFFERENT_E            */     \
/*18  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_KEY_NOT_EVEN_INDEX_E           */     \
/*19  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_DATA_NOT_ODD_INDEX_E           */     \
/*20*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_BIN_ENTRIES_NUM_MISMATCH_E              \
/*21*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_TOTAL_NUM_MISMATCH_E                    \
/*22*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_ENTRY_BIN_INDEX_INVALID_E               \
/*23*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_SCAN_PTR_INVALID_E                      \
/*24*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_USAGE_MATRIX_L1_INVALID_E               \
/*25*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_USAGE_MATRIX_L2_INVALID_E               \
/*26*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_ENTRY_INVALID_E                            \
/*27*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_FREE_ENTRY_VALID_EXIST_E                   \
/*28*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_FREE_ENTRY_SP_EXIST_E                      \
/*29*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_LEARN_LIMIT_GLOBAL_INVALID_E                  \
/*30    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_LEARN_LIMIT_FID_INVALID_E              */     \
/*31    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_LEARN_LIMIT_GLOBAL_EPORT_INVALID_E     */     \
/*32    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_LEARN_LIMIT_TRUNK_INVALID_E            */     \
/*33    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_LEARN_LIMIT_PORT_INVALID_E             */     \
/*34    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_LEARN_LIMIT_SRC_INTERFACES_CURRENT_INVALID_E*/\
    }
#else
#define FDB_SELF_TEST_ALL_ERR  {                                                           \
/* 0*/   CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_GLOBAL_PARAM_HW_INVALID_E                     \
...
/* 7*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_ENTRY_HW_INDEX_MISMATCH_E                     \
...
static const FDB_MANAGER_DEBUG_ERROR_INFO debugErrorArr[] =
{
    ...
    {1              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_GLOBAL_PARAM_HW_INVALID_E"          , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_GLOBAL_PARAM_HW_INVALID_E, CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_INVALID_E}            }, /* 0*/
    ...
    {0              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_INVALID_E"       , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_INVALID_E}           }, /*13*/
    {0              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_MISMATCH_E"      , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_MISMATCH_E}           }, /*14*/

    {3              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_INDEX_POINT_INVALID_ENTRY_E"        , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_FREE_LIST_ENTRIES_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_1ST_PTR_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_INDEX_POINT_INVALID_ENTRY_E}       }, /*15*/
    {2              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_ENTRY_HW_INDEX_MISMATCH_E"          , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_BANK_COUNTERS_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_ENTRY_HW_INDEX_MISMATCH_E}         }, /*16*/
    {3              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_INDEXES_DIFFERENT_E"      , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_BANK_COUNTERS_INVALID_E, CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_MISMATCH_E, CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_INDEXES_DIFFERENT_E}          }, /*17*/
    {3              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_KEY_NOT_EVEN_INDEX_E"     , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_TYPE_COUNTERS_INVALID_E, CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_KEY_NOT_EVEN_INDEX_E, CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_ENTRY_INVALID_E}          }, /*18*/
    {2              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_DATA_NOT_ODD_INDEX_E"     , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_TYPE_COUNTERS_INVALID_E, CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_DATA_NOT_ODD_INDEX_E}          }, /*19*/

    {3              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_BIN_ENTRIES_NUM_MISMATCH_E"   , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_BIN_ENTRIES_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_USAGE_MATRIX_L1_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_USAGE_MATRIX_L2_INVALID_E}     }, /*20*/
    {3              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_TOTAL_NUM_MISMATCH_E"         , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_FREE_LIST_ENTRIES_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_ENTRIES_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_TOTAL_NUM_MISMATCH_E}      }, /*21*/
    {4              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_ENTRY_BIN_INDEX_INVALID_E"    , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_BIN_ENTRIES_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_TOTAL_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_ENTRY_BIN_INDEX_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_SCAN_PTR_INVALID_E}  }, /*22*/
    {5              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_SCAN_PTR_INVALID_E"           , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_GETNEXT_PTR_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_BIN_ENTRIES_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_TOTAL_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_SCAN_PTR_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_FREE_ENTRY_VALID_EXIST_E}}, /*23*/
    {3              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_USAGE_MATRIX_L1_INVALID_E"    , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_BIN_ENTRIES_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_USAGE_MATRIX_L1_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_USAGE_MATRIX_L2_INVALID_E}     }, /*24*/
    {1              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_USAGE_MATRIX_L2_INVALID_E"    , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_USAGE_MATRIX_L2_INVALID_E}           }, /*25*/

    {1              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_ENTRY_INVALID_E"                 , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_ENTRY_INVALID_E}           }, /*26*/
    {5              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_FREE_ENTRY_VALID_EXIST_E"        , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_GETNEXT_PTR_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_BIN_ENTRIES_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_TOTAL_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_AGING_SCAN_PTR_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_FREE_ENTRY_VALID_EXIST_E}}, /*27*/
    {1              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_FREE_ENTRY_SP_EXIST_E"           , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_HW_FREE_ENTRY_SP_EXIST_E}           }, /*28*/
#ifdef PRV_CPSS_DXCH_BRG_FDB_MANAGER_ALLOW_HW_BANK_COUNTER_UPDATE_CNS
...
/*11    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_ENTRY_PREV_PTR_INVALID_E     */     \
/*12    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_ENTRIES_NUM_MISMATCH_E       */     \
/*13    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_INVLAID_E           */     \
/*14    ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_HW_INDEX_MISMATCH_E          */     \
/*15*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_INDEX_POINT_INVALID_ENTRY_E                   \
/*16*/  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_ENTRY_HW_INDEX_MISMATCH_E                     \
/*17  ,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_INDEXES_DIFFERENT_E            */     \
...
static const FDB_MANAGER_DEBUG_ERROR_INFO debugErrorArr_AC5[] =
{
    ...
    {3              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_INDEX_POINT_INVALID_ENTRY_E"        , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_FREE_LIST_ENTRIES_NUM_MISMATCH_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_USED_LIST_1ST_PTR_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_INDEX_POINT_INVALID_ENTRY_E}       }, /*15*/
    {2              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_ENTRY_HW_INDEX_MISMATCH_E"          , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_BANK_COUNTERS_INVALID_E,CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_ENTRY_HW_INDEX_MISMATCH_E}         }, /*16*/
    {0              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_INDEXES_DIFFERENT_E"      , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_INDEXES_DIFFERENT_E}           }, /*17*/
    {0              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_KEY_NOT_EVEN_INDEX_E"     , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_KEY_NOT_EVEN_INDEX_E}          }, /*18*/
    {0              , "CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_DATA_NOT_ODD_INDEX_E"     , {CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_DATA_NOT_ODD_INDEX_E}          }, /*19*/
...
void prvTgf_testsFDB(void)
{
    ...
    for(ii = 0; ii< PRV_CPSS_DXCH_PP_MAC(devNum)->bridge.fdbHashParams.numOfBanks; ii++)
    {
...
static void internal_cpssDxChBrgFdbManagerCreateUT(void)
{
    ...
    if(IS_SIP5_OR_HYBRID)
    {
        ...
        CHECK_BOUNDERS_NUMERIC_FIELD_cpssDxChBrgFdbManagerCreate(
            ...
            SHADOW_TYPE_PER_DEVICE() == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP7_E)
    {
        CHECK_BOUNDERS_NUMERIC_FIELD_cpssDxChBrgFdbManagerCreate(
...
)
{
    ...
    fdbEntryType_valid_arr_ptr = (is_sip6_xor) ? fdbEntryType_valid_legacy_hash_arr : fdbEntryType_valid_arr;
...
)
{
    ...
    if(SHADOW_TYPE_PER_DEVICE() == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP7_E)
    {
...
)
{
    ...
    if (SHADOW_TYPE_PER_DEVICE() == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP6_E ||
        SHADOW_TYPE_PER_DEVICE() == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP7_E)
    {
        fdbEntryFormatPtr->ucRouteType                  = (rand32Bits >> 2) % 3;
    }
    else
    {
...
)
{
    ...
    /* Invalidating the previous status, when fdbManagerEntryAdd_macAddr is called in a loop */
    *entryAddedPtr = GT_FALSE;
    ...
    else if(SHADOW_TYPE_PER_DEVICE() == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_SIP6_HYBRID_E)
    {
        ...
        fdbEntryMacAddrFormatPtr->mirrorToAnalyzerPort   =
    ...
    else if(st == GT_ALREADY_EXIST)
    {
        PRV_UTF_LOG6_MAC("cpssDxChBrgFdbManagerEntryAdd: Returned GT_ALREADY_EXIST for MAC %x:%x:%x:%x:%x:%x\n",
                fdbEntryMacAddrFormatPtr->macAddr.arEther[0], fdbEntryMacAddrFormatPtr->macAddr.arEther[1],
                fdbEntryMacAddrFormatPtr->macAddr.arEther[2], fdbEntryMacAddrFormatPtr->macAddr.arEther[3],
                fdbEntryMacAddrFormatPtr->macAddr.arEther[4], fdbEntryMacAddrFormatPtr->macAddr.arEther[5]);
    }
    ...
    if((*entryAddedPtr) == GT_TRUE)
    {
        ...
        st = cpssDxChBrgFdbManagerEntryGet(fdbManagerId, GT_FALSE, &entryGet);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
...
/**
GT_STATUS fdbManagerIpxUcEntryPointerCheck
(
    IN  GT_U32                                           fdbManagerId,
    IN  CPSS_DXCH_BRG_FDB_MANAGER_UC_ROUTING_TYPE_ENT    ucRouteType,
...
*/
static GT_VOID fdbManagerIpxUcEntryPointerCheck
(
    IN  GT_U32                                          fdbManagerId,
    IN  CPSS_DXCH_BRG_FDB_MANAGER_UC_ROUTING_TYPE_ENT   ucRouteType,
    OUT GT_BOOL                                         *statePtr
)
{
    ...
    *statePtr = GT_TRUE;
    ...
    st = cpssDxChBrgFdbManagerDevListGet(fdbManagerId, &numOfDevs, devListArr);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChBrgFdbManagerDevListGet: expected to GT_OK on manager [%d]",
        fdbManagerId);
    ...
    for(ii = 0; ii < numOfDevs; ii++)
    {
        ...
        /* The device is Falcon */
        if(PRV_CPSS_SIP_6_CHECK_MAC(dev) && !PRV_CPSS_SIP_6_10_CHECK_MAC(dev))
        {
            *statePtr = GT_FALSE;
            return;
        }
...
)
{
    ...
    {
        fdbManagerIpxUcEntryPointerCheck(fdbManagerId, fdbEntryFormatPtr->ucRouteType, &entryState);
        if(GT_FALSE == entryState)
        {
            UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PARAM, st,
...
)
{
    ...
    {
        /* Hybrid shadow type does not support ipv6 unicast */
        return;
    }
    ...
    else if (st != GT_FULL)
    {
        ...
        {
            UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PARAM, st,
                "fdbManagerEntryAdd_ipv6Uc: unexpected error in manager [%d]",
                fdbManagerId);
        }
        else
        {
...
)
{
    ...
    for(ii = 0 ; ii < entriesToAdd; ii++)
    {
        ...
        fdbEntryType = (inputFdbEntryType < CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE__LAST__E)?
            inputFdbEntryType : fdbEntryType_valid_arr_ptr[ii % UT_FDB_ENTRY_TYPE_VALID_NUM];
        switch(fdbEntryType)
        {
...
)
{
    ...
    if(IS_IPV6_IN_HYBRID_SHADOW(entryPtr))
    {
        /* Hybrid shadow type does not support ipv6 unicast */
        return;
    }
...
)
{
    ...
    fdbEntryAddInfo.tempEntryExist  = GT_TRUE;
    fdbEntryAddInfo.tempEntryOffset = BANK_AS_PER_DEVICE(9); /* force using this bank as 'first choice' */
...
)
{
    ...
    *ucRouteTypePtr = CPSS_DXCH_BRG_FDB_MANAGER_UC_ROUTING_TYPE_NEXT_HOP_INFO_FULL_IN_FDB_ARP_PTR_E;
    ...
    if(PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->vportInfo.useVPortMode)
    {
        maxValue = VPORT_MASK_AS_PER_DEVICE() +1;
    }
    else
    if((shadowType == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_E) ||
    ...
    CHECK_BOUNDERS_NUMERIC_FIELD_cpssDxChBrgFdbManagerEntryAdd(
            ...
            0/*min*/,
            VIDX_MASK_AS_PER_DEVICE()/*max*/,
            (VIDX_MASK_AS_PER_DEVICE()+1)/5/*step*/);
    ...
    *ucRouteTypePtr = CPSS_DXCH_BRG_FDB_MANAGER_UC_ROUTING_TYPE_NEXT_HOP_INFO_FULL_IN_FDB_ARP_PTR_E;
        ...
        (shadowType != CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_SIP6_HYBRID_E))
    {
        ...
        *ucRouteTypePtr = CPSS_DXCH_BRG_FDB_MANAGER_UC_ROUTING_TYPE_NEXT_HOP_POINTER_TO_ROUTER_E;
        ...
        fdbManagerIpxUcEntryPointerCheck(fdbManagerId, *ucRouteTypePtr, &entryState);
        if(GT_TRUE == entryState)
        {
            CHECK_BOUNDERS_NUMERIC_FIELD_cpssDxChBrgFdbManagerEntryAdd(
                    fdbManagerId, entryPtr, fdbEntryAddInfoPtr,
...
)
{
    ...
    /* check that info for the entry is valid */
    FDB_MANAGER_ENTRY_ADD_WITH_STATISTICS(fdbManagerId, &entry, &fdbEntryAddInfo, st);
    fdbManagerIpxUcEntryPointerCheck(fdbManagerId, ipv4UcAddrFormatPtr->ucRouteType, &entryState);
    if(GT_FALSE == entryState)
    {
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PARAM, st,
            "cpssDxChBrgFdbManagerEntryAdd: unexpected GT_OK [%d]",
    ...
    if(shadowType == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP6_E ||
       shadowType == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP7_E ||
       shadowType == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_SIP6_HYBRID_E)
    {
        fdbManagerPtr = MANAGER_GET_MAC(fdbManagerId);
        ipv4PrefixLength = fdbManagerPtr->lookupInfo.ipv4PrefixLength;
        fdbManagerPtr->lookupInfo.ipv4PrefixLength = 4;

        FDB_MANAGER_ENTRY_ADD_WITH_STATISTICS(fdbManagerId, &entry, &fdbEntryAddInfo, st);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PARAM, st,
            "cpssDxChBrgFdbManagerEntryAdd: expected to GT_BAD_PARAM on ipv4PrefixLength [%d]",
            fdbManagerPtr->lookupInfo.ipv4PrefixLength);

        fdbManagerPtr->lookupInfo.ipv4PrefixLength = ipv4PrefixLength;
    }
}
...
)
{
    ...
    if(shadowType == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_SIP6_HYBRID_E)
    {
        /* ipv6 entries in hybrid shadow - not supported */
        return;
    }
    ...
    /* check that info for the entry is valid */
    FDB_MANAGER_ENTRY_ADD_WITH_STATISTICS(fdbManagerId, &entry, &fdbEntryAddInfo, st);
    fdbManagerIpxUcEntryPointerCheck(fdbManagerId, ipv6UcAddrFormatPtr->ucRouteType, &entryState);
    if(GT_FALSE == entryState)
    {
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PARAM, st,
            "cpssDxChBrgFdbManagerEntryAdd: unexpected GT_OK [%d]",
    ...
    {
        fdbManagerPtr = MANAGER_GET_MAC(fdbManagerId);
        ipv6PrefixLength = fdbManagerPtr->lookupInfo.ipv6PrefixLength;
        fdbManagerPtr->lookupInfo.ipv6PrefixLength = 16;

        FDB_MANAGER_ENTRY_ADD_WITH_STATISTICS(fdbManagerId, &entry, &fdbEntryAddInfo, st);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PARAM, st,
            "cpssDxChBrgFdbManagerEntryAdd: expected to GT_BAD_PARAM on ipv6PrefixLength [%d]",
            fdbManagerPtr->lookupInfo.ipv6PrefixLength);

        fdbManagerPtr->lookupInfo.ipv6PrefixLength = ipv6PrefixLength;
    }
...
static void internal_cpssDxChBrgFdbManagerEntryAddUT(void)
{
    ...
    for(ii = 0 ; ii < maxTotalEntries; ii++)
    {
        ...
        fdbEntryType = fdbEntryType_valid_arr_ptr[ii % UT_FDB_ENTRY_TYPE_VALID_NUM];
    ...
    while(GT_OK == cpssDxChBrgFdbManagerEntryGetNext(fdbManagerId, getFirst, GT_FALSE, &entry))
    {
        getFirst = GT_FALSE;
...
)
{
    ...
    *entryUpfdatedPtr = GT_FALSE;
       ...
       SHADOW_TYPE_PER_DEVICE() == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP7_E)
    {
        ...
        fdbEntryFormatPtr->dstInterface.interfaceInfo.vidx  = (fdbEntryFormatPtr->dstInterface.interfaceInfo.vidx + 10) & VIDX_MASK_AS_PER_DEVICE(); /* 14 Bits */
    }
    else if(SHADOW_TYPE_PER_DEVICE() == CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_E)
    {
...
static void setAllVlansModeVid1lookup(IN GT_BOOL enable)
{
    ...
    for(vid = 0 ; vid < numVlans ; vid++)
    {
        ...
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
         ...
         /* since vlanId is GT_U16 and maxVid can be 64K
           we will get to endless loop when we get to 64K+1 -->vlanId=0 */
        if (vid == (BIT_16-1))
        {
            break;
        }
...
UTF_TEST_CASE_MAC(cpssDxChBrgFdbManagerEntryAdd_use_vid1)
{
    ...
    /* Not supported in Legacy FDB hash mode */
    if(is_sip6_xor)
    {
        SKIP_TEST_MAC;
    }
...
static GT_VOID internal_cpssDxChBrgFdbManagerEntryTempDeleteUT(void)
{
    ...
    tempEntryOffset             = force_single_bank_to_add = BANK_AS_PER_DEVICE(5);
    ...
    for(ii=0; ii<5; ii++)
    {
        ...
        st = cpssDxChBrgFdbManagerEntryGet(fdbManagerId, GT_FALSE, &entry);
...
static void internal_cpssDxChBrgFdbManagerEntryGetUT(void)
{
    ...
    for(ii = 0 ; ii < CPSS_DXCH_BRG_FDB_MANAGER_MAX_INSTANCE_NUM_CNS; ii++)
    {
        st = cpssDxChBrgFdbManagerEntryGet(ii, GT_FALSE, &entry);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_NOT_INITIALIZED, st,
    ...
    /* NULL pointer */
    st = cpssDxChBrgFdbManagerEntryGet(fdbManagerId, GT_FALSE, NULL);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st,
...
static void internal_cpssDxChBrgFdbManagerEntryGetNextUT(void)
{
    ...
    for(ii = 0 ; ii < CPSS_DXCH_BRG_FDB_MANAGER_MAX_INSTANCE_NUM_CNS; ii++)
    {
        st = cpssDxChBrgFdbManagerEntryGetNext(ii, GT_TRUE, GT_FALSE, &entry);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_NOT_INITIALIZED, st,
    ...
    st = cpssDxChBrgFdbManagerEntryGetNext(fdbManagerId, GT_FALSE, GT_FALSE, &entry);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
    ...
    /* calling 'first' */
    st = cpssDxChBrgFdbManagerEntryGetNext(fdbManagerId, GT_TRUE, GT_FALSE, &entry);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChBrgFdbManagerEntryGetNext: expected to GT_OK on manager [%d]",
        fdbManagerId);
    ...
    /* NULL pointer */
    st = cpssDxChBrgFdbManagerEntryGetNext(fdbManagerId, GT_TRUE, GT_FALSE, NULL);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st,
...
/* function to get HW entry index */
static void fdbManagerHwEntryIndexGet
(
    IN  CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_STC  *entryPtr,
...
)
{
    ...
    {
        st = prvTgfBrgFdbMacEntryIndexFind_MultiHash(&tgf_macEntryKey, hwIndexPtr);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
    ...
    {
        /* support sip4 devices */
        st = prvTgfBrgFdbMacEntryIndexFind(&tgf_macEntryKey, hwIndexPtr);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
            "prvTgfBrgFdbMacEntryIndexFind: expected to find entry type [%d]",
            entryPtr->fdbEntryType);
    }
}
...
)
{
    ...
    {
        /* support sip4 devices */
        st = prvTgfBrgFdbMacEntryIndexFind(&tgf_macEntryKey, &hwIndex);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
            "prvTgfBrgFdbMacEntryIndexFind: expected to find entry type [%d]",
            entryPtr->fdbEntryType);
    }
...
void test_Jira_CPSS_9420_FDB_MANAGER_Delete_mac_entry_doesnt_work(void)
{
    ...
    st = cpssDxChBrgFdbManagerEntryGet(fdbManagerId, GT_FALSE, &entryZero);
...
static GT_VOID internal_cpssDxChBrgFdbManagerLearningThrottlingGet_threshold_VerifyUT(GT_VOID)
{
    ...
    for(hashCns = 0; hashCns < 3; hashCns++)
    {
        ...
        for(hwIndexCns = 0; hwIndexCns < 6; hwIndexCns++)
        {
            ...
            if((PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum)) &&
               ((hwCapacity.numOfHwIndexes < _128K) ||
                (validNumOfHashes[hashCns] > PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->bridge.fdbHashParams.numOfBanks)))
            {
                /* AAS Support 128K and more. each bank has 32K entries. */
                continue;
            }
...
static GT_VOID internal_cpssDxChBrgFdbManagerDatabaseCheckUT(GT_VOID)
{
    ...
    /* test cannot use real random values because some corruptions done by prvCpssDxChFdbManagerDebugSelfTest
       may detect additional failures depends on entries disposition. */
    cpssOsSrand(100);
    ...
    for(ii=0; errorArr[ii].expErrArrSize != GT_NA ; ii++)
    {
        ...
        /* In SIP_5 design data and key entry can be present on any index */
        if(!PRV_TGF_FDB_MANAGER_IS_SHADOW_SIP6_MAC(shadowType))
        {
            if((ii == CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_INDEXES_DIFFERENT_E) ||
                    (ii == CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_KEY_NOT_EVEN_INDEX_E) ||
                    (ii == CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_IPV6_HOST_DATA_NOT_ODD_INDEX_E))
            {
                continue;
            }
        }
        ...
        if( ii == CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_ENTRY_HW_INDEX_MISMATCH_E /*14*/ &&
            ...
            errorNum == 5)
        {
            ...
            */
            ...
            /* see in the error LOG : for the first 2 errors :
                ...
                ERROR 0x0000ffff in function: prvCpssDxChBrgFdbManagerDbCheck_indexPointer, file prvcpssdxchbrgfdbmanager_db.c, line[3823]. Debug Error number [2] of Type[CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_ENTRY_HW_INDEX_MISMATCH_E]
...
GT_STATUS   prvCpssDxChFdbManagerTest(IN GT_U32 withHw , IN GT_U32 doPrint, GT_U32 numOfHashes, GT_32 stages, GT_BOOL isRand)
{
    ...
    for(ii = 0 ; ii < iiMax; ii++)
    {
        ...
        fdbEntryMacAddrFormatPtr->fid                = (1 + ii) & FID_MASK_AS_PER_DEVICE();
        ...
        switch(fdbEntryMacAddrFormatPtr->dstInterface.type)
        {
            case CPSS_INTERFACE_PORT_E:
                ...
                if(PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->vportInfo.useVPortMode)
                {
                    fdbEntryMacAddrFormatPtr->dstInterface.interfaceInfo.devPort.portNum  = (ii + 0x55) & VPORT_MASK_AS_PER_DEVICE();
                }
                else
                {
    ...
    /* remove all entries from the DB (one by one) */
    while(GT_OK == cpssDxChBrgFdbManagerEntryGetNext(fdbManagerId, getFirst, GT_FALSE, &fdbEntry))
    {
        getFirst = GT_FALSE;
...
static GT_STATUS   prvCpssDxChFdbManagerUpdateFdbMacEntryTest(IN GT_U32 fdbManagerId, IN GT_U32 doPrint, IN GT_U32 iiMax)
{
    ...
    for(ii = 0 ; ii < iiMax; ii++)
    {
        ...
        rc = cpssDxChBrgFdbManagerEntryGet(fdbManagerId,  GT_FALSE, &fdbEntry);
        if(rc != GT_OK)
        {
            return rc;
        }
        ...
        switch(fdbEntryMacAddrFormatPtr->dstInterface.type)
        {
            case CPSS_INTERFACE_PORT_E:
                ...
                if(PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->vportInfo.useVPortMode)
                {
                    fdbEntryMacAddrFormatPtr->dstInterface.interfaceInfo.devPort.portNum  = (fdbEntryMacAddrFormatPtr->dstInterface.interfaceInfo.devPort.portNum + 10) & VPORT_MASK_AS_PER_DEVICE();
                }
                else
                {
...
void prvCpssDxChFdbManagerIpv6EntryAddTest()
{
    ...
    hwFormatType = PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum) ?
        PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP7_E :
        PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP6_E;

    for(hwIndex = 0; hwIndex<fdbManagerPtr->capacityInfo.hwCapacity.numOfHwIndexes; hwIndex++)
    {
        st = prvCpssDxChFdbManagerHwEntryRead(0, hwIndex, fdbManagerPtr, hwFormatType, &addParams, &isValid);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                                     "prvCpssDxChFdbManagerHwEntryRead: expected to GT_OK on manager [%d]",
                                     fdbManagerId);
        if(isValid)
        {
            st = prvCpssDxChFdbManagerDbBuildDbFormatFromHwEntry(fdbManagerPtr, hwFormatType, &entry);
            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
...
static GT_STATUS AddingMacEntriesToFdb(GT_U32 fdbManagerId, GT_U32 macprefx, GT_U32 NDprefix1, GT_U32 NDprefix2, GT_U32 ndcnum,    GT_U32  step, GT_BOOL  macRandom, GT_U32  iterator, GT_BOOL v4)
{
    GT_STATUS   rc;
    ...
    for (ii = 0; ii < ndcnum; ii++)
    {
        for (n = 0; n < iterator; n++)
        {
            ...
            fdbEntryMacAddrFormatPtr->age = GT_TRUE;
            if (macRandom == GT_TRUE)
            {
                rand30Bits = cpssOsRand() | cpssOsRand() << 15;
                fdbEntryMacAddrFormatPtr->macAddr.arEther[0] = 0; /*((rand30Bits >> 24) & 0xFF); */
            ...
            else
            {
                ...
                fdbEntryMacAddrFormatPtr->macAddr.arEther[3] = ((numMAC + step)/255/255)%255;
                fdbEntryMacAddrFormatPtr->macAddr.arEther[4] = ((numMAC + step)/255)%255;
                fdbEntryMacAddrFormatPtr->macAddr.arEther[5] = (numMAC + step)%255;/*new DA mac*/


            }

            fdbEntryMacAddrFormatPtr->fid = iterator & FID_MASK_AS_PER_DEVICE();
        ...
        {
            cpssOsMemSet(&fdbEntry,0,sizeof(fdbEntry));
            fdbEntry.fdbEntryType = CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_UC_E;
            fdbEntryIpv6UcFormatPtr = &fdbEntry.format.fdbEntryIpv6UcFormat;
            fdbEntryIpv6UcFormatPtr->vrfId = 0;
            ...
            cpssOsMemSet(&fdbEntryIpv6UcFormatPtr->ucRouteInfo.fullFdbInfo,0,sizeof(fdbEntryIpv6UcFormatPtr->ucRouteInfo.fullFdbInfo));

            fdbEntryIpv6UcFormatPtr->ucRouteInfo.fullFdbInfo.dstInterface.type = CPSS_INTERFACE_PORT_E;
            fdbEntryIpv6UcFormatPtr->ucRouteInfo.fullFdbInfo.dstInterface.interfaceInfo.devPort.portNum = 1;
            fdbEntryIpv6UcFormatPtr->ucRouteInfo.fullFdbInfo.dstInterface.interfaceInfo.devPort.hwDevNum = 16;

            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[0] = (GT_U8)(NDprefix1 >> 24);
            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[1] = (GT_U8)(NDprefix1 >> 16);
            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[2] = (GT_U8)(NDprefix1 >>  8);
            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[3] = (GT_U8)(NDprefix1 >>  0);
            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[4] = (GT_U8)(NDprefix2 >> 24);
            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[5] = (GT_U8)(NDprefix2 >> 16);
            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[6] = (GT_U8)(NDprefix2 >>  8);
            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[7] = (GT_U8)(NDprefix2 >>  0);


            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[13] = ((i +step)/255/255)%255;
            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[14] = ((i +step)/255)%255;
            fdbEntryIpv6UcFormatPtr->ipv6Addr.arIP[15] = (i +step)%255;/*new ip */
        ...
        else
        {
            ...
            /*ARP*/
            cpssOsMemSet(&fdbEntry,0,sizeof(fdbEntry));
            fdbEntry.fdbEntryType = CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV4_UC_E;
            fdbEntryIpv4UcFormatPtr = &fdbEntry.format.fdbEntryIpv4UcFormat;
            fdbEntryIpv4UcFormatPtr->vrfId = 0;
            ...
            fdbEntryIpv4UcFormatPtr->ucRouteInfo.fullFdbInfo.dstInterface.interfaceInfo.devPort.portNum = 1;
            fdbEntryIpv4UcFormatPtr->ucRouteInfo.fullFdbInfo.dstInterface.interfaceInfo.devPort.hwDevNum = 16;

            fdbEntryIpv4UcFormatPtr->ipv4Addr.arIP[0] = (GT_U8)(NDprefix1 >> 24);
            fdbEntryIpv4UcFormatPtr->ipv4Addr.arIP[1] = (GT_U8)(NDprefix1 >> 16);
            fdbEntryIpv4UcFormatPtr->ipv4Addr.arIP[2] = (GT_U8)(NDprefix1 >>  8);

            fdbEntryIpv4UcFormatPtr->ipv4Addr.arIP[1] = ((i +step)/255/255)%255;
            fdbEntryIpv4UcFormatPtr->ipv4Addr.arIP[2] = ((i +step)/255)%255;
            fdbEntryIpv4UcFormatPtr->ipv4Addr.arIP[3] = (i +step)%255;/*new ip */
    ...
    for (errorNumItr = 0; errorNumItr<errorNum; errorNumItr++)
    {
        PRV_UTF_LOG3_MAC("After ADD testResult Error[Itr - %d] -[Err_No - %d]-[%s]\n",
                         errorNumItr,
                         testResultArray[errorNumItr],
                         debugErrorArr[testResultArray[errorNumItr]].errString);
    }

    cpssOsPrintf("ADD %d mac success %d, add %d nd success %d \n", numMAC,numEntriesOK, i, numEntriesNDOK );
...
static GT_STATUS my_test_cuckoo_init(GT_U32 fdbManagerId, GT_U32 numOfHashes)
{
    GT_U32                                                  maxTotalEntries;
    CPSS_DXCH_BRG_FDB_MANAGER_HW_CAPACITY_STC               fdb_hw_capacity;

    FDB_SIZE_FULL_INIT();

    cpssOsMemSet(&fdb_hw_capacity, 0, sizeof(fdb_hw_capacity));
    maxTotalEntries = _64K;
    fdb_hw_capacity.mode = CPSS_MAC_HASH_FUNC_CRC_MULTI_HASH_E;
    fdb_hw_capacity.numOfHashes = numOfHashes;
    fdb_hw_capacity.numOfHwIndexes = maxTotalEntries;

    /* create manager with device */
    createFdbManagerWithDevice(fdbManagerId, maxTotalEntries, prvTgfDevNum, &fdb_hw_capacity, GT_FALSE);
    cpssOsPrintf("FDB manager ID = %d, maxTotalEntries = %d, numOfHashes=%d\n", fdbManagerId, maxTotalEntries, numOfHashes);

    return GT_OK;
}


static GT_VOID prvCpssDxChFdbManagerMixedEntriesCuckooTest(GT_U32 orderSet, GT_U32 * retValPtr)
{
    GT_STATUS                                               st;
    GT_U32                                                  numEntriesRemoved;/* total number of entries removed from the DB */
    GT_U32                                                  numEntriesAdded;  /* total number of entries added to the DB */
    ...
    CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS_RESULT_ENT          testResultArray[CPSS_DXCH_BRG_FDB_MANAGER_DB_CHECKS___LAST___E];
    GT_U32                                                  errorNum, errorNumItr;
    GT_BOOL                                                 cuckooEnable = GT_TRUE;
    GT_U32                                                  ii;
    GT_U32                                                  secondsStart, secondsEnd,
                                                            nanoSecondsStart, nanoSecondsEnd,
                                                            seconds, nanoSec; /* time of init */
    CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_ENT                orderTypesArr[3] = {CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV4_UC_E, CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_UC_E, CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV4_MC_E};
    GT_U32                                                  orderTypeEntries[3] = {13107, 9830, 65536};

    CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_ENT                orderTypesArr1[3] = {CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_MC_E, CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_UC_E, CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV4_MC_E};
    GT_U32                                                  orderTypeEntries1[3] = {52428, 39321, 262144};

    CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_ENT                orderTypesArr2[3] = {CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_MC_E, CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_UC_E, CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_MAC_ADDR_E};
    GT_U32                                                  orderTypeEntries2[3] = {FDB_SIZE_FULL/4, FDB_SIZE_FULL/4, FDB_SIZE_FULL*5};

    CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_ENT                *orderTypesArrPtr = 0;
    GT_U32                                                  *orderTypeEntriesPtr = 0;
    ...
    if (orderSet < 4)
    {
        if (orderSet == 0)
        {
            ...
            for (ii = 0; ii < maxTotalEntries; ii++)
            {
                if ((ii % 1000) == 0)
                {
                    fdbEntryType = cpssOsRand() % 5;
                }

                st = prvTgfBrgFdbManagerAddEntries(fdbManagerId, 1, fdbEntryType, cuckooEnable, &numEntriesAdded);
                UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, st);
            }
        }
        else
        {
            dbCheckParam.countersCheckEnable = GT_TRUE;
            switch (orderSet)
            {
                case 1:
                    orderTypesArrPtr = orderTypesArr;
                    orderTypeEntriesPtr = orderTypeEntries;
                    break;
                case 2:
                    orderTypesArrPtr = orderTypesArr1;
                    orderTypeEntriesPtr = orderTypeEntries1;
                    break;
                case 3:
                    orderTypesArrPtr = orderTypesArr2;
                    orderTypeEntriesPtr = orderTypeEntries2;
                    break;
                default:
                    PRV_UTF_LOG0_MAC("Bad parameter\n");
                    return;
            }

            for (ii = 0; ii < 3; ii++)
            {
                fdbEntryType = orderTypesArrPtr[ii];
                st = prvTgfBrgFdbManagerAddEntries(fdbManagerId, orderTypeEntriesPtr[ii], fdbEntryType, cuckooEnable, &numEntriesAdded);
                UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, st);

                if (debug_limited_entries == numEntriesAdded)
                {
                    break;
                }
            }
    ...
    else
    {
        ...
        GT_U8 nx;
            GT_U32 rand32Bits;
        nx = orderSet == 4 ? 1 : 2;
        for(ii = 0; ii < maxTotalEntries+1; ii++ )
        {
            rand32Bits = cpssOsRand();
            fdbEntryType = (rand32Bits >> 2) % 5;
            if (fdbEntryType == CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV4_MC_E || fdbEntryType == CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV4_UC_E )
                 fdbEntryType = CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_MAC_ADDR_E;
            if (fdbEntryType == CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_MC_E)
                fdbEntryType = CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_UC_E;


            before = numEntriesAdded;
            st = prvTgfBrgFdbManagerAddEntries(fdbManagerId, nx, fdbEntryType, fdbEntryType == CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_MAC_ADDR_E ? GT_FALSE : GT_TRUE, &numEntriesAdded);
                UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, st);
            if(numEntriesAdded > before)
            {
                if(fdbEntryType == CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV6_UC_E)
                    v6x += numEntriesAdded - before;
                if(fdbEntryType == CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_IPV4_UC_E)
                    v4x += numEntriesAdded - before;
                if(fdbEntryType == CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_TYPE_MAC_ADDR_E)
                    macx += numEntriesAdded - before;
            }
        }
        PRV_UTF_LOG3_MAC("end add mac [%d] v4 [%d] v6 [%d] entries \n", macx, v4x, v6x);
    }

    HOW_MUCH_TIME(cpssDxChBrgFdbManagerEntryAdd, numEntriesAdded);

    PRV_UTF_LOG2_MAC("Total succeded [%d] entries (%d%%)\n",
                  numEntriesAdded, (100*numEntriesAdded)/maxTotalEntries);
    ...
    HOW_MUCH_TIME(cpssDxChBrgFdbManagerDatabaseCheck, numEntriesAdded);
    ...
    while(GT_OK == cpssDxChBrgFdbManagerEntryGetNext(fdbManagerId, getFirst, GT_FALSE, &entry))
    {
        ...
        if (st != GT_OK)
        {
            PRV_UTF_LOG3_MAC("cpssDxChBrgFdbManagerEntryDelete: entry number [%d], return code [%d], on manager [%d] \n",  numEntriesRemoved, st, fdbManagerId);
            if(retValPtr)
            {
                *retValPtr = 2;
            }
            ...
            fdbManagerPtr = MANAGER_GET_MAC(fdbManagerId);
            st = prvCpssDxChFdbManagerDbCalcHashAndLookupResult(fdbManagerPtr,&entry,NULL,&calcInfo);
            UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, st);

            st = prvCpssDxChBrgFdbManagerRehashInfoPrint(fdbManagerPtr, &entry, &calcInfo, 0, calcInfo.rehashStageBank);
            UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, st);

            st = prvCpssDxChFdbManagerDebugPrintStatistics(fdbManagerId);
            UTF_VERIFY_EQUAL0_PARAM_MAC(GT_OK, st);
    ...
    HOW_MUCH_TIME(cpssDxChBrgFdbManagerEntryDelete, numEntriesRemoved);
    ...
    for(errorNumItr = 0; errorNumItr<errorNum; errorNumItr++)
    {
        PRV_UTF_LOG3_MAC("After DELETE testResult Error[Itr - %d] -[Err_No - %d]-[%s]\n",
                errorNumItr,
                testResultArray[errorNumItr],
                debugErrorArr[testResultArray[errorNumItr]].errString);
    }

    HOW_MUCH_TIME(cpssDxChBrgFdbManagerDatabaseCheck, numEntriesRemoved);
}

GT_VOID wrPrvCpssDxChFdbManagerMixedEntriesCuckooTestExt
(
    GT_VOID
)
{
    ...
    while(retVal == 0)
    {
        prvCpssDxChFdbManagerMixedEntriesCuckooTest((orderSet + 4), &retVal);
        orderSet = (orderSet == 0) ? 1 : 0;
        iterNum++;
        PRV_UTF_LOG1_MAC("prvCpssDxChFdbManagerMixedEntriesCuckooTest: iteration [%d]) \n", iterNum);
    }

    HOW_MUCH_TIME(prvCpssDxChFdbManagerMixedEntriesCuckooTest, iterNum);

    return;
}

GT_VOID wrPrvCpssDxChFdbManagerMixedEntriesCuckooTest
(
    GT_U32 orderSet
)
{
    prvCpssDxChFdbManagerMixedEntriesCuckooTest(orderSet, NULL);

    return;
}

UTF_TEST_CASE_MAC(cpssDxChBrgFdbManager_mixed_entries_cuckooTest)
{
    PRV_TGF_NOT_SUPPORTED_DEV_CHECK_MAC(prvTgfDevNum, ~(UTF_CPSS_PP_ALL_SIP6_CNS | UTF_CPSS_PP_ALL_SIP5_CNS))

    prvCpssDxChFdbManagerMixedEntriesCuckooTest(0, NULL);

    CLEANUP_ALL_MANAGERS;
}

UTF_TEST_CASE_MAC(cpssDxChBrgFdbManager_mixed_entries_cuckoo_eight_hashes)
{
    GT_STATUS                                           st;
    GT_U32                                              fdbManagerId = TESTED_FDB_MANAGER_ID_CNS;
    ...
    prvWrAppDbEntryAdd("sharedTableMode", CPSS_DXCH_CFG_SHARED_TABLE_MODE_MID_HIGH_L3_MID_LOW_L2_NO_EM_MAX_ARP_E);
    ...
    */
    ...
    set_global_macEntryMuxingMode(CPSS_DXCH_BRG_FDB_MANAGER_MAC_ENTRY_MUXING_MODE_UDB_10_SRC_ID_1_DA_ACCESS_LEVEL_E);

    st = my_test_cuckoo_init(fdbManagerId, 8);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "my_test_cuckoo_init: GT_OK [%d]", fdbManagerId);

    st = AddingMacEntriesToFdb(fdbManagerId, 0x00120100, 0xfe800211, 0x01fffe00, 12000, 0, 0, 2, 0);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "AddingMacEntriesToFdb: GT_OK [%d]", fdbManagerId);

    restore_global_macEntryMuxingMode();

    /* Set default shared table mode */
    prvWrAppDbEntryAdd("sharedTableMode", CPSS_DXCH_CFG_SHARED_TABLE_MODE_MID_L3_MID_L2_MIN_EM_E);
...
void internal_cpssDxChBrgFdbManagerAgingScan_with_appDemo(void)
{
    ...
    if(counters.usedEntries != 0 &&
      (counters.usedEntries < (NUM_ENTRIES_STEPS_CNS*2)))
    {
        cpssOsPrintf("still hold [%d] entries (instead of ZERO) .. give it some more sleep",
            counters.usedEntries);

        /* the aging is still on going ... give it more time */
        cpssOsTimerWkAfter((agingTime / 2) * 1000);
        rc = cpssDxChBrgFdbManagerCountersGet(fdbManagerId, &counters);
        UTF_VERIFY_EQUAL0_STRING_MAC(GT_OK, rc, "cpssDxChBrgFdbManagerCountersGet: GT_OK");
    }
    #endif /* defined ASIC_SIMULATION && defined _LINUX */
...
)
{
    ...
    PRV_UTF_LOG3_MAC("Interrupt received for HW table [%d] index : 0x%x - portGroup 0x%x\n",
...
void internal_cpssDxChBrgFdbManagerEntryRewrite_SER(void)
{
    ...
    /* provide time to finish all related events after add entries */
    ...
    for(indexesNum = 0; indexesNum < numEntriesAdded; indexesNum++)
    {
        ...
        hwFdbEntryType = fdbManagerPtr->entryPoolPtr[indexesNum].hwFdbEntryType;
        PRV_UTF_LOG2_MAC("HW Index      :  %x - Entry Type (%d)\n",
                          indexesArray[indexesNum], hwFdbEntryType);
    }
    ...
    /* scan table by 16 entries. This guaranty read FDB RAMs only once during scan.
       And errors in same RAM will be detected properly by this scan. */
    scanEntries = 16;
    wasWrapAround = GT_FALSE;
    nextEntryIndex = 0xFFFFFFFF;

    while((wasWrapAround == GT_FALSE) && (nextEntryIndex >= 16))
    {
        ...
        /* provide time for context switching for interrupt/event tasks */
    ...
    rc = cpssDxChBrgFdbManagerEntryRewrite(fdbManagerId, indexesArray, numEntriesAdded);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, rc,
...
UTF_TEST_CASE_MAC(cpssDxChBrgFdbManagerEntryRewrite_SER)
{
    ...
    /* SER Test case if based on DI, and its not supported on some devices     */
    {
        GT_U8   dev;
        /* prepare device iterator */
        PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, ~(UTF_BOBCAT3_E | UTF_ALDRIN2_E | UTF_FALCON_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E));
        if (GT_OK != prvUtfNextDeviceGet(&dev, GT_TRUE))
        {
            /* the current running device is NOT in the supporting list */
            SKIP_TEST_MAC;
...
{
    /* AC5 and AAS - HYBRID is not supported */
    if((!PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum)) ||
        PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))
    {
        SKIP_TEST_MAC;
    }
    ...
    if(PRV_CPSS_SIP_7_CHECK_MAC(prvTgfDevNum))
    {
        /* Not hybrid defined/implemented for SIP7 devices with other devices */
        SKIP_TEST_MAC;
    }
...
/* Number of tested SP entries */
#define FDB_TEMP_ENTRIES_NUM    10

/* a comparison function to be passed into qsort */
static int compareIntMembersFunc(const void *elem0, const void *elem1)
{
    GT_U32 a = *((GT_U32 *)elem0);
    GT_U32 b = *((GT_U32 *)elem1);

    return (int)(a - b);
}

/* Get FDB SP entry status */
static GT_STATUS fdbManagerFdbSpEntryStatusGet
(
...
{
    GT_STATUS       st;
    GT_U32          hwDataArr[FDB_ENTRY_WORDS_SIZE_CNS];
    GT_U32          bitValue;

    /* get the entry from port group */
    st = prvCpssDxChPortGroupReadTableEntry(prvTgfDevNum, portGroupId, CPSS_DXCH_TABLE_FDB_E, hwIndex, hwDataArr);
    if(st != GT_OK)
    {
        return st;
    }
    ...
    /* Get SP entry bit  */
    prvCpssFieldValueGet(hwDataArr, spBit, 1, &bitValue);
    *isSpPtr = bitValue;

    /* Get valid bit */
    prvCpssFieldValueGet(hwDataArr, 0, 1, &bitValue);
    *isValidPtr = bitValue;

    if((*isValidPtr) == GT_TRUE &&
        PRV_CPSS_DXCH_PP_MAC(prvTgfDevNum)->bridge.fdbHashParams.hashMode !=
        CPSS_MAC_HASH_FUNC_CRC_MULTI_HASH_E)
    {
        /* support sip4 devices */

        /* Get skip bit */
        prvCpssFieldValueGet(hwDataArr, 1, 1, &bitValue);
        *isValidPtr = bitValue ? 0 /*skip entry, as 'not valid'*/: 1;
    }

    return GT_OK;
}

#define SIPx_FDB_START_BIT(_field)   \
        PRV_TABLE_FORMAT_INFO(prvTgfDevNum)[PRV_CPSS_DXCH_TABLE_FORMAT_FDB_E]. \
            fieldsInfoPtr[_field].startBit

/**
GT_STATUS cpssDxChBrgFdbManagerEntryTempGetNex
(
    IN GT_U32 fdbManagerId,
    IN GT_BOOL getFirst,
    INOUT GT_U32 *entryIndexPtr,
    IN GT_U32 indexesNumToCheck,
    OUT CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_STC *entryPtr,
    IN GT_BOOL deleteEntry
)
*/
static GT_VOID internal_cpssDxChBrgFdbManagerEntryTempGetNextUT(void)
{
    GT_STATUS                                           st;
    GT_U32                                              ii;
    GT_U32                                              fdbManagerId = TESTED_FDB_MANAGER_ID_CNS;
    ...
    GT_BOOL                                             getFirst;
    GT_U32                                              entryIndex;
    GT_U32                                              indexesNumToCheck;
    GT_BOOL                                             deleteEntry;
    GT_U32                                              numEntriesAdded = 0;
    GT_BOOL                                             entryAdded;
    UTF_PRV_CPSS_BRG_FDB_API_OUTPUT_RESULTS_INFO_STC    outputResults;
    GT_U32                                              maxTotalEntries;
    GT_U32                                              hwIndexArr[FDB_TEMP_ENTRIES_NUM+1];
    GT_U32                                              portGroupId  = 0;
    GT_U32                                              portGroupId1 = 0;
    GT_U32                                              hwDataArr[FDB_ENTRY_WORDS_SIZE_CNS];
    GT_U32                                              hwDataArr1[FDB_ENTRY_WORDS_SIZE_CNS];
    GT_BOOL                                             isValid;
    GT_BOOL                                             isSp;
    GT_U32                                              jj = 0;
    GT_U32                                              spBit;
    ...
    if(PRV_CPSS_SIP_6_CHECK_MAC(prvTgfDevNum))
    {
        spBit = SIPx_FDB_START_BIT(SIP6_FDB_FDB_TABLE_FIELDS_SP_UNKNOWN_E);
    }
    else
    if(PRV_CPSS_SIP_5_CHECK_MAC(prvTgfDevNum))
    {
        spBit = SIPx_FDB_START_BIT(SIP5_FDB_FDB_TABLE_FIELDS_SP_UNKNOWN_E);
    }
    else  /*sip4*/
    {
        spBit = 98;/*AC5,Lion2*/
    ...
    getFirst = GT_TRUE;
    entryIndex = 0;
    indexesNumToCheck = 0xFFFFFFFF;
    deleteEntry = GT_FALSE;

    outputResults.entryPtr                              = &entry;
    outputResults.entryAddedPtr                         = &entryAdded;

    PRV_UTF_LOG0_MAC("No valid FDB manager - expect 'GT_NOT_INITIALIZED'\n");
    for(ii = 0; ii < CPSS_DXCH_BRG_FDB_MANAGER_MAX_INSTANCE_NUM_CNS; ii++)
    {
        st = cpssDxChBrgFdbManagerEntryTempGetNext(ii, getFirst, &entryIndex, indexesNumToCheck, &entry, deleteEntry);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_NOT_INITIALIZED, st,
            "cpssDxChBrgFdbManagerEntryTempGetNext: expected to GT_NOT_INITIALIZED on manager [%d]", ii);
    }

    PRV_UTF_LOG0_MAC("Check out of range managers - expect 'GT_BAD_PARAM'\n");
    for(/*continue*/; ii < 100 ; ii+= 7)
    {
        st = cpssDxChBrgFdbManagerEntryTempGetNext(ii, getFirst, &entryIndex, indexesNumToCheck, &entry, deleteEntry);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PARAM, st,
            "cpssDxChBrgFdbManagerEntryTempGetNext: expected to GT_BAD_PARAM on manager [%d]", ii);
    }
    ...
    for(ii = 0; ii < maxTotalEntries; ii++)
    {
        ...
        if(entryAdded)
        {
            ...
            {
                jj = (ii/100) % 10;
                /* Store HW index in array */
                fdbManagerHwEntryIndexGet(&entry, &hwIndexArr[jj]);
            }
            else
            {
                if(jj == 9)
                {
                    /* Store last HW index in array */
                    fdbManagerHwEntryIndexGet(&entry, &hwIndexArr[++jj]);
                }
            }
        }
    ...
    PRV_UTF_LOG3_MAC("End - out of [%d] entries, succeeded [%d] entries (%d%%)\n",
        maxTotalEntries, numEntriesAdded,
            (100*numEntriesAdded)/maxTotalEntries);

    PRV_UTF_LOG0_MAC("Scan all HW entries and lookup SP entries - expect 'GT_NO_MORE\n");

    st = cpssDxChBrgFdbManagerEntryTempGetNext(fdbManagerId, getFirst, &entryIndex, indexesNumToCheck, NULL, deleteEntry);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_NO_MORE, st,
        "cpssDxChBrgFdbManagerEntryTempGetNext: expected to GT_NO_MORE on manager [%d]", fdbManagerId);

    PRV_UTF_LOG0_MAC("SP entries exist scenario (No 'Delete')\n");

    if (PRV_CPSS_PP_MAC(prvTgfDevNum)->multiPipe.numOfTiles > 1)
    {
        portGroupId = 1 * PRV_CPSS_PP_MAC(prvTgfDevNum)->multiPipe.numOfPipesPerTile;

        if(PRV_CPSS_PP_MAC(prvTgfDevNum)->multiPipe.numOfTiles > 2)
        {
            portGroupId1 = 2 * PRV_CPSS_PP_MAC(prvTgfDevNum)->multiPipe.numOfPipesPerTile;
        }
    }

    cpssOsQsort(hwIndexArr, FDB_TEMP_ENTRIES_NUM + 1, sizeof(GT_U32),  compareIntMembersFunc);

    for(ii = 0; ii < FDB_TEMP_ENTRIES_NUM; ii++)
    {
        PRV_UTF_LOG1_MAC("Invalidate entry at hwIndexArr[%d]\n", hwIndexArr[ii]);
        st = cpssDxChBrgFdbMacEntryInvalidate(prvTgfDevNum, hwIndexArr[ii]);
        UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st, "cpssDxChBrgFdbMacEntryInvalidate: %d, %d", prvTgfDevNum, hwIndexArr[ii]);

        /* Get entry per port group */
        st = prvCpssDxChPortGroupReadTableEntry(prvTgfDevNum, portGroupId, CPSS_DXCH_TABLE_FDB_E, hwIndexArr[ii], hwDataArr);
        UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st, "prvCpssDxChPortGroupReadTableEntry: %d, %d", prvTgfDevNum, hwIndexArr[0]);

        /* Set entry 'valid' - bit[0] and 'SP unknown' */
        prvCpssFieldValueSet(hwDataArr, 0, 1, 1);
        prvCpssFieldValueSet(hwDataArr, spBit, 1, 1);
            ...
            CPSS_MAC_HASH_FUNC_CRC_MULTI_HASH_E)
        {
            /* support sip4 devices */
            /* set 'skipBit' to be 0 */
            prvCpssFieldValueSet(hwDataArr, 1, 1, 0);
        }

        PRV_UTF_LOG2_MAC("Write SP entry to portGroupId[%d] at hwIndexArr[%d]\n", portGroupId, hwIndexArr[ii]);
        st = prvCpssDxChPortGroupWriteTableEntry(prvTgfDevNum, portGroupId, CPSS_DXCH_TABLE_FDB_E, hwIndexArr[ii], hwDataArr);
        UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st, "prvCpssDxChPortGroupWriteTableEntry: %d, %d", prvTgfDevNum, hwIndexArr[0]);

        if(portGroupId1)
        {
            if(ii % 3 == 0)
            {
                PRV_UTF_LOG2_MAC("Write SP entry to portGroupId1[%d] at hwIndexArr[%d]\n", portGroupId1, hwIndexArr[ii]);
                st = prvCpssDxChPortGroupWriteTableEntry(prvTgfDevNum, portGroupId1, CPSS_DXCH_TABLE_FDB_E, hwIndexArr[ii], hwDataArr);
                UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st, "prvCpssDxChPortGroupWriteTableEntry: %d, %d", prvTgfDevNum, hwIndexArr[0]);
            }
        }
    }
    ...
    if(PRV_CPSS_PP_MAC(prvTgfDevNum)->multiPipe.numOfTiles > 2)
    {
        /* Get HW entry per port group/HW index */
        st = prvCpssDxChPortGroupReadTableEntry(prvTgfDevNum, portGroupId, CPSS_DXCH_TABLE_FDB_E, hwIndexArr[ii], hwDataArr);
        UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st, "prvCpssDxChPortGroupReadTableEntry: %d, %d", prvTgfDevNum, hwIndexArr[0]);

        /* Save entry in HW format before modification */
        cpssOsMemCpy(hwDataArr1, hwDataArr, FDB_ENTRY_WORDS_SIZE_CNS * sizeof(GT_U32));

        /* Set entry 'SP unknown' and MACAddr[15:0] - bits[34:19] */
        prvCpssFieldValueSet(hwDataArr, spBit, 1, 1);
        prvCpssFieldValueSet(hwDataArr, 19, 16, 0xBAD0);

        PRV_UTF_LOG2_MAC("Write SP entry with invalid MAC to portGroupId1[%d] at hwIndexArr[%d] = 0x%x\n", portGroupId, hwIndexArr[ii]);
        st = prvCpssDxChPortGroupWriteTableEntry(prvTgfDevNum, portGroupId, CPSS_DXCH_TABLE_FDB_E, hwIndexArr[ii], hwDataArr);
        UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st, "prvCpssDxChPortGroupWriteTableEntry: %d, %d", prvTgfDevNum, hwIndexArr[ii]);
    }
    ...
    for(ii = 0; ii < FDB_TEMP_ENTRIES_NUM; ii++)
    {
        PRV_UTF_LOG2_MAC("Get SP [%s] entry HW index {%d}, expect SP valid entry \n",
                         (getFirst == GT_TRUE) ? "first" : "next",
                         hwIndexArr[ii]);

        st = cpssDxChBrgFdbManagerEntryTempGetNext(fdbManagerId, getFirst, &entryIndex, indexesNumToCheck, NULL, deleteEntry);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
            "cpssDxChBrgFdbManagerEntryTempGetNext: expected to GT_OK on manager [%d]", fdbManagerId);
        UTF_VERIFY_EQUAL2_STRING_MAC(hwIndexArr[ii], entryIndex,
            "Expected HW entry index: %d, %d", hwIndexArr[ii], entryIndex);

        /* Get and check status of SP entry per port group/HW index */
        st = fdbManagerFdbSpEntryStatusGet(portGroupId, entryIndex, &isValid, &isSp , spBit);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
            "fdbManagerFdbSpEntryVerify: expected to GT_OK on manager [%d]", fdbManagerId);
        UTF_VERIFY_EQUAL2_STRING_MAC(GT_TRUE, isValid,
            "Expected valid HW entry index [%d], port group [%d]", entryIndex, portGroupId);
        UTF_VERIFY_EQUAL2_STRING_MAC(GT_TRUE, isSp,
            "Expected SP HW entry index [%d], port group [%d]", entryIndex, portGroupId);
        ...
        if(ii % 3 == 0)
        {
            ...
            {
                /* Get and check status of SP entry per port group/HW index */
                st = fdbManagerFdbSpEntryStatusGet(portGroupId1, entryIndex, &isValid, &isSp , spBit);
                UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                    "fdbManagerFdbSpEntryVerify: expected to GT_OK on manager [%d]", fdbManagerId);
                UTF_VERIFY_EQUAL2_STRING_MAC(GT_TRUE, isValid,
                    "Expected valid HW entry index [%d], port group [%d]", entryIndex, portGroupId1);
                UTF_VERIFY_EQUAL2_STRING_MAC(GT_TRUE, isSp,
                    "Expected not SP HW entry index [%d], port group [%d]", entryIndex, portGroupId1);
            }
        }

        /* To make test happy  */
        entryIndex = (entryIndex == 0) ? entryIndex+1 : entryIndex;

        getFirst = GT_FALSE;
    }

    PRV_UTF_LOG0_MAC("SP entries exist scenario (With 'Delete')\n");

    /* Start from entry index 0 */
    entryIndex = 0;
    deleteEntry = GT_TRUE;
    ...
    for(ii = 0; ii < FDB_TEMP_ENTRIES_NUM; ii++)
    {
        PRV_UTF_LOG2_MAC("Get SP [%s] entry HW index {%d}, expect not valid entry \n",
                         (getFirst == GT_TRUE) ? "first" : "next",
                         hwIndexArr[ii]);

        st = cpssDxChBrgFdbManagerEntryTempGetNext(fdbManagerId, getFirst, &entryIndex, indexesNumToCheck, &entry, deleteEntry);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
            "cpssDxChBrgFdbManagerEntryTempGetNext: expected to GT_OK on manager [%d]", fdbManagerId);
        UTF_VERIFY_EQUAL2_STRING_MAC(hwIndexArr[ii], entryIndex,
            "Expected HW entry index: %d, %d", hwIndexArr[ii], entryIndex);
        ...
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
            "fdbManagerFdbSpEntryVerify: expected to GT_OK on manager [%d]", fdbManagerId);
        UTF_VERIFY_EQUAL2_STRING_MAC(GT_FALSE, isValid,
            "Expected not valid HW entry index [%d], port group [%d]", entryIndex, portGroupId);
        if(ii % 3 == 0)
        {
            if(portGroupId1)
            {
                ...
                UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                    "fdbManagerFdbSpEntryVerify: expected to GT_OK on manager [%d]", fdbManagerId);
                UTF_VERIFY_EQUAL2_STRING_MAC(GT_FALSE, isValid,
                    "Expected not valid HW entry index [%d], port group [%d]", entryIndex, portGroupId1);
            }
        }
    ...
    if(PRV_CPSS_PP_MAC(prvTgfDevNum)->multiPipe.numOfTiles > 2)
    {
        PRV_UTF_LOG1_MAC("Get SP next entry HW index {%d}, expect valid entry with original MAC\n",
                         hwIndexArr[ii]);
        ...
        /* Get HW entry per port group/HW index */
        st = prvCpssDxChPortGroupReadTableEntry(prvTgfDevNum, portGroupId, CPSS_DXCH_TABLE_FDB_E, hwIndexArr[ii], hwDataArr);
        UTF_VERIFY_EQUAL2_STRING_MAC(GT_OK, st, "prvCpssDxChPortGroupReadTableEntry: %d, %d", prvTgfDevNum, hwIndexArr[ii]);

        /* Compare entry in HW format after recovery */
        cpssOsMemCmp(hwDataArr1, hwDataArr, FDB_ENTRY_WORDS_SIZE_CNS * sizeof(GT_U32));
        UTF_VERIFY_EQUAL1_STRING_MAC(0, cpssOsMemCmp(
                                            hwDataArr1, hwDataArr,
                                            FDB_ENTRY_WORDS_SIZE_CNS * sizeof(GT_U32)),
            "prvCpssDxChPortGroupReadTableEntry : expected 'get' entry to match 'set' entry in manager [%d]",
            fdbManagerId);
    }
    ...
    while(GT_OK == cpssDxChBrgFdbManagerEntryGetNext(fdbManagerId, getFirst, GT_FALSE, &entry))
    {
        ...
        if (st != GT_OK)
        {
            ...
            UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
                "cpssDxChBrgFdbManagerEntryDelete: expected to GT_OK on manager [%d]", fdbManagerId);
        }
    }

    st = cpssDxChFdbDump(prvTgfDevNum);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChFdbDump: expected to GT_OK on manager [%d]", fdbManagerId);
}
...
*/
UTF_TEST_CASE_MAC(cpssDxChBrgFdbManagerEntryTempGetNext)
{
    /* this is device less API , check if we allow it to run on current device */
    DEVICE_LESS_API_SKIP_NON_APPLICABLE_DEVICE;
    ...
    internal_cpssDxChBrgFdbManagerEntryTempGetNextUT();

    CLEANUP_ALL_MANAGERS;
}

/**
1.      Create FDB Manager
2.      Add Dynamic MAC entry.
3.      Get it’s index – prvTgfBrgFdbMacEntryIndexFind
4.      Calculate hwTableEntryIndex for data_4 or data_5 or both
5.      Enable error injection
6.      Call cpssDxChDiagDataIntegrityTableEntryFix with hwTableEntryIndex and bit #31 set
a.      This will inject error
7.      Disable error injection
8.      Call cpssDxChBrgFdbManagerAgingScan
a.      Check that DI event/events arrived
9.      Call cpssDxChBrgFdbManagerEntryRewrite
10.     Call cpssDxChBrgFdbManagerAgingScan
11.     Check that NO DI event/events arrived
*/
#ifndef ASIC_SIMULATION
static void internal_cpssDxChBrgFdbManager_falcon_fix_sbm_4_5_integrity_error()
{
    GT_STATUS st;
    GT_U32    fdbManagerId = TESTED_FDB_MANAGER_ID_CNS;
    static CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_STC fdbEntry;
    static CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_ADD_PARAMS_STC   fdbEntryAddInfo;
    GT_U32   fdbEntryIndex;
    PRV_TGF_MAC_ENTRY_KEY_STC macEntryKey;
    GT_U32 hwTableEntryIndex;
    static CPSS_DXCH_LOCATION_SPECIFIC_INFO_STC memEntry;
    static CPSS_DXCH_LOCATION_SPECIFIC_INFO_STC location;
    static CPSS_DXCH_BRG_FDB_MANAGER_AGING_SCAN_PARAMS_STC ageScanParam;
    static CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_UPDATE_EVENT_STC entriesAgedoutArray[2];
    GT_U32 entriesAgedoutNum;
    ...
    PRV_UTF_LOG0_MAC("Unmask interrupts from the DFX.\n");
    cpssOsMemSet(&errorLocationInfo,0,sizeof(errorLocationInfo));
    cpssOsMemSet(indexesArray,0,sizeof(indexesArray));
    errorLocationInfo.portGroupsBmp                                                   = 0;
    errorLocationInfo.type                                                            = CPSS_DXCH_LOCATION_LOGICAL_INDEX_INFO_TYPE;
    ...
    errorLocationInfo.info.logicalEntryInfo.logicaTableInfo[0].logicalTableType       = CPSS_DXCH_LOGICAL_TABLE_FDB_E;
    errorLocationInfo.info.logicalEntryInfo.logicaTableInfo[0].logicalTableEntryIndex = 0;
    errorLocationInfo.info.logicalEntryInfo.logicaTableInfo[0].numEntries             = 0;
    st = cpssDxChDiagDataIntegrityEventMaskSet(
        prvTgfDevNum, &errorLocationInfo,
            CPSS_DIAG_DATA_INTEGRITY_ERROR_CAUSE_TYPE_PARITY_E,
            CPSS_EVENT_UNMASK_E);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChDiagDataIntegrityEventMaskSet: expected to GT_OK on manager [%d]",
        fdbManagerId);

    PRV_UTF_LOG0_MAC("Add Dynamic MAC entry.\n");
    fdbManagerEntryBuild_macAddr(&fdbEntry);
    fdbEntry.format.fdbEntryMacAddrFormat.isStatic = GT_FALSE;
    cpssOsMemSet(&fdbEntryAddInfo,0,sizeof(fdbEntryAddInfo));
    fdbEntryAddInfo.rehashEnable    = globalRehashEnable;
    fdbEntryAddInfo.tempEntryExist  = GT_FALSE;
    fdbEntryAddInfo.tempEntryOffset = 0;
    st = cpssDxChBrgFdbManagerEntryAdd(fdbManagerId, &fdbEntry, &fdbEntryAddInfo);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChBrgFdbManagerEntryAdd: expected to GT_OK on manager [%d]",
        fdbManagerId);

    PRV_UTF_LOG0_MAC("Get it’s index – prvTgfBrgFdbMacEntryIndexFind\n");
    cpssOsMemSet(&macEntryKey, 0, sizeof(macEntryKey));
    macEntryKey.entryType = PRV_TGF_FDB_ENTRY_TYPE_MAC_ADDR_E;
    macEntryKey.vid1 = fdbEntry.format.fdbEntryMacAddrFormat.vid1;
    cpssOsMemCpy(
        &macEntryKey.key.macVlan.macAddr.arEther,
        &fdbEntry.format.fdbEntryMacAddrFormat.macAddr.arEther,
        sizeof(macEntryKey.key.macVlan.macAddr.arEther));
    macEntryKey.key.macVlan.vlanId =
        fdbEntry.format.fdbEntryMacAddrFormat.fid;
    st = prvTgfBrgFdbMacEntryIndexFind(
        &macEntryKey, &fdbEntryIndex);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "prvTgfBrgFdbMacEntryIndexFind: expected to GT_OK on manager [%d]",
        fdbManagerId);

    PRV_UTF_LOG0_MAC("Calculate hwTableEntryIndex for data_4 or data_5 or both\n");
    hwTableEntryIndex =
        /* for SBM2 - in SBM0, for SBM3 - in SBM1*/
        (fdbEntryIndex % (fdbSize / 2))
        /* mark to use SBM 4 and 5 instead */
        | (1 << CPSS_DXCH_DIAG_DATA_INTEGRITY_INTERNAL_RAM_FLAG_BIT_CNS);
    PRV_UTF_LOG3_MAC(
        "fdbSize 0x%X fdbEntryIndex 0x%X  hwTableEntryIndex 0x%X \n",
        fdbSize, fdbEntryIndex, hwTableEntryIndex);

    PRV_UTF_LOG0_MAC("Enable error injection\n");
    ...
    memEntry.info.ramEntryInfo.ramRow = 0;
    st = cpssDxChDiagDataIntegrityErrorInjectionConfigSet(
        prvTgfDevNum, &memEntry,
        CPSS_DIAG_DATA_INTEGRITY_ERROR_INJECT_MODE_SINGLE_E /*injectMode*/,
        GT_TRUE /*injectEnable*/);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChDiagDataIntegrityErrorInjectionConfigSet: expected to GT_OK on manager [%d]",
        fdbManagerId);

    PRV_UTF_LOG0_MAC("Call cpssDxChDiagDataIntegrityTableEntryFix with hwTableEntryIndex and bit #31 set\n");
    ...
    location.info.hwEntryInfo.hwTableType = CPSS_DXCH_TABLE_FDB_E;
    location.info.hwEntryInfo.hwTableEntryIndex = hwTableEntryIndex;
    st = cpssDxChDiagDataIntegrityTableEntryFix(
        prvTgfDevNum, &location);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChDiagDataIntegrityTableEntryFix: expected to GT_OK on manager [%d]",
        fdbManagerId);

    PRV_UTF_LOG0_MAC("Disable error injection\n");
    cpssOsMemSet(&memEntry, 0, sizeof(memEntry));
    memEntry.type = CPSS_DXCH_LOCATION_RAM_INDEX_INFO_TYPE;
    memEntry.info.ramEntryInfo.memType =
        CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SHM_TYPE2_SBM_DATA_E;
    ...
    st = cpssDxChDiagDataIntegrityErrorInjectionConfigSet(
        prvTgfDevNum, &memEntry,
        CPSS_DIAG_DATA_INTEGRITY_ERROR_INJECT_MODE_SINGLE_E /*injectMode*/,
        GT_FALSE /*injectEnable*/);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChDiagDataIntegrityErrorInjectionConfigSet: expected to GT_OK on manager [%d]",
        fdbManagerId);

    PRV_UTF_LOG0_MAC("Cleanup hwInfoEventErrorHandlerFunc DB \n");
    indexesNum = 0;
    cpssOsMemSet(indexesArray,0,sizeof(indexesArray));

    PRV_UTF_LOG0_MAC("Call cpssDxChBrgFdbManagerAgingScan\n");
    cpssOsMemSet(&ageScanParam, 0, sizeof(ageScanParam));
    ageScanParam.checkAgeMacUcEntries           = GT_TRUE;
    ageScanParam.checkAgeMacMcEntries           = GT_TRUE;
    st = cpssDxChBrgFdbManagerAgingScan(
        fdbManagerId, &ageScanParam, entriesAgedoutArray, &entriesAgedoutNum);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChBrgFdbManagerAgingScan: expected to GT_OK on manager [%d]",
        fdbManagerId);

    /* Waiting for the events to come and populate the index array */
    cpssOsTimerWkAfter(1000);

    PRV_UTF_LOG0_MAC("Check that DI event/events arrived\n");
    UTF_VERIFY_NOT_EQUAL0_STRING_MAC(
        0, indexesNum, "expected not zero");

    PRV_UTF_LOG0_MAC("Call cpssDxChBrgFdbManagerEntryRewrite\n");
    st = cpssDxChBrgFdbManagerEntryRewrite(
        fdbManagerId,
        &hwTableEntryIndex, /* arrSizeVarName=entriesIndexesNum */
        1 /*entriesIndexesNum*/);
    UTF_VERIFY_EQUAL1_STRING_MAC(GT_OK, st,
        "cpssDxChBrgFdbManagerEntryRewrite: expected to GT_OK on manager [%d]",
        fdbManagerId);
    ...
    PRV_UTF_LOG0_MAC("Check that NO DI event/events arrived\n");
    UTF_VERIFY_EQUAL0_STRING_MAC(
        0, indexesNum, "expected zero");
}
#endif /*no ASIC_SIMULATION*/

UTF_TEST_CASE_MAC(cpssDxChBrgFdbManager_falcon_fix_sbm_4_5_integrity_error)
{
#ifdef ASIC_SIMULATION
    SKIP_TEST_MAC;
#else
    ...
    PRV_UTF_LOG0_MAC("Substitute dxChDataIntegrityEventIncrementFunc\n");
    savedDataIntegrityHandler              = dxChDataIntegrityEventIncrementFunc;
    dxChDataIntegrityEventIncrementFunc    = hwInfoEventErrorHandlerFunc;
    internal_cpssDxChBrgFdbManager_falcon_fix_sbm_4_5_integrity_error();
    PRV_UTF_LOG0_MAC("Restore dxChDataIntegrityEventIncrementFunc\n");
    dxChDataIntegrityEventIncrementFunc = savedDataIntegrityHandler;
    PRV_UTF_LOG0_MAC("CLEANUP_ALL_MANAGERS\n");
    CLEANUP_ALL_MANAGERS;
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssDxChBridgeFdbManager)
    ...
    /* get next SP entry */
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChBrgFdbManagerEntryTempGetNext)

    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChBrgFdbManager_mixed_entries_cuckooTest)

    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChBrgFdbManager_mixed_entries_cuckoo_eight_hashes)
    ...
    /* data integrity Falcon specific case */
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxChBrgFdbManager_falcon_fix_sbm_4_5_integrity_error)

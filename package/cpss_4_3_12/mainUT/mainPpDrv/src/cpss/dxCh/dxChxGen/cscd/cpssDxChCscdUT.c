...
*/
    ...
    CPSS_CSCD_PORT_TYPE_ENT portType    = CPSS_CSCD_PORT_DSA_MODE_1_WORD_E;

    CPSS_CSCD_PORT_TYPE_ENT portTypeGet = CPSS_CSCD_PORT_DSA_MODE_1_WORD_E;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        while (GT_OK == prvUtfNextMacPortGet(&utPhysicalPort, GT_TRUE))
        {
            ...
            */
            ...
            portType = CPSS_CSCD_PORT_DSA_MODE_1_WORD_E;
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        mode = CPSS_DXCH_DEV_MAP_LOOKUP_MODE_TRG_DEV_TRG_PORT_E;
        targetHwDevNum = PRV_CPSS_SIP_7_CHECK_MAC(dev) ? BIT_7 :
            PRV_CPSS_SIP_5_CHECK_MAC(dev) ? BIT_6 : BIT_5;
        ...
        */
        mode = CPSS_DXCH_DEV_MAP_LOOKUP_MODE_TRG_DEV_SRC_DEV_E;
        targetHwDevNum = PRV_CPSS_SIP_7_CHECK_MAC(dev) ? BIT_8 :
                         PRV_CPSS_SIP_5_CHECK_MAC(dev) ? BIT_7 : BIT_5;
...
UTF_TEST_CASE_MAC(cpssDxChCscdQosTcDpRemapTableSet)
{
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        tcDpMappings.isStack         = CPSS_DXCH_PORT_PROFILE_CSCD_E;
        tcDpMappings.tc              = 5;
                ...
                for (j = 0; j < sizeof(trgProfileArr)/sizeof(trgProfileArr[0]); j++)
                {
                    if (PRV_CPSS_SIP_6_CHECK_MAC(dev))
                    {
                     ...
                     else
                     {
                        ...
                        if(!TXQ_IS_PREEMPTIVE_DEVICE(dev))
                        {
                           continue;
                        }
...
*/
    ...
    CPSS_PORT_DIRECTION_ENT directionArr[] = {CPSS_PORT_DIRECTION_RX_E,
                                              CPSS_PORT_DIRECTION_TX_E,
                                              CPSS_PORT_DIRECTION_BOTH_E};
    CPSS_DXCH_PORT_PROFILE_ENT profileArr[] =
    {

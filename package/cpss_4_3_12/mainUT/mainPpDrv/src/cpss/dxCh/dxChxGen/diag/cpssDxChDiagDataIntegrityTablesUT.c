...
#if (!defined(CPSS_APP_PLATFORM_REFERENCE) || defined(MIXED_MODE)) && defined(IMPL_GALTIS)
...
typedef enum {
    ...
    /** all events need to be checked. But dfx row and HW index
     *  are not captured by HW because of erratum and need not
     *  to compare them with expected results  */
    PRV_DATA_INTEGRITY_EVENT_MATCH_TYPE_ALL_NO_INDEX_E
...
)
{
    ...
    if (traceEvents > 1)
    {
        ...
        PRV_UTF_LOG2_MAC("                     Instance type %d, id %d\n",
                         eventPtr->location.ramEntryInfo.memLocation.dfxInstance.dfxInstanceType,
                         eventPtr->location.ramEntryInfo.memLocation.dfxInstance.dfxInstanceIndex);
...
)
{
    ...
    for (i = 0; i< occuredEvents.eventsCount && !failed; i++)
    {
        ...
        if (PRV_DATA_INTEGRITY_EVENT_MATCH_TYPE_ALL_NO_INDEX_E == matchType)
        {
            /* do not compare indexes for such RAMs */
        ...
        switch (matchType)
        {
            ...
            case PRV_DATA_INTEGRITY_EVENT_MATCH_TYPE_ALL_NO_INDEX_E:
...
*/
    ...
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_XCAT3_E | UTF_LION2_E | UTF_AAS_E);
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(dev, portGroupId)
        {
            ...
            */
            ...
            numOfEntries = PRV_CPSS_ACCESS_TABLE_INFO_PTR(dev)[hwTableType].maxNumOfEntries;
...
)
{
    ...
    CMD_DXCH_DIAG_DATA_INTEGRITY_COUNTER_DB_STC * dbEventCounterPtr = NULL;
#ifdef CPSS_APP_PLATFORM_REFERENCE
    if (cpssAppPlatformInitialized == GT_TRUE) {
        dbEventCounterPtr = appRefDxChDiagDataIntegrityCountersDbGet();
    }
#endif /*CPSS_APP_PLATFORM_REFERENCE*/

#if !defined(CPSS_APP_PLATFORM_REFERENCE) || defined(MIXED_MODE)
    if (cpssAppPlatformInitialized == GT_FALSE) {
        dbEventCounterPtr = wrCpssDxChDiagDataIntegrityCountersDbGet();
    }
#endif
...
#endif /*CPSS_APP_PLATFORM_REFERENCE*/
#endif /*defined(CPSS_APP_PLATFORM_REFERENCE) || defined(IMPL_GALTIS)*/

#if (!defined(CPSS_APP_PLATFORM_REFERENCE) && !defined(IMPL_GALTIS)) || defined(MIXED_MODE)
    if (cpssAppPlatformInitialized == GT_FALSE)
    {
        (void)memTypeExp;
        (void)entryIndex;
...
#endif /*(!defined(CPSS_APP_PLATFORM_REFERENCE) && !defined(IMPL_GALTIS)) || defined(MIXED_MODE)*/
    return GT_NOT_FOUND;
}
...
#endif /*(!defined(CPSS_APP_PLATFORM_REFERENCE) || defined(MIXED_MODE)) && defined(IMPL_GALTIS))*/
    return;
}
    ...
    if (rc != GT_OK)
    {
        ...
        else if (rc == GT_NOT_FOUND)
        {
            if (((tableType >= CPSS_DXCH_SIP6_TXQ_PDS_DATA_STORAGE_E) &&
                ...
                ((tableType >= CPSS_DXCH_SIP6_30_TABLE_TXQ_PDS_NEXT_DESC_E) &&
                (tableType <= CPSS_DXCH_SIP6_30_TABLE_TXQ_PDS_READ_POINTER_E)))
            {
            ...
            switch (tableType)
            {
                ...
                /* tables are implemented as registers. there is no protection for it. */
                case CPSS_DXCH_SIP5_TABLE_BRIDGE_SOURCE_TRUNK_ATTRIBUTE_E:
                case CPSS_DXCH_SIP5_TABLE_EQ_TX_PROTECTION_E:
                case CPSS_DXCH_SIP5_TABLE_IPVX_ROUTER_NEXTHOP_AGE_BITS_E:
                case CPSS_DXCH_SIP5_TABLE_INGRESS_POLICER_0_IPFIX_ALERT_WRAPAROUND_E:
                case CPSS_DXCH_SIP5_TABLE_INGRESS_POLICER_1_IPFIX_ALERT_WRAPAROUND_E:
                case CPSS_DXCH_SIP5_TABLE_EGRESS_POLICER_IPFIX_ALERT_WRAPAROUND_E:
                case CPSS_DXCH_SIP5_TABLE_INGRESS_POLICER_0_IPFIX_ALERT_AGING_E:
                case CPSS_DXCH_SIP5_TABLE_INGRESS_POLICER_1_IPFIX_ALERT_AGING_E:
                case CPSS_DXCH_SIP5_TABLE_EGRESS_POLICER_IPFIX_ALERT_AGING_E:
                ...
                case CPSS_DXCH_SIP6_TABLE_INGRESS_POLICER_0_PORT_ATTRIBUTE_TABLE_E:
                case CPSS_DXCH_SIP6_TABLE_INGRESS_POLICER_1_PORT_ATTRIBUTE_TABLE_E:
                case CPSS_DXCH_SIP6_TABLE_PREQ_CNC_PORT_MAPPING_E:
                case CPSS_DXCH_SIP6_10_TABLE_INGRESS_POLICER_0_IPFIX_FIRST_N_PACKETS_E:
                case CPSS_DXCH_SIP6_10_TABLE_INGRESS_POLICER_1_IPFIX_FIRST_N_PACKETS_E:
                case CPSS_DXCH_SIP6_10_TABLE_EGRESS_POLICER_IPFIX_FIRST_N_PACKETS_E:
                case CPSS_DXCH_SIP6_30_TABLE_IPCL0_UDB_REPLACEMENT_E:
                case CPSS_DXCH_SIP6_30_TABLE_IPCL1_UDB_REPLACEMENT_E:
                case CPSS_DXCH_SIP6_30_TABLE_TXQ_PDS_WRITE_POINTER_E:
                case CPSS_DXCH_SIP6_30_TABLE_TXQ_PDS_READ_POINTER_E:
                case CPSS_DXCH_SIP6_30_TABLE_PREQ_SRF_ZERO_BIT_VECTOR_0_E:
                case CPSS_DXCH_SIP6_30_TABLE_PREQ_SRF_ZERO_BIT_VECTOR_1_E:
                    if(PRV_CPSS_DXCH_IRONMAN_CHECK_MAC(devNum))
                    {
                        return GT_NOT_IMPLEMENTED;
                    }
                    break;
                ...
                case CPSS_DXCH_SIP6_TABLE_PREQ_TARGET_PHYSICAL_PORT_E:
                    if(PRV_CPSS_DXCH_FALCON_CHECK_MAC(devNum) || PRV_CPSS_DXCH_IRONMAN_CHECK_MAC(devNum))
                    {
                        return GT_NOT_IMPLEMENTED;
                    }
                    break;
                ...
                case CPSS_DXCH_SIP6_15_TXQ_SDQ_PORT_PFC_STATE_E:
                    ...
                    if(PRV_CPSS_DXCH_AC5X_CHECK_MAC(devNum) || PRV_CPSS_DXCH_AC5P_CHECK_MAC(devNum) ||
                       PRV_CPSS_DXCH_HARRIER_CHECK_MAC(devNum) || PRV_CPSS_DXCH_IRONMAN_CHECK_MAC(devNum))
                    {
                        return GT_NOT_IMPLEMENTED;
                    }
                    break;
                ...
                case CPSS_DXCH_XCAT_TABLE_EGRESS_POLICER_REMARKING_E:
                    /* tables are implemented as registers. there is no protection for it. */
                    if(PRV_CPSS_DXCH_AC5_CHECK_MAC(devNum) || PRV_CPSS_DXCH_IRONMAN_CHECK_MAC(devNum))
                    {
                        return GT_NOT_IMPLEMENTED;
                    }
                    break;
                case CPSS_DXCH_SIP5_TABLE_TTI_QOS_MAP_DSCP_TO_QOS_PROFILE_E:
                    /* tables are implemented as registers. there is no protection for it. */
                    if(PRV_CPSS_DXCH_HARRIER_CHECK_MAC(devNum) || PRV_CPSS_DXCH_IRONMAN_CHECK_MAC(devNum))
                    {
                        return GT_NOT_IMPLEMENTED;
                    }
                    break;
...
*/
    ...
    {
        lastTableType =
            PRV_CPSS_SIP_6_30_CHECK_MAC(dev) ? CPSS_DXCH_SIP6_30_TABLE_LAST_E :
        ...
        for(tableType = CPSS_DXCH_TABLE_VLAN_PORT_PROTOCOL_E; tableType < lastTableType; tableType++)
        {
            ...
            for (i = 0; i < 3; i++)
            {
                ...
                else if (tableType == CPSS_DXCH_SIP6_30_TABLE_SMU_IRF_COUNTING_E)
                {
                    /* This is Read Only Clear on read memory.
                       Read operation writes zero to it and insert error. */
                    st = prvCpssDxChPortGroupReadTableEntry(
                        dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS,
                        tableType, entryIndex, &readEntryBuf[0]);
                }
...
UTF_TEST_CASE_MAC(cpssDxChDiagDataIntegrityTableScan_1)
{
    ...
    /* prepare device iterator */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&devNum, UTF_XCAT3_E | UTF_LION2_E | UTF_AAS_E);
    ...
    while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
    {
        ...
        for(ii = 0 ; ii < CPSS_DXCH_LOGICAL_TABLE_LAST_E; ii++)
        {
            ...
            logicalInfoPtr->logicalTableEntryIndex =
                nextEntryIndex;
            if (global_maxTableSize <= 5)
            {
                /* need to increment number of entries to get wraparound */
                logicalInfoPtr->numEntries += 1;
                numOfEntries++;
            }
            rc = cpssDxChDiagDataIntegrityTableScan(devNum,&specificLocation,
...
GT_VOID cpssDxChDiagDataIntegrityTables_cleanup_withSystemReset(GT_VOID)
{
    ...
    /* AAS does not support DI yet */
    if (PRV_CPSS_DXCH_AAS_CHECK_MAC(prvTgfDevNum))
    {
        SKIP_TEST_MAC;
    }
...
static SPECIAL_COMPARE_BITS_STC special_compareBitsArr[] = {
    ...
    ,{CPSS_DXCH_SIP5_TABLE_EGRESS_EGF_QAG_EGRESS_VLAN_E,    /* non valid : 48..63 */
      UTF_BOBCAT3_E | UTF_ALDRIN2_E | UTF_FALCON_E | UTF_AC5X_E | UTF_AC5P_E | UTF_HARRIER_E | UTF_IRONMAN_L_E,
    ...
    ,{CPSS_DXCH_SIP6_30_TABLE_SMU_IRF_SNG_E, /* only bits 1,16,17 may be changed by test  */
      UTF_ALL_FAMILY_E,
      {0x60001, 0x0}}
    ,{CPSS_DXCH_SIP6_30_TABLE_PREQ_SRF_CONFIG_E, /* only bits 0..10,60-73 may be changed by test  */
      UTF_ALL_FAMILY_E,
      {0x80007FF, 0xF0000000, 0x3FF }}
...
)
{
    ...
    if(PRV_CPSS_DXCH_IRONMAN_CHECK_MAC(dev) &&
       ((*tableTypePtr == CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E) ||
        (*tableTypePtr == CPSS_DXCH_SIP6_TABLE_LMU_STATISTICS_E) ||
        (*tableTypePtr == CPSS_DXCH_SIP6_TABLE_LMU_CONFIGURATION_E) ||
        (*tableTypePtr == CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E)))
    {
        /* IronMan has erratum DFXTABLES-4490 and erroneous row is not
           captured by device. DFX row is always 0 and HW index is wrong. */
        *matchTypePtr = PRV_DATA_INTEGRITY_EVENT_MATCH_TYPE_ALL_NO_INDEX_E;
        return;
    }

    /* init OUT parameter to avoid warnings */
...
static GT_U32 portGroupToTest = CPSS_PORT_GROUP_UNAWARE_MODE_CNS;
GT_U32 utfErrorInjectPortGroupSet(GT_U32 newPortGroup)
{
    GT_U32 oldValue = portGroupToTest;
    portGroupToTest = newPortGroup;
    return oldValue;
}
...
*/
    ...
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_LION2_E | UTF_XCAT3_E | UTF_AAS_E);
        ...
        for (tabIter=0; tabIter< eventsPtr->eventsInfo[eventsIter].numOfLogicalTables; tabIter++)
        {
            ...
            switch (logicalPtr->logicalTableType)
            {
                case CPSS_DXCH_LOGICAL_TABLE_ARP_E:
                     ...
                     * AC5X, Harrier and IronMan use two memories for each HW entry. Each memory holds 4 ARPs. */
                    expectedNumEntries = (PRV_CPSS_DXCH_AC5X_CHECK_MAC(dev) || PRV_CPSS_DXCH_HARRIER_CHECK_MAC(dev) ||
                                          PRV_CPSS_DXCH_IRONMAN_CHECK_MAC(dev)) ? 4 :
...
*/
    ...
    meteringEntry.modifyUp                          = CPSS_DXCH_POLICER_MODIFY_UP_DISABLE_E;
            ...
            for (pgIndex = 0; pgIndex < PORT_GROUPS_NUM_CNS; pgIndex++)
            {
                ...
                switch (memType)
                {
                    case CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CNC_COUNTERS_E:
                        ...
                        break;
                    case CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PCL_CONFIG_E:
                        expectArr = (PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.pcl.iPcl0Bypass == GT_FALSE) ?
                            prvExpect_HW_tbl_for_CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PCL_CONFIG_E :
                            prvExpect_sip6_HW_tbl_for_CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PCL_CONFIG_E;
                        break;
                    case CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_IPFIX_AGING_E:

...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        /*
            1.3. Call function with cmd [CPSS_PACKET_CMD_DROP_SOFT_E] (supported in case of SIP5 devices).
            Expected: NOT GT_OK.
        */
        cmd = CPSS_PACKET_CMD_DROP_SOFT_E;
        st = cpssDxChBrgGenIpV6SolicitedCmdSet(dev, cmd);
        ...
        /*
            1.4. Call function with cmd [CPSS_PACKET_CMD_DROP_HARD_E] (supported in case of SIP5 devices).
            Expected: NOT GT_OK.
        */
        cmd = CPSS_PACKET_CMD_DROP_HARD_E;
        st = cpssDxChBrgGenIpV6SolicitedCmdSet(dev, cmd);
...
*/
    ...
    /* prepare device iterator */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_LION2_E | UTF_AAS_E | UTF_CPSS_PP_E_ARCH_CNS);

...
*/
    ...
    */
    ...
    if ((tmpShadowType == CPSS_DXCH_IP_LPM_RAM_SIP5_SHADOW_E) ||
        ...
        (tmpShadowType == CPSS_DXCH_IP_LPM_RAM_SIP7_SHADOW_E))
    {
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        if(PRV_CPSS_SIP_7_CHECK_MAC(dev))
        {
            ...
            st = cpssDxChIpLpmDBCreate(lpmDBId, CPSS_DXCH_IP_LPM_RAM_SIP7_SHADOW_E, CPSS_IP_PROTOCOL_IPV4V6_E, &lpmMemoryCfg);
        ...
        */
        ...
        if (firstDev==GT_TRUE)
        {
            ...
            */
            ...
            lpmDBId = 0;
            /* in sip7 Increase the VRF-ID trie-root mapping to from 4K (12bits) to 32K(15bits) */
            ...
            if (prvUtfIsPbrModeUsed())
            {
                ...
                */
                ...
                /*
                    ...
                    Expected: NON GT_OK.
                */
                vrConfigInfo.defIpv4UcNextHopInfo.pclIpUcAction.policer.policerEnable = CPSS_DXCH_PCL_POLICER_ENABLE_METER_AND_COUNTER_E;
                ...
                vrConfigInfo.defIpv4UcNextHopInfo.pclIpUcAction.policer.policerEnable = CPSS_DXCH_PCL_POLICER_DISABLE_ALL_E;
                vrConfigInfo.defIpv4UcNextHopInfo.pclIpUcAction.policer.policerId     = 0;

                vrConfigInfo.defIpv6UcNextHopInfo.pclIpUcAction.policer.policerEnable = CPSS_DXCH_PCL_POLICER_ENABLE_METER_AND_COUNTER_E;
                ...
                vrConfigInfo.defIpv6UcNextHopInfo.pclIpUcAction.policer.policerEnable = CPSS_DXCH_PCL_POLICER_DISABLE_ALL_E;
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        while (GT_OK == prvUtfNextDeviceGet(&devNum, GT_TRUE))
        {
            ...
            {
                prvUtfSetDefaultIpLttEntry(devNum, &nextHopInfo.ipLttEntry);
            }
    ...
    */
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        cpssOsMemSet(&ipGroup, 0, sizeof(ipGroup));
        cpssOsMemSet(&ipSrc, 0, sizeof(ipSrc));
...
)
{
    ...
    pclActionPtr->egressPolicy     = CPSS_PCL_DIRECTION_INGRESS_E;
    ...
    pclActionPtr->policer.policerEnable = CPSS_DXCH_PCL_POLICER_DISABLE_ALL_E;

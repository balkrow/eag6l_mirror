...
*/
    ...
    /* prepare device iterator */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_CH1_E | UTF_CH1_DIAMOND_E | UTF_CH2_E | UTF_AAS_E);
...
*/
    ...
    /* prepare device iterator */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_CH1_E | UTF_CH1_DIAMOND_E | UTF_CH2_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E);
...
UTF_TEST_CASE_MAC(cpssDxCh3PolicerEntryMeterParamsCalculate_CheckRanges)
{
    ...
    PRV_TGF_APPLIC_DEV_RESET_MAC(
        &dev, (UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E));
...
*/
    ...
    /* prepare device iterator */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_CH1_E | UTF_CH1_DIAMOND_E | UTF_CH2_E | UTF_CH3_E | UTF_AC5P_E | UTF_AC5X_E | UTF_HARRIER_E | UTF_IRONMAN_L_E | UTF_AAS_E);
...
*/
    ...
    entrySet.modifyUp      = CPSS_DXCH_POLICER_MODIFY_UP_DISABLE_E;
    entrySet.modifyDscp    = CPSS_DXCH_POLICER_MODIFY_DSCP_DISABLE_E;
...
*/
    ...
    /* prepare device iterator */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_CH1_E | UTF_CH1_DIAMOND_E | UTF_CH2_E | UTF_CH3_E | UTF_XCAT2_E | UTF_AAS_E);
...
/*33*/    {GT_FAIL, 0, 0, 0},
/*34*/    {GT_OK, 90, 524280, 100000},
/*35*/    {GT_FAIL, 0, 0, 0},
/*36*/    {GT_OK, 90, 524280, 100000},
...
/*22*/    {GT_OK, 20, 400000, 100000},
/*23*/    {GT_FAIL, 0, 0, 0},
/*24*/    {GT_OK, 21, 262140, 100000},
/*25*/    {GT_FAIL, 0, 0, 0},
/*26*/    {GT_OK, 21, 262140, 100000},
/*27*/    {GT_OK, 20, 400000, 100000},

/*28*/    {GT_FAIL, 0, 0, 0},
/*29*/    {GT_OK, 29, 262140, 100000},
/*30*/    {GT_FAIL, 0, 0, 0},
/*31*/    {GT_OK, 29, 262140, 100000},
/*32*/    {GT_OK, 30, 400000, 100000},
...
*/
    ...
    /* prepare iterator for go over all active devices */
    PRV_TGF_NOT_APPLIC_DEV_RESET_MAC(&dev, UTF_XCAT3_E | UTF_AC5_E | UTF_LION2_E | UTF_AAS_E);
...
*/
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        ...
        index = PRV_CPSS_SIP_7_CHECK_MAC(dev)? 7 : 1;
        enable = GT_TRUE;
...
*/
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        */
        meterMaxSize = PRV_CPSS_DXCH_PP_MAC(dev)->fineTuning.tableSize.policersNum;

        memoryCfg.numMeteringEntries[0] = meterMaxSize + 1;
        st = cpssDxChPolicerMemorySizeSet(dev, &memoryCfg);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PARAM, st, dev);
        ...
        */
        memoryCfg.numMeteringEntries[0] = 10;
        memoryCfg.numMeteringEntries[1] = meterMaxSize + 1;
        st = cpssDxChPolicerMemorySizeSet(dev, &memoryCfg);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PARAM, st, dev);
        ...
        */
        memoryCfg.numMeteringEntries[1] = 20;
        memoryCfg.numMeteringEntries[2] = meterMaxSize + 1;
        st = cpssDxChPolicerMemorySizeSet(dev, &memoryCfg);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PARAM, st, dev);
        ...
        */
        memoryCfg.numMeteringEntries[2] = 50;
        memoryCfg.numMeteringEntries[0] = meterMaxSize/2;
        memoryCfg.numMeteringEntries[1] = (meterMaxSize/2) + 1;
        st = cpssDxChPolicerMemorySizeSet(dev, &memoryCfg);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PARAM, st, dev);
        ...
        /*
           ...
           Expected: GT_BAD_PARAM and the same value.
        */
        memoryCfg.numMeteringEntries[2] = (meterMaxSize/2) + 1;
        memoryCfg.numMeteringEntries[0] = (meterMaxSize/2);
        memoryCfg.numMeteringEntries[1] = 20;
        st = cpssDxChPolicerMemorySizeSet(dev, &memoryCfg);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PARAM, st, dev);
        ...
        /*
           ...
           Expected: GT_BAD_PARAM and the same value.
        */
        memoryCfg.numMeteringEntries[2] = (meterMaxSize/2);
        memoryCfg.numMeteringEntries[0] = 10;
        memoryCfg.numMeteringEntries[1] = (meterMaxSize/2) + 1;
        st = cpssDxChPolicerMemorySizeSet(dev, &memoryCfg);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PARAM, st, dev);
        ...
        /*
           ...
           Expected: GT_BAD_PARAM and the same value.
        */
        memoryCfg.numMeteringEntries[2] = (meterMaxSize/4);
        memoryCfg.numMeteringEntries[0] = (meterMaxSize/4);
        memoryCfg.numMeteringEntries[1] = (meterMaxSize/2) + 1;
        st = cpssDxChPolicerMemorySizeSet(dev, &memoryCfg);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_BAD_PARAM, st, dev);
        ...
        */
        memoryCfg.numMeteringEntries[0] = (meterMaxSize/4);
        memoryCfg.numMeteringEntries[1] = (meterMaxSize/2);
        memoryCfg.numMeteringEntries[2] = (meterMaxSize/4) + 1;
        memoryCfg.numCountingEntries[0] = 20;
        memoryCfg.numCountingEntries[1] = 30;
        memoryCfg.numCountingEntries[2] = 100;
...
/*----------------------------------------------------------------------------*/
/* Checks calculations for small bucket sizes */
UTF_TEST_CASE_MAC(cpssDxCh3PolicerMeteringEntrySet_small_buckets)
{
    GT_STATUS   st = GT_OK;
    GT_U8       dev;
    GT_U32                                  entryIndex = 0;
    ...
    typedef struct
    {
        ...
        GT_U32  outCbs;
        GT_U32  outEbs;
    } SINGLE_RATE_TB_CHECK_STC;

    SINGLE_RATE_TB_CHECK_STC casesArr[] =
    {
         { 5,7,0,   5,7,0}
        ,{ 5,7,7,   5,7,7}
        ,{50,7,0,  50,50,0}
    ...
    SINGLE_RATE_TB_CHECK_STC casesArrSip6[] =
    {
         { 5,7,0,   5,8,0}
        ,{ 5,7,7,   5,8,8}
        ,{50,7,0,  50,52,0}
    ...
    SINGLE_RATE_TB_CHECK_STC *casesArrPtr;
    ...
    while (GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        casesArrPtr = casesArr;
        if (PRV_CPSS_SIP_6_CHECK_MAC(dev))
        {
            casesArrPtr = casesArrSip6;
        }
        entryIndex = 0;

        entry.meterMode          = CPSS_DXCH3_POLICER_METER_MODE_SR_TCM_E; /* single rate */
        entry.byteOrPacketCountingMode = CPSS_DXCH3_POLICER_METER_RESOLUTION_PACKETS_E;
        entry.countingEntryIndex = 0;
        entry.mngCounterSet      = CPSS_DXCH3_POLICER_MNG_CNTR_SET0_E;
        entry.meterColorMode     = CPSS_POLICER_COLOR_BLIND_E;
        entry.modifyUp      = CPSS_DXCH_POLICER_MODIFY_UP_KEEP_PREVIOUS_E;
        ...
        for (caseIdx = 0; (casesArr[caseIdx].inCir != 0xFFFFFFFF); caseIdx++)
        {
            PRV_UTF_LOG3_MAC(
                "CASE: cir: %d, cbs: %d ebs: %d\n", casesArrPtr[caseIdx].inCir,
                casesArrPtr[caseIdx].inCbs, casesArrPtr[caseIdx].inEbs);
            entry.tokenBucketParams.srTcmParams.cir = casesArrPtr[caseIdx].inCir;
            entry.tokenBucketParams.srTcmParams.cbs = casesArrPtr[caseIdx].inCbs;
            entry.tokenBucketParams.srTcmParams.ebs = casesArrPtr[caseIdx].inEbs;

            st = cpssDxCh3PolicerMeteringEntrySet(dev, plrStage, entryIndex, &entry, &tbParams);
            UTF_VERIFY_EQUAL2_PARAM_MAC(GT_OK, st, dev, entryIndex);

            UTF_VERIFY_EQUAL1_STRING_MAC(
                casesArrPtr[caseIdx].outCir, tbParams.srTcmParams.cir,
                "got another tbParams.casesArrPtr.cir then was set: %d", dev);
            UTF_VERIFY_EQUAL1_STRING_MAC(
                casesArrPtr[caseIdx].outCbs, tbParams.srTcmParams.cbs,
                "got another tbParams.srTcmParams.cbs then was set: %d", dev);
            UTF_VERIFY_EQUAL1_STRING_MAC(
                casesArrPtr[caseIdx].outEbs, tbParams.srTcmParams.ebs,
                "got another tbParams.srTcmParams.ebs then was set: %d", dev);

            cpssOsBzero((GT_VOID*) &entryGet, sizeof(entryGet));
            st = cpssDxCh3PolicerMeteringEntryGet(dev, plrStage, entryIndex, &entryGet);
            UTF_VERIFY_EQUAL2_STRING_MAC(
                GT_OK, st, "cpssDxCh3PolicerMeteringEntryGet: %d, %d", dev, entryIndex);

            UTF_VERIFY_EQUAL1_STRING_MAC(
                casesArrPtr[caseIdx].outCir, entryGet.tokenBucketParams.srTcmParams.cir,
                "got another entryPtr->tokenBucketParams.srTcmParams.cir then was set: %d", dev);
            UTF_VERIFY_EQUAL1_STRING_MAC(
                casesArrPtr[caseIdx].outCbs, entryGet.tokenBucketParams.srTcmParams.cbs,
                "got another entryPtr->tokenBucketParams.srTcmParams.cbs then was set: %d", dev);
            UTF_VERIFY_EQUAL1_STRING_MAC(
                casesArrPtr[caseIdx].outEbs, entryGet.tokenBucketParams.srTcmParams.ebs,
                "got another entryPtr->tokenBucketParams.srTcmParams.ebs then was set: %d", dev);
        }
    }
}
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssDxCh3Policer)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(cpssDxCh3PolicerMeteringEntrySet_small_buckets)

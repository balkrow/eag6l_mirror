...
(
    ...
    IN  GT_U32              cos,
    IN  GT_U32              probabilityArr[CPSS_TM_DROP_PROB_ARR_SIZE_CNS],
    INOUT GT_U32              *curvePtr
)
*/
UTF_TEST_CASE_MAC(cpssTmDropWredCurveByIndexCreate)
{
    GT_STATUS               st = GT_OK;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        cos = 0;
        curvePtr = 5;
        st = cpssTmDropWredCurveByIndexCreate(dev, level, cos, probabilityArr, &curvePtr);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
        ...
        */
        ...
        /*
            ...
            Expected: GT_BAD_PTR.
        */
        st = cpssTmDropWredCurveByIndexCreate(dev, level, cos, probabilityArr, NULL);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st, "%d, curvePtr = NULL", dev);
...
*/
UTF_TEST_CASE_MAC(cpssTmDropWredTraditionalCurveByIndexCreate)
{
    GT_STATUS               st = GT_OK;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        maxProbability=50;
        curvePtr = 5;
        st = cpssTmDropWredTraditionalCurveByIndexCreate(dev, level, cos, maxProbability, &curvePtr);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
        ...
        */
        ...
        st = cpssTmDropWredTraditionalCurveByIndexCreate(dev, level, cos, maxProbability, NULL);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st, "%d, curvePtr = NULL", dev);
...
(
    ...
    INOUT GT_U32                          *profilePtr
);
*/

UTF_TEST_CASE_MAC(cpssTmDropProfileByIndexCreate)
{
    GT_STATUS               st = GT_OK;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        profilePtr = 5;
        st = cpssTmDropProfileByIndexCreate(dev, level, cos, &profileStrPtr, &profilePtr);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
       ...
       */
        ...
        */
        ...
        st = cpssTmDropProfileByIndexCreate(dev, level, cos, &profileStrPtr, NULL);
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssTmDrop)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(cpssTmDropWredCurveByIndexCreate)
    UTF_SUIT_DECLARE_TEST_MAC(cpssTmDropWredTraditionalCurveCreate)
    UTF_SUIT_DECLARE_TEST_MAC(cpssTmDropWredTraditionalCurveByIndexCreate)
    UTF_SUIT_DECLARE_TEST_MAC(cpssTmDropProfileCreate)
    UTF_SUIT_DECLARE_TEST_MAC(cpssTmDropProfileByIndexCreate)

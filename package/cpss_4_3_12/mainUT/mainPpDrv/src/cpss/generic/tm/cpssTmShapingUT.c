...
*/
UTF_TEST_CASE_MAC(cpssTmShapingProfileByIndexCreate)
{
    GT_STATUS               st = GT_OK;
    ...
    while(GT_OK == prvUtfNextDeviceGet(&dev, GT_TRUE))
    {
        ...
        profileStrPtr.ebs = 10; /*KBytes*/
        profileIndPtr = 12;
        st = cpssTmShapingProfileByIndexCreate(dev, level, &profileStrPtr, &profileIndPtr);
        UTF_VERIFY_EQUAL1_PARAM_MAC(GT_OK, st, dev);
        ...
        */
        profileIndPtr = 18;
        st = cpssTmShapingProfileByIndexCreate(dev, level, NULL, &profileIndPtr);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st, "%d, profileStrPtr = NULL", dev);
        ...
        */
        ...
        st = cpssTmShapingProfileByIndexCreate(dev, level, &profileStrPtr, NULL);
        UTF_VERIFY_EQUAL1_STRING_MAC(GT_BAD_PTR, st, "%d, profileIndPtr = NULL", dev);
...
UTF_SUIT_BEGIN_TESTS_MAC(cpssTmShaping)
    ...
    UTF_SUIT_DECLARE_TEST_MAC(cpssTmShapingProfileByIndexCreate)

/**
********************************************************************************
* @file luaCLIEngineFS.c
*
* @brief genFS support for Lua:
* - Lua loader
...
#ifdef SHARED_MEMORY
#define LUA_FS_MALLOC(l)      malloc(l)
#define LUA_FS_FREE(l)        free(l)
#else
#define LUA_FS_MALLOC(l)      osMalloc(l)
#define LUA_FS_FREE(l)        osFree(l)
#endif
...
/**
* @internal luaEngineFSLoader function
* @endinternal
*
* @brief   package loader for genFS
*/
static int luaEngineFSLoader(lua_State *L)
{
    ...
    lf = (LoadF*)LUA_FS_MALLOC(sizeof(*lf));
    if (!lf)
    {
        lua_pushliteral(L, "\n\tno CPU memory");
        return 1;
...
/**
* @internal luaEngineFS_loadfile function
* @endinternal
*
* @brief   loads file as Lua chunk. Cycle through all loaders
*/
...
/**
* @internal l_loadfile function
* @endinternal
*
* @brief   loadfile() with genFS support
*/
...
/**
* @internal l_dofile function
* @endinternal
*
* @brief   dofile() with genFS support
*/
...
/**
* @internal luaEngineFSregisterLoader function
* @endinternal
*
* @brief   register package loader for genFS
*/
...
/**
* @internal l_genFSclose function
* @endinternal
*
* @brief   fs.close
...
/**
* @internal l_genFSwrite function
* @endinternal
*
* @brief   fs.write
...
/**
* @internal l_genFSlseek function
* @endinternal
*
* @brief   fs.lseek
...
/**
* @internal l_genFSexists function
* @endinternal
*
* @brief   fs.exists
...
/**
* @internal l_genFSfileexists function
* @endinternal
*
* @brief   fs.fileexists
...
/**
* @internal l_genFSunlink function
* @endinternal
*
* @brief   fs.unkink
...
/**
* @internal l_genFSopendir function
* @endinternal
*
* @brief   fs.opendir
*         open a directory
...
/**
* @internal l_genFSclosedir function
* @endinternal
*
* @brief   fs.closedir
*         close a directory
...
/**
* @internal l_genFSreaddir function
* @endinternal
*
* @brief   fs.readdir
...
/**
* @internal luaEngineFSregisterAPI function
* @endinternal
*
* @brief   register cmdFS API in Lua instance
*/

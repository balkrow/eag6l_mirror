...
/**
* @enum AU_EV_HANDLER_CB_TYPE_ENT
 *
...
/**
* @internal prvAuEvHandlerMatch function
* @endinternal
*
...
/**
* @internal prvAuEvCbHandlerMatch function
* @endinternal
*
* @brief   Initialize library
*
...
/**
* @internal prvAuEvAddCallBack function
* @endinternal
*

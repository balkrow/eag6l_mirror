...
if(devFamily == "CPSS_PP_FAMILY_DXCH_AAS_E") then
    ...
    other_GOPs_400G = "40-48"
    first_ports_in_other_GOPs_400G = "20,28,40,48"
    traffic_port_1 = "16"
    traffic_port_2 = "24"
    traffic_port_3 = "32"
    traffic_port_4 = "40"
    ...
    ports_100G   = {"0","2","4","6"}
    ports_200G   = {"0","4"}
elseif(devFamily == "CPSS_PP_FAMILY_DXCH_HARRIER_E") then --ports ok for Harrier but not for Aldrin3M
...
elseif(devFamily == "CPSS_PP_FAMILY_DXCH_FALCON_E") then
    ...
    printLog(devFamily .. " not implemented for the test")
    setFailState() 
    return
end

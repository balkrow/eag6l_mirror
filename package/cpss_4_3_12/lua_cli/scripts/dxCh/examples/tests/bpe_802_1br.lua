...
--the BPE tests assums that eports starts at 256 (meaning that physical ports are only 0..255)
-- this is needed for AAS that supports single 'physical ports mode' of 1024 physical ports
wrLogWrapper("wrlCpssDevicePhysicalPortNumberLimit", "(run_in_limited_physical_ports)", 256)
...
--restore the 'no limit'
wrLogWrapper("wrlCpssDevicePhysicalPortNumberLimit", "(run_in_limited_physical_ports)", 0)

...
local trgHwDevNum = 20
if (trgHwDevNum == devNum) or (hw_device_id_number == trgHwDevNum) then
    trgHwDevNum = trgHwDevNum - 1
end

-- assign variable for the test
global_test_data_env.trgHwDevNum = trgHwDevNum

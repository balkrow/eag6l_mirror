...
--********************************************************************************
--* high_availebility_fdb_manager_parallel.lua
--*
--* DESCRIPTION:
...
local function doTest()
    ...
    printLog("\nSet PARALLEL catchUp for FDB ")
    managerArray= {[0] = "CPSS_SYSTEM_RECOVERY_FDB_MANAGER_E"}
    ...
    printLog("\nSet PARALLEL completion for FDB ")
    myGenWrapper("cpssSystemRecoveryHaParallelModeSet",{
    ...
    printLog("\nRestore FDB Config\n")
    result, values = myGenWrapper("prvTgfBrgFdbManager_restoreFdbConfig",{})

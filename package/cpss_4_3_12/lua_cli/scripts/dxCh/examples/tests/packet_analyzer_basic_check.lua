...
SUPPORTED_DEV_DECLARE(devNum,"CPSS_PP_FAMILY_DXCH_ALDRIN_E","CPSS_PP_FAMILY_DXCH_ALDRIN2_E","CPSS_PP_FAMILY_DXCH_FALCON_E",
                             "CPSS_PP_FAMILY_DXCH_AC5X_E","CPSS_PP_FAMILY_DXCH_AC5P_E","CPSS_PP_FAMILY_DXCH_HARRIER_E",
...
if devFamily == "CPSS_PP_FAMILY_DXCH_FALCON_E" or devFamily == "CPSS_PP_FAMILY_DXCH_AC5X_E" or
   devFamily == "CPSS_PP_FAMILY_DXCH_AC5P_E"   or devFamily == "CPSS_PP_FAMILY_DXCH_HARRIER_E" or
   devFamily == "CPSS_PP_FAMILY_DXCH_AC5P_E" or devFamily == "CPSS_PP_FAMILY_DXCH_IRONMAN_E" then
...
for ii, sendPort in ipairs(ports) do
    ...
    elseif devFamily == "CPSS_PP_FAMILY_DXCH_FALCON_E" then
        ...
        expStage[12]["hit"] = 1
        expStage[13]["hit"] = 1
    elseif devFamily == "CPSS_PP_FAMILY_DXCH_IRONMAN_E" then
        expStage[1]["hit"] = 1
        expStage[2]["hit"] = 0
        expStage[3]["hit"] = 0
        expStage[4]["hit"] = 0

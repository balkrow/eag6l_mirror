...
local function preemption_set_port_state(params)
    ...
    set_one_bit(portParamVal.portParams.portParamsType.regPort.portAttributes.validAttrsBitMask,12) --CPSS_PM_PORT_ATTR_PREEMPTION_E
            ...
            if params.verifBypass and params.verifBypass==true then
                portParamVal.portParams.portParamsType.regPort.portAttributes.preemptionParams.disableVerification = true
                print("TX_VERIF_DIS = 1")
            else
                portParamVal.portParams.portParamsType.regPort.portAttributes.preemptionParams.disableVerification = false
                print("TX_VERIF_DIS = 0")
            end
...
CLI_addCommand("debug", "txq-sip6-preemption set-port-state", {
   ...
   params={
        ...
        { format="verifBypass  %bool", name="verifBypass",help="Bypass preemption verification"},

...
CLI_addCommand("debug", "txq-sip6-enqueue-stat", {
   ...
   params={
        ...
        { format="force %bool",name="force",help="Init even if the block is currently used by other client" },
         mandatory={"devID"},
        }
    }
})

...
local function check_pa_field_value(param)
    ...
    elseif "mac_da" == currentField or "mac_sa" == currentField or
           "egress_mac_da" == currentField or "egress_mac_sa" == currentField then
        ...
        for i=1, #stages do
            ...
            result, values = myGenWrapper(
                    "cpssDxChPacketAnalyzerStageFieldsGet", {
                                ...
                                { "INOUT", "GT_U32", "numOfFieldsPtr", 150 },
                                { "OUT", "CPSS_DXCH_PACKET_ANALYZER_FIELD_ENT[150]", "fieldsArr" }
                }
            )
            if (result ~= 0) then
                status = false
            ...
            for i = 1, values["numOfFieldsPtr"] do
                ...
                if printPaField[field] == "packet_trace" then
                    if (devFamily == "CPSS_PP_FAMILY_DXCH_FALCON_E" or devFamily == "CPSS_PP_FAMILY_DXCH_AC5P_E" or
                        devFamily == "CPSS_PP_FAMILY_DXCH_AC5X_E" or devFamily == "CPSS_PP_FAMILY_DXCH_HARRIER_E" or 
                        devFamily == "CPSS_PP_FAMILY_DXCH_IRONMAN_E"  ) and paDb.stage == "CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_PCL_E" then
...
local function initDbAndStringsSip6()
    ...
    if INIT_PA_STRINGS == NOT_INITIALIZED then
        ...
        if (devFamily == "CPSS_PP_FAMILY_DXCH_HARRIER_E") then
            ...
            printPaStageIndex[14]      = nil
            printPaStageIndex[17]      = nil
            printPaStageIndexHelp[14]  = nil
            printPaStageIndexHelp[17]  = nil
            printPaStageCpssIndex[14]  = nil
            printPaStageCpssIndex[17]  = nil

            --remove MAC and PHA from DEFAULT_SIP6 table
            paTable[DEFAULT_SIP6][0][14] = nil
            paTable[DEFAULT_SIP6][0][17] = nil

            INIT_PA_STRINGS = MODIFY_MODE
        end

        if (devFamily == "CPSS_PP_FAMILY_DXCH_IRONMAN_E") then
            --remove E-POLICER and REPLICATION from tables
            printPaStageIndex[12]      = nil
            printPaStageIndex[15]      = nil
            printPaStageIndexHelp[12]  = nil
            printPaStageIndexHelp[15]  = nil
            printPaStageCpssIndex[12]  = nil
            printPaStageCpssIndex[15]  = nil

            --remove E-POLICER and REPLICATION from DEFAULT_SIP6 table
            paTable[DEFAULT_SIP6][0][12] = nil
            paTable[DEFAULT_SIP6][0][15] = nil
...
local function packetAnalyzerSetField(params)
    ...
    if (params["no"] == nil) then
        ...
        if currentField == "mac_da" or currentField == "mac_sa" or
           currentField == "egress_mac_da" or currentField =="egress_mac_sa" then
...
local function addCommands()
    ...
    local devFamily = wrlCpssDeviceFamilyGet(paDb.dev)
    if devFamily == "CPSS_PP_FAMILY_DXCH_FALCON_E" or devFamily == "CPSS_PP_FAMILY_DXCH_AC5P_E" or
       devFamily == "CPSS_PP_FAMILY_DXCH_AC5X_E" or devFamily == "CPSS_PP_FAMILY_DXCH_HARRIER_E" or devFamily == "CPSS_PP_FAMILY_DXCH_IRONMAN_E" then
...
local function packetAnalyzer(params)
    ...

    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_16_E"] = 67,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_17_E"] = 68,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_LAST_E"] = 69,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_0_E"] = 70,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_1_E"] = 71,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_2_E"] = 72,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_3_E"] = 73,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_4_E"] = 74,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_5_E"] = 75,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_6_E"] = 76,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_7_E"] = 77,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_8_E"] = 78,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_9_E"] = 79,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_10_E"] = 80,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_11_E"] = 81,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_12_E"] = 82,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_13_E"] = 83,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_14_E"] = 84,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_15_E"] = 85,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_16_E"] = 86,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_17_E"] = 87,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_18_E"] = 88,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_19_E"] = 89,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_20_E"] = 90,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_21_E"] = 91,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_22_E"] = 92,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_23_E"] = 93,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_24_E"] = 94,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_25_E"] = 95,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_26_E"] = 96,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_27_E"] = 97,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_28_E"] = 98,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_29_E"] = 99,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_30_E"] = 100,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_31_E"] = 101,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_32_E"] = 102,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_33_E"] = 103,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_34_E"] = 104,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_35_E"] = 105,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_36_E"] = 106,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_37_E"] = 107,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_38_E"] = 108,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_39_E"] = 109,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_40_E"] = 110,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_41_E"] = 111,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_42_E"] = 112,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_43_E"] = 113,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_44_E"] = 114,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_45_E"] = 115,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_46_E"] = 116,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_47_E"] = 117,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_48_E"] = 118,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_49_E"] = 119,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_50_E"] = 120,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_51_E"] = 121,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_52_E"] = 122,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_53_E"] = 123,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_54_E"] = 124,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_55_E"] = 125,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_56_E"] = 126,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_57_E"] = 127,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_58_E"] = 128,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_59_E"] = 129,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_60_E"] = 130,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_61_E"] = 131,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_62_E"] = 132,
    ["CPSS_DXCH_PACKET_ANALYZER_FIELD_UDF_63_E"] = 133,
...
printPaStageIndexHelp =
{
    ...
    [11] = "Pre PCL egress stage",
    [12] = "Pre OAM egress stage",
...
printPaStageCpssIndex =
{
    ...
    [11] = "CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_PCL_E",
    [12] = "CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_OAM_E",
...
printPaStageCpssInt =
{
    ...
    ["CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_PCL_E"] = 11,
    ["CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_OAM_E"] = 12,
...
local function printField(fieldStr,fieldsValues,printMask)
  ...
  if fieldStr == "mac_sa" or fieldStr == "mac_da" or
     fieldStr == "egress_mac_da" or fieldStr == "egress_mac_sa" then
      ...
      if values["numOfFieldsPtr"] == 0 then
          ...
          result, values1 = myGenWrapper(
            "cpssDxChPacketAnalyzerGroupRuleGet", {
                            ...
                            { "INOUT", "GT_U32", "numOfFieldsValuePtr", 150 },
                            { "OUT", "CPSS_DXCH_PACKET_ANALYZER_FIELD_VALUE_STC[150]", "fieldsValueArr" },
            ...
            if values["numOfFieldsPtr"] ~= 0 then
                ...
                result, values1 = myGenWrapper(
                    "cpssDxChPacketAnalyzerStageMatchDataAllFieldsGet", {
                                    ...
                                    { "INOUT", "GT_U32", "numOfSampleFieldsPtr", 150 },
                                    { "OUT", "CPSS_DXCH_PACKET_ANALYZER_FIELD_VALUE_STC[150]", "sampleFieldsValueArr" }
                    }
                )
                if (result ~= 0) then
                    status = false

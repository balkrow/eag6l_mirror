        ...
        for iterator, devNum, portNum in command_data:getPortIterator() do
            ...
            if true==val then 
                ...
                elseif ret == 7 then
                    ...
                    if ret ~= 0 then
                        command_data:setFailPortAndLocalStatus()
                        command_data:addError("Error at Port Manager params Get: device %d " ..
                                              "port %d: %s", devNum, portNum,
                                              returnCodes[ret])
                        return ret
                    end
                    ...
                    if ret ~= 0 then
                        command_data:setFailPortAndLocalStatus()
                        command_data:addError("Error at Port Manager Event Set (Delete): device %d " ..
                                              "port %d: %s", devNum, portNum,
                                              returnCodes[ret])
                        return ret
                    end
                    ...
                    if ret ~= 0 then
                        command_data:setFailPortAndLocalStatus()
                        command_data:addError("Error at Port Manager Event Set (Create): device %d " ..
                                              "port %d: %s", devNum, portNum,
                                              returnCodes[ret])
                        return ret
                    end

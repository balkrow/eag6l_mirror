...
function bridge_multicast_address_group_func(params)
    ...
    local maxPhyPort = system_capability_get_table_size(devlist[1], "PHYSICAL_PORT");
    ...
    dev_vlan_ports              = {}
    dev_vlan_ports["added"]     = port_list_limited_copy(full_port_list, 0, maxPhyPort)--511 to support Bobcat3

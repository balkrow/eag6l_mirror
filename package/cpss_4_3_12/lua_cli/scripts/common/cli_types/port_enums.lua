...
CLI_type_dict["port_interface_mode"] = {
    ...
    ["1000Base_SX"]   = { value="CPSS_PORT_INTERFACE_MODE_1000BASE_SXLX_E",
                                        help="1000 Base SX interface mode"      },
    ...
    ["CR4"]           = { value="CPSS_PORT_INTERFACE_MODE_CR4_E",
                                        help="CR4 (4 lanes) interface mode"     },
    ...
    ["USX_10G_SXGMII"]    = { value="PSS_PORT_INTERFACE_MODE_USX_10G_SXGMII_E",
    ...
    ["USX_20G_DXGMII"]    = { value="PSS_PORT_INTERFACE_MODE_USX_20G_DXGMII_E",
...
CLI_type_dict["interface_mode"] = {
    ...
    ["USX_20G_DXGMII"] =  { value=49, help="Change port's mode to USX_10G_DXGMII"        },
    ...
    ["USX_20G_QXGMII"] =  { value=52, help="Change port's mode to USX_10G_QXGMII"        },
    ["USX_OUSGMII"] =     { value=53, help="Change port's mode to USX_OUSGMII"           },
    ["USX_20G_OXGMII"] =  { value=54, help="Change port's mode to USX_10G_0XGMII"        },
...
CLI_type_dict["auto_tune"] = {
    ...
    help = "Auto tune mode",
    enum = {
            ["trx-training"] =  { value="CPSS_PORT_SERDES_AUTO_TUNE_MODE_TX_TRAINING_START_E", help="Run TRX training" },
            ["rx-training"] =   { value="CPSS_PORT_SERDES_AUTO_TUNE_MODE_RX_TRAINING_E", help="Run RX training"        }
            }
}
...
CLI_type_dict["serdes_speed"] = {
    ...
    enum = {
        ["1.25"] =      { value="CPSS_PORT_SERDES_SPEED_1_25_E",    help="Serdes speed is 1.25G"  },
        ["3.125"] =     { value="CPSS_PORT_SERDES_SPEED_3_125_E",   help="Serdes speed is 3.125G" },
        ["3.75"] =      { value="CPSS_PORT_SERDES_SPEED_3_75_E",    help="Serdes speed is 3.75G"  },
        ["6.25"] =      { value="CPSS_PORT_SERDES_SPEED_6_25_E",    help="Serdes speed is 6.25G"  },
        ["5"] =         { value="CPSS_PORT_SERDES_SPEED_5_E",       help="Serdes speed is 5G"     },
        ["4.25"] =      { value="CPSS_PORT_SERDES_SPEED_4_25_E",    help="Serdes speed is 4.25G"  },
        ["2.5"] =       { value="CPSS_PORT_SERDES_SPEED_2_5_E",     help="Serdes speed is 2.5G"   },
        ["5.156"] =     { value="CPSS_PORT_SERDES_SPEED_5_156_E",   help="Serdes speed is 5.156G" },
        ["10.3125"] =   { value="CPSS_PORT_SERDES_SPEED_10_3125_E", help="used by KR"             },
        ["3.333"] =     { value="CPSS_PORT_SERDES_SPEED_3_333_E",   help="used by HGL 16G"        },
        ["12.5"] =      { value="CPSS_PORT_SERDES_SPEED_12_5_E",    help="for 12.5G, 25G and 50G" },
        ["7.5"] =       { value="CPSS_PORT_SERDES_SPEED_7_5_E",     help="legacy"                 },
        ["11.25"] =     { value="CPSS_PORT_SERDES_SPEED_11_25_E",   help="legacy"                 },
        ["11.5625"] =   { value="CPSS_PORT_SERDES_SPEED_11_5625_E", help="for 22G SR_LR"          },
        ["10.9375"] =   { value="CPSS_PORT_SERDES_SPEED_10_9375_E", help="legacy"                 },
        ["12.1875"] =   { value="CPSS_PORT_SERDES_SPEED_12_1875_E", help="for 11.8G, 23.6G, 47.2G"},
        ["5.625"] =     { value="CPSS_PORT_SERDES_SPEED_5_625_E",   help="for 5.45G in xCat3"     },
        ["12.8906"] =   { value="CPSS_PORT_SERDES_SPEED_12_8906_E", help="for 12.5G, 25G and 50G" },
        ["20.625"] =    { value="CPSS_PORT_SERDES_SPEED_20_625_E",  help="for 40G R2"             },
        ["25.78125"] =  { value="CPSS_PORT_SERDES_SPEED_25_78125_E",help="for 25G, 50G, 100G"     },
        ["27.5"] =      { value="CPSS_PORT_SERDES_SPEED_27_5",      help="for EDSA compensation mode 107G"},
        ["28.05"] =     { value="CPSS_PORT_SERDES_SPEED_28_05",     help="for EDSA compensation mode 109G"}
    }
}
...
--------------------------------------------
CLI_type_dict["port_fec_mode_gen"] = {
    checker = CLI_check_param_enum,
    complete = CLI_complete_param_enum,
    help = "port fec mode",
    enum = {
        ["disabled"] = { value="CPSS_PORT_FEC_MODE_DISABLED_E",            help="FEC disabled"                   },
        ["fc_fec"]   = { value="CPSS_PORT_FEC_MODE_ENABLED_E",             help="FC-FEC enabled on port"         },
        ["rs_fec"]   = { value="CPSS_PORT_RS_FEC_MODE_ENABLED_E",          help="RS-FEC enabled on port"         },
        ["both_fec"] = { value="CPSS_PORT_BOTH_FEC_MODE_ENABLED_E",        help="both FEC modes enabled on port" },
        ["rs_fec544"] = { value="CPSS_PORT_RS_FEC_544_514_MODE_ENABLED_E", help="RS-FEC 544 enabled on port"     }
    }
}

CLI_type_dict["port_fec_mode_gen1"] = {
    checker = CLI_check_param_enum,
    complete = CLI_complete_param_enum,
...
--------------------------------------------
CLI_type_dict["ap_flow_control_gen"] = {
    checker = CLI_check_param_enum,
    complete = CLI_complete_param_enum,
    help = "enumerator of ap port fc direction enablers",
    enum = {
        ["symmetric"] =    { value="CPSS_PORT_AP_FLOW_CONTROL_SYMMETRIC_E", help="flow control in both directions" },
        ["asymmetric"] =   { value="CPSS_PORT_AP_FLOW_CONTROL_ASYMMETRIC_E", help="flow control in one directions" }
    }
}
...
function fcToVal(fc)
      if fc ==  "CPSS_DXCH_PORT_AP_FLOW_CONTROL_SYMMETRIC_E" or fc ==  "CPSS_PORT_AP_FLOW_CONTROL_SYMMETRIC_E" or fc ==  "CPSS_PX_PORT_AP_FLOW_CONTROL_SYMMETRIC_E" then
          return 0
      elseif fc ==  "CPSS_DXCH_PORT_AP_FLOW_CONTROL_ASYMMETRIC_E" or fc == "CPSS_PORT_AP_FLOW_CONTROL_ASYMMETRIC_E" or fc == "CPSS_PX_PORT_AP_FLOW_CONTROL_ASYMMETRIC_E" then
          return 1
      else

...
require_safe("common/exec/show_patches")
...
require_safe_dx("exec/show_router_drop_counter")
...
require_safe_dx("configuration/router_drop_counter")
...
require_safe_dx("debug/txq-sip6-qbv")
require_safe_dx("debug/txq-sip7-deep-buffering")
require_safe_dx("debug/txq-sip7-profiles")

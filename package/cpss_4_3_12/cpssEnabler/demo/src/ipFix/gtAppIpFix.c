...
)
{
    ...
    if(appDemoIpfixUdbCfg == NULL)
    {
        ...
        /* clean DB to avoid trash value */
        cpssOsMemSet(appDemoIpfixUdbCfg, 0, sizeof(APP_DEMO_IPFIX_UDB_CFG_STC));
...
)
{
    ...
    if(enable == GT_TRUE )
    {
        ...
        vTcamInfo.tcamSpaceUnmovable   = CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_CPSS_ALLOCATED_E;

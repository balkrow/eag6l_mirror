 ...
 * @param[in] printEnable - enable printing of compared config values
 *
...
/**
 * @internal appDemoIpfixManagerFlowInfoGet
 *
 ...
 * @retval GT_OK - on success
 */
GT_STATUS appDemoIpfixManagerFlowInfoGet
(
    IN  GT_U32                      portGroupId,
    IN  GT_U32                      flowId,
    OUT PRV_APP_IPFIX_MGR_FLOWS_STC *flowInfoPtr
);

/**
 * @internal appDemoIpfixManagerFlowInfoSet
 *
 ...
 * @retval GT_OK - on success
 */
GT_STATUS appDemoIpfixManagerFlowInfoSet
(
    IN  GT_U32                      portGroupId,
    IN  GT_U32                      flowId,
    IN  PRV_APP_IPFIX_MGR_FLOWS_STC *flowInfoPtr
);

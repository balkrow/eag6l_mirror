...
#  define DMA_LEN                 (CONFIG_DMA_LEN*1024*1024)
#else
#  define DMA_LEN                 (CONFIG_DMA_LEN*1024*1024)
#endif
...
#define PRV_DEVNUM_DONT_CARE_VALUE 0
#define PRV_ADRESS_SPACE_DONT_CARE_VALUE CPSS_HW_DRIVER_AS_LAST_E
...
*   Get DMA buffer info of the device by device number in the DB
*
*******************************************************************************/

...
static struct {
    ...
    { RES_OFFSET(cnm),                    MV_RESOURCE_MBUS_RUNIT,  0 },
    { RES_OFFSET(switching),              MV_RESOURCE_MBUS_SWITCH, 0 },
...
)
{
    ...
    vaddr = mmap(osNonSharedGlobalVars.osNonVolatileDb.aslrSupport?NULL:vaddr,
                maxSize,
                PROT_READ | PROT_WRITE,
                flags ,
                mvMbusDrvFd,
    ...
    /*osGlobalDbNonSharedDbMbusPpMappingSet(mbusResource,vaddr);*/
...
)
{
...
#endif
    hwInfoPtr->irq.switching = 0x11ab0000 | (osNonSharedGlobalVars.osNonVolatileDb.noKmMappingsNum & 0xffff);
    ...
    osNonSharedGlobalVars.osNonVolatileDb.noKmMappingsList[osNonSharedGlobalVars.osNonVolatileDb.noKmMappingsNum] = *hwInfoPtr;
...
)
{
    ...
    osGlobalDbNonSharedDbMbusPpMappingSet(res,vaddrm);

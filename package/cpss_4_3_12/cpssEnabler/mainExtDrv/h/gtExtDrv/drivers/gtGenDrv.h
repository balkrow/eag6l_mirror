...
/* Ironman Marvell Boards */
#define EXT_DRV_IRONMAN_MARVELL_BOARD_ID_BASE        0xD0
#define EXT_DRV_IRONMAN_A0_DB_IM_L_SFP_ID  /*A0*/   (EXT_DRV_IRONMAN_MARVELL_BOARD_ID_BASE + 0)
#define EXT_DRV_IRONMAN_A0_DB_IM_L_PHY_ID  /*A0*/   (EXT_DRV_IRONMAN_MARVELL_BOARD_ID_BASE + 1)
#define EXT_DRV_IRONMAN_A0_DB_IM_M_ID      /*A0*/   (EXT_DRV_IRONMAN_MARVELL_BOARD_ID_BASE + 2)
#define EXT_DRV_IRONMAN_A0_RD_IM_DX1508M_8G4XG_ID   (EXT_DRV_IRONMAN_MARVELL_BOARD_ID_BASE + 3)
#define EXT_DRV_IRONMAN_A0_RD_IM_DX1518M_24G6XG_ID  (EXT_DRV_IRONMAN_MARVELL_BOARD_ID_BASE + 4)

...
override CFLAGS += -Ih -I$(PDL_DIR)/h -I$(PDLIB_DIR)/h
...
IDBG_PDL_OBJ := $(patsubst %.c,$(OBJ_OUT_DIR)/%.$(OBJ_EXTENSION),$(IDBG_PDL_SRC))
DEP += $(patsubst %.$(OBJ_EXTENSION),%.$(DEP_EXTENSION),$(IDBG_PDL_OBJ))
###############################################################################
#

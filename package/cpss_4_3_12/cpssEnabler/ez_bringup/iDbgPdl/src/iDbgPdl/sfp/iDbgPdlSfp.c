...
)
{
    ...
    for (tempDev = firstDev; tempDev < lastDev; tempDev ++) {
        ...
        for (i_port = 0; i_port < sizeof(portListArr); i_port++) {
            ...
            if (pdlStatus == PDL_OK) {
                if (pdlLibConvertEnumValueToString(PDL_ENUM_ID_INTERFACE_TYPE_E, sfpInfo.eepromInfo.interfaceType, &str) != PDL_OK) {
                    str = "parsing error";
                }
                ...
                if (pdlLibConvertEnumValueToString(PDL_ENUM_ID_INTERFACE_TYPE_E, sfpInfo.lossInfo.interfaceType, &str) != PDL_OK) {
                    str = "parsing error";
                }
                ...
                if (pdlLibConvertEnumValueToString(PDL_ENUM_ID_INTERFACE_TYPE_E, sfpInfo.presentInfo.interfaceType, &str) != PDL_OK) {
                    str = "parsing error";
                }
                IDBG_PDL_LOGGER_API_OUTPUT_LOG(" %-6s   %-4s | %-15s | \n", "", "", "PRESENT INFO");
                ...
                if (pdlLibConvertEnumValueToString(PDL_ENUM_ID_INTERFACE_TYPE_E, sfpInfo.txDisableInfo.interfaceType, &str) != PDL_OK) {
                    str = "parsing error";
                }
                IDBG_PDL_LOGGER_API_OUTPUT_LOG(" %-6s   %-4s | %-15s | \n", "", "", "TX DISABLE INFO");
                ...
                if (pdlLibConvertEnumValueToString(PDL_ENUM_ID_INTERFACE_TYPE_E, sfpInfo.txEnableInfo.interfaceType, &str) != PDL_OK) {
                    str = "parsing error";
                }
                IDBG_PDL_LOGGER_API_OUTPUT_LOG(" %-6s   %-4s | %-15s | \n", "", "", "TX ENABLE INFO");

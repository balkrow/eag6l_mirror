...
)
{
    ...
    if (pdlStatus == PDL_OK) {
        ...
        pdlibStatusToString(pdlStatus, &infoPtr);
    }
...
)
{
    ...
    for (index = firstFpId; index < lastFpId; index ++) {
        ...
        if (pdlStatus == PDL_OK) {
            pdlStatus = pdlLibConvertEnumValueToString(PDL_ENUM_ID_SPEED_TYPE_E, frontPanelAttributes.portMaximumSpeed, &maxSpeedStr);
            PDL_CHECK_STATUS(pdlStatus);
            pdlStatus = pdlLibConvertEnumValueToString(PDL_ENUM_ID_PANEL_GROUP_ORDERING_TYPE_E, frontPanelAttributes.ordering, &grOrderStr);
            PDL_CHECK_STATUS(pdlStatus);
...
)
{
    ...
    if (maxSpeedStr) {
        pdlStatus = pdlLibConvertStringToEnumValue(PDL_ENUM_ID_SPEED_TYPE_E, maxSpeedStr, (UINT_32*) &frontPanelAttributes.portMaximumSpeed);
        if (pdlStatus != PDL_OK) {
    ...
    if (grOrderStr) {
        pdlStatus = pdlLibConvertStringToEnumValue(PDL_ENUM_ID_PANEL_GROUP_ORDERING_TYPE_E, grOrderStr, (UINT_32*) &frontPanelAttributes.ordering);
        if (pdlStatus != PDL_OK) {
...
)
{
    ...
    /* ***************************************************************************/
    PDL_STATUS                          pdlStatus;
    PDL_PP_B2B_ATTRIBUTES_STC           b2bAttributes, b2bAttributes2;
    PDL_PP_ATTRIBUTES_STC               ppAttributes;
    UINT_32                             index;
    /****************************************************************************/
    /*                     F U N C T I O N   L O G I C                          */
    ...
    if (maxSpeedStr) {
        pdlStatus = pdlLibConvertStringToEnumValue(PDL_ENUM_ID_SPEED_TYPE_E, maxSpeedStr, (UINT_32*) &b2bAttributes.maxSpeed);
        if (pdlStatus != PDL_OK) {
    ...
    if (ifModeStr) {
        pdlStatus = pdlLibConvertStringToEnumValue(PDL_ENUM_ID_L1_INTERFACE_MODE_TYPE_E, ifModeStr, (UINT_32*) &b2bAttributes.interfaceMode);
        if (pdlStatus != PDL_OK) {
...
)
{
    ...
    if (res == FALSE) {
        ...
        PDL_CHECK_STATUS(pdlStatus);
        pdlStatus = pdlLibConvertEnumValueToString(PDL_ENUM_ID_L1_INTERFACE_MODE_TYPE_E, mode, &modeStr);
        PDL_CHECK_STATUS(pdlStatus);
...
)
{
    ...
    PDL_PP_NETWORK_PORT_ATTRIBUTES_STC          portAttr;
    /****************************************************************************/
    /*                     F U N C T I O N   L O G I C                          */
    /****************************************************************************/
    PDL_UNUSED_PARAM(resultPtr);

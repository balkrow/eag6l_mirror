...
#define IDBG_PDL_LOGGER_TYPEOF_INT_8_CNS        3
#define IDBG_PDL_LOGGER_TYPEOF_INT_16_CNS       4
#define IDBG_PDL_LOGGER_TYPEOF_INT_32_CNS       5
#define IDBG_PDL_LOGGER_TYPEOF_BOOLEAN_CNS      6
#define IDBG_PDL_LOGGER_TYPEOF_CHAR_PTR_CNS     7
#define IDBG_PDL_LOGGER_TYPEOF_PTR_CNS          8
...
#define IDBG_PDL_LOGGER_TYPEOF_SIZE_MAC(_type_val)\
   ((_type_val == IDBG_PDL_LOGGER_TYPEOF_UINT_8_CNS)             ?  sizeof(UINT_8)               :\
    ...
    (_type_val == IDBG_PDL_LOGGER_TYPEOF_INT_8_CNS)              ?  sizeof(INT_8)                :\
    (_type_val == IDBG_PDL_LOGGER_TYPEOF_INT_16_CNS)             ?  sizeof(INT_16)               :\
    (_type_val == IDBG_PDL_LOGGER_TYPEOF_INT_32_CNS)             ?  sizeof(INT_32)               :\
...
#define IDBG_PDL_LOGGER_TYPEOF_TEXT_MAC(_type_val)\
   ((_type_val == IDBG_PDL_LOGGER_TYPEOF_UINT_8_CNS)             ?  "UINT_8"                 :\
    ...
    (_type_val == IDBG_PDL_LOGGER_TYPEOF_INT_8_CNS)              ?  "INT_8"                  :\
    (_type_val == IDBG_PDL_LOGGER_TYPEOF_INT_16_CNS)             ?  "INT_16"                 :\
    (_type_val == IDBG_PDL_LOGGER_TYPEOF_INT_32_CNS)             ?  "INT_32"                 :\

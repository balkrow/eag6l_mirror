...
} PDL_PP_ATTRIBUTES_STC;

/**
 * @struct  PDL_PP_FRONT_PANEL_ATTRIBUTES_STC
 *
...
typedef struct {
    /** @brief   The ordering */
    PDL_PANEL_GROUP_ORDERING_TYPE_ENT       ordering;
...
} PDL_PP_FRONT_PANEL_ATTRIBUTES_STC;
...
/**
 * @struct  PDL_PP_NETWORK_PORT_ATTRIBUTES_STC
 *
...
} PDL_PP_NETWORK_PORT_ATTRIBUTES_STC;


/**
 * @struct  PDL_PP_B2B_ATTRIBUTES_STC
 *
...
typedef struct {
    ...
    UINT_32                             secondPort;
    UINT_32                             secondMacPort;
    /** @brief   The maximum speed */
    PDL_PORT_SPEED_ENT                  maxSpeed;
    /** @brief   The interface mode */
    PDL_INTERFACE_MODE_ENT              interfaceMode;
} PDL_PP_B2B_ATTRIBUTES_STC;

/**
 * @struct  PDL_PP_NETWORK_PORT_PHY_INIT_KEY_STC
 *
 * @brief   defines key to phy init values
 */
typedef struct {
    UINT_32                                     index;
} PDL_PP_NETWORK_PORT_PHY_INIT_KEY_STC;

/**
 * @struct  PDL_PP_NETWORK_PORT_PHY_INIT_INFO_STC
 *
 * @brief   defines entry of phy init values
 */
typedef struct {
    PDL_PP_NETWORK_PORT_PHY_INIT_KEY_STC    key;
    PDL_PHY_SMI_XSMI_VALUE_STC                  info;
} PDL_PP_NETWORK_PORT_PHY_INIT_INFO_STC;

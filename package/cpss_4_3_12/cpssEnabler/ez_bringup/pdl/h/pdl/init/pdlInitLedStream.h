...
#define PDL_LEDSTREAM_UNITS_MAX_NUM_CNS       16
/*
...
typedef struct {
    ...
    GT_U32     ledStart[PDL_LEDSTREAM_UNITS_MAX_NUM_CNS];
    GT_U32     ledEnd[PDL_LEDSTREAM_UNITS_MAX_NUM_CNS];
    GT_U32     ledChainBypass[PDL_LEDSTREAM_UNITS_MAX_NUM_CNS];

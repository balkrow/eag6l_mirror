...
typedef PDL_STATUS pdlI2cChannelToDevIdConvert_FUN(
...
typedef void pdlSleep_FUN(
    UINT_32                     msec
);

typedef GT_STATUS pdlMpdLogicalPortValueSet_FUN(
...
typedef struct PDL_OS_CALLBACK_API_STCT {
    ...
    pdlI2cChannelToDevIdConvert_FUN                         *i2cChannelToDevIdConvertClbk;
    PDL_LEDSTREAK_CALLBACK_INFO_STC                          ledStreamCallbackInfo;
    pdlSleep_FUN                                            *sleepClbk;
    pdlMpdLogicalPortValueSet_FUN                           *mpdLogicalPortValueSetClbk;
...
*                PP MPPs can't - they need CPSS to complete initialization

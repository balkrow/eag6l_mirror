...
typedef enum {
    ...
    PDL_POWER_PORT_TYPE_BT_TYPE2_E,
    PDL_POWER_PORT_TYPE_BT_TYPE3_E,
    PDL_POWER_PORT_TYPE_BT_TYPE4_E,
...
typedef enum {
    PDL_POWER_PD_STATUS_POWERED_E,
    PDL_POWER_PD_STATUS_ABSENT_E
} PDL_POWER_PD_STATUS_ENT;
...
/**
 * @struct  PDL_POWER_CAPABILITIES_STC
 *
 ...
 *
 * @brief    Pdl get poe attributes
 *
 * @param [OUT] *poeAttributesPtr   .
 *
 * @return  PDL_STATUS.
 */
...
/**
* @fn  PDL_STATUS pdlPowerPoEPDAttributesGet ( OUT PDL_POE_PARAMS_STC  *poePdAttributesPtr );
 *
 * @brief    Pdl get poe pd attributes
 *
 * @param [OUT] *poePdAttributesPtr   .
 *
 * @return  PDL_STATUS.
 */
 ...
 *
 * @brief    Pdl get poe pd port status (powered/absent)
 *
 * @param [OUT] *pdPoweredStatusPtr   .
 *
 * @return  PDL_STATUS.
 */
PDL_STATUS pdlPowerPDPortPoweredStatusGet(
    OUT UINT_32 *  pdPoweredStatusPtr
);

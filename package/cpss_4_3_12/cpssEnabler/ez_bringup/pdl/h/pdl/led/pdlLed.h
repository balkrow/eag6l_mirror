...
typedef enum {
    ...
    PDL_LED_TYPE_DEVICE_CLOUD_MGMT_E,
    PDL_LED_TYPE_DEVICE_LOCATOR_E,
    PDL_LED_TYPE_DEVICE_SPEED_E,
...
typedef enum {
    ...
    PDL_LED_STATE_ALTERNATE_E,
    PDL_LED_STATE_LAST_E
} PDL_LED_STATE_ENT;


/**
 * @struct  PDL_LED_CAPABILITIES_STC
 *
...
/**
 * @fn  PDL_STATUS pdlLedDbDeviceCapabilitiesGet ( IN PDL_LED_ID_ENT ledId, IN UINT_32 dev, IN UINT_32 logicalPort, OUT PDL_LED_CAPABILITIES_STC * capabilitiesPtr );
 *
...
/**
 * @fn  PDL_STATUS pdlLedDbPortCapabilitiesGet ( IN PDL_LED_ID_ENT ledId, IN UINT_32 dev, IN UINT_32 logicalPort, OUT PDL_LED_CAPABILITIES_STC * capabilitiesPtr );
 *
 * @brief   Get \b led supported capabilities
 *          @note
 *          Based on data retrieved from XML

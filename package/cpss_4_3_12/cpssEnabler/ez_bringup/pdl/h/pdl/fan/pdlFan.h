...
typedef enum {
    ...
    PDL_FAN_CONTROLLER_TYPE_NCT7802_E,
...
/*
 * @brief   Prototype for init function
 */
...
/*
 * @brief   Prototype for deinitializing function
 */
typedef PDL_STATUS pdlFanDbDeInit_FUN(
    IN  void
);
...
typedef PDL_STATUS pdlFanHwRpmGet_FUN(
    IN  UINT_32                      fanControllerId,
    IN UINT_32                       fanNumber,
    OUT UINT_32                    * rpmPtr
);
typedef PDL_STATUS pdlFanHwTemperatureGet_FUN(
    IN  UINT_32                      fanControllerId,
...
} PDL_FAN_CALLBACK_DB_DEINIT_INFO_STC;

typedef struct {
    pdlFanHwRpmGet_FUN                              * fanControllerRpmGetFun;
    PDL_OS_LOCK_TYPE_ENT                              lockType;
} PDL_FAN_CALLBACK_HW_RPM_GET_STC;
typedef struct {
    pdlFanHwTemperatureGet_FUN                      * fanControllerTemperatureGetFun;
    PDL_OS_LOCK_TYPE_ENT                              lockType;
} PDL_FAN_CALLBACK_HW_TEMPERATURE_GET_STC;
...
typedef struct {
    ...
    PDL_FAN_CALLBACK_DB_DEINIT_INFO_STC                                     fanDbDeInitCallbackInfo;
    PDL_FAN_CALLBACK_HW_RPM_GET_STC                                         fanHwRpmGetInfo;
    PDL_FAN_CALLBACK_HW_TEMPERATURE_GET_STC                                 fanControllerHwTemperatureGetCallbackInfo;

...
static PRV_PDLIB_DB_TYP pdlFanEMC2305Db;
    ...
    *statePtr = PDL_FAN_STATE_INFO_OK_E;
    ...
    if (*statePtr != PDL_FAN_STATE_INFO_FAULT_E) {
        ...
        if (pdl_fan_role == PDL_FAN_ROLE_REDUNDANT_E) {
            ...
            pdlStatus = prvPdlibDbFind(pdlFanEMC2305Db, (void*) &fanKey, (void**) &fanPtr);
            PDL_CHECK_STATUS(pdlStatus);
...
)
{
    ...
    /*add to db*/
    pdlStatus = prvPdlibDbAdd(pdlFanEMC2305Db, (void*) &fanDbStruct.fanKey, (void*) &fanDbStruct, (void**) &fanControllerPtr);
    PDL_CHECK_STATUS(pdlStatus);
...
/**
 * @fn  PDL_STATUS prvPdlFanEMC2305DbInit ( void )
 *
...
/**
 * @fn  PDL_STATUS prvPdlFanEMC2305DbDestroy ( void )
 *
 * @brief   Pdl fan deinitialize
 *
 * @return  A PDL_STATUS.
 */
PDL_STATUS prvPdlFanEMC2305DbDestroy(
    IN  void
)
{
    /* ***************************************************************************/
    ...
    pdlStatus = prvPdlibDbDestroy(pdlFanEMC2305Db);
    PDL_CHECK_STATUS(pdlStatus);

    return PDL_OK;
}
/*$ END OF prvPdlFanEMC2305DbDestroy */

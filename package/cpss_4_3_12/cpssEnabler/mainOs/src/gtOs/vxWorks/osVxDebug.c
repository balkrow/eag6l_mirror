...
* @file osVxDebug.c
*
* @brief VxWorks Operating System wrapper. Debug facility.
*
* @version   6
********************************************************************************
*/
...
/**
* @internal prvDebugMonitorFillTraceTimeEntry function
* @endinternal
*
* @brief   Fills trace time entry
*
* @param[out] entryPtr                 - (pointer to) trace time entry
*                                       None
*/
...
/**
* @internal prvDebugCpuUtilizationFromInterrupt function
* @endinternal
*
* @brief   CPU Utilization from ISR
*
* @param[in] endOfInt
*/
...
/**
* @internal prvDebugEntryFromTaskSwitch function
* @endinternal
*
* @brief   Hook to Task Switch
*
* @param[in] pOldTcb                  - pointer to old task's WIND_TCB
* @param[in] pNewTcb                  - pointer to new task's WIND_TCB
*                                       None
*/
...
/**
* @internal prvDebugHookAdd function
* @endinternal
*
* @brief   Adds debug hook to task switch
*
...
/**
* @internal prvDebugCheckHookDelete function
* @endinternal
*
* @brief   Deletes debug hook from task switch
*/
...
/**
* @internal prvDebugTicksUnite function
* @endinternal
*
* @brief   Calculates delta
*
* @param[in] sys_tick1                - old system tick
* @param[in] sys_tick2                - new system tick
* @param[in] time_tick1               - old timer tick
* @param[in] time_tick2               - new timer tick
...
/**
* @internal prvDebugInterruptExpHndlrPrint function
* @endinternal
*
* @brief   Prints Exception information (PPC)
*/
...
#elif defined(CPU_ARM)
/**
* @internal prvDebugPrintStack function
* @endinternal
*
* @brief   Prints stack (ARM)
*
* @param[in] pc                       - (pointer to) Program counter
* @param[in] taskId                   - (pointer to) Task Id
*/
static int    prvDebugPrintStack
(
    GT_U32 *pc,
...
/**
* @internal prvDebugInterruptExcepHndlr function
* @endinternal
*
* @brief   Exception handler hook for ARM.
*/
static int prvDebugInterruptExcepHndlr
(
    int  task,
...
* @endinternal
*
* @brief   Gets task utilization measurement for given task.
*
* @param[in] taskId                   - ID of task whose measurement is to be given.
*
* @param[out] utilizationPtr           - (pointer to) utilization measurement.
*
* @retval GT_OK                    - on success
* @retval GT_NOT_INITIALIZED       - task utilization isn't started
* @retval GT_NOT_FOUND             - given task ID is not found
* @retval GT_FAIL                  - on error
*/
...
)
{
    ...
    else
    {
        ...
        {
            /* the utilization is active for less than a second */
...
/**
* @internal prvDebugUtilPrint function
* @endinternal
*
* @brief   Prints task utilization
*
* @param[in] namePtr
* @param[in] infoPtr
*
...
/**
* @internal osDebugTaskUtilPrint function
* @endinternal
*
* @brief   Prints tasks utilization measurements.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
*/

...
)
{
    ...
    if (poolHdrPtr->first_free_PTR != NULL&&poolHdrPtr->free_size!=0)
    {
...
static GT_VOID dmaFreeAll(GT_VOID)
{
    ...
    while(currentPtr)
    {
        ...
        /*  DO NOT  free the element itself.
            They can be reused after reset.
            We set the myMemoryPtr to NULL so it can be reused next time .
            No point releasing the linked list node.
            Allocation/Dealllocation may cause fragmentation.
        */

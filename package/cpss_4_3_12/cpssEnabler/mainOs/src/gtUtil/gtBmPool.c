...
typedef struct gt_pool_head
{
    ...
    GT_U8                   devNum;  /* select one of the available DMA windows */
...
)
{
    ...
    if (forDma)
    {
        ...
        {
            pBytePtr = osCacheDmaMallocByDevice(devNum , poolSize + alignment);
        }
    }
    else
    {
...
{
    return internalPoolCreatePool(reqBufferSize,alignment,numOfBuffers,useSem,GT_FALSE,0/*devNum*/,pPoolId);
}
/**
...
{
    return internalPoolCreatePool(reqBufferSize,alignment,numOfBuffers,useSem,GT_TRUE,0/*devNum*/,pPoolId);
}

/**
* @internal gtPoolCreateDmaPoolByDevice function
* @endinternal
*
...
*
*/
GT_STATUS gtPoolCreateDmaPoolByDevice
(
    IN   GT_U8             devNum,
    IN   GT_U32            reqBufferSize,
    IN   GT_POOL_ALIGNMENT alignment,
...
{
    return internalPoolCreatePool(reqBufferSize,alignment,numOfBuffers,useSem,GT_TRUE,devNum/*dmaWindow*/,pPoolId);
}

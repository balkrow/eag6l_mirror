...
* @endinternal
*
* @brief   Create pool of DMA buffers from specific device number
*          All buffers have the same size. The buffers are created in a physically
*          contiguous area.
*          the pool is associated with one of the already existing devices.
*
* @param[in] devNum                - The device number to use

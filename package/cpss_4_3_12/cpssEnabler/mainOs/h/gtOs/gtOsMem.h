...
#define ASLR_MODE_OSMEM_MAX_MEMORY_SIZE_USE 256*1024*1024 /* 256MB */
...
*/
    ...
    /* the windowId should be the devNum */
    #define GT_MEMORY_DMA_CONFIG_WINDOWS_CNS    GT_MEMORY_DMA_DEVICE_INFO_CNS
#else
...
/* @brief : the max number of DMA capable devices for which info will be stored
*
*/
#define GT_MEMORY_DMA_DEVICE_INFO_CNS        128

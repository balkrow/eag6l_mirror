...
typedef enum
{
    ...
    GRANULAR_LOCKING_TYPE_TRAFFIC_MANAGER_CONFIGURATION,        /*Mutex is manager and device related ,functionality is configuration*/
    GRANULAR_LOCKING_TYPE_FLEXE_CONFIGURATION                   /*Mutex is manager and device related ,functionality is configuration*/

...
static CPSS_APP_PLATFORM_MPP_SELECT_STC ac5x_mpp_select_Arr[] =
{
     /* mppNum          mppSelect    */
     {       19          , 0          },
     {       38          , 1          },
...
CPSS_APP_PLATFORM_BOARD_PARAM_PP_MAP_STC PP_AC5X_PP_MAP_TABLE =
{
    ...
    _SM_(mppSelectPtr          ) ac5x_mpp_select_Arr,
    _SM_(mppSelectArrSize      ) sizeof(ac5x_mpp_select_Arr)/sizeof(CPSS_APP_PLATFORM_MPP_SELECT_STC)
};
...
CPSS_APP_PLATFORM_BOARD_PARAM_PP_MAP_STC PP_AC5X_0_PP_MAP_TABLE =
{
    _SM_(mapType               ) CPSS_APP_PLATFORM_PP_MAP_TYPE_FIXED_E,
    _SM_(mngInterfaceType      ) CPSS_CHANNEL_PEX_EAGLE_E,
    _SM_(devNum                ) 0,
...
CPSS_APP_PLATFORM_BOARD_PROFILE_STC WM_AC5X_0_PP_MAP_INFO =
{
    _SM_(boardInfoType             ) CPSS_APP_PLATFORM_BOARD_PARAM_PP_MAP_E,
    {
#ifdef ANSI_PROFILES
        _SM_(ppMapPtr   ) (CPSS_APP_PLATFORM_BOARD_PARAM_GENERIC_STC*)&PP_AC5X_0_PP_MAP_TABLE
#else
        _SM_(ppMapPtr   ) &PP_AC5X_0_PP_MAP_TABLE
#endif
    }
};

CPSS_APP_PLATFORM_BOARD_PARAM_PP_MAP_STC PP_AC5X_1_PP_MAP_TABLE =
{
    _SM_(mapType               ) CPSS_APP_PLATFORM_PP_MAP_TYPE_FIXED_E,
    _SM_(mngInterfaceType      ) CPSS_CHANNEL_PEX_EAGLE_E,
    _SM_(devNum                ) 1,
...
CPSS_APP_PLATFORM_BOARD_PROFILE_STC WM_AC5X_1_PP_MAP_INFO =
{
    _SM_(boardInfoType             ) CPSS_APP_PLATFORM_BOARD_PARAM_PP_MAP_E,
    {
#ifdef ANSI_PROFILES
        _SM_(ppMapPtr   ) (CPSS_APP_PLATFORM_BOARD_PARAM_GENERIC_STC*)&PP_AC5X_1_PP_MAP_TABLE
#else
        _SM_(ppMapPtr   ) &PP_AC5X_1_PP_MAP_TABLE
#endif
    }
};

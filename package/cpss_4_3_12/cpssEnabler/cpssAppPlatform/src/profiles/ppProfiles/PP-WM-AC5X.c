...
static CPSS_APP_PLATFORM_PP_PARAM_CASCADE_STC ac5x_b2b_0_cscd_arr[] =
{
     /* numCscdTrunks, srcDevNum, trgtDevNum,  {trunkInfo - trunkID, numCscdPorts, cscdPortType,  {portList} } */
     { 1, 0, 1, {{1, 4, CPSS_CSCD_PORT_DSA_MODE_4_WORDS_E, {50, 51, 52, 53} }} }
};

static CPSS_APP_PLATFORM_PP_PARAM_CASCADE_STC ac5x_b2b_1_cscd_arr[] =
{
     /* numCscdTrunks, trgtDevNum,  {trunkInfo - trunkID, numCscdPorts, cscdPortType,  {portList} } */
     { 1, 1, 0, {{1, 4, CPSS_CSCD_PORT_DSA_MODE_4_WORDS_E, {50, 51, 52, 53} }} }
};
...
#define CPSS_APP_PLATFORM_PP_PROFILE_PHASE2_DEFAULTS_1 \
    _SM_(newDevNum                  ) 1, /* to be modified */ \
    _SM_(auDescNum                  ) 12288,\
    _SM_(auMessageLength            ) CPSS_AU_MESSAGE_LENGTH_8_WORDS_E,\
    _SM_(useDoubleAuq               ) GT_TRUE,\
    _SM_(useSecondaryAuq            ) GT_FALSE,\
...
#define CPSS_APP_PLATFORM_PP_PROFILE_LOGICAL_INIT_DEFAULTS_0 \
    /*Logical Init*/\
    _SM_(routingMode                ) CPSS_DXCH_POLICY_BASED_ROUTING_ONLY_E, \
    _SM_(maxNumOfPbrEntries         ) 5120,\
    _SM_(lpmMemoryMode              ) CPSS_DXCH_LPM_RAM_MEM_MODE_FULL_MEM_SIZE_E,\
    ...
    _SM_(mirrorAnalyzerPortNum      ) 0,\
    /*Cascade Init*/\
    _SM_(cascadePtr                 ) ac5x_b2b_0_cscd_arr


#define CPSS_APP_PLATFORM_PP_PROFILE_LOGICAL_INIT_DEFAULTS_1 \
    /*Logical Init*/\
    _SM_(routingMode                ) CPSS_DXCH_POLICY_BASED_ROUTING_ONLY_E, \
    _SM_(maxNumOfPbrEntries         ) 5120,\
    _SM_(lpmMemoryMode              ) CPSS_DXCH_LPM_RAM_MEM_MODE_FULL_MEM_SIZE_E,\
    ...
    _SM_(mirrorAnalyzerPortNum      ) 0,\
    /*Cascade Init*/\
    _SM_(cascadePtr                 ) ac5x_b2b_1_cscd_arr
...
/** Macro for PP serdes polarity Params RD **/
#define CPSS_APP_PLATFORM_PP_PROFILE_RD_SERDES_PARAMS_DEFAULTS \
    /*Serdes Params*/\
...
CPSS_APP_PLATFORM_PP_PROFILE_STC WM_AC5X_0_PP_INFO = {
	CPSS_APP_PLATFORM_PP_PROFILE_PP_NAME_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_DEFAULTS_128_PHY,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_AP_ENABLE,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE2_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_AFTER_PHASE2_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_LOGICAL_INIT_DEFAULTS_0,
    CPSS_APP_PLATFORM_PP_PROFILE_LIB_INIT_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_SERDES_PARAMS_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_SERDES_MUX_PARAMS_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_NO_INTERNAL_CPU,
...
CPSS_APP_PLATFORM_PP_PROFILE_STC WM_AC5X_1_PP_INFO = {
	CPSS_APP_PLATFORM_PP_PROFILE_PP_NAME_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_DEFAULTS_128_PHY,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_AP_ENABLE,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE2_DEFAULTS_1,
    CPSS_APP_PLATFORM_PP_PROFILE_AFTER_PHASE2_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_LOGICAL_INIT_DEFAULTS_1,
    CPSS_APP_PLATFORM_PP_PROFILE_LIB_INIT_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_SERDES_PARAMS_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_SERDES_MUX_PARAMS_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_NO_INTERNAL_CPU,
...
CPSS_APP_PLATFORM_PP_PROFILE_STC WM_AC5X_0_INT_CPU_PP_INFO = {
    CPSS_APP_PLATFORM_PP_PROFILE_PP_NAME_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_DEFAULTS_128_PHY,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_AP_ENABLE,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE2_DEFAULTS,
...
CPSS_APP_PLATFORM_PP_PROFILE_STC WM_AC5X_INT_CPU_RD_PP_INFO = {
    CPSS_APP_PLATFORM_PP_PROFILE_PP_NAME_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_DEFAULTS_128_PHY,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_AP_ENABLE,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE2_DEFAULTS,
    ...
    CPSS_APP_PLATFORM_PP_PROFILE_LOGICAL_INIT_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_LIB_INIT_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_RD_SERDES_PARAMS_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_SERDES_MUX_PARAMS_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_INTERNAL_CPU,

...
* @file PP-WM-AC5.c
*
* @brief PP-WM-AC5 Packet Processor information.
*
* @version   1
********************************************************************************/
...
#if 0
static CPSS_APP_PLATFORM_SERDES_LANE_POLARITY_STC  ac5_DB_PolarityArray[] =
{
...
#define CPSS_APP_PLATFORM_PP_PROFILE_PHASE2_DEFAULTS \
    ...
    _SM_(auDescNum                  ) 4096,\
    _SM_(auMessageLength            ) CPSS_AU_MESSAGE_LENGTH_4_WORDS_E,\
...
#define CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_DEFAULTS_128_PHY \
    ...
    _SM_(isrAddrCompletionRegionsBmp) 0x2,\
...
/*GREG MSA AC5P does not have this initialization*/
...
#define CPSS_APP_PLATFORM_PP_PROFILE_PP_NAME_DEFAULTS \
    _SM_(ppName                ) "AC5" /*GREG AC% or AC5P ???*/

CPSS_APP_PLATFORM_PP_PROFILE_STC WM_AC5_PP_INFO = {
...
CPSS_APP_PLATFORM_PP_PROFILE_STC WM_AC5_INT_CPU_PP_INFO = {
	CPSS_APP_PLATFORM_PP_PROFILE_PP_NAME_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_DEFAULTS_128_PHY,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_AP_ENABLE,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE2_DEFAULTS,
...
CPSS_APP_PLATFORM_PP_PROFILE_STC DB_AC5_INT_CPU_PP_INFO = {
	CPSS_APP_PLATFORM_PP_PROFILE_PP_NAME_DEFAULTS,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_DEFAULTS_128_PHY,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE1_AP_ENABLE,
    CPSS_APP_PLATFORM_PP_PROFILE_PHASE2_DEFAULTS,

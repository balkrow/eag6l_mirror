...
#else
static CPSS_APP_PLATFORM_SDMA_QUEUE_STC txGenQueues[] = { {0,3,256,144}, {0,6,256,144}, {15,6,1,3032}, {15,7,1,144} };
#endif
...
#define CPSS_APP_PLATFORM_PP_PROFILE_PHASE2_DEFAULTS \
    ...
    _SM_(txDescNum                  ) 160, /* To resolve memory exhaust error in Falcon_12_8_B2B,
...
#define CPSS_APP_PLATFORM_PP_PROFILE_LIB_INIT_DEFAULTS \
	...
	_SM_(phaFwImageId               ) 2,\
	_SM_(phaFwImageIdVersion        ) 554696704,\
	_SM_(phaThreadList              ) NULL /*GREG phaThreads*/,\
...
#define CPSS_APP_PLATFORM_PP_PROFILE_COS_DEFAULTS          \
    ...
    _SM_(globalTailDropLimit                   ) 360000,   \
    _SM_(profileCount                          ) 0,        \
    ...
    _SM_(multicastTailDropLimit                ) 300000,   \
    _SM_(multicastTailDropLowGuaranteedLimit   ) 300000,   \
    _SM_(multicastTailDropHighGuaranteedLimit  ) 300000,   \

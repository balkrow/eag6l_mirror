...
extern CPSS_PORTS_BMP_STC appRefTodoTuneBmp[CPSS_APP_PLATFORM_MAX_PP_CNS]; /* bitmap of ports to run tuning*/
...
static GT_U32   printLinkChangeEnabled = 0; /* By default don't print log for all devices */

static GT_U32   printEeeInterruptInfo = 0;/* WM not supports this interrupt */

static CPSS_ENABLER_LINK_PORT_MODE_ENT linkScanMode[PRV_CPSS_MAX_PP_DEVICES_CNS][CPSS_MAX_PORTS_NUM_CNS];
    ...
    switch (uniEv)
    {
        ...
        case CPSS_PP_PORT_MMPCS_SIGNAL_DETECT_CHANGE_E:
            ...
            else /* legacy Mode */
            {
                ...
                {
                    CPSS_PORTS_BMP_PORT_SET_MAC(&appRefTodoTuneBmp[devNum], portNum);
...
/**
* @internal cpssAppRefLinkChangePortModeSet function
* @endinternal
*
* @brief   Enable or disable link notification on port.
*
* @param[in] devNum    - device number.
*
* @retval GT_OK        - on success
*
*/
GT_STATUS cpssAppRefLinkChangePortModeSet
(
    IN GT_U8                             devNum,
    IN GT_32                             portNum,
    IN CPSS_ENABLER_LINK_PORT_MODE_ENT   mode
)
{

    linkScanMode[devNum][portNum] = mode;
...
/**
* @internal cpssAppRefLinkChangePortModeGet function
* @endinternal
*
* @brief   Get link notification status on port.
*
* @param[in] devNum    - device number.
*
* @retval GT_OK        - on success
*
*/
GT_STATUS cpssAppRefLinkChangePortModeGet
(
    IN  GT_U8                             devNum,
    IN  GT_32                             portNum,
    OUT CPSS_ENABLER_LINK_PORT_MODE_ENT   *mode
)
{

    *mode = linkScanMode[devNum][portNum];

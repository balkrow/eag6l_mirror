...
/**
* @enum CPSS_ENABLER_LINK_PORT_MODE_ENT
 *
 * @brief Enumeration for linkscan port modes.
*/
typedef enum{

    /** @brief Ignore link change notification on ports
     */
    CPSS_ENABLER_LINKSCAN_PORT_MODE_NONE_E = 0,

    /** @brief Enables link change notification on ports
     */
    CPSS_ENABLER_LINKSCAN_PORT_MODE_HW_E = 2,

    /** @brief last
     */
    CPSS_ENABLER_LINKSCAN_PORT_MODE_LAST_E

} CPSS_ENABLER_LINK_PORT_MODE_ENT;

...
{
    /* Port is disabled */
    CPSS_APP_PLATFORM_L1_PORT_DEFAULT_TYPE_DISABLED_E = 0,
    /* Port is enabled with fixed speed*/
    CPSS_APP_PLATFORM_L1_PORT_DEFAULT_TYPE_FIX_E = 1,
    /* Port is enabled with Autoneg Protocol */
    CPSS_APP_PLATFORM_L1_PORT_DEFAULT_TYPE_AP_E = 2,
    CPSS_APP_PLATFORM_L1_PORT_DEFAULT_TYPE_LAST_E = 3
} CPSS_APP_PLATFORM_L1_PORT_DEFAULT_TYPE_ENT;
...
typedef struct
{
    ...
    /* Port type – disabled/fixed-speed/ap */
    CPSS_APP_PLATFORM_L1_PORT_DEFAULT_TYPE_ENT
                                         portEnabledByDefault;
    /* Lane TX/RX parameters */
    CPSS_PM_MODE_LANE_PARAM_STC          laneParams;
    /* Port AP parameters */

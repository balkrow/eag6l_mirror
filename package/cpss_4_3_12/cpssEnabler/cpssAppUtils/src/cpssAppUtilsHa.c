...
)
{
    ...
    {
      if(PRV_SHARED_CPSS_DRIVER_PP_CONFIG_NO_CAST[i] == NULL)
      {
          continue;
      }
    ...
    cpssOsMemSet(&(PRV_SHARED_GLOBAL_VAR_SYSTEM_RECOVERY_MANAGERS_DB),0,sizeof(PRV_CPSS_SYSTEM_RECOVERY_MANAGER_STC));

    /*clear systemRecoveryErrorInjection Db */
    cpssOsMemSet(&(PRV_NON_SHARED_GLOBAL_VAR_SYSTEM_RECOVERY_ERROR_INJECTION_DB),0,sizeof(CPSS_SYSTEM_RECOVERY_ERROR_INJECTION_STC));
...
#ifdef CPSS_APP_PLATFORM
/**
* @internal cpssAppPlatformReInitSystem function
* @endinternal
*
...
* @retval GT_FAIL                  - otherwise.
*/
GT_STATUS cpssAppPlatformReInitSystem
(
    GT_VOID
)
{
...
/**
* @internal appPlatformEventRequestDrvnModeInit function
* @endinternal
*
...
* @retval GT_FAIL                  - otherwise.
*/
GT_STATUS appPlatformEventRequestDrvnModeInit
(
    IN GT_VOID
)
{
    ...
    {
        CPSS_APP_PLATFORM_LOG_INFO_MAC("appDemoEventRequestDrvnModeInit  skiped due to system recovery in HA/HS process");
        return GT_OK;
    }

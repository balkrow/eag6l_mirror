...
/* Use in MYD_MAPPED_SERDES_ID macro; SerdesID[] stores the mapping of 32 SerDes lanes */
/* [Port 0-3][MYD_HOST_MODE_IDX/MYD_LINE_MODE_IDX][LaneOffset 0-3] */
extern const MYD_U16 SerdesID[MYD_MAX_PORTS][MYD_NUM_INTERFACE][MYD_NUM_LANES]; 
...
#define MYD_MAPPED_SERDES_ID(portIDx,HostOrLinex,laneOffsetx) SerdesID[portIDx][HostOrLinex][laneOffsetx]

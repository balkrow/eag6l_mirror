...
/********************************************************************
 ...
 PHYS CUX3610(M)/CUE2610(M) and CUX3680/CUE2680/CUE2681
 MTD_CE_SERDES32X1X4 (to use serdes functions, for example, to swap serdes polarity)
 MTD_TU_PTP (to use PTP)
...
/* CE Serdes Support, include subdirectories:
   ./serdes/mcesd
   ./serdes/mcesd/C28GP4X2 (for 28X2, exclude this directory if not needed)
   ./serdes/mcesd/N5C32GP5X4 (for 32X1 or 32X4, exclude this directory if not needed) */

#ifndef MTD_CE_SERDES28X2
#define MTD_CE_SERDES28X2        0
#endif

#ifndef MTD_CE_SERDES32X1X4
#define MTD_CE_SERDES32X1X4        0
#endif

/* Groups of related features that share code */
/* Do not modify. */
#define MTD_PKG_CE_SERDES         (MTD_CE_SERDES28X2 || MTD_CE_SERDES32X1X4)

/* MACSec support for X3610 */
#if defined(MACSEC_API_IEEE) || defined(MTD_RS_MACSEC_CT)
#define MTD_RS_MACSEC 1
#endif

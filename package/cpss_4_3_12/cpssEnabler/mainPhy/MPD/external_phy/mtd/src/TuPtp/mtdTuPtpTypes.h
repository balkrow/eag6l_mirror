...
structures for the 88X35X0 and CUX36X0/CUE26X0Ethernet PHYs.
********************************************************************/
...
/* X36X0 PTP Control/Status/Clock Registers Definitions */
#define MTD_TU_XGTOP_XG_CLK_ENABLE    0xD800
#define MTD_TU_XGTOP_XG_BLK_RESET     0xD801
#define MTD_TU_PTP_36X0_CNTL_REG0     0xD820
#define MTD_TU_PTP_36X0_CNTL_REG1     0xD821
#define MTD_TU_XGTOP_XG_PTP_INT_MASK  0xD829
#define MTD_TU_MPM_CONFIG           0xD830
#define MTD_TU_MPM_SOFT_RESET       0xD831
#define MTD_TU_XGM_PCS156_TST_CTRL  0xDC04

/* X35X0 PTP Control/Status/Clock Registers Definitions */
...
typedef enum _MTD_TU_PTP_MODE
{
    MTD_PTP_BOUNDARY_CLK     = 0x0,
    MTD_PTP_PEER_TO_PEER_CLK = 0x1,
    MTD_PTP_END_TO_END_CLK   = 0x2
} MTD_TU_PTP_MODE;

typedef enum _MTD_TU_PTP_STEP
{
    MTD_PTP_TWO_STEP = 0x0,
    MTD_PTP_ONE_STEP = 0x1
}MTD_TU_PTP_STEP;

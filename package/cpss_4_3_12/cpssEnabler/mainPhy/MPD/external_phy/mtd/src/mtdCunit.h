...
/******************************************************************************
 ...
 Returns:
    MTD_OK or MTD_FAIL (if called for X35X0 devices or other error occurs)
 ...
 Notes/Warnings:
    ...
    NOTE: An error will be returned if called for X35X0 devices.
          Use mtdPutPhyInLowPowerMode() and mtdRemovePhyLowPowerMode()
          instead to power down/up X35X0 devices.

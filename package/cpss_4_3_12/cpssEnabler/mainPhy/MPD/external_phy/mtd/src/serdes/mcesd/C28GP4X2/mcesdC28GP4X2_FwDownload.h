...
COMPHY_28G_PIPE4_X2
********************************************************************/
#ifndef MCESD_C28GP4X2_FW_DOWNLOAD_H
#define MCESD_C28GP4X2_FW_DOWNLOAD_H
...
@note Can only be downloaded as part of the API_C28GP4X2_PowerOnSeq() sequence.
...
@note Expected to only be called by API_C28GP4X2_DownloadFirmware()
...
#endif /* defined MCESD_C28GP4X2_FW_DOWNLOAD_H */

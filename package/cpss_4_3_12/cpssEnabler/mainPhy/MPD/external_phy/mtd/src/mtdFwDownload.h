...
/* X36X0 parts */
#define MTD_MAX_X36X0_MAX_SERDES_IMG_SZ (128*1024UL)
#define MTD_MAX_X36X0_FLASH_IMAGE_SIZE (MTD_MAX_X35X0_APP_SIZE+ MTD_MAX_X36X0_MAX_SERDES_IMG_SZ + (MTD_MAX_X35X0_HEADERS*MTD_HEADER_SIZE))
...
/******************************************************************************
 ...
 Notes/Warnings:
    This function is not applicable for X35X0/E25X0 devices. Call mtdParallelUpdateRamImage() instead.
    For X35X0/E25X0 one-port-at-a-time RAM download is not supported.
...
/******************************************************************************
 ...
 Notes/Warnings:    
    ...
    X3580/E2580 have special requirements for RAM download. Please see
    mtdSampleUpdateRamImageX3580() for a description how to do the RAM
    download for X3580/E2580.

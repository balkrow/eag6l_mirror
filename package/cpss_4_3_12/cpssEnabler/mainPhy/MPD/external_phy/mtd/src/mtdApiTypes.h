...
#ifdef MTD_EXPORT_FUNC
#define MTD_FUNC __declspec(dllexport)
#else
#define MTD_FUNC
#endif
...
/* MTD_DEVICE_ID format (assumes 32-bit minimum enum ):  */
/* Bits 31:24 reserved */
/* Bits 23:16 Extended base type, when base type(i.e. ieee model) is 0x3F, this holds Marvell extended model number */
/*            Will be 0 for those parts with other ieee model numbers (not 0x3F) */
/* Bit 15: 1-> It's an X35X0 octal port device */
/* Bit 14: 1-> It's an X36X0 single port T device */
/* Bit 13: 1-> E21X1 device with max speed of 2.5G, or just max speed 2.5G for devices after  */
/* Bit 12: 1-> E20X0 device with max speed of 5G, or just max speed of 5G for devices after */
/* Bit 11: 1-> Macsec Capable (Macsec/PTP module included */
/* Bit  10: 1-> Copper Capable (T unit interface included) */
/* Bits 9:4 0x18 -> X32X0 base, 0x1A X33X0 base, 0x1B E21X0 base, 0x3C X35X0 base, 0x3F plus another 8 bits X36X0 base */
/*          These bits may not be 0. Fully 0 extended base/base is not allowed. */
/* Bits 3:0 revision/number of ports indication, see list */
/* Following defines are for building MTD_DEVICE_ID */
#define MTD_X35X0_OCTALDEV (1UL<<15) /* whether it's an X35X0 octal device */
#define MTD_X36X0_TDEVICE (1UL<<14)  /* whether it's an X36X0 T device */  
#define MTD_E21X1_DEVICE (1UL<<13)   /* whether this is an E21X1 device group */
#define MTD_E2XX0_DEVICE (1UL<<12)   /* whether this is an E2XX0, i.e 5g and below device group */
#define MTD_MACSEC_CAPABLE (1UL<<11) /* whether the device has a Macsec/PTP module */
#define MTD_COPPER_CAPABLE (1UL<<10) /* whether the device has a copper (T unit) module */
#define MTD_X32X0_BASE (0x18UL<<4)   /* whether the device uses X32X0 firmware base */
#define MTD_X33X0_BASE (0x1AUL<<4)   /* whether the device uses X33X0 firmware base */
#define MTD_E21X0_BASE (0x1BUL<<4)   /* whether the device uses E21X0 firmware base, this is a max 5G part, copper only, no Macsec, basic PTP */
#define MTD_X35X0_BASE (0x3CUL<<4)   /* whether the device uses X35X0 firmware base, this is a max 10G part, */

/* Starting with X36X0 parts, model number is 0x3F and base comes from 3.DB01.15:8 */
#define MTD_EXTENDED_BASE (0x3FUL<<4)  /* devices X36X0 and later, other bits in 0.3.DB01.15:8 */
#define MTD_X36X0_BASE    (0x00UL<<16 | MTD_EXTENDED_BASE) /* whether device uses X36X0 firmware base */

#define MTD_DEVID_GETBASE(mTdrevID)    (mTdrevID & ((0xFFUL<<16) | (0x3FUL<<4)))  /* to get full ieee model number/base */
                                                                                 /* parts prior to X36X0 it was only 6 bits */
                                                                                 /* starting with X36X0 it is 8 bits and 6 bits*/                                                                                 

/* Following macros are to test MTD_DEVICE_ID for various features */
#define MTD_IS_DEVID_UNK(mTdrevId) ((MTD_BOOL)(mTdrevId == MTD_REV_UNKNOWN))
#define MTD_IS_MACSEC_CAPABLE(mTdrevId) ((MTD_BOOL)((mTdrevId & MTD_MACSEC_CAPABLE) && (!MTD_IS_DEVID_UNK(mTdrevId))))
#define MTD_IS_COPPER_CAPABLE(mTdrevId) ((MTD_BOOL)((mTdrevId & MTD_COPPER_CAPABLE)&& (!MTD_IS_DEVID_UNK(mTdrevId))))
#define MTD_IS_X32X0_BASE(mTdrevId) ((MTD_BOOL)((MTD_DEVID_GETBASE(mTdrevId) == MTD_X32X0_BASE) && (!MTD_IS_DEVID_UNK(mTdrevId))))
#define MTD_IS_X33X0_BASE(mTdrevId) ((MTD_BOOL)((MTD_DEVID_GETBASE(mTdrevId) == MTD_X33X0_BASE) && (!MTD_IS_DEVID_UNK(mTdrevId))))
#define MTD_IS_E21X0_BASE(mTdrevId) ((MTD_BOOL)((MTD_DEVID_GETBASE(mTdrevId) == MTD_E21X0_BASE) && (!MTD_IS_DEVID_UNK(mTdrevId))))
#define MTD_IS_X35X0_BASE(mTdrevId) ((MTD_BOOL)((MTD_DEVID_GETBASE(mTdrevId) == MTD_X35X0_BASE) && (!MTD_IS_DEVID_UNK(mTdrevId))))
#define MTD_IS_X36X0_BASE(mTdrevId) ((MTD_BOOL)((MTD_DEVID_GETBASE(mTdrevId) == MTD_X36X0_BASE) && (!MTD_IS_DEVID_UNK(mTdrevId))))
#define MTD_HAS_X_UNIT(mTddevPtr)   !(MTD_IS_E21X0_BASE(mTddevPtr->deviceId)   || \
                                      ...
                                      MTD_IS_X36X0_BASE(mTddevPtr->deviceId))

/* Following macros are to test whether passed-in device structure is a specific device */
#define MTD_IS_E2XX0_DEVICE(mTdrevId) ((MTD_BOOL)((mTdrevId & MTD_E2XX0_DEVICE) && (!MTD_IS_DEVID_UNK(mTdrevId)))) /* E20X0, E25X0 or E26X0 device, i.e. no 10G copper and no X unit */
#define MTD_IS_E20X0_DEVICE(mTdrevId) ((MTD_IS_X33X0_BASE(mTdrevId)) && (MTD_IS_E2XX0_DEVICE(mTdrevId)))
#define MTD_IS_E25X0_DEVICE(mTdrevId) ((MTD_IS_X35X0_BASE(mTdrevId)) && (MTD_IS_E2XX0_DEVICE(mTdrevId)))
...
#define MTD_IS_E21X1_DEVICE(mTdrevId) ((MTD_BOOL)((mTdrevId & MTD_E21X1_DEVICE) && (!MTD_IS_DEVID_UNK(mTdrevId)))) /* E2111 or E2181 device, 2.5G and below device */
#define MTD_IS_X3680_DEVICE(mTddevPtr) (MTD_IS_X36X0_BASE(mTddevPtr->deviceId) && mTddevPtr->numPortsPerDevice == 8) /* Will also be true for E2680 */
#define MTD_IS_X3610_DEVICE(mTddevPtr) (MTD_IS_X36X0_BASE(mTddevPtr->deviceId) && mTddevPtr->numPortsPerDevice == 1) /* Will also be true for E2610 */
#define MTD_IS_X36X0_DEVICE(mTddevPtr) (MTD_IS_X3680_DEVICE(mTddevPtr) || MTD_IS_X3610_DEVICE(mTddevPtr))
...
#define MTD_X35X0BASE_QUADOCTAL_PORTB3 0x7 /* X3540/X3580 */

#define MTD_X36X0BASE_SINGLE_PORTA0  0x0 /* X36X0/E26X0 */
#define MTD_X36X0BASE_SINGLE_PORTA1  0x1
#define MTD_X36X0BASE_SINGLE_PORTA2 0x2
#define MTD_X36X0BASE_SINGLE_PORTB0  0x4
#define MTD_X36X0BASE_OCTAL_PORTA0   0x8
#define MTD_X36X0BASE_OCTAL_PORTA1  0x9
#define MTD_X36X0BASE_OCTAL_PORTB0   0xC
...
typedef enum
{
    ...
    MTD_REV_X3540_B3 = (MTD_X35X0_BASE | MTD_COPPER_CAPABLE | MTD_X35X0BASE_QUADOCTAL_PORTB3),
    ...
    MTD_REV_E2540_B3 = (MTD_E2XX0_DEVICE | MTD_X35X0_BASE | MTD_COPPER_CAPABLE | MTD_X35X0BASE_QUADOCTAL_PORTB3),

    MTD_REV_X3580_A0 = (MTD_X35X0_BASE | MTD_COPPER_CAPABLE | MTD_X35X0BASE_OCTAL_PORTA0),    
    MTD_REV_X3580_B3 = (MTD_X35X0_OCTALDEV | MTD_X35X0_BASE | MTD_COPPER_CAPABLE | MTD_X35X0BASE_QUADOCTAL_PORTB3),
    MTD_REV_E2580_A0 = (MTD_E2XX0_DEVICE | MTD_X35X0_BASE | MTD_COPPER_CAPABLE | MTD_X35X0BASE_OCTAL_PORTA0),
    MTD_REV_E2580_B3 = (MTD_X35X0_OCTALDEV | MTD_E2XX0_DEVICE | MTD_X35X0_BASE | MTD_COPPER_CAPABLE | MTD_X35X0BASE_QUADOCTAL_PORTB3),

    MTD_REV_X3610_A0 = (MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA0),
    MTD_REV_X3610_A1 = (MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA1),
    MTD_REV_X3610_A2 = (MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA2), 
    MTD_REV_X3610_B0 = (MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTB0),

    MTD_REV_X3610M_A0 = (MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA0),
    MTD_REV_X3610M_A1 = (MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA1), 
    MTD_REV_X3610M_A2 = (MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA2),
    MTD_REV_X3610M_B0 = (MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTB0),

    MTD_REV_X3610T_A0 = (MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_X36X0_TDEVICE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA0),
    MTD_REV_X3610T_A1 = (MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_X36X0_TDEVICE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA1), 
    MTD_REV_X3610T_A2 = (MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_X36X0_TDEVICE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA2),
    MTD_REV_X3610T_B0 = (MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_X36X0_TDEVICE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTB0),

    MTD_REV_X3680_A0 = (MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_OCTAL_PORTA0),
    MTD_REV_X3680_A1 = (MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_OCTAL_PORTA1),
    MTD_REV_X3680_B0 = (MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_OCTAL_PORTB0),

    MTD_REV_E2610_A0 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA0),
    MTD_REV_E2610_A1 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA1),
    MTD_REV_E2610_A2 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA2),
    MTD_REV_E2610_B0 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTB0),    

    MTD_REV_E2610M_A0 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA0),
    MTD_REV_E2610M_A1 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA1),     
    MTD_REV_E2610M_A2 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA2),     
    MTD_REV_E2610M_B0 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTB0),

    MTD_REV_E2610T_A0 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_X36X0_TDEVICE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA0),
    MTD_REV_E2610T_A1 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_X36X0_TDEVICE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA1),     
    MTD_REV_E2610T_A2 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_X36X0_TDEVICE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTA2),     
    MTD_REV_E2610T_B0 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_MACSEC_CAPABLE | MTD_X36X0_TDEVICE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_SINGLE_PORTB0),

    MTD_REV_E2680_A0 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_OCTAL_PORTA0),
    MTD_REV_E2680_A1 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_OCTAL_PORTA1),
    MTD_REV_E2680_B0 = (MTD_E2XX0_DEVICE | MTD_X36X0_BASE | MTD_COPPER_CAPABLE | MTD_X36X0BASE_OCTAL_PORTB0)    
...
typedef union _MTD_SERDES_CTRL_TYPE {
    ...
    MTD_SERDES_CTRL c28gX2;     /* X35X0 PHYs */
    MTD_SERDES_CTRL n5c32gX1X4; /* X36X0 PHYs */
...
typedef struct _MTD_RSMASEC_CTRL_TYPE {
    RmsDev_t rmsDev;     /* RS_MACSEC device pointer */
    MTD_U16  rsMACSecPort;
    MTD_U32  rsMACSecData;  /* reserved 32 bits for RS_MACSEC control union */
} MTD_RSMASEC_CTRL_TYPE;
...
#if MTD_RS_MACSEC
    MTD_RSMASEC_CTRL_TYPE rsMACSecCntl;         /* Structure for controlling RS_MACSec */
#endif
...
#define MTD_ENABLE_AS_NEEDED    2    /* feature enable as needed */

...
#define MTD_HUNIT_COMMON_NUM_REGS (46 + 23) /* 23 package gen registers are offset by 0x900 print both sets of these */
#endif                                      /* registers for x36x0 and none x36x0 */
...
#define MTD_TUNIT_MMD1_NUM_REGS 74
#endif

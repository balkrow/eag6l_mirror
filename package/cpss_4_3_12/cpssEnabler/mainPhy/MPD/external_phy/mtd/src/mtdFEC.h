...
(
 ...
 Description:
    Enables or disable the RS-FEC. Call only on the primary port for
    for DXGMII/QXGMII/OXGMII to disable the RS-FEC.
...
(
 ...
 Description:
    ...
    Enable in the RS-FEC Control Register. Call only on the primary port for
    for DXGMII/QXGMII/OXGMII to disable the RS-FEC.
...
(
 ...
 Description:
    ...
    Call only on the primary port for for DXGMII/QXGMII/OXGMII to disable the 
    RS-FEC.
...
(
 ...
 Description:
    ...
    registers based on the mode/speed. Call only on the primary port for
    for DXGMII/QXGMII/OXGMII to disable the RS-FEC.
...
(
 ...
 Description:
    Reset the RS-FEC block, including RS-FEC counters. Call only on the 
    primary port for for DXGMII/QXGMII/OXGMII to disable the RS-FEC.
...
(
 ...
 Description:
    Reads the RS-FEC corrected codewords counter. Call only on the primary port for
    for DXGMII/QXGMII/OXGMII to disable the RS-FEC.
...
(
 ...
 Description:
    Reads the RS-FEC uncorrected codewords counter. Call only on the primary port for
    for DXGMII/QXGMII/OXGMII to disable the RS-FEC.
...
(
 ...
 Description:
    Read RS-FEC symbol error counter per FEC lane. Call only on the 
    primary port for DXGMII/QXGMII/OXGMII to disable the RS-FEC.

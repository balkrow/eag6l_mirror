...
********************************************************************/
#ifndef MCESD_N5C32GP5X4_API_H
#define MCESD_N5C32GP5X4_API_H
...
@note When enabled, per-lane field writes may have possibility of affecting the other fields in the reg.
@note For example, if LANE_SEL is 0 and MCESD is writing to a field, then a 32-bit read is performed on the field's register in lane 0.
@note Then the read value is modified to change the value to the target field and the whole 32-bit value is written to ALL lanes because of broadcast.
@note Therefore lanes having different intended values in the other fields will be overwritten.
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  mode - E_N5C32GP5X4_PHYMODE enum to represent SERDES, etc.
...
@param[out] mode - N5C32GP5X4_PHYMODE_SERDES.
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  txFreq - E_N5C32GP5X4_REFFREQ enum that represents the reference frequency
@param[in]  rxFreq - E_N5C32GP5X4_REFFREQ enum that represents the reference frequency
@param[in]  txClkSel - E_N5C32GP5X4_REFCLK_SEL enum that represents the reference clock selection group
@param[in]  rxClkSel - E_N5C32GP5X4_REFCLK_SEL enum that represents the reference clock selection group
...
@param[out] txFreq - E_N5C32GP5X4_REFFREQ enum that represents the reference frequency
@param[out] rxFreq - E_N5C32GP5X4_REFFREQ enum that represents the reference frequency
@param[out] txClkSel - E_N5C32GP5X4_REFCLK_SEL enum that represents the reference clock selection group
@param[out] rxClkSel - E_N5C32GP5X4_REFCLK_SEL enum that represents the reference clock selection group
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  txSpeed - E_N5C32GP5X4_SERDES_SPEED enum that represents the TX bitrate
@param[in]  rxSpeed - E_N5C32GP5X4_SERDES_SPEED enum that represents the RX bitrate
...
@param[out] txSpeed - E_N5C32GP5X4_SERDES_SPEED that represents the TX bitrate
@param[out] rxSpeed - E_N5C32GP5X4_SERDES_SPEED that represents the RX bitrate
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  txWidth - E_N5C32GP5X4_DATABUS_WIDTH enum that represents the number of bits for TX databus
@param[in]  rxWidth - E_N5C32GP5X4_DATABUS_WIDTH enum that represents the number of bits for RX databus
...
@param[out] txWidth - E_N5C32GP5X4_DATABUS_WIDTH enum that represents the number of bits for TX databus
@param[out] rxWidth - E_N5C32GP5X4_DATABUS_WIDTH enum that represents the number of bits for RX databus
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  type - N5C32GP5X4_TRAINING_TRX or N5C32GP5X4_TRAINING_RX
...
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  type - N5C32GP5X4_TRAINING_TRX or N5C32GP5X4_TRAINING_RX
@param[in]  training - S_N5C32GP5X4_TRAIN_TIMEOUT represents the context for timeout
...
@param[out] training - S_N5C32GP5X4_TRAIN_TIMEOUT represents the context for timeout
...
@param[out] trainedEyeHeight - pointer to S_N5C32GP5X4_TRAINED_EYE_H
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  param - CDR parameter (E_N5C32GP5X4_CDR_PARAM)
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  threshold - the squelch threshold level (range: N5C32GP5X4_SQ_THRESH_MIN ~ N5C32GP5X4_SQ_THRESH_MAX)
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  path - N5C32GP5X4_PATH_EXTERNAL or N5C32GP5X4_PATH_FAR_END_LB
...
@param[out] path - N5C32GP5X4_PATH_EXTERNAL or N5C32GP5X4_PATH_FAR_END_LB
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  txPolarity - set transmitter to N5C32GP5X4_POLARITY_NORMAL or N5C32GP5X4_POLARITY_INV
@param[in]  rxPolarity - set receiver to N5C32GP5X4_POLARITY_NORMAL or N5C32GP5X4_POLARITY_INV
...
@param[out] txPolarity - N5C32GP5X4_POLARITY_NORMAL or N5C32GP5X4_POLARITY_INV
@param[out] rxPolarity - N5C32GP5X4_POLARITY_NORMAL or N5C32GP5X4_POLARITY_INV
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  txPattern - E_N5C32GP5X4_PATTERN for transmitter
@param[in]  rxPattern - E_N5C32GP5X4_PATTERN for receiver
@param[in]  txUserPattern - string of hexadecimal characters (max 20 characters); valid when tx pattern = N5C32GP5X4_PAT_USER
@param[in]  rxUserPattern - string of hexadecimal characters (max 20 characters); valid when rx pattern = N5C32GP5X4_PAT_USER

@note Use this function to configure TX and RX pattern before calling API_N5C32GP5X4_StartPhyTest()
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  txGrayCode - E_N5C32GP5X4_GRAY_CODE for transmitter
@param[in]  rxGrayCode - E_N5C32GP5X4_GRAY_CODE for receiver
...
@param[out]  txGrayCode - E_N5C32GP5X4_GRAY_CODE for transmitter
@param[out]  rxGrayCode - E_N5C32GP5X4_GRAY_CODE for receiver
...
@param[out] statistics - pointer to S_N5C32GP5X4_PATTERN_STATS which will be populated by this function

@note API_N5C32GP5X4_StartPhyTest() must be called first to start the pattern checker.
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  type - N5C32GP5X4_PHYTEST_TX or N5C32GP5X4_PHYTEST_RX
...
@note Called by API_N5C32GP5X4_EOMGetWidthHeight to initialize EOM circuit
...
@note Called by API_N5C32GP5X4_EOMGetWidthHeight to disable EOM circuit
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  eyeTMB - N5C32GP5X4_EYE_TOP, N5C32GP5X4_EYE_MID or N5C32GP5X4_EYE_BOT
...
@param[out] measurement - pointer to S_N5C32GP5X4_EOM_DATA which will hold the results

@note Called by API_N5C32GP5X4_EOMGetWidthHeight to measure a specific point
...
/**
@brief  Converts EYE width and height

@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  lane - lane number 0, 1, 2, 3, etc.
@param[in]  width - EYE width
@param[in]  heightUpper - upper EYE height
@param[in]  heightLower - lower EYE height

@param[out] widthmUI - EYE width in mUI
@param[out] height10uVUpper - upper EYE height in 10uV
@param[out] height10uVLower - lower EYE height in 10uV

@note Returns both upper and lower EYE height in 10uV units
...
@param[in,out]  eyeRawDataPtr - pointer to S_N5C32GP5X4_EYE_RAW_PTR which stores eye raw data

@note Call API_N5C32GP5X4_EOMGetWidthHeight before to check if eye is centered
@note At least minSamples will be measured
...
@param[in]  eyeRawDataPtr - pointer to S_N5C32GP5X4_EYE_RAW_PTR which store eye raw data
...
@note Call API_N5C32GP5X4_EOMGetEyeData before to populate eyeRawDataPtr
...
@note See API_N5C32GP5X4_EOMGetWidthHeight() for example of berThreshold
...
#endif /* defined MCESD_N5C32GP5X4_API_H */

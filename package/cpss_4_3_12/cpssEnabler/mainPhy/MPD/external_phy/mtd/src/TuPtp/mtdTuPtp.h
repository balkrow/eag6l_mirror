...
Precision Time Protocol(PTP) feature for the 88X35X0 and
CUX36X0/CUE26X0 Ethernet PHYs.
********************************************************************/
...
/******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPConfigPTPBlock
(
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSoftReset
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port
);
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetBypass
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetBypass
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTaiGPIO
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 todCtrlOption
);

 Inputs:
    devPtr - pointer to MTD_DEV initialized by mtdLoadDriver() call
    port - MDIO port address, 0-31
    todCtrlOption - 1: enabled PTP TOD TAI signals to chip GPIO; default is 0
 ...
 Description:
    This TOD controls enable the TAI signals to chip GPIO connection.  
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTaiGPIO
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    OUT MTD_U16 *todCtrlOption
);
 ...
 Description:
    Read back the TOD control of the TAI signals to chip GPIO connection.  
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetEtherType
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetEtherType
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetMsgTSEnable
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetMsgTSEnable
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetAltScheme
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetAltScheme
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetGrandMaster
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetGrandMaster
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetPTPMode
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 ptpMode
 ...
 Inputs:
    ...
    port - MDIO port address, 0-31
    ptpMode - PTP Mode:
        MTD_PTP_BOUNDARY_CLK     = 0
        MTD_PTP_PEER_TO_PEER_CLK = 1
        MTD_PTP_END_TO_END_CLK   = 2
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetPTPMode
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    OUT MTD_U16 *ptpMode
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetOneStep
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 oneStep
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetOneStep
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    OUT MTD_U16 *oneStep
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetOneStepDomain
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 oneStepDomainMode
);

 Inputs:
    devPtr - pointer to MTD_DEV initialized by mtdLoadDriver() call
    port - MDIO port address, 0-31
    oneStepDomainMode - PTP OneStep Domain Mode; default 0
        0 - When OneStep is enabled it is enabled only for matching Domains
        1 - When OneStep is enabled it is enabled for Most Domains
        2 - When OneStep is enabled it is enabled for Domain Zero
        3 - When OneStep is enabled it is enabled for Domain Zero AND
            When OneStep is enabled it is enabled for Most Domains

        Bit 1:
        One Step on Domain Zero.
        0 = When OneStep is enabled it is enabled only for matching Domains
        1 = When OneStep is enabled it is enabled for Domain Zero
        When OneStep is enabled (Index 0x00) this bit determines which Domain numbers 
        support OneStep operation. If this bit is zero the frame's Domain number must 
        match the Time Array's Domain number. If this bit is set to a one the Domain 
        number field must match a value of 0x00. If it does then OneStep is supported 
        on the frame.

        Bit 0:
        One Step on Most Domains.
        0 = When OneStep is enabled it is enabled only for matching Domains
        1 = When OneStep is enabled it is enabled for Most Domains
        When OneStep is enabled (Index 0x00) this bit determines which Domain numbers 
        support OneStep operation. If this bit is zero the frame's Domain number must 
        match the Time Array's Domain number. If this bit is set to a one the Domain 
        number field becomes don't care, except if it matches a value of 0x00. In the 
        Domain 0x00 case bit 2 above is used.
 ...
 Description:
    This API is only for X36X0 devices only

    This API sets the OneStep domain options to matching the domain number. 

 Side effects:
    None

 Notes/Warnings:
    X3540 does not support this API
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetOneStepDomain
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    OUT MTD_U16 *oneStepDomainMode
);
 ...
 Outputs:
        oneStepDomainMode - PTP OneStep Domain Mode
        0 - When OneStep is enabled it is enabled only for matching Domains
        1 - When OneStep is enabled it is enabled for Most Domains
        2 - When OneStep is enabled it is enabled for Domain Zero
        3 - When OneStep is enabled it is enabled for Domain Zero AND
 ...
 Description:
    ...
    This API gets the OneStep domain options to matching the domain number. 
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetInternalTime
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 PTPInternalTimeOption
);

 Inputs:
    devPtr - pointer to MTD_DEV initialized by mtdLoadDriver() call
    port - MDIO port address, 0-31
    PTPInternalTimeOption - PTP Internal Time; default 0
        0 = Use ToD ns time (counts to 2 sec & then wraps)
        1 = Use 1722 ns time (counts to >4 sec & then wraps)
 ...
 Description:
    ...
    When a port is in PTP Hardware Acceleration mode (PTP Port offset 0x02) this 
    bit determines the format of the internal timestamp information that is placed 
    into the frame while it passes through the switch as follows:
    0 = Use ToD ns time (counts to 2 sec & then wraps)
    1 = Use 1722 ns time (counts to >4 sec & then wraps)
 ...
 Notes/Warnings:
    X3540 does not support this API
    This register does not effect the Ext 1722 Time format selected below for 
    external block usage. The ToD ns mode is required for this device to interoperate 
    with existing Marvell PHYs that support PTP.
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetInternalTime
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    OUT MTD_U16 *PTPInternalTimeOption
);
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetCfgTransSpec
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
 ...
 Inputs:
    ...
    transSpec - Transport Specific bits present in PTP Common header
                MTD_TU_PTP_IEEE_1588
                MTD_TU_PTP_IEEE_802_1AS
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetCfgDisableTSpecCheck
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetCfgDisTimeStmpCntOverwrite
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetCfgIPJump
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 ipJump
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetCfgETJump
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 etJump
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetCfgArrTSMode
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetCfgHWAccel
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 hwAccel
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetKeepSourceAddr
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 keepSA
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetExtHwAccEnable
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetDepartureIntEn
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetArrivalIntEn
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetPortConfig
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTimeStamp
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuGetPTPTSValidSt
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_TU_PTP_TIME timeToRead,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPTimeStampReset
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTimeStampArrivalPtr
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 tsArrPtr
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTimeStampArrivalPtr
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetIntStatus
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetIgrMeanPathDelay
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 delay
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetIgrMeanPathDelay
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    OUT MTD_U16 *delay
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetIgrPathDelayAsym
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 asym
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetIgrPathDelayAsym
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    OUT MTD_U16 *asym
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPEgrPathDelayAsymSet
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U16 asym
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPEgrPathDelayAsymGet
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    OUT MTD_U16 *asym
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTODBusyBitStatus
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPTODStoreOperation
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPTODCaptureAll
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U8 timeArrayIndex,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetPulse
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetPulse
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetPTPGlobalTime
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPEventCaptureTime
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetEventCaptureCounter
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPClearEventCaptureCounter
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port
);
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetEventCaptureValid
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetEventCaptureErr
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPClearEventCaptureErr
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port
);
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetEventCaptureTrigger
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetEventCaptureTrigger
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetDriftComp
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetDriftComp
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTodClkPeriod
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTodClkPeriod
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetEnableTodClk
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetEnableTodClk
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetSyncTod
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetSyncTod
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTodTrigRequest
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTodTrigRequest
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetMinDriftThreshold
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetMinDriftThreshold
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetMaxDriftThreshold
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetMaxDriftThreshold
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetFreqDriftIntr
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetClkGenIntr
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetMaskFreqDriftInt
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetMaskFreqDriftInt
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetFreqDriftIntTriggered
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTAIGlobalCfg
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTAIGlobalCfg
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_TU_PTP_TAI_CONFIG taiCfgOptionBit,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTimeStampClkPeriod 
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTrigGenAmt
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTrigCompensateDir
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTrigCompensateDir
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTrigCompensate
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTrigCompensate
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTrigCompensatePS
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTrigCompensatePS
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTrigPulseWidth
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTrigPulseWidth
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTrigPulseWidthRange
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTrigPulseWidthRange
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPSetTrigGenTime
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
...
/*******************************************************************************
MTD_FUNC MTD_STATUS mtdTuPTPGetTrigGenTime
(
    IN MTD_DEV_PTR devPtr,
    IN MTD_U16 port,
    IN MTD_U32 *trigGenTime

...
(
 ...
 Outputs:
    ...
    interruptStatus.cunitIntr - C-unit interrupt status 
            ...
            MTD_X_UNIT_INTR                   0x0002   == not applicable to E20X0, E21X0, X35X0, X36X0 and E25X0 PHYs. 
 ...
 Notes/Warnings:
    No X-unit on E20X0, E21X0, X35X0, X36X0 and E25X0 PHYs.
...
/* Top interrupts */
/* Applicable to X36X0 only*/
#define MTD_SFP_PLUS_INTR              0x4000
/* Applicable to X35X0, X36X0, E25X0 PHYs only */
#define MTD_COMPHY_INTR                0x2000
#define MTD_TAI_INTR_BIT               0x1000
#define MTD_PTP_INTR                   0x0800
#define MTD_PTP_MPM_INTR               0x0800 /* MACSec and MMAC block combined with PTP interrupt in mpm_unit */
#define MTD_I2C_INTR                   0x0400
#define MTD_RMFIFO_INTR                0x0200
/* Applicable to ALL PHYs */
#define MTD_WOL_INTR                   0x0100
/* Applicable to ALL PHYs except X36X0 */
...
#define MTD_X_UNIT_INTR                0x0002  /* not applicable to E20X0, E21X0, X35X0, X36X0 and E25X0 PHYs. */
...
#define MTD_ALL_X36X0_TOP_INTR        (MTD_SFP_PLUS_INTR | MTD_COMPHY_INTR | MTD_TAI_INTR_BIT  | MTD_PTP_INTR |\
                                       MTD_I2C_INTR      | MTD_RMFIFO_INTR | MTD_WOL_INTR      | MTD_PROC_INTR|\
                                       MTD_GPIO_INTR     | MTD_M_UNIT_INTR | MTD_T_UNIT_INTR)
...
(
 ...
 Notes/Warnings:
    No X-unit on E20X0, E21X0, X35X0, X36X0 and E25X0 PHYs. Select MTD_X_UNIT_INTR on these PHYs 
...
(
 ...
 Notes/Warnings:
    No X unit on E20X0, E21X0, X35X0, X36X0 and E25X0 devices. 
...
/* H and X unit interrupt. Note: E20X0, E21X0, X35X0, X36X0 and E25X0 PHY have no X unit */
...
(
 ...
 Notes/Warnings:
    No X unit on E20X0, E21X0, X35X0, X36X0 and E25X0 devices. Set HorXunit to MTD_X_UNIT on these 
...
(
 ...
 Notes/Warnings:
    No X unit on E20X0, E21X0, X35X0, X36X0 and E25X0 PHYs. Set HorXunit to MTD_X_UNIT on these 
    devices will return MTD_FAIL.
******************************************************************************/
MTD_STATUS mtdGetBaseRInterruptsEnabled
(
...
(
 ...
 Description:
    Get 10GBASE-R real-time status. 

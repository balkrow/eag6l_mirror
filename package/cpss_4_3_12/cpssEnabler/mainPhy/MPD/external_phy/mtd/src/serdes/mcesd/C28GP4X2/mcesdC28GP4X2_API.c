...
#include "mcesdC28GP4X2_HwCntl.h"
#include <string.h>
...
{
    MCESD_FIELD txEmPoCtrl = F_C28GP4X2R2P0_TX_EM_POST_RD;
    MCESD_FIELD txEmPeakCtrl = F_C28GP4X2R2P0_TX_EM_PEAK_RD;
    MCESD_FIELD txEmPreCtrl = F_C28GP4X2R2P0_TX_EM_PRE_RD;
    MCESD_FIELD txMargin = F_C28GP4X2R2P0_TX_MARGIN;
...
)
{
    ...
    MCESD_FIELD txTrainTimerEnable = F_C28GP4X2R2P0_TX_TRAIN_TIMEREN;
    MCESD_FIELD rxTrainTimerEnable = F_C28GP4X2R2P0_RX_TRAIN_TIMEREN;
...
{
    MCESD_FIELD digRxToTx               = F_C28GP4X2R2P0_DIG_RX2TX_LPBKEN;
    MCESD_FIELD anaTxToRx               = F_C28GP4X2R2P0_ANA_TX2RX_LPBKEN;
    MCESD_FIELD digTxToRx               = F_C28GP4X2R2P0_DIG_TX2RX_LPBKEN;
    MCESD_FIELD dtxFloopEn              = F_C28GP4X2R2P0_DTX_FLOOP_EN;
    MCESD_FIELD dtxFloopEnRing          = F_C28GP4X2R2P0_DTX_FLOOP_ENRING;
...
{
    MCESD_FIELD txPatternSel        = F_C28GP4X2R2P0_PT_TX_PATT_SEL;
    MCESD_FIELD rxPatternSel        = F_C28GP4X2R2P0_PT_RX_PATT_SEL;
    ...
    MCESD_FIELD userPattern_79_48   = F_C28GP4X2R2P0_PT_USER_PAT_7948;
    MCESD_FIELD userPattern_47_16   = F_C28GP4X2R2P0_PT_USER_PAT_4716;
    MCESD_FIELD userPattern_15_0    = F_C28GP4X2R2P0_PT_USER_PAT_1500;
...
)
{
    ...
    MCESD_FIELD startRd         = F_C28GP4X2R2P0_PT_START_RD;
    MCESD_FIELD userKChar       = F_C28GP4X2R2P0_PT_USER_K_CHAR;
    MCESD_FIELD userPatternFieldArray[] = { F_C28GP4X2R2P0_PT_USER_PAT_7948 , F_C28GP4X2R2P0_PT_USER_PAT_4716 , F_C28GP4X2R2P0_PT_USER_PAT_1500 };
...
)
{
    ...
    MCESD_FIELD ptPhyReadyForce = F_C28GP4X2R2P0_PT_PHYREADYFORCE;
...
)
{
    ...
    {
        S_C28GP4X2_EOM_DATA measurement;

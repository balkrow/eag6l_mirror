...
registers in the Marvell 88X32X0, 88X33X0, 88X35X0, CUX36X0, CUE26X0, 
...
#define MTD_FWBUILD_INFO1              MTD_T_UNIT_PMA_PMD,0xC051 /* Only available on E21X0 and later PHYs and newer firmware revs */
#define MTD_FWBUILD_INFO2              MTD_T_UNIT_PMA_PMD,0xC044 /* Only available on E21X0 and later PHYs and newer firmware revs */
#define MTD_FWBUILD_INFO3              MTD_T_UNIT_PMA_PMD,0xC045 /* Only available on E21X0 and later PHYs and newer firmware revs */
...
#define MTD_TUNIT_TESNE_CTL0           MTD_T_UNIT_PCS_CU,0xDB09 /*TESNE temperature sensor in x36x0*/
#define MTD_TUNIT_TESNE_DATA           MTD_T_UNIT_PCS_CU,0xDB0C /* 12 bits signed integer reading*/

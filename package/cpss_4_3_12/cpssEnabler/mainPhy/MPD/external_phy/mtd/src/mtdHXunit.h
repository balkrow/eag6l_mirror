...
/******************************************************************************
 ...
 Outputs:
    regOffset - returns register address offset for Hunit Pkt Gen registers
 ...
 Description:
    This function returns the offset in register address for the Hunit
    packet generator/checker registers as they were offset from their
    original address of 4.F010 starting on X36X0 devices.

    X36X0 devices have an offset of 0x900, starting with 4.F910
...
(
 ...
 Notes/Warnings:
    ...
    for E25X0/X35X0/X36X0 in MPUXSGMII mode, shallow mac loopback is not supported. call
    mtdSetTunitDeepMacLoopback() instead
*******************************************************************************/
MTD_STATUS mtdSetShallowMacLoopbackLinkDown
(
    IN MTD_DEV_PTR devPtr,

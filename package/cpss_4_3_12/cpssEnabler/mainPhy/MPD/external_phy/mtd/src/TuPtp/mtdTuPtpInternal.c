...
)
{
    ...
    switch (readPlusType)
    {
        case MTD_TUPTP_READPLUS_TAI:    /* based on MTD_TU_PTP_TAI_GLOBAL_REG:D940 */
            /* regOffset expected from 0x0 to 0x10 */
            regVal = (regOffset & 0x1F) | 0x8E00;
            break;

        case MTD_TUPTP_READPLUS_TOD:    /* based on MTD_TU_PTP_GLOBAL_ETHTYPE:D960 */
            /* regOffset expected from 0x10 to 0x1F */
            regVal = (regOffset & 0x1F) | 0x8F10;
            break;

        case MTD_TUPTP_READPLUS_PORT:    /* based on MTD_TU_PTP_PORT_REG_0:D900 */
            /* regOffset expected from 0x8 to 0x13 */
            regVal = (regOffset & 0x1F) | 0x8000;
            break;

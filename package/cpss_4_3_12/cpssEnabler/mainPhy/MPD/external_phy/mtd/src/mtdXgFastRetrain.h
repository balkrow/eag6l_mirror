...
/* Different settings for NFR Extended Timer (7.800C.8) */
#define MTD_NFR_TIMER_30MS      (0) /* Extended maxwait not enabled, 30ms timeout */
#define MTD_NFR_TIMER_200MS     (1) /* Extended maxwait enabled, 200ms timeout */
#define MTD_NFR_TIMER_UNCHANGED (2) /* Leave NFR timer unchanged */
/*****************************************************************************
...
(
 ...
 Inputs:
    ...
    extendedNFR - set the NFR extended timer. The options are ...
        MTD_NFR_TIMER_30MS                0x00
        MTD_NFR_TIMER_200MS               0x01 (default)
        MTD_NFR_TIMER_UNCHANGED           0x02
 ...
 Description:
    Reads the Marvell Negotiated Fast Retrain Advertisement Register 7.800C 
    and sets bit 0 to advertise NFR capability and bit 8 to control extended 
    NFR timer. Also sets the signal type bits in 1.147 (which are shared with 
    the 10GBTFR).

...
the Marvell 88X32X0, 88X33X0, 88X35X0, CUX36X0, CUE26X0 88E20X0 
and 88E21X0 ethernet PHYs.
********************************************************************/
/*! \defgroup mtdHunit mtdHunit.h
@{*/
#ifndef MTDHUNIT_H
#define MTDHUNIT_H
...
/************************************* macType X32X0/X33X0/E20X0 devices ************************/

/* Please read the options carefully not all are available on */
/* all devices. */
...
#define MTD_MAC_TYPE_10GR_RM_AMD_ON     (0xE) /* Rate matching with Auto-Media Detect On */
                                              /* X35X0/X36X0 only supports 10GBASE-R rate matching to 5GBR/2.5GBX */
                                              /* 1G and below speeds use SGMII interface */
/* MTD_MAC_LEAVE_UNCHANGED used to leave as-is */

/************************************ macType for X36X0/E26X0 devices ************************/

/* X3610/E2610 macType: */
/* MTD_MAC_TYPE_SXGMII             (0x0)  USXGMII No AMD, speed is controlled by macMaxIfSpeed and can be 10/5/2.5 */

/* MTD_MAC_TYPE_10GR_SGMII_AN_EN  (0x4)  10GBASE-R/5GBASE-R/2.5GBASE-X, or SGMII AN Enabled */ 
/* MTD_MAC_TYPE_10GR_1000BX_AP_AN  (0x5)  10GBASE-KR/5GBASE-KR/2.5GBASE-KX, or 1000BASE-X (AP AN enabled) 
                                          100M/10M are not supported*/                                              
/* MTD_MAC_TYPE_10GR_RM_AMD_OFF    (0x6)  Rate matching with Auto-Media Detect Off 
                                          10G/5G/2.5G use 10GBR PCS
                                          1G and below uses SGMII */
/* MTD_MAC_LEAVE_UNCHANGED used to leave as-is */

/* X3680/E2680 macType: */
#define MTD_MAC_TYPE_SXGMII_AMD_OFF (0x0)  /* USXGMII with AMD OFF, speed is controlled by macMaxIfSpeed and can be 10/5/2.5 */
#define MTD_MAC_TYPE_SXGMII_AMD_ON  (0x10) /* USXGMII with AMD ON, only X3680 support, only 10G speed supported */

/* MTD_MAC_TYPE_10G_DXGMII         (0x1)  10GBASE-R dual ports USXGMII, two copper ports 5G max each */
/* MTD_MAC_TYPE_10G_QXGMII         (0x2)  10GBASE-R quad ports USXGMII, four copper ports 2.5G max each */
/* MTD_MAC_TYPE_20G_DXGMII         (0x9)  20GBASE-R dual ports USXGMII, two copper ports 10G max each */
/* MTD_MAC_TYPE_20G_QXGMII         (0xA)  20GBASE-R quad ports USXGMII, four copper ports 5G max each */
/* MTD_MAC_TYPE_OXGMII             (0x3)  Octal ports USXGMII, 20GBASE-R only, four copper ports 2.5G max each */

/* MTD_MAC_TYPE_10GR_SGMII_AN_EN   (0x4)  10GBASE-R/5GBASE-R/2.5GBASE-X, or SGMII AN enabled for 1G and below */
/* MTD_MAC_TYPE_10GR_1000BX_AP_AN  (0x5)  10GBASE-KR/5GBASE-KR/2.5GBASE-KX, or 1000BASE-X (AP AN enabled) 
                                               100M/10M are not supported*/                                              
/* MTD_MAC_TYPE_10GR_RM_AMD_OFF    (0x6)  Rate matching with Auto-Media Detect Off */
/* MTD_MAC_TYPE_10GR_RM_AMD_ON     (0xE)  Rate matching with Auto-Media Detect On 
                                          10G/5G/2.5G use 10GBR PCS
                                          1G and below uses SGMII  RM_AMD_OFF/ON */
...
#define MTD_MAC_SPEED_NOT_APPLICABLE     (0X4) /* for X35X0/X36X0/E25X0 MP-USXGMII modes */
...
/* On X3680/E2680 this cannot be set */
/* On X3610/E2610 can only set it to 10G, 5G or 2.5G for macType SXGMII, otherwise can't set it */
#define MTD_MAX_MAC_SPEED_10G             (0x0) /* Automatically set based on macType for X3540/X3680/E2680 */
                                                /* Valid option for X3610 SXGMII */
#define MTD_MAX_MAC_SPEED_5G              (0x2) /* Use for X33X0/E20X0 and E21X0 PHYs */
                                                /* Not applicable on X3540/X3680/E2680 */                                                
#define MTD_MAX_MAC_SPEED_SXGMII_5G       (0x1) /* Valid option for X3610 SXGMII, not applicable on PHYs */
                                                /* prior to X3610 */
#define MTD_MAX_MAC_SPEED_20G             (0x2) /* Automatically set based on macType for X3540/X3680/E2680 */
#define MTD_MAX_MAC_SPEED_2P5G            (0x3) /* Not applicable on X3540/X3680/E2680 */
                                                /* Valid option for X3610 SXGMII */
#define MTD_MAX_MAC_SPEED_LEAVE_UNCHANGED (0x4)
#define MTD_MAX_MAC_SPEED_NOT_APPLICABLE  (0x4) /* for X32X0 and X3540/E2540/X3680/E2680 devices pass this on set */
...
/******************************************************************************
 ...
 Inputs:
    ...
    macType - the type of MAC interface being used (the hardware interface).
        ...
        For E21X0 and X35X0/X36X0/E25X0 devices mactype, please refer to mtdSetMacInterfaceCopperOnlyPhy().
    ...
    macIfPowerDown - MTD_TRUE if the host interface is always to be powered up
        ...
        For E21X0 and X35X0/X36X0 devices, MTD_FALSE not allowed for all MP-USXGMII macTypes
    ...
    macLinkDownSpeed - The speed the mac interface should run when the media side is
        link down. One of the following:
            ...
            MTD_MAC_SPEED_NOT_APPLICABLE (for X35X0/X36X0/E25X0 devices pass this on set)
    ...
    macMaxIfSpeed - Can be used to limit the Mac interface speed. NOT settable on X32X0 or X3540/E2540.
        ...
        MTD_MAX_MAC_SPEED_5G (on X33X0/E20X0 and E21X0 PHYs)
        MTD_MAX_MAC_SPEED_SXGMII_5G (on X3610/E2610)
 ...
 Description:
    ...
    software reset to take effect.
        ...
        X35X0/X36X0/E25X0 - Uses 31.F000/F001/F007
 ...
 Notes/Warnings:
    ...
    Applicable to E21X0/X35X0/X36X0/E25X0 devices:
...
/******************************************************************************
 ...
 Outputs:
    macType - the type of MAC interface being used (the hardware interface).
        ...
        For E21X0 and X35X0/X36X0/E25X0 devices mactype, please refer to mtdGetMacInterfaceCopperOnlyPhy().

    macIfPowerDown - MTD_TRUE if the host interface is always to be powered up
                     MTD_FALSE if the host interface can be powered down under 
                     certain circumstances (see datasheet)
        For E21X0 and X35X0/X36X0 devices, MTD_FALSE not applicable for all MP-USXGMII macTypes
    ...
    macMaxIfSpeed - Can be used to limit the Mac interface speed. NOT available on X32X0.
        ...
        MTD_MAX_MAC_SPEED_10G 
        MTD_MAX_MAC_SPEED_5G (on X33X0/E20X0 and E21X0 PHYs)
        MTD_MAX_MAC_SPEED_SXGMII_5G (on X3610/E2610 PHYs)
        MTD_MAX_MAC_SPEED_2P5G (on E21X0 device not allowed for macType SXGMII)
        MTD_MAX_MAC_SPEED_NOT_APPLICABLE (for X32X0 and X3540/E2540 devices pass this on set)
 ...
 Description:
    ...
    based on device type and returns them.
        ...
        X35X0/X36X0/E25X0 - Reads 31.F000/F001/F007
...
/******************************************************************************
 ...
 Inputs:
    ...
    port - port number, 0-31, MUST be the first(Master) of the grouped port (P0-1, P2-3, P0-3)
           for X35X0/X36X0/E25X0 DXGMII/QXGMII/OXGMII modes
    macType - the type of MAC interface being used (the hardware interface). 
        For E21X0 devices:
        ...
        - The 2nd X35X0/X36X0/E25X0 PHY should be configured to MTD_MAC_TYPE_OXGMII_PARTNER, which runs 10G QXGMII
        ...
        MTD_MAC_TYPE_10GR_RM_AMD_ON    - Rate matching with Auto-Media Detect On
                                         X35X0/X36X0 only supports 10GBASE-R rate matching to 5GBR/2.5GBX, not to 1G/100M/10M
        MTD_MAC_LEAVE_UNCHANGED        - used to leave as-is

        For X3610/E2610 devices:
        MTD_MAC_TYPE_SXGMII            - Single port USXGMII (maMaxIfSpeed 10/5/2.5G to selected speed)
        MTD_MAC_TYPE_10GR_SGMII_AN_EN  - 10GBASE-R/5GBASE-R/2.5GBASE-X, or SGMII AN disabled for 1G and below
        MTD_MAC_TYPE_10GR_1000BX_AP_AN - 10GBASE-KR/5GBASE-KR/2.5GBASE-KX, or 1000BASE-KX (CL73 AN enabled)
                                       - 100M/10M are not supported
        MTD_MAC_TYPE_10GR_RM_AMD_OFF   - Rate matching with Auto-Media Detect Off          
        MTD_MAC_LEAVE_UNCHANGED        - used to leave as-is
                                         
        For X3680/E2680 devices:
        MTD_MAC_TYPE_SXGMII            - Single port USXGMII (speed cannot set)
        MTD_MAC_TYPE_10G_DXGMII        - 10GBASE-R dual ports USXGMII
        MTD_MAC_TYPE_10G_QXGMII        - 10GBASE-R quad ports USXGMII
        MTD_MAC_TYPE_20G_DXGMII        - 20GBASE-R dual ports USXGMII, supports two ports of 10GBASE-T, X3680 only
        MTD_MAC_TYPE_20G_QXGMII        - 20GBASE-R quad ports USXGMII, supports four ports of 2.5/5GBASE-T, X3680 only
        MTD_MAC_TYPE_OXGMII            - Octal ports USXGMII, 20GBASE-R only, X3680 only
        MTD_MAC_TYPE_10GR_SGMII_AN_EN  - 10GBASE-R/5GBASE-R/2.5GBASE-X, or SGMII AN enabled for 1G and below
        MTD_MAC_TYPE_10GR_1000BX_AP_AN - 10GBASE-KR/5GBASE-KR/2.5GBASE-KX, or 1000BASE-KX (CL73 AN enabled)
                                       - 100M/10M are not supported
        MTD_MAC_TYPE_10GR_RM_AMD_OFF   - Rate matching with Auto-Media Detect Off
        MTD_MAC_TYPE_10GR_RM_AMD_ON    - Rate matching with Auto-Media Detect On
                                         only supports 10GBASE-R rate matching to 5GBR/2.5GBX, not to 1G/100M/10M
        MTD_MAC_LEAVE_UNCHANGED        - used to leave as-is                                         
    ...
    macIfPowerDown - MTD_TRUE if the host interface is always to be powered up
                     MTD_FALSE if the host interface can be powered down under 
                     certain circumstances (see datasheet)  
        For E21X0 and X35X0/E25X0/X36X0 devices, must be MTD_TRUE for all MP-USXGMII macTypes
    ...
    macLinkDownSpeed - The speed the mac interface should run when the media side is
        ...
        On X3540/E2540/X36X0 devices link down speed follows the last link up speed and the power-on default
        is MTD_MAC_SPEED_10_GBPS.

    macMaxIfSpeed - Can be used to limit the Mac interface speed. NOT settable on X3540/E2540/X3680/E2680.
        On the X3540/E2540/X3680/E2680 device, it is automatically set to 10G unless MACType is
        MTD_MAC_TYPE_20G_DXGMII, MTD_MAC_TYPE_20G_QXGMII or MTD_MAC_TYPE_OXGMII, then it
        is set to 20G.
        On the X3610/E2680 can pass 10G/5G/2.5G for macType MTD_MAC_TYPE_SXGMII, otherwise pass
        MTD_MAX_MAC_SPEED_NOT_APPLICABLE in all other macTypes and cases.        
        ...
        For other devices:
            ...
            MTD_MAX_MAC_SPEED_2P5G (on E21X0 device not allowed for macType SXGMII)
            MTD_MAX_MAC_SPEED_LEAVE_UNCHANGED
            MTD_MAX_MAC_SPEED_NOT_APPLICABLE (for X3540/E2540/X3680/E2680 devices pass this on set)
 ...
 Notes/Warnings:
    ...
    X35X0/X36X0/E25X0 DXGMII/QXGMII/OXGMII/OXGMII_PARTNER modes.

    If this is a X35X0/X36X0/E25X0 device that used for OXGMII partner, user must call this API to configure
    it to MTD_MAC_TYPE_OXGMII_PARTNER mode, which runs 10G QXGMII with extra settings.
...
/******************************************************************************
 ...
 Notes/Warnings:
    ...
    X35X0/E2540 will return MTD_MAC_TYPE_10G_QXGMII instead of MTD_MAC_TYPE_OXGMII_PARTNER if the OXGMII master have 
    it's RS_FEC turned off.
...
/******************************************************************************
 For X35X0/X36X0/E25X0 and E21X0 only
******************************************************************************/

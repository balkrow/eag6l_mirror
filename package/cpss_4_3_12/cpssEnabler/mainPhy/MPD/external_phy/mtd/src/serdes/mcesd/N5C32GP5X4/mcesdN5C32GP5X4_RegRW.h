...
********************************************************************/
#ifndef MCESD_N5C32GP5X4_REGRW_H
#define MCESD_N5C32GP5X4_REGRW_H
...
#define N5C32GP5X4_WRITE_FIELD(xDevPtr, xField, xLane, xData)          MCESD_ATTEMPT(API_N5C32GP5X4_WriteField(xDevPtr, xLane, &(MCESD_FIELD)xField, xData));
#define N5C32GP5X4_READ_FIELD(xDevPtr, xField, xLane, xData)           MCESD_ATTEMPT(API_N5C32GP5X4_ReadField(xDevPtr, xLane, &(MCESD_FIELD)xField, &xData));
#define N5C32GP5X4_POLL_FIELD(xDevPtr, xField, xLane, xData, xTimeout) MCESD_ATTEMPT(API_N5C32GP5X4_PollField(xDevPtr, xLane, &(MCESD_FIELD)xField, xData, xTimeout))
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  pin - enum of type E_N5C32GP5X4_PIN
@param[in]  value - value to match
@param[in]  timeout_ms - timeout in milliseconds
...
#endif /* defined MCESD_N5C32GP5X4_REGRW_H */

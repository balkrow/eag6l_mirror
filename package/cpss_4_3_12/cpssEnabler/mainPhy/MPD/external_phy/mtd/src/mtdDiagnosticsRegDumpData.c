...
of registers for the Marvell 88X32X0, 88X33X0, 88X35X0,  CUX36X0, CUE26X0,
...
{31,0xF0A8}, /*Device Max Speed limit control Register. Not for X32X0 and X35X0 */
...
/* for x36x0, these register are offset by 0x900*/
{4,0xF910}, /*Packet Generation Control 1*/
{4,0xF911}, /*Packet Generation Control 2*/
{4,0xF912}, /*Initial Payload 0-1/Packet Generation*/
{4,0xF913}, /*Initial Payload 2-3/Packet Generation*/
{4,0xF916}, /*Packet Generation Length*/
{4,0xF917}, /*Packet Generation Burst Sequence*/
{4,0xF918}, /*Packet Generation IPG*/
{4,0xF91B}, /*Transmit Packet Counter [15:0]*/
{4,0xF91C}, /*Transmit Packet Counter [31:16]*/
{4,0xF91D}, /*Transmit Packet Counter [47:32]*/
{4,0xF91E}, /*Transmit Byte Counter [15:0]*/
{4,0xF91F}, /*Transmit Byte Counter [31:16]*/
{4,0xF920}, /*Transmit Byte Counter [47:32]*/
{4,0xF921}, /*Receive Packet Counter [15:0]*/
{4,0xF922}, /*Receive Packet Counter [31:16]*/
{4,0xF923}, /*Receive Packet Counter [47:32]*/
{4,0xF924}, /*Receive Byte Count [15:0]*/
{4,0xF925}, /*Receive Byte Count [31:16]*/
{4,0xF926}, /*Receive Byte Count [47:32]*/
{4,0xF927}, /*Receive Packet Error Count [15:0]*/
{4,0xF928}, /*Receive Packet Error Count [31:16]*/
{4,0xF929}, /*Receive Packet Error Count [47:32]*/
{4,0xF92a}, /*Link_drop Count [15:0]*/
...
{1,0xC02A}, /*Abnormal Restart 1*/
{1,0xC02B}, /*Abnormal Restart 2*/
{1,0xC02C}, /*Abnormal Restart 3*/
{1,0xC02D}, /*Abnormal Restart 4*/
{1,0xC031}, /*1G Misc Control*/
{1,0xC032}, /*Polarity Swap Rx Status*/
{1,0xC033}, /*EEE Legacy Control*/
{1,0xC034}, /*NbaseT Downshift COntrol*/
{1,0xC035}, /*NbaseT Downshift Status*/
{1,0xC036}, /*Internal Use Only*/
{1,0xC037}, /*Internal Use Only*/
{1,0xC044}, /*Build Info 1*/
{1,0xC045}, /*Build Info 2*/
{1,0xC04E}, /*Internal Use Only*/
{1,0xC04F}, /*Fatal Error*/
{1,0xC050}, /*Boot Status*/
{1,0xC051}, /*Build Info 3*/
{1,0xC052}, /*Internal Use Only*/
...
{7,0x003E}, /*EEE Advertisement 2 Register 2.5/5G */
{7,0x003F}, /*Link Partner EEE Ability 2 Register 2.5/5G */
{7,0x0040}, /*MGbase-T AN Control 2 Register (2.5/5G) */
{7,0x0041}, /*MGbase-T AN Status 2 Register (2.5/5G)  */
...
{3,0x2006}, /*1000BASE-X Auto-Negotiation Expansion Register*/
{3,0x2006}, /*LH */    
...
)
{
    ...
    for (addrIndex = 0; addrIndex < addrArrayLength; addrIndex++)
    {
        ...
        /* read the register */
        MTD_ATTEMPT(mtdHwXmdioRead(devPtr,port,addrArray[addrIndex].mmd,addrArray[addrIndex].reg,&valueRead));

        /* dump the port, address and value to the char buffer */
        bytesWritten = sprintf((char *)&dumpBuffer[*bufferOffset],"%02d %02d.%04x=%04x\n", (int)port,

...
static MPD_SAMPLE_PORT_DB_STC mpdSamplePortDb[MPD_MAX_PORT_NUMBER_CNS] = {
    /*  valid, dev  port    mdioType                    phyType             phyNumber   mdioBus     mdioAddress         usxInfo*/
#ifdef MYD_PHY_INCLUDE
    {0,     0,  0,      0,                              0,                  0,          0,          0,           MPD_PHY_USX_TYPE_NONE     },
    {1,     0,  0,      MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88X7120_E,     0,          0,          0,           MPD_PHY_USX_TYPE_NONE     }, /* 1 */
    {1,     0,  1,      MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88X7120_E,     0,          0,          4,           MPD_PHY_USX_TYPE_NONE     }, /* 2 */
    {1,     0,  2,      MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88X7120_E,     0,          0,          8,           MPD_PHY_USX_TYPE_NONE     }, /* 3 */
    {1,     0,  3,      MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88X7120_E,     0,          0,          0xc,         MPD_PHY_USX_TYPE_NONE     }, /* 4 */
#endif
    {1,     0,  4,      MPD_SAMPLE_MDIO_TYPE_SMI_E, MPD_TYPE_88E1680_E,     1,          1,          0,           MPD_PHY_USX_TYPE_NONE     }, /* 5 */
    {1,     0,  5,      MPD_SAMPLE_MDIO_TYPE_SMI_E, MPD_TYPE_88E1680_E,     1,          1,          2,           MPD_PHY_USX_TYPE_NONE     }, /* 6 */
    {1,     0,  6,      MPD_SAMPLE_MDIO_TYPE_SMI_E, MPD_TYPE_88E1680_E,     1,          1,          1,           MPD_PHY_USX_TYPE_NONE     }, /* 7 */
    {1,     0,  7,      MPD_SAMPLE_MDIO_TYPE_SMI_E, MPD_TYPE_88E1680_E,     1,          1,          3,           MPD_PHY_USX_TYPE_NONE     }, /* 8 */
    {1,     0,  8,      MPD_SAMPLE_MDIO_TYPE_SMI_E, MPD_TYPE_88E1680_E,     1,          1,          4,           MPD_PHY_USX_TYPE_NONE     }, /* 9 */
    {1,     0,  9,      MPD_SAMPLE_MDIO_TYPE_SMI_E, MPD_TYPE_88E1680_E,     1,          1,          6,           MPD_PHY_USX_TYPE_NONE     }, /* 10 */
    {1,     0,  10,     MPD_SAMPLE_MDIO_TYPE_SMI_E, MPD_TYPE_88E1680_E,     1,          1,          5,           MPD_PHY_USX_TYPE_NONE     }, /* 11 */
    {1,     0,  11,     MPD_SAMPLE_MDIO_TYPE_SMI_E, MPD_TYPE_88E1680_E,     1,          1,          7,           MPD_PHY_USX_TYPE_NONE     }, /* 12 */
#ifdef MTD_PHY_INCLUDE
    {1,     0,  24,     MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88E2540_E,     2,          1,          0,           MPD_PHY_USX_TYPE_OXGMII   }, /* 13 */
    {1,     0,  25,     MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88E2540_E,     2,          1,          1,           MPD_PHY_USX_TYPE_OXGMII   }, /* 14 */
    {1,     0,  26,     MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88E2540_E,     2,          1,          2,           MPD_PHY_USX_TYPE_OXGMII   }, /* 15 */
    {1,     0,  27,     MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88E2540_E,     2,          1,          3,           MPD_PHY_USX_TYPE_OXGMII   }, /* 16 */
    {1,     0,  28,     MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88E2540_E,     3,          1,          4,           MPD_PHY_USX_TYPE_OXGMII   }, /* 13 */
    {1,     0,  29,     MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88E2540_E,     3,          1,          5,           MPD_PHY_USX_TYPE_OXGMII   }, /* 14 */
    {1,     0,  30,     MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88E2540_E,     3,          1,          6,           MPD_PHY_USX_TYPE_OXGMII   }, /* 15 */
    {1,     0,  31,     MPD_SAMPLE_MDIO_TYPE_XSMI_E, MPD_TYPE_88E2540_E,     3,          1,          7,           MPD_PHY_USX_TYPE_OXGMII   } /* 16 */
#endif
};
...
)
{
    ...
    if (phyType == MPD_TYPE_88E2540_E) {
        fwFileName_PTR = "sample/resources/v0A030000_10979_10954_e2540.hdr";
    }
    if (phyType == MPD_TYPE_88X3540_E) {
        fwFileName_PTR = "sample/resources/v0A030000_10979_10954_x3540.hdr";
    }
...
)
{
...
#ifdef MPD_XML_INIT
    /* The mpd_sample.xml describe a different aboard from db_entry_PTR, containing two phy's - MPD_TYPE_88E1780_E, MPD_TYPE_88E2540_E. */
    memset(xml_file_name, 0, sizeof(xml_file_name));
    prvMpdSnprintf(xml_file_name, sizeof(xml_file_name), "sample/resources/mpd_sample.xml");
    if (mpdPortDbUpdateFromXml(xml_file_name, NULL) != MPD_OK_E) {
        PRV_MPD_HANDLE_FAILURE_MAC(0, MPD_ERROR_SEVERITY_FATAL_E, "update db from xml failed");
        return FALSE;
    }
#else
    ...
    for (i=0; i<MPD_TYPE_NUM_OF_TYPES_E; i++) {
        PRV_MPD_SHARED_GLBVAR_GLOBAL_DB_ACCESS_MAC()->fwDownloadType_ARR[i] = MPD_FW_DOWNLOAD_TYPE_FLASH_E;
    }
#endif
...
int main()
{
    ...
    if (result == MPD_OK_E) {
        ...
        printf("set speed to 200G on rel_ifIndex [%d] failed\n", 1);
    }
#endif

    mpdDriverDestroy();
    printf("Cleaned allocation\n");
    return 1;
}
/**
 * @} Example-main

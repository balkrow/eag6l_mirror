...
MODULES += external_phy/mtd/src
endif

ifeq ($(INCLUDE_MYD),yes)
MODULES += external_phy/alaska_c/src 
endif

ifdef ADD_PREFIX_TO_CODE
MPDPREFIX_FLAG=/D "MPDPREFIX"=$(ADD_PREFIX_TO_CODE)
endif
...
BASE_CFLAGS = /nologo /W3 /wd4819 /EHsc /Z7 /Od /MTd /c /Zm1000 /D "_WIN32" /D "PHY_SIMULATION" /D "ASIC_SIMULATION" $(MPDPREFIX_FLAG)
...
ifeq ($(INCLUDE_MTD),yes)
 override CFLAGS += \
  ...
  -Iexternal_phy/mtd/src/serdes/mcesd/ \
  -Iexternal_phy/mtd/src/serdes/mcesd/C28GP4X2/ \
  -Iexternal_phy/mtd/src/LinkCryptPtp/ \
  -Iexternal_phy/mtd/src/serdes/mcesd/N5C32GP5X4/ \
  -DMTD_PHY_INCLUDE
endif
...
ifeq ("$(DEBUG_MODE)", "yes")
 override CFLAGS += -DMTD_DEBUG -DMTD_DEBUG_FUNC
endif 
...
ifeq ("$(INCLUDE_PDLIB)", "yes")
 override CFLAGS += -DPDLIB_INCLUDE
endif
endif

...
GT_BOARD_LIST_ELEMENT   boardsList[] =
{
    ...
    EMPTY_LINE,
    EMPTY_LINE,
    {gtDbDxPhoenixBoardReg,"Aldrin3s+Caelum",1,{"Rev 0.1 - (2 device)"
                                    }, GT_TRUE},/* 26,x, */
    ...
    {gtDbPxFalconBoardReg,"Falcon",14,{"12.8T/6.4T/3.2T - 128 ports mode"                    /* 1*/
    ...
    {gtDbDxIronmanBoardReg,"Ironman",5,{"Rev 0.1 IM-L DB SFP mode"     /*1*/
                                       ,"Rev 0.2 IM-L DB PHY mode"     /*2*/
                                       ,"Rev 0.3 IM-M DB"              /*3*/
                                       ,"Rev 0.4 IM-M RD 8G 4XG"       /*4*/
                                       ,"Rev 0.5 IM-L RD 24G 6XG"      /*5*/
                                    }, GT_TRUE},/* 41,x,Ironman & co. */
    {gtDbDxAasBoardReg, "AAS",2,{"Rev 0.1"     /*1*/,
                                 "Rev 0.1 HQOS" /*2*/
                                    }, GT_FALSE},/* 42,x AAS & co. */
#if defined(DXCH_CODE) && defined(PX_CODE)
    {gtDbDxPhoenixBoardReg,
#else
    {NULL,
#endif
                                "AC5X-RD+PIPE",1,{"Rev 0.1"  /*1*/
                                    }, GT_TRUE},/* 43,1 */

...
#include <cpss/dxCh/dxChxGen/trunk/private/prvCpssDxChTrunk.h>/*for prvCpssDxChTrunkDesignatedTableForSrcPortHashMappingSet*/
...
static GT_STATUS phoenix_EventsSpecificInit
(
...
static AC5X_PORT_MAP_STC phoenix_defaultMap_port_mode[] =
{
    /* ports from USX mac */
...
static AC5X_PORT_MAP_STC phoenix_defaultMap_port_mode_rpp[] =
{
    /* ports from USX mac */
...
static AC5X_PORT_MAP_STC phoenix_defaultMap_24_6_port_mode[] =
{
    /* ports from USX mac */
     {{ 0,  1,  2,  3,  4,  5,  6,  7,  GT_NA} , { 0,  1,  2,  3,  4,  5,  6,  7,  GT_NA} , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E}
    ,{{ 8,  9,  10, 11, 12, 13, 14, 15, GT_NA} , { 8,  9,  10, 11, 12, 13, 14, 15, GT_NA} , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E}
...
static AC5X_PORT_MAP_STC phoenix_defaultMap_16_port_mode[] =
{
    /* ports from USX mac */
     {{ 0,  1,  2,  3,  4,  5,  6,  7,  GT_NA} , { 0,  1,  2,  3,  4,  5,  6,  7,  GT_NA} , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E}
    ,{{ 8,  9,  10, 11, 12, 13, 14, 15, GT_NA} , { 8,  9,  10, 11, 12, 13, 14, 15, GT_NA} , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E}
...
static AC5X_PORT_MAP_STC aldrin_3s_defaultMap_12_port_mode[] =
{
    /* ports from USX mac */
     {{ 0,  1,  2,  3,  GT_NA} , { 0,  1,  2,  3,  GT_NA} , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E}
    ,{{ 8,  9,  10, 11, GT_NA} , { 8,  9,  10, 11, GT_NA} , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E}
...
static AC5X_PORT_MAP_STC aldrin_3s_defaultMap_8_port_mode[] =
{
    /* ports from USX mac */
     {{ 0,  1,  2,  3,  GT_NA} , { 0,  1,  2,  3,  GT_NA} , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E}
    ,{{ 8,  9,  10, 11, GT_NA} , { 8,  9,  10, 11, GT_NA} , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E}
...
static GT_BOOL  withCaelum = GT_FALSE;
static GT_BOOL  withPipe = GT_FALSE;
static GT_BOOL  ac5xBackToBack = GT_FALSE;
/***************************************************************/
...
#define CSCD_TRUNK_ID   100   /* trunk ID for cascade ports */

#define DEV0_CSCD_0      50   /* port (on dev 0 to dev 1) */ /*SD 6 */
#define DEV0_CSCD_1      51   /* port (on dev 0 to dev 1) */ /*SD 7 */
#define DEV0_CSCD_2      52   /* port (on dev 0 to dev 1) */ /*SD 8 */
#define DEV0_CSCD_3      53   /* port (on dev 0 to dev 1) */ /*SD 9 */

#define DEV1_CSCD_0      DEV0_CSCD_0   /* port (on dev 1 to dev 0) */ /*SD 6 */
#define DEV1_CSCD_1      DEV0_CSCD_1   /* port (on dev 1 to dev 0) */ /*SD 7 */
#define DEV1_CSCD_2      DEV0_CSCD_2   /* port (on dev 1 to dev 0) */ /*SD 8 */
#define DEV1_CSCD_3      DEV0_CSCD_3   /* port (on dev 1 to dev 0) */ /*SD 9 */
...
static const LOCAL_CASCADE_CONNECTED_PORTS_INFO_STC phoenix_b2b_connectedPortsInfo[] =
{
    {
        {
        /*ports on dev 0*/{DEV0_CSCD_0/*portNum*/},
        /*ports on dev 1*/{DEV1_CSCD_0/*portNum*/}
        }
        , CPSS_CSCD_PORT_DSA_MODE_4_WORDS_E/*cascadePortType*/
    }
   ,{
        {
        /*ports on dev 0*/{DEV0_CSCD_1/*portNum*/},
        /*ports on dev 1*/{DEV1_CSCD_1/*portNum*/}
        }
        , CPSS_CSCD_PORT_DSA_MODE_4_WORDS_E/*cascadePortType*/
    }
   ,{
        {
        /*ports on dev 0*/{DEV0_CSCD_2/*portNum*/},
        /*ports on dev 1*/{DEV1_CSCD_2/*portNum*/}
        }
        , CPSS_CSCD_PORT_DSA_MODE_4_WORDS_E/*cascadePortType*/
    }
   ,{
        {
        /*ports on dev 0*/{DEV0_CSCD_3/*portNum*/},
        /*ports on dev 1*/{DEV1_CSCD_3/*portNum*/}
        }
        , CPSS_CSCD_PORT_DSA_MODE_4_WORDS_E/*cascadePortType*/
    }
...
static PortInitList_STC phoenix_dev0_b2b_portInitlist[] =
{
    /* ports in 10G */
    { PORT_LIST_TYPE_LIST,      {0,8,16,24,32,40,48,49,     APP_INV_PORT_CNS }, CPSS_PORT_SPEED_10000_E,  CPSS_PORT_INTERFACE_MODE_KR_E             }
    /* 4 cascade ports */
   ,{ PORT_LIST_TYPE_LIST,      {DEV0_CSCD_0, DEV0_CSCD_1, DEV0_CSCD_2, DEV0_CSCD_3,       APP_INV_PORT_CNS }, CPSS_PORT_SPEED_25000_E,  CPSS_PORT_INTERFACE_MODE_KR_E}

   ,{ PORT_LIST_TYPE_EMPTY,     {APP_INV_PORT_CNS }, CPSS_PORT_SPEED_NA_E,   CPSS_PORT_INTERFACE_MODE_QSGMII_E                      }
};

static PortInitList_STC phoenix_dev1_b2b_portInitlist[] =
{
    /* ports in 10G */
    { PORT_LIST_TYPE_LIST,      {0,8,16,24,32,40,48,49,     APP_INV_PORT_CNS }, CPSS_PORT_SPEED_10000_E,  CPSS_PORT_INTERFACE_MODE_KR_E             }
    /* 4 cascade ports */
   ,{ PORT_LIST_TYPE_LIST,      {DEV1_CSCD_3, DEV1_CSCD_2, DEV1_CSCD_1, DEV1_CSCD_0,       APP_INV_PORT_CNS }, CPSS_PORT_SPEED_25000_E,  CPSS_PORT_INTERFACE_MODE_KR_E}
...
#warning "-----MV DEMOBOARD ----------"
   ...
   ,{ PORT_LIST_TYPE_LIST,  {50,     APP_INV_PORT_CNS }, CPSS_PORT_SPEED_100G_E,  CPSS_PORT_INTERFACE_MODE_SR_LR4_E}
#endif
#else
   ,{ PORT_LIST_TYPE_LIST,  {50,51,52,53,     APP_INV_PORT_CNS }, CPSS_PORT_SPEED_25000_E,  CPSS_PORT_INTERFACE_MODE_KR_E}
#endif
...
{
    GT_STATUS   rc;
    AC5X_PORT_MAP_STC *currAppDemoInfoPtr = NULL;
    ...
    if(withCaelum == GT_TRUE)
    {
        currAppDemoInfoPtr = &ac5x_with_rpp_for_caelum_port_mode[0];
        numEntries = actualNum_ac5x_with_rpp_for_caelum_port_mode;
        phoenix_force_PortsInitListPtr = ac5x_with_rpp_for_caelum_portInitlist;
    }
#if defined(PX_FAMILY)
    else
    if(withPipe == GT_TRUE)
    {
        currAppDemoInfoPtr = &ac5x_with_rpp_for_pipe_port_mode[0];
        numEntries = actualNum_ac5x_with_rpp_for_pipe_port_mode;
        phoenix_force_PortsInitListPtr = ac5x_with_rpp_for_pipe_portInitlist;
    }
#endif
    else
...
)
{
    ...
    if(rc == GT_OK)
    {
        GT_U32  deviceId = (pciInfo->pciDevVendorId.devId << 16) |
               (pciInfo->pciDevVendorId.vendorId/*0x11ab*/);
        APP_DEMO_PP_CONFIG  *appDemoPtr;
        switch(deviceId)
        {
            case CPSS_BOBK_CAELUM_DEVICES_CASES_MAC:
                /* let's assume that we run in the internal CPU of the AC5P and
                   we see the Caelum on the PCIe */
                withCaelum = GT_TRUE;
                appDemoPtr = &appDemoPpConfigList[i+1];
                /* we save info for the Caelum at index (1) and not at index (0) */
                appDemoPtr->valid = GT_FALSE;
                appDemoPtr->deviceId  = deviceId;
                appDemoPtr->devFamily = CPSS_PP_FAMILY_DXCH_BOBCAT2_E;
                appDemoPtr->channel = CPSS_CHANNEL_PCI_E;
                appDemoPtr->devNum  = (GT_U8)(i+1);
                cpssOsMemCpy(&appDemoPtr->pciInfo, pciInfo, sizeof(GT_PCI_INFO));

                rc = appDemoAc5xWithCaelum_fillAc5xWithPortMappingAndSpeed();
                CPSS_ENABLER_DBG_TRACE_RC_MAC("appDemoAc5xWithCaelum_fillAc5xWithPortMappingAndSpeed", rc);
                if (rc != GT_OK)
                {
                    return rc;
                }

                /* we jump to the AC5X device */
                rc = gtPresteraGetPciDev(GT_FALSE/*not first*/, pciInfo);

                ac5xInternalCpu = GT_TRUE;
                flag_mbus_ac5x = MV_EXT_DRV_CFG_FLAG_SPECIAL_INFO_AC5X_ID_CNS;
                if(pciInfo->pciBusNum == 0xFF)
                {
            ...
            case CPSS_PIPE_ALL_DEVICES_CASES_MAC:
                /* let's assume that we run in the internal CPU of the AC5X and
                   we see the PIPE on the PCIe */
                withPipe = GT_TRUE;
                appDemoPtr = &appDemoPpConfigList[i+1];
                /* we save info for the PIPE at index (1) and not at index (0) */
                appDemoPtr->valid = GT_FALSE;
                appDemoPtr->deviceId  = deviceId;
                appDemoPtr->devFamily = CPSS_PX_FAMILY_PIPE_E;
                appDemoPtr->channel = CPSS_CHANNEL_PCI_E;
                appDemoPtr->devNum  = (GT_U8)(i+1);
                cpssOsMemCpy(&appDemoPtr->pciInfo, pciInfo, sizeof(GT_PCI_INFO));

                rc = appDemoAc5xWithPipe_fillAc5xWithPortMappingAndSpeed();
                CPSS_ENABLER_DBG_TRACE_RC_MAC("appDemoAc5xWithPipe_fillAc5xWithPortMappingAndSpeed", rc);
                if (rc != GT_OK)
                {
                    return rc;
                }
...
#endif
            default:
                /* Board is candidate to be AC5X Back To Back.
                   Final decision will be made in phoenix_getBoardInfoSimple */
                ac5xBackToBack = GT_TRUE;
                break;
        }
    }
...
)
{
    ...
    if(rc == GT_OK)
    {
        deviceId =  (pciInfo->pciDevVendorId.devId << 16) |
                    (pciInfo->pciDevVendorId.vendorId/*0x11ab*/);
        switch (deviceId)
        {
            case CPSS_PHOENIX_ALL_DEVICES_CASES_MAC:
                ...
                appDemoPpConfigList[SYSTEM_DEV_NUM_MAC(appDemoPpConfigDevAmount)].hwInfo = *(hwInfoPtr+1);
                appDemoPpConfigDevAmount++;
                return GT_OK;
            default:
                break;
    ...
    /* The board is not AC5X Back To Back */
    ac5xBackToBack = GT_FALSE;
...
)
{
    ...
    if(withCaelum == GT_TRUE)
    {
        osPrintf("%s with CAELUM : Board Type: %s [%s]\n", devName , boardName , environment);
    }
    else
    if(withPipe == GT_TRUE)
    {
        osPrintf("%s with PIPE : Board Type: %s [%s]\n", devName , boardName , environment);
    }
    else
    {
...
)
{
    ...
    rc = appDemoDevIdxGet(devNum, &devIndex);
    if(rc != GT_OK)
        return rc;
...
)
{
    ...
    if(ac5xBackToBack)
    {
        if(devIndex == SYSTEM_DEV_NUM_MAC(0))
        {
            ...
            portInitListPtr = phoenix_dev0_b2b_portInitlist;
        }
        else
        {
            /* use speed table with the needed speeds on the connection ports */
            portInitListPtr = phoenix_dev1_b2b_portInitlist;;
        }
    }
    else if(phoenix_force_PortsInitListPtr)
    {
        /* allow to 'FORCE' specific array by other logic */
...
)
{
    ...
    rc = appDemoDxChBoardTypeGet(SYSTEM_DEV_NUM_MAC(devNum), boardRevId, &bc2BoardType);
    if (GT_OK != rc)
    {
        return rc;
    }
    ...
    *devTypePtr = devType;
    ...
    if(appDemoDbEntryGet("oam_up_mep_enable_wa", &value) == GT_OK && value != 0)
    {
        rc = appDemoOamUpMepWAInit(devNum);
        if (rc != GT_OK)
        {
            return rc;
        }
...
/**
* @internal phoenix_B2B_CascadeInit function
* @endinternal
*
* @brief   B2B Cascade ports configurations
*
* @param[in] devIndex               - device index  in the array of appDemoPpConfigList[devIndex]
* @param[in] devNum                 - device number
*
* @retval GT_OK                     - on success
* @retval GT_FAIL                   - otherwise
*
*/
static GT_STATUS phoenix_B2B_CascadeInit
(
    IN GT_U32                   devIndex,
    IN GT_SW_DEV_NUM            devNum
)
{
    const LOCAL_CASCADE_CONNECTED_PORTS_INFO_STC  *currConnectedPortsInfoPtr;
    GT_STATUS   rc;
    GT_U32          trunkId = CSCD_TRUNK_ID;    /* trunk ID */
    GT_U32  ii;
    ...
    for(ii = 0, currConnectedPortsInfoPtr = &phoenix_b2b_connectedPortsInfo[0];
        currConnectedPortsInfoPtr->cascadePortType != GT_NA;
        ii++, currConnectedPortsInfoPtr++)
    {
        ...
        appDemoPpConfigList[devIndex].cscdPortsArr[ii].cscdPortType = currConnectedPortsInfoPtr->cascadePortType;
        appDemoPpConfigList[devIndex].cscdPortsArr[ii].trunkId = (GT_TRUNK_ID)trunkId;
        appDemoPpConfigList[devIndex].cscdPortsArr[ii].portNum = currConnectedPortsInfoPtr->devPortInfo[devIndex].portNum;

        /* for the DSA compensation */
        portNum = appDemoPpConfigList[devIndex].cscdPortsArr[ii].portNum;
    ...
    appDemoPpConfigList[devIndex].numberOfCscdTrunks = 1;
    appDemoPpConfigList[devIndex].numberOfCscdPorts = ii;
    appDemoPpConfigList[devIndex].numberOfCscdTargetDevs = 1;
    appDemoPpConfigList[devIndex].cscdTargetDevsArr[0].targetDevNum = (GT_U8)(SYSTEM_DEV_NUM_MAC(0) == devNum) ? SYSTEM_DEV_NUM_MAC(1) : SYSTEM_DEV_NUM_MAC(0);
    appDemoPpConfigList[devIndex].cscdTargetDevsArr[0].linkToTargetDev.linkNum = trunkId;
    appDemoPpConfigList[devIndex].cscdTargetDevsArr[0].linkToTargetDev.linkType = CPSS_CSCD_LINK_TYPE_TRUNK_E;
    appDemoPpConfigList[devIndex].internal10GPortConfigFuncPtr = NULL;

    targetDevNum = appDemoPpConfigList[devIndex].cscdTargetDevsArr[0].targetDevNum;
    ...
    cpssCascadeLink.linkNum = appDemoPpConfigList[devIndex].cscdTargetDevsArr[0].linkToTargetDev.linkNum;
    cpssCascadeLink.linkType = appDemoPpConfigList[devIndex].cscdTargetDevsArr[0].linkToTargetDev.linkType;

    /* update the <srcPortTrunkHashEn> to be 'HASH_IS_SRC_PORT' */
    rc = cpssDxChCscdDevMapTableSet(devNum, targetHwDevNum, 0, 0, 0,
                                    &cpssCascadeLink,
...
{
    GT_STATUS   rc;
    CPSS_PP_DEVICE_TYPE devType = 0; /* init variable to avoid warnings */
    GT_U32              tmpData;
    ...
    GT_U32  deviceId;
    GT_U32  hwInfoIndex; /* index of the device in HW info array */
    GT_U32    secondsStart;
    GT_U32    nanoSecondsStart;
    ...
    {
        deviceId = (appDemoPpConfigList[devIndex].pciInfo.pciDevVendorId.devId << 16) |
                            (appDemoPpConfigList[devIndex].pciInfo.pciDevVendorId.vendorId/*0x11ab*/);
        switch (deviceId)
        {
            case CPSS_PHOENIX_ALL_DEVICES_CASES_MAC:
                devNum = devIndex;
                ...
                hwInfoIndex = devIndex - SYSTEM_DEV_NUM_MAC(0);

                rc = phoenix_initPhase1AndPhase2(devNum,boardRevId,hwInfoPtr+hwInfoIndex,devIndex,&devType);
    ...
    if(ac5xBackToBack)
    {
        ...
        {
            devNum = devIndex;
            rc = phoenix_B2B_CascadeInit(devIndex, devNum);
            CPSS_ENABLER_DBG_TRACE_RC_MAC("phoenix_B2B_CascadeInit", rc);
            if (rc != GT_OK)
            {
                return rc;
            }
        ...
        switch (deviceId)
        {
            case CPSS_PHOENIX_ALL_DEVICES_CASES_MAC:
                ...
                if(rc != GT_OK)
                    return rc;
#endif /*0*/
                rc = phoenix_EventsSpecificInit(CAST_SW_DEVNUM(devNum));
                CPSS_ENABLER_DBG_TRACE_RC_MAC("phoenix_EventsSpecificInit", rc);
                if(rc != GT_OK)
                    return rc;
...
/**
* @internal phoenix_EventsSpecificInit function
* @endinternal
*
* @brief   Additional init of specific events that is required for Phoenix appdemo.
*          Phoenix appDemo initializes events before init of libraries.
*          And unmask of some events like PHA need additional iteration after init of libraries.
*
*/
static GT_STATUS phoenix_EventsSpecificInit
(
...
)
{
    ...
    if (GT_OK == appDemoDbEntryGet("initSystemWithoutInterrupts", &value) && value)
    {
        /* we don't want interrupts handling */
        return GT_OK;
    }
    ...
    /* unmask PHA events. PHA units are "Clock Gated" before cpssDxChPhaInit and
       appDemoEventRequestDrvnModeInit does not unmasks some PHA related interrupts.
       Need to unmask them again after cpssDxChPhaInit */
    rc = cpssEventDeviceMaskSet(devNum, CPSS_PP_PHA_E, CPSS_EVENT_UNMASK_E);
...
static GT_STATUS   appDemoPhoenixMainUtForbidenTests(void)
{
    ...
    /* Those tests are exceeding timeout for distributed simulation */
    utfAddPreSkippedRule("cpssDxChBridgeFdbManager","*","","");
    utfAddPreSkippedRule("cpssDxChExactMatchManager","*","","");
    utfAddPreSkippedRule("cpssDxChLpm","*","","");
    utfAddPreSkippedRule("cpssDxChHwInitDeviceMatrix","*","","");
#endif
#endif /*IMPL_TGF*/
...
)
{
     ...
     *           P3,    LED Server 1,  Position 8   Ports 24..31                                              *
...
)
{
    ...
    for(smiAddr = 0; smiAddr < 32; smiAddr++)
    {
        ...
        /* Change to Page 0 */
        rc = cpssSmiRegisterWriteShort(devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, phySmiInterface, smiAddr, 22, 0);
        if( rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    */
    ...
    /* Force boardRevId to be RD for AC5X and PIPE simulation */
    boardRevId = (withPipe == GT_TRUE) ? 2 : boardRevId;
    ...
    rc = phoenix_appDemoInitSequence(boardRevId, hwInfo);
    if (rc != GT_OK)
        return rc;
    if (appDemoInitRegDefaults != GT_FALSE)
    {
    ...
    if(withCaelum == GT_TRUE)
    {
        ...
        cpssOsPrintf("cpssInitSystem for first device : time: %d sec., %d nanosec.\n", seconds, nanoSec);

        rc = appDemoAc5xWithCaelum_initAfterBasicAc5xInit(SYSTEM_DEV_NUM_MAC(0));
        CPSS_ENABLER_DBG_TRACE_RC_MAC("appDemoAc5xWithCaelum_initAfterBasicAc5xInit", rc);
        if (rc != GT_OK)
            return rc;

        appDemoSysConfig.mixedSip5AndSip6System = GT_TRUE;
    }
    ...
    if(withPipe == GT_TRUE)
    {
        ...
        rc = appDemoAc5xWithPipe_initAfterBasicAc5xInit(SYSTEM_DEV_NUM_MAC(0));
        CPSS_ENABLER_DBG_TRACE_RC_MAC("appDemoAc5xWithCaelum_initAfterBasicAc5xInit", rc);
        if (rc != GT_OK)
            return rc;
    }
    ...
    if(withCaelum == GT_TRUE || withPipe == GT_TRUE)
    {
        /* this sleep already done during
           appDemoAc5xWithCaelum_initAfterBasicAc5xInit or appDemoAc5xWithPipe_initAfterBasicAc5xInit */
    }
    else
    {
...
/* if a device set with hashMode = CPSS_DXCH_TRUNK_LBH_PACKETS_INFO_CRC_E   */
/* it must have defaults for hashing that will allow to use trunks with LBH */
GT_STATUS   appDemoTrunkCrcHashDefaultsSet(IN GT_U8 devNum)
{
    GT_STATUS   rc;
    GT_U32      ii;
...
/*   maskEntry.localSrcPortMaskBmp = 1; */ /* one byte */
     ...
     for (ii = 16; ii < 31; ii++)
     {
         rc = cpssDxChTrunkHashMaskCrcEntrySet(devNum, 0/*hashIndex*/, ii, &maskEntry);
         if(rc != GT_OK)
         {
             return rc;
         }
...
/*  function to allow test define how traffic send to the cascade ports in B2B system
...
*/
GT_STATUS appDemoCascadeTrunkDesignatedTableForSrcPortHashMappingSet(
    IN GT_U8             devNum,
    IN GT_U32            numOfPorts,
    IN GT_PHYSICAL_PORT_NUM srcPort_0,
    IN GT_PHYSICAL_PORT_NUM trunkPort_0,
    IN GT_PHYSICAL_PORT_NUM srcPort_1,
    IN GT_PHYSICAL_PORT_NUM trunkPort_1,
    IN GT_PHYSICAL_PORT_NUM srcPort_2,
    IN GT_PHYSICAL_PORT_NUM trunkPort_2,
    IN GT_PHYSICAL_PORT_NUM srcPort_3,
    IN GT_PHYSICAL_PORT_NUM trunkPort_3
)
{
    CPSS_DXCH_MULTI_PORT_GROUP_SRC_PORT_HASH_PAIR_STC   portsArr[4];

    if(numOfPorts > 4)
    {
        osPrintf("numOfPorts[%d] must not be > 4 \n");
        return GT_BAD_PARAM;
    }

    portsArr[0].srcPort   =   srcPort_0;
    portsArr[0].trunkPort = trunkPort_0;
    portsArr[1].srcPort   =   srcPort_1;
    portsArr[1].trunkPort = trunkPort_1;
    portsArr[2].srcPort   =   srcPort_2;
    portsArr[2].trunkPort = trunkPort_2;
    portsArr[3].srcPort   =   srcPort_3;
    portsArr[3].trunkPort = trunkPort_3;

    return prvCpssDxChTrunkDesignatedTableForSrcPortHashMappingSet(
        devNum,numOfPorts,portsArr,CPSS_DXCH_MULTI_PORT_GROUP_SRC_HASH_MODE_MODULO_64_E);
}

...
)
{
    ...
    if ( (appDemoCpssPciProvisonDone == GT_FALSE) && (isSystemRecoveryHa2PhasesInit == GT_FALSE) )
    {
        ...
        {
            /* we init specific device of Caelum , and should not harm the PCI info in any index
                ((appDemoPpConfigList[0].pciInfo).pciDevVendorId).devId
                ((appDemoPpConfigList[1].pciInfo).pciDevVendorId).devId
            */
            pciStat = GT_OK;
        }
        else
    ...
    appDemoPpConfigDevAmount = ppCounter;
...
)
{
    ...
    appDemoPpConfigList[devIdx].hwInfo = localPpPh1Config.hwInfo[0];
    ...
    if(GT_OK == appDemoDbEntryGet("hwInfo.irq.switching", &value) && value != 0)
    {
        localPpPh1Config.hwInfo[0].irq.switching = value; /*allow to set : CPSS_PP_INTERRUPT_VECTOR_USE_POLLING_CNS;*/
        osPrintf("Force to use : hwInfo[0].irq.switching = [0x%x] \n",
            value);
    }
...
extern GT_STATUS appDemoTmPortsIdsGet
(
    IN      GT_U8  dev,
...
)
{
    ...
    rc = appDemoTmPortsIdsGet(devNum, &tmPortsArrSize, tmPortsArr);
    if(rc != GT_OK)
    {
        return rc;
    }
    ...
    for(entryIndex = 0; entryIndex < 255; entryIndex++)
    {
        ...
        else
        {
            ...
            if ((entryIndex < 64) && (entryIndex < tmPortsArrSize))
            {
...
)
{
    ...
    START_LOOP_ALL_DEVICES(ii,devNum)
    {
        waIndex = 0;
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort,        tmEnable,      tmPortInd*/
      {   0, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           0,       GT_NA,          GT_TRUE,         0 ,GT_FALSE,HQOS_UNAWARE}
     ,{   1, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           1,         1,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
     ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           2,         2,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
     ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           3,         3,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
     ,{   4, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           4,         4,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
     ,{   5, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           5,         5,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
     ,{   6, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           6,         6,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
     ,{   7, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           7,         7,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
     ,{   8, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           8,         8,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
     ,{   9, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,        0,           9,         9,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
     ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,            0,         GT_NA,      63,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
};
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort,        tmEnable,      tmPortInd*/
     {   0, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           0,       GT_NA,          GT_TRUE,         0 ,GT_FALSE,HQOS_UNAWARE}
    ,{   1, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           1,       GT_NA,          GT_TRUE,         1 ,GT_FALSE,HQOS_UNAWARE}
    ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           2,       GT_NA,          GT_TRUE,         2 ,GT_FALSE,HQOS_UNAWARE}
    ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           3,       GT_NA,          GT_TRUE,         3 ,GT_FALSE,HQOS_UNAWARE}
    ,{   4, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           4,       GT_NA,          GT_TRUE,         4 ,GT_FALSE,HQOS_UNAWARE}
    ,{   5, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           5,       GT_NA,          GT_TRUE,         5 ,GT_FALSE,HQOS_UNAWARE}
    ,{   6, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           6,       GT_NA,          GT_TRUE,         6 ,GT_FALSE,HQOS_UNAWARE}
    ,{   7, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           7,       GT_NA,          GT_TRUE,         7 ,GT_FALSE,HQOS_UNAWARE}
    ,{   8, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           8,       GT_NA,          GT_TRUE,         8 ,GT_FALSE,HQOS_UNAWARE}
    ,{   9, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,           9,       GT_NA,          GT_TRUE,         9 ,GT_FALSE,HQOS_UNAWARE}
    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,             0,         GT_NA,      63,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
};
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort,        tmEnable,      tmPortInd*/
     {  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          56,       GT_NA,          GT_TRUE,        56 ,GT_FALSE,HQOS_UNAWARE}
    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          57,        57,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          58,        58,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          59,        59,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,             0,         GT_NA,      63,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
                                                                                /* txQ 64 is reserved for tm */
    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          64,        56,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          65,        65,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          66,        66,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  67, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          67,        67,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  68, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          68,        68,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  69, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          69,        69,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  70, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          70,        70,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
    ,{  71, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          71,        71,            GT_FALSE,        0 ,GT_FALSE,HQOS_UNAWARE}
};
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort,        tmEnable,      tmPortInd*/
     {  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          56,       GT_NA,          GT_TRUE,         56 ,GT_FALSE,HQOS_UNAWARE}
    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          57,       GT_NA,          GT_TRUE,         57 ,GT_FALSE,HQOS_UNAWARE}
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          58,       GT_NA,          GT_TRUE,         58 ,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          59,       GT_NA,          GT_TRUE,         59 ,GT_FALSE,HQOS_UNAWARE}
    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,             0,         GT_NA,      63,            GT_FALSE,        0  ,GT_FALSE,HQOS_UNAWARE}
    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          64,       GT_NA,          GT_TRUE,         64 ,GT_FALSE,HQOS_UNAWARE}
    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          65,       GT_NA,          GT_TRUE,         65 ,GT_FALSE,HQOS_UNAWARE}
    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          66,       GT_NA,          GT_TRUE,         66 ,GT_FALSE,HQOS_UNAWARE}
    ,{  67, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          67,       GT_NA,          GT_TRUE,         67 ,GT_FALSE,HQOS_UNAWARE}
    ,{  68, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          68,       GT_NA,          GT_TRUE,         68 ,GT_FALSE,HQOS_UNAWARE}
    ,{  69, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          69,       GT_NA,          GT_TRUE,         69 ,GT_FALSE,HQOS_UNAWARE}
    ,{  70, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          70,       GT_NA,          GT_TRUE,         70 ,GT_FALSE,HQOS_UNAWARE}
    ,{  71, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          71,       GT_NA,          GT_TRUE,         71 ,GT_FALSE,HQOS_UNAWARE}
};
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort,         tmEnable,     tmPortInd*/
    ...
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          58,       GT_NA,           GT_TRUE,        58,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          59,       GT_NA,           GT_TRUE,        59,GT_FALSE,HQOS_UNAWARE}
    ,{  90, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          62,        62,             GT_FALSE,       GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,             0,         GT_NA,      63,             GT_FALSE,       0,GT_FALSE,HQOS_UNAWARE}
    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          64,       GT_NA,           GT_TRUE,        64,GT_FALSE,HQOS_UNAWARE}
    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          65,       GT_NA,           GT_TRUE,        65,GT_FALSE,HQOS_UNAWARE}
    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,          66,       GT_NA,           GT_TRUE,        66,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
    ...
    ,{   8, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,        8,    GT_NA,          GT_TRUE,                8,GT_FALSE,HQOS_UNAWARE}
    ,{   9, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,        9,    GT_NA,          GT_TRUE,                9,GT_FALSE,HQOS_UNAWARE}
    ,{  10, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       10,    GT_NA,          GT_TRUE,               10,GT_FALSE,HQOS_UNAWARE}
    ,{  11, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       11,    GT_NA,          GT_TRUE,               11,GT_FALSE,HQOS_UNAWARE}
    ,{  12, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       12,    GT_NA,          GT_TRUE,               12,GT_FALSE,HQOS_UNAWARE}
    ,{  13, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       13,    GT_NA,          GT_TRUE,               13,GT_FALSE,HQOS_UNAWARE}
    ,{  14, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       14,    GT_NA,          GT_TRUE,               14,GT_FALSE,HQOS_UNAWARE}
    ,{  15, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       15,    GT_NA,          GT_TRUE,               15,GT_FALSE,HQOS_UNAWARE}
    ,{  16, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       16,    GT_NA,          GT_TRUE,               16,GT_FALSE,HQOS_UNAWARE}
    ,{  17, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       17,    GT_NA,          GT_TRUE,               17,GT_FALSE,HQOS_UNAWARE}
    ,{  18, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       18,    GT_NA,          GT_TRUE,               18,GT_FALSE,HQOS_UNAWARE}
    ,{  19, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       19,    GT_NA,          GT_TRUE,               19,GT_FALSE,HQOS_UNAWARE}
    ,{  20, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       20,    GT_NA,          GT_TRUE,               20,GT_FALSE,HQOS_UNAWARE}
    ,{  21, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       21,    GT_NA,          GT_TRUE,               21,GT_FALSE,HQOS_UNAWARE}
    ,{  22, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       22,    GT_NA,          GT_TRUE,               22,GT_FALSE,HQOS_UNAWARE}
    ,{  23, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       23,    GT_NA,          GT_TRUE,               23,GT_FALSE,HQOS_UNAWARE}
    ,{  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       56,    GT_NA,          GT_TRUE,               56,GT_FALSE,HQOS_UNAWARE}
    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       57,    GT_NA,          GT_TRUE,               57,GT_FALSE,HQOS_UNAWARE}
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       58,    GT_NA,          GT_TRUE,               58,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       59,    GT_NA,          GT_TRUE,               59,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
    ...
    ,{  22, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       22,    GT_NA,          GT_TRUE,               22,GT_FALSE,HQOS_UNAWARE}
    ,{  23, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       23,    GT_NA,          GT_TRUE,               23,GT_FALSE,HQOS_UNAWARE}
    ,{  24, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       24,    GT_NA,          GT_TRUE,               24,GT_FALSE,HQOS_UNAWARE}
    ,{  25, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       25,    GT_NA,          GT_TRUE,               25,GT_FALSE,HQOS_UNAWARE}
    ,{  26, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       26,    GT_NA,          GT_TRUE,               26,GT_FALSE,HQOS_UNAWARE}
    ,{  27, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       27,    GT_NA,          GT_TRUE,               27,GT_FALSE,HQOS_UNAWARE}
    ,{  28, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       28,    GT_NA,          GT_TRUE,               28,GT_FALSE,HQOS_UNAWARE}
    ,{  29, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       29,    GT_NA,          GT_TRUE,               29,GT_FALSE,HQOS_UNAWARE}
    ,{  30, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       30,    GT_NA,          GT_TRUE,               30,GT_FALSE,HQOS_UNAWARE}
    ,{  31, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       31,    GT_NA,          GT_TRUE,               31,GT_FALSE,HQOS_UNAWARE}
    ,{  32, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       32,    GT_NA,          GT_TRUE,               32,GT_FALSE,HQOS_UNAWARE}
    ,{  33, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       33,    GT_NA,          GT_TRUE,               33,GT_FALSE,HQOS_UNAWARE}
    ,{  34, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       34,    GT_NA,          GT_TRUE,               34,GT_FALSE,HQOS_UNAWARE}
    ,{  35, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       35,    GT_NA,          GT_TRUE,               35,GT_FALSE,HQOS_UNAWARE}
    ,{  36, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       36,    GT_NA,          GT_TRUE,               36,GT_FALSE,HQOS_UNAWARE}
    ,{  37, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       37,    GT_NA,          GT_TRUE,               37,GT_FALSE,HQOS_UNAWARE}
    ,{  38, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       38,    GT_NA,          GT_TRUE,               38,GT_FALSE,HQOS_UNAWARE}
    ,{  39, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       39,    GT_NA,          GT_TRUE,               39,GT_FALSE,HQOS_UNAWARE}
    ,{  40, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       40,    GT_NA,          GT_TRUE,               40,GT_FALSE,HQOS_UNAWARE}
    ,{  41, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       41,    GT_NA,          GT_TRUE,               41,GT_FALSE,HQOS_UNAWARE}
    ,{  42, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       42,    GT_NA,          GT_TRUE,               42,GT_FALSE,HQOS_UNAWARE}
    ,{  43, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       43,    GT_NA,          GT_TRUE,               43,GT_FALSE,HQOS_UNAWARE}
    ,{  44, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       44,    GT_NA,          GT_TRUE,               44,GT_FALSE,HQOS_UNAWARE}
    ,{  45, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       45,    GT_NA,          GT_TRUE,               45,GT_FALSE,HQOS_UNAWARE}
    ,{  46, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       46,    GT_NA,          GT_TRUE,               46,GT_FALSE,HQOS_UNAWARE}
    ,{  47, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       47,    GT_NA,          GT_TRUE,               47,GT_FALSE,HQOS_UNAWARE}
    ,{  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       56,    GT_NA,          GT_TRUE,               56,GT_FALSE,HQOS_UNAWARE}
    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       57,    GT_NA,          GT_TRUE,               57,GT_FALSE,HQOS_UNAWARE}
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       58,    GT_NA,          GT_TRUE,               58,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,         0,       59,    GT_NA,          GT_TRUE,               59,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
     {   0, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        0,       0,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{   1, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        1,       1,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        2,       2,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        3,       3,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{   4, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        4,       4,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ...
    ,{   8, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        8,       8,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{   9, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        9,       9,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  10, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       10,      10,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  11, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       11,      11,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  12, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       12,      12,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  13, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       13,      13,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  14, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       14,      14,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  15, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       15,      15,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  16, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       16,      16,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  17, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       17,      17,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  18, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       18,      18,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  19, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       19,      19,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  20, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       20,      20,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  21, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       21,      21,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  22, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       22,      22,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  23, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       23,      23,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       56,      56,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       57,      57,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       58,      58,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       59,      59,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,    GT_NA,      63,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       64,      64,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       65,      65,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       66,      66,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  67, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       67,      67,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  68, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       68,      68,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
     {   0, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        0,       0,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   1, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        1,       1,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        2,       2,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        3,       3,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   4, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        4,       4,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   5, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        5,       5,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   6, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        6,       6,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   7, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        7,       7,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   8, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        8,       8,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   9, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        9,       9,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  10, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       10,      10,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  11, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       11,      11,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  12, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       12,      12,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  13, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       13,      13,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  14, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       14,      14,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  15, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       15,      15,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  16, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       16,      16,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  17, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       17,      17,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  18, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       18,      18,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  19, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       19,      19,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  20, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       20,      20,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  21, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       21,      21,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  22, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       22,      22,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  23, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       23,      23,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  24, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       24,      24,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  25, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       25,      25,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  26, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       26,      26,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  27, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       27,      27,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  28, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       28,      28,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  29, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       29,      29,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  30, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       30,      30,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  31, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       31,      31,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  32, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       32,      32,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  33, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       33,      33,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  34, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       34,      34,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  35, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       35,      35,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  36, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       36,      36,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  37, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       37,      37,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  38, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       38,      38,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  39, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       39,      39,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  40, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       40,      40,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  41, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       41,      41,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  42, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       42,      42,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  43, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       43,      43,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  44, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       44,      44,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  45, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       45,      45,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  46, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       46,      46,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  47, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       47,      47,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       56,      56,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       57,      57,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       58,      58,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       59,      59,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,    GT_NA,      63,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       64,      64,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       65,      65,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       66,      66,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  67, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       67,      67,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  68, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       68,      68,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  69, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       69,      69,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  70, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       70,      70,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  71, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       71,      71,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
};
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
    ...
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       58,      58,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       59,      59,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  90, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       62,      62,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,    GT_NA,      63,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       64,      64,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       65,      65,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       66,      66,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
     {  52, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       52,      52,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  53, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       53,      53,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  54, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       54,      54,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  55, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       55,      55,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       56,      56,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       57,      57,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       58,      58,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       59,      59,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
    ...
    ,{  22, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       22,      22,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  23, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       23,      23,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  24, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       24,      24,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  25, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       25,      25,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  26, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       26,      26,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  27, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       27,      27,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       56,      56,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       57,      57,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       58,      58,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       59,      59,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
    ...
    ,{   6, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        6,       6,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{   7, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        7,       7,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  48, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       48,      48,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  49, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       49,      49,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  50, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       50,      50,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  51, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       51,      51,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  52, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       52,      52,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  53, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       53,      53,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  54, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       54,      54,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  55, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       55,      55,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
    ...
    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       58,      58,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       59,      59,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  80, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       60,      60,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  81, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       61,      61,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  82, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       62,      62,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,    GT_NA,      63,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       64,      64,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       65,      65,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       66,      66,           GT_FALSE,              0,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
   ...
   ,{  46, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       46,      46,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  47, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       47,      47,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  80, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       60,      60,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  81, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       61,      61,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE} /* virtual router port */
   ,{  82, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       62,      62,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,    GT_NA,      63,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       64,      64,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       65,      65,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       66,      66,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
...
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
    {   0, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       32,      32,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{   1, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       33,      33,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       34,      34,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       35,      35,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{   4, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       36,      36,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{   5, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       37,      37,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{   6, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       38,      38,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{   7, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       39,      39,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{   8, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       40,      40,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{   9, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       41,      41,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  10, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       42,      42,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  11, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       43,      43,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  12, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       44,      44,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  13, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       45,      45,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  14, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       46,      46,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  15, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       47,      47,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  24, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       52,      52,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  25, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       53,      53,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  26, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       54,      54,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  27, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       55,      55,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  28, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       56,      56,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  29, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       57,      57,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  30, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       58,      58,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  31, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       59,      59,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
   ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,    GT_NA,      63,           GT_FALSE,           GT_NA,GT_FALSE,HQOS_UNAWARE}
};

static CPSS_DXCH_PORT_MAP_STC aldrinZ0DefaultMap_8332_Z0[] =
{ /* Port,            mappingType                           portGroupm, intefaceNum, txQPort, trafficManegerEnable , tmPortInd*/
     {   0, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       64,      64,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   1, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       65,      65,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       66,      66,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       67,      67,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   4, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       68,      68,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   5, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       69,      69,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   6, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       70,      70,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   7, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       71,      71,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   8, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       56,      56,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{   9, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       57,      57,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  10, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       58,      58,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  11, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       59,      59,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  20, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       44,      44,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  21, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       40,      40,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  22, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       36,      36,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  23, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       32,      32,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  24, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       28,      28,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  25, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       24,      24,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  26, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       20,      20,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  27, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       16,      16,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  28, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       12,      12,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  29, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        8,       8,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  30, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        4,       4,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  31, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,        0,       0,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,    GT_NA,      63,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
    ,{  12, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       62,      62,           GT_FALSE,          GT_NA,GT_FALSE,HQOS_UNAWARE}
};
...
{ /* Port,            mappingType                           portGroupm,         intefaceNum, txQPort,      trafficManegerEnable , tmPortInd*/
/*DP[0]*/
/* 0*/     {   0, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 0),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{   1, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 1),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 2),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 3),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{   4, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{   5, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{   6, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{   7, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{   8, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{   9, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 9),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  10, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(10),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  11, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[1]*/
/* 0*/    ,{  12, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 0),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  13, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 1),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  14, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 2),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  15, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 3),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{  16, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  17, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  18, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  19, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  20, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  21, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+ 9),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  22, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+10),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  23, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(1*12+11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[2]*/
/* 0*/    ,{  24, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 0),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  25, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 1),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  26, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 2),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  27, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 3),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{  28, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  29, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  30, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  31, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  32, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  33, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+ 9),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  34, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+10),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  35, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(2*12+11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[3]*/
/* 0*/    ,{  36, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 0),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  37, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 1),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  38, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 2),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  39, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 3),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{  40, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  41, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  42, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  43, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  44, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  45, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+ 9),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  46, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+10),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  47, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(3*12+11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[4]*/
/* 0*/    ,{  48, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 0),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  49, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 1),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  50, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 2),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  51, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 3),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{  52, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  53, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  54, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  55, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+ 9),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+10),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[5]*/
/* 0*/    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 0),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 1),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  67, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 2),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  68, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 3),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{  69, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  70, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  71, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  72, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  73, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  74, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 9),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  75, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+10),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  76, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/********** special 2 last MAC ports ***************************/
/*DP[2]*/
/*12*/    ,{  77, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       72, BC3_LOCAL_PORT_IN_DP_TO_TXQ_PORT_MAC(12 , 2)    ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[5]*/
/*12*/    ,{  78, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       73, BC3_LOCAL_PORT_IN_DP_TO_TXQ_PORT_MAC(12 , 5)    ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/************************  DMAs only *******************/
/*DP[0]*/
/*12*/    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,       BC3_CPU_PORT_MAC_AND_TXQ_PORT_MAC,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/********** special 3 additional CPU SDMAs  ***************************/
/*DP[1]*/
/*12*/    ,{  80, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,       80,191,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/*12*/    ,{  81, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,       81,383,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[4]*/
/*12*/    ,{  82, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,       82,479,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
...
/*11*/    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(4*12+11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[5]*/
/* 4*/    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  67, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  68, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  69, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  70, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+ 9),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  71, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+10),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  72, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(5*12+11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/********** special 2 last MAC ports ***************************/
/*DP[2]*/
/*12*/    ,{  73, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       72, BC3_LOCAL_PORT_IN_DP_TO_TXQ_PORT_MAC(12 , 2)    ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[5]*/
/*12*/    ,{  74, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       73, BC3_LOCAL_PORT_IN_DP_TO_TXQ_PORT_MAC(12 , 5)    ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
...
/*2*/ ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 2),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*3*/ ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 3),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*4*/ ,{  18, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*5*/ ,{  36, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*6*/ ,{  54, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*7*/ ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*8*/ ,{  79, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*9*/ ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC( 9),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(10),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/,{  80, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       BC3_MAC_AND_TXQ_PORT_MAC(11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*12*/,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,                   0,       BC3_CPU_PORT_MAC_AND_TXQ_PORT_MAC,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
};
...
{ /* Port,            mappingType                       portGroupm,    intefaceNum, txQPort,      trafficManegerEnable , tmPortInd*/
/*DP[0]*/
/* 0*/     {   0, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 0)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{   1, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 1)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 2)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 3)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{   4, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 4)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{   5, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 5)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{   6, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 6)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{   7, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 7)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{   8, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 8)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{   9, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 9)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  10, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(10)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  11, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(11)         ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[1]*/
/* 0*/    ,{  12, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 0)/*12*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  13, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 1)/*13*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  14, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 2)/*14*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  15, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 3)/*15*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{  16, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 4)/*16*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  17, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 5)/*17*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  18, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 6)/*18*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  19, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 7)/*19*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  20, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 8)/*20*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  21, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+ 9)/*21*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  22, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+10)/*22*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  23, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12+11)/*23*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[2]*/
/* 0*/    ,{  24, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 0)/*24*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  25, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 1)/*25*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  26, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 2)/*26*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  27, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 3)/*27*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{  28, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 4)/*28*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  29, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 5)/*29*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  30, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 6)/*30*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  31, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 7)/*31*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  32, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 8)/*32*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  33, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+ 9)/*33*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  34, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+10)/*34*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  35, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+11)/*35*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*12*/    ,{  36, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+12)/*36*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*13*/    ,{  37, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+13)/*37*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*14*/    ,{  38, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+14)/*38*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*15*/    ,{  39, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+15)/*39*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*16*/    ,{  40, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+16)/*40*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*17*/    ,{  41, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+17)/*41*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*18*/    ,{  42, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+18)/*42*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*19*/    ,{  43, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+19)/*43*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*20*/    ,{  44, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+20)/*44*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*21*/    ,{  45, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+21)/*45*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*22*/    ,{  46, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+22)/*46*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*23*/    ,{  47, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(24+23)/*47*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[3]*/
/* 0*/    ,{  48, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 0)/*48*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  49, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 1)/*49*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  50, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 2)/*50*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  51, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 3)/*51*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{  52, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 4)/*52*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  53, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 5)/*53*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  54, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 6)/*54*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  55, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 7)/*55*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  56, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 8)/*56*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 9)/*57*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+10)/*58*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+11)/*59*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*12*/    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+12)/*60*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*13*/    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+13)/*61*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*14*/    ,{  67, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+14)/*62*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*15*/    ,{  68, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+15)/*63*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*16*/    ,{  69, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+16)/*64*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*17*/    ,{  70, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+17)/*65*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*18*/    ,{  71, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+18)/*66*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*19*/    ,{  72, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+19)/*67*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*20*/    ,{  73, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+20)/*68*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*21*/    ,{  74, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+21)/*69*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*22*/    ,{  75, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+22)/*70*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*23*/    ,{  76, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+23)/*71*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/********** special 1 last MAC port ***********************/
/*DP[0]*/
/*24*/    ,{  77, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(72)   /*72*//*TXQ-24*/ ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/************************  DMAs only *******************/
/*DP[3]*/
/*24*/    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,     0, ALDRIN2_SDMA_MG0_CPU_PORT_MAC_AND_TXQ_PORT_MAC/*TXQ-99*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/********** special 3 additional CPU SDMAs  ****************/
/*DP[1]*/
/*24*/    ,{  80, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,     0, ALDRIN2_SDMA_MG1_CPU_PORT_MAC_AND_TXQ_PORT_MAC/*TXQ-49*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[2]*/
/*24*/    ,{  81, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,     0, ALDRIN2_SDMA_MG2_CPU_PORT_MAC_AND_TXQ_PORT_MAC/*TXQ-74*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[0]*/
/*23*/    ,{  82, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,     0, ALDRIN2_SDMA_MG3_CPU_PORT_MAC_AND_TXQ_PORT_MAC/*TXQ-23*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
...
/*2*/ ,{   2, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 2),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*3*/ ,{   3, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 3),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*4*/ ,{  18, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*5*/ ,{  36, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*6*/ ,{  54, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*7*/ ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*8*/ ,{  79, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*9*/ ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC( 9),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(10),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/,{  80, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,     0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/************************  DMAs only *******************/
/*DP[0]*/
/*23*/,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,         0, ALDRIN2_SDMA_MG0_CPU_PORT_MAC_AND_TXQ_PORT_MAC/*TXQ-99*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
};
...
/* 9*/    ,{  57, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+ 9)/*57*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+10)/*58*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  59, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(48+11)/*59*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/********** special 1 last MAC port ***********************/
/*DP[2]*/
/*23*/    ,{  47, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(47)   /*47*//*TXQ-24*/ ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/************************  DMAs only *******************/
/*DP[3]*/
/*24*/    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,     0, ALDRIN2_SDMA_MG0_CPU_PORT_MAC_AND_TXQ_PORT_MAC/*TXQ-99*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
...
/********** special 1 last MAC port ***********************/
/*DP[2]*/
/*23*/    ,{  47, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(47)   /*47*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/************************  DMAs only *******************/
/*DP[3]*/
/*24*/    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,     0, ALDRIN2_SDMA_MG0_CPU_PORT_MAC_AND_TXQ_PORT_MAC/*TXQ-99*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
...
/********** special 1 last MAC port ***********************/
/*DP[0]*/
/*24*/    ,{  72, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(72)   /*72*//*TXQ-24*/ ,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/************************  DMAs only *******************/
/*DP[3]*/
/*24*/    ,{  63, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,     0, ALDRIN2_SDMA_MG0_CPU_PORT_MAC_AND_TXQ_PORT_MAC/*TXQ-99*/,  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
...
/*11*/    ,{  11, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(11),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[1]*/
/* 0*/    ,{  12, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(12),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  13, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(13),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  14, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(14),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  15, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(15),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 4*/    ,{  16, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(16),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  17, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(17),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  18, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(18),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  19, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(19),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 8*/    ,{  20, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(20),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  21, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(21),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  22, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(22),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  23, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(23),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*DP[2]*/
/* 0*/    ,{  28, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(28),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  29, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(29),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  30, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(30),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  31, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(31),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/* 4*/    ,{  36, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(36),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  37, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(37),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  38, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(38),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  39, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(39),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/* 8*/    ,{  44, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(44),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  45, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(45),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 10*/   ,{  46, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(46),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 11*/   ,{  47, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(47),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/*DP[3]*/
/* 0*/    ,{  52, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(52),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 1*/    ,{  53, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(53),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 2*/    ,{  54, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(54),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 3*/    ,{  55, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(55),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/* 4*/    ,{  65, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(60),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 5*/    ,{  66, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(61),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 6*/    ,{  67, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(62),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 7*/    ,{  68, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(63),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}

/* 8*/    ,{  69, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(68),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/* 9*/    ,{  70, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(69),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*10*/    ,{  71, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(70),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*11*/    ,{  72, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E, 0, ALDRIN2_MAC_AND_TXQ_PORT_MAC(71),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
...
)
{
    ...
    for (i = 0, mapPtr = mapArrPtr; i < mapArrLen; i++, mapPtr++)
    {
        ...
        {
            copyLine = GT_FALSE;
            if (PRV_CPSS_PHY_PORT_IS_EXIST_MAC(devNum, 62))
            {
        ...
        if(mapPtr->mappingType == CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E)
        {
            ...
            {
                if (PRV_CPSS_PHY_PORT_IS_EXIST_MAC(devNum, 63))
                {
...
)
{
    ...
    GET_FIRST_VALID_DEV_INDEX(devIndex);
#if defined(CONFIG_V2_DMA)
    rc = appDemo_configure_dma_per_devNum(CAST_SW_DEVNUM(devIndex));
...
#endif
    rc = cpssDxChHwCoreClockGet(appDemoPpConfigList[devIndex].devNum, &coreClockDB, &coreClockHW);
    if(rc != GT_OK)
    {
        return rc;
    }

    rc = appDemoDxChBoardTypeGet(devIndex, boardRevId, &bc2BoardType);
    ...
    appDemoIsTmSupported(devIndex, &isTmSupported);
    ...
    switch(appDemoPpConfigList[devIndex].deviceId)
    {
        ...
        case CPSS_BOBK_CETUS_DEVICES_CASES_MAC:
            ...
            appDemoPpConfigList[devIndex].portInitlist_AllPorts_used = 0;
            if(isTmEnabled)
            {
            ...
            if (appDemoPpConfigList[devIndex].deviceId ==  CPSS_98DX8208_CNS)
            {
        ...
        case CPSS_ARMSTRONG_ALL_DEVICES_CASES_MAC:
            {
                ...
                {
                    if (appDemoPpConfigList[devIndex].deviceId == CPSS_98CX8405_CNS)
                    {
            ...
            dev = appDemoPpConfigList[devIndex].devNum;
        ...
        case CPSS_ALDRIN2_ALL_DEVICES_CASES_MAC:
            {
                ...
                {
                    if (appDemoPpConfigList[devIndex].deviceId == CPSS_98EX5524_CNS ||
                        appDemoPpConfigList[devIndex].deviceId == CPSS_98DX8524_CNS)
                    {
                        ARR_PTR_AND_SIZE_MAC(aldrin2defaultMap_48_ports, mapArrPtr, mapArrLen);
                    }
                    else
                    if (appDemoPpConfigList[devIndex].deviceId == CPSS_98DX8525_CNS)
                    {
                        ARR_PTR_AND_SIZE_MAC(aldrin2defaultMap_24_ports, mapArrPtr, mapArrLen);
                    }
                    else
                    if (appDemoPpConfigList[devIndex].deviceId == CPSS_98DX8515_CNS)
                    {
                        ARR_PTR_AND_SIZE_MAC(aldrin2defaultMap_16_ports, mapArrPtr, mapArrLen);
                    }
                    else
                    if (appDemoPpConfigList[devIndex].deviceId == CPSS_98DX4310_CNS)
                    {
                        ARR_PTR_AND_SIZE_MAC(aldrin2defaultMap_64_ports, mapArrPtr, mapArrLen);
                    }
                    else
                    if (appDemoPpConfigList[devIndex].deviceId == CPSS_98DX8410_CNS)
                    {
    ...
    if(1 == noCpu)
    {
        mapArrPtr = configBoardAfterPhase1MappingNoCPUCorrect(appDemoPpConfigList[devIndex].devNum, mapArrPtr,mapArrLen,/*OUT*/&mapArrLen);
    }
    ...
    START_LOOP_ALL_DEVICES(devIndex,dev)
    {
...
)
{
    ...
    GET_FIRST_VALID_DEV_INDEX(devNum);
    fuDescNum = auDescNum;
...
#if defined(CONFIG_V2_DMA)
            osCacheDmaMallocByDevice(devNum, ppPhase2Params->auqCfg.auDescBlockSize +
...
#if defined(CONFIG_V2_DMA)
            osCacheDmaMallocByDevice(devNum, ppPhase2Params->fuqCfg.auDescBlockSize +
                            tmpData);/*allocate space for one message more for alignment purposes
                                      NOTE: we not add it to the size , only to the buffer ! */
#else
...
#if defined(CONFIG_V2_DMA)
        osCacheDmaMallocByDevice(devNum, ppPhase2Params->netIfCfg.txDescBlockSize);
#else
...
#if defined(CONFIG_V2_DMA)
        osCacheDmaMallocByDevice(devNum, ppPhase2Params->netIfCfg.rxDescBlockSize);
#else
    ...
    if (ppPhase2Params->netIfCfg.rxBufInfo.allocMethod == CPSS_RX_BUFF_STATIC_ALLOC_E)
    {
        ...
        {
#if defined(CONFIG_V2_DMA)
            tmpPtr = osCacheDmaMallocByDevice(devNum, ((rxBufSize * rxDescNum) + rxBufAllign));
#else
...
)
{
    ...
    localPpPh2Config.fuqUseSeparate = CPSS_PP_PHASE2_UPLOAD_QUEUE_SEPARATE_E;
    if(appDemoDbEntryGet("fuqUseSeparate", &tmpData) == GT_OK)
    {
        localPpPh2Config.fuqUseSeparate =
            (tmpData != 0)
                ? CPSS_PP_PHASE2_UPLOAD_QUEUE_SEPARATE_E
                : CPSS_PP_PHASE2_UPLOAD_QUEUE_SHARED_WITH_AUQ_E;
    }
    ...
    if (dmaSize < _512K)
    {
        ...
        localPpPh2Config.fuqUseSeparate = CPSS_PP_PHASE2_UPLOAD_QUEUE_SHARED_WITH_AUQ_E;
...
)
{
    ...
    phase2Params->fuqUseSeparate = CPSS_PP_PHASE2_UPLOAD_QUEUE_SEPARATE_E;
...
)
{
    ...
    START_LOOP_ALL_DEVICES(dev,_dummy)
    {
...
)
{
    ...
    {
        prvCpssDrvHwPpResetAndInitControllerSetRegField(dev, 0xf829c, 0, 1, 0) ;

        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x50000000, 0x5f2037);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x50000120, 0x55555555);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x50000004, 0x10012d);
        ...
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x102C8030, 0x8c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x102C9030, 0xac);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x102CA030, 0xcc);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x102CB030, 0xec);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x102CC030, 0x10c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x102CD030, 0x12c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x102CE030, 0x14c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x102CF030, 0x16c);


        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x50000128, 0x00FFFFFF);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x5000012C, 0x00FFFFFF);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x50000130, 0x00FFFFFF);
    ...
    else if(APP_DEMO_ALDRIN_BOARD_RD_CNS == bc2BoardType)
    {
        ...
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x21000000 , 0x5f2037);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x21000120, 0x55555555);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x21000004 , 0x0010012A);

        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x21000128, 0x00FFFFFF);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x2100012C, 0x00FFFFFF);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x21000130, 0x00FFFFFF);


        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C8030, 0x0c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C9030, 0x2c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100CA030, 0x4c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100CB030, 0x6c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C0030, 0x8c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C1030, 0xAc);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C2030, 0xCc);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C3030, 0xEc);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C4030, 0x10c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C5030, 0x12c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C6030, 0x14c);
        prvCpssHwPpPortGroupWriteRegister(dev, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, 0x100C7030, 0x16c);
            ...
            xsmiInterface <= CPSS_PHY_XSMI_INTERFACE_1_E; xsmiInterface++)
        {
            ...
            {
                cpssXsmiPortGroupRegisterWrite(dev, 0x0, xsmiInterface,  phyAddr,  0xf020, 31,  0x139);
                cpssXsmiPortGroupRegisterWrite(dev, 0x0, xsmiInterface,  phyAddr,  0xf021, 31,  0x28);
                cpssXsmiPortGroupRegisterWrite(dev, 0x0, xsmiInterface,  phyAddr,  0xf022, 31,  0x30);
            }
        }
    ...
    else if(APP_DEMO_ALDRIN2_BOARD_RD_CNS == bc2BoardType)
    {
        ...
        for(xsmiInterface = CPSS_PHY_XSMI_INTERFACE_0_E; xsmiInterface <= CPSS_PHY_XSMI_INTERFACE_3_E; xsmiInterface++)
        {
            for(phyAddr = 0; phyAddr < 12; phyAddr++)
            {
                ...
                cpssXsmiPortGroupRegisterWrite(dev, 0x0, xsmiInterface, phyAddr, 0x0, 0x1, 0x2058);
            }
        }

        cpssDxChLedStreamPortPositionSet(dev,0,0);
        cpssDxChLedStreamPortPositionSet(dev,1,1);
        cpssDxChLedStreamPortPositionSet(dev,2,2);
        cpssDxChLedStreamPortPositionSet(dev,3,3);
        cpssDxChLedStreamPortPositionSet(dev,4,4);
        cpssDxChLedStreamPortPositionSet(dev,5,5);
        cpssDxChLedStreamPortPositionSet(dev,6,6);
        cpssDxChLedStreamPortPositionSet(dev,7,7);
        cpssDxChLedStreamPortPositionSet(dev,8,8);
        cpssDxChLedStreamPortPositionSet(dev,9,9);
        cpssDxChLedStreamPortPositionSet(dev,10,10);
        cpssDxChLedStreamPortPositionSet(dev,11,11);

        cpssDxChLedStreamPortPositionSet(dev,12,0);
        cpssDxChLedStreamPortPositionSet(dev,13,1);
        cpssDxChLedStreamPortPositionSet(dev,14,2);
        cpssDxChLedStreamPortPositionSet(dev,15,3);
        cpssDxChLedStreamPortPositionSet(dev,16,4);
        cpssDxChLedStreamPortPositionSet(dev,17,5);
        cpssDxChLedStreamPortPositionSet(dev,18,6);
        cpssDxChLedStreamPortPositionSet(dev,19,7);
        cpssDxChLedStreamPortPositionSet(dev,20,8);
        cpssDxChLedStreamPortPositionSet(dev,21,9);
        cpssDxChLedStreamPortPositionSet(dev,22,10);
        cpssDxChLedStreamPortPositionSet(dev,23,11);

        cpssDxChLedStreamPortPositionSet(dev,48,0);
        cpssDxChLedStreamPortPositionSet(dev,49,1);
        cpssDxChLedStreamPortPositionSet(dev,50,2);
        cpssDxChLedStreamPortPositionSet(dev,51,3);
        cpssDxChLedStreamPortPositionSet(dev,52,4);
        cpssDxChLedStreamPortPositionSet(dev,53,5);
        cpssDxChLedStreamPortPositionSet(dev,54,6);
        cpssDxChLedStreamPortPositionSet(dev,55,7);
        cpssDxChLedStreamPortPositionSet(dev,56,8);
        cpssDxChLedStreamPortPositionSet(dev,57,9);
        cpssDxChLedStreamPortPositionSet(dev,58,10);
        cpssDxChLedStreamPortPositionSet(dev,64,11);
        cpssDxChLedStreamPortPositionSet(dev,65,12);
        cpssDxChLedStreamPortPositionSet(dev,66,13);
        cpssDxChLedStreamPortPositionSet(dev,67,14);
        cpssDxChLedStreamPortPositionSet(dev,68,15);
        cpssDxChLedStreamPortPositionSet(dev,69,16);
        cpssDxChLedStreamPortPositionSet(dev,70,17);
        cpssDxChLedStreamPortPositionSet(dev,71,18);
        cpssDxChLedStreamPortPositionSet(dev,72,19);
        cpssDxChLedStreamPortPositionSet(dev,73,20);
        cpssDxChLedStreamPortPositionSet(dev,74,21);
        cpssDxChLedStreamPortPositionSet(dev,75,22);
        cpssDxChLedStreamPortPositionSet(dev,76,23);

        cpssDxChLedStreamPortPositionSet(dev,24,0);
        cpssDxChLedStreamPortPositionSet(dev,25,1);
        cpssDxChLedStreamPortPositionSet(dev,26,2);
        cpssDxChLedStreamPortPositionSet(dev,27,3);
        cpssDxChLedStreamPortPositionSet(dev,28,4);
        cpssDxChLedStreamPortPositionSet(dev,29,5);
        cpssDxChLedStreamPortPositionSet(dev,30,6);
        cpssDxChLedStreamPortPositionSet(dev,31,7);
        cpssDxChLedStreamPortPositionSet(dev,32,8);
        cpssDxChLedStreamPortPositionSet(dev,33,9);
        cpssDxChLedStreamPortPositionSet(dev,34,10);
        cpssDxChLedStreamPortPositionSet(dev,35,11);
        cpssDxChLedStreamPortPositionSet(dev,36,12);
        cpssDxChLedStreamPortPositionSet(dev,37,13);
        cpssDxChLedStreamPortPositionSet(dev,38,14);
        cpssDxChLedStreamPortPositionSet(dev,39,15);
        cpssDxChLedStreamPortPositionSet(dev,40,16);
        cpssDxChLedStreamPortPositionSet(dev,41,17);
        cpssDxChLedStreamPortPositionSet(dev,42,18);
        cpssDxChLedStreamPortPositionSet(dev,43,19);
        cpssDxChLedStreamPortPositionSet(dev,44,20);
        cpssDxChLedStreamPortPositionSet(dev,45,21);
        cpssDxChLedStreamPortPositionSet(dev,46,22);
        cpssDxChLedStreamPortPositionSet(dev,47,23);
    ...
    if (boardRevId == 4)
    {
        ...
        cpssDxChPortSerdesPolaritySet(dev, 59, 1, GT_TRUE,  GT_TRUE);
        cpssDxChPortSerdesPolaritySet(dev, 58, 1, GT_TRUE,  GT_TRUE);
        cpssDxChPortSerdesPolaritySet(dev, 57, 1, GT_FALSE, GT_FALSE);
        cpssDxChPortSerdesPolaritySet(dev, 56, 1, GT_FALSE, GT_FALSE);
        cpssDxChPortSerdesPolaritySet(dev, 71, 1, GT_FALSE, GT_FALSE);
        cpssDxChPortSerdesPolaritySet(dev, 70, 1, GT_FALSE, GT_FALSE);
        cpssDxChPortSerdesPolaritySet(dev, 69, 1, GT_FALSE, GT_FALSE);
        cpssDxChPortSerdesPolaritySet(dev, 68, 1, GT_FALSE, GT_FALSE);
        cpssDxChPortSerdesPolaritySet(dev, 64, 1, GT_FALSE, GT_TRUE);
        cpssDxChPortSerdesPolaritySet(dev, 65, 1, GT_FALSE, GT_TRUE);
        cpssDxChPortSerdesPolaritySet(dev, 66, 1, GT_FALSE, GT_TRUE);
        cpssDxChPortSerdesPolaritySet(dev, 67, 1, GT_TRUE,  GT_TRUE);
    }
    if (boardRevId == 3)
    {
        cpssDxChPortSerdesPolaritySet(dev, 66, 1, GT_FALSE, GT_TRUE);
...
extern GT_STATUS appDemoTmConditionalUnitsErrorsDump(GT_U8 devNum, char *fileNamePtr, GT_32 line, GT_BOOL dumpAlways);

/*
    API to initialize TM scenario
*/
GT_STATUS appDemoBc2TmScenarioInit
(
    IN GT_U8    dev
)
{
    ...
    switch (appDemoTmScenarioMode)
    {
        ...
        case CPSS_TM_17_PORT:
            ...
            rc = appDemoTmScenario17PortInit(dev);
            CPSS_ENABLER_DBG_TRACE_RC_MAC("appDemoTmScenario17PortInit 1", rc);
            if (rc != GT_OK)
            {
                return rc;
            }
            break;
        case CPSS_TM_BIST:
            rc = appDemoTmScenarioBISTInit(dev);
            CPSS_ENABLER_DBG_TRACE_RC_MAC("appDemoTmScenarioBISTInit", rc);
            if (rc != GT_OK)
            {
                return rc;
            }
...
)
{
    ...
    rc = appDemoBc2TmScenarioInit(dev);
    CPSS_ENABLER_DBG_TRACE_RC_MAC("appDemoTmScenarioInit", rc);
    if (rc != GT_OK)
    {
        return rc;
    }
    ...
    if (dumpTmErrors)
    {
        rc = appDemoTmConditionalUnitsErrorsDump(dev, __FILE__, __LINE__, GT_FALSE);
        CPSS_ENABLER_DBG_TRACE_RC_MAC("appDemoTmConditionalUnitsErrorsDump", rc);
    }
...
)
{
    ...
    if(GT_OK != rc)
    {
     ...
     /* iterate over packet processors.
        Don't iterate over PIPE devices in mixed systems with DX and PIPEs */
     START_LOOP_ALL_DEVICES_WITH_AMOUNT(dev,_dummy, ppCounter)
     {
        rc = cpssSystemRecoveryStateGet(&system_recovery);
        if (rc != GT_OK)
        {
...
)
{
    ...
    GT_U32    secondsStart1;
    GT_U32    nanoSecondsStart1;
    ...
    cpssOsTimeRT(&secondsStart1, &nanoSecondsStart1);
    rc = cpssDxChHwPpPhase1Init(&cpssPpPhase1Info, &devType);
    if (prvAppDemoFirstInitTimes.initSystemTimePpPhase1BeforeReset == 0)
    {
        prvAppDemoFirstInitTimes.initSystemTimePpPhase1BeforeReset =
            prvAppDemoGetDurationTimeMilliSec(secondsStart1, nanoSecondsStart1);
    }

...
GT_BOOL     appDemoIsEbofDevice = GT_FALSE;
...
/* mapping of falcon Ebof physical ports to MAC ports (and TXQ ports).*/
static FALCON_PORT_MAP_STC falcon_3_2_EBOF_defaultMap[] =
{
     {0               , 1          ,   0       , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{4              , 1          ,   4       , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{8              , 1          ,   8       , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{12             , 1          ,   12      , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{16             , 1          ,   32      , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{20             , 1          ,   36      , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{24             , 8          ,   96      , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{32             , 1          ,   111     , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{33             , 1          ,   110     , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{34             , 1          ,   109     , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{35             , 1          ,   108     , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{36             , 1          ,   107     , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{37             , 1          ,   106     , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{38             , 1          ,   105     , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{39             , 1          ,   104     , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{40             , 8          ,   112     , CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E ,IGNORE_DMA_STEP}
     ,{CPU_PORT/*63*/ , 1          ,  136/*DMA*/, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E    ,IGNORE_DMA_STEP}
     ,{58             , 3          ,  137/*DMA*/, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E    ,IGNORE_DMA_STEP}
};
static GT_U32   actualNum_falcon_3_2_EBOF_defaultMap = sizeof(falcon_3_2_EBOF_defaultMap)/sizeof(falcon_3_2_EBOF_defaultMap[0]);
...
static PortInitList_STC falcon_3_2_EBOF_portInitlist_modeSonic128MacPorts[] =
{
     /* ports 0..23 in step of 4 ports, each port is 200G, there are totally 6x200G ports*/
     /* ports 24..47, in step of 1 port, each port is 25G */
     { PORT_LIST_TYPE_INTERVAL,  {0/*startPort*/,23/*stopPort*/,4/*step*/, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_200G_E,  CPSS_PORT_INTERFACE_MODE_CR4_E }
     ,{ PORT_LIST_TYPE_INTERVAL,  {24/*startPort*/,47/*stopPort*/,1/*step*/, APP_INV_PORT_CNS }, CPSS_PORT_SPEED_25000_E,  CPSS_PORT_INTERFACE_MODE_KR_E }
};
...
static GT_STATUS fillDbForCpssPortMappingInfo(IN GT_U32 devNum)
{
    ...
    switch(PRV_CPSS_PP_MAC(devNum)->multiPipe.numOfTiles)
    {
        ...
        case 2:
            ...
            {
                if (appDemoIsEbofDevice == GT_TRUE)
                {
                    currAppDemoInfoPtr = &falcon_3_2_EBOF_defaultMap[0];
                    numEntries = actualNum_falcon_3_2_EBOF_defaultMap;
                }
                else
                {
    ...
    for (ii = 0 ; ii < numEntries; ii++ , currAppDemoInfoPtr++)
    {
        ...
        for(jj = 0 ; jj < currAppDemoInfoPtr->numOfPorts; jj++ , currCpssInfoPtr++)
        {
            ...
            /*This is just for debug mode of HQOS,in order to verify 5 level scheduling tree on SIP6 device.
                            In normal mode this parameters will be ignored by CPSS.
                        */
            if((appDemoDbEntryGet("hqos", &value) == GT_OK) && (value != 0))
            {
                if(currAppDemoInfoPtr->mappingType == CPSS_DXCH_PORT_MAPPING_TYPE_REMOTE_PHYSICAL_PORT_E)
                {
                  switch(jj)
                  {
                    ...
                    case 3:
                      currCpssInfoPtr->hqosId[0]=0;
                      currCpssInfoPtr->hqosId[1]=1;
                     break;
                    case 4:
                    case 5:
                      currCpssInfoPtr->hqosId[0]=1;
                      currCpssInfoPtr->hqosId[1]=0;
                     break;
                    default:
                      currCpssInfoPtr->hqosId[0]=1;
...
/*0*/  {   0, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       GM_FALCON_MAC_AND_TXQ_PORT_MAC( 0),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*1*/ ,{  18, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       GM_FALCON_MAC_AND_TXQ_PORT_MAC( 1),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*2*/ ,{  36, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       GM_FALCON_MAC_AND_TXQ_PORT_MAC( 2),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*3*/ ,{  54, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       GM_FALCON_MAC_AND_TXQ_PORT_MAC( 3),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*4*/ ,{  58, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       GM_FALCON_MAC_AND_TXQ_PORT_MAC( 4),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*5*/ ,{  79, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       GM_FALCON_MAC_AND_TXQ_PORT_MAC( 5),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*6*/ ,{  64, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       GM_FALCON_MAC_AND_TXQ_PORT_MAC( 6),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*7*/ ,{  80, CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E,               0,       GM_FALCON_MAC_AND_TXQ_PORT_MAC( 7),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
/*8*/ ,{CPU_PORT, CPSS_DXCH_PORT_MAPPING_TYPE_CPU_SDMA_E,               0,       GM_FALCON_MAC_AND_TXQ_PORT_MAC( 8),  GT_FALSE,   GT_NA,GT_FALSE,HQOS_UNAWARE}
};
...
)
{
    switch(boardType)
    {
        ...
        case APP_DEMO_FALCON_BOARD_6_4_TH_CNS:
            ...
            {
                /* SerDes Muxing DB's */
                ARR_PTR_AND_SIZE_MAC(falcon_EBOF_3_2T_MacToSerdesMap, falcon_MacToSerdesMap, falcon_MacToSerdesMap_arrSize);
                /* Polarity Swap DB's */
                ARR_PTR_AND_SIZE_MAC(falcon_EBOF_3_2T_PolarityArray, falcon_PolarityArray, falcon_PolarityArray_arrSize);
            }
            else
            {
                /* SerDes Muxing DB's */
...
/* retrieve PP Core Clock from HW */
    ...
    if (appDemoIsEbofDevice == GT_TRUE)
    {
        phase1Params->isrAddrCompletionRegionsBmp = 2;
        phase1Params->appAddrCompletionRegionsBmp = 60;
    }
...
)
{
    ...
    auDescNum = FALCON_AU_DESC_NUM_SIP6_DEF * PRV_CPSS_PP_MAC(devNum)->multiPipe.numOfTiles;
    ...
    fuDescNum = AU_DESC_NUM_SIP6_DEF * PRV_CPSS_PP_MAC(devNum)->multiPipe.numOfPipes;
    ...
    */
    ...
    {
#ifdef INTEL64_CPU
        /* Kernel driver for Intel CPUs is not ready for big DMA allocations.
           Reduce DMA allocations for such systems.*/
        {
            GT_U32  sdmaFactor;
        ...
        else
        {
            ...
            rc = appDemoDbEntryAdd("txGenNumOfDescBuff", 512);
            if(rc != GT_OK)
            {
                return rc;
            }
            ...
            if(useSinglePipeSingleDp == 0)
            {
                switch(PRV_CPSS_PP_MAC(devNum)->multiPipe.numOfTiles)
                {
                    ...
                    case 2:
                        ...
                        {
                            if (appDemoIsEbofDevice)
                            {
                                portInitListPtr = falcon_3_2_EBOF_portInitlist_modeSonic128MacPorts;
                            }
                            else
                            {
...
extern GT_STATUS force_early_check_for_device_not_reset_set(GT_U32 val);
extern GT_U32 force_early_check_for_device_not_reset_get(void);
/**
...
)
{
    ...
    /* The default value of force_early_check_for_device_not_reset is 1.
       MUST not call force_early_check_for_device_not_reset_set(0)
...
phase_1_init_lbl:
    ...
    if (forceSoftResetInInit)
    {
        /* require check reset-needed stamp and reset if found */
        cpssOsPrintf("Reset forced due to application request\n");
        forceSoftResetInInit = 0;
    ...
    prvCpssDxChCheckIsHwDidHwReset(devNum);
...
)
{
    ...
    if(appDemoDbEntryGet("treatIpv4ClassEasNonRegularUc", &value) == GT_OK)
    {
        if (value == 0)
        {
            sysConfigParamsPtr->treatIpv4ClassEasNonRegularUc = GT_FALSE;
        }
        else
        {
            sysConfigParamsPtr->treatIpv4ClassEasNonRegularUc = GT_TRUE;
        }
    }
    else
    {
...
)
{
    ...
    if(appDemoDbEntryGet("assignSmallBankToOctet0", &value) == GT_OK)
    {
        if(value)
        {
            ramDbCfgPtr->assignSmallBankToOctet0 = GT_TRUE;
        }
        else
        {
            ramDbCfgPtr->assignSmallBankToOctet0 = GT_FALSE;
        }
    }
    else
    {
...
)
{
    ...
    for(; portNum < appDemoPpConfigList[devNum].maxPortNumber ; portNum++)
    {
        ...
        /* Check if the port is CPU port, then skip */
    ...
    else
    {
        if(isUnderAddDeviceCatchup == GT_TRUE)
        {
            ...
            */
            ...
            {
                /* Assigned Device ID is 31 */
                lastIndexInLoop++;
                if(lastIndexInLoop == 32)
                {
                    break;
                }
            }
...
)
{
    ...
    switch(boardRevId)
    {
        ...
        case 14:
            if (boardRevId == 14)
            {
                appDemoIsEbofDevice = GT_TRUE;
            }
            boardType = APP_DEMO_FALCON_BOARD_6_4_TH_CNS;
            if (appDemoIsEbofDevice == GT_TRUE)
            {
                falcon_boardTypePrint("EBOF 3.2T" /*boardName*/, "Falcon" /*devName*/);
    ...
    CPSS_ENABLER_OS_RMON_CREATE_ENTRY_CHECKPOINT("falcon_appDemoInitSequence");
    rc = falcon_appDemoInitSequence(boardRevId, devIndex, devNum, hwInfo);
    CPSS_ENABLER_OS_RMON_CREATE_EXIT_CHECKPOINT("falcon_appDemoInitSequence");
    if (rc != GT_OK)
        return rc;
    if(falcon_force_stop_init_after_d2d_init_get())
    {
...
)
{
    ...
    cpssOsPrintf ("  5.Dump A node (port)  shaping configuration parameters - prvCpssDxChTxqDumpNodeShapingParameters(devNum,tileNum,aLevelStart,aLevelEnd,PRV_CPSS_PDQ_LEVEL_A_E)\n");
...
)
{
    MPD_RESULT_ENT ret;
    GT_U32 rel_ifIndex;
    PRV_MPD_OP_CODE_ENT op = PRV_MPD_OP_CODE_GET_LANE_BMP_E;
...
)
{
    ...
    speedParam.hostSide.fecMode = (CPSS_PORT_FEC_MODE_ENT)fecModeHost;
    speedParam.lineSide.fecMode = (CPSS_PORT_FEC_MODE_ENT)fecModeLine;

...
GT_BOOL gtAppDemoOAmSrvCpuInited = GT_TRUE;
...
/**
* @internal gtAppDemoOamTtiInitBfdMpls function
* @endinternal
*
* @brief   This function does specific initialization of TTI engine needed for BFD
...
/**
* @internal gtAppDemoOamTtiInitBfdMplsTp function
* @endinternal
*
* @brief   This function does specific initialization of TTI engine needed for BFD
...
/**
* @internal gtAppDemoOamTtiInitCfmMplsTp function
* @endinternal
*
* @brief   This function does specific initialization of TTI engine needed for OAM
...
/**
* @internal gtAppDemoOamPclInitGen function
* @endinternal
*
* @brief   This function does generic initialization of PCL engine.
...
/**
* @internal gtAppDemoOamPclInitGenDualEndedLm function
* @endinternal
*
* @brief   This function does generic initialization of PCL engine.
*         It is enabled per port and access to the PCL configuration table
...
/**
* @internal gtAppDemoOamEPclInitGen function
* @endinternal
*
* @brief   This function does generic initialization of Egress PCL engine.
*         It is enabled per port and access to the PCL configuration table
...
/**
* @internal gtAppDemoOamPclInitBfdIpv4 function
* @endinternal
*
* @brief   This function does specific initialization of PCL UDB needed for BFD IPv4
...
/**
* @internal gtAppDemoOamPclInitBfdMpls function
* @endinternal
*
* @brief   This function does specific initialization of PCL UDB needed for BFD IPv4
...
/**
* @internal gtAppDemoOamPclInitBfdMplsTp function
* @endinternal
*
* @brief   This function does specific initialization of PCL UDB needed for BFD
...
/**
* @internal gtAppDemoOamPclInitCfm function
* @endinternal
*
* @brief   This function does specific initialization of PCL UDB needed for CFM packet
...
/**
* @internal gtAppDemoOamPclInitCfmMplsTp function
* @endinternal
*
* @brief   This function does specific initialization of PCL UDB needed for MPLS-TP
...
/**
* @internal gtAppDemoOamEPclInitCfm function
* @endinternal
*
* @brief   This function does specific initialization of Egress PCL UDB needed for
...
/**
* @internal gtAppDemoOamPclInitLmData function
* @endinternal
*
* @brief   This function does specific initialization of Ingress and Egress PCL UDB
...
/**
* @internal gtAppDemoOamHwInitGen function
* @endinternal
*
* @brief   This function does generic initialization of OAM engine for all OAM packets.
...
* @param[in] agingDaemonEnable        - enable aging daemon.
* @param[in] upMep                    - Up MEP flow type.
*
* @retval GT_OK                    - on success,
* @retval GT_FAIL                  - otherwise.
*
* @note when the aging period is set to 5/6 ms and the aging Threshold is set to 14
*       it is possible to have an exception every 3.5 times for a transmission
*       period of 3.3 ms,  5/614 = 11 2/3 = 3.33.5
*
*/
...
/**
* @internal gtAppDemoOamHwInitCcm function
* @endinternal
*
* @brief   This function does specific initialization of OAM engine for CCM packets.
...
/**
* @internal gtAppDemoOamHwInitUpMepCcm function
* @endinternal
*
* @brief   This function does specific initialization of OAM engine for CCM Up MEPs.
...
/**
* @internal gtAppDemoOamHwInitLm function
* @endinternal
*
* @brief   This function does specific initialization of Ingress and Egress OAM
...
/**
* @internal gtAppDemoOamHwInitDm function
* @endinternal
*
* @brief   This function does specific initialization of Ingress and Egress OAM
...
/**
* @internal gtAppDemoOamHwInitLb function
* @endinternal
*
* @brief   This function does specific initialization of OAM engine for CCM packets.
*         CCM opcode packet command is set to trap to CPU and statistical rate
...
/**
* @internal gtAppDemoOamExceptionConfigInit function
* @endinternal
*
* @brief   This function does generic initialization of OAM Exceptions.
...
/**
* @internal gtAppDemoOamEntrySetCcm function
* @endinternal
*
* @brief   Set OAM Entry configuration for CCM flows.
...
* @param[in] flowId                   - The OAM flow ID (APPLICABLE RANGES: 1..2047)
*                                      0 is reserverd.
* @param[in] enableEntry              - enable or disable keepalive processing
* @param[in] megLevel                 - Determines the MEG level of the current MEP
*                                      (APPLICABLE RANGES: 0..7)
* @param[in] portNum                  - The Source port number
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamEntrySetUpMepCcm function
* @endinternal
*
* @brief   Set OAM Entry configuration for Up MEP CCM flows.
...
* @retval GT_FAIL                  - otherwise.
*
* @note when the aging period is set to 5/6 ms and the aging Threshold is set to
...
/**
* @internal gtAppDemoOamEntrySetLm function
* @endinternal
*
* @brief   Set OAM Entry configuration for LM flows.
...
* @param[in] portNum                  - The Source port number
* @param[in] stage                    - OAM  type.
* @param[in] oamPtpOffsetIndex        - An index to the OAM Offset Table.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamEntrySetDm function
* @endinternal
*
* @brief   Set OAM Entry configuration for DM flows.
*         The functions updates the entry with meg Level Check, source Interface
...
/**
* @internal gtAppDemoOamEntrySetLb function
* @endinternal
*
* @brief   Set OAM Entry configuration for LM flows.
*         The functions updates the entry with meg Level Check, source Interface
...
/**
* @internal gtAppDemoOamEntrySetBfd function
* @endinternal
*
* @brief   Set OAM Entry configuration for BFD flows.
...
/**
* @internal gtAppDemoOamPclRuleCfmFlow function
* @endinternal
*
* @brief   Set OAM CFM (L2) per flow Ingress PCL rule.
...
)
{
    ...
    for(devNum=0; devNum<appDemoPpConfigDevAmount; devNum++)
    {
        rc = cpssDxChPclRuleSet(devNum, 0/*tcamIndex*/, ruleFormat, ruleIndex, 0,
                                &mask, &pattern, &action);
...
/**
* @internal gtAppDemoOamPclRuleUpMepCfmFlow function
* @endinternal
*
* @brief   Set OAM CFM (L2) per Up MEP flow Ingress and Egress PCL rule.
*         The functions sets a 20B UDB rule format with the following key:
*         PCL-ID         = 0x0, UDB[0-1]
...
)
{
    ...
    action.egressPolicy = CPSS_PCL_DIRECTION_EGRESS_E;
    for(devNum=0; devNum<appDemoPpConfigDevAmount; devNum++)
    {
        rc = cpssDxChPclRuleSet(devNum, 0/*tcamIndex*/, ruleFormat, ruleIndex, 0,
                                &mask, &pattern, &action);
...
/**
* @internal gtAppDemoOamEPclRuleCfmFlow function
* @endinternal
*
* @brief   Set OAM CFM (L2) per flow Egress PCL rule.
*         The functions sets a 20B UDB rule format with the following key:
*         PCL-ID         = 0x0, UDB[0-1]
*         Destination MAC     = 00:00:00:00:00:01, UDB[2-7]
...
* @param[in] flowId                   - The OAM flow ID (APPLICABLE RANGES: 1..2047)
*                                      0 is reserverd.
* @param[in] dstMacAddr               - the end of destination mac: 00:00:00:00:00:XX.
* @param[in] srcMacAddr               - the end of source mac: 00:00:00:00:00:XX.
*
* @retval GT_OK                    - on success
* @retval GT_OUT_OF_RANGE          - one of the parameters is out of range
* @retval GT_FAIL                  - otherwise.
...
/**
* @internal gtAppDemoOamPclRuleCfmMplsTpFlow function
* @endinternal
*
* @brief   Set OAM CFM MPLS-TP per flow Ingress PCL rule.
...
* @param[in] flowId                   - The OAM flow ID (APPLICABLE RANGES: 1..2047)
*                                      0 is reserverd.
* @param[in] mplsLable0               - The MPLS lable 0 (transport lable).
*
* @retval GT_OK                    - on success
* @retval GT_OUT_OF_RANGE          - one of the parameters is out of range
* @retval GT_FAIL                  - otherwise.
...
/**
* @internal gtAppDemoOamPclRuleLmData function
* @endinternal
*
* @brief   Set OAM LM DATA flow PCL rule according to direction, for policer
*         billing counting.
*         The functions sets a 20B UDB rule format with the following key:
...
)
{
    ...
    if(direction != CPSS_PCL_DIRECTION_EGRESS_E) /* ingress pcl */
    {
        ruleFormat = CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_20_E;
    ...
    for(devNum=0; devNum < appDemoPpConfigDevAmount; devNum++)
    {
        rc = cpssDxChPclRuleSet(devNum, 0/*tcamIndex*/, ruleFormat, ruleIndex,
...
/**
* @internal gtAppDemoOamPclRuleBfdIpv4MplsLspFlow function
* @endinternal
*
* @brief   Set OAM BFD IPv4 MPLS per flow PCL rule.
...
* @param[in] flowId                   - The OAM flow ID (APPLICABLE RANGES: 1..2047)
*                                      0 is reserverd.
* @param[in] ipAddrThirdByte          - The 3rd byte source IP address (192.168.XXX.001).
* @param[in] ipAddrLastByte           - The last byte source IP address (192.168.001.XXX).
*
* @retval GT_OK                    - on success
* @retval GT_OUT_OF_RANGE          - one of the parameters is out of range
* @retval GT_FAIL                  - otherwise.
...
/**
* @internal gtAppDemoOamPclRuleBfdMplsTpFlow function
* @endinternal
*
* @brief   Set OAM BFD MPLS-TP per flow PCL rule.
...
/**
* @internal gtAppDemoOamPclRuleBfdIpv4Flow function
* @endinternal
*
* @brief   Set OAM BFD IPv4 per flow PCL rule.
...
* @param[in] flowId                   - The OAM flow ID (APPLICABLE RANGES: 1..2047)
*                                      0 is reserverd.
* @param[in] srcIpAddrThirdByte       - The 3rd byte source IP address (192.168.XXX.001).
* @param[in] srcIpAddrLastByte        - The last byte source IP address (192.168.001.XXX).
*
* @retval GT_OK                    - on success
* @retval GT_OUT_OF_RANGE          - one of the parameters is out of range
* @retval GT_FAIL                  - otherwise.
...
/**
* @internal gtAppDemoOamPclRuleBfdIpv4 function
* @endinternal
*
* @brief   Set PCL rule to indentify OAM BFD IPv4 UDP packets according to RFC 5881.
...
/**
* @internal gtAppDemoOamTtiRuleBfdIpv4MplsLsp function
* @endinternal
*
* @brief   Set TTI rule to indentify OAM BFD IPv4 MPLS packets according to RFC 5884.
*         The functions sets a 20B UDB ingress rule format with the following
*         key:
...
)
{
    ...
    CPSS_DXCH_TTI_ACTION_STC            action; /* rule action */
    ...
    /*Set Pattern */
    pattern.udbArray.udb[2] = 0x00; /* mpls.label0 */
    pattern.udbArray.udb[3] = 0x05;
    pattern.udbArray.udb[4] = 0x50; /* S0 = 0 */
    pattern.udbArray.udb[5] = 0x01; /* S1 = 1 */
    pattern.udbArray.udb[6] = 0x0;  /* 0 = IPv4 (ms nibble = 0x4) */
    pattern.udbArray.udb[7] = 0x1;  /* IPv4 TTL */
    pattern.udbArray.udb[8] = 0x11; /* IP Protocol = 17 (UDP) */
    pattern.udbArray.udb[9] = 0x0E; /* Destination UDP port*/
    pattern.udbArray.udb[10] = 0xC8;
    /* Set Mask */
    mask.udbArray.udb[0] = 0x1F;    /* PCL-ID [4:0] in metadata */
    mask.udbArray.udb[1] = 0x1F;    /* PCL-ID [9:5] in metadata */
    mask.udbArray.udb[2] = 0xFF;    /* Label0 */
    mask.udbArray.udb[3] = 0xFF;    /* Label0 */
    mask.udbArray.udb[4] = 0xF1;    /* Label0 , S0*/
    mask.udbArray.udb[5] = 0x01;    /* S1 */
    mask.udbArray.udb[6] = 0x03;    /* Protocol after mpls in metadata*/
    mask.udbArray.udb[7] = 0xFF;    /* IPv4 TTL */
    mask.udbArray.udb[8] = 0xFF;    /* IP Protocol */
    mask.udbArray.udb[9] = 0xFF;    /* Destination UDP port*/
    mask.udbArray.udb[10] = 0xFF;   /* Destination UDP port*/
    /* Set Action */
    ...
    action.pcl0OverrideConfigIndex = CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E;
    action.iPclConfigIndex = 0x000;
    action.iPclUdbConfigTableEnable = GT_TRUE;
    /* override PCL UDB configuration */
    action.iPclUdbConfigTableIndex = CPSS_DXCH_PCL_PACKET_TYPE_UDE1_E;
    /* parsing with override PCL UDB is not currently possible, see Bugs00148646 */
    /* Parse Passenger as IP Only
    action.passengerParsingOfTransitMplsTunnelMode = CPSS_DXCH_TTI_PASSENGER_PARSING_OF_TRANSIT_MPLS_TUNNEL_MODE_AS_IP_E; */
    ...
    for(devNum=0; devNum < appDemoPpConfigDevAmount; devNum++)
    {
        ...
        pattern.udbArray.udb[0] = mplsPclId & 0xFF;
        pattern.udbArray.udb[1] = (mplsPclId & 0x300) >> 0x8;
...
/**
* @internal gtAppDemoOamTtiRuleBfdMplsTp function
* @endinternal
*
* @brief   Set TTI rule to indentify BFD MPLS-TP packets.
...
)
{
    ...
    action.iPclUdbConfigTableEnable = GT_TRUE;
    /* override PCL UDB configuration */
    action.iPclUdbConfigTableIndex = CPSS_DXCH_PCL_PACKET_TYPE_UDE2_E;
...
/**
* @internal gtAppDemoOamTtiRuleCfmMplsTp function
* @endinternal
*
* @brief   Set TTI rule to indentify OAM CFM MPLS-TP packets.
*         The functions sets a TTI MPLS ingress rule format with the following
*         key:
*         PCL-ID        = the value that was initially set by appDemo.
*         reservedLabelExist  = GT_TRUE.
...
)
{
    ...
    action.iPclUdbConfigTableEnable = GT_TRUE;
    /* override PCL UDB configuration */
    action.iPclUdbConfigTableIndex = CPSS_DXCH_PCL_PACKET_TYPE_UDE3_E;
...
/**
* @internal gtAppDemoOamPclDisableRule function
* @endinternal
*
* @brief   This function disables PCL rule.
*
* @param[in] ruleIndex                - the PCL rule index which be disabled
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
)
{
    ...
    for(devNum=0; devNum < appDemoPpConfigDevAmount; devNum++)
    {
        rc = cpssDxChPclRuleInvalidate(devNum, 0/*tcamIndex*/, ruleSize, ruleIndex);
...
/**
* @internal gtAppDemoOamHashInitGen function
* @endinternal
*
* @brief   This function does generic initialization of trunk hash engine.
...
/**
* @internal gtAppDemoOamHashInitBfdIpv4 function
* @endinternal
*
* @brief   This function does specific initialization of trunk hash engine
...
GT_STATUS gtAppDemoOamHashInitBfdIpv4(GT_VOID)
{
    ...
    for(devNum=0; devNum < appDemoPpConfigDevAmount; devNum++)
    {
        ...
        rc = cpssDxChTrunkHashMaskCrcEntrySet(devNum, 0/*hashIndex*/,
...
/**
* @internal gtAppDemoOamHashInitBfdIpv4MplsLsp function
* @endinternal
*
* @brief   This function does specific initialization of trunk hash engine
...
/**
* @internal gtAppDemoOamHashInitBfdMplsTp function
* @endinternal
*
* @brief   This function does specific initialization of trunk hash engine
...
/**
* @internal gtAppDemoOamHashInitCfm function
* @endinternal
*
* @brief   This function does specific initialization of trunk hash engine
...
/**
* @internal gtAppDemoOamHashInitCfmMplsTp function
* @endinternal
*
* @brief   This function does specific initialization of trunk hash engine
...
#ifdef ASIC_SIMULATION
/**
* @internal prvAppDemoOamCbFunc function
* @endinternal
*
* @brief   This function is a call back for trapped RX packets.
...
* @param[in] queueIdx                 - received Rx SDMA queue.
* @param[in] numOfBuff                - number of received buffers.
* @param[in] packetBuffs[]            - Array of packet buffers.
* @param[in] buffLen[]                - Array of buffers length.
* @param[in] rxParamsPtr              - net RX parameters (DSA tag).
*
* @retval GT_OK                    - on success,
* @retval GT_FAIL                  - otherwise.
*/
...
#endif
/**
* @internal gtAppDemoOamSdmaTxGeneratorEnable function
* @endinternal
*
* @brief   This function enables the Tx queue defined by
...
/**
* @internal gtAppDemoOamSdmaTxGeneratorDisable function
* @endinternal
*
* @brief   This function disables the Tx queue defined by
*         GT_APP_DEMO_OAM_SDMA_TX_GENERATOR_Q_CNS.
*
* @retval GT_OK                    - on success,
* @retval GT_FAIL                  - otherwise.
...
/**
* @internal gtAppDemoOamSdmaTxGeneratorRateSet function
* @endinternal
*
* @brief   This function configures the Tx queue defined by
...
* @retval GT_FAIL                  - otherwise.
*
* @note in ASIC_SIMULATION the rate is 1s
*
*/
...
/**
* @internal gtAppDemoOamSdmaTxGeneratorPacketAdd function
* @endinternal
*
* @brief   This function Adds a packet to the Tx queue defined by
*         GT_APP_DEMO_OAM_SDMA_TX_GENERATOR_Q_CNS, the packet is sent through
*         interface port type to port given by dstPortNum.
* @param[in] packetDataPtr            - pointer to the packet data.
* @param[in] packetDataLength         - the packet data lenght in bytes.
...
/**
* @internal gtAppDemoOamSdmaTxGeneratorPacketRemove function
* @endinternal
*
* @brief   This function removes a packet from the Tx queue defined by
*         GT_APP_DEMO_OAM_SDMA_TX_GENERATOR_Q_CNS, the packet is removed
*         according to packetId.
* @param[in] packetId                 - packet identification number.
*
* @retval GT_OK                    - on success,
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamSdmaTxPacketSend function
* @endinternal
*
...
/**
* @internal gtAppDemoOamBillingCountingModeSet function
* @endinternal
*
* @brief   Set policers memory control mode, init each of the stages to
...
GT_STATUS gtAppDemoOamBillingCountingModeSet(GT_VOID)
{
    ...
    for(devNum=0; devNum < appDemoPpConfigDevAmount; devNum++)
    {
        ...
        rc = cpssDxChPolicerMemorySizeModeSet(devNum, CPSS_DXCH_POLICER_MEMORY_CTRL_MODE_1_E,0,0);
...
/**
* @internal gtAppDemoOamBillingEntrySet function
* @endinternal
*
* @brief   Set Policer Billing Entry configuration for LM counting.
*         The entry is set to count packets and to insert mode for LM
*         counter capture
* @param[in] flowId                   - The OAM flow ID (APPLICABLE RANGES: 1..2047)
*                                      0 is reserverd.
* @param[in] stage                    - policer  type.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamBfdInit function
* @endinternal
*
* @brief   This function does general initialization of PCL, TTI and OAM engines.
...
/**
* @internal gtAppDemoOamBfdIpv4RxFlowSet function
* @endinternal
*
* @brief   Set OAM BFD IPv4 Rx flow.
*         The function configs a PCL rule and OAM entry accroding to the flow ID
*         and two last bytes of source IP address.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
* @param[in] srcIpAddrThirdByte       - The 3rd byte source IP address (192.168.XXX.001).
* @param[in] srcIpAddrLastByte        - The last byte source IP address (192.168.001.XXX).
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamBfdIpv4MplsLspRxFlowSet function
* @endinternal
*
* @brief   Set OAM BFD IPv4 MPLS Rx flow.
*         The function configs a PCL rule and OAM entry accroding to the flow ID
*         and two last bytes of source IP address.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
* @param[in] srcIpAddrThirdByte       - The 3rd byte source IP address (192.168.XXX.001).
...
/**
* @internal gtAppDemoOamBfdIpv4RxFlowDel function
* @endinternal
*
* @brief   Disable OAM BFD IPv4 Rx flow.
...
/**
* @internal gtAppDemoOamBfdIpv4MplsLspRxFlowDel function
* @endinternal
*
* @brief   Disable OAM BFD IPv4 MPLS Rx flow.
*         The function diasbles a PCL rule and OAM entry accroding to the flow ID.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamBfdIpv4TxFlowSet function
* @endinternal
*
* @brief   Set OAM BFD IPv4 Tx flow.
...
/**
* @internal gtAppDemoOamBfdIpv4TxFlowDel function
* @endinternal
*
* @brief   Remove OAM BFD IPv4 Tx flow.
 ...
 ******************************************************************************/
/**
* @internal gtAppDemoOamBfdMplsTpInit function
* @endinternal
*
* @brief   This function does general initialization of PCL, TTI and OAM engines.
*         cpssInitSystem() must be called before calling this function for CPSS
...
/**
* @internal gtAppDemoOamBfdMplsTpRxFlowSet function
* @endinternal
*
* @brief   Set OAM BFD MPLS-TP Rx flow.
*         The function configs a PCL rule and OAM entry accroding to the flow ID.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamKeepAliveExceptionGet function
* @endinternal
*
* @brief   Display OAM keepalive exception status and counter.
...
/**
* @internal gtAppDemoOamHashExceptionGet function
* @endinternal
*
* @brief   Display OAM hash exception status and counter.
*         The status is of a specific flow.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamCcmInit function
* @endinternal
*
* @brief   This function does general initialization of PCL and OAM engines.
...
/**
* @internal gtAppDemoOamCcmRxFlowSet function
* @endinternal
*
* @brief   Set OAM CCM Rx flow.
*         The function configs a PCL rule and OAM entry accroding to the flow ID,
...
/**
* @internal gtAppDemoOamCcmFlowDel function
* @endinternal
*
* @brief   Disable OAM CCM flow.
*         The function diasbles a PCL rule and OAM entry accroding to the flow ID.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamUpMepCcmInit function
* @endinternal
*
* @brief   This function does general initialization of PCL and OAM engines.
*         cpssInitSystem() must be called before caling this function for CPSS
...
/**
* @internal gtAppDemoOamUpMepCcmRxFlowSet function
* @endinternal
*
* @brief   Set OAM Up MEP CCM Rx flow.
*         The function configs a PCL rule and OAM entry accroding to the flow ID,
*         meg level and source port number.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
* @param[in] megLevel                 - Determines the MEG level of the current MEP
...
/**
* @internal gtAppDemoOamUpMepCcmFlowDel function
* @endinternal
*
* @brief   Disable OAM CCM flow.
*         The function diasbles a PCL rule and OAM entry accroding to the flow ID.
 ...
 ******************************************************************************/
/**
* @internal gtAppDemoOamCcmMplsTpInit function
* @endinternal
*
* @brief   This function does general initialization of PCL, TTI and OAM engines.
*         cpssInitSystem() must be called before calling this function for CPSS
...
/**
* @internal gtAppDemoOamCcmMplsTpRxFlowSet function
* @endinternal
*
* @brief   Set OAM CCM MPLS-TP Rx flow.
*         The function configs a PCL rule and OAM entry accroding to the flow ID,
*         meg level and source port number.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
* @param[in] megLevel                 - Determines the MEG level of the current MEP
 ...
 ******************************************************************************/
/**
* @internal gtAppDemoOamLmInit function
* @endinternal
*
* @brief   This function does general initialization of PCL, Policer and OAM engines.
*         cpssInitSystem() must be called before caling this function for CPSS
*         initialization for BOBCAT2 device.
*
* @retval GT_OK                    - on success,
...
/**
* @internal gtAppDemoOamLmRxFlowSet function
* @endinternal
*
* @brief   Set OAM LM Rx flow support.
*         The function configs a PCL rule and OAM entry accroding to the flow ID
...
* @param[in] megLevel                 - Determines the MEG level of the current MEP
*                                      (APPLICABLE RANGES: 0..7)
* @param[in] cfmPortNum               - The Source port number for the LMM/LMR frames.
* @param[in] dataPortNum              - The Source port number the data frames.
* @param[in] srcMacAddr                  - the end of source mac: 00:00:00:00:00:XX.
* @param[in] dataSrcMacAddr           - the end of src mac: 00:00:00:00:00:XX for data pcl rule.
* @param[in] vlanId                         - vlanId of a packet.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamLmTxFlowSet function
* @endinternal
*
* @brief   Set OAM LM Tx flow support.
*         The function configs a PCL rule and OAM entry accroding to the flow ID
...
* @param[in] megLevel                 - Determines the MEG level of the current MEP
*                                      (APPLICABLE RANGES: 0..7)
* @param[in] dataPortNum             -  port number for data packets
* @param[in] dstMacAddr               - the end of destination mac: 00:00:00:00:00:XX fot LM packet.
* @param[in] srcMacAddr               - the end of source mac: 00:00:00:00:00:XX fot LM packet.
* @param[in] dataSrcMacAddr          -  the end of src mac: 00:00:00:00:00:XX for data packet/pcl rule.
* @param[in] vlanId                   - vlanId of a packet.
* @param[in] cfmPortNum               - source port number.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamLmTxFlowSend function
* @endinternal
*
* @brief   This function sends a single LMM or starts tramsmiting continuously,
...
/**
* @internal gtAppDemoOamLmDualEndedRxFlowSet function
* @endinternal
*
* @brief   Set OAM LM Rx flow support.
*         The function configs a PCL rule and OAM entry accroding to the flow ID
...
/**
* @internal gtAppDemoOamLmDualEndedTxFlowSet function
* @endinternal
*
* @brief   Set OAM LM Tx flow support.
*         The function configs a PCL rule and OAM entry accroding to the flow ID
...
/**
* @internal gtAppDemoOamLmDualEndedTxFlowSend function
* @endinternal
*
* @brief   This function sends a single LMM or starts tramsmiting continuously,
*         according to generatorEnable.
...
/**
* @internal gtAppDemoOamLmRxFlowGet function
* @endinternal
*
* @brief   Get OAM LM rx flow configuration from the OAM service CPU.
*
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamLmStatCntrGet function
* @endinternal
*
* @brief   Get OAM LM Rx flow statistical counters from the OAM service CPU.
*
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
* @param[in] clrOnRead                - enable counter clear
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamLmStatCntrClr function
* @endinternal
*
* @brief   Clear OAM LM Rx flow statistical counters at the OAM service CPU.
*
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
 ...
 ******************************************************************************/
/**
* @internal gtAppDemoOamDmInit function
* @endinternal
*
* @brief   This function does general initialization of PCL, Policer and OAM engines.
*         cpssInitSystem() must be called before caling this function for CPSS
...
/**
* @internal gtAppDemoOamDmRxFlowSet function
* @endinternal
*
* @brief   Set OAM DM Rx flow support.
*         The function configs a PCL rule and OAM entry accroding to the flow ID
...
/**
* @internal gtAppDemoOamDmTxFlowSet function
* @endinternal
*
* @brief   Set OAM DM Tx flow support.
*         The function configs a PCL rule and OAM entry accroding to the flow ID
...
/**
* @internal gtAppDemoOamDmTxFlowSend function
* @endinternal
*
* @brief   This function sends a single DWMM or starts tramsmiting continuously,
*         according to generatorEnable.
*         The packets are sent with the following paramaters:
*         dst MAC       = 00:00:00:00:00:01
*         src MAC       = 00:00:00:00:00:02
...
/**
* @internal gtAppDemoOamDmRxFlowGet function
* @endinternal
*
* @brief   Get OAM DM rx flow configuration from the OAM service CPU.
*
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamDmStatCntrGet function
* @endinternal
*
* @brief   Get OAM DM Rx flow statistical counters from the OAM service CPU.
*
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
* @param[in] clrOnRead                - enable counter clear
*
...
/**
* @internal gtAppDemoOamDmStatCntrClr function
* @endinternal
*
* @brief   Clear OAM DM Rx flow statistical counters at the OAM service CPU.
*
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
 ...
 ******************************************************************************/
/**
* @internal gtAppDemoOamLbInit function
* @endinternal
*
* @brief   This function does general initialization of PCL, OAM engines and OAM service CPU.
*         cpssInitSystem() must be called before caling this function for CPSS
*         initialization for BOBCAT2 device.
*
* @retval GT_OK                    - on success,
...
/**
* @internal gtAppDemoOamLbRxFlowSet function
* @endinternal
*
* @brief   Set OAM Loopback Rx flow.
*         The function configs a PCL rule and OAM entry accroding to the flow ID,
*         meg level and source port number.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
* @param[in] megLevel                 - Determines the MEG level of the current MEP
*                                      (APPLICABLE RANGES: 0..7)
* @param[in] portNum                  - The Source port number
* @param[in] outOfSequenceEnable      - enable out of sequence check
* @param[in] invalidTlvEnable         - enable invalid TLV check
* @param[in] tlvDataCrc32Val          - data TLV CRC32 value, relevant only if
* @param[in] invalidTlvEnable         is TRUE
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamLbRxFlowGet function
* @endinternal
*
* @brief   Get OAM Loopback Rx flow configuration from the OAM service CPU.
*
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamLbStatCntrGet function
* @endinternal
*
* @brief   Get OAM Loopback Rx flow statistical counters from the OAM service CPU.
*
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
* @param[in] clrOnRead                - enable counter clear
*
...
/**
* @internal gtAppDemoOamLbStatCntrClr function
* @endinternal
*
* @brief   Clear OAM Loopback Rx flow statistical counters at the OAM service CPU.
*
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamExceptionGet function
* @endinternal
*
* @brief   Display OAM exceptions status and counter.
*         The status is of a specific flow.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
*
* @retval GT_OK                    - on success
...
/**
* @internal gtAppDemoOamPolicerGet function
* @endinternal
*
* @brief   Display policer green counter.
*         The status is of a specific flow.
* @param[in] flowId                   - The flow ID (APPLICABLE RANGES: 1..2047)
* @param[in] reset                    -  the counter values
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamLocalMacAddressSet function
* @endinternal
*
* @brief   Globally configure the MAC address table in the firmware.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamLocalMacAddressGet function
* @endinternal
*
* @brief   Get the MAC address table from the firmware.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamLocalInterfaceMacIndexSet function
* @endinternal
*
* @brief   Configures the MAC address index for some local interface
*
* @param[in] portNum                  - 0-27 or (for eport) 0-8k
* @param[in] isPhysicalPort           - for eport ==0. for regular port ==1.
* @param[in] macAddIndex              - 0-127 (index to table configured here- gtAppDemoOamLocalMacAddressSet)
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamLocalInterfaceMacIndexGet function
* @endinternal
*
* @brief   Get the MAC address index for some local interface
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamRxFlowEntryParamsSet function
* @endinternal
*
* @brief   Configures parameters for rx flow
*
* @param[in] flowId                   - flowId
* @param[in] mpType                   - 0-upMep, 1-downMep
* @param[in] cfmOffset                - Represent the beginning of CFM payload in the received OAM frame (0-127)
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal gtAppDemoOamRxFlowEntryParamsGet function
* @endinternal
*
* @brief   Get the rx flow generic parameters
*
* @param[in] flowId
*
* @retval GT_OK                    - on success

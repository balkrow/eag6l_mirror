...
/* Times of stagest of first cpssInitSystem */
PRV_APPDEMO_FIRST_INIT_TIMES_STC prvAppDemoFirstInitTimes = {0,0,0,0,0,0,0};
...
)
{
    ...
    result = ((seconds * 1000) + (nanoSec / 1000000));
    if (result == 0)
    {
        /* never return 0 - used also as stamp */
        result = 1;
    }

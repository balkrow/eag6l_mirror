...
#define DEVICE_ID_88x3240 0x3240
#define DEVICE_ID_88x3340 0x3340
...
#define MTD_SPEED_2P5GIG_FD    0x0800 /* 2.5GBASE-T full-duplex, 88X33X0 family only*/
#define MTD_SPEED_5GIG_FD      0x1000 /* 5GBASE-T full-duplex, 88X33X0 family only */

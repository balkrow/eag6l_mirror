...
#define MYD_NIMB_EYE_DEFAULT 0
#define MYD_NIMB_EYE_UPDATE  1
/*******************************************************************************
...
(
 ...
 Inputs:
    ...
    maxEyeDeltaLine - 
    maxEyeDeltaHost - 
    eyeCoeffOptions - MYD_NIMB_EYE_DEFAULT=0; MYD_NIMB_EYE_UPDATE=1
       if MYD_NIMB_EYE_DEFAULT, the min and max Eye fields will not be used
 ...
 Description:
    This function accesses NIMB register to set the min/max to trigger 
    the iCal calibration. These values need to be set before calling mydNIMBSetICal
 ...
 Notes/Warnings:
    ...
    Refer to the mydSampleNIMBSetICal sample API on using this usage
*******************************************************************************/
MYD_STATUS mydNIMBSetEyeCoeff
(
    IN MYD_DEV_PTR pDev,
...
(
 ...
 Inputs:
    ...
    mdioPort - MDIO port address, 0-31
    laneOffset - 0..3 for lanes 0-3
    iCalNIMBOption - 0 = stop AutoCal; non-0 = start
 ...
 Description:
    This function accesses NIMB register to start/stop the iCal polling and 
    calibration. The minEyeVal and maxEyeVal values need to be set in mydNIMBSetEyeCoeff
    before starting the auto calibration.
 ...
 Notes/Warnings:
    ...
    The mydNIMBSetICal must be stopped when calling API that issues 
...
(
 ...
 Outputs:
    iCalNIMBStatus - 1 = auto iCal running; 0 = stop
 ...
 Description:
    This function accesses NIMB register for the auto iCal calibration status 

...
/* Kernel driver for Intel CPUs is not ready for big DMA allocations.
   Reduce DMA allocations for Intel based CPUs */
#ifdef INTEL64_CPU
/* Number of AUQ descriptors for Falcon devices */
#define FALCON_AU_DESC_NUM_SIP6_DEF  3072
/* Number of FUQ descriptors for Falcon and AUQ descriptors for SIP6_10 devices and above */
#define AU_DESC_NUM_SIP6_DEF    2048
#else
/* Number of AUQ descriptors for Falcon devices */
#define FALCON_AU_DESC_NUM_SIP6_DEF  32768
/* Number of FUQ descriptors for Falcon and AUQ descriptors for SIP6_10 devices and above */
#define AU_DESC_NUM_SIP6_DEF    12288
#endif /* INTEL64_CPU */
...
{                                                                              \
    ...
    GT_FALSE                                                 /* assignSmallBankToOctet0 */ \
}
...
{                                                                    \
    ...
    GT_TRUE,                        /* treatIpv4ClassEasNonRegularUc */  \

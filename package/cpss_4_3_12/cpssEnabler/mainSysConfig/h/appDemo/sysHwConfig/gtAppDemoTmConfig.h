...
* @endinternal
*
* @brief   Implements scenario 7 initialization for specific device.
*         In this scenario there are shapers for every (S-VLAN,C-VLAN) pair
* @param[in] dev                      -   device number
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise
...
*         In this scenario there are shapers for every (VLAN,TC) pair
* @param[in] dev                      -   device number
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise
...
* @endinternal
*
* @brief   Implements scenario for BIST test on TM DRAM.
* @param[in] dev                      -   device number
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - otherwise

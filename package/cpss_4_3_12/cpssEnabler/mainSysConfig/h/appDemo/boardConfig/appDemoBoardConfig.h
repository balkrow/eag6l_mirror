...
/**
* @enum APP_DEMO_HW_PP_TRACING_ADDR_ADD_MODE_ENT
 *
 * @brief Types of register address add modes
*/
typedef enum
{
    /** Adding filters overriding previous */
    APP_DEMO_HW_PP_TRACING_ADDR_ADD_MODE_OVERRIDE_E,
    /** Adding filters append */
    APP_DEMO_HW_PP_TRACING_ADDR_ADD_MODE_APPEND_E,

} APP_DEMO_HW_PP_TRACING_ADDR_ADD_MODE_ENT;
...
/* Terminate all device specific tasks */
...
/** @struct APP_DEMO_REG_PRINT_FIELD_STC
*
*   @brief Structure describes field inside register.
*
*/
typedef struct {
    /** Field start bit */
    ...
    /** Field len in bits - 0 as end of array mark */
    GT_U8 length;

    /** Field format: 0 - %d, 1 - 0x%X */
    GT_U8 hexPrint;

    /** Field name - NULL as end of array mark */
    const char* name;
} APP_DEMO_REG_PRINT_FIELD_STC;

/** @struct APP_DEMO_REG_PRINT_DATA_STC
*
*   @brief Structure describes register contents.
*
*/
typedef struct {
    /** Register address base offset from unit base */
    GT_U32 addrBaseOffset;
    ...
    /** Register name - NULL as end of array mark*/
    const char* name;

    /** Fields descriptions array pointer - NULL to print all 32 bits */
    const APP_DEMO_REG_PRINT_FIELD_STC *fieldsArrPtr;

} APP_DEMO_REG_PRINT_DATA_STC;

/** @struct APP_DEMO_REG_PRINT_UNIT_STC
*
*   @brief Structure describes register list of unit.
*
*/
typedef struct {
    /** unit Ids array pointer */
    const PRV_CPSS_DXCH_UNIT_ENT  *prvUnitIdArrPtr;

    /** Unit name */
    const char* name;

    /** Register description - NULL as end of array mark */
    const APP_DEMO_REG_PRINT_DATA_STC *registersArrPtr;

} APP_DEMO_REG_PRINT_UNIT_STC;

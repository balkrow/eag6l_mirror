...
)
{
    ...
    *isInitDonePtr = GT_FALSE;
    ...
    phy_entry.transceiverType   = (GT_U32)ezbPpConfigPtr->macGenInfoPtr[macPort].transceiverType;
...
)
{
    ...
    if(operPtr->do_anEnable)
    {
        ...
        operPtr->anEnable       = (opParams.phyAutoneg.enable == MPD_AUTO_NEGOTIATION_ENABLE_E)? GT_TRUE:GT_FALSE;

...
CPSS_OS_STR_N_CMP_FUNC   cmdOsStrNCmp                                                = (CPSS_OS_STR_N_CMP_FUNC) extServiceFuncNotImplementedCalled;
...
)
{
    ...
    SET_NON_NULL(cmdOsStrNCmp                        , cmdOsFuncBind.osStrBindInfo.osStrNCmpFunc            );

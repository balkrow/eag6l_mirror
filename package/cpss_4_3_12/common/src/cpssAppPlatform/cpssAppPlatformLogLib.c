...
)
{
       if (module < CPSS_APP_PLATFORM_LOG_MODULE_LAST_E)
           PRV_APP_REF_GLOBAL_LOG_DB[module] = trace_mask | CPSS_APP_PLATFORM_LOG_LEVEL_PRINT_E;
       else
...
)
{
    ...
    for(i=0;i<CPSS_APP_PLATFORM_LOG_MODULE_LAST_E;i++)
    {
        PRV_APP_REF_GLOBAL_LOG_DB[i]=CPSS_APP_PLATFORM_LOG_LEVEL_ERR_E | CPSS_APP_PLATFORM_LOG_LEVEL_INFO_E | CPSS_APP_PLATFORM_LOG_LEVEL_PRINT_E;
    }
}

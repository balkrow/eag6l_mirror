...
void allocateEnhUtUseCaptureToCpu()
{
    if (NULL != cpssAppUtilsEnhUtUseCaptureToCpuPtrPtr)
    {
        *cpssAppUtilsEnhUtUseCaptureToCpuPtrPtr = (GT_U32*)osMalloc(sizeof(GT_U32)); /* allocated in shared area */
    }
}
#endif
#endif /* IMPL_GALTIS */
...
{
#ifdef IMPL_GALTIS
    if (NULL != cpssAppUtilsTgfCmdCpssNetEnhUtUseCaptureToCpuPtrPtr &&
        NULL != cpssAppUtilsEnhUtUseCaptureToCpuPtrPtr)
    {
        *cpssAppUtilsTgfCmdCpssNetEnhUtUseCaptureToCpuPtrPtr = *cpssAppUtilsEnhUtUseCaptureToCpuPtrPtr;
    }
#endif /* IMPL_GALTIS */
}
#endif /* IMPL_TGF */

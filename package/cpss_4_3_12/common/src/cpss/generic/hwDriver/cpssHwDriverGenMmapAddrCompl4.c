...
GT_VOID cpssHwDriverGenMmapAc4DrvReload
(
    CPSS_HW_DRIVER_STC *drv
)
{
    drv->read = (CPSS_HW_DRIVER_METHOD_READ)prvCpssHwDriverGenMmapAc4Read;
    drv->writeMask =  (CPSS_HW_DRIVER_METHOD_WRITE_MASK)prvCpssHwDriverGenMmapAc4WriteMask;
    drv->destroy = (CPSS_HW_DRIVER_METHOD_DESTROY)prvCpssHwDriverGenMmapAc4DestroyDrv;
}
...
)
{
    ...
    drv->common.adressSpaceType = CPSS_HW_DRIVER_AS_SWITCHING_E;

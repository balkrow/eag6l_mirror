...
)
{
    ...
    {
        /* Harrier supports USX_10G_SXGMII port mode on non USX MAC  */
        return 1;
    }
    return 0;
}
    ...
    *supportedPtr = GT_FALSE;
    ...
    switch(ifMode)
    {
        ...
        case CPSS_PORT_INTERFACE_MODE_SR_LR_E:
            ...
            {
                case CPSS_PORT_SPEED_1000_E:
                    if ( ifMode == CPSS_PORT_INTERFACE_MODE_SR_LR_E )
                    {
                        portMode = _1000Base_SX;
                    }
                    else
...
)
{
    switch (cpssSpeed)
    {
        ...
        case CPSS_PORT_SPEED_11800_E:    return 11800;
        ...
        case CPSS_PORT_SPEED_800G_E:     return 800000;
        default: return 0;
    }
}
...
)
{
    switch (cpssSpeed)
    {
        ...
        case CPSS_PORT_SPEED_800G_E:
            return MV_HWS_PORT_SPEED_800G_E;

...
#define PRV_SHARED_HW_INIT_DIR_HW_INIT_SRC_GLOBAL_VAR_INIT(_var,_value)\
    PRV_SHARED_GLOBAL_VAR_SET(mainPpDrvMod.hwInitDir._var,_value)
...
#define PRV_SHARED_DIAG_DIR_DIAG_BIRST_SIZE_GEN_DIAG_SRC_GLOBAL_VAR_INIT(_var,_value)\
    PRV_SHARED_GLOBAL_VAR_SET(mainPpDrvMod.diagDir._var,_value)
...
)
{
...

    {
        ...
        GT_U32 packetBytesArray[PRV_CPSS_DXCH_LPM_NUM_OF_OCTETS_FOR_GON_IN_IPV6_MC_PROTOCOL_CNS] = {NOT_VALID, NOT_VALID, NOT_VALID, NOT_VALID,
                                                                                                    ...
                                                                                                    NOT_VALID, NOT_VALID, NOT_VALID, NOT_VALID,
                                                                                                    NOT_VALID, NOT_VALID};
        GT_BOOL packetsByteArrayStatus[PRV_CPSS_DXCH_LPM_NUM_OF_OCTETS_FOR_GON_IN_IPV6_MC_PROTOCOL_CNS] = {GT_FALSE, GT_FALSE, GT_FALSE, GT_FALSE,
        ...
        cpssOsMemCpy(
            PRV_SHARED_GLOBAL_VAR_GET(
                mainPpDrvMod.ipLpmDir.lpmRamDbgSrc.packetBytesArray),
                packetBytesArray, sizeof(packetBytesArray)
                   );

         cpssOsMemCpy(
            PRV_SHARED_GLOBAL_VAR_GET(
                mainPpDrvMod.ipLpmDir.lpmRamDbgSrc.packetsByteArrayStatus),
                packetsByteArrayStatus, sizeof(packetsByteArrayStatus)
                   );
...
/**
 * @internal
 *          cpssGlobalSharedDbMainPpDrvModPhyDirMpdSrcDataSectionInit
 *          function
 * @endinternal
 *
 * @brief  Initialize global shared variables used in :
 ...
 *
 */
static GT_VOID cpssGlobalSharedDbMainPpDrvModPhyDirMpdSrcDataSectionInit
(
    GT_VOID
)
{
    prvCpssDxChPhyMpdSharedDbInit (&(PRV_MPD_SHARED_DB));
}
...
/**
 * @internal
 *           cpssGlobalSharedDbMainPpDrvModGenericTmDirDataSectionInit
 *           function
 * @endinternal
 *
 * @brief   Initialize global shared variables used in :
 ...
 *
 */
static GT_VOID cpssGlobalSharedDbMainPpDrvModGenericTmDirDataSectionInit
(
    GT_VOID
)
{
    ...
    /* ArraySize: TM_CONF_MAX_ERROR + 1 */
    GT_STATUS tmToCpssErrCodes[101] = {GT_NOT_INITIALIZED};
    GT_STATUS tmToCpssErrCodesNeg[140] = {GT_NOT_INITIALIZED};

    PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(tmCurrentNum) = 0;
    cpssOsMemCpy(PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(tmLadParamsArr), tmLadParamsArr, sizeof(tmLadParamsArr));
    cpssOsMemCpy(&PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(tmHwParamsBc2), &tmHwParamsBc2, sizeof(tmHwParamsBc2));
    cpssOsMemCpy(&PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(tmHwParamsBobk), &tmHwParamsBobk, sizeof(tmHwParamsBobk));

    PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(tmDbgLogOn) = GT_FALSE;
    cpssOsMemCpy(PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(tmToCpssErrCodes), tmToCpssErrCodes, sizeof(tmToCpssErrCodes));
    cpssOsMemCpy(PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(tmToCpssErrCodesNeg), tmToCpssErrCodesNeg, sizeof(tmToCpssErrCodesNeg));

    PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(bapDramAccessTest) = GT_FALSE;
    PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(bapDramAccessTestRetries) = 0;
    PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(bapDramBaseAddress) = 0;
    /* 1Gbit/2 - 2 Baps per DDR, 8 - to bytes, 16 - data chunck */
    PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(bapDramHighAddress) = (512 * 1024 * 1024) / 2 / 8 / 16;
    /* 1Gbit/2 - 2 Baps per DDR, 8 - to bytes, 16 - data chunck */
...
)
{
    ...
    PRV_SHARED_HW_INIT_DIR_DXCH_HW_INIT_REG_V1_SRC_GLOBAL_VAR_GET(prvDxChAasUnitsIdUnitBaseAddrArr)[0] =
        invalidEntry;
...
#ifndef GM_USED
    /* this feature does not work on GM */
    PRV_SHARED_HW_INIT_DIR_DXCH_HW_INIT_DXCH_HW_INIT_SRC_GLOBAL_VAR_GET(
        force_early_check_for_device_not_reset) = 1;
#endif /*GM_USED*/
}
...
)
{
    ...
    PRV_SHARED_PORT_DIR_PORT_CTRL_SRC_GLOBAL_VAR_INIT(extendedPortDeletedFlag, GT_FALSE);
}
...
)
{
    ...
    {
        CPSS_PORT_INTERFACE_MODE_ENT supportedPortsModes_XG_PORT_XG_HX_QX[9] =
        {
            CPSS_PORT_INTERFACE_MODE_SGMII_E,
            CPSS_PORT_INTERFACE_MODE_XGMII_E,
            ...
            CPSS_PORT_INTERFACE_MODE_1000BASE_SXLX_E,
            CPSS_PORT_INTERFACE_MODE_NA_E
        };
    ...
    {
        CPSS_PORT_INTERFACE_MODE_ENT supportedPortsModes_GE_PORT_GE_ONLY[10] =
        {
    ...
    {
        CPSS_PORT_INTERFACE_MODE_ENT supportedPortsModes_XG_PORT_XLG_SGMII[16] =  /* Lion - sip 5.15*/
        {
            CPSS_PORT_INTERFACE_MODE_SGMII_E,
            CPSS_PORT_INTERFACE_MODE_XGMII_E,
    ...
    {
        CPSS_PORT_INTERFACE_MODE_ENT supportedPortsModes_XG_PORT_CG_SGMII[21] = /* sip 5.20 and above , flex link */
        {
            CPSS_PORT_INTERFACE_MODE_SGMII_E,
            CPSS_PORT_INTERFACE_MODE_XGMII_E,
...
{
    {
        ...
        /* byte 3 */
            ...
            PRV_CPSS_STANDARD_FIELD_MAC(5  ),
            /*SIP7_TTI_LEGACY_KEY_FIELDS_EVLAN_15_13_E,                           */
            PRV_CPSS_STANDARD_FIELD_MAC(3  ),
        /* byte 4 */
...

    {
        ...
        /* byte 37 */
            ...
            PRV_CPSS_STANDARD_FIELD_MAC(7  ),
        /* byte 38 */
            /*TTI_META_DATA_FIELDS_GENERIC_CLASSIFICATION__7_0_E                */
            PRV_CPSS_STANDARD_FIELD_MAC(8  ),
        /* byte 39 */
            /*TTI_META_DATA_FIELDS_GENERIC_CLASSIFICATION__15_8_E               */
            PRV_CPSS_STANDARD_FIELD_MAC(8  )
        };

...
#ifdef CHX_FAMILY
const char * const prvCpssLogEnum_CPSS_HW_PP_SOFT_RESET_OPTIONS_ENT[]  =
{
    "CPSS_HW_PP_RESET_ALL_SKIP_NONE_E",
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_HW_PP_SOFT_RESET_OPTIONS_ENT);
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_PHY_REF_CLK_PU_OE_CFG_ENT[]  =
{PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_PHY_REF_CLK_PU_DISABLE_OE_DISABLE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_PHY_REF_CLK_PU_DISABLE_OE_ENABLE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_PHY_REF_CLK_PU_ENABLE_OE_DISABLE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_PHY_REF_CLK_PU_ENABLE_OE_ENABLE_E)
};
PRV_CPSS_LOG_STC_ENUM_MAP_ARRAY_SIZE_MAC(CPSS_PHY_REF_CLK_PU_OE_CFG_ENT);
const char * const prvCpssLogEnum_CPSS_PP_PHASE2_UPLOAD_QUEUE_TYPE_ENT[]  =
{
    "CPSS_PP_PHASE2_UPLOAD_QUEUE_SHARED_WITH_AUQ_E",
    "CPSS_PP_PHASE2_UPLOAD_QUEUE_SEPARATE_E",
    "CPSS_PP_PHASE2_UPLOAD_QUEUE_SEPARATE_AND_LIMITED_CNC_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_PP_PHASE2_UPLOAD_QUEUE_TYPE_ENT);
...
#ifdef CHX_FAMILY
void prvCpssLogParamFunc_CPSS_HW_PP_SOFT_RESET_OPTIONS_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_HW_PP_SOFT_RESET_OPTIONS_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_HW_PP_SOFT_RESET_OPTIONS_ENT);
}

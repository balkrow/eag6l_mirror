...
)
{
    ...
    GT_U32 regValue, pcsField, markerInterval;
...
/**
* @internal mvHwsMtiPcs50Rev2RxReset function
* @endinternal
*
* @brief   PCS 50 SD RX RESET/UNRESET action.
*
* @param[in] devNum                   - system device number
* @param[in] portGroup                - port group (core) number
* @param[in] portMacNum               - MAC number
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsMtiPcs50Rev2RxReset
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portMacNum,
...
/**
 * @internal mvHwsMtiPcs50Rev2RxResetGet function
 * @endinternal
 *
 ...
 * @return GT_STATUS
 */
static GT_STATUS mvHwsMtiPcs50Rev2RxResetGet
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portMacNum,
...
GT_STATUS mvHwsMtiPcs50Rev2IfInit(MV_HWS_PCS_FUNC_PTRS **funcPtrArray)
{
    ...
    funcPtrArray[MTI_PCS_50]->pcsRxResetFunc   = mvHwsMtiPcs50Rev2RxReset;
    funcPtrArray[MTI_PCS_50]->pcsRxResetGetFunc = mvHwsMtiPcs50Rev2RxResetGet;

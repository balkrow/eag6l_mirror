...
#define PRV_AAPL_SERDES_DB aaplSerdesDb
#endif
...
{_27_5G,                   {AVAGO_TX(   0,   0,   0,   0,   0)},{AVAGO_RX_BASIC(   3,  15,  15,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   3,   7,   0,  15,   0,   5,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    125, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   160,    70)}},
{_26_5625G_PAM4,           {AVAGO_TX(   0,   0,   0,   0,   0)},{AVAGO_RX_BASIC(   8,   6,   6,   0,   2,   3,0x10,   0,   2,   8),AVAGO_RX_ADVANCED(   4,   8,   0,  15,   0,  15,  -8,   5,  -3,  10,  68),AVAGO_RX_MAIN(   0x10,      1,      0,      4,      0, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,  1000, -1000,   500,  -500,   160,   160,   180,   100)}},
{_27_1875_PAM4,            {AVAGO_TX(   0,   0,   0,   0,   0)},{AVAGO_RX_BASIC(   8,   6,   6,   0,   2,   3,0x10,   0,   2,   8),AVAGO_RX_ADVANCED(   4,   8,   0,  15,   0,  15,  -8,   5,  -3,  10,  68),AVAGO_RX_MAIN(   0x10,      1,      0,      4,      0, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,  1000, -1000,   500,  -500,   160,   160,   180,   100)}},
...
{_28_125G_PAM4,            {AVAGO_TX(   0,   0,   8,   0,   2)},{AVAGO_RX_BASIC(   8,   6,   6,   0,   2,   3,0x10,   0,   2,   8),AVAGO_RX_ADVANCED(   4,   8,   0,  15,   0,  15,  -8,   5,  -3,  10,  68),AVAGO_RX_MAIN(   0x10,      1,      0,      4,      0, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,  1000, -1000,   500,  -500,   160,   160,   180,   100)}},
#else /* AN */
{_1_25G,                   {AVAGO_TX(   0,   0,   0,   0,   0)},{AVAGO_RX_BASIC(   7,  15,  15,   0,   0,   1,  NA,  NA,   5,   1),AVAGO_RX_ADVANCED(  NA,  15,  NA,  NA,   0,   0,   0,   0,   8,   8, 148),AVAGO_RX_MAIN(     NA,     NA,      0,      0,   L_NA,   L_NA),AVAGO_RX_MISC(    NA,L_NA_S,L_NA_S,L_NA_S,L_NA_S,L_NA_S,L_NA_S,    NA,    NA,    NA,    NA)}},
...
{_12_1875G,                {AVAGO_TX(   0,   0,   0,   4,   0)},{AVAGO_RX_BASIC(   6,  13,  NA,   0,   3,   2,0x1F,   0,   5,   1),AVAGO_RX_ADVANCED(   0,  15,  10,  15,   0,   8,  -5,   5,  -3,   8,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,      0, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   120,    70)}},
{_20_625G,                 {AVAGO_TX(   0,   0,   2,   0,  14)},{AVAGO_RX_BASIC(   3,   6,   6,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   3,   7,   0,  15,   0,   5,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    125, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   160,    70)}},
...
{_27_5G,                   {AVAGO_TX(   0,   0,   0,   0,   0)},{AVAGO_RX_BASIC(   3,  15,  15,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   3,   7,   0,  15,   0,   5,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    125, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   160,    70)}},
{_26_5625G_PAM4,           {AVAGO_TX(   0,   0,   6,   0,   6)},{AVAGO_RX_BASIC(   8,   6,   6,   0,   2,   3,0x10,   0,   2,   8),AVAGO_RX_ADVANCED(   4,   8,   0,  15,   0,  15,  -8,   5,  -3,  10,  68),AVAGO_RX_MAIN(   0x10,      1,      0,      4,      0, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,  1000, -1000,   500,  -500,   160,   160,   180,   100)}},
{_27_1875_PAM4,            {AVAGO_TX(   0,   0,   6,   0,   6)},{AVAGO_RX_BASIC(   8,   6,   6,   0,   2,   3,0x10,   0,   2,   8),AVAGO_RX_ADVANCED(   4,   8,   0,  15,   0,  15,  -8,   5,  -3,  10,  68),AVAGO_RX_MAIN(   0x10,      1,      0,      4,      0, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,  1000, -1000,   500,  -500,   160,   160,   180,   100)}},
{_28_125G_PAM4,            {AVAGO_TX(   0,   0,   6,   0,   6)},{AVAGO_RX_BASIC(   8,   6,   6,   0,   2,   3,0x10,   0,   2,   8),AVAGO_RX_ADVANCED(   4,   8,   0,  15,   0,  15,  -8,   5,  -3,  10,  68),AVAGO_RX_MAIN(   0x10,      1,      0,      4,      0, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,  1000, -1000,   500,  -500,   160,   160,   180,   100)}},
...
{_25_78125G,               {AVAGO_TX(   0,   0,   0,   0,   0)},{AVAGO_RX_BASIC(   8,   2,   2,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   2,   9,   2,  12,   0,  15,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      0,      0,      0,    100, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   120,    70)}},
...
{_27_5G,                   {AVAGO_TX(   0,   0,   0,   0,   0)},{AVAGO_RX_BASIC(   8,   2,   2,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   2,   9,   2,  12,   0,  15,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    100, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   120,    70)}},
...
{_12_1875G,                {AVAGO_TX(   0,   0,   0,   4,   0)},{AVAGO_RX_BASIC(   3,  15,  13,   0,   3,   2,0x1F,   0,   5,   1),AVAGO_RX_ADVANCED(   2,   7,  10,  15,   0,   8,  -5,   5,  -3,   8,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,      0, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   120,    70)}},
{_20_625G,                 {AVAGO_TX(   0,   0,   2,   0,  14)},{AVAGO_RX_BASIC(   8,   2,   2,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   2,   9,   2,  12,   0,  15,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    100, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   160,    70)}},
{_25_78125G,               {AVAGO_TX(   0,   0,   2,   0,  14)},{AVAGO_RX_BASIC(   8,   2,   2,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   2,   9,   2,  12,   0,  15,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    150, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   120,    70)}},
...
{_27_5G,                   {AVAGO_TX(   0,   0,   2,   0,  14)},{AVAGO_RX_BASIC(   8,   2,   2,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   2,   9,   2,  12,   0,  15,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    100, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   130,   130,   120,    70)}},
...
{_27_5G,                   {AVAGO_TX(   0,   0,   0,   0,   0)},{AVAGO_RX_BASIC(   6,  15,  15,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   0,   7,   0,  15,   0,  15,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    150, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   150,    50)}},
...
#else /* AN */
{_25_78125G,               {AVAGO_TX(   0,   0,   2,   0,  14)},{AVAGO_RX_BASIC(   6,  15,  15,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   0,   7,   0,  15,   0,  15,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    150, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   150,    50)}},
{_27_34375G,               {AVAGO_TX(   0,   0,   2,   0,  14)},{AVAGO_RX_BASIC(   6,  15,  15,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   0,   7,   0,  15,   0,  15,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    150, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   150,    50)}},
{_27_5G,                   {AVAGO_TX(   0,   0,   2,   0,  14)},{AVAGO_RX_BASIC(   6,  15,  15,   0,   1,   2,0x19,   0,   2,   8),AVAGO_RX_ADVANCED(   0,   7,   0,  15,   0,  15,   0,   0,  -3,  10,  68),AVAGO_RX_MAIN(    0x0,      1,      0,      0,    125, 0x2B5C),AVAGO_RX_MISC(     2,  1000, -1000,L_NA_S,L_NA_S,  1200, -1200,   160,   160,   150,    50)}},
...
GT_STATUS mvHwsAvagoCallbacksInit
(
...
)
{
    ...
    return mvHwsAvagoCallbacksInit(funcPtrArray);
}
#endif
...
)
{
...
#endif /*! MV_HWS_REDUCED_BUILD_EXT_CM3*/
    {
        ...
        for (chipIndex = 0; chipIndex < RAVEN_MAX_AVAGO_CHIP_NUMBER ; chipIndex++)
        {
            if ((ravenDevBmp >> chipIndex) & 0x1)
            {
                res = mvHwsAvagoSerdesInit2(devNum, chipIndex + (devNum * RAVEN_MAX_AVAGO_CHIP_NUMBER));
                if (res != GT_OK)
                {
                    return res;
                }
        ...
        PRV_HWS_SDFW_DOWNLOAD_DONE = GT_TRUE;
#endif
#else
    ...
    funcPtrArray[AVAGO_16NM]->serdesTestGenFunc            = BIND_SET_FUNC(mvHwsAvago16nmSerdesTestGen);
...
)
{
    ...
    *txStatus = TUNE_NOT_COMPLITED;
    ...
    data = avago_serdes_pmd_status(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    pmd_debug = avago_serdes_pmd_debug_construct(PRV_AAPL_SERDES_DB[chipIndex]);
    if ( pmd_debug != NULL )
    {
        /* Gathers up the PMD training debug information from Serdes */
        avago_serdes_pmd_debug(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, pmd_debug);

        /* print PMD debug info */
        avago_serdes_pmd_debug_print(PRV_AAPL_SERDES_DB[chipIndex], pmd_debug);

        /* Frees the memory pointed */
        avago_serdes_pmd_debug_destruct(PRV_AAPL_SERDES_DB[chipIndex], pmd_debug);
    }
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    ip_rev = aapl_get_ip_rev(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
    ...
    AVAGO_LOCK(devNum, chipIndex);
    avago_serdes_set_tx_eq(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &txParamValues);
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    avago_serdes_get_tx_eq(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &txParamValues);
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    *enable = GT_FALSE;
    ...
    AVAGO_LOCK(devNum, chipIndex);
    *enable = (avago_serdes_get_signal_ok(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, FALSE)) ? GT_TRUE : GT_FALSE;
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    *rxEncodingPtr = SERDES_ENCODING_NA;
    ...
    AVAGO_LOCK(devNum, chipIndex);
    avago_serdes_get_tx_rx_line_encoding(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &txEncoding, &rxEncoding);
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    avago_serdes_get_rx_datapath(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &rxDatapath);
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    *lockPtr = GT_FALSE;
    ...
    AVAGO_LOCK(devNum, chipIndex);
    *lockPtr = (avago_serdes_get_frequency_lock(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr)) ? GT_TRUE : GT_FALSE;
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    *rxSignal = ((avago_serdes_mem_rd(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_LSB, 0x027) & 0x0010) != 0) ? TUNE_READY : TUNE_NOT_READY;
    AVAGO_UNLOCK(devNum, chipIndex);
#endif /* ASIC_SIMULATION */
    GT_UNUSED_PARAM(portGroup);
...
)
{
    ...
    avago_serdes_tune_init(PRV_AAPL_SERDES_DB[chipIndex], &dfe_state);
    CHECK_AVAGO_RET_CODE();
    ...
    avago_serdes_tune(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &dfe_state);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
...
#if !defined(MV_HWS_REDUCED_BUILD_EXT_CM3) || defined RAVEN_DEV_SUPPORT || defined FALCON_DEV_SUPPORT
/**
* @internal mvHwsAvago16nmSerdesTestGen function
* @endinternal
*
...
GT_STATUS mvHwsAvago16nmSerdesTestGen
(
    IN GT_U8                       devNum,
    IN GT_UOPT                     portGroup,
    IN GT_UOPT                     serdesNum,
...
)
{
    ...
    if ((widthMode10Bit >> 9) == 1)
    {
        ...
        AVAGO_LOCK(devNum, chipIndex);
        avago_serdes_set_tx_rx_width(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, 20, 20);
        AVAGO_UNLOCK(devNum, chipIndex);
        CHECK_AVAGO_RET_CODE();
    }
    ...
    if (TUNE_NOT_COMPLITED == rxStatusPrev) {
        ...
        avago_spico_int(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, 0xa, 0x0);
        AVAGO_UNLOCK(devNum, chipIndex);
        CHECK_AVAGO_RET_CODE();
    ...
    if (mode == SERDES_TEST)
    {
        ...
        if (txPattern <= _10T)
        {
            ...
            avago_serdes_set_tx_data_sel(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_SERDES_TX_DATA_SEL_USER);
            AVAGO_UNLOCK(devNum, chipIndex);
            CHECK_AVAGO_RET_CODE();

            AVAGO_LOCK(devNum, chipIndex);
            /* Sets the USER pattern to compare incoming data against, Auto-seed to received 40 bit repeating pattern */
            avago_serdes_set_rx_cmp_data(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_SERDES_RX_CMP_DATA_SELF_SEED);
            AVAGO_UNLOCK(devNum, chipIndex);
            CHECK_AVAGO_RET_CODE();

            AVAGO_LOCK(devNum, chipIndex);
            /* Loads the 80-bit value into the TX user data register */
            avago_serdes_set_tx_user_data(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, tx_user);
            AVAGO_UNLOCK(devNum, chipIndex);
            CHECK_AVAGO_RET_CODE();

            AVAGO_LOCK(devNum, chipIndex);
            /* reset counter */
            avago_serdes_error_reset(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
            AVAGO_UNLOCK(devNum, chipIndex);
            CHECK_AVAGO_RET_CODE();
        }
        else /* for PRBS modes */
        {
            ...
            avago_serdes_set_tx_data_sel(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, txPatternData);
            AVAGO_UNLOCK(devNum, chipIndex);
            CHECK_AVAGO_RET_CODE();

            AVAGO_LOCK(devNum, chipIndex);
            /* Sets the PRBS pattern to compare incoming data against */
            avago_serdes_set_rx_cmp_data(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, rxPatternData);
            AVAGO_UNLOCK(devNum, chipIndex);
            CHECK_AVAGO_RET_CODE();
    ...
    else /* for SERDES_NORMAL mode */
    {
        if ((widthMode10Bit >> 9) == 1)
        {
            ...
            AVAGO_LOCK(devNum, chipIndex);
            avago_serdes_set_tx_rx_width(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, 10, 10);
            AVAGO_UNLOCK(devNum, chipIndex);
            CHECK_AVAGO_RET_CODE();
        ...
        avago_serdes_set_tx_data_sel(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_SERDES_TX_DATA_SEL_CORE);
        AVAGO_UNLOCK(devNum, chipIndex);
        CHECK_AVAGO_RET_CODE();

        AVAGO_LOCK(devNum, chipIndex);
        /* Sets the PRBS pattern to compare incoming data against */
        avago_serdes_set_rx_cmp_data(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_SERDES_RX_CMP_DATA_OFF);
        AVAGO_UNLOCK(devNum, chipIndex);
        CHECK_AVAGO_RET_CODE();

        AVAGO_LOCK(devNum, chipIndex);
        avago_serdes_aux_counter_disable(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
        AVAGO_UNLOCK(devNum, chipIndex);
        CHECK_AVAGO_RET_CODE();
    }
    ...
    if (TUNE_NOT_COMPLITED == rxStatusPrev) {
        AVAGO_LOCK(devNum, chipIndex);
        avago_spico_int(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, 0xa, 0x6);
        ms_sleep(1);
        /* Only the 16nm have the aux_counter that can be read during adaptive */
        avago_serdes_aux_counter_start(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
        AVAGO_UNLOCK(devNum, chipIndex);
        CHECK_AVAGO_RET_CODE();
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    data_sel = avago_serdes_get_tx_data_sel(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
    ...
    switch(data_sel)
    {
        ...
        case AVAGO_SERDES_TX_DATA_SEL_USER: /* User pattern generator */
            AVAGO_LOCK(devNum, chipIndex);
            avago_serdes_get_tx_user_data(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, tx_user);
            AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    if ((hwsDeviceSpecInfo[devNum].serdesType == AVAGO_16NM) && (rxStatus == TUNE_NOT_COMPLITED))
    {
        ...
        status->errorsCntr.l[0] = avago_serdes_aux_counter_read(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
        status->errorsCntr.l[1] = 0;
    ...
    {
        /* Retrieves the value of the error counter */
        status->errorsCntr.l[0] = avago_serdes_get_errors(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_LSB, !counterAccumulateMode);
        status->errorsCntr.l[1] = 0;
    }
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
...
)
{
    ...
    if (hwsDeviceSpecInfo[devNum].serdesType == AVAGO_16NM)
    {
        ...
        /* clear on read */
        avago_serdes_mem_wr(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_LSB, 0x41, 0x8541);
        avago_serdes_mem_wr(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_LSB, 0x41, 0x8540);
    ...
    switch(lbMode)
    {
        case SERDES_LP_DISABLE:
            ...
            if (hwsDeviceSpecInfo[devNum].serdesType != AVAGO_16NM)
            {
                /* CDR Rx power down */
                AVAGO_LOCK(devNum, chipIndex);
                avago_serdes_set_tx_rx_enable(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, GT_TRUE, GT_FALSE, GT_TRUE);
                AVAGO_UNLOCK(devNum, chipIndex);

                /* CDR Rx power up for recalibration */
                AVAGO_LOCK(devNum, chipIndex);
                avago_serdes_set_tx_rx_enable(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, GT_TRUE, GT_TRUE, GT_TRUE);
                AVAGO_UNLOCK(devNum, chipIndex);
            }
             AVAGO_LOCK(devNum, chipIndex);
             avago_serdes_set_tx_data_sel(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_SERDES_TX_DATA_SEL_CORE);
        ...
        case SERDES_LP_DIG_RX_TX:
            ...
            AVAGO_LOCK(devNum, chipIndex);
            avago_serdes_set_tx_data_sel(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_SERDES_TX_DATA_SEL_LOOPBACK);
            AVAGO_UNLOCK(devNum, chipIndex);
#ifndef ALDRIN_DEV_SUPPORT
            if (hwsDeviceSpecInfo[devNum].serdesType == AVAGO_16NM)
            {
...
)
{
    ...
    *lbModePtr = SERDES_LP_DISABLE;
    ...
    internalLB = avago_serdes_get_rx_input_loopback(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
    ...
    externalLB = avago_serdes_get_tx_data_sel(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
...
)
{
    ...
    avago_serdes_set_tx_output_enable(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, enable);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
...
)
{
    ...
    *enablePtr = avago_serdes_get_tx_output_enable(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
#endif /* ASIC_SIMULATION */
    GT_UNUSED_PARAM(portGroup);
...
)
{
    ...
    avago_serdes_pmd_init(PRV_AAPL_SERDES_DB[chipIndex], &pmd_mode);
    ...
    if (txTraining != IGNORE_TX_TRAINING)
    {
        ...
        if (HWS_DEV_SERDES_TYPE(devNum) == AVAGO_16NM)
        {
            ...
            AVAGO_LOCK(devNum, chipIndex);
            isPam4 = avago_serdes_get_rx_line_encoding(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
            AVAGO_UNLOCK(devNum, chipIndex);
            if ( isPam4) {
...
/* Read the divider value: */
        ...
        {
            AVAGO_LOCK(devNum, chipIndex);
            avago_serdes_pmd_train(PRV_AAPL_SERDES_DB[chipIndex], &pmd_mode);
            AVAGO_UNLOCK(devNum, chipIndex);
            CHECK_AVAGO_RET_CODE();
        }
    }
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    serdes_dfe_update_ctle(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &dfe, 0x26);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();

    AVAGO_LOCK(devNum, chipIndex);
    serdes_dfe_update_gain(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &dfe, GT_TRUE);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    avago_serdes_enable_low_power_mode(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, enableLowPower);
    isPam4 = avago_serdes_get_rx_line_encoding(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    avago_serdes_get_dfe_state(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &dfe);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    *eoMatricValue = avago_serdes_eye_get_simple_metric(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
#endif /* ASIC_SIMULATION */
    GT_UNUSED_PARAM(portGroup);
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    avago_serdes_initialize_signal_ok(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, signalThreshold);
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    for(i=0; i < 10; i++)
    {
        if(FALSE == avago_serdes_get_signal_ok_live(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr))
        {
            AVAGO_UNLOCK(devNum, chipIndex);
            *signalDet = GT_FALSE;
            return GT_OK;
...
)
{
    ...
    *signalThreshold = 0;
    ...
    AVAGO_LOCK(devNum, chipIndex);
    *signalThreshold = avago_serdes_get_signal_ok_threshold(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    (serdesDirection == RX_DIRECTION) ? avago_serdes_rx_inject_error(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, numOfBits)
                                      : avago_serdes_tx_inject_error(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, numOfBits);
    AVAGO_UNLOCK(devNum, chipIndex);
    ...
    for (i=(*inOutI); i < currentDelaySize; i++)
    {
        ...
        else
        {
            ...
            for (j=0; j < numOfSerdes; j++)
            {
                ...
                eye = avago_serdes_eye_get_simple_metric(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
                AVAGO_UNLOCK(devNum, chipIndex);
                CHECK_AVAGO_RET_CODE();
...
)
{
    ...
    *voltage = 0;
    ...
    {
        if (chipIndex > PRV_HWS_NUMBER_OF_RAVENS - 1)
        {
            return GT_NOT_SUPPORTED;
        }
    }
    ...
    *voltage = avago_sensor_get_voltage(PRV_AAPL_SERDES_DB[chipIndex], sensor_addr, 0, 0);
    AVAGO_UNLOCK(devNum, chipIndex);
...
)
{
    ...
    avago_serdes_get_tx_eq(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &tx_eq);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
    ...
    AVAGO_LOCK(devNum, chipIndex);
    results->EO = avago_serdes_eye_get_simple_metric(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    results->termination = avago_serdes_get_rx_term(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
...
)
{
     ...
     AVAGO_LOCK(devNum, chipIndex);
     data1 = avago_serdes_mem_rd(PRV_AAPL_SERDES_DB[chipIndex], sbusAddr, AVAGO_ESB, divxCtl1Reg);
     data2 = avago_serdes_mem_rd(PRV_AAPL_SERDES_DB[chipIndex], sbusAddr, AVAGO_ESB, divxCtl2Reg);
     AVAGO_UNLOCK(devNum, chipIndex);
     CHECK_AVAGO_RET_CODE();
...
)
{
    ...
    if ((devType == Raven) || (devType == Falcon))
    {
        ...
        AVAGO_LOCK(devNum, chipIndex);
        avago_serdes_get_tx_rx_line_encoding(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, &txLineEncoding, &rxLineEncoding);
        AVAGO_UNLOCK(devNum, chipIndex);
        CHECK_AVAGO_RET_CODE();
    }
    else
    {
        AVAGO_LOCK(devNum, chipIndex);
        divider = divider_lookup28nm(avago_serdes_mem_rd(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, AVAGO_ESB, 0x220));
        AVAGO_UNLOCK(devNum, chipIndex);
        CHECK_AVAGO_RET_CODE();
    }
...
)
{
    ...
    if (HWS_DEV_SILICON_TYPE(devNum) == Falcon)
    {
        for (chipIndex = 0; chipIndex < RAVEN_MAX_AVAGO_CHIP_NUMBER; chipIndex++)
        {
            if (PRV_AAPL_SERDES_DB[chipIndex + (RAVEN_MAX_AVAGO_CHIP_NUMBER * devNum)] != NULL)
            {
                break;
            }
        }
    ...
    else if(PRV_AAPL_SERDES_DB[chipIndex] == NULL)
    {
        CPSS_LOG_INFORMATION_MAC("AAPL is already closed for devNum %d\n", devNum);
        return;
    }
    ...
    if (HWS_DEV_SILICON_TYPE(devNum) == Falcon)
    {
        for (chipIndex = 0; chipIndex < RAVEN_MAX_AVAGO_CHIP_NUMBER; chipIndex++)
        {
            if (PRV_AAPL_SERDES_DB[chipIndex + (RAVEN_MAX_AVAGO_CHIP_NUMBER * devNum)] != NULL)
            {
                aapl_destruct(PRV_AAPL_SERDES_DB[chipIndex + (RAVEN_MAX_AVAGO_CHIP_NUMBER * devNum)]);
                cpssOsFree(PRV_AAPL_SERDES_DB[chipIndex + (RAVEN_MAX_AVAGO_CHIP_NUMBER * devNum)]);
                PRV_AAPL_SERDES_DB[chipIndex + (RAVEN_MAX_AVAGO_CHIP_NUMBER * devNum)] = NULL;
            }
        }
    }
    else
    {
        aapl_destruct(PRV_AAPL_SERDES_DB[chipIndex]);
        PRV_AAPL_SERDES_DB[chipIndex] = NULL;
    }
...
)
{
    ...
    RETURN_GT_OK_ON_EMULATOR;
    AVAGO_LOCK(devNum, chipIndex);
    *metricPtr = avago_pmro_get_metric(PRV_AAPL_SERDES_DB[chipIndex], 19);
    AVAGO_UNLOCK(devNum, chipIndex);
#endif
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    avago_serdes_hal_func(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, halFunc);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
#endif
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    *halRegValue = avago_serdes_hal_get(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, serdesHalType, regSelect);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
#endif
...
)
{
    ...
    AVAGO_LOCK(devNum, chipIndex);
    avago_serdes_hal_set(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, serdesHalType, regSelect, registerValue);
    AVAGO_UNLOCK(devNum, chipIndex);
    CHECK_AVAGO_RET_CODE();
#endif
...
)
{
    ...
    {
        AVAGO_LOCK(devNum, chipIndex);
        avago_serdes_set_rx_term(PRV_AAPL_SERDES_DB[chipIndex], sbus_addr, rxConfigPtr->rxAvago16nm.termination);
        AVAGO_UNLOCK(devNum, chipIndex);
    }
...
static GT_STATUS mvHwsAvagoSerdesAaplEnableLog(GT_U8 chipIndex, GT_BOOL enableLog, GT_U8 debugLevel)
{
    ...
    PRV_AAPL_SERDES_DB[chipIndex]->debug = debugLevel;

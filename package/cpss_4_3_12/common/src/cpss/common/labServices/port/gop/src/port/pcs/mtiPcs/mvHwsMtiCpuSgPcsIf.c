...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsMtiCpuSgPcsMode
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portMacNum,
...
{
    GT_U32 sgmiiSpeed = 0, sgmiiEnable = 0, fieldName;
    ...
    CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, portMacNum, MTI_CPU_SGPCS_UNIT, fieldName, sgmiiSpeed, NULL));
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsMtiCpuSgPcsSpeedPcsReset
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portMacNum,
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsMtiCpuSgPcsLoopBack
(
    IN  GT_U8                   devNum,
    IN  GT_U32                  portGroup,
...
)
{
    ...
    */
    ...
    {
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, portMacNum, MTI_CPU_SGPCS_UNIT, CPU_SGPCS_UNIT_PORT_CONTROL_PORT_RESET_E, 0x1, NULL));
    }
...
/**
* @internal mvHwsMtiCpuSgPcsRxReset function
* @endinternal
*
* @brief   CPU CG PCS SD RX RESET/UNRESET action.
*
* @param[in] devNum                   - system device number
* @param[in] portGroup                - port group (core) number
* @param[in] portMacNum               - MAC number
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsMtiCpuSgPcsRxReset
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portMacNum,
...
static GT_STATUS mvHwsMtiCpuSgPcsAnDoneGet
(
    IN  GT_U8                   devNum,
    IN  GT_U32                  portGroup,
    IN  GT_U32                  pcsNum,
...
)
{
    ...
    extField = MTIP_CPU_EXT_UNITS_STATUS_SG_AN_DONE_E;

    CHECK_STATUS(genUnitRegisterFieldGet(devNum, 0, pcsNum, MTI_CPU_EXT_UNIT, extField, &data, NULL));
...
GT_STATUS mvHwsMtiCpuSgPcsIfInit(MV_HWS_PCS_FUNC_PTRS **funcPtrArray)
{
    ...
    funcPtrArray[MTI_CPU_SGPCS]->pcsRxResetFunc         = mvHwsMtiCpuSgPcsRxReset;
    ...
    funcPtrArray[MTI_CPU_SGPCS]->pcsAnDoneGetFunc    = mvHwsMtiCpuSgPcsAnDoneGet;

...
/**
* @internal mvHwsComphyC12GP41P2VSerdesTemperatureGet function
* @endinternal
*
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsComphyC12GP41P2VSerdesTemperatureGet
(
    IN  GT_U8    devNum,
    IN  GT_UOPT  portGroup,
    IN  GT_UOPT  serdesNum,
...
/**
* @internal mvHwsComphyC12GP41P2VSerdesCtleGraduallyTune function
* @endinternal
*
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsComphyC12GP41P2VSerdesCtleGraduallyTune
(
    MCESD_DEV_PTR           devPtr,
    E_C12GP41P2V_CTLE_PARAM param,
    MCESD_U32               startVal,
    MCESD_U32               endVal
)
{
    ...
    if (startVal == endVal)
    {
        MCESD_CHECK_STATUS(API_C12GP41P2V_SetCTLEParam(devPtr, param, startVal));
    }
    while (startVal != endVal)
    {
        ...
        MCESD_CHECK_STATUS(API_C12GP41P2V_SetCTLEParam(devPtr, param, startVal));
        MCESD_CHECK_STATUS(API_C12GP41P2V_Wait(devPtr, 1));
    }
...
)
{
    ...
    MCESD_DEV_PTR   sDev;
    MCESD_U32 resSel, capSel, ctleLimitMinCap, ctleLimitMaxCap, ctleLimitMinRes, ctleLimitMaxRes;
    GT_U32 txImp1 = 0, txImp2 = 0, txImp3 = 0;
    ...
    *resultPtr = 0;
    ...
    switch ( operation )
    {
    case MV_HWS_PORT_SERDES_OPERATION_RES_CAP_SEL_TUNING_IC_E:

        /* get Temperature!! */
        CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesTemperatureGet(devNum, portGroup, serdesNum, &temperature));
    ...
    case MV_HWS_PORT_SERDES_OPERATION_SET_CTLE_LIMITS_E:
        ...
        MCESD_CHECK_STATUS(API_C12GP41P2V_GetCTLEParam(sDev, C12GP41P2V_CTLE_RES_SEL,   &resSel));
        MCESD_CHECK_STATUS(API_C12GP41P2V_GetCTLEParam(sDev, C12GP41P2V_CTLE_CAP_SEL,   &capSel));
        rc = mvHwsComphyC12GP41P2VSerdesDbRxConfigGet(devNum, portGroup, serdesNum, (MV_HWS_SERDES_SPEED) dataPtr[0] /*serdes speed*/, SERDES_DB_OVERRIDE_ONLY, &rxParameters);
        if ( rc != GT_OK)
        {
        ...
        ctleLimitMinCap = (MCESD_U32)rxParameters.rxComphyC12GP41P2V.minCap;
        ctleLimitMaxCap = (MCESD_U32)rxParameters.rxComphyC12GP41P2V.maxCap;
        ctleLimitMinRes = (MCESD_U32)rxParameters.rxComphyC12GP41P2V.minRes;
        ctleLimitMaxRes = (MCESD_U32)rxParameters.rxComphyC12GP41P2V.maxRes;

        if ((ctleLimitMaxCap < NA_8BIT) && (capSel >= ctleLimitMaxCap))
        {
            CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesCtleGraduallyTune(sDev, C12GP41P2V_CTLE_CAP_SEL, capSel, ctleLimitMaxCap));
        }
        else if ((ctleLimitMinCap < NA_8BIT) && (capSel <= ctleLimitMinCap))
        {
            CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesCtleGraduallyTune(sDev, C12GP41P2V_CTLE_CAP_SEL, capSel, ctleLimitMinCap));
        }
        if ((ctleLimitMaxRes < NA_8BIT) && (resSel >= ctleLimitMaxRes))
        {
            CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesCtleGraduallyTune(sDev, C12GP41P2V_CTLE_RES_SEL, resSel, ctleLimitMaxRes));
        }
        else if ((ctleLimitMinRes < NA_8BIT) && (resSel <= ctleLimitMinRes))
        {
            CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesCtleGraduallyTune(sDev, C12GP41P2V_CTLE_RES_SEL, resSel, ctleLimitMinRes));
        }

        break;

    case MV_HWS_PORT_SERDES_OPERATION_CHECK_TX_IMPEDANCE_CALIBRATION_E:

            CHECK_STATUS(mvHwsComphySerdesRegisterRead(devNum, portGroup, serdesNum, 0x301, 0x7FFF, &txImp1)); /* tximp_tunen0_side1_lane, tximp_tunen_side1_lane, tximp_tunen0_side0_lane, tximp_tunen_side0_lane */
            CHECK_STATUS(mvHwsComphySerdesRegisterRead(devNum, portGroup, serdesNum, 0x302, 0x7FFF, &txImp2)); /* tximp_tunep0_side1_1st_lane, tximp_tunep_side1_1st_lane, tximp_tunep0_side0_1st_lane, tximp_tunep_side0_1st_lane */
            CHECK_STATUS(mvHwsComphySerdesRegisterRead(devNum, portGroup, serdesNum, 0x303, 0x7FFF, &txImp3)); /* tximp_tunep0_side1_2nd_lane, tximp_tunep_side1_2nd_lane, tximp_tunep0_side0_2nd_lane, tximp_tunep_side0_2nd_lane */

            /* if all fields are 0x0, tx impedance calibration failed */
            if ( (txImp1 == 0x0) && (txImp2 == 0x0) && (txImp3 == 0x0) )
            {
                *resultPtr = 1;
            }
...
)
{
    ...
    else/*override param exist - go over rx params and set override value if exist or default if not exist*/
    {
        ...
        HWS_COMPHY_CHECK_AND_SET_DB_8BIT_VAL(configParamsPtr->rxComphyC12GP41P2V.minCap,    tuneParams[defaultParamIterator].rxParams.rxComphyC12GP41P2V.minCap,  serdesData->tuneOverrideParams[speedIdx].rxParams.rxComphyC12GP41P2V.minCap);
        HWS_COMPHY_CHECK_AND_SET_DB_8BIT_VAL(configParamsPtr->rxComphyC12GP41P2V.maxCap,    tuneParams[defaultParamIterator].rxParams.rxComphyC12GP41P2V.maxCap,  serdesData->tuneOverrideParams[speedIdx].rxParams.rxComphyC12GP41P2V.maxCap);
        HWS_COMPHY_CHECK_AND_SET_DB_8BIT_VAL(configParamsPtr->rxComphyC12GP41P2V.minRes,    tuneParams[defaultParamIterator].rxParams.rxComphyC12GP41P2V.minRes,  serdesData->tuneOverrideParams[speedIdx].rxParams.rxComphyC12GP41P2V.minRes);
        HWS_COMPHY_CHECK_AND_SET_DB_8BIT_VAL(configParamsPtr->rxComphyC12GP41P2V.maxRes,    tuneParams[defaultParamIterator].rxParams.rxComphyC12GP41P2V.maxRes,  serdesData->tuneOverrideParams[speedIdx].rxParams.rxComphyC12GP41P2V.maxRes);
...
)
{
    ...
    if(powerUp)
    {
        ...
        for(serdesIterator = 0; serdesIterator < numOfSer; serdesIterator++)
        {
            ...
            CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesDbTxConfigGet(devNum, 0, serdesArr[serdesIterator], baudRate, SERDES_DB_OVERRIDE_AND_DEFAULT, &txParameters));
            CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesManualTxConfig(devNum, 0, serdesArr[serdesIterator], &txParameters));

            CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesDbRxConfigGet(devNum, 0, serdesArr[serdesIterator], baudRate, SERDES_DB_OVERRIDE_AND_DEFAULT, &rxParameters));
            CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesManualRxConfig(devNum, 0, serdesArr[serdesIterator], &rxParameters));

            CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesTxRxExtraConfiguraion(devNum, portGroup, serdesArr[serdesIterator], serdesConfigPtr->baudRate, GT_TRUE));
    ...
    else /* Power-Down */
    {
        for(serdesIterator = 0 ; serdesIterator < numOfSer ; serdesIterator++)
        {
            ...
            if (PRV_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR_GET(serdesBgEnable) == GT_TRUE)
            {
                ...
                CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesOperation(devNum, portGroup, serdesArr[serdesIterator],
                                                           /*don't care*/_1000Base_X, MV_HWS_PORT_SERDES_OPERATION_RESET_RXTX_E, &data, &result));

                CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesTxRxExtraConfiguraion(devNum, portGroup, serdesArr[serdesIterator], serdesConfigPtr->baudRate, GT_FALSE));

                /* still keep analog unreset */
                CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesReset(devNum, portGroup, serdesArr[serdesIterator], GT_FALSE, GT_FALSE, GT_TRUE));
            }
            else
            {
                CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesReset(devNum, portGroup, serdesArr[serdesIterator], GT_FALSE, GT_TRUE, GT_TRUE));
...
/**
* @internal mvHwsComphyC12GP41P2VSerdesEomMatrixGet function
* @endinternal
*
* @brief   Read eye data
*
...
* @retval 1                        - on error
*/
GT_STATUS mvHwsComphyC12GP41P2VSerdesEomMatrixGet
(
    IN   GT_U8                              devNum,
    IN   GT_U32                             serdesNum,
...
GT_STATUS mvHwsComphyC12GP41P2VSerdesRxInit
(
    GT_U8                   devNum,
    GT_UOPT                 portGroup,
    GT_UOPT                 serdesNum,
...
)
{
    ...
    *rxInitStatus = TUNE_PASS;
    ...
    /* check signal */
    MCESD_CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesSignalDetectGet(devNum, portGroup, serdesNum, &sigDetect));
...
static GT_STATUS mvHwsComphyC12GP41P2VBandGapOptimization
(
    GT_U8                   devNum,
    GT_UOPT                 portGroup,
    GT_UOPT                 serdesNum
)
{
    GT_U32 data = 0;
    GT_STATUS rc;
    /* serdes 10 & 11 might be connected to OOB port */
    if ((serdesNum == 10) || (serdesNum == 11))
    {
        /* read sd_tx_if_sel to skip OOB port if connected */
        CHECK_STATUS(hwsSerdesRegGetFuncPtr(devNum, portGroup, EXTERNAL_REG, serdesNum, SERDES_EXTERNAL_CONFIGURATION_3, &data, 0x7));
        /* Interface 3 – select tx data from gunit - meaning the port is connected to OOB and configured in the uboot */
        if (data == 3)
        {
            return GT_OK;
        }
    ...
    /* Analog Unreset */
    CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesReset(devNum, portGroup, serdesNum, GT_FALSE, GT_TRUE, GT_TRUE));
    CHECK_STATUS(mvHwsComphyC12GP41P2VSerdesCoreReset(devNum, portGroup, serdesNum, UNRESET));
...
)
{
    ...
    HWS_COMPHY_BIND_SERDES_FUNC(funcPtrArray, serdesTemperatureFunc                 ,COM_PHY_C12GP41P2V, mvHwsComphyC12GP41P2VSerdesTemperatureGet);
#ifndef MV_HWS_REDUCED_BUILD
    HWS_COMPHY_BIND_SERDES_FUNC(funcPtrArray, serdesEomMatrixGetFunc                ,COM_PHY_C12GP41P2V, mvHwsComphyC12GP41P2VSerdesEomMatrixGet);
    HWS_COMPHY_BIND_SERDES_FUNC(funcPtrArray, serdesRxInitFunc                      ,COM_PHY_C12GP41P2V, mvHwsComphyC12GP41P2VSerdesRxInit);
    HWS_COMPHY_BIND_SERDES_FUNC(funcPtrArray, serdesBandGapOptimizationFunc         ,COM_PHY_C12GP41P2V, mvHwsComphyC12GP41P2VBandGapOptimization);
#endif

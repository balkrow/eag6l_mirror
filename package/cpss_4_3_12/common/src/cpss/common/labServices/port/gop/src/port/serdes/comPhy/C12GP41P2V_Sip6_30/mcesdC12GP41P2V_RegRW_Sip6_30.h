...
********************************************************************/
#ifndef MCESD_C12GP41P2V_REGRW_SIP6_30_H
#define MCESD_C12GP41P2V_REGRW_SIP6_30_H
...
CPSS_ADDITION_START
#define C12GP41P2V_WRITE_FIELD(xDevPtr, xField, xData)          {MCESD_FIELD tempField = xField; MCESD_ATTEMPT(API_C12GP41P2V_WriteField(xDevPtr, &tempField, xData));}
#define C12GP41P2V_READ_FIELD(xDevPtr, xField, xData)           {MCESD_FIELD tempField = xField; MCESD_ATTEMPT(API_C12GP41P2V_ReadField(xDevPtr, &tempField, &xData));}
#define C12GP41P2V_POLL_FIELD(xDevPtr, xField, xData, xTimeout) {MCESD_FIELD tempField = xField; MCESD_ATTEMPT(API_C12GP41P2V_PollField(xDevPtr, &tempField, xData, xTimeout));}
CPSS_ADDITION_END

...
/*
    N5XC56GP5X4 was taken from MCESD 2.9.0 :
    MCESD_API_MAJOR_VERSION 2
    MCESD_API_MINOR_VERSION 9
    MCESD_API_BUILD_ID      0
*/

#define C12GP41P2V_SIP6_30  /* clone of C12GP41P2V, updated MCESD version for SIP6_30 */
/*
    C12GP41P2V_SIP6_30 was taken from MCESD 2.9.1 :
    MCESD_API_MAJOR_VERSION 2
    MCESD_API_MINOR_VERSION 9
    MCESD_API_BUILD_ID      1
*/

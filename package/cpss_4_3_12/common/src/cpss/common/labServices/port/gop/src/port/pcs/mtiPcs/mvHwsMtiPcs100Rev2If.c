...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsMtiPcs100Rev2RxReset
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portMacNum,
...
/**
 * @internal mvHwsMtiPcs100Rev2RxResetGet function
 * @endinternal
 *
 ...
 * @return GT_STATUS
 */
static GT_STATUS mvHwsMtiPcs100Rev2RxResetGet
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portMacNum,
...
GT_STATUS mvHwsMtiPcs100Rev2IfInit(MV_HWS_PCS_FUNC_PTRS **funcPtrArray)
{
    ...
    funcPtrArray[MTI_PCS_100]->pcsRxResetFunc   = mvHwsMtiPcs100Rev2RxReset;
    funcPtrArray[MTI_PCS_100]->pcsRxResetGetFunc = mvHwsMtiPcs100Rev2RxResetGet;

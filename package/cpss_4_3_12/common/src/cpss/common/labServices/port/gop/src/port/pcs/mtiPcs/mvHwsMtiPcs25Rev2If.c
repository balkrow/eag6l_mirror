...
/**
* @internal mvHwsMtiPcs25Rex2RxReset function
* @endinternal
*
* @brief   PCS 25 SD RX RESET/UNRESET action.
*
* @param[in] devNum                   - system device number
* @param[in] portGroup                - port group (core) number
* @param[in] portMacNum               - MAC number
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsMtiPcs25Rev2RxReset
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portMacNum,
...
/**
 * @internal mvHwsMtiPcs25Rev2RxResetGet function
 * @endinternal
 *
 ...
 * @return GT_STATUS
 */
static GT_STATUS mvHwsMtiPcs25Rev2RxResetGet
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portMacNum,
...
GT_STATUS mvHwsMtiPcs25Rev2IfInit(MV_HWS_PCS_FUNC_PTRS **funcPtrArray)
{
    ...
    funcPtrArray[MTI_PCS_25]->pcsRxResetFunc   = mvHwsMtiPcs25Rev2RxReset;
    funcPtrArray[MTI_PCS_25]->pcsRxResetGetFunc   = mvHwsMtiPcs25Rev2RxResetGet;

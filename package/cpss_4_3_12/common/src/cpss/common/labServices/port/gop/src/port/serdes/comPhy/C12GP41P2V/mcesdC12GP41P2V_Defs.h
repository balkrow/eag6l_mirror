...
#if defined(C12GP41P2V) || defined(C12GP41P2V_SIP6_30)
...
#define C12GP41P2V_EYE_MAX_PHASE_LEVEL      1024
#define C12GP41P2V_EOM_UI_MAX_LOOP          40
...
typedef enum
{
    ...
    C12GP41P2V_SERDES_10G           = 17,   /* 10 Gbps */
    C12GP41P2V_SERDES_2P578125G     = 18,   /* 2.578125 Gbps */
    C12GP41P2V_SERDES_12P375G       = 19,   /* 12.375 Gbps */
...
typedef enum
{
    C12GP41P2V_PATH_LOCAL_ANALOG_LB,
    C12GP41P2V_PATH_EXTERNAL,
    C12GP41P2V_PATH_FAR_END_LB,
    C12GP41P2V_PATH_LOCAL_DIGITAL_LB,
    C12GP41P2V_PATH_UNKNOWN
...
typedef enum
{
    ...
    C12GP41P2V_PIN_PLL_READY_TX         = 26,
    C12GP41P2V_PIN_PLL_READY_RX         = 27
} E_C12GP41P2V_PIN;
...
typedef struct
{
    ...
    MCESD_U16 syncDivEnF;
    MCESD_U16 resetBypass;
    MCESD_U16 coarseBypass;
    MCESD_U16 phaseMoveDfe;
    MCESD_U16 coarseDfeEn;
    MCESD_U16 f0bAdaptEn;
    MCESD_U16 checkBypass;
    MCESD_U16 resolAdjEn;
    MCESD_U16 coarseDfeAdj;
    MCESD_U16 fineDfeResol;
    MCESD_U16 adaptDataEn;
    MCESD_U16 adaptSliceren;
    MCESD_U16 cdrDfeForce;
} S_C12GP41P2V_EOM_SAVED;

/* Eye Raw Data */
typedef struct
{
    MCESD_32 eyeRawData[C12GP41P2V_EYE_MAX_PHASE_LEVEL][(C12GP41P2V_EYE_MAX_VOLT_STEPS * 2) - 1];
...
#define F_C12GP41P2VR2P0_SQ_THRESH_EXT  FIELD_DEFINE(0x02F2, 14, 9)
#define F_C12GP41P2VR2P0_SQ_THRESH_F_EN FIELD_DEFINE(0x02F2, 15, 15)
...
#define F_C12GP41P2VR2P0_TX_EM_PEAK     FIELD_DEFINE(0x00A7, 3, 0)
#define F_C12GP41P2VR2P0_TX_EM_POST     FIELD_DEFINE(0x00A7, 11, 8)
#define F_C12GP41P2VR2P0_TX_EM_PRE      FIELD_DEFINE(0x00A7, 7, 4)

/* CTLE */
#define F_C12GP41P2VR2P0_RES_SEL        FIELD_DEFINE(0x004E, 2, 0)      /* G1_FFE_RES_SEL_LANE */
#define F_C12GP41P2VR2P0_RES_SHIFT      FIELD_DEFINE(0x005F, 3, 0)      /* G1_FFE_RES_SHIFT_LANE */
#define F_C12GP41P2VR2P0_CAP_SEL        FIELD_DEFINE(0x004D, 3, 0)      /* G1_FFE_CAP_SEL_LANE */
#define F_C12GP41P2VR2P0_FFE_SETTING_F  FIELD_DEFINE(0x004E, 12, 12)    /* G1_FFE_SETTING_FORCE_LANE */
...
/* CDR */
#define F_C12GP41P2VR2P0_RX_SELMUFI     FIELD_DEFINE(0x004B, 2, 0)      /* G1_RX_SELMUFI_LANE */
#define F_C12GP41P2VR2P0_RX_SELMUFF     FIELD_DEFINE(0x004C, 2, 0)      /* G1_RX_SELMUFF_LANE */
#define F_C12GP41P2VR2P0_RX_SELMUPI     FIELD_DEFINE(0x0049, 3, 0)      /* G1_RX_SELMUPI_LANE */
#define F_C12GP41P2VR2P0_RX_SELMUPF     FIELD_DEFINE(0x004A, 3, 0)      /* G1_RX_SELMUPF_LANE */
...
#define F_C12GP41P2VR2P0_DFE_F0_D       FIELD_DEFINE(0x0117, 5, 0)      /* DFE_F0_D_SM_LANE */
...
/* TRX Training */
#define F_C12GP41P2VR2P0_TRX_TRAINTIMER FIELD_DEFINE(0x024B, 9, 0)      /* TRX_TRAIN_TIMER */
...
CPSS_ADDITION_START
#define F_C12GP41P2VR2P0_PT_PRBS_LOAD_LANE FIELD_DEFINE(0x0072, 10, 10)
CPSS_ADDITION_END
...
#define F_C12GP41P2VR2P0_DFE_SPLR_EN    FIELD_DEFINE(0x0100, 1, 0)      /* DFE_ADAPT_SPLR_EN_LANE */
...
#define F_C12GP41P2VR2P0_DFE_LPNUM      FIELD_DEFINE(0x0102, 15, 6)     /* DFE_ADAPT_LPNUM_LANE */
...
#define F_C12GP41P2VR2P0_EOM_PH_FORCE   FIELD_DEFINE(0x01E1, 6, 6)      /* RX_EOM_PH_OFFSET_FORCE_LANE */
#define F_C12GP41P2VR2P0_EOM_PH_VALID   FIELD_DEFINE(0x01E1, 5, 5)      /* RX_EOM_PH_OFFSET_EXT_VALID_LANE */
#define F_C12GP41P2VR2P0_EOM_PH_EXT     FIELD_DEFINE(0x01E1, 4, 0)
#define F_C12GP41P2VR2P0_DFE_F0_S_EXT   FIELD_DEFINE(0x0143, 5, 0)
#define F_C12GP41P2VR2P0_DFE_F0_D_EXT   FIELD_DEFINE(0x0143, 13, 8)
...
#define F_C12GP41P2VR2P0_EOM_EN_D_FORCE FIELD_DEFINE(0x01E1, 14, 14)    /* RX_EOM_EN_D_FORCE_LANE */
#define F_C12GP41P2VR2P0_EOM_EN_S_FORCE FIELD_DEFINE(0x01E1, 12, 12)
#define F_C12GP41P2VR2P0_EOM_EN_E_FORCE FIELD_DEFINE(0x01E1, 10, 10)
#define F_C12GP41P2VR2P0_EOM_EN_D_EXT   FIELD_DEFINE(0x01E1, 13, 13)    /* RX_EOM_EN_D_EXT_LANE */
#define F_C12GP41P2VR2P0_EOM_EN_S_EXT   FIELD_DEFINE(0x01E1, 11, 11)
#define F_C12GP41P2VR2P0_UI_ALIGN_FAIL  FIELD_DEFINE(0x0168, 3, 3)      /* EOM_UI_ALIGN_FAIL_LANE */
#define F_C12GP41P2VR2P0_EOM_PH_OFFSET  FIELD_DEFINE(0x01E3, 4, 0)      /* RX_EOM_PH_OFFSET_LANE */
#define F_C12GP41P2VR2P0_EOM_PH_OFF_EXT FIELD_DEFINE(0x01E1, 4, 0)      /* RX_EOM_PH_OFFSET_EXT_LANE */
#define F_C12GP41P2VR2P0_SYNC_DIV_EN    FIELD_DEFINE(0x0168, 14, 14)    /* EOM_SYNC_DIV_EN_LANE */
#define F_C12GP41P2VR2P0_SYNC_DIV_EN_F  FIELD_DEFINE(0x0168, 15, 15)    /* EOM_SYNC_DIV_EN_FORCE_LANE */
#define F_C12GP41P2VR2P0_SCHEME_START_F FIELD_DEFINE(0x015C, 1, 1)      /* CDR_DFE_SCHEME_START_FORCE_LANE */
#define F_C12GP41P2VR2P0_SCHEME_START   FIELD_DEFINE(0x015C, 0, 0)      /* CDR_DFE_SCHEME_START_LANE */
#define F_C12GP41P2VR2P0_SAV_EYE_CHECK  FIELD_DEFINE(0x0150, 0, 0)      /* SAV_EYE_CHECK_PASS_LANE */
#define F_C12GP41P2VR2P0_RESET_BYPASS   FIELD_DEFINE(0x015E, 5, 5)      /* CDR_DFE_RESET_BYPASS_LANE */
#define F_C12GP41P2VR2P0_COARSE_BYPASS  FIELD_DEFINE(0x015E, 11, 11)    /* CDR_DFE_COARSE_DTL_BYPASS_LANE */
#define F_C12GP41P2VR2P0_PHASE_MOVE_DFE FIELD_DEFINE(0x015E, 4, 4)      /* CDR_DFE_PHASE_MOVE_WITH_DFE_EN_LANE */
#define F_C12GP41P2VR2P0_COARSE_DFE_EN  FIELD_DEFINE(0x015E, 12, 12)    /* CDR_DFE_COARSE_DFE_EN_LANE */
#define F_C12GP41P2VR2P0_F0B_ADAPT_EN   FIELD_DEFINE(0x015E, 8, 8)      /* CDR_DFE_F0B_ADAPT_EN_LANE */
#define F_C12GP41P2VR2P0_CHECK_BYPASS   FIELD_DEFINE(0x015E, 0, 0)      /* EYE_CHECK_BYPASS_LANE */
#define F_C12GP41P2VR2P0_RESOL_ADJ_EN   FIELD_DEFINE(0x015E, 3, 3)      /* CDR_DFE_RESOL_ADJUST_EN_LANE */
#define F_C12GP41P2VR2P0_COARSE_DFE_ADJ FIELD_DEFINE(0x015E, 2, 2)      /* CDR_DFE_COARSE_DFE_IN_RESOL_ADJ_EN_LANE */
#define F_C12GP41P2VR2P0_FINE_DFE_RESOL FIELD_DEFINE(0x015E, 1, 1)      /* CDR_DFE_FINE_DFE_IN_RESOL_ADJ_EN_LANE */
#define F_C12GP41P2VR2P0_ADAPT_DATA_EN  FIELD_DEFINE(0x015F, 11, 11)
#define F_C12GP41P2VR2P0_ADAPT_SLICEREN FIELD_DEFINE(0x015F, 10, 10)    /* ADAPT_SLICER_EN_LANE */
#define F_C12GP41P2VR2P0_CDR_DFE_FORCE  FIELD_DEFINE(0x015E, 15, 15)
#define F_C12GP41P2VR2P0_DFE_RES_F0     FIELD_DEFINE(0x0140, 6, 5)

/* TX Programming */
#define F_C12GP41P2VR2P0_TX_CLK_FORCE   FIELD_DEFINE(0x0065, 1, 1)      /* TX_TXREG_SPEEDTRK_CLK_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_TX_CLK      FIELD_DEFINE(0x0054, 2, 0)      /* G1_TX_TXREG_SPEEDTRK_CLK_LANE */
#define F_C12GP41P2VR2P0_TX_DATA_FORCE  FIELD_DEFINE(0x0065, 0, 0)      /* TX_TXREG_SPEEDTRK_DATA_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_TX_DATA     FIELD_DEFINE(0x0053, 2, 0)      /* G1_TX_TXREG_SPEEDTRK_DATA_LANE */
...
#define F_C12GP41P2VR2P0_G1_TX_VDDCALEN FIELD_DEFINE(0x005A, 12, 12)    /* G1_TX_VDD_CAL_EN_LANE */

/* DRO */
#define F_C12GP41P2VR2P0_VALUE_5B       FIELD_DEFINE(0x0289, 9, 5)      /* PROCESS_VALUE_5B */
#define F_C12GP41P2VR2P0_CAL_SUBSS0     FIELD_DEFINE(0x0288, 14, 10)    /* PROCESS_CAL_SUBSS0 */
#define F_C12GP41P2VR2P0_CNT_TO_CONST   FIELD_DEFINE(0x0289, 4, 0)      /* CNT_TO_PROCESS_CONST */
#define F_C12GP41P2VR2P0_CAL_SS2TT0     FIELD_DEFINE(0x0288, 9, 5)      /* PROCESS_CAL_SS2TT0 */
#define F_C12GP41P2VR2P0_CAL_TT2FF0     FIELD_DEFINE(0x0288, 4, 0)      /* PROCESS_CAL_TT2FF0 */

/* RX Programming */
#define F_C12GP41P2VR2P0_RX_SPDIV_FORCE FIELD_DEFINE(0x0066, 5, 5)      /* RX_SPEED_DIV_FORCE_LANE */
#define F_C12GP41P2VR2P0_RX_SPEED_DIV   FIELD_DEFINE(0x0066, 3, 2)
#define F_C12GP41P2VR2P0_RX_DTLCLK_F    FIELD_DEFINE(0x0064, 3, 3)      /* RX_DTLCLK_DIV_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_DTLCLK_D FIELD_DEFINE(0x0054, 13, 12)    /* G1_RX_DTLCLK_DIV_LANE */
...
#define F_C12GP41P2VR2P0_RX_EOM_INTPR_F FIELD_DEFINE(0x0069, 10, 10)    /* RX_EOM_INTPR_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RXEOM_INTPR FIELD_DEFINE(0x0059, 2, 0)      /* G1_RX_EOM_INTPR_LANE */
#define F_C12GP41P2VR2P0_RX_CLK_FORCE   FIELD_DEFINE(0x0065, 3, 3)      /* RX_RXREG_SPEEDTRK_CLK_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_CLK      FIELD_DEFINE(0x0056, 2, 0)      /* G1_RX_RXREG_SPEEDTRK_CLK_LANE */
#define F_C12GP41P2VR2P0_RX_DATA_FORCE  FIELD_DEFINE(0x0065, 2, 2)      /* RX_RXREG_SPEEDTRK_DATA_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_DATA     FIELD_DEFINE(0x0055, 2, 0)      /* G1_RX_RXREG_SPEEDTRK_DATA_LANE */
#define F_C12GP41P2VR2P0_RX_CKPW_CNT_F  FIELD_DEFINE(0x0069, 9, 9)      /* RX_CKPW_CNT_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_CKPW_CNT FIELD_DEFINE(0x0057, 13, 12)
#define F_C12GP41P2VR2P0_RX_PU_A90_F    FIELD_DEFINE(0x0068, 13, 13)    /* RX_PU_ALIGN90_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_PU_A90   FIELD_DEFINE(0x0056, 12, 12)    /* G1_RX_PU_ALIGN90_LANE */
#define F_C12GP41P2VR2P0_RX_CTLE_1_F    FIELD_DEFINE(0x006A, 10, 10)    /* RX_CTLE_DATA_RATE1_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_CTLE_1   FIELD_DEFINE(0x005A, 2, 0)      /* G1_RX_CTLE_DATA_RATE1_LANE */
#define F_C12GP41P2VR2P0_RX_CTLE_2_F    FIELD_DEFINE(0x006A, 11, 11)    /* RX_CTLE_DATA_RATE2_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_CTLE_2   FIELD_DEFINE(0x005B, 2, 0)      /* G1_RX_CTLE_DATA_RATE2_LANE */
#define F_C12GP41P2VR2P0_RX_CTLE_3_F    FIELD_DEFINE(0x006A, 12, 12)    /* RX_CTLE_DATA_RATE3_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_CTLE_3   FIELD_DEFINE(0x005C, 2, 0)      /* G1_RX_CTLE_DATA_RATE3_LANE */
#define F_C12GP41P2VR2P0_RX_VDD_CAL_F   FIELD_DEFINE(0x006A, 14, 14)    /* RX_VDD_CAL_EN_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_VDDCALEN FIELD_DEFINE(0x005B, 12, 12)    /* G1_RX_VDD_CAL_EN_LANE */
#define F_C12GP41P2VR2P0_RX_DCC_CAL_F   FIELD_DEFINE(0x006A, 15, 15)    /* RX_DCC_CAL_EN_FORCE_LANE */
#define F_C12GP41P2VR2P0_G1_RX_DCCCA_EN FIELD_DEFINE(0x005C, 12, 12)    /* G1_RX_DCC_CAL_EN_LANE */
#define F_C12GP41P2VR2P0_RX_25M_FORCE   FIELD_DEFINE(0x0017, 12, 12)    /* RXCLK_25M_FORCE_LANE */
#define F_C12GP41P2VR2P0_RX_25M_CTRL    FIELD_DEFINE(0x0017, 9, 8)      /* ANA_RXCLK_25M_CTRL_LANE */
#define F_C12GP41P2VR2P0_RX_25M_DIV1P5  FIELD_DEFINE(0x0017, 11, 11)    /* ANA_RXCLK_25M_DIV1P5_EN_LANE */
#define F_C12GP41P2VR2P0_RX_25M_DIV     FIELD_DEFINE(0x0017, 7, 0)      /* ANA_RXCLK_25M_DIV_LANE */
#define F_C12GP41P2VR2P0_RX_25M_FIX_DIV FIELD_DEFINE(0x0017, 10, 10)    /* ANA_RXCLK_25M_FIX_DIV_EN_LANE */

/* PLL Programming */
#define F_C12GP41P2VR2P0_PHY_MODE_FMREG FIELD_DEFINE(0x0020, 15, 15)    /* PHY_MODE_FM_REG */
#define F_C12GP41P2VR2P0_PHY_MODE       FIELD_DEFINE(0x0020, 14, 12)
#define F_C12GP41P2VR2P0_FREF_SEL_FMREG FIELD_DEFINE(0x0025, 5, 5)      /* REF_FREF_SEL_FM_REG */
#define F_C12GP41P2VR2P0_REF_FREF_SEL   FIELD_DEFINE(0x0025, 4, 0)
#define F_C12GP41P2VR2P0_PLL_REFDIV_F   FIELD_DEFINE(0x0069, 11, 11)    /* PLL_REFDIV_FORCE */
#define F_C12GP41P2VR2P0_PLL_REFDIV     FIELD_DEFINE(0x0069, 15, 12)
#define F_C12GP41P2VR2P0_PLL_FBDIV_F    FIELD_DEFINE(0x0066, 15, 15)    /* PLL_FBDIV_FORCE */
#define F_C12GP41P2VR2P0_PLL_FBDIV      FIELD_DEFINE(0x0066, 14, 6)
#define F_C12GP41P2VR2P0_PLL_BW_SEL_F   FIELD_DEFINE(0x0064, 5, 5)      /* PLL_BW_SEL_FORCE */
#define F_C12GP41P2VR2P0_G1_PLL_BW_SEL  FIELD_DEFINE(0x005E, 2, 0)
#define F_C12GP41P2VR2P0_PLL_LPF_C2_F   FIELD_DEFINE(0x0064, 10, 10)    /* PLL_LPF_C2_SEL_FORCE */
#define F_C12GP41P2VR2P0_G1_PLL_LPF_C2  FIELD_DEFINE(0x0060, 1, 0)      /* G1_PLL_LPF_C2_SEL */
#define F_C12GP41P2VR2P0_PLL_ICP_FORCE  FIELD_DEFINE(0x0064, 6, 6)
#define F_C12GP41P2VR2P0_G1_PLL_ICP     FIELD_DEFINE(0x005D, 3, 0)
#define F_C12GP41P2VR2P0_PLL_SPEED_F    FIELD_DEFINE(0x006B, 9, 9)      /* PLL_SPEED_THRESH_FORCE */
#define F_C12GP41P2VR2P0_PLL_SPEED      FIELD_DEFINE(0x006B, 8, 0)      /* PLL_SPEED_THRESH */
#define F_C12GP41P2VR2P0_FBDIV_CAL_F    FIELD_DEFINE(0x006A, 9, 9)      /* PLL_FBDIV_CAL_FORCE */
...
#define F_C12GP41P2VR2P0_TXDTXCLK_DIV_F FIELD_DEFINE(0x0064, 7, 7)      /* TXDTXCLK_DIV_FORCE */
#define F_C12GP41P2VR2P0_R0_TXDTXCLKDIV FIELD_DEFINE(0x0061, 12, 12)    /* R0_TXDTXCLK_DIV */
#define F_C12GP41P2VR2P0_PLL_REG_FORCE  FIELD_DEFINE(0x0068, 12, 12)    /* PLL_REG_SPEED_TRK_FORCE */
#define F_C12GP41P2VR2P0_R0_REG_SPD_TRK FIELD_DEFINE(0x0062, 2, 0)      /* R0_PLL_REG_SPEED_TRK */
#define F_C12GP41P2VR2P0_INIT_TXFOFFS_F FIELD_DEFINE(0x0068, 11, 11)    /* INIT_TXFOFFS_FORCE_LANE */
#define F_C12GP41P2VR2P0_INIT_TXFOFFS   FIELD_DEFINE(0x0068, 10, 0)
#define F_C12GP41P2VR2P0_INIT_RXFOFFS_F FIELD_DEFINE(0x0067, 11, 11)    /* INIT_RXFOFFS_FORCE_LANE */
#define F_C12GP41P2VR2P0_INIT_RXFOFFS   FIELD_DEFINE(0x0067, 10, 0)

/* Initialization */
#define F_C12GP41P2VR2P0_LINK_TRAINMODE FIELD_DEFINE(0x024A, 0, 0)      /* LINK_TRAIN_MODE_LANE */
#define F_C12GP41P2VR2P0_DET_BYPASS     FIELD_DEFINE(0x0005, 14, 14)
#define F_C12GP41P2VR2P0_START_SQ_EN    FIELD_DEFINE(0x0171, 11, 11)    /* TX_TRAIN_START_SQ_EN_LANE */
...
#define F_C12GP41P2VR2P0_PAT_TWO_ZERO   FIELD_DEFINE(0x0252, 11, 11)    /* TX_TRAIN_PAT_TWO_ZERO */
#define F_C12GP41P2VR2P0_ETHERNET_MODE  FIELD_DEFINE(0x0240, 0, 0)
#define F_C12GP41P2VR2P0_AMP_DEFAULT1   FIELD_DEFINE(0x0259, 13, 8)     /* TX_AMP_DEFAULT1 */
#define F_C12GP41P2VR2P0_EMPH1_DEFAULT1 FIELD_DEFINE(0x0259, 7, 4)      /* TX_EMPH1_DEFAULT1 */
#define F_C12GP41P2VR2P0_EMPH0_DEFAULT1 FIELD_DEFINE(0x0259, 3, 0)      /* TX_EMPH0_DEFAULT0 */
#define F_C12GP41P2VR2P0_AMP_DEFAULT2   FIELD_DEFINE(0x025A, 13, 8)     /* TX_AMP_DEFAULT2 */
#define F_C12GP41P2VR2P0_EMPH1_DEFAULT2 FIELD_DEFINE(0x025A, 7, 4)      /* TX_EMPH1_DEFAULT2 */
#define F_C12GP41P2VR2P0_EMPH0_DEFAULT2 FIELD_DEFINE(0x025A, 3, 0)      /* TX_EMPH0_DEFAULT2 */
#define F_C12GP41P2VR2P0_TRAIN_PAT_SEL  FIELD_DEFINE(0x0071, 5, 4)      /* TX_TRAIN_PAT_SEL_LANE */
#define F_C12GP41P2VR2P0_TRAIN_PAT_MODE FIELD_DEFINE(0x0252, 10, 10)    /* TX_TRAIN_PAT_MODE */
#define F_C12GP41P2VR2P0_LOCAL_INDEX    FIELD_DEFINE(0x0258, 7, 4)      /* LOCAL_TX_PRESET_INDEX_LANE */
#define F_C12GP41P2VR2P0_VICM_SMPLR_SEL FIELD_DEFINE(0x0170, 9, 9)      /* RX_CTLE_VICM_SMPLR_SEL_LANE */
#define F_C12GP41P2VR2P0_CTLE_VICM1     FIELD_DEFINE(0x00CD, 9, 8)      /* RX_CTLE_VICM1_CTRL_LANE */
#define F_C12GP41P2VR2P0_CTLE_VICM2     FIELD_DEFINE(0x00CD, 11, 10)    /* RX_CTLE_VICM2_CTRL_LANE */
#define F_C12GP41P2VR2P0_VICM_SMPLR     FIELD_DEFINE(0x00CD, 7, 6)      /* RX_VICM_SMPLR_CTRL_LANE */
#define F_C12GP41P2VR2P0_VICM_DFE_CTRL  FIELD_DEFINE(0x00CD, 5, 4)      /* RX_VICM_DFE_CTRL_LANE */
#define F_C12GP41P2VR2P0_SAMPLER_VCM    FIELD_DEFINE(0x0088, 10, 8)     /* VREF_SAMPLER_VCM_SEL */
...
#define F_C12GP41P2VR2P0_DFE_RES_LOW    FIELD_DEFINE(0x0175, 3, 0)      /* DFE_RES_F0A_LOW_THRES_LANE */
...
#define F_C12GP41P2VR2P0_TXADAPT_G1_EN  FIELD_DEFINE(0x01A6, 0, 0)      /* TX_ADAPT_G1_EN_LANE */
#define F_C12GP41P2VR2P0_TXADAPT_GN1_EN FIELD_DEFINE(0x01A6, 1, 1)      /* TX_ADAPT_GN1_EN_LANE */
#define F_C12GP41P2VR2P0_TXADAPT_G0_EN  FIELD_DEFINE(0x01A6, 2, 2)      /* TX_ADAPT_G0_EN_LANE */

#define F_C12GP41P2VR2P0_TRAIN_CHK_INIT FIELD_DEFINE(0x024A, 9, 9)      /* TX_TRAIN_CHK_INIT */
#define F_C12GP41P2VR2P0_DFE_UPDATE_EN  FIELD_DEFINE(0x0104, 7, 0)
#define F_C12GP41P2VR2P0_PAT_TOGGLE     FIELD_DEFINE(0x0252, 9, 9)      /* TX_TRAIN_PAT_TOGGLE */
#define F_C12GP41P2VR2P0_START_NO_WAIT  FIELD_DEFINE(0x0171, 10, 10)    /* TX_TRAIN_START_NO_WAIT_LANE */
#define F_C12GP41P2VR2P0_FRAME_DETECTED FIELD_DEFINE(0x0171, 12, 12)    /* TX_TRAIN_START_FRAME_DETECTED_EN_LANE */
#define F_C12GP41P2VR2P0_START_LOCK_EN  FIELD_DEFINE(0x0171, 13, 13)    /* TX_TRAIN_START_FRAME_LOCK_EN_LANE */
#define F_C12GP41P2VR2P0_WAIT_TIME_EN   FIELD_DEFINE(0x0171, 14, 14)    /* TX_TRAIN_START_WAIT_TIME_EN_LANE */
#define F_C12GP41P2VR2P0_LOCK_LOST_EN   FIELD_DEFINE(0x024A, 8, 8)      /* PATTERN_LOCK_LOST_TIMEOUT_EN_LANE */

#define F_C12GP41P2VR2P0_SQ_DEGLITCH_EN FIELD_DEFINE(0x00C9, 8, 8)
#define F_C12GP41P2VR2P0_SQ_LPF         FIELD_DEFINE(0x00CA, 15, 0)
#define F_C12GP41P2VR2P0_SQ_LPF_EN      FIELD_DEFINE(0x00C9, 12, 12)
#define F_C12GP41P2VR2P0_RCAL_VTH_RX    FIELD_DEFINE(0x0309, 2, 0)
#define F_C12GP41P2VR2P0_TX_VREF_TXDRV  FIELD_DEFINE(0x0048, 2, 0)      /* G1_TX_VREF_TXDRV_SEL_LANE */
#define F_C12GP41P2VR2P0_REALPHASEADAPT FIELD_DEFINE(0x0053, 12, 12)    /* G1_REAL_TIME_PHASE_ADAPT_LANE */

#define F_C12GP41P2VR2P0_DTL_LOOP_FRZ   FIELD_DEFINE(0x0033, 3, 3)      /* DTL_LOOP_FREEZE_LANE */
#define F_C12GP41P2VR2P0_DTL_CLK_OFF    FIELD_DEFINE(0x0033, 8, 8)
#define F_C12GP41P2VR2P0_DTL_CLK_OFF_F  FIELD_DEFINE(0x0033, 9, 9)      /* DTL_CLK_OFF_FORCE */
#define F_C12GP41P2VR2P0_G1_PLL_FBCK    FIELD_DEFINE(0x0040, 12, 12)    /* G1_PLL_FBCK_SEL */

#define F_C12GP41P2VR2P0_TXDRV_SEL_F    FIELD_DEFINE(0x00A6, 9, 9)      /* TX_VREF_TXDRV_SEL_FORCE_LANE */
#define F_C12GP41P2VR2P0_PLL_FBCK_SEL_F FIELD_DEFINE(0x0089, 15, 15)    /* PLL_FBCK_SEL_FORCE */
#define F_C12GP41P2VR2P0_G1_PLL_FBCK    FIELD_DEFINE(0x0040, 12, 12)    /* G1_PLL_FBCK_SEL */
#define F_C12GP41P2VR2P0_DFE_UPDATE_DC  FIELD_DEFINE(0x0103, 6, 6)      /* DFE_UPDATE_DC_EN */
#define F_C12GP41P2VR2P0_DC_OS_NORMAL   FIELD_DEFINE(0x015B, 9, 9)      /* DC_OS_UPDATE_EN_NORMAL_LANE */
#define F_C12GP41P2VR2P0_DC_OS_TRAIN    FIELD_DEFINE(0x015B, 8, 8)      /* DC_OS_UPDATE_EN_TRAIN_LANE */
#define F_C12GP41P2VR2P0_MIN_BOOST_MODE FIELD_DEFINE(0x0197, 3, 3)

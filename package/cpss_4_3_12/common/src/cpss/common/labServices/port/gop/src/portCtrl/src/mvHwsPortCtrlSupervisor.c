...
#if !defined (AC5P_DEV_SUPPORT) && !defined(AC5_DEV_SUPPORT) && !defined(IRONMAN_DEV_SUPPORT)
...
#if defined (ALDRIN_DEV_SUPPORT) || defined(BC3_DEV_SUPPORT) || defined(ALDRIN2_DEV_SUPPORT) || defined(PIPE_DEV_SUPPORT) || defined(RAVEN_DEV_SUPPORT) || defined(AC5_DEV_SUPPORT) || defined(IRONMAN_DEV_SUPPORT)

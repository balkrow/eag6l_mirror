...
#include <cpss/generic/diag/private/serdesOpt/private/gtSkipList.h>
#include <cpssCommon/private/prvCpssSkipList.h>
#include <cpss/generic/diag/private/serdesOpt/SerdesRxOptimizer.h>
#include <cpss/generic/diag/serdesOpt/private/SerdesRxOptAppIf.h>
...
/**
* @internal skipDestroy function
* @endinternal
*
* @brief   Destroys the given skip-list.
*
* @param[in] pSlHead                  - A pointer to the skip-list to be destroyed.
...
*                                      on the user's data.
*
* @param[out] pSlHead                  - Points to NULL, this node will also be deleted.
*                                       GT_OK on success,
*                                       GT_FAIL otherwise.
*/
...
/**
* @internal skipAddAndGetNode function
* @endinternal
*
...
* @param[in] pSlHead                  - a pointer to the skipList, to which the new node will be
*                                      added.
* @param[in] pData                    - A pointer to the new data to be added.
* @param[in,out] newAddedNode             - A pointer to the new added node, or NULL if this
*                                      information is not required.
* @param[in,out] newAddedNode             - A pointer to the new added node at the bottom level
*                                      of the skip-list.
...
/**
* @internal skipIsEmpty function
* @endinternal
*
* @brief   checks if a skip-List is empty.
*
* @param[in] pSlHead                  - a pointer to the head of the skipList.

...
static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD C28GP4X1_hwsToMcesdSerdesSpeedDb[]=
{
    ...
    {_12_1875G,     C28GP4X1_SERDES_12P1875G_LC},
    {_28_125G,      C28GP4X1_SERDES_28P125G    }
};
...
static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD C28GP4X4_hwsToMcesdSerdesSpeedDb[]=
{
    ...
    {_12_1875G,     C28GP4X4_SERDES_12P1875G_LC},
    {_28_125G,      C28GP4X4_SERDES_28P125G    }
...
static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD C112GX4_hwsToMcesdSerdesSpeedDb[]=
{
    ...
    {_2_578125,                  C112GX4_SERDES_2P578125G },
    ...
    {_12_1875G,                  C112GX4_SERDES_12P1875G  },
    {_12_5G,                     C112GX4_SERDES_12P5G     },
    {_12_8906G,                  C112GX4_SERDES_12P890625G},
    {_20_625G,                   C112GX4_SERDES_20P625G   },
    {_25_78125G,                 C112GX4_SERDES_25P78125G },
    {_26_5625G,                  C112GX4_SERDES_26P5625G  },
    {_27_5G,                     C112GX4_SERDES_27P5G     },
    {_28_125G,                   C112GX4_SERDES_28P125G   },
    {_26_5625G_PAM4,             C112GX4_SERDES_53P125G   },
    {_28_125G_PAM4,              C112GX4_SERDES_56P25G    }
};
...
static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD N5XC56GP5X4_hwsToMcesdSerdesSpeedDb[]=
{
    ...
    {_28_125G,              N5XC56GP5X4_SERDES_28P125G },
...
#include "C12GP41P2V/mcesdC12GP41P2V_Defs.h"
static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD C12GP41P2V_SIP6_30_hwsToMcesdSerdesSpeedDb[]=
{
    {_5G,        C12GP41P2V_SERDES_5G       },
    {_5_15625G,  C12GP41P2V_SERDES_5P15625G },
    {_1_25G,     C12GP41P2V_SERDES_1P25G    },
    ...
    {_10_3125G,  C12GP41P2V_SERDES_10P3125G },
    {_12_5G,     C12GP41P2V_SERDES_12P5G    },
    {_10G,       C12GP41P2V_SERDES_10G      },
    {_2_578125,  C12GP41P2V_SERDES_2P578125G},
    {_12_375G,   C12GP41P2V_SERDES_12P375G  },
    {_1_25G_100FX, C12GP41P2V_SERDES_1P25G}
};

static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD C12GP41P2V_SIP6_30_hwsToMcesdRefClockFreqDb[]=
{
    {_25Mhz,        C12GP41P2V_REFFREQ_25MHZ    },
    {_125Mhz,       C12GP41P2V_REFFREQ_125MHZ   },
    {_156dot25Mhz,  C12GP41P2V_REFFREQ_156P25MHZ}
...
static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD C12GP41P2V_SIP6_30_hwsToMcesdRefClockSourceDb[]=
{
    {PRIMARY,   C12GP41P2V_REFCLK_SEL_GROUP1},
    {SECONDARY, C12GP41P2V_REFCLK_SEL_GROUP2}
};

static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD C12GP41P2V_SIP6_30_hwsToMcesdDataBusWidthDb[]=
{
    {_10BIT_ON,  C12GP41P2V_DATABUS_20BIT},
    {_10BIT_OFF, C12GP41P2V_DATABUS_20BIT},
    {_20BIT_ON,  C12GP41P2V_DATABUS_20BIT},
...
static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD C12GP41P2V_SIP6_30_hwsToMcesdPatternDb[]=
{
    {_1T,         C12GP41P2V_PAT_JITTER_1T  },
    {_2T,         C12GP41P2V_PAT_JITTER_2T  },
    {_4T,         C12GP41P2V_PAT_JITTER_4T  },
...
static const MV_HWS_COMPHY_ENUMS_CONVERSION_RECORD C12GP41P2V_SIP6_30_hwsToMcesdLoopbackDb[]=
{
    {SERDES_LP_AN_TX_RX,  C12GP41P2V_PATH_LOCAL_ANALOG_LB},
    {SERDES_LP_DISABLE,   C12GP41P2V_PATH_EXTERNAL       },
    {SERDES_LP_DIG_RX_TX, C12GP41P2V_PATH_FAR_END_LB     },
    ...
    *conversionDb = NULL;
    switch( enumType )
    {
        case MV_HWS_COMPHY_MCESD_ENUM_SERDES_SPEED:
            ...
            IF_C12GP41P2V_SIP6_30(serdesType, MV_HWS_COMPHY_INIT_ARR_PTR_MAC(C12GP41P2V_SIP6_30_hwsToMcesdSerdesSpeedDb, *conversionDb, *conversionDbSize));
        ...
        case MV_HWS_COMPHY_MCESD_ENUM_REF_CLOCK_FREQ:
            ...
            IF_C12GP41P2V_SIP6_30(serdesType,MV_HWS_COMPHY_INIT_ARR_PTR_MAC(C12GP41P2V_SIP6_30_hwsToMcesdRefClockFreqDb,*conversionDb,*conversionDbSize));
        ...
        case MV_HWS_COMPHY_MCESD_ENUM_REF_CLOCK_SOURCE:
            ...
            IF_C12GP41P2V_SIP6_30(serdesType,MV_HWS_COMPHY_INIT_ARR_PTR_MAC(C12GP41P2V_SIP6_30_hwsToMcesdRefClockSourceDb,*conversionDb,*conversionDbSize));
        ...
        case MV_HWS_COMPHY_MCESD_ENUM_DATA_BUS_WIDTH:
            ...
            IF_C12GP41P2V_SIP6_30(serdesType,MV_HWS_COMPHY_INIT_ARR_PTR_MAC(C12GP41P2V_SIP6_30_hwsToMcesdDataBusWidthDb,*conversionDb,*conversionDbSize));
        ...
        case MV_HWS_COMPHY_MCESD_ENUM_PATTERN:
            ...
            IF_C12GP41P2V_SIP6_30(serdesType,MV_HWS_COMPHY_INIT_ARR_PTR_MAC(C12GP41P2V_SIP6_30_hwsToMcesdPatternDb,*conversionDb,*conversionDbSize));
        ...
        case MV_HWS_COMPHY_MCESD_ENUM_LOOPBACK:
            ...
            IF_C12GP41P2V_SIP6_30(serdesType,MV_HWS_COMPHY_INIT_ARR_PTR_MAC(C12GP41P2V_SIP6_30_hwsToMcesdLoopbackDb,*conversionDb,*conversionDbSize));

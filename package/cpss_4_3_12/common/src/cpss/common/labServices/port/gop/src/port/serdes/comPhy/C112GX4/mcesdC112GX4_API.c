...
static MCESD_STATUS INT_C112GX4_CalculateBER(IN MCESD_U32 bitErrorCount, IN MCESD_U64 bitCount, OUT MCESD_U32* nanoBER);
static MCESD_STATUS INT_C112GX4_SpeedGbpsToMbps(IN E_C112GX4_SERDES_SPEED speed, OUT MCESD_U32 *mbps);
#ifdef C112GX4_DFE_MILLIVOLTS
static MCESD_STATUS INT_C112GX4_GetDfeF0(IN MCESD_DEV_PTR devPtr, IN MCESD_U8 lane, INOUT MCESD_U32 *table);
#endif
...
/* API_C112GX4_GetDataAcquisitionRate implementation was taken from MCESD 2.8.7 */
...
{
    E_C112GX4_SERDES_SPEED txSpeed, rxSpeed;
    MCESD_U32 mbps;

    *acqRate = C112GX4_RATE_UNKNOWN;

    MCESD_ATTEMPT(API_C112GX4_GetTxRxBitRate(devPtr, lane, &txSpeed, &rxSpeed));
    MCESD_ATTEMPT(INT_C112GX4_SpeedGbpsToMbps(rxSpeed, &mbps));

    if (mbps > 56250)       /* 56.25 Gbps < speed */
    {
        *acqRate = C112GX4_RATE_QUARTER;
    }
    else if (mbps > 28125)  /* 28.125 Gbps < speed <= 56.25 Gbps */
    {
        *acqRate = C112GX4_RATE_HALF;
    }
    else if (mbps > 0)      /* 0 Gbps < speed <= 28.125 Gbps*/
    {
...
/* INT_C112GX4_SpeedGbpsToMbps implementation was taken from MCESD 2.8.7 */
MCESD_STATUS INT_C112GX4_SpeedGbpsToMbps
(
...
)
{
    *mbps = 0;
    ...
    switch (speed)
    {
    case C112GX4_SERDES_1P25G:      /* 1.25 Gbps */
        *mbps = 1250;
        break;
    case C112GX4_SERDES_2P5G:       /* 2.5 Gbps */
        *mbps = 2500;
        break;
    case C112GX4_SERDES_2P578125G:  /* 2.578125 Gbps */
        *mbps = 2578;
        break;
    case C112GX4_SERDES_3P125G:     /* 3.125 Gbps */
        *mbps = 3125;
        break;
    case C112GX4_SERDES_5G:         /* 5 Gbps */
        *mbps = 5000;
        break;
    case C112GX4_SERDES_5P15625G:   /* 5.15625 Gbps */
        *mbps = 5156;
        break;
    case C112GX4_SERDES_6P25G:      /* 6.25 Gbps */
        *mbps = 6250;
        break;
    case C112GX4_SERDES_10G:        /* 10 Gbps */
        *mbps = 10000;
        break;
    case C112GX4_SERDES_10P3125G:   /* 10.3125 Gbps */
        *mbps = 10312;
        break;
    case C112GX4_SERDES_12P1875G:   /* 12.1875 Gbps */
        *mbps = 12187;
        break;
    case C112GX4_SERDES_12P5G:      /* 12.5 Gbps */
        *mbps = 12500;
        break;
    case C112GX4_SERDES_12P890625G: /* 12.890625 Gbps */
        *mbps = 12890;
        break;
    case C112GX4_SERDES_20P625G:    /* 20.625 Gbps */
        *mbps = 20625;
        break;
    case C112GX4_SERDES_25P78125G:  /* 25.78125 Gbps */
        *mbps = 25781;
        break;
    case C112GX4_SERDES_26P5625G:   /* 26.5625 Gbps */
        *mbps = 26562;
        break;
    case C112GX4_SERDES_27P5G:      /* 27.5 Gbps */
        *mbps = 27500;
        break;
    case C112GX4_SERDES_28P125G:    /* 28.125 Gbps */
        *mbps = 28125;
        break;
    case C112GX4_SERDES_51P5625G:   /* 51.5625 Gbps */
        *mbps = 51562;
        break;
    case C112GX4_SERDES_53P125G:    /* 53.125 Gbps */
        *mbps = 53125;
        break;
    case C112GX4_SERDES_56G:        /* 56 Gbps */
        *mbps = 56000;
        break;
    case C112GX4_SERDES_56P25G:     /* 56.25 Gbps */
        *mbps = 56250;
        break;
    case C112GX4_SERDES_103P125G:   /* 103.125 Gbps */
        *mbps = 103125;
        break;
    case C112GX4_SERDES_106GP25G:    /* 106.250 Gbps */
        *mbps = 106250;
        break;
    case C112GX4_SERDES_112G:       /* 112 Gbps */
        *mbps = 112000;
        break;
    default:
        return MCESD_FAIL;
...
(
    IN MCESD_DEV_PTR devPtr,
    IN MCESD_U8 lane,
    OUT E_C112GX4_SERDES_SPEED *txSpeed,
    OUT E_C112GX4_SERDES_SPEED *rxSpeed
)
{
    MCESD_FIELD phyGenRx = F_C112GX4R1P0_PHY_GEN_RX;
    MCESD_FIELD phyGenTx = F_C112GX4R1P0_PHY_GEN_TX;
    ...
    *rxSpeed = (E_C112GX4_SERDES_SPEED)data;
    MCESD_ATTEMPT(API_C112GX4_ReadField(devPtr, lane, &phyGenTx, &data));
    *txSpeed = (E_C112GX4_SERDES_SPEED)data;
...
)
{
    ...
    {
        /* RX.X < R1.2 */
        C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_PIN_PHY_GEN_TX_RD, lane, txData);
        C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_PIN_PHY_GEN_RX_RD, lane, rxData);
    }
    else
    {
        /* RX.X >= R1.2 */
        C112GX4_READ_FIELD(devPtr, F_C112GX4R1P2_PIN_PHY_GEN_TX_RD, lane, txData);
        C112GX4_READ_FIELD(devPtr, F_C112GX4R1P2_PIN_PHY_GEN_RX_RD, lane, rxData);
    }

    *txSpeed = (E_C112GX4_SERDES_SPEED)txData;
    *rxSpeed = (E_C112GX4_SERDES_SPEED)rxData;
...
)
{
    ...
    if (C112GX4_SERDES_106P25G == speed)
    {
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_EOM_DEBUG0, lane, 3);
    }*/

    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ESM_PATH_SEL, lane, 1);
    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_ADAPT_SPLR_EN, lane, 0xF);
    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ADAPT_EVEN, lane, 1);
    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ADAPT_ODD, lane, 1);
    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ESM_EN, lane, 1);
    C112GX4_POLL_FIELD(devPtr, F_C112GX4R1P0_EOM_READY, lane, 1, 5000);
    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ESM_LPNUM, lane, 0xFF);
...
{
    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ESM_EN, lane, 0);
    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_EOM_DEBUG0, lane, 0);
...
{
    MCESD_U32 vldCntPData_39_32, vldCntPData_31_00, vldCntNData_39_32, vldCntNData_31_00, errCntPData, errCntNData, totalErrCntPData, totalErrCntNData;
    ...
    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ESM_PHASE, lane, phase);
    C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ESM_VOLTAGE, lane, voltage);
    ...
    {
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_EOM_DFE_CALL, lane, 1);
        C112GX4_POLL_FIELD(devPtr, F_C112GX4R1P0_EOM_DFE_CALL, lane, 0, 1000);

        switch (eyeTMB)
        {
        case C112GX4_EYE_TOP:
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_T_P_39_32, lane, vldCntPData_39_32);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_T_P_31_00, lane, vldCntPData_31_00);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_T_N_39_32, lane, vldCntNData_39_32);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_T_N_31_00, lane, vldCntNData_31_00);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_EC_T_P, lane, errCntPData);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_EC_T_N, lane, errCntNData);
            break;
        case C112GX4_EYE_MID:
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_M_P_39_32, lane, vldCntPData_39_32);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_M_P_31_00, lane, vldCntPData_31_00);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_M_N_39_32, lane, vldCntNData_39_32);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_M_N_31_00, lane, vldCntNData_31_00);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_EC_M_P, lane, errCntPData);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_EC_M_N, lane, errCntNData);
            break;
        case C112GX4_EYE_BOT:
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_B_P_39_32, lane, vldCntPData_39_32);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_B_P_31_00, lane, vldCntPData_31_00);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_B_N_39_32, lane, vldCntNData_39_32);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_VC_B_N_31_00, lane, vldCntNData_31_00);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_EC_B_P, lane, errCntPData);
            C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_EOM_EC_B_N, lane, errCntNData);
            break;
        default:
        ...
        totalErrCntPData += errCntPData;
        totalErrCntNData += errCntNData;
    }
...
)
{
    ...
    if (mbps >= 80000)       /* 80 Gbps <= speed */
    {
        *phaseStepCount = 64;
    }
    else if (mbps >= 16000)  /* 16 Gbps <= speed < 80 Gbps */
    {
        *phaseStepCount = 128;
    }
...
)
{
    ...
    memset(&measurement, 0x0, sizeof(S_C112GX4_EOM_DATA));
    ...
    {
        MCESD_ATTEMPT(API_C112GX4_EOMMeasPoint(devPtr, lane, eyeTMB, phase, 0, minSamples, &measurement));
        ...
        MCESD_ATTEMPT(INT_C112GX4_CalculateBER(measurement.upperBitErrorCount, measurement.upperBitCount, &upperBER));
        MCESD_ATTEMPT(INT_C112GX4_CalculateBER(measurement.lowerBitErrorCount, measurement.lowerBitCount, &lowerBER));
    ...
    {
        MCESD_ATTEMPT(API_C112GX4_EOMMeasPoint(devPtr, lane, eyeTMB, phaseMidpoint, (MCESD_U8)voltage, minSamples, &measurement));
...
MCESD_STATUS INT_C112GX4_CalculateBER
(
...
)
{
    ...
    C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_TRAIN_F0A, lane, f0aData);
    C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_TRAIN_F0A_MAX, lane, f0aMaxData);
    C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_TRAIN_F0B, lane, f0bData);
    C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_TRAIN_F0D, lane, f0dData);
    C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_TRAIN_F0X, lane, f0xData);
...
)
{
    ...
    case C112GX4_PATH_LOCAL_ANALOG_LB:
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DTX_FLOOP_STEP, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DTL_CLAMPING_SEL, lane, 6);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_RX2TX_NO_STOP, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_RX2TX_RD_START, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_RX_FOFFSET_DIS, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DTX_FOFFSET_SEL, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DIG_RX2TX_LPBK_EN, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ANA_TX2RX_LPBK_EN, lane, 1);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DIG_TX2RX_LPBK_EN, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_PU_LB, lane, 1);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_PT_EN, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_VREF_SHIFT, lane, 2);

        /* Additional Sequence for 53.125G */
        if ((C112GX4_SERDES_53P125G == txSpeed) && (C112GX4_SERDES_53P125G == rxSpeed))
        {
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_SQ_EN, lane, 0);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_VREF, lane, 0x3);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F0, lane, 0x3);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F15171921, lane, 1);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F16182022, lane, 1);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F2, lane, 0x3);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F23252729, lane, 1);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F24262830, lane, 1);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F3TO4, lane, 0x3);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F5TO8, lane, 1);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F9TO14, lane, 1);

            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_CLI_CMD, lane, 0xF6);
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_CLI_START, lane, 1);
            C112GX4_POLL_FIELD(devPtr, F_C112GX4R1P0_CLI_START, lane, 0, 90000);
        }
        else
        {
            C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_SQ_EN, lane, 1);
        }
        break;
    case C112GX4_PATH_EXTERNAL:
        ...
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DTX_FOFFSET_SEL, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DIG_RX2TX_LPBK_EN, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ANA_TX2RX_LPBK_EN, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DIG_TX2RX_LPBK_EN, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_PU_LB, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_PT_EN, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_VREF_SHIFT, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DFE_SQ_EN, lane, 1);
        break;
    case C112GX4_PATH_FAR_END_LB:
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DTX_FLOOP_STEP, lane, 3);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DTL_CLAMPING_SEL, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_RX2TX_NO_STOP, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_RX2TX_RD_START, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_RX_FOFFSET_DIS, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DTX_FOFFSET_SEL, lane, 1);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DIG_RX2TX_LPBK_EN, lane, 1);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_ANA_TX2RX_LPBK_EN, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_DIG_TX2RX_LPBK_EN, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_PU_LB, lane, 0);
        C112GX4_WRITE_FIELD(devPtr, F_C112GX4R1P0_PT_EN, lane, 0);
...
#ifdef C112GX4_DFE_MILLIVOLTS
MCESD_STATUS INT_C112GX4_GetDfeF0
(
    IN MCESD_DEV_PTR devPtr,
    IN MCESD_U8 lane,
...
{
    MCESD_U32 i, resData, resDoubleData;

    C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_DFE_RES_F0, lane, resData);
    C112GX4_READ_FIELD(devPtr, F_C112GX4R1P0_DFE_F0_RES_DOUBLE, lane, resDoubleData);

    for (i = 0; i < 64; i++)
    {
        if (1 == resDoubleData)
            table[i] = C112GX4_DFE_F0_TABLE[resData][i] * 2;
        else
            table[i] = C112GX4_DFE_F0_TABLE[resData][i];
    }
...
)
{
    ...
    *widthmUI = (MCESD_U32)width * 1000 / phaseStepCount;
    ...
    /* Convert height */
    MCESD_ATTEMPT(INT_C112GX4_GetDfeF0(devPtr, lane, table));
    *heightuV = table[heightUpper] + table[heightLower];
...
)
{
    ...
    phaseCenterIdx = C112GX4_EYE_MAX_PHASE_LEVEL / 2;
    ...
    MCESD_ATTEMPT(API_C112GX4_EOMInit(devPtr, lane));
    CPSS_ADDITION_START
    hwsOsMemSetFuncPtr(&measurement,0x0,sizeof(S_C112GX4_EOM_DATA));
    CPSS_ADDITION_END
    /* Check (0, 0) */
    MCESD_ATTEMPT(API_C112GX4_EOMMeasPoint(devPtr, lane, eyeTMB, 0, 0, minSamples, &measurement));
    ...
    {
        MCESD_ATTEMPT(API_C112GX4_EOMFinalize(devPtr, lane));
        MCESD_DBG_ERROR("API_C112GX4_EOMGetEyeData: BER > berThreshold at (Phase: 0, Voltage: 0)\n");
        return MCESD_FAIL;
    }
    ...
    for (phase = 0; phase <= leftMaxEdge; phase++)
    {
        ...
        {
            MCESD_ATTEMPT(API_C112GX4_EOMMeasPoint(devPtr, lane, eyeTMB, phase, (MCESD_U8)voltage, minSamples, &measurement));
...
#ifdef C112GX4_DFE_MILLIVOLTS
    MCESD_ATTEMPT(INT_C112GX4_GetDfeF0(devPtr, lane, eyeRawDataPtr->mVTable));
#endif
...
)
{
    ...
    MCESD_ATTEMPT(plotEyeData(eyeRawDataPtr->eyeRawData[0], eyeRawDataPtr->leftEdge, eyeRawDataPtr->rightEdge, C112GX4_EYE_MAX_PHASE_LEVEL / 2, phaseStepSize,
        eyeRawDataPtr->upperEdge, eyeRawDataPtr->lowerEdge, C112GX4_EYE_MAX_VOLT_STEPS - 1, voltageStepSize, eyeRawDataPtr->sampleCount, (C112GX4_EYE_MAX_VOLT_STEPS * 2) - 1,
...
)
{
    if (!eyeRawDataPtr)
    {
        MCESD_DBG_ERROR("API_C112GX4_EOMGetStats: eyeRawDataPtr is NULL\n");
        return MCESD_FAIL;
    }

    /* Calculate Q and SNR */
    MCESD_ATTEMPT(INT_EOM_STATS_GetAmplitudeStats(eyeRawDataPtr->eyeRawData[0], eyeBufferDataPtr->bufferData[0],
        eyeRawDataPtr->relativeCenter, C112GX4_EYE_MAX_PHASE_LEVEL,
        eyeRawDataPtr->upperEdge, eyeRawDataPtr->lowerEdge, C112GX4_EYE_MAX_VOLT_STEPS - 1, (C112GX4_EYE_MAX_VOLT_STEPS * 2) - 1,
        amplitudeStats));

    /* Estimate Height */
    MCESD_ATTEMPT(INT_EOM_STATS_EstimateDimension(eyeRawDataPtr->eyeRawData[0], eyeBufferDataPtr->bufferData[0],
        eyeRawDataPtr->leftEdge, eyeRawDataPtr->rightEdge, eyeRawDataPtr->relativeCenter, C112GX4_EYE_MAX_PHASE_LEVEL,
        eyeRawDataPtr->upperEdge, eyeRawDataPtr->lowerEdge, C112GX4_EYE_MAX_VOLT_STEPS - 1, (C112GX4_EYE_MAX_VOLT_STEPS * 2) - 1,
...
MCESD_STATUS API_C112GX4_EyeDataDimensions
(
    IN S_C112GX4_EYE_RAW_PTR eyeRawDataPtr,
    IN MCESD_U32 berThreshold,
    OUT MCESD_U32 *width,
...
)
{
    ...
    phaseCenter = C112GX4_EYE_MAX_PHASE_LEVEL / 2;
    leftIndex = eyeRawDataPtr->leftEdge;
    rightIndex = eyeRawDataPtr->rightEdge;
    voltageCenter = C112GX4_EYE_MAX_VOLT_STEPS - 1;
    ...
    {
        MCESD_ATTEMPT(INT_C112GX4_CalculateBER(eyeRawDataPtr->eyeRawData[phaseIndex][voltageCenter], eyeRawDataPtr->sampleCount, &upperBER));
        MCESD_ATTEMPT(INT_C112GX4_CalculateBER(eyeRawDataPtr->eyeRawData[phaseIndex][voltageCenter + 1], eyeRawDataPtr->sampleCount, &lowerBER));
        if ((berThreshold < upperBER) || (berThreshold < lowerBER))
        {
    ...
    {
        MCESD_ATTEMPT(INT_C112GX4_CalculateBER(eyeRawDataPtr->eyeRawData[phaseIndex][voltageIndex], eyeRawDataPtr->sampleCount, &upperBER));
        if (berThreshold < upperBER)
        {
    ...
    {
        MCESD_ATTEMPT(INT_C112GX4_CalculateBER(eyeRawDataPtr->eyeRawData[phaseIndex][voltageIndex], eyeRawDataPtr->sampleCount, &lowerBER));
        if (berThreshold < lowerBER)
        {
...
)
{
    ...
    memset(&entry, 0x0, sizeof(S_C112GX4_TRX_TRAINING_LOGENTRY));

...
#elif IRONMAN_DEV_SUPPORT
    portNumBase = MV_PORT_CTRL_IRONMAN_AP_PORT_LOW_PORT_NUM_BASE;
    maxApPortNum = MV_PORT_CTRL_IRONMAN_AP_PORT_HIGH_PORT_NUM_BASE + (MV_PORT_CTRL_MAX_AP_PORT_NUM - MV_PORT_CTRL_IRONMAN_AP_PORT_HIGH_PORT_LOGICAL_INDEX -1);
#else

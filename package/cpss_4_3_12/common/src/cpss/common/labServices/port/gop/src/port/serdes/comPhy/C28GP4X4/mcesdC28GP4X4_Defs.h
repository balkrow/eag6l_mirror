...
#define C28GP4X4_EYE_MAX_PHASE_LEVEL    1024
...
typedef enum
{
    ...
    C28GP4X4_SERDES_12P1875G_RING = 5,  /* 12.1875 Gbps (RING)*/
    C28GP4X4_SERDES_12P1875G_LC = 19,   /* 12.1875 Gbps (LC)*/
...
typedef struct
{
    MCESD_32 eyeRawData[C28GP4X4_EYE_MAX_PHASE_LEVEL][(C28GP4X4_EYE_MAX_VOLT_STEPS * 2) - 1];
...
#define F_C28GP4X4R1P0_PHY_GEN_TX_RD    FIELD_DEFINE(0x2030, 31, 27)
#define F_C28GP4X4R1P0_PHY_GEN_RX_RD    FIELD_DEFINE(0x2114, 31, 27)
...
#define F_C28GP4X4R1P0_DFE_RES_F0       FIELD_DEFINE(0x0050, 4, 3)

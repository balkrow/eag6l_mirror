...
GT_BOOL serdesBgEnable          = GT_TRUE;
GT_BOOL serdesBgClkBypassEnable = GT_FALSE;
...
)
{
    ...
    SERDES_LOCK(devNum, serdesType);
        ...
        mvHwsSseInvokerRxAutoTuneStartSeq(SSE_ORDER_PRE_E, devNum, portGroup, serdesNum, serdesType, rxTraining);
    #endif
    ...
    #if defined (SSE_ENABLED) && defined (CHX_FAMILY)
        mvHwsSseInvokerRxAutoTuneStartSeq(SSE_ORDER_POST_E, devNum, portGroup, serdesNum, serdesType, rxTraining);
    #endif
...
)
{
    ...
    #if defined (SSE_ENABLED) && defined (CHX_FAMILY)
        mvHwsSseInvokerSerdesResetSeq(SSE_ORDER_PRE_E, devNum, portGroup, serdesNum , analogReset, digitalReset, syncEReset);
    #endif
    ...
    #if defined (SSE_ENABLED) && defined (CHX_FAMILY)
        mvHwsSseInvokerSerdesResetSeq(SSE_ORDER_POST_E, devNum, portGroup, serdesNum, analogReset, digitalReset, syncEReset);
    #endif
...
)
{
...
#endif
    {
        ...
        #if defined (SSE_ENABLED) && defined (CHX_FAMILY)
            mvHwsSseInvokerSerdesPowerUpArrayCtrlSeq(SSE_ORDER_PRE_E, devNum, portGroup, numOfSer, serdesArr, powerUp, serdesConfigPtr);
        #endif
        ...
        #if defined (SSE_ENABLED) && defined (CHX_FAMILY)
            mvHwsSseInvokerSerdesPowerUpArrayCtrlSeq(SSE_ORDER_POST_E, devNum, portGroup, numOfSer, serdesArr, powerUp, serdesConfigPtr);
        #endif
...
/**
* @internal mvHwsSerdesSigDetectMask function
* @endinternal
*
* @brief   Serdes signal detect mask configuration.
*
* @param[in] devNum                   - system device number
* @param[in] portGroup                - port group (core) number
* @param[in] serdesNum                - physical serdes number
* @param[in] serdesType               - serdes type
* @param[in] sigDetectMask            - true to enable
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
GT_STATUS mvHwsSerdesSigDetectMask
(
    IN GT_U8               devNum,
    IN GT_U32              portGroup,
    IN GT_U32              serdesNum,
    IN MV_HWS_SERDES_TYPE  serdesType,
    IN GT_BOOL             sigDetectMask
)
{
    GT_STATUS rc;
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesSigDetectMaskFunc);
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesSigDetectMaskFunc(devNum,portGroup,serdesNum,sigDetectMask);
    SERDES_UNLOCK(devNum, serdesType);
    return rc;
}
#endif
...
/**
* @internal mvHwsSerdesClampingValuesResetAndStatusGet function
* @endinternal
*
* @brief   Set Serdes Clamping Values to default if clamping
*          status is false. Also return the clamping status
*
* @param[in] devNum                   - system device number
* @param[in] portGroup                - port group (core) number
* @param[in] serdesNum                - physical PCS number
* @param[in] serdesType               - serdes PCS type
*
* @param[out] clampingStatusPtr       - clamping status.
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
GT_STATUS mvHwsSerdesClampingValuesResetAndStatusGet
(
    IN GT_U8                   devNum,
    IN GT_U32                  portGroup,
    IN GT_U32                  serdesNum,
...
)
{
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesClampingValuesResetFunc);
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesClampingValuesResetFunc(devNum,portGroup,serdesNum,clampingStatusPtr);
    SERDES_UNLOCK(devNum, serdesType);
    return rc;
}
...
)
{
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesOperFunc);
    ...
    *resultPtr = 0;
    ...
    if (PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesOperFunc == NULL)
    {
        return GT_OK;
    }
    ...
    #if defined (SSE_ENABLED) && defined (CHX_FAMILY)
        mvHwsSseInvokerSerdesOperation(SSE_ORDER_PRE_E, devNum, portGroup, serdesNum, portMode, operation, dataPtr, resultPtr);
    #endif

    rc = (PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesOperFunc(devNum, portGroup, serdesNum,
                                                                           portMode, operation, dataPtr, resultPtr));

    #if defined (SSE_ENABLED) && defined (CHX_FAMILY)
        mvHwsSseInvokerSerdesOperation(SSE_ORDER_POST_E, devNum, portGroup, serdesNum, portMode, operation, dataPtr, resultPtr);
    #endif
...
#endif
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesDbTxCfgGetFunc(devNum, portGroup, serdesNum, baudRate, dbType, configParamsPtr);
    SERDES_UNLOCK(devNum, serdesType);
...
#endif
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesDbRxCfgGetFunc(devNum, portGroup, serdesNum, baudRate, dbType, configParamsPtr);
    SERDES_UNLOCK(devNum, serdesType);
...
)
{
    ...
    {
        if (COM_PHY_C12GP41P2V_SIP6_30 == serdesInfo->serdesType)   /* not supported */
        {
            *addressPtr = 0x0;
            return;
        }
...
/**
* @internal mvHwsSerdesGrayCodeEnableSet function
* @endinternal
*
...
* @retval 1                        - on error
*/
GT_STATUS mvHwsSerdesGrayCodeEnableSet
(
    IN GT_U8                   devNum,
    IN GT_U32                  serdesNum,
    IN GT_BOOL                 enable
)
{
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesGrayCodeEnableSetFunc);
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesGrayCodeEnableSetFunc(devNum,serdesNum,enable);
    SERDES_UNLOCK(devNum, serdesType);
...
/**
* @internal mvHwsSerdesGrayCodeEnableGet function
* @endinternal
*
* @brief   enable/disable gray code
*
...
* @retval 1                        - on error
*/
GT_STATUS mvHwsSerdesGrayCodeEnableGet
(
    IN  GT_U8                   devNum,
    IN  GT_U32                  serdesNum,
...
)
{
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesGrayCodeEnableGetFunc);
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesGrayCodeEnableGetFunc(devNum,serdesNum,enablePtr);
    SERDES_UNLOCK(devNum, serdesType);
...
/**
* @internal mvHwsSerdesPreCodeEnableSet function
* @endinternal
*
...
* @retval 1                        - on error
*/
GT_STATUS mvHwsSerdesPreCodeEnableSet
(
    IN GT_U8                   devNum,
    IN GT_U32                  serdesNum,
    IN GT_BOOL                 enable
)
{
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesPreCodeEnableSetFunc);
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesPreCodeEnableSetFunc(devNum,serdesNum,enable);
    SERDES_UNLOCK(devNum, serdesType);
...
/**
* @internal mvHwsSerdesPreCodeEnableGet function
* @endinternal
*
* @brief   enable/disable pre code
*
...
* @retval 1                        - on error
*/
GT_STATUS mvHwsSerdesPreCodeEnableGet
(
    IN  GT_U8                   devNum,
    IN  GT_U32                  serdesNum,
    OUT GT_BOOL                 *enablePtr
)
{
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesPreCodeEnableGetFunc);
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesPreCodeEnableGetFunc(devNum,serdesNum,enablePtr);
    SERDES_UNLOCK(devNum, serdesType);
...
#ifndef MV_HWS_REDUCED_BUILD
/**
* @internal mvHwsSerdesBandGapOptimization function
* @endinternal
*
* @brief   reset/unreset core and enable/disable BG Clk bypass
*
* @param[in] devNum                   - system device number
* @param[in] portGroup                - port group (core) number
* @param[in] serdesNum                - serdes number
* @param[in] bgClkBypassEnable        - enable bg clk bypass
* @param[in] bandGapEnable            - enable band gap
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
GT_STATUS mvHwsSerdesBandGapOptimization
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  serdesNum
)
{
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesBandGapOptimizationFunc);
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesBandGapOptimizationFunc(devNum, portGroup, serdesNum);
    SERDES_UNLOCK(devNum, serdesType);
...
/**
* @internal mvHwsSerdesEomMatrixGet function
* @endinternal
*
* @brief   Returns eye values
*
* @param[in] devNum                   - system device number
* @param[in] serdesNum                - serdes number
...
* @retval 1                        - on error
*/
GT_STATUS mvHwsSerdesEomMatrixGet
(
    IN     GT_U8                                devNum,
    IN     GT_U32                               serdesNum,
...
)
{
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesEomMatrixGetFunc);
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesEomMatrixGetFunc(devNum,serdesNum,printEnable,eomInParams,eomOutParams);
    SERDES_UNLOCK(devNum, serdesType);
...
/**
* @internal mvHwsSerdesBandGapOptimizationEnableSet function
* @endinternal
*
* @brief   Enable/Disable band gap WA
*
* @param[in] bgEnable                   - enable = 1/disable = 0
* @param[in] bgClkBypassEnable          - enable = 1/disable = 0
*
* @retval 0                        - on success
* @retval 1                        - on error
*
* @note default : bgEnable = enabled, bgClkBypassEnable = disabled
*/
GT_STATUS mvHwsSerdesBandGapOptimizationEnableSet
(
    GT_BOOL bgEnable,
    GT_BOOL bgClkBypassEnable
)
{
    PRV_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR_GET(serdesBgEnable) = bgEnable;
    PRV_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR_GET(serdesBgClkBypassEnable) = bgClkBypassEnable;
...
/**
* @internal mvHwsSerdesRxInit function
* @endinternal
*
* @brief   execute RX_INIT.
*
* @param[in] devNum                   - system device number
* @param[in] portGroup                - port group (core) number
* @param[in] serdesNum                - physical PCS number
...
*
* @param[out]rxInitStatus             - rx_init status
*
*
* @retval 0                        - on success
* @retval 1                        - on error
...
#if !defined(MV_HWS_FREE_RTOS) || defined(IRONMAN_DEV_SUPPORT) || defined(AC5P_DEV_SUPPORT) || defined(HARRIER_DEV_SUPPORT)
GT_STATUS mvHwsSerdesRxInit
(
    IN  GT_U8                   devNum,
    IN  GT_U32                  portGroup,
    IN  GT_U32                  serdesNum,
    IN  MV_HWS_RX_INIT_MODE     rxInitMode,
    OUT MV_HWS_AUTO_TUNE_STATUS *rxInitStatus
)
{
    GT_STATUS rc;
    MV_HWS_SERDES_TYPE  serdesType;
    ...
    MV_HWS_IS_SERDES_FUNC_IMPLEMENTED_CHECK_AND_RETURN(devNum, serdesType, serdesRxInitFunc);
    SERDES_LOCK(devNum, serdesType);
    rc = PRV_NON_SHARED_SERDES_DIR_SERDES_IF_SRC_GLOBAL_VAR(hwsSerdesFuncsPtr)[devNum][serdesType]->serdesRxInitFunc(devNum,portGroup,serdesNum,rxInitMode,rxInitStatus);
    SERDES_UNLOCK(devNum, serdesType);
    return rc;
}
#endif

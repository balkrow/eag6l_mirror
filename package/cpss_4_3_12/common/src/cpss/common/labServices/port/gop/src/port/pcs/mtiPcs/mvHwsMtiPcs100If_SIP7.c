...
)
{
    ...
    {
        pcsField = AAS_PCS100_CONTROL1_RESET_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0, NULL));

        pcsField = AAS_PCS100_VENDOR_PCS_MODE_HI_BER25_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x0, NULL));

        pcsField = AAS_PCS100_VENDOR_PCS_MODE_HI_BER5_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x0, NULL));

        pcsField = AAS_PCS100_VENDOR_PCS_MODE_DISABLE_MLD_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x1, NULL));

        pcsField = AAS_PCS100_VENDOR_PCS_MODE_ENA_CLAUSE49_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x1, NULL));

        pcsField = AAS_PCS100_VENDOR_VL_INTVL_MARKER_COUNTER_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x3FFF, NULL));
        ...
        pcsField = AAS_PCS100_VL0_0_VL0_0_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x68c1, NULL));

        pcsField = AAS_PCS100_VL0_1_VL0_1_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x21, NULL));

        pcsField = AAS_PCS100_VL1_0_VL1_0_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x719d, NULL));

        pcsField = AAS_PCS100_VL1_1_VL1_1_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x8e, NULL));

        pcsField = AAS_PCS100_VL2_0_VL2_0_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x4b59, NULL));

        pcsField = AAS_PCS100_VL2_1_VL2_1_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0xe8, NULL));

        pcsField = AAS_PCS100_VL3_0_VL3_0_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x954d, NULL));

        pcsField = AAS_PCS100_VL3_1_VL3_1_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x7b, NULL));
    }
    else if (UNRESET == action)
    {
        pcsField = AAS_PCS100_CONTROL1_RESET_E;
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 1, NULL));
    }
    else
    {
...
)
{
    ...
    {
        hwsOsPrintf("mvHwsMtiPcs100Mode: bad MII type for port mode %d\n", portMode);
        return GT_BAD_PARAM;
    }
    ...
    switch(portMode)
    {
        ...
        case HWS_40G_R4_MODE_CASE:
            pcsField = AAS_PCS100_VL0_0_VL0_0_E;
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x7690, NULL));

            pcsField = AAS_PCS100_VL0_1_VL0_1_E;
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x47, NULL));

            pcsField = AAS_PCS100_VL1_0_VL1_0_E;
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0xc4f0, NULL));

            pcsField = AAS_PCS100_VL1_1_VL1_1_E;
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0xe6, NULL));

            pcsField = AAS_PCS100_VL2_0_VL2_0_E;
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x65c5, NULL));

            pcsField = AAS_PCS100_VL2_1_VL2_1_E;
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x9b, NULL));

            pcsField = AAS_PCS100_VL3_0_VL3_0_E;
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x79a2, NULL));

            pcsField = AAS_PCS100_VL3_1_VL3_1_E;
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, 0x3d, NULL));
            break;
    ...
    pcsField = AAS_PCS100_VENDOR_VL_INTVL_MARKER_COUNTER_E;
    CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, phyPortNum, MTI_PCS100_UNIT, pcsField, markerInterval, NULL));
...
)
{
    ...
    pcsField = AAS_PCS100_CONTROL1_LOOPBACK_E;
    data = (lbType == TX_2_RX_LB) ? 1 : 0;
    CHECK_STATUS(genUnitRegisterFieldSet(devNum, portGroup, phyPortNum, MTI_PCS100_UNIT, pcsField, data, NULL));
...
)
{
    ...
    pcsField = AAS_PCS100_CONTROL1_LOOPBACK_E;
    CHECK_STATUS(genUnitRegisterFieldGet(devNum, portGroup, phyPortNum, MTI_PCS100_UNIT, pcsField, &data, NULL));
...
)
{
    ...
    {
        pcsField = AAS_PCS100_BASER_STATUS1_BLOCK_LOCK_E;
        CHECK_STATUS(genUnitRegisterFieldGet(devNum, portGroup, phyPortNum, MTI_PCS100_UNIT, pcsField, &data, NULL));
...
/**
* @internal mvHwsMtiPcs100Rex2RxReset function
* @endinternal
*
* @brief   PCS 100 SD RX RESET/UNRESET action.
*
* @param[in] devNum                   - system device number
* @param[in] portGroup                - port group (core) number
* @param[in] phyPortNum               - MAC number
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsMtiPcs100RxReset
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  phyPortNum,
...
/**
 * @internal mvHwsMtiPcs100RxResetGet function
 * @endinternal
 *
 ...
 * @return GT_STATUS
 */
static GT_STATUS mvHwsMtiPcs100RxResetGet
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  phyPortNum,
...
* @endinternal
*
* @brief   Init MTI PCS100 for SIP7 devices configuration sequences and IF
*          functions.
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
GT_STATUS mvHwsMtiPcs100_SIP7IfInit(MV_HWS_PCS_FUNC_PTRS **funcPtrArray)
{
    ...
    funcPtrArray[MTI_PCS_100]->pcsRxResetFunc   = mvHwsMtiPcs100RxReset;
    funcPtrArray[MTI_PCS_100]->pcsRxResetGetFunc = mvHwsMtiPcs100RxResetGet;

...
typedef struct
{
    ...
    ** [15:15] autoKrEnable
    ** [16:17] 20G R1
    ** [18:18] precoding Enable
    ** [19:19] skip resolution
    ** [20:20] Rx train
    ** [21:21] optical mode
    ** [22:22] signal detect callback enable
    ** [23:31] reserved
    */
    GT_U32 options;
    /*
    ...
    **  */
    ...
    /*
    ** Extended AP parameters
    ** [00:00] External signal detection state (signal status - valid(stable)/not valid)
    ** [01:07] Reserved
    */
    GT_U8  extendedParams;

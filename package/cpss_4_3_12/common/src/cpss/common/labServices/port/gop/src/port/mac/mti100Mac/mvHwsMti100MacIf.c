...
)
{
    ...
    switch (curPortParams.portStandard)
    {
        ...
        case _48GBaseR4:
        case _48GBase_SR4:
            if (/* 106G, 53G */_27_34375G == curPortParams.serdesSpeed || /* 42G */_10_9375G == curPortParams.serdesSpeed || _27_5G == curPortParams.serdesSpeed)
                {
    ...
    */
    ...
    /*
        MTI_MAC_XIF_MODE:
            ...
            Xgmii = 0
    */
    if( HWS_1000BASE_MODE_CHECK(curPortParams.portStandard) || (curPortParams.portStandard == _2500Base_X) || (curPortParams.portStandard == SGMII))
    {

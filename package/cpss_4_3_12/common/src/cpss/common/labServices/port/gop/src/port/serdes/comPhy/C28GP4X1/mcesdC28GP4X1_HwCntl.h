...
********************************************************************/
#ifndef MCESD_C28GP4X1_HWCNTL_H
#define MCESD_C28GP4X1_HWCNTL_H
...
@param[in]  devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call
@param[in]  pin - the selected E_C28GP4X1_PIN to configure
...
#endif /* defined MCESD_C28GP4X1_HWCNTL_H */

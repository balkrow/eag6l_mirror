...
GT_BOOL mvHwsAnpUsedForStaticPort = GT_FALSE;
GT_BOOL mvHwsAnpUseCmdTable = GT_FALSE;

MV_HWS_ANP_PORT_DATA_STC mvHwsAnpPortDB;
GT_U32 mvHwsAnpTimerDisable = 0;
...
typedef enum
{
    MV_HWS_ANP_PROG_SET_MODE_NONE,
    MV_HWS_ANP_PROG_SET_MODE_SINGLE,
    MV_HWS_ANP_PROG_SET_MODE_ALL /* Currently only CH SM PROG state are being supported */
}MV_HWS_ANP_PROG_SET_MODE;

typedef enum
{
    MV_HWS_ANP_CI_LANE_NUM_R1          = 1,
    MV_HWS_ANP_CI_LANE_NUM_R2          = 2,
    MV_HWS_ANP_CI_LANE_NUM_R4          = 4,
    MV_HWS_ANP_CI_LANE_NUM_R8          = 8,
    MV_HWS_ANP_CI_LANE_NUM_ALL         = 0xFF
}MV_HWS_ANP_CI_LANE_NUM;

typedef enum
{
    MV_HWS_ANP_CI_MODE_NON_AP       = 0x0,
    MV_HWS_ANP_CI_MODE_AP           = 0x1,
    MV_HWS_ANP_CI_MODE_NONE         = 0xFF
}MV_HWS_ANP_CI_MODE;

/*CI defs*/
/*TBD - struct per dev when ANP design change*/
typedef enum
{
    MV_HWS_ANP_CI_AC5P_CODE_CTLE                = 0x1,
    MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_ADDR        = 0x10,
    MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_DATA1       = 0x11,
    MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_DATA2       = 0x12,
    MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_MASK1       = 0x13,
    MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_MASK2       = 0x14,
    MV_HWS_ANP_CI_AC5P_CODE_TX_EQ               = 0x17
}MV_HWS_ANP_CI_AC5P_AC5X_CODE;

/*TBD - Add TX/RX code here - currently onlot WR supported*/
typedef enum
{
    MV_HWS_ANP_CI_HARRIER_CODE_WR_ADDR       = 0x0,
    MV_HWS_ANP_CI_HARRIER_CODE_WR_DATA       = 0x1,
    MV_HWS_ANP_CI_HARRIER_CODE_WR_MASK       = 0x2,
}MV_HWS_ANP_CI_AC5P_HARRIER_CODE;


/*AC5P RX Defs*/
#define MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK    0x3
#define MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT   12
typedef enum
{
    MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_INIT       = 0x0,
    MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MIN        = 0x1,
    MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MAX        = 0x2
}MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE;

#define MV_HWS_ANP_CI_AC5P_RX_PARAM_MASK    0xFF
#define MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT   14
typedef enum
{
    MV_HWS_ANP_CI_AC5P_RX_PARAM_RES1        = 0x0,
    MV_HWS_ANP_CI_AC5P_RX_PARAM_CAP1        = 0x1,
    MV_HWS_ANP_CI_AC5P_RX_PARAM_RL2_TUNE    = 0x2,
    MV_HWS_ANP_CI_AC5P_RX_PARAM_CAP2        = 0x3
}MV_HWS_ANP_CI_AC5P_RX_PARAM;

/*AC5P TX Defs*/
#define MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MASK    0x1
#define MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_SHIFT   16
typedef enum
{
    MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MIN_MAX     = 0x0,
    MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_INIT        = 0x1
}MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE;

#define MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK                0x3F
#define MV_HWS_ANP_CI_AC5P_TX_PARAM_SHIFT               12
#define MV_HWS_ANP_CI_AC5P_TX_MAX_PARAM_VALUE_SHIFT     6
typedef enum
{
    MV_HWS_ANP_CI_AC5P_TX_PARAM_PRE2        = 0x0,
    MV_HWS_ANP_CI_AC5P_TX_PARAM_PRE         = 0x1,
    MV_HWS_ANP_CI_AC5P_TX_PARAM_MAIN        = 0x2,
    MV_HWS_ANP_CI_AC5P_TX_PARAM_POST        = 0x3
}MV_HWS_ANP_CI_AC5P_TX_PARAM;

/*AC5X -TX Min/Max reg addr */
#define TX_EM_REG1 0x600C
#define TX_EM_REG2 0x6014
/*AC5X -TX post adapt reg addr */
#define TX_POST_ADAPT_REG_ADDR 0x6058

/*HARRIER WR Defs*/
#define MV_HWS_ANP_CI_HARRIER_WR_CMD    0x2

#define MV_HWS_ANP_TIMER_DISABLE_CNS 0xFFFF


#ifndef MICRO_INIT
#define MAX_DUMP_MESSAGE_LEN 100
#define LAST_MESSAGE 0xFFFF

typedef struct{
    GT_U32 unitNum;
    GT_CHAR message[MAX_DUMP_MESSAGE_LEN];
}MV_HWS_AN_UNIT_DUMP_STC;

static const MV_HWS_AN_UNIT_DUMP_STC mvHwsAC5PAnpDumpArr[]={
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_CONTROL_AN_AP_TRAIN_TYPE_E, "ANP_UNITS_GLOBAL_CONTROL" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_CLOCK_AND_RESET_PWM_SOFT_RESET__E, "ANP_UNITS_GLOBAL_CLOCK_AND_RESET" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_SD_MUX_CONTROL_SD_MUX_CONTROL0_E, "ANP_UNITS_GLOBAL_SD_MUX_CONTROL" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_SD_MUX_CONTROL1_SD_MUX_CONTROL4_E, "ANP_UNITS_GLOBAL_SD_MUX_CONTROL1" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_AN_TRAIN_TYPE_AN_TRAIN_TYPE_MODE_1G_E, "ANP_UNITS_GLOBAL_AN_TRAIN" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_SPEED_TABLE_PM_SPEED_TABLE_1P25G_E, "ANP_UNITS_GLOBAL_SPEED" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_SPEED_TABLE1_PM_SPEED_TABLE_10P3125G_E, "ANP_UNITS_GLOBAL_SPEED_TABLE1" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_SPEED_TABLE2_PM_SPEED_TABLE_56G_E, "ANP_UNITS_GLOBAL_SPEED_TABLE2" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_INTERRUPT_CAUSE_GLOBAL_INT_SUM_E, "ANP_UNITS_GLOBAL_INTERRUPT" },
    { (GT_U32)HAWK_ANP_UNITS_INTERRUPT_SUMMARY_CAUSE_INTERRUPT_CAUSE_INT_SUM_E, "ANP_UNITS_INTERRUPT" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_CONTROL2_REG_PU_TX_CONF_DELAY_E, "ANP_UNITS_GLOBAL_CONTROL2" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_CONTROL3_REG_NO_PRE_SELECTOR_E, "ANP_UNITS_GLOBAL_CONTROL3" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_CONTROL4_REG_SD_DFE_UPDATE_DIS_SAMP_E, "ANP_UNITS_GLOBAL_CONTROL4" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_INTERRUPT_CAUSE_P0_PORT_INT_SUM_E, "ANP_UNITS_PORT0_INTERRUPT" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_SERDES_TX_SM_CONTROL_P0_SD_TX_SM_OVERRIDE_CTRL_E, "ANP_UNITS_PORT0_SERDES_TX_SM" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_AN_CONTROL_P0_PHY_GEN_AP_OW_E, "ANP_UNITS_PORT0_AN_CONTROL" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_AN_TIED_IN_P0_PM_AP_ANEG_REMOTE_READY_S_E, "ANP_UNITS_PORT0_AN_TIED_IN" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_AN_HANG_OUT_P0_AP_IRQ_S_E, "ANP_UNITS_PORT0_AN_HANG_OUT" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_AN_STATUS1_P0_AP_PWRUP_4X_S_E, "ANP_UNITS_PORT0_AN_STATUS1" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_AN_STATUS2_P0_AP_AA_CLEAR_HCD_S_E, "ANP_UNITS_PORT0_AN_STATUS2" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL_P0_PORT_MODE_E, "ANP_UNITS_PORT0_CONTROL" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL1_P0_RG_MODE_50GR_OW_E, "ANP_UNITS_PORT0_CONTROL1" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL2_P0_PM_SD_PHY_GEN_TX_OW_E, "ANP_UNITS_PORT0_CONTROL2" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL3_P0_PM_PCS_COUPLE_OW_E, "ANP_UNITS_PORT0_CONTROL3" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL4_P0_PM_AP_EN_S_OW_E, "ANP_UNITS_PORT0_CONTROL4" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL5_P0_PM_RX_TRAIN_ENABLE_OW_E, "ANP_UNITS_PORT0_CONTROL5" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL6_P0_PM_PCS_RX_CLK_ENA_OW_E, "ANP_UNITS_PORT0_CONTROL6" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL7_P0_PLL_READY_RX_CLEAN_OW_E, "ANP_UNITS_PORT0_CONTROL7" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL8_P0_PM_TRAIN_TYPE_OW_E, "ANP_UNITS_PORT0_CONTROL8" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL9_P0_INT_ENABLED_OW_VAL_E, "ANP_UNITS_PORT0_CONTROL9" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL10_P0_PM_PU_RX_REQ_S_OW_E, "ANP_UNITS_PORT0_CONTROL10" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_CONTROL11_P0_PU_RX_BOTH_IN_IDLE_E, "ANP_UNITS_PORT0_CONTROL11" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_STATUS_P0_REG_TX_TRAIN_COMPLETE_E, "ANP_UNITS_PORT0_STATUS" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_STATUS1_P0_STAT_DSP_RXSTR_REQ_MX_S_E, "ANP_UNITS_PORT0_STATUS1" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_STATUS2_P0_STAT_PM_MODE_50GR2_E, "ANP_UNITS_PORT0_STATUS2" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_STATUS3_P0_STAT_PM_SD_PU_TX_S_E, "ANP_UNITS_PORT0_STATUS3" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_STATUS4_P0_STAT_PM_SD_TX_IDLE_S_E, "ANP_UNITS_PORT0_STATUS4" },
    { (GT_U32)HAWK_ANP_UNITS_PORT0_STATUS5_P0_STAT_PM_CMEM_ADDR_S_E, "ANP_UNITS_PORT0_STATUS5" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_SD_TX_IDLE_MIN_WAIT_REG_TX_IDLE_MIN_WAIT_S_E, "Global_SD_TX_Idle_min_wait" },
    { (GT_U32)HAWK_ANP_UNITS_GLOBAL_SD_RX_IDLE_MIN_WAIT_REG_RX_IDLE_MIN_WAIT_S_E, "Global_SD_RX_Idle_min_wait" },
    { (GT_U32)LAST_MESSAGE, "Empty"}

};

static const MV_HWS_AN_UNIT_DUMP_STC mvHwsHarrierAnpDumpArr[]={
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_CONTROL_AN_AP_TRAIN_TYPE_E, "ANP_UNITS_GLOBAL_CONTROL" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_CLOCK_AND_RESET_PWM_SOFT_RESET__E, "ANP_UNITS_GLOBAL_CLOCK_AND_RESET" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_SD_MUX_CONTROL_SD_MUX_CONTROL0_E, "ANP_UNITS_GLOBAL_SD_MUX_CONTROL" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_SD_MUX_CONTROL1_SD_MUX_CONTROL4_E, "ANP_UNITS_GLOBAL_SD_MUX_CONTROL1" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_AN_TRAIN_TYPE_AN_TRAIN_TYPE_MODE_1G_E, "ANP_UNITS_GLOBAL_AN_TRAIN" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_SPEED_TABLE_PM_SPEED_TABLE_1P25G_E, "ANP_UNITS_GLOBAL_SPEED" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_SPEED_TABLE1_PM_SPEED_TABLE_10P3125G_E, "ANP_UNITS_GLOBAL_SPEED_TABLE1" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_SPEED_TABLE2_PM_SPEED_TABLE_56G_E, "ANP_UNITS_GLOBAL_SPEED_TABLE2" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_INTERRUPT_CAUSE_GLOBAL_INT_SUM_E, "ANP_UNITS_GLOBAL_INTERRUPT" },
    {(GT_U32)HARRIER_ANP_UNITS_INTERRUPT_SUMMARY_CAUSE_INTERRUPT_CAUSE_INT_SUM_E, "ANP_UNITS_INTERRUPT" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_CONTROL2_REG_PU_TX_CONF_DELAY_E, "ANP_UNITS_GLOBAL_CONTROL2" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_CONTROL3_REG_NO_PRE_SELECTOR_E, "ANP_UNITS_GLOBAL_CONTROL3" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_CONTROL4_REG_SD_DFE_UPDATE_DIS_SAMP_E, "ANP_UNITS_GLOBAL_CONTROL4" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_INTERRUPT_CAUSE_P0_PORT_INT_SUM_E, "ANP_UNITS_PORT0_INTERRUPT" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_SERDES_TX_SM_CONTROL_P0_SD_TX_SM_OVERRIDE_CTRL_E, "ANP_UNITS_PORT0_SERDES_TX_SM" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_AN_CONTROL_P0_PHY_GEN_AP_OW_E, "ANP_UNITS_PORT0_AN_CONTROL" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_AN_TIED_IN_P0_PM_AP_ANEG_REMOTE_READY_S_E, "ANP_UNITS_PORT0_AN_TIED_IN" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_AN_HANG_OUT_P0_AP_IRQ_S_E, "ANP_UNITS_PORT0_AN_HANG_OUT" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_AN_STATUS1_P0_AP_PWRUP_4X_S_E, "ANP_UNITS_PORT0_AN_STATUS1" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_AN_STATUS2_P0_AP_AA_CLEAR_HCD_S_E, "ANP_UNITS_PORT0_AN_STATUS2" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL_P0_PORT_MODE_E, "ANP_UNITS_PORT0_CONTROL" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL1_P0_RG_MODE_50GR_OW_E, "ANP_UNITS_PORT0_CONTROL1" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL2_P0_PM_SD_PHY_GEN_TX_OW_E, "ANP_UNITS_PORT0_CONTROL2" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL3_P0_PM_PCS_COUPLE_OW_E, "ANP_UNITS_PORT0_CONTROL3" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL4_P0_PM_AP_EN_S_OW_E, "ANP_UNITS_PORT0_CONTROL4" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL5_P0_PM_RX_TRAIN_ENABLE_OW_E, "ANP_UNITS_PORT0_CONTROL5" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL6_P0_PM_PCS_RX_CLK_ENA_OW_E, "ANP_UNITS_PORT0_CONTROL6" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL7_P0_PLL_READY_RX_CLEAN_OW_E, "ANP_UNITS_PORT0_CONTROL7" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL8_P0_PM_TRAIN_TYPE_OW_E, "ANP_UNITS_PORT0_CONTROL8" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL9_P0_INT_ENABLED_OW_VAL_E, "ANP_UNITS_PORT0_CONTROL9" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL10_P0_PM_PU_RX_REQ_S_OW_E, "ANP_UNITS_PORT0_CONTROL10" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_CONTROL11_P0_PU_RX_BOTH_IN_IDLE_E, "ANP_UNITS_PORT0_CONTROL11" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_STATUS_P0_REG_TX_TRAIN_COMPLETE_E, "ANP_UNITS_PORT0_STATUS" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_STATUS1_P0_STAT_DSP_RXSTR_REQ_MX_S_E, "ANP_UNITS_PORT0_STATUS1" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_STATUS2_P0_STAT_PM_MODE_50GR2_E, "ANP_UNITS_PORT0_STATUS2" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_STATUS3_P0_STAT_PM_SD_PU_TX_S_E, "ANP_UNITS_PORT0_STATUS3" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_STATUS4_P0_STAT_PM_SD_TX_IDLE_S_E, "ANP_UNITS_PORT0_STATUS4" },
    {(GT_U32)HARRIER_ANP_UNITS_PORT0_STATUS5_P0_STAT_PM_CMEM_ADDR_S_E, "ANP_UNITS_PORT0_STATUS5" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_SD_TX_IDLE_MIN_WAIT_REG_TX_IDLE_MIN_WAIT_S_E, "Global_SD_TX_Idle_min_wait" },
    {(GT_U32)HARRIER_ANP_UNITS_GLOBAL_SD_RX_IDLE_MIN_WAIT_REG_RX_IDLE_MIN_WAIT_S_E, "Global_SD_RX_Idle_min_wait" },
    {(GT_U32)LAST_MESSAGE, "Empty"}

};

static const MV_HWS_AN_UNIT_DUMP_STC mvHwsAC5XAnpDumpArr[]={
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_CONTROL_AN_AP_TRAIN_TYPE_E, "ANP_UNITS_GLOBAL_CONTROL" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_CLOCK_AND_RESET_PWM_SOFT_RESET__E, "ANP_UNITS_GLOBAL_CLOCK_AND_RESET" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_SD_MUX_CONTROL_SD_MUX_CONTROL0_E, "ANP_UNITS_GLOBAL_SD_MUX_CONTROL" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_SD_MUX_CONTROL1_SD_MUX_CONTROL4_E, "ANP_UNITS_GLOBAL_SD_MUX_CONTROL1" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_AN_TRAIN_TYPE_AN_TRAIN_TYPE_MODE_1G_E, "ANP_UNITS_GLOBAL_AN_TRAIN" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_SPEED_TABLE_PM_SPEED_TABLE_1P25G_E, "ANP_UNITS_GLOBAL_SPEED" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_SPEED_TABLE1_PM_SPEED_TABLE_10P3125G_E, "ANP_UNITS_GLOBAL_SPEED_TABLE1" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_SPEED_TABLE2_PM_SPEED_TABLE_56G_E, "ANP_UNITS_GLOBAL_SPEED_TABLE2" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_INTERRUPT_CAUSE_GLOBAL_INT_SUM_E, "ANP_UNITS_GLOBAL_INTERRUPT" },
    { (GT_U32)PHOENIX_ANP_UNITS_INTERRUPT_SUMMARY_CAUSE_INTERRUPT_CAUSE_INT_SUM_E, "ANP_UNITS_INTERRUPT" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_CONTROL2_REG_PU_TX_CONF_DELAY_E, "ANP_UNITS_GLOBAL_CONTROL2" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_CONTROL3_REG_NO_PRE_SELECTOR_E, "ANP_UNITS_GLOBAL_CONTROL3" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_CONTROL4_REG_SD_DFE_UPDATE_DIS_SAMP_E, "ANP_UNITS_GLOBAL_CONTROL4" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_INTERRUPT_CAUSE_P0_PORT_INT_SUM_E, "ANP_UNITS_PORT0_INTERRUPT" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_SERDES_TX_SM_CONTROL_P0_SD_TX_SM_OVERRIDE_CTRL_E, "ANP_UNITS_PORT0_SERDES_TX_SM" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_AN_CONTROL_P0_PHY_GEN_AP_OW_E, "ANP_UNITS_PORT0_AN_CONTROL" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_AN_TIED_IN_P0_PM_AP_ANEG_REMOTE_READY_S_E, "ANP_UNITS_PORT0_AN_TIED_IN" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_AN_HANG_OUT_P0_AP_IRQ_S_E, "ANP_UNITS_PORT0_AN_HANG_OUT" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_AN_STATUS1_P0_AP_PWRUP_4X_S_E, "ANP_UNITS_PORT0_AN_STATUS1" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_AN_STATUS2_P0_AP_AA_CLEAR_HCD_S_E, "ANP_UNITS_PORT0_AN_STATUS2" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL_P0_PORT_MODE_E, "ANP_UNITS_PORT0_CONTROL" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL1_P0_RG_MODE_50GR_OW_E, "ANP_UNITS_PORT0_CONTROL1" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL2_P0_PM_SD_PHY_GEN_TX_OW_E, "ANP_UNITS_PORT0_CONTROL2" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL3_P0_PM_PCS_COUPLE_OW_E, "ANP_UNITS_PORT0_CONTROL3" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL4_P0_PM_AP_EN_S_OW_E, "ANP_UNITS_PORT0_CONTROL4" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL5_P0_PM_RX_TRAIN_ENABLE_OW_E, "ANP_UNITS_PORT0_CONTROL5" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL6_P0_PM_PCS_RX_CLK_ENA_OW_E, "ANP_UNITS_PORT0_CONTROL6" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL7_P0_PLL_READY_RX_CLEAN_OW_E, "ANP_UNITS_PORT0_CONTROL7" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL8_P0_PM_TRAIN_TYPE_OW_E, "ANP_UNITS_PORT0_CONTROL8" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL9_P0_INT_ENABLED_OW_VAL_E, "ANP_UNITS_PORT0_CONTROL9" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL10_P0_PM_PU_RX_REQ_S_OW_E, "ANP_UNITS_PORT0_CONTROL10" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_CONTROL11_P0_PU_RX_BOTH_IN_IDLE_E, "ANP_UNITS_PORT0_CONTROL11" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_STATUS_P0_REG_TX_TRAIN_COMPLETE_E, "ANP_UNITS_PORT0_STATUS" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_STATUS1_P0_STAT_DSP_RXSTR_REQ_MX_S_E, "ANP_UNITS_PORT0_STATUS1" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_STATUS2_P0_STAT_PM_MODE_50GR2_E, "ANP_UNITS_PORT0_STATUS2" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_STATUS3_P0_STAT_PM_SD_PU_TX_S_E, "ANP_UNITS_PORT0_STATUS3" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_STATUS4_P0_STAT_PM_SD_TX_IDLE_S_E, "ANP_UNITS_PORT0_STATUS4" },
    { (GT_U32)PHOENIX_ANP_UNITS_PORT0_STATUS5_P0_STAT_PM_CMEM_ADDR_S_E, "ANP_UNITS_PORT0_STATUS5" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_SD_TX_IDLE_MIN_WAIT_REG_TX_IDLE_MIN_WAIT_S_E, "Global_SD_TX_Idle_min_wait" },
    { (GT_U32)PHOENIX_ANP_UNITS_GLOBAL_SD_RX_IDLE_MIN_WAIT_REG_RX_IDLE_MIN_WAIT_S_E, "Global_SD_RX_Idle_min_wait" },
    { (GT_U32)LAST_MESSAGE, "Empty"}

};

static const MV_HWS_AN_UNIT_DUMP_STC mvHwsAnDumpArr[]={
    { (GT_U32)AN_UNITS_REG_802_3AP_AUTO_NEGOTIATION_CONTROL_CONTROL_RESERVED_E, "AN_UNITS_REG_802_3AP_AUTO_NEGOTIATION_CONTROL" },
    { (GT_U32)AN_UNITS_REG_802_3AP_AUTO_NEGOTIATION_STATUS_LINK_PARTNER_AUTO_NEGOTIATION_ABILITY_E, "AN_UNITS_REG_802_3AP_AUTO_NEGOTIATION_STATUS" },
    { (GT_U32)AN_UNITS_REG_802_3AP_LINK_PARTNER_BASE_PAGE_ABILITY_REGISTER_1_LP_SELECTOR_FIELD_E, "AN_UNITS_REG_802_3AP_LINK_PARTNER_BASE_PAGE_ABILITY_REGISTER_1" },
    { (GT_U32)AN_UNITS_REG_802_3AP_NEXT_PAGE_TRANSMIT_REGISTER_EXTENDED_NEXT_PAGE_TRANSMIT_REGISTER_LD_NP_MESSAGEUNFORMATTED_FIELD_E, "AN_UNITS_REG_802_3AP_NEXT_PAGE_TRANSMIT_REGISTER_EXTENDED_NEXT_PAGE_TRANSMIT" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_0_OVERRIDE_CTRL_S_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_0" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_1_AG_LGTH_MATCH_CNT_S3_0_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_1" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_2_CLEAR_HCD_OW_S_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_2" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_3_REG3_RESERVED_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_3" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_4_AA_PWRUP_G_S_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_4" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_5_AA_PWRUP_200GRCR4_S_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_5" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_6_OW_PM_NORM_X_STATE_S_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_6" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_7_RG_LOSTLOCK_VALUE_S_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_7" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_8_DET_DATA_TIMER_WINDOW_SELECT__E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_8" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_9_SW_AG_MODE_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_9" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_10_ADVERTISED_CON25GKRCR_LOCATION_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_10" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_11_REG11_RESERVED_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_11" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_12_REG12_RESERVED_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_12" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_13_AP_INTERRUPT_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_13" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_14_ADVERTISED_200G_R8_MARVELL_MODE_A15_TO_A22_BIT_LOCATION_SELECT_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_14" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_15_PM_NORM_X_STATE_S_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_15" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_16_CONSORTIUM_MP5_REGISTER_0_REG16_MESSAGEUNFORMATTED_FIELD_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_16" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_17_CONSORTIUM_MP5_REGISTER_1_REG17_OUI_23_13_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_17" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_18_CONSORTIUM_MP5_REGISTER_2_REG18_OUI_12_2_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_18" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_19_CONSORTIUM_ET_REGISTER_0_REG19_MESSAGEUNFORMATTED_FIELD_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_19" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_20_CONSORTIUM_ET_REGISTER_1_REG20_RESERVED_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_20" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_21_CONSORTIUM_ET_REGISTER_2_REG21_MARVELL_CONSORTIUM_40GR2_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_21" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_22_LINK_PARTNER_CONSORTIUM_MP5_REGISTER_0_REG22_MESSAGEUNFORMATTED_FIELD_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_22" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_23_LINK_PARTNER_CONSORTIUM_MP5_REGISTER_1_REG23_OUI_23_13_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_23" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_24_LINK_PARTNER_CONSORTIUM_MP5_REGISTER_2_REG24_OUI_12_2_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_24" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_25_LINK_PARTNER_CONSORTIUM_ET_REGISTER_0_REG25_MESSAGEUNFORMATTED_FIELD_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_25" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_26_LINK_PARTERN_CONSORTIUM_ET_REGISTER_1_REG26_RESERVED_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_26" },
    { (GT_U32)AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_27_LINK_PARTNER_CONSORTIUM_ET_REGISTER_2_REG27_RESERVED1_E, "AN_UNITS_ANEG_LANE_0_CONTROL_REGISTER_27" },
    { (GT_U32)LAST_MESSAGE, "Empty"}
};
...
#define ANP_INFO_DB_ARRAY_SIZE 8
#define GET_ALL_PORTS 0xFFFF
#define MV_HWS_ANP_GET_ANP_REG_ADDR(baseAddr, fieldReg, convertIdx) \
    (baseAddr + fieldReg.regOffset + fieldReg.offsetFormula * convertIdx.ciderIndexInUnit)
...
)
{
    ...
    if (GT_OK != mvHwsGlobalMacToLocalIndexConvert(devNum, phyPortNum, portMode, &convertIdx))
    {
        return GT_BAD_PARAM;
    }
...
{
    PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum][portNum] = trainingMode;
    return GT_OK;
}
...
{
    PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum][portNum] = isStaticOverAnp;
    return GT_OK;
}
...
)
{
    ...
    *isANPStaticPtr = PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum][portNum];
    return GT_OK;
}
...
{
    PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum][portNum] = useCmdTable;
    return GT_OK;
}
...
{
    return PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum][portNum];
}
...
)
{
    ...
    if (NULL != PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum])
    {
        hwsOsFreeFuncPtr(PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum]);
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum] = NULL;
    }
    if (NULL != PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum])
    {
        hwsOsFreeFuncPtr(PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum]);
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum] = NULL;
    }
    if (NULL != PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum])
    {
        hwsOsFreeFuncPtr(PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum]);
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum] = NULL;
    }
    return GT_OK;
}
...
)
{
    ...
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum] = (GT_BOOL *)cpssOsMalloc(sizeof(GT_BOOL)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum] = (GT_BOOL *)cpssOsMalloc(sizeof(GT_BOOL)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum] = (MV_HWS_ANP_PORT_TRAINING_MODE_ENT *)cpssOsMalloc(sizeof(MV_HWS_ANP_PORT_TRAINING_MODE_ENT)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
#else
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpPortParamPtr[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpPortParamPtr[devNum] = (MV_HWS_AP_CFG *)hwsOsMallocFuncPtr(sizeof(MV_HWS_AP_CFG)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpPortMiscParamDbPtr[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpPortMiscParamDbPtr[devNum] = (MV_HWS_ANP_MISC_PARAM_STC *)hwsOsMallocFuncPtr(sizeof(MV_HWS_ANP_MISC_PARAM_STC)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpCmdIntLineIdxPtr[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpCmdIntLineIdxPtr[devNum] = (GT_U32 *)hwsOsMallocFuncPtr(sizeof(GT_U32)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpSkipResetPtr[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpSkipResetPtr[devNum] = (GT_BOOL *)hwsOsMallocFuncPtr(sizeof(GT_BOOL)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum] = (GT_BOOL *)hwsOsMallocFuncPtr(sizeof(GT_BOOL)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum] = (GT_BOOL *)hwsOsMallocFuncPtr(sizeof(GT_BOOL)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum] == NULL )
    {
        PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum] = (MV_HWS_ANP_PORT_TRAINING_MODE_ENT *)hwsOsMallocFuncPtr(sizeof(MV_HWS_ANP_PORT_TRAINING_MODE_ENT)*(hwsDeviceSpecInfo[devNum].portsNum));
    }
#endif
    ...
    hwsOsMemSetFuncPtr(PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpIsStaticPortOverAnpPtr[devNum], 0, sizeof(GT_BOOL) * (hwsDeviceSpecInfo[devNum].portsNum));
    hwsOsMemSetFuncPtr(PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpUseCmdTablePtr[devNum], 0, sizeof(GT_BOOL)*(hwsDeviceSpecInfo[devNum].portsNum));
    hwsOsMemSetFuncPtr(PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum], MV_HWS_ANP_PORT_RX_TRAINING_E, sizeof(MV_HWS_ANP_PORT_TRAINING_MODE_ENT)*(hwsDeviceSpecInfo[devNum].portsNum));
        ...
        for(portNum = 0; portNum < hwsDeviceSpecInfo[devNum].portsNum; portNum++)
        {
...
#endif
            {
                if (GT_OK == hwsPortModeParamsGetToBuffer(devNum, 0, portNum, _10GBase_KR, &curPortParams))
                {
                    ...
                    unitIdArr[0] = (portNum%2) ? (LAST_UNIT) : (ANP_400_UNIT);
#endif
                }
            ...
            else if((portNum >= 52) && (portNum <= 100))
            {
                if((portNum%26 <= 2) || (((portNum%26) % 4) == 2))
                    unitIdArr[0] = ANP_400_UNIT;
            }
            else if((portNum%26 <= 2) || ((portNum%26) % 4) == 2)
            {
                unitIdArr[0] = ANP_400_UNIT;
                if(((portNum%26)%4) == 2 )
                {
            ...
            for(i = 0; i < 2; i++)
            {
                if (unitIdArr[i] != LAST_UNIT)
                {
                    ...
                    CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0,  portNum, unitIdArr[i], field, regValue, NULL));
...
#if 0 /*Move to Ironman ANP*/
    GT_U32 unitAddr;

    /* For Ironman there is no PWM - so only SW should access the Serdes */
    if (HWS_DEV_SILICON_TYPE(devNum) == Ironman)
    {
...
#if 0
GT_STATUS mvHwsIronmanAnpMuxRegDump
(
    void
)
{
    ...
    GT_U32  portNum;
    MV_HWS_UNITS_ID unitId;
    MV_HWS_IRONMAN_ANP_UNITS anpRegName = IRONMAN_ANP_UNIT_GLOBAL_SD_MUX_CONTROL_SD_MUX_CONTROL0_E;

    cpssOsPrintf("*************** ANP HW *****************\n");
    for (portNum = 0; portNum < hwsDeviceSpecInfo[0].portsNum; portNum++)
    {
        switch(portNum)
        {
            case (0 + 0 * 8):
        ...
        if(mvHwsMtipIsReducedPort(0, portNum))
        {
            unitId = ANP_CPU_UNIT;
        }
        else if (mvHwsUsxModeCheck(0, portNum, _10GBase_KR))
        {
            unitId = ANP_USX_UNIT;
        }
        else
        ...
        CHECK_STATUS(genUnitRegisterFieldGet(0, 0, portNum,     unitId,     anpRegName,  &fieldData, NULL));
        hwsOsPrintf("portNum[%d]: IRONMAN_ANP_UNIT_GLOBAL_SD_MUX_CONTROL_SD_MUX_CONTROL0_E base: value: 0x%x\n", portNum, fieldData);
    }
    hwsOsPrintf("\n");
    for (portNum = 0; portNum < hwsDeviceSpecInfo[0].portsNum; portNum++)
    {
...
)
{
    ...
    GT_U32 anpRegName,anpSwapRegName;
    GT_STATUS       rc;
    ...
    GT_BOOL doTraining = GT_TRUE;
    MV_HWS_ANP_PORT_TRAINING_MODE_ENT trainingMode;
#ifndef HARRIER_DEV_SUPPORT
    MV_HWS_PORT_IN_GROUP_ENT portFullConfig;
    GT_U32 hawkLocalIndexArr[8]    = {0,1,2,6,10,14,18,22};
    MV_HWS_PORT_IN_GROUP_ENT isLast;
#endif
    GT_U32 nextPortShift;
    MV_HWS_SERDES_CONFIG_STC serdesConfig;
    MV_HWS_PORT_IN_GROUP_ENT isFirst;
    ...
    mvHwsAnpGetStaticPort(devNum,portNum,&isANPStatic);
    if(((apEnable == GT_FALSE) && (enable == GT_TRUE) && (isANPStatic == GT_FALSE))
#ifndef  MV_HWS_FREE_RTOS
    ...
    for (laneIdx = 0; laneIdx < curPortParams.numOfActLanes; laneIdx++)
    {
        ...
        /*
        We face Harrier 400 R8 multiple FEC errors in 1/~300 cycles.
        The failure happens at cold and hot conditions and high SD voltage.
        After stopping the system at failing cycle we see that on port receiving multiple packets even if TG traffic stopped.
        WA is to change "parallel timer"(rg_txrx_min_timer) >1.7 sec. WA should be removed when real root cause is found
        */
        if((HWS_DEV_SILICON_TYPE(devNum) == Harrier)) 
        {
            GT_U32 timerRegValue = 0x0000061A; /* default value - SAR register, it depends on the clock of REG domain of the chip - This is constant */
            field = HARRIER_ANP_UNITS_PORT0_CH_TXRX_MIN_TIMER_P0_RG_TXRX_MIN_TIMER_E;
            if (enable == GT_TRUE)
            {
                /* issue is not relevant to SR_LR mode and non AN */
                if ((apEnable == GT_TRUE) && ((portMode == _400GBase_KR8) || (portMode == _400GBase_CR8)))
                {                    
                    timerRegValue = 0x12A05F20;
                }
            }
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0,  portNum+nextPortShift, unitId, field, timerRegValue, NULL));            
        }
    }
    if ((apEnable == GT_FALSE) && (isANPStatic))
    {
        if (GT_OK != hwsPortModeParamsGetToBuffer(devNum, 0, portNum, portMode, &curPortParams))
        {
            return GT_BAD_PTR;
...
#ifndef MICRO_INIT /*Need to fix when MI support Static over ANP on Harrier*/
        if((HWS_DEV_SILICON_TYPE(devNum) == Harrier))
        {
            ...
            if (serdesRefClockGetFunc != NULL)
            {
                ...
                serdesConfig.refClock = (MV_HWS_REF_CLOCK)serdesRefClock;

                if(serdesRefClock == MHz_156)
                {
                    serdesConfig.refClockSource = SECONDARY;
                }
                else if(serdesRefClock == MHz_25)
                {
        ...
        if ( enable )
        {
            ...
            {
                isFirst = MV_HWS_PORT_IN_GROUP_FIRST_E;
            }
            if(isFirst == MV_HWS_PORT_IN_GROUP_FIRST_E)
            {
        ...
        {
            trainingMode = PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpStaticOverAnpTrainingMode[devNum][portNum];
            field = mvHwsAnpFieldSet(devNum,
                                     HAWK_ANP_UNITS_PORT0_CONTROL8_P0_PM_TRAIN_TYPE_OW_E,
                                     HARRIER_ANP_UNITS_PORT0_CONTROL8_P0_PM_TRAIN_TYPE_OW_E,
                                     PHOENIX_ANP_UNITS_PORT0_CONTROL8_P0_PM_TRAIN_TYPE_OW_E);
            ...
            field = mvHwsAnpFieldSet(devNum,
                                     ...
                                     HARRIER_ANP_UNITS_PORT0_CONTROL8_P0_PM_TRAIN_TYPE_OW_VAL_E,
                                     PHOENIX_ANP_UNITS_PORT0_CONTROL8_P0_PM_TRAIN_TYPE_OW_VAL_E);
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0,  portNum, unitId, field, trainingMode, NULL));
        }
    }
...
#ifndef HARRIER_DEV_SUPPORT
    if(GT_OK != hwsPortModeParamsGetToBuffer(devNum, 0, phyPortNum, LAST_PORT_MODE, &curPortParams))
    {
        return GT_BAD_PARAM;
    }
    portMode = curPortParams.portStandard;
...
)
{
   ...
   /* case (1<<16):
    ...
    if(CPSS_DEV_IS_WM_NATIVE_OR_ASIM_MAC(devNum))
    {
        ...
        /* the function already support non-AP port , so not need WM to add
           additional logic for 'AP' that not exists in WM */
        CHECK_STATUS(mvHwsPortFecCofigGet(devNum, 0/*portGroupId*/, phyPortNum, resolution/*portMode*/,
            &fecMode));
...
#ifndef  MV_HWS_FREE_RTOS
/**
* @internal mvHwsAnpPrintDebugInfo function
* @endinternal
*
* @brief   Print format to desired output
*
* @param[in] output          The output type.
* @param[in] format          Describes the format to use.
* @param[in] ...             The ...
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
static GT_VOID mvHwsAnpPrintDebugInfo
(
    IN MV_HWS_AP_DEBUG_LOG_OUTPUT_ENT   output,
    IN const GT_CHAR                    *format,
    IN                                  ...
)
{
    GT_U32 len;
    va_list args;
    GT_CHAR buffer[2 * MAX_LINE_LEN] = {0};

    va_start(args, format);
    len = hwsVsnprintf(buffer, sizeof(buffer), format, args);
    buffer[MIN(len, (2 * MAX_LINE_LEN) - 1)] = '\0';
    va_end(args);
...
/**
* @internal mvHwsAnpPrintPortCountersInfo function
* @endinternal
*
* @brief  Print ANP port counters information to desire output
*
* @param[in] numOfLanes            - number of serdes lanes
* @param[in] phyPortNum            - physical port number
* @param[in] anpInfoDb             - AnP DB
* @param[in] output                - output type
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
static GT_STATUS mvHwsAnpPrintPortCountersInfo
(
    IN  GT_U32                                      numOfLanes,
    IN  GT_U32                                      phyPortNum,
    IN  MV_HWS_ANP_INFO_STC                         *anpInfoDb,
    IN  MV_HWS_AP_DEBUG_LOG_OUTPUT_ENT              output
)
{
    GT_U32 i = 0;

    mvHwsAnpPrintDebugInfo(output, "\nPort %d counters \n", phyPortNum);

    mvHwsAnpPrintDebugInfo(output,
                "%-6s%-12s%-12s%-12s%-10s%-15s%-16s%-9s%-14s%-14s%-10s%-15s\n",
                  "anRst", "dspLockFail", "linkFailCnt",
                  "txTrainFail", "txTrainOk", "txTrainTimeout",
                  "txTrainDuration", "rxInitOk", "rxInitTimeOut",
                  "rxTrainFailed", "rxTrainOk", "rxTrainTimeOut");

    for (i = 0; i < numOfLanes; i++)
    {
        mvHwsAnpPrintDebugInfo(output, "L%d:", i);
        mvHwsAnpPrintDebugInfo(output, "%-6d%-12d%-12d%-12d%-10d%-15d%-16d",
                            anpInfoDb[i].portConters.anRestartCounter,
                            anpInfoDb[i].portConters.dspLockFailCounter,
                            anpInfoDb[i].portConters.linkFailCounter,
                            anpInfoDb[i].portConters.txTrainFailCounter,
                            anpInfoDb[i].portConters.txTrainOkCounter,
                            anpInfoDb[i].portConters.txTrainTimeoutCounter,
                            anpInfoDb[i].portConters.txTrainDuration);

        mvHwsAnpPrintDebugInfo(output, "%-9d%-14d%-14d%-10d%-15d\n",
                            anpInfoDb[i].portConters.rxInitOk,
                            anpInfoDb[i].portConters.rxInitTimeOut,
                            anpInfoDb[i].portConters.rxTrainFailed,
                            anpInfoDb[i].portConters.rxTrainOk,
                            anpInfoDb[i].portConters.rxTrainTimeOut);
    }
...
/**
* @internal mvHwsAnpGetAndPrintStateMachineInfo function
* @endinternal
*
* @brief  Print ANP port counters information to desire output
*
...
* @param[in] anpInfoDb             - AnP DB
* @param[in] portMode              - Port mode
* @param[in] output                - Output Print type
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
static GT_STATUS mvHwsAnpGetAndPrintStateMachineInfo
(
    IN  GT_U8                                       devNum,
    IN  GT_U32                                      numOfLanes,
    IN  GT_U32                                      phyPortNum,
...
{
    GT_U32                      i = 0, nextPortShift = 0, value, fieldName;
    MV_HWS_UNITS_ID             unitId;
    ...
    mvHwsAnpPrintDebugInfo(output,
                "%-13s\t%-13s\t%-14s\n",
                "CH FSM State", "TX FSM State", "RX FSM State:");

    mvHwsAnpPrintDebugInfo(output,
                "%-13s", ch_fsm_states[anpInfoDb->portSm.chSmState]);

    for (i = 0; i < numOfLanes; i++)
    {
        mvHwsAnpNextPortShiftGet(devNum, phyPortNum, portMode, i, &nextPortShift);

        fieldName = mvHwsAnpFieldSet(devNum,
                        HAWK_ANP_UNITS_PORT0_SERDES_TX_SM_CONTROL_P0_SD_TX_SM_STATE_E,
                        HARRIER_ANP_UNITS_PORT0_SERDES_TX_SM_CONTROL_P0_SD_TX_SM_STATE_E,
                        PHOENIX_ANP_UNITS_PORT0_SERDES_TX_SM_CONTROL_P0_SD_TX_SM_STATE_E);
        CHECK_STATUS(genUnitRegisterFieldGet(devNum, 0,
                        phyPortNum+nextPortShift, unitId, fieldName, &value, NULL));
        mvHwsAnpPrintDebugInfo(output, "\tL%d: %-11s", i, tx_fsm_states[value]);
        ...
        mvHwsAnpPrintDebugInfo(output,  "\tL%d: %-14s\n", i, rx_fsm_states[value]);
    }
...
/**
* @internal mvHwsAnpGetAndPrintApInteropInfo function
* @endinternal
*
* @brief  Print ANP port counters information to desire output
*
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsAnpGetAndPrintApInteropInfo
(
    IN  GT_U8                                       devNum,
    IN  GT_U32                                      phyPortNum,
    IN  MV_HWS_AP_DEBUG_LOG_OUTPUT_ENT              output
)
{
    ...
    mvHwsAnpPrintDebugInfo(output, "\nPort %d interop:\n", phyPortNum);
    mvHwsAnpPrintDebugInfo(output, "Slow:%d Nrz:%d Pam4:%d\n",
                    apInterop.pdLinkMaxInterval,
                    apInterop.apLinkMaxInterval,
                    apInterop.anPam4LinkMaxInterval);

    return GT_OK;
}

/**
* @internal mvHwsAnpGetAndPrintApStatusInfo function
* @endinternal
*
* @brief  Print ANP port counters information to desire output
*
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsAnpGetAndPrintApStatusInfo
(
    IN     GT_U8                                       devNum,
    IN     GT_U32                                      phyPortNum,
    IN     MV_HWS_AP_DEBUG_LOG_OUTPUT_ENT              output,
...
)
{
    ...
    *numOfLanes = 1;
    ...
    mvHwsAnpPrintDebugInfo(output,
                    "Resolution found: %s\n",
                    apStatus.hcdResult.hcdFound ? "True" : "False");

    if (apStatus.hcdResult.hcdFound)
    {
        mvHwsAnpPrintDebugInfo(output,
                        "Mode:%d fecEn:%d fecType:%d fcRxPause:%d, fcTxPause:%d\n",
                        apStatus.postApPortMode,apStatus.hcdResult.hcdFecEn,
                        apStatus.hcdResult.hcdFecType,
                        apStatus.hcdResult.hcdFcRxPauseEn,
                        apStatus.hcdResult.hcdFcTxPauseEn);

        if (hwsPortModeParamsGetToBuffer(devNum, 0, phyPortNum,
                                        apStatus.postApPortMode, &curPortParams))
...
/**
* @internal mvHwsSetAnpInfoDb function
* @endinternal
*
...
* @param[in] numOfLanes            - number of serdes lanes
* @param[in] portMode              - port mode
* @param[in] anpInfoDb             - AnP Array that need to set
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
static GT_STATUS mvHwsSetAnpInfoDb
(
    IN  GT_U8                                       devNum,
    IN  GT_U32                                      phyPortNum,
    IN  GT_U32                                      numOfLanes,
    IN  MV_HWS_PORT_STANDARD                        portMode,
    OUT  MV_HWS_ANP_INFO_STC                        *anpInfoDb
)
{
    GT_U32 i, nextPortShift = 0;

    for (i = 0; i < numOfLanes; i++)
    {
        mvHwsAnpNextPortShiftGet(devNum, phyPortNum, portMode, i, &nextPortShift);
        mvHwsAnpPortInfoGet(devNum, phyPortNum + nextPortShift, &anpInfoDb[i]);
    }
...
)
{
    GT_U32                      numOfLanes = 1;
    MV_HWS_PORT_STANDARD        portMode = _10GBase_KR;
    MV_HWS_ANP_INFO_STC         anpInfoDb[ANP_INFO_DB_ARRAY_SIZE];

    mvHwsAnpPrintDebugInfo(output, "Port %d status:\n", phyPortNum);

    mvHwsAnpGetAndPrintApStatusInfo(devNum, phyPortNum, output, &numOfLanes);
    mvHwsAnpGetAndPrintApInteropInfo(devNum, phyPortNum, output);

    mvHwsSetAnpInfoDb(devNum, phyPortNum, numOfLanes, portMode, anpInfoDb);

    mvHwsAnpPrintPortCountersInfo(numOfLanes, phyPortNum, anpInfoDb, output);
    mvHwsAnpGetAndPrintStateMachineInfo(devNum, numOfLanes, phyPortNum,
                                        anpInfoDb, portMode, output);
...
{
    MV_HWS_UNITS_ID unitId;
    GT_U32 fieldName, startProg, stopProg, prog, data;
    ...
    switch ( progSetMode )
    {
        case MV_HWS_ANP_PROG_SET_MODE_SINGLE:
            startProg = stopProg = progState;
            break;
        case MV_HWS_ANP_PROG_SET_MODE_NONE:
            startProg = MV_HWS_ANP_PROG_STATE_PWRUP;
            stopProg = MV_HWS_ANP_PROG_STATE_RX_INIT;
            break;
        case MV_HWS_ANP_PROG_SET_MODE_ALL:
            startProg = MV_HWS_ANP_PROG_STATE_PWRUP;
            stopProg = MV_HWS_ANP_PROG_STATE_NORM;
            break;
        default:
            startProg = stopProg = MV_HWS_ANP_PROG_STATE_INIT;
            break;
    }

    for (prog = startProg; prog <=stopProg; prog++)
    {
        switch ( prog )
        {
        case 0xd: /*RX_INIT */
        ...
        {
            data = (enable) ? 1 : 0;
            CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0,  phyPortNum, unitId, fieldName, data, NULL));
        }
    }
    return GT_OK;
}
...
static GT_STATUS mvHwsAnpCmdInterface
(
    GT_U8                devNum,
    GT_U32               cmdLineIdx,
    GT_BOOL              enable,
...
)
{
    ...
    if ((HWS_DEV_SILICON_TYPE(devNum) != AC5P) && (HWS_DEV_SILICON_TYPE(devNum) != AC5X) && (HWS_DEV_SILICON_TYPE(devNum) != Harrier))
    {
        return GT_NOT_SUPPORTED;
    }
    ...
    CHECK_STATUS(mvHwsAnpCmdInterfaceSetProg(devNum, phyPortNum,GT_TRUE, progState, MV_HWS_ANP_PROG_SET_MODE_SINGLE));

    /**** write enable [0:0]****/
    if ( enable == GT_TRUE) {
        cmdLineLow |= (1<<0);
        /**** write serdesSpeed - opMode - AC5X/P:[4:8] Harrier:[3:8]****/
        CHECK_STATUS(mvHwsAnpCmdGetOpmode(devNum, phyPortNum, serdesSpeed, unitId, &val));
        hwsOsPrintf("mvHwsAnpCmdInterface opMode %d \n",val);
        if((HWS_DEV_SILICON_TYPE(devNum) == AC5P) || (HWS_DEV_SILICON_TYPE(devNum) == AC5X))
        {
            cmdLineLow |= ((val & 0x1F)<<4);
        }
        else if(HWS_DEV_SILICON_TYPE(devNum) == Harrier)
        {
            cmdLineLow |= ((val & 0x3F)<<3);
        }

        /**** write numOfLanes - couple(R1/R2/R4/R8) [9:11]****/
        switch ( numOfLanes) {
        case MV_HWS_ANP_CI_LANE_NUM_R1:
            val = 0;
            break;
        case MV_HWS_ANP_CI_LANE_NUM_R2:
            val = 1;
            break;
        case MV_HWS_ANP_CI_LANE_NUM_R4:
            val = 2;
            break;
        case MV_HWS_ANP_CI_LANE_NUM_R8:
            val = 3;
            break;
        case MV_HWS_ANP_CI_LANE_NUM_ALL:
            val = 4;
            break;
        default:
        ...
        {
            /**** write code [18:24]****/
            cmdLineLow |= ((code & 0x7F)<<18);

            /**** write data [25:31]****/
            cmdLineLow |= ((data & 0x7F)<<25);

            /**** write data high bits [7:21]****/
            val = ((data & 0x3FFF80)>>7);
            cmdLineHigh = val;
        }
    }
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsAnpCmdTableGetIdx
(
    GT_U8                devNum,
    GT_U32               phyPortNum,
    GT_U32               *indexPtr
...
)
{
    ...
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpCmdIntLineIdxPtr[devNum][phyPortNum] != MV_HWS_ANP_CMD_TABLE_EMPTY_CNS )
    {
        CHECK_STATUS(mvHwsAnpCmdInterfaceSetProg(devNum, phyPortNum, GT_FALSE, 0, MV_HWS_ANP_PROG_SET_MODE_NONE));
...
)
{
    ...
    MV_HWS_PORT_INIT_PARAMS     curPortParams;  /* current port parameters */
    GT_U32 nextPortShift = 0, laneIdx;
    ...
    for (laneIdx = 0; laneIdx < curPortParams.numOfActLanes; laneIdx++)
    {
        if (GT_OK != mvHwsAnpNextPortShiftGet(devNum,phyPortNum,portMode,laneIdx,&nextPortShift))
        {
            return GT_BAD_PARAM;
        }

        switch (HWS_DEV_SERDES_TYPE(devNum,MV_HWS_SERDES_NUM(curPortParams.activeLanesList[laneIdx])))
        {
        case COM_PHY_C112GX4:
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum + nextPortShift, &idx));
            data =  (paramType << MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT) | ((valMinMax & MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK) << MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT) | (paramValue & MV_HWS_ANP_CI_AC5P_RX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum + nextPortShift, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, MV_HWS_ANP_CI_AC5P_CODE_CTLE, data);
            break;
        default:
            break;
        }
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsAnpCmdTxOverride
(
    GT_U8                devNum,
    GT_U32               phyPortNum,
    MV_HWS_SERDES_SPEED  serdesSpeed,
...
)
{
    ...
    rc = mvHwsSerdesDbTxConfigGet(devNum, portGroup,  serdesNum,  HWS_DEV_SERDES_TYPE(devNum,serdesNum), serdesSpeed, SERDES_DB_OVERRIDE_ONLY, &configParams);
    if ( rc != GT_OK)
    {
        if ( rc == GT_NOT_FOUND )
        {
    ...
    switch ( HWS_DEV_SERDES_TYPE(devNum,serdesNum) )
    {
    ...
    case COM_PHY_C28GP4X4:
        ...
        {
            data1 |= (((configParams.txComphyC28GP4.peak & 0xF)<<20)/*Min*/ | ((configParams.txComphyC28GP4.peak & 0xF)<<16))/*Max*/;
            mask1 |= ((0xF<<20) | (0xF<<16));
#if 0 /*fix value*/
            /* F_C28GP4X4R1P0_TX_EM_PEAK_CTRL = FIELD_DEFINE(0x2634, 15, 12) + F_C28GP4X4R1P0_TX_EM_PEAK_CTRL_EN = FIELD_DEFINE(0x2634, 23, 23)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, 0x2634, ((configParams.txComphyC28GP4.peak << 12)|(0x1 << 23)), ((0xF << 12)|(0x1 << 23))));
#endif
        }
        if (configParams.txComphyC28GP4.post != NA_8BIT)
        {
            /*Max val*/
            data1 |= ((configParams.txComphyC28GP4.post & 0xF)<<24);
            mask1 |= (0xF<<24);
            /*Min val*/
            data2 |= ((configParams.txComphyC28GP4.post & 0xF)<<28);
            mask2 |= (0xF<<28);
#if 0 /*fix value*/
            /* F_C28GP4X4R1P0_TX_EM_PO_CTRL = FIELD_DEFINE(0x2634, 7, 4) +  F_C28GP4X4R1P0_TX_EM_PO_CTRL_EN = FIELD_DEFINE(0x2634, 21, 21)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, 0x2634, ((configParams.txComphyC28GP4.post << 4)|(0x1 << 21)), ((0xF << 4)|(0x1 << 21))));
#endif
        }
        if (configParams.txComphyC28GP4.pre != NA_8BIT)
        {
            /*Max val*/
            data1 |= ((configParams.txComphyC28GP4.pre & 0xF)<<28);
            mask1 |= (0xF<<28);
            /*Min val*/
            data2 |= ((configParams.txComphyC28GP4.pre & 0xF)<<24);
            mask2 |= (0xF<<24);
#if 0
            /*  F_C28GP4X4R1P0_TX_EM_PRE_CTRL = FIELD_DEFINE(0x2634, 11, 8) +  F_C28GP4X4R1P0_TX_EM_PRE_CTRL_EN  FIELD_DEFINE(0x2634, 22, 22))*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, 0x2634, ((configParams.txComphyC28GP4.pre << 8)|(0x1 << 22)), ((0xF << 8)|(0x1 << 22))));
#endif
        }

        if ( data1 != 0 ) {
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed,  HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, TX_EM_REG1, data1, mask1));
        }

        if ( data2 != 0 ) {
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed,  HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, TX_EM_REG2, data2, mask2));
        }
    ...
    case COM_PHY_C112GX4:
       /* GT_U8 pre2;
        ...
        if ( configParams.txComphyC112G.main != NA_8BIT_SIGNED )
        {
            ...
            data1 = (MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MIN_MAX << MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_SHIFT) | (MV_HWS_ANP_CI_AC5P_TX_PARAM_MAIN << MV_HWS_ANP_CI_AC5P_TX_PARAM_SHIFT) | ((configParams.txComphyC112G.main & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK) << MV_HWS_ANP_CI_AC5P_TX_MAX_PARAM_VALUE_SHIFT) | (configParams.txComphyC112G.main & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum, idx, GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, code, data1);
        }
        if (configParams.txComphyC112G.post != NA_8BIT_SIGNED)
        {
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data1 = (MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MIN_MAX << MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_SHIFT) | (MV_HWS_ANP_CI_AC5P_TX_PARAM_POST << MV_HWS_ANP_CI_AC5P_TX_PARAM_SHIFT) | ((configParams.txComphyC112G.post & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK) << MV_HWS_ANP_CI_AC5P_TX_MAX_PARAM_VALUE_SHIFT) | (configParams.txComphyC112G.post & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum, idx, GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, code, data1);
        }
        ...
        {
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data1 = (MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MIN_MAX << MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_SHIFT) | (MV_HWS_ANP_CI_AC5P_TX_PARAM_PRE << MV_HWS_ANP_CI_AC5P_TX_PARAM_SHIFT) | ((configParams.txComphyC112G.pre & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK) << MV_HWS_ANP_CI_AC5P_TX_MAX_PARAM_VALUE_SHIFT) | (configParams.txComphyC112G.pre & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum, idx, GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, code, data1);
        }
        if ( configParams.txComphyC112G.pre2 != NA_8BIT_SIGNED )
        {
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data1 = (MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MIN_MAX << MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_SHIFT) | (MV_HWS_ANP_CI_AC5P_TX_PARAM_PRE2 << MV_HWS_ANP_CI_AC5P_TX_PARAM_SHIFT) | ((configParams.txComphyC112G.pre2 & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK) << MV_HWS_ANP_CI_AC5P_TX_MAX_PARAM_VALUE_SHIFT) | (configParams.txComphyC112G.pre2 & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum, idx, GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, code, data1);
        }
        break;
...
)
{
    ...
    for (laneIdx = 0; laneIdx < curPortParams.numOfActLanes; laneIdx++)
    {
        ...
        case COM_PHY_C28GP4X4:
            ...
            if (maxMain != NA_8BIT )
            {
                data1 |= ((maxMain & 0xF)<<16);
                mask1 |= (0xF<<16);
            }
            if (minMain != NA_8BIT )
            {
                data1 |= ((minMain & 0xF)<<20);
                mask1 |= (0xF<<20);
            }

            if (maxPost != NA_8BIT)
            {
                data1 |= ((maxPost & 0xF)<<24);
                mask1 |= (0xF<<24);
            }
            if (minPost != NA_8BIT)
            {
                data2 |= ((minPost & 0xF)<<28);
                mask2 |= (0xF<<28);
            }
            ...
            if ( data1 != 0 )
            {
                CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum + nextPortShift, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,MV_HWS_SERDES_NUM(curPortParams.activeLanesList[laneIdx])), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, TX_EM_REG1, data1, mask1));
            }

            if ( data2 != 0 )
            {
                CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum + nextPortShift, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,MV_HWS_SERDES_NUM(curPortParams.activeLanesList[laneIdx])), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, TX_EM_REG2, data2, mask2));
            }
        ...
        case COM_PHY_C112GX4:
           /* GT_U8 pre2;
            ...
            GT_U8 main;
            GT_U8 post;*/
            if ((maxMain != NA_8BIT_SIGNED) && (minMain != NA_8BIT_SIGNED))
            {
                CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum + nextPortShift, &idx));
                data1 = (MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MIN_MAX << MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_SHIFT) | (MV_HWS_ANP_CI_AC5P_TX_PARAM_MAIN << MV_HWS_ANP_CI_AC5P_TX_PARAM_SHIFT) | ((maxMain & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK) << MV_HWS_ANP_CI_AC5P_TX_MAX_PARAM_VALUE_SHIFT) | (minMain & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK);
                mvHwsAnpCmdInterface(devNum, idx, GT_TRUE, phyPortNum + nextPortShift, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, code, data1);
            }
            if ((maxPost != NA_8BIT_SIGNED) && (maxPost != NA_8BIT_SIGNED))
            {
                CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum + nextPortShift, &idx));
                data1 = (MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MIN_MAX << MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_SHIFT) | (MV_HWS_ANP_CI_AC5P_TX_PARAM_POST << MV_HWS_ANP_CI_AC5P_TX_PARAM_SHIFT) | ((maxPost & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK) << MV_HWS_ANP_CI_AC5P_TX_MAX_PARAM_VALUE_SHIFT) | (minPost & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK);
                mvHwsAnpCmdInterface(devNum, idx, GT_TRUE, phyPortNum + nextPortShift, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, code, data1);
            }
            if ((maxPre != NA_8BIT_SIGNED) && (maxPre != NA_8BIT_SIGNED))
            {
                CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum + nextPortShift,  &idx));
                data1 = (MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MIN_MAX << MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_SHIFT) | (MV_HWS_ANP_CI_AC5P_TX_PARAM_PRE << MV_HWS_ANP_CI_AC5P_TX_PARAM_SHIFT) | ((maxPre & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK) << MV_HWS_ANP_CI_AC5P_TX_MAX_PARAM_VALUE_SHIFT) | (minPre & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK);
                mvHwsAnpCmdInterface(devNum, idx, GT_TRUE, phyPortNum + nextPortShift, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, code, data1);
            }
            if ((maxPre2 != NA_8BIT_SIGNED) && (maxPre2 != NA_8BIT_SIGNED))
            {
                CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum + nextPortShift, &idx));
                data1 = (MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_MIN_MAX << MV_HWS_ANP_CI_AC5P_TX_PARAM_TYPE_SHIFT) | (MV_HWS_ANP_CI_AC5P_TX_PARAM_PRE2 << MV_HWS_ANP_CI_AC5P_TX_PARAM_SHIFT) | ((maxPre2 & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK) << MV_HWS_ANP_CI_AC5P_TX_MAX_PARAM_VALUE_SHIFT) | (minPre2 & MV_HWS_ANP_CI_AC5P_TX_PARAM_MASK);
                mvHwsAnpCmdInterface(devNum, idx, GT_TRUE, phyPortNum + nextPortShift, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, code, data1);
            }
            break;
...
* @retval 1                        - on error
*/
static GT_STATUS mvHwsAnpCmdRxOverride
(
    GT_U8                devNum,
    GT_U32               phyPortNum,
    MV_HWS_SERDES_SPEED  serdesSpeed,
...
)
{
    ...
    rc = mvHwsSerdesDbRxConfigGet(devNum, portGroup,  serdesNum,  HWS_DEV_SERDES_TYPE(devNum,serdesNum), serdesSpeed, SERDES_DB_OVERRIDE_ONLY, &configParams);
    if ( rc != GT_OK)
    {
        if ( rc == GT_NOT_FOUND )
        {
    ...
    case COM_PHY_C28GP4X4:
        ...
        GT_U32 cap1Sel;
        GT_U32 cap2Sel;*/
        if ( configParams.rxComphyC28GP4.res1Sel != NA_16BIT )
        {
            /* F_C28GP4X4R1P0_RES1_SEL = FIELD_DEFINE(0x0200, 7, 4)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed,  HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x0200, (configParams.rxComphyC28GP4.res1Sel << 4), (0xF << 4)));
        }
        if ( configParams.rxComphyC28GP4.res2Sel != NA_16BIT )
        {
            /* F_C28GP4X4R1P0_RES2_SEL_E = FIELD_DEFINE(0x0000, 7, 4)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x0000, (configParams.rxComphyC28GP4.res2Sel << 4), (0xF << 4)));
            /* F_C28GP4X4R1P0_RES2_SEL_O = FIELD_DEFINE(0x0204, 7, 4)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x0204, (configParams.rxComphyC28GP4.res2Sel << 4), (0xF << 4)));
        }
        if ( configParams.rxComphyC28GP4.cap1Sel != NA_16BIT )
        {
            /* F_C28GP4X1R1P0_CAP1_SEL = FIELD_DEFINE(0x0200, 3, 0)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x0200, configParams.rxComphyC28GP4.cap1Sel, 0xF));
        }
        if ( configParams.rxComphyC28GP4.cap2Sel != NA_16BIT )
        {
            /* F_C28GP4X1R1P0_CAP2_SEL_E = FIELD_DEFINE(0x0000, 3, 0)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x0000, configParams.rxComphyC28GP4.cap2Sel, 0xF));
            /* F_C28GP4X1R1P0_CAP2_SEL_O = FIELD_DEFINE(0x0204, 3, 0)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x0204, configParams.rxComphyC28GP4.cap2Sel, 0xF));
        }
        break;
    ...
    case COM_PHY_N5XC56GP5X4:
        ...
        GT_U32 cap1Sel;
        GT_U32 cap2Sel;*/
        if ( configParams.rxComphyC56G.res1Sel != NA_16BIT )
        {
            /*F_N5XC56GP5X4_RES1_SEL = FIELD_DEFINE(0x1058, 3, 0)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x1058, configParams.rxComphyC56G.res1Sel, 0xF));
        }
        if ( configParams.rxComphyC56G.res2Sel != NA_16BIT )
        {
            /*F_N5XC56GP5X4_RES2_SEL = FIELD_DEFINE(0x105C, 3, 0)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x105C, configParams.rxComphyC56G.res2Sel, 0xF));
        }
        if ( configParams.rxComphyC56G.cap1Sel != NA_16BIT )
        {
            /*F_N5XC56GP5X4_CAP1_SEL_G = FIELD_DEFINE(0x1048, 3, 0)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x1048, configParams.rxComphyC56G.cap1Sel, 0xF));
        }
        if ( configParams.rxComphyC56G.cap2Sel != NA_16BIT )
        {
            /*F_N5XC56GP5X4_CAP2_SEL = FIELD_DEFINE(0x104C, 3, 0)*/
            CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,serdesNum), MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, 0x104C, configParams.rxComphyC56G.cap2Sel, 0xF));
        }
        break;

    case COM_PHY_C112GX4:
        if ( configParams.rxComphyC112G.res1Sel != NA_16BIT )
        {
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data =  (MV_HWS_ANP_CI_AC5P_RX_PARAM_RES1 << MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT) | ((MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MIN &  MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK) << MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT) | (configParams.rxComphyC112G.res1Sel & 0xff);
            mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, MV_HWS_ANP_CI_AC5P_CODE_CTLE, data);
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data =  (MV_HWS_ANP_CI_AC5P_RX_PARAM_RES1 << MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT) | ((MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MAX & MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK) << MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT) | (configParams.rxComphyC112G.res1Sel & 0xff);
            mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, MV_HWS_ANP_CI_AC5P_CODE_CTLE, data);
        }
        if ( configParams.rxComphyC112G.cap1Sel != NA_16BIT )
        {
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data =  (MV_HWS_ANP_CI_AC5P_RX_PARAM_CAP1 << MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT) | ((MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MIN & MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK) << MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT) | (configParams.rxComphyC112G.cap1Sel & MV_HWS_ANP_CI_AC5P_RX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, MV_HWS_ANP_CI_AC5P_CODE_CTLE, data);
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data =  (MV_HWS_ANP_CI_AC5P_RX_PARAM_CAP1 << MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT) | ((MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MAX & MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK) << MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT) | (configParams.rxComphyC112G.cap1Sel & MV_HWS_ANP_CI_AC5P_RX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, MV_HWS_ANP_CI_AC5P_CODE_CTLE, data);
        }
        if ( configParams.rxComphyC112G.rl2Tune != NA_16BIT )
        {
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data =  (MV_HWS_ANP_CI_AC5P_RX_PARAM_RL2_TUNE << MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT) | ((MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MIN & MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK) << MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT) | (configParams.rxComphyC112G.rl2Tune  & MV_HWS_ANP_CI_AC5P_RX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, MV_HWS_ANP_CI_AC5P_CODE_CTLE, data);
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data =  (MV_HWS_ANP_CI_AC5P_RX_PARAM_RL2_TUNE << MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT) | ((MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MAX & MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK) << MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT) | (configParams.rxComphyC112G.rl2Tune  & MV_HWS_ANP_CI_AC5P_RX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, MV_HWS_ANP_CI_AC5P_CODE_CTLE, data);
        }
        if ( configParams.rxComphyC112G.cap2Sel != NA_16BIT )
        {
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data =  (MV_HWS_ANP_CI_AC5P_RX_PARAM_CAP2 << MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT) | ((MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MIN & MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK) << MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT) | (configParams.rxComphyC112G.cap2Sel & MV_HWS_ANP_CI_AC5P_RX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum,idx,GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, MV_HWS_ANP_CI_AC5P_CODE_CTLE, data);
            CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
            data =  (MV_HWS_ANP_CI_AC5P_RX_PARAM_CAP2 << MV_HWS_ANP_CI_AC5P_RX_PARAM_SHIFT) | ((MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MAX & MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_MASK) << MV_HWS_ANP_CI_AC5P_RX_PARAM_TYPE_SHIFT) | (configParams.rxComphyC112G.cap2Sel &  MV_HWS_ANP_CI_AC5P_RX_PARAM_MASK);
            mvHwsAnpCmdInterface(devNum,idx,GT_TRUE, phyPortNum, serdesSpeed, MV_HWS_ANP_CI_LANE_NUM_ALL, MV_HWS_ANP_PROG_STATE_TX_TRAIN, MV_HWS_ANP_CI_MODE_NONE, MV_HWS_ANP_CI_AC5P_CODE_CTLE, data);
        }
        break;
    default:
...
)
{
    ...
    for (laneIdx = 0; laneIdx < curPortParams.numOfActLanes; laneIdx++)
    {
        ...
        CHECK_STATUS(mvHwsAnpCmdRegisterWrite(devNum, phyPortNum + nextPortShift, serdesSpeed, HWS_DEV_SERDES_TYPE(devNum,MV_HWS_SERDES_NUM(curPortParams.activeLanesList[laneIdx])), MV_HWS_ANP_CI_LANE_NUM_ALL/*curPortParams.numOfActLanes*/, progState, apMode, addr, data, mask));
    }
...
)
{
    ...
    case COM_PHY_C112GX4:
        CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
        val =  mask & 0xFFFF;
        mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_MASK1, val);

        CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
        val =  data & 0xFFFF;
        mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_DATA1 , val);

        CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
        val =  (mask>>16) & 0xFFFF;
        mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_MASK2, val);

        CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
        val =  (data>>16) & 0xFFFF;
        mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_DATA2, val);

        CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
        val =  addr & 0xFFFF;
        mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, MV_HWS_ANP_CI_AC5P_AC5X_CODE_WR_ADDR, val);
        break;

    case COM_PHY_N5XC56GP5X4:
        CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
        val = (addr << 3) | MV_HWS_ANP_CI_HARRIER_WR_CMD;
        mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, MV_HWS_ANP_CI_HARRIER_CODE_WR_ADDR, val);

        CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
        val = (mask << 3) | MV_HWS_ANP_CI_HARRIER_WR_CMD;
        mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, MV_HWS_ANP_CI_HARRIER_CODE_WR_MASK, val);

        CHECK_STATUS(mvHwsAnpCmdTableGetIdx(devNum, phyPortNum, &idx));
        val = (data << 3) | MV_HWS_ANP_CI_HARRIER_WR_CMD;
        mvHwsAnpCmdInterface(devNum,idx ,GT_TRUE, phyPortNum, serdesSpeed, numOfLanes, progState, apMode, MV_HWS_ANP_CI_HARRIER_CODE_WR_DATA, val);
        break;
    default:
        return GT_NOT_SUPPORTED;
    }
...
static GT_STATUS mvHwsAnpSetDefaultLinkTimer
(
    GT_U8  devNum,
    GT_U32 port,
    GT_U32 capability
...
/*TODO remove when training is fixed (time)*/
    ...
    if (((AP_CTRL_ADV_25G_ALL_GET(capability)) || (AP_CTRL_ADV_50G_CONSORTIUM_GET(capability)) || (AP_CTRL_ADV_100G_R4_ALL_GET(capability)) || (AP_CTRL_ADV_40G_R4_ALL_GET(capability))) &&
...
)
{
    ...
    MV_HWS_PORT_INIT_PARAMS     curPortParams;
    MV_HWS_SERDES_CONFIG_STC    serdesConfig;
    GT_U32 nextPortShift = 0, sdIndex;
    MV_HWS_HAWK_CONVERT_STC convertIdx;
    GT_U32 hawkLocalIndexArr[8]    = {0,1,2,6,10,14,18,22};
    ...
    if ( PRV_SHARED_LAB_SERVICES_DIR_ANP_SRC_GLOBAL_VAR_GET(mvHwsAnpPortDB).anpSkipResetPtr[devNum][phyPortNum] )
    {
        if (HWS_DEV_SILICON_TYPE(devNum) == Harrier)
        {
            /* we reach here when  HCD is changed and we call portModeSpeedSet with power = FALSE,
               we need to re-enable the serdesAnp params*/
            serdesConfig.serdesType = (MV_HWS_SERDES_TYPE)(HWS_DEV_SERDES_TYPE(devNum, MV_HWS_SERDES_NUM(curPortParams.activeLanesList[0])));
            for(sdIndex = 0; sdIndex < curPortParams.numOfActLanes; sdIndex++)
            {
                CHECK_STATUS(mvHwsSerdesApPowerCtrl(devNum, 0, curPortParams.activeLanesList[sdIndex], GT_FALSE, &serdesConfig));
            }
        }
        return GT_OK;
    }
    ...
    if (GT_OK != mvHwsGlobalMacToLocalIndexConvert(devNum, phyPortNum, maxPortMode, &convertIdx))
    {
        return GT_BAD_PARAM;
    }

    CHECK_STATUS(mvHwsAnpUseCmdTableSet(devNum,phyPortNum,GT_FALSE));

    for (sdIndex = 0; sdIndex < curPortParams.numOfActLanes; sdIndex++)
    {
        if (HWS_DEV_SILICON_TYPE(devNum) == AC5P)
        {
            nextPortShift = hawkLocalIndexArr[convertIdx.ciderIndexInUnit + sdIndex] - hawkLocalIndexArr[convertIdx.ciderIndexInUnit];
        }
        else if (HWS_DEV_SILICON_TYPE(devNum) == Harrier)
        {
            nextPortShift = 2*sdIndex;
        }
        else
        {
            nextPortShift = sdIndex;
        }

        CHECK_STATUS(mvHwsAnpCmdTableClear(devNum, phyPortNum+nextPortShift));
        mvHwsComphySerdesManualDBClear(devNum, phyPortNum, curPortParams.activeLanesList[sdIndex]);
    }
...
)
{
    ...
    if(AC5P == hwsDeviceSpecInfo[devNum].devType)
    {
        CHECK_STATUS(mvHwsAnpPortEnable(devNum, portNum, portMode, GT_TRUE, GT_TRUE));
    }
    ...
    serdesConfig.serdesType = (MV_HWS_SERDES_TYPE)(HWS_DEV_SERDES_TYPE(devNum, MV_HWS_SERDES_NUM(curPortParams.activeLanesList[0])));
    serdesConfig.refClock = (MV_HWS_REF_CLOCK)apCfgPtr->refClockCfg.refClockFreq;
    serdesConfig.refClockSource = (MV_HWS_REF_CLOCK_SRC)apCfgPtr->refClockCfg.refClockSource;
    ...
    /* update cmd table */
    if (mvHwsAnpGetUseCmdTable(devNum,portNum))
    {
        rc = mvHwsGlobalMacToLocalIndexConvert(devNum, portNum, portMode, &convertIdx);
        if (rc != GT_OK)
        {
        ...
        for (laneIdx = 0; laneIdx < curPortParams.numOfActLanes; laneIdx++)
        {
            ...
            if ( (AP_CTRL_ADV_40G_R4_ALL_GET(apCfgPtr->modesVector)) || (AP_CTRL_10GBase_KR_GET(apCfgPtr->modesVector)) ||
                ...
                CHECK_STATUS(mvHwsAnpCmdRxOverride(devNum, portNum + nextPortShift, serdesSpeed, curPortParams.activeLanesList[laneIdx]));
                CHECK_STATUS(mvHwsAnpCmdTxOverride(devNum, portNum + nextPortShift, serdesSpeed, curPortParams.activeLanesList[laneIdx]));
            }
            /* serdes speed 25G */
...
/**
* @internal mvHwsAnpGetMaxMessageLen function
* @endinternal
*
* @brief   Get max len of message(string) from the input array
*
* @param[in] ArrayOfstrings     - Array of UNIT_DUMP struct.
* @param[in] maxLenParamPtr     - Max len of string in the array.
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
GT_STATUS mvHwsAnpGetMaxMessageLen
(
    IN  MV_HWS_AN_UNIT_DUMP_STC     *dumpArr,
    OUT GT_U32                      *maxLenParamPtr
)
{
    GT_U32 maxLen = 0, i = 0, len = 0;

    for (i = 0; dumpArr[i].unitNum != LAST_MESSAGE; i++)
    {
        len = hwsStrLen(dumpArr[i].message);
        maxLen = (len > maxLen) ? len : maxLen;
    }

    *maxLenParamPtr = maxLen;

    return GT_OK;
}

/**
* @internal mvHwsAnpGetRegFromDb function
* @endinternal
*
* @brief   Print address and data from DB
*
* @param[in] devNum                - System device number
* @param[in] phyPortNum            - Physical port number
* @param[in] unitIdAn              - AN Unit ID
* @param[in] portMode              - Port Mode
* @param[in] baseAddr              - Base address
* @param[in] dumpArr               - AnP Dump
* @param[in] output                - Output type
*
* @retval 0                        - on success
* @retval 1                        - on error
*/
GT_STATUS mvHwsAnpGetRegFromDb
(
    IN GT_U32                          devNum,
    IN GT_U32                          phyPortNum,
    IN GT_U32                          unitIdAn,
...
{
    GT_U32 i = 0, regAddr, regData, maxStrLen = 0;
    MV_HWS_HAWK_CONVERT_STC convertIdx;
    MV_HWS_REG_ADDR_FIELD_STC fieldReg;

    mvHwsAnpGetMaxMessageLen(dumpArr, &maxStrLen);

    mvHwsAnpPrintDebugInfo(output, "\n\n%-*s\t%-17s\t%-14s\n\n",
                maxStrLen, "Register Name", "Register Address", "Register Data");

    for(i = 0; dumpArr[i].unitNum != LAST_MESSAGE; i++)
    {
        CHECK_STATUS(genUnitRegDbEntryGet(
                                        devNum,
                                        phyPortNum,
                                        unitIdAn,
                                        portMode,
        ...
        if(unitIdAn == ANP_USX_UNIT)
        {
            convertIdx.ciderIndexInUnit = 0;
        }

        regAddr = MV_HWS_ANP_GET_ANP_REG_ADDR(baseAddr, fieldReg, convertIdx);

        CHECK_STATUS(hwsRegisterGetFieldFunc(devNum, 0, regAddr, 0, 32, &regData));

        mvHwsAnpPrintDebugInfo(output,
                        "%-*s\t0x%-17x\t0x%-14x\n",
                        maxStrLen, dumpArr[i].message, regAddr, regData);
    }
...
/**
* @internal mvHwsAnpGetDumpArrayByDev function
* @endinternal
*
* @brief   assign dumpArr by device type
*
* @param[in] devNum                - system device number
* @param[in] dumpArr
*
...
* @retval 1                        - on error
*/
GT_STATUS mvHwsAnpGetDumpArrayByDev
(
    IN GT_U8                   devNum,
    INOUT MV_HWS_AN_UNIT_DUMP_STC **dumpArr
)
{
    switch(HWS_DEV_SILICON_TYPE(devNum))
    {
        case AC5P:
            *dumpArr = (MV_HWS_AN_UNIT_DUMP_STC *)mvHwsAC5PAnpDumpArr;
            break;
        case Harrier:
            *dumpArr = (MV_HWS_AN_UNIT_DUMP_STC *)mvHwsHarrierAnpDumpArr;
            break;
        case AC5X:
            *dumpArr = (MV_HWS_AN_UNIT_DUMP_STC *)mvHwsAC5XAnpDumpArr;
            break;
        default:
...
{
    MV_HWS_AN_UNIT_DUMP_STC         *dumpArr = NULL;
    MV_HWS_UNITS_ID                 unitId, unitIdAn;
    MV_HWS_PORT_STANDARD            portMode = _10GBase_KR;
    GT_U32                          baseAddr,unitIndex, unitNum;
    ...
    CHECK_STATUS(mvUnitExtInfoGet(devNum, unitId, phyPortNum,
                                    &baseAddr, &unitIndex, &unitNum));

    mvHwsAnpPrintDebugInfo(output, "\n\n------ ANP registers ------\n");
    mvHwsAnpGetDumpArrayByDev(devNum, &dumpArr);
    mvHwsAnpGetRegFromDb(devNum, phyPortNum, unitId, portMode, baseAddr, dumpArr, output);

    mvHwsAnpPrintDebugInfo(output, "\n\n------ AN registers ------\n");
    CHECK_STATUS(mvUnitExtInfoGet(devNum, unitIdAn, phyPortNum,
                                    &baseAddr, &unitIndex, &unitNum));

    dumpArr = (MV_HWS_AN_UNIT_DUMP_STC *)mvHwsAnDumpArr;
    mvHwsAnpGetRegFromDb(devNum, phyPortNum, unitIdAn, portMode, baseAddr, dumpArr, output);
...
)
{
    ...
    CHECK_STATUS(mvHwsAnpCmdRegisterWriteExt(devNum, phyPortNum, curPortParams.serdesSpeed, portMode, MV_HWS_ANP_PROG_STATE_TX_TRAIN, 0xff, TX_POST_ADAPT_REG_ADDR, enable << 21, 0x1 << 21));
...
)
{
    ...
    {
    case COM_PHY_C112GX4:
        hwsOsMemCopyFuncPtr(&(rxSerdesTune.rxComphyC112G),
                            &(rxConfigPtr->rxComphyC112G),
                            sizeof(MV_HWS_MAN_TUNE_COMPHY_C112G_RX_CONFIG_DATA));
        break;
    case COM_PHY_C28GP4X1:
    case COM_PHY_C28GP4X4:
        hwsOsMemCopyFuncPtr(&(rxSerdesTune.rxComphyC28GP4),
                            &(rxConfigPtr->rxComphyC28GP4),
                            sizeof(MV_HWS_MAN_TUNE_COMPHY_C28GP4_RX_CONFIG_DATA));
        break;
     case COM_PHY_N5XC56GP5X4:
        hwsOsMemCopyFuncPtr(&(rxSerdesTune.rxComphyC56G),
                            &(rxConfigPtr->rxComphyC56G),
    ...
    if ( rc == GT_OK)
    {
        CHECK_STATUS(mvHwsComphySerdesManualRxDBSet(devNum, portGroup, phyPortNum, serdesSpeed, serdesNumber, &rxSerdesTune));
        CHECK_STATUS(mvHwsAnpUseCmdTableSet(devNum,phyPortNum,GT_TRUE));
    }
#endif
    return rc;
}
...
)
{
    ...
    {
    case COM_PHY_C112GX4:
        hwsOsMemCopyFuncPtr(&(txSerdesTune.txComphyC112G),
                            &(txConfigPtr->txComphyC112G),
                            sizeof(MV_HWS_MAN_TUNE_COMPHY_C112G_TX_CONFIG_DATA));
        break;
    case COM_PHY_C28GP4X1:
    case COM_PHY_C28GP4X4:
        hwsOsMemCopyFuncPtr(&(txSerdesTune.txComphyC28GP4),
                            &(txConfigPtr->txComphyC28GP4),
                            sizeof(MV_HWS_MAN_TUNE_COMPHY_C28GP4_TX_CONFIG_DATA));
        break;
    case COM_PHY_N5XC56GP5X4:
        hwsOsMemCopyFuncPtr(&(txSerdesTune.txComphyC56G),
                            &(txConfigPtr->txComphyC56G),
    ...
    if ( rc == GT_OK)
    {
        CHECK_STATUS(mvHwsComphySerdesManualTxDBSet(devNum, portGroup, phyPortNum, serdesSpeed, serdesNumber, &txSerdesTune));
        CHECK_STATUS(mvHwsAnpUseCmdTableSet(devNum,phyPortNum,GT_TRUE));
    }
#endif
    return rc;
...
)
{
    ...
    data = (enable) ? 0 : 1;
    fieldName = mvHwsAnpFieldSet(devNum,
                                 HAWK_ANP_UNITS_GLOBAL_CLOCK_AND_RESET_PWM_CLK_EN_E,
                                 HARRIER_ANP_UNITS_GLOBAL_CLOCK_AND_RESET_PWM_CLK_EN_E,
                                 PHOENIX_ANP_UNITS_GLOBAL_CLOCK_AND_RESET_PWM_CLK_EN_E);
    ...
    for (sdIndex = 0; sdIndex < curPortParams.numOfActLanes; sdIndex++)
    {
        ...
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0,  phyPortNum + nextPortShift, unitId, fieldName, data, NULL));
    }
...
{
    GT_STATUS rc;
    GT_U32 startIterator = 0;
    GT_U32 stopIterator = HWS_CORE_PORTS_NUM(devNum) - 1;
    ...
    if (phyPortNum != GET_ALL_PORTS)
    {
        startIterator = stopIterator = phyPortNum;
    }

    for (; startIterator <= stopIterator; startIterator++)
    {
        rc = mvHwsAnpPortInfoDump(devNum, startIterator, output);
        if(rc != GT_OK)
        {
            return rc;
        }

        rc = mvHwsAnpPortRegDump(devNum, startIterator, output);
        if(rc != GT_OK)
        {
            return rc;
        }

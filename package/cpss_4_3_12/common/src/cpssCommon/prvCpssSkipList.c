...
/**
********************************************************************************
* @file prvCpssSkipList.c
*
* @brief This file includes a skip-list (refered as SL) implementation, it
...
*
* @retval return value in the range 0 <= x <= 232 - 1
*/
...
/**
* @internal sRandom function
* @endinternal
*
* @brief   Returns a 32 bit random number.
*
* @param[in] seed                     - the  that is used to create the linear congruential table
*                                       None.
*/
...
/**
* @internal prvCpssSlHitlessUpgrdActivate function
* @endinternal
*
* @brief   Activates the skip list module
*
* @retval GT_OK                    - success
* @retval GT_FAIL                  - otherwise
*
* @note Needed for hitless upgrade first phase only.
*       Internal use only.
*
*/
...
)
{
    ...
    slCtrlPtr->compareFunc     = PRV_CALLBACK_ID_GET(compFuncPtr);

    if(!slCtrlPtr->compareFunc)
    {
        DBG_INFO(("slCtrlPtr->compareFunc not set\n", __LINE__));
        return NULL;
    }
...
/**
* @internal prvCpssSlIsEmpty function
* @endinternal
*
* @brief   checks if a skip-List is empty.
*
* @param[in] ctrlPtr                  - A pointer to the skipList control block.
...
)
{
    ...
    slCtrlPtr = (SL_CTRL_STC*)ctrlPtr;
    compFunc  = PRV_CALLBACK_GET(slCtrlPtr->compareFunc,FUNCP_SL_COMP);
...
/**
* @internal prvCpssSlAdd function
* @endinternal
*
* @brief   Adds a new node to the skipList.
...
* @param[in] ctrlPtr                  - A pointer to the skipList control block.
* @param[in] dataPtr                  - A pointer to the new data to be added.
*
* @param[out] iteratorPtr              - The iteration Id to be sent in the next call to this
*                                      function to get the next data.
*                                       GT_OK if succeeded, or
*
* @retval GT_ALREADY_EXIST         - if the node with the key already exists
*                                       GT_FAIL otherwise.
*/
...
/**
* @internal prvCpssSlDestroy function
* @endinternal
*
* @brief   Destroys the given skip-list.
*
* @param[in] ctrlPtr                  - A pointer to the skipList control block.

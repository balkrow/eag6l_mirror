...
GT_VOID cpssHwDriverSimulationReload
(
    CPSS_HW_DRIVER_STC *drv
)
{
    drv->read = (CPSS_HW_DRIVER_METHOD_READ)cpssHwDriverSimulationRead;
    drv->writeMask =  (CPSS_HW_DRIVER_METHOD_WRITE_MASK)cpssHwDriverSimulationWriteMask;
    drv->destroy = (CPSS_HW_DRIVER_METHOD_DESTROY)cpssHwDriverSimulationDestroy;
}
#endif
...
)
{
    ...
    drv->common.type = CPSS_HW_DRIVER_TYPE_SIMULATION;

...
)
{
    ...
    currInfoPtr->adressSpaceType               = CPSS_HW_DRIVER_AS_DFX_E;
    ...
    currInfoPtr->adressSpaceType               = CPSS_HW_DRIVER_AS_CNM_E;
    ...
    currInfoPtr->adressSpaceType               = CPSS_HW_DRIVER_AS_SWITCHING_E;
    ...
    currInfoPtr->nextSplitResourcePtr   = NULL; /* point to NULL */
    currInfoPtr->adressSpaceType               = CPSS_HW_DRIVER_AS_ATU_E;

...
/**
* @internal prvCpssDrvPpHwAccessCheck function
* @endinternal
*
* @brief   Function performing validation of managment access
*          to device. Function is called from ISR context.
*
* @param[in] devNum                   - The device number to check.
* @param[in] portGroupId              - The portGroupId. for multi-port-groups device.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on failure
*/
static GT_STATUS prvCpssDrvPpHwAccessCheck
(
    IN GT_U8    devNum,
...
)
{
    ...
    /* use vendor ID register for the check.
       This register hold constant 0x11AB and cannot be 0xFFFFFFFF */

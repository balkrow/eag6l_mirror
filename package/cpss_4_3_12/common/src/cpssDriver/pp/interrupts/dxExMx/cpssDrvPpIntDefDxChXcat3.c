...
/**
********************************************************************************
* @file cpssDrvPpIntDefDxChXcat3.c
*
...
/**
* @internal xCat3XgPortMultiplexerHwPpPortGroupIsrRead function
* @endinternal
*
...
static const PRV_CPSS_DRV_INTERRUPT_SCAN_STC xcat3IntrScanArr[] =
{
...
*/
static const GT_U32 xcat3UniEvMapTableWithExtData[] = {
 /* Per Queue events */
 ...
 CPSS_PP_PORT_PCS_ALIGN_LOCK_LOST_E,
    SET_EVENT_PER_XLG_PORTS___ON_ALL_PORTS_MAC(PRV_CPSS_XCAT3_PCS40_G,COMMON_ALIGN_LOCK_LOST_E),
 MARK_END_OF_UNI_EV_CNS,

 CPSS_PP_PORT_PCS_GB_LOCK_SYNC_CHANGE_E,
    SET_EVENT_PER_XLG_PORTS___ON_ALL_PORTS_MAC(PRV_CPSS_XCAT3_PCS40_G,COMMON_GB_LOCK_SYNC_CHANGE_E),
 MARK_END_OF_UNI_EV_CNS,
...
static const GT_U32 xcat3UniEvMapTableWithExtDataSize = (sizeof(xcat3UniEvMapTableWithExtData)/(sizeof(GT_U32)));


/* Interrupt cause to unified event map for xCat3
 This Table is for unified event without extended data
*/
static const GT_U32 xcat3UniEvMapTable[][2] =
{
...
static const GT_U32 xcat3UniEvMapTableSize = (sizeof(xcat3UniEvMapTable)/(sizeof(GT_U32)*2));


/**
* @internal setXcat3DedicatedEventsConvertInfo function
* @endinternal
*
...
{
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableWithExtDataArr   = xcat3UniEvMapTableWithExtData;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableWithExtDataSize  = xcat3UniEvMapTableWithExtDataSize;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableArr              = xcat3UniEvMapTable;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableSize             = xcat3UniEvMapTableSize;
...
)
{
    ...
    if(PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(xcat3InitDone) == GT_TRUE)
    {
        return GT_OK;
    }
    ...
    */
    ...
    devFamilyPtr = &PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(prvCpssDrvDevFamilyInterruptInfoArray[PRV_CPSS_DRV_FAMILY_DXCH_XCAT3_E]);
    ...
    PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_SET(xcat3InitDone, GT_TRUE);
...
/**
* @internal prvCpssDrvPpIntDefXcat3Print function
* @endinternal
*
* @brief   print the interrupts arrays info, of xcat3 devices
*/
...
)
{
    ...
    cpssOsPrintf("xcat3 - start : \n");
    devInterruptInfoPtr = &PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(prvCpssDrvDevFamilyInterruptInfoArray[PRV_CPSS_DRV_FAMILY_DXCH_XCAT3_E]);
    interruptsScanArray = devInterruptInfoPtr->interruptsScanArray;

    prvCpssDrvPpIntDefPrint(XCAT3_NUM_ELEMENTS_IN_SCAN_TREE_CNS, interruptsScanArray,
                            XCAT3_NUM_MASK_REGISTERS_CNS,

...
/**
********************************************************************************
* @file cpssDrvPpIntDefDxChBobK.c
*
...
#define   rxDma1_SUB_TREE_MAC(bit)                                         \
    /* rxDmaIntSum */                                                               \
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_RXDMA1_E, NULL,                                \
        ...
        {3, GT_FALSE, PRV_CPSS_DXCH_UNIT_RXDMA1_E, NULL,                             \
            ...
            FILLED_IN_RUNTIME_CNS, 0, 0x0, 2 , NULL, NULL},                         \
                                                 /* bit */ /*port*/                 \
            BOBK_RXDMA_SCDMA_PORT_INT_ELEMENT_MAC( 2  , 62,     1 ),             \
    ...
    {bit, GT_FALSE,PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E, NULL, 0x3C090000, 0x3C090004,\
        ...
        {10, GT_FALSE,PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E, NULL, 0x3C090890, 0x3C090894,             \
            ...
            FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 10,NULL, NULL},                             \
                                                                  /* bit */ /*port*/            \
                BOBK_TXQ_QUEUE_LOW_CROSSING_FOR_PORT_INT_ELEMENT_MAC( 1 ,   62 ),            \
                BOBK_TXQ_QUEUE_LOW_CROSSING_FOR_PORT_INT_ELEMENT_MAC( 2 ,   63 ),            \
        ...
        {13, GT_FALSE,PRV_CPSS_DXCH_UNIT_TXQ_QUEUE_E, NULL, 0x3C0908a8, 0x3C0908ac,               \
            ...
            FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 10,NULL, NULL},                               \
                                                                  /* bit */ /*port*/              \
                BOBK_TXQ_QUEUE_HIGH_CROSSING_FOR_PORT_INT_ELEMENT_MAC( 1 ,   62 ),             \
                BOBK_TXQ_QUEUE_HIGH_CROSSING_FOR_PORT_INT_ELEMENT_MAC( 2 ,   63 ),             \
...
#define BOBK_XLG_ODD_PORT_SUMMARY_INT_SUB_TREE_MAC(bitIndexInCaller,port)   \
                ...
                FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 4+(XPCS_BIT4_EXISTS_MAC(port)),NULL, NULL},\
                    ...
                    prvCpssDrvHwPpPortGroupIsrRead,                          \
                    prvCpssDrvHwPpPortGroupIsrWrite,                         \
                    PRV_CPSS_BOBK_MPCS_PORT_##port##_ACCESS_ERROR_E,  \
                    PRV_CPSS_BOBK_MPCS_PORT_##port##_GB_LOCK_SYNC_CHANGE_E,  \
                    FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0,NULL, NULL},  \
                    /*bit 7*/ \
...
#define BOBK_PORTS_56_59_AND_62_AND_64_71_SUMMARY_INT_SUB_TREE_MAC         \
                                                      /*bit,port*/      \
            ...
            BOBK_GIGA_PORT_SUMMARY_FROM_MG_INT_SUB_TREE_MAC (  7 , 62 ),  \
...
#define   AP_Doorbell_SUB_TREE_MAC(bit)                                     \
    ...
    {bit,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000010, 0x00000011,    \
        ...
        PRV_CPSS_BOBK_AP_DOORBELL_MAIN_IPC_E,                               \
        PRV_CPSS_BOBK_AP_DOORBELL_MAIN_RESERVED31_E,                        \
        ...
        {4,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000012, 0x00000013,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_0_LINK_STATUS_CHANGE_E,          \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_31_LINK_STATUS_CHANGE_E,         \
        ...
        {5,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000014, 0x00000015,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_32_LINK_STATUS_CHANGE_E,         \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_63_LINK_STATUS_CHANGE_E,         \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL},          \
        /* AP_DOORBELL_PORT64_95_LINK_STATUS_CHANGE */                      \
        {6,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000016, 0x00000017,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_64_LINK_STATUS_CHANGE_E,         \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_95_LINK_STATUS_CHANGE_E,         \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL},          \
        /* AP_DOORBELL_PORT0_31_802_3_AP */                                 \
        {8,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000018, 0x00000019,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_0_802_3_AP_E,                    \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_31_802_3_AP_E,                   \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL},          \
        /* AP_DOORBELL_PORT32_63_802_3_AP */                                \
        {9,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x0000001a, 0x0000001b,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_32_802_3_AP_E,                   \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_63_802_3_AP_E,                   \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL},          \
        /* AP_DOORBELL_PORT64_95_802_3_AP */                                \
        {10,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x0000001c, 0x0000001d, \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_64_802_3_AP_E,                   \
            PRV_CPSS_BOBK_AP_DOORBELL_PORT_95_802_3_AP_E,                   \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL}
...
static const PRV_CPSS_DRV_INTERRUPT_SCAN_STC bobkIntrScanArr[] =
{
    ...
    {0, GT_FALSE, PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000030, 0x00000034,
        ...
        {6, GT_FALSE, PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x000000ac, 0x000000b0,
            prvCpssDrvHwPpPortGroupIsrRead,
            prvCpssDrvHwPpPortGroupIsrWrite,
            PRV_CPSS_BOBK_DFX_SUM_DFX_INTERRUPT_SUM_1_E,
            PRV_CPSS_BOBK_DFX_SUM_DFX_INTERRUPT_SUM_31_E,
            FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL},
        ...
        {10, GT_FALSE, PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x000000b8, 0x000000bc,
            prvCpssDrvHwPpPortGroupIsrRead,
            prvCpssDrvHwPpPortGroupIsrWrite,
            PRV_CPSS_BOBK_DFX1_SUM_DFX_1_INTERRUPT_SUM_1_E,
            PRV_CPSS_BOBK_DFX1_SUM_DFX_1_INTERRUPT_SUM_31_E,
            FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL},
        ...
        {17,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000158, 0x0000015c,
            ...
            /* XLG ports 56..59 and 64..71 and GE port 62 in bits 1..4 and 9...16 and 7 */
            BOBK_PORTS_56_59_AND_62_AND_64_71_SUMMARY_INT_SUB_TREE_MAC,
            /* TAI Interrupt Cause */
...
/* port 62 has only GIGA mac */
#define SET_EVENT_PORT_62__MAC(_prefix,_postFix)   \
...
#define SET_EVENT_PER_72_PORTS___ON_ALL_PORTS_MAC(_prefix,_postFix)   \
    ...
    SET_EVENT_PORT_62__MAC(_prefix,_postFix)
...
*/
static const GT_U32 bobkUniEvMapTableWithExtData[] = {
 /* Per Queue events */
...
CPSS_PP_GTS_GLOBAL_FIFO_FULL_E,
    PRV_CPSS_BOBK_ERMRK_SUM_INGRESS_TIMESTAMP_QUEUE0_FULL_E,  0,
    PRV_CPSS_BOBK_ERMRK_SUM_EGRESS_TIMESTAMP_QUEUE0_FULL_E,   1,
    PRV_CPSS_BOBK_ERMRK_SUM_INGRESS_TIMESTAMP_QUEUE1_FULL_E,  2,
    PRV_CPSS_BOBK_ERMRK_SUM_EGRESS_TIMESTAMP_QUEUE1_FULL_E,   3,
    SET_EVENT_PER_72_PORTS_WITH_PORT_OFFSET_AND_PARAM___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_PTP,TIMESTAMP_QUEUE0_FULL_E,GTS_INT_EXT_PARAM_MAC(1,0,1) ,8/*port<<8*/),
    SET_EVENT_PER_72_PORTS_WITH_PORT_OFFSET_AND_PARAM___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_PTP,TIMESTAMP_QUEUE1_FULL_E,GTS_INT_EXT_PARAM_MAC(1,1,1) ,8/*port<<8*/),
 MARK_END_OF_UNI_EV_CNS,

 CPSS_PP_GTS_VALID_TIME_SAMPLE_MESSAGE_E,
    PRV_CPSS_BOBK_ERMRK_SUM_NEW_INGRESS_TIMESTAMP_Q0_E,  0,
    PRV_CPSS_BOBK_ERMRK_SUM_NEW_EGRESS_TIMESTAMP_Q0_E,   1,
    PRV_CPSS_BOBK_ERMRK_SUM_NEW_INGRESS_TIMESTAMP_Q1_E,  2,
    PRV_CPSS_BOBK_ERMRK_SUM_NEW_EGRESS_TIMESTAMP_Q1_E,   3,
    SET_EVENT_PER_72_PORTS_WITH_PORT_OFFSET_AND_PARAM___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_PTP,NEW_TIMESTAMP_QUEUE0_E,GTS_INT_EXT_PARAM_MAC(1,0,1),8/*port<<8*/),
    SET_EVENT_PER_72_PORTS_WITH_PORT_OFFSET_AND_PARAM___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_PTP,NEW_TIMESTAMP_QUEUE1_E,GTS_INT_EXT_PARAM_MAC(1,1,1),8/*port<<8*/),
 MARK_END_OF_UNI_EV_CNS,
 ...
 CPSS_PP_PORT_PTP_MIB_FRAGMENT_E,
    /* Ports 0..71 */
    SET_EVENT_PER_72_PORTS___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_PTP,MIB_FRAGMENT_E),
 MARK_END_OF_UNI_EV_CNS,
 ...
 CPSS_PP_PORT_MMPCS_SIGNAL_DETECT_CHANGE_E,
    SET_EVENT_PER_PORTS_56_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_MPCS,SIGNAL_DETECT_CHANGED_E),
 MARK_END_OF_UNI_EV_CNS,

 CPSS_PP_PORT_PCS_ALIGN_LOCK_LOST_E,
    SET_EVENT_PER_PORTS_56_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_MPCS,ALIGN_LOCK_LOST_E),
 MARK_END_OF_UNI_EV_CNS,

 CPSS_PP_PORT_PCS_GB_LOCK_SYNC_CHANGE_E,
    SET_EVENT_PER_PORTS_56_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_MPCS,GB_LOCK_SYNC_CHANGE_E),
 MARK_END_OF_UNI_EV_CNS,
...
/*  The following event is in valid traffic case. Should be verified in HW.
    ...
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBK_TXDMA_0_RX_DMA_UPDATE1_SUM_RX_DMA_1_UPDATES_FIF_OS_OVERRUN_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBK_TXDMA_1_RX_DMA_UPDATE1_SUM_RX_DMA_0_UPDATES_FIF_OS_OVERRUN_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBK_TXDMA_1_RX_DMA_UPDATE1_SUM_RX_DMA_1_UPDATES_FIF_OS_OVERRUN_E),
...
*/
 ...
 /* -- _DFX_ -- */
    /*full register*/ SET_INDEX_EQUAL_EVENT__FULL_REG_MAC(PRV_CPSS_BOBK_DFX_SUM_DFX_INTERRUPT_SUMMARY_E),

    /* -- _DFX_1_ -- */
    /*full register*/ SET_INDEX_EQUAL_EVENT__FULL_REG_MAC(PRV_CPSS_BOBK_DFX1_SUM_DFX_1_INTERRUPT_SUMMARY_E),
 ...
 CPSS_SRVCPU_PORT_LINK_STATUS_CHANGED_E,
    SET_EVENT_PER_72_PORTS___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_AP_DOORBELL,LINK_STATUS_CHANGE_E),
 MARK_END_OF_UNI_EV_CNS,

 CPSS_SRVCPU_PORT_802_3_AP_E,
    SET_EVENT_PER_72_PORTS___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_AP_DOORBELL,802_3_AP_E),
 MARK_END_OF_UNI_EV_CNS

};
/* Interrupt cause to unified event map for BOBK with extended data size */
#define BOBK_NUM_UNI_EVENTS_CNS     (sizeof(bobkUniEvMapTableWithExtData)/(sizeof(GT_U32)))


static const GT_U32 bobkCetusUniEvMapTableWithExtData[] = {
 /* Per Queue events */
 CPSS_PP_TX_BUFFER_QUEUE_E,
    PRV_CPSS_BOBK_TX_SDMA_TX_BUFFER_QUEUE_0_E,  0,
    PRV_CPSS_BOBK_TX_SDMA_TX_BUFFER_QUEUE_1_E,  1,
...
CPSS_PP_GTS_GLOBAL_FIFO_FULL_E,
 ...
 CPSS_PP_PORT_LINK_STATUS_CHANGED_E,
    /* GIGA ports 56..71 */
    SET_EVENT_PER_PORTS_56_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_GIGA,LINK_STATUS_CHANGED_E),
    SET_EVENT_PORT_62__MAC(PRV_CPSS_BOBK_GIGA,LINK_STATUS_CHANGED_E),
    /* XLG ports 56..71 */
    SET_EVENT_PER_PORTS_56_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_XLG,LINK_STATUS_CHANGED_E),
 MARK_END_OF_UNI_EV_CNS,
 ...
 CPSS_PP_PORT_RX_FIFO_OVERRUN_E,
    /* GIGA ports 56..71 */
    SET_EVENT_PER_PORTS_56_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_GIGA,RX_FIFO_OVERRUN_E),
    SET_EVENT_PORT_62__MAC(PRV_CPSS_BOBK_GIGA,RX_FIFO_OVERRUN_E),
    /* XLG ports 56.71 */
    SET_EVENT_PER_PORTS_56_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_XLG,RX_FIFO_OVERRUN_E),
 MARK_END_OF_UNI_EV_CNS,
 ...
 CPSS_PP_PORT_TX_UNDERRUN_E,
    /* GIGA ports 56..71 */
    SET_EVENT_PER_PORTS_56_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_GIGA,TX_UNDERRUN_E),
    SET_EVENT_PORT_62__MAC(PRV_CPSS_BOBK_GIGA,TX_UNDERRUN_E),
    /* XLG ports 56..71 */
    SET_EVENT_PER_PORTS_56_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBK_XLG,TX_UNDERRUN_E),
 MARK_END_OF_UNI_EV_CNS,
...
*/
 ...
 CPSS_PP_PTP_TAI_INCOMING_TRIGGER_E,
    PRV_CPSS_BOBK_TAI_INCOMING_TRIGGER_INT_E,  0,
 MARK_END_OF_UNI_EV_CNS,

 CPSS_PP_PTP_TAI_GENERATION_E,
    PRV_CPSS_BOBK_TAI_GENERATION_INT_E,        0,
 MARK_END_OF_UNI_EV_CNS,
...
/* Interrupt cause to unified event map for BOBK with extended data size */
#define BOBK_CETUS_NUM_UNI_EVENTS_CNS     (sizeof(bobkCetusUniEvMapTableWithExtData)/(sizeof(GT_U32)))

/* Interrupt cause to unified event map for BOBK
 This Table is for unified event without extended data
*/
static const GT_U32 bobkUniEvMapTable[][2] =
{
...
*/
 ...
 {CPSS_SRVCPU_IPC_E,                     PRV_CPSS_BOBK_AP_DOORBELL_MAIN_IPC_E}
};

/* Interrupt cause to unified event map for BOBK without extended data size */
static const GT_U32 bobkUniEvMapTableSize = (sizeof(bobkUniEvMapTable)/(sizeof(GT_U32)*2));
...
*/
static const GT_U32 bobkCetusRemoveFromBobkCaelum[] =
{
...
/**
* @internal setBobKDedicatedEventsConvertInfo function
* @endinternal
*
...
)
{
    ...
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableArr              = bobkUniEvMapTable;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableSize             = bobkUniEvMapTableSize;
...
)
{
    ...
    PRV_CPSS_DRV_INTERRUPTS_INFO_STC devCaelumFamilyInterrupstInfo =
    {
        NULL,
    ...
    PRV_CPSS_DRV_INTERRUPTS_INFO_STC devCetusFamilyInterrupstInfo =
    {
        NULL,
        PRV_CPSS_DRV_FAMILY_DXCH_BOBCAT2_BOBK_CETUS_E,
        BOBK_NUM_ELEMENTS_IN_SCAN_TREE_CNS ,
        bobkIntrScanArr,
        BOBK_NUM_MASK_REGISTERS_CNS,
        NULL, NULL, NULL
    ...
    switch (PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->devType)
    {
        case CPSS_BOBK_CAELUM_DEVICES_CASES_MAC:
            ...
            if (PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(caelumInitDone) == GT_TRUE)
            {
                return GT_OK;
            }

            rc = prvCpssDrvDxExMxInterruptsMemoryInit(&devCaelumFamilyInterrupstInfo, 1);
            if(rc != GT_OK)
            {
                /* error */
                return rc;
            ...
            intrScanArrPtr = devCaelumFamilyInterrupstInfo.intrScanOutArr;
            maskRegDefaultSummaryArrPtr = devCaelumFamilyInterrupstInfo.maskRegDefaultSummaryArr;
            maskRegMapArrPtr = devCaelumFamilyInterrupstInfo.maskRegMapArr;

            PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_SET(caelumInitDone, GT_TRUE);
        ...
        case CPSS_BOBK_CETUS_DEVICES_CASES_MAC:
            ...
            if (PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(cetusInitDone) == GT_TRUE)
            {
                return GT_OK;
            }

            rc = prvCpssDrvDxExMxInterruptsMemoryInit(&devCetusFamilyInterrupstInfo, 1);
            if(rc != GT_OK)
            {
                /* error */
                return rc;
            ...
            rc = prvCpssDrvPpIntRemoveSubTreeList(
                devCetusFamilyInterrupstInfo.intrScanOutArr,/* the 'basic tree' */
            ...
            intrScanArrPtr = devCetusFamilyInterrupstInfo.intrScanOutArr;
            maskRegDefaultSummaryArrPtr = devCetusFamilyInterrupstInfo.maskRegDefaultSummaryArr;
            maskRegMapArrPtr = devCetusFamilyInterrupstInfo.maskRegMapArr;

            PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_SET(cetusInitDone, GT_TRUE);
...
/**
* @internal prvCpssDrvPpIntDefBobKPrint function
* @endinternal
*
...
)
{
    ...
    devInterruptInfoPtr = &PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(prvCpssDrvDevFamilyInterruptInfoArray[PRV_CPSS_DRV_FAMILY_DXCH_BOBCAT2_BOBK_CAELUM_E]);
    if (devInterruptInfoPtr->interruptsScanArray == NULL)
    {
        devInterruptInfoPtr = &PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(prvCpssDrvDevFamilyInterruptInfoArray[PRV_CPSS_DRV_FAMILY_DXCH_BOBCAT2_BOBK_CETUS_E]);
    }
    interruptsScanArray = devInterruptInfoPtr->interruptsScanArray;

    cpssOsPrintf("BobK - start : \n");
    /* port group 0 */
    prvCpssDrvPpIntDefPrint(BOBK_NUM_ELEMENTS_IN_SCAN_TREE_CNS, interruptsScanArray,
                            BOBK_NUM_MASK_REGISTERS_CNS,
...
/**
* @internal prvCpssDrvPpIntDefBobKPrint_regInfoByInterruptIndex function
* @endinternal
*
* @brief   print for BobK devices the register info according to value in
...
)
{
    ...
    else
    {
        ...
        prvCpssDrvPpIntDefPrint_regInfoByInterruptIndex(BOBK_NUM_ELEMENTS_IN_SCAN_TREE_CNS, interruptsScanArray, interruptId, GT_FALSE);
    }

...
#define mac_pcs_USX_NODE_MAC(bit, unit, inst, port, chanIdx)                                        \
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_MTI_USX_##inst##_MAC_##unit##_E, NULL,                   \
        ...
        prvCpssDrvHwPpPortGroupIsrRead,                                                         \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                        \
        PRV_CPSS_AC5P_USX_4_AND_8_MAC_MACRO_INST_##unit##_USX_MAC_UNIT_INST_##inst##_PORT_NUM_##chanIdx##_LINK_OK_CHANGE_E,   \
        PRV_CPSS_AC5P_USX_4_AND_8_MAC_MACRO_INST_##unit##_USX_MAC_UNIT_INST_##inst##_PORT_NUM_##chanIdx##_LPCS_LINK_STATUS_CLEAN_CHANGE_E, \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}
...
#define mac_pcs_USX_SUB_TREE_MAC(bit, unit, inst)                                                   \
    ...
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_MTI_USX_##inst##_MAC_##unit##_E, NULL,                       \
        ...
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 8, NULL, NULL},                                     \
            mac_pcs_USX_NODE_MAC(1, unit, inst, 0, 0),                                              \
            mac_pcs_USX_NODE_MAC(2, unit, inst, 1, 2),                                              \
            mac_pcs_USX_NODE_MAC(3, unit, inst, 2, 1),                                              \
            mac_pcs_USX_NODE_MAC(4, unit, inst, 3, 3),                                              \
            mac_pcs_USX_NODE_MAC(5, unit, inst, 4, 4),                                              \
            mac_pcs_USX_NODE_MAC(6, unit, inst, 5, 6),                                              \
            mac_pcs_USX_NODE_MAC(7, unit, inst, 6, 5),                                              \
            mac_pcs_USX_NODE_MAC(8, unit, inst, 7, 7)
...
#define   eoam_NODE_MAC(bit)                                                                        \
    ...
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_EOAM_E, NULL,                                                \
        ...
        PRV_CPSS_AC5P_EOAM_OAM_UNIT_INTERRUPT_CAUSE_TX_PERIOD_E,                                    \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0,NULL, NULL}
...
#define   ioam_NODE_MAC(bit)                                                        \
    ...
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_IOAM_E,  NULL,                               \
        ...
        PRV_CPSS_AC5P_IOAM_OAM_UNIT_INTERRUPT_CAUSE_TX_PERIOD_E,                    \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}
...
#define cnm_grp_0_8_IntsSum_SUB_TREE_MAC(bit, _mgIndex)                                                 \
/* MG1 Internal Interrupt Cause register */                                                             \
    {bit, GT_FALSE, MG_UNIT(_mgIndex), NULL,                                                            \
        0x0000009c, 0x000000a0,                                                                         \
        prvCpssDrvHwPpPortGroupIsrRead,                                                                 \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                \
        PRV_CPSS_AC5P_MG_##_mgIndex##_MG1_INTERNAL_INTERRUPT_CAUSE_MISCELLANEOUS_INTERRUPT_SUMMARY1_E,           \
        PRV_CPSS_AC5P_MG_##_mgIndex##_MG1_INTERNAL_INTERRUPT_CAUSE_CM3_SRAM_ADDRESS_OUT_OF_RANGE_INTERRUPT_E,    \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}
...
#define misc1_interript_sum(bitIndexInCaller, _mgIndex)                                                           \
        /* Mg Internal Int Sum  */                                                                                \
        {bitIndexInCaller, GT_FALSE, MG_UNIT(_mgIndex), NULL,                                                     \
            0x000009c, 0x00000A0,                                                                                 \
            prvCpssDrvHwPpPortGroupIsrRead,                                                                       \
...
#define  HAWK_INTERRUPTS_MG_1_MAC(bitIndexInCaller, _mgId)                          \
    /* Global Interrupt Cause */                                                    \
    HAWK_MG_GLOBAL_SUMMARY_MAC(bitIndexInCaller, 4 /*numChild*/,_mgId/*mgId*/),     \
        ...
        misc1_interript_sum(18, 1 /*_mgIndex*/)
...
#define  HAWK_INTERRUPTS_MG_x_MAC(bitIndexInCaller, _mgId)                          \
    ...
    HAWK_MG_GLOBAL_SUMMARY_MAC(bitIndexInCaller, 4 /*numChild*/,_mgId/*mgId*/),     \
        ...
        HAWK_MG_Rx_SDMA_SUMMARY_MAC(9, _mgId /*_mgIndex*/),                         \
        /* Misc1 Interrupt SUM bit */                                               \
        misc1_interript_sum(18, _mgId /*_mgIndex*/)
...
{
    /* Global Interrupt Cause */
    HAWK_MG_GLOBAL_SUMMARY_MAC(0, 11 /*numChild*/, 0 /*_mgIndex*/),
        /* FuncUnitsIntsSum Interrupt Cause */
        ...
        cnm_grp_0_8_IntsSum_SUB_TREE_MAC(18, 0 /*_mgIndex*/)
};
...
/* the results of MTI_PORT_NUM(index) are :
    hawkMtiMacPorts[]={0,1,2,6,10,14,18,22};
*/
#define MTI_PORT_NUM(index/*0..7*/) \
    ((index) > 2 ? 2+((index)-2)*4 : (index))

#define HAWK_SET_EVENT_PER_400G_PORT_MAC(_instance, _postFix, _portNum)   \
    PRV_CPSS_AC5P_400G_MAC_INST_##_instance##_PORT_NUM_##_portNum##_##_postFix,      ((_instance) * 26 + MTI_PORT_NUM(_portNum))

#define HAWK_SET_EVENT_PER_SEG_PORT_MAC(_instance, _postFix, _portNum)   \
    PRV_CPSS_AC5P_400G_MAC_INST_##_instance##_SEG_PORT_NUM_##_portNum##_##_postFix,  ((_instance) * 26 + MTI_PORT_NUM(_portNum*4))

#define HAWK_SET_EVENT_PER_USX_PORT_MAC(_unit, _instance, _postFix, _portNum)   \
    PRV_CPSS_AC5P_USX_4_AND_8_MAC_MACRO_INST_##_unit##_USX_MAC_UNIT_INST_##_instance##_PORT_NUM_##_portNum##_##_postFix, (2+ ((_unit) * 26) + ((_instance) * 8) + (_portNum))
...
\
 ...
 MARK_END_OF_UNI_EV_CNS,                                                                                                \
  ...
  CPSS_SRVCPU_SDK_WATCHDOG_E,                                                                                           \
    PRV_CPSS_AC5P_MG_0_MG1_INTERNAL_INTERRUPT_CAUSE_CM3_SECOND_TIMER_INTERRUPT_E,  0,                                   \
    PRV_CPSS_AC5P_MG_1_MG1_INTERNAL_INTERRUPT_CAUSE_CM3_SECOND_TIMER_INTERRUPT_E,  1,                                   \
    PRV_CPSS_AC5P_MG_2_MG1_INTERNAL_INTERRUPT_CAUSE_CM3_SECOND_TIMER_INTERRUPT_E,  2,                                   \
    PRV_CPSS_AC5P_MG_3_MG1_INTERNAL_INTERRUPT_CAUSE_CM3_SECOND_TIMER_INTERRUPT_E,  3,                                   \
 MARK_END_OF_UNI_EV_CNS,                                                                                                \
                                                                                                                        \
 CPSS_SRVCPU_SDK_DOORBELL_E,                                                                                            \
    PRV_CPSS_AC5P_MG_0_MG_INTERNAL_INTERRUPT_CAUSE_CM3_TO_HOST_DOORBELL_INTERRUPT_E,  0,                                \
    PRV_CPSS_AC5P_MG_1_MG_INTERNAL_INTERRUPT_CAUSE_CM3_TO_HOST_DOORBELL_INTERRUPT_E,  1,                                \
    PRV_CPSS_AC5P_MG_2_MG_INTERNAL_INTERRUPT_CAUSE_CM3_TO_HOST_DOORBELL_INTERRUPT_E,  2,                                \
    PRV_CPSS_AC5P_MG_3_MG_INTERNAL_INTERRUPT_CAUSE_CM3_TO_HOST_DOORBELL_INTERRUPT_E,  3,                                \
 MARK_END_OF_UNI_EV_CNS,                                                                                                \
                                                                                                                        \
...
\
 ...
 CPSS_PP_OAM_EXCEPTION_KEEPALIVE_AGING_E,                                                                               \
    HAWK_SET_EQUAL_EVENT_WITH_POSTFIX_MAC(IOAM_OAM_UNIT_INTERRUPT_CAUSE_KEEP_ALIVE_AGING_E),                      \
    HAWK_SET_EQUAL_EVENT_WITH_POSTFIX_MAC(EOAM_OAM_UNIT_INTERRUPT_CAUSE_KEEP_ALIVE_AGING_E),                      \
                                                                                                                        \
 MARK_END_OF_UNI_EV_CNS,                                                                                                \
                                                                                                                        \
...
#define AC5P_PORT_LANE_SQ_EVENTS                                 \
    PRV_CPSS_AC5P_SDW_INST_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 0,\
    PRV_CPSS_AC5P_SDW_INST_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                 1,\
    PRV_CPSS_AC5P_SDW_INST_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                 2,\
    PRV_CPSS_AC5P_SDW_INST_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                 3,\
    PRV_CPSS_AC5P_SDW_INST_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 4,\
    PRV_CPSS_AC5P_SDW_INST_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                 5,\
    PRV_CPSS_AC5P_SDW_INST_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                 6,\
    PRV_CPSS_AC5P_SDW_INST_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                 7,\
    PRV_CPSS_AC5P_SDW_INST_2_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 8,\
    PRV_CPSS_AC5P_SDW_INST_2_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                 9,\
    PRV_CPSS_AC5P_SDW_INST_2_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                 10,\
    PRV_CPSS_AC5P_SDW_INST_2_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                 11,\
    PRV_CPSS_AC5P_SDW_INST_3_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 12,\
    PRV_CPSS_AC5P_SDW_INST_3_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                 13,\
    PRV_CPSS_AC5P_SDW_INST_3_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                 14,\
    PRV_CPSS_AC5P_SDW_INST_3_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                 15,\
    PRV_CPSS_AC5P_SDW_INST_4_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 16,\
    PRV_CPSS_AC5P_SDW_INST_4_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                 17,\
    PRV_CPSS_AC5P_SDW_INST_4_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                 18,\
    PRV_CPSS_AC5P_SDW_INST_4_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                 19,\
    PRV_CPSS_AC5P_SDW_INST_5_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 20,\
    PRV_CPSS_AC5P_SDW_INST_5_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                 21,\
    PRV_CPSS_AC5P_SDW_INST_5_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                 22,\
    PRV_CPSS_AC5P_SDW_INST_5_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                 23,\
    PRV_CPSS_AC5P_SDW_INST_6_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 24,\
    PRV_CPSS_AC5P_SDW_INST_6_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                 25,\
    PRV_CPSS_AC5P_SDW_INST_6_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                 26,\
    PRV_CPSS_AC5P_SDW_INST_6_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                 27,\
    PRV_CPSS_AC5P_SDW_INST_7_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 28,\
    PRV_CPSS_AC5P_SDW_INST_7_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                 29,\
    PRV_CPSS_AC5P_SDW_INST_7_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                 30,\
    PRV_CPSS_AC5P_SDW_INST_7_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                 31,\
    PRV_CPSS_AC5P_SDW_28G_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                    32
...
static const GT_U32 hawkUniEvMapTable[][2] =
{
    ...
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_0_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_1_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_2_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_3_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_4_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_5_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_6_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_7_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_8_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_9_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_10_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_11_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_12_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_13_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_14_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_0_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_15_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_0_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_1_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_2_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_3_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_4_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_5_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_6_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_7_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_8_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_9_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_10_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_11_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_12_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_13_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_14_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_1_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_15_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_0_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_1_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_2_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_3_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_4_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_5_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_6_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_7_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_8_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_9_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_10_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_11_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_12_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_13_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_14_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5P_PB_SMB_INST_2_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_15_INTERRUPT_AGE_ERR_E},
...
*          Hawk devices.
*/
GT_STATUS prvCpssHawkDedicatedEventsNonSharedConvertInfoSet(IN GT_U8   devNum)
{

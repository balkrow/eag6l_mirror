...
/**
********************************************************************************
* @file cpssDrvPpIntDefDxChLion2.c
*
...
extern GT_BOOL prvCpssLion2DuplicatedMultiPortGroupsGet
(
...
*/
static const GT_U32 lion2UniEvMapTableWithExtData[] = {
...
static const GT_U32 lion2UniEvMapTableWithExtDataSize = (sizeof(lion2UniEvMapTableWithExtData)/(sizeof(GT_U32)));


/* Interrupt cause to unified event map for Lion2
 This Table is for unified event without extended data
*/
static const PRV_CPSS_DRV_EVENT_INFO_TYPE lion2UniEvMapTable[] =
{
...
static const GT_U32 lion2UniEvMapTableSize = (sizeof(lion2UniEvMapTable)/(sizeof(PRV_CPSS_DRV_EVENT_INFO_TYPE)));


/**
* @internal setLion2DedicatedEventsConvertInfo function
* @endinternal
*
...
{
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableWithExtDataArr   = lion2UniEvMapTableWithExtData;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableWithExtDataSize  = lion2UniEvMapTableWithExtDataSize;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableArr              = lion2UniEvMapTable;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableSize             = lion2UniEvMapTableSize;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.numReservedPorts              = 16;
...
GT_STATUS prvCpssDrvPpIntDefDxChLion2Init(IN GT_U8   devNum)
{
    ...
    GT_BOOL isAdditionalRegDupNeededPtr;
    PRV_CPSS_DUPLICATED_ADDITIONAL_ADDRESSES_INFO_STC additionalRegDup;
    /* device interrupt info */
    PRV_CPSS_DRV_INTERRUPTS_INFO_STC devFamilyInterrupstInfoArr[LION2_NUM_PORT_GROUPS_CNS] =
    {
        {
            NULL,
        ...
        ,{
            NULL,
            PRV_CPSS_DRV_FAMILY_DXCH_LION2_PORT_GROUP_ID_2_E,
            LION2_NUM_ELEMENTS_IN_SCAN_TREE_CNS,
            lion2IntrScanArrSinglePortGroup,
            LION2_NUM_MASK_REGISTERS_CNS,
            NULL, NULL, NULL
        ...
        ,{
            NULL,
            PRV_CPSS_DRV_FAMILY_DXCH_LION2_PORT_GROUP_ID_3_E,
            LION2_NUM_ELEMENTS_IN_SCAN_TREE_CNS,
            lion2IntrScanArrSinglePortGroup,
            LION2_NUM_MASK_REGISTERS_CNS,
            NULL, NULL, NULL
        ...
        ,{
            NULL,
            PRV_CPSS_DRV_FAMILY_DXCH_LION2_PORT_GROUP_ID_4_E,
            LION2_NUM_ELEMENTS_IN_SCAN_TREE_CNS,
            lion2IntrScanArrSinglePortGroup,
            LION2_NUM_MASK_REGISTERS_CNS,
            NULL, NULL, NULL
        ...
        ,{
            NULL,
            PRV_CPSS_DRV_FAMILY_DXCH_LION2_PORT_GROUP_ID_5_E,
            LION2_NUM_ELEMENTS_IN_SCAN_TREE_CNS,
            lion2IntrScanArrSinglePortGroup,
            LION2_NUM_MASK_REGISTERS_CNS,
            NULL, NULL, NULL
        ...
        ,{
            NULL,
            PRV_CPSS_DRV_FAMILY_DXCH_LION2_PORT_GROUP_ID_7_E,
            LION2_NUM_ELEMENTS_IN_SCAN_TREE_CNS,
            lion2IntrScanArrSinglePortGroup,
            LION2_NUM_MASK_REGISTERS_CNS,
            NULL, NULL, NULL
    ...
    if(PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(lion2InitDone) == GT_TRUE)
    {
        return GT_OK;
    }

    rc = prvCpssDrvDxExMxInterruptsMemoryInit(devFamilyInterrupstInfoArr, LION2_NUM_PORT_GROUPS_CNS);
    if(rc != GT_OK)
    {
        /* error */
        return rc;
    ...
    devFamilyPtr = &PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(prvCpssDrvDevFamilyInterruptInfoArray[PRV_CPSS_DRV_FAMILY_DXCH_LION2_PORT_GROUP_ID_0_E]);

    for(portGroupId = 0; portGroupId < LION2_NUM_PORT_GROUPS_CNS; portGroupId++, devFamilyPtr++)
    {
        /*
        ...
        */
        rc = prvCpssDrvExMxDxHwPpMaskRegInfoGet(
                ...
                LION2_NUM_ELEMENTS_IN_SCAN_TREE_CNS,
                devFamilyInterrupstInfoArr[portGroupId].intrScanOutArr,
                LION2_NUM_MASK_REGISTERS_CNS,
                devFamilyInterrupstInfoArr[portGroupId].maskRegDefaultSummaryArr,
                devFamilyInterrupstInfoArr[portGroupId].maskRegMapArr);
        if(rc != GT_OK)
        {
            /* error */
            return rc;
        ...
        for(ii = 0 ; ii < LION2_NUM_MASK_REGISTERS_CNS; ii++)
        {
            ...
            if(GT_TRUE == prvCpssLion2DuplicatedMultiPortGroupsGet(devNum,
                    CPSS_PORT_GROUP_UNAWARE_MODE_CNS, devFamilyInterrupstInfoArr[portGroupId].maskRegMapArr[ii],
                    &portGroupsBmp, &isAdditionalRegDupNeededPtr, &additionalRegDup, NULL))
            {
                if(0 == (portGroupsBmp & (1 << portGroupId)))
                {
                    devFamilyInterrupstInfoArr[portGroupId].maskRegMapArr[ii] = dummyMaskRegAddr;
                }
            }
        }
        ...
        devFamilyPtr->maskRegistersAddressesArray = devFamilyInterrupstInfoArr[portGroupId].maskRegMapArr;
        devFamilyPtr->maskRegistersDefaultValuesArray = devFamilyInterrupstInfoArr[portGroupId].maskRegDefaultSummaryArr;
        devFamilyPtr->interruptsScanArray = devFamilyInterrupstInfoArr[portGroupId].intrScanOutArr;
    ...
    PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_SET(lion2InitDone, GT_TRUE);
...
#ifdef GM_USED
/**
* @internal prvCpssDrvPpIntDefDxChBobcat2Init__GM function
* @endinternal
*
* @brief   Interrupts initialization for the Bobcat2_Gm devices.
*
* @retval GT_OK                    - on success,
* @retval GT_OUT_OF_CPU_MEM        - fail to allocate cpu memory (osMalloc)
* @retval GT_BAD_PARAM             - the scan tree information has error
...
)
{
...
#if 0  /* code below is not relevant for latest GMs */
    ...
    if(PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(bc2InitDone) == 0)
    {
        PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_SET(bc2InitDone, 1);
    ...
    for(ii = 0 ; ii < BOBCAT2_NUM_ELEMENTS_IN_SCAN_TREE_CNS; ii++)
    {
        ...
        if(0x00000000 == (causeRegAddr & 0xFF000000))/* MG unit */
        {
            /* needed for FALCON */
            unitBaseAddr = prvCpssDxChHwUnitBaseAddrGet(devNum,PRV_CPSS_DXCH_UNIT_MG_E,NULL);
        ...
        if(causeRegAddr == 0x06000018) /*FDB*/
        {
            ...
            /*can't use : PRV_CPSS_SIP_7_CHECK_MAC(devNum) at this stage , as
              PRV_CPSS_PP_MAC(devNum) is still NULL */
            GT_U32  fdbRegistersRelativeBase =
                CPSS_DXCH_ALL_SIP7_FAMILY_MAC(PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->devFamily) ?
                AAS_FDB_REG_RELATIVE_BASE : 0;

            unitBaseAddr = prvCpssDxChHwUnitBaseAddrGet(devNum,PRV_CPSS_DXCH_UNIT_FDB_E,NULL);
            bobcat2_Gm_IntrScanArrSinglePortGroup[ii].causeRegAddr =
                unitBaseAddr + 0x000001B0 + fdbRegistersRelativeBase;
            bobcat2_Gm_IntrScanArrSinglePortGroup[ii].maskRegAddr =
                unitBaseAddr + 0x000001B4 + fdbRegistersRelativeBase;
    ...
    */
    ...
    /* lion2 info, port group 0 */
    devInterruptInfoPtr =
        &PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(prvCpssDrvDevFamilyInterruptInfoArray[PRV_CPSS_DRV_FAMILY_DXCH_LION2_PORT_GROUP_ID_0_E]);
...
/**
* @internal prvCpssDrvPpIntDefLion2Print function
* @endinternal
*
* @brief   print the interrupts arrays info, of lion2 devices
*/
...
)
{
    ...
    devInterruptInfoPtr = &PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(prvCpssDrvDevFamilyInterruptInfoArray[PRV_CPSS_DRV_FAMILY_DXCH_LION2_PORT_GROUP_ID_0_E]);

    /* port group 0 */
    prvCpssDrvPpIntDefPrint(LION2_NUM_ELEMENTS_IN_SCAN_TREE_CNS, devInterruptInfoPtr->interruptsScanArray,
                            LION2_NUM_MASK_REGISTERS_CNS,

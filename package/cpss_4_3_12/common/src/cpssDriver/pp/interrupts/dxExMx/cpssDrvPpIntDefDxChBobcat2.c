...
/**
********************************************************************************
* @file cpssDrvPpIntDefDxChBobcat2.c
*
...
#define BOBCAT2_XLG_ODD_PORT_SUMMARY_INT_SUB_TREE_MAC(bitIndexInCaller,port)   \
                ...
                FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 4+(XPCS_BIT4_EXISTS_MAC(port)),NULL, NULL},\
                    ...
                    prvCpssDrvHwPpPortGroupIsrRead,                          \
                    prvCpssDrvHwPpPortGroupIsrWrite,                         \
                    PRV_CPSS_BOBCAT2_MPCS_PORT_##port##_ACCESS_ERROR_E,  \
                    PRV_CPSS_BOBCAT2_MPCS_PORT_##port##_GB_LOCK_SYNC_CHANGE_E,  \
                    FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0,NULL, NULL},  \
                    /*bit 7*/ \
...
#define LAST_ENTRY_DRV_INTERRUPT_SCAN_OVERRIDE_INFO_CNS     LAST_ENTRY_INT_CAUSE_CNS,\
   {0, GT_FALSE, PRV_CPSS_DXCH_UNIT___NOT_VALID___E, NULL, 0, 0, NULL, NULL, \
        PRV_CPSS_BOBCAT2_B0_OVERRIDE_LAST_INT_E,                          \
        PRV_CPSS_BOBCAT2_B0_OVERRIDE_LAST_INT_E,        \
        FILLED_IN_RUNTIME_CNS, 0, 0x0, 0 , NULL, NULL}/* structure to allow 'override' of element in the interrupts tree by other element.
...
static const PRV_CPSS_DRV_INTERRUPT_SCAN_STC txqLl_NODE_arr[] = {
    txqLl_NODE_MAC(TXQLL_BIT_CNS)
};
static const GT_U32   txqLl_NODE_numEntries = sizeof(txqLl_NODE_arr)/sizeof(txqLl_NODE_arr[0]);

static const PRV_CPSS_DRV_INTERRUPT_SCAN_STC bc2_B0_txqLl_SUB_TREE_arr[] = {
    bc2_B0_txqLl_SUB_TREE_MAC(TXQLL_BIT_CNS)
};
static const GT_U32   bc2_B0_txqLl_SUB_TREE_numEntries = sizeof(bc2_B0_txqLl_SUB_TREE_arr)/sizeof(bc2_B0_txqLl_SUB_TREE_arr[0]);
...
static const PRV_CPSS_DRV_INTERRUPT_SCAN_STC txqPfc_SUB_TREE_arr[] = {
    txqPfc_SUB_TREE_MAC(TXQPFC_BIT_CNS)
};
static const GT_U32   txqPfc_SUB_TREE_numEntries = sizeof(txqPfc_SUB_TREE_arr)/sizeof(txqPfc_SUB_TREE_arr[0]);
...
static const PRV_CPSS_DRV_INTERRUPT_SCAN_STC bc2_B0_txqPfc_SUB_TREE_arr[] = {
    bc2_B0_txqPfc_SUB_TREE_MAC(TXQPFC_BIT_CNS)
};
static const GT_U32   bc2_B0_txqPfc_SUB_TREE_numEntries = sizeof(bc2_B0_txqPfc_SUB_TREE_arr)/sizeof(bc2_B0_txqPfc_SUB_TREE_arr[0]);
...
#define   txDma_SUB_TREE_MAC(bit)                                          \
    ...
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_TXDMA_E, NULL, 0x26002040, 0x26002044,         \
        ...
        {7, GT_FALSE, PRV_CPSS_DXCH_UNIT_TXDMA_E, NULL, 0x26002038, 0x2600203c,          \
            prvCpssDrvHwPpPortGroupIsrRead,                                              \
            prvCpssDrvHwPpPortGroupIsrWrite,                                             \
            PRV_CPSS_BOBCAT2_TXDMA_GENERAL_SUM_REQUEST_EXECUTOR_NOT_READY_E,             \
            PRV_CPSS_BOBCAT2_B0_TXDMA_GENERAL_SUM_BANK_REQUESTS_ON_AIR_REACHED_MAXIMAL_THRESHOLD_E, \
            FILLED_IN_RUNTIME_CNS, 0, 0x0, 0 , NULL, NULL},                              \
...
#define   txFifo_SUB_TREE_MAC(bit)                                          \
    ...
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_TX_FIFO_E, NULL, 0x27000440, 0x27000444,            \
        ...
        {1, GT_FALSE, PRV_CPSS_DXCH_UNIT_TX_FIFO_E, NULL, 0x27000400, 0x27000404,        \
            prvCpssDrvHwPpPortGroupIsrRead,                                              \
            prvCpssDrvHwPpPortGroupIsrWrite,                                             \
            PRV_CPSS_BOBCAT2_TX_FIFO_GENERAL1_SUM_LATENCY_FIFO_NOT_READY_E,              \
            PRV_CPSS_BOBCAT2_TX_FIFO_GENERAL1_SUM_CT_BC_IDDB_I_DS_RUN_OUT_E,             \
            FILLED_IN_RUNTIME_CNS, 0, 0x0, 0 , NULL, NULL},                              \
...
#define   AP_Doorbell_SUB_TREE_MAC(bit)                                     \
    ...
    {bit,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000010, 0x00000011,    \
        ...
        PRV_CPSS_BOBCAT2_AP_DOORBELL_MAIN_IPC_E,                            \
        PRV_CPSS_BOBCAT2_AP_DOORBELL_MAIN_RESERVED31_E,                     \
        ...
        {4,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000012, 0x00000013,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_0_LINK_STATUS_CHANGE_E,       \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_31_LINK_STATUS_CHANGE_E,      \
        ...
        {5,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000014, 0x00000015,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_32_LINK_STATUS_CHANGE_E,      \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_63_LINK_STATUS_CHANGE_E,      \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL},          \
        /* AP_DOORBELL_PORT64_95_LINK_STATUS_CHANGE */                      \
        {6,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000016, 0x00000017,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_64_LINK_STATUS_CHANGE_E,      \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_95_LINK_STATUS_CHANGE_E,      \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL},          \
        /* AP_DOORBELL_PORT0_31_802_3_AP */                                 \
        {8,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000018, 0x00000019,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_0_802_3_AP_E,                 \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_31_802_3_AP_E,                \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL},          \
        /* AP_DOORBELL_PORT32_63_802_3_AP */                                \
        {9,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x0000001a, 0x0000001b,  \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_32_802_3_AP_E,                \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_63_802_3_AP_E,                \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL},          \
        /* AP_DOORBELL_PORT64_95_802_3_AP */                                \
        {10,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x0000001c, 0x0000001d, \
            prvCpssGenericSrvCpuRegisterRead,                               \
            prvCpssGenericSrvCpuRegisterWrite,                              \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_64_802_3_AP_E,                \
            PRV_CPSS_BOBCAT2_AP_DOORBELL_PORT_95_802_3_AP_E,                \
            FILLED_IN_RUNTIME_CNS, 0xFFFFFFFF, 0x0, 0,NULL, NULL}
...
static const PRV_CPSS_DRV_INTERRUPT_SCAN_STC bobcat2IntrScanArr[] =
{
    ...
    {0, GT_FALSE, PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000030, 0x00000034,
       ...
       {6, GT_FALSE, PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x000000ac, 0x000000b0,
            prvCpssDrvHwPpPortGroupIsrRead,
            prvCpssDrvHwPpPortGroupIsrWrite,
            PRV_CPSS_BOBCAT2_DFX_SUM_DFX_INTERRUPT_SUM_1_E,
            PRV_CPSS_BOBCAT2_DFX_SUM_DFX_INTERRUPT_SUM_31_E,
        ...
        {7,GT_FALSE,PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x00000038, 0x0000003C,
            ...
            FILLED_IN_RUNTIME_CNS, 0x0, 0xFEFFFFFF, 1,NULL, NULL},
        ...
        {10, GT_FALSE, PRV_CPSS_DXCH_UNIT_MG_E, NULL, 0x000000b8, 0x000000bc,
            prvCpssDrvHwPpPortGroupIsrRead,
            prvCpssDrvHwPpPortGroupIsrWrite,
            PRV_CPSS_BOBCAT2_DFX1_SUM_DFX_1_INTERRUPT_SUM_1_E,
            PRV_CPSS_BOBCAT2_DFX1_SUM_DFX_1_INTERRUPT_SUM_31_E,
            FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}, /* without children yet */
...
static const PRV_CPSS_DRV_INTERRUPT_SCAN_OVERRIDE_INFO_STC    bc2B0OverrideA0Arr[] =
{
...
*/
static const GT_U32 bobcat2UniEvMapTableWithExtData[] = {
 /* Per Queue events */
...
CPSS_PP_GTS_GLOBAL_FIFO_FULL_E,
    PRV_CPSS_BOBCAT2_ERMRK_SUM_INGRESS_TIMESTAMP_QUEUE0_FULL_E,  0,
    PRV_CPSS_BOBCAT2_ERMRK_SUM_EGRESS_TIMESTAMP_QUEUE0_FULL_E,   1,
    PRV_CPSS_BOBCAT2_ERMRK_SUM_INGRESS_TIMESTAMP_QUEUE1_FULL_E,  2,
    PRV_CPSS_BOBCAT2_ERMRK_SUM_EGRESS_TIMESTAMP_QUEUE1_FULL_E,   3,
    SET_EVENT_PER_72_PORTS_WITH_PORT_OFFSET_AND_PARAM___ON_ALL_PORTS_MAC(PRV_CPSS_BOBCAT2_PTP,TIMESTAMP_QUEUE0_FULL_E,GTS_INT_EXT_PARAM_MAC(1,0,1) ,8),
    SET_EVENT_PER_72_PORTS_WITH_PORT_OFFSET_AND_PARAM___ON_ALL_PORTS_MAC(PRV_CPSS_BOBCAT2_PTP,TIMESTAMP_QUEUE1_FULL_E,GTS_INT_EXT_PARAM_MAC(1,1,1) ,8),
 MARK_END_OF_UNI_EV_CNS,

 CPSS_PP_GTS_VALID_TIME_SAMPLE_MESSAGE_E,
    PRV_CPSS_BOBCAT2_ERMRK_SUM_NEW_INGRESS_TIMESTAMP_Q0_E,  0,
    PRV_CPSS_BOBCAT2_ERMRK_SUM_NEW_EGRESS_TIMESTAMP_Q0_E,   1,
    PRV_CPSS_BOBCAT2_ERMRK_SUM_NEW_INGRESS_TIMESTAMP_Q1_E,  2,
    PRV_CPSS_BOBCAT2_ERMRK_SUM_NEW_EGRESS_TIMESTAMP_Q1_E,   3,
    SET_EVENT_PER_72_PORTS_WITH_PORT_OFFSET_AND_PARAM___ON_ALL_PORTS_MAC(PRV_CPSS_BOBCAT2_PTP,NEW_TIMESTAMP_QUEUE0_E,GTS_INT_EXT_PARAM_MAC(1,0,1),8),
    SET_EVENT_PER_72_PORTS_WITH_PORT_OFFSET_AND_PARAM___ON_ALL_PORTS_MAC(PRV_CPSS_BOBCAT2_PTP,NEW_TIMESTAMP_QUEUE1_E,GTS_INT_EXT_PARAM_MAC(1,1,1),8),
 MARK_END_OF_UNI_EV_CNS,
 ...
 CPSS_PP_PORT_MMPCS_SIGNAL_DETECT_CHANGE_E,
    SET_EVENT_PER_PORTS_48_71___ON_ALL_PORTS_MAC(PRV_CPSS_BOBCAT2_MPCS,SIGNAL_DETECT_CHANGED_E),
 MARK_END_OF_UNI_EV_CNS,
 ...
 CPSS_PP_TTI_ACCESS_DATA_ERROR_E,
    PRV_CPSS_BOBCAT2_B0_TTI_SUM_TTI0_ACCESS_DATA_ERROR_E, 0,
    PRV_CPSS_BOBCAT2_B0_TTI_SUM_TTI1_ACCESS_DATA_ERROR_E, 1,
    PRV_CPSS_BOBCAT2_B0_TTI_SUM_TTI2_ACCESS_DATA_ERROR_E, 2,
    PRV_CPSS_BOBCAT2_B0_TTI_SUM_TTI3_ACCESS_DATA_ERROR_E, 3,
 MARK_END_OF_UNI_EV_CNS,
...
/*  The following event is in valid traffic case. Should be verified in HW.
    ...
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_TXDMA_GENERAL_SUM_TX_Q_TO_TX_DMA_HA_DESC_OVERRUN_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_TXDMA_GENERAL_SUM_TX_Q_TO_TX_DMA_DESC_OVERRUN_E),
...
/*full register*/    SET_INDEX_EQUAL_EVENT__FULL_REG_MAC(PRV_CPSS_BOBCAT2_CRITICAL_ECC_ERROR_BM_CRITICAL_ECC_SUM_E),
    ...
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_B0_TTI_SUM_SECOND_CRITICAL_ECC_ONE_ERROR_CORRECTED_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_B0_TTI_SUM_SECOND_CRITICAL_ECC_TWO_ERROR_DETECTED_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_B0_TTI_SUM_FIRST_CRITICAL_ECC_TWO_ERROR_DETECTED_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_B0_TTI_SUM_FIRST_CRITICAL_ECC_ONE_ERROR_CORRECTED_E),
    ...
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_TXDMA_GENERAL_SUM_ECC_SINGLE_ERROR_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_TXDMA_GENERAL_SUM_ECC_DOUBLE_ERROR_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_TX_FIFO_GENERAL1_SUM_ECC_0_SINGLE_ERROR_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_TX_FIFO_GENERAL1_SUM_ECC_1_SINGLE_ERROR_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_TX_FIFO_GENERAL1_SUM_ECC_0_DOUBLE_ERROR_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_TX_FIFO_GENERAL1_SUM_ECC_1_DOUBLE_ERROR_E),
...
*/
...
#endif /*0*/
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_B0_BM_GEN1_SUM_CORE_0_VALID_TABLE_PARITY_ERROR_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_B0_BM_GEN1_SUM_CORE_1_VALID_TABLE_PARITY_ERROR_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_B0_BM_GEN1_SUM_CORE_2_VALID_TABLE_PARITY_ERROR_E),
    SET_INDEX_EQUAL_EVENT_MAC(PRV_CPSS_BOBCAT2_B0_BM_GEN1_SUM_CORE_3_VALID_TABLE_PARITY_ERROR_E),
    ...
    */
    ...
    /* -- _DFX_ -- */
    /*full register*/ SET_INDEX_EQUAL_EVENT__FULL_REG_MAC(PRV_CPSS_BOBCAT2_DFX_SUM_DFX_INTERRUPT_SUMMARY_E),

    /* -- _DFX_1_ -- */
    /*full register*/ SET_INDEX_EQUAL_EVENT__FULL_REG_MAC(PRV_CPSS_BOBCAT2_DFX1_SUM_DFX_1_INTERRUPT_SUMMARY_E),
 MARK_END_OF_UNI_EV_CNS,
 ...
 CPSS_SRVCPU_PORT_LINK_STATUS_CHANGED_E,
    SET_EVENT_PER_72_PORTS___ON_ALL_PORTS_MAC(PRV_CPSS_BOBCAT2_AP_DOORBELL,LINK_STATUS_CHANGE_E),
 MARK_END_OF_UNI_EV_CNS,

 CPSS_SRVCPU_PORT_802_3_AP_E,
    SET_EVENT_PER_72_PORTS___ON_ALL_PORTS_MAC(PRV_CPSS_BOBCAT2_AP_DOORBELL,802_3_AP_E),
 MARK_END_OF_UNI_EV_CNS

};
/* Interrupt cause to unified event map for Bobcat2 with extended data size */
static const GT_U32 bobcat2UniEvMapTableWithExtDataSize = (sizeof(bobcat2UniEvMapTableWithExtData)/(sizeof(GT_U32)));


/* Interrupt cause to unified event map for Bobcat2
 This Table is for unified event without extended data
*/
static const GT_U32 bobcat2UniEvMapTable[][2] =
{
...
*/
 ...
 {CPSS_SRVCPU_IPC_E,                     PRV_CPSS_BOBCAT2_AP_DOORBELL_MAIN_IPC_E}
};

/* Interrupt cause to unified event map for Bobcat2 without extended data size */
static const GT_U32 bobcat2UniEvMapTableSize = (sizeof(bobcat2UniEvMapTable)/(sizeof(GT_U32)*2));


/**
* @internal setBobcat2DedicatedEventsConvertInfo function
* @endinternal
*
...
{
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableWithExtDataArr   = bobcat2UniEvMapTableWithExtData;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableWithExtDataSize  = bobcat2UniEvMapTableWithExtDataSize;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableArr              = bobcat2UniEvMapTable;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.uniEvMapTableSize             = bobcat2UniEvMapTableSize;
    PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->intCtrl.numReservedPorts              = 72;

    return;
}

/**
* @internal skipSubTreeOfValidSubTree function
* @endinternal
*
* @brief   set indication on sub tree that it should be ignored (skipped).
*
...
/**
* @internal replaceSubTree function
* @endinternal
*
* @brief   replace in 'main tree' 'old sub tree' with 'new sub tree'
*         NOTE: the 'old sub tree' must be larger the the 'new sub tree'
* @param[in] fullTreePtr              - pointer to the 'Full tree' of interrupts
* @param[in] numElementsInFullTree    - number of elements in the 'Full tree'
* @param[in] numElementsInOldSubTree  - number of elements in the 'old sub tree'
* @param[in] newSubTreePtr            - pointer to the 'new sub tree' of interrupts
* @param[in] numElementsInNewSubTree  - number of elements in the 'new sub tree'
* @param[in] subTreeIndex             - index in the 'Full tree' that represent the 'Old sub tree'
*                                      which need replacement.
*
* @retval GT_OK                    - on success,
* @retval GT_BAD_PARAM             - the 'old sub tree' smaller then the 'new sub tree'
*/
...
(
    ...
    IN const PRV_CPSS_DRV_INTERRUPT_SCAN_STC    *newSubTreePtr ,
...
/**
* @internal jumpSubTree function
* @endinternal
*
* @brief   jump over sub tree.
*
* @param[in] fullTreePtr              - pointer to the 'Full tree' of interrupts
* @param[in] numElementsInFullTree    - number of elements in the 'Full tree'
* @param[in] subTreeIndex             - index in the 'Full tree' that represent the 'Sub tree'
...
)
{
    ...
    {
        NULL,
        PRV_CPSS_DRV_FAMILY_DXCH_BOBCAT2_E,
    ...
    if(PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(bc2InitDone) == GT_TRUE)
    {
        return GT_OK;
    }
    ...
    */
    ...
    if(PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->devSubFamily == CPSS_PP_SUB_FAMILY_NONE_E)
    {
    ...
    if(0 == isBc2A0)
    {
        ...
        for(jj = 0 ; jj < BOBCAT2_NUM_ELEMENTS_IN_SCAN_TREE_CNS ; jj++)
        {
            ...
            if((PRV_CPSS_DXCH_UNIT_ENT)devFamilyInterrupstInfo.intrScanOutArr[jj].gppId ==
                                                PRV_CPSS_DXCH_UNIT_RXDMA_E)
            {
                /* the tree hold addresses of A0 need to add to all 0x500 */
                devFamilyInterrupstInfo.intrScanOutArr[jj].causeRegAddr += BC2_B0_RXDMA_OFFSET_FROM_A0_CNS;
                devFamilyInterrupstInfo.intrScanOutArr[jj].maskRegAddr  += BC2_B0_RXDMA_OFFSET_FROM_A0_CNS;
            }
            else
            if((devFamilyInterrupstInfo.intrScanOutArr[jj].gppId & EXTRA_INFO_SUB_TREE_MASK_CNS) ==
                    A0_TXQ_PFC_TO_REPLACE_WITH_B0_SUB_TREE_CNS)
            {
                ...
                rc = replaceSubTree(devFamilyInterrupstInfo.intrScanOutArr, BOBCAT2_NUM_ELEMENTS_IN_SCAN_TREE_CNS/* max elements */ ,
                    /* old info */
            ...
            devFamilyInterrupstInfo.intrScanOutArr[orig_jj].gppId &= ~EXTRA_INFO_SUB_TREE_MASK_CNS;
        }
        ...
        for(ii = 0 ; bc2B0OverrideA0Arr[ii].oldIntCause != LAST_ENTRY_INT_CAUSE_CNS ; ii++)
        {
            ...
            for(jj = 0 ; jj < BOBCAT2_NUM_ELEMENTS_IN_SCAN_TREE_CNS ; jj++)
            {
                if(bc2B0OverrideA0Arr[ii].oldIntCause == devFamilyInterrupstInfo.intrScanOutArr[jj].startIdx)
                {
                    /* match */
                    break;
                }
            ...
            devFamilyInterrupstInfo.intrScanOutArr[jj] = bc2B0OverrideA0Arr[ii].newInfo;
        }
    }
    else /* A0 */
    {
        ...
        for(jj = 0 ; jj < BOBCAT2_NUM_ELEMENTS_IN_SCAN_TREE_CNS ; jj++)
        {
            ...
            if((devFamilyInterrupstInfo.intrScanOutArr[jj].gppId & EXTRA_INFO_SUB_TREE_MASK_CNS) ==
                    NON_A0_SUB_TREE_CNS)
            {
                orig_maskRcvIntrEn = devFamilyInterrupstInfo.intrScanOutArr[jj].maskRcvIntrEn;
                /* state that all leaf under this sub tree to be 'ignored'*/
                /* as it is NOT valid for A0 devices */
                rc = skipSubTreeOfValidSubTree(devFamilyInterrupstInfo.intrScanOutArr , BOBCAT2_NUM_ELEMENTS_IN_SCAN_TREE_CNS/* max elements */ ,
                ...
                for(ii = 0; ii < orig_jj ; ii++)
                {
                    ...
                    if((orig_maskRcvIntrEn >> 5) ==
                        (devFamilyInterrupstInfo.intrScanOutArr[ii].startIdx >> 5))
                    {
                        /* match found */
                        break;
                    }
                ...
                devFamilyInterrupstInfo.intrScanOutArr[ii].subIntrListLen --;
            }
            else
            if((devFamilyInterrupstInfo.intrScanOutArr[jj].gppId & EXTRA_INFO_SUB_TREE_MASK_CNS) ==
    ...
    */
    ...
    /* bobcat2 info */
    devInterruptInfoPtr =
        &PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(prvCpssDrvDevFamilyInterruptInfoArray[PRV_CPSS_DRV_FAMILY_DXCH_BOBCAT2_E]);
    ...
    PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_SET(bc2InitDone, GT_TRUE);
...
/**
* @internal prvCpssDrvPpIntDefBobcat2Print function
* @endinternal
*
* @brief   print the interrupts arrays info, of Bobcat2 devices
*/
...
)
{
    ...
    devInterruptInfoPtr = &PRV_SHARED_COMMON_INT_DIR_DXEXMX_GLOBAL_VAR_GET(prvCpssDrvDevFamilyInterruptInfoArray[PRV_CPSS_DRV_FAMILY_DXCH_BOBCAT2_E]);

    interruptsScanArray = devInterruptInfoPtr->interruptsScanArray;
    /* port group 0 */
    prvCpssDrvPpIntDefPrint(BOBCAT2_NUM_ELEMENTS_IN_SCAN_TREE_CNS,
                            interruptsScanArray,
                            BOBCAT2_NUM_MASK_REGISTERS_CNS,
...
/**
* @internal prvCpssDrvPpIntDefBobcat2Print_regInfoByInterruptIndex function
* @endinternal
*
* @brief   print for Bobcat2 devices the register info according to value in
...
)
{
    ...
    {
        prvCpssDrvPpIntDefPrint_regInfoByInterruptIndex(BOBCAT2_NUM_ELEMENTS_IN_SCAN_TREE_CNS, interruptsScanArray,interruptId, GT_FALSE);
    }

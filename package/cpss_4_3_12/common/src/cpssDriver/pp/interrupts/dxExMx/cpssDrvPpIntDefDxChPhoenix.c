...
/* 3 elements */
#define gop_sdw                                                                                      \
        global_port_sdw_5_NODE_MAC(29),                                                              \
        global_port_sdw_1_4_0_NODE_MAC(30),                                                          \
        global_port_sdw_1_4_1_NODE_MAC(31)
...
#define global_port_sdw_1_4_0_NODE_MAC(bit)                                                             \
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_SDW4_0_E, NULL,                                                \
        0x00000300, 0x00000304,                                                                         \
        prvCpssDrvHwPpPortGroupIsrRead, /* use dedicated callback */                                \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                \
        PRV_CPSS_AC5X_SDW_INST_1_4_0_SDW_INTERRUPT_CAUSE_SER_DES_INTERRUPT_E,                           \
        PRV_CPSS_AC5X_SDW_INST_1_4_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                                 \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}

#define global_port_sdw_1_4_1_NODE_MAC(bit)                                                             \
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_SDW4_1_E , NULL,                                    \
        0x00000300, 0x00000304,                                                                         \
        prvCpssDrvHwPpPortGroupIsrRead, /* use dedicated callback */                                \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                \
        PRV_CPSS_AC5X_SDW_INST_1_4_1_SDW_INTERRUPT_CAUSE_SER_DES_INTERRUPT_E,                           \
        PRV_CPSS_AC5X_SDW_INST_1_4_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                                 \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}

#define global_port_sdw_1_4_2_NODE_MAC(bit)                                                             \
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_SDW4_2_E , NULL,                                    \
        0x00000300, 0x00000304,                                                                         \
        prvCpssDrvHwPpPortGroupIsrRead, /* use dedicated callback */                                \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                \
        PRV_CPSS_AC5X_SDW_INST_1_4_2_SDW_INTERRUPT_CAUSE_SER_DES_INTERRUPT_E,                           \
        PRV_CPSS_AC5X_SDW_INST_1_4_2_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                                 \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}

#define global_port_sdw_1_4_3_NODE_MAC(bit)                                                             \
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_SDW4_3_E, NULL,                                    \
        0x00000300, 0x00000304,                                                                         \
        prvCpssDrvHwPpPortGroupIsrRead, /* use dedicated callback */                                \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                \
        PRV_CPSS_AC5X_SDW_INST_1_4_3_SDW_INTERRUPT_CAUSE_SER_DES_INTERRUPT_E,                           \
        PRV_CPSS_AC5X_SDW_INST_1_4_3_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                                 \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}

#define global_port_sdw_0_NODE_MAC(bit)                                                                 \
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_SDW0_0_E , NULL,                                                 \
        0x00000300, 0x00000304,                                                                         \
        prvCpssDrvHwPpPortGroupIsrRead, /* use dedicated callback */                                \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                \
        PRV_CPSS_AC5X_SDW_INST_0_0_SDW_INTERRUPT_CAUSE_SER_DES_INTERRUPT_E,                             \
        PRV_CPSS_AC5X_SDW_INST_0_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                                   \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}

#define global_port_sdw_5_NODE_MAC(bit)                                                                 \
    {bit, GT_FALSE, PRV_CPSS_DXCH_UNIT_SDW5_0_E, NULL,                                       \
        0x00000300, 0x00000304,                                                                         \
        prvCpssDrvHwPpPortGroupIsrRead, /* use dedicated callback */                                \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                \
        PRV_CPSS_AC5X_SDW_INST_5_1_SDW_INTERRUPT_CAUSE_SER_DES_INTERRUPT_E,                             \
        PRV_CPSS_AC5X_SDW_INST_5_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                                   \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}
...
#define cnm_grp_0_3_IntsSum_SUB_TREE_MAC(bit, _mgIndex)                                                 \
    ...
    {bit, GT_FALSE, MG_UNIT(PRV_CPSS_DXCH_UNIT_MG_E, _mgIndex), NULL,                                   \
        ...
        FILLED_IN_RUNTIME_CNS, 0, 0x0, 13, NULL, NULL},                                                 \
        global_port_sdw_1_4_2_NODE_MAC(1),                                                              \
        global_port_sdw_1_4_3_NODE_MAC(2),                                                              \
        global_port_sdw_0_NODE_MAC(3),                                                                  \
...
/* Start of  reduced tree1 for alternative management of SDMAs */

#define MG_GLOBAL_TREE1_SUMMARY_MAC(bit, numChild, _mgIndex)                                                    \
    /* AC5X Tree1 Global Interrupt Cause */                                                                     \
    {bit, GT_FALSE, MG_UNIT(PRV_CPSS_DXCH_UNIT_MG_E,_mgIndex), NULL,                                            \
        0x00000610, 0x00000614,                                                                                 \
        prvCpssDrvHwPpPortGroupIsrRead,                                                                         \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                        \
        PRV_CPSS_AC5X_MG_##_mgIndex##_GLOBAL_INTERRUPTS_SUMMARY_CAUSE1_FUNCTIONAL_UNITS_INTERRUPT_SUMMARY1_E,   \
        PRV_CPSS_AC5X_MG_##_mgIndex##_GLOBAL_INTERRUPTS_SUMMARY_CAUSE1_MG1_INTERNAL_INTERRUPT_SUMMARY1_E,       \
        FILLED_IN_RUNTIME_CNS, 0, 0x0, numChild, NULL, NULL}

#define AC5X_MG_TREE1_Tx_SDMA_SUMMARY_MAC(bit, _mgIndex)                                  \
    /* Tx SDMA - real access left to application */                                       \
    {bit, GT_FALSE,MG_UNIT(PRV_CPSS_DXCH_UNIT_MG_E,_mgIndex), NULL,                       \
        0x00002898, 0x000028A8,                                                           \
        prvCpssDrvHwPpPortGroupIsrRead_dummy,                                             \
        prvCpssDrvHwPpPortGroupIsrWrite_dummy,                                            \
        PRV_CPSS_AC5X_MG_##_mgIndex##_TRANSMIT_SDMA_INTERRUPT_CAUSE1_TX_BUFFER_QUEUE_0_E, \
        PRV_CPSS_AC5X_MG_##_mgIndex##_TRANSMIT_SDMA_INTERRUPT_CAUSE1_TX_REJECT_1_E,       \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0,NULL, NULL}

#define AC5X_MG_TREE1_Rx_SDMA_SUMMARY_MAC(bit, _mgIndex)                                  \
    /* Rx SDMA  - real access left to application */                                      \
    {bit, GT_FALSE,MG_UNIT(PRV_CPSS_DXCH_UNIT_MG_E,_mgIndex), NULL,                       \
        0x00002890, 0x000028A0,                                                           \
        prvCpssDrvHwPpPortGroupIsrRead_dummy,                                             \
        prvCpssDrvHwPpPortGroupIsrWrite_dummy,                                            \
        PRV_CPSS_AC5X_MG_##_mgIndex##_RECEIVE_SDMA_INTERRUPT_CAUSE1_RX_BUFFER_QUEUE_0_E,  \
        PRV_CPSS_AC5X_MG_##_mgIndex##_RECEIVE_SDMA_INTERRUPT_CAUSE1_PACKET_CNT_OF_E,      \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0,NULL, NULL}

#define  AC5X_MG_TREE1_SDMA_INTERRUPTS_MAC(bit, _mgIndex)                     \
    /* Global Interrupt Cause */                                              \
    MG_GLOBAL_TREE1_SUMMARY_MAC(bit, 2 /*numChild*/, _mgIndex),               \
        /* Tx SDMA  */                                                        \
        AC5X_MG_TREE1_Tx_SDMA_SUMMARY_MAC(8, _mgIndex),                       \
        /* Rx SDMA  */                                                        \
        AC5X_MG_TREE1_Rx_SDMA_SUMMARY_MAC(9, _mgIndex)

/* Each interrupts tree cannot receive summary for interrupts of other trees in the same MG unit */
/* but can receive from other trees other unit */
#define AC5X_MG_TREE1_OTHER_MG_TREE1_SDMA_INTERRUPTS_MAC(bit, _mgIndex, _mgOther)                        \
    /* Tree1 FuncUnits1IntsSum */                                                                        \
    {bit, GT_FALSE,MG_UNIT(PRV_CPSS_DXCH_UNIT_MG_E, _mgIndex), NULL,                                     \
        0x00000648, 0x00000644,                                                                          \
        prvCpssDrvHwPpPortGroupIsrRead,                                                                  \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                 \
        PRV_CPSS_AC5X_MG_##_mgIndex##_FUNCTIONAL_1_INTERRUPTS_SUMMARY_CAUSE1_FUNC_UNITS_1_INT_SUM_1_1_E, \
        PRV_CPSS_AC5X_MG_##_mgIndex##_FUNCTIONAL_1_INTERRUPTS_SUMMARY_CAUSE1_FUNC_UNITS_1_INT_SUM_1_31_E,\
        FILLED_IN_RUNTIME_CNS, 0, 0x0, 1, NULL, NULL},                                                   \
        /*other MG tree1*/                                                                               \
        AC5X_MG_TREE1_SDMA_INTERRUPTS_MAC(phoenix_MG##_mgOther##_int_tree1_sum, _mgOther/*_mgIndex*/)

#define  AC5X_MG_TREE1_SDMA_AND_OTHER_MG_SDMA_INTERRUPTS_MAC(bit, _mgIndex, _mgOther) \
    /* Global Interrupt Cause */                                                      \
    MG_GLOBAL_TREE1_SUMMARY_MAC(bit, 3 /*numChild*/, _mgIndex),                       \
        /* Tree1 FuncUnits1IntsSum */                                                 \
        AC5X_MG_TREE1_OTHER_MG_TREE1_SDMA_INTERRUPTS_MAC(11, _mgIndex, _mgOther),     \
        /* Tx SDMA  */                                                                \
        AC5X_MG_TREE1_Tx_SDMA_SUMMARY_MAC(8, _mgIndex),                               \
        /* Rx SDMA  */                                                                \
        AC5X_MG_TREE1_Rx_SDMA_SUMMARY_MAC(9, _mgIndex)

/* End of reduced tree1 for alternative management of SDMAs */

#define cnm_mg0_grp_0_5_IntsSum_SUB_TREE_MAC(bit)                                            \
    /* FuncUnits1IntsSum */                                                                  \
    {bit, GT_FALSE,MG_UNIT(PRV_CPSS_DXCH_UNIT_MG_E, 0), NULL,                                \
        0x000003F4, 0x000003F0,                                                              \
        prvCpssDrvHwPpPortGroupIsrRead,                                                      \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                     \
        PRV_CPSS_AC5X_MG_0_FUNCTIONAL_1_INTERRUPTS_SUMMARY_CAUSE_FUNC_UNITS_1_INT_SUM_1_E,   \
        PRV_CPSS_AC5X_MG_0_FUNCTIONAL_1_INTERRUPTS_SUMMARY_CAUSE_FUNC_UNITS_1_INT_SUM_31_E,  \
        ...
        /*MG1 tree1*/                                                                        \
        AC5X_MG_TREE1_SDMA_AND_OTHER_MG_SDMA_INTERRUPTS_MAC(phoenix_MG1_int_tree1_sum, 1/*_mgIndex*/, 0/*_mgOther*/)
...
/* MG1 Internal Interrupt Cause register */                                                                      \
    {bit, GT_FALSE,MG_UNIT(PRV_CPSS_DXCH_UNIT_MG_E, _mgIndex), NULL,                                             \
        ...
        prvCpssDrvHwPpPortGroupIsrRead,                                                                          \
        prvCpssDrvHwPpPortGroupIsrWrite,                                                                         \
        PRV_CPSS_AC5X_MG_##_mgIndex##_MG1_INTERNAL_INTERRUPT_CAUSE_MISCELLANEOUS_INTERRUPT_SUMMARY1_E,           \
        PRV_CPSS_AC5X_MG_##_mgIndex##_MG1_INTERNAL_INTERRUPT_CAUSE_CM3_SRAM_ADDRESS_OUT_OF_RANGE_INTERRUPT_E,    \
        FILLED_IN_RUNTIME_CNS, 0x0, 0xFFFFFFFF, 0, NULL, NULL}
...
#define  AC5X_MG_INTERRUPTS_MG_1_MAC(bitIndexInCaller)                       \
    /* Global Interrupt Cause */                                                    \
    MG_GLOBAL_SUMMARY_MAC(bitIndexInCaller, 4 /*numChild*/, 1/*mgId*/), \
...
#define  AC5X_MG_INTERRUPTS_MG_2_MAC(bitIndexInCaller)                              \
    ...
    MG_GLOBAL_SUMMARY_MAC(bitIndexInCaller, 2 /*numChild*/, 2/*mgId*/),             \
        ...
        /* Misc1 Interrupt SUM bit */                                               \
        misc1_interript_sum(18, 2 /*_mgIndex*/)

#define phoenix_MG1_int_sum 4
#define phoenix_MG2_int_sum 7
#define phoenix_MG0_int_tree1_sum 2
#define phoenix_MG1_int_tree1_sum 5
#define phoenix_MG2_int_tree1_sum 8
...
static GT_STATUS prvCpssDrvHwPpPortGroupIsrRead_dummy
(
    IN GT_U8    devNum,
    IN GT_U32   portGroupId,
    IN GT_U32   regAddr,
...
{
    /* Global Interrupt Cause */
    MG_GLOBAL_SUMMARY_MAC(0, 9/*numChild*/, 0 /*_mgIndex*/),
        /* FuncUnitsIntsSum Interrupt Cause */
        ...
        /* Func1UnitsIntsSum */
        cnm_mg0_grp_0_5_IntsSum_SUB_TREE_MAC(11),
        /* MG1 Internal Interrupt Cause register summary bit */
        cnm_grp_0_6_IntsSum_SUB_TREE_MAC(18, 0 /*_mgIndex*/)
};
...
CPSS_PP_PTP_TAI_INCOMING_TRIGGER_E,                                                                                     \
 ...
 CPSS_SRVCPU_SDK_WATCHDOG_E,                                                                                            \
    PRV_CPSS_AC5X_MG_0_MG1_INTERNAL_INTERRUPT_CAUSE_CM3_SECOND_TIMER_INTERRUPT_E,  0,                                   \
    PRV_CPSS_AC5X_MG_1_MG1_INTERNAL_INTERRUPT_CAUSE_CM3_SECOND_TIMER_INTERRUPT_E,  1,                                   \
    PRV_CPSS_AC5X_MG_2_MG1_INTERNAL_INTERRUPT_CAUSE_CM3_SECOND_TIMER_INTERRUPT_E,  2,                                   \
 MARK_END_OF_UNI_EV_CNS,                                                                                                \
                                                                                                                        \
 CPSS_SRVCPU_SDK_DOORBELL_E,                                                                                            \
    PRV_CPSS_AC5X_MG_0_MG_INTERNAL_INTERRUPT_CAUSE_CM3_TO_HOST_DOORBELL_INTERRUPT_E,  0,                                \
    PRV_CPSS_AC5X_MG_1_MG_INTERNAL_INTERRUPT_CAUSE_CM3_TO_HOST_DOORBELL_INTERRUPT_E,  1,                                \
    PRV_CPSS_AC5X_MG_2_MG_INTERNAL_INTERRUPT_CAUSE_CM3_TO_HOST_DOORBELL_INTERRUPT_E,  2,                                \
 MARK_END_OF_UNI_EV_CNS,                                                                                                \
                                                                                                                        \
...
#define AC5X_PORT_LANE_SQ_EVENTS                                 \
    PRV_CPSS_AC5X_SDW_INST_5_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                   0,\
    PRV_CPSS_AC5X_SDW_INST_5_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                   1,\
    PRV_CPSS_AC5X_SDW_INST_5_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                   2,\
    PRV_CPSS_AC5X_SDW_INST_5_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                   3,\
    PRV_CPSS_AC5X_SDW_INST_1_4_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 4,\
    PRV_CPSS_AC5X_SDW_INST_1_4_1_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 5,\
    PRV_CPSS_AC5X_SDW_INST_1_4_2_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 6,\
    PRV_CPSS_AC5X_SDW_INST_1_4_3_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                 7,\
    PRV_CPSS_AC5X_SDW_INST_0_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_0_E,                   8,\
    PRV_CPSS_AC5X_SDW_INST_0_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_1_E,                   9,\
    PRV_CPSS_AC5X_SDW_INST_0_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_2_E,                   10,\
    PRV_CPSS_AC5X_SDW_INST_0_0_SDW_INTERRUPT_CAUSE_SQ_DETECT_3_E,                   11\
...
static const GT_U32 ac5xUniEvMapTable[][2] =
{
    ...
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5X_SMB_MC_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_0_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5X_SMB_MC_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_1_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5X_SMB_MC_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_2_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5X_SMB_MC_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_3_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5X_SMB_MC_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_4_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5X_SMB_MC_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_5_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5X_SMB_MC_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_6_INTERRUPT_AGE_ERR_E},
    {CPSS_PP_BM_AGED_PACKET_E,               PRV_CPSS_AC5X_SMB_MC_INTERRUPT_AGE_CAUSE_LOGICAL_MEMORY_7_INTERRUPT_AGE_ERR_E},

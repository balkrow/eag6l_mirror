...
#define PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_OBJ_CONFIG(__devNum_) \
              ((PRV_CPSS_DRV_OBJ_STC*)PRV_SHARED_GLOBAL_VAR_GET(commonMod.configDir.dDrvPpConGenInitSrc.prvCpssDrvPpObjConfig[__devNum_]))

#define PRV_SHARED_CPSS_DRIVER_PP_OBJ_CONFIG_NO_CAST \
...
#define PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_OBJ_CONFIG_CHECK(_index) \
        ...
        { \
            ...
            if(NULL == PRV_SHARED_CPSS_DRIVER_PP_OBJ_CONFIG_NO_CAST[_index])\
            { \

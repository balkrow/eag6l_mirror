...
/**
********************************************************************************
* @file prvCpssSkipList.h
*
* @brief This file includes a skip-list implementation, it provides the following
...
#ifdef SHARED_MEMORY
typedef GT_U32 SL_COMPARE;
#else
typedef FUNCP_SL_COMP SL_COMPARE;
#endif

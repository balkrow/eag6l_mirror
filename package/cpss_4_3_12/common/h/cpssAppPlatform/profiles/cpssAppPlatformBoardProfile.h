 ...
 * @brief, Single MPP select = mpp number + mpp select
 */
typedef struct _CPSS_APP_PLATFORM_MPP_SELECT_STC
{
    GT_U32  mppNumber;
    GT_U32  mppSelect;
}CPSS_APP_PLATFORM_MPP_SELECT_STC;
...
typedef struct _CPSS_APP_PLATFORM_BOARD_PARAM_PP_MAP_STC {
   ...
   /* MPP Select Params **/
   CPSS_APP_PLATFORM_MPP_SELECT_STC     *mppSelectPtr;
   GT_U32                               mppSelectArrSize;

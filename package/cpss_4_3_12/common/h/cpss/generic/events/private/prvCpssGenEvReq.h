...
STR(CPSS_PP_STREAM_LATENT_ERROR_E),                       /* 636 */             \
  /**************************** SCPU SDK events **************************/     \
STR(CPSS_SRVCPU_SDK_WATCHDOG_E),                           /* 637 */            \
STR(CPSS_SRVCPU_SDK_DOORBELL_E),                           /* 638 */            \
STR(CPSS_PP_PORT_PM_LINK_STATUS_CHANGED_E),               /* 639 */             \
/**************************** SRVCPU EVENTS *******************************/    \
STR(CPSS_SRVCPU_IPC_E),                                   /* 640 */             \
STR(CPSS_SRVCPU_PORT_LINK_STATUS_CHANGED_E),              /* 641 */             \
STR(CPSS_SRVCPU_PORT_802_3_AP_E),                         /* 642 */             \
STR(CPSS_SRVCPU_PORT_REMOTE_FAULT_TX_CHANGE_E)           ,/* 643 */             \
STR(CPSS_SRVCPU_PORT_AP_DISABLE_E)                       ,/* 644 */             \
STR(CPSS_SRVCPU_RESERVED_5)                              ,/* 645 */             \
STR(CPSS_SRVCPU_RESERVED_6)                              ,/* 646 */             \
STR(CPSS_SRVCPU_RESERVED_7)                              ,/* 647 */             \
STR(CPSS_SRVCPU_RESERVED_8)                              ,/* 648 */             \
STR(CPSS_SRVCPU_RESERVED_9)                              ,/* 649 */

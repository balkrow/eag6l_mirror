 ...
 *
 * @brief LED group classes used for the combinational logic.
 *      The combinational logic = (Class A AND Class B) OR (Class C AND Class D).
*/
typedef struct CPSS_LED_GROUP_CONF_STCT
{
    /** Selects which class is used as A in the group combinational logic. */
    GT_U32  classA;

    /** Selects which class is used as B in the group combinational logic. */
    GT_U32  classB;

    /** Selects which class is used as C in the group combinational logic. */
    GT_U32  classC;

    /** Selects which class is used as D in the group combinational logic. */
    GT_U32  classD;

...
#ifdef CHX_FAMILY
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_HW_PP_SOFT_RESET_OPTIONS_ENT);
PRV_CPSS_LOG_STC_ENUM_MAP_DECLARE_MAC(CPSS_PHY_REF_CLK_PU_OE_CFG_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PP_PHASE2_UPLOAD_QUEUE_TYPE_ENT);

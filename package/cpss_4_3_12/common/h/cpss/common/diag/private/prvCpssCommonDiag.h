...
#ifdef SHARED_MEMORY
typedef GT_U32 PRV_CPSS_DFX_PIPES_BMP_GET_FUNC_PTR;
#else
typedef PRV_CPSS_DFX_PIPES_BMP_GET_FUNC PRV_CPSS_DFX_PIPES_BMP_GET_FUNC_PTR;
#endif
...
typedef struct{
    ...
    */
    PRV_CPSS_DFX_PIPES_BMP_GET_FUNC_PTR        dfxPipesBmpGetFunc;
    ...
    /** @brief DFX pipes bmp
        NOTE: relevant only when != 0
    */
    GT_U32                                  dfxPipesBmp;

    /** @brief indication if the packet generator not supported/implemented (yet)
    */
    GT_BOOL                                 notSupportPacketGenerator;

...
typedef struct{
   ...
   struct /*DFXServerUnitsDeviceSpecificRegs*/{
       ...
       /* For Falcon devices DFX units are multiple and present in each Tile (2 Processing Cores  */
       /* container) and in each GOP.                                                             */
       /* Falcon SkipInitializationMatrixes registers of Tile and of GOP are similar, but there   */
       /* are some different registers with the same offsets.                                     */
       /* The registers DB contains all SkipInitializationMatrixes registers.                     */
       ...
       /* Control And Management (CnM) subsystem skip configuration
           a.k.a. Core Mng Skip in Falcon */
       GT_U32    cnmSkipInitializationMatrix;
       /* skip Switch (CP, DP, Packet Buffer, TxQ, PCA, EPI/GOP)
          a.k.a. Core Tile Skip in Falcon */
       GT_U32    coreSkipInitializationMatrix;
       GT_U32    poeSkipInitializationMatrix;
       GT_U32    mppSkipInitializationMatrix;
       GT_U32    deviceEnabledAndInitDoneSkipInitMatrix;
       ...
       /* Falcon devices Processing Core only (Eagle) SkipInitializationMatrixes */
       GT_U32    Core_D2DSkipInitializationMatrix;
       GT_U32    Core_RavenSkipInitializationMatrix;
       /* Falcon devices Processing GOP only (Raven) SkipInitializationMatrixes */
       ...
       /* User Defined registers added starting from Falcon
          some device control registers are used for this */
       GT_U32    userDefined0;
       /* SIP6_30 parallel mode LED specific registers */
       GT_U32    segmentCmosLed0PadControl;
       GT_U32    segmentCmosLed1PadControl;
       GT_U32    segmentCmosLed2PadControl;
       GT_U32    segmentCmosLed3PadControl;
       GT_U32    segmentCmosLed4PadControl;
       GT_U32    segmentCmosLed5PadControl;
       GT_U32    segmentCmosLed6PadControl;
       GT_U32    segmentCmosLed7PadControl;
   ...
   struct /*DFXServerUnits*/{
       ...
       struct /*DFXServerRegs*/{
           ...
           GT_U32    id0eFuseSlaveChipIdArr[3];          /* used also by sip6 units */
       }DFXServerRegs;
   ...
   struct /*DFXRam*/{
    ...
    struct /*DFXServerUnits - core*/{
        ...
        struct /*DFXServerRegs*/{
            ...
            GT_U32    id0eFuseSlaveChipIdArr[3]; /*SIP6 part of memory shown as regs */
        }DFXServerRegs;

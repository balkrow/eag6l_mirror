...
typedef enum{
    ...
    /** @brief features that added in generation 7
     *  devices like : AAS (Aldrin3 , Armstong4 , Seahawk)
     */
    CPSS_GEN_SIP_7_E,
...
/* number of words in Unit Level Traceability Chip Id */
#define CPSS_GEN_ULT_CHIP_ID_WORDS_NUM_CNS 3
...
typedef struct{
    ...
    /** Unit Level Traceability (for short ULT).
    *   This parameter is unique per silicon part and is used in RMA processing,
    *   to map and trace back the part testing history.
    *   It also helps in gathering useful statistics as a part of Failure analysis.
    * (APPLICABLE DEVICES: AC5; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.)
    */
    GT_U32 unitLevelTraceabilityArr[CPSS_GEN_ULT_CHIP_ID_WORDS_NUM_CNS];

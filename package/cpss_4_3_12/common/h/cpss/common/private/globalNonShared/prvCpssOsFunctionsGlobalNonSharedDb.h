...
typedef GT_VOID (*CPSS_ASK_EVENTS_FREE_FUNC)
(
    IN GT_U8 devNum
);

typedef GT_STATUS (*CPSS_ASK_EVENT_COUNTER_INCREMENT)
(
    IN GT_U8   devNum,
...
typedef GT_STATUS (*CPSS_ASK_EVENT_HANDLER_PRE_INIT)
(
    IN GT_U8 devNum
);

typedef GT_STATUS (*CPSS_ASK_EVENT_FUNC_INIT)
(
    IN GT_U8 devNum
);


typedef GT_STATUS (*CPSS_ASK_DB_ENTRY_ADD)
(
    IN  GT_CHAR *namePtr,
    IN  GT_U32  value
);

typedef GT_STATUS (*CPSS_ASK_DB_ENTRY_GET)
(
    IN  GT_CHAR *namePtr,
    OUT GT_U32  *valuePtr
);
...
typedef struct
{
   PRV_CPSS_OS_DECLARE_FUNC(cpssAskCommonEventUniEventsFreeCb, CPSS_ASK_EVENTS_FREE_FUNC);
   PRV_CPSS_OS_DECLARE_FUNC(cpssAskCommonEventCounterIncrementCb, CPSS_ASK_EVENT_COUNTER_INCREMENT);
   PRV_CPSS_OS_DECLARE_FUNC(cpssAskCommonEventHandlerPreInitCb, CPSS_ASK_EVENT_HANDLER_PRE_INIT);
   PRV_CPSS_OS_DECLARE_FUNC(cpssAskCommonEventFuncInitCb, CPSS_ASK_EVENT_FUNC_INIT);
   PRV_CPSS_OS_DECLARE_FUNC(cpssAskDbEntryAddCb, CPSS_ASK_DB_ENTRY_ADD);
   PRV_CPSS_OS_DECLARE_FUNC(cpssAskDbEntryGetCb, CPSS_ASK_DB_ENTRY_GET);
#ifdef IMPL_GALTIS
   GT_U32** enhUtUseCaptureToCpuPtrPtr;
   GT_U32** tgfCmdCpssNetEnhUtUseCaptureToCpuPtrPtr;
#endif /* IMPL_GALTIS */
} PRV_ASK_COMMON_FUNC_PTR_NON_SHARED_GLOBAL_DB;
...
typedef struct
{
   ...
   PRV_CPSS_OS_DECLARE_FUNC(cpssOsCacheDmaMallocByDevice, CPSS_OS_CACHE_DMA_MALLOC_BY_DEVICE_FUNC);
   ...
   PRV_CPSS_OS_DECLARE_FUNC(cpssOsSocketExtractPortFromSocketAddr, CPSS_SOCKET_EXTRACT_IPADDR_FROM_SOCKET_ADDR_FUNC);
...
#define cpssOsCacheDmaMallocByDevice PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.osFuncDb.cpssOsCacheDmaMallocByDevice)
...
#define cpssOsSocketExtractPortFromSocketAddr PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.osFuncDb.cpssOsSocketExtractPortFromSocketAddr)
...
#define cpssAppUtilsUniEventsFreeCb PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.askDrvFuncDb.cpssAskCommonEventUniEventsFreeCb)
#define cpssAppUtilsGenEventCounterIncrementCb PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.askDrvFuncDb.cpssAskCommonEventCounterIncrementCb)
#define cpssAppUtilsEventHandlerPreInitCb PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.askDrvFuncDb.cpssAskCommonEventHandlerPreInitCb)
#define cpssAppUtilsGenEventFuncInitCb PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.askDrvFuncDb.cpssAskCommonEventFuncInitCb)
#define cpssAppUtilsDbEntryAddCb PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.askDrvFuncDb.cpssAskDbEntryAddCb)
#define cpssAppUtilsDbEntryGetCb PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.askDrvFuncDb.cpssAskDbEntryGetCb)
#ifdef IMPL_GALTIS
#define cpssAppUtilsEnhUtUseCaptureToCpuPtrPtr PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.askDrvFuncDb.enhUtUseCaptureToCpuPtrPtr)
#define cpssAppUtilsTgfCmdCpssNetEnhUtUseCaptureToCpuPtrPtr PRV_NON_SHARED_GLOBAL_VAR_DIRECT_GET(nonVolatileDb.askDrvFuncDb.tgfCmdCpssNetEnhUtUseCaptureToCpuPtrPtr)
#endif /* IMPL_GALTIS */
#endif


#ifndef CONFIG_V2_DMA
    #define perDev_cpssOsPhy2Virt(_dev,_phy,_virt)   cpssOsPhy2Virt(_phy,_virt)/*not using the '_dev'*/;_dev=_dev
#else /*CONFIG_V2_DMA*/
    #define perDev_cpssOsPhy2Virt(_dev,_phy,_virt)   cpssOsPhy2Virt(_dev,_phy,_virt)
#endif /*CONFIG_V2_DMA*/

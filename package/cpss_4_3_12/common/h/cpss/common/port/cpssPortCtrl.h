...
#define CPSS_PORT_USX_PORT_MODE_CHECK_MAC(_ifMode)                  \
        ( CPSS_PORT_MULTIPLE_USX_PORT_MODE_CHECK_MAC(_ifMode)     ||  \
        ((_ifMode) == CPSS_PORT_INTERFACE_MODE_USX_2_5G_SXGMII_E) ||  \
        ((_ifMode) == CPSS_PORT_INTERFACE_MODE_USX_5G_SXGMII_E)   ||  \
        ((_ifMode) == CPSS_PORT_INTERFACE_MODE_USX_10G_SXGMII_E))
 ...
 *
 * @brief Enumeration of port's serdes rx_init modes.
*/
typedef enum{

    CPSS_PORT_SERDES_RX_INIT_MODE_START_E,
    CPSS_PORT_SERDES_RX_INIT_MODE_STOP_E,
    CPSS_PORT_SERDES_RX_INIT_MODE_BLOCKING_E,
    CPSS_PORT_SERDES_RX_INIT_MODE_STATUS_E

} CPSS_PORT_SERDES_RX_INIT_MODE_ENT;
 ...
 *
 * @brief: Port specific Preemption class
 */
typedef enum
{
    /** Preemption class Express */
    CPSS_PORT_PREEMPTION_CLASS_EXPRESS_E,

    /** Preemption class Preemptive */
    CPSS_PORT_PREEMPTION_CLASS_PREEMPTIVE_E,

    /** Preemption class BOTH, Express and Preemptive */
    CPSS_PORT_PREEMPTION_CLASS_BOTH_E
} CPSS_PORT_PREEMPTION_CLASS_ENT;
...
typedef enum
{
    ...
    CPSS_PORT_INTERFACE_MODE_1000BASE_SXLX_E,   /* 56 */ /* CPSS_PORT_SPEED_1000_E */
    CPSS_PORT_INTERFACE_MODE_REMOTE_E,              /* 57 */ /* used for remote ports configuration.(For SIP6 devices only) */

    CPSS_PORT_INTERFACE_MODE_NA_E,              /* 58 */
...
typedef enum
{
    ...
    CPSS_PORT_SPEED_800G_E,     /* 34 */  /* used in combination with CPSS_PORT_INTERFACE_MODE_KR8_E */
    CPSS_PORT_SPEED_REMOTE_E,   /* 35 */     /* used for remote port configuration (For SIP6 devices only)*/
    CPSS_PORT_SPEED_NA_E,       /* 36 */
...
#define CPSS_PORT_SPEED_SPECIAL_MODE(_speed) ((_speed == CPSS_PORT_SPEED_42000_E) || (_speed == CPSS_PORT_SPEED_47200_E) || (_speed == CPSS_PORT_SPEED_53000_E) || (_speed == CPSS_PORT_SPEED_106G_E) || \
                                    (_speed == CPSS_PORT_SPEED_102G_E) || (_speed == CPSS_PORT_SPEED_424G_E)) || (_speed == CPSS_PORT_SPEED_107G_E)
...
typedef struct
{
    ...
    /* Advanced (CTLE) */
    GT_U32 sumfBoostTargetC0;
    GT_U32 sumfBoostTargetC1;
    GT_U32 sumfBoostTargetC2;
    GT_U32 midpointPhaseOs0;
    GT_U32 midpointPhaseOs1;
    GT_U32 midpointPhaseOs2;
    ...
    GT_U32 inxSumfMidpointAdatptiveEnLane;
...
* @param[in] portMacNum               - port MAC number (not CPU
*       port)

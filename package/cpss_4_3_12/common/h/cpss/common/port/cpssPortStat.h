...
typedef struct{
    ...
    /** @brief Frames (good and bad) with 1519 to 2047 octets. */
    /* APPLICABLE DEVICES: AAS. */
    GT_U64 etherStatsPkts1519to2047Octets;

    /** @brief Frames (good and bad) with 2048 to 4095 octets. */
    /* APPLICABLE DEVICES: AAS. */
    GT_U64 etherStatsPkts2048to4095Octets;

    /** @brief Frames (good and bad) with 4096 to 8191 octets. */
    /* APPLICABLE DEVICES: AAS. */
    GT_U64 etherStatsPkts4096to8191Octets;

    /** @brief Frames (good and bad) with 8192 to 9216 octets. */
    /* APPLICABLE DEVICES: AAS. */
    GT_U64 etherStatsPkts8192to9216Octets;

    /** @brief Frames (good and bad) with 9217 to 16383 octets. */
    /* APPLICABLE DEVICES: AAS. */
    GT_U64 etherStatsPkts9217to16383Octets;

    /** @brief Frames (good and bad) with 16384 and above octets. */
    /* APPLICABLE DEVICES: AAS. */
    GT_U64 etherStatsPktsBiggerThan16383;
...
typedef struct{
    ...
    /** @brief Frames longer than MTU transmitted */
    /* APPLICABLE DEVICES: AAS. */
    GT_U64 etherStatsPktsMoreThanMTU;
 ...
 *
 * @brief Enumeration of the ethernet MTI MAC Counters.
*/
typedef enum{
    ...
    /** @brief
     */
    CPSS_MTI_RX_A_PAUSE_MAC_CTRL_FRAMES_RECIEVED_E = 3,
    ...
    /** @brief
     */
    CPSS_MTI_RX_A_MAC_CONTROL_FRAMES_RECIEVED_E = 42,

    /** @brief
     */
    CPSS_MTI_TX_ETHER_STATS_OCTETS_E  = 43,

    /** @brief
     */
    CPSS_MTI_TX_OCTETS_TRANSMITTED_OK_E = 44,

    /** @brief
     */
    CPSS_MTI_TX_A_PAUSE_MAC_CTRL_FRAMES_TRANSMITTED_E = 45,

    /** @brief
     */
    CPSS_MTI_TX_A_FRAMES_TRANSMITTED_OK_E = 46,

    /** @brief
     */
    CPSS_MTI_TX_VLAN_RECIEVED_OK_E = 47,

    /** @brief
     */
    CPSS_MTI_TX_IF_OUT_ERRORS_E = 48,

    /** @brief
     */
    CPSS_MTI_TX_IF_OUT_UC_PKTS_E = 49,

    /** @brief
     */
    CPSS_MTI_TX_IF_OUT_MC_PKTS_E = 50,

    /** @brief
     */
    CPSS_MTI_TX_IF_OUT_BC_PKTS_E = 51,

    /** @brief
     */
    CPSS_MTI_TX_ETHER_STATS_PTKS_64OCTETS_E = 52,

    /** @brief
     */
    CPSS_MTI_TX_ETHER_STATS_PTKS_65TO127_OCTETS_E = 53,

    /** @brief
     */
    CPSS_MTI_TX_ETHER_STATS_PTKS_128TO255_OCTETS_E = 54,

    /** @brief
     */
    CPSS_MTI_TX_ETHER_STATS_PTKS_256TO511_OCTETS_E = 55,

    /** @brief
     */
    CPSS_MTI_TX_ETHER_STATS_PTKS_512TO1023_OCTETS_E = 56,

    /** @brief
     */
    CPSS_MTI_TX_ETHER_STATS_PTKS_1024TO1518_OCTETS_E = 57,

    /** @brief
     */
    CPSS_MTI_TX_ETHER_STATS_PTKS_1519TOMAX_OCTETS_E = 58,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_0_E = 59,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_1_E = 60,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_2_E = 61,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_3_E = 62,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_4_E = 63,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_5_E = 64,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_6_E = 65,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_7_E = 66,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_8_E = 67,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_9_E = 68,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_10_E = 69,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_11_E = 70,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_12_E = 71,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_13_E = 72,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_14_E = 73,

    /** @brief
     */
    CPSS_MTI_TX_A_CBFC_PAUSE_FRAMES_TRANSMITTED_15_E = 74,

    /** @brief
     */
    CPSS_MTI_TX_A_MAC_CONTROL_FRAMES_TRANSMITTED_E = 75,

    /** @brief
     */
    CPSS_MTI_TX_ETHER_STATS_PKTS_E = 76,

    /** @brief
     */
    CPSS_MTI_LAST_E = 77

} CPSS_PORT_MAC_MTI_COUNTER_ENT;
...
typedef enum
{
   ...
   /** @brief Number of bad received VERIFY frames. Saturates
        */

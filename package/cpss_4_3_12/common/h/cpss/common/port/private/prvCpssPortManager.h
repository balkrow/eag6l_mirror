...
typedef enum{
    ...
    /* enable/disable static port over ANP */
    PRV_CPSS_PM_PORT_ATTR_STATIC_OVER_ANP_ENABLE_E,

    PRV_CPSS_PM_PORT_ATTR_DUPLEX_MODE_E,

    /* signal detection callback provided by application (for case PM over FW) */
    PRV_CPSS_PM_PORT_ATTR_EXTERNAL_SIG_DET_CALLBACK_ENABLED_E

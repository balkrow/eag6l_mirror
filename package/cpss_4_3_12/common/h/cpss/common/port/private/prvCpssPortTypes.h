...
typedef enum{
    ...
    /** using MTI MAC CPU Unit(1G or 10G or 25G) */
    /* APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman */
...
typedef struct
{
    ...
    /** @brief PCA Loopback port number and appropriated Resource port number */
    GT_U32                              pcaLoopbackPort;
    GT_U32                              pcaLoopbackResourcePort;
...
typedef GT_STATUS (*PRV_CPSS_PORT_SERDES_CLAMPING_RESET_AND_STATUS_GET_FUNC)
(
    GT_SW_DEV_NUM        devNum,
    GT_PHYSICAL_PORT_NUM portNum,
...
typedef GT_STATUS (*PRV_CPSS_PORT_CHECK_MAP_VALIDITY_FUNC)
(
    GT_SW_DEV_NUM        devNum,
    GT_PHYSICAL_PORT_NUM portNum,
    GT_BOOL              *portMapValidity
);
...
typedef GT_STATUS (*PRV_CPSS_PORT_AP_ENABLE_GET_FUNC)
(
    IN  GT_U8                     devNum,
    IN  GT_PHYSICAL_PORT_NUM      portNum,
...
typedef GT_STATUS (*PRV_CPSS_PORT_PCS_RESET_SET_FUNC)
(
    IN  GT_SW_DEV_NUM                       devNum,
    IN  GT_PHYSICAL_PORT_NUM                portNum,
...
typedef GT_STATUS (*PRV_CPSS_PORT_PTP_PARAMS_SET_FUNC)
(
    IN GT_SW_DEV_NUM                      devNum,
    IN GT_PHYSICAL_PORT_NUM               portNum
);
...
typedef GT_STATUS (*PRV_CPSS_PORT_ANP_CALL_FUNC)
(
    IN  GT_U8                           devNum,
    IN  GT_PHYSICAL_PORT_NUM            portNum,
...
typedef GT_STATUS (*PRV_CPSS_PORT_RSFEC_STATUS_FUNC)
(
    IN GT_U8     devNum,
    IN GT_U32    portNum,
...
typedef GT_STATUS (*PRV_CPSS_PORT_RX_INIT_FUNC)
(
    IN  GT_U8                                   devNum,
    IN  GT_PHYSICAL_PORT_NUM                    portNum,
...
typedef GT_STATUS (*PRV_CPSS_PORT_SERDES_SIGNAL_DETECT_MASK_SET_FUNC)
(
    IN  GT_U8                   devNum,
    IN  GT_PHYSICAL_PORT_NUM    portNum,
...
typedef GT_STATUS (*PRV_CPSS_PORT_SERDES_FREE_CHECK_FUNC)
(
    IN  GT_SW_DEV_NUM                  devNum,
    IN  GT_PHYSICAL_PORT_NUM           portNum,
    IN  CPSS_PORT_INTERFACE_MODE_ENT   ifMode,
...
typedef struct{
    ...
    PRV_CPSS_PORT_PCS_RESET_SET_FUNC                ppPortPcsResetSetFunc;
    ...
    PRV_CPSS_PORT_PTP_PARAMS_SET_FUNC               ppPortPtpParamsSetFunc;
    ...
    PRV_CPSS_PORT_ANP_CALL_FUNC                     ppPortAnpCallFunc;
    PRV_CPSS_PORT_CDR_LOCK_GET_FUNC                 ppCdrLockGetFunc;
    PRV_CPSS_PORT_SERDES_CLAMPING_RESET_AND_STATUS_GET_FUNC  ppClampingResetAndStatusGetFunc;
    PRV_CPSS_PORT_CHECK_MAP_VALIDITY_FUNC           ppPortCheckMapValidity;
    PRV_CPSS_PORT_RSFEC_STATUS_FUNC                 ppPortRsFecStatusGet;
    PRV_CPSS_PORT_RX_INIT_FUNC                      ppPortRxInitFunc;
    PRV_CPSS_PORT_SERDES_SIGNAL_DETECT_MASK_SET_FUNC ppPortSerdesSigDetMaskSet;
    PRV_CPSS_PORT_SERDES_FREE_CHECK_FUNC            ppPortSerdesFreeCheck;
    PRV_CPSS_PORT_AP_ENABLE_GET_FUNC                ppPortApEnableGetFunc;

 ...
 *
 * @brief enum for the CDR state when it's done in the init
 */
typedef enum {
    CPSS_PM_CDR_INIT_CDR_CHECK_STATE_E,
    CPSS_PM_CDR_INIT_CLAMPING_STATE_E,
    CPSS_PM_CDR_INIT_DONE_STATE_E

} CPSS_PM_CDR_INIT_STATE_ENT;
 ...
 */
typedef enum {
    CPSS_PM_PCS_ALIGN_LOCK_LOST_MASKING_E          = 0x1, /* low level */
    CPSS_PM_PCS_GB_LOCK_SYNC_CHANGE_MASKING_E      = 0x2, /* low level */
    CPSS_PM_MMPCS_SIGNAL_DETECT_CHANGE_MASKING_E   = 0x4, /* low level */
    CPSS_PM_PORT_LINK_STATUS_CHANGED_E             = 0x8, /* mac level */
    CPSS_PM_PORT_LANE_SQ_EVENT_MASKING_E           = 0x10 /* low level */
...
typedef struct{
    ...
    */
    ...
    /*
       ...
       CPSS_PM_AP_PORT_ATTR_TX_POST_ADAPT_E
    */
...
typedef struct{
    ...
    */
    ...
    CPSS_PORT_MANAGER_LKB_CONFIG_STC    linkBinding;
    GT_BOOL                     oneShotiCal;
    CPSS_PM_CDR_INIT_STATE_ENT  cdrState; /* only valid for devices and modes that checking CDR in the init state. otherwise it's don't care */
    GT_U32                      cdrDelayTimeStampNSec; /*for making delay between CDR lock and clamping reset (nano seconds) */
    GT_U32                      cdrDelayTimeStampSec; /*for making delay between CDR lock and clamping reset (seconds) */
    /* un/mask bitmap info */
 ...
 *
 * @brief CPSS PM callback function  that checks attribute of PM
 *
*/
typedef GT_STATUS (*PRV_CPSS_PORT_PM_CHECK_BOOL_ATTRIBUTE_FUNC_PTR)
(
    GT_U8                           devNum,
    GT_U32                          portNum,
    GT_BOOL                         *enablePtr
...
typedef struct
{
  PRV_CPSS_PORT_PM_CHECK_BOOL_ATTRIBUTE_FUNC_PTR           cpssPmIsFwFunc;
  PRV_CPSS_PORT_PM_CHECK_BOOL_ATTRIBUTE_FUNC_PTR           cpssPmIsInDebugStateFunc;

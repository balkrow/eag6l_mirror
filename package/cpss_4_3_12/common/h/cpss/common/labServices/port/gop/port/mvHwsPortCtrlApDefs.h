...
#define AP_DEBUG_ALL_PORTS_MASK     0x80000000
#endif
...
#define MV_PORT_CTRL_IRONMAN_AP_PORT_HIGH_PORT_LOGICAL_INDEX    (6)
#define MV_PORT_CTRL_IRONMAN_AP_PORT_HIGH_PORT_NUM_BASE         (48)
#define MV_PORT_CTRL_IRONMAN_AP_PORT_LOW_PORT_NUM_BASE          (0)
#define MV_PORT_CTRL_MAX_AP_PORT_NUM                            (13)
#define MV_PORT_CTRL_AP_PORT_NUM_BASE                           MV_PORT_CTRL_IRONMAN_AP_PORT_HIGH_PORT_NUM_BASE - MV_PORT_CTRL_IRONMAN_AP_PORT_HIGH_PORT_LOGICAL_INDEX
...
#else
#define MV_HWS_PORT_CTRL_AP_LOGICAL_PORT_GET(phyPort, portNumBase) \
        ((phyPort) >= MV_PORT_CTRL_IRONMAN_AP_PORT_HIGH_PORT_NUM_BASE )? (phyPort - portNumBase) : (phyPort/4)

#define MV_HWS_PORT_CTRL_AP_PHYSICAL_PORT_GET(portIndex, portNumBase) \
        ((portIndex) >= MV_PORT_CTRL_IRONMAN_AP_PORT_HIGH_PORT_LOGICAL_INDEX)? (portIndex + portNumBase) : (portIndex*4)
#endif
...
** [27:27] Advertisement 40GBase_KR2                            0x8000000
** [28:28] Advertisement 2500Base KX                            0x10000000
** [29:29] Advertisement 100GBASE_CR10                          0x20000000
** [30:31] Reserved
*/
...
#define AP_CTRL_2500Base_KX_SHIFT          (28)
#define AP_CTRL_2500Base_KX_GET(adv)       AP_CTRL_GET(adv, AP_CTRL_ADV_MASK, AP_CTRL_2500Base_KX_SHIFT)
#define AP_CTRL_2500Base_KX_SET(adv, val)  AP_CTRL_SET(adv, AP_CTRL_ADV_MASK, AP_CTRL_2500Base_KX_SHIFT, val)

#define AP_CTRL_100GBASE_CR10_SHIFT          (29)
#define AP_CTRL_100GBASE_CR10_GET(adv)       AP_CTRL_GET(adv, AP_CTRL_ADV_MASK, AP_CTRL_100GBASE_CR10_SHIFT)
#define AP_CTRL_100GBASE_CR10_SET(adv, val)  AP_CTRL_SET(adv, AP_CTRL_ADV_MASK, AP_CTRL_100GBASE_CR10_SHIFT, val)
...
#define AP_CTRL_ADV_ALL_MASK               (0x3FFFFFFF)
...
#define AN_CTRL_IS_EXT_SIGDET_CB_EN_MASK                    (0x1)
#define AN_CTRL_IS_EXT_SIGDET_CB_EN_SHIFT                   (22)
#define AN_CTRL_IS_EXT_SIGDET_CB_EN_GET(opt)                AP_CTRL_GET(opt, AN_CTRL_IS_EXT_SIGDET_CB_EN_MASK, AN_CTRL_IS_EXT_SIGDET_CB_EN_SHIFT)
#define AN_CTRL_IS_EXT_SIGDET_CB_EN_SET(opt, val)           AP_CTRL_SET(opt, AN_CTRL_IS_EXT_SIGDET_CB_EN_MASK, AN_CTRL_IS_EXT_SIGDET_CB_EN_SHIFT, val)


/*Special speeds : 42G, 53G, 106G, 107G*/

...
#else
#if defined RAVEN_DEV_SUPPORT || defined FALCON_DEV_SUPPORT || defined AC5P_DEV_SUPPORT || defined HARRIER_DEV_SUPPORT || defined IRONMAN_DEV_SUPPORT
...
#define MV_HWS_AAS_GOP_PORT_NUM_CNS             20
#define MV_HWS_AAS_GOP_PORT_1TILE_CPU_0_CNS     145
#define MV_HWS_AAS_GOP_PORT_2TILE_CPU_0_CNS     289
#define MV_HWS_AAS_GOP_PORT_2TILE_CPU_1_CNS     293
...
/* 115*/ _1000Base_SX,          /*Optical - Serdes speed: _1_25G */
...
#define HWS_1000BASE_MODE_CHECK(_mode) ((_mode == _1000Base_X ) || (_mode == _1000Base_SX ) )

#define HWS_2500_MODE_CHECK(_mode)  ((_mode == _2500Base_X) || (_mode == SGMII2_5))
...
#define HWS_USX_SLOW_MODE_CHECK(_mode) ((_mode == SGMII) || (_mode == QSGMII) || (_mode == _5G_QUSGMII)|| \
                                        (_mode == _10G_OUSGMII) || (_mode == _1000Base_X) || (_mode == SGMII2_5)|| (_mode == _2500Base_X) || (_mode == _1000Base_SX))
...
#define HWS_1000BASE_MODE_CASE  \
                 _1000Base_X:   \
            case _1000Base_SX

#define HWS_2500_MODE_CASE      \
                 SGMII2_5:      \
            case _2500Base_X    \

#define HWS_LOW_SPEED_MODE_CASE             \
                 HWS_1000BASE_MODE_CASE:    \
            case HWS_2500_MODE_CASE:        \
            case SGMII:       \
            case _5GBaseR

#define HWS_RX_TRAIN_SKIP_NEEDED_CHECK(_mode) ((_mode == _1000Base_X) || (_1000Base_SX == _mode) || (_mode == SGMII) || (_mode == _5G_QUSGMII) || (_mode == SGMII2_5) || (_mode == QSGMII) || \
                                      (_mode == _2500Base_X) || (_mode == _2_5G_SXGMII) || (_mode == _5_625GBaseR) || (_mode == _100Base_FX) || ((HWS_DEV_SIP_6_10_CHECK_MAC(devNum)) && (_mode == _5GBaseR)))
...
#define HWS_200G_R4_MODE_CASE   \
             _200GBase_KR4:     \
        case _200GBase_CR4:     \
        case _200GBase_SR_LR4:  \
        case _212GBase_KR4

#define HWS_100G_R1_MODE_CASE   \
             _100GBase_KR

#define HWS_200G_R2_MODE_CASE   \
             _200GBase_KR2

#define HWS_400G_R4_MODE_CASE   \
             _400GBase_KR4

#define HWS_800G_R8_MODE_CASE   \
             _800GBase_KR8

#define HWS_400G_R8_MODE_CASE   \
             _400GBase_KR8:     \
        case _400GBase_CR8:     \
...
typedef struct
{
    ...
    MV_HWS_PORT_DUPLEX_ENT   duplexMode;
#endif
...
#define HWS_IS_PORT_MODE_200G_R2(portMode)  ((portMode == _200GBase_KR2))

#define HWS_IS_PORT_MODE_200G_R4(portMode)  ((portMode == _200GBase_KR4) || \
                                             (portMode == _212GBase_KR4) || \
                                             (portMode == _200GBase_CR4) || \
                                             (portMode == _200GBase_SR_LR4))

/* is port 400G R8*/
#define HWS_IS_PORT_MODE_400G_R8(portMode)  ((portMode == _400GBase_KR8)   || \
                                             (portMode == _400GBase_CR8)   || \
                                             (portMode == _400GBase_SR_LR8)|| \
                                             (portMode == _424GBase_KR8))

/* is port 400G R8*/
#define HWS_IS_PORT_MODE_400G_R4(portMode)   ((portMode == _400GBase_KR4))

/* is port 800G */
#define HWS_IS_PORT_MODE_800G_R8(portMode)     ((portMode == _800GBase_KR8))

...
#if defined(BOBK_DEV_SUPPORT) || defined(ALDRIN_DEV_SUPPORT) || defined(BC3_DEV_SUPPORT) || defined(PIPE_DEV_SUPPORT) || defined(ALDRIN2_DEV_SUPPORT) || defined(RAVEN_DEV_SUPPORT) || defined(AC5_DEV_SUPPORT) || defined(AC5P_DEV_SUPPORT) || defined(IRONMAN_DEV_SUPPORT)
...
#ifdef IRONMAN_DEV_SUPPORT /*TBD - can optimize to number of AP ports*/
#define IRONMAN_PORTS_NUM 56
#endif
...
/*MB - not conisit ... */
#if defined (CM3) && (defined (BOBK_DEV_SUPPORT) || defined (ALDRIN_DEV_SUPPORT) || defined (AC5_DEV_SUPPORT)) /*AC5, AC5P-TBD*/
/**
...
typedef enum
{
    ...
    Harrier,
    Ironman,
    AAS             /* Armstrong3P,Aldrin4,Seahawk */
...
typedef enum
{
    ...
    MTI_EXT_UNIT,                   /* 27 */
    MTI_GLOBAL_EXT_UNIT,            /* 28 */
    MTI_PCS_EXT_UNIT,               /* 29 */
    MTI_RSFEC_UNIT,                 /* 30 */
    RAVEN_MSDB_UNIT,                /* 31 */
    RAVEN_MPFS_UNIT,                /* 32 */
    RAVEN_TSU_UNIT,                 /* 33 */
    RAVEN_STATISTICS_UNIT,          /* 34 */
    MTI_CPU_MAC_UNIT,               /* 35 */
    MTI_CPU_PCS_UNIT,               /* 36 */
    MTI_CPU_EXT_UNIT,               /* 37 */
    MTI_CPU_GLOBAL_EXT_UNIT,        /* 38 */
    MTI_CPU_PCS_EXT_UNIT,           /* 39 */
    RAVEN_MTI_CPU_MPFS_UNIT,        /* 40 */
    RAVEN_DFX_UNIT,                 /* 41 */
    MIF_400_UNIT,                   /* 42 */
    MIF_400_BR_UNIT,                /* 43 */ /* fake unit for preemption MIF_32 registers access  */
    MIF_400_SEG_UNIT,               /* 44 */
    MIF_USX_UNIT,                   /* 45 */
    MIF_CPU_UNIT,                   /* 46 */
    ANP_400_UNIT,                   /* 47 */
    ...
    ANP_USX_UNIT,                   /* 49 */ /* each anp has 4 ports*/
    AN_USX_UNIT,                    /* 50 */ /* each anp has 4 ports*/
    ANP_USX_O_UNIT,                 /* 51 */ /* each anp has 8 ports and onlt the first anp is used*/
    AN_USX_O_UNIT,                  /* 52 */ /* Ironman unit */
    ANP_CPU_UNIT,                   /* 53 */
    AN_CPU_UNIT,                    /* 54 */
    ...
    MTI_USX_EXT_UNIT,               /* 56 */
    MTI_USX_PCS_UNIT,               /* 57 */
    MTI_USX_LPCS_UNIT,              /* 58 */
    MTI_USX_RSFEC_UNIT,             /* 59 */
    MTI_USX_MULTIPLEXER_UNIT,       /* 60 */
    MTI_CPU_RSFEC_UNIT,             /* 61 */
    MTI_CPU_RSFEC_STATISTICS_UNIT,  /* 62 */
    MTI_CPU_SGPCS_UNIT,             /* 63 */

    MTI_10G_MAC_BR_UNIT,            /* 64 */ /* Ironman : the 10G MAC BR unit */
    MTI_10G_MAC_NON_BR_UNIT,        /* 65 */ /* Ironman : the 10G MAC NON-BR unit */
    MTI_10G_GLOBAL_EXT_UNIT,        /* 66 */ /* Ironman : the 10G Global EXT unit */
    MTI_10G_PORT_EXT_UNIT,          /* 67 */ /* Ironman : the 10G Port EXT unit */

    MTI_10G_PCS_LPCS_GENERAL_UNIT,  /* 68 */ /* Ironman : the 10G GENERAL LPCS unit */
    MTI_10G_PCS_LPCS_PORT_UNIT,     /* 69 */ /* Ironman : the 10G PORT LPCS unit */
    MTI_10G_PCS_BASER_UNIT,         /* 70 */ /* Ironman : the 10G BaseR PCS unit */
    MTI_10G_PCS_FCFEC_UNIT,         /* 71 */ /* Ironman : the 10G FCFEC unit */
    MTI_10G_PCS_EXT_UNIT,           /* 72 */ /* Ironman : the 10G PCS EXT unit */

    MTI_RSFEC_STATISTICS_UNIT,      /* 73 */
    MTI_USX_RSFEC_STATISTICS_UNIT,  /* 74 */
#endif
    LAST_UNIT                       /* 75 */
...
typedef struct
{
    ...
    GT_U32                          serdesToMac[MV_HWS_MAX_LANES_NUM_PER_PORT];
    union
    {
...
typedef struct _HWS_DEVICE_INFO
{
    ...
    GT_U32                          gopRev;
    GT_U8                           gopMuxMode[3]; /* SerDes 0-2, SerDes 3-5, SerDes 6-8 */
...
/* check SIP_6_30 */
#define HWS_DEV_SIP_6_30_CHECK_MAC(_devNum)     (HWS_DEV_SILICON_TYPE(_devNum) == Ironman)
...
#define HWS_DEV_SIP_6_20_CHECK_MAC(_devNum)     ((HWS_DEV_SILICON_TYPE(_devNum) == Harrier) || \
                                                 HWS_DEV_SIP_6_30_CHECK_MAC(_devNum))
...
/* @internal MV_HWS_UNIT_FIELD_FIND_ADDR_FUNC_PTR function
* @endinternal
*
* @brief   unit field address calculation
*
* @param[in] devNum                - Device Number
* @param[in] phyPortNum            - Port Num
...
* @param[out] fieldRegOutPtr       - (pointer to) field structure
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
*/
typedef GT_U32 (*MV_HWS_UNIT_FIELD_FIND_ADDR_FUNC_PTR)
(
    IN GT_U8                        devNum,
...
typedef struct
{
    ...
    MV_HWS_UNIT_FIELD_FIND_ADDR_FUNC_PTR    devUnitFieldFindAddrFunc;
...
/**
 * MV_SPIFLASH_ACCESS_GET function
 *
 * @brief Implement SPI Flash read
 *
 * @param[in]  ch                   - SPI interface number
 * @param[in]  offset
 * @param[out] pReadBuff
 * @param[in]  buffSize
 *
 ...
 * @retval GT_FAIL                  - on error
 */
typedef GT_STATUS (*MV_SPIFLASH_ACCESS_GET)
(
    IN  GT_U8  ch,
    IN  GT_U32 offset,
    OUT GT_U8* pReadBuff,
...
/**
 * MV_SPIFLASH_ACCESS_SET function
 *
 * @brief Implement SPI Flash write
 *
 * @param[in] ch                    - SPI interface number
 * @param[in] offset
 * @param[in] pWriteBuff
 ...
 * @retval GT_FAIL                  - on error
 */
typedef GT_STATUS (*MV_SPIFLASH_ACCESS_SET)
(
    IN  GT_U8  ch,
    IN  GT_U32 offset,
    IN  GT_U8* pWriteBuff,
...
/*******************************************************************************
* MV_DEVICE_TEMPERATURE_GET
*
* DESCRIPTION:
*       Get the PP temperature
*
* INPUTS:
...
*
*******************************************************************************/
typedef GT_STATUS (*MV_DEVICE_TEMPERATURE_GET)
(
    IN  GT_U8    devNum,
...
typedef struct {
  ...
  MV_SPIFLASH_ACCESS_SET   spiFlashSetAccess;
  MV_SPIFLASH_ACCESS_GET   spiFlashGetAccess;
#endif
#if defined(CHX_FAMILY) || defined (AC5_DEV_SUPPORT) || defined (IRONMAN_DEV_SUPPORT)
  MV_DEVICE_TEMPERATURE_GET deviceTemperatureGet;
#endif
}HWS_OS_FUNC_PTR;
...
#if defined (AC5P_DEV_SUPPORT) || defined (HARRIER_DEV_SUPPORT)
extern MV_SPIFLASH_ACCESS_SET   hwsSFlashSetFuncPtr;
extern MV_SPIFLASH_ACCESS_GET   hwsSFlashGetFuncPtr;
#endif
#if defined (AC5_DEV_SUPPORT) || defined (IRONMAN_DEV_SUPPORT)
extern MV_DEVICE_TEMPERATURE_GET hwsDeviceTemperatureGetFuncPtr;
#endif
#endif
...
GT_STATUS hwsAlleycat5PortsParamsSupModesMapSet
(
    GT_U8 devNum
);
...
GT_STATUS hwsBobKPortsParamsSupModesMapSet
(
    GT_U8 devNum
);
...
GT_STATUS hwsAldrinPortsParamsSupModesMapSet
(
    GT_U8 devNum
);
...
GT_STATUS hwsBobcat3PortsParamsSupModesMapSet
(
    GT_U8 devNum
);
...
GT_STATUS hwsAldrin2PortsParamsSupModesMapSet
(
    GT_U8 devNum
);
...
/**
* @internal hwsAasNumOfTilesSet function
* @endinternal
*
* @brief   indicate the HWS that the Harrier device is actually AAS (with 1 or 2 tiles)
*          this function is called by CPSS (for AAS) prior to Harrier initialization
*
* @param[in] numOfTiles               - number of tiles.
*                                       None
*/
void hwsAasNumOfTilesSet
(
    IN GT_U32 numOfTiles
);
...
typedef enum {
    ...
    HWS_UNIT_BASE_ADDR_TYPE_MTI_CPU_RSFEC_STATISTICS_E,
    ...
    HWS_UNIT_BASE_ADDR_TYPE_AN_USX_O_E,
    ...
    /*start of Ironman units*/
    HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_MAC_BR_E,
    HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_MAC_NON_BR_E,
    HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_GLOBAL_EXT_E,
    HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PORT_EXT_E,
    HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_LPCS_GENERAL_E,
    HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_LPCS_PORT_E,
    HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_BASER_E,
    HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_FCFEC_E,
    HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_EXT_E,
    /*end of Ironman units*/
...
GT_STATUS hwsBobcat2IfInitHwsDevFunc
(
    GT_U8 devNum,
    HWS_OS_FUNC_PTR *funcPtr
);
...
GT_STATUS hwsBobcat2IfReload
(
    IN GT_U8           devNum
);

#endif
GT_STATUS hwsFalconPortsParamsSupModesMapSet
(
    GT_U8 devNum
);

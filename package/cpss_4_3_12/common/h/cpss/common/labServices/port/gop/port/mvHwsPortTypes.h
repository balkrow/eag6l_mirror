...
/*18*/  MTI_MAC_10G,        /*  MAC without preemption feature for 1G to 10G ports
                                APPLICABLE DEVICES: IronmanL */
/*19*/  MTI_MAC_10G_BR,     /*  MAC with preemption feature for 1G to 10G ports
                                APPLICABLE DEVICES: IronmanL */
    LAST_MAC
...
typedef enum
{
    ...
    MTI_PCS_25,         /*  PCS for 10G to 25G odd ports.
                            APPLICABLE DEVICES: AC5X; Harrier */
    MTI_CPU_SGPCS,      /*  Reduced/CPU  for 1G to 2.5G ports.
                            APPLICABLE DEVICES: AC5X, Harrier, AC5P */
    MTI_PCS_10G_BASE_R, /*  PCS for 10G
                            APPLICABLE DEVICES: Ironman */
    MTI_PCS_10G_LPCS,   /*  Low speed PCS for USX and slow speed port modes
                            APPLICABLE DEVICES: Ironman */

    MTI_PCS_800,        /* APPLICABLE DEVICES: AAS */
    LAST_PCS
...
typedef enum
{
    ...
    RS_FEC_544_514_INT  = (1 << 4),  /* Interleaved Reed Solomon FEC (544, 514) */
    RS_FEC_272_257      = (1 << 5),  /* Reed Solomon Consortium LL RSFEC */
    RS_FEC_272_257_INT  = (1 << 6),  /* Interleaved Reed Solomon Consortium LL RSFEC */
...
typedef enum
{
    ...
    _40BIT_ON,
    _80BIT_ON,
    _32BIT_ON,  /*AAS: port modes with SD rate below 50G*/
    _64BIT_ON,  /*AAS: port modes with SD rate 50G*/
    _128BIT_ON, /*AAS: port modes with SD rate 100G*/
...
typedef enum
{
    ...
    COM_PHY_C12GP41P2V_SIP6_30, /* Used in : Ironman */
    SERDES_LAST
...
typedef enum
{
    ...
    MV_HWS_PORT_SPEED_800G_E  = 800000
...
typedef enum{
    ...
    /** full duplex mode */
    MV_HWS_PORT_FULL_DUPLEX_E,

    /** half duplex mode */
    MV_HWS_PORT_HALF_DUPLEX_E

} MV_HWS_PORT_DUPLEX_ENT;
...
typedef enum{
    ...
    MV_HWS_DIRECTION_INGRESS_E,

    /** the direction is egress */
    MV_HWS_DIRECTION_EGRESS_E

} MV_HWS_DIRECTION_ENT;

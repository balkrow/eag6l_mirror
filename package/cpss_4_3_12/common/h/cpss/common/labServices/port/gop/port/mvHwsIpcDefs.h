...
#define MV_HWS_IPC_PORT_OPERATION_EXT_SIG_DET_SET            10

/* debug option to change the preset parameter*/
#define MV_HWS_IPC_PORT_OPERATION_CFG_HAL_SET_PRESET          100 /* change preset request */
#define MV_HWS_IPC_PORT_OPERATION_CFG_HAL_SET_CAL_DELTA_LIMIT 101 /* change cal delta limit in pam4 */

...
typedef GT_STATUS (*MV_HWS_PCS_RX_RESET_GET_FUNC_PTR)
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  phyPortNum,
...
typedef GT_STATUS (*MV_HWS_PCS_REMOTE_FAULT_SELECT_SET_FUNC_PTR)
(
    GT_U8                   devNum,
    GT_U32                  portNum,
    MV_HWS_PORT_STANDARD    portMode,
...
typedef GT_STATUS (*MV_HWS_PCS_AN_DONE_GET_FUNC_PTR)
(
    GT_U8                   devNum,
    GT_U32                  portGroup,
    GT_U32                  portNum,
...
typedef struct
{
    ...
    MV_HWS_PCS_RX_RESET_GET_FUNC_PTR    pcsRxResetGetFunc;
#endif
...
#endif
    MV_HWS_PCS_REMOTE_FAULT_SELECT_SET_FUNC_PTR pcsTxRemoteFaultSelectSetFunc;
    MV_HWS_PCS_AN_DONE_GET_FUNC_PTR     pcsAnDoneGetFunc;

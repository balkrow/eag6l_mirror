...
#else
#define MV_HWS_SERDES_TXRX_OVERRIDE_TUNE_PARAMS_ARR_SIZE       3
#endif

#define HWS_COMPHY_CHECK_AND_SET_DB_32BIT_VAL(val, defVal, overrideVal)\
        val = ((overrideVal == NA_32BIT) ?  defVal : overrideVal)

#define HWS_COMPHY_CHECK_AND_SET_DB_8BIT_SIGNED_VAL(val, defVal, overrideVal)\
        val = ((overrideVal == NA_8BIT_SIGNED) ?  defVal : overrideVal)
...
#define HWS_COMPHY_CHECK_AND_SET_DB_16BIT_VAL(val, defVal, overrideVal)\
        val = ((overrideVal == NA_16BIT) ?  defVal : overrideVal)
...
#define MV_HWS_COMPHY_PPM_TOLERANCE_FOR_112G         60
#define MV_HWS_COMPHY_PPM_TOLERANCE_FOR_28G          2
#define MV_HWS_COMPHY_FREQUENCY_TOLERANCE               500

#define PLL_INIT_POLLING_RETRIES 100
#if defined(AC5_DEV_SUPPORT) || defined(IRONMAN_DEV_SUPPORT)
...
#define DTL_CLAMPING_DELAY 5
#define RESET_CORE_ACK_DELAY 1
#define RESET_CORE_ACK_TIMEOUT 500
...
typedef enum
{
    MV_HWS_COMPHY_UNDEFINED_DATA,
    MV_HWS_COMPHY_CMN_DATA,
    MV_HWS_COMPHY_LANE_DATA,
    MV_HWS_COMPHY_FW_DATA,
    COMPHY_MAX_DATA_TYPE
}MV_HWS_COMPHY_RAM_DATA_TYPE;

/**
 * @struct COMPHY_ProgRamData
 *
 * @brief
 */
typedef struct tag_MV_HWS_COMPHY_ProgRamData
{
   MV_HWS_COMPHY_RAM_DATA_TYPE xType;
   GT_U8        lane;
   GT_U32       *pDataPtr;
   GT_U32       dataSizeDW;
   GT_U32       dataBaseAddr;
   GT_U32       dataMaxSize;
   GT_U32       regAddrActualCheckSum;
   GT_U32       regAddrExpectCheckSum;
   GT_U32       regAddrCSPass;
   GT_U32       expectCheckSum;
   MCESD_U16    errCode;

}MV_HWS_COMPHY_PROG_RAM_DATA;
...
GT_STATUS mvHwsComphyC12GP41P2VSip6_30_IfInit(IN MV_HWS_SERDES_FUNC_PTRS **funcPtrArray);

...
#define HWS_COMPHY_SERDES_TYPE_CHECK(serdesType) \
        ((serdesType == COM_PHY_C12GP41P2V) || (serdesType == COM_PHY_C28GP4X2) || (serdesType == COM_PHY_C28GP4X1) ||\
         (serdesType == COM_PHY_C28GP4X4)   || (serdesType == COM_PHY_C112GX4)  || (serdesType == COM_PHY_N5XC56GP5X4) || (serdesType == COM_PHY_C12GP41P2V_SIP6_30))
...
#define MV_HWS_TIME_DIFF(startSec,startNsec, endSec,endNsec)\
        ((int)(endSec - startSec)*1000 + (int)(endNsec-startNsec)/1000000)

/* timeout for CDR lock/unlock in msec */
#define MV_HWS_SERDES_CDR_LOCK_TIMEOUT 100
#define MV_HWS_SERDES_CDR_LOCK_COUNT_CONSECUTIVE 4

#define MV_HWS_SERDES_EOM_RETRIES 5
...
#define NA_32BIT_SIGNED 0x7FFFFFFF
...
/* used to get the correct serdes db parameters type (default/override/combination) */
/**
* @enum MV_HWS_SERDES_DB_TYPE
* @endinternal
*
* @brief   SerDes DB types
*
*/
typedef enum
{
    SERDES_DB_DEFAULT_ONLY,
    SERDES_DB_OVERRIDE_ONLY,
    SERDES_DB_OVERRIDE_AND_DEFAULT,

    SERDES_DB_LAST

}MV_HWS_SERDES_DB_TYPE;
...
typedef GT_STATUS (*MV_HWS_SERDES_ENABLE_SET_FUNC_PTR)
(
    IN GT_U8                                devNum,
    IN GT_U32                               serdesNum,
    IN GT_BOOL                              enable
...
typedef GT_STATUS (*MV_HWS_SERDES_ENABLE_GET_FUNC_PTR)
(
    IN  GT_U8                                devNum,
    IN  GT_U32                               serdesNum,
...
typedef GT_STATUS (*MV_HWS_SERDES_BAND_GAP_OPT_FUNC_PTR)
(
    GT_U8                   devNum,
    GT_UOPT                 portGroup,
    GT_UOPT                 serdesNum
...
typedef GT_STATUS (*MV_HWS_SERDES_EOM_MATRIX_GET_FUNC_PTR)
(
    IN     GT_U8                                devNum,
    IN     GT_U32                               serdesNum,
...
typedef GT_STATUS (*MV_HWS_SERDES_RX_INIT_FUNC_PTR)
(
    GT_U8                               devNum,
    GT_UOPT                             portGroup,
    GT_UOPT                             serdesNum,
...
typedef struct
{
  ...
  MV_HWS_SERDES_GEN_BOOL_GET_FUNC_PTR            serdesClampingValuesResetFunc;
  ...
  MV_HWS_SERDES_ENABLE_SET_FUNC_PTR              serdesGrayCodeEnableSetFunc;
  MV_HWS_SERDES_ENABLE_GET_FUNC_PTR              serdesGrayCodeEnableGetFunc;
  MV_HWS_SERDES_ENABLE_SET_FUNC_PTR              serdesPreCodeEnableSetFunc;
  MV_HWS_SERDES_ENABLE_GET_FUNC_PTR              serdesPreCodeEnableGetFunc;
#ifndef MV_HWS_REDUCED_BUILD
  MV_HWS_SERDES_BAND_GAP_OPT_FUNC_PTR            serdesBandGapOptimizationFunc;
  MV_HWS_SERDES_EOM_MATRIX_GET_FUNC_PTR          serdesEomMatrixGetFunc;
#endif
  ...
  MV_HWS_SERDES_GEN_BOOL_FUNC_PTR                serdesSigDetectMaskFunc;
  ...
  */
  ...
  MV_HWS_SERDES_RX_INIT_FUNC_PTR                 serdesRxInitFunc;
#endif
...
extern GT_BOOL serdesBgEnable;
extern GT_BOOL serdesBgClkBypassEnable;
#endif
/**
...
* @param[in] dbType                   - serdes db parameters
*       type (default/override/combination)
*

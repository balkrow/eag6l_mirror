...
/**
* @internal CPSS_OS_TASK_GET_PID_FUNC  function
* @endinternal
*
...
* @retval Process ID
*
* @noteThis function  is always successful.
*/
...
* @endinternal
*
* @brief Registers the given function to be called
...
*
*
* @retval GT_OK- the function was successfully registered.
*         GT_FAIL  the function was not successfully registered.
*
* @note The same function may be registered multiple times: it is called

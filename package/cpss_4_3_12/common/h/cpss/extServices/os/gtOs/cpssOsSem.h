...
/**
* @internal CPSS_OS_NAMED_SEM_OPEN_FUNC  function
* @endinternal
*
* @brief Creates a new named  semaphore or opens an existing
*        semaphore.  The semaphore is identified by name.
*
* @param[in] namePtr    - (pointer to) semaphore name
* @param[in] smidPtr    - (pointer to)semaphore id
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
*
* @retval GT_OK- named semaphore was successfully opened
*         GT_FAIL named semaphore was not successfully opened
*
*/
typedef GT_STATUS (*CPSS_OS_NAMED_SEM_OPEN_FUNC )
(
    IN const GT_CHAR_PTR namePtr,
    IN CPSS_OS_SIG_SEM   *smidPtr
);

/**
* @internal CPSS_OS_NAMED_SEM_WAIT_FUNC  function
* @endinternal
*
* @brief   Locks the semaphore indicated  by smid.
*
...
*
*
* @retval GT_OK- named semaphore was successfully locked
*         GT_FAIL named semaphore was not successfully locked
*
...
/**
* @internal CPSS_OS_NAMED_SEM_POST_FUNC  function
* @endinternal
*
* @brief     Unlocks the semaphore indicated  by smid.
*
* @param[in] smid   - semaphore id
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
...
*
*
* @retval GT_OK- named semaphore was successfully unlocked
*         GT_FAIL named semaphore was not successfully unlocked
*
*/
...
/**
* @internal CPSS_OS_NAMED_SEM_CLOSE_FUNC  function
* @endinternal
*
* @brief  Closes the named semaphore indicated  by smid.
...
*
*
* @retval GT_OK- named semaphore was successfully closed
*         GT_FAIL named semaphore was not successfully closed
*
*/
...
/**
* @internal CPSS_OS_NAMED_SEM_UNLINK_FUNC  function
* @endinternal
*
* @brief Removes the named semaphore referred to by namePtr.
...
*
*
* @retval GT_OK- named semaphore was successfully unlinked
*         GT_FAIL named semaphore was not successfully unlinked
*
*/

...
/**
* @internal CPSS_INTERRUPTS_HW_ACCESS_CHECK_FUNC function
* @endinternal
*
* @brief   Pointer to function performing validation of managment access
...
*/
typedef GT_STATUS (*CPSS_INTERRUPTS_HW_ACCESS_CHECK_FUNC)
(
    IN GT_U8    devNum,

...
typedef GT_LL_COMP_RES (*prototypeCmpFunc)(void* elem_PTR1,void* elem_PTR2);
...
/**
* @internal llIsEmpty function
* @endinternal
*
* @brief   Checks whether the linked-list is empty.
*
* @param[in] pLlist                   - A pointer to the linked-list to check.
*
* @retval GT_TRUE is the linked    -list contains no nodes, GT_FALSE otherwise.
*/
GT_BOOL llIsEmpty
(
...
/**
* @internal llAdd function
* @endinternal
*
* @brief   inserts a new node, containing pData, to the linked-list.
*
* @param[in] pLlist                   - A pointer to the linked-list to insert to.
* @param[in] pData                    - A pointer to the data to be inserted.
*
* @param[out] pLlist                   - A pointer to the linked-list after insertion.
...
/**
* @internal llAddFirst function
* @endinternal
*
* @brief   Adds a new data to the beginning of the linked-list.
*
* @param[in] pLlist                   - A pointer to the linked-list to add to.
* @param[in] pData                    - A pointer to the data to be added.
*
* @param[out] pLlist                   - A pointer to the linked-list after adding pData.
*                                       GT_OK on success,
*                                       GT_FAIL otherwise.
*/
...
/**
* @internal llAddLast function
* @endinternal
*
* @brief   Adds a new data to the end of the linked-list.
*
* @param[in] pLlist                   - A pointer to the linked-list to add to.
* @param[in] pData                    - A pointer to the data to be added.
*
...
/**
* @internal llDestroy function
* @endinternal
*
* @brief   Destroys the given linked-list.
*
* @param[in] pLlist                   - A pointer to the linked-list to be destroyed.
...
*                                      on the user's data.
*
* @param[out] pLlist                   - Points to NULL, this node will also be deleted.
*                                       GT_OK on success,
*                                       GT_FAIL otherwise.
*/
GT_STATUS llDestroy

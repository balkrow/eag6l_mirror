...
/**
* @internal cmdCpssDxChPclRuleClearEgrCommonOvelappingFields function
* @endinternal
*
* @brief   Clear overlapping fields in the given egress common structure.
*
* @param[out] dataPtr                  - (pointer to)the structure with result values.
*                                       none.
*/
...
/**
* @internal cmdCpssDxChPclRuleClearOvelappingFields function
* @endinternal
*
* @brief   Clear overlapping fields in the given structure.
*
...
/**
* @internal cmdCpssDxChByteArrayIncrement function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
* @param[in,out] basePtr                  - (pointer to)the byte array with base values.
* @param[in] incrPtr                  - (pointer to)the byte array with increment values.
* @param[in] length                   - amount of byte in array
* @param[in] carry                    - GT_TRUE  - to add  bit to the next byte
...
/**
* @internal cmdCpssDxChPclRuleIngrCommonIncrement function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
...
/**
* @internal cmdCpssDxChPclRuleIngrCommonStdIpIncrement function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
...
/**
* @internal cmdCpssDxChPclRuleIngrCommonExtIncrement function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
...
/**
* @internal cmdCpssDxChPclRuleEgrCommonIncrement function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
...
/**
* @internal cmdCpssDxChPclRuleEgrCommonStdIpIncrement function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
...
/**
* @internal cmdCpssDxChPclRuleEgrCommonExtIncrement function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
...
/**
* @internal cmdCpssDxChPclRuleIngrCommonUdbIncrement function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
...
/**
* @internal cmdCpssDxChPclRuleIngrCommonEnh1Increment function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
...
/**
* @internal cmdCpssDxChPclRuleEgrCommonEnh1Increment function
* @endinternal
*
* @brief   Increment all supported fields in the given structure.
*
...
)
{
    ...
    if ((incrPtr->egressPolicy == CPSS_PCL_DIRECTION_EGRESS_E)
...
)
{
    ...
    else
    {
        ...
        rc = cpssDxChPclRuleParsedGet(
            devNum, tcamIndex, ruleFormat, baseRuleIndex, 0 /*ruleOptionsBmp*/,
        ...
        rc = cpssDxChPclRuleParsedGet(
            devNum, tcamIndex, ruleFormat, incrRuleIndex, 0 /*ruleOptionsBmp*/,
    ...
    for (i = 1; (i < amountToWrite); i++)
    {
        ...
        else
        {
            rc = cpssDxChPclRuleSet(
                devNum, tcamIndex, ruleFormat, index, 0 /*ruleOptionsBmp*/,
...
{
    return cmdCpssDxChPclRuleSequenceWriteExt1(
        devNum, utilPclMultiTcamIndexGet(devNum), ruleFormat,
        baseRuleIndex, incrRuleIndex, amountToWrite, writeIndexIncr);
}

...
)
{
    ...
    {
        ethMode1 = (CPSS_ETHER_MODE_ENT)inArgs[2];
        result = wrSip5Emulate_cpssDxChBrgVlanPortIngressTpidSet(devNum, portNum, ethMode1, tpidBmp);
    }
...
)
{
    ...
    {
        ethMode1 = (CPSS_ETHER_MODE_ENT)inArgs[2];
        result = wrSip5Emulate_cpssDxChBrgVlanPortIngressTpidGet(devNum, portNum, ethMode1, &tpidBmpPtr);
    }

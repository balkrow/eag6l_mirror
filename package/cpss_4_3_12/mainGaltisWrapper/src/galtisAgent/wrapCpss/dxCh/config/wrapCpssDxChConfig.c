...
)
{
    ...
    global.enable = (CPSS_DXCH_CFG_GLOBAL_EPORT_CONFG_ENT)inArgs[1];
    global.pattern = (GT_U32)inArgs[2];
    global.mask = (GT_U32)inArgs[3];

    ecmp.enable = (CPSS_DXCH_CFG_GLOBAL_EPORT_CONFG_ENT)inArgs[4];
    ecmp.pattern = (GT_U32)inArgs[5];
    ecmp.mask = (GT_U32)inArgs[6];

    dlb.enable = (CPSS_DXCH_CFG_GLOBAL_EPORT_CONFG_ENT)inArgs[7];

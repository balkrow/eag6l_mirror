...
)
{
    ...
    switch(inArgs[1])
    {
        case DXCH_TX_BY_VIDX:
            ...
            {
                netTxPacketDesc->dsaParam.dsaInfo.fromCpu.dstInterface.vidx = (GT_U32)inFields[24];
            }
...
)
{
    ...
    netTxPacketDesc->dsaParam.dsaInfo.forward.srcIsTagged =
        (CPSS_DXCH_BRG_VLAN_PORT_TAG_CMD_ENT)inFields[16];
    ...
    switch(inArgs[1])
    {
        case DXCH_TX_BY_VIDX:
            ...
            {
                netTxPacketDesc->dsaParam.dsaInfo.forward.dstInterface.vidx = (GT_U32)inFields[25];
            }
            else/*CPSS_INTERFACE_VID_E*/
            {

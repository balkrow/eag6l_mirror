...
)
{
    ...
    actionPtr->egressInterface.vidx            = (GT_U32)inFields[15];
    ...
    actionPtr->trustUp                         = (CPSS_DXCH_TTI_TRUST_UP_ENT)inFields[35];
...
)
{
    ...
    ruleFormat = CPSS_DXCH_TTI_RULE_MPLS_E;
...
)
{
    ...
    ruleFormat = CPSS_DXCH_TTI_RULE_ETH_E;
...
)
{
    ...
    if ((mask_set && pattern_set) && (actionIndex != INVALID_RULE_INDEX))
    {
        ...
        keyType = (CPSS_DXCH_TTI_RULE_TYPE_ENT)inArgs[1];
...
)
{
    ...
    ruleFormat = CPSS_DXCH_TTI_RULE_MIM_E;
...
)
{
    ...
    switch ((CPSS_DXCH_TTI_RULE_TYPE_ENT)inArgs[3]) /* key type tab */
    {
    ...
    {
        actionPtr                    = &(ttiActionDatabase[actionIndex].actionEntry);
        keyType                      = (CPSS_DXCH_TTI_RULE_TYPE_ENT)inArgs[3];
        ttiRuleFormat[ruleIndex]     = keyType;
...
)
{
    ...
    CONVERT_TRUNK_ID_TEST_TO_CPSS_MAC(actionPtr->egressInterface.trunkId);
    actionPtr->egressInterface.vidx            = (GT_U32)inFields[19];
    ...
    actionPtr->trustUp                         = (CPSS_DXCH_TTI_TRUST_UP_ENT)inFields[39];
...
)
{
    ...
    actionPtr->unknownSaCommand                = (CPSS_PACKET_CMD_ENT)inFields[93];
...
)
{
   ...
   /* set action entry in TTI action database as valid */
    ...
    ttiMultiActionDatabaseParams->actionEntry.egressInterface.vidx            = (GT_U32)inArgs[21];
    ...
    ttiMultiActionDatabaseParams->actionEntry.trustUp                         = (CPSS_DXCH_TTI_TRUST_UP_ENT)inArgs[41];

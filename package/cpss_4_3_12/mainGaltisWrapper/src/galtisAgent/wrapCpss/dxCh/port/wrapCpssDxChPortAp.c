...
)
{
    ...
    apParams.fcAsmDir       = (CPSS_DXCH_PORT_AP_FLOW_CONTROL_ENT)inFields[3];
...
)
{
    ...
    if(useCpssDefaultsArray[numOfApPortsToConfig] == GT_FALSE)
    {
        ...
        apPortsArray[numOfApPortsToConfig].fcAsmDir = (CPSS_DXCH_PORT_AP_FLOW_CONTROL_ENT)inFields[2];
        apPortsArray[numOfApPortsToConfig].fcPause = (GT_BOOL)inFields[3];

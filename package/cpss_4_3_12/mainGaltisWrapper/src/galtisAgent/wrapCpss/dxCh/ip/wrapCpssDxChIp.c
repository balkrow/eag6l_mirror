 ...
 )
{
    ...
    regularEntry->nextHopInterface.vidx = (GT_U32)inFields[26];
 ...
 )
{
    ...
    routeEntriesArray[cIndexSet].entry.regularEntry.nextHopInterface.vidx = (GT_U32)inFields[26];
 ...
 )
{
    ...
    CONVERT_TRUNK_ID_TEST_TO_CPSS_MAC(routeEntriesArray[cIndexSet].entry.regularEntry.nextHopInterface.trunkId);
    routeEntriesArray[cIndexSet].entry.regularEntry.nextHopInterface.vidx = (GT_U32)inFields[27];
 ...
 )
{
        ...
        mllPairWriteForm == CPSS_DXCH_PAIR_READ_WRITE_FIRST_ONLY_E)
    {
        ...
        mllPairEntry.firstMllNode.nextHopInterface.vidx = (GT_U32)inFields[9];
        ...
        CPSS_DXCH_PAIR_READ_WRITE_SECOND_NEXT_POINTER_ONLY_E)
    {
        ...
        mllPairEntry.secondMllNode.nextHopInterface.vidx = (GT_U32)inFields[22];
 ...
 )
{
        ...
        CPSS_DXCH_PAIR_READ_WRITE_SECOND_NEXT_POINTER_ONLY_E)
    {
        ...
        CONVERT_TRUNK_ID_TEST_TO_CPSS_MAC(mllPairEntry.secondMllNode.nextHopInterface.trunkId);
        mllPairEntry.secondMllNode.nextHopInterface.vidx = (GT_U32)inFields[23];

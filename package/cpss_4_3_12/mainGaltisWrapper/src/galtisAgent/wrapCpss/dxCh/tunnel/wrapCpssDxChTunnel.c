...
)
{
    ...
    stConfigPtr.mplsCfg.exp1MarkMode = (CPSS_DXCH_TUNNEL_START_QOS_MARK_MODE_ENT)inFields[10];
    stConfigPtr.mplsCfg.exp1 = (GT_BOOL)inFields[11];
    stConfigPtr.mplsCfg.label2 = (GT_BOOL)inFields[12];
    stConfigPtr.mplsCfg.exp2MarkMode = (CPSS_DXCH_TUNNEL_START_QOS_MARK_MODE_ENT)inFields[13];

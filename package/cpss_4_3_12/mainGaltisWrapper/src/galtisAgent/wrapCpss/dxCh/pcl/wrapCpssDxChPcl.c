...
)
{
    if (wrCpssDxChVirtualTcam_useVTcamApi)
    {
        ...
        actionType.action.pcl.direction = actionPtr->egressPolicy;
...
)
{
    ...
    actionPtr->egressPolicy = (CPSS_PCL_DIRECTION_ENT)inFields[5];
    ...
    actionPtr->policer.policerEnable =
        (CPSS_DXCH_PCL_POLICER_ENABLE_ENT)inFields[24];
...
)
{
    ...
    actionPtr->policer.policerEnable = (CPSS_DXCH_PCL_POLICER_ENABLE_ENT)inFields[30];
...
)
{
    ...
    case CPSS_INTERFACE_VIDX_E:
        interfaceInfoPtr.vidx = (GT_U32)inArgs[5];
        break;
...
)
{
    ...
    switch (interfaceInfo.type)
    {
        ...
        case CPSS_INTERFACE_VIDX_E:
            interfaceInfo.vidx = (GT_U32)inArgs[5];
            break;
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChPclInvalidUdbCmdSet(
        devNum, CPSS_PCL_DIRECTION_INGRESS_E, udbErrorCmd);
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChPclInvalidUdbCmdGet(
        devNum, CPSS_PCL_DIRECTION_INGRESS_E, &udbErrorCmd);
...
)
{
    ...
    actionPtr->egressPolicy  = (CPSS_PCL_DIRECTION_ENT)inFields[i++];
    ...
    /* WA - GUI defines the field modifyDscp as BOOL instead of Enum */
        ...
        case CPSS_PCL_DIRECTION_EGRESS_E: /* egress */
            ...
            actionPtr->qos.egress.modifyDscp =
                (CPSS_DXCH_PCL_ACTION_EGRESS_DSCP_EXP_CMD_ENT)(inFields[i]);
...
)
{
    ...
    result = cpssDxChPclOamRFlagMatchingSet(
        devNum, CPSS_PCL_DIRECTION_INGRESS_E, oamProfile, rFlagMask, rFlagPattern);
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChPclSourceIdMaskSet(
...
)
{
    ...
    /* call cpss api function */
    result = cpssDxChPclSourceIdMaskGet(
        devNum, CPSS_PCL_DIRECTION_INGRESS_E, lookupNum, &mask);

...
static GT_STATUS init_txPacketDescTbl(void)
{
    ...
    *******************************************************************************/
    ...
    )
    {
        ...
        cpssPcktParams.dsaParam.commonParams.dsaTagType = CPSS_DXCH_NET_DSA_2_WORD_TYPE_ENT;
    ...
    switch(inArgs[1])
    {
        ...
        case 0: /* TX to MULTI DESTINATION */
            ...
            if(txPacketDescTbl[entryIndex].dstInterface.type == CPSS_INTERFACE_VID_E)
                ...
                txPacketDescTbl[entryIndex].dstInterface.vidx = (GT_U32)inFields[16];
...
)
{
    ...
    cpssDxChPcktParams.dsaParam.commonParams.dsaTagType = CPSS_DXCH_NET_DSA_2_WORD_TYPE_ENT;

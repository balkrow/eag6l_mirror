...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, modesAdvertiseArr, CPSS_PX_PORT_AP_IF_ARRAY_SIZE_CNS, CPSS_PORT_MODE_SPEED_STC);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, fecAbilityArr, CPSS_PX_PORT_AP_IF_ARRAY_SIZE_CNS, CPSS_PORT_FEC_MODE_ENT);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, fecRequestedArr, CPSS_PX_PORT_AP_IF_ARRAY_SIZE_CNS, CPSS_PORT_FEC_MODE_ENT);
    prvCpssLogStcLogEnd(contextLib, logType);
}

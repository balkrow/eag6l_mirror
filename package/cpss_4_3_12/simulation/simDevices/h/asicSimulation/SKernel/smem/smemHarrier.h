...
ACTIVE_READ_FUNC_PROTOTYPE_MAC(smemHarrierActiveRead_pm_ctrl_tx_lane_reg1_lane);
ACTIVE_READ_FUNC_PROTOTYPE_MAC(smemHarrierActiveRead_pm_ctrl_rx_lane_reg1_lane);
ACTIVE_READ_FUNC_PROTOTYPE_MAC(smemHarrierActiveRead_tx_train_if_reg3);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemHarrierActiveWriteSerdesInterruptsMaskReg);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemHarrierActiveWrite_Lane_Control_0);

...
#define SIP6_MAX_DP_QUEUE_CNS    456 /* Ironman  - 456  */
...
#define OAM_MAX_GROUP_STATUS_CNS 64
...
/* 3 trees in sip 5,6 devices */
#define SIM_MG_MAX_INT_TREES    3
/* CNM max trees */
#define CNM_MAX_INT_TREES       16

/* GDMA constants*/
#define SIM_MAX_GDMA_QUEUE_NUM_CNS                      32
#define SIM_MAX_GDMA_MC_PROFILE_NUM_CNS                 16
#define SIM_MAX_GDMA_PDI_SLAVE_NUM_CNS                   8
#define SIM_MAX_GDMA_PDI_QUEUE_PROFILE_NUM_CNS           4
#define SIM_MAX_GDMA_PDI_QUEUE_PROFILE_HEADER_NUM_CNS    8
...
/* get pointer to CNC wraparound FIFO memory for the device */
#define SMEM_SIP_6_10_CNC_WRAP_FIFO_MEM_GET(dev, _cncUnit, _cncBlock) \
            SMEM_CHT_FIELD_PTR_GET_MAC(dev,cncWrapFifo.wrapStatusFifoRegs[(_cncUnit)][(_cncBlock)][0])
...
/* set/get if device support sip7 */
#define SMEM_CHT_IS_SIP7_GET(dev)   \
            dev->sipRevInfo.isSip7
...
/* define registers that valid from sip 6.10 */
#define SIP_6_10_REG(dev,reg)  \
    (SMEM_CHT_IS_SIP6_10_GET(dev) ? SMEM_CHT_MAC_REG_DB_SIP5_GET(dev)->reg : \
        SMAIN_NOT_VALID_CNS)

/* define registers that valid from sip 6.30 */
#define SIP_6_30_REG(dev,reg)  \
    (SMEM_CHT_IS_SIP6_30_GET(dev) ? SMEM_CHT_MAC_REG_DB_SIP5_GET(dev)->reg : \
        SMAIN_NOT_VALID_CNS)

/* define registers that valid from sip 7.0 */
#define SIP_7_REG(dev,reg)  \
    (SMEM_CHT_IS_SIP7_GET(dev) ? SMEM_CHT_MAC_REG_DB_SIP5_GET(dev)->reg : \
        SMAIN_NOT_VALID_CNS)
...
/* maximal amount of channels in MIF unit (Ironman) */
#define SMEM_CHT_EPI_MIF_MAX_CHANNELS_E 17
/* maximal amount of MIF units in datapath (Ironman) */
#define SMEM_CHT_EPI_MIF_MAX_DP_UNITS_E 4
...
/*sip6_30 holds 35 RX counters of 64 bits each */
#define CHT_INTERNAL_SIMULATION_SIP_6_30_RX_STATISTIC_PAGE 35
/*sip6_30 holds 26 TX counters of 64 bits each */
#define CHT_INTERNAL_SIMULATION_SIP_6_30_TX_STATISTIC_PAGE 26


/*sip6 holds 43 RX and 34 TX counters of 64 bits each */
#define CHT_INTERNAL_SIMULATION_STATISTIC_PAGE (CHT_INTERNAL_SIMULATION_RX_STATISTIC_PAGE+CHT_INTERNAL_SIMULATION_TX_STATISTIC_PAGE)
...
typedef enum{
    ...
    CHT_INTERNAL_SIMULATION_USE_MEM_RX_STATISTICAL_SNIFF_RATIO_ANALYZER_7_E =
        CHT_INTERNAL_SIMULATION_USE_MEM_RX_STATISTICAL_SNIFF_RATIO_ANALYZER_1_E + 6,
...
/* sip5 : on chip fifo : number of entries --> 256 words / 6 words per message */
#define MAC_ON_CHIP_FIFO_NUM_ENTRIES_CNS    (MAC_UPD_FIFO_REGS_NUM / 6) /*messages are 6 words*/
/* sip7 : on chip fifo : number of entries --> 256 words / 14 words per message */
#define SIP7_MAC_ON_CHIP_FIFO_NUM_ENTRIES_CNS    (MAC_UPD_FIFO_REGS_NUM / 14)

/* number of words to hold in macUpdFifoRegs */
/* the register in FDB "AU FIFO to CPU Configuration" hold 7 bits value that state
   value of "8-byte words" messages , so to convert the 127 values to "4-bytes words"
   we need to use X2 on it --> 127 x 2 = 254 */
#define     SIP5_MAC_UPD_FIFO_REGS_NUM      254
/* the register in FDB "AU FIFO to CPU Configuration" hold 5 bits value that state
   value of "8-byte words" messages , so to convert the 31 values to "4-bytes words"
   we need to use X2 on it --> 31 x 2 = 62 */
#define     SIP4_MAC_UPD_FIFO_REGS_NUM      62
...
typedef struct {
    SMEM_REGISTER         macUpdFifoRegs[SIP5_MAC_UPD_FIFO_REGS_NUM];
}CHT_AUQ_FIFO_MEM;
...
/* CNC Wraparound Status info FIFO size per CNC Block */
#define     CNC_WRAP_FIFO_REGS_NUM_CNS                   (8)

/* FIFO to hold CNC Wraparound Status info
   It's used for single tile and single pipe devices:
   AC5P (Hawk), AC5X (Phoenix), Harier */
typedef struct {
    SMEM_REGISTER wrapStatusFifoRegs[MAX_CNC_UNITS_CNS][MAX_CNC_BLOCKS_IN_UNIT_CNS][CNC_WRAP_FIFO_REGS_NUM_CNS];
}SMEM_SIP_6_10_CNC_WRAP_FIFO;
...
typedef struct {
    ...
    GT_U32    mg1InternalInterruptsSummaryCause;
    GT_U32    mg1InternalInterruptsSummaryMask;

    /* MG SDMA interrupts (also per tree) */
    struct{
...
typedef struct {
    struct /*MG - MG */{
        ...
        MG_GLOBAL_INTERRUPT_STC globalInterrupt[SIM_MG_MAX_INT_TREES];
...
DONE_SIP5_ALIGN        GT_U32    MPLSEthertype[4];
...
typedef struct {
    ...
    GT_U32  extControl;     /* sip 6_30, part of PCS EXT unit: EPI/<PCS_x8>MTIP 10G PCS WRAPPER_%b_%a/<PCS_x8> <MTIP_PCS_EXT> MTIP PCS EXT */
...
typedef struct /*MIF-unit*/{
    GT_U32  mif_channel_mapping_register[SMEM_CHT_EPI_MIF_MAX_CHANNELS_E];
    GT_U32  mif_link_fsm_control_register[SMEM_CHT_EPI_MIF_MAX_CHANNELS_E];
} SMEM_CHT_EPI_MIF_UNIT_REG_STC;

typedef struct /*MIF-DP*/{
    SMEM_CHT_EPI_MIF_UNIT_REG_STC unit[SMEM_CHT_EPI_MIF_MAX_DP_UNITS_E];
}SMEM_CHT_EPI_MIF_DP_REG_STC;
...
typedef struct /*MTI_EXT*/{
    ...
    GT_U32 portInterruptCause;
    GT_U32 portInterruptMask;
    GT_U32 portSummaryInterruptCause;
    GT_U32 portSummaryInterruptMask;
...
}SMEM_CHT_MTI_PCS_EXT_PORT_UNIT_REG_STC;
...
typedef struct /*ANP*/{
    ...
    GT_U32 Global_SD_Mux_Control[2];
}SMEM_CHT_PORT_ANP_UNIT_REG_STC;


typedef struct /*sip_6_10_SERDES*/{
    GT_U32 SDWInterruptCause;
    GT_U32 SDWInterruptMask;
}SMEM_CHT_PORT_SIP_6_10_SERDES_UNIT_REG_STC;
...
DONE_SIP5_ALIGN   GT_U32    myPhysicalPortAttributes[304]/*Port*/;
...
NEED_TO_BE_USED_BY_SIP5            GT_U32    duplicationOfPktsToCPUConfig[_32_PHY_PORTS_IN_REG_CNS]/*port*/;
...
DONE_SIP5_ALIGN            GT_U32    cscdTrunkHashBitSelectionConfig; /* obsolete in sip7 */
...
DONE_SIP5_ALIGN            GT_U32    mirrorInterfaceParameterReg[MAX_NUM_ANALYZER_PORTS]/*Parameter Number*/;
DONE_SIP5_ALIGN            GT_U32    analyzerPortGlobalConfig;
        ...
        struct{
            GT_U32 stagePathInfo[3];/* hold fields :      length  start bit
                        ...
                        StageX P/B Path Selection GCF lsb 7 bits   12
                                */
        }GCF;SIM_TBD_BOOKMARK/* not in Cider yet */

        /* sip7 : E2PHY */
        struct{
            GT_U32  Circuits_base_address_in_E2PHY;/*
                 0..15 : Circuits_base_address_in_E2PHY
                16..31 : Circuits_base_address_analyzer_in_E2PHY
                */
            GT_U32  mll_To_Other_device;/*
                0..2  : mll_To_Other_device_CMD
                3..10 : mll_To_Other_device_CPU_CODE
                */
            GT_U32  Hierarchical_ECMP_out_of_sync;/*
                0..2  : Hierarchical_ECMP_out_of_sync_CMD
                3..10 : Hierarchical_ECMP_out_of_sync_CPU_CODE
                */
        }E2PHY;SIM_TBD_BOOKMARK/* not in Cider yet */
...
DONE_SIP5_ALIGN             GT_U32    lpmMemBankId;     /* new in sip7 */
...
DONE_SIP5_ALIGN             GT_U32    exceptionStatus;
    ...
    struct /*TCAM*/{
        ...
        GT_U32    tcamHitNumAndGroupSelFloor[24]/*Floor num (24 in AAS) */;
...
NEED_TO_BE_USED_BY_SIP5    GT_U32    toAnalyzerLoopback[MAX_NUM_ANALYZER_PORTS + 1]/*Reg Offset*/;
...
NOT_RELEVANT_TO_SIM            GT_U32    mcUcSDWRRAndStrictPriorityConfig;
NOT_RELEVANT_TO_SIM            GT_U32    mcPriorityTypeConfiguration;/* new in sip7 */
...
DONE_SIP5_ALIGN            GT_U32    ePortToEVIDXBase;
        ...
        struct /*multiTargetVPortMap*/{ /* new in sip7 */

            GT_U32    multiTargetVportRangeBase;
            GT_U32    multiTargetVportRangeSize;
            GT_U32    multiTargetVportRangeEVidx;
            struct{
...
DONE_SIP5_ALIGN        GT_U32    policyEngineConfig;
DONE_SIP5_ALIGN        GT_U32    policyEngineUserDefinedBytesConfig;
DONE_SIP5_ALIGN        GT_U32    lookupSourceIDMask[3]/*lookup num*/;/* in sip6.30 renamed to policyGlobalConfig */
DONE_SIP5_ALIGN        GT_U32    policyEngineUserDefinedBytesExtConfig;
...
DONE_SIP5_ALIGN        GT_U32    IPCLReservedBitMask[3]/*lookup num*/;
    ...
    struct /*MPCL*/{
        ...
        GT_U32    policyGenericActionConfig;
        GT_U32    policyGlobalConfig;
        GT_U32    policyGlobalConfig_ext1;
        GT_U32    countingModeConfig;
        GT_U32    exactMatchProfileIdMapEntry[256]/*entry num*/;
        GT_U32    maxSduSizeProfile[4]/*profile num*/;
        GT_U32    maxSduException;
        GT_U32    flowIdActionAssignmentModeConfig;
        GT_U32    actionModifiedFieldsSelect[2]; /*reg idx */
    } MPCL;
...
NOT_RELEVANT_TO_SIM        GT_U32    EPCLInterruptMask;
        ...
        GT_U32    latencyMonitoringSamplingConfig[8]; /* Threshold Config table */
        ...
        /* SIP6_10 Register */
        GT_U32    queueOffsetLatencyProfileConfig[8]; /* Priority Queue...table */
        /* SIP6_30 Register */
    ...
    struct /*OAMUnit*/{
        ...
        GT_U32    agingEntryGroupStatus[OAM_MAX_GROUP_STATUS_CNS]/*reg*/;
        GT_U32    summaryExceptionGroupStatus[OAM_MAX_GROUP_STATUS_CNS]/*reg*/;
        GT_U32    txPeriodExceptionGroupStatus[OAM_MAX_GROUP_STATUS_CNS]/*reg*/;
        GT_U32    sourceInterfaceMismatchCntr;
        GT_U32    OAMGlobalCtrl1;
        GT_U32    RDIStatusChangeExceptionGroupStatus[OAM_MAX_GROUP_STATUS_CNS]/*reg*/;
        ...
        GT_U32    MEGLevelGroupStatus[OAM_MAX_GROUP_STATUS_CNS]/*reg*/;
        GT_U32    MEGLevelExceptionCntr;
        GT_U32    sourceInterfaceGroupStatus[OAM_MAX_GROUP_STATUS_CNS]/*reg*/;
        GT_U32    invalidKeepaliveHashCntr;
        GT_U32    invalidKeepaliveGroupStatus[OAM_MAX_GROUP_STATUS_CNS]/*reg*/;
        GT_U32    hashBitsSelection;
        GT_U32    excessKeepaliveGroupStatus[OAM_MAX_GROUP_STATUS_CNS]/*reg*/;
...
DONE_SIP5_ALIGN           GT_U32    ECMPConfig;
    ...
    struct /*GOP_PTP*/{
        ...
        }TSU_GLOBAL[SIM_MAX_DP_CNS];/*per TSU unit*//* TSU==PTP*/
    ...
    }LMU[4 * 8 * SIM_MAX_TILE_CNS]; /* MAX=(PCA/DP * LMUs * numOfTiles) */
    struct /*MTI*/{
        SMEM_CHT_MTI_EXT_PORT_UNIT_REG_STC      MTI_EXT_PORT;
        SMEM_CHT_MTI_EXT_PORT_UNIT_REG_STC      USX_MAC_PORT;
        SMEM_CHT_MTI_PCS_EXT_PORT_UNIT_REG_STC  MTI_PCS_EXT_PORT;
    ...
    struct
    {
        /* ironman MIF registers per DP - MIF-type==8 */
        SMEM_CHT_EPI_MIF_DP_REG_STC mif8Dp;
    } sip6_30_MIF[SIM_MAX_DP_CNS];
...
*/
    ...
    struct /*sip6_10*/{
        SMEM_CHT_PORT_SIP_6_10_SERDES_UNIT_REG_STC          sip_6_10_SERDES;
    }sip_6_10_SERDES[SIM_SIP_7_MAX_SERDES_UNITS * SIM_MAX_TILE_CNS];
    ...
    struct /*MTI_EXT*/{
        ...
        SMEM_CHT_PORT_MTI_MAC_COMMON_REG_STC MTI_cpuPreemtionMac;
        ...
        /* AC5P, AC5X, Harrier MIF registers per DP */
...
DONE_SIP5_ALIGN        GT_U32    policerIPFIXPktCountWAThresholdLSB;
DONE_SIP5_ALIGN        GT_U32    policerIPFIXPktCountWAThresholdMSB;
...
DONE_SIP5_ALIGN        GT_U32    policerInterruptCause;
        ...
        GT_U32    IPFIXSecondsLSbTimerStampUpload;
        GT_U32    policerShadow[2]/*RegNum*/;
DONE_SIP5_ALIGN        GT_U32    ipfixSampleEntriesLog_n[4/*n*/];
...
DONE_SIP5_ALIGN        GT_U32    globalBillingCntrIndexingModeConfig1;
    ...
    struct /*CNC*/{
        ...
        struct /*perBlockRegs*/{
            ...
            struct /*clientInterrupts*/
            {
                GT_U32    CNCBlockClientInterruptCauseRegister[16][3]/*Block*//*client:sip6.30*/;
                GT_U32    CNCBlockClientInterruptMaskRegister[16][3]/*Block*//*client:sip6.30*/;
            }clientInterrupts;
    ...
    }CNC[MAX_CNC_UNITS_CNS]/*CNC number*/;
...
#define SIP_5_DQ_NUM_PORTS_CNS      72/* 72 ports per DQ (BC2,bobk with single DQ) */
    ...
    struct /*TXQ_sip6*/{
        struct{ /*TXQ_SDQ[]*/
            SMEM_CHT_PP_REGS_UNIT_START_INFO_STC    startUnitInfo;
           struct{
                GT_U32 queueConfig [SIP6_MAX_DP_QUEUE_CNS];
            }Queue;
            ...
            struct{
                GT_U32 qbvConfig[SIP6_MAX_DP_PORTS_CNS];
                GT_U32 portQbvTableSet[SIP6_MAX_DP_PORTS_CNS];
                GT_U32 portEgressTodOffset[SIP6_MAX_DP_PORTS_CNS];
                GT_U32 portTableSetCycleTime[SIP6_MAX_DP_PORTS_CNS];
                GT_U32 portLengthAwrAttr[SIP6_MAX_DP_PORTS_CNS];
                /*going to simulate only one entry per tableSet ,not 255 like in real HW */
                GT_U32 portQbvConfTable[SIP6_MAX_DP_PORTS_CNS/2+1];
                GT_U32 configChangeTimeEgressTODOffset;
                GT_U32 configChangeTimeCycleTime;
            }QBV;
    ...
    struct /*sip6_rxDMA*/{
        ...
        struct /*debug*/{
            ...
            GT_U32  dp_rx_config_debug_counters;

            /* For SIP7 base addresses of array [channel][prio] channel 0-63 prto 0-3 */
            /* The address formula is base + (channel * 64) + (prio * 16) */
    ...
    struct /*SHM*/{
        ...
        GT_U32    block_port_select[130]/*SBM number*/;
    ...
    }EXACT_MATCH[MAX_EM_UNIT_NUM_CNS];/*sip6 only */

    struct /*REDUCED_EM - sip7 only */{
    ...
    struct /* CNM */
    {
        ...
        struct /*GDMA*/ {
            ...
            struct/*SGD and AXI Control Regs*/ {
                ...
                GT_U32 sgdChainSize;
            }sgdAxiControlRegs[SIM_MAX_GDMA_QUEUE_NUM_CNS];

            struct/*GDMA Timer Regs*/ {
                GT_U32 timerValue;
                GT_U32 timerJitterCfg;
            }gdmaTimerRegs[SIM_MAX_GDMA_QUEUE_NUM_CNS];
            ...
            struct/*PDI to PDI Queue Profile Regs*/ {
                ...
                GT_U32 header[SIM_MAX_GDMA_PDI_QUEUE_PROFILE_HEADER_NUM_CNS];
            }pdiToPdiQueueProfileRegs[SIM_MAX_GDMA_PDI_QUEUE_PROFILE_NUM_CNS];
            ...
            struct/*Interrupt and Debug Regs*/ {
                ...
                GT_U32 gdmaQInterruptCause[SIM_MAX_GDMA_QUEUE_NUM_CNS];
                GT_U32 gdmaQInterruptMask[SIM_MAX_GDMA_QUEUE_NUM_CNS];
            }interruptAndDebugRegs;


        }GDMA[SIM_MAX_GDMA_UNITS_CNS];
        ...
        struct /*Interrupts*/ {
            ...
            struct /* Trees regs */{
                ...
                GT_U32 cnmAggregationInterruptCause;
                GT_U32 cnmAggregationInterruptMask;

                GT_U32 cnmInterruptCause[4];
                GT_U32 cnmInterruptMask[4];

                GT_U32 unitsInterruptCause[15];
                GT_U32 unitsInterruptMask[15];

                GT_U32 highPriorityCoalescingBypassInterruptCause[2];
                GT_U32 highPriorityCoalescingBypassInterruptMask[2];

                GT_U32 gdmaInterruptCause[8];
                GT_U32 gdmaInterruptMask[8];
            }Trees[CNM_MAX_INT_TREES];
        }Interrupts;
...
typedef struct {
    ...
    SMEM_SIP_6_10_CNC_WRAP_FIFO     cncWrapFifo; /* FIFO to store wraparound status, used for AC5P/X and Harrier single pipe and tile devices */
...
/* MAC entry width in words :
    ...
    sip7 - 5 words (133 bits)
*/
#define SMEM_CHT_MAC_TABLE_WORDS            (5)

#define SMEM_CHT_MAC_TABLE_WORDS_MAC(dev)   \
    (SMEM_CHT_IS_SIP7_GET(dev) ? 5 :        \
     SMEM_CHT_IS_SIP6_GET(dev) ? 4 :        \
     SMEM_CHT_IS_SIP5_GET(dev) ? 5 :        \
     4)


/* MAC update message alignment size in words */
...
/* NA message size in words */
/* number of words alignment in AU Message format .
in ch1,2,3,xcat1,2,lion - 4 words
in lion2 6 words entry format - but alignment is 8 words
in sip5  6 words entry format - but alignment is 8 words
in sip7 14 words entry format - but alignment is 16 words
*/
#define SMEM_CHT_NA_MSG_WORDS               (16)
...
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemChtActiveAuqControlWrite);
...
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemChtPostStartSnapshotWriteClearEntry);
...
ACTIVE_READ_FUNC_PROTOTYPE_MAC (smemChtActiveReadEntryWithSnapShot);

ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemChtActiveReadCntrs64Bit);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemChtActiveReadCntrs64Bit_high32);

...
#define ACTIVE_MEM_MG_INTERRUPT_TREE_0_MAC                                                      \
    ...
    {0x00000038, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 11, smemChtActiveWriteIntrCauseReg, 0},                  \
    ...
    {0x0000280C, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 22, smemChtActiveWriteIntrCauseReg, 0},                  \
    /* Receive SDMA Interrupt Mask Register */                                                  \
    {0x00002814, SMEM_FULL_MASK_CNS,NULL, 0, smemChtActiveWriteRcvSdmaInterruptsMaskReg, 0},                                \
    /* Transmit SDMA Interrupt Cause Register */                                                \
    {0x00002810, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 21 , smemChtActiveWriteIntrCauseReg,0},                  \
    /* Transmit SDMA Interrupt Mask Register */                                                 \
    {0x00002818, SMEM_FULL_MASK_CNS,NULL, 0, smemChtActiveWriteTransSdmaInterruptsMaskReg, 0},                              \
    ...
    /* MG1 internal Interrupt Mask */                                                                     \
    {0x000000A0, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},            \
    /* MG1 internal Interrupt Cause  */                                                                   \
    {0x0000009C, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 18, smemChtActiveWriteIntrCauseReg, 0},\
    /*ports2InterruptsSummaryMask*/                                                                       \
    {0x0000015c, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},            \
    /*ports2InterruptsSummaryCause*/                                                                      \
    {0x00000158, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*ports1InterruptsSummaryMask*/                                                                       \
    {0x00000154, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},            \
    /*ports1InterruptsSummaryCause*/                                                                      \
    {0x00000150, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*dfx1InterruptsSummaryMask*/                                                                       \
    {0x000000BC, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*dfx1InterruptsSummaryCause*/                                                                      \
    {0x000000B8, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*stackPortsInterruptMask*/                                                                         \
    {0x00000084, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*stackPortsInterruptCause*/                                                                        \
    {0x00000080, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*SERInterruptsMask*/                                                                               \
    {0x000000A8, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*SERInterruptsSummary*/                                                                            \
    {0x000000A4, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*dfxInterruptsSummaryMask*/                                                                        \
    {0x000000B0, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*dfxInterruptsSummaryCause*/                                                                       \
    {0x000000AC, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0}

#define ACTIVE_MEM_MG_INTERRUPT_TREE_1_MAC                                                      \
    /* Global interrupt cause register */                                                       \
    {0x00000610, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveWriteIntrCauseReg, 0},              \
    {0x00000614, SMEM_FULL_MASK_CNS, NULL, 0, smemChtActiveGenericWriteInterruptsMaskReg, 0},   \
    /* read interrupts cause registers Misc -- ROC register */                                  \
    {0x00000618, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 11, smemChtActiveWriteIntrCauseReg, 0},                  \
    /* Write Interrupt Mask MIsc Register */                                                    \
    {0x0000061C, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveWriteMiscInterruptsMaskReg, 0},     \
    /* Receive SDMA Interrupt Cause Register (RxSDMAInt) */                                     \
    {0x00002890, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 22, smemChtActiveWriteIntrCauseReg, 0},                  \
    /* Receive SDMA Interrupt Mask Register */                                                  \
    {0x000028A0, SMEM_FULL_MASK_CNS,NULL, 0, smemChtActiveWriteRcvSdmaInterruptsMaskReg, 0},                                \
    /* Transmit SDMA Interrupt Cause Register */                                                \
    {0x00002898, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 21 , smemChtActiveWriteIntrCauseReg,0},                  \
    /* Transmit SDMA Interrupt Mask Register */                                                 \
    {0x000028A8, SMEM_FULL_MASK_CNS,NULL, 0, smemChtActiveWriteTransSdmaInterruptsMaskReg, 0},                              \
    /* Write Interrupt Mask FuncUnitsIntsSum Register */                                        \
    ...
    /* MG1 internal Interrupt Cause  */                                                                   \
    {0x00000144, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 18, smemChtActiveWriteIntrCauseReg, 0},\
    /* MG1 internal Interrupt Mask Register */                                                            \
    {0x00000148, SMEM_FULL_MASK_CNS,NULL, 0, smemChtActiveGenericWriteInterruptsMaskReg, 0},              \
    /*ports2InterruptsSummaryMask*/                                                                       \
    {0x0000016c, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},            \
    /*ports2InterruptsSummaryCause*/                                                                      \
    {0x00000168, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*ports1InterruptsSummaryMask*/                                                                       \
    {0x00000164, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},            \
    /*ports1InterruptsSummaryCause*/                                                                      \
    {0x00000160, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*dfx1InterruptsSummaryMask*/                                                                       \
    {0x0000063c, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*dfx1InterruptsSummaryCause*/                                                                      \
    {0x00000638, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*stackPortsInterruptMask*/                                                                         \
    {0x00000624, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*stackPortsInterruptCause*/                                                                        \
    {0x00000620, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*SERInterruptsMask*/                                                                               \
    {0x0000062c, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*SERInterruptsSummary*/                                                                            \
    {0x00000628, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*dfxInterruptsSummaryMask*/                                                                        \
    {0x00000634, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*dfxInterruptsSummaryCause*/                                                                       \
    {0x00000630, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0}

#define ACTIVE_MEM_MG_INTERRUPT_TREE_2_MAC                                                      \
    /* Global interrupt cause register */                                                       \
    {0x00000670, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveWriteIntrCauseReg, 0},              \
    {0x00000674, SMEM_FULL_MASK_CNS, NULL, 0, smemChtActiveGenericWriteInterruptsMaskReg, 0},   \
    /* read interrupts cause registers Misc -- ROC register */                                  \
    {0x00000678, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 11, smemChtActiveWriteIntrCauseReg, 0},                  \
    /* Write Interrupt Mask MIsc Register */                                                    \
    {0x0000067C, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveWriteMiscInterruptsMaskReg, 0},     \
    /* Receive SDMA Interrupt Cause Register (RxSDMAInt) */                                     \
    {0x00002894, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 22, smemChtActiveWriteIntrCauseReg, 0},                  \
    /* Receive SDMA Interrupt Mask Register */                                                  \
    {0x000028A4, SMEM_FULL_MASK_CNS,NULL, 0, smemChtActiveWriteRcvSdmaInterruptsMaskReg, 0},                                \
    /* Transmit SDMA Interrupt Cause Register */                                                \
    {0x0000289C, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 21 , smemChtActiveWriteIntrCauseReg,0},                  \
    /* Transmit SDMA Interrupt Mask Register */                                                 \
    {0x000028AC, SMEM_FULL_MASK_CNS,NULL, 0, smemChtActiveWriteTransSdmaInterruptsMaskReg, 0},                              \
    /* Write Interrupt Mask FuncUnitsIntsSum Register */                                        \
    {0x000006B0, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},  \
    /* Read/Write Interrupt cause FuncUnitsIntsSum Register */                                  \
    {0x000006AC, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0 , smemChtActiveWriteIntrCauseReg, 0},\
    /* Write Interrupt Mask FuncUnits1IntsSum Register */                                       \
    {0x000006A4, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},  \
    /* Read/Write Interrupt cause FuncUnits1IntsSum Register */                                 \
    {0x000006A8, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0 , smemChtActiveWriteIntrCauseReg, 0},\
    /* MG1 internal Interrupt Cause  */                                                                   \
    {0x0000010C, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 18, smemChtActiveWriteIntrCauseReg, 0},\
    /* MG1 internal Interrupt Mask Register */                                                            \
    {0x00000114, SMEM_FULL_MASK_CNS,NULL, 0, smemChtActiveGenericWriteInterruptsMaskReg, 0},              \
    /*ports2InterruptsSummaryMask*/                                                                       \
    {0x0000017c, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},            \
    /*ports2InterruptsSummaryCause*/                                                                      \
    {0x00000178, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*ports1InterruptsSummaryMask*/                                                                       \
    {0x00000174, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},            \
    /*ports1InterruptsSummaryCause*/                                                                      \
    {0x00000170, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*dfx1InterruptsSummaryMask*/                                                                       \
    {0x0000069c, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*dfx1InterruptsSummaryCause*/                                                                      \
    {0x00000698, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*stackPortsInterruptMask*/                                                                         \
    {0x00000684, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*stackPortsInterruptCause*/                                                                        \
    {0x00000680, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*SERInterruptsMask*/                                                                               \
    {0x0000068c, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*SERInterruptsSummary*/                                                                            \
    {0x00000688, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},\
    /*dfxInterruptsSummaryMask*/                                                                        \
    {0x00000694, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveGenericWriteInterruptsMaskReg, 0},          \
    /*dfxInterruptsSummaryCause*/                                                                       \
    {0x00000690, SMEM_FULL_MASK_CNS,smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0}

#define ACTIVE_MEM_MG_COMMON_MAC                                                                \
    /*MG*/                                                                                      \
    /* the interrupt trees 0,1,2 */                                                             \
    ACTIVE_MEM_MG_INTERRUPT_TREE_0_MAC,                                                         \
    ACTIVE_MEM_MG_INTERRUPT_TREE_1_MAC,                                                         \
    ACTIVE_MEM_MG_INTERRUPT_TREE_2_MAC,                                                         \
                                                                                                \
    ...
    /* Address Update Queue Control */                                                          \
    {0x000000C4, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveAuqControlWrite, 0},                \
                                                                                                \
    /* FDB Upload Queue Base Address */                                                         \
    {0x000000C8, SMEM_FULL_MASK_CNS, NULL, 0 , smemCht2ActiveFuqBaseWrite, 0},                  \
    /* FDB Upload Update Queue Control */                                                       \
    {0x000000CC, SMEM_FULL_MASK_CNS, NULL, 0 , smemChtActiveAuqControlWrite, 0},                \
                                                                                                \
    ...
    {0x00030014, SMEM_FULL_MASK_CNS,                                                            \
        NULL, 0, smemChtActiveGenericWriteInterruptsMaskReg, 0},                                \
...
#define MG_NODE_ADD(index,currDbPtr,genNode,mgIndex,treeId) \
    INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, currDbPtr, &genNode##_##treeId[mgIndex])

#define MG_NODE_ADD_ALL_3_TREES(index,currDbPtr,genNode,mgIndex)    \
    MG_NODE_ADD(index,currDbPtr,genNode,mgIndex,0);                 \
    MG_NODE_ADD(index,currDbPtr,genNode,mgIndex,1);                 \
    MG_NODE_ADD(index,currDbPtr,genNode,mgIndex,2)


#define BIND_MG_NODE_TO_FATHER(mgNode,mgIndex,father_mgNode,father_mgIndex,treeId) \
        mgNode##_##treeId[mgIndex].myFatherInfo.interruptPtr = &father_mgNode##_##treeId[father_mgIndex]

#define BIND_MG_NODE_TO_FATHER_ALL_3_TREES(mgNode,mgIndex,father_mgNode,father_mgIndex) \
        BIND_MG_NODE_TO_FATHER(mgNode,mgIndex,father_mgNode,father_mgIndex,0);          \
        BIND_MG_NODE_TO_FATHER(mgNode,mgIndex,father_mgNode,father_mgIndex,1);          \
        BIND_MG_NODE_TO_FATHER(mgNode,mgIndex,father_mgNode,father_mgIndex,2)

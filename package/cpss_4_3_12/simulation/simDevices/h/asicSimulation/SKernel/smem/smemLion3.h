...
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemLion3ActiveWriteTodStepConfReg);
...
ACTIVE_READ_FUNC_PROTOTYPE_MAC(smemLion3ActiveWriteProtectReadOnly);
...
extern SNET_ENTRY_FORMAT_TABLE_STC lion3TtiDefaultEPortTableFieldsFormat
                [SMEM_LION3_TTI_DEFAULT_E_PORT_TABLE_FIELDS___LAST_VALUE___E];
extern SNET_ENTRY_FORMAT_TABLE_STC sip7TtiDefaultEPortTableFieldsFormat
                [SMEM_LION3_TTI_DEFAULT_E_PORT_TABLE_FIELDS___LAST_VALUE___E];
...
,    SMEM_SIP6_30_TTI_ACTION_TABLE_FIELDS_Group_IDs_Assignment_Enable /*tti_reserved_assign_en*/
,    SMEM_SIP6_30_TTI_ACTION_TABLE_FIELDS_Group_IDs                   /*tti_to_txq_reserved*/
...
extern SNET_ENTRY_FORMAT_TABLE_STC sip7TtiEPortAttributesTableFieldsFormat[
    SMEM_LION3_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS___LAST_VALUE___E];
...
typedef enum {
    ...
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_TRG_VPORT_E
        = SMEM_SIP6_10_IPCL_ACTION_TABLE_FIELDS___LAST_VALUE___E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_31_0_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_47_32_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_MIDWAY_LOOKUP_MODE_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_USE_TARGET_VPORT_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_FORCE_DP_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_DISABLE_EM_LOOKUP_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_CANCEL_DROP_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_ASSIGN_CMD_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_VALUE_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_SR_V6_PSP_ENABLE_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_DECREMENT_TTL_ENABLE_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_SR_V6_SET_PASSENGER_END_NODE_TYPE_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_ASSIGN_EN_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_CONTROL_ENABLE_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_LOOPBACK_SELECTOR_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_DISABLE_E
    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_PROFILE_ASSIGN_EN

    ,SMEM_SIP7_IPCL_ACTION_TABLE_FIELDS___LAST_VALUE___E/* used for array size */

}SMEM_SIP6_IPCL_ACTION_TABLE_FIELDS;

/* the fields of the (MPCL) action table in Sip7 */
typedef enum {
    SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_CPU_CODE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_COMMAND_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_REDIRECT_COMMAND_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_ACTION_STOP_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_EPCL_LOOKUP_MODE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_EPCL_CONFIGURATION_INDEX_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_USE_VIDX_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_VIDX_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_IS_TRUNK_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TRG_PORT_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TARGET_DEVICE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TRUNK_ID_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TUNNEL_START_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_ARP_POINTER_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TUNNEL_POINTER_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TUNNEL_START_PASSENGER_TYPE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_ACTIVATE_METER_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_BIND_TO_POLICER_COUNTER_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_POLICER_PTR_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_ENABLE_MIRROR_TCP_RST_OR_FIN_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_MIRROR_TO_ANALYZER_PORT_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_MODIFY_MAC_DA_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_MODIFY_MAC_SA_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_EN_NESTED_VLAN_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_SET_SST_ID_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_SST_ID_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_ACTIVATE_COUNTER_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_COUNTER_INDEX_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_VLAN_COMMAND_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_VID0_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_QOS_PROFILE_MARKING_ENABLE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_QOS_PROFILE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_MODIFY_DSCP_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_MODIFY_UP_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_VLAN1_CMD_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_UP1_CMD_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_VID1_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_UP1_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_IPCL_RESERVED_EN_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_IPCL_TO_TXQ_RESERVED_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TIMESTAMP_EN_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_OFFSET_INDEX_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_OAM_PROCESSING_EN_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_OAM_PROFILE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_FLOW_ID_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_ASSIGN_SRC_EPORT_EN_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_SRC_EPORT_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_LATENCY_PROFILE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_LATENCY_MONITORING_ENABLE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TRIGGER_INTERRUPT_EN_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TAG0_DEI_CFI_VALUE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TAG1_DEI_CFI_VALUE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_ASSIGN_TAG1_FROM_UDBS_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_IPFIX_ENABLE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_FLOW_TRACK_ENABLE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_BYPASS_INGRESS_AND_EGRESS_FILTERING_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_GENERIC_ACTION_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_TRG_VPORT_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_USE_TARGET_VPORT_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_CANCEL_DROP_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_ASSIGN_CMD_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_VALUE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_ASSIGN_EPCL_UDB_PKT_TYPE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_EPCL_UDB_PKT_TYPE_VALUE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_CANCEL_DECREMENT_TTL_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_CANCEL_ROUTE_HA_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_CANCEL_ROUTED_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_ASSIGN_EN_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_CONTROL_ENABLE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_LOOPBACK_SELECTOR_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_DISABLE_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_FORCE_DP_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_DISABLE_EM_LOOKUP_E
   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS_VLAN_PRECEDENCE_E

   ,SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS___LAST_VALUE___E/* used for array size */

}SMEM_SIP7_MPCL_ACTION_TABLE_FIELDS;
...
typedef enum
{
     SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_EVLAN_E                      /*bit 14:0*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED0_E                  /*bit 15*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_SRC_EPG_E                    /*bit 27:16*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_SRC_IS_VPORT_E               /*bit 28*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_SRC_VPORT_BITS_BASE16_LEN2_E /*bit 29:30*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED1_E                  /*bit 31*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_DST_EPG_E                    /*bit 43:32*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED2_E                  /*bit 47:44*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_QOS_PROFILE_E                /*bit 57:48*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED3_E                  /*bit 63:58*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_SRC_VPORT_BITS_BASE0_LEN16_E /*bit 79:64*/ /*mux*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_SRC_EPORT_E                  /*bit 78:64*/ /*mux*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TAG1_VID_E                   /*bit 91:80*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TAG1_UP_E                    /*bit 94:92*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TAG1_CFI_E                   /*bit 95*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_VRF_ID_E                     /*bit 110:96*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED4_E                  /*bit 111:111*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_SRC_ID_E                     /*bit 123:112*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED5_E                  /*bit 127:124*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_HASH_BYTES_E                 /*bit 159:128*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_GEN_CLASS_E                  /*bit 191:160*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_PKT_CMD_E                    /*bit 194:192*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_CPU_CODE_E                   /*bit 202:195*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED6_E                  /*bit 207:203*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TRG_DEV_E                    /*bit 217:208*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TRG_IS_VIDX_E                /*bit 218:218*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TRG_IS_TRUNK_E               /*bit 219:219*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TRG_IS_VPORT_E               /*bit 220:220*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TRG_VPORT_BITS_BASE16_LEN2_E /*bit 222:221*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED7_E                  /*bit 223*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TRG_EVIDX_E                  /*bit 239:224*/ /*mux*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TRG_VPORT_BITS_BASE0_LEN16_E /*bit 239:224*/ /*mux*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TRG_EPORT_E                  /*bit 238:224*/ /*mux*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TRG_TRUNK_ID_E               /*bit 235:224*/ /*mux*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TUNNEL_START_E               /*bit 240*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_TS_PTR_E                     /*bit 258:241*/ /*mux*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_ARP_PTR_E                    /*bit 259:241*/ /*mux*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED8_E                  /*bit 263:260*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_EM_PROFILE1_E                /*bit 267:264*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_EM_PROFILE2_E                /*bit 271:268*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_POLICER_INDEX_E              /*bit 288:272*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_BILLING_ENABLED_E            /*bit 289*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_METERING_ENABLED_E           /*bit 290*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED9_E                  /*bit 295:291*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_COPY_RESERVED_E              /*bit 315:296*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED10_E                 /*bit 319:316*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_FLOW_ID_E                    /*bit 337:320*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED11_E                 /*bit 343:338*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_PCL_ID2_E                    /*bit 367:344*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_RESERVED12_E                 /*bit 383:368*/
    ,SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS___LAST_VALUE___E
} SMEM_SIP7_IPCL_METADATA_MODIFIED_FIELDS_ENT;
...
/* the fields of the (EQ) VPORT MAPPING table in Sip7 */
typedef enum {
    ...
    ,SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELDS___LAST_VALUE___E/* used for array size */
}SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELDS_ENT;

/* macro to shorten the calling code of (EQ) 'VPORT_MAPPING' fields - for GET field */
#define SMEM_SIP7_EQ_VPORT_MAPPING_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)       \
    SNET_TABLE_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName,SKERNEL_TABLE_FORMAT_VPORT_MAPPING_E)


/* the fields of the (EQ) E2PHY table in Sip7 */
typedef enum {
    ...
    ,SMEM_SIP7_EQ_H_ECMP_TABLE_FIELDS___LAST_VALUE___E/* used for array size */
}SMEM_SIP7_EQ_H_ECMP_TABLE_FIELDS_ENT;

/* macro to shorten the calling code of (EQ) 'H_ECMP' fields - for GET field */
#define SMEM_SIP7_EQ_H_ECMP_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName)       \
    SNET_TABLE_ENTRY_FIELD_GET(_devObjPtr,_memPtr,_index,fieldName,SKERNEL_TABLE_FORMAT_H_ECMP_E)
...
typedef enum{
   ...
   ,SMEM_SIP6_30_HA_EPORT_TABLE_1_FIELDS_NAT_PTR_E              /*46..61*/
...
typedef enum{
    ...
    ,SMEM_SIP7_HA_TUNNEL_START_TABLE_FIELDS_FLOW_ID_GCF_ASSIGNMENT_PROFILE_E
    ,SMEM_SIP7_HA_TUNNEL_START_TABLE_FIELDS_FLOW_ID_GCF_BITS_E

    /* sip7 ipv6 vport TSE */
    ,SMEM_SIP7_HA_TUNNEL_START_TABLE_FIELDS_FLOW_LABEL_MODE_E
    ,SMEM_SIP7_HA_TUNNEL_START_TABLE_FIELDS_FLOW_LABEL_ENTROPY_MODE_E
    ,SMEM_SIP7_HA_TUNNEL_START_TABLE_FIELDS_FLOW_LABEL_VALUE_E
...
typedef enum {
    ...
    ,SMEM_SIP7_EPCL_ACTION_TABLE_FIELDS_OAM_PTP_OFFSET = SMEM_SIP6_10_EPCL_ACTION_TABLE_FIELDS___LAST_VALUE___E
    ,SMEM_SIP7_EPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_ASSIGN_CMD
    ,SMEM_SIP7_EPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_VALUE
    ,SMEM_SIP7_EPCL_ACTION_TABLE_FIELDS_TCAM_PRIORITY
    ,SMEM_SIP7_EPCL_ACTION_TABLE_FIELDS_CANCEL_DROP
    ,SMEM_SIP7_EPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_CONTROL_ENABLE_E
    ,SMEM_SIP7_EPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_LOOPBACK_SELECTOR_E
    ,SMEM_SIP7_EPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_DISABLE_E

    ,SMEM_SIP7_EPCL_ACTION_TABLE_FIELDS___LAST_VALUE___E/* used for array size */
...
typedef enum {
    ...
    SIM_TBD_BOOKMARK /* all next sip7 fields locations ARE in FAKE places as no real Cider alignment was done
                    as it will impact the tests that uses EPCL metadata for legacy tests */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_TRG_VPORT_E           /* 18 bits */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_TRG_IS_VPORT_E        /*  1 bit  */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_SRC_VPORT_E           /* 18 bits */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_SRC_IS_VPORT_E        /*  1 bit  */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_TRG_CIRCUIT_E         /* 17 bits */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_HFT0_TRIGGERED_E      /*  1 bit  */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_HFT0_PTR_E            /* 20 bits */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_HFT1_TRIGGERED_E      /*  1 bit  */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_HFT1_PTR_E            /* 20 bits */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_FLOW_ID_16_18_E       /*  3 bits */
    ,SMEM_SIP7_EPCL_META_DATA_FIELDS_TAG0_VID_E            /* 12 bits */
...
typedef enum{
    ...
    /* fields for L3NHE Next Hop Entry*/
...
typedef enum{
    ...
    SIM_TBD_BOOKMARK /* fake location as not in Cider yet */
    ,SMEM_SIP7_OAM_TABLE_FIELDS_SRC_IS_VPORT
    ,SMEM_SIP7_OAM_TABLE_FIELDS_SRC_VPORT

    ,SMEM_SIP5_OAM_TABLE_FIELDS___LAST_VALUE___E /* used for array size */
}SMEM_SIP5_OAM_TABLE_FIELDS_ENT;

/* macro to set value to field of OAM entry format in buffer */
#define SMEM_SIP5_OAM_ENTRY_FIELD_SET_MAC(_dev,_memPtr,_index,fieldName,_value)          \
    SNET_TABLE_ENTRY_FIELD_SET(_dev,_memPtr,_index,fieldName,_value,SKERNEL_TABLE_FORMAT_OAM_E)

/* macro to get field value of OAM entry format in buffer */
#define SMEM_SIP5_OAM_ENTRY_FIELD_GET_MAC(_dev,_memPtr,_index,fieldName)                 \
    SNET_TABLE_ENTRY_FIELD_GET(_dev,_memPtr,_index,fieldName,SKERNEL_TABLE_FORMAT_OAM_E)

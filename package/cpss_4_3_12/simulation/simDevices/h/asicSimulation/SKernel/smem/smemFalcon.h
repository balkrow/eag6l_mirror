...
/**
* @internal smemFalconCauseInterrupt function
* @endinternal
*
* @brief   Implement interrupt cause registers triggering
*
* @param[in] devObjPtr                - device object PTR.
* @param[in] baseAddress              - Address for ASIC memory - base of MG.
* @param[in] causeOffset              - offset for interrupt cause register.
* @param[in] causeBits                - Registers' specific parameter - global interrupt bit number.
*
*/
void smemFalconCauseInterrupt
(
    IN         SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN         GT_U32   baseAddress,
    IN         GT_U32   causeOffset,
    IN         GT_U32   causeBits
);
...
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemFalconActiveWriteShmSizeForWm);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemFalconActiveWriteHWSemaphore);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemFalconActiveWriteDoorbellHostToCm);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemFalconActiveWriteDoorbellCmToHost);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemFalconActiveWriteDoorbellCPToCP);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemFalconActiveWriteTimer1StartReg);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemFalconActiveWriteTimer1ControlReg);
ACTIVE_WRITE_FUNC_PROTOTYPE_MAC(smemFalconActiveWriteCnmRfuSystemSoftResetReg);

...
#define SIM_MAX_MIF_UNITS 17 /* in Hawk 7 MIF units . in Phoenix 5 . AAS have 17 (3 per DP, 1 - CPU, 4 FlexE) */

#define SIM_MAX_ANP_UNITS 25 /* in Hawk 17 ANP units . in Phoenix 9 . in Ironman 19,in AAS 25*/
#define SIM_SIP_6_10_MAX_SERDES_UNITS 13   /* in Hawk 9 (8+1) . in Phoenix : 6 (4+2) . In Harrier : 5 . in IM : 13 (7+6) */
#define SIM_SIP_7_MAX_SERDES_UNITS   21  /* in AAS : (per tile) 20 + 1 for CPU */
#define SIM_SIP_7_MAX_GOP_UNITS      ((3*4)+1) /* in AAS : (per tile) 4 GOPs each with 2 'mini-gop' for 400G and 1 'mini-gop' for 200G + 1 for CPU*/
...
/* number of CNC units triggers :
    in non-sip7 this is SIM_MAX_NUM_OF_MG
    as the each/mux cnc unit connected to MG for the upload

    In sip7 this is 4 * 2 = 8 (4 cnc units * 2 tiles)
    as each cnc unit connected to GDMA for the upload
*/
#define SIM_MAX_NUM_OF_CNC_TRIGGERS (8*2)

/* number of IA (ingress Aggregator) that the device support */
#define SIM_MAX_IA_CNS      SIM_MAX_PIPES_CNS

/* number of GDMA units per CnM (not per device) */
#define SIM_MAX_GDMA_UNITS_CNS   4

enum{
     CNM_Address_Decoder_iNIC
    ,CNM_Address_Decoder_PCIe
    ,CNM_Address_Decoder_iunit
    ,CNM_Address_Decoder_GDMA0
    ,CNM_Address_Decoder_GDMA1
    ,CNM_Address_Decoder_GDMA2
    ,CNM_Address_Decoder_GDMA3
    ,CNM_Address_Decoder_EHSM_DMA
    ,CNM_Address_Decoder_AAC_0
    ,CNM_Address_Decoder_AAC_1
    ,CNM_Address_Decoder_AMB
};
/* number of ADDR_DECODER units per CnM (not per device) */
#define SIM_MAX_ADDR_DECODER_UNITS_CNS  11
...
/* Flexe */
#define SIM_MAX_FLEXE_UNITS_CNS 9

enum {
    FLEXE_UNIT_XC_0_E,
    FLEXE_UNIT_XC_TAI_0_E,
    FLEXE_UNIT_XC_1_E,
    FLEXE_UNIT_XC_TAI_1_E,
    FLEXE_UNIT_CODERS_E,
    FLEXE_UNIT_SHIM_0_E,
    FLEXE_UNIT_SHIM_TAI_0_E,
    FLEXE_UNIT_SHIM_1_E,
    FLEXE_UNIT_SHIM_TAI_1_E
};
...
typedef enum
{
    ...
    SKERNEL_AAS,          /* (sip 7) AAS (Armstrong3P / Aldrin4 / Seahawk) */
    SKERNEL_AAS_2_TILES,  /* (sip 7) only Seahawk (out of the AAS devices) */
...
#define SKERNEL_IS_LION2_PORT_GROUP_DEV_MAC(_dev) \
    SKERNEL_IS_LION2_PORT_GROUP_ONLY_DEV_MAC(_dev)
...
typedef enum
{
    ...
    SKERNEL_EMPTY_1_FAMILY,
    SKERNEL_NIC_FAMILY,
    SKERNEL_COM_MODULE_FAMILY,
    SKERNEL_EMPTY_4_FAMILY,
    SKERNEL_EMPTY_5_FAMILY,
    SKERNEL_EMPTY_6_FAMILY,
    SKERNEL_SOHO_FAMILY,
    SKERNEL_EMPTY_8_FAMILY,
    SKERNEL_EMPTY_9_FAMILY,
    SKERNEL_EMPTY_10_FAMILY,
    ...
    SKERNEL_XCAT_FAMILY,
    SKERNEL_EMPTY_14_FAMILY,
    SKERNEL_EMPTY_15_FAMILY,
    SKERNEL_EMPTY_16_FAMILY,
    SKERNEL_EMPTY_17_FAMILY,
    SKERNEL_EMPTY_18_FAMILY,
    SKERNEL_EMPTY_19_FAMILY,
    SKERNEL_EMPTY_20_FAMILY,
    SKERNEL_EMPTY_21_FAMILY,
    ...
    SKERNEL_AAS_FAMILY,        /* (sip 7) AAS (Armstrong3P / Aldrin4 / Seahawk / Seahawk-2-tiles) */
...
typedef struct{
    void* /*SMEM_ACTIVE_MEM_WRITE_FUN*/ postStartSnapshotWriteFunc;/* a write action to do after triggering the snapshot (like 'clear the entry') */
}SMEM_CHT_READ_ENTRY_SNAP_SHOT_INFO_STC;
...
typedef struct{
    ...
    SKERNEL_TABLE_INFO_STC      fdbTable;/*FDB table */
    ...
    SKERNEL_TABLE_INFO_STC      arpTable;/*arp table*/
    ...
    SKERNEL_TABLE_INFO_STC      tunnelStartTable;/*tunnel start table */
    ...
    SKERNEL_TABLE_INFO_STC      mllTable;/*mll table*/
    ...
    SKERNEL_TABLE_INFO_STC      ipvxL3NheProfile;     /* (sip7) IPvX -  Router L3NHE Profile Table */
    ...
    SKERNEL_TABLE_INFO_STC      eqTrunkEcmp;/* EQ - trunk Table . new in sip7 */
    ...
    SKERNEL_TABLE_INFO_STC      haIngressEPortAttr1;/* HA - Sip7 Ingress ePort Table Attribute 1 */
    SKERNEL_TABLE_INFO_STC      haIngressEPortAttr2;/* HA - Sip7 Ingress ePort Table Attribute 2 */
    SKERNEL_TABLE_INFO_STC      haTargetCircuits;/* HA - Sip7 Target Circuits Table */
    SKERNEL_TABLE_INFO_STC      haQueueMapping;/* HA - Sip7 Queue Mapping Table */
    ...
    SKERNEL_TABLE_INFO_STC      haIngressPhyPort2;/* HA - Sip7 Ingress Physical port Attributes table 2*/
    ...
    SKERNEL_TABLE_INFO_STC      haAnalyzersTargetCircuits;/* HA - sip7 Analyzers Target Circuits Table */
    SKERNEL_TABLE_INFO_STC      haQosMapping;/* HA - sip7 QoS Mapping Table */
    SKERNEL_TABLE_INFO_STC      haHeaderFieldsTable0;/* HA - sip7 Header Fields Table 0 */
    SKERNEL_TABLE_INFO_STC      haHeaderFieldsTable1;/* HA - sip7 Header Fields Table 1 */
    ...
    SKERNEL_TABLE_INFO_STC      egfQueueMapTable;/* EGF - QAG -    Queue Map Table*/
    ...
    SKERNEL_TABLE_INFO_STC      lpmCommonVrfId;/* new in sip7 instead lpmIpv4VrfId/lpmIpv6VrfId/lpmFcoeVrfId */
    ...
    SKERNEL_TABLE_INFO_STC      smuSgcIntervalMax;
    SKERNEL_TABLE_INFO_STC      smuSgcOctetCounters;
    SKERNEL_TABLE_INFO_STC      smuSgcTableSetTimeConfigurations;
    SKERNEL_TABLE_INFO_STC      smuSgcTimeSlotAttributes;
    SKERNEL_TABLE_INFO_STC      smuSgcTimeToAdvance;
    ...
    /* TM QMAP */
    SKERNEL_TABLE_INFO_STC      tmQueueMapQueueSelector;
    SKERNEL_TABLE_INFO_STC      tmQueueMapTargetDeviceToIndex;
    SKERNEL_TABLE_INFO_STC      tmQueueMapCpuCodeToTc;
    ...
    SKERNEL_TABLE_INFO_STC      mpclConfigTable;
    SKERNEL_TABLE_INFO_STC      mpclSourcePortCfgTable;
    SKERNEL_TABLE_INFO_STC      mpclExactMatchProfileIdMapping;
    ...
    SKERNEL_TABLE_INFO_STC      eqQueueGroupProfile; /* EQ : queue group profile table */
    SKERNEL_TABLE_INFO_STC      eqVPortMapping;      /* EQ : vPort mapping table */
    SKERNEL_TABLE_INFO_STC      eqHEcmpStatusVector ;/* EQ : H-ECMP status vector table */
    SKERNEL_TABLE_INFO_STC      eqHEcmpLttTable;     /* EQ : H-ECMP LTT table */
    SKERNEL_TABLE_INFO_STC      eqHEcmpEcmpTable;    /* EQ : H-ECMP ECMP table */

    SKERNEL_TABLE_INFO_STC      gdmaDispatcherCpuCodeToGdmaQ;/* GDMA Dispatcher : Cpu Code To GdmaQ table */
    SKERNEL_TABLE_INFO_STC      reducedEmTable;

    SKERNEL_TABLE_INFO_STC      egfEftEVlanAttributesTable;/* map evlan [64K] to tag0 vid [4k] */
    SKERNEL_TABLE_INFO_STC      egfEftTrgDevToHashBlockSizeMappingTable;/*map trg dev to 'number of cascade trunk port members through which the target device can be reached' */


    /* sip7 : PPU for IPE tables */
    SKERNEL_TABLE_INFO_STC      ppuForIpeActionTable0;
    SKERNEL_TABLE_INFO_STC      ppuForIpeActionTable1;
    SKERNEL_TABLE_INFO_STC      ppuForIpeActionTable2;
    SKERNEL_TABLE_INFO_STC      ppuForIpeActionTable3;
    /* sip7 : ipe tables */
    SKERNEL_TABLE_INFO_STC      ipeStateAddrProfile;    /* (sip7) IPE -  Ipe State Address Profile Table */
    SKERNEL_TABLE_INFO_STC      ipeIctTable        ;    /* (sip7) IPE -  ict Table */
    SKERNEL_TABLE_INFO_STC      ipeStateDataCmdProfile; /* (sip7) IPE -  Ipe State Data Command Profile Table */
    SKERNEL_TABLE_INFO_STC      ipeDpoTable;            /* (sip7) IPE -  Ipe DPO table Table */
    SKERNEL_TABLE_INFO_STC      ipeDpiTable;            /* (sip7) IPE -  Ipe DPI table Table */
    SKERNEL_TABLE_INFO_STC      ipeStateT0Table;        /* (sip7) IPE -  Ipe State T0 Table */
    SKERNEL_TABLE_INFO_STC      ipeStateT1Table;        /* (sip7) IPE -  Ipe State T1 Table */

    /* sip7 : HBU tables */
    SKERNEL_TABLE_INFO_STC      hbuPortMappingTable;    /* (sip7) HBU -  map IN local_dev_src_port to OUT local_dev_src_port */
    ...
    SKERNEL_TABLE_2_PARAMETERS_INFO_STC lpmMemorySingleBank;/* single bank with 256K lines */
    ...
    SKERNEL_TABLE_2_PARAMETERS_INFO_STC tcamProfileSubkeySizeAndMux; /* SIP6_10 tcam per profile subkey sizes and pointers to mux table */
    SKERNEL_TABLE_2_PARAMETERS_INFO_STC tcamSubkeyMux2byteUnits; /* SIP6_10 tcam mux 2-byte units table */
    SKERNEL_TABLE_2_PARAMETERS_INFO_STC tcamGroup5ProfileSubkeySizeAndMux; /* SIP7 tcam per profile subkey sizes and pointers to mux table */
    SKERNEL_TABLE_2_PARAMETERS_INFO_STC tcamGroups0_5SubkeySharedMux; /* SIP7 tcam per profile subkeys shared pointer to mux table */

    SKERNEL_TABLE_3_PARAMETERS_INFO_STC txqSdqSip7QueueToPortMap;
    /* SIP7 TCAM sub-key build */
    ...
    SKERNEL_TABLE_3_PARAMETERS_INFO_STC tcamGroups0_4ProfileSubkeySizeAndMux; /* SIP7 tcam per profile subkey sizes and pointers to mux table */
    SKERNEL_TABLE_3_PARAMETERS_INFO_STC tcamGroups0_5SubkeyMux2byteUnits; /* SIP7 tcam mux 2-byte units table */
    ...
    /* tables with snapshot that need 'postStartSnapshotWriteFunc'
       (see SMEM_CHT_READ_ENTRY_SNAP_SHOT_INFO_STC) */
    struct {
        SMEM_CHT_READ_ENTRY_SNAP_SHOT_INFO_STC  smuIrfCounters;
    }snapShot;
...
typedef enum{
    ...
    /** IPCL Meta Data Modified Felds format */
    SKERNEL_TABLE_FORMAT_IPCL_METADATA_MODIFIED_E,
    ...
    /* SMU Stream Gate Control (SGC) (new in sip6.30)*/
    SKERNEL_TABLE_FORMAT_SMU_SGC_INTERVAL_MAX_E,
    SKERNEL_TABLE_FORMAT_SMU_SGC_OCTET_COUNTERS_E,
    SKERNEL_TABLE_FORMAT_SMU_SGC_TABLE_SET_TIME_CONFIGURATIONS_E,
    SKERNEL_TABLE_FORMAT_SMU_SGC_TIME_SLOT_ATTRIBUTES_E,
    SKERNEL_TABLE_FORMAT_SMU_SGC_TIME_TO_ADVANCE_E,
    ...
    /** MPCL action format - new in SIP7 */
    SKERNEL_TABLE_FORMAT_MPCL_ACTION_E,

    /** EQ - new in sip7 */
    SKERNEL_TABLE_FORMAT_VPORT_MAPPING_E,
    SKERNEL_TABLE_FORMAT_H_ECMP_E,

    /** GDMA - new in sip7 */
    SKERNEL_TABLE_FORMAT_GDMA_SW_GDMA_DESCRIPTOR_RX_E,
    SKERNEL_TABLE_FORMAT_GDMA_SW_GDMA_DESCRIPTOR_TX_E,


    /** IPv4 VPort TS table format - SIP7 */
    SKERNEL_TABLE_FORMAT_HA_IPV4_VPORT_TUNNEL_START_E,

    /** IPv6 VPort TS table format - SIP7 */
    SKERNEL_TABLE_FORMAT_HA_IPV6_VPORT_TUNNEL_START_E,

    /** MPLS VPort TS table format - SIP7 */
    SKERNEL_TABLE_FORMAT_HA_MPLS_VPORT_TUNNEL_START_E,

    /** HA - new in sip7 */
    SKERNEL_TABLE_FORMAT_HA_SRC_EPORT_1_E,
    SKERNEL_TABLE_FORMAT_HA_SRC_EPORT_2_E,
    SKERNEL_TABLE_FORMAT_HA_SRC_PHYSICAL_PORT_2_E,
    SKERNEL_TABLE_FORMAT_HA_TARGET_CIRCUITS_E,
    SKERNEL_TABLE_FORMAT_HA_ANALYZERS_TARGET_CIRCUITS_E,
    SKERNEL_TABLE_FORMAT_HA_QUEUE_MAPPING_E,
    SKERNEL_TABLE_FORMAT_HA_QOS_MAPPING_E,
    SKERNEL_TABLE_FORMAT_HA_HEADER_FIELDS_E,

    /** IPVX- new in sip7 */
    SKERNEL_TABLE_FORMAT_IPVX_ROUTER_L3NHE_PROFILE_E,

    /** IPE- new in sip7 */
    SKERNEL_TABLE_FORMAT_IPE_STATE_ADDRESS_PROFILE_E,

    /** IP MLL BIER table format - new in sip7  */
    SKERNEL_TABLE_FORMAT_IP_MLL_BIER_E,

    /** L2 MLL BIER table format - new in sip7  */
    SKERNEL_TABLE_FORMAT_L2_MLL_BIER_E,
...
/* CNC blocks number in CNC unit */
#define MAX_CNC_BLOCKS_IN_UNIT_CNS  (16)
...
typedef struct{
    ...
    GT_U32 lmu[4 * 8 * SIM_MAX_TILE_CNS]; /* MAX=(PCA/DP * LMUs * numOfTiles) */
    GT_U32 tsu[4 * SIM_MAX_TILE_CNS];    /* in Hawk the TSU is not in Raven. */
    GT_U32 macMib [SIM_SIP_7_MAX_GOP_UNITS * SIM_MAX_TILE_CNS];/* Hawk: 0..3-mti_400, 4-9-usx;   Phoenix: '0'-mti_100 '1..6'-usx*/
    GT_U32 macWrap[SIM_SIP_7_MAX_GOP_UNITS * SIM_MAX_TILE_CNS];/* Hawk: 0..3-mti_400, 4-9-usx;   Phoenix: '0'-mti_100 '1..6'-usx*/
    GT_U32 macPcs [SIM_SIP_7_MAX_GOP_UNITS * SIM_MAX_TILE_CNS];/* Hawk: 0..3-mti_400, 4-9-usx;   Phoenix: '0'-mti_100 '1..6'-usx*/

    GT_U32 cpuMacMib [7];/* in Hawk the cpuMacMib  is not in Raven. In Ironman there are 7 CPU ports - [48..54] */
    GT_U32 cpuMacWrap[7];/* in Hawk the cpuMacWrap is not in Raven. In Ironman there are 7 CPU ports - [48..54] */
    GT_U32 cpuMacPcs [7];/* in Hawk the cpuMacPcs  is not in Raven. In Ironman there are 7 CPU ports - [48..54] */

    GT_U32 mif[SIM_MAX_MIF_UNITS * SIM_MAX_TILE_CNS];    /* in Hawk 7 MIF units . in Phoenix 5 */
    GT_U32 anp[SIM_MAX_ANP_UNITS * SIM_MAX_TILE_CNS];    /* in Hawk 7 MIF units . in Phoenix 5 */
    GT_U32 sip_6_10_SERDES[SIM_SIP_7_MAX_SERDES_UNITS * SIM_MAX_TILE_CNS];

    GT_U32 sip_7_GDMA[SIM_MAX_GDMA_UNITS_CNS * SIM_MAX_TILE_CNS];
    GT_U32 sip_7_ADDR_DECODER[SIM_MAX_ADDR_DECODER_UNITS_CNS];
    GT_U32 sip7Flexe[SIM_MAX_FLEXE_UNITS_CNS * SIM_MAX_TILE_CNS];
...
/* when MG_UNIT_USED_CNS used :
    bits 0..7  are the 'MG unit ID'
    bits 8..15 are the 'tree Id'

    bit 31 is the MG_UNIT_USED_CNS
*/
#define MG_TREE_ID(treeId)  ((treeId) << 8)
...
#define AAS_TCAM_NUM_OF_GROUPS_CNS                    5
...
typedef enum{
    ...
    SMEM_UNIT_TYPE_EPI_MAC_TO_SERDES_E, /* SIP_6_10 SERDES support : convert global MAC number to global SERDES number */
    SMEM_UNIT_TYPE_EPI_SERDES_TO_MAC_E, /* SIP_6_10 SERDES support : convert global SERDES number to global MAC number */
    SMEM_UNIT_TYPE_MTI_PCS_50G_E,       /* AAS : PCS 50G for 4 'CPU' ports per GOP */
...
typedef struct{
    MAC_NUM_INFO_STC        genInfo;
    SIMPLE_PORT_INFO_STC    serdesInfo;
    GT_U32                  globalSerdesNum;
    SIMPLE_PORT_INFO_STC    mifInfo;
}MAC_NUM_INFO_EXT_STC;
...
/*******************************************************************************
*   SMEM_PORT_SIP6_10_SERDES_LINK_CHANGE_INTERRUPT_FUN
*
* DESCRIPTION:
* @brief   Notify device that SERDES link state changed
*
* INPUTS:
*       devObjPtr   - pointer to device object.
*       portNum     - the port num
*       linkState   - link up/down
* OUTPUTS:
*
* RETURNS:
*      None
...
*
*******************************************************************************/
typedef GT_VOID (*SMEM_PORT_SIP6_10_SERDES_LINK_CHANGE_INTERRUPT_FUN)
(
    IN SKERNEL_DEVICE_OBJECT_T_PTR devObjPtr,
    IN GT_U32                  portNum,
    IN GT_U32                  linkState
...
/**
* @internal SMEM_MAC_CONVERT_TO_MIF_CHANNEL_FUN function
* @endinternal
*
* @brief   Convert Global MAC to MIF Unit Channel.
*
* @param[in]   globalMac          - Global MAC index.
...
*/
typedef GT_STATUS (*SMEM_MAC_CONVERT_TO_MIF_CHANNEL_FUN)
(
    IN   GT_U32   globalMac,
...
/**
* @internal SMEM_MIF_CONVERT_TO_MAC_CHANNEL_FUN function
* @endinternal
*
...
*/
typedef GT_STATUS (*SMEM_MIF_CONVERT_TO_MAC_CHANNEL_FUN)
(
    IN  GT_U32   mifUnit,
...
/**
* @internal SMEM_DMA_CHANNEL_IS_PREMPTIVE_FUN function
* @endinternal
*
* @brief   Get Prremtive status of DMA Channel.
*
* @param[in]   devObjPtr          - pointer to device object.
* @param[in]   globalDma          - Global DMA index.
*
* @retval - GT_TRUE - preemtive, otherwise - GT_FALSE.
*/
typedef GT_BOOL (*SMEM_DMA_CHANNEL_IS_PREEMPTIVE_FUN)
(
    IN   SKERNEL_DEVICE_OBJECT_T_PTR devObjPtr,
    IN   GT_U32                      globalDma
);
...
/**
* @internal SMEM_MIF_CHANNEL_FIND_BY_DMA_FUN function
* @endinternal
*
...
* @param[out]  mifChannelPtr      - (Pointer to) MIF Channel index.
*/
typedef GT_STATUS (*SMEM_MIF_CHANNEL_FIND_BY_DMA_FUN)
(
    IN SKERNEL_DEVICE_OBJECT_T_PTR devObjPtr,
    IN   GT_U32   globalDma,
    IN   GT_U32   isTx,
...
#define SIM_MAX_TAI_INST    5 /* Ironman have 0..4 */
#define SIM_MAX_TAI_GROUPS  9
...
typedef struct SKERNEL_DEVICE_OBJECT_T
{
    ...
    SMEM_MAC_CONVERT_TO_MIF_CHANNEL_FUN     devMemMacToMifChannelConvertPtr;
    SMEM_MIF_CONVERT_TO_MAC_CHANNEL_FUN     devMemMifToMacChannelConvertPtr;
    SMEM_DMA_CHANNEL_IS_PREEMPTIVE_FUN      devMemDmaIsPreemptivePtr;
    SMEM_MIF_CHANNEL_FIND_BY_DMA_FUN        devMemMifChannelFindByDmaPtr;
    SMEM_PORT_SIP6_10_SERDES_LINK_CHANGE_INTERRUPT_FUN  devMemSerdesLinkChangedPtr;
    ...
    GT_U32                      fdbNoDirectMemory;/* sip6 (bit not sip7) not support direct address for FDB --> no Cider address for FDB table */
    GT_U32                      orig_fdbNumEntries;
    GT_U32                      fdbRegistersRelativeBase;/* in sip7 the registers in fdb unit starts at 0x02000000*/
    ...
    GT_U32                      emNumEntries[MAX_EM_UNIT_NUM_CNS];
    GT_U32                      emMaxNumEntries;
    GT_U32                      emNumOfBanks[MAX_EM_UNIT_NUM_CNS];
    ...
    GT_U32                          numOfMifs;/*number of MIF units*/
    GT_U32                          numOfSip6_10_SERDES_units;/*number of SERDES units*/
    ...
    GT_U32                      cncUnitSize; /* CNC unit size (in bytes) */
    ...
    GT_U32                      ipFixTimeStampClockDiff[3/*state*/]; /* Three stages clock offsets.
                                                               Used for calculation of TOD clock value. */
    GT_U32                      clockWhenPolicerTimerTblWasSet[3/*stage*/];/* hold the time (clock) when the application set the ipfix time (per stage)
                                            the value saved when application set the new time.
                                            the value used when application need to read the current time ,
                                            so we calc the time padded from the time application set the
                                            value and we add it to the value that application set.
                                            */
    ...
    struct{
        ...
        GT_BIT      upChangesInEgressMirroredPackets;/*EREP-43 : UP changes in Egress Mirrored packets*/
        GT_BIT      ipMllWrongSetMllRepInBridgedCopy; /* MLL-518: IP MLL logic set wrongly mll_rep for original bridged descriptor */
        GT_BIT      ipfixAlarmIndex; /* [JIRA] POLICER-2027: Adapt IPFIX Alarm register index as per HW */
    }errata;
    ...
    GT_32   eTodTimeStampClockDiff[SIM_MAX_TAI_GROUPS][SIM_MAX_TAI_INST];
    /* TOD auxilary pseudo registers */
    SNET_TOD_TIMER_STC  eTod[SIM_MAX_TAI_GROUPS][SIM_MAX_TAI_INST];
    ...
    /* indication to allow the device to use the 3 interrupt trees */
    /* the use of it may cause performance degradation             */
    GT_BIT                               support3InterruptTrees;
    ...
    struct{
        ...
        */
        ...
        GT_BIT  isSip7;     /* AAS               - indication that device supports sip7    features and registers structure */

    }sipRevInfo;

    struct{
        GT_BIT  isLion2AndAbove; /* Set to 1 for Lion2, SIP5 and above
                                    Set to 0 for AC3 ,AC5*/
    }legacyRevInfo;
    ...
    GT_U32  sip7_numWordsAlignmentInNaMsg;/* sip7 : number of words alignment in NA Message format .
                            16 words alignment (as NA message is 448 bits)
                            the NA is long as it holds extra 16 HASH values (16 bits each) , after first 6 words.
                            NOTE: other message types still uses : numWordsAlignmentInAuMsg (8 words)
                            */
    GT_U32  sip7_numOfWordsInNaMsg;/* sip7 : number of words in NA Message format .
                            14 words of data (as NA message is 448 bits)
                            the NA is long as it holds extra 16 HASH values (16 bits each) , after first 6 words.
                            NOTE: other message types still uses : numOfWordsInAuMsg (6 words)
                            */
    ...
    */
    ...
    struct{/* next are used when not 0 corresponding to the same resource by the
        ...
        GT_U32      trunkEcmp;/*sip7 : the trunk ECMP is not part of l2LttEcmp */
        ...
        GT_U32      smuSgcTimeSlotAttributesNum;/* number of SMU SGC Time Slot Attributes entries in the memory (sip 6.30) */
        GT_U32      portIsolationNum;/* number of port isolation entries (sip 6.30) */
        GT_U32      ipToMeNum;/* number of IP TO ME entries (sip 6.30) */
        GT_U32      l2iHportsNum;/* number of L2i HPort entries (sip 6.30) */
        GT_U32      numOfTs;/* number of TSs (sip 7) , different table than numOfArps */
        GT_U32      ipclConfigNum;/*number of entries in the IPCL config table
                            NOTE: when value is 0 , the table considered '4K+'num of phyPort'
                            the Hawk is using 6K
                            the AAS is using 6K
                            */
    ...
    */
    ...
    }cncUploadInfo[SIM_MAX_NUM_OF_CNC_TRIGGERS];
    struct{
        GT_U32  mgUnit;/*the MG unit that serves CNC uploads */
    }cncUnitInfo[MAX_CNC_UNITS_CNS];
    ...
    GT_BIT  cmFwSim; /* simulate CM FW rather than MicroInit */
    GT_BIT  timer1TaskStarted; /* Timer1 (Watchdog) task started */
    GT_BIT  timer1Running; /* Indicates Timer1 is running versus stopped */
    GT_U32  timer1StartAddrs[SIM_MAX_NUM_OF_MG]; /* Record which address was used to access timer1 start address. Simplifies the decoding between Falcon and AC5/X/P */
    ...
    GT_U32  numofMPclProfileId;/* in seaHawk 256  */
    ...
    struct{
        GT_BIT  isSharedTablesSupported;
        ...
        GT_BIT  isIpe0Shared;
        GT_BIT  isIpe1Shared;
        GT_BIT  isPlrMeterShared;
        GT_BIT  isPlrCounterShared;
        GT_BIT  isHf0Shared;
        GT_BIT  isHf1Shared;
        GT_BIT  isCncShared;

        struct{
            /** @brief : bmp of blocks that are connected to CNC_0_1 units
             *  Note : as the IPE0,1 are muxed with CNC_0_1 units , the blocks that
             *      will be given to the IPE0,1 will be removed from this BMP
             *      (and be set into sip7_ipe0_usedCncBlocksBmp , sip7_ipe1_usedCncBlocksBmp)
             *  set by smemAasActiveWriteShmCncBmpWm(...)
             *  Relevant to sip7 devices
             */
            GT_U32  sip7_cnc_0_1_usedBlocksBmp;
            /** @brief : bmp of blocks that are connected to CNC_2_3 units
             *  Note : CNC_2_3 are NOT muxed with other client
             *  Relevant to sip7 devices
             *  set by smemAasActiveWriteShmCncBmpWm(...)
             */
            GT_U32  sip7_cnc_2_3_usedBlocksBmp;
        }cnc;
        struct{
            /** @brief : bmp of CNC_0_1 blocks that are used by muxed with IPE0 ,
             *      and used by IPE stage 0
             *  Relevant to sip7 devices
             */
            GT_U32  sip7_ipe0_usedCncBlocksBmp;
            /** @brief : bmp of CNC_0_1 blocks that are used by muxed with IPE1 ,
             *      and used by IPE stage 1
             *  Relevant to sip7 devices
             */
            GT_U32  sip7_ipe1_usedCncBlocksBmp;
        }sip7_ipe;

        struct{
            /** @brief : array of banks with the number of SBMs that that are connected to this LPM bank
             *  Relevant to sip7 devices
             *  set by smemAasActiveWriteShmLpmBlockWm(...)
             */
            GT_U32  sip7_lpm_numSbmsPerBlock[48];
        }lpm;

        struct{
            /*
              info about pairs of tables that share the memory between them
              ...
              ======
              NOTE: this info set by smemAasActiveWriteShmSharingInfoWm
                    and used by smemAasActiveWriteShmSizeForWm
            */
            GT_BOOL isUsed;
            GT_U32  tileId;
            GT_U32  tableId;
            ...
            #define SKERNEL_SHARING_PAIRS_MAX_NUM_CNS   32
        }sharing_pairs[SKERNEL_SHARING_PAIRS_MAX_NUM_CNS];


    }sharedTablesInfo;

    GT_U32  egfNumBitsPerPort;
    GT_U32  eqNumBitsPerEPort;

    GT_U32* mgUnitsBaseAddrArr;/* used if not NULL , instead of 'mgUnitNames' of smemFalcon.c
                              to get the addresses of MG units
                              size of array according to devObjPtr->numOfMgUnits */

    GT_U32  freeRunningTaiInst;/* in Ironman this is TAI4 , in Seahawk it is TAI2 */

    GT_BIT  supportGdma;/* SIP7 : indication that the device used the GDMA and not the MG for
                           SDMA operations.
                           the flag needed till finish to move the CPSS and WM to this mode.
                            */
    GT_BIT  supportGdma_AUQ;/* SIP7 : indication that the device used the GDMA and not the MG for
                           AUQ operations.
                           the flag needed till finish to move the CPSS and WM to this mode.
                            */
    GT_BIT  supportGdma_FUQ;/* SIP7 : indication that the device used the GDMA and not the MG for
                           AUQ operations.
                           the flag needed till finish to move the CPSS and WM to this mode.
                            */
    GT_BIT  supportGdma_CNC;/* SIP7 : indication that the device used the GDMA and not the MG for
                           AUQ operations.
                           the flag needed till finish to move the CPSS and WM to this mode.
                            */
    GT_U32  numOfGdmaUnits;/* number of GDMA units (per device after number of tiles multiple) */

    struct /*gdmaInfo*/{
        /* convert the 4 values : 0..3 in <gdma_id> in :
            ...
            */
        GT_U32  gdmaDispatcherToUnitmap[4];

        /* convert the local GDMA in tile to ingressRxDmaPortNumber index */
        GT_U32  gdmaFromCpuMapTo_ingressRxDmaPortNumber[4/*per tile*/*2 /*tiles*/];

        GT_U32  gdmaUnitForFdbMsg;
        GT_U32  gdmaUnitForCncMsg;
        GT_U32  gdmaUnitForIpeMsg;

    }gdmaInfo;

    struct {
        GT_U32  numMllPairsEntriesInLine; /* in sip7 = 4 */
        GT_U32  numMllPairsBitsPerEntry;  /* in sip7 = 185 */
    } sip7_mllInfo;

    struct {
        GT_U32  tunnelStartTempSubEntry[(1584+31) / 32];
    }sip7_ha;
...
/* isTrgPhyPortValid - Cleared by all mechanisms that assign ePort/vport */
#define SNET_E_ARCH_CLEAR_IS_TRG_PHY_PORT_VALID_MAC(dev,_descPtr,unitName)    \
    _descPtr->eArchExtInfo.isTrgPhyPortValid = 0


/* relevant to SIP7 device only */
/* invalidate the target ePort and the target device , because we use target vPort */
/* we also set isTrgPhyPortValid = 0 */
#define SIP7_INVALIDATE_TRG_EPORT_TRG_DEV_MAC(dev,_descPtr,unitName) \
    {                                                                 \
        _descPtr->trgDev   = SMAIN_NOT_VALID_CNS;                     \
        _descPtr->trgEPort = SMAIN_NOT_VALID_CNS;                     \
        SNET_E_ARCH_CLEAR_IS_TRG_PHY_PORT_VALID_MAC(dev,_descPtr,unitName); \
        __LOG(("[%s] : Invalidate the target ePort and the target vPort , because we use target vPort \n", \
        #unitName));                                                  \
    }
...
typedef struct{
    ...
    GT_U32          localDevSrcEPort;/*
                            ...
                            */
                            /* in sip7 :
                               When <Src is vPort>==0 used as index to source ePort attributes.
                               When <Src is vPort>==1 used as the source vPort profile
                            */
   ...
   GT_U32           srcTrgIsVPort ; /* SIP7 : indication that the 'srcTrg' is vPort (and not eport)*/
   GT_U32           srcTrgVPort;    /* SIP7 : indication that the 'srcTrg' is vPort
                                       NOTE: the srcTrgEPort is used as 'src/trg vport profile' when srcTrgIsVPort == 1
                                       NOTE: this field Not muxed with Desc<Src Trg ePort> */
    ...
    struct{
        ...
        GT_BIT          Is_Stacking_Port;/*sip7 indication that src port is 'stack port' (get value once , used in 2 places)*/
        GT_BIT          needVPortE2PhyLogic_part2;/*sip7 indication that part 1 of E2PHY done , and need to do part 2 */
        GT_U32          preE2phy_trgDev;/*sip7 need the value of trgDev before the E2PHY was accessed */
   ...
   GT_BIT          assignTrgEPortAttributesLocally; /* Setting by TxQ (dev map table).
    ...
    GT_U32          eqInTrgEPort; /* Input value of Target ePort in EQ uint. Used exclusively in EQ unit for Falcon only devices */
...
typedef struct{ /* valid info during egress to specific physical port */
    ...
    GT_U32   sip6_sdqLocalQueue;/* sdqLocalQueue for this egress packet */
...
typedef struct SKERNEL_FRAME_CHEETAH_DESCR_STCT
{
   ...
   GT_U32                       trgEPort; /* Target E Port, Set by Frame Parser from Marvel tag, PCL or L2i
                                         ...
                                         /* in sip 7 :
                                         1. The packet's target ePort / target vPort Profile.
                                            If <Trg is vPort>==0 and current validity logic for Trg ePort is true
                                            then {<Trg Dev>, <trg ePort>} is the packet's target ePort.
                                            If <Trg is vPort>==1
                                            then from EQ to EREP this is the vPort Profile

                                         2. TTI ->EQ Muxed with <Trg vPort>
                                            EQ->EREP not muxed with <Trg vPort>
                                         */
   ...
   GT_U32                       trgDev;  /* Target Device, Set by Frame Parser from Marvel tag, PCL or L2i.
                                         ...
                                         /* in sip7 :
                                            The packet's target device.
                                            When <Trg is vPort>==0 and validity logic for <Trg ePort> is true
                                            then it is also used in {<trg device>, <trg ePort>} pair to indicate the target ePort in a stack.
                                         */
   ...
   GT_U32                       origSrcEPortOrTrnk; /* Packet's Original Source port or Trunk, frame parser from Marvell Tag
                                        ...
                                        */
                                        /* in sip7 :
                                            The packet's original source ePort.
                                            If <Src is vPort>==0 and current validity logic for src ePort is true
                                            then {<Src Dev>, < Orig Src ePort>} is used for data plane ePort learning

                                            Can be muxed with<Src vPort>
                                        */
   ...
   GT_U32                       excludedPort;/* Together ExcludedDev, specifies the port that excluded from the Multicast group.,
                                                  Set by frame parser from Marvell Tag */
   GT_U32                       excludedVPort;/* SIP7 : indication to exclude vPort (not trunk/ePort)
                                                 NOTE: the 'exluded 'is vPort' comes from excludedIsPhyPort == 2 !!! */
   ...
   GT_BIT                       ipOptionFragError; /* ipv4 packet contains options or is pragmented */
   ...
   GT_U32                       srcDev; /* Source device id, set by Frame Parser from Marvell Tag or from ownDevice register
                                         ...
                                         /* in sip7 :
                                         Packet's Source device.
                                         When <Src is vPort>==0 and current validity logic for src ePort is true
                                         then {<Src Dev>, < Orig Src ePort>} is used for data plane ePort learning.
                                         When <Src is vPort>==1 it is used in FDB to indicate on which device the vPort was learned.
                                         */
  ...
  GT_U8                   ttlArr[10];        /* TTL value: SIP7: exp index 0..9; SIP5: 0..4, Legacy: 0..2  */
  ...
  GT_U32                  label[10];        /* SIP7: lable index 0..9; SIP5: 0..4, Legacy: 0..2 */
  GT_U32                  exp[10];          /* SIP7: exp index 0..9; SIP5: 0..4, Legacy: 0..2  */
  ...
  SKERNEL_PCL_LOOKUP_MODE_ENT pclLookUpMode[3]; /* Controls the index used for IPCL lookups :
                                                ...
                                                index 2 - lookup 10
                                                */
  SKERNEL_PCL_LOOKUP_MODE_ENT mpclLookUpMode; /* Controls the index used for MPCL lookups*/
  SKERNEL_PCL_LOOKUP_MODE_ENT epclLookUpMode; /* Controls the index used for EPCL lookups*/
  ...
  GT_U8  *ingressTimestampTagPtr;   /* pointer to ingress timestamp tag */
  GT_U32 ingressTimestampTagSize;   /* ingress timestamp tag size in bytes */

  SNET_TOD_TIMER_STC timestamp[4][2];             /* Ingress & Egress TOD based on selected TAI 0..3 */
  ...
  GT_BOOL pktMchTwoStepEn;                        /* Indication if packet egress time should be captured in TSQ */
  ...
  GT_U32    ptpUdpChecksumOffset; /* Specifies the offset of the UDP Checksum Trailer in bytes, relative to the beginning of the egress header size */
  GT_U32    ptpOffset;       /* if (isPtp) defines byte offset to the start of the PTP header,
                                relative to the start of the L3 header */
  GT_U32    ptpTsByteLength;       /* timestamp length */
  GT_U8     ptpTimestamp[10];      /* timestamp value */
  GT_U8     ptpTimestamp1[10];     /* timestamp value */
  GT_U32    ptpTsOffset;           /* offset from start of prame to timestamp */
  GT_U32    ptpTsOffset1;          /* offset from start of prame to timestamp */
  GT_U32    ptpDomain;       /* PTP domain entry number (0..4) */
  GT_U32    ptpDomain_8bits; /* 8 bits from the PTP header */
  ...
  GT_U32          tunnelTerminationOffset;/*relevant when descrPtr->eArchExtInfo.packetIsTT */
    ...
    GT_U32                      ipclMetadataInfo[ (1500+31) / 32];/* sip6 : supporting 1256 bits of metadata in sip6
                                                ...
                                                */
    GT_U32                      ipclMetadataModifiedFields[ (384+31) / 32]; /* sip7 IPCL metadata modified fields */
    ...
    */
    ...
    GT_U8   *srHeaderStartOffsetPtr; /* pointer to start Segment Routing Extension Header */
    ...
    GT_U32  maxAllowedVlanTagOffset;    /* max offset in the packet that the vlan tag parsing is allowed
                                        in sip5 this is 6*4=24 bytes after the macSa (and after optional TS tag)
                                        else 4*4=16 bytes
                                        */
    GT_U32 genericClassification[4]/*128 bits*/; /*sip7 - Generic Classification Field to be used by customer applications.*/

    GT_U32 isPktMirrorInLocalDev;/* info from EQ to the egress pipe , if the mirror was locally generated */

    GT_U32  trgVPort;/* sip 7 - 18 bits : The packet's target vPort
                        TTI->EQ Muxed with <Trg ePort>:
                        <Trg is vPort>=0 => <Trg ePort> is valid
                        <Trg is vPort>=1 => <Trg vPort> is valid
                        TTI->EREP */
    GT_BIT  trgIsVPort; /*sip 7 : Indicates that the target is vPort
                        TTI->EREP */
    GT_U32  srcVPort;/* sip 7 - 18 bits : The packet's source vPort.
                        Muxed with <Orig Src ePort>
                        TTI->EREP */
    GT_BIT  srcIsVPort; /*sip 7 : Indicates that the source is vPort
                        TTI->EREP */
    GT_U32  trgCircuit; /*sip7 : 17 bits : The packet's target circuit
                            EQ->HA */
    GT_BIT  hft0Triggered; /*sip7 : Indicates that Desc<HFT0 ptr> is valid
                            EQ->HA */
    GT_U32  hft0Ptr; /*sip7 : 20 bits : Pointer to Header Fields Table0
                            EQ->HA */
    GT_BIT  hft1Triggered; /*sip7 : Indicates that Desc<HFT1 ptr> is valid
                            EQ->HA*/
    GT_U32  hft1Ptr; /*sip7 : 20 bits : Pointer to Header Fields Table1
                            EQ->HA */

    /* SIP7 : MLL unit internal info (not between units)
        it is needed for 'Multi Traget vPorts' support , that need to :
        For all replicas overwrite L2MLL<Trg vPort 0(1)> such that
        L2MLL<Trg vPort 0(1)>= temp (inDesc<Trg vPort>)
    */
    struct {
        GT_BIT      isUsed;
        GT_U32      origTrgVPort;
    ...
    GT_BIT     ipclActionStop; /* SIP7 IPCL to MPCL */
    GT_BIT     mpclActionStop; /* SIP7 MPCL to EPCL */

    /* SIP7: (Replaces old Desc<MPLS Cmd>)
     * Total number of labels popped from the label stack
     * (including ELI+EL and Explicit Null labels) */
    GT_U32     totalPoppedLabels;
    /* SIP7:
     * 0 - None of the TTI Actions assigned <MPLS Command>=Swap
     * 1 - One of the EM/TTI Action assigned <MPLS Command>=Swap or Pop/Swap
     */
    GT_BIT     isLabelSwapped; /* Indicates the label is Swapped. Applicable devices: SIP7 */
    GT_BIT     isLabelPushed; /* Indicates the label is Pushed. Applicable devices: SIP7 */
    GT_U32     fwdLabelsPopSwap; /* Number of Forwarding labels Popped/Swapped. Applicable devices: SIP7 */
    GT_U32     currFwdLabelIndex;  /* Current Forwarding Label Index. Applicable devices: SIP7*/
    GT_BIT     isLabelValid[10]; /* Valid Labels in Label stack. Applicable devices: SIP7*/
    GT_BIT     isLastLabelInStack[10]; /* Indicates last label in stack. Applicable devices: SIP7*/
    GT_U32     fwdLabelStackIndex[10]; /* Forwarding Label stack index. Applicable devices: SIP7*/
    GT_U32     exp4Egress;     /* Selected exp4Egress */
    GT_U32     exp4Qos;        /* Selected EXP4Qos */
    GT_U32     outerEthDeiUp;  /* Outer Ethernet DEI-UP */
    GT_U32     qosModel;       /* Selected QoS Model. Applicable devices: SIP7 */
    GT_U32     ttlModel;       /* Selected TTL model. Applicable devices: SIP7 */
    GT_BIT     trustExpFlag;   /* Selected Trust EXP Flag */
    GT_BIT     trustDscpFlag;  /* Selected Trust DSCP Flag */
    GT_U32     trustUpFlag;    /* Selected Trust DSCP Flag */
    /*
        From IAS : Init QAG per TC_DP_Profile table to indicate whether this trg queue is for
        preemption/express (see Table 289, QAG TC/DP map table changes). Used
        by QAG to reflect preemption channel towards TXQ in the queuery i/f (+1 to
        local_dev_trg_phy_port)
        Terminated in the EREP. Used by EREP to reflect preemption channel
        towards TXQ in the enqueue i/f (+1 to local_dev_trg_phy_port)
    */
    GT_U32     sip7TrgPreempt;

    GT_U32     trgPortTcProfile; /* sip7 : <tc_profile> for target port , that EQ sets and the EGF_QAG use
                                    in legacy the tc_profile was in the EGF_QAG per target port */

    GT_U32  tag0Vid;/* sip7 : the physical vlan of tag 0 (translated from eVlan)
                       value is 12 bits */
    GT_U32  pipPriority; /* RX_DMA PIP priority */
    GT_U32  rxDmaDebugCpTpRxCntDone; /*rxDmaDebugCpTpRxCounter incremented - SIP6 and above */
...
typedef enum{
    ...
    SNET_DST_INTERFACE_VPORT_E /* new in sip7 */
...
#define IS_SIP6_BY_FAMILY_MAC(dev) \
     (((dev)->deviceFamily == SKERNEL_FALCON_FAMILY ||   \
       ...
       (dev)->deviceFamily == SKERNEL_HAWK_FAMILY    ||  \
       IS_SIP7_BY_FAMILY_MAC(dev)) ? 1 : \
        0)

/* NOTE: used instead of 'SMEM_CHT_IS_SIP6_GET' because in GM it is used before setting the 'flag' for SMEM_CHT_IS_SIP6_GET */
#define IS_SIP7_BY_FAMILY_MAC(dev) \
     (((dev)->deviceFamily == SKERNEL_AAS_FAMILY) ? 1 : \
        0)
...
* INPUTS:
*       deviceObj   - pointer to device object.
*       bufferId    - pointer to the buffer that hold the message.
...
/**
 * @internal skernelCreateTimer1Task function
 * @endinternal
 *
 * @brief   Create Timer1 task
 *
 * @param[in] deviceObjPtr             - allocated pointer for the device
 * @param[in] tgNumber                 - packet generator number
 */
GT_VOID skernelCreateTimer1Task
(
    IN SKERNEL_DEVICE_OBJECT * deviceObjPtr
);
...
/* default EM unit number */
#define SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT   0

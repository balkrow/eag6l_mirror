...
#define __wm_asic_sim_defs_h
    ...
    /* Thread#76 */
    struct thr76_Copy_Flow_ID_to_Trg_Phy_Port_in_hdr*  ac5pMemCast_thr76_Copy_Flow_ID_to_Trg_Phy_Port_in_hdr(uint32_t address);
    /* Thread#93 */
    struct thr93_MPLS_LSR_In_Stacking_System_Thread_in_hdr*  ac5pMemCast_thr93_MPLS_LSR_In_Stacking_System_Thread_in_hdr(uint32_t address);
    struct thr93_MPLS_LSR_In_Stacking_System_Thread_cfg*  ac5pMemCast_thr93_MPLS_LSR_In_Stacking_System_Thread_cfg(uint32_t address);

...
#define HARD_DROP     (3)
/* Packet command allocated by FW set to Trap to CPU */
#define TRAP_TO_CPU     (2)
/* 8 bytes size */
...
/* Offsets in bytes from the begining of the packet. These offsets are used by THREAD_TYPE_RESERVED_1_X, while X can be: [0,1,2] */
#define RESERVED_PTYPE_OFFSET 0x48
#define RESERVED_TS_DATA_0_3_OFFSET 0x2E
#define RESERVED_HOP_LIMIT_I_OFFSET 0x49
#define DESC_PHA_METADATA_0_OFFSET  0x17
#define RESERVED_DESC_PHA_METADATA_0_OFFSET (AC5P_DESC_REGs_lo + DESC_PHA_METADATA_0_OFFSET)
...
/* THR93_MPLS_LSR_In_Stacking_System_Thread */
#define OUTGOING_MTAG_FORWARD_CMD_CNS 0x3

...
#define __wm_asic_sim_defs_h
    ...
    /* Thread#76 */
    struct thr76_Copy_Flow_ID_to_Trg_Phy_Port_in_hdr*  falconMemCast_thr76_Copy_Flow_ID_to_Trg_Phy_Port_in_hdr(uint32_t address);
    /* Thread 71 */
    struct thr71_ifa_header_cfg* falconMemCast_thr71_ifa_header_cfg(uint32_t address);
    /* Thread 72 */
    struct thr72_ifa_ingress_metadata_cfg* falconMemCast_thr72_ifa_ingress_metadata_cfg(uint32_t address);
    /* Thread 73 */
    struct thr73_ifa_transit_metadata_cfg* falconMemCast_thr73_ifa_transit_metadata_cfg(uint32_t address);
    /* Thread 74 */
    struct thr74_ifa_egress_node_mirror_cfg* falconMemCast_thr74_ifa_egress_node_mirror_cfg(uint32_t address);
    /* Thread 75 */
    struct thr75_ifa_egress_node_metadata_cfg* falconMemCast_thr75_ifa_egress_node_metadata_cfg(uint32_t address);
    /* Thread 91 */
    struct thr91_INQA_ECN_Thread_out_hdr* falconMemCast_thr91_INQA_ECN_Thread_out_hdr(uint32_t address);

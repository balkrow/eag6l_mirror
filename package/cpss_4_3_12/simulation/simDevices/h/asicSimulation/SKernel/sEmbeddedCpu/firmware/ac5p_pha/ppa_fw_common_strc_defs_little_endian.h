...
struct ppa_in_desc {
    struct {
		...
		uint32_t reserved_alignment:4;            /* offset:0 */
		...
		uint32_t egress_inner_packet_type:2;      /* offset:43 */
		uint32_t oam_tx_period:3;                  /* offset:40 */
		uint32_t local_dev_packet_source:2;       /* offset:38 */
		uint32_t lm_counter_insert_en:1;          /* offset:37 */
		uint32_t qcn_generated_by_local_dev:1;   /* offset:36 */
		uint32_t egress_outer_is_tagged:1;        /* offset:35 */
		uint32_t queue_dp:2;                       /* offset:33 */
		uint32_t oam_processing_en:1;             /* offset:32 */
		uint32_t latency_profile:9;                 /* offset:87 */
		uint32_t qos_mapped_up:3;                   /* offset:84 */
		uint32_t trigger_qcn:1;                     /* offset:83 */
		...
		uint32_t egress_tag_state:3;                /* offset:64 */
		uint32_t ptp_dispatching_en:1;              /* offset:127 */
		uint32_t ptp_timestamp_queue_entry_id:10;  /* offset:117 */
		uint32_t do_nat:1;                           /* offset:116 */
		uint32_t copy_reserved:20;                  /* offset:96 */
		uint32_t pha_metadata4:8;              /* offset:152 */
		uint32_t pha_metadata5:8;              /* offset:144 */
		uint32_t egress_tunnel_start:1;             /* offset:143 */
		uint32_t do_route_ha:1;                      /* offset:142 */
		uint32_t egress_byte_count:14;              /* offset:128 */
		uint32_t pha_metadata0:8;              /* offset:184 */
		uint32_t pha_metadata1:8;              /* offset:176 */
		uint32_t pha_metadata2:8;              /* offset:168 */
		uint32_t pha_metadata3:8;              /* offset:160 */
        uint32_t packet_hash:12;                    /* offset:212 */ 
        uint32_t queue_length:20;                   /* offset:192 */
        ...
        uint32_t egress_outer_l3_offset:6;         /* offset:224 */
        uint32_t ptp_cf_wraparound_check_en:1;      /* offset:287 */
        uint32_t routed:1;                            /* offset:286 */
        uint32_t egress_filter_registered:1;        /* offset:285 */
        uint32_t sr_end_node:1;                      /* offset:284 */
        uint32_t dp:2;                                /* offset:282 */
        uint32_t is_trg_phy_port_valid:1;           /* offset:281 */
		...
		uint32_t ptp_egress_tai_sel:1;              /* offset:256 */
    	uint32_t l4_offset:7;                         /* offset:313 */
        uint32_t egress_inner_header_offset:7;      /* offset:306 */
        uint32_t ptp_offset:7;                        /* offset:299 */
        uint32_t egress_inner_l3_offset:6;          /* offset:293 */ 
        uint32_t analyzer_index:3;                   /* offset:290 */
        uint32_t ptp_trigger_type:2;                 /* offset:288 */
        uint32_t cpu_code:8;                          /* offset:344 */
        uint32_t egress_dscp:6;                       /* offset:338 */
        uint32_t flow_id:16;                          /* offset:322 */
        uint32_t l2_echo:1;                           /* offset:321 */
		uint32_t tables_read_error:1;                /* offset:320 */
        uint32_t trg_phy_port:10;                     /* offset:374 */
        ...
        uint32_t orig_is_trunk:1;                     /* offset:388 */
        uint32_t is_ptp:1;                             /* offset:387 */
        uint32_t timestamp_en:1;                      /* offset:386 */
        uint32_t outgoing_mtag_cmd:2;                 /* offset:384 */
	...
	struct {
		...
		uint32_t prep_table_read_error:1;             /* offset:492 */
		uint32_t pha_cnc_client_trigger:1;            /* offset:491 */
		uint32_t pha_cnc_client_index_override:1;    /* offset:490 */

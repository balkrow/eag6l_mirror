...
#define ENABLE_THR57_SFLOW_V5_ENT0_FORMAT1_RAW_PACKET
...
#define ENABLE_THR67_Forward_DSA_Routed_Clear
#define ENABLE_THR68_Erspan_TypeI_Ipv4
#define ENABLE_THR69_Erspan_TypeI_Ipv6
#define ENABLE_THR71_IFA_Header
#define ENABLE_THR72_IFA_Ingress_Metadata
#define ENABLE_THR73_IFA_Transit_Metadata
#define ENABLE_THR74_IFA_Egress_Node_Mirror
#define ENABLE_THR75_IFA_Egress_Node_Metadata
#define ENABLE_THR90_Router_SA_Modification_Thread
#define ENABLE_THR91_INQA_ECN_Thread
#define ENABLE_THR92_VXLAN_DCI_VNI_Remapping_Thread

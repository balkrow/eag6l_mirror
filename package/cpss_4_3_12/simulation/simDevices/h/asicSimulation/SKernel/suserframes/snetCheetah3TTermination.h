...
typedef struct{
    ...
    GT_U32      assignSrcInterfaceEnable;/* in sip7 will hold 2 bits :
                                      0 - no src EPORT assignment (like sip5) , and not src VPORT assignment (sip7)
                                      1 - src EPORT assignment (like sip5) -> use <sourceEPort>
                                      2 - src VPORT assignment (sip7) --> use <sourceVPort>
                                    */
    GT_U32      sourceEPort;
    GT_U32      sourceVPort;        /*sip7*/
    GT_BIT      sourceVPortProfileAssignmentEnable;
...
/*  GT_U32  oamProfile; already in SNET_LION3_PCL_ACTION_OAM_STC */
    ...
    GT_U32  pwTagMode;
    GT_BIT  continueToNextTtiLookup; /* not used in SIP7 */
/*    GT_BIT  channelTypeToOpcodeMappingEn; already in SNET_LION3_PCL_ACTION_OAM_STC */
    ...
    /* sip 6.30 new fields based on options of Generic Action. Action has Generic 12b Action field.
       But content of this field is used for assignment of different fields based on global configuration. */
    GT_U32  srcEpg; /* Source EPG value from Generic Action. Value == 0 skips assignment */
    GT_U32  dstEpg; /* Destination EPG value from Generic Action. Value == 0 skips assignment */

    /* SIP 7*/
    GT_U32  qosModel;       /* 0=Uniform Model, 1=Pipe Model, 2=Short Pipe Model.*/
    GT_U32  ttlModel;       /* 0=Uniform Model, 1=Pipe Model, 2=Short Pipe Model.*/
    GT_U32  qosMappingMode; /* 0 = QoS Profile Mode: Map QoS field to QoS Profile
                               1 = TC-DP Mode: Map QoS filed to TC-DP */
    GT_BOOL stopMpls;
...
typedef enum{
    /* Parallel Lookup */
    TTI_PARALLEL_LOOKUP_E,
    /* Serial EM Lookup */
    TTI_SERIAL_EM_LOOKUP_E
} TTI_LOOKUP_TYPE_ENT;

/* QoS related Enums */
typedef enum{
    /* Uniform model */
    TTI_QOS_UNIFORM_MODEL_E,
    /* Pipe model */
    TTI_QOS_PIPE_MODEL_E,
    /* Short Pipe model */
    TTI_QOS_SHORT_PIPE_MODEL_E
} TTI_QOS_MODEL_ENT;

typedef enum{
    /* QoS Profile Mode
     * Map QoS Field to QoS Profile */
    TTI_QOS_PROFILE_MODE_E,
    /* TC-DP Mode
     * Map QoS Field to TC_DP*/
    TTI_TC_DP_MODE_E
} TTI_QOS_MAPPING_MODE_ENT;

typedef enum{
    /* Previous QoS Model */
    TTI_QOS_MODEL_PREVIOUS_E,
    /* Current QoS Model */
    TTI_QOS_MODEL_CURRENT_E
} TTI_QOS_MODEL_SELECTION_MODE_ENT;

typedef enum{
    /* Previous Trust QoS Mapping table */
    TTI_TRUST_QOS_MAPPING_TABLE_PREVIOUS_E,
    /* Current Trust QoS Mapping table */
    TTI_TRUST_QOS_MAPPING_TABLE_CURRENT_E
} TTI_TRUST_QOS_MAPPING_TABLE_SELECTION_MODE_ENT;

typedef enum{
    /* Previous QoS Trust Fields Selection Mode */
    TTI_QOS_TRUST_FIELDS_SELECTION_PREVIOUS_E,
    /* Current QoS Trust Fields Selection Mode */
    TTI_QOS_TRUST_FIELDS_SELECTION_CURRENT_E
} TTI_QOS_TRUST_FIELDS_SELECTION_MODE_ENT;

typedef enum{
    /* Previous EXP4QoS Selection Mode */
    TTI_EXP_4_QOS_SELECTION_PREVIOUS_E,
    /* Current EXP4QoS Selection Mode */
    TTI_EXP_4_QOS_SELECTION_CURRENT_E,
    /* Next EXP4QoS Selection Mode */
    TTI_EXP_4_QOS_SELECTION_NEXT_E
} TTI_EXP_4_QOS_SELECTION_MODE_ENT;

typedef enum{
    /* Previous EXP4Egress Selection Mode */
    TTI_EXP_4_EGRESS_SELECTION_PREVIOUS_E,
    /* Current EXP4Egress Selection Mode */
    TTI_EXP_4_EGRESS_SELECTION_CURRENT_E,
    /* Next EXP4Egress Selection Mode */
    TTI_EXP_4_EGRESS_SELECTION_NEXT_E
}TTI_EXP_4_EGRESS_SELECTION_MODE_ENT;

/* TTL related Enums */
typedef enum{
    /* Uniform model */
    TTI_TTL_UNIFORM_MODEL_E,
    /* Pipe model */
    TTI_TTL_PIPE_MODEL_E,
    /* Short Pipe model */
    TTI_TTL_SHORT_PIPE_MODEL_E
} TTI_TTL_MODEL_ENT;

typedef enum{
    /* Previous TTL Model */
    TTI_TTL_MODEL_PREVIOUS_E,
    /* Current TTL Model */
    TTI_TTL_MODEL_CURRENT_E
} TTI_TTL_MODEL_SELECTION_MODE_ENT;

typedef enum{
    /* Previous <Selected TTL> */
    TTI_TTL_SELECT_PREVIOUS_E,
    /* Current Layer TTL */
    TTI_TTL_SELECT_CURRENT_E,
    /* Next Layer TTL */
    TTI_TTL_SELECT_NEXT_E
} TTI_TTL_SELECTION_MODE_ENT;

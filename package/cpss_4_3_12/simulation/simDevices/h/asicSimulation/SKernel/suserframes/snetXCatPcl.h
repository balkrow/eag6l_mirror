...
typedef enum
{
    ...
    LION3_IPCL_KEY_TYPE_SIP7_NOT_IP_ARP_120B_E,
    LION3_IPCL_KEY_TYPE_SIP7_IPV4_120B_E,
    LION3_IPCL_KEY_TYPE_SIP7_IPV6_120B_E,

    LION3_MPCL_KEY_TYPE_SIP7_NOT_IP_ARP_120B_E,
    LION3_MPCL_KEY_TYPE_SIP7_IPV4_120B_E,
    LION3_MPCL_KEY_TYPE_SIP7_IPV6_120B_E,

    LION3_EPCL_KEY_TYPE_SIP7_NOT_IP_ARP_100B_E,
    LION3_EPCL_KEY_TYPE_SIP7_IPV4_100B_E,
    LION3_EPCL_KEY_TYPE_SIP7_IPV6_100B_E,
...
typedef enum
{
    ...
    ,LION3_KEY_80B_EXTRA_10B_FIELD_NAME_BUILD(584 , 607 , MAC_SA_47_24     )
...
typedef struct{
    GT_BIT      lookup1Mode;/*second IPCL lookup*/
    GT_BIT      lookup2Mode;/*third IPCL lookup*/
    GT_BIT      mpclMode;/*MPCL lookup - relevant only for SIP7 IPCL Action*/
    GT_BIT      epclMode;/*EPCL lookup - relevant only for SIP7 MPCL Action*/
...
/*
    ...
    For SIP7 devices used both for IPCL and MPCL
*/
typedef struct {
    ...
    /* SIP7 */
    GT_BIT     cancelDrop;
    GT_BIT     exactMatchDisable;
    /* SIP7 MPCL */
    GT_BIT     routerTtlDecrementDisable;
    GT_BIT     routerMacSaAssignmentDisable;
    GT_BIT     routerMacDaAndIpHeaderModificationsDisable;
...
/**
* @internal snetSip7MPcl function
* @endinternal
*
* @brief   Middle Policy Engine processing for incoming frame on AAS
*         ASIC simulation.
*         PCL processing, Pcl assignment, Lookup Key creation, 1 Lookup,
*         actions to descriptor processing
* @param[in] devObjPtr                - pointer to device object.
* @param[in] descrPtr                 - pointer to frame data buffer Id
*
...
*                                      COMMENTS:
*/
void snetLion3IpclUdbMetaDataBuild
(
    IN  SKERNEL_DEVICE_OBJECT           *devObjPtr,
    INOUT  SKERNEL_FRAME_CHEETAH_DESCR_STC *descrPtr,

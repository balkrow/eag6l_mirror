...
/**
* @internal SNET_PCL_LOOKUP_STAGE_ENT enum
* @endinternal
*
*/
typedef enum{
    SNET_PCL_LOOKUP_STAGE_EPCL_E,
    SNET_PCL_LOOKUP_STAGE_IPCL_E,
    SNET_PCL_LOOKUP_STAGE_MPCL_E
} SNET_PCL_LOOKUP_STAGE_ENT;
...
typedef struct {
    ...
    SNET_PCL_LOOKUP_STAGE_ENT      pclLookUpStage;

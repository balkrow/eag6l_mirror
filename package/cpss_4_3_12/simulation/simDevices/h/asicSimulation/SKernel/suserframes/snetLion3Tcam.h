...
typedef enum{
    ...
    SIP5_TCAM_CLIENT_MPCL_E     ,     /* SIP7 Midway Pcl    */

    SIP5_TCAM_CLIENT_LAST_E           /* last value - used for context reset */
...
typedef enum{
    ...
    SIP5_TCAM_KEY_SIZE_70B_E = 7,     /* 70 bytes */
    SIP5_TCAM_KEY_SIZE_80B_E = 8,     /* 80 bytes */

    SIP5_TCAM_KEY_SIZE_LAST_E,         /* last value */

    /* SIP7 suprkeys only */
    SIP5_TCAM_KEY_SIZE_100B_E = 10,     /* 100 bytes EPCL */
    SIP5_TCAM_KEY_SIZE_120B_E = 12      /* 120 bytes IPCL, MPCL*/

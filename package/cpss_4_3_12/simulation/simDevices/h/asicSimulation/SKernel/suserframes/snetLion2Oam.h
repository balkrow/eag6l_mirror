...
typedef struct
{
    ...
    GT_BIT keepaliveAgingStormSuppressEnable;       /* When enabled, exception storms are suppressed */
    GT_BIT invalidHashKeepaliveStormSuppressEnable; /* When enabled, exception storms are suppressed */
    GT_BIT megLevelStormSuppressEnable;             /* When enabled, exception storms are suppressed */
    GT_BIT sourceInterfaceStormSuppressEnable;      /* When enabled, exception storms are suppressed */
    GT_BIT txPeriodStormSuppressEnable;             /* When enabled, exception storms are suppressed */
    GT_BIT keepaliveAgingStatus;                    /* Represents the previous state of Keepalive Aging for this flow */
    GT_BIT megLevelStatus;                          /* Represents the previous state of MEG Level Status for this flow */
    GT_BIT sourceInterfaceStatus;                   /* Represents the previous state of source interface Status for this flow */
    GT_BIT txPeriodStatus;                          /* Represents the previous state of TX period Status for this flow */
    GT_BIT hashVerificationStatus;                  /* Represents the previous state of hash verification Status for this flow */

    GT_BIT skipOamLogic;                            /* When enabled, OAM processing is skipped */
    GT_BIT ignoreBadKeepAliveInAgingEnable;         /* When disabled, keepalive processing is skiped for bad hash */
    GT_BIT protectionOnRdiEnable;                   /* When enabled, LOC table indicates hash state */
    GT_BIT protectionRdiState;                      /* Represents the previous RDI state */
    /* sip5_10 : new fields.*/
    ...
    /* sip7 : new fields.*/
    GT_BIT sourceIsVPort; /* sip7 : is the src is vPort */
    GT_U32 sourceVPort;   /* sip7 : the src vPort (when sourceIsVPort == 1 and localDevSrcEPortTrunk == 0)*/

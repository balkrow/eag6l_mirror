...
/* triple key size (in bytes)  length of 3 regular keys  */
#define SNET_SIP7_POLICY_KEY_SIZE_BYTES_MAX_CNS             (120)/* sip7 devices IPCL,MPCL - 120, EPCL - 100 */
...
typedef enum {
    ...
    CHT_PCL_KEY_80B_E, /* SIP5 PCL, SIP7 TTI superkey */

    CHT_PCL_KEY_100B_E, /* SIP7 EPCL superkey */
    CHT_PCL_KEY_120B_E, /* SIP7 IPCL and MPCL superkey */
...
typedef union{
    ...
    GT_U8   sip7key[SNET_SIP7_POLICY_KEY_SIZE_BYTES_MAX_CNS];

    GT_U8   *unlimitedBufferPtr;
    GT_U32  data[(SNET_SIP7_POLICY_KEY_SIZE_BYTES_MAX_CNS+3)/4];

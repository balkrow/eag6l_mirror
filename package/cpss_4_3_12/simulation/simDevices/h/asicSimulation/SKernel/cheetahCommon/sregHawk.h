...
/* PPU - DAU Protected Window Error Latched Data */
#define SMEM_SIP6_10_PPU_DAU_PROTECTED_WINDOW_ERROR_LATCH_REG(dev) \
    SIP_6_10_REG(dev,PPU.dau.dauProtWinLatchData)
...
#define SMEM_SIP6_10_EXACT_MATCH_AUTO_LEARN_PROFILE_CONFIG_1_REG(dev, emUnitNum, profileIndex) \
    SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emProfileConfiguration1[profileIndex])

#define SMEM_SIP6_10_EXACT_MATCH_AUTO_LEARN_PROFILE_CONFIG_2_REG(dev, emUnitNum, profileIndex) \
    SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emProfileConfiguration2[profileIndex])

    #define SMEM_SIP6_10_EXACT_MATCH_AUTO_LEARN_PROFILE_CONFIG_3_REG(dev, emUnitNum, profileIndex) \
    SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emProfileConfiguration3[profileIndex])

#define SMEM_SIP6_10_EXACT_MATCH_AUTO_LEARN_PROFILE_CONFIG_4_REG(dev, emUnitNum, profileIndex) \
    SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emProfileConfiguration4[profileIndex])

/* EM Flow ID configuration */
#define SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_CONFIG_1_REG(dev, emUnitNum) \
     SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emFlowIdAllocationConfiguration1)

#define SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_CONFIG_2_REG(dev, emUnitNum) \
     SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emFlowIdAllocationConfiguration2)

#define SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_STATUS_1_REG(dev, emUnitNum) \
     SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emFlowIdAllocationStatus1)

#define SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_STATUS_2_REG(dev, emUnitNum) \
     SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emFlowIdAllocationStatus2)

#define SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_STATUS_3_REG(dev, emUnitNum) \
     SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emFlowIdAllocationStatus3)

#define SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_INTERRUPT_CAUSE_REGISTER_REG(dev, emUnitNum) \
     SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emInterrupt.emInterruptCauseReg)

#define SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_INTERRUPT_MASK_REGISTER_REG(dev, emUnitNum) \
     SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emInterrupt.emInterruptMaskReg)

#define SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_FAIL_COUNTER_REG(dev, emUnitNum) \
     SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emFlowIdFailCounter)

#define SMEM_SIP6_10_EXACT_MATCH_INDEX_FAIL_COUNTER_REG(dev, emUnitNum) \
     SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emIndexFailCounter)
...
#define SMEM_SIP6_10_AUTO_LEARN_COLLISION_STATUS_1_REGISTER_REG(dev, emUnitNum)   \
    SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emAutoLearningCollisionStatus1)

#define SMEM_SIP6_10_AUTO_LEARN_COLLISION_STATUS_N_REGISTER_REG(dev,emUnitNum,index)   \
    SIP_6_10_REG(dev, EXACT_MATCH[emUnitNum].emAutoLearning.emAutoLearningCollisionStatus_n[index])

...
#define CPU_PORT_INDEX(dev, port) \
        ((IS_CHT_CPU_PORT(port)) ? 28 : (port))

/* Miscellaneous Interrupt Mask Register - Cht/Ch2/Ch3 */
#define SMEM_CHT_MISC_INTR_MASK_REG(dev,treeId)                                 \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.globalInterrupt[treeId].miscellaneousInterruptMask

/* Miscellaneous Interrupt Cause Register - Cht/Ch2/Ch3 */
#define SMEM_CHT_MISC_INTR_CAUSE_REG(dev,treeId)                                \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.globalInterrupt[treeId].miscellaneousInterruptCause

/* Global Control Register - Cht/Cht2 */
#define SMEM_CHT_GLB_CTRL_REG(dev)                                       \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.globalConfig.globalCtrl

/* Global Interrupt Cause Register - Cht/Cht2 */
#define SMEM_CHT_GLB_INT_CAUSE_REG(dev,treeId)                                  \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.globalInterrupt[treeId].globalInterruptCause

/* Global Interrupt Mask Register - Cht/Cht2 */
#define SMEM_CHT_GLB_INT_MASK_REG(dev,treeId)                                   \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.globalInterrupt[treeId].globalInterruptMask
...
#define SMEM_CHT_HA_ROUTE_DEVICE_ID_MODIFICATION_ENABLE_REG(dev)  \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->HA.deviceIDModificationEnable[0])
...
#define SMEM_CHT_MAC_TBL_GLB_CONF_REG(dev)                               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.FDBGlobalConfig.FDBGlobalConfig )
...
#define SMEM_CHT_MSG_FROM_CPU_0_REG(dev)                                 \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.FDBAddrUpdateMsgs.AUMsgFromCPUWord[0])
...
#define SMEM_CHT_MSG_FROM_CPU_REG(dev)                                   \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.FDBAddrUpdateMsgs.AUMsgFromCPUCtrl)
...
#define SMEM_CHT_IPV6_MC_BRDG_BYTE_SEL_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.IPv6McBridgingBytesSelection.IPv6MCBridgingBytesSelectionConfig)
...
#define SMEM_CHT_IPV6_ICMP_CMD_REG(dev)                                  \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ctrlTrafficToCPUConfig.IPv6ICMPCommand)
...
#define SMEM_CHT_BRDG_GLB_CONF0_REG(dev)                                 \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.bridgeEngineConfig.bridgeGlobalConfig[0])
...
#define SMEM_CHT_BRDG_GLB_CONF1_REG(dev)                                 \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.bridgeEngineConfig.bridgeGlobalConfig[1])
...
#define SMEM_CHT_INGR_VLAN_RANGE_CONF_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.VLANRangesConfig.ingrVLANRangeConfig)
...
#define SMEM_CHT_BRDG_FILTER_CNT_REG(dev)                                \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.bridgeDropCntrAndSecurityBreachDropCntrs.bridgeFilterCntr)
...
#define SMEM_CHT_GLB_SECUR_BRCH_DROP_CNT_REG(dev)                        \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.bridgeDropCntrAndSecurityBreachDropCntrs.globalSecurityBreachFilterCntr)
...
#define SMEM_CHT_PORT_VLAN_SECUR_BRCH_DROP_CNT_REG(dev)                  \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.bridgeDropCntrAndSecurityBreachDropCntrs.portVLANSecurityBreachDropCntr)
...
#define SMEM_CHT_SECUR_BRCH_STAT0_REG(dev)                               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.securityBreachStatus.securityBreachStatus[0])
...
#define SMEM_CHT_SECUR_BRCH_STAT1_REG(dev)                               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.securityBreachStatus.securityBreachStatus[1])
...
#define SMEM_CHT_SECUR_BRCH_STAT2_REG(dev)                               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.securityBreachStatus.securityBreachStatus[2] )
...
#define SMEM_CHT_MAC_ADDR_CNT0_REG(dev)                                  \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.MACAddrCount[0])
...
#define SMEM_CHT_MAC_ADDR_CNT1_REG(dev)                                  \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.MACAddrCount[1])
...
#define SMEM_CHT_MAC_ADDR_CNT2_REG(dev)                                  \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.MACAddrCount[2])
...
#define SMEM_CHT_HOST_OUT_PKT_CNT_REG(dev)                               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.hostOutgoingPktsCount)
...
#define SMEM_CHT_HOST_OUT_BCST_PKT_CNT_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.hostOutgoingBcPktCount)
...
#define SMEM_CHT_HOST_OUT_MCST_PKT_CNT_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.hostOutgoingMcPktCount)
...
#define SMEM_CHT_HOST_IN_PKT_CNT_REG(dev)                                \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.hostIncomingPktsCount)
...
#define SMEM_CHT_MATRIX_SRC_DST_PKT_CNT_REG(dev)                         \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.matrixSourceDestinationPktCount)

/* Counters Set0 Configuration Register - Cht/Cht2 */
#define SMEM_CHT_CNT_SET0_CONF_REG(dev)                                  \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.cntrsSetConfig[0])
...
#define SMEM_CHT_SET0_IN_PKT_CNT_REG(dev)                                \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.setIncomingPktCount[0])
...
#define SMEM_CHT_SET0_VLAN_IN_FILTER_CNT_REG(dev)                        \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.setVLANIngrFilteredPktCount[0])
...
#define SMEM_CHT_SET0_SECUR_FILTER_CNT_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.setSecurityFilteredPktCount[0])
...
#define SMEM_CHT_SET0_BRDG_FILTER_CNT_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.layer2BridgeMIBCntrs.setBridgeFilteredPktCount[0])
...
#define SMEM_CHT_AU_FIFO_TO_CPU_CONF_REG(dev)                           \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.FDBAddrUpdateMsgs.AUFIFOToCPUConfig)
...
#define SMEM_CHT_MAC_TBL_INTR_CAUSE_MASK_REG(dev)                        \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.FDBInterrupt.FDBInterruptMaskReg)
...
#define SMEM_CHT_MAC_TBL_INTR_CAUSE_REG(dev)                             \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.FDBInterrupt.FDBInterruptCauseReg)
...
#define SMEM_CHT_LEARN_ENTRY_DISCARD_CNT_REG(dev)                        \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.sourceAddrNotLearntCntr.learnedEntryDiscardsCount)

/* MAC Table Action0 Register - Cht/Cht2 */
#define SMEM_CHT_MAC_TBL_ACTION0_REG(dev)               \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.FDBAction.FDBAction[0])

/* MAC Table Action2 Register - Cht/Cht2... */
#define SMEM_CHT_MAC_TBL_ACTION2_REG(dev)               \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.FDBAction.FDBAction[2])

/* CNC block client interrupt cause register */
#define SMEM_CHT_CNC_BLOCK_CLIENT_INTR_CAUSE_REG(block, client)               \
    (SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->CNC[0].perBlockRegs.clientInterrupts.CNCBlockClientInterruptCauseRegister[block][client])

/* CNC block client interrupt mask register */
#define SMEM_CHT_CNC_BLOCK_CLIENT_INTR_MASK_REG(block, client)               \
    (SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->CNC[0].perBlockRegs.clientInterrupts.CNCBlockClientInterruptMaskRegister[block][client])


/* Policers Global Configuration Register - Cht/Cht2 */
#define SMEM_CHT_POLICER_GLB_CONF_REG(dev, cycle) \
        SMEM_XCAT_POLICER_GLB_CONF_REG(dev, cycle)

/* Unicast Routing Engine Configuration Register - Cht/Cht2 */
#define SMEM_CHT_UC_ROUT_ENG_CONF_REG(dev) \
        SMEM_XCAT_UC_ROUT_ENG_CONF_REG(dev)
...
#define SMEM_CHT_MAC_TBL_ACC_DATA0_REG(dev)                              \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.FDBDirectAccess.FDBDirectAccessData[0])
...
#define SMEM_CHT_INGR_PORT_BRDG_CONF0_REG(dev, port) \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ingrPortsBridgeConfig.ingrPortBridgeConfig0[CPU_PORT_INDEX(dev, port)]

/* Ingress Port<n> Bridge Configuration
    Register1 (0<=n<27, CPU Port n= 0x3F) , Cht/Cht2 */
#define SMEM_CHT_INGR_PORT_BRDG_CONF1_REG(dev, port) \
     (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ingrPortsBridgeConfig.ingrPortBridgeConfig1[CPU_PORT_INDEX(dev, port)]
...
#define SMEM_CHT_IPV6_ICMP_MSG_TYPE_CONF_REG(dev, entry_index) \
     ...
     (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ctrlTrafficToCPUConfig.IPv6ICMPMsgTypeConfig[(entry_index / 4)])
...
#define SMEM_CHT_IPV4_MCST_LINK_LOCAL_CONF_REG(dev, entry_index) \
     ...
     (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ctrlTrafficToCPUConfig.IPv4McLinkLocalConfig[(entry_index)])
...
#define SMEM_CHT_IPV6_MCST_LINK_LOCAL_CONF_REG(dev, entry_index) \
     ...
     (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ctrlTrafficToCPUConfig.IPv6McLinkLocalConfig[(entry_index)])
...
#define SMEM_CHT_PORTS_MIB_CNT_INT_SUM_REG(dev)                          \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->LMS.LMS0.MIBCntrsInterruptSummary

/* Tri-speed ports MIB Counters Interrupt Summary Mask Register , Cht/Cht2 */
#define SMEM_CHT_PORTS_MIB_CNT_INT_SUM_MASK_REG(dev)            \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->LMS.LMS0LMS0Group0.portsMIBCntrsInterruptSummaryMask
...
#define SMEM_CHT_CPU_PORT_GOOD_FRAMES_COUNT_REG(dev)                     \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.cpuPortConfigRegAndMIBCntrs.cpuPortGoodFramesReceivedCntr

/* CPU Port GoodOctetsReceived Counter , Cht/Cht2 */
#define SMEM_CHT_CPU_PORT_GOOD_OCTETS_COUNT_REG(dev)                     \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.cpuPortConfigRegAndMIBCntrs.cpuPortGoodOctetsReceivedCntr
...
#define SMEM_CHT_MAC_QOS_TBL_ENTRY_REG(dev, entry_index) \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.MACBasedQoSTable.MACQoSTableEntry[entry_index])
...
#define SMEM_CHT_TRUNK_TBL_DATA_REG(dev)                               \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.trunksMembersTable.trunkTableDataAccess)

/* QoSProfile to QoS table Data Access Register , Cht/Cht2 */
#define SMEM_CHT_QOS_PROFILE_DATA_REG(dev)                               \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.qoSProfileToQoSTable.qoSProfileToQoSTableDataAccess)

/* CPU Code Table Data Access Register , Cht/Cht2 */
#define SMEM_CHT_CPU_CODE_DATA_REG(dev)                                  \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.CPUCodeTable.CPUCodeTableDataAccess)

/* Statistical Rate Limits Table Data Access Register , Cht/Cht2 */
#define SMEM_CHT_STAT_RATE_LIMIT_DATA_REG(dev)                           \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.statisticalRateLimitsTable.statisticalRateLimitsTableDataAccess)

/* Ingress STC Table Word0 Access Register , Cht/Cht2 */
#define SMEM_CHT_INGR_STC_TBL_WORD0_REG(dev)                             \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.ingrSTCTable.ingrSTCTableWord0Access)
...
#define SMEM_CHT_INGR_DROP_CNT_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.ingrDropCntr.ingrDropCntr)
...
#define SMEM_CHT_INGR_DROP_CNT_CONFIG_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.ingrDropCntr.ingrDropCntrConfig)
...
#define SMEM_CHT_SDMA_CONFIG_REG(dev)                                    \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.SDMARegs.SDMAConfig
...
#define SMEM_CHT_TX_SDMA_CUR_DESC_PTR0_REG(dev)                          \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.SDMARegs.transmitSDMACurrentDescPointer[0]
...
#define SMEM_CHT_BRIDGE_INT_CAUSE_REG(dev)                               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.bridgeEngineInterrupts.bridgeInterruptCause)
...
#define SMEM_CHT_BRIDGE_INT_MASK_CAUSE_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.bridgeEngineInterrupts.bridgeInterruptMask)

/* Indirect tables */

/* SDMA Interrupt Mask Register , Cht/Cht2 */
#define SMEM_CHT_SDMA_INT_MASK_REG(dev,treeId)                                  \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.globalInterrupt[treeId].SDMARegs.receiveSDMAInterruptMask

/* SDMA Interrupt Registers , Cht/Cht2 */
#define SMEM_CHT_SDMA_INT_CAUSE_REG(dev,treeId)                                 \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.globalInterrupt[treeId].SDMARegs.receiveSDMAInterruptCause

/* Transmit SDMA Interrupt Cause Register , Cht/Cht2 */
#define SMEM_CHT_TX_SDMA_INT_CAUSE_REG(dev,treeId)                              \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.globalInterrupt[treeId].SDMARegs.transmitSDMAInterruptCause

/* Transmit SDMA Interrupt Mask Register  , Cht/Cht2 */
#define SMEM_CHT_TX_SDMA_INT_MASK_REG(dev,treeId)                               \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.globalInterrupt[treeId].SDMARegs.transmitSDMAInterruptMask
...
#define SMEM_CHT_INGRESS_STC_CONF_REG(dev)                               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.ingrSTCConfig.ingrSTCConfig)
...
#define SMEM_CHT_EQ_INT_CAUSE_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.preEgrInterrupt.preEgrInterruptSummary)
...
#define SMEM_CHT_EQ_INT_MASK_REG(dev)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.preEgrInterrupt.preEgrInterruptSummaryMask)
...
#define SMEM_CHT_INGRESS_STC_INT_CAUSE_REG(dev,port)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.ingrSTCInterrupt.ingrSTCInterruptCause)
...
#define SMEM_CHT_INGRESS_STC_INT_MASK_REG(dev,port)                          \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.ingrSTCInterrupt.ingrSTCInterruptMask)
...
#define SMEM_CHT_STAT_SNIF_CONF_REG(dev)                                 \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.mirrToAnalyzerPortConfigs.ingrStatisticMirrToAnalyzerPortConfig)
...
#define SMEM_CHT_EGR_MON_EN_CONF_REG(dev)                                \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.mirrToAnalyzerPortConfigs.egrMonitoringEnableConfig[0])
...
#define SMEM_CHT_INGR_EGR_MON_TO_ANALYZER_QOS_CONF_REG(dev)              \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.mirrToAnalyzerPortConfigs.ingrAndEgrMonitoringToAnalyzerQoSConfig)
...
#define SMEM_CHT_TRG_DEV_CONF0_REG(dev)                                 \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.CPUTargetDeviceConfig.CPUTargetDeviceConfigReg0)
...
#define SMEM_CHT_TRG_DEV_CONF1_REG(dev)                                  \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.CPUTargetDeviceConfig.CPUTargetDeviceConfigReg1)

/* Cht/Cht2 */
#define SFDB_CHT_DEVICE_TBL_MEM(dev)                             \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->FDB.deviceTable.deviceTable)
...
/* Cht/Cht2/Cht3.. sip5,sip7 (NOT to be used by sip6) */
/* for SIP6 see use of SMEM_SIP6_HIDDEN_FDB_PTR(...) */
#define SMEM_CHT_MAC_TBL_MEM(dev, entry_index) \
    SMEM_TABLE_ENTRY_INDEX_GET_MAC(dev,fdbTable,entry_index)
...
#define SMEM_CHT_ARP_TBL_MEM(dev, entry_index) \
    SMEM_TABLE_ENTRY_INDEX_GET_MAC(dev,arpTable,entry_index)
...
#define SMEM_CHT_CPU_PORT_GOOD_FRM_CNT_REG(dev)                          \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.cpuPortConfigRegAndMIBCntrs.cpuPortGoodFramesSentCntr

/* Cht/Cht2 */
#define SMEM_CHT_CPU_PORT_GOOD_OCT_CNT_REG(dev)                          \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.cpuPortConfigRegAndMIBCntrs.cpuPortGoodOctetsSentCntr

/* Receive SDMA Current Rx Descriptor Pointer [7:0] (CRDPx) Register , Cht/Cht2  */
#define SMEM_CHT_RX_QUEUE_EN_REG(dev)                                    \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.SDMARegs.receiveSDMAQueueCommand
...
#define SMEM_CHT1_MIB_COUNT_CONTROL_REG(dev,port) \
     ((port < 6)  ? (SMEM_CHT_MAC_REG_DB_GET(dev))->LMS.LMS0.MIBCntrsCtrlReg0forPorts0Through5 : \
...
#define SMEM_CHT_CUR_RX_DESC_POINTER_REG(dev, rxQueue) \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.SDMARegs.receiveSDMACurrentDescPointer[rxQueue]

/* Receive SDMA<n> Packet Count Register , Cht/Cht2 */
#define SMEM_CHT_PACKET_COUNT_REG(dev, rxQueue)  \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.SDMARegs.receiveSDMAPktCount[rxQueue]

/* Receive SDMA<n> Byte Count Register , Cht/Cht2 */
#define SMEM_CHT_BYTE_COUNT_REG(dev, rxQueue)    \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->MG.SDMARegs.receiveSDMAByteCount[rxQueue]
...
/* start register SMEM_CHT_CNC_BLOCK_CLIENT_INTR_CAUSE_REG */
    /* Block<n> client<m> Exceed block size */
    #define SMEM_CHT_CNC_BLOCK_LIMIT_EXCEED_INT            (1 << 2)

/* end register SMEM_CHT_CNC_BLOCK_CLIENT_INTR_CAUSE_REG */
...
#define  SMEM_CHT_XG_PORT_CAUSE_INT_SUM_BMP(dev,port)      \
     (1 << (dev)->globalInterruptCauseRegister.global1)
...
#define SMEM_CHT_PCL_GLOBAL_REG(dev) \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->IPCL.ingrPolicyGlobalConfig)
...
#define SMEM_CHT_BRIDGE_GLOBAL_CONF2_REG(dev)   \
    (SMEM_CHT_IS_SIP5_GET(dev)  ? SMAIN_NOT_VALID_CNS : \
     SMEM_CHT_MAC_REG_DB_GET(dev)->L2I.bridgeEngineConfig.bridgeGlobalConfig[2] )
...
#define SMEM_CHT_PRE_EGR_GLB_CONF_REG(dev) \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->EQ.preEgrEngineGlobalConfig.preEgrEngineGlobalConfig)
...
#define SMEM_CHT_IP_PROT_CPU_CODE_VALID_CONF_REG(dev) \
        SMEM_CHT2_IP_PROT_CPU_CODE_VALID_CONF_REG(dev)
...
#define     SMEM_CHT_TRI_SPEED_PORTS_INTERRUPT_SUMMARY_REG(dev)     \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->LMS.LMS1.portsInterruptSummary

/* not applicable to CH1 devices */
#define     SMEM_CHT_TRI_SPEED_PORTS_INTERRUPT_SUMMARY_MASK_REG(dev)     \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->LMS.LMS0LMS0Group0.portsInterruptSummaryMask
...
#define SMEM_CHT_INGR_RATE_LIMIT_CONF0_REG(dev)               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ingrPortsRateLimitConfig.ingrRateLimitConfig0 )
...
#define SMEM_CHT_INGR_RATE_LIMIT_CONF1_REG(dev)               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ingrPortsRateLimitConfig.ingrRateLimitConfig1 )
...
#define SMEM_CHT_INGR_PORT_RATE_LIMIT_CNT_REG(dev, port) \
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ingrPortsRateLimitConfig.portRateLimitCntr[port]
...
#define SMEM_CHT_INGR_RATE_LIMIT_DROP_CNT_0_REG(dev)               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ingrPortsRateLimitConfig.ingrRateLimitDropCntr310)
...
#define SMEM_CHT_INGR_RATE_LIMIT_DROP_CNT_1_REG(dev)               \
    ...
    (SMEM_CHT_MAC_REG_DB_GET(dev))->L2I.ingrPortsRateLimitConfig.ingrRateLimitDropCntr3932)

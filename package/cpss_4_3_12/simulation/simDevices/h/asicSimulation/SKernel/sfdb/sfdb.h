...
/**
* @enum SIP7_SFDB_UPDATE_MSG_TYPE
 *
...
typedef enum{
    ...
    /** New address */
    SIP7_SFDB_UPDATE_MSG_NA_E = 1,

    /** Moved address */
    SIP7_SFDB_UPDATE_MSG_MOVED_E = 2,

    /** Query Address */
    SIP7_SFDB_UPDATE_MSG_QA_E = 3,

    /** Query Respond */
    SIP7_SFDB_UPDATE_MSG_QR_E = 4,

    /** Aged Out Address */
    SIP7_SFDB_UPDATE_MSG_AA_E = 5,

    /** Transplanted Address */
    SIP7_SFDB_UPDATE_MSG_TA_E = 6,

    /** FDB Upload message */
    SIP7_SFDB_UPDATE_MSG_FU_E = 7,

    /** Index Query Request and Index Query Respond */
    SIP7_SFDB_UPDATE_MSG_QI_E = 8,

    /** FDB Hash Request */
    SIP7_SFDB_UPDATE_MSG_HR_E = 9,

} SIP7_SFDB_UPDATE_MSG_TYPE;
/**

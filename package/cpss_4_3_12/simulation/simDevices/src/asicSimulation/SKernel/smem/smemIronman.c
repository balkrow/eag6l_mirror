...
#define LMU_0_BASE_ADDR 0x91080000
#define TSU_0_BASE_ADDR 0x91000000

#define IM_NUM_TSU_UNITS  1
...
#define MTIP_UNIT_USX_MAC_BR_0_BASE_ADDR  0x98000000 /* BR:      0..7 */
#define MTIP_UNIT_USX_MAC_BR_1_BASE_ADDR  0x99000000 /* BR:      8..15*/
#define MTIP_UNIT_USX_MAC_BR_2_BASE_ADDR  0x93000000 /* BR:     16..23*/
#define MTIP_UNIT_USX_MAC_NON_BR_0_BASE_ADDR  0x98100000 /* NON-BR: 24..31*/
#define MTIP_UNIT_USX_MAC_NON_BR_1_BASE_ADDR  0x99100000 /* NON-BR: 32..39*/
#define MTIP_UNIT_USX_MAC_NON_BR_2_BASE_ADDR  0x93100000 /* NON-BR: 40..47*/

#define MTIP_UNIT_CPU_MAC_BR_0_BASE_ADDR  0x91600000 /* BR:      48 */
#define MTIP_UNIT_CPU_MAC_BR_1_BASE_ADDR  0x91700000 /* BR:      49 */
#define MTIP_UNIT_CPU_MAC_BR_2_BASE_ADDR  0x91800000 /* BR:      50 */
#define MTIP_UNIT_CPU_MAC_BR_3_BASE_ADDR  0x91900000 /* BR:      51 */
#define MTIP_UNIT_CPU_MAC_NON_BR_0_BASE_ADDR  0x98200000 /* NON-BR:  52*/
#define MTIP_UNIT_CPU_MAC_NON_BR_1_BASE_ADDR  0x99200000 /* NON-BR:  53*/
#define MTIP_UNIT_CPU_MAC_NON_BR_2_BASE_ADDR  0x93200000 /* NON-BR:  54*/

#define MTIP_UNIT_USX_PCS_0_BASE_ADDR  0x98300000 /* PCS 10G x8 */
#define MTIP_UNIT_USX_PCS_1_BASE_ADDR  0x99300000 /* PCS 10G x8 */
#define MTIP_UNIT_USX_PCS_2_BASE_ADDR  0x93300000 /* PCS 10G x8 */
#define MTIP_UNIT_USX_PCS_3_BASE_ADDR  0x98400000 /* PCS 10G x8 */
#define MTIP_UNIT_USX_PCS_4_BASE_ADDR  0x99400000 /* PCS 10G x8 */
#define MTIP_UNIT_USX_PCS_5_BASE_ADDR  0x93400000 /* PCS 10G x8 */

#define MTIP_UNIT_CPU_PCS_0_BASE_ADDR  0x91A00000 /* PCS 10G x1 */
#define MTIP_UNIT_CPU_PCS_1_BASE_ADDR  0x91B00000 /* PCS 10G x1 */
#define MTIP_UNIT_CPU_PCS_2_BASE_ADDR  0x91C00000 /* PCS 10G x1 */
#define MTIP_UNIT_CPU_PCS_3_BASE_ADDR  0x91D00000 /* PCS 10G x1 */
#define MTIP_UNIT_CPU_PCS_4_BASE_ADDR  0x98500000 /* PCS 10G x1 */
#define MTIP_UNIT_CPU_PCS_5_BASE_ADDR  0x99500000 /* PCS 10G x1 */
#define MTIP_UNIT_CPU_PCS_6_BASE_ADDR  0x93500000 /* PCS 10G x1 */
...
#define ANP_0_BASE_ADDR         0x98800000      /* SD 0..2 */ /* PCS */
#define ANP_1_BASE_ADDR         0x98900000      /* SD 0..2 */
#define ANP_2_BASE_ADDR         0x98A00000      /* SD 0..2 */
#define ANP_3_BASE_ADDR         0x98B00000      /* SD 0..2 */
#define ANP_4_BASE_ADDR         0x98C00000      /* SD 0..2 */
#define ANP_5_BASE_ADDR         0x99800000      /* SD 3..5 */
#define ANP_6_BASE_ADDR         0x99900000      /* SD 3..5 */
#define ANP_7_BASE_ADDR         0x99A00000      /* SD 3..5 */
#define ANP_8_BASE_ADDR         0x99B00000      /* SD 3..5 */
#define ANP_9_BASE_ADDR         0x99C00000      /* SD 3..5 */
#define ANP_10_BASE_ADDR        0x93800000      /* SD 6..8 */
#define ANP_11_BASE_ADDR        0x93900000      /* SD 6..8 */
#define ANP_12_BASE_ADDR        0x93A00000      /* SD 6..8 */
#define ANP_13_BASE_ADDR        0x93B00000      /* SD 6..8 */
#define ANP_14_BASE_ADDR        0x93C00000      /* SD 6..8 */
#define ANP_15_BASE_ADDR        0x91E00000      /* SD 9 */
#define ANP_16_BASE_ADDR        0x91F00000      /* SD 10 */
#define ANP_17_BASE_ADDR        0x92000000      /* SD 11 */
#define ANP_18_BASE_ADDR        0x92100000      /* SD 12 */

#define SDW0_BASE_ADDR          0x99D00000
#define SDW1_BASE_ADDR          0x99D80000
#define SDW2_BASE_ADDR          0x99E00000
#define SDW3_BASE_ADDR          0x99E80000
#define SDW4_BASE_ADDR          0x99F00000
#define SDW5_BASE_ADDR          0x99F80000
#define SDW6_BASE_ADDR          0x9A000000
#define SDW7_BASE_ADDR          0x91300000
#define SDW8_BASE_ADDR          0x91380000
#define SDW9_BASE_ADDR          0x91400000
#define SDW10_BASE_ADDR         0x91480000
#define SDW11_BASE_ADDR         0x91500000
#define SDW12_BASE_ADDR         0x91580000
...
#define PORT0_100G_OFFSET         0x00003000 /* currently use value like in phoenix  */
...
/********** start : PCS for usx *********/
#define USX_PCS_PORTS_OFFSET      0x00002000
#define USX_PCS_LPCS_OFFSET       0x00001000
#define USX_PCS_EXT_OFFSET        0x00000000
...
/*    ,UNIT_INFO_MAC(0x0cf00000,UNIT_IA                ,64  *     _1K)*/
    ...
    /* PGC */
    ,UNIT_INFO_MAC(0x90B00000,UNIT_PCA_PGC_RX_E           ,512 * _1K )
    ,UNIT_INFO_MAC(0x90D00000,UNIT_PCA_PGC_TX_E           ,512 * _1K )
...
/*  ,UNIT_INFO_MAC(0x--------,UNIT_SHM               ,64  *     _1K) no such unit */
    ...
    ,UNIT_INFO_MAC(0x98700000,UNIT_LED_0             ,1   * _1M)
    ,UNIT_INFO_MAC(0x99700000,UNIT_LED_1             ,1   * _1M)
    ,UNIT_INFO_MAC(0x93700000,UNIT_LED_2             ,1   * _1M)
    ,UNIT_INFO_MAC(0x92200000,UNIT_LED_3             ,1   * _1M)
    ...
    ,UNIT_INFO_MAC(0x7FE00000,UNIT_CNM_SRAM    ,512   *     _1K) /*in CnM */
    ...
    ,UNIT_INFO_MAC(MTIP_UNIT_USX_MAC_BR_0_BASE_ADDR,  UNIT_USX_MAC_BR_0              ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_USX_MAC_BR_1_BASE_ADDR,  UNIT_USX_MAC_BR_1              ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_USX_MAC_BR_2_BASE_ADDR,  UNIT_USX_MAC_BR_2              ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_USX_MAC_NON_BR_0_BASE_ADDR,  UNIT_USX_MAC_NON_BR_0      ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_USX_MAC_NON_BR_1_BASE_ADDR,  UNIT_USX_MAC_NON_BR_1      ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_USX_MAC_NON_BR_2_BASE_ADDR,  UNIT_USX_MAC_NON_BR_2      ,64 * _1K)

    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_MAC_BR_0_BASE_ADDR,  UNIT_CPU_MAC_BR_0              ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_MAC_BR_1_BASE_ADDR,  UNIT_CPU_MAC_BR_1              ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_MAC_BR_2_BASE_ADDR,  UNIT_CPU_MAC_BR_2              ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_MAC_BR_3_BASE_ADDR,  UNIT_CPU_MAC_BR_3              ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_MAC_NON_BR_0_BASE_ADDR,  UNIT_CPU_MAC_NON_BR_0      ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_MAC_NON_BR_1_BASE_ADDR,  UNIT_CPU_MAC_NON_BR_1      ,64 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_MAC_NON_BR_2_BASE_ADDR,  UNIT_CPU_MAC_NON_BR_2      ,64 * _1K)

    ,UNIT_INFO_MAC(MTIP_UNIT_USX_PCS_0_BASE_ADDR,  UNIT_USX_PCS_0              ,32 * _1K)
    ...
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_PCS_0_BASE_ADDR,  UNIT_CPU_PCS_0              ,32 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_PCS_1_BASE_ADDR,  UNIT_CPU_PCS_1              ,32 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_PCS_2_BASE_ADDR,  UNIT_CPU_PCS_2              ,32 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_PCS_3_BASE_ADDR,  UNIT_CPU_PCS_3              ,32 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_PCS_4_BASE_ADDR,  UNIT_CPU_PCS_4              ,32 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_PCS_5_BASE_ADDR,  UNIT_CPU_PCS_5              ,32 * _1K)
    ,UNIT_INFO_MAC(MTIP_UNIT_CPU_PCS_6_BASE_ADDR,  UNIT_CPU_PCS_6              ,32 * _1K)
    ...
    ,UNIT_INFO_MAC(ANP_17_BASE_ADDR, UNIT_ANP_17             ,64   *     _1K)
    ,UNIT_INFO_MAC(ANP_18_BASE_ADDR, UNIT_ANP_18             ,64   *     _1K)

    ,UNIT_INFO_MAC(SDW0_BASE_ADDR,   UNIT_SERDES_0_0         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW1_BASE_ADDR,   UNIT_SERDES_0_1         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW2_BASE_ADDR,   UNIT_SERDES_0_2         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW3_BASE_ADDR,   UNIT_SERDES_0_3         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW4_BASE_ADDR,   UNIT_SERDES_0_4         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW5_BASE_ADDR,   UNIT_SERDES_0_5         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW6_BASE_ADDR,   UNIT_SERDES_0_6         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW7_BASE_ADDR,   UNIT_SERDES_0_7         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW8_BASE_ADDR,   UNIT_SERDES_0_8         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW9_BASE_ADDR,   UNIT_SERDES_0_9         ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW10_BASE_ADDR,  UNIT_SERDES_0_10        ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW11_BASE_ADDR,  UNIT_SERDES_0_11        ,512  *     _1K)
    ,UNIT_INFO_MAC(SDW12_BASE_ADDR,  UNIT_SERDES_0_12        ,512  *     _1K)
...
#define sip6_MTI_EXTERNAL_representativePortIndex_base_ironmanCpuPortsArr 0
...
static MAC_NUM_INFO_STC ironmanCpuPortsArr[] = {
     {48 ,           {0, 0} ,    {0, 48}      ,0+sip6_MTI_EXTERNAL_representativePortIndex_base_ironmanCpuPortsArr    }
    ,{49 ,           {1, 0} ,    {0, 49}      ,1+sip6_MTI_EXTERNAL_representativePortIndex_base_ironmanCpuPortsArr    }
    ,{50 ,           {2, 0} ,    {0, 50}      ,2+sip6_MTI_EXTERNAL_representativePortIndex_base_ironmanCpuPortsArr    }
    ,{51 ,           {3, 0} ,    {0, 51}      ,3+sip6_MTI_EXTERNAL_representativePortIndex_base_ironmanCpuPortsArr    }
    ,{52 ,           {4, 0} ,    {0, 52}      ,4+sip6_MTI_EXTERNAL_representativePortIndex_base_ironmanCpuPortsArr    }
    ,{53 ,           {5, 0} ,    {0, 53}      ,5+sip6_MTI_EXTERNAL_representativePortIndex_base_ironmanCpuPortsArr    }
    ,{54 ,           {6, 0} ,    {0, 54}      ,6+sip6_MTI_EXTERNAL_representativePortIndex_base_ironmanCpuPortsArr    }
    ,{SMAIN_NOT_VALID_CNS,{0,0},{0,0}}
};
...
static SMEM_UNIT_DUPLICATION_INFO_STC ironman_duplicatedUnits[] =
{
    ...
    {STR(UNIT_USX_MAC_BR_0)  ,2},  /* 2 more per device */
        {STR(UNIT_USX_MAC_BR_1)},
        {STR(UNIT_USX_MAC_BR_2)},

    {STR(UNIT_USX_MAC_NON_BR_0)  ,2},  /* 2 more per device */
        {STR(UNIT_USX_MAC_NON_BR_1)},
        {STR(UNIT_USX_MAC_NON_BR_2)},

    {STR(UNIT_CPU_MAC_BR_0)  ,3},  /* 3 more per device */
        {STR(UNIT_CPU_MAC_BR_1)},
        {STR(UNIT_CPU_MAC_BR_2)},
        {STR(UNIT_CPU_MAC_BR_3)},

    {STR(UNIT_CPU_MAC_NON_BR_0)  ,2},  /* 3 more per device */
        {STR(UNIT_CPU_MAC_NON_BR_1)},
        {STR(UNIT_CPU_MAC_NON_BR_2)},

    {STR(UNIT_USX_PCS_0)  ,5},  /* 2 more per device */
        {STR(UNIT_USX_PCS_1)},
        {STR(UNIT_USX_PCS_2)},
        {STR(UNIT_USX_PCS_3)},
        {STR(UNIT_USX_PCS_4)},
    ...
    {STR(UNIT_CPU_PCS_0)  ,6},  /* 2 more per device */
        {STR(UNIT_CPU_PCS_1)},
        {STR(UNIT_CPU_PCS_2)},
        {STR(UNIT_CPU_PCS_3)},
        {STR(UNIT_CPU_PCS_4)},
    ...
    {STR(UNIT_ANP_0)  ,18},  /* 2 more per device */
        {STR(UNIT_ANP_1)},
        {STR(UNIT_ANP_2)},
        {STR(UNIT_ANP_3)},
        {STR(UNIT_ANP_4)},
    ...
    {STR(UNIT_SERDES_0_0)  ,12},  /* 4 more per device */
        {STR(UNIT_SERDES_0_1)},
        {STR(UNIT_SERDES_0_2)},
        {STR(UNIT_SERDES_0_3)},
        {STR(UNIT_SERDES_0_4)},
        ...
        {STR(UNIT_SERDES_0_8)},
        {STR(UNIT_SERDES_0_9)},
        {STR(UNIT_SERDES_0_10)},
        {STR(UNIT_SERDES_0_11)},
        {STR(UNIT_SERDES_0_12)},
    ...
    {STR(UNIT_PCA_PGC_RX_E)     ,1}, /* 1 duplication of this unit */
        {STR(UNIT_PCA_PGC_TX_E)},
...
)
{
    ...
    for (ii=0; ii<IM_NUM_TSU_UNITS; ii++)
    {
            ...
            address <  (devObjPtr->memUnitBaseAddrInfo.tsu[ii] + (512 *_1K)))
        {
            ...
            {
                skernelFatalError("smemIronmanGopPortByAddrGet : unknown port for address [0x%8.8x] as 'TSU unit' (case 1)\n",address);
                return 0;
            }
            ...
            {
                if(ironmanUsxPortsArr[ii].channelInfo.unitIndex   == unitIndex &&
                   ironmanUsxPortsArr[ii].channelInfo.indexInUnit == localPortInUnit)
                {
                    return ironmanUsxPortsArr[ii].globalMacNum;
                }
            }
            for(ii = 0 ; ironmanCpuPortsArr[ii].globalMacNum != SMAIN_NOT_VALID_CNS; ii++)
            {
                if(ironmanCpuPortsArr[ii].channelInfo.unitIndex   == unitIndex &&
                   ironmanCpuPortsArr[ii].channelInfo.indexInUnit == localPortInUnit)
                {
                    return ironmanCpuPortsArr[ii].globalMacNum;
                }
            }
            return SMAIN_NOT_VALID_CNS;
        }
    ...
    if(isCpuPort)
    {
        ...
        for(ii = 0 ; ironmanCpuPortsArr[ii].globalMacNum != SMAIN_NOT_VALID_CNS; ii++)
        {
            if(ironmanCpuPortsArr[ii].macInfo.unitIndex == unitIndex)
            {
        ...
        skernelFatalError("smemIronmanGopPortByAddrGet : in CPU mac : unknown cpu port for address [0x%8.8x] as 'Gop unit' \n",
            address);
        return 0;
    }
    /***************************/
    /* End of CPU port section */
    /***************************/
        ...
        ii++)
    {
           ...
           address <  (devObjPtr->memUnitBaseAddrInfo.macWrap[ii] + MAC_UNIT_SIZE) )
        {
            ...
            if((address >= unitBase) && (address < (unitBase + 0x1000)))
            {
                ...
                {
                    /* rx registers */
                    localPortInUnit = (address - unitBase) / (35 * 0x4);
                    break;
                }
                ...
                {
                    /* tx registers */
                    localPortInUnit = (address - unitBase) / (26 * 0x4);
                    break;
                }
            ...
            if(address >= unitBase + 0x00000100 &&
               address < (unitBase + 0x00000124 + (NUM_PORTS_PER_USX_UNIT * 0x100)))
            {
                localPortInUnit = (address - (unitBase + 0x00000100)) / 0x100;
                break;
            }
            ...
            /* SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.tsqTimestamp */
            if ((address & 0xFF) == 0xB0)
            {
                index = ((address >> 8) & 0xFF);
                if ((index >= 1) && (index <= 8))
                {
                    localPortInUnit = index -1;
                    break;
                }
            }
            break; /* common to the unit */
        ...
        if(address >=  (devObjPtr->memUnitBaseAddrInfo.macPcs[ii] + 0x30) &&
           address <=  (devObjPtr->memUnitBaseAddrInfo.macPcs[ii] + 0xAC) )
        {
            unitBase = devObjPtr->memUnitBaseAddrInfo.macPcs[ii];
            /*
                n: [0..7] * 0x4
                ...
                Port<%n> Status
                CPU 0x93300050
                Port<%n> Interrupt Cause
                CPU 0x93300070
                Port<%n> Interrupt Mask
                CPU 0x93300090
                Port<%n> Control
            */
            localPortInUnit = ((address - (unitBase + USX_PCS_EXT_OFFSET + 0x30)) % 0x20) / 4;
            break;
        }
...
static const MIF_TO_MAC_RANGE_MAP_STC smemChtIronmanMIFtoMAC_MappingArr[] =
{
    ...
    ,{2, 16,  1, 54, 0}
    ,{3,  0,  4, 48, 0}
    ,{0,  8,  8,  0, 1} /*instead 0f 24-31*/
    ,{1,  8,  8,  8, 1} /*instead 0f 32-39*/
    ,{2,  8,  8, 16, 1} /*instead 0f 40-47*/
    ,{3,  4,  4, 52, 1}
    ,{0xFF,0, 0,  0, 0}
};

/**
* @internal smemChtIronmanGlobalMacToMifUintChannel function
* @endinternal
*
...
/**
* @internal smemChtIronmanMifFindUintChannelByGlobalDma function
* @endinternal
*
* @brief   Find MIF Unit Channel by Global DMA.
*
* @param[in]   globalDma          - Global DMA index.
* @param[in]   isTx               - 1 - Tx, 0 - Rx.
* @param[out]  mifUnitPtr         - (Pointer to) MIF unit index.
* @param[out]  mifChannelPtr      - (Pointer to) MIF Channel index.
*/
GT_STATUS smemChtIronmanMifFindUintChannelByGlobalDma
(
...
)
{
    ...
    SMEM_CHT_EPI_MIF_UNIT_REG_STC  *portDbPtr;
    GT_U32 regAddr;
    GT_U32 regValue;
    GT_U32 dmaChannelOffset;
    GT_U32 dmaEnableOffset;

    dmaEnableOffset = isTx ? 6 : 14;
    dmaChannelOffset = isTx ? 0 : 8;
    for (mifUnit = 0; (mifUnit < 4); mifUnit++)
    {
        portDbPtr = &(SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_30_MIF[0].mif8Dp.unit[mifUnit]);
        mifChannelsNum = (mifUnit < 3) ? 17 : 8;
        for (mifChannel = 0; (mifChannel < mifChannelsNum); mifChannel++)
        {
            regAddr = portDbPtr->mif_channel_mapping_register[mifChannel];
            scibReadMemory(devObjPtr->deviceId, regAddr, 1, &regValue);
            if (SMEM_U32_GET_FIELD(regValue,18,1) == 0) continue; /*clock disable*/
            if (SMEM_U32_GET_FIELD(regValue,dmaEnableOffset,1) == 0) continue; /* tx or rx enable */
            if (SMEM_U32_GET_FIELD(regValue,dmaChannelOffset,6) != globalDma) continue; /* tx or rx channel */
           *mifUnitPtr     = mifUnit;
           *mifChannelPtr  = mifChannel;
           return GT_OK;
        }
    }
    return GT_NOT_FOUND;
...
)
{
    ...
    {
        /* support generic code , that check if port supports 50G port */
        /* currently we support only USX/CPU ports */
        return GT_NOT_FOUND;
    }
    ...
    switch(unitType)
    {
        ...
        case SMEM_UNIT_TYPE_MTI_MAC_CPU_E:
            if((portNum >= 48) && (portNum <= 54))
            {
                sip6_MTI_bmpPorts = 0x1;/*single port in group*/
            }
            else
            {
                return GT_NOT_FOUND;
        ...
        switch(unitType)
        {
            ...
            case SMEM_UNIT_TYPE_PCA_LMU_CHANNEL_E:
                 if(jj ==0)
                    ...
                    tmpMacInfoPtr = ironmanCpuPortsArr;
                break;
            case SMEM_UNIT_TYPE_MTI_MAC_USX_E:
                tmpMacInfoPtr = ironmanUsxPortsArr;
                break;
            ...
            ii++,tmpMacInfoPtr++)
        {
            ...
            switch(unitType)
            {
                ...
                case SMEM_UNIT_TYPE_PCA_LMU_CHANNEL_E:
                    ...
                    /* use channel 0 in LMU for all channels */
...
/**
* @internal smemIronmanActiveWriteQbvConfigChangeTimeReq function
* @endinternal
*
...
static void smemIronmanActiveWriteQbvConfigChangeTimeReq(
    IN         SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN         GT_U32   address,
    IN         GT_U32   memSize,
    IN         GT_U32 * memPtr,
...
)
{
    ...
    DECLARE_FUNC_NAME(smemIronmanActiveWriteQbvConfigChangeTimeReq);
...
GT_BOOL  smemIronmanIsPreemptiveChannelGet
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN GT_U32                 local_dma_number
 )
{
     GT_U32 regAddr,regValue;
      DECLARE_FUNC_NAME(smemChtActiveIronmanIsPreemptiveChannelGet);
     /* check if this is preemptive channel .
            In Ironman local port is equal to global dma_number
         */

    regAddr = SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->SIP6_TXQ_SDQ[0].PortConfig.PortConfig[local_dma_number];
    smemRegGet(devObjPtr,regAddr,&regValue);
    regValue= SMEM_U32_GET_FIELD(regValue,14,1);
    __LOG(("Channel %d is %s preemptive\n",local_dma_number,regValue==1?"":"NOT"));
    return  regValue==1?GT_TRUE:GT_FALSE;
}
...
)
{
    ...
    GT_U32   dpIndex;
    GT_U32   ii,mifUnitId,baseAddr,mifUnitIdMax=devObjPtr->numOfMifs?devObjPtr->numOfMifs:SIM_MAX_MIF_UNITS;
    ...
    *memPtr = *inMemPtr;
    ...
    dpIndex %= devObjPtr->multiDataPath.maxDp;/*local DP in the pipe*/

    pipeId = smemGetCurrentPipeId(devObjPtr);

    isPreemptiveChannel = smemIronmanIsPreemptiveChannelGet(devObjPtr,new_local_dma_number);
    ...
    rc = smemChtIronmanMifUintChannelToGlobalMac(
        ...
        isPreemptiveChannel, &globalMacPort);
    if (rc != GT_OK)
    {
        /* not found ?! */
        skernelFatalError(
...
)
{
    ...
    /*Mask: \Cider \EBU-IP \DP \RxDMA IP \RxDMA 8.0 - Ironman-L \RXDMA IP IMXL {IronmanL_20201124}*/
    {
        ...
        {0x00001D84, 0xFFFFFFFF  , NULL, 0, smemHawkActiveWriteRxDmaDebugClearAllCounters, 0, NULL},
        /* CP2RX and RX2CP ROC (read only clear) counters*/
        { 0x00002080, SMEM_FULL_MASK_CNS, smemChtActiveReadCntrs, 0, NULL,0},
        { 0x00002084, SMEM_FULL_MASK_CNS, smemChtActiveReadCntrs, 0, NULL,0},
        { 0x00002100, SMEM_FULL_MASK_CNS, smemChtActiveReadCntrs, 0, NULL,0},
        { 0x00002104, SMEM_FULL_MASK_CNS, smemChtActiveReadCntrs, 0, NULL,0},
        { 0x00002110, SMEM_FULL_MASK_CNS, smemChtActiveReadCntrs, 0, NULL,0},
        { 0x00002114, SMEM_FULL_MASK_CNS, smemChtActiveReadCntrs, 0, NULL,0},
...
)
{
...

    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000700, 0x00000738)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000900, 0x00000938)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000B00, 0x00000B38)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000C00, 0x00000C38)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000D00, 0x00000D38)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000E00, 0x00000E38)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000F00, 0x00000F38)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00001000, 0x00001038)}
...

    {
        static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
        {
             {DUMMY_NAME_PTR_CNS,            0x00000000,         0x0000663f,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000004,         0x00000008,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000600,         0xffffffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x0000060C,         0x00000007,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000610,         0x00000006,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000614,         0x00000004,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000618,         0x00000004,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x0000061C,         0x00000003,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000620,         0x00000003,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000624,         0x00000002,      6,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000700,         0xffffffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x0000070C,         0x0500024c,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000710,         0x050001f8,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000714,         0x05000150,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000718,         0x05000150,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x0000071C,         0x050000fc,      8,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000900,         0xffffffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x0000090C,         0x00000020,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000910,         0x0000001a,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000914,         0x00000011,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000918,         0x0000000a,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x0000091C,         0x00000009,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000920,         0x00000006,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000924,         0x00000005,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000928,         0x00000004,      5,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000B00,         0xffffffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000B0C,         0x0a6b0100,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000B10,         0x08560046,     11,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000C00,         0xffffffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000C0C,         0x03550100,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000C10,         0x02aa0100,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000C14,         0x01aa0100,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000C18,         0x00cc0100,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000C1C,         0x00aa0100,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000C20,         0x00550100,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000C24,         0x002a0100,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000C28,         0x00110100,      5,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000D00,         0xffffffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000D0C,         0x000000c0,     12,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000E00,         0xffffffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000E0C,         0x00e000a0,     12,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000F00,         0xffffffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000F0C,         0x00010001,      6,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000F24,         0x01ff0200,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000F28,         0x00510052,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000F2C,         0x00080009,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000F30,         0x0008000f,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000F34,         0x00010001,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00000F38,         0x00010001,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00001000,         0xffffffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x0000100C,         0x0000ffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00001018,         0x000001e5,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x0000101C,         0x000000ff,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00001020,         0x000000b4,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00001024,         0x0000007d,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00001028,         0x00000005,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x0000102C,         0x00000005,      1,    0x0      }
            ,{DUMMY_NAME_PTR_CNS,            0x00001030,         0x0000ffff,      3,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00002000,         0x00000003,     2,    0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00002008,         0x00000008,     (NUM_PORTS_PER_DP_UNIT+1-2),  0x4      }
            ,{DUMMY_NAME_PTR_CNS,            0x00002200,         0x18000000,     (NUM_PORTS_PER_DP_UNIT+1),    0x4      }
...
*/
static void smemIronmanUnitPcaPgc
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
{
    /**
     * IP:  \Cider \EBU-IP \PCA \PGC IP \PGC 2.0 \PGC IP {IM-64-RTLF-3.1} \PGC IP TLU \Units
     * Mask:  \Cider \EBU-IP \PCA \PGC IP \PGC 2.0 \PGC Gen IP {IM-64-RTLF-3.1}
     *
     **/
    SMEM_CHUNK_BASIC_STC  chunksMem[]=
    {
        ...
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000700, 0x0000070C)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000800, 0x0000080C)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000900, 0x0000090C)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000A00, 0x00000A0C)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000B00, 0x00000B0C)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000C00, 0x00000C0C)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000D00, 0x00000D0C)}
        /* Profile Gaps Configuration <<%m>> */
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000E00, 0x00000E0C)}
        /* Profile Payload Configuration <<%m>> */
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000F00, 0x00000F0C)}
        /* Tested Channel Control <<%n>> */
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00001000, 0x00001004)}
        /* Tested Channel Number of Packets <<%n>> */
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00001100, 0x00001104)}

        /* Tested Channel Rate Control Status %n */
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00001200, 0x00001404)}

        /* Tested Channel Engine Prof Num and Pkt Count Status %n */
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00001400, 0x00001404)}
    };
...

    {
        static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
        {
            /* Tested Channel Control configuration */
             {DUMMY_NAME_PTR_CNS,         0x00001000,       0x000000FC,        2,    0x4      }
            ,{NULL,                       0,                0x00000000,        0,    0x0      }
        };
        static SMEM_LINK_LIST_REGISTER_DEFAULT_VALUE_STC list = {myUnit_registersDefaultValueArr,NULL};
        unitPtr->unitDefaultRegistersPtr = &list;
...
)
{
    ...
    SMEM_CHUNK_BASIC_STC  chunksMem[]=
    {
        ...
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000330, 0x0000047C)}
        /*MacSec Interrupts*/
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000500, 0x0000054C)}
    };
...
/**
* @internal smemIronmanUnitLed function
* @endinternal
*
* @brief   Allocate address type specific memories -- for the LED
*/
static void smemIronmanUnitLed
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
...
/**
* @internal smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg function
* @endinternal
*
...
*/
void smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg
(
    IN         SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN         GT_U32   address,
    IN         GT_U32   memSize,
...
)
{
    ...
    DECLARE_FUNC_NAME(smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg);
    ...
    *outMemPtr = *memPtr;
    ...
    egressPort =  smemGopPortByAddrGet(devObjPtr,address);
     ...
     __LOG(("smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg , address 0x%8.8x, egress port: %d",address, egressPort));

    snetSip6_30TimestampPortMacEgressQueueRemoveEntry(devObjPtr, egressPort);
}

/**
* @internal smemIronmanUnitUsxMacBr function
* @endinternal
*
* @brief   Allocate address type specific memories - for the USX MAC
*/
static void smemIronmanUnitUsxMacBr
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
{
    {
        START_BIND_UNIT_ACTIVE_MEM_MAC(devObjPtr,unitPtr)
            ...
            */
            ...
            /*0x0000010c + 0x200*portIndex + unitOffset*/
            /* SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portInterruptCause */
            {MAC_EXT_BASE_OFFSET + 0x0000010c + 0x100*0, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x0000010c + 0x100*1, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x0000010c + 0x100*2, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x0000010c + 0x100*3, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x0000010c + 0x100*4, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x0000010c + 0x100*5, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x0000010c + 0x100*6, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x0000010c + 0x100*7, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},

            /* SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portInterruptMask */
            {MAC_EXT_BASE_OFFSET + 0x00000110 + 0x100*0, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWritePortInterruptsMaskReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x00000110 + 0x100*1, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWritePortInterruptsMaskReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x00000110 + 0x100*2, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWritePortInterruptsMaskReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x00000110 + 0x100*3, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWritePortInterruptsMaskReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x00000110 + 0x100*4, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWritePortInterruptsMaskReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x00000110 + 0x100*5, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWritePortInterruptsMaskReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x00000110 + 0x100*6, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWritePortInterruptsMaskReg, 0},
            {MAC_EXT_BASE_OFFSET + 0x00000110 + 0x100*7, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWritePortInterruptsMaskReg, 0},

            /* Egress MAC TSQ */
            /* SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.tsqTimestamp */
            {0x000001B0,SMEM_FULL_MASK_CNS,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_BR_8_PORT: port 0, address 0x1B0 */
            {0x000002B0,SMEM_FULL_MASK_CNS-0x100,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_BR_8_PORT: ports 1..2, address 0x2B0,0x3B0 */
            {0x000004B0,SMEM_FULL_MASK_CNS-0x300,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_BR_8_PORT: port3 3..6, address 0x4B0,0x5B0,0x6B0,0x7bB0 */
            {0x000008B0,SMEM_FULL_MASK_CNS,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_BR_8_PORT: port 8, address 0x8B0 */
...

    {
        SMEM_CHUNK_EXTENDED_STC  chunksMem[]=
        {
            ...
            /*start of port EXT*/
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000100, 0x00000128)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000130, 0x0000016C)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000180, 0x000001FC)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
            /*end of port EXT*/

            /*start of pmac*/
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3000, 0x3000)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3008, 0x3014)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3020, 0x3024)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3040, 0x304C)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3054, 0x3074)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x307C, 0x3080)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30A8, 0x30B0)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30B8, 0x30B8)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30C0, 0x30C0)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30C8, 0x30C8)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30D0, 0x30D0)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30D8, 0x30D8)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30E0, 0x30F8)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            /*end of pmac*/

            /*start of emac*/
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3108, 0x3114)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3120, 0x3120)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3154, 0x3154)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3164, 0x3164)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3174, 0x3174)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x31A4, 0x31A4)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            /*end of emac*/

            /*start of MIB*/
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1000, 0x1014)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x101C, 0x1A24)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1AB4, 0x1B18)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1BA8, 0x1C0C)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1C9C, 0x1D00)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1D90, 0x1DF4)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1E84, 0x1EE8)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1F78, 0x1FDC)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x206C, 0x20D0)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x2160, 0x21C4)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x2254, 0x22B8)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x2348, 0x23AC)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x243C, 0x24A0)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x2530, 0x2594)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x2624, 0x2688)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x2718, 0x277C)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x280C, 0x2870)}}
...

    {
        ...
        {
            /* Global EXT */
             {DUMMY_NAME_PTR_CNS, 0x00000004,         0x0000c350,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00000008,         0x0000aa30,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00000024,         0x0000ffff,      1,    0x0}

            /*port EXT */
            ,{DUMMY_NAME_PTR_CNS, 0x00000100,         0x0012fd10,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS, 0x00000124,         0x0000000f,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS, 0x00000130,         0x00000001,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS, 0x0000014c,         0x00000043,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS, 0x00000180,         0x01000100,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS, 0x00000198,         0x00000007,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS, 0x0000019c,         0x00000043,      8,    0x100}

            /*pmac*/
            ,{DUMMY_NAME_PTR_CNS, 0x00003000,         0x00010300,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
            ,{DUMMY_NAME_PTR_CNS, 0x00003014,         0x00000600,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
            ,{DUMMY_NAME_PTR_CNS, 0x00003020,         0x00000003,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
            ,{DUMMY_NAME_PTR_CNS, 0x00003040,         0x00600360,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
            ,{DUMMY_NAME_PTR_CNS, 0x00003044,         0x0000000c,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
            ,{DUMMY_NAME_PTR_CNS, 0x00003080,         0x00000101,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
            ,{DUMMY_NAME_PTR_CNS, 0x000030a8,         0x01780a00,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
            ,{DUMMY_NAME_PTR_CNS, 0x000030ac,         0x00000001,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}

            /*emac*/
            ,{DUMMY_NAME_PTR_CNS, 0x00003114,         0x00000600,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
            ,{DUMMY_NAME_PTR_CNS, 0x00003120,         0x00000003,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
            ,{DUMMY_NAME_PTR_CNS, 0x000031a4,         0x00000002,      1,    0x4            ,(NUM_PORTS_PER_USX_UNIT) , (MAC_STEP_PORT_OFFSET)}
...
* @brief   Allocate address type specific memories - for the USX MAC
*/
static void smemIronmanUnitUsxMacNonBr
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
{
    START_BIND_UNIT_ACTIVE_MEM_MAC(devObjPtr,unitPtr)
        ...
        */
        ...
        /* Egress MAC TSQ */
        /* SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.tsqTimestamp */
        {0x000001B0,SMEM_FULL_MASK_CNS,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_NO_BR_8_PORT: port 0, address 0x1B0 */
        {0x000002B0,SMEM_FULL_MASK_CNS-0x100,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_NO_BR_8_PORT: ports 1..2, address 0x2B0,0x3B0 */
        {0x000004B0,SMEM_FULL_MASK_CNS-0x300,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_NO_BR_8_PORT: port3 3..6, address 0x4B0,0x5B0,0x6B0,0x7bB0 */
        {0x000008B0,SMEM_FULL_MASK_CNS,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_NO_BR_8_PORT: port 8, address 0x8B0 */
...

    {
        SMEM_CHUNK_EXTENDED_STC  chunksMem[]=
        {
            ...
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3008, 0x3014)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3020, 0x3024)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3040, 0x3048)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3054, 0x3054)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3064, 0x3064)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3074, 0x3078)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3080, 0x3080)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30A4, 0x30a4)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , MAC_STEP_PORT_OFFSET)}
            /*end of pmac*/

            /*start of MIB*/
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1000, 0x1014)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x101C, 0x15C4)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1654, 0x16B8)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1748, 0x17AC)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x183C, 0x18A0)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1930, 0x1994)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1A24, 0x1A88)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1B18, 0x1B7C)}}
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1C0C, 0x1C70)}}
...
/**
* @internal smemIronmanUnitUsxPcs function
* @endinternal
*
* @brief   Allocate address type specific memories - for the USX PCS
*/
static void smemIronmanUnitUsxPcs
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
{
    START_BIND_UNIT_ACTIVE_MEM_MAC(devObjPtr,unitPtr)
        /* LPCS : 8 ports */
        {0x4 * 0 + 0x00000090, SMEM_FULL_MASK_CNS , NULL, 0, smemFalconActiveWritePcsControl1, 0},
        {0x4 * 1 + 0x00000090, SMEM_FULL_MASK_CNS , NULL, 0, smemFalconActiveWritePcsControl1, 0},
        {0x4 * 2 + 0x00000090, SMEM_FULL_MASK_CNS , NULL, 0, smemFalconActiveWritePcsControl1, 0},
        {0x4 * 3 + 0x00000090, SMEM_FULL_MASK_CNS , NULL, 0, smemFalconActiveWritePcsControl1, 0},
        {0x4 * 4 + 0x00000090, SMEM_FULL_MASK_CNS , NULL, 0, smemFalconActiveWritePcsControl1, 0},
        {0x4 * 5 + 0x00000090, SMEM_FULL_MASK_CNS , NULL, 0, smemFalconActiveWritePcsControl1, 0},
        {0x4 * 6 + 0x00000090, SMEM_FULL_MASK_CNS , NULL, 0, smemFalconActiveWritePcsControl1, 0},
        {0x4 * 7 + 0x00000090, SMEM_FULL_MASK_CNS , NULL, 0, smemFalconActiveWritePcsControl1, 0},
...

    {
        SMEM_CHUNK_EXTENDED_STC  chunksMem[]=
        {
           ...
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000030, 0x000000AC)}}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000000C0, 0x000000E0)}}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000000F0, 0x00000110)}}
            /*end of PCS EXT*/

            /*start of LPCS General registers*/
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000013E0, 0x000013F4)}}
            /*end of LPCS General registers*/

            /*start of LPCS*/
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00001000, 0x00001020)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x80)}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00001040, 0x0000105C)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x80)}
            /*end of LPCS*/

           /*start of Base_R_PCS*/
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00002000, 0x00002020)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00002038, 0x0000203C)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00002050, 0x00002050)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00002058, 0x00002058)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00002080, 0x000020B4)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000020C8, 0x000020C8)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000020F0, 0x000020FC)} , FORMULA_SINGLE_PARAMETER(NUM_PORTS_PER_USX_UNIT , 0x100)}
           /*end of Base_R_PCS*/

           /*start of FCFEC*/
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00003000, 0x0000301C)} , FORMULA_SINGLE_PARAMETER(2, 0x1000)}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00003040, 0x0000305C)} , FORMULA_SINGLE_PARAMETER(2, 0x1000)}
           ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00003300, 0x00003314)} , FORMULA_SINGLE_PARAMETER(2, 0x1000)}
           /*end of FCFEC*/
        };
        GT_U32  numOfChunks = sizeof(chunksMem)/sizeof(SMEM_CHUNK_EXTENDED_STC);
        SMEM_UNIT_CHUNKS_STC    tmpUnitChunk;
...

    {
        ...
        {
            /*start of PCS EXT*/
             {DUMMY_NAME_PTR_CNS,  0x00000004,         0x00000058,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00000020,         0x0000ffff,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000000c0,         0x00000820,      2,    0x30}
            ,{DUMMY_NAME_PTR_CNS,  0x000000c4,         0x01003118,      2,    0x30}
            ,{DUMMY_NAME_PTR_CNS,  0x000000c8,         0x0000c350,      2,    0x30}

            /*start of LPCS*/
            ,{DUMMY_NAME_PTR_CNS,  0x00001000,         0x00001140,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x00001004,         0x00000009,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x00001008,         0x00004950,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x0000100c,         0x00004d54,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x00001010,         0x000001a0,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x00001018,         0x00000004,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x00001044,         0x00000001,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x00001048,         0x000012d0,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x0000104c,         0x00000013,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x00001050,         0x00000900,      8,    0x80}
            ,{DUMMY_NAME_PTR_CNS,  0x0000105c,         0x0000000c,      8,    0x80}

            /*start of Base_R_PCS*/
            ,{DUMMY_NAME_PTR_CNS,  0x00002000,         0x00002040,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x00002010,         0x00000011,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x00002014,         0x00000008,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x00002020,         0x00008081,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x00002050,         0x00000440,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x00002088,         0x0000804f,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x0000208c,         0x0000cab6,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x00002090,         0x0000b44d,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x00002094,         0x000003c8,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x00002098,         0x00008884,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x0000209c,         0x000085a3,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x000020a0,         0x000006bb,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x000020a4,         0x00000349,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x000020b4,         0x00008000,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x000020f4,         0x00004901,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x000020f8,         0x00000303,      8,    0x100}
            ,{DUMMY_NAME_PTR_CNS,  0x000020fc,         0x00000006,      8,    0x100}

            ,{DUMMY_NAME_PTR_CNS,  0x0000300c,         0x00001004,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x0000301c,         0x00000006,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x00003040,         0x000068c1,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x00003044,         0x00000021,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x00003048,         0x0000c4f0,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x0000304c,         0x000000e6,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x00003050,         0x000065c5,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x00003054,         0x0000009b,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x00003058,         0x000079a2,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x0000305c,         0x0000003d,      2,    0x1000}
            ,{DUMMY_NAME_PTR_CNS,  0x00003300,         0x00000003,      2,    0x1000}
...
/**
* @internal smemIronmanUnitCpuMacBr function
* @endinternal
*
* @brief   Allocate address type specific memories - for the MIF
*/
static void smemIronmanUnitCpuMacBr
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
{
    START_BIND_UNIT_ACTIVE_MEM_MAC(devObjPtr,unitPtr)
        ...
        */
        ...
        {CPU_MAC_EXT_BASE_OFFSET + 0x0000010C, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},

        /* SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[1].MTI_EXT_PORT.portInterruptMask */
        {CPU_MAC_EXT_BASE_OFFSET + 0x00000110, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWriteCpuPortInterruptsMaskReg, 0},

        /* Egress MAC TSQ */
        /* SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.tsqTimestamp */
        {0x000001B0,SMEM_FULL_MASK_CNS,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_BR_1_PORT: port 0, address 0x1B0 */
...

    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000130, 0x0000016C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000180, 0x000001FC)}
            /*end of port EXT*/

            /*start of pmac*/
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3000, 0x3000)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3008, 0x3014)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3020, 0x3024)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3040, 0x3048)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3080, 0x3080)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30A8, 0x30B0)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30B8, 0x30B8)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30C0, 0x30C0)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30C8, 0x30C8)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30D0, 0x30D0)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30D8, 0x30D8)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30E0, 0x30E8)}
            /*end of pmac*/

            /*start of emac*/
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3108, 0x3108)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3114, 0x3114)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3120, 0x3120)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3154, 0x3154)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3164, 0x3164)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3174, 0x3174)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x31A4, 0x31A4)}
            /*end of emac*/

            /*start of MIB*/
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1000, 0x1014)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x101C, 0x127C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x130C, 0x1370)}
            /*end of MIB*/
...

    {
        static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
        {
            ...
            /*port EXT */
            ,{DUMMY_NAME_PTR_CNS, 0x00000100,         0x0012fd10,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00000124,         0x0000000f,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00000130,         0x00000001,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x0000014c,         0x00000043,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00000180,         0x01000100,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00000198,         0x00000007,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x0000019c,         0x00000043,      1,    0x0}

            /*pmac*/
            ,{DUMMY_NAME_PTR_CNS, 0x00003000,         0x00010300,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00003014,         0x00000600,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00003020,         0x00000003,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00003040,         0x00600360,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00003044,         0x0000000c,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00003080,         0x00000101,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x000030a8,         0x01780a00,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x000030ac,         0x00000001,      1,    0x0}

            /*emac*/
            ,{DUMMY_NAME_PTR_CNS, 0x00003114,         0x00000600,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x00003120,         0x00000003,      1,    0x0}
            ,{DUMMY_NAME_PTR_CNS, 0x000031a4,         0x00000002,      1,    0x0}
...
* @brief   Allocate address type specific memories - for the MIF
*/
static void smemIronmanUnitCpuMacNonBr
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
{
    START_BIND_UNIT_ACTIVE_MEM_MAC(devObjPtr,unitPtr)
        ...
        */
        ...
        /* Egress MAC TSQ */
        /* SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.tsqTimestamp */
        {0x000001B0,SMEM_FULL_MASK_CNS,smemSip6_30ActiveReadMacGopPtpTxTsQueueReg2Reg,0,NULL,0}, /* MAC_NO_BR_1_PORT: port 0, address 0x1B0 */
...

    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000100, 0x00000128)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000130, 0x0000016C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000180, 0x000001A8)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000001B0, 0x000001BC)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000001C0, 0x000001C0)}
            /*end of port EXT*/
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3008, 0x3014)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3020, 0x3024)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3040, 0x304C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x3054, 0x3074)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x307C, 0x3080)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x30A4, 0x30A4)}
            /*end of pmac*/

            /*start of MIB*/
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x1000, 0x1014)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x101C, 0x11F0)}
            /*end of MIB*/
...
* @endinternal
*
* @brief   Allocate address type specific memories - for the Cpu PCS
*/
static void smemIronmanUnitCpuPcs
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
{
...

    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
           ...
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00001040, 0x0000105C)}
            /*end of LPCS*/
           ...
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00002050, 0x00002050)}
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00002058, 0x00002058)}
           ...
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000020F0, 0x000020FC)}
           /*end of Base_R_PCS*/

           /*start of FCFEC*/
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00003000, 0x0000301C)}
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00003040, 0x0000305C)}
...

    {
        static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
        {
            /*start of PCS EXT*/
             {DUMMY_NAME_PTR_CNS,  0x00000004,         0x00000058,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00000020,         0x0000ffff,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000000c0,         0x00000820,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000000c4,         0x01003118,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000000c8,         0x0000c350,      1,    0x0 }

            /*start of LPCS*/
            ,{DUMMY_NAME_PTR_CNS,  0x00001000,         0x00001140,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00001004,         0x00000009,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00001008,         0x00004950,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x0000100c,         0x00004d54,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00001010,         0x000001a0,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00001018,         0x00000004,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00001044,         0x00000001,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00001048,         0x000012d0,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x0000104c,         0x00000013,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00001050,         0x00000100,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x0000105c,         0x0000000c,      1,    0x0 }

            /*start of Base_R_PCS*/
            ,{DUMMY_NAME_PTR_CNS,  0x00002000,         0x00002040,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00002010,         0x00000011,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00002014,         0x00000008,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00002020,         0x00008081,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00002050,         0x00000440,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00002088,         0x0000804f,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x0000208c,         0x0000cab6,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00002090,         0x0000b44d,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00002094,         0x000003c8,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00002098,         0x00008884,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x0000209c,         0x000085a3,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000020a0,         0x000006bb,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000020a4,         0x00000349,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000020b4,         0x00008000,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000020f4,         0x00004901,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000020f8,         0x00000303,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x000020fc,         0x00000006,      1,    0x0 }

            ,{DUMMY_NAME_PTR_CNS,  0x0000300c,         0x00001004,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x0000301c,         0x00000006,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00003040,         0x000068c1,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00003044,         0x00000021,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00003048,         0x0000c4f0,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x0000304c,         0x000000e6,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00003050,         0x000065c5,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00003054,         0x0000009b,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x00003058,         0x000079a2,      1,    0x0 }
            ,{DUMMY_NAME_PTR_CNS,  0x0000305c,         0x0000003d,      1,    0x0 }
...
/**
* @internal smemIronmanUnitAnp function
* @endinternal
*
* @brief   Allocate address type specific memories - for the ANP
*/
static void smemIronmanUnitAnp
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
{
    START_BIND_UNIT_ACTIVE_MEM_MAC(devObjPtr,unitPtr)
        ...
        {ANP_OFFSET + 0x00000100, SMEM_FULL_MASK_CNS, smemChtActiveReadIntrCauseReg, 0, smemChtActiveWriteIntrCauseReg, 0},
        {ANP_OFFSET + 0x00000104, SMEM_FULL_MASK_CNS, NULL, 0, smemFalconActiveWritePortInterruptsMaskReg, 0},
...

    {
        ...
        {
            /*start of ANP*/
            {SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000000, 0x000000DC)}
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000100, 0x000003A0)}
            /*end of ANP*/

           /*start of AN*/
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00004000, 0x0000400c)}
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00004014, 0x00004018)}
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00004038, 0x0000406c)}
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000040c0, 0x000040c4)}
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00004800, 0x0000486c)}
           ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00004880, 0x0000488c)}
           /*end of AN*/
...

    {
        ...
        {
             /*start of ANP*/
             {DUMMY_NAME_PTR_CNS,    0x00000000,         0xFD02AA46,      1,    0x0            }

            ,{DUMMY_NAME_PTR_CNS,    0x00000004,         0x00000003,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x00000008,         0x03020100,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x0000000c,         0x07060504,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x00000070,         0x0000008a,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x00000074,         0x0b41002b,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x00000078,         0x0000002a,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x00000120,         0x009c009c,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x00000124,         0x003000cc,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x00000128,         0x00000001,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001bc,         0x0000000e,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001c4,         0x05004000,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001c8,         0x00000020,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001cc,         0x00040000,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001d0,         0x00022810,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001d4,         0x0f00c000,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001d8,         0x10000000,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001dc,         0x00000818,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001e4,         0xf3f10000,      1,    0x0            }
            ,{DUMMY_NAME_PTR_CNS,    0x000001e8,         0x00000002,      1,    0x0            }
...
/**
* @internal smemIronmanActiveWriteToSdwPuPllRxInit function
* @endinternal
*
* @brief   Writing to PU PLL and PU_TX/PU_RX sets PLL ready indication + RX_INIT
*
* @param[in] devObjPtr                - device object PTR.
* @param[in] address                  - Address for ASIC memory.
* @param[in] memPtr                   - Pointer to the register's memory in the simulation.
...
* @param[in] inMemPtr                 - Pointer to the memory to get register's content.
*/
void smemIronmanActiveWriteToSdwPuPllRxInit
(
    IN  SKERNEL_DEVICE_OBJECT   *devObjPtr,
    IN  GT_U32                  address,
    IN  GT_U32                  memSize,
...
)
{
    ...
    *memPtr = *inMemPtr;
    ...
    /* calculate address */
    regAddr = address + 0x100; /* SDW Lane %c Status 0 */

    smemRegFldSet(devObjPtr, regAddr, 2/* pll_ready_tx*/ ,1, (*inMemPtr & 1/*pu_pll*/) && (*inMemPtr & (1<<2)/*pu_tx*/));
    smemRegFldSet(devObjPtr, regAddr, 3/* pll_ready_rx*/ ,1, (*inMemPtr & 1/*pu_pll*/) && (*inMemPtr & (1<<1)/*pu_rx*/));

    smemRegFldSet(devObjPtr, regAddr, 4/* rx_init_done*/ ,1, (((*inMemPtr & (1<<16)) != 0) ? 1 : 0));

    return;
}

/**
* @internal smemIronmanActiveWriteToSdPhyTest function
* @endinternal
*
...
* @param[in] inMemPtr                 - Pointer to the memory to get register's content.
*/
void smemIronmanActiveWriteToSdPhyTest
(
    IN  SKERNEL_DEVICE_OBJECT   *devObjPtr,
    IN  GT_U32                  address,
    IN  GT_U32                  memSize,
...
)
{
    ...
    *memPtr = *inMemPtr;
    ...
    /* calculate address */
    regAddr = address + 0x24; /* SDW Lane %c Status 0 */

    smemRegFldSet(devObjPtr, regAddr, 0/*PT_LOCK_LANE*/ ,1, ((*inMemPtr & (1<<15)/*PT_EN_LANE*/) != 0));

    return;
}

/**
* @internal smemIronmanActiveRead_tx_rx_train function
* @endinternal
*
* @brief   Read Lane_lane_Status[0] value.
*
* @param[in] devObjPtr                - device object PTR.
* @param[in] address                  - Address for ASIC memory.
* @param[in] memPtr                   - Pointer to the register's memory in the simulation.
...
*
*/
void smemIronmanActiveRead_tx_rx_train (
    IN         SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN         GT_U32   address,
    IN         GT_U32   memSize,
    IN         GT_U32 * memPtr,
...
{
    /* output value */
    * outMemPtr = (* memPtr) | (1<<9)/*tx_train_complete*/ | (1<<11)/*rx_train_complete*/;

    return;
}

/**
* @internal smemIronmanUnitSerdes function
* @endinternal
*
...
* @param[in,out] unitPtr                  - pointer to the unit chunk
*/
static void smemIronmanUnitSerdes
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
    INOUT SMEM_UNIT_CHUNKS_STC  * unitPtr
)
{
    ...
    {0x00000500, SMEM_FULL_MASK_CNS, NULL, 0 ,smemIronmanActiveWriteToSdwPuPllRxInit,0},
    {0x000201c0, SMEM_FULL_MASK_CNS, NULL, 0 ,smemIronmanActiveWriteToSdPhyTest,0},

    {0x00000600, SMEM_FULL_MASK_CNS, smemIronmanActiveRead_tx_rx_train, 0 ,NULL,0},
...

    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020000, 0x00020064)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020080, 0x000200B4)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000200C0, 0x000200D8)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020100, 0x00020188)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020190, 0x000201AC)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000201C0, 0x000201F8)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020200, 0x00020208)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020210, 0x00020224)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020240, 0x00020268)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020270, 0x00020270)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020278, 0x0002029C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000202C0, 0x000202C4)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000202CC, 0x000202D8)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000202E0, 0x000202E4)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020300, 0x00020300)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020308, 0x0002031C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020324, 0x00020338)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020400, 0x00020438)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x0002045C, 0x00020474)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020480, 0x0002049C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000204A8, 0x000204AC)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000204C0, 0x000204E4)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020500, 0x00020544)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x0002054C, 0x0002057C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020584, 0x000205B4)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000205C0, 0x000205CC)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000205D4, 0x000205D4)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020600, 0x00020664)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020694, 0x00020698)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000206A4, 0x000206F4)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020700, 0x00020700)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020748, 0x000207FC)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020900, 0x0002098C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020A00, 0x00020A10)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020A20, 0x00020A2C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020A40, 0x00020A8C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020AA0, 0x00020AEC)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020B20, 0x00020B60)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020BA0, 0x00020BA4)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020BC0, 0x00020BCC)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020BE0, 0x00020BF8)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020C00, 0x00020C14)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020C20, 0x00020C24)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020C40, 0x00020C60)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020E00, 0x00020E34)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020E84, 0x00020E88)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020E98, 0x00020F70)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020F80, 0x00020FB4)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00020FC0, 0x00020FC0)}
        };
...
)
{
    SMEM_DEVICE_UNIT_ALLOCATION_STC allocUnitsArr[] = {
    {
        ...
        ,{STR(UNIT_PCA_PGC_RX_E)               ,smemIronmanUnitPcaPgc            }
        ,{STR(UNIT_MIF_0)                      ,smemIronmanUnitMif               }
        ,{STR(UNIT_USX_MAC_BR_0)               ,smemIronmanUnitUsxMacBr          }
        ,{STR(UNIT_CPU_MAC_BR_0)               ,smemIronmanUnitCpuMacBr          }
        ,{STR(UNIT_USX_MAC_NON_BR_0)           ,smemIronmanUnitUsxMacNonBr       }
        ,{STR(UNIT_CPU_MAC_NON_BR_0)           ,smemIronmanUnitCpuMacNonBr       }
        ,{STR(UNIT_USX_PCS_0)                  ,smemIronmanUnitUsxPcs            }
        ,{STR(UNIT_CPU_PCS_0)                  ,smemIronmanUnitCpuPcs            }
        ,{STR(UNIT_ANP_0)                      ,smemIronmanUnitAnp               }
        ,{STR(UNIT_SERDES_0_0)                 ,smemIronmanUnitSerdes            }
        ,{STR(UNIT_LED_0)                      ,smemIronmanUnitLed               }
...
/*    ALIGN_REG_DB_TO_UNIT_MAC(UNIT_SHM,SHM);no such unit */
...
)
{
    ...
    ENHANCED_PORT_INFO_STC portInfo;
    GT_U32 unitIndex;
    GT_U32  is_SMEM_UNIT_TYPE_MTI_MAC_CPU_E = GT_FALSE;


    if(GT_OK != smemIronmanPortInfoGet(devObjPtr,SMEM_UNIT_TYPE_MTI_MAC_USX_E,portNum,&portInfo))
    {
        if(GT_OK != smemIronmanPortInfoGet(devObjPtr,SMEM_UNIT_TYPE_MTI_MAC_CPU_E,portNum,&portInfo))
        {
            return;
        }
        else
        {
            is_SMEM_UNIT_TYPE_MTI_MAC_CPU_E = GT_TRUE;
        }
    }

    if(is_SMEM_UNIT_TYPE_MTI_MAC_CPU_E)
    {
        unitIndex = 12+(portNum-48); /* ports: 48..54  -> ANP[12..18]*/
    }
    else
    {
        unitIndex = ((portNum/8) * 2) + ((portNum % 8) / 4);
    }
...
)
{
    ...
    /* convert Global Mac to MIF conversion */
    devObjPtr->devMemMacToMifChannelConvertPtr =
        &smemChtIronmanGlobalMacToMifUintChannel;

    /* convert Global MIF to Mac conversion */
    devObjPtr->devMemMifToMacChannelConvertPtr =
        &smemChtIronmanMifUintChannelToGlobalMac;

    /* Get Preemptive status of DMA Channel */
    devObjPtr->devMemDmaIsPreemptivePtr =
        &smemIronmanIsPreemptiveChannelGet;

    /* Get Preemptive status of DMA Channel */
    devObjPtr->devMemMifChannelFindByDmaPtr =
        &smemChtIronmanMifFindUintChannelByGlobalDma;

    for (mifUnit = 0; (mifUnit < 4); mifUnit++)
    {
        portDbPtr = &(SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_30_MIF[0].mif8Dp.unit[mifUnit]);
        mifChannelsNum = (mifUnit < 3) ? 17 : 8;
        unitOffset = devObjPtr->memUnitBaseAddrInfo.mif[mifUnit];
        for (mifChannel = 0; (mifChannel < mifChannelsNum); mifChannel++)
        {
            portDbPtr->mif_channel_mapping_register[mifChannel] =
                unitOffset + 0x00000A00 + mifChannel*0x4;
            portDbPtr->mif_link_fsm_control_register[mifChannel] =
                unitOffset + 0x00000C00 + mifChannel*0x4;
        }
    }
}
...
/**
* @internal regAddr_UsxMac function
* @endinternal
*
...
)
{
    ...
    eMacOffset = devObjPtr->portsArr[portNum].portSupportPreemption ? 0x100 : 0;

    SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_WRAPPER.MTI64_MAC.commandConfig  = eMacOffset + 0x00000008 + portFormula + unitOffset;
    SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_WRAPPER.MTI64_MAC.frmLength      = eMacOffset + 0x00000014 + portFormula + unitOffset;
    /* shared */
    ...
    if(devObjPtr->portsArr[portNum].portSupportPreemption)
    {
...
)
{
    ...
    if(is_SMEM_UNIT_TYPE_MTI_MAC_USX_E == GT_TRUE)
    {
        unitOffset = devObjPtr->memUnitBaseAddrInfo.macWrap[indexTo_macWrap] + MAC_EXT_BASE_OFFSET;
        if (portIndex == 0)
        {
        ...
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portControl         = 0x00000100 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portStatus          = 0x00000104 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portInterruptCause  = 0x0000010c + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portInterruptMask   = 0x00000110 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portPeerDelay       = 0x00000114 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portEmacUsxPchRxControl  = 0x00000138 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portEmacUsxPchTxControl1 = 0x0000013c + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portSummaryInterruptCause  = 0x00000168 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portSummaryInterruptMask   = 0x0000016c + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portPmacUsxPchRxControl  = 0x0000019c + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portPmacUsxPchTxControl1 = 0x000001a0 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.portEmacUsxPchBadCrcCounter = 0x000001c0 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.tsqTimestamp        = 0x000001b0 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.tsqSignature        = 0x000001b4 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_EXT_PORT.tsqClearControl     = 0x000001bc + 0x100 * portIndex + unitOffset;

        regAddr_UsxMac      (devObjPtr,portNum,portIndex,indexTo_macWrap);
    ...
    {
        unitOffset = devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[indexTo_macWrap] + MAC_EXT_BASE_OFFSET;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[sip6_MTI_EXTERNAL_representativePortIndex].MTI_GLOBAL.globalResetControl          = 0x00000000 + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[sip6_MTI_EXTERNAL_representativePortIndex].MTI_GLOBAL.control = 0x00000008 + unitOffset;

        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portControl         = 0x00000100  + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portStatus          = 0x00000104  + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portInterruptCause  = 0x0000010C + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portInterruptMask   = 0x00000110 + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portPeerDelay       = 0x00000114 + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portEmacUsxPchRxControl  = 0x00000138 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portEmacUsxPchTxControl1 = 0x0000013c + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portSummaryInterruptCause  = 0x00000168 + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portSummaryInterruptMask   = 0x0000016c + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portPmacUsxPchRxControl  = 0x0000019c + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portPmacUsxPchTxControl1 = 0x000001a0 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.portEmacUsxPchBadCrcCounter = 0x000001c0 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.tsqTimestamp        = 0x000001b0 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.tsqSignature        = 0x000001b4 + 0x100 * portIndex + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_EXT_PORT.tsqClearControl     = 0x000001bc + 0x100 * portIndex + unitOffset;

        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_GLOBAL.control               = 0x00000008 + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_GLOBAL.globalResetControl    = 0x00000000 + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_GLOBAL.globalInterruptSummaryCause    = 0x00000018 + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_GLOBAL.globalInterruptSummaryMask    = 0x0000001C + unitOffset;

        portFormula = devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex] + PORT0_100G_OFFSET;
        eMacOffset = devObjPtr->portsArr[portNum].portSupportPreemption ? 0x100 : 0;

        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_cpuMac.commandConfig = eMacOffset + 0x00000008 + portFormula;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_cpuMac.frmLength     = eMacOffset + 0x00000014 + portFormula;
        /* common */
        ...
        if (devObjPtr->portsArr[portNum].portSupportPreemption)
        {
            SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_cpuPreemtionMac.commandConfig = 0x00000008 + portFormula;
            SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_cpuPreemtionMac.frmLength     = 0x00000014 + portFormula;
            SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex]._802_3_BR.brControl               = 0x000000A8 + portFormula;
        }

        smemChtGopMtiInitMacMibCounters(devObjPtr,portNum ,portIndex , sip6_MTI_EXTERNAL_representativePortIndex/*channelIndex*/ , 0/*dieIndex*/ , 0 /*globalRaven*/ , 1/*isCpuPort*/);
    }
...
)
{
    ...
    if(is_SMEM_UNIT_TYPE_MTI_MAC_USX_E == GT_TRUE)
    {
        unitOffset = devObjPtr->memUnitBaseAddrInfo.macPcs[indexTo_macPcs];
        ...
        portFormula = USX_PCS_EXT_OFFSET + (0x4 * portIndex);
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI[portNum].MTI_WRAPPER.USX_PCS.extControl = 0x00000090 + portFormula + unitOffset;
    }
    else
    {
        unitOffset = devObjPtr->memUnitBaseAddrInfo.cpuMacPcs[indexTo_macPcs];
        portFormula = USX_PCS_PORTS_OFFSET + unitOffset;
        ...
        portFormula = USX_PCS_EXT_OFFSET + (0x4 * portIndex) + unitOffset;
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->sip6_MTI_cpu_port[unitIndex].MTI_cpuPcs.extControl    = 0x00000090 + portFormula;
    }
...
)
{
    ...
    /* USX support */
    {
        ...
        unitIndex=0;
        devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex]  = MTIP_UNIT_USX_MAC_BR_0_BASE_ADDR;
        ...
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex]  = MTIP_UNIT_USX_MAC_BR_1_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.macMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.macPcs [unitIndex]  = MTIP_UNIT_USX_PCS_1_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex]  = MTIP_UNIT_USX_MAC_BR_2_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.macMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.macPcs [unitIndex]  = MTIP_UNIT_USX_PCS_2_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex]  = MTIP_UNIT_USX_MAC_NON_BR_0_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.macMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.macPcs [unitIndex]  = MTIP_UNIT_USX_PCS_3_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex]  = MTIP_UNIT_USX_MAC_NON_BR_1_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.macMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.macPcs [unitIndex]  = MTIP_UNIT_USX_PCS_4_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex]  = MTIP_UNIT_USX_MAC_NON_BR_2_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.macMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.macWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.macPcs [unitIndex]  = MTIP_UNIT_USX_PCS_5_BASE_ADDR;

        /* support for the CPU MAC */
        unitIndex=0;
        devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex]  = MTIP_UNIT_CPU_MAC_BR_0_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.cpuMacMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.cpuMacPcs [unitIndex]  = MTIP_UNIT_CPU_PCS_0_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex]  = MTIP_UNIT_CPU_MAC_BR_1_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.cpuMacMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.cpuMacPcs [unitIndex]  = MTIP_UNIT_CPU_PCS_1_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex]  = MTIP_UNIT_CPU_MAC_BR_2_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.cpuMacMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.cpuMacPcs [unitIndex]  = MTIP_UNIT_CPU_PCS_2_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex]  = MTIP_UNIT_CPU_MAC_BR_3_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.cpuMacMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.cpuMacPcs [unitIndex]  = MTIP_UNIT_CPU_PCS_3_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex]  = MTIP_UNIT_CPU_MAC_NON_BR_0_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.cpuMacMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.cpuMacPcs [unitIndex]  = MTIP_UNIT_CPU_PCS_4_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex]  = MTIP_UNIT_CPU_MAC_NON_BR_1_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.cpuMacMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.cpuMacPcs [unitIndex]  = MTIP_UNIT_CPU_PCS_5_BASE_ADDR;
        unitIndex++;
        devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex]  = MTIP_UNIT_CPU_MAC_NON_BR_2_BASE_ADDR;
        devObjPtr->memUnitBaseAddrInfo.cpuMacMib [unitIndex]  = devObjPtr->memUnitBaseAddrInfo.cpuMacWrap[unitIndex] + MAC_MIB_OFFSET;
        devObjPtr->memUnitBaseAddrInfo.cpuMacPcs [unitIndex]  = MTIP_UNIT_CPU_PCS_6_BASE_ADDR;
        ...
        for(globalPort = 0 ; globalPort < devObjPtr->portsNumber ; globalPort++)
        {
            ...
            GT_U32  is_SMEM_UNIT_TYPE_MTI_MAC_CPU_E = (GT_OK == smemIronmanPortInfoGet(devObjPtr,SMEM_UNIT_TYPE_MTI_MAC_CPU_E,globalPort,&portInfo)) ? 1 : 0;

            if((globalPort < 24) || ((globalPort >= 48) && (globalPort < 52)))
            {
            ...
            if(is_SMEM_UNIT_TYPE_MTI_MAC_USX_E)
            {
                regAddr_MTIPMacWrap(devObjPtr,
                    ...
                    portInfo.simplePortInfo.indexInUnit, /* local  port in the unit */
                    portInfo.simplePortInfo.unitIndex);  /* for usx : the unit index 0..5*/
            ...
            if(is_SMEM_UNIT_TYPE_MTI_MAC_CPU_E)
            {
                regAddr_MTIPMacWrap(devObjPtr,
                    ...
                    GT_FALSE,
                    portInfo.sip6_MTI_EXTERNAL_representativePortIndex,/* representative global port in the device (for 'shared' registers) */
                    portInfo.simplePortInfo.indexInUnit, /* always 0 */
                    portInfo.simplePortInfo.unitIndex);  /* for CPU_MAC : index 0..6 */
...
)
{
    ...
    if (isIronman == GT_TRUE)
    {
        ...
        devObjPtr->numOfMgUnits = 3;/* 3 MG units, SDMA is only in MG0, MG1/2 are used for CM3 */
        ...
        SET_IF_ZERO_MAC(devObjPtr->TTI_myPhysicalPortAttributes_numEntries,64);
        ...
        devObjPtr->emMaxNumEntries       = 0;   /* No EM */
        devObjPtr->emAutoLearnNumEntries = 0;   /* No EM */
        ...
        devObjPtr->policerSupport.numOfIpfix    =  2*_1K;      /* 64K in Hawk*/
        ...
        devObjPtr->limitedResources.portIsolationNum = 4*_1K + 64;
        devObjPtr->limitedResources.ipToMeNum = 8;
        devObjPtr->limitedResources.l2iHportsNum = 10;
        devObjPtr->egfNumBitsPerPort = 6;
        devObjPtr->eqNumBitsPerEPort = 10;/*1K eports*/

        devObjPtr->numofTcamClients = IRONMAN_TCAM_NUM_OF_GROUPS_CNS;

        devObjPtr->mtiMibCounter.rxCntNum = CHT_INTERNAL_SIMULATION_SIP_6_30_RX_STATISTIC_PAGE;
        devObjPtr->mtiMibCounter.txCntNum = CHT_INTERNAL_SIMULATION_SIP_6_30_TX_STATISTIC_PAGE;

        devObjPtr->freeRunningTaiInst = 4;
    }
...
)
{
    ...
    */
    ...
    /* Only 1 register changed, so in order not to duplicate code we initialize the default
       value here */
    {
        smemRegFldSet(devObjPtr ,
            SMEM_CHT2_L3_ROUTE_GLB_CONTROL_REG(devObjPtr),
            0,32,0x27);
    }
}
...
)
{

    {
        ...
        {0x00006478, SMEM_FULL_MASK_CNS, NULL, 0 , smemIronmanActiveWriteQbvConfigChangeTimeReq,0},
    ...
    }
    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00006000, 0x000060E0)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00006200, 0x000062E0)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00006400, 0x00006404)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00006420, 0x00006424)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00006440, 0x00006444)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00006460, 0x00006478)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00006600,0x000066E0)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00006800,0x000068E0)}
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x0000A100, 0x0000A114)}
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x0000C000, 228)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x0000D000, 3648)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x0000F000, 1824)}
...

    {
        ...
        /*QBV*/
        {
            ...
            SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->SIP6_TXQ_SDQ[0].QBV.configChangeTimeEgressTODOffset = 0x00006468;

            /*TXQ/<TXQ_SCN>TXQ_SCN_IP/<TXQ_SCN> TXQ_SDQ/SDQ/QBV Configuration/Config Change Time Cycle Time*/
            SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->SIP6_TXQ_SDQ[0].QBV.configChangeTimeCycleTime = 0x00006464;

            for(pt = 0; pt <= NUM_PORTS_PER_DP_UNIT/2; pt++)
            {
                ...
                SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->SIP6_TXQ_SDQ[0].QBV.portQbvConfTable[pt] =
                    0x00010000 + (pt*0x8*256);
            }

            for(pt = 0; pt < NUM_QUEUES_PER_DP_UNIT ; pt++)
            {
  ...
  static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
    {
        ...
        ,{DUMMY_NAME_PTR_CNS,           0x00006800,         0x00000007,      57,    0x4    }/*Port_Remain_Per_NS_Resolution*/
        ,{DUMMY_NAME_PTR_CNS,           0x00002000,         0x60000000,      456,    0x8    }/*queue_cfg*/
        ,{DUMMY_NAME_PTR_CNS,           0x0000f000,         0x00000381,      456,    0x4    }/*queue_elig_state*/
        ,{NULL,                         0,                  0x00000000,      0,    0x0  }
    };
  static SMEM_LINK_LIST_REGISTER_DEFAULT_VALUE_STC list = {myUnit_registersDefaultValueArr,NULL};
  unitPtr->unitDefaultRegistersPtr = &list;
...
)
{
    SMEM_CHUNK_BASIC_STC  chunksMem[]=
    {
       /*PSI_REG*/
       {SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000000,0x000000E8)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00000208,0x00000238)}
       /*PDQ*/
       ...
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00000300, IRONMAN_PSI_SCHED_OFFSET+0x00000304)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00000308, IRONMAN_PSI_SCHED_OFFSET+0x0000030C)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00000310, IRONMAN_PSI_SCHED_OFFSET+0x00000314)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00000320, IRONMAN_PSI_SCHED_OFFSET+0x00000324)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00000400, 1024)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00000800, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00000C00, 1024)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00001000, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00001400, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00001800, IRONMAN_PSI_SCHED_OFFSET+0x00001804)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00001808, IRONMAN_PSI_SCHED_OFFSET+0x0000180C)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00001810, IRONMAN_PSI_SCHED_OFFSET+0x00001814)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00001C00, 1024)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00002000, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00002400, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00002800, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00002C00, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00003000, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00003800, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00004000, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00004800, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00005000, 1024)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00005800, IRONMAN_PSI_SCHED_OFFSET+0x00005804)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00005808, IRONMAN_PSI_SCHED_OFFSET+0x0000580C)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00005810, IRONMAN_PSI_SCHED_OFFSET+0x00005814)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00005A00, IRONMAN_PSI_SCHED_OFFSET+0x00005A04)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00005A08, IRONMAN_PSI_SCHED_OFFSET+0x00005A0C)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00005A10, IRONMAN_PSI_SCHED_OFFSET+0x00005A14)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00005C00, 1024)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00006000, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00007000, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00008000, 512)}
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (IRONMAN_PSI_SCHED_OFFSET+0x00009000, 512)}
       ...
       ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (IRONMAN_PSI_SCHED_OFFSET+0x0000B410, IRONMAN_PSI_SCHED_OFFSET+0x0000B414)}
...

     {
        static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
        {
         {DUMMY_NAME_PTR_CNS,           0x00000208,         0x00000010,      1,    0x4    }/*Credit_Value*/
        ,{DUMMY_NAME_PTR_CNS,           0x00000004,         0x0000ffff,      1,    0x4    }/*PSI_Metal_Fix_Register*/
        ,{DUMMY_NAME_PTR_CNS,           0x0000021c,         0x000001ff,      1,    0x4    }/*MSG_FIFO_Min_Peak*/
        ...
        ,{DUMMY_NAME_PTR_CNS,           0x00000000,         0x00000007,      1,    0x4    }/*Psi_Idle*/
         ...
         ,{DUMMY_NAME_PTR_CNS,           0x00000300+IRONMAN_PSI_SCHED_OFFSET,         0x00500000,      1,    0x8    }/*PPerCtlConf_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00000308+IRONMAN_PSI_SCHED_OFFSET,         0x066f0002,      1,    0x8    }/*PPerRateShap_Addr*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x0000030c+IRONMAN_PSI_SCHED_OFFSET,         0x0000016e,      1,    0x8    }/*PPerRateShap_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00000310+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*PPerRateShapInt_Addr*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00000314+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*PPerRateShapInt_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00000320+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      1,    0x8    }/*Port_Pizza_Last_Slice*/
        ...
        ,{DUMMY_NAME_PTR_CNS,           0x0000b410+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*QPerRateShapInt_Addr*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x0000b414+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*QPerRateShapInt_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00005a00+IRONMAN_PSI_SCHED_OFFSET,         0x0e390000,      1,    0x8    }/*APerCtlConf_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00005a08+IRONMAN_PSI_SCHED_OFFSET,         0x066f0002,      1,    0x8    }/*APerRateShap_Addr*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00005a0c+IRONMAN_PSI_SCHED_OFFSET,         0x0000016e,      1,    0x8    }/*APerRateShap_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00005a10+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*APerRateShapInt_Addr*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00005a14+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*APerRateShapInt_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00005800+IRONMAN_PSI_SCHED_OFFSET,         0x0e390000,      1,    0x8    }/*BPerCtlConf_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00005808+IRONMAN_PSI_SCHED_OFFSET,         0x066f0002,      1,    0x8    }/*BPerRateShap_Addr*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x0000580c+IRONMAN_PSI_SCHED_OFFSET,         0x0000016e,      1,    0x8    }/*BPerRateShap_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00005810+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*BPerRateShapInt_Addr*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00005814+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*BPerRateShapInt_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00001800+IRONMAN_PSI_SCHED_OFFSET,         0x071c0000,      1,    0x8    }/*CPerCtlConf_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00001808+IRONMAN_PSI_SCHED_OFFSET,         0x066f0002,      1,    0x8    }/*CPerRateShap_Addr*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x0000180c+IRONMAN_PSI_SCHED_OFFSET,         0x0000016e,      1,    0x8    }/*CPerRateShap_Addr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00001810+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*CPerRateShapInt_Addr*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00001814+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      1,    0x8    }/*CPerRateShapInt_Addr*/
        ...
        ,{DUMMY_NAME_PTR_CNS,           0x00000400+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      128,    0x8    }/*PortEligPrioFunc_Entry*/
        ,{DUMMY_NAME_PTR_CNS,           0x00001000+IRONMAN_PSI_SCHED_OFFSET,         0x0fff0fff,      64,    0x8    }/*PortTokenBucketTokenEnDiv*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00001004+IRONMAN_PSI_SCHED_OFFSET,         0x00000001,      64,    0x8    }/*PortTokenBucketTokenEnDiv*/
        ,{DUMMY_NAME_PTR_CNS,           0x00001400+IRONMAN_PSI_SCHED_OFFSET,         0x0001ffff,      64,    0x8    }/*PortTokenBucketBurstSize*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00001404+IRONMAN_PSI_SCHED_OFFSET,         0x0001ffff,      64,    0x8    }/*PortTokenBucketBurstSize*/
        ,{DUMMY_NAME_PTR_CNS,           0x00000c00+IRONMAN_PSI_SCHED_OFFSET,         0x00001010,      128,    0x8    }/*PortQuantumsPriosLo*/
        ,{DUMMY_NAME_PTR_CNS,           0x00000800+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      64,    0x8    }/*PortRangeMap*/
        ,{DUMMY_NAME_PTR_CNS,           0x0000b600+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      64,    0x8    }/*QueueEligPrioFunc*/
        ,{DUMMY_NAME_PTR_CNS,           0x0000c000+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      512,    0x8    }/*Queuemapping*/
        ...
        ,{DUMMY_NAME_PTR_CNS,           0x00005c00+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      128,    0x8    }/*AlvlEligPrioFunc_Entry*/
        ,{DUMMY_NAME_PTR_CNS,           0x00007000+IRONMAN_PSI_SCHED_OFFSET,         0x0fff0fff,      64,    0x8    }/*AlvlTokenBucketTokenEnDiv*/
        ,{DUMMY_NAME_PTR_CNS,           0x00008000+IRONMAN_PSI_SCHED_OFFSET,         0x00000fff,      64,    0x8    }/*AlvlTokenBucketBurstSize*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00008004+IRONMAN_PSI_SCHED_OFFSET,         0x00000fff,      64,    0x8    }/*AlvlTokenBucketBurstSize*/
        ,{DUMMY_NAME_PTR_CNS,           0x00009000+IRONMAN_PSI_SCHED_OFFSET,         0x00001040,      64,    0x8    }/*AlvlQuantum*/
        ,{DUMMY_NAME_PTR_CNS,           0x00006000+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      64,    0x8    }/*ALvltoBlvlAndQueueRangeMap*/
        ,{DUMMY_NAME_PTR_CNS,           0x00005000+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      128,    0x8    }/*BlvlEligPrioFunc_Entry*/
        ,{DUMMY_NAME_PTR_CNS,           0x00003800+IRONMAN_PSI_SCHED_OFFSET,         0x0fff0fff,      64,    0x8    }/*BlvlTokenBucketTokenEnDiv*/
        ,{DUMMY_NAME_PTR_CNS,           0x00004000+IRONMAN_PSI_SCHED_OFFSET,         0x00000fff,      64,    0x8    }/*BlvlTokenBucketBurstSize*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00004004+IRONMAN_PSI_SCHED_OFFSET,         0x00000fff,      64,    0x8    }/*BlvlTokenBucketBurstSize*/
        ,{DUMMY_NAME_PTR_CNS,           0x00004800+IRONMAN_PSI_SCHED_OFFSET,         0x00001040,      64,    0x8    }/*BlvlQuantum*/
        ,{DUMMY_NAME_PTR_CNS,           0x00003000+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      64,    0x8    }/*BLvltoClvlAndAlvlRangeMap*/
        ,{DUMMY_NAME_PTR_CNS,           0x00001c00+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      128,    0x8    }/*ClvlEligPrioFunc_Entry*/
        ,{DUMMY_NAME_PTR_CNS,           0x00002800+IRONMAN_PSI_SCHED_OFFSET,         0x0fff0fff,      64,    0x8    }/*ClvlTokenBucketTokenEnDiv*/
        ,{DUMMY_NAME_PTR_CNS,           0x00002c00+IRONMAN_PSI_SCHED_OFFSET,         0x00000fff,      64,    0x8    }/*ClvlTokenBucketBurstSize*/
        /**/,{DUMMY_NAME_PTR_CNS,           0x00002c04+IRONMAN_PSI_SCHED_OFFSET,         0x00000fff,      64,    0x8    }/*ClvlTokenBucketBurstSize*/
        ,{DUMMY_NAME_PTR_CNS,           0x00002400+IRONMAN_PSI_SCHED_OFFSET,         0x00001040,      64,    0x8    }/*ClvlQuantum*/
        ,{DUMMY_NAME_PTR_CNS,           0x00002000+IRONMAN_PSI_SCHED_OFFSET,         0x00000000,      64,    0x8    }/*ClvltoPortAndBlvlRangeMap*/
...
)
{
...

   {
    static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
    {
        ...
        ,{DUMMY_NAME_PTR_CNS,           0x00001220,         0x00006000,      1,    0x4    }/*pfcc_burst_fifo_thr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00001210,         0x00006000,      1,    0x4    }/*global_burst_fifo_thr*/
        ,{DUMMY_NAME_PTR_CNS,           0x00001200,         0x00006000,      1,    0x4    }/*global_burst_fifo_available_entries*/
        ,{NULL,                         0,                  0x00000000,      0,    0x0  }
    };
    static SMEM_LINK_LIST_REGISTER_DEFAULT_VALUE_STC list = {myUnit_registersDefaultValueArr,NULL};
    unitPtr->unitDefaultRegistersPtr = &list;
...
)
{
    ...
    /* HSR PRP Proxy Node Table Discard Packets LRE A,B Counter <%n> (ROC (read only clear)) */
    /* the 0x1F : support 4 registers in 0x000022C0 and 4 registers in 0x000022D0 */
    {0x000022C0, SMEM_FULL_MASK_CNS-0x1F, smemChtActiveReadCntrs, 0, smemChtActiveWriteToReadOnlyReg, 0},
...
)
{
...

    {
        static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
        {
            ...
            {DUMMY_NAME_PTR_CNS,    0x000A0A04,         0x0000BFFF,      1,    0x0}
...
)
{
...

    {
        static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
        {
            ...
            ,{DUMMY_NAME_PTR_CNS,            0x00006440,         0x00000008,      1,    0x0      }
...
/**
* @internal smemIronmanUnitTcam function
* @endinternal
*
* @brief   Allocate address type specific memories -- for the TCAM unit
*/
static void smemIronmanUnitTcam
(
    IN SKERNEL_DEVICE_OBJECT *devObjPtr,
    IN SMEM_UNIT_CHUNKS_STC  *unitPtr
)
{
    ...
    /* exact  match - 0x005021C0 */
    {0x005021C0, SMEM_FULL_MASK_CNS, NULL, 0, smemLion3ActiveWriteTcamMgHitGroupHitNum,0},
...

    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
             /* 4 floors : 32K lines : 16K - X lines , 16K - Y lines */
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x00200000, 524288/2),/* actual size is half of the 'address range' accessed by CPU */
              SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(256, 32),SMEM_BIND_TABLE_MAC(globalActionTable)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00500000, 0x00500000)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00501000, 0x00501010)} /*interrupts */
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00502000, 0x00502050)} /*MG*/
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x005021A8, 0x005021A8)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x005021BC, 0x005021C0)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00502308, 0x00502310)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00503000, 0x00503030)} /*parity daemon*/
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x0050303C, 0x0050303C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00504010, 0x00504014)} /*TCAM array*/
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00505000, 0x00505024)} /*client request counters*/
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00506000, 0x0050600C)} /*FIFOs Config*/
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x0050606C, 0x0050606C)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00507000, 0x00507008)} /*miscelanous registers*/
    ...
    /* chunks with formulas */
    {
        SMEM_CHUNK_EXTENDED_STC  chunksMem[]=
        {
            /* TCAM Hit Number and Group Select Floor %n : 0x00500100 + n*0x8: where n (0-3) represents Floor num */
             {{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC(0x00500100 ,0)}, FORMULA_SINGLE_PARAMETER(4,0x8)}
            /*SubKey0 Maping %n.0x00509000 + 4*4*(n-1): where n (1-31) represents Profile*/
            /*SubKey%i Maping %n.0x00509004 + 4*4*(n-1) + 4*(i-1): where n (1-31) represents Entry, where i (1-1) represents SubKey*/
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC(0x00509000, 0),
                ...
                FORMULA_TWO_PARAMETERS(31,(4*0x4),2,0x4)}
            /*Mux Configuration Table Entry %n 10B %i.0x00509800 + 4*i+6*4*(n-1): where i (0-5) represents 10B, where n (1-23) represents 60B line*/
            ,{{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC(0x00509800, 0),
                    SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(32, 4),
                    SMEM_BIND_TABLE_MAC(tcamSubkeyMux2byteUnits)},
                FORMULA_TWO_PARAMETERS(23,(6*0x4),6,0x4)}
        };
        GT_U32  numOfChunks = sizeof(chunksMem)/sizeof(SMEM_CHUNK_EXTENDED_STC);
        SMEM_UNIT_CHUNKS_STC    tmpUnitChunk;
...

    {
        static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
        {
            /* init the X,Y of the tcam */
             {DUMMY_NAME_PTR_CNS,            0x00000000,         0x0000000f,  (32*_1K)/2,    0x20     }
            ,{DUMMY_NAME_PTR_CNS,            0x00000010,         0x0000000f,  (32*_1K)/2,    0x20     }
            ...
            ,{DUMMY_NAME_PTR_CNS,            0x00505004,         0x00000f3f,      4,    0x8   }
            ,{DUMMY_NAME_PTR_CNS,            0x00506000,         0x00000010,      4,    0x4   }
...
)
{
...

    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x00400000, 32768),SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(384,64), SMEM_BIND_TABLE_MAC(arpTable)/*tunnelStartTable*/}
        };
...
)
{
...

    {
        static SMEM_REGISTER_DEFAULT_VALUE_STC myUnit_registersDefaultValueArr[] =
        {
             ...
             ,{DUMMY_NAME_PTR_CNS,           0x00001100,         0x00001803,      1,    0x4   }
             ,{DUMMY_NAME_PTR_CNS,           0x00001104,         0x00060003,      1,    0x4   }
             ,{DUMMY_NAME_PTR_CNS,           0x0000110C,         0x03938700,      1,    0x4   }
             ,{DUMMY_NAME_PTR_CNS,           0x00001110,         0x005B8D80,      1,    0x4   }
             ...
             ,{DUMMY_NAME_PTR_CNS,           0x00001120,         0x00B0D400,      1,    0x4   }
...
)
{
    ...
    /* data to be written */
    *memPtr = *inMemPtr;
    if(!devObjPtr->devMemHsrPrpTimerGetFuncPtr)
    {
        return;
    }
...
{
    GT_U32  tileId;
    GT_U32  old_hsr_prp_fdb_mode;
    GT_U32  new_hsr_prp_fdb_mode;

    old_hsr_prp_fdb_mode = SMEM_U32_GET_FIELD((*memPtr)   ,25,3);
    new_hsr_prp_fdb_mode = SMEM_U32_GET_FIELD((*inMemPtr) ,25,3);
    ...
    *memPtr = *inMemPtr;
    ...
    if(old_hsr_prp_fdb_mode != new_hsr_prp_fdb_mode)
    {
        GT_U32  currAddr = SMEM_SIP6_FDB_GLOBAL_CONFIG_2_REG(devObjPtr);
        /* call to 'get'+'set' the register , to trigger the active memory of :
            smemAasActiveWriteFDBGlobalCfg2Reg(...)
        */
        smemRegUpdateAfterRegFile(devObjPtr,currAddr,1);
    }
...
)
{
    SMEM_DEVICE_UNIT_ALLOCATION_STC allocUnitsArr []=
    {
        ...
        ,{STR(UNIT_TCAM)        ,smemIronmanUnitTcam}

...
#define cnm_grp_0_0_intr  (hawk_FuncUnitsInterruptsSummary_0  [0])
#define cnm_grp_0_1_intr  (hawk_dataPathInterruptSummary_0    [0])
#define cnm_grp_0_2_intr  (hawk_portsInterruptsSummary_0      [0])
#define cnm_grp_0_3_intr  (hawk_dfxInterruptsSummary_0        [0])
#define cnm_grp_0_4_intr  (hawk_dfx1InterruptsSummary_0       [0])
#define cnm_grp_0_5_intr  (hawk_FuncUnitsInterruptsSummary1_0 [0])
...
enum{  /*cnm_grp_0_5_intr  - hawk_FuncUnitsInterruptsSummary1 */
...
#define MG_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName,mgIndex,father_myBitIndex,father_interrupt,treeId) \
{                                                                                              \
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[treeId].mg_causeRegName),0,mgIndex | MG_TREE_ID(treeId) | MG_UNIT_USED_CNS}, \
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[treeId].mg_maskRegName ),0,mgIndex | MG_TREE_ID(treeId) | MG_UNIT_USED_CNS}, \
        /*myFatherInfo*/{                                                                      \
...
#define MG_SDMA_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName,mgIndex,father_myBitIndex,father_interrupt,treeId) \
{                                                                                              \
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[treeId].SDMARegs.mg_causeRegName),0,mgIndex | MG_TREE_ID(treeId) | MG_UNIT_USED_CNS}, \
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[treeId].SDMARegs.mg_maskRegName ),0,mgIndex | MG_TREE_ID(treeId) | MG_UNIT_USED_CNS}, \
        /*myFatherInfo*/{                                                                      \
            /*myBitIndex*/  father_myBitIndex ,                                                \
            /*interruptPtr*/&father_interrupt                                                  \
            },                                                                                 \
...
#define DUP_PRIMARY_ONLY_MG_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt,treeId) \
     MG_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_0_INDEX,father_myBitIndex,father_interrupt[MG_0_INDEX],treeId) \
...
#define DUP_ALL_MG_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt,treeId) \
     MG_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_0_INDEX,father_myBitIndex,father_interrupt[MG_0_INDEX],treeId) \
    ,MG_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_1_INDEX,father_myBitIndex,father_interrupt[MG_1_INDEX],treeId) \
    ,MG_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_2_INDEX,father_myBitIndex,father_interrupt[MG_2_INDEX],treeId) \
    ,MG_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_3_INDEX,father_myBitIndex,father_interrupt[MG_3_INDEX],treeId)

#define _3_TREES(node)  \
    node##_tree(0);     \
    node##_tree(1);     \
    node##_tree(2)

#define hawk_ports2FatherInterruptsSummary_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_ports2FatherInterruptsSummary##_##treeId[NUM_OF_MGS]

#define hawk_ports2InterruptsSummary_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_ports2InterruptsSummary##_##treeId    [NUM_OF_MGS] =    \
{    DUP_ALL_MG_INTERTTUPT_REG(ports2InterruptsSummaryCause     ,ports2InterruptsSummaryMask     ,ports_2_int_sum  ,hawk_ports2FatherInterruptsSummary##_##treeId,treeId)  }

_3_TREES(hawk_ports2FatherInterruptsSummary);
_3_TREES(hawk_ports2InterruptsSummary);

#define hawk_GlobalInterruptsSummary_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_GlobalInterruptsSummary##_##treeId    [NUM_OF_MGS] =    \
{                                                                                                   \
    { /* copied from GlobalInterruptsSummary */                                                     \
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[treeId].globalInterruptCause),0,MG_0_INDEX | MG_TREE_ID(treeId) | MG_UNIT_USED_CNS},/*SMEM_CHT_GLB_INT_CAUSE_REG*/\
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[treeId].globalInterruptMask) ,0,MG_0_INDEX | MG_TREE_ID(treeId) | MG_UNIT_USED_CNS},                              \
        /*myFatherInfo*/{                                                                           \
            /*myBitIndex*/0 ,                                                                       \
    ...
    ,MG_INTERTTUPT_REG(globalInterruptCause,globalInterruptMask, MG_1_INDEX,Mg1_Int_Out0+treeId, hawk_ports2InterruptsSummary##_##treeId[MG_0_INDEX],treeId)/* into MG_0_0 (tile 0)*/ \
    ,MG_INTERTTUPT_REG(globalInterruptCause,globalInterruptMask, MG_2_INDEX,Mg2_Int_Out0+treeId, hawk_ports2InterruptsSummary##_##treeId[MG_0_INDEX],treeId)                          \
    ,MG_INTERTTUPT_REG(globalInterruptCause,globalInterruptMask, MG_3_INDEX,Mg3_Int_Out0+treeId, hawk_ports2InterruptsSummary##_##treeId[MG_0_INDEX],treeId)                          \
}

_3_TREES(hawk_GlobalInterruptsSummary);

#define hawk_FuncUnitsInterruptsSummary_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_FuncUnitsInterruptsSummary##_##treeId [NUM_OF_MGS] =    \
{    DUP_ALL_MG_INTERTTUPT_REG(functionalInterruptsSummaryCause ,functionalInterruptsSummaryMask ,FuncUnitsIntsSum ,hawk_GlobalInterruptsSummary##_##treeId,treeId) }

#define hawk_dataPathInterruptSummary_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_dataPathInterruptSummary##_##treeId   [NUM_OF_MGS] =    \
{    DUP_ALL_MG_INTERTTUPT_REG(SERInterruptsSummary             ,SERInterruptsMask               ,DataPathIntSum   ,hawk_GlobalInterruptsSummary##_##treeId,treeId) }

#define hawk_portsInterruptsSummary_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_portsInterruptsSummary##_##treeId     [NUM_OF_MGS] =    \
{    DUP_ALL_MG_INTERTTUPT_REG(stackPortsInterruptCause     ,stackPortsInterruptMask             ,PortsIntSum      ,hawk_GlobalInterruptsSummary##_##treeId,treeId) }

#define hawk_dfxInterruptsSummary_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_dfxInterruptsSummary##_##treeId     [NUM_OF_MGS] =      \
{    DUP_ALL_MG_INTERTTUPT_REG(dfxInterruptsSummaryCause     ,dfxInterruptsSummaryMask           ,dfxIntSum        ,hawk_GlobalInterruptsSummary##_##treeId,treeId) }

#define hawk_dfx1InterruptsSummary_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_dfx1InterruptsSummary##_##treeId     [NUM_OF_MGS] =     \
{    DUP_ALL_MG_INTERTTUPT_REG(dfx1InterruptsSummaryCause    ,dfx1InterruptsSummaryMask          ,dfx1IntSum       ,hawk_GlobalInterruptsSummary##_##treeId,treeId) }

#define hawk_FuncUnitsInterruptsSummary1_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_FuncUnitsInterruptsSummary1##_##treeId [NUM_OF_MGS] =   \
{    DUP_ALL_MG_INTERTTUPT_REG(functionalInterruptsSummary1Cause ,functionalInterruptsSummary1Mask ,FuncUnits1IntsSum ,hawk_GlobalInterruptsSummary##_##treeId,treeId) }

/* this node need support in primary and secondary MG units (to support CNC dump from the FUQ) */
#define hawk_mg_global_misc_interrupts_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_mg_global_misc_interrupts##_##treeId  [NUM_OF_MGS] =    \
{    DUP_ALL_MG_INTERTTUPT_REG(miscellaneousInterruptCause ,miscellaneousInterruptMask ,MgInternalIntSum ,hawk_GlobalInterruptsSummary##_##treeId,treeId) }

/* this node need support in all MG units (to support CM3 interrupts) */
#define hawk_mg1_internal_interrupts_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_mg1_internal_interrupts##_##treeId  [NUM_OF_MGS] =      \
{    DUP_ALL_MG_INTERTTUPT_REG(mg1InternalInterruptsSummaryCause ,mg1InternalInterruptsSummaryMask ,Mg1InternalIntSum ,hawk_GlobalInterruptsSummary##_##treeId,treeId) }

#define hawk_ports1InterruptsSummary_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_ports1InterruptsSummary##_##treeId    [NUM_OF_MGS] =    \
{    DUP_ALL_MG_INTERTTUPT_REG(ports1InterruptsSummaryCause     ,ports1InterruptsSummaryMask     ,ports_1_int_sum  ,hawk_GlobalInterruptsSummary##_##treeId,treeId)  }

_3_TREES(hawk_FuncUnitsInterruptsSummary);
_3_TREES(hawk_dataPathInterruptSummary);
_3_TREES(hawk_portsInterruptsSummary);
_3_TREES(hawk_dfxInterruptsSummary);
_3_TREES(hawk_dfx1InterruptsSummary);
_3_TREES(hawk_FuncUnitsInterruptsSummary1);
_3_TREES(hawk_mg_global_misc_interrupts);
_3_TREES(hawk_mg1_internal_interrupts);
_3_TREES(hawk_ports1InterruptsSummary);


#define MG_SDMA_INTERTTUPT_REG_ENTRY(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt,mgIndex,treeId) \
     MG_SDMA_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,mgIndex,father_myBitIndex,father_interrupt[mgIndex],treeId)


/* duplicate the node of MG to all MG units */
#define DUP_SDMA_MG_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt,treeId) \
     MG_SDMA_INTERTTUPT_REG_ENTRY(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt,MG_0_INDEX,treeId) \
    ,MG_SDMA_INTERTTUPT_REG_ENTRY(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt,MG_1_INDEX,treeId) \
    ,MG_SDMA_INTERTTUPT_REG_ENTRY(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt,MG_2_INDEX,treeId) \
    ,MG_SDMA_INTERTTUPT_REG_ENTRY(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt,MG_3_INDEX,treeId)

/* this node need support in ALL MG units (to MG SDMA) */
#define hawk_mg_global_sdma_receiveSDMA_interrupts_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_mg_global_sdma_receiveSDMA_interrupts##_##treeId  [NUM_OF_MGS] =    \
{    DUP_SDMA_MG_INTERTTUPT_REG(receiveSDMAInterruptCause ,receiveSDMAInterruptMask ,RxSDMASum ,hawk_GlobalInterruptsSummary##_##treeId,treeId) }

/* this node need support in ALL MG units (to MG SDMA) */
#define hawk_mg_global_sdma_transmitSDMA_interrupts_tree(treeId)    \
static SKERNEL_INTERRUPT_REG_INFO_STC  hawk_mg_global_sdma_transmitSDMA_interrupts##_##treeId  [NUM_OF_MGS] =   \
{    DUP_SDMA_MG_INTERTTUPT_REG(transmitSDMAInterruptCause ,transmitSDMAInterruptMask ,TxSDMASum ,hawk_GlobalInterruptsSummary##_##treeId,treeId) };

_3_TREES(hawk_mg_global_sdma_receiveSDMA_interrupts);
_3_TREES(hawk_mg_global_sdma_transmitSDMA_interrupts);
...
#define DUP_ALL_XSMI_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt) \
    ...
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_3_INDEX,father_myBitIndex,father_interrupt[MG_3_INDEX])

static SKERNEL_INTERRUPT_REG_INFO_STC xsmi_interrupts[NUM_OF_MGS] =
{    DUP_ALL_XSMI_INTERTTUPT_REG(XSMI.XSMIInterruptCause ,XSMI.XSMIInterruptMask ,xsmiIntSum ,hawk_GlobalInterruptsSummary_0)};
...
static SKERNEL_INTERRUPT_REG_INFO_STC cnc_summary_interrupts[] =
{
   ...
   ,{
   /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[2].globalRegs.CNCInterruptSummaryCauseReg)},/*SMEM_CHT3_CNC_INTR_CAUSE_REG*/
   /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[2].globalRegs.CNCInterruptSummaryMaskReg)},
   /*myFatherInfo*/{
       /*myBitIndex*/cp_top_pipe0_cnc2_int_sum ,
       /*interruptPtr*/&cnm_grp_0_0_intr
       },
   /*isTriggeredByWrite*/ 0
   }
  ,{
   /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[3].globalRegs.CNCInterruptSummaryCauseReg)},/*SMEM_CHT3_CNC_INTR_CAUSE_REG*/
   /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[3].globalRegs.CNCInterruptSummaryMaskReg)},
   /*myFatherInfo*/{
       /*myBitIndex*/cp_top_pipe0_cnc3_int_sum,
       /*interruptPtr*/&cnm_grp_0_0_intr
       },
   /*isTriggeredByWrite*/ 0
   }
...
{
    {
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[0].globalRegs.wraparoundFunctionalInterruptCauseReg)},/*SMEM_CHT3_CNC_INTR_CAUSE_REG*/
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[0].globalRegs.wraparoundFunctionalInterruptMaskReg)},
    /*myFatherInfo*/{
        /*myBitIndex*/1 ,
        /*interruptPtr*/&cnc_summary_interrupts[0]
        },
    /*isTriggeredByWrite*/ 1
    }
   ,{
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[1].globalRegs.wraparoundFunctionalInterruptCauseReg)},/*SMEM_CHT3_CNC_INTR_CAUSE_REG*/
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[1].globalRegs.wraparoundFunctionalInterruptMaskReg)},
    /*myFatherInfo*/{
        /*myBitIndex*/1,
        /*interruptPtr*/&cnc_summary_interrupts[1]
        },
    /*isTriggeredByWrite*/ 1
    }
   ,{
   /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[2].globalRegs.wraparoundFunctionalInterruptCauseReg)},/*SMEM_CHT3_CNC_INTR_CAUSE_REG*/
   /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[2].globalRegs.wraparoundFunctionalInterruptMaskReg)},
   /*myFatherInfo*/{
       /*myBitIndex*/1 ,
       /*interruptPtr*/&cnc_summary_interrupts[2]
       },
   /*isTriggeredByWrite*/ 1
   }
  ,{
   /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[3].globalRegs.wraparoundFunctionalInterruptCauseReg)},/*SMEM_CHT3_CNC_INTR_CAUSE_REG*/
   /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(CNC[3].globalRegs.wraparoundFunctionalInterruptMaskReg)},
   /*myFatherInfo*/{
       /*myBitIndex*/1,
       /*interruptPtr*/&cnc_summary_interrupts[3]
       },
   /*isTriggeredByWrite*/ 1
   }
};
...
static SKERNEL_INTERRUPT_REG_INFO_STC hawk_lmu_summary_cause_interrupts[] =
{
    {
        ...
        /*myFatherInfo*/{
            /*myBitIndex*/gop_downlink_top_pca0_lmu_interrupt_cause_int_sum ,
   ...
   ,{
        ...
        /*myFatherInfo*/{
            /*myBitIndex*/gop_downlink_top_pca1_lmu_interrupt_cause_int_sum,
            /*interruptPtr*/&cnm_grp_0_3_intr
            },
        /*isTriggeredByWrite*/ 1
    }
   ,{
        ...
        /*myFatherInfo*/{
            /*myBitIndex*/gop_uplink_top_pca2_lmu_interrupt_cause_int_sum,
            /*interruptPtr*/&cnm_grp_0_4_intr
            },
        /*isTriggeredByWrite*/ 1
    }
   ,{
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(LMU[3].summary_cause)},
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(LMU[3].summary_mask)},
        /*myFatherInfo*/{
            /*myBitIndex*/gop_uplink_top_pca3_lmu_interrupt_cause_int_sum,
...
#define hawk_LMU_latencyOverThresholdCause(lmuIndex, k)                                                  \
    {                                                                                                       \
        ...
        /*myFatherInfo*/{                                                                                   \
            /*myBitIndex*/1 + k,                                                                            \
            /*interruptPtr*/&hawk_lmu_summary_cause_interrupts[lmuIndex]                                    \
        },                                                                                                  \
        /*isTriggeredByWrite*/ 1                                                                            \
    }

#define HAWK_LMU_LATENCY_OVER_THRESHOLD_MAC(lmuIndex)                                                    \
         hawk_LMU_latencyOverThresholdCause(lmuIndex,  0)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex,  1)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex,  2)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex,  3)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex,  4)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex,  5)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex,  6)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex,  7)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex,  8)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex,  9)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex, 10)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex, 11)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex, 12)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex, 13)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex, 14)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex, 15)                                                \
        ,hawk_LMU_latencyOverThresholdCause(lmuIndex, 16)

static SKERNEL_INTERRUPT_REG_INFO_STC hawk_lmu_latency_over_threshold_interrupts[] =
{
     HAWK_LMU_LATENCY_OVER_THRESHOLD_MAC(0)
    ,HAWK_LMU_LATENCY_OVER_THRESHOLD_MAC(1)
    ,HAWK_LMU_LATENCY_OVER_THRESHOLD_MAC(2)
    ,HAWK_LMU_LATENCY_OVER_THRESHOLD_MAC(3)
};
...
{
    {
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(EXACT_MATCH[SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT].emInterrupt.emInterruptCauseReg)},
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(EXACT_MATCH[SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT].emInterrupt.emInterruptMaskReg)},
    /*myFatherInfo*/{
...
)
{
    ...
    { /* MG unit related interrupts */
        ...
        {
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_FuncUnitsInterruptsSummary,mgIndex);
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_FuncUnitsInterruptsSummary1,mgIndex);
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_dataPathInterruptSummary,mgIndex);
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_portsInterruptsSummary,mgIndex);

            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_ports1InterruptsSummary,mgIndex);
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_ports2InterruptsSummary,mgIndex);
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_mg1_internal_interrupts,mgIndex);
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_dfxInterruptsSummary,mgIndex);
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_dfx1InterruptsSummary,mgIndex);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &xsmi_interrupts[mgIndex]);

            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_GlobalInterruptsSummary  ,mgIndex         );
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_mg_global_misc_interrupts,mgIndex         );
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_mg_global_sdma_receiveSDMA_interrupts ,mgIndex);
            MG_NODE_ADD_ALL_3_TREES(index, &currDbPtr, hawk_mg_global_sdma_transmitSDMA_interrupts,mgIndex);
        }
    }

    INTERRUPT_TREE_ADD_NODE_WITH_CHECK(index, &currDbPtr, hawk_lmu_summary_cause_interrupts);
    INTERRUPT_TREE_ADD_NODE_WITH_CHECK(index, &currDbPtr, hawk_lmu_latency_over_threshold_interrupts);
...
)
{
    ...
    BIND_MG_NODE_TO_FATHER_ALL_3_TREES(hawk_ports2InterruptsSummary,MG_0_INDEX,hawk_GlobalInterruptsSummary,MG_0_INDEX);
    BIND_MG_NODE_TO_FATHER_ALL_3_TREES(hawk_ports2InterruptsSummary,MG_1_INDEX,hawk_GlobalInterruptsSummary,MG_0_INDEX);
    BIND_MG_NODE_TO_FATHER_ALL_3_TREES(hawk_ports2InterruptsSummary,MG_2_INDEX,hawk_GlobalInterruptsSummary,MG_0_INDEX);
    BIND_MG_NODE_TO_FATHER_ALL_3_TREES(hawk_ports2InterruptsSummary,MG_3_INDEX,hawk_GlobalInterruptsSummary,MG_0_INDEX);

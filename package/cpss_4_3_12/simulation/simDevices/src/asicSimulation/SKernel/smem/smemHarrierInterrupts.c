...
static SKERNEL_INTERRUPT_REG_INFO_STC harrier_lmu_summary_cause_interrupts[] =
{
    {
...
#define harrier_LMU_latencyOverThresholdCause(lmuIndex, k)                                                  \
    {                                                                                                       \
        ...
        /*myFatherInfo*/{                                                                                   \
            /*myBitIndex*/1 + k,                                                                            \
            /*interruptPtr*/&harrier_lmu_summary_cause_interrupts[lmuIndex]                                 \
        },                                                                                                  \
        /*isTriggeredByWrite*/ 1                                                                            \
    }
...
static SKERNEL_INTERRUPT_REG_INFO_STC harrier_lmu_latency_over_threshold_interrupts[] =
{
...
static SKERNEL_INTERRUPT_REG_INFO_STC  harrier_serdes_interrupts[] =
{
    {
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[0].sip_6_10_SERDES.SDWInterruptCause)},
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[0].sip_6_10_SERDES.SDWInterruptMask)},
    /*myFatherInfo*/{
        /*myBitIndex*/ gop_downlink_epi0_sdw_int_0_sum ,
        /*interruptPtr*/&cnm_grp_0_1_intr
        },
    /*isTriggeredByWrite*/ 1
    },
    {
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[1].sip_6_10_SERDES.SDWInterruptCause)},
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[1].sip_6_10_SERDES.SDWInterruptMask)},
    /*myFatherInfo*/{
        /*myBitIndex*/ gop_downlink_epi0_sdw_int_1_sum ,
        /*interruptPtr*/&cnm_grp_0_1_intr
        },
    /*isTriggeredByWrite*/ 1
    },
    {
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[2].sip_6_10_SERDES.SDWInterruptCause)},
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[2].sip_6_10_SERDES.SDWInterruptMask)},
    /*myFatherInfo*/{
        /*myBitIndex*/ gop_downlink_epi1_sdw_int_0_sum ,
        /*interruptPtr*/&cnm_grp_0_1_intr
        },
    /*isTriggeredByWrite*/ 1
    },
    {
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[3].sip_6_10_SERDES.SDWInterruptCause)},
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[3].sip_6_10_SERDES.SDWInterruptMask)},
    /*myFatherInfo*/{
        /*myBitIndex*/ gop_downlink_epi1_sdw_int_1_sum ,
        /*interruptPtr*/&cnm_grp_0_1_intr
        },
    /*isTriggeredByWrite*/ 1
    },
    {
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[4].sip_6_10_SERDES.SDWInterruptCause)},
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(sip_6_10_SERDES[4].sip_6_10_SERDES.SDWInterruptMask)},
    /*myFatherInfo*/{
        /*myBitIndex*/ gop_downlink_top_epi2_sdw_int_sum ,
...
{    DUP_ALL_XSMI_INTERTTUPT_REG(XSMI.XSMIInterruptCause ,XSMI.XSMIInterruptMask ,xsmiIntSum ,harrier_GlobalInterruptsSummary)};
...
)
{
    ...
    { /* MG unit related interrupts */
        ...
        {
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &harrier_FuncUnitsInterruptsSummary[mgIndex]);
            /*INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &harrier_FuncUnitsInterruptsSummary1[mgIndex]);*/
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &harrier_dataPathInterruptSummary[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &harrier_portsInterruptsSummary[mgIndex]);

            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &harrier_ports2InterruptsSummary[mgIndex]);
            /*INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &harrier_mg1_internal_interrupts[mgIndex]);*/
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &harrier_dfxInterruptsSummary[mgIndex]);
            /*INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &harrier_dfx1InterruptsSummary[mgIndex]);*/
    ...
    INTERRUPT_TREE_ADD_NODE_WITH_CHECK(index, &currDbPtr, harrier_serdes_interrupts);
    INTERRUPT_TREE_ADD_NODE_WITH_CHECK(index, &currDbPtr, harrier_mac_ports_interrupts);
    INTERRUPT_TREE_ADD_NODE_WITH_CHECK(index, &currDbPtr, harrier_lmu_latency_over_threshold_interrupts);
    INTERRUPT_TREE_ADD_NODE_WITH_CHECK(index, &currDbPtr, harrier_lmu_summary_cause_interrupts);

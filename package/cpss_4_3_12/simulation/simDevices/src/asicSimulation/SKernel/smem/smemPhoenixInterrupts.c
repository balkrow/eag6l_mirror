...
static SKERNEL_INTERRUPT_REG_INFO_STC  phoenix_mg1_internal_interrupts  [NUM_OF_MGS] =
{    DUP_ALL_MG_INTERTTUPT_REG(mg1InternalInterruptsSummaryCause ,mg1InternalInterruptsSummaryMask ,Mg1InternalIntSum ,phoenix_GlobalInterruptsSummary) };
...
{    DUP_ALL_XSMI_INTERTTUPT_REG(XSMI.XSMIInterruptCause ,XSMI.XSMIInterruptMask ,xsmiIntSum ,phoenix_GlobalInterruptsSummary)};
...
/*        INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &phoenix_portsInterruptsSummary[mgIndex]); */
        ...
        {
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &phoenix_FuncUnitsInterruptsSummary[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &phoenix_FuncUnits1InterruptsSummary[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &phoenix_dataPathInterruptSummary[mgIndex]);

            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &phoenix_mg1_internal_interrupts[mgIndex]);

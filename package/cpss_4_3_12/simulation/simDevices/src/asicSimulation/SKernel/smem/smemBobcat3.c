...
{ /*tableOffsetValid,tableOffsetInBytes*/     /*startAddr*/ /*lastAddr*/    /*table_unitType_deviceAccess*/  /*table_unitType_cpu_access*/
     {SMEM_BIND_TABLE_MAC(arpTable)/*tunnelStartTable*/       ,0           ,0          ,UNIT_TYPE_PIPE_0_AND_PIPE_1_E ,UNIT_TYPE_PIPE_0_AND_PIPE_1_E}
    /* must be last  */
    ,{0,0                                           ,0           ,0          ,0                             ,0}
};
...
)
{
    ...
    else if (devObjPtr->cmFwSim)
    { /* When simulating CM Firmware, don't define Active write registers used for MicroInit simulation */
        START_BIND_UNIT_ACTIVE_MEM_MAC(devObjPtr, unitPtr)

        ACTIVE_MEM_MG_COMMON_MAC ,

        {0x00000800, 0xfffffc00,
            NULL, 0, smemFalconActiveWriteHWSemaphore, 0},

        {0x00000534, 0xffffffff,
            NULL, 0, smemFalconActiveWriteDoorbellHostToCm, 0},

        {0x00000538, 0xffffffff,
            NULL, 0, smemFalconActiveWriteDoorbellCmToHost, 0},

        {0x00000440, 0xfffffff0,
            NULL, 0, smemFalconActiveWriteDoorbellCPToCP, 0},

        {0x00000410, 0xffffffff,
            NULL, 0, smemFalconActiveWriteTimer1StartReg, 0},

        {0x00000414, 0xffffffff,
            NULL, 0, smemFalconActiveWriteTimer1ControlReg, 0},
    ...
    if ( (isSip6_20 == 1) && (!devObjPtr->cmFwSim) )
    { /* For CM FW simulation, external process "boots" independently */
    ...
    else
    {
        ...
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000003A0, 0x000003C0)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x000003F0, 0x000003FC)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x00000400, 28)} /* add another fake register to inicate watchdog expired */
        ...
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00032000, 0x00032000)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_END_ADDR_MAC (0x00032008, 0x00032014)}
        ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_SHARED_MEM_MAC (0x00080000, 393216, "UNIT_MG")}
    ...
    /*,{DUMMY_NAME_PTR_CNS,           0x0000004c,         0x000e0000,      1,    0x4    }Device_ID*/
            ...
            ,{DUMMY_NAME_PTR_CNS,           0x00000800,         0x000000ff,      128,    0x4    }/*Unit_Default_ID*/
            ,{DUMMY_NAME_PTR_CNS,           0x00000534,         0x00000000,      2,    0x4    }/*Unit_Default_ID*/
            ,{DUMMY_NAME_PTR_CNS,           0x00000440,         0x00000000,      4,    0x4    }/*Unit_Default_ID*/
...
)
{

    {
        ...
        /*SMEM_BIND_TABLE_MAC(arpTable)-- tunnelStartTable*/
...

    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x00400000, 2097152), SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(384,64) , SMEM_BIND_TABLE_MAC(arpTable)/*tunnelStartTable*/}
        };
        GT_U32  numOfChunks = sizeof(chunksMem)/sizeof(SMEM_CHUNK_BASIC_STC);
...
)
{

    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x00100000, 1048576), SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(162, 32) , SMEM_BIND_TABLE_MAC(mllTable)}
        };
        GT_U32  numOfChunks = sizeof(chunksMem)/sizeof(SMEM_CHUNK_BASIC_STC);
...
)
{
    ...
    {0x28, 0xFFFFFFFF, NULL, 0 , smemLion3ActiveWriteTodStepConfReg, 0},

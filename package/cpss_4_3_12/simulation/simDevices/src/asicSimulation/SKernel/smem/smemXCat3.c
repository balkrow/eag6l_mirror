...
static SKERNEL_DEVICE_ROUTE_TCAM_INFO_STC  xcatRoutTcamInfo =
{
...
{
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[0].SERInterruptsSummary),0, MG0 | MG_UNIT_USED_CNS},
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[0].SERInterruptsMask   ),0, MG0 | MG_UNIT_USED_CNS},
    /*myFatherInfo*/{
...
static SKERNEL_INTERRUPT_REG_INFO_STC xCat3InterruptsTreeDb[] = {
    {
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[0].SDMARegs.receiveSDMAInterruptCause),0, MG0 | MG_UNIT_USED_CNS}, /*SMEM_CHT_SDMA_INT_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[0].SDMARegs.receiveSDMAInterruptMask ),0, MG0 | MG_UNIT_USED_CNS},
        /*myFatherInfo*/{
    ...
    ,{
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[0].SDMARegs.transmitSDMAInterruptCause),0, MG0 | MG_UNIT_USED_CNS},/*SMEM_CHT_TX_SDMA_INT_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[0].SDMARegs.transmitSDMAInterruptMask) ,0, MG0 | MG_UNIT_USED_CNS},
        /*myFatherInfo*/{
   ...
   ,{
    ...
    ,{
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[0].miscellaneousInterruptCause),0, MG0 | MG_UNIT_USED_CNS},/*SMEM_CHT_MISC_INTR_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[0].miscellaneousInterruptMask ),0, MG0 | MG_UNIT_USED_CNS},
        /*myFatherInfo*/{
    ...
    SMEM_UNIT_CHUNKS_STC * unitChunkPtr = UNIT_CHUNK_PTR_MAC(devMemInfoPtr, SMEM_XCAT3_UNIT_FDB_E);
    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
             ...
             {SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC(0x0B400000, 262144),
              SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(114, 16),SMEM_BIND_TABLE_MAC(fdbTable)}
        };
        GT_U32  numOfChunks = sizeof(chunksMem)/sizeof(SMEM_CHUNK_BASIC_STC);
    ...
    SMEM_UNIT_CHUNKS_STC * unitChunkPtr = UNIT_CHUNK_PTR_MAC(devMemInfoPtr, SMEM_XCAT3_UNIT_HA_E);
    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            {SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC(0x1C040000, 32768),
             SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(192, 32),SMEM_BIND_TABLE_MAC(arpTable)}
...
)
{
    ...
    devObjPtr->memUnitBaseAddrInfo.mllRegBase = 0x19000000;
    ...
    devObjPtr->tablesInfo.mllTable.commonInfo.baseAddress = 0x19080000;
    ...
    /* devObjPtr->tablesInfo.arpTable.commonInfo.baseAddress = 0x1C040000 */
    devObjPtr->tablesInfo.arpTable.paramInfo[0].divider = 4;
...
)
{
    ...
    {/*start of unit MG - MG  */
        ...
        {/*start of unit MGRegsMGMiscellaneous */
            ...
            regAddrDbPtr->MG.globalInterrupt[0].functionalInterruptsSummaryCause = 0x000003F8;
            regAddrDbPtr->MG.globalInterrupt[0].functionalInterruptsSummaryMask = 0x000003FC;
            regAddrDbPtr->MG.globalInterrupt[0].functionalInterruptsSummary1Cause = 0x000003F4;
            regAddrDbPtr->MG.globalInterrupt[0].functionalInterruptsSummary1Mask = 0x000003F0;

            regAddrDbPtr->MG.globalInterrupt[0].ports1InterruptsSummaryCause = 0x00000150;
            regAddrDbPtr->MG.globalInterrupt[0].ports1InterruptsSummaryMask  = 0x00000154;

            regAddrDbPtr->MG.globalInterrupt[0].ports2InterruptsSummaryCause = 0x00000158;
            regAddrDbPtr->MG.globalInterrupt[0].ports2InterruptsSummaryMask  = 0x0000015c;

            regAddrDbPtr->MG.globalInterrupt[0].dfx1InterruptsSummaryCause   = 0x000000B8;
            regAddrDbPtr->MG.globalInterrupt[0].dfx1InterruptsSummaryMask    = 0x000000BC;
            ...
            regAddrDbPtr->MG.globalInterrupt[0].globalInterruptCause = 0x00000030;
            regAddrDbPtr->MG.globalInterrupt[0].globalInterruptMask = 0x00000034;
            regAddrDbPtr->MG.globalInterrupt[0].miscellaneousInterruptCause = 0x00000038;
            regAddrDbPtr->MG.globalInterrupt[0].miscellaneousInterruptMask = 0x0000003c;
            regAddrDbPtr->MG.globalInterrupt[0].stackPortsInterruptCause = 0x00000080;
            regAddrDbPtr->MG.globalInterrupt[0].stackPortsInterruptMask = 0x00000084;
            regAddrDbPtr->MG.globalInterrupt[0].SERInterruptsSummary = 0x000000a4;
            regAddrDbPtr->MG.globalInterrupt[0].SERInterruptsMask = 0x000000a8;

            regAddrDbPtr->MG.globalInterrupt[0].dfxInterruptsSummaryCause = 0x000000ac;
            regAddrDbPtr->MG.globalInterrupt[0].dfxInterruptsSummaryMask  = 0x000000b0;

            regAddrDbPtr->MG.globalInterrupt[1].globalInterruptCause = 0x00000610;
            regAddrDbPtr->MG.globalInterrupt[1].globalInterruptMask = 0x00000614;
            regAddrDbPtr->MG.globalInterrupt[1].miscellaneousInterruptCause = 0x00000618;
            regAddrDbPtr->MG.globalInterrupt[1].miscellaneousInterruptMask = 0x0000061C;
            regAddrDbPtr->MG.globalInterrupt[1].stackPortsInterruptCause = 0x00000620;
            regAddrDbPtr->MG.globalInterrupt[1].stackPortsInterruptMask = 0x00000624;
            regAddrDbPtr->MG.globalInterrupt[1].SERInterruptsSummary = 0x00000628;
            regAddrDbPtr->MG.globalInterrupt[1].SERInterruptsMask = 0x0000062c;
            regAddrDbPtr->MG.globalInterrupt[1].functionalInterruptsSummaryCause = 0x0000064c;
            regAddrDbPtr->MG.globalInterrupt[1].functionalInterruptsSummaryMask = 0x00000650;
            regAddrDbPtr->MG.globalInterrupt[1].functionalInterruptsSummary1Cause = 0x00000648;
            regAddrDbPtr->MG.globalInterrupt[1].functionalInterruptsSummary1Mask = 0x00000644;
            regAddrDbPtr->MG.globalInterrupt[1].ports1InterruptsSummaryCause = 0x00000160;
            regAddrDbPtr->MG.globalInterrupt[1].ports1InterruptsSummaryMask = 0x00000164;
            regAddrDbPtr->MG.globalInterrupt[1].ports2InterruptsSummaryCause = 0x00000168;
            regAddrDbPtr->MG.globalInterrupt[1].ports2InterruptsSummaryMask = 0x0000016c;
            regAddrDbPtr->MG.globalInterrupt[1].dfxInterruptsSummaryCause = 0x00000630;
            regAddrDbPtr->MG.globalInterrupt[1].dfxInterruptsSummaryMask =0x00000634;
            regAddrDbPtr->MG.globalInterrupt[1].dfx1InterruptsSummaryCause = 0x0000638;
            regAddrDbPtr->MG.globalInterrupt[1].dfx1InterruptsSummaryMask = 0x0000063c;

            regAddrDbPtr->MG.globalInterrupt[2].globalInterruptCause = 0x00000670;
            regAddrDbPtr->MG.globalInterrupt[2].globalInterruptMask = 0x00000674;
            regAddrDbPtr->MG.globalInterrupt[2].miscellaneousInterruptCause = 0x00000678;
            regAddrDbPtr->MG.globalInterrupt[2].miscellaneousInterruptMask = 0x0000067C;
            regAddrDbPtr->MG.globalInterrupt[2].stackPortsInterruptCause = 0x00000680;
            regAddrDbPtr->MG.globalInterrupt[2].stackPortsInterruptMask = 0x00000684;
            regAddrDbPtr->MG.globalInterrupt[2].SERInterruptsSummary = 0x00000688;
            regAddrDbPtr->MG.globalInterrupt[2].SERInterruptsMask = 0x0000068C;
            regAddrDbPtr->MG.globalInterrupt[2].functionalInterruptsSummaryCause = 0x000006AC;
            regAddrDbPtr->MG.globalInterrupt[2].functionalInterruptsSummaryMask = 0x000006B0;
            regAddrDbPtr->MG.globalInterrupt[2].functionalInterruptsSummary1Cause = 0x000006A8;
            regAddrDbPtr->MG.globalInterrupt[2].functionalInterruptsSummary1Mask = 0x000006A4;
            regAddrDbPtr->MG.globalInterrupt[2].ports1InterruptsSummaryCause = 0x00000170;
            regAddrDbPtr->MG.globalInterrupt[2].ports1InterruptsSummaryMask = 0x00000174;
            regAddrDbPtr->MG.globalInterrupt[2].ports2InterruptsSummaryCause = 0x00000178;
            regAddrDbPtr->MG.globalInterrupt[2].ports2InterruptsSummaryMask = 0x0000017C;
            regAddrDbPtr->MG.globalInterrupt[2].dfxInterruptsSummaryCause = 0x00000690;
            regAddrDbPtr->MG.globalInterrupt[2].dfxInterruptsSummaryMask =0x00000694;
            regAddrDbPtr->MG.globalInterrupt[2].dfx1InterruptsSummaryCause = 0x00000698;
            regAddrDbPtr->MG.globalInterrupt[2].dfx1InterruptsSummaryMask = 0x0000069C;


            regAddrDbPtr->MG.globalInterrupt[0].SDMARegs.receiveSDMAInterruptCause  = 0x0000280c;
            regAddrDbPtr->MG.globalInterrupt[0].SDMARegs.transmitSDMAInterruptCause = 0x00002810;
            regAddrDbPtr->MG.globalInterrupt[0].SDMARegs.receiveSDMAInterruptMask   = 0x00002814;
            regAddrDbPtr->MG.globalInterrupt[0].SDMARegs.transmitSDMAInterruptMask  = 0x00002818;

            regAddrDbPtr->MG.globalInterrupt[1].SDMARegs.receiveSDMAInterruptCause  = 0x00002890;
            regAddrDbPtr->MG.globalInterrupt[1].SDMARegs.transmitSDMAInterruptCause = 0x00002898;
            regAddrDbPtr->MG.globalInterrupt[1].SDMARegs.receiveSDMAInterruptMask   = 0x000028A0;
            regAddrDbPtr->MG.globalInterrupt[1].SDMARegs.transmitSDMAInterruptMask  = 0x000028A8;

            regAddrDbPtr->MG.globalInterrupt[2].SDMARegs.receiveSDMAInterruptCause  = 0x00002894;
            regAddrDbPtr->MG.globalInterrupt[2].SDMARegs.transmitSDMAInterruptCause = 0x0000289C;
            regAddrDbPtr->MG.globalInterrupt[2].SDMARegs.receiveSDMAInterruptMask   = 0x000028A4;
            regAddrDbPtr->MG.globalInterrupt[2].SDMARegs.transmitSDMAInterruptMask  = 0x000028AC;
    ...
    {/*start of unit HA - HA  */
        ...
        regAddrDbPtr->HA.MPLSEthertype[0] = 0x1c000480;

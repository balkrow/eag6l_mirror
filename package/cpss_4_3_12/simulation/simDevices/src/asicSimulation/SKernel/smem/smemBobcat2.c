...
#define BOBCAT2_ACTIVE_READ_OAM_MASK_CNS   0xFFFFFC00
...
#define ACTIVE_MEM_OAM_COMMON_SIP5_MAC(oamId)                                                                      \
    ...
    {0x000000D0, SMEM_FULL_MASK_CNS, NULL, oamId , smemLion3ActiveWriteOamTbl,oamId},                   \
                                                                                                        \
    /* Aging Table */                                                                                   \
    {0x00000c00, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
    /* Meg Exception Table */                                                                           \
    {0x00010000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
    /* Source Interface Exception Table */                                                              \
    {0x00018000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
    /* Invalid Keepalive Hash Exception Table */                                                        \
    {0x00020000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
    /* Excess Keepalive Exception Table */                                                              \
    {0x00028000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
    /* OAM Exception Summary Table */                                                                   \
    {0x00030000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
    /* RDI Status Change Exception Table */                                                             \
    {0x00038000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
    /* Tx Period Exception Table */                                                                     \
    {0x00040000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
                                                                                                        \
...
#define ACTIVE_MEM_OAM_COMMON_SIP5_15_MAC(oamId)                                                        \
    ...
    {0x000000D0, SMEM_FULL_MASK_CNS, NULL, oamId , smemLion3ActiveWriteOamTbl,oamId},                   \
                                                                                                        \
    /* Aging Table */                                                                                   \
    {0x00007000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
    /* Meg Exception Table */                                                                           \
    {0x00010000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
    /* Source Interface Exception Table */                                                              \
    {0x00018000, BOBCAT2_ACTIVE_READ_OAM_MASK_CNS, smemLion3ActiveReadExceptionSummaryBitmap, oamId , NULL,oamId},    \
...
{
    {
        SMEM_CHUNK_BASIC_STC  chunksMem[]=
        {
            ...
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x00030000, 4096),
                SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(126 , 16),SMEM_BIND_TABLE_MAC(tmQueueMapQueueSelector)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x00010000, 4096),
                SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(8 , 4),SMEM_BIND_TABLE_MAC(tmQueueMapTargetDeviceToIndex)}
            ,{SET_SMEM_CHUNK_BASIC_STC_ENTRY_BY_NUM_BYTES_MAC (0x00001000, 1024),
                SET_SMEM_ENTRY_SIZE_AND_ALIGN_MAC(4 , 4),SMEM_BIND_TABLE_MAC(tmQueueMapCpuCodeToTc)}
        };
        GT_U32  numOfChunks = sizeof(chunksMem)/sizeof(SMEM_CHUNK_BASIC_STC);
...
{
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].globalInterruptCause)},/*SMEM_CHT_GLB_INT_CAUSE_REG*/
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].globalInterruptMask)},
    /*myFatherInfo*/{
        /*myBitIndex*/0 ,
...
#define  FUNC_UNITS1_INTERRUPTS_SUMMARY_MAC  \
    {                                       \
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].functionalInterruptsSummary1Cause)},\
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].functionalInterruptsSummary1Mask)}, \
        /*myFatherInfo*/{                                                                                          \
...
#define  FUNC_UNITS_INTERRUPTS_SUMMARY_MAC  \
    {                                       \
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].functionalInterruptsSummaryCause)},\
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].functionalInterruptsSummaryMask)}, \
        /*myFatherInfo*/{                                                                                         \
...
{
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].SERInterruptsSummary)},
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].SERInterruptsMask)},
    /*myFatherInfo*/{
...
{
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].stackPortsInterruptCause)},/*SMEM_CHT3_XG_PORTS_INTERRUPT_CAUSE_REG*/
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].stackPortsInterruptMask)},/*SMEM_CHT3_XG_PORTS_INTERRUPT_MASK_REG*/
    /*myFatherInfo*/{
...
{
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].ports1InterruptsSummaryCause)},/**/
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].ports1InterruptsSummaryMask)},/**/
    /*myFatherInfo*/{
...
{
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].ports2InterruptsSummaryCause)},/**/
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].ports2InterruptsSummaryMask)},/**/
    /*myFatherInfo*/{
...
{
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].dfxInterruptsSummaryCause)},/**/
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].dfxInterruptsSummaryMask)},/**/
    /*myFatherInfo*/{
...
{
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].dfx1InterruptsSummaryCause)},/**/
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].dfx1InterruptsSummaryMask)},/**/
    /*myFatherInfo*/{
...
{
    {
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].SDMARegs.receiveSDMAInterruptCause)}, /*SMEM_CHT_SDMA_INT_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].SDMARegs.receiveSDMAInterruptMask)},
        /*myFatherInfo*/{
    ...
    {
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].SDMARegs.transmitSDMAInterruptCause)},/*SMEM_CHT_TX_SDMA_INT_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].SDMARegs.transmitSDMAInterruptMask)},
        /*myFatherInfo*/{
...
{
    {
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].miscellaneousInterruptCause)},/*SMEM_CHT_MISC_INTR_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].miscellaneousInterruptMask)},
        /*myFatherInfo*/{
...
)
{
    ...
    devObjPtr->errata.ipfixTodIncrementModeWraparoundIssues = 0; /*[JIRA] (POLICER-1370) [ERR-5031469]*/
    ...
    devObjPtr->errata.ttiTemotePhysicalPortOrigSrcPhyIsTrunk = 0;/*TTI-1511 : TTI does not set <Orig Phy Src is Trunk> <Orig Phy Src Trunk> in centralized switching remote source physical port */
    ...
    if(0 == SMEM_CHT_IS_SIP6_30_GET(devObjPtr))
    {
        return;
    }

    /* Fixed in IronMan */
    devObjPtr->errata.byte_count_missing_4_bytes_in_L2i = 0; /* [JIRA] [L2I-794] Maximum Receive Unit (MRU) limit per eVLAN - 4 bytes unaccounted for */
}

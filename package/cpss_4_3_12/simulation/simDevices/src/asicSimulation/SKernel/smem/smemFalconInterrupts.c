...
static SKERNEL_INTERRUPT_REG_INFO_STC  falcon_GlobalInterruptsSummary    [NUM_OF_MGS] =
{
    { /* copied from GlobalInterruptsSummary */
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].globalInterruptCause),0,MG_0_0_INDEX | MG_TREE_ID(SINGLE_TREE_ID) | MG_UNIT_USED_CNS},/*SMEM_CHT_GLB_INT_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[SINGLE_TREE_ID].globalInterruptMask) ,0,MG_0_0_INDEX | MG_TREE_ID(SINGLE_TREE_ID) | MG_UNIT_USED_CNS},
        /*myFatherInfo*/{
            /*myBitIndex*/0 ,
...
static SKERNEL_INTERRUPT_REG_INFO_STC  tile1_tree1_nodes    [] =
{
    /*  MG4 : global of tree 1 */
    {
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].globalInterruptCause),0,MG_1_0_INDEX | MG_TREE_ID(1) | MG_UNIT_USED_CNS},/*SMEM_CHT_GLB_INT_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].globalInterruptMask) ,0,MG_1_0_INDEX | MG_TREE_ID(1) | MG_UNIT_USED_CNS},
        /*myFatherInfo*/{
            /*myBitIndex*/0 ,
            /*interruptPtr*/NULL /* no father for me , thank you */
            },
    ...
    /*  MG4 : 'ports 2' of tree 1 */
    {
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].ports2InterruptsSummaryCause),0,MG_1_0_INDEX | MG_TREE_ID(1) | MG_UNIT_USED_CNS},/*SMEM_CHT_GLB_INT_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].ports2InterruptsSummaryMask) ,0,MG_1_0_INDEX | MG_TREE_ID(1) | MG_UNIT_USED_CNS},
        /*myFatherInfo*/{
            /*myBitIndex*/0 ,
            /*interruptPtr*/NULL /* no father for me , thank you */
            },
...
{                                                                                                               \
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].mg_causeRegName), 0, mgIndex | MG_TREE_ID(1) | MG_UNIT_USED_CNS}, \
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].mg_maskRegName ), 0, mgIndex | MG_TREE_ID(1) | MG_UNIT_USED_CNS}, \
        /*myFatherInfo*/{                                                                      \
            /*myBitIndex*/  father_myBitIndex ,                                                \
            /*interruptPtr*/&father_interrupt                                                  \
            },                                                                                 \
...
{                                                                                              \
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].SDMARegs.mg_causeRegName),0, MG_2_0_INDEX | MG_TREE_ID(1) | MG_UNIT_USED_CNS}, \
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].SDMARegs.mg_maskRegName ),0, MG_2_0_INDEX | MG_TREE_ID(1) | MG_UNIT_USED_CNS}, \
        /*myFatherInfo*/{                                                                      \
            /*myBitIndex*/  father_myBitIndex,                                                 \
            /*interruptPtr*/&father_interrupt                                                  \
            },                                                                                 \
...
{
    { /* copied from GlobalInterruptsSummary */
        /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].globalInterruptCause), 0, MG_2_0_INDEX | MG_TREE_ID(1) | MG_UNIT_USED_CNS},/*SMEM_CHT_GLB_INT_CAUSE_REG*/
        /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.globalInterrupt[1].globalInterruptMask) , 0, MG_2_0_INDEX | MG_TREE_ID(1) | MG_UNIT_USED_CNS},
        /*myFatherInfo*/{
...
{
    MG_SDMA_INTERTTUPT_TREE1_REG(receiveSDMAInterruptCause, receiveSDMAInterruptMask, RxSDMASum, falcon_GlobalInterruptsSummary_MG8_tree1[0])
};

static SKERNEL_INTERRUPT_REG_INFO_STC  falcon_mg_global_sdma_transmitSDMA_interrupts_MG8_tree1[] =
{
    MG_SDMA_INTERTTUPT_TREE1_REG(transmitSDMAInterruptCause, transmitSDMAInterruptMask, TxSDMASum, falcon_GlobalInterruptsSummary_MG8_tree1[0])
};
...
#define  raven_x_globalInterruptsSummary(ravenIndex) \
    {                                                \
        /*causeReg*/{ SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(MG_RAVEN[ravenIndex].globalInterrupt[SINGLE_TREE_ID].globalInterruptCause) }, /**/ \
        /*maskReg*/{ SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(MG_RAVEN[ravenIndex].globalInterrupt[SINGLE_TREE_ID].globalInterruptMask) }, /**/   \
        /*myFatherInfo*/{                                                     \
...
#define  raven_x_portsInterruptsSummary(ravenIndex)  \
    {                                                \
        /*causeReg*/{ SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(MG_RAVEN[ravenIndex].globalInterrupt[SINGLE_TREE_ID].stackPortsInterruptCause) }, /**/\
        /*maskReg*/{ SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(MG_RAVEN[ravenIndex].globalInterrupt[SINGLE_TREE_ID].stackPortsInterruptMask) }, /**/  \
        /*myFatherInfo*/{                                                \
...
#define  raven_x_ports1InterruptsSummary(ravenIndex)  \
    {                                                \
        /*causeReg*/{ SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(MG_RAVEN[ravenIndex].globalInterrupt[SINGLE_TREE_ID].ports1InterruptsSummaryCause) }, /**/\
        /*maskReg*/{ SKERNEL_INTERRUPT_BIND_REG_SIP5_MAC(MG_RAVEN[ravenIndex].globalInterrupt[SINGLE_TREE_ID].ports1InterruptsSummaryMask) }, /**/  \
        /*myFatherInfo*/{                                                \
...
static SKERNEL_INTERRUPT_REG_INFO_STC raven_lmu_latency_over_threshold_interrupts[] =
{
...
#define DUP_ALL_XSMI_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName,father_myBitIndex,father_interrupt) \
     xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_0_0_INDEX,father_myBitIndex,father_interrupt[MG_0_0_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_0_1_INDEX,father_myBitIndex,father_interrupt[MG_0_1_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_0_2_INDEX,father_myBitIndex,father_interrupt[MG_0_2_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_0_3_INDEX,father_myBitIndex,father_interrupt[MG_0_3_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_1_0_INDEX,father_myBitIndex,father_interrupt[MG_1_0_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_1_1_INDEX,father_myBitIndex,father_interrupt[MG_1_1_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_1_2_INDEX,father_myBitIndex,father_interrupt[MG_1_2_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_1_3_INDEX,father_myBitIndex,father_interrupt[MG_1_3_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_2_0_INDEX,father_myBitIndex,father_interrupt[MG_2_0_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_2_1_INDEX,father_myBitIndex,father_interrupt[MG_2_1_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_2_2_INDEX,father_myBitIndex,father_interrupt[MG_2_2_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_2_3_INDEX,father_myBitIndex,father_interrupt[MG_2_3_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_3_0_INDEX,father_myBitIndex,father_interrupt[MG_3_0_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_3_1_INDEX,father_myBitIndex,father_interrupt[MG_3_1_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_3_2_INDEX,father_myBitIndex,father_interrupt[MG_3_2_INDEX]) \
    ,xsmi_INTERTTUPT_REG(mg_causeRegName,mg_maskRegName ,MG_3_3_INDEX,father_myBitIndex,father_interrupt[MG_3_3_INDEX])

static SKERNEL_INTERRUPT_REG_INFO_STC xsmi_interrupts[NUM_OF_MGS] =
{    DUP_ALL_XSMI_INTERTTUPT_REG(XSMI.XSMIInterruptCause ,XSMI.XSMIInterruptMask ,xsmiIntSum ,falcon_GlobalInterruptsSummary)};


#define xsmi_INTERTTUPT_REG_TREE1(mg_causeRegName,mg_maskRegName,mgIndex,father_myBitIndex,father_interrupt) \
{                                                                                              \
    /*causeReg*/ {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.mg_causeRegName),0,mgIndex | MG_TREE_ID(1) | MG_UNIT_USED_CNS}, \
    /*maskReg*/  {SKERNEL_INTERRUPT_BIND_REG_LEGACY_MAC(MG.mg_maskRegName ),0,mgIndex | MG_TREE_ID(1) | MG_UNIT_USED_CNS}, \
        /*myFatherInfo*/{                                                                      \
            /*myBitIndex*/  father_myBitIndex ,                                                \
            /*interruptPtr*/&father_interrupt                                                  \
            },                                                                                 \
...
static SKERNEL_INTERRUPT_REG_INFO_STC xsmi_interrupts_MG8_tree1[] =
{    xsmi_INTERTTUPT_REG_TREE1(XSMI.XSMIInterruptCause ,XSMI.XSMIInterruptMask ,MG_2_0_INDEX,xsmiIntSum ,falcon_GlobalInterruptsSummary_MG8_tree1[0])};
...
)
{
    ...
    if(currDbPtr == NULL || currDbPtr->causeReg.registerOffsetInDb == 0)
    {
        return;
    }
    ...
    {/* MG unit related interrupts */
        ...
        */
        ...
        for(/* continue*/; mgIndex < mgMax ; mgIndex++)
        {
            ...
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &falcon_FuncUnitsInterruptsSummary[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &falcon_FuncUnitsInterruptsSummary1[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &falcon_dataPathInterruptSummary[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &falcon_portsInterruptsSummary[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &falcon_ports1InterruptsSummary[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &falcon_ports2InterruptsSummary[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &falcon_dfxInterruptsSummary[mgIndex]);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, &falcon_dfx1InterruptsSummary[mgIndex]);
        ...
        if(devObjPtr->numOfTiles > 2 /*4 tiles*/ && tileId == 0) /* need to add also the tree 1 info */
        {
            INTERRUPT_TREE_ADD_NODE_WITH_CHECK(index, &currDbPtr, tile1_tree1_nodes );
        }

        if(devObjPtr->numOfTiles > 2 /*4 tiles*/ && tileId == 0) /* need to add also the tree 1 info */
        {
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_GlobalInterruptsSummary_MG8_tree1 );
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_FuncUnitsInterruptsSummary_MG8_tree1);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_FuncUnitsInterruptsSummary1_MG8_tree1);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_dataPathInterruptSummary_MG8_tree1);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_portsInterruptsSummary_MG8_tree1  );
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_ports1InterruptsSummary_MG8_tree1);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_ports2InterruptsSummary_MG8_tree1);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_dfxInterruptsSummary_MG8_tree1);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_dfx1InterruptsSummary_MG8_tree1);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, xsmi_interrupts_MG8_tree1);
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_mg_global_misc_interrupts_MG8_tree1         );
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_mg_global_sdma_receiveSDMA_interrupts_MG8_tree1 );
            INTERRUPT_TREE_ADD_SINGLE_NODE_WITH_CHECK(index, &currDbPtr, falcon_mg_global_sdma_transmitSDMA_interrupts_MG8_tree1);
        }
    }
...
#define MG_REG_OFFSET_IN_DB(treeId,regName)     \
    FIELD_OFFSET_IN_STC_MAC(MG.globalInterrupt[treeId].regName,SMEM_CHT_PP_REGS_ADDR_STC)

#define SDMA_MG_REG_OFFSET_IN_DB(treeId,regName)     \
    FIELD_OFFSET_IN_STC_MAC(MG.globalInterrupt[treeId].SDMARegs.regName,SMEM_CHT_PP_REGS_ADDR_STC)
...
{
    {MG_REG_OFFSET_IN_DB(0,globalInterruptCause)              , falcon_GlobalInterruptsSummary        }
   ,{MG_REG_OFFSET_IN_DB(0,functionalInterruptsSummaryCause)  , falcon_FuncUnitsInterruptsSummary     }
   ,{MG_REG_OFFSET_IN_DB(0,functionalInterruptsSummary1Cause) , falcon_FuncUnitsInterruptsSummary1    }
   ,{MG_REG_OFFSET_IN_DB(0,SERInterruptsSummary)              , falcon_dataPathInterruptSummary       }
   ,{MG_REG_OFFSET_IN_DB(0,stackPortsInterruptCause)          , falcon_portsInterruptsSummary         }
   ,{MG_REG_OFFSET_IN_DB(0,ports1InterruptsSummaryCause)      , falcon_ports1InterruptsSummary         }
   ,{MG_REG_OFFSET_IN_DB(0,ports2InterruptsSummaryCause)      , falcon_ports2InterruptsSummary        }
   ,{MG_REG_OFFSET_IN_DB(0,miscellaneousInterruptCause)       , falcon_mg_global_misc_interrupts      }
   ,{SDMA_MG_REG_OFFSET_IN_DB(0,receiveSDMAInterruptCause)    , falcon_mg_global_sdma_receiveSDMA_interrupts      }
   ,{SDMA_MG_REG_OFFSET_IN_DB(0,transmitSDMAInterruptCause)   , falcon_mg_global_sdma_transmitSDMA_interrupts     }
   ,{MG_REG_OFFSET_IN_DB(0,dfxInterruptsSummaryCause)         , falcon_dfxInterruptsSummary         }
   ,{MG_REG_OFFSET_IN_DB(0,dfx1InterruptsSummaryCause)        , falcon_dfx1InterruptsSummary        }
...
{
    {MG_REG_OFFSET_IN_DB(0,globalInterruptCause)              , falcon_GlobalInterruptsSummary_MG8_tree1        }
   ,{MG_REG_OFFSET_IN_DB(0,functionalInterruptsSummaryCause)  , falcon_FuncUnitsInterruptsSummary_MG8_tree1     }
   ,{MG_REG_OFFSET_IN_DB(0,functionalInterruptsSummary1Cause) , falcon_FuncUnitsInterruptsSummary1_MG8_tree1    }
   ,{MG_REG_OFFSET_IN_DB(0,SERInterruptsSummary)              , falcon_dataPathInterruptSummary_MG8_tree1       }
   ,{MG_REG_OFFSET_IN_DB(0,stackPortsInterruptCause)          , falcon_portsInterruptsSummary_MG8_tree1         }
   ,{MG_REG_OFFSET_IN_DB(0,ports1InterruptsSummaryCause)      , falcon_ports1InterruptsSummary_MG8_tree1         }
   ,{MG_REG_OFFSET_IN_DB(0,ports2InterruptsSummaryCause)      , falcon_ports2InterruptsSummary_MG8_tree1        }
   ,{MG_REG_OFFSET_IN_DB(0,miscellaneousInterruptCause)       , falcon_mg_global_misc_interrupts_MG8_tree1      }
   ,{SDMA_MG_REG_OFFSET_IN_DB(0,receiveSDMAInterruptCause)    , falcon_mg_global_sdma_receiveSDMA_interrupts_MG8_tree1      }
   ,{SDMA_MG_REG_OFFSET_IN_DB(0,transmitSDMAInterruptCause)   , falcon_mg_global_sdma_transmitSDMA_interrupts_MG8_tree1     }
   ,{MG_REG_OFFSET_IN_DB(0,dfxInterruptsSummaryCause)         , falcon_dfxInterruptsSummary_MG8_tree1         }
   ,{MG_REG_OFFSET_IN_DB(0,dfx1InterruptsSummaryCause)        , falcon_dfx1InterruptsSummary_MG8_tree1        }
...
)
{
    ...
    /* mandatory for interrupts of tree 1 from tile 2 going into tree 0 in tile 1 */
    ...
    {/* Raven interrupts */
        ...
        INTERRUPT_TREE_ADD_X_NODES_WITH_CHECK(index, &currDbPtr, raven_lmu_latency_over_threshold_interrupts, numOfRavens * 2/*LMU units*/ * 17/*LMU latency Thresholds*/);
    }

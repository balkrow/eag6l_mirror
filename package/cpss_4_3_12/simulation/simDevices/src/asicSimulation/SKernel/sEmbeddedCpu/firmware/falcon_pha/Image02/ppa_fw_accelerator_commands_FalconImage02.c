...
/*
 * ppa_fw_accelerator_commands_FalconImage02.c
 *
...
void PPA_FW(load_accelerator_commands)() {
    ...
    ACCEL_CMD_LOAD(COPY_BITS_THR56_Clear_Outgoing_Mtag_Cmd_DESC_phal2ppa__local_dev_src_port_LEN10_TO_DESC_phal2ppa__flow_id_PLUS3_OFFSET,  COPY_BITS_THR56_Clear_Outgoing_Mtag_Cmd_DESC_phal2ppa__local_dev_src_port_LEN10_TO_DESC_phal2ppa__flow_id_PLUS3_VALUE);
...
ACCEL_INFO_STC accelInfoArrFalconImage02[] =
{
...
/*************** THR54_IPv4_TTL_Increment *******************/
    ,{ FALCON_ENUM_NAME_AND_VALUE( CSUM_LOAD_OLD_THR54_IPv4_TTL_Increment_LEN2_FROM_PKT_IPv4_Header__ttl_OFFSET),                                           54}
    ,{ FALCON_ENUM_NAME_AND_VALUE( ADD_BITS_THR54_IPv4_TTL_Increment_CONST_0x1_LEN8_TO_PKT_IPv4_Header__ttl_OFFSET),                                        54}
    ,{ FALCON_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR54_IPv4_TTL_Increment_LEN2_FROM_PKT_IPv4_Header__ttl_OFFSET),                                           54}
    ,{ FALCON_ENUM_NAME_AND_VALUE( CSUM_LOAD_OLD_THR54_IPv4_TTL_Increment_LEN2_FROM_PKT_IPv4_Header__header_checksum_OFFSET),                               54}
    ,{ FALCON_ENUM_NAME_AND_VALUE( CSUM_STORE_IP_THR54_IPv4_TTL_Increment_TO_PKT_IPv4_Header__header_checksum_OFFSET),                                      54}

/*************** THR55_IPv6_HopLimit_Increment *******************/
    ,{ FALCON_ENUM_NAME_AND_VALUE( ADD_BITS_THR55_IPv6_HopLimit_Increment_CONST_0x1_LEN8_TO_PKT_IPv6_Header__hop_limit_OFFSET),                             55}

/*************** THR56_Clear_Outgoing_Mtag_Cmd *******************/
    ,{ FALCON_ENUM_NAME_AND_VALUE( COPY_BITS_THR56_Clear_Outgoing_Mtag_Cmd_CONST_0x3_LEN2_TO_DESC_phal2ppa__outgoing_mtag_cmd_OFFSET),                      56}
    ,{ FALCON_ENUM_NAME_AND_VALUE( COPY_BITS_THR56_Clear_Outgoing_Mtag_Cmd_DESC_phal2ppa__local_dev_src_port_LEN10_TO_DESC_phal2ppa__flow_id_PLUS3_OFFSET), 56}
    ,{ FALCON_ENUM_NAME_AND_VALUE( COPY_BITS_THR56_Clear_Outgoing_Mtag_Cmd_CONST_0x0_LEN3_TO_DESC_phal2ppa__flow_id_OFFSET),                                56}
    ,{ FALCON_ENUM_NAME_AND_VALUE( COPY_BITS_THR56_Clear_Outgoing_Mtag_Cmd_PKT_eDSA_w0_ToCpu__OuterTagVid_eVLAN_11_0_LEN12_TO_DESC_phal2ppa__copy_reserved_OFFSET), 56}
    ,{ FALCON_ENUM_NAME_AND_VALUE( COPY_BITS_THR56_Clear_Outgoing_Mtag_Cmd_PKT_vlan__vid_LEN12_TO_DESC_phal2ppa__copy_reserved_OFFSET),                     56}

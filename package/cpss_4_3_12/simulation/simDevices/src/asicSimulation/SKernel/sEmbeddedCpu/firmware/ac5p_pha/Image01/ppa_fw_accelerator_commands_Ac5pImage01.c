...
/*
 * ppa_fw_accelerator_commands_Ac5pImage01.c
 *
...
void PPA_FW(load_accelerator_commands)() {
    ...
    ACCEL_CMD_LOAD(COPY_BYTES_THR46_SFLOW_IPv4_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_sflow_ipv4_header__sub_agent_id_OFFSET,             COPY_BYTES_THR46_SFLOW_IPv4_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_sflow_ipv4_header__sub_agent_id_VALUE);
    ...
    ACCEL_CMD_LOAD(COPY_BYTES_THR47_SFLOW_IPv6_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_sflow_ipv6_header__sub_agent_id_OFFSET,             COPY_BYTES_THR47_SFLOW_IPv6_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_sflow_ipv6_header__sub_agent_id_VALUE);
    ...
    ACCEL_CMD_LOAD(COPY_BYTES_THR62_enhanced_sFlow_fill_remain_IPv4_DESC_phal2ppa__pha_metadata3_LEN2_TO_PKT_enhanced_sflow_rx_ts_shim_header__ip_high_OFFSET, COPY_BYTES_THR62_enhanced_sFlow_fill_remain_IPv4_DESC_phal2ppa__pha_metadata3_LEN2_TO_PKT_enhanced_sflow_rx_ts_shim_header__ip_high_VALUE);
    ...
    ACCEL_CMD_LOAD(COPY_BYTES_THR62_enhanced_sFlow_fill_remain_IPv4_DESC_phal2ppa__pha_metadata1_LEN2_TO_PKT_enhanced_sflow_tx_ts_shim_header__ip_low_OFFSET, COPY_BYTES_THR62_enhanced_sFlow_fill_remain_IPv4_DESC_phal2ppa__pha_metadata1_LEN2_TO_PKT_enhanced_sflow_tx_ts_shim_header__ip_low_VALUE);
    ...
    ACCEL_CMD_LOAD(COPY_BYTES_THR63_enhanced_sFlow_fill_remain_IPv6_DESC_phal2ppa__pha_metadata1_LEN2_TO_PKT_enhanced_sflow_tx_ts_shim_header__ip_low_OFFSET, COPY_BYTES_THR63_enhanced_sFlow_fill_remain_IPv6_DESC_phal2ppa__pha_metadata1_LEN2_TO_PKT_enhanced_sflow_tx_ts_shim_header__ip_low_VALUE);
    ...
    ACCEL_CMD_LOAD(COPY_BYTES_THR90_Router_SA_Modification_Thread_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_mac_header__mac_sa_31_16_OFFSET, COPY_BYTES_THR90_Router_SA_Modification_Thread_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_mac_header__mac_sa_31_16_VALUE);
    ACCEL_CMD_LOAD(COPY_BITS_THR90_Router_SA_Modification_Thread_DESC_phal2ppa__copy_reserved_LEN16_TO_PKT_mac_header__mac_sa_47_32_OFFSET, COPY_BITS_THR90_Router_SA_Modification_Thread_DESC_phal2ppa__copy_reserved_LEN16_TO_PKT_mac_header__mac_sa_47_32_VALUE);
...
ACCEL_INFO_STC accelInfoArrAc5pImage01[] =
{
...
/*************** THR46_SFLOW_IPv4 *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_28_BYTES_THR46_SFLOW_IPv4_LEN28_FROM_PKT_IPv4_Header__version_OFFSET),                                         46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR46_SFLOW_IPv4_CONST_0x5_LEN3_TO_PKT_sflow_ipv4_header__version_PLUS29_OFFSET),                              46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR46_SFLOW_IPv4_CONST_0x1_LEN1_TO_PKT_sflow_ipv4_header__agent_ip_version_PLUS31_OFFSET),                     46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR46_SFLOW_IPv4_CFG_sflow_ipv4_template__agent_ip_address_LEN4_TO_PKT_sflow_ipv4_header__agent_ip_address_OFFSET), 46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR46_SFLOW_IPv4_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_sflow_ipv4_header__sub_agent_id_OFFSET),            46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR46_SFLOW_IPv4_DESC_phal2ppa__lm_counter_LEN4_TO_PKT_sflow_ipv4_header__sequence_number_OFFSET),            46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR46_SFLOW_IPv4_CONST_0x1_LEN1_TO_PKT_sflow_ipv4_header__samples_number_PLUS31_OFFSET),                       46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_OLD_THR46_SFLOW_IPv4_LEN2_FROM_PKT_IPv4_Header__total_length_OFFSET),                                          46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR46_SFLOW_IPv4_CONST_0x1C_LEN16_TO_PKT_IPv4_Header__total_length_OFFSET),                                     46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR46_SFLOW_IPv4_LEN2_FROM_PKT_IPv4_Header__total_length_OFFSET),                                          46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_OLD_THR46_SFLOW_IPv4_LEN2_FROM_PKT_IPv4_Header__header_checksum_OFFSET),                                       46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_STORE_IP_THR46_SFLOW_IPv4_TO_PKT_IPv4_Header__header_checksum_OFFSET),                                              46}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR46_SFLOW_IPv4_CONST_0x1C_LEN16_TO_PKT_udp_header__Length_OFFSET),                                            46}

/*************** THR47_SFLOW_IPv6 *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_40_BYTES_THR47_SFLOW_IPv6_LEN32_FROM_PKT_IPv6_Header__version_OFFSET),                                         47}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_40_BYTES_THR47_SFLOW_IPv6_LEN16_FROM_PKT_IPv6_Header__version_PLUS32_OFFSET),                                  47}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR47_SFLOW_IPv6_CONST_0x5_LEN3_TO_PKT_sflow_ipv6_header__version_PLUS29_OFFSET),                              47}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR47_SFLOW_IPv6_CONST_0x2_LEN2_TO_PKT_sflow_ipv6_header__agent_ip_version_PLUS30_OFFSET),                     47}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR47_SFLOW_IPv6_CFG_sflow_ipv6_template__agent_ip_address_127_96_LEN16_TO_PKT_sflow_ipv6_header__agent_ip_address_127_96_OFFSET), 47}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR47_SFLOW_IPv6_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_sflow_ipv6_header__sub_agent_id_OFFSET),            47}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR47_SFLOW_IPv6_DESC_phal2ppa__lm_counter_LEN4_TO_PKT_sflow_ipv6_header__sequence_number_OFFSET),            47}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR47_SFLOW_IPv6_CONST_0x1_LEN1_TO_PKT_sflow_ipv6_header__samples_number_PLUS31_OFFSET),                       47}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR47_SFLOW_IPv6_CONST_0x28_LEN16_TO_PKT_IPv6_Header__payload_length_OFFSET),                                   47}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR47_SFLOW_IPv6_CONST_0x28_LEN16_TO_PKT_udp_header__Length_OFFSET),                                            47}

/*************** THR48_SRV6_Best_Effort *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR48_SRV6_Best_Effort_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_IPv6_Header__dip3_low_OFFSET),          48}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR48_SRV6_Best_Effort_PKT_IPv6_Header__dip3_low_LEN2_TO_PKT_IPv6_Header__dip2_low_OFFSET),                   48}

/*************** THR49_SRV6_Source_Node_1_CONTAINER *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR49_SRV6_Source_Node_1_CONTAINER_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_IPv6_Header__dip3_low_OFFSET), 49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_24_BYTES_THR49_SRV6_Source_Node_1_CONTAINER_LEN32_FROM_PKT_IPv6_Header__version_OFFSET),                       49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_24_BYTES_THR49_SRV6_Source_Node_1_CONTAINER_LEN8_FROM_PKT_IPv6_Header__version_PLUS32_OFFSET),                 49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR49_SRV6_Source_Node_1_CONTAINER_PKT_IPv6_Header__sip0_high_MINUS24_LEN16_TO_PKT_SRv6_Segment0_Header__dip0_high_OFFSET), 49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR49_SRV6_Source_Node_1_CONTAINER_CONST_0x401_LEN11_TO_PKT_SRv6_Header__routing_type_PLUS5_OFFSET),           49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR49_SRV6_Source_Node_1_CONTAINER_PKT_IPv6_Header__next_header_MINUS24_LEN2_TO_PKT_SRv6_Header__next_header_OFFSET), 49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR49_SRV6_Source_Node_1_CONTAINER_CONST_0x2_LEN8_TO_PKT_SRv6_Header__hdr_ext_len_OFFSET),                     49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR49_SRV6_Source_Node_1_CONTAINER_CONST_0x0_LEN8_TO_PKT_SRv6_Header__last_entry_OFFSET),                      49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR49_SRV6_Source_Node_1_CONTAINER_CFG_ipv6_sip_template__val_0_LEN16_TO_PKT_IPv6_Header__sip0_high_OFFSET),  49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR49_SRV6_Source_Node_1_CONTAINER_CONST_0x18_LEN16_TO_PKT_IPv6_Header__payload_length_OFFSET),                 49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR49_SRV6_Source_Node_1_CONTAINER_CONST_0x2B_LEN8_TO_PKT_IPv6_Header__next_header_OFFSET),                    49}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR49_SRV6_Source_Node_1_CONTAINER_CONST_0x18_LEN8_TO_DESC_ppa_internal_desc__fw_bc_modification_OFFSET),      49}

/*************** THR50_SRV6_Source_Node_First_Pass_1_CONTAINER *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_16_BYTES_THR50_SRV6_Source_Node_First_Pass_1_CONTAINER_LEN32_FROM_PKT_mac_header__mac_da_47_32_OFFSET),        50}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_16_BYTES_THR50_SRV6_Source_Node_First_Pass_1_CONTAINER_LEN32_FROM_PKT_mac_header__mac_da_47_32_PLUS32_OFFSET), 50}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_16_BYTES_THR50_SRV6_Source_Node_First_Pass_1_CONTAINER_LEN6_FROM_PKT_mac_header__mac_da_47_32_PLUS64_OFFSET),  50}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR50_SRV6_Source_Node_First_Pass_1_CONTAINER_PKT_IPv6_Header__sip0_high_MINUS16_LEN16_TO_PKT_SRv6_Segment2_Header__dip0_high_OFFSET), 50}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR50_SRV6_Source_Node_First_Pass_1_CONTAINER_CFG_ipv6_sip_template__val_0_LEN16_TO_PKT_IPv6_Header__sip0_high_OFFSET), 50}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR50_SRV6_Source_Node_First_Pass_1_CONTAINER_CONST_0x1_LEN16_TO_PKT_eDSA_fwd_w3__Trg_ePort_15_0_OFFSET),       50}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR50_SRV6_Source_Node_First_Pass_1_CONTAINER_CONST_0x0_LEN1_TO_PKT_eDSA_fwd_w2__IsTrgPhyPortValid_OFFSET),    50}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR50_SRV6_Source_Node_First_Pass_1_CONTAINER_CONST_0x10_LEN8_TO_DESC_ppa_internal_desc__fw_bc_modification_OFFSET), 50}

/*************** THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_40_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_LEN32_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_40_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_LEN32_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_PLUS32_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_40_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_LEN12_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_PLUS64_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_40_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_LEN32_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_PLUS76_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_40_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_LEN16_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_PLUS64_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_40_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_LEN32_FROM_PKT_with_vlan__Generic_TS_Data__mac_da_47_32_PLUS80_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_PKT_no_vlan__Generic_TS_Data__data_35_32_MINUS40_LEN4_TO_PKT_no_vlan__SRv6_Header__last_entry_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_PKT_with_vlan__Generic_TS_Data__data_35_32_MINUS40_LEN4_TO_PKT_with_vlan__SRv6_Header__last_entry_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_no_vlan__IPv6_Header__dip3_low_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_with_vlan__IPv6_Header__dip3_low_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_CONST_0x38_LEN16_TO_PKT_no_vlan__IPv6_Header__payload_length_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_CONST_0x38_LEN16_TO_PKT_with_vlan__IPv6_Header__payload_length_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_CONST_0x2B_LEN8_TO_PKT_no_vlan__IPv6_Header__next_header_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_CONST_0x2B_LEN8_TO_PKT_with_vlan__IPv6_Header__next_header_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_PKT_no_vlan__Generic_TS_Data__data_31_28_MINUS40_LEN32_TO_PKT_no_vlan__SRv6_Segment0_Header__dip0_high_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_PKT_with_vlan__Generic_TS_Data__data_31_28_MINUS40_LEN32_TO_PKT_with_vlan__SRv6_Segment0_Header__dip0_high_OFFSET), 51}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_CONST_0xF2_LEN8_TO_DESC_ppa_internal_desc__fw_bc_modification_OFFSET), 51}

/*************** THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_24_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_LEN32_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_24_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_LEN32_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_PLUS32_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_24_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_LEN12_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_PLUS64_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_24_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_LEN32_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_PLUS76_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_24_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_LEN16_FROM_PKT_no_vlan__Generic_TS_Data__mac_da_47_32_PLUS64_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( SHIFTLEFT_24_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_LEN32_FROM_PKT_with_vlan__Generic_TS_Data__mac_da_47_32_PLUS80_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_PKT_no_vlan__Generic_TS_Data__data_35_32_MINUS24_LEN4_TO_PKT_no_vlan__SRv6_Header__last_entry_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_PKT_with_vlan__Generic_TS_Data__data_35_32_MINUS24_LEN4_TO_PKT_with_vlan__SRv6_Header__last_entry_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_no_vlan__IPv6_Header__dip3_low_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_with_vlan__IPv6_Header__dip3_low_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_CONST_0x28_LEN16_TO_PKT_no_vlan__IPv6_Header__payload_length_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_CONST_0x28_LEN16_TO_PKT_with_vlan__IPv6_Header__payload_length_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_CONST_0x2B_LEN8_TO_PKT_no_vlan__IPv6_Header__next_header_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_CONST_0x2B_LEN8_TO_PKT_with_vlan__IPv6_Header__next_header_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_PKT_no_vlan__Generic_TS_Data__data_15_12_MINUS24_LEN16_TO_PKT_no_vlan__SRv6_Segment0_Header__dip0_high_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_PKT_with_vlan__Generic_TS_Data__data_15_12_MINUS24_LEN16_TO_PKT_with_vlan__SRv6_Segment0_Header__dip0_high_OFFSET), 52}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_CONST_0xE2_LEN8_TO_DESC_ppa_internal_desc__fw_bc_modification_OFFSET), 52}

/*************** THR61_save_target_port_info *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR61_save_target_port_info_DESC_phal2ppa__trg_dev_PLUS2_LEN8_TO_DESC_phal2ppa__copy_reserved_PLUS2_OFFSET),   61}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR61_save_target_port_info_DESC_phal2ppa__trg_phy_port_PLUS2_LEN8_TO_DESC_phal2ppa__copy_reserved_PLUS10_OFFSET), 61}

/*************** THR62_enhanced_sFlow_fill_remain_IPv4 *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR62_enhanced_sFlow_fill_remain_IPv4_DESC_phal2ppa__pha_metadata3_LEN2_TO_PKT_enhanced_sflow_rx_ts_shim_header__ip_high_OFFSET), 62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR62_enhanced_sFlow_fill_remain_IPv4_LEN6_FROM_PKT_enhanced_sflow_rx_ts_shim_header__rx_timestamp_47_32_OFFSET), 62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR62_enhanced_sFlow_fill_remain_IPv4_LEN4_FROM_PKT_enhanced_sflow_rx_ts_shim_header__reserved_OFFSET),    62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_STORE_IP_THR62_enhanced_sFlow_fill_remain_IPv4_TO_PKT_enhanced_sflow_rx_ts_shim_header__checksum_PLUS2_OFFSET),     62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR62_enhanced_sFlow_fill_remain_IPv4_DESC_phal2ppa__pha_metadata1_LEN2_TO_PKT_enhanced_sflow_tx_ts_shim_header__ip_low_OFFSET), 62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR62_enhanced_sFlow_fill_remain_IPv4_LEN6_FROM_PKT_enhanced_sflow_tx_ts_shim_header__tx_timestamp_47_32_OFFSET), 62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR62_enhanced_sFlow_fill_remain_IPv4_LEN4_FROM_PKT_enhanced_sflow_tx_ts_shim_header__reserved_OFFSET),    62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_STORE_IP_THR62_enhanced_sFlow_fill_remain_IPv4_TO_PKT_enhanced_sflow_tx_ts_shim_header__checksum_PLUS2_OFFSET),     62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR62_enhanced_sFlow_fill_remain_IPv4_CONST_0x1_LEN1_TO_DESC_phal2ppa__egress_checksum_mode_OFFSET),           62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR62_enhanced_sFlow_fill_remain_IPv4_CONST_0x2C_LEN16_TO_PKT_udp_header__Length_OFFSET),                       62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_OLD_THR62_enhanced_sFlow_fill_remain_IPv4_LEN2_FROM_PKT_IPv4_Header__total_length_OFFSET),                     62}
    ,{ AC5P_ENUM_NAME_AND_VALUE( ADD_BITS_THR62_enhanced_sFlow_fill_remain_IPv4_CONST_0x2C_LEN16_TO_PKT_IPv4_Header__total_length_OFFSET),                62}
...
/*************** THR63_enhanced_sFlow_fill_remain_IPv6 *******************/
    ...
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR63_enhanced_sFlow_fill_remain_IPv6_LEN6_FROM_PKT_enhanced_sflow_rx_ts_shim_header__rx_timestamp_47_32_OFFSET), 63}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR63_enhanced_sFlow_fill_remain_IPv6_LEN4_FROM_PKT_enhanced_sflow_rx_ts_shim_header__reserved_OFFSET),    63}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_STORE_IP_THR63_enhanced_sFlow_fill_remain_IPv6_TO_PKT_enhanced_sflow_rx_ts_shim_header__checksum_PLUS2_OFFSET),     63}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR63_enhanced_sFlow_fill_remain_IPv6_DESC_phal2ppa__pha_metadata1_LEN2_TO_PKT_enhanced_sflow_tx_ts_shim_header__ip_low_OFFSET), 63}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR63_enhanced_sFlow_fill_remain_IPv6_LEN6_FROM_PKT_enhanced_sflow_tx_ts_shim_header__tx_timestamp_47_32_OFFSET), 63}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR63_enhanced_sFlow_fill_remain_IPv6_LEN4_FROM_PKT_enhanced_sflow_tx_ts_shim_header__reserved_OFFSET),    63}
    ,{ AC5P_ENUM_NAME_AND_VALUE( CSUM_STORE_IP_THR63_enhanced_sFlow_fill_remain_IPv6_TO_PKT_enhanced_sflow_tx_ts_shim_header__checksum_PLUS2_OFFSET),     63}
...
/*************** THR66_enhanced_sFlow *******************/
    ...
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR66_enhanced_sFlow_CONST_0x5_LEN3_TO_PKT_enhanced_sflow_shim_header__version_PLUS29_OFFSET),                 66}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR66_enhanced_sFlow_CFG_enhanced_sflow_template__src_device_id_LEN8_TO_PKT_enhanced_sflow_shim_header__src_modid_OFFSET), 66}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR66_enhanced_sFlow_DESC_phal2ppa__orig_src_eport_PLUS5_LEN8_TO_PKT_enhanced_sflow_shim_header__src_port_OFFSET), 66}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR66_enhanced_sFlow_DESC_phal2ppa__copy_reserved_PLUS2_LEN16_TO_PKT_enhanced_sflow_shim_header__dst_modid_OFFSET), 66}
...
/*************** THR90_Router_SA_Modification_Thread *******************/
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BYTES_THR90_Router_SA_Modification_Thread_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_mac_header__mac_sa_31_16_OFFSET), 90}
    ,{ AC5P_ENUM_NAME_AND_VALUE( COPY_BITS_THR90_Router_SA_Modification_Thread_DESC_phal2ppa__copy_reserved_LEN16_TO_PKT_mac_header__mac_sa_47_32_OFFSET), 90}
/*************** Last Entry *******************/
    /*must be last*/
    ,{NULL , 0 , 0}
};

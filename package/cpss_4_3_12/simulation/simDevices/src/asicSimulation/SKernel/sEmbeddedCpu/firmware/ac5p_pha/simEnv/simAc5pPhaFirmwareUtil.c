...
extern ACCEL_INFO_STC accelInfoArrAc5pImage02[];
extern THREAD_TYPE phaThreadsTypeAc5pImage02[];
void Ac5pImage02_load_accelerator_commands();
void Ac5pImage02_get_fw_version (uint32_t imageId);
...
ac5pMemCast_DEFAULT_IMPLEMENTATION(thr76_Copy_Flow_ID_to_Trg_Phy_Port_in_hdr );
ac5pMemCast_DEFAULT_IMPLEMENTATION(thr93_MPLS_LSR_In_Stacking_System_Thread_in_hdr );
ac5pMemCast_DEFAULT_IMPLEMENTATION(thr93_MPLS_LSR_In_Stacking_System_Thread_cfg );
...
static PHA_THREAD_INFO ac5p_phaThreadsInfo[] = {
    ...
    /*58*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_58 , invalidFirmwareThread , "PHA_THREAD_IPSEC_PTP: set Desc<ptp_packet_format> to PTPv2 to allow adding timestamp to PTP packet encrypted by IPSEC"}
    ...
    /*68*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_68 , invalidFirmwareThread , "PHA_THREAD_Erspan_TypeI_Ipv4: ERSPAN Type I over IPv4-GRE tunnel" }
    /*69*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_69 , invalidFirmwareThread , "PHA_THREAD_Erspan_TypeI_Ipv6: ERSPAN Type I over IPv6-GRE tunnel" }
    /*70*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_70 , invalidFirmwareThread , "PHA_THREAD_Radio_Header: Add Radio Header before L2 one" }
    ...
    /*77*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_77 , invalidFirmwareThread , "PHA_THREAD_TYPE_RESERVED_1_0: remove generic TS and apply transport header modifications" }
    /*78*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_78 , invalidFirmwareThread , "PHA_THREAD_TYPE_RESERVED_1_1: remove generic TS and apply transport header modifications" }
    /*79*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_79 , invalidFirmwareThread , "PHA_THREAD_TYPE_RESERVED_1_2: remove generic TS and apply transport header modifications" }

    /*80*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_80 , invalidFirmwareThread , "TBD" }
    /*81*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_81 , invalidFirmwareThread , "TBD" }
    /*82*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_82 , invalidFirmwareThread , "TBD" }
    /*83*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_83 , invalidFirmwareThread , "TBD" }
    /*84*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_84 , invalidFirmwareThread , "TBD" }
    /*85*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_85 , invalidFirmwareThread , "TBD" }
    /*86*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_86 , invalidFirmwareThread , "TBD" }
    /*87*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_87 , invalidFirmwareThread , "TBD" }
    /*88*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_88 , invalidFirmwareThread , "TBD" }
    /*89*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_89 , invalidFirmwareThread , "TBD" }
    /*90*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_90 , invalidFirmwareThread , "PHA_THREAD_TYPE_ROUTER_SA_MODIFICATION" }
    /*91*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_91 , invalidFirmwareThread , "TBD" }
    /*92*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_92 , invalidFirmwareThread , "TBD" }
    /*93*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_93 , invalidFirmwareThread , "TBD" }
    /*94*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_94 , invalidFirmwareThread , "TBD" }
    /*95*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_95 , invalidFirmwareThread , "TBD" }
    /*96*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_96 , invalidFirmwareThread , "TBD" }
    /*97*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_97 , invalidFirmwareThread , "TBD" }
    /*98*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_98 , invalidFirmwareThread , "TBD" }
    /*99*/,{AC5P_PLACE_HOLDER_CNS , PPA_FW_THREAD_ID_99 , invalidFirmwareThread , "TBD" }
...
static  THREAD_TYPE *phaThreadsTypeAc5pPtr[AC5P_FW_VERSIONS_TOTAL_NUM] = {
    ...
    /* 6*/ phaThreadsTypeAc5pImage02,         /* For Image02 & most up to date fw version */
    /* 7*/ phaThreadsTypeAc5pImage02,         /* For Image02 & previous fw version */
    /* 8*/ phaThreadsTypeAc5pImage02,         /* For Image02 & oldest fw version */
    };
...
static  ACCEL_INFO_STC *accelInfoArrAc5pPtr[AC5P_FW_VERSIONS_TOTAL_NUM] = {
    ...
    /* 6*/ accelInfoArrAc5pImage02,           /* For Image02 & most up to date fw version */
    /* 7*/ accelInfoArrAc5pImage02,           /* For Image02 & previous fw version */
    /* 8*/ accelInfoArrAc5pImage02,           /* For Image02 & oldest fw version */
    };
...
static  void (*load_accelerator_commands[AC5P_FW_VERSIONS_TOTAL_NUM])() = {
    ...
    /* 6*/ Ac5pImage02_load_accelerator_commands,
    /* 7*/ Ac5pImage02_load_accelerator_commands,
    /* 8*/ Ac5pImage02_load_accelerator_commands,
    };
...
********************************************************************************************/
static  void (*get_fw_version[AC5P_FW_VERSIONS_TOTAL_NUM])(uint32_t fwImageId) = {
    ...
    /* 6*/ Ac5pImage02_get_fw_version,         /* For Image02 & most up to date fw version */
    /* 7*/ Ac5pImage02_get_fw_version,         /* For Image02 & previous fw version */
    /* 8*/ Ac5pImage02_get_fw_version,         /* For Image02 & oldest fw version */
    };
...
)
{
    ...
    ppa_in_desc_Ptr->phal2ppa.egress_outer_packet_type              = descrPtr->outerPacketType;
    ppa_in_desc_Ptr->phal2ppa.ptp_packet_format                     = descrPtr->timestampActionInfo.packetFormat;
    ...
    ppa_in_desc_Ptr->phal2ppa.egress_byte_count                     = descrPtr->egressByteCount - 4; /* reduce FCS size */
    ...
    ppa_in_desc_Ptr->phal2ppa.egress_outer_l3_offset                = (descrPtr->tunnelStart) ?
                                                                      descrPtr->haToEpclInfo.tunnelStartL3StartOffsetPtr - devObjPtr->egressBuffer
                                                                      : descrPtr->haToEpclInfo.l3StartOffsetPtr - descrPtr->haToEpclInfo.macDaSaPtr;
    ...
    ppa_in_desc_Ptr->phal2ppa.l4_offset                             = (descrPtr->l4StartOffsetPtr != NULL) ?
                                                                       descrPtr->l4StartOffsetPtr - descrPtr->l3StartOffsetPtr : 0;
    ...
    ppa_in_desc_Ptr->phal2ppa.trg_phy_port                          = descrPtr->useVidx == 1 ? 0:descrPtr->eArchExtInfo.trgPhyPort;
    ppa_in_desc_Ptr->phal2ppa.outgoing_mtag_cmd                     = descrPtr->outGoingMtagCmd;
    ppa_in_desc_Ptr->phal2ppa.timestamp_en                          = TBD;
    ppa_in_desc_Ptr->phal2ppa.is_ptp                                = descrPtr->isPtp;
...
)
{
    ...
    descrPtr->outerPacketType                = ppa_in_desc_Ptr->phal2ppa.egress_outer_packet_type           ;
    descrPtr->timestampActionInfo.packetFormat = ppa_in_desc_Ptr->phal2ppa.ptp_packet_format                  ;
    ...
    descrPtr->egressByteCount                = ppa_in_desc_Ptr->phal2ppa.egress_byte_count + 4              ; /* add FCS size */
    ...
    descrPtr->isPtp                          = ppa_in_desc_Ptr->phal2ppa.is_ptp                             ;

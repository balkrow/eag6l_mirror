...
/*
 * ppa_fw_threads_FalconDefault.c
 *
...
/* ==========================
  ...
  =========================== */
#ifdef ASIC_SIMULATION
#include "asicSimulation/SKernel/sEmbeddedCpu/firmware/falcon_pha/Default/ppa_fw_image_info.h"
...
#ifdef ASIC_SIMULATION
/********************************************************************************************************************//**
* funcname        FalconDefault_get_fw_version
 ...
 *              - Calculate IPv4 CS
 *              - Set fw byte count to zero just to activate core
 *****************************************************************************************************************************************/
__attribute__ ((aligned (16)))
void PPA_FW(THR59_SLS_Test)() {
    ...
    struct ppa_in_desc* thr59_desc_ptr = FALCON_MEM_CAST(FALCON_DESC_REGs_lo,ppa_in_desc);
    struct thr59_sls_test_in_hdr* thr59_ipv4_in_hdr_ptr = FALCON_MEM_CAST(FALCON_PKT_REGs_lo,thr59_sls_test_in_hdr);
    ...
    {	/* Packet is IPv4 */
        ...
        /* Do it just to activate core. Set byte count to zero since no change to packet size */
        __LOG_FW(("Do it just to activate core. Set byte count to zero since no change to packet size"));
        thr59_desc_ptr->ppa_internal_desc.fw_bc_modification = 0x0;
    }
    else
    {
...
void PPA_FW(THR81_Erspan_TypeIII_SameDevMirroring_IPv4)() {
    ...
    /* Get pointers to descriptor,cfg & packet */
    struct ppa_in_desc* thr81_desc_ptr = FALCON_MEM_CAST(FALCON_DESC_REGs_lo,ppa_in_desc);
    ...
    /* Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6.*/
    __LOG_FW(("Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6."));
    smemAnalayzerTemplateOfst = (thr81_desc_ptr->phal2ppa.pha_metadata & 0x7) * 64;
    __LOG_FW(("thr81_desc_ptr->phal2ppa.pha_metadata"));
    __LOG_PARAM_FW(thr81_desc_ptr->phal2ppa.pha_metadata);
    ...
    /*-----------------------------------------------------------------------------------------------------------------------------------------------
      ...
      ------------------------------------------------------------------------------------------------------------------------------------------------*/
    __LOG_FW(("Copy 20B of IPv4 header from shared memory into packet output"));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR81_OUT_HDR_IPV4__VER_OFFSET) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  0));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR81_OUT_HDR_IPV4__VER_OFFSET + 4) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  4));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR81_OUT_HDR_IPV4__VER_OFFSET + 8) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  8));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR81_OUT_HDR_IPV4__VER_OFFSET + 12) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 12));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR81_OUT_HDR_IPV4__VER_OFFSET + 16) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 16));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 0));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 4));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 8));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 12));
    ...
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR81_OUT_HDR_ERSPAN__VER_OFFSET , erspan_header_VER_to_C);
    __PRAGMA_NO_REORDER
    ...
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR81_OUT_HDR_ERSPAN__VER_OFFSET + 4 , ts_nano_sec);
    __PRAGMA_NO_REORDER
    ...
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR81_OUT_HDR_ERSPAN__VER_OFFSET + 8 , erspan_header_SGT_to_O);
    ...
    __PRAGMA_NO_REORDER
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR81_OUT_HDR_ERSPAN__VER_OFFSET + 12 , pssh_header_platId_index);
    ...
    __LOG_PARAM_FW(ts_sec);
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR81_OUT_HDR_ERSPAN__VER_OFFSET + 16 , ts_sec);
    ...
    /* Check if stack was overflowed */
    __LOG_FW(("Check if stack was overflowed"));
    falcon_stack_overflow_checker(81);
#endif
...
void PPA_FW(THR82_Erspan_TypeIII_SameDevMirroring_IPv6_FirstPass)() {
    ...
    struct ppa_in_desc* thr82_desc_ptr = FALCON_MEM_CAST(FALCON_DESC_REGs_lo,ppa_in_desc);
    #ifdef ERSPAN_III_DEBUG
        /* write edsa tags*/
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + 44, 0x01234567 );
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + 48, 0x89abcef0);
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + 52, 0x01234567 );
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + 56, 0x89abcef0);
    #endif
    ...
    /* Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6.*/
    __LOG_FW(("Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6."));
    smemAnalayzerTemplateOfst = (thr82_desc_ptr->phal2ppa.pha_metadata & 0x7) * 64;
    __LOG_FW(("thr82_desc_ptr->phal2ppa.pha_metadata"));
    __LOG_PARAM_FW(thr82_desc_ptr->phal2ppa.pha_metadata & 0x7);
    __LOG_FW(("smemAnalayzerTemplateOfst"));
    __LOG_PARAM_FW(smemAnalayzerTemplateOfst);
    ...
    __LOG_FW(("erspan_header_VER_to_C"))
    __LOG_PARAM_FW(erspan_header_VER_to_C);
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR82_OUT_HDR_ERSPAN__VER_OFFSET , erspan_header_VER_to_C);
    __PRAGMA_NO_REORDER
    ...
    __LOG_FW(("Set ERSPAN.T to TOD nano seconds"));
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR82_OUT_HDR_ERSPAN__VER_OFFSET + 4 , ts_nano_sec);
    __PRAGMA_NO_REORDER
    ...
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR82_OUT_HDR_ERSPAN__VER_OFFSET + 8 , erspan_header_SGT_to_O);
    ...
    __LOG_PARAM_FW(pssh_header_platId_index);
    __PRAGMA_NO_REORDER
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR82_OUT_HDR_ERSPAN__VER_OFFSET + 12 , pssh_header_platId_index);
    /* Set port Index according to RxSniff */
    __LOG_FW(("Set port Index according to RxSniff"
              "if descRxSniff = 0 trigger target port accelerator if 1 trigger source port accelerator (next command 4B offset)"));
    ...
    __LOG_FW(("pssh_Timestamp:"));
    __LOG_PARAM_FW(ts_sec);
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR82_OUT_HDR_ERSPAN__VER_OFFSET + 16 , ts_sec);
    ...
    /* Check if stack was overflowed */
    __LOG_FW(("Check if stack was overflowed"));
    falcon_stack_overflow_checker(82);
#endif
...
void PPA_FW(THR83_Erspan_TypeIII_SameDevMirroring_IPv6_SecondPass)() {
    ...
    /* Get pointer to descriptor */
    struct ppa_in_desc* thr83_desc_ptr = FALCON_MEM_CAST(FALCON_DESC_REGs_lo,ppa_in_desc);
    ...
    /* Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6.*/
    __LOG_FW(("Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6."));
    smemAnalayzerTemplateOfst = (thr83_desc_ptr->phal2ppa.pha_metadata & 0x7) * 64;
    __LOG_FW(("thr83_desc_ptr->phal2ppa.pha_metadata"));
    __LOG_PARAM_FW(thr83_desc_ptr->phal2ppa.pha_metadata & 0x7);
    __LOG_FW(("smemAnalayzerTemplateOfst"));
    __LOG_PARAM_FW(smemAnalayzerTemplateOfst);
    ...
    __LOG_FW(("Get 40B of IPv6 header from shared memory and place them in output packet"));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  0));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET + 4) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  4));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET + 8) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  8)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET + 12) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 12)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET + 16) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 16)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET + 20) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 20)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET + 24) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 24)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET + 28) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 28)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET + 32) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 32)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR83_OUT_HDR_NO_VLAN_IPV6__VERSION_OFFSET + 36) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 36)  );
    ...
    /* Check if stack was overflowed */
    __LOG_FW(("Check if stack was overflowed"));
    falcon_stack_overflow_checker(83);
#endif
...
void PPA_FW(THR84_Erspan_TypeIII_OrigDevMirroring)() {
    ...
    struct ppa_in_desc* thr84_desc_ptr = FALCON_MEM_CAST(FALCON_DESC_REGs_lo,ppa_in_desc);
    ...
    /* Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6.*/
    __LOG_FW(("Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6."));
    smemAnalayzerTemplateOfst = (thr84_desc_ptr->phal2ppa.pha_metadata & 0x7) * 64;
    __LOG_FW(("thr84_desc_ptr->phal2ppa.pha_metadata"));
    __LOG_PARAM_FW(thr84_desc_ptr->phal2ppa.pha_metadata & 0x7);
    __LOG_FW(("smemAnalayzerTemplateOfst"));
    __LOG_PARAM_FW(smemAnalayzerTemplateOfst);
    ...
    erspan_header_VER_to_C |= (PPA_FW_SP_READ( FALCON_PKT_REGs_lo + THR84_OUT_HDR_EDSA_W0_TO_ANALYZER__VER_OFFSET) & 0xE000);
    __PRAGMA_NO_REORDER
    ...
    __LOG_FW(("erspan_header_VER_to_C"));
    __LOG_PARAM_FW(erspan_header_VER_to_C);
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR84_OUT_HDR_ERSPAN__VER_OFFSET , erspan_header_VER_to_C);
    __PRAGMA_NO_REORDER
    ...
    __LOG_FW(("Set ERSPAN.T to TOD nano seconds"));
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR84_OUT_HDR_ERSPAN__VER_OFFSET + 4 , ts_nano_sec);
    __PRAGMA_NO_REORDER
    ...
    __LOG_PARAM_FW(erspan_header_SGT_to_O);
    __LOG_FW(("Set ERSPAN fiels: SGT:0x0 P:0x1 FT:0x0 hw_id:erspan_HW_ID D:descRxSniff Gra:0x2 O:0x1"));
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR84_OUT_HDR_ERSPAN__VER_OFFSET + 8 , erspan_header_SGT_to_O);
    ...
    __LOG_PARAM_FW(pssh_header_platId_index);
    __PRAGMA_NO_REORDER
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR84_OUT_HDR_ERSPAN__VER_OFFSET + 12 , pssh_header_platId_index);
    /* Set port Index according to RxSniff */
    __LOG_FW(("Set port Index according to RxSniff"
              "if descRxSniff = 0 trigger target port accelerator if 1 trigger source port accelerator (next command 4B offset)"));
    ...
    __LOG_FW(("pssh_Timestamp:"));
    __LOG_PARAM_FW(ts_sec);
    PPA_FW_SP_WRITE( FALCON_PKT_REGs_lo + THR84_OUT_HDR_ERSPAN__VER_OFFSET + 16 , ts_sec);
    ...
    /* Check if stack was overflowed */
    __LOG_FW(("Check if stack was overflowed"));
    falcon_stack_overflow_checker(84);
#endif
...
void PPA_FW(THR85_Erspan_TypeIII_TrgDevMirroring_IPv4_Tagged)() {
    ...
    /* Get pointers to descriptor,cfg & packet */
    struct ppa_in_desc* thr85_desc_ptr = FALCON_MEM_CAST(FALCON_DESC_REGs_lo,ppa_in_desc);
    ...
    __LOG_PARAM_FW(descRxSniff);
        ...
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR85_IN_HDR_ERSPAN__VER_OFFSET ,  (descRxSniff == 1) ? 0x200040f8: 0x2000401f);
        /* TimeStamp[4B] - 0xb6b6b6b6 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR85_IN_HDR_ERSPAN__VER_OFFSET + 4, 0xb6b6b6b6);
        /* SGT[2B] - 0x0 | P[1b] - 0x1 | FT[5b] - 0x0 | HW ID[6b] - 0x3f | D[1b] - 0 | GRA[2b] - 0x2 | O[1b] - 0x1 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR85_IN_HDR_ERSPAN__VER_OFFSET + 8, (descRxSniff == 1) ? 0x000083f5 : 0x000083fa);
        /* Platform specific sub header */
        /* Platf_ID[6b] - 0x5 | Switch_ID[10b] - 0x3ff | Port_ID[2B] - 0xcafe */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR85_IN_HDR_ERSPAN__VER_OFFSET + 12, (descRxSniff == 1) ? 0x17ffcafe : 0x17ffbabe);
        /* TimeStamp[4B] - 0xa1a1a1a1 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR85_IN_HDR_ERSPAN__VER_OFFSET + 16, 0xa1a1a1a1);
    #endif
    ...
    /* Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6.*/
    __LOG_FW(("Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6."));
    smemAnalayzerTemplateOfst = (thr85_desc_ptr->phal2ppa.pha_metadata & 0x7) * 64;
    __LOG_FW(("thr85_desc_ptr->phal2ppa.pha_metadata"));
    __LOG_PARAM_FW(thr85_desc_ptr->phal2ppa.pha_metadata);
    __LOG_FW(("smemAnalayzerTemplateOfst"));
    __LOG_PARAM_FW(smemAnalayzerTemplateOfst);
    ...
    /*-----------------------------------------------------------------------------------------------------------------------------------------------
      ...
      ------------------------------------------------------------------------------------------------------------------------------------------------*/
    __LOG_FW(("Copy 20B of IPv4 header from shared memory into packet output"));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR85_OUT_HDR_IPV4__VER_OFFSET) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  0));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR85_OUT_HDR_IPV4__VER_OFFSET + 4) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  4));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR85_OUT_HDR_IPV4__VER_OFFSET + 8) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  8));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR85_OUT_HDR_IPV4__VER_OFFSET + 12) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 12));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR85_OUT_HDR_IPV4__VER_OFFSET + 16) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 16));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 0));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 4));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 8));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 12));
    ...
    /* Check if stack was overflowed */
    __LOG_FW(("Check if stack was overflowed"));
    falcon_stack_overflow_checker(85);
#endif
...
void PPA_FW(THR86_Erspan_TypeIII_TrgDevMirroring_IPv4_Untagged)() {
    ...
    struct ppa_in_desc* thr86_desc_ptr = FALCON_MEM_CAST(FALCON_DESC_REGs_lo,ppa_in_desc);
    ...
    /* Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6.*/
    __LOG_FW(("Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6."));
    smemAnalayzerTemplateOfst = (thr86_desc_ptr->phal2ppa.pha_metadata & 0x7) * 64;
    __LOG_FW(("thr86_desc_ptr->phal2ppa.pha_metadata"));
    __LOG_PARAM_FW(thr86_desc_ptr->phal2ppa.pha_metadata);
    __LOG_FW(("smemAnalayzerTemplateOfst"));
    __LOG_PARAM_FW(smemAnalayzerTemplateOfst);
    ...
    __LOG_PARAM_FW(smemAnalyzerTemplateBaseAddr);
        ...
        /* ERSPAN header */
        /* Ver[4b] - 0x2 | VLAN[12b] - 0x0 | COS[3b] - 0x2 | BSO[2b] - 0x0 | T[1b] - 0| c(sessionId)[10b] - 0xf8  */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR86_IN_HDR_ERSPAN__VER_OFFSET ,  (descRxSniff == 1) ? 0x200040f8: 0x2000401f);
        /* TimeStamp[4B] - 0xb6b6b6b6 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR86_IN_HDR_ERSPAN__VER_OFFSET + 4, 0xb6b6b6b6);
        /* SGT[2B] - 0x0 | P[1b] - 0x1 | FT[5b] - 0x0 | HW ID[6b] - 0x3f | D[1b] - 0 | GRA[2b] - 0x2 | O[1b] - 0x1 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR86_IN_HDR_ERSPAN__VER_OFFSET + 8, (descRxSniff == 1) ? 0x000083f5 : 0x000083fa);
        /* Platform specific sub header */
        /* Platf_ID[6b] - 0x5 | Switch_ID[10b] - 0x3ff | Port_ID[2B] - 0xcafe */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR86_IN_HDR_ERSPAN__VER_OFFSET + 12, (descRxSniff == 1) ? 0x17ffcafe : 0x17ffbabe);
        /* TimeStamp[4B] - 0xa1a1a1a1 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR86_IN_HDR_ERSPAN__VER_OFFSET + 16, 0xa1a1a1a1);
    #endif
    ...
    /*-----------------------------------------------------------------------------------------------------------------------------------------------
      ...
      ------------------------------------------------------------------------------------------------------------------------------------------------*/
    __LOG_FW(("Copy 20B of IPv4 header from shared memory into packet output"));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR86_OUT_HDR_IPV4__VER_OFFSET) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  0));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR86_OUT_HDR_IPV4__VER_OFFSET + 4) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  4));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR86_OUT_HDR_IPV4__VER_OFFSET + 8) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  8));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR86_OUT_HDR_IPV4__VER_OFFSET + 12) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 12));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR86_OUT_HDR_IPV4__VER_OFFSET + 16) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 16));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 0));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 4));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 8));
    __LOG_PARAM_FW(PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 12));
    ...
    /* Check if stack was overflowed */
    __LOG_FW(("Check if stack was overflowed"));
    falcon_stack_overflow_checker(86);
#endif
...
void PPA_FW(THR87_Erspan_TypeIII_TrgDevMirroring_IPv6_Tagged)() {
    ...
    /* Get pointers to descriptor,cfg & packet */
    struct ppa_in_desc* thr87_desc_ptr = FALCON_MEM_CAST(FALCON_DESC_REGs_lo,ppa_in_desc);
    ...
    /* Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6.*/
    __LOG_FW(("Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6."));
    smemAnalayzerTemplateOfst = (thr87_desc_ptr->phal2ppa.pha_metadata & 0x7) * 64;
    __LOG_FW(("thr87_desc_ptr->phal2ppa.pha_metadata"));
    __LOG_PARAM_FW(thr87_desc_ptr->phal2ppa.pha_metadata);
    __LOG_FW(("smemAnalayzerTemplateOfst"));
    __LOG_PARAM_FW(smemAnalayzerTemplateOfst);
    ...
    __LOG_PARAM_FW(smemAnalyzerTemplateBaseAddr);
        ...
        /* ERSPAN header */
        /* Ver[4b] - 0x2 | VLAN[12b] - 0x0 | COS[3b] - 0x2 | BSO[2b] - 0x0 | T[1b] - 0| c(sessionId)[10b] - 0xf8  */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR87_IN_HDR_ERSPAN__VER_OFFSET ,  (descRxSniff == 1) ? 0x200040f8: 0x2000401f);
        /* TimeStamp[4B] - 0xb6b6b6b6 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR87_IN_HDR_ERSPAN__VER_OFFSET + 4, 0xb6b6b6b6);
        /* SGT[2B] - 0x0 | P[1b] - 0x1 | FT[5b] - 0x0 | HW ID[6b] - 0x3f | D[1b] - 0 | GRA[2b] - 0x2 | O[1b] - 0x1 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR87_IN_HDR_ERSPAN__VER_OFFSET + 8, (descRxSniff == 1) ? 0x000083f5 : 0x000083fa);
        /* Platform specific sub header */
        /* Platf_ID[6b] - 0x5 | Switch_ID[10b] - 0x3ff | Port_ID[2B] - 0xcafe */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR87_IN_HDR_ERSPAN__VER_OFFSET + 12, (descRxSniff == 1) ? 0x17ffcafe : 0x17ffbabe);
        /* TimeStamp[4B] - 0xa1a1a1a1 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR87_IN_HDR_ERSPAN__VER_OFFSET + 16, 0xa1a1a1a1);
    #endif
    ...
    __LOG_FW(("Get 40B of IPv6 header from shared memory and place them in output packet"));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  0));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET + 4) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  4));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET + 8) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  8)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET + 12) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 12)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET + 16) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 16)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET + 20) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 20)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET + 24) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 24)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET + 28) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 28)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET + 32) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 32)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR87_OUT_HDR_IPV6__VER_OFFSET + 36) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 36)  );
    ...
    /* Check if stack was overflowed */
    __LOG_FW(("Check if stack was overflowed"));
    falcon_stack_overflow_checker(87);
#endif
...
void PPA_FW(THR88_Erspan_TypeIII_TrgDevMirroring_IPv6_Untagged)() {
    ...
    /* Get pointers to descriptor,cfg & packet */
    struct ppa_in_desc* thr88_desc_ptr = FALCON_MEM_CAST(FALCON_DESC_REGs_lo,ppa_in_desc);
    ...
    /* Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6.*/
    __LOG_FW(("Desc.pha_metadata[0:2] contains shared memory index. Applicable values are 0:6."));
    smemAnalayzerTemplateOfst = (thr88_desc_ptr->phal2ppa.pha_metadata & 0x7) * 64;
    __LOG_FW(("thr88_desc_ptr->phal2ppa.pha_metadata"));
    __LOG_PARAM_FW(thr88_desc_ptr->phal2ppa.pha_metadata);
    __LOG_FW(("smemAnalayzerTemplateOfst"));
    __LOG_PARAM_FW(smemAnalayzerTemplateOfst);
    ...
    __LOG_PARAM_FW(smemAnalyzerTemplateBaseAddr);
        ...
        /* ERSPAN header */
        /* Ver[4b] - 0x2 | VLAN[12b] - 0x0 | COS[3b] - 0x2 | BSO[2b] - 0x0 | T[1b] - 0| c(sessionId)[10b] - 0xf8  */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR88_IN_HDR_ERSPAN__VER_OFFSET ,  (descRxSniff == 1) ? 0x200040f8: 0x2000401f);
        /* TimeStamp[4B] - 0xb6b6b6b6 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR88_IN_HDR_ERSPAN__VER_OFFSET + 4, 0xb6b6b6b6);
        /* SGT[2B] - 0x0 | P[1b] - 0x1 | FT[5b] - 0x0 | HW ID[6b] - 0x3f | D[1b] - 0 | GRA[2b] - 0x2 | O[1b] - 0x1 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR88_IN_HDR_ERSPAN__VER_OFFSET + 8, (descRxSniff == 1) ? 0x000083f5 : 0x000083fa);
        /* Platform specific sub header */
        /* Platf_ID[6b] - 0x5 | Switch_ID[10b] - 0x3ff | Port_ID[2B] - 0xcafe */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR88_IN_HDR_ERSPAN__VER_OFFSET + 12, (descRxSniff == 1) ? 0x17ffcafe : 0x17ffbabe);
        /* TimeStamp[4B] - 0xa1a1a1a1 */
        PPA_FW_SP_WRITE(FALCON_PKT_REGs_lo + THR88_IN_HDR_ERSPAN__VER_OFFSET + 16, 0xa1a1a1a1);
    #endif
    ...
    __LOG_FW(("Get 40B of IPv6 header from shared memory and place them in output packet"));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  0));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET + 4) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  4));
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET + 8) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr +  8)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET + 12) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 12)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET + 16) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 16)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET + 20) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 20)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET + 24) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 24)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET + 28) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 28)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET + 32) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 32)  );
    PPA_FW_SP_WRITE( (FALCON_PKT_REGs_lo + THR88_OUT_HDR_IPV6__VER_OFFSET + 36) , PPA_FW_SP_READ(smemAnalyzerTemplateBaseAddr + 36)  );
    ...
    /* Check if stack was overflowed */
    __LOG_FW(("Check if stack was overflowed"));
    falcon_stack_overflow_checker(88);
#endif
...
THREAD_TYPE phaThreadsTypeFalconDefault[] = {

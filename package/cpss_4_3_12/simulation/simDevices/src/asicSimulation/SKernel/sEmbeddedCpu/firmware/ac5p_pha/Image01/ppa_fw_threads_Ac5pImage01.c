...
void PPA_FW(THR90_Router_SA_Modification_Thread)() {
    ...
    ACCEL_CMD_TRIG(COPY_BYTES_THR90_Router_SA_Modification_Thread_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_mac_header__mac_sa_31_16_OFFSET, 0);
    ...
    /* Check if stack was overflowed */
    __LOG_FW(("Check if stack was overflowed"));
    ac5p_stack_overflow_checker(90);
#endif

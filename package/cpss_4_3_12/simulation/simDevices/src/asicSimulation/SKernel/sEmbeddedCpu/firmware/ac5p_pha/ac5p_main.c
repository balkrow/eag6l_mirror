...
void ac5p_init_shared_data_memory(uint32_t ppn_num)
{
    ...
    PPA_FW_SP_WRITE(AC5P_PKT_REGs_lo + THR83_IN_HDR_GRE__C_OFFSET,      0x100022eb);
    PPA_FW_SP_WRITE(AC5P_PKT_REGs_lo + THR83_IN_HDR_GRE__C_OFFSET + 4,  0x88888888);
    /* ERSPAN header */
    /* Ver[4b] - 0x2 | VLAN[12b] - 0x0 | COS[3b] - 0x2 | BSO[2b] - 0x0 | T[1b] - 0| c(sessionId)[10b] - 0xf8  */
    PPA_FW_SP_WRITE(AC5P_PKT_REGs_lo + THR83_IN_HDR_GRE__C_OFFSET + 8,  0x200040f8);
    /* TimeStamp[4B] - 0xb6b6b6b6 */
    PPA_FW_SP_WRITE(AC5P_PKT_REGs_lo + THR83_IN_HDR_GRE__C_OFFSET + 12, 0xb6b6b6b6);
    /* SGT[2B] - 0x0 | P[1b] - 0x1 | FT[5b] - 0x0 | HW ID[6b] - 0x3f | D[1b] - 0 | GRA[2b] - 0x2 | O[1b] - 0x1 */
    PPA_FW_SP_WRITE(AC5P_PKT_REGs_lo + THR83_IN_HDR_GRE__C_OFFSET + 16, 0x000083f5);
    /* Platform specific sub header */
    /* Platf_ID[6b] - 0x5 | Switch_ID[10b] - 0x3ff | Port_ID[2B] - 0xcafe */
    PPA_FW_SP_WRITE(AC5P_PKT_REGs_lo + THR83_IN_HDR_GRE__C_OFFSET + 20, 0x17ffcafe);
    /* TimeStamp[4B] - 0xa1a1a1a1 */
    PPA_FW_SP_WRITE(AC5P_PKT_REGs_lo + THR83_IN_HDR_GRE__C_OFFSET + 24, 0xa1a1a1a1);
    #endif

...
)
{
    ...
    else
    {
        ...
        {/* EPCL configuration table index = Local Device Target Port# + 4K */
            __LOG(("EPCL configuration table index = Local Device Target Port# + 4K"));
    ...
    lookupConfPtr->pclLookUpStage = SNET_PCL_LOOKUP_STAGE_EPCL_E;

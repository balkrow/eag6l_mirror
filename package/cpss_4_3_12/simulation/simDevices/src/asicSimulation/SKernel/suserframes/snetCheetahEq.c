...
#define SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELDS_NAME                     \
     STR(SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_NEXT_STAGE              )\
    ,STR(SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_NEXT_STAGE_PTR          )\
    ,STR(SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_TABLE_PTR_TABLE_ID      )\
    ,STR(SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_TABLE_PTR_BASE_ADDRESS  )\
    ,STR(SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_TABLE_PTR_ENTRY_SIZE    )\
    ,STR(SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_PROFILE                 )

static char * sip7EqVPortMappingFieldsTableNames[SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELDS___LAST_VALUE___E] =
    {SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELDS_NAME};

static SNET_ENTRY_FORMAT_TABLE_STC sip7EqVPortMappingTableFieldsFormat[SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELDS___LAST_VALUE___E] =
{
/*SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_NEXT_STAGE*/
     STANDARD_FIELD_MAC(2)
/*SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_NEXT_STAGE_PTR*/
    ,STANDARD_FIELD_MAC(18)
/*SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_TABLE_PTR_TABLE_ID*/
    ,STANDARD_FIELD_MAC(2)
/*SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_TABLE_PTR_BASE_ADDRESS*/
    ,STANDARD_FIELD_MAC(19)
/*SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_TABLE_PTR_ENTRY_SIZE*/
    ,STANDARD_FIELD_MAC(2)
/*SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_PROFILE*/
    ,STANDARD_FIELD_MAC(14)
};

#define SMEM_SIP7_EQ_H_ECMP_TABLE_FIELDS_NAME                             \
      STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_NEXT_STAGE             )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_NEXT_STAGE_PTR         )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_TABLE_PTR_TABLE_ID     )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_TABLE_PTR_BASE_ADDRESS )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_TABLE_PTR_ENTRY_SIZE   )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_MEMBER_ID              )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_NEXT_STAGE              )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_NEXT_STAGE_PTR          )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_TABLE_PTR_TABLE_ID      )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_TABLE_PTR_BASE_ADDRESS  )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_TABLE_PTR_ENTRY_SIZE    )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_MEMBER_ID               )\
     ,STR(SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_STATUS_VECTOR_PTR              )

static char * sip7EqHEcmpFieldsTableNames[SMEM_SIP7_EQ_H_ECMP_TABLE_FIELDS___LAST_VALUE___E] =
    {SMEM_SIP7_EQ_H_ECMP_TABLE_FIELDS_NAME};

static SNET_ENTRY_FORMAT_TABLE_STC sip7EqHEcmpTableFieldsFormat[SMEM_SIP7_EQ_H_ECMP_TABLE_FIELDS___LAST_VALUE___E] =
{
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_NEXT_STAGE              */
     STANDARD_FIELD_MAC(2)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_NEXT_STAGE_PTR          */
    ,STANDARD_FIELD_MAC(18)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_TABLE_PTR_TABLE_ID      */
    ,STANDARD_FIELD_MAC(2)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_TABLE_PTR_BASE_ADDRESS  */
    ,STANDARD_FIELD_MAC(20)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_TABLE_PTR_ENTRY_SIZE    */
    ,STANDARD_FIELD_MAC(2)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_MEMBER_ID               */
    ,STANDARD_FIELD_MAC(8)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_NEXT_STAGE               */
    ,STANDARD_FIELD_MAC(2)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_NEXT_STAGE_PTR           */
    ,STANDARD_FIELD_MAC(18)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_TABLE_PTR_TABLE_ID       */
    ,STANDARD_FIELD_MAC(2)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_TABLE_PTR_BASE_ADDRESS   */
    ,STANDARD_FIELD_MAC(20)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_TABLE_PTR_ENTRY_SIZE     */
    ,STANDARD_FIELD_MAC(2)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_BACKUP_MEMBER_ID                */
    ,STANDARD_FIELD_MAC(8)
/*SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_STATUS_VECTOR_PTR               */
...
/* enum used for : ha_table_id , table_ptr_table_id */
enum{
    HA_TABLE_ID_NO_TABLE_USED           = 0,
    HA_TABLE_ID_HEADER_FIELDS_TABLE_1   = 1,
    HA_TABLE_ID_HEADER_FIELDS_TABLE_2   = 2,
    HA_TABLE_ID_TUNNEL_START_TABLE      = 3,
};

typedef struct{
    GT_U32  ha_table_id;
    GT_U32  ha_table_address;
}EQ_SIP7_H_ECMP_STAGE_HA_INFO;

typedef struct{
    GT_U32  next_stage;
    GT_U32  next_stage_ptr;
    GT_U32  table_ptr_table_id;
    GT_U32  table_ptr_base_address;
    GT_U32  table_ptr_entry_size;
}EQ_SIP7_H_ECMP_STAGE_COMMON_INFO;

typedef struct{
    EQ_SIP7_H_ECMP_STAGE_COMMON_INFO  IN_info;

    EQ_SIP7_H_ECMP_STAGE_COMMON_INFO  OUT_info;

    EQ_SIP7_H_ECMP_STAGE_HA_INFO      OUT_ha_info;
}EQ_SIP7_H_ECMP_STAGE_INFO;

static GT_VOID eqSip7VPortMapping
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN SKERNEL_FRAME_CHEETAH_DESCR_STC * descrPtr,
    OUT EQ_SIP7_H_ECMP_STAGE_COMMON_INFO *vPortMapInfoPtr
);
static GT_VOID eqSip7HierarchicalEcmp
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN SKERNEL_FRAME_CHEETAH_DESCR_STC  *descrPtr,
    IN EQ_SIP7_H_ECMP_STAGE_COMMON_INFO *vPortMapInfoPtr
);
static GT_VOID eqSip7E2PhyIndexGet
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN SKERNEL_FRAME_CHEETAH_DESCR_STC * descrPtr,
    OUT GT_U32      *indexToE2PHYPtr
);
static GT_VOID eqSip7E2Phy_part2
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN SKERNEL_FRAME_CHEETAH_DESCR_STC * descrPtr
);
...
)
{
    ...
    descrPtr->oamInfo.opCode                   = 0;
    descrPtr->oamInfo.oamProcessEnable         = 0;
    descrPtr->oamInfo.oamProfile               = 0;
    descrPtr->oamInfo.oamRdi                   = 0;
    descrPtr->oamInfo.oamTxPeriod              = 0;
    descrPtr->oamInfo.megLevel                 = 0;
    descrPtr->oamInfo.lmCounterCaptureEnable   = 0;

    /* CNC : count the 'sending out of the EQ.
       Count the passing of the packet.
       It should be done before packet hash reduction because
       CNC Hash client use original ingress hash. */
    ...
    if(devObjPtr->supportEArch)
    {
        ...
        {
            /* SIP7 supports 32 bits of packet hash */
            startBit = 0;
            numOfBits = 32;
        }
        else
    ...
    /* the GM code :
        m_bIsPktMirrorInLocalDev = (m_uSourceType == MIRROR) || (m_uSourceType == STC) || (m_uSourceType ==  SNIFFER) || (m_uSourceType ==  TXQ) || ((m_uSourceType ==  INGRESS) && (m_uPipePacketCmd == PKT_CMD_TRAP));*/
    descrPtr->isPktMirrorInLocalDev = 1;/* !!! not implemented yet !!! */SIM_TBD_BOOKMARK
    if (descrPtr->marvellTagged && descrPtr->incomingMtagCmd == SKERNEL_MTAG_CMD_TO_TRG_SNIFFER_E)
    {
        /* mirror done on remote device */
        descrPtr->isPktMirrorInLocalDev = 0;
    }
...
* @param[in]  IN_lttMemPtr             - (pointer to) the lttMemPtr (used if not NULL)
*/
...
)
{
    ...
    GT_BIT ignoreEcmpEnableBit = 0;/* indication if we need to ignore the <ECMP enable> bit in the LTT entry */

    if (instanceType == SNET_CHT_EQ_HASH_INDEX_RESOLUTION_INSTANCE_H_ECMP_E)
    {
        lttMemPtr = IN_lttMemPtr; /* MUST not be NULL */
        hashBitSelectionConfigRegAddr = SMEM_LION2_EQ_EPORT_ECMP_HASH_BIT_SELECTION_CONFIG_REG(devObjPtr);
        /* LTT<ECMP Enable> field is not required for Hierarchical ECMP */
        /* ignore it in case of Hierarchical ECMP                       */
        ignoreEcmpEnableBit = 1;
    }
    else
    ...
    {
        /*ECMP Enable bit */
        if(ignoreEcmpEnableBit ==0 && 0 == snetFieldValueGet(lttMemPtr,0,1))
        {
            if(instanceType == SNET_CHT_EQ_HASH_INDEX_RESOLUTION_INSTANCE_TRUNK_E)
            {
                /* ecmp disabled */
        ...
        else
        {
            ...
            GT_U32  startBit = SMEM_CHT_IS_SIP7_GET(devObjPtr) ? 30 : 28;
            ...
            l2_ecmp_hash_selection_mode = snetFieldValueGet(lttMemPtr,startBit,4);
    ...
    */
    ...
    /* multiply 32bits value by 16bits value , in 32 bits system */

    {
        /* support hashIndex that is more than 20 bits that multiple by 12 bits 'numOfMembers'
           can lead to value in more than 32 bits .

           this easily happen when using 32 bits hash value , so hashIndex is 32 bits
           and numRightShiftBits is also 32
        */
        ecmpMemberIndex = (GT_U64_BIT)((GT_U64_BIT)hashIndex * (GT_U64_BIT)numOfMembers) >> numRightShiftBits;
    }
    ...
    if(lttMemPtr)
    {
        ...
        {
            GT_U32 selectedDevNum,selectedEPort;

            if(SMEM_CHT_IS_SIP7_GET(devObjPtr) &&
               instanceType == SNET_CHT_EQ_HASH_INDEX_RESOLUTION_INSTANCE_TRUNK_E)
            {
                /* Sip7 : the trunk got dedicated table */
                regAddr = SMEM_SIP7_EQ_TRUNK_ECMP_TBL_MEM(devObjPtr,ecmpIndex);
                /* Sip7 : DLB keep using the L2_ECMP */
            }
            else
            {
                regAddr = SMEM_LION2_EQ_L2_ECMP_TBL_MEM(devObjPtr,ecmpIndex);
            ...
            regPtr = smemMemGet(devObjPtr, regAddr);
            selectedDevNum = snetFieldValueGet(regPtr,0,10);

            __LOG(("from ECMP table : target device [0x%x] \n",selectedDevNum));
            if(selectedDevNumPtr)
            {
                /*target device*/
                *selectedDevNumPtr =  selectedDevNum;
            }

            if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
            {
                width_target_eport_phy_port = 15;
            }
            else
            ...
            /*target port*/
            selectedEPort =  snetFieldValueGet(regPtr,10,width_target_eport_phy_port);

            __LOG(("from ECMP table : target port [0x%x] \n",selectedEPort));

            if(selectedEPortPtr)
            {
                *selectedEPortPtr = selectedEPort;
            }
            ...
            if(SMEM_CHT_IS_SIP6_10_GET(devObjPtr))
            {
                ...
                if(replicationMode == 1 /* CASCADED_SYSTEM */&&
                   (mllReplicated == 1) &&
                   (selectedDevNum/* Target Device */ != descrPtr->ownDev))
                {
...
)
{
    ...
    /* Analyzer Index field length */
    fieldLength = SMEM_CHT_IS_SIP7_GET(devObjPtr)? 6 : 3;
    fieldOffset = SMEM_CHT_IS_SIP7_GET(devObjPtr)? 8 : 5;

    if(isRxMirror)
    {
        /* Global Ingress Mirror Index */
        global_Mirror_Index = SMEM_U32_GET_FIELD(analyzerPortGlobalConfig, 2, fieldLength);
    }
    else
    {
        /* Global Egress Mirror Index */
        global_Mirror_Index = SMEM_U32_GET_FIELD(analyzerPortGlobalConfig, fieldOffset, fieldLength);
    }
...
)
{
    ...
    GT_U32    fieldLength; /* Analyzer field field length */
    GT_U32    saveIndex; /* save desc<analyzerIndex> value to restore */
    GT_U32    saveRxSniff;/* save desc<rxSniff> value to restore*/
    ...
    if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        ...
        if(fieldVal == 0)
        {
            ...
            if(descrPtr->packetCmd == SKERNEL_EXT_PKT_CMD_TO_TRG_SNIFFER_E /*came from DSA as 'TO_ANALYZER' */ &&
               (descrPtr->marvellTaggedExtended + 1) < 4 )/* came from device that sent 'non-eDSA tag' */
            {
                __LOG(("WARNING : potential config ERROR : 'END_TO_END' mirroring mode not proper when NOT using eDSA tag \n"
                       "As the target port info is not in the first 2 words of the DSA ! \n"));
            }
        }
        else if(fieldVal == 1)
        {
    ...
    if(doPerPhysicalPort)
    {
        ...
        if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
        {
            ...
            step = SMEM_CHT_IS_SIP7_GET(devObjPtr)? 12 : 4;

            /** Per-port Ingress Mirror Index - 8 ports in entry ,
             *  In AAS, 6  bits in steps of 12 and in other devices 3 bits in steps of 4
             */
            fieldVal =  snetFieldValueGet(regPtr, ((localDevSrcPort % 8) * step), fieldLength);

            /**  In SIP7 devices, Physical port based analyzer index won't compete with incoming analyzerIndex,
            *   instead the port analyzer index will always generates a mirrored copy independent of
            *   incoming desc<analyzerIndex>. This analyzerIndex has its own 1:N sampling ratio.
            *   So in SIP7, there will be 2 final analyzer index, one based on high index win mechanism
            *   and other based on physical port */
            if(SMEM_CHT_IS_SIP7_GET(devObjPtr) && fieldVal != 0)
            {
                /** Save descr<analyzerIndex> and descr<rxSniff> before assigning port based analyzerIndex,
                 *  Restore these values after port based mirroring is done to 'avoid' the physical port based
                 *  analyzerIndex competing in the finalizing index process
                 */
                saveIndex = descrPtr->analyzerIndex;
                saveRxSniff = descrPtr->rxSniff;

                /*Assign the src Port based analyzer Index*/
                descrPtr->analyzerIndex = fieldVal;

                descrPtr->rxSniff = 1;

                /* Do rx sniffing */
                if(descrPtr->packetCmd != SKERNEL_EXT_PKT_CMD_TO_TRG_SNIFFER_E && /* when packet is from DSA to sniffer ..
                we already sent it to the analyzer */
                descrPtr->rxSniff)
                {
                ...
                __LOG(("SIP7 source port[%d] based analyzer index : mirror index [%d] \n",
                    descrPtr->localDevSrcPort,
                    fieldVal));

                /* Restore analyzerIndex and rxSniff values */
                descrPtr->analyzerIndex = saveIndex;
                descrPtr->rxSniff = saveRxSniff;
            }
        }
        else
        {
    ...
    else
    {
        ...
        if(descrPtr->analyzerIndex && descrPtr->rxSniff)
        {
            ...
            fieldVal = SMEM_U32_GET_FIELD(analyzerPortGlobalConfig, 2, fieldLength);
            if(fieldVal)
            {
...
)
{
    ...
    if(descrPtr->useVidx == 0)/* otherwise descrPtr->trgDev not valid */
    {
        if(SMEM_CHT_IS_SIP7_GET(devObjPtr) &&
            ...
            descrPtr->trgIsVPort)
        {
            /* allow access to E2PHY for vPorts (descrPtr->trgDev is not valid)*/
        }
        else
    ...
    {
        /* get the index to the E2PHY */
        eqSip7E2PhyIndexGet(devObjPtr,descrPtr,&indexToE2PHY);
    }

    __LOG_PARAM(indexToE2PHY);
    ...
    */
    ...
    if(descrPtr->eArchExtInfo.eqInfo.needVPortE2PhyLogic_part2) /*sip7*/
    {
        /* do 'part-2' after we accessed the E2PHY */
        eqSip7E2Phy_part2(devObjPtr,descrPtr);
    }
}
...
)
{
    ...
    GT_U32    isLocSet;
    GT_U32  numBits = (SMEM_CHT_IS_SIP7_GET(devObjPtr)    ? 14 :
                       SMEM_CHT_IS_SIP6_30_GET(devObjPtr) ?  7 :
                       SMEM_CHT_IS_SIP6_10_GET(devObjPtr) ? 11 :
...
)
{
    ...
    if (trgPortMuxLen != 0)
    {
        eportLimit =  devObjPtr->eqNumBitsPerEPort ? devObjPtr->eqNumBitsPerEPort-1  :
...
)
{
    ...
    {
        /* Store eqInTrgEPort */
        descrPtr->eArchExtInfo.eqInTrgEPort = descrPtr->trgEPort;
    }

    if(descrPtr->trgIsVPort)
    {
        /* we not have yet the E-ECMP for the vPort mapping , so need to use the E2PHY */
        /* because we set 0xFFFFFFFF to the 2 feilds when we set 'trgIsVPort'          */
        descrPtr->trgEPort = descrPtr->trgVPort;
        descrPtr->trgDev   = descrPtr->ownDev;
    }
    ...
    */
    ...
    if(descrPtr->trgIsVPort)/* sip7 */
    {
        EQ_SIP7_H_ECMP_STAGE_COMMON_INFO vPortMapInfo;
        /*
            Hierarchical ECMP is composed from the following components:
            Target vPort Mapping table
            ECMP stages ,Pointers Selection and calc : descrPtr->trgCircuit
            Accessing the E2PHY
        */

        /* Target vPort Mapping table */
        eqSip7VPortMapping(devObjPtr, descrPtr , &vPortMapInfo/*OUT*/);

        /* ECMP stages
            and calc : descrPtr->trgCircuit
        */
        eqSip7HierarchicalEcmp(devObjPtr, descrPtr , &vPortMapInfo/*IN*/);
    }
    else
    if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        ...
        descrPtr->packetCmd == SKERNEL_EXT_PKT_CMD_HARD_DROP_E)
    {
        ...
        if(pktDropEnable)
        {
            /* CNC Trigger : count the drop.
               CNC Counting will be done inside snetChtEqToEgfOnDroppedPacket in case
               pktDropEnable == 0 */
...
)
{
    ...
    /* duplicated descriptor get Forward command */
    newDescrPtr->packetCmd = SKERNEL_EXT_PKT_CMD_FORWARD_E;
...
)
{
    ...
    GT_U32  * rxSniffPtr;       /* pointer to counter for statistical feature */
    GT_U32  * rxSniffRatioPtr;  /* pointer to internal ratio value */
    GT_U32  nextStatRatio;      /* value of ratio for next packet */
    ...
    if(SMEM_CHT_IS_SIP6_GET(devObjPtr))
    {
        /* get pointer to internal ratio */
        rxSniffRatioPtr = CHT_INTERNAL_MEM_PTR(devObjPtr,
            CHT_INTERNAL_SIMULATION_USE_MEM_RX_STATISTICAL_SNIFF_RATIO_ANALYZER_1_E + (descrPtr->analyzerIndex-1));
        ...
        /* SIP_6 device use internal ratio for decisions */
        statRatio = *rxSniffRatioPtr;

        /* internal ratio is updated by packet.
           configured ratio will be applied only on next packet. */
        *rxSniffRatioPtr = nextStatRatio;
    }
    else
    {
...
)
{
    ...
    if(callFromErep == GT_TRUE)
    {
        /* trap/mirror to CPU from the egress pipe (sip6 support)
           all the 'src/Trg' related fields already set by function
           erepPrepareCopyDescToEq(...) */

        /* JIRA:CPSS-16410
         * In HW, egress units use Egress Packet Cmd in descriptor
         * EQ unit duplicates it and assign below fields for "TRAP" duplicated descriptor
         * Egress Packet Cmd = FORWARD
         * Outgoing Mtag Cmd = TO_CPU
         */
        descrPtr->packetCmd = SKERNEL_EXT_PKT_CMD_FORWARD_E;
    }
    else
    ...
    else
    {
        if((descrPtr->marvellTagged == 0) ||
           (descrPtr->marvellTagged == 1 && descrPtr->incomingMtagCmd != SKERNEL_MTAG_CMD_TO_CPU_E))
        {
            descrPtr->srcTrg = 0;
            descrPtr->srcTaggedTrgTagged = descrPtr->tagSrcTagged[SNET_CHT_TAG_0_INDEX_CNS];
        }
        else /* ingress with DSA of 'TO_CPU' */
        {
            /*descrPtr->srcTrg was set from the ingress DSA */
            /*descrPtr->trgTagged was set from the ingress DSA */
            descrPtr->srcTaggedTrgTagged = descrPtr->trgTagged;
        }
            ...
            descrPtr->marvellTagged == 1)
        {
               ...
               (descrPtr->incomingMtagCmd != SKERNEL_MTAG_CMD_TO_TRG_SNIFFER_E))
            {
                ...
                */
                ...
                if(descrPtr->cpuCode == SNET_CHT_MAIL_FROM_NEIGHBOR_CPU)
                {
                    descrPtr->eArchExtInfo.srcTrgEPort = descrPtr->eArchExtInfo.localDevSrcEPort;/* local eport info */
                }
                else
                {
...
{
    GT_BOOL                           callFromErep;

    /* check that descriptor was duplicated by EREP. It's notified by txqToEq. */
    callFromErep = (SMEM_CHT_IS_SIP6_GET(devObjPtr) && descrPtr->txqToEq) ? GT_TRUE : GT_FALSE;

    snetChtEqDoToCpuGeneric(devObjPtr,descrPtr,GT_TRUE/* call the TXQ*/,callFromErep);
}
...
)
{
    ...
    else
    {
        ...
        if(descrPtr->mirrorToAllCpus &&
           descrPtr->localDevSrcPort != SNET_CHT_CPU_PORT_CNS)
        {
            GT_U32 orig_cpuCode = descrPtr->cpuCode;

            descrPtr->cpuCode = SNET_CHT_CPU_TO_ALL_CPUS;

            /* Send to CPU */
            __LOG(("Send to the local CPU the 'mirror to all CPUs' (as it ingress from port[%d] != [%d]) with CPU code = 'CPU_TO_ALL_CPUS' \n",
                descrPtr->localDevSrcPort,SNET_CHT_CPU_PORT_CNS));
            snetChtEqDuplicateToCpu(devObjPtr, descrPtr, GT_FALSE/* NOT called from EREP */);

            __LOG(("Continue the 'mirror to all CPUs' that may egress more cascade ports (toward other CPUs) in the evidx[0x%x] \n",descrPtr->eVidx));

            /* resort the CPU code */
            descrPtr->cpuCode = orig_cpuCode; /*probably back to '0'*/
        }
    }
...
)
{
    ...
    GT_BOOL forbidNullPortToModifyCpuCode = GT_FALSE;
    ...
    */
    ...
    /* The erratum EQ-489:
     * CNC - Packet Type - Pass/Drop Client does not count local replications
     * is fixed for SIP5_10 devices.
     */
    ...
    if((dropBit == 1) && SMEM_CHT_IS_SIP6_10_GET(devObjPtr))
    {
        ...
        {
            /* fix for :
                CPSS-15769 : [WM][SCT]CNC client 'PACKET_TYPE_PASS_DROP_E' set in 'CPU code' mode do not count dropped traffic .

                The counting of drops by the EQ CNC clients is allowed , regardless to
                which unit will do the actual drop :  EQ or EREP.
            */
            __LOG(("The counting of drops by the EQ CNC clients is allowed , regardless to fact that the actual drop will be by EREP unit (and not EQ). \n"));
        }
        else
        {
            __LOG(("The counting of drops by the EQ CNC clients is allowed , regardless to fact that the actual drop will be by EQ unit. \n"));
        }
    }

    if(descrPtr->useVidx == 0 && descrPtr->targetIsTrunk == 0)
    {
        /* CPSS-16192: [Falcon] when packet command is TRAP, EQ modifies the outgoing trgEPort to CPU_PORT.
         * But the incoming trgEPort is NULL_PORT. Therefore, for such packets CNC counting should be based
         * on incoming trgEPort(NULL_PORT) instead of outgoing trgEPort(CPU_PORT)
         */
        if(devObjPtr->deviceFamily == SKERNEL_FALCON_FAMILY)
        {
            trgEPort = descrPtr->eArchExtInfo.eqInTrgEPort;
            __LOG(("[FALCON]: For Trapped packets CNC counting should use incoming trgEPort[%d] before EQ unit modification instead of outgoing trgEPort[%d] before EQ unit modification\n", descrPtr->eArchExtInfo.eqInTrgEPort, descrPtr->trgEPort));
        }
        else
        {
            trgEPort = descrPtr->trgEPort;
        }
        if((descrPtr->eArchExtInfo.isTrgPhyPortValid == 0) && (trgEPort == SNET_CHT_NULL_PORT_CNS))
        {
        ...
        /* VERIFIER code:
           if ((m_uPipeTRGePort == DROP_PORT) && (m_uPipeUseVidx == 0) && (m_uPipeTargetIsTrunk == 0) && (m_uOutgoingMtagCmd != MTAG_CMD_TO_CPU) & (m_uDescPacketCmd != PKT_CMD_SOFT_DROP) & (m_uDescPacketCmd != PKT_CMD_HARD_DROP))
        */
        if(eqDropOnNullPort && SMEM_CHT_IS_SIP6_10_GET(devObjPtr) &&
            (descrPtr->packetCmd == SKERNEL_EXT_PKT_CMD_HARD_DROP_E ||
             descrPtr->packetCmd == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E ||
             descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_TO_CPU_E))
        {
            __LOG(("Sip6.10 : The EQ CNC will use original cpuCode and not using drop code for 'NULL port' \n"));
            forbidNullPortToModifyCpuCode = 1;
        }
    ...
    else
    {
        ...
        if(eqDropOnNullPort && (outGoingMtagCmd != SKERNEL_MTAG_CMD_TO_CPU_E))
        {
            dropBit = 1;
    ...
    if (descrPtr->isEqCncOrigCounted)
    {
        __LOG(("Skip Ingress VLAN Pass/Drop for replication (mirror/STC) \n"));
    }
    else
    {
    ...
    __LOG(("This accessing to EQ CNC clients considered 'original' packet and was counted (replications (mirror/STC) will not be) \n"));
    descrPtr->isEqCncOrigCounted = 1;

    if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        GT_U32  orig_cpuCode = descrPtr->cpuCode;
        GT_U32  Target_Port_Is_Null_Drop_Code;/* drop code from register for NULL port */

        /* HW support from sip5_10 but default register value in WM is not ok */
        if(SMEM_CHT_IS_SIP5_20_GET(devObjPtr))
        {
            regAddress = SMEM_CHT_PRE_EGR_GLB_CONF_REG(devObjPtr);
            smemRegGet(devObjPtr, regAddress, &fldValue);
            Target_Port_Is_Null_Drop_Code = SMEM_U32_GET_FIELD(fldValue, 24, 8);
        }
        else
        {
            Target_Port_Is_Null_Drop_Code = SNET_CHT_TARGET_NULL_PORT_E;/*62*/
        }

        if(eqDropOnNullPort &&
            descrPtr->cpuCode != Target_Port_Is_Null_Drop_Code)
        {
            if(forbidNullPortToModifyCpuCode == GT_TRUE)
            {
                __LOG(("sip6.10 : EQ counting of 'DROP code'(CPU code) , will be according original drop code [%d] and not 'NULL port'(%d) \n",
                    descrPtr->cpuCode,
                    Target_Port_Is_Null_Drop_Code));
            }
            else
            {
                /* emulate JIRA : EQ-717 : RFN - No need to override CNC cpu-code for
                    SOFT/HARD drop packets that came from ingress pipe in case of NULL port
                    and/or -
                    EQ-816 : EQ changes cpu code to drop code on TRAP command
                */

                /* issue fixed in SIP_6_10 */

                __LOG(("WARNING : EQ counting of 'DROP code'(CPU code) , will be according to 'DROP code' = 'NULL port'(%d) , instead of original one [%d]\n",
                    Target_Port_Is_Null_Drop_Code,
                    descrPtr->cpuCode));
                descrPtr->cpuCode = Target_Port_Is_Null_Drop_Code;
            }
        ...
        descrPtr->cpuCode = orig_cpuCode;/*restore*/
    }
}
...
)
{
    ...
    if (SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        LION3_TABLES_FORMAT_INIT_MAC(
            devObjPtr, SKERNEL_TABLE_FORMAT_VPORT_MAPPING_E,
            sip7EqVPortMappingTableFieldsFormat, sip7EqVPortMappingFieldsTableNames);

        LION3_TABLES_FORMAT_INIT_MAC(
            devObjPtr, SKERNEL_TABLE_FORMAT_H_ECMP_E,
            sip7EqHEcmpTableFieldsFormat, sip7EqHEcmpFieldsTableNames);
...
/* values for 'GCF_mode' */
enum{
    GCF_MODE_STATUS_BIT = 0 ,
    GCF_MODE_PRIMARY    = 1 ,
    GCF_MODE_BACKUP     = 2
};
/**
* @internal eqSip7HierarchicalEcmpStage function
* @endinternal
*
* @brief   EQ - Sip7 Hierarchical Ecmp stage
*
* @param[in] devObjPtr                - pointer to device object.
* @param[in] descrPtr                 - pointer to the frame's descriptor.
* @param[in] infoPtr                  - pointer to info with the IN info filled.
*
* @param[out] isSkippedPtr            - pointer indication if the Stage skipped.
* @param[out] infoPtr                 - pointer to info with the OUT info filled.
*/
static GT_VOID eqSip7HierarchicalEcmpStage
(
    IN SKERNEL_DEVICE_OBJECT        * devObjPtr,
    IN SKERNEL_FRAME_CHEETAH_DESCR_STC * descrPtr,
    IN GT_U32                        current_stageId,
    OUT   GT_BIT                    *isSkippedPtr,
    INOUT EQ_SIP7_H_ECMP_STAGE_INFO  *infoPtr
)
{
    DECLARE_FUNC_NAME(eqSip7HierarchicalEcmpStage);

    GT_U32 *lttMemPtr; /* LTT table entry pointer */
    GT_U32 *ecmpMemPtr; /* ECMP table entry pointer */
    GT_U32 *statusVectorMemPtr; /* ECMP Status Vector start of table pointer */
    GT_U32  regValue;
    GT_U32  Enable_Dual_Mode;
    GT_U32  StageX_Path_Selection_Enable;
    GT_U32  StageX_Path_Selection_GCF_lsb;
    GT_U32  StageX_Path_Selection_GCF_size;
    GT_U32  StageX_P_B_Path_Selection_Enable;
    GT_U32  StageX_P_B_Path_Selection_GCF_lsb;
    GT_U32  GCF_mode,GCF_value;
    GT_U32  next_stage,next_stage_ptr,table_ptr_table_id,table_ptr_base_address,table_ptr_entry_size,member_id;
    GT_U32  status_vector_ptr;
    GT_U32  ecmp_start_index,ecmpIndex;
    GT_U32  usePrimary;
    GT_U32  statusBit;/* value of status bit in statusVectorMemPtr */

    if(current_stageId != infoPtr->IN_info.next_stage)
    {
        __LOG(("'skip' H ECMP stage [%d] \n",
            current_stageId + 1));

        *isSkippedPtr = 1;

        /* copy the IN to the OUT */
        infoPtr->OUT_info = infoPtr->IN_info;

        infoPtr->OUT_ha_info.ha_table_id = 0;
        infoPtr->OUT_ha_info.ha_table_address = 0;/* not defined in the IAS , but ignored when ha_table_id == 0 */
    ...
    *isSkippedPtr = 0;
    ...
    __LOG(("Start H ECMP stage [%d] \n",
        current_stageId+1/*1,2,3*/));

    __LOG(("Access the ECMP LTT , index [%d] (according to 'next_stage_ptr')\n",
        infoPtr->IN_info.next_stage_ptr));

    lttMemPtr = smemMemGet(devObjPtr,
        SMEM_LION2_EQ_L2_ECMP_LTT_TBL_MEM(devObjPtr,infoPtr->IN_info.next_stage_ptr));

    if(0 == snetFieldValueGet(lttMemPtr,0,1))
    {
        __LOG(("NOTE: The LTT index [%d] with <ECMP enable> == 0 , but the field is ignored (for H-ECMP) \n",
            infoPtr->IN_info.next_stage_ptr,
            current_stageId + 1));
    }


    Enable_Dual_Mode = snetFieldValueGet(lttMemPtr,34,1);
    ecmp_start_index = snetFieldValueGet(lttMemPtr,2,16/*width_l2_ecmp_start_index*/);

    smemRegGet(devObjPtr,
        SMEM_SIP7_EQ_STAGE_PATH_INFO_REG(devObjPtr,current_stageId),
        &regValue);

    StageX_Path_Selection_Enable      = SMEM_U32_GET_FIELD(regValue,  0 ,  1);
    StageX_Path_Selection_GCF_lsb     = SMEM_U32_GET_FIELD(regValue,  1 ,  7);
    StageX_Path_Selection_GCF_size    = SMEM_U32_GET_FIELD(regValue,  8 ,  3);
    StageX_P_B_Path_Selection_Enable  = SMEM_U32_GET_FIELD(regValue,  11,  1);
    StageX_P_B_Path_Selection_GCF_lsb = SMEM_U32_GET_FIELD(regValue,  12,  7);

    if(simLogIsOpenFlag)
    {
        __LOG_PARAM(Enable_Dual_Mode);
        __LOG_PARAM(ecmp_start_index);

        __LOG_PARAM(StageX_Path_Selection_Enable     );
        __LOG_PARAM(StageX_Path_Selection_GCF_lsb    );
        __LOG_PARAM(StageX_Path_Selection_GCF_size   );
    }
    ...
    /* get x bits from the 128 bits of descrPtr->genericClassification[0..3]
       x is StageX_Path_Selection_GCF_size
       start bit : StageX_Path_Selection_GCF_lsb
    */
    if(StageX_Path_Selection_GCF_size == 0)
    {
        GCF_value = 0;
    }
    else
    {
        GCF_value = snetFieldValueGet(descrPtr->genericClassification,
            StageX_Path_Selection_GCF_lsb,StageX_Path_Selection_GCF_size);

        if((StageX_P_B_Path_Selection_GCF_lsb+StageX_Path_Selection_GCF_size) > 128)
        {
            __LOG(("Warning : GCF_value from the descrPtr->genericClassification start at bit[%d] so can't get [%d] bits (so get till bit 127) \n",
                StageX_Path_Selection_GCF_lsb,
                StageX_Path_Selection_GCF_size));
            /* not able to read all bits , so the MSBits are not valid , so remove them */
            GCF_value &= SMEM_BIT_MASK(128-StageX_P_B_Path_Selection_GCF_lsb);
        }
    }
    __LOG_PARAM(GCF_value);

    if(StageX_Path_Selection_Enable == 0 || GCF_value == 0)
    {
        /* get the ECMP offset */
        snetChtEqHashIndexResolution(devObjPtr,descrPtr, 0, 0, &ecmpIndex,
            SNET_CHT_EQ_HASH_INDEX_RESOLUTION_INSTANCE_H_ECMP_E,
            NULL,
            NULL,
            lttMemPtr);

        __LOG(("Use ecmpIndex [%d] into ECMP table \n",
            ecmp_start_index));
    }
    else
    {
        ecmpIndex = ecmp_start_index + (GCF_value - 1);
        __LOG(("Use ecmpIndex [%d] into ECMP table ((<GCF value>-1) = [%d] + ecmp_start_index [%d]) \n",
            ecmpIndex,
            (GCF_value - 1) ,
            ecmp_start_index));
    }
    ...
    if(Enable_Dual_Mode)
    {
        __LOG(("Dual mode : use ecmpIndex[%d] 'As is' \n",
            ecmpIndex));

        __LOG_PARAM(StageX_P_B_Path_Selection_Enable );
        __LOG_PARAM(StageX_P_B_Path_Selection_GCF_lsb);

        /* get 2 bits from the 128 bits of descrPtr->genericClassification[0..3]
           start bit : StageX_P_B_Path_Selection_GCF_lsb
        */
        GCF_mode = snetFieldValueGet(descrPtr->genericClassification,
            StageX_P_B_Path_Selection_GCF_lsb,2);
        if((StageX_P_B_Path_Selection_GCF_lsb+2) > 128)
        {
            __LOG(("Warning : GCF_mode from the descrPtr->genericClassification start at bit[%d] so can't get [%d] bits (so get till bit 127) \n",
                StageX_P_B_Path_Selection_GCF_lsb,
                2));
            /* not able to read 2 bits , so the MSBit is not valid , so remove it */
            GCF_mode &= 0x1;
        }

        __LOG_PARAM(GCF_mode);/* 0,1,2 */

        ecmpMemPtr = smemMemGet(devObjPtr,
            SMEM_LION2_EQ_L2_ECMP_TBL_MEM(devObjPtr,ecmpIndex));

        status_vector_ptr        =
            SMEM_SIP7_EQ_H_ECMP_ENTRY_FIELD_GET(devObjPtr,ecmpMemPtr,ecmpIndex,
            SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_STATUS_VECTOR_PTR);

        statusVectorMemPtr = smemMemGet(devObjPtr,
            SMEM_SIP7_EQ_H_ECMP_STATUS_VECTOR_TBL_MEM(devObjPtr,0));

        statusBit = snetFieldValueGet(statusVectorMemPtr,status_vector_ptr,1);
        __LOG_PARAM(statusBit);

        usePrimary = (statusBit == 0/*active*/) ? 1  : 0;

        if(((StageX_P_B_Path_Selection_Enable == 0 || GCF_mode == GCF_MODE_STATUS_BIT) && usePrimary) ||
            (StageX_P_B_Path_Selection_Enable == 1 && GCF_mode == GCF_MODE_PRIMARY))
        {
            usePrimary = 1;
        }
        else
    ...
    else  /*Enable_Dual_Mode == 0*/
    {
        usePrimary = ecmpIndex & 1; /* get the value , before '>>= 1' */
        ecmpIndex >>= 1;

        __LOG(("Non Dual mode : use ecmpIndex[%d] (half of previous calculated index) \n",
            ecmpIndex));
    ...
    if(usePrimary)
    {
        ...
        table_ptr_table_id      =
            SMEM_SIP7_EQ_H_ECMP_ENTRY_FIELD_GET(devObjPtr,ecmpMemPtr,ecmpIndex,
            SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_TABLE_PTR_TABLE_ID);
        table_ptr_base_address  =
            SMEM_SIP7_EQ_H_ECMP_ENTRY_FIELD_GET(devObjPtr,ecmpMemPtr,ecmpIndex,
            SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_TABLE_PTR_BASE_ADDRESS);
        table_ptr_entry_size    =
            SMEM_SIP7_EQ_H_ECMP_ENTRY_FIELD_GET(devObjPtr,ecmpMemPtr,ecmpIndex,
            SMEM_SIP7_EQ_H_ECMP_TABLE_FIELD_PRIMARY_TABLE_PTR_ENTRY_SIZE);
        member_id               =
            SMEM_SIP7_EQ_H_ECMP_ENTRY_FIELD_GET(devObjPtr,ecmpMemPtr,ecmpIndex,
    ...
    infoPtr->OUT_info.next_stage             = next_stage            ;
    infoPtr->OUT_info.next_stage_ptr         = next_stage_ptr        ;
    infoPtr->OUT_info.table_ptr_table_id     = table_ptr_table_id    ;
    infoPtr->OUT_info.table_ptr_base_address = table_ptr_base_address;
    infoPtr->OUT_info.table_ptr_entry_size   = table_ptr_entry_size  ;

    infoPtr->OUT_ha_info.ha_table_id         = infoPtr->IN_info.table_ptr_table_id;
    infoPtr->OUT_ha_info.ha_table_address    = infoPtr->IN_info.table_ptr_base_address +
        ((1<<infoPtr->IN_info.table_ptr_entry_size) * member_id);


    if(simLogIsOpenFlag)
    {
        __LOG_PARAM(infoPtr->OUT_info.next_stage);
        __LOG_PARAM(infoPtr->OUT_info.next_stage_ptr);
        __LOG_PARAM(infoPtr->OUT_info.table_ptr_table_id);
        __LOG_PARAM(infoPtr->OUT_info.table_ptr_base_address);
        __LOG_PARAM(infoPtr->OUT_info.table_ptr_entry_size);
        __LOG_PARAM(infoPtr->OUT_ha_info.ha_table_id);
        __LOG_PARAM(infoPtr->OUT_ha_info.ha_table_address);

        __LOG(("Ended H ECMP stage [%d] \n",
            current_stageId+1/*1,2,3*/));
    }
...
/**
* @internal eqSip7VPortMapping function
* @endinternal
*
* @brief   EQ - Sip7 vPort mapping
*
* @param[in] devObjPtr                - pointer to device object.
* @param[in] descrPtr                 - pointer to the frame's descriptor.
*
* @param[out] vPortMapInfoPtr         - pointer to the info from the vPort mapping table
*/
static GT_VOID eqSip7VPortMapping
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
...
{
    DECLARE_FUNC_NAME(eqSip7VPortMapping);

    GT_U32 *memPtr;    /* pointer to table in memory */
    GT_U32  index;     /* index   to table in memory */
    GT_U32  egress_Replicated;/* is this 'to_cpu'/'to_analyzer' replication from the egress pipe */
    GT_U32  profile;

    /* save for later use */
    descrPtr->eArchExtInfo.eqInfo.Is_Stacking_Port = 0;SIM_TBD_BOOKMARK/* no Cider for this yet */

    memset(vPortMapInfoPtr,0,sizeof(*vPortMapInfoPtr));

    egress_Replicated =
       ((descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_TO_TRG_SNIFFER_E && descrPtr->rxSniff==0) ||
        (descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_TO_CPU_E && descrPtr->srcTrg == 1)/*Trg*/) ? 1 :0;

    __LOG_PARAM(egress_Replicated);

    if(simLogIsOpenFlag)
    {
        if (egress_Replicated)
        {
            __LOG_PARAM(descrPtr->eArchExtInfo.srcTrgIsVPort);
            __LOG_PARAM(descrPtr->srcTrgDev);
            __LOG_PARAM(descrPtr->ownDev);
        }
        else
        {
            __LOG_PARAM(descrPtr->eArchExtInfo.eqInfo.Is_Stacking_Port);
            __LOG_PARAM(descrPtr->trgIsVPort);
            __LOG_PARAM(descrPtr->trgDev);
            __LOG_PARAM(descrPtr->ownDev);
            __LOG_PARAM(descrPtr->repMll);
        }
    }

    if (egress_Replicated &&
        descrPtr->eArchExtInfo.srcTrgIsVPort &&
        descrPtr->srcTrgDev == descrPtr->ownDev)
    {
        index = descrPtr->eArchExtInfo.srcTrgVPort;
    }
    else
    if ((!egress_Replicated) && descrPtr->trgIsVPort &&
        (descrPtr->eArchExtInfo.eqInfo.Is_Stacking_Port == 0 ||
         descrPtr->trgDev == descrPtr->ownDev ||
         descrPtr->repMll == GT_TRUE))
    {
        index = descrPtr->trgVPort;
    }
    else
    {
        __LOG(("Sip7 : not access the VPORT MAPPING table \n"));
        return;
    }

    memPtr = smemMemGet(devObjPtr, SMEM_SIP7_EQ_VPORT_MAPPING_TBL_MEM(devObjPtr,index));

    vPortMapInfoPtr->next_stage =
        SMEM_SIP7_EQ_VPORT_MAPPING_ENTRY_FIELD_GET(devObjPtr,memPtr,index,
        SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_NEXT_STAGE);
    vPortMapInfoPtr->next_stage_ptr =
        SMEM_SIP7_EQ_VPORT_MAPPING_ENTRY_FIELD_GET(devObjPtr,memPtr,index,
        SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_NEXT_STAGE_PTR);
    vPortMapInfoPtr->table_ptr_table_id =
        SMEM_SIP7_EQ_VPORT_MAPPING_ENTRY_FIELD_GET(devObjPtr,memPtr,index,
        SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_TABLE_PTR_TABLE_ID);
    vPortMapInfoPtr->table_ptr_base_address =
        SMEM_SIP7_EQ_VPORT_MAPPING_ENTRY_FIELD_GET(devObjPtr,memPtr,index,
        SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_TABLE_PTR_BASE_ADDRESS);
    vPortMapInfoPtr->table_ptr_entry_size =
        SMEM_SIP7_EQ_VPORT_MAPPING_ENTRY_FIELD_GET(devObjPtr,memPtr,index,
        SMEM_SIP7_EQ_VPORT_MAPPING_TABLE_FIELD_TABLE_PTR_ENTRY_SIZE);
    profile =
        SMEM_SIP7_EQ_VPORT_MAPPING_ENTRY_FIELD_GET(devObjPtr,memPtr,index,
    ...
    if (egress_Replicated)
    {
        descrPtr->eArchExtInfo.srcTrgEPort = profile;
        __LOG(("egress_Replicated : Assign vPort profile to descrPtr->eArchExtInfo.srcTrgEPort[%d] \n",
            descrPtr->eArchExtInfo.srcTrgEPort));
    }
    else
    {
        descrPtr->trgEPort    = profile;
        __LOG(("Assign vPort profile to descrPtr->trgEPort[%d] \n",
            descrPtr->trgEPort));
    }
...
/**
* @internal eqSip7HierarchicalEcmp function
* @endinternal
*
* @brief   EQ - Sip7 Hierarchical Ecmp sub-block processing
*          and calc : descrPtr->trgCircuit
*
* @param[in] devObjPtr                - pointer to device object.
* @param[in] descrPtr                 - pointer to the frame's descriptor.
* @param[in] vPortMapInfoPtr          - pointer to the info from the vPort mapping table
*/
static GT_VOID eqSip7HierarchicalEcmp
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
...
{
    DECLARE_FUNC_NAME(eqSip7HierarchicalEcmp);

    GT_U32  stage;/* stage 0..2 of the H ECMP */
    EQ_SIP7_H_ECMP_STAGE_INFO         stageInfo;
    EQ_SIP7_H_ECMP_STAGE_COMMON_INFO  stage_OUT_info   [H_ECMP_STAGE_3_E+1]; /* info per stage */
    EQ_SIP7_H_ECMP_STAGE_HA_INFO      stage_OUT_ha_info[H_ECMP_STAGE_3_E+1]; /* more info per stage */
    GT_BIT  isSkippedArr[H_ECMP_STAGE_3_E+1];/*was the stage skipped*/
    GT_BIT  IN_tunnelStart = descrPtr->tunnelStart;
    GT_BIT  IN_tunnelPtr   = descrPtr->tunnelPtr;


    memset(&stageInfo,0,sizeof(stageInfo));

    stageInfo.IN_info.next_stage             = vPortMapInfoPtr->next_stage            ;
    stageInfo.IN_info.next_stage_ptr         = vPortMapInfoPtr->next_stage_ptr        ;
    stageInfo.IN_info.table_ptr_table_id     = vPortMapInfoPtr->table_ptr_table_id    ;
    stageInfo.IN_info.table_ptr_base_address = vPortMapInfoPtr->table_ptr_base_address;
    stageInfo.IN_info.table_ptr_entry_size   = vPortMapInfoPtr->table_ptr_entry_size  ;

    for(stage = 0 ; stage <= H_ECMP_STAGE_3_E ; stage++)
    {
        eqSip7HierarchicalEcmpStage(devObjPtr,descrPtr,
            stage,
            &isSkippedArr[stage],
            &stageInfo);

        stage_OUT_info   [stage] = stageInfo.OUT_info;
        stage_OUT_ha_info[stage] = stageInfo.OUT_ha_info;

        memset(&stageInfo,0,sizeof(stageInfo));
        /* the 'OUT' of current stage , are the 'IN' to the next stage */
        stageInfo.IN_info = stage_OUT_info[stage];
    }

    for(stage = 0 ; stage <= H_ECMP_STAGE_3_E ; stage++)
    {
        if(isSkippedArr[stage])
        {
            __LOG(("NOTE : Stage %d was 'skipped' \n",
                stage+1));
        }

        switch(stage_OUT_ha_info[stage].ha_table_id)
        {
            case HA_TABLE_ID_HEADER_FIELDS_TABLE_1:
                descrPtr->hft0Triggered = 1;
                descrPtr->hft0Ptr = stage_OUT_ha_info[stage].ha_table_address;
                __LOG(("From Stage %d Assigned hft0Ptr[%d] \n",
                    stage+1,
                    descrPtr->hft0Ptr));
                break;
            case HA_TABLE_ID_HEADER_FIELDS_TABLE_2:
                descrPtr->hft1Triggered = 1;
                descrPtr->hft1Ptr = stage_OUT_ha_info[stage].ha_table_address;
                __LOG(("From Stage %d Assigned hft1Ptr[%d] \n",
                    stage+1,
                    descrPtr->hft1Ptr));
                break;
            case HA_TABLE_ID_TUNNEL_START_TABLE:
                descrPtr->tunnelStart = 1;
                descrPtr->tunnelPtr   = stage_OUT_ha_info[stage].ha_table_address;
                __LOG(("From Stage %d Assigned tunnelPtr[%d] \n",
                    stage+1,
                    descrPtr->tunnelPtr));
                break;
            default:
            case HA_TABLE_ID_NO_TABLE_USED:
                __LOG(("From Stage %d NOT Assigned hft0Ptr/hft1Ptr/tunnelPtr \n",
                    stage+1));
                break;
        }
    }

    switch(stage_OUT_info[H_ECMP_STAGE_3_E].table_ptr_table_id)
    {
        case HA_TABLE_ID_HEADER_FIELDS_TABLE_1:
            descrPtr->hft0Triggered = 1;
            descrPtr->hft0Ptr = stage_OUT_info[H_ECMP_STAGE_3_E].table_ptr_base_address;
            __LOG(("From Stage 3 'extra' : Assigned hft0Ptr[%d] \n",
                descrPtr->hft0Ptr));
            break;
        case HA_TABLE_ID_HEADER_FIELDS_TABLE_2:
            descrPtr->hft1Triggered = 1;
            descrPtr->hft1Ptr = stage_OUT_info[H_ECMP_STAGE_3_E].table_ptr_base_address;
            __LOG(("From Stage 3 'extra' : Assigned hft1Ptr[%d] \n",
                descrPtr->hft1Ptr));
            break;
        case HA_TABLE_ID_TUNNEL_START_TABLE:
            descrPtr->tunnelStart = 1;
            descrPtr->tunnelPtr   = stage_OUT_info[H_ECMP_STAGE_3_E].table_ptr_base_address;
            __LOG(("From Stage 3 'extra' : Assigned tunnelPtr[%d] \n",
                descrPtr->tunnelPtr));
            break;
        default:
        case HA_TABLE_ID_NO_TABLE_USED:
            __LOG(("From Stage 3  NOT Assigned 'extra' hft0Ptr/hft1Ptr/tunnelPtr \n"));
            break;
    }

    descrPtr->trgCircuit = stage_OUT_info[H_ECMP_STAGE_3_E].next_stage_ptr;

    __LOG(("From Stage 3 : Assigned trgCircuit[%d] (according to 'OUT_info.next_stage_ptr' of stage 3) \n",
        descrPtr->trgCircuit));


    if(simLogIsOpenFlag)
    {
        __LOG_PARAM(descrPtr->hft0Triggered);
        __LOG_PARAM(descrPtr->hft0Ptr);
        __LOG_PARAM(descrPtr->hft1Triggered);
        __LOG_PARAM(descrPtr->hft1Ptr);
        __LOG_PARAM(descrPtr->tunnelStart);
        __LOG_PARAM(descrPtr->tunnelPtr);
        __LOG_PARAM(descrPtr->trgCircuit);

        if(IN_tunnelStart == 0 && descrPtr->tunnelStart)
        {
            __LOG(("Got TunnelStart indication (descrPtr->tunnelStart=1) \n"));
        }
        else
        if(IN_tunnelStart && descrPtr->tunnelStart && IN_tunnelPtr != descrPtr->tunnelPtr)
        {
            __LOG(("The tunnelPtr changed from [%d] to [%d] \n",
                IN_tunnelPtr,
                descrPtr->tunnelPtr));
        }
    }
...
* @param[in] descrPtr                 - pointer to the frame's descriptor.
*
* @param[out] indexToE2PHYPtr         - pointer to the index to access the E2PHY
*/
static GT_VOID eqSip7E2PhyIndexGet
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
...
{
    DECLARE_FUNC_NAME(eqSip7E2PhyIndexGet);

    GT_U32  Circuits_base_address_in_E2PHY;
    GT_U32  Circuits_base_address_analyzer_in_E2PHY;

    descrPtr->eArchExtInfo.eqInfo.preE2phy_trgDev = descrPtr->trgDev;

    if(descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_TO_TRG_SNIFFER_E &&
       descrPtr->rxSniff == 0 && descrPtr->eArchExtInfo.srcTrgIsVPort &&
       descrPtr->trgDev == descrPtr->ownDev)
    {
        smemRegFldGet(devObjPtr,
            SMEM_SIP7_EQ_CIRCUITS_BASE_ADDRESS_IN_E2PHY_REG(devObjPtr),
            16, 16, &Circuits_base_address_analyzer_in_E2PHY);
        __LOG_PARAM(Circuits_base_address_analyzer_in_E2PHY);

        *indexToE2PHYPtr = Circuits_base_address_analyzer_in_E2PHY + descrPtr->analyzerIndex;
    }
    else
    if ((descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_FORWARD_E  ||
         descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_FROM_CPU_E ||
         (descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_TO_TRG_SNIFFER_E && descrPtr->rxSniff == 1)) &&
        descrPtr->trgIsVPort &&
        (descrPtr->eArchExtInfo.eqInfo.Is_Stacking_Port == 0 ||
         descrPtr->trgDev == descrPtr->ownDev ||
         descrPtr->repMll == GT_TRUE))
    {
        smemRegFldGet(devObjPtr,
            SMEM_SIP7_EQ_CIRCUITS_BASE_ADDRESS_IN_E2PHY_REG(devObjPtr),
            0, 16, &Circuits_base_address_in_E2PHY);

        __LOG_PARAM(Circuits_base_address_in_E2PHY);

        *indexToE2PHYPtr =  Circuits_base_address_in_E2PHY + descrPtr->trgCircuit;

        /* we need to continue logic after accessing the E2PHY */
        descrPtr->eArchExtInfo.eqInfo.needVPortE2PhyLogic_part2 = 1;
    }
}

/**
* @internal eqSip7E2Phy_part2 function
* @endinternal
*
* @brief   EQ - After E2Phy check if need to drop replications to other devices.
*
* @param[in] devObjPtr            - pointer to device object.
* @param[in] descrPtr             - pointer to the frame's descriptor.
*/
...
{
    DECLARE_FUNC_NAME(eqSip7E2Phy_part2);

    /* we not need the indication any more (was set by eqSip7E2PhyIndexGet(...))*/
    descrPtr->eArchExtInfo.eqInfo.needVPortE2PhyLogic_part2 = 0;

    if (descrPtr->repMll == GT_TRUE &&
        (descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_FORWARD_E ||
         descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_FROM_CPU_E) &&
         descrPtr->trgDev != descrPtr->ownDev)
    {
        GT_U32 mll_To_Other_device_CMD,mll_To_Other_device_CPU_CODE;

        smemRegFldGet(devObjPtr,
            SMEM_SIP7_EQ_MLL_TO_OTHER_DEVICE_REG(devObjPtr),
            0, 3, &mll_To_Other_device_CMD);
        smemRegFldGet(devObjPtr,
            SMEM_SIP7_EQ_MLL_TO_OTHER_DEVICE_REG(devObjPtr),
            3, 8, &mll_To_Other_device_CPU_CODE);

        __LOG(("Apply Replicated MLL to other device Command \n"));

        snetChtIngressCommandAndCpuCodeResolution(devObjPtr, descrPtr,
                                                  descrPtr->packetCmd,
                                                  mll_To_Other_device_CMD,
                                                  descrPtr->cpuCode,
                                                  mll_To_Other_device_CPU_CODE,
                                                  SNET_CHEETAH_ENGINE_UNIT_EQ_E,
                                                  GT_FALSE);
    }
    else
    if (descrPtr->eArchExtInfo.eqInfo.Is_Stacking_Port == 1 &&
        descrPtr->repMll == GT_FALSE &&
        descrPtr->trgDev != descrPtr->eArchExtInfo.eqInfo.preE2phy_trgDev)
    {
        GT_U32 Hierarchical_ECMP_out_of_sync_CMD,Hierarchical_ECMP_out_of_sync_CPU_CODE;

        __LOG_PARAM(descrPtr->trgDev);
        __LOG_PARAM(descrPtr->eArchExtInfo.eqInfo.preE2phy_trgDev);

        smemRegFldGet(devObjPtr,
            SMEM_SIP7_EQ_HIERARCHICAL_ECMP_OUT_OF_SYNC_REG(devObjPtr),
            0, 3, &Hierarchical_ECMP_out_of_sync_CMD);
        smemRegFldGet(devObjPtr,
            SMEM_SIP7_EQ_HIERARCHICAL_ECMP_OUT_OF_SYNC_REG(devObjPtr),
            3, 8, &Hierarchical_ECMP_out_of_sync_CPU_CODE);

        __LOG(("Apply Hierarchical ECMP out of sync Command (for stacking port) \n"));

        snetChtIngressCommandAndCpuCodeResolution(devObjPtr, descrPtr,
                                                  descrPtr->packetCmd,
                                                  Hierarchical_ECMP_out_of_sync_CMD,
                                                  descrPtr->cpuCode,
                                                  Hierarchical_ECMP_out_of_sync_CPU_CODE,
                                                  SNET_CHEETAH_ENGINE_UNIT_EQ_E,
                                                  GT_FALSE);
    }

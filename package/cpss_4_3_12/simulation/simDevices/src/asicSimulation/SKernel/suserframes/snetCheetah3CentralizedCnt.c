...
static SNET_CHT3_CNC_CLIENT_TRIG_FUN_MAC(snetCht3CncClientTmPassDropTrigger          );
...
static SNET_CHT3_CNC_CLIENT_TRIG_FUN gCncClientTrigFuncArr[SNET_CNC_CLIENT_LAST_E] =
{
    ...
    snetCht3CncClientTmPassDropTrigger,         /* SNET_CNC_CLIENT_TRAFFIC_MANAGER_PASS_DROP_E                    */
...
/* Trigger function array for sip_7 device for CNC blocks 0..3 array holds trigger function for cnc client */
static SIP6_10_CNC_CLIENT_IN_BLOCK gCncClientTrigFuncArrSip7[SNET_CNC_CLIENT_LAST_E] =
{
     SIP6_10_ENTRY_CNC_CLIENT_ALL( 0,snetXCatCncClientTunnelTerminatedTrigger)                 /* SNET_CNC_CLIENT_TTI_ACTION_0_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL( 1,snetXCatCncClientTunnelTerminatedTrigger)                 /* SNET_CNC_CLIENT_TTI_ACTION_1_E */
    ,SIP6_10_ENTRY_CNC_INVALID_CLIENT                                                          /* SNET_CNC_CLIENT_IPCL_LOOKUP_0_ACTION_0_E */
    ...
    ,SIP6_10_ENTRY_CNC_INVALID_CLIENT                                                          /* SNET_CNC_CLIENT_IPCL_LOOKUP_0_ACTION_2_E */
    ,SIP6_10_ENTRY_CNC_INVALID_CLIENT                                                          /* SNET_CNC_CLIENT_IPCL_LOOKUP_0_ACTION_3_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(7,snetCht3CncClientPclLookUpIngrTrigger)                    /* SNET_CNC_CLIENT_IPCL_LOOKUP_1_ACTION_0_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(8,snetCht3CncClientPclLookUpIngrTrigger)                    /* SNET_CNC_CLIENT_IPCL_LOOKUP_1_ACTION_1_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(9,snetCht3CncClientPclLookUpIngrTrigger)                    /* SNET_CNC_CLIENT_IPCL_LOOKUP_1_ACTION_2_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(10,snetCht3CncClientPclLookUpIngrTrigger)                    /* SNET_CNC_CLIENT_IPCL_LOOKUP_1_ACTION_3_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(11,snetCht3CncClientPclLookUpIngrTrigger)                    /* SNET_CNC_CLIENT_IPCL_LOOKUP_2_ACTION_0_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(12,snetCht3CncClientPclLookUpIngrTrigger)                    /* SNET_CNC_CLIENT_IPCL_LOOKUP_2_ACTION_1_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(13,snetCht3CncClientPclLookUpIngrTrigger)                    /* SNET_CNC_CLIENT_IPCL_LOOKUP_2_ACTION_2_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(14,snetCht3CncClientPclLookUpIngrTrigger)                    /* SNET_CNC_CLIENT_IPCL_LOOKUP_2_ACTION_3_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(24,snetCht3CncClientL2L3VlanIngrTrigger)                     /* SNET_CNC_CLIENT_INGRESS_VLAN_L2_L3_E     */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(23,snetCht3CncClientIpclSourceEPortTrigger)                  /* SNET_CNC_CLIENT_SOURCE_EPORT_E           */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(26,snetCht3CncClientVlanPassDropIngrTrigger)                 /* SNET_CNC_CLIENT_INGRESS_VLAN_PASS_DROP_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(25,snetLion3CncClientPreEgressPacketTypePassDropTrigger)     /* SNET_CNC_CLIENT_PACKET_TYPE_PASS_DROP_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(31,snetCht3CncClientVlanPassDropEgrTrigger)                  /* SNET_CNC_CLIENT_EGRESS_VLAN_PASS_DROP_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(32,snetCht3CncClientTxqQueuePassDropEgrTrigger)              /* SNET_CNC_CLIENT_EGRESS_QUEUE_PASS_DROP_AND_QCN_PASS_DROP_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(37,snetCht3CncClientArpTblTrigger)                           /* SNET_CNC_CLIENT_ARP_INDEX_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(35,snetCht3CncClientTunnelStartTrigger)                      /* SNET_CNC_CLIENT_TUNNEL_START_INDEX_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(36,snetCht3CncClientHaTargetEPortTrigger)                    /* SNET_CNC_CLIENT_TARGET_EPORT_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(19,snetCht3CncClientPclEgrTrigger)                           /* SNET_CNC_CLIENT_EPCL_ACTION_0_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(20,snetCht3CncClientPclEgrTrigger)                           /* SNET_CNC_CLIENT_EPCL_ACTION_1_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(21,snetCht3CncClientPclEgrTrigger)                           /* SNET_CNC_CLIENT_EPCL_ACTION_2_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(22,snetCht3CncClientPclEgrTrigger)                           /* SNET_CNC_CLIENT_EPCL_ACTION_3_E  */
    ,SIP6_10_ENTRY_CNC_INVALID_CLIENT                                                          /* SNET_CNC_CLIENT_TRAFFIC_MANAGER_PASS_DROP_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL( 2,snetXCatCncClientTunnelTerminatedTrigger)                 /* SNET_CNC_CLIENT_TTI_ACTION_2_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL( 3,snetXCatCncClientTunnelTerminatedTrigger)                 /* SNET_CNC_CLIENT_TTI_ACTION_3_E */
    ,SIP6_10_ENTRY_CNC_INVALID_CLIENT                                                          /* SNET_CNC_PIPE_DEVICE_CLIENT_PCP_DEST_INDEX_E        */
    ,SIP6_10_ENTRY_CNC_INVALID_CLIENT                                                          /* SNET_CNC_PIPE_DEVICE_CLIENT_PPA_TRG_PORT_PKT_TYPE_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(28,snetCht3CncClientEgfPassDropTrigger)                      /* SNET_SIP6_CNC_CLIENT_EGF_EVLAN_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(29,snetSip6CncClientPreqQueueStatisticTrigger)               /* SNET_SIP6_CNC_CLIENT_PREQ_QUEUE_STATISTICS_E */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(30,snetSip6CncClientPreqPortStatisticTrigger)                /* SNET_SIP6_CNC_CLIENT_PREQ_PORT_STATISTICS_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(41,snetCht3CncClientErepPacketTypePassDropTrigger)           /* SNET_SIP6_CNC_CLIENT_EREP_PACKET_TYPE_PASS_DROP_E  */
    ,SIP6_10_ENTRY_CNC_CLIENT_ALL(40,snetSip6_10_cncClientPhaTrigger)                          /* SNET_SIP6_10_CNC_CLIENT_PHA_E                      */
};
...
)
{
    ...
    cncBlockToClientInfoPtr = SMEM_CHT_IS_SIP7_GET(devObjPtr)    ?  &gCncClientTrigFuncArrSip7   [clientUnified] :
                              SMEM_CHT_IS_SIP6_30_GET(devObjPtr) ?  &gCncClientTrigFuncArrSip6_30[clientUnified] :
...
)
{
    ...
    if (status == GT_OK)
    {
        /* check wraparound after byte count update in case that wraparound was not detected yet. */
...
)
{
    ...
    if (descrPtr->cutThroughModeEnabled
        ...
        && descrPtr->sip6_isCtByteCount /* byteCount not callculated by RX and by TTI*/)
    {
        egressByteCount = 0;
        __LOG(("CNC : Cut Through terminated - byteCount not callculated by TTI \n"));
    }
    else if (descrPtr->egressByteCount)
    {
       ...
       forceIngressByteCountLogic == GT_TRUE)
    {
        ...
        else
        {
            ...
            if(clientInfoPtr->byteCntMode == SMEM_CHT3_CNC_BYTE_CNT_L3_MODE_E)
            {
                byteCount -= descrPtr->tunnelTerminationOffset;
                __LOG(("CNC : L3 byte count mode. TT (tunnel terminated) packet uses passenger L3 packet \n"));
            }
    ...
    switch (clientInfoPtr->byteCntMode)
    {
        case SMEM_CHT3_CNC_BYTE_CNT_L2_MODE_E:
            ...
            /** All devices receive frames without CRC from CPU,
             *  For SIP6_30 devices (align with BM behavior), don't expect 4B of CRC for FROM_CPU packets */
            if(!SMEM_IS_PIPE_FAMILY_GET(devObjPtr) && descrPtr->isFromSdma && !SMEM_CHT_IS_SIP6_30_GET(devObjPtr))
            {
                cncFinalSizeToCount += 4; /* include CRC */
                __LOG(("Frame received from SDMA doesn't include CRC, therefore add 4B of CRC in the final byte count of L2 counting mode \n"));
            }

            if (egressByteCount != 0)
            {
                /* include HA zero padding */
                cncFinalSizeToCount = descrPtr->egressByteCount;
            }
    ...
    if (cncFinalSizeToCount > 0x3FFF)
    {
        cncFinalSizeToCount = 0x3FFF;
        __LOG(("CNC : Ended calculate the byte count Truncated to [%d] \n",
            cncFinalSizeToCount));
    }
...
* @retval GT_OUT_OF_RANGE          - (Applicable for sip6.30 devices) client index exceeds block limit
*/
...
)
{
    ...
    GT_U32 packetByteCount;         /* packet byte count - according to all count modes */
    SNET_CHT3_CNC_COUNTER_STC cncCounter;
                                    /* CNC counter value */
    CNC_COUNTER_FORMAT_ENT cncFormat;
                                    /* CNC counter format */
    ...
    packetByteCount = cncByteCountGet(devObjPtr,descrPtr,clientInfoPtr);
    ...
    nullBytesAdd = GT_FALSE;
    if (SMEM_CHT_IS_SIP5_20_GET(devObjPtr))
    {
        GT_U32 byteCountMaskEnable;
        GT_U32 byteCountMask;

        smemRegFldGet(devObjPtr, SMEM_CHT3_CNC_GLB_CONF_REG(devObjPtr,cncUnitIndex), 25, 1, &byteCountMaskEnable);
        smemRegFldGet(devObjPtr, SMEM_CHT3_CNC_GLB_CONF_REG(devObjPtr,cncUnitIndex), 21, 4, &byteCountMask);

        if (byteCountMaskEnable &&
            ((size >> 10) & byteCountMask) == (0x0F & byteCountMask))
        {
            nullBytesAdd = GT_TRUE;
        }
    }

    if (nullBytesAdd != GT_FALSE)
    {
        size = 0;
        __LOG(("CT packet with not calculated size, CNC Byte Count set to 0 \n"));
    }
    ...
    for (block = 0; block < (GT_U32)CNC_CNT_BLOCKS(devObjPtr); block++)
    {
        ...
        if(SMEM_CHT_IS_SIP6_30_GET(devObjPtr))
        {
            ...
            clientIndex = (clientInfoPtr->index % devObjPtr->cncBlockMaxRangeIndex) + clientInfoPtr->fewClientsPerBlock.clientOffsetInBlock[block];

            /* If the resulting clientIndex exceeds block limit,
             * it should not update respective counter
             */
            if(clientIndex >= devObjPtr->cncBlockMaxRangeIndex)
            {
                __LOG(("Client index [%d] exceeds block limit [%d] \n",
                clientIndex, devObjPtr->cncBlockMaxRangeIndex));

                /* Assert Interrupt - Exceed block size */
                snetChetahDoInterrupt(devObjPtr,
                                      SMEM_CHT_CNC_BLOCK_CLIENT_INTR_CAUSE_REG(block, clientInfoPtr->fewClientsPerBlock.clientInstance),
                                      SMEM_CHT_CNC_BLOCK_CLIENT_INTR_MASK_REG(block, clientInfoPtr->fewClientsPerBlock.clientInstance),
                                      SMEM_CHT_CNC_BLOCK_LIMIT_EXCEED_INT,
...
)
{
    ...
    {
        cncClientTriggerFunc = gCncClientTrigFuncArrSip7[clientInfoPtr->client].cncClientTriggerFunc;
    }
    else
    if(SMEM_CHT_IS_SIP6_30_GET(devObjPtr))
    {
...
)
{
    ...
    GT_U32  tileId,pipeId,localPipeId;/* the PipeId */
    GT_U32  globalMgUnit=0;/* the serving MG unit for the upload */
    GT_U32 clearByRead;             /* enable setting of a configurable value
                                       to the Counters after read by the CPU */
    GT_U32  *clearByReadValuePtr;/* pointer to 2 words memory of clear by read */
    GT_U32  ii;
    GT_U32  cncUploadInfo_index = 0;
    ...
    if(!SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        ...
        cncUploadInfo_index = globalMgUnit;
    }
    else
    {
        pipeId = smemGetCurrentPipeId(devObjPtr);
        tileId = (pipeId / devObjPtr->numOfPipesPerTile);
        cncUploadInfo_index = tileId * SIM_MAX_GDMA_UNITS_CNS + cncUnitIndex;
    }


    entry = devObjPtr->cncUploadInfo[cncUploadInfo_index].indexInCnc;
    ...
    else
    {
        ...
        {
            /* DMA message size is 4 words. Iterate memory space with step of 4 words */
            __LOG(("tileId[%d] : CNC unit [%d] Send CNC messages to GDMA - start \n",
                tileId,cncUnitIndex));
        }
        else
        {
            /* DMA message size is 4 words. Iterate memory space with step of 4 words */
            __LOG(("tileId[%d] : CNC unit [%d] Send CNC messages to GDMA - continue from entry [%d] \n",
                tileId,cncUnitIndex,entry));
        }
    }
    ...
    for (/**/; entry < devObjPtr->cncBlockMaxRangeIndex / numOfCncInFu; entry++, entryPtr+= CNC_BLOCK_ENTRY_WORDS_CNS * numOfCncInFu)
    {
                                                 ...
                                                 &doInterrupt,cncUnitIndex))
        {
            ...
            else
            {
                ...
                devObjPtr->cncUploadInfo[cncUploadInfo_index].indexInCnc = entry;
                ...
                {
                    __LOG(("tileId[%d] : CNC unit [%d] Send CNC messages to GDMA - was broken at entry [%d] (will be continued...) \n",
                        tileId,cncUnitIndex,entry));
                }
    ...
    devObjPtr->cncUploadInfo[cncUploadInfo_index].indexInCnc = 0;
    ...
    {
        __LOG(("tileId[%d] : CNC unit [%d] Send CNC messages to GDMA - ended \n",
            tileId,cncUnitIndex));
    }
...
)
{
    ...
    if(devObjPtr->supportGdma && devObjPtr->supportGdma_CNC)/*sip7*/
    {
        GT_U32  gdma_queue_num;
        GT_BOOL needRetry;

        smemRegFldGet(devObjPtr, SMEM_CHT3_CNC_GLB_CONF_REG(devObjPtr,cncUnitIndex), 26, 5, &gdma_queue_num);

        snetSip7GdmaSendMsgToCpu(devObjPtr,SNET_SIP7_GDMA_MSG_CLIENT_CNC_E,
            gdma_queue_num,/*ringId*/
            cncDumpPtr,
            (2 * CNC_BLOCK_ENTRY_WORDS_CNS)/*always 2 CNC counters*/,
            &needRetry);
    ...
    for (block = 0; block < numBlocks; block++)
    {
        ...
        if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
        {
            if(SMEM_CHT_IS_SIP6_30_GET(devObjPtr))
            {
                ...
                if(clientHwBit != SMEM_U32_GET_FIELD(regPtr[0], 4, SMEM_CHT_IS_SIP7_GET(devObjPtr) ? 6 : 5))
                {
                    continue;
                }

                clientInfoPtr->fewClientsPerBlock.clientOffsetInBlock[block] =
                    SMEM_U32_GET_FIELD(regPtr[0], 16, SMEM_CHT_IS_SIP7_GET(devObjPtr) ? 13 : 10);
...
)
{
    ...
    GT_U32 dropBit = 0, outPorts, *regPtr;
    ...
    /* Set PASS/DROP bit of counter index */
    dropBit = (outPorts) ? 0 : 1;
...
/**
* @internal snetCht3CncClientTmPassDropTrigger function
* @endinternal
*
* @brief   CNC TM Pass Drop client
*
* @param[in] devObjPtr                - pointer to device object.
* @param[in] descrPtr                 - pointer to the frame's descriptor.
* @param[in] clientInfoPtr            - pointer to CNC client info.
...
* @retval GT_FAIL                  - fail in client triggering
*/
static GT_STATUS snetCht3CncClientTmPassDropTrigger
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
    IN SKERNEL_FRAME_CHEETAH_DESCR_STC * descrPtr,
    IN SNET_CHT3_CNC_CLIENT_INFO_STC * clientInfoPtr
)
{
    GT_U32  regAddr;
    GT_U32  *memPtr;
    GT_U32   mode, drop, dp, queue_id, cnc_index;
    /*
        pass: 0
        drop: 1
        0 = MODE0: {1'b0,queue_id[13:0],pass/drop}
        1 = MODE1: {queue_id[13:0],DP[0],pass/drop}
        2 = MODE2: {queue_id[12:0],DP[1:0],pass/drop}
        3 = MODE3: {queue_id[13:0],DP[1],pass/drop}
    */
    drop     = clientInfoPtr->userDefined ? 1 : 0;
    queue_id = descrPtr->tmQueueId;
    dp       = descrPtr->dp;
    regAddr = SMEM_BOBCAT2_TM_DROP_GLOBAL_CFG_REG(devObjPtr);
    memPtr = smemMemGet(devObjPtr,regAddr);
    mode = (*memPtr) & 0x3;
    switch (mode)
    {
        case 0: cnc_index = drop | ((queue_id & 0x3FFF) << 1); break;
        case 1: cnc_index = drop | ((dp & 1) << 1) | ((queue_id & 0x3FFF) << 2); break;
        case 2: cnc_index = drop | ((dp & 3) << 1) | ((queue_id & 0x1FFF) << 3); break;
        case 3: cnc_index = drop | ((dp & 2) << 0) | ((queue_id & 0x3FFF) << 2); break;
    }
    clientInfoPtr->index = cnc_index;
    clientInfoPtr->byteCntMode = 0; /*L2*/
...
)
{
    ...
    if((descrPtr->isNat) || (descrPtr->isL2Nat))
    {
        ...
        smemRegFldGet(devObjPtr, SMEM_BOBCAT2_HA_NAT_CONFIGURATIONS_REG(devObjPtr), 0, numOfBits,
                      &fldValue);
...
)
{
    ...
    GT_U32 * regPtr,offset;

    if (SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        regPtr = smemMemGet(devObjPtr, SMEM_SIP7_TTI_LU_UNIT_GENERAL_GLOBAL_CONFIG_REG(devObjPtr));
        offset = 25;
    }
    else
    {
    ...
    if (SMEM_U32_GET_FIELD(*regPtr, offset, 1) == 0)
    {
...
{
    DECLARE_FUNC_NAME(snetCht3CncBlockWrapStatusSet);
    ...
    __LOG(("Update CNC wraparound status: Unit[%d] , Block[%d] , Index [%d] in the block\n",
        cncUnitIndex, block , index));

    if(SMEM_CHT_IS_SIP6_10_GET(devObjPtr) && !SMEM_CHT_IS_SIP6_30_GET(devObjPtr))
    {
        /* AC5P/X and Harrier use FIFO to store status */
        regPtr = SMEM_SIP_6_10_CNC_WRAP_FIFO_MEM_GET(devObjPtr,cncUnitIndex, block);

        /* place data to end of FIFO */
        for (entry = 0; entry < CNC_WRAP_FIFO_REGS_NUM_CNS; entry++)
        {
            ...
            SMEM_U32_SET_FIELD(regPtr[entry], 1, 10, index);
            SMEM_U32_SET_FIELD(regPtr[entry], 0, 1, 1);
            status = GT_OK;
            __LOG(("CNC wraparound status FIFO entry[%d]\n",entry));
            break;
        }
    }
    else
    {
        ...
        for (entry = 0; entry < 4; entry++)
        {
            ...
            if (fldValue == 0)
            {
                ...
                SMEM_U32_SET_FIELD(regPtr[entry],0,1,1);
                status = GT_OK;
                __LOG(("CNC wraparound status entry[%d] bits 0..12\n",entry));
                break;
            }
            ...
            if (fldValue == 0)
            {
                ...
                status = GT_OK;
                __LOG(("CNC wraparound status entry[%d] bits 16..28\n",entry));
                break;
            }
        }
    }
...
* @param[in] format                   - CNC counter HW format,
*                                      relevant only for Lion and above
* @param[inout] cncCounterPtr         - (pointer to) CNC Counter in SW format
* @param[in]do64BitsByteWrapAround    -  GT_TRUE - check wraparound for PKT_0_BC_64 format
*                                        GT_FALSE - do not check wraparound for PKT_0_BC_64 format
*
* @retval GT_OK                    - on success
...
(
    IN    GT_U32 wrapEn,
    IN    CNC_COUNTER_FORMAT_ENT         format,
    INOUT SNET_CHT3_CNC_COUNTER_STC     *cncCounterPtr,
    IN    GT_BIT                         do64BitsByteWrapAround
)
{
...
)
{
    ...
    GT_BIT  cncIndexMode; /* for sip_6_30 to denote CNC index mode to derive client index */
    ...
    cpuCodeValid |= (descrPtr->outGoingMtagCmd == SKERNEL_MTAG_CMD_TO_CPU_E &&
    ...
    cncIndexMode = SMEM_CHT_IS_SIP6_30_GET(devObjPtr) ? SMEM_U32_GET_FIELD(*regPtr, 8, 1) : 0;
    /*If CNC index mode is 0x1, mask the packetCmd portion of the index [10:8] */
    clientInfoPtr->index = (cncIndexMode == 0x1) ? clientInfoPtr->index & 0xff : clientInfoPtr->index;

     __LOG_PARAM(cncIndexMode);
     __LOG_PARAM(clientInfoPtr->index);

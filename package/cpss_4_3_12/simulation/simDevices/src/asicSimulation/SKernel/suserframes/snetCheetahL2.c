...
#define IS_FDB_MEMORY_EXISTS(dev) \
    (!(dev->sharedTablesInfo.isFdbShared && \
     (!dev->fdbNoDirectMemory) &&           \
     (0 == dev->tablesInfo.fdbTable.paramInfo[0].outOfRangeIndex)))
...
SNET_ENTRY_FORMAT_TABLE_STC sip7L2iEPortTableFieldsFormat[SMEM_LION3_L2I_EPORT_TABLE_FIELDS___LAST_VALUE___E] =
{
/*   SMEM_LION3_L2I_EPORT_TABLE_FIELDS_NA_MSG_TO_CPU_EN                         */
     STANDARD_FIELD_MAC(1)
/*   SMEM_LION3_L2I_EPORT_TABLE_FIELDS_AUTO_LEARN_DIS                           */
...
/*   SMEM_LION3_L2I_EPORT_TABLE_FIELDS_PORT_VLAN_IS_TRUNK                       */
    ,STANDARD_FIELD_MAC(1)
/*   SMEM_LION3_L2I_EPORT_TABLE_FIELDS_PORT_PVLAN_TRG_EPORT_TRUNK_NUM           */
    ,STANDARD_FIELD_MAC(15)/* was 14 in sip5.20 */
/*   SMEM_LION3_L2I_EPORT_TABLE_FIELDS_PORT_PVLAN_TRG_DEV                       */
    ,STANDARD_FIELD_MAC(10)
/*   SMEM_LION3_L2I_EPORT_TABLE_FIELDS_ALL_PKT_TO_PVLAN_UPLINK_EN               */
    ,STANDARD_FIELD_MAC(1)
...
/*   SMEM_LION3_L2I_EPORT_TABLE_FIELDS_MOVED_MAC_SA_CMD                         */
    ,STANDARD_FIELD_MAC(3)
/*   SMEM_SIP7_EPORT_TABLE_FIELDS_ENABLE_TRAP_MIRROR_ARP_BC_WITH_MY_IP_E        */
    ,EXPLICIT_FIELD_MAC(74, 1)
/*   SMEM_SIP7_EPORT_TABLE_FIELDS_ENABLE_EPORT_GRATUITOUS_ARP_REPLY_BC_TO_CPU_E */
    ,EXPLICIT_FIELD_MAC(82, 1)
};
...
#define SMEM_BOBCAT2_B0_L2I_INGRESS_VLAN_TABLE_FIELDS_NAME                               \
    ...
    ,STR(SMEM_SIP7_L2I_INGRESS_VLAN_TABLE_FIELDS_ENABLE_TRAP_MIRROR_ARP_BC_WITH_MY_IP   )\
    ,STR(SMEM_SIP7_L2I_INGRESS_VLAN_TABLE_FIELDS_GRATUITOUS_ARP_REPLY_BC_TO_CPU_EN      )
    ...
    SMEM_LION3_L2I_INGRESS_VLAN_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    STANDARD_FIELD_MAC(1),
    /*SMEM_SIP7_L2I_INGRESS_VLAN_TABLE_FIELDS_ENABLE_TRAP_MIRROR_ARP_BC_WITH_MY_IP*/
    STANDARD_FIELD_MAC(0),
    /*SMEM_SIP7_L2I_INGRESS_VLAN_TABLE_FIELDS_GRATUITOUS_ARP_REPLY_BC_TO_CPU_EN*/
    STANDARD_FIELD_MAC(0)
...
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_FID_15                        )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_USE_VPORT                     )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_VPORT_0_13                    )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_VPORT_14_17                   )   \
                                                                         \
...
,STR(SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_ORIG_VID1_0          )   \
                                                                         \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_USE_VPORT            )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_VPORT_0_13           )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_VPORT_14_17          )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_USE_VPORT        )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_VPORT_0_13       )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_VPORT_14_17      )   \
                                                                         \
...
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_VIDX_16                       )   \
                                                                         \
...
,STR(SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_POINTER_TYPE         )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_NEXT_HOP_EVLAN_15    )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_USE_VPORT            )   \
,STR(SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_VPORT                )   \
                                                                         \
...
,STANDARD_FIELD_MAC(1)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_FID_15*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_USE_VPORT*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_VPORT_0_13*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_VPORT_14_17*/
,STANDARD_FIELD_MAC(0)
...
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_USE_VPORT*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_VPORT_0_13*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_VPORT_14_17*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_USE_VPORT*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_VPORT_0_13*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_VPORT_14_17*/
,STANDARD_FIELD_MAC(0)
...
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_VIDX_16*/
,STANDARD_FIELD_MAC(0)
...
,STANDARD_FIELD_MAC(1)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_POINTER_TYPE*/
,EXPLICIT_FIELD_MAC(164,1)/*muxed with TS_IS_NAT*/
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_NEXT_HOP_EVLAN_15*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_USE_VPORT*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_VPORT*/
,STANDARD_FIELD_MAC(0)
...
#define SMEM_SIP6_FDB_FDB_TABLE_FIELDS_NAME                  \
    ...
    ,STR(SMEM_SIP7_FDB_FDB_TABLE_FIELDS_TRG_VPORT_0_13       )\
    ,STR(SMEM_SIP7_FDB_FDB_TABLE_FIELDS_TRG_VPORT_14_17      )\
    ,STR(SMEM_SIP7_FDB_FDB_TABLE_FIELDS_USE_VPORT            )\
    ,STR(SMEM_SIP7_FDB_FDB_TABLE_FIELDS_FID_15               )\
    ,STR(SMEM_SIP7_FDB_FDB_TABLE_FIELDS_VIDX_16              )\
                                                              \
                                                              \
    ...
    ,STR(SMEM_SIP6_30_FDB_FDB_TABLE_FIELDS_UC_ROUTE_EPG_STREAM_ID                   )\
    ,STR(SMEM_SIP7_FDB_FDB_TABLE_FIELDS_UC_ROUTE_NEXT_HOP_EVLAN_15                  )\
    ,STR(SMEM_SIP7_FDB_FDB_TABLE_FIELDS_UC_ROUTE_USE_VPORT                          )\
    ,STR(SMEM_SIP7_FDB_FDB_TABLE_FIELDS_UC_ROUTE_TRG_VPORT                          )\
                                                                                     \
...
static SNET_ENTRY_FORMAT_TABLE_STC sip6FdbFdbTableFieldsFormat[SMEM_SIP6_FDB_FDB_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    ,STANDARD_FIELD_MAC(12)
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_TRG_VPORT_0_13*/
    ,STANDARD_FIELD_MAC(0)
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_TRG_VPORT_14_17*/
    ,STANDARD_FIELD_MAC(0)
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_USE_VPORT*/
    ,STANDARD_FIELD_MAC(0)
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_FID_15*/
    ,STANDARD_FIELD_MAC(0)
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_VIDX_16*/
    ,STANDARD_FIELD_MAC(0)
    ...
    ,STANDARD_FIELD_MAC(1)
    /*SMEM_SIP6_30_FDB_FDB_TABLE_FIELDS_UC_ROUTE_EPG_STREAM_ID*/
    ,STANDARD_FIELD_MAC(12)
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_UC_ROUTE_NEXT_HOP_EVLAN_15*/
    ,STANDARD_FIELD_MAC(0)
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_UC_ROUTE_USE_VPORT*/
    ,STANDARD_FIELD_MAC(0)
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_UC_ROUTE_TRG_VPORT*/
    ,STANDARD_FIELD_MAC(0)
...
static SNET_ENTRY_FORMAT_TABLE_STC sip7FdbFdbTableFieldsFormat[SMEM_SIP6_FDB_FDB_TABLE_FIELDS___LAST_VALUE___E] =
{
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_VALID*/
    STANDARD_FIELD_MAC(1)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_SKIP*/
    ,STANDARD_FIELD_MAC(1)  /* used only for 'XOR mode' , otherwise used as 'FID[15]' see : SMEM_SIP7_FDB_FDB_TABLE_FIELDS_FID_15 */
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_AGE*/
    ,STANDARD_FIELD_MAC(1)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_FDB_ENTRY_TYPE*/
    ,STANDARD_FIELD_MAC(3)
    ...
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_ORIG_VID1_11_7*/
    ,EXPLICIT_FIELD_MAC(80,5)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_ORIG_VID1_6_1*/
    ,EXPLICIT_FIELD_MAC(102,6)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_ORIG_VID1_0*/
    ,EXPLICIT_FIELD_MAC(109,1)

    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_SOURCE_ID_11_7*/
    ,EXPLICIT_FIELD_MAC(80,5)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_SOURCE_ID_6_3*/
    ,EXPLICIT_FIELD_MAC(102,4)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_SOURCE_ID_2_1*/
    ,EXPLICIT_FIELD_MAC(106,2)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_SOURCE_ID_0*/
    ,EXPLICIT_FIELD_MAC(109,1)

    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_USER_DEFINED_10_7*/
    ,EXPLICIT_FIELD_MAC(81,4)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_USER_DEFINED_0*/
    ,EXPLICIT_FIELD_MAC(101,1)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_USER_DEFINED_4_1*/
    ,EXPLICIT_FIELD_MAC(102,4)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_USER_DEFINED_6_5*/
    ,EXPLICIT_FIELD_MAC(106,2)
    ...
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_VIDX*/
    ,EXPLICIT_FIELD_MAC(85,16)

    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_IS_TRUNK*/
    ,EXPLICIT_FIELD_MAC(85,1)
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_TRUNK_NUM*/
        ,{FIELD_SET_IN_RUNTIME_CNS,
         12,
         SMEM_SIP6_FDB_FDB_TABLE_FIELDS_IS_TRUNK}
    ...
    ,STANDARD_FIELD_MAC(12)
        ...
        ,{FIELD_SET_IN_RUNTIME_CNS,
         ...
         SMEM_SIP7_FDB_FDB_TABLE_FIELDS_TRG_VPORT_0_13}
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_FID_15*/
    ,EXPLICIT_FIELD_MAC(1,1)/*muxed with 'skip' bit */
    /*SMEM_SIP7_FDB_FDB_TABLE_FIELDS_VIDX_16*/
    ,EXPLICIT_FIELD_MAC(129,1)
    ...
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_UC_ROUTE_TRG_IS_TRUNK*/
        ,{FIELD_SET_IN_RUNTIME_CNS,
         ...
         SMEM_SIP6_FDB_FDB_TABLE_FIELDS_UC_ROUTE_USE_VIDX}
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_UC_ROUTE_TRG_EPORT*/
        ,EXPLICIT_FIELD_MAC(61,14)/*after trg_vport*/
    /*SMEM_SIP6_FDB_FDB_TABLE_FIELDS_UC_ROUTE_TRG_TRUNK_ID*/
        ,{FIELD_SET_IN_RUNTIME_CNS,
         12,
         SMEM_SIP6_FDB_FDB_TABLE_FIELDS_UC_ROUTE_TRG_IS_TRUNK}
...
static SNET_ENTRY_FORMAT_TABLE_STC sip7L2iIngressVlanTableFieldsFormat[
    SMEM_LION3_L2I_INGRESS_VLAN_TABLE_FIELDS___LAST_VALUE___E] =
{
    /*SMEM_LION3_L2I_INGRESS_VLAN_TABLE_FIELDS_VALID */
    STANDARD_FIELD_MAC(1),
...
static SNET_ENTRY_FORMAT_TABLE_STC sip7FdbAuMsgTableFieldsFormat[SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS___LAST_VALUE___E] =
{
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_MESSAGE_ID                               */
STANDARD_FIELD_MAC(0)
...
,STANDARD_FIELD_MAC(10)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_RESERVED*/
,STANDARD_FIELD_MAC(0)/* this bit fix JIRA : MT-358 : in the MC-IP update message : Bit 77 is part of 2 fields (non-muxed fields) : fid and sip[26:0]*/
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_FID*/
,EXPLICIT_FIELD_MAC(78,15)

/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_IS_TRUNK                             */
,EXPLICIT_FIELD_MAC(98,1)
    /*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_EPORT_NUM                        */
    ,{FIELD_SET_IN_RUNTIME_CNS,
     14,
     SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_IS_TRUNK}
...
/*,SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_USER_DEFINED_10_7*/
,EXPLICIT_FIELD_MAC(94,4)
/*,SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_USER_DEFINED_0*/
,EXPLICIT_FIELD_MAC(114,1)
/*,SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_USER_DEFINED_4_1*/
,STANDARD_FIELD_MAC(4)
/*,SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_USER_DEFINED_6_5*/
,STANDARD_FIELD_MAC(2)
...
/*,SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_SOURCE_ID_11_7*/
,EXPLICIT_FIELD_MAC(93,5)
/*,SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_SOURCE_ID_6_3*/
,EXPLICIT_FIELD_MAC(115,4)
/*,SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_SOURCE_ID_2_1*/
,STANDARD_FIELD_MAC(2)
/*,SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_SOURCE_ID_0*/
,STANDARD_FIELD_MAC(1)
...
,STANDARD_FIELD_MAC(1)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_FID_15*/
,EXPLICIT_FIELD_MAC(8,1)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_USE_VPORT*/
,EXPLICIT_FIELD_MAC(77,1)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_VPORT_0_13*/
,EXPLICIT_FIELD_MAC(99,14)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_VPORT_14_17*/
,EXPLICIT_FIELD_MAC(184,4)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_IS_MOVED*/
,STANDARD_FIELD_MAC(0)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_IS_TRUNK                    */
,EXPLICIT_FIELD_MAC(137,1)
/*    SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_EPORT                   */
    ,{FIELD_SET_IN_RUNTIME_CNS,
     14,
     SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_IS_TRUNK}
...
,EXPLICIT_FIELD_MAC(77,1)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_VPORT_0_13*/
,EXPLICIT_FIELD_MAC(100,14)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_VPORT_14_17*/
,EXPLICIT_FIELD_MAC(184,4)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_USE_VPORT*/
,EXPLICIT_FIELD_MAC(113,1)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_VPORT_0_13*/
,EXPLICIT_FIELD_MAC(138,14)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_VPORT_14_17*/
,EXPLICIT_FIELD_MAC(188,4)
...
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_VIDX*/
,EXPLICIT_FIELD_MAC(98, 16)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_MAC_ADDR_INDEX_8_0*/
,EXPLICIT_FIELD_MAC(10, 9)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_MAC_ADDR_INDEX_20_9*/
,EXPLICIT_FIELD_MAC(122, 12)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_ENTRY_FOUND*/
,EXPLICIT_FIELD_MAC(16, 1)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_DIP*/
,EXPLICIT_FIELD_MAC(19, 32)
...
,EXPLICIT_FIELD_MAC(147, 1)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_SA_ACCESS_LEVEL*/
,EXPLICIT_FIELD_MAC(17, 1)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_DA_ACCESS_LEVEL*/
,STANDARD_FIELD_MAC(1)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_SEARCH_TYPE*/
,EXPLICIT_FIELD_MAC(136, 1)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_MULTIPLE*/
,EXPLICIT_FIELD_MAC(147, 1)
/*,SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_DA_ROUTE*/
,STANDARD_FIELD_MAC(1)
...
,EXPLICIT_FIELD_MAC(159, 1)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_FDB_LOOKUP_KEY_MODE*/
,EXPLICIT_FIELD_MAC(162, 1)
/*SMEM_SIP6_30_FDB_AU_MSG_TABLE_FIELDS_MAC_MC_IP_EPG_STREAM_ID*/
,EXPLICIT_FIELD_MAC(163,12)
/*SMEM_SIP6_30_FDB_AU_MSG_TABLE_FIELDS_UC_EPG_STREAM_ID*/
,EXPLICIT_FIELD_MAC(179,12)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_VIDX_16*/
,EXPLICIT_FIELD_MAC(150, 1)
...
,STANDARD_FIELD_MAC(1)
/*SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_POINTER_TYPE*/
,EXPLICIT_FIELD_MAC(151,1)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_NEXT_HOP_EVLAN_15*/
,EXPLICIT_FIELD_MAC(93,1)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_USE_VPORT*/
,EXPLICIT_FIELD_MAC(106,1)
/*SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_UC_ROUTE_VPORT*/
,EXPLICIT_FIELD_MAC(109,18)
...
static GT_BOOL snetChtL2iFdbLookup(
    ...
    OUT GT_U32 out_calculatedHashArr[/*FDB_MAX_BANKS_CNS*/] /* ignored if NULL , needed for sip7 NA for SA learn */
);
...
)
{
    ...
    GT_BIT bypassFdbLookup;/* sip6 bypass FDB lookups for low latency */
    ...
    */
    ...
    if (SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        ...
        bypassFdbLookup = SMEM_U32_GET_FIELD(brgGlobCntrlReg0Data, 27, 1);
        __LOG(("================= bypassFdbLookup[%d] =================== \n", bypassFdbLookup));
    }
    ...
    if(GT_FALSE == snetChtL2iTriggerCheck(devObjPtr,descrPtr))
    {
        if(descrPtr->packetCmd == SKERNEL_EXT_PKT_CMD_FROM_CPU_E)
        {
            ...
            {
                /* the from_cpu NOT have dedicated field in the DSA for this field */
                /* so treat it like non-from-cpu */
                __LOG(("Bridge bypassed set descrPtr->egressFilterRegistered = 1 (for single word 'from cpu' DSA)\n"));
                descrPtr->egressFilterRegistered = 1;
            }
            else
            {
                /* the from_cpu have dedicated field in the DSA for this field */
                __LOG(("Keep descrPtr->egressFilterRegistered with value [%d] (unchanged) \n",
    ...
    {
        if(descrPtr->srcIsVPort)
        {
            learnInfo.FDB_isVPort = 1;
            learnInfo.FDB_vPort   = descrPtr->srcVPort;
        }
        else
        {
    ...
    if(devObjPtr->supportEArch)
    {
        ...
        if(SMEM_CHT_IS_SIP6_GET(devObjPtr))
        {
            ...
            if(learnInfo.FDB_isTrunk == 0 && learnInfo.FDB_isVPort)
            {
                __LOG(("The VPort[%d] can't be considered as global eport (relevant to eports) \n",
                    learnInfo.FDB_vPort));
            }
            else
    ...
    if (bypassFdbLookup)
    {
        ...
        daLookupInfo.useVidx = 1;
        daLookupInfo.found = 0;
        memset(&saLookupInfo, 0, sizeof(saLookupInfo));
        descrPtr->skipFdbSaLookup = 1;
    ...
    if(SMEM_CHT_IS_SIP6_30_GET(devObjPtr))
    {
        /* regardless to bypass bridge mode */
       ...
       (bypassBridge == SNET_CHEETA_L2I_BYPASS_BRIDGE_ONLY_FORWARD_DECISION_E))
    {
        ...
        snetChtL2iPhase1Decision(devObjPtr, descrPtr, &descrPtr->ingressVlanInfo, &saLookupInfo,
                                 &daLookupInfo, &cntrlPcktInfo,  &filtersInfo, bypassBridge, preL2iPacketCmd);
    ...
    if ((descrPtr->bypassIngressPipe == GT_FALSE) && (bypassFdbLookup == 0))
    {
    ...
    {
        __LOG(
            ("no SA learning due to descrPtr->bypassIngressPipe[%d], bypassFdbLookup[%d] \n",
             descrPtr->bypassIngressPipe, bypassFdbLookup));
    }
...
)
{
    ...
    dipLookupInfoPtr->trgEpg                           = sip6FdbEntryInfoPtr->epg_streamId;

    dipLookupInfoPtr->trg_isVPort                      = sip6FdbEntryInfoPtr->ucRoute.trg_isVPort;
    dipLookupInfoPtr->trg_vportNum                     = sip6FdbEntryInfoPtr->ucRoute.trg_vportNum;
...
)
{
    ...
    if(descrPtr->skipFdbSaLookup == 0)
    {
        ...
        /* sip7 : check if FDB table was allocated , as it may not been yet connected to
           SBM (shared-table) */
        if(!IS_FDB_MEMORY_EXISTS(devObjPtr))
        {
            fdbFound = GT_FALSE;
            __LOG(("ERROR : not access the FDB as the FDB table hold no SMB behind it yet \n"));
        }
        else
        {
            /* Lookup for SA */
            fdbFound = snetChtL2iFdbLookup(devObjPtr, &entryHashInfo,GT_FALSE/*from PP*/,GT_TRUE,
                                       ...
                                       &saLookupInfoPtr->sendFailedNa2Cpu,
                                        NULL,/*numValidPlacesPtr*/
                                       &learnInfoPtr->calculatedHashArr[0]);
        }
    ...
    if(SMEM_CHT_IS_SIP6_GET(devObjPtr))
    {
        ...
        if(sip6FdbEntryInfoPtr->isVPort)
        {
            learnInfoPtr->oldInfo.FDB_isVPort = 1;
            learnInfoPtr->oldInfo.FDB_vPort   = sip6FdbEntryInfoPtr->vportNum;
        }
        else
        {
            /* port number */
    ...
    if(learnInfoPtr->FDB_isVPort         == 1 &&
       learnInfoPtr->oldInfo.FDB_isVPort == 1 &&
       learnInfoPtr->FDB_vPort == learnInfoPtr->oldInfo.FDB_vPort)
    {
        /*the entry not moved , was and is on this vPort */

        if(learnInfoPtr->FDB_devNum != learnInfoPtr->oldInfo.FDB_devNum)
        {
            /* for vPorts change of devNum not cause 'Address moved' */
            /* as the vPorts considered global */

            __LOG(("SA on vPort [%d] NOT considered 'moved' although 'devId' : from entry [%d] from desc[%d] \n",
                          learnInfoPtr->FDB_vPort,
                          learnInfoPtr->oldInfo.FDB_devNum,
                          learnInfoPtr->FDB_devNum));
        }
    }
    else/* sip7 only */
    if(learnInfoPtr->FDB_isVPort    != learnInfoPtr->oldInfo.FDB_isVPort ||
       learnInfoPtr->FDB_vPort      != learnInfoPtr->oldInfo.FDB_vPort)
    {
        if(learnInfoPtr->FDB_isVPort    != learnInfoPtr->oldInfo.FDB_isVPort)
        {
            __LOG(("SA 'moved' due to different new [%s] but old is [%s]: \n",
                          learnInfoPtr->FDB_isVPort ? "vPort" :
                            learnInfoPtr->FDB_isTrunk ? "Trunk" :
                            "ePort",
                          learnInfoPtr->oldInfo.FDB_isVPort ? "vPort" :
                            learnInfoPtr->oldInfo.FDB_isTrunk ? "Trunk" :
                            "ePort"));
        }
        else
        {
            __LOG(("SA 'moved' to new vPort [%d] but old vPort was [%d]: \n",
                          learnInfoPtr->FDB_vPort,
                          learnInfoPtr->oldInfo.FDB_vPort));
        }
...
)
{
    ...
    __LOG(("List the 'key' info for hashing for : [%s] \n" , namePtr));
...
)
{
    ...
    if(sip6FdbEntryInfoPtr)
    {
        ...
        /* the sip6.30 not require 'UC mac' (macDA bit40 ==0) , to support 'Single destination'*/
        if ((entryHashInfo.entryType == SNET_CHEETAH_FDB_ENTRY_MAC_E) &&
            (descrPtr->macDaType == SKERNEL_UNICAST_MAC_E || SMEM_CHT_IS_SIP6_30_GET(devObjPtr)) &&
            (daLookupInfoPtr->multiTrg == 0))
        {
            ...
            if(sip6FdbEntryInfoPtr->isVPort) /* relevant only to SIP7 */
            {
                daLookupInfoPtr->targed.ucast.isVPort  = 1;
                daLookupInfoPtr->targed.ucast.vportNum = sip6FdbEntryInfoPtr->vportNum;
            }
            else
            {
...
)
{
    ...
    ipv6InterfaceEn = vlanInfoPtr->ipV6InterfaceEn;
...
)
{
    ...
    GT_U32  bypassLearnPriorityTable = 0;/*do we bypass access to Learn Priority Table */
    GT_U32  Learn_Priority_Minimal_vPort_Number = 0;
    GT_U32  Learn_Priority_Number_of_vPorts = 0;
    GT_U32  Learn_Priority_Table_base_index = 0;
    GT_U32  globalIndex;
    ...
    else
    {
        ...
        /* PrvEdgeVlanPortEnable */
        allPktToPveUplinkEn = SMEM_U32_GET_FIELD(regPtr[0], 22, 1);
        /* Port PVLAN Trunk */
       ...
       saLookupInfoPtr->isMoved && saLookupInfoPtr->found)
    {
        ...
        if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
        {
            smemRegGet(devObjPtr,SMEM_SIP7_L2I_BRDG_MAC_SPOOF_PROTECTION_CONF0_REG(devObjPtr),&fldValue);
            Learn_Priority_Table_base_index = SMEM_U32_GET_FIELD(fldValue, 0, 14);
            Learn_Priority_Number_of_vPorts = SMEM_U32_GET_FIELD(fldValue,14, 18);

            smemRegGet(devObjPtr,SMEM_SIP7_L2I_BRDG_MAC_SPOOF_PROTECTION_CONF1_REG(devObjPtr),&fldValue);
            Learn_Priority_Minimal_vPort_Number = SMEM_U32_GET_FIELD(fldValue, 0, 18);

            __LOG_PARAM(Learn_Priority_Minimal_vPort_Number);
            __LOG_PARAM(Learn_Priority_Number_of_vPorts);
            __LOG_PARAM(Learn_Priority_Table_base_index);
        }

        if(descrPtr->origIsTrunk == 0 && descrPtr->srcIsVPort)
        {
            if (descrPtr->srcVPort >= Learn_Priority_Minimal_vPort_Number &&
                descrPtr->srcVPort  < (Learn_Priority_Minimal_vPort_Number+Learn_Priority_Number_of_vPorts))
            {
                /*Access the ePort Learn Priority table */
                globalIndex = descrPtr->srcVPort - Learn_Priority_Minimal_vPort_Number + Learn_Priority_Table_base_index;

                fldBit = globalIndex & 0x7;
                index  = globalIndex >> 3;

                __LOG(("(For vport) : (new FDB info) Access the the ePort Learn Priority table index [%d] \n",
                    globalIndex));
            }
            else
            {
                /*Don't Access the ePort Learn Priority table */
                /*Use <Learn Priority>=0 and <User Group>=0 as if it was read from the table */

                fldBit = 0;/* dummy , not used*/
                index  = 0;/* dummy , not used*/

                __LOG(("(For vport) : (new FDB info) Don't Access the ePort Learn Priority table \n"));

                bypassLearnPriorityTable = 1;
            }
        }
        else
        {
        ...
        if(bypassLearnPriorityTable == 1)
        {
            learnPriority_packet = 0;
            userGroup_packet     = 0;
        }
        else
        ...
        bypassLearnPriorityTable = 0;

        if(learnInfoPtr->oldInfo.FDB_isTrunk == 0 && learnInfoPtr->oldInfo.FDB_isVPort)
        {
            if (learnInfoPtr->oldInfo.FDB_vPort >= Learn_Priority_Minimal_vPort_Number &&
                learnInfoPtr->oldInfo.FDB_vPort  < (Learn_Priority_Minimal_vPort_Number+Learn_Priority_Number_of_vPorts))
            {
                /*Access the ePort Learn Priority table */
                globalIndex = learnInfoPtr->oldInfo.FDB_vPort - Learn_Priority_Minimal_vPort_Number + Learn_Priority_Table_base_index;

                fldBit = globalIndex & 0x7;
                index  = globalIndex >> 3;

                __LOG(("(For vport) : (existing FDB info) Access the the ePort Learn Priority table index [%d] \n",
                    globalIndex));
            }
            else
            {
                ...
                __LOG(("(For vport) : (existing FDB info) Don't Access the ePort Learn Priority table \n"));
        ...
        {
            /* MAC Spoof Protection Event is Security Breach field in
             * Bridge Global Configuration1 register is not used
             */
            regAddr = SMEM_LION3_L2I_BRIDGE_COMMAND_CONFIG_0_REG(devObjPtr);
            smemRegFldGet(devObjPtr, regAddr, 18, 3, &fldValue);
    ...
    if (fldValue)
    {
        ...
        if (fldValue)
        {
            ...
            filterInfoPtr->allPktToPveUplinkEn = allPktToPveUplinkEn;
            ...
            __LOG(("get PVE info:pvlanTrgIsTrunk[%d],pvlanPortOrTrunkId[%d],pvlanDevNum[%d],allPktToPveUplinkEn[%d] \n",
                pvlanTrgIsTrunk,pvlanPortOrTrunkId,pvlanDevNum,allPktToPveUplinkEn));
    ...
    */
    ...
    {
        /* If the packet arrives DSA tagged, the DSA tag overhead is not included in the packet byte count.*/
        if(descrPtr->marvellTagged)
        {
            /* add VLAN Tag size if it's tagged */
            if (descrPtr->tagSrcTagged[SNET_CHT_TAG_0_INDEX_CNS])
            {
                byteCount += 4;
            }

            /* reduce DSA size from byte count */
            byteCount -= (4 * (descrPtr->marvellTaggedExtended + 1));
            __LOG(("Exclude DSA overhead from byte count [%d]\n",(4 * (descrPtr->marvellTaggedExtended + 1))));
        }
...
)
{
        ...
        descrPtr->packetCmd == SKERNEL_EXT_PKT_CMD_TRAP_TO_CPU_E)
    {
        ...
        if (filtersInfoPtr->pvlanEn == 0)
        {
            if (descrPtr->packetCmd != SKERNEL_EXT_PKT_CMD_TRAP_TO_CPU_E)
            {
                if( bypassBridge == SNET_CHEETA_L2I_BYPASS_BRIDGE_NONE_E )
                {
                    ...
                    if(descrPtr->packetCmd != SKERNEL_EXT_PKT_CMD_FORWARD_E)
                    {
                        __LOG(("The command resolution from the bridge Phase 1 is not FORWARD, Set egressFilterRegistered = 1 \n"));
                        descrPtr->egressFilterRegistered = 1;
                    }
                    ...
                    if (daLookupInfoPtr->found)
                    {
                        ...
                        else
                        {
                            ...
                            if(daLookupInfoPtr->targed.ucast.isVPort)
                            {
                                descrPtr->trgIsVPort = 1;
                                descrPtr->trgVPort   = daLookupInfoPtr->targed.ucast.vportNum;
                                __LOG(("use fdb target vPort [0x%x]\n",
                                    descrPtr->trgVPort));
                                /* call after setting trgVPort */
                                SIP7_INVALIDATE_TRG_EPORT_TRG_DEV_MAC(devObjPtr,descrPtr,fdb);
                            }
                            else
                            {
        ...
        else /* (filtersInfoPtr->pvlanEn == 1) */
        {
            if(descrPtr->bypassBridge == SNET_CHEETA_L2I_BYPASS_BRIDGE_NONE_E)
            {
                /* PVLAN enabled */
                ...
                {
                    descrPtr->trgIsVPort = 0; /* no PVE support for vPort (instead use PCL to redirect to vPort) */
                ...
                if(((SKERNEL_EXT_PKT_CMD_MIRROR_TO_CPU_E == preL2iPacketCmd) ||
                    (SKERNEL_EXT_PKT_CMD_TRAP_TO_CPU_E   == preL2iPacketCmd)) &&
                    filtersInfoPtr->allPktToPveUplinkEn)
                {
                    __LOG(("PVE and 'allPktToPveUplinkEn' for 'trap/mirror' (prior to L2i) treated as 'forward' \n"));
                    descrPtr->packetCmd = SKERNEL_EXT_PKT_CMD_FORWARD_E;
                }
            }
        }
    ...
    /* even if descriptor came to bridge with 'TRAP/SOFT DROP' ,
       the router still need the next indication , so need to set it not only for
       'forward/mirror' */
    if (daLookupInfoPtr->daRoute == 1)
    {
        ...
        __LOG_PARAM(descrPtr->bridgeMcRoutEn);
    }
...
)
{
    ...
    GT_BOOL mayChangeDropMode;   /* GT_FALSE - Don't change drop counter mode
                                    GT_TRUE - Change drop counter mode */
    ...
    /* Check for drop mode status to avoid value overwrite,
       also skip drop counter mode configuration for non SIP5 devices.
       For non SIP5 device, drop counter mode setting is done in snetCht2L2iSecurity */
    if(SMEM_CHT_IS_SIP5_GET(devObjPtr) && filtersInfoPtr->dropCounterMode == 0)
    {
        mayChangeDropMode = GT_TRUE;
    }
    else
    {
        mayChangeDropMode = GT_FALSE;
    }
    ...
    if (descrPtr->macDaType == SKERNEL_UNICAST_MAC_E)
    {
        ...
        /* Set bridge drop counter mode for unknown UC packets */
        if(mayChangeDropMode &&
           (filtersInfoPtr->unknUcastCmd == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E ||
            filtersInfoPtr->unknUcastCmd == SKERNEL_EXT_PKT_CMD_HARD_DROP_E))
        {
            filtersInfoPtr->dropCounterMode = SNET_CHT_BRG_UNKN_UCAST_TRAP_MIRROR;
        }
    ...
    if (descrPtr->macDaType == SKERNEL_MULTICAST_MAC_E)
    {
        ...
        /* Unregistered IPv4 Multicast Command is only applicable if MAC DA is multicast 01-00-5E-xx-xx-xx
         * as well as the packet DIP is Multicast 224:0:0:x
         */
        if(filtersInfoPtr->mcMacIsIpmV4 && SMEM_CHT_IS_SIP5_15_GET(devObjPtr) && descrPtr->ipm == 0)
        {
            __LOG(("sip5_15 : not applying unregistered IPv4 mcast[%d] command, since not 'IPMC' packet\n",
                    vlanInfoPtr->unregIPv4McastCmd));
            return;
        }
        else
        {
            if (filtersInfoPtr->mcMacIsIpmV4)
            {
                ...
                /* Set drop counter mode for UNREG IPV4 MC packets */
                if(mayChangeDropMode &&
                   (filtersInfoPtr->uregL2Ipv4McCmd == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E ||
                    filtersInfoPtr->uregL2Ipv4McCmd == SKERNEL_EXT_PKT_CMD_HARD_DROP_E))
                {
                    filtersInfoPtr->dropCounterMode = SNET_CHT_BRG_IPV4_UNREG_MCAST_TRAP_MIRROR;
                }
        ...
        if (filtersInfoPtr->mcMacIsIpmV6 == 0)
        {
            ...
            /* Set drop counter mode for UNREG  Non-IPv4/6 MC packets */
            if(mayChangeDropMode &&
               (filtersInfoPtr->uregL2NonIpmMcCmd == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E ||
                filtersInfoPtr->uregL2NonIpmMcCmd == SKERNEL_EXT_PKT_CMD_HARD_DROP_E))
            {
                filtersInfoPtr->dropCounterMode = SNET_CHT_BRG_NON_IPV4_IPV6_UNREG_MCAST_TRAP_MIRROR;
            }
        ...
        /* Unregistered IPv6 Multicast Command is only applicable if MAC DA is multicast 33-33-xx-xx-xx-xx
         * as well as the packet DIP is Multicast FF02:0:0:0:0:0:0:xx
         */
        if(SMEM_CHT_IS_SIP5_15_GET(devObjPtr) && descrPtr->ipm == 0)
        {
            __LOG(("sip5_15 : not applying unregistered IPv6 mcast[%d] command, since not 'IPMC' packet\n",
                    vlanInfoPtr->unregIPv6McastCmd));
            return;
        }
        ...
        /* Set drop counter mode for UNREG IPv6 MC packets */
        if(mayChangeDropMode &&
           (filtersInfoPtr->uregL2Ipv6McCmd == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E ||
            filtersInfoPtr->uregL2Ipv6McCmd == SKERNEL_EXT_PKT_CMD_HARD_DROP_E))
        {
            filtersInfoPtr->dropCounterMode = SNET_CHT_BRG_IPV6_UNREG_MCAST_TRAP_MIRROR;
        }
    ...
    if (descrPtr->isIPv4)
    {
        ...
        /* Set drop counter mode for UNREG IPv4 BC packets */
        if(mayChangeDropMode &&
           (filtersInfoPtr->uregL2Ipv4BcCmd == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E ||
            filtersInfoPtr->uregL2Ipv4BcCmd == SKERNEL_EXT_PKT_CMD_HARD_DROP_E))
        {
            filtersInfoPtr->dropCounterMode = SNET_CHT_IPV4_BCAST_TRAP_MIRROR;
        }
    ...
    /* Set drop counter mode for UNREG Non-IPv4 BC packets */
    if(mayChangeDropMode &&
       (filtersInfoPtr->uregL2NonIpv4BcCmd == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E ||
        filtersInfoPtr->uregL2NonIpv4BcCmd == SKERNEL_EXT_PKT_CMD_HARD_DROP_E))
    {
        filtersInfoPtr->dropCounterMode = SNET_CHT_NON_IPV4_BCAST_TRAP_MIRROR;
    }
...
)
{
    ...
    /* Aligning with BM, if brgCounterMode = count ALL, the SOFT dropped packets by TTI/IPCL are counted by bridge */
    if(filtersInfoPtr->dropCounterMode == 0 && descrPtr->packetCmd != SKERNEL_EXT_PKT_CMD_SOFT_DROP_E)
    {
        return;
    }
...
)
{
    ...
    GT_BIT FDB_isVPort;/*SIP7 : is the value assigned to FDB<VPort> in learning*/
    GT_U32 FDB_vPort;  /*SIP7 : the Source VPort assigned to the FDB<vPort> in learning*/
    ...
    */
    ...
    FDB_isVPort = FDB_isTrunk ? 0 : descrPtr->srcIsVPort;
    FDB_vPort   = (FDB_isTrunk || descrPtr->srcIsVPort == 0) ? 0 : descrPtr->srcVPort;
    ...
    learnInfoPtr->FDB_isVPort    = FDB_isVPort;
    learnInfoPtr->FDB_vPort      = FDB_vPort;
    ...
    if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        __LOG_PARAM_NO_LOCATION_META_DATA(FDB_isVPort);
        __LOG_PARAM_NO_LOCATION_META_DATA(FDB_vPort);
    }
...
)
{
    ...
    GT_U32  disable_fdb_lookup;
    GT_U32  regAddr;

    regAddr = SMEM_CHT_BRDG_GLB_CONF0_REG(devObjPtr);
    smemRegFldGet(devObjPtr, regAddr, 26, 1, &skip_fdb_sa_lookup_mode);
    smemRegFldGet(devObjPtr, regAddr, 27, 1, &disable_fdb_lookup);

    __LOG_PARAM(skip_fdb_sa_lookup_mode);
    __LOG_PARAM(disable_fdb_lookup);
    ...
    else if (SMEM_CHT_IS_SIP7_GET(devObjPtr) && disable_fdb_lookup)
    {
        descrPtr->skipFdbSaLookup = GT_TRUE;
        __LOG(("SIP6 : SA lookup disabled due to Disabled FDB Lookups bit \n"));
    }
    else if(skip_fdb_sa_lookup_mode == 0)
    {
...
)
{
    ...
    if(filtersInfoPtr->vlanMruCmd >= SKERNEL_EXT_PKT_CMD_HARD_DROP_E)
    {
        /* No Learning and no NA Messages */
        __LOG(("No Learning and no NA Messages due to filtersInfoPtr->vlanMruCmd >= HARD DROP\n"));
        return;
    }
    ...
    if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        ...
        smemRegFldGet(devObjPtr, SMEM_CHT_BRDG_GLB_CONF1_REG(devObjPtr),
                      30, 1, &SPLearnEnNAtoCPU);
        __LOG(("SPLearnEnNAtoCPU[%d]\n", SPLearnEnNAtoCPU));
    }

    /* This field is relevant when
     *   1. Auto-learning is disabled
     *   2. New Address (NA) update Storm Prevention is enabled
     *   3. SPLearnEnNAtoCPU is enabled
     */
    spUnknown = ((filtersInfoPtr->naMsgToCpuEn | SPLearnEnNAtoCPU) &
...
)
{
    ...
    if (auMsgsToCpuIf)
    {
        ...
        status = snetChtL2iPciAuMsg(devObjPtr, macUpdMsgPtr, GT_FALSE , msgSizeInWords);
    }
    else
    {
        ...
        status = snetChtL2iFifoAuMsg(devObjPtr, macUpdMsgPtr , msgSizeInWords);
    }
...
)
{
    ...
    if(devObjPtr->supportGdma && devObjPtr->supportGdma_FUQ)/*sip7*/
    {
        fldValue = 1;/* use the dedicated FUQ and not with the AUQ */
    }
    else
    {
    ...
    else
    {
        ...
        status = snetChtL2iSendUpdMsg2Cpu(devObjPtr, macFuMsgPtr,devObjPtr->numOfWordsInAuMsg);
    }
...
)
{
    ...
    GT_BOOL status;                 /* function return value */
    GT_U32 macUpdateMsg[SMEM_CHT_NA_MSG_WORDS];/* message send to CPU */
    GT_32    msgSizeInWords;
    ...
    if(SMEM_CHT_IS_SIP7_GET(devObjPtr) &&
       !learnInfoPtr->FDB_isMoved)  /* not moved --> NA address */
    {
        msgSizeInWords = devObjPtr->sip7_numWordsAlignmentInNaMsg;
    }
    else
    {
        msgSizeInWords = devObjPtr->numWordsAlignmentInAuMsg;
    }

   /* reset the buffer */
    memset(macUpdateMsg,0,4*msgSizeInWords);
    ...
    status = snetChtL2iSendUpdMsg2Cpu(devObjPtr, &macUpdateMsg[0] , msgSizeInWords);
...
)
{
    ...
    if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        /* ignore input param that may be 24/56 or 32/64, as message if comes directly to fifo stated as 25/56 ,
           but if comes from the PCIe that is full , stated as 32/64 */
        if(msgSizeInWords <= 32)
        {
            msgSizeInWords = 24;
        }
        else
        if(msgSizeInWords <= 64)
        {
            msgSizeInWords = 56;
        }
    }
    ...
    if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        /* ignore input param that may be 6 or 8 , as message if comes directly to fifo stated as 6 ,
           but if comes from the PCIe that is full , stated as 8 */
        msgSizeInWords = 6;
    }
    else
    {
    ...
    numOfEntries = fifoSize / msgSizeInWords;

    /* protect FIFO management */
    SCIB_SEM_TAKE;
    for (i = 0; i < numOfEntries; i++, fifoBufferPtr+= msgSizeInWords)
    {
        ...
        memcpy(fifoBufferPtr, macUpdMsgPtr, 4*msgSizeInWords);
        break;
    }
    SCIB_SEM_SIGNAL;
...
)
{
    ...
    *entryOffsetPtr = 0;
    ...
    if(multiHashEnable)
    {
        ...
        /* sip7 : use FDB_MAX_BANKS_CNS and not devObjPtr->fdbNumOfBanks ,
           as the HW generate the 16 values into the NA msg , regardless to the number of devObjPtr->fdbNumOfBanks*/
        sip5MacHashCalcMultiHash(devObjPtr,hashType, vlanMode, entryInfoPtr,numBitsToUse,
                    (out_calculatedHashArr && SMEM_CHT_IS_SIP7_GET(devObjPtr)) ? FDB_MAX_BANKS_CNS : devObjPtr->fdbNumOfBanks,calculatedHashArr);
        if(out_calculatedHashArr)
        {
            /* sip7 : use FDB_MAX_BANKS_CNS and not devObjPtr->fdbNumOfBanks ,
               as the HW generate the 16 values into the NA msg , regardless to the number of devObjPtr->fdbNumOfBanks*/
            for(hashFunctionIndex = 0 ; hashFunctionIndex < FDB_MAX_BANKS_CNS; hashFunctionIndex++)
            {
                out_calculatedHashArr[hashFunctionIndex] = calculatedHashArr[hashFunctionIndex];
            }
        }
        /* print to LOG the 16 hash values */
        __LOG(("hash[0]  = [0x%4.4x], hash[1]  = [0x%4.4x], hash[2]  = [0x%4.4x], hash[3]  = [0x%4.4x] \n"
               "hash[4]  = [0x%4.4x], hash[5]  = [0x%4.4x], hash[6]  = [0x%4.4x], hash[7]  = [0x%4.4x] \n"
               "hash[8]  = [0x%4.4x], hash[9]  = [0x%4.4x], hash[10] = [0x%4.4x], hash[11] = [0x%4.4x] \n"
               "hash[12] = [0x%4.4x], hash[13] = [0x%4.4x], hash[14] = [0x%4.4x], hash[15] = [0x%4.4x] \n" ,
            calculatedHashArr[ 0],calculatedHashArr[1] ,calculatedHashArr[2] ,calculatedHashArr[3] ,
            calculatedHashArr[ 4],calculatedHashArr[5] ,calculatedHashArr[6] ,calculatedHashArr[7] ,
            calculatedHashArr[ 8],calculatedHashArr[9] ,calculatedHashArr[10],calculatedHashArr[11],
            calculatedHashArr[12],calculatedHashArr[13],calculatedHashArr[14],calculatedHashArr[15]
            ));
    }
    else
    {
        ...
        if(out_calculatedHashArr)
        {
            out_calculatedHashArr[0] = hashIndex;
            for(hashFunctionIndex = 1 ; hashFunctionIndex < FDB_MAX_BANKS_CNS; hashFunctionIndex++)
            {
                out_calculatedHashArr[hashFunctionIndex] = 0;
            }
        }
    }
        ...
        hashFunctionIndex ++)
    {
        ...
        for (i = 0; i < bucketSize; i++)
        {
            ...
            if(SMEM_CHT_IS_SIP7_GET(devObjPtr) && isDipLookup)
            {
                /* the format not have the Skip bit */
            }
            else
...
)
{
    ...
    if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        if(learnInfoPtr->FDB_isMoved)
        {
            SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
                SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_MSG_TYPE,
                    SIP7_SFDB_UPDATE_MSG_MOVED_E);
        }
        else
        {
            SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
                SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_MSG_TYPE,
                    SIP7_SFDB_UPDATE_MSG_NA_E);
        }
    }
    else
    {
    ...
    SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
        SMEM_SIP6_FDB_AU_MSG_TABLE_FIELDS_FID,
        (learnInfoPtr->FDB_fid & 0x7FFF));

    if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
            SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_FID_15,
            (learnInfoPtr->FDB_fid >> 15));
    }
    ...
    if(learnInfoPtr->FDB_isVPort)
    {
        SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
            SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_USE_VPORT,
            learnInfoPtr->FDB_isVPort);
        SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
            SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_VPORT_0_13,
            learnInfoPtr->FDB_vPort);
        SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
            SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_VPORT_14_17,
            learnInfoPtr->FDB_vPort >> 14);
    }
    else
    {
        SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
    ...
    if (newAddressMessageEn)
    {
        ...
        if (learnInfoPtr->FDB_isMoved)
        {
            ...
            if(learnInfoPtr->oldInfo.FDB_isVPort)
            {
                SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
                    SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_USE_VPORT,
                    learnInfoPtr->oldInfo.FDB_isVPort);
                SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
                    SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_VPORT_0_13,
                    learnInfoPtr->oldInfo.FDB_vPort);
                SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
                    SMEM_SIP7_FDB_AU_MSG_TABLE_FIELDS_NA_MOVED_OLD_VPORT_14_17,
                    learnInfoPtr->oldInfo.FDB_vPort >> 14);
            }
            else
            {
                SMEM_SIP6_FDB_AU_MSG_ENTRY_FIELD_SET(devObjPtr,macUpdMsgPtr,
    ...
    if(SMEM_CHT_IS_SIP7_GET(devObjPtr) &&
       newAddressMessageEn && /* should always be 1 */
       !learnInfoPtr->FDB_isMoved)
    {
        /* the NA message hold the 16 values of the hash */
        /* each word hold 2 hash values */
        for(ii = 0 ; ii < FDB_MAX_BANKS_CNS; ii += 2)
        {
            if(simLogIsOpenFlag)
            {
                __LOG(("calculatedHashArr[%d] = [0x%4.4x] \n",
                    ii ,
                    learnInfoPtr->calculatedHashArr[ii] ));
                __LOG(("calculatedHashArr[%d] = [0x%4.4x] \n",
                    ii+1 ,
                    learnInfoPtr->calculatedHashArr[ii+1] ));
            }

            /* start at word[6] (bit 192) , and add 16 bits for each hash value */
            macUpdMsgPtr[6 + (ii/2)] =
                learnInfoPtr->calculatedHashArr[ii] |
                learnInfoPtr->calculatedHashArr[ii+1] << 16;
        }
...
*/
GT_BOOL snetChtL2iPciAuMsg
(
    IN SKERNEL_DEVICE_OBJECT * devObjPtr,
    INOUT GT_U32 * macUpdMsgPtr,
    IN GT_BOOL     dataFromFifo,
    IN GT_32    msgSizeInWords
)
{
    ...
    GT_U32 treeId = 0;/* function snetChtDoInterruptInMgInAllTrees will support falcon that uses tree 1 on MG[8] */
    GT_U32  AU_Addr_msg_size = 0;

    if(devObjPtr->supportGdma && devObjPtr->supportGdma_AUQ)/*sip7*/
    {
        GT_U32  auq_gdma_q;
        GT_BOOL needRetry;

        smemRegFldGet(devObjPtr, SMEM_SIP6_FDB_GLOBAL_CONFIG_2_REG(devObjPtr), 4, 5, &auq_gdma_q);

        snetSip7GdmaSendMsgToCpu(devObjPtr,SNET_SIP7_GDMA_MSG_CLIENT_FDB_AUQ_E,
            auq_gdma_q,/*ringId*/
            macUpdMsgPtr,
            msgSizeInWords,
            &needRetry);

        status = (needRetry == GT_TRUE) ? GT_FALSE : GT_TRUE;
    ...
    miscCauseRegister = SMEM_CHT_MISC_INTR_CAUSE_REG(devObjPtr,treeId);
    miscMaskRegister = SMEM_CHT_MISC_INTR_MASK_REG(devObjPtr,treeId);

    simAuqMem = SMEM_CHT_MAC_AUQ_MEM_GET(devObjPtr);

    SCIB_SEM_TAKE; /* protect the AUQ state */

    /* Check validity of AUQ base segment */
    if (simAuqMem->auqBaseValid == GT_FALSE)
    {
        SCIB_SEM_SIGNAL;
        /* don't use FIFO if data came from it */
        if (!dataFromFifo)
        {
            status = snetChtL2iFifoAuMsg(devObjPtr, macUpdMsgPtr , msgSizeInWords);
        }
...
)
{
    ...
    if(devObjPtr->supportGdma && devObjPtr->supportGdma_FUQ)/*sip7*/
    {
        GT_U32  upload_gdma_q;
        GT_BOOL needRetry;

        smemRegFldGet(devObjPtr, SMEM_SIP6_FDB_GLOBAL_CONFIG_2_REG(devObjPtr), 9, 5, &upload_gdma_q);

        snetSip7GdmaSendMsgToCpu(devObjPtr,SNET_SIP7_GDMA_MSG_CLIENT_FDB_FUQ_E,
            upload_gdma_q,/*ringId*/
            fuMsgPtr,
            numWordsData,
            &needRetry);
...
)
{
    ...
    {
        smemMemSet(devObjPtr, SMEM_CHT_MAC_TBL_MEM(devObjPtr, entryIndex), hwData, macEntrySize);
    }
}
...
)
{
    ...
    else if(daLookupInfoPtr->targed.ucast.isTrunk == learnInfoPtr->FDB_isTrunk)
    {
        ...
        */
        ...
        if(daLookupInfoPtr->targed.ucast.isVPort && descrPtr->srcIsVPort)
        {
            /* came from vPort , go to vPort */
            if(daLookupInfoPtr->targed.ucast.vportNum == descrPtr->srcVPort)
            {
                filterInfoPtr->localPortCmd = SKERNEL_EXT_PKT_CMD_SOFT_DROP_E;

                __LOG(("Local Switching filter 'vPort' [0x%x] : assign command[%d](soft DROP) \n",
                              descrPtr->srcVPort,
                              filterInfoPtr->localPortCmd));
            }
        }
        ...
        if(daLookupInfoPtr->targed.ucast.isVPort != descrPtr->srcIsVPort)
        {
            /* not use the same vPort type , so not need the filter */
        }
        else
        {
            /*came from port , go to port */
    ...
    else if(daLookupInfoPtr->targed.ucast.isTrunk == 0 &&  /*learnInfoPtr->FDB_isTrunk == 1*/
            daLookupInfoPtr->targed.ucast.isVPort == 0 &&
...
)
{
    ...
    if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        LION3_TABLES_FORMAT_INIT_MAC(
            ...
            sip7L2iIngressVlanTableFieldsFormat, bobcat2B0L2iIngressVlanTableFieldsNames);
    }
    else
    if(SMEM_CHT_IS_SIP6_GET(devObjPtr))
    {
    ...
    if(SMEM_CHT_IS_SIP5_20_GET(devObjPtr))
    {
        ...
        if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
        {
            LION3_TABLES_FORMAT_INIT_MAC(
                devObjPtr, SKERNEL_TABLE_FORMAT_BRIDGE_INGRESS_EPORT_E,
                sip7L2iEPortTableFieldsFormat, lion3L2iEPortFieldsTableNames);

            LION3_TABLES_FORMAT_INIT_MAC(
                devObjPtr, SKERNEL_TABLE_FORMAT_FDB_E,
                sip7FdbFdbTableFieldsFormat, sip6FdbFdbFieldsTableNames);

            LION3_TABLES_FORMAT_INIT_MAC(
                devObjPtr, SKERNEL_TABLE_FORMAT_FDB_AU_MSG_E,
                sip7FdbAuMsgTableFieldsFormat, sip6FdbAuMsgFieldsTableNames);
        }
        else
        if(SMEM_CHT_IS_SIP6_GET(devObjPtr))
        {
...
static GT_U32/*fdbIndex*/ snetSip6_30L2iFdbDdeEmptyEntryGet(
    ...
    OUT GT_BOOL        *needCountInOverridenNonExpiredPtr
...
)
{
    ...
    *needCountInOverridenNonExpiredPtr = GT_FALSE;
    ...
    for(ii = 0 ; ii < devObjPtr->fdbNumOfBanks; ii++)
    {
        ...
        {
            fdbEntryPtr = smemMemGet(devObjPtr,  SMEM_CHT_MAC_TBL_MEM(devObjPtr, index));
        }
    ...
    *needCountInOverridenNonExpiredPtr = GT_TRUE;
...
static GT_U32/*fdbIndex*/ snetSip6_30L2iFdbDdeMatchGet(
    ...
    IN GT_U32          sequenceNumber,
    IN GT_U32          calculatedHashArr[FDB_MAX_BANKS_CNS],
    IN GT_U32          DDESameKeyExpirationTime,
    IN GT_U32          fdb_hrs_prp_timer,
    IN GT_U32          dde_enable_to_be_deleted_fdb_entry,
    IN GT_U32          dde_to_be_deleted_fdb_entry_address
)
{
    ...
    for(ii = 0 ; ii < devObjPtr->fdbNumOfBanks; ii++)
    {
        ...
        timeDiff = snetSip6_30L2iFdbTimerSubtract(fdb_hrs_prp_timer, fieldValue /*FDB<Timestamp>*/);
        __LOG(("Entry at index [%d] with time [0x%8.8x], the current HSR/PRP time is [0x%8.8x] so the diff is [0x%8.8x] and DDESameKeyExpirationTime[0x%8.8x] \n",
            index,fieldValue,fdb_hrs_prp_timer,timeDiff,DDESameKeyExpirationTime));
        if(timeDiff >= DDESameKeyExpirationTime)
        {
        ...
        else /**/
        {
               ...
               0 == descrPtr->hsrPrpInfo.acceptSamePort)
            {
                ...
                if(descrPtr->hsrPrpInfo.acceptSamePort)
                {
                    smemRegFldGet(devObjPtr,
                    ...
                    __LOG_PARAM(prp_algorithem_mode);
                }

                if(descrPtr->hsrPrpInfo.acceptSamePort/* PRP enable */ &&
                   prp_algorithem_mode == 0/*delete_packet_twice*/)
                {
                    __LOG(("PRP : Invalidate the DDE after the entry filtered a different entering port \n"));

                    SMEM_SIP6_FDB_FDB_ENTRY_FIELD_SET(devObjPtr,fdbEntryPtr, index,
                        SMEM_SIP6_FDB_FDB_TABLE_FIELDS_VALID,0);
                }
                else
                {
                    SMEM_SIP6_FDB_FDB_ENTRY_FIELD_SET(devObjPtr,fdbEntryPtr, index,
...
)
{
    ...
    GT_U32  DDEExpirationTime,DDESameKeyExpirationTime;
    ...
    GT_BOOL needCountInOverridenNonExpired;
    ...
    smemRegFldGet(devObjPtr,
        SMEM_SIP6_30_FDB_UNIT_HSR_PRP_GLOBAL_CONFIG_REG(devObjPtr),
        2,22,&DDESameKeyExpirationTime);
    __LOG_PARAM(DDESameKeyExpirationTime);

    smemRegFldGet(devObjPtr,
        SMEM_CHT_MAC_REG_DB_SIP5_GET(devObjPtr)->FDB.FDBCore.hsrPrp.ddeExpirationTimeConfig,
        0,22,&DDEExpirationTime);
    ...
    if(index == SMAIN_NOT_VALID_CNS)
    {
        index = snetSip6_30L2iFdbDdeEmptyEntryGet(devObjPtr,descrPtr,
            ...
            dde_enable_to_be_deleted_fdb_entry,
            dde_to_be_deleted_fdb_entry_address,
            &needCountInOverridenNonExpired);
    ...
    else /* HW issue : MTMISL-441 / CPSS-16406 */
    {
        __LOG(("doing 'empty entry' logic even for traffic that match the {SA,instance,sequenceNum} lookup \n"));
        /* the HW counting the 'overriden non expired' (Multi-hash row is full counter)
            even for traffic that match the lookup */

        (void)snetSip6_30L2iFdbDdeEmptyEntryGet(devObjPtr,descrPtr,
            calculatedHashArr,
            DDEExpirationTime,
            fdb_hrs_prp_timer,
            dde_enable_to_be_deleted_fdb_entry,
    ...
    if(needCountInOverridenNonExpired == GT_TRUE)/* need to count 'Overriden Non Expired Counter' */
    {
        regAddr = SMEM_SIP6_30_FDB_UNIT_HSR_PRP_OVERRIDEN_NON_EXPIRED_COUNTER_REG(devObjPtr);
        smemRegGet(devObjPtr,regAddr,&regValue);
        __LOG(("counter 'overriden non expired' (Multi-hash row is full counter) before increment by [%d] is [0x%8.8x] \n",1,regValue));
        smemRegSet(devObjPtr,regAddr,regValue+1);
    }
        ...
        case 1:     /*Bits[5:0] are EPG[5:0], Bits[8:6] are Tag1 UP, and Bit[9] is Tag1 DEI*/
            ...
            else
            {
                __LOG(("Update descrPtr->dstEpg according to fdbEntry->epg[0x%x] of DA lookup \n",
                    (daLookupInfoPtr->da_epg_streamId & 0x3F)));
                descrPtr->dstEpg = (daLookupInfoPtr->da_epg_streamId & 0x3F);

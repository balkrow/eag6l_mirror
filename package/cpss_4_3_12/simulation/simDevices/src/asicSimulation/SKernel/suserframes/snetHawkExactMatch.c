...
)
{
    ...
    regAddr = SMEM_FALCON_EXACT_MATCH_GLOBAL_CONFIGURATION_REG(devObjPtr,SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT,
                                                               emGlobalConfiguration1);
...
)
{
    ...
    regAddr = SMEM_SIP6_10_EXACT_MATCH_AUTO_LEARN_PROFILE_CONFIG_1_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT,
...
)
{
    ...
    *numberOfBanksPtr = numOfValidBanks;
    ...
    snetChetahDoInterrupt(devObjPtr,
              SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_INTERRUPT_CAUSE_REGISTER_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT),
              SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_INTERRUPT_MASK_REGISTER_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT),
              (1<<6),/*  Auto Learning Collision */
              0/*not used in sip5*/);

    /* set collision status */
    regAddr = SMEM_SIP6_10_AUTO_LEARN_COLLISION_STATUS_1_REGISTER_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT);
    ...
    if(collisionStatusValid == 0)
    {
        ...
        for (n=0; n<SIP6_EXACT_MATCH_MAX_KEY_SIZE_WORD_CNS; n++)
        {
            ...
            regAddr = SMEM_SIP6_10_AUTO_LEARN_COLLISION_STATUS_N_REGISTER_REG(devObjPtr,
                                                                              SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT,n);
    ...
    {
        /* update fail counter */
        regAddr = SMEM_SIP6_10_EXACT_MATCH_INDEX_FAIL_COUNTER_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT);
...
)
{
    ...
    regAddr = SMEM_SIP6_10_EXACT_MATCH_AUTO_LEARN_PROFILE_CONFIG_2_REG(devObjPtr,
                                                                       SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT,
                                                                       exactMatchProfileIndex);
    ...
    regAddr = SMEM_SIP6_10_EXACT_MATCH_AUTO_LEARN_PROFILE_CONFIG_3_REG(devObjPtr,
                                                                       SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT,
                                                                       exactMatchProfileIndex);
    ...
    regAddr = SMEM_SIP6_10_EXACT_MATCH_AUTO_LEARN_PROFILE_CONFIG_4_REG(devObjPtr,
                                                                       SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT,
                                                                       exactMatchProfileIndex);
    ...
    {
        /* clear bits */
        exactMatchEntryInfo.action_31_0 &= (~(0xFFFF<<flowIdBitOffset));
        /* set new value */
     ...
     else
    {
        ...
        {
            /* clear bits */
            exactMatchEntryInfo.action_63_32 &= (~(0xFFFF<<(flowIdBitOffset-32)));
            /* set new value */
            exactMatchEntryInfo.action_63_32 |= (newFlowId<<(flowIdBitOffset-32));
        }
        else
        {
            ...
            else
            {
                ...
                exactMatchEntryInfo.action_31_0 |= (newFlowId<<flowIdBitOffset);
                 /* clear bits */
                exactMatchEntryInfo.action_63_32 &= (~(0xFFFF>>bitsUsed));
                /* set new value */
    ...
    for (relativeBank = 0 ;relativeBank <= (GT_U32)exactMatchNewKeySize ;relativeBank ++ )
    {
        ...
        */
        ...
        if (devObjPtr->emNumOfBanks[instance] == 0)
        {
...
)
{
    ...
    regAddr = SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_STATUS_1_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT);
    ...
    if (rangeFull)
    {
        ...
        {
            /* update fail counter */
            regAddr = SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_FAIL_COUNTER_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT);
    ...
    regAddr = SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_STATUS_3_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT);
    ...
    regAddr = SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_CONFIG_2_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT);
    ...
    *freeFlowIdPtr = nextFlowId + ipfixBaseFlowId;
    ...
    regAddr = SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_STATUS_2_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT);
    ...
    regAddr = SMEM_SIP6_10_EXACT_MATCH_FLOW_ID_ALLOCATION_CONFIG_1_REG(devObjPtr, SIP6_EXACT_MATCH_UNIT_NUM_DEFAULT);

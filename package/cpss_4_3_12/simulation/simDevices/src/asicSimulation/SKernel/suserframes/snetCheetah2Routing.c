...
#define GET_HW_ROUTER_PACKET_COMMAND_NAME_MAC(/*IN*/hwRouterPacketCommand,/*OUT*/hwRouterPacketCommandName)      \
    ...
    {                                                                                                            \
        ...
        SWITCH_CASE_NAME_MAC(HW_ROUTER_PACKET_COMMAND_DEFAULT_ROUTE_ENTRY_E         ,hwRouterPacketCommandName); \
...
#define CMD_DEFAULT_ROUTE   HW_ROUTER_PACKET_COMMAND_DEFAULT_ROUTE_ENTRY_E
...
(
    ...
    IN  GT_BOOL                              checkDoneFromBridgeServices,
    OUT SNET_CHEETAH2_L3_CNTRL_PACKET_INFO  *cntrlPcktInfo
);

static GT_VOID snetCht3SipSaCheck
(
    IN  SKERNEL_DEVICE_OBJECT               *devObjPtr,
    IN  SKERNEL_FRAME_CHEETAH_DESCR_STC     *descrPtr,
    IN  SNET_ROUTE_SECURITY_CHECKS_INFO_STC *ipSecurChecksInfoPtr,
...
/* sip5 : hold value in bridge style for the matrix of convert router_style_packet_cmd and bridge_style_packet_cmd to bridge_style_packet_cmd
    different from sip4 , in sip5 the <soft drop> from bridge with <bridge+mirror>/<route+mirror> from router -->
    TRAP (and not 'soft drop' as sip4)

*/
static SKERNEL_EXT_PACKET_CMD_ENT sip5_cht2ResovedPacketl3intrabridgeCmdTable[SKERNEL_EXT_PKT_CMD_SOFT_DROP_E+1][HW_ROUTER_PACKET_COMMAND_BRIDGE_E+1]=
{
/*               CMD_ROUTE          | CMD_ROUTE_MIRR    | CMD_TRAP           |CMD_HARD_DROP| CMD_SOFT_DROP  | CMD_BRIDGE_MIRROR   | CMD_BRIDGE           */
/*forward   */ {PCK_FORWARD         , PCK_MIRROR_TO_CPU ,PCK_TRAP_TO_CPU     ,PCK_HARD_DROP, PCK_SOFT_DROP  , PCK_MIRROR_TO_CPU   , PCK_FORWARD          },
/*mirror    */ {PCK_MIRROR_TO_CPU   , PCK_MIRROR_TO_CPU ,PCK_TRAP_TO_CPU     ,PCK_HARD_DROP, PCK_TRAP_TO_CPU, PCK_MIRROR_TO_CPU   , PCK_MIRROR_TO_CPU    },
/*trap      */ {PCK_TRAP_TO_CPU     , PCK_TRAP_TO_CPU   ,PCK_TRAP_TO_CPU     ,PCK_HARD_DROP, PCK_TRAP_TO_CPU, PCK_TRAP_TO_CPU     , PCK_TRAP_TO_CPU      },
/*hard drop */ {PCK_HARD_DROP       , PCK_HARD_DROP     ,PCK_HARD_DROP       ,PCK_HARD_DROP, PCK_HARD_DROP  , PCK_HARD_DROP       , PCK_HARD_DROP        },
/*soft drop */ {PCK_SOFT_DROP       , PCK_TRAP_TO_CPU   ,PCK_TRAP_TO_CPU     ,PCK_HARD_DROP, PCK_SOFT_DROP  , PCK_TRAP_TO_CPU     , PCK_SOFT_DROP        }
};
...
#define SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_NAME                                  \
    ...
    ,STR(SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_MC_RPF_EVLAN_ID                 )\
    ...
    ,STR(SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_NHE_ROW_MODE                    )\
    ,STR(SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_0_MODE)\
    ,STR(SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_0_MODE)\
    ,STR(SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_1_MODE)\
    ,STR(SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_1_MODE)\
    ,STR(SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_2_MODE)\
    ,STR(SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_2_MODE)\
    ,STR(SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_3_MODE)\
    ,STR(SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_3_MODE)
    ...
    SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    /*MC_Vlan_Check = "rpf_check"*/
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_MC_RPF_EVLAN_ID            */
    ,{FIELD_SET_IN_RUNTIME_CNS,
         13,
         SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_MODIFY_UP}
...
static SNET_ENTRY_FORMAT_TABLE_STC sip7IpvxNextHopTableFieldsFormat[
    SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS___LAST_VALUE___E] =
{
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_PACKET_CMD                           */
    STANDARD_FIELD_MAC(3)
    ...
    ,STANDARD_FIELD_MAC(2)
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_INGRESS_MIRROR_TO_ANALYZER_INDEX     */
    ,STANDARD_FIELD_MAC(6)/* was 3 in sip5 */
        /*enable_vid1_unicast_routing = 1*/
        /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_NEXT_HOP_VID1                        */
    ,    {FIELD_SET_IN_RUNTIME_CNS,
         12,
    ...
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_NEXT_HOP_EVLAN                       */
    ,EXPLICIT_FIELD_MAC(28,16)/* was 13 in sip5, was 15 in sip6 */
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_USE_VIDX                             */
    ,STANDARD_FIELD_MAC(1)
        /* useVidx = 1 */
        /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_EVIDX                                */
    ...
    ,        {FIELD_SET_IN_RUNTIME_CNS,
            ...
            /* isTrunk = 0 */
            /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_TRG_EPORT                            */
            ,EXPLICIT_FIELD_MAC(47,15)/* was 13 in sip 5, and 14 in sip5_20 */
    ...
    ,STANDARD_FIELD_MAC(1)
        ...
        /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_ARP_PTR                              */
    ,    {FIELD_SET_IN_RUNTIME_CNS,
         20, /*was 17 in sip 5, was 18 in sip 5_20 */
         SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_START_OF_TUNNEL}

        /* isTunnel = 1 */
        /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_TUNNEL_PTR                           */
    ,    {FIELD_SET_IN_RUNTIME_CNS,
         19, /*was 15 in sip 5, was 16 in sip 5_20*/
         SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_START_OF_TUNNEL}
        /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_RESERVED*/
    ,    STANDARD_FIELD_MAC(0)
        /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_TS_IS_NAT                            */
    ,   {104,1,0}/*start at bit 104 */
        /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_TUNNEL_TYPE                          */
    ,    STANDARD_FIELD_MAC(1)
    ...
    /*MC_Vlan_Check = "rpf_check"*/
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_MC_RPF_EVLAN_ID            */
    ,{28,16,0}/*start at bit 28.  was 13 in sip5, was 15 in sip6 */

    /*MC_Vlan_Check = "bidir_tree_check"*/
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_MC_RPF_EVLAN_MRST_ID            */
    ,{28,6,0}/*start at bit 28*/

     /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_MC_ING_VLAN_CHECK_FAIL_CMD      */
    ,{51,3,0}/*start at bit 51 */
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_MC_RPF_FAIL_CMD_MODE            */
    ,STANDARD_FIELD_MAC(1)
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_MC_INTERNAL_MLL_PTR             */
    ,{55,18,0}/*in sip6 it start at bit 53 and have 16 bits in sip7 start at bit 52 and has 18 bits */
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_IPV6_MC_EXTERNAL_MLL_POINTER_MSBITS  */
    ,STANDARD_FIELD_MAC(0)/* in sip7 this is not used instead we have 18 consecutive bits */
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_MC_ING_VLAN_CHECK               */
    ,{78,2,0}/*start at bit 78 */
    /*SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_IPV6_MC_EXTERNAL_MLL_POINTER         */
    ,STANDARD_FIELD_MAC(18)/* was 16 in sip5_20, in sip7 it is 18 */
...
/*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_TARGET_VPORT*/
    ,{FIELD_SET_IN_RUNTIME_CNS,
     ...
     /*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_NHE_ROW_MODE               */
     ,EXPLICIT_FIELD_MAC(128,1)

    /*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_0_MODE*/
    ,EXPLICIT_FIELD_MAC(0,8)
    /*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_0_MODE*/
    ,EXPLICIT_FIELD_MAC(8,18)
    /*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_1_MODE*/
    ,EXPLICIT_FIELD_MAC(26,8)
    /*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_1_MODE*/
    ,EXPLICIT_FIELD_MAC(34,18)
    /*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_2_MODE*/
    ,EXPLICIT_FIELD_MAC(52,8)
    /*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_2_MODE*/
    ,EXPLICIT_FIELD_MAC(60,18)
    /*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_3_MODE*/
    ,EXPLICIT_FIELD_MAC(78,8)
    /*SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_3_MODE*/
    ,EXPLICIT_FIELD_MAC(86,18)
};
...
{
    DECLARE_FUNC_NAME(snetCht2ArpTrigger);
    ...
    if (descrPtr->packetCmd == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E)
    {
     /* Enable router engine services for bridged ARP packets that were assigned
        ...
        if (fldVal == 0)
        {
            __LOG(("The Router in Global config register in not allow ARP 'SOFT_DROP' to be processed \n"));
            return GT_FALSE;
        }
    }
    ...
    if (descrPtr->packetCmd == SKERNEL_EXT_PKT_CMD_TRAP_TO_CPU_E)
    {
     /* Enable router engine services for bridged ARP packets that were assigned
        ...
        if (fldVal == 0)
        {
            __LOG(("The Router in Global config register in not allow ARP 'TRAP_TO_CPU' to be processed \n"));
            return GT_FALSE;
        }
    }
    ...
    {
        __LOG(("The Router not allow ARP 'TRAP_TO_CPU/MIRROR_TO_CPU' to be processed \n"));
        return GT_FALSE;
    }
    ...
    if (fldVal == 0)
    {
        __LOG(("The Router in Global config register in not allow ARP (of any kind) to be processed \n"));
        return GT_FALSE;
    }
    ...
    {
        __LOG(("The Router in bypassBridge == 1 not allow ARP to be processed \n"));
        return GT_FALSE;
    }
    ...
    if (descrPtr->ingressVlanInfo.ipInterfaceEn == GT_FALSE)
    {
        ...
        __LOG(("The Router in ipInterfaceEn == 0 not allow ARP to be processed \n"));
        return GT_FALSE;
    }
...
{
    DECLARE_FUNC_NAME(snetCht2IPv4MCTrigger);
    ...
    if(status == GT_FALSE)
    {
        __LOG(("The Router in Global config register in not allow IPV4 Mc 'SOFT_DROP' to be processed \n"));
        return GT_FALSE;
    }
    ...
    if (status == GT_FALSE)
    {
        __LOG(("The Router in Global config register in not allow IPV4 MC 'TRAP_TO_CPU' to be processed \n"));
        return GT_FALSE;
    }
    ...
    if (status == GT_FALSE)
    {
        __LOG(("The Router in 'per src port'[%d] in not allow IPV4 MC to be processed \n",
    ...
    if(descrPtr->tunnelTerminated)
    {
        if (status == GT_FALSE)
        {
            __LOG(("The Router in 'ipv4McRoutEn == 0 (from vlan)' not allow 'tunnel terminated' IPV4 MC to be processed \n"));
        }
    ...
    {
        status = GT_FALSE;
        __LOG(("The Router in 'ipv4McRoutEn == 0'(from vlan) or 'ipV4mcvlan == 0' (from vlan) not allow IPV4 MC to be processed \n"));
    }

    /* bypass router for igmp packets */
    if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        smemRegFldGet(devObjPtr, SMEM_CHT2_L3_ROUTE_GLB_CONTROL_REG(devObjPtr), 4, 1, &fldVal);
        if(fldVal && ((descrPtr->igmpQuery != 0) || (descrPtr->igmpNonQuery != 0)))
        {
            status = GT_FALSE;
            __LOG(("The Router wasn't triggered because packet is IPv4 MC IGMP and CFG<bypass_router> enabled"));
        }
    }
...
{
    DECLARE_FUNC_NAME(snetCht2IPv6MCTrigger);
    ...
    if(status == GT_FALSE)
    {
        __LOG(("The Router in Global config register in not allow IPV6 Mc 'SOFT_DROP' to be processed \n"));
        return GT_FALSE;
    }
    ...
    if (status == GT_FALSE)
    {
        __LOG(("The Router in Global config register in not allow IPV6 MC 'TRAP_TO_CPU' to be processed \n"));
        return GT_FALSE;
    }
    ...
    if (status == GT_FALSE)
    {
        __LOG(("The Router in 'per src port'[%d] in not allow IPV6 MC to be processed \n",
            SMEM_CHT_IS_SIP5_GET(devObjPtr) ?
            descrPtr->eArchExtInfo.localDevSrcEPort :
            descrPtr->localDevSrcPort));
        return GT_FALSE;
    ...
    if(descrPtr->tunnelTerminated)
    {
        if (status == GT_FALSE)
        {
            __LOG(("The Router in 'ipv6McRoutEn == 0 (from vlan)' not allow 'tunnel terminated' IPV6 MC to be processed \n"));
        }
        /* not need extra checks */
        return status;
    }
    ...
    {
        status = GT_FALSE;
        __LOG(("The Router in 'ipv6McRoutEn == 0'(from vlan) or 'ipV6mcvlan == 0' (from vlan) not allow IPV6 MC to be processed \n"));
    }

    /* bypass router for mld packets */
    if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        smemRegFldGet(devObjPtr, SMEM_CHT2_L3_ROUTE_GLB_CONTROL_REG(devObjPtr), 4, 1, &fldVal);
        if(fldVal && descrPtr->isIpv6Mld)
        {
            status = GT_FALSE;
            __LOG(("The Router wasn't triggered because packet is IPv6 MC MLD and CFG<bypass_router> enabled"));
        }
    }
...
)
{
    ...
    {   /* Check IPv4 Header errors */
        ...
        if (descrPtr->brdgUcIpHeaderCheck == GT_FALSE)
        {
    ...
    return isException;     /* return code */
}
...
)
{
    ...
    if ((srcIp == 0xFFFFFFFF) && (SMEM_CHT_IS_SIP5_GET(devObjPtr)))
    {
        /* Check if BC considered as illegal SIP */
        smemRegFldGet(devObjPtr, SMEM_CHT2_L3_ROUTE_CONTROL1_IPV4_REG(devObjPtr), 6, 1, &fldVal);
        if(fldVal == 1)
        {
            error = GT_TRUE;
        }
...
)
{
    ...
    if(((descrPtr->ipm == 0) && (descrPtr->tunnelTerminated == 1)) || ((descrPtr->macDaPtr[0] & 0x1) == 0))
    {
...
)
{
    ...
    /* IPv4 UC mismatch check */
    if(snetCht2IPv4UCTrigger(devObjPtr, descrPtr) &&
       (descrPtr->ipm == 1) &&
       (ipdipVersion == 0xe))
    {
    ...
    if((snetCht2IPv4MCTrigger(devObjPtr, descrPtr) && descrPtr->macDaType==SKERNEL_MULTICAST_MAC_E) &&
         (((ipdipVersion != 0xe) && (ipdipVersion != 0xf)) ||
           (descrPtr->macDaPtr[0] != 0x01) ||
           (descrPtr->macDaPtr[1] != 0x00) ||
           (descrPtr->macDaPtr[2] != 0x5E) ||
           (fldVal != 0) ||
           (ipMacMismatch != ipMacMismatch2) ))
    {
...
)
{
    ...
    {/* Unicast packet */
        ...
        {
            __LOG(("Unicast IPv6 packet with MC DIP"));
    ...
    else /* Packet is Multicast */
    {
        ...
        {
            __LOG(("Multicast IPv6 packet with mismatch DIP"));
...
)
{
    ...
    smemRegFldGet(devObjPtr, SMEM_CHT2_L3_ROUTE_GLB_CONTROL_REG(devObjPtr), fieldOffset, 1, &fldVal);
    if (fldVal == 0)
    {
...
* @param[in] checkDoneFromBridgeServices - GT_TRUE: SIP/SA check is done from bridge services
*                                          GT_FALSE: SIP/SA check is done from route services
*
...
)
{
    ...
    if((SMEM_CHT_IS_SIP5_GET(devObjPtr)) &&
       ...
       (ipSecurChecksInfoPtr->rpfCheckMode != SNET_RPF_DISABLED_E))
    {
    ...
    if((SMEM_CHT_IS_SIP5_GET(devObjPtr)) &&
       ...
       (ipSecurChecksInfoPtr->rpfCheckMode == SNET_RPF_DISABLED_E))
    {
        smemRegFldGet(devObjPtr, SMEM_CHT2_ROUTER_ADDITIONAL_CONTROL_REG(devObjPtr), 5, 1, &fldVal);
        if(fldVal == 1)
        {
            /* In Design implementation, when SIP NHE is of type ECMP,
               the eVLAN <uRPF Mode> is available only after accessing the NHE and so
               if LTT<EnURPF> is disabled then design will not access the SIP_ECMP entry (the extra ECMP entry) */
            __LOG(("Global uRPF for ECMP/Qos is enabled and LTT<EnURPF> is disabled, so Unicast IPv4/6 SIP Filtering is not performed for ecmp/qos block"));
            return;
        }
    }
    ...
    {
        smemRegFldGet(devObjPtr, SMEM_CHT2_L3_ROUTE_GLB_CONTROL_REG(devObjPtr), 17 + offsetShift, 1, &fldVal);
    }
    else
    {
       ...
       (descrPtr->ipServiceFlag == GT_FALSE && fldVal))
    {
        ...
        if (fldVal)
        {
            ...
            if (checkDoneFromBridgeServices==GT_TRUE)
            {
...
)
{
    ...
    if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        if((descrPtr->isIp) && (!descrPtr->isIPv4)) /* Ipv6 */
        {
            sipAccessLevel += 64;
        }
        else if(descrPtr->isFcoe)
...
)
{
    ...
    /* concerns only loose urpf feature. otherwise it's consider as Route */
    if(cntrlPcktInfo->ipvRouteEntry03Cmd == HW_ROUTER_PACKET_COMMAND_DEFAULT_ROUTE_ENTRY_E)
    {
    ...
    if(0 == fdbDipLookupInfoPtr->isValid && SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        ...
        smemRegFldGet(devObjPtr, SMEM_CHT2_L3_ROUTE_GLB_CONTROL_REG(devObjPtr), fieldOffset, fieldSize, &nhMuxMode);
    ...
    if(isEntryRouteCmd)
    {
        if (descrPtr->ipm == 0)
        {
            ...
            else
            {
                ...
                else  /* not evidx and not trunk */
                {
                    if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
                    {
                        nextHopFieldName = SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_TARGET_IS_VPORT;
                        if(fdbDipLookupInfoPtr->isValid && fdbDipLookupInfoPtr->routeType)
                        {
                            localDescrPtr->trgIsVPort = SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(devObjPtr,primaryNextHopEntryPtr, nextHopIndex, nextHopFieldName);
                        }
                        else
                        {
                            localDescrPtr->trgIsVPort =
                            fdbDipLookupInfoPtr->isValid ? fdbDipLookupInfoPtr->trg_isVPort :
                            SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(devObjPtr,primaryNextHopEntryPtr, nextHopIndex,nextHopFieldName);
                        }
                        __LOG_PARAM(localDescrPtr->trgIsVPort);
                    }

                    if(localDescrPtr->trgIsVPort)/*only in sip7*/
                    {
                        nextHopFieldName = SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_TARGET_VPORT;
                        if(fdbDipLookupInfoPtr->isValid && fdbDipLookupInfoPtr->routeType)
                        {
                            localDescrPtr->trgVPort = SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(devObjPtr,primaryNextHopEntryPtr, nextHopIndex, nextHopFieldName);
                        }
                        else
                        {
                            localDescrPtr->trgVPort =
                            fdbDipLookupInfoPtr->isValid ? fdbDipLookupInfoPtr->trg_vportNum :
                            SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(devObjPtr,primaryNextHopEntryPtr, nextHopIndex,nextHopFieldName);
                        }
                        __LOG_PARAM(localDescrPtr->trgVPort);

                        /* called after setting trgVPort */
                        SIP7_INVALIDATE_TRG_EPORT_TRG_DEV_MAC(devObjPtr,localDescrPtr,ipvx);
                    }
                    else
                    {
            ...
            if(localDescrPtr->tunnelStart)
            {
                ...
                if(localDescrPtr->trgIsVPort)
                {
                    /* from IAS :
                    In case of assigning target vPort it is the user responsibility not to assign tunnel start.
                    Therefore the descriptor values would be Desc<Tunnel Start>=0 and Desc<Do Route HA>=1 */
                    __LOG(("Warning : potential configuration error : the NH set to 'vport' and 'tunnel start' \n"));
                }
    ...
    if(descrPtr->ipm)/* regardless to isEntryRouteCmd */
    {
        if(isIpv6)
        {
            ...
            /* sip7 has all 18 bits stored in SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_IPV6_MC_EXTERNAL_MLL_POINTER
               no need to read 3 extra bits */
            if(( SMEM_CHT_IS_SIP5_GET(devObjPtr))&&(!SMEM_CHT_IS_SIP7_GET(devObjPtr)))
            {
    ...
    if( (SMEM_CHT_IS_SIP5_GET(devObjPtr)) || (isEntryRouteCmd) )
    {
        ...
        if (bypassTtlCheck == 0 && descrPtr->isFcoe == 0)
        {
            ...
            if ((localDescrPtr->ttl == 0) || ((localDescrPtr->ttl == 1) && (descrPtr->decTtl)))
            {
                ...
                {
                    smemRegFldGet(devObjPtr, regAddr, 18, 3, &fldVal);
                }
    ...
    if(SMEM_CHT_IS_SIP6_GET(devObjPtr) && fdbDipLookupInfoPtr->isValid && fdbDipLookupInfoPtr->routeType)
    {
        icmpEn = SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(devObjPtr,primaryNextHopEntryPtr, nextHopIndex,nextHopFieldName);
    }
    else
    {
        icmpEn = fdbDipLookupInfoPtr->isValid ? fdbDipLookupInfoPtr->icmpRedirectExceptionMirror :
                SMEM_CHT_IS_SIP5_GET(devObjPtr) ?
                 SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(devObjPtr,primaryNextHopEntryPtr, nextHopIndex,nextHopFieldName) :
    ...
    if (icmpEn &&
        (!descrPtr->ipm) && /*ICMP redirection is applicable only for UC*/
        cntrlPcktInfo->ipvRouteEntry03Cmd == HW_ROUTER_PACKET_COMMAND_ROUTE_E)
    {
        GT_BIT needIcmpRedirect = 0;
        if(localDescrPtr->trgIsVPort == 0 &&

            descrPtr->eVid == entryVid)
        {
            needIcmpRedirect = 1;
            if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
            {
                __LOG(("ICMP Redirect due to same target vlan [%d] (non-vport mode)\n",entryVid));
            }
            else
            {
                __LOG(("ICMP Redirect due to same target vlan [%d] \n",entryVid));
            }
        }
        else
        if((descrPtr->origIsTrunk == 0 && descrPtr->srcIsVPort == 1) &&
           (localDescrPtr->useVidx == 0 && localDescrPtr->targetIsTrunk == 0 && localDescrPtr->trgIsVPort == 1) &&
           (localDescrPtr->trgVPort == descrPtr->trgVPort))
        {
            needIcmpRedirect = 1;
            __LOG(("ICMP Redirect due to the same trg vport [%d] \n",
                descrPtr->trgVPort));
        }
        ...
        if(isSipLookupPerformed == GT_TRUE)
        {
            ...
            if(fdbDipLookupInfoPtr->isValid)
            {
                ...
                snetCht2SipFiltering(devObjPtr, descrPtr, ipSecurChecksInfoPtr,
                                        sipNextHopEntryPtr, sipNextHopIndex, GT_FALSE, cntrlPcktInfo);
            }
            else
            {
                __LOG(("Unicast SIP Filtering"));
                snetCht2SipFiltering(devObjPtr, descrPtr, ipSecurChecksInfoPtr,
                                        primaryNextHopEntryPtr, nextHopIndex, GT_FALSE, cntrlPcktInfo);
            }
            ...
            snetCht3URpfCheck(devObjPtr, descrPtr, routeIndexPtr, ipSecurChecksInfoPtr,
                                        vid1UnicastRoutingEn, nextHopVid1, GT_FALSE, cntrlPcktInfo);
            ...
            {
                __LOG(("Unicast SIP/SA Packet check"));
                snetCht3SipSaCheck(devObjPtr, descrPtr,ipSecurChecksInfoPtr,
                                   sipNextHopEntryPtr, sipNextHopIndex ,GT_FALSE, cntrlPcktInfo);
            }
        }
    ...
    {/* Multicast IPv4/6 Packet RPF check */
        ...
        if(1 == fldVal && (descrPtr->eVid != entryVid))
        {
            ...
            if(ipSecurChecksInfoPtr->mcRpfFailCmdFromMll)
            {
                cntrlPcktInfo->isMcRpfFailCmdFromMll = 1;

                __LOG_PARAM(cntrlPcktInfo->isMcRpfFailCmdFromMll);
            }
    ...
    if (isIpv6 == 0)
    {
        ...
        if (descrPtr->sip[0] == 0)   /*  IP ADDRESS 0.0.0.0 */
        {
            if (descrPtr->ipm == 0) /*  unicast packet */
            {
                if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
                {
                    switch(SMEM_U32_GET_FIELD(fldVal, 21, 3))
                    {
                        case 0:
                            cntrlPcktInfo->ipvAllZeroCmd =  HW_ROUTER_PACKET_COMMAND_ROUTE_E;
                            break;
                        case 1:
                            cntrlPcktInfo->ipvAllZeroCmd =  HW_ROUTER_PACKET_COMMAND_ROUTE_AND_MIRROR_TO_CPU_E;
                            break;
                        case 2:
                            cntrlPcktInfo->ipvAllZeroCmd =  HW_ROUTER_PACKET_COMMAND_TRAP_TO_CPU_E;
                            break;
                        case 3:
                            cntrlPcktInfo->ipvAllZeroCmd =  HW_ROUTER_PACKET_COMMAND_HARD_DROP_E;
                            break;
                        case 4:
                            cntrlPcktInfo->ipvAllZeroCmd =  HW_ROUTER_PACKET_COMMAND_SOFT_DROP_E;
                            break;
                        default:
                            __LOG(("Illegal UC IPv4 All Zero SIP command"));
                            break;
                    }
    ...
    else /*ipv6*/
    {
            ...
            (descrPtr->sip[3] == 0 ))
        {
            if (descrPtr->ipm == 0) /*  unicast packet */
            {
                if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
                {
                    switch(SMEM_U32_GET_FIELD(fldVal, 0, 3))
                    {
                        case 0:
                            cntrlPcktInfo->ipvAllZeroCmd =  HW_ROUTER_PACKET_COMMAND_ROUTE_E;
                            break;
                        ...
                        case 4:
                            ...
                            break;
                        default:
                            __LOG(("Illegal UC IPv6 All Zero SIP command"));
                            break;
                    }
            ...
            else
            {
                ...
                if ((SMEM_U32_GET_FIELD(fldVal, fieldOffset, 1)))
                {
                    cntrlPcktInfo->ipvAllZeroCmd =  HW_ROUTER_PACKET_COMMAND_BRIDGE_E ;
                    logRouterPacketCommand(devObjPtr,
                        NAME_AND_VALUE_MAC(cntrlPcktInfo->ipvAllZeroCmd));
    ...
    if(SMEM_CHT_IS_SIP6_30_GET(devObjPtr) && fdbDipLookupInfoPtr->isValid)
    {
        __LOG(("use <trgEpg> [0x%x]from the FDB entry \n",
            fdbDipLookupInfoPtr->trgEpg));
        localDescrPtr->dstEpg = fdbDipLookupInfoPtr->trgEpg;
    }
    else
    if(nhMuxMode == 1)
    {
    ...
    else
    {
        ...
        if(!SMEM_CHT_IS_SIP6_30_GET(devObjPtr))
        {
            targetEpgFromNh &= 0x1ff; /* In SIP 6.30 changed from 9 to 12 bits */
        }
        __LOG(("Router EPG: targetEpgFromNh %d \n",targetEpgFromNh));

        if (targetEpgFromNh &&
                ((((!descrPtr->ipm) && ((nhMuxMode == 2)||(nhMuxMode == 3))) && (!SMEM_CHT_IS_SIP6_30_GET(devObjPtr))) ||
                 (((!descrPtr->ipm) && ((nhMuxMode == 4)||(nhMuxMode == 5))) && (SMEM_CHT_IS_SIP6_30_GET(devObjPtr))) ||
                   ((descrPtr->ipm && (nhMuxMode == 3)) && (!SMEM_CHT_IS_SIP6_30_GET(devObjPtr))) ||
                   ((descrPtr->ipm && (nhMuxMode == 5)) && (SMEM_CHT_IS_SIP6_30_GET(devObjPtr)))))
        {
            if (SMEM_CHT_IS_SIP6_30_GET(devObjPtr))
            {
    ...
    if(cntrlPcktInfo->ipvAllZeroCmd > HW_ROUTER_PACKET_COMMAND_ROUTE_AND_MIRROR_TO_CPU_E)
    {
        skipAging = GT_TRUE;
    }
    ...
    __LOG(("Route Refresh Aging En [%d], skipAging[%d]\n",
        fldVal, skipAging));
    if((fldVal) && (!skipAging))
    {
...
{
    HW_ROUTER_PACKET_COMMAND_E cmd = currCmd;
    if(currCmd == HW_ROUTER_PACKET_COMMAND_DEFAULT_ROUTE_ENTRY_E)
    {
        cmd = HW_ROUTER_PACKET_COMMAND_ROUTE_E;
    }
    if(prevCmd > HW_ROUTER_PACKET_COMMAND_BRIDGE_E ||
       cmd > HW_ROUTER_PACKET_COMMAND_BRIDGE_E)
    {
        /* fatal error */
        skernelFatalError("snetCht2IntraRouterPktCmdResolution: bad parameters \n");
    }

    return  cht2ResovedPacketl3intrarouterCmdTable[prevCmd][cmd];
}
...
{
    DECLARE_FUNC_NAME(snetCht2InterBridgeRouterPktCmdResolution);
    ...
    if(SMEM_CHT_IS_SIP5_GET(devObjPtr))
    {
        /* CPSS-15683 : [WM][SCT]Multiple engines assign packet command to CPU
            this issue show that the actual :
            <soft drop> from bridge with <bridge+mirror>/<route+mirror> from router -->
            TRAP (not 'soft drop' that described in the the FS)

            So sip5 devices uses different table for resolution.
        */
        if(bridgeCmd == PCK_SOFT_DROP && (routerCmd == CMD_ROUTE_MIRR || routerCmd == CMD_BRIDGE_MIRROR))
        {
            __LOG(("NOTE: router packet command resolution for : <soft drop> from bridge with <bridge+mirror>/<route+mirror> from router --> TRAP (not 'soft drop' that described in the the FS)\n"));
        }

        return sip5_cht2ResovedPacketl3intrabridgeCmdTable[bridgeCmd][routerCmd];
    }
...
)
{
    ...
    /* No further routing process for ARP broadcast packets.
       in case of UC Rpf Fail/ SIP filtering/SIP SA mismatch,
       for ARP packets we need to continue with the command resolution */
    if ((descrPtr->arp)&&
        (cntrlPcktInfo->ipSaMismatchCmd==HW_ROUTER_PACKET_COMMAND_ROUTE_E)&&
        (cntrlPcktInfo->ipvUcRpfRailCmd==HW_ROUTER_PACKET_COMMAND_ROUTE_E)&&
        (cntrlPcktInfo->ipvSipFilterCmd==HW_ROUTER_PACKET_COMMAND_ROUTE_E))
    {
...
*/
    ...
    if (IS_CPU_CODE_NEEDED_MAC(cntrlPcktInfo->ipvOptionHbhOptionFailCmd,doRout))
    {
        ...
        else
        {
            ...
            {
                descrPtr->cpuCode = SNET_CHT_IPV6_NON_HBH_OPTIONS;
            }
        }
    }
    else
...
*/
GT_BOOL snetCht2L3iGetRpfFailCmdFromMll
(
    IN SKERNEL_DEVICE_OBJECT                    * devObjPtr,
    IN SKERNEL_FRAME_CHEETAH_DESCR_STC          * descrPtr,
...
)
{
    ...
    GT_U32  isRouted;
    GT_BOOL mllEn = GT_FALSE;
    GT_BOOL doRouteHa = GT_FALSE;
    ...
    isMc = ((((descrPtr->ipm == 1) && (descrPtr->tunnelTerminated == 1)) || ((descrPtr->macDaPtr[0] & 0x1) == 1))) ? GT_TRUE : GT_FALSE;
    ...
    if ((fdbDipLookupInfo.isValid == GT_TRUE) && (descrPtr->fdbBasedUcRouting) &&
        (descrPtr->lpmLookupPriority == 0) && (fdbDipLookupInfo.routeType == 1))
    {
        /* For devices before Hawk, FDB pointer type pointing to ECMP is not supported */
        if ((fdbDipLookupInfo.pointerType == 1) || (SMEM_CHT_IS_SIP6_10_GET(devObjPtr)))
        {
            isValidFdbPointerNextHop = GT_TRUE;
            fdbPointerNextHop = routeIndexPtr[2];
        }
    }
    ...
    if((cntrlPcktInfoPtr->ipvFinalPacketCmd <= HW_ROUTER_PACKET_COMMAND_ROUTE_AND_MIRROR_TO_CPU_E) &&
       (descrPtr->packetCmd <= SKERNEL_EXT_PKT_CMD_MIRROR_TO_CPU_E))
    {
        mllEn = (descrPtr->ipm == 1) ? GT_TRUE : GT_FALSE;
    }
    ...
    if((cntrlPcktInfoPtr->ipvFinalPacketCmd <= HW_ROUTER_PACKET_COMMAND_ROUTE_AND_MIRROR_TO_CPU_E) &&
       (descrPtr->packetCmd <= SKERNEL_EXT_PKT_CMD_MIRROR_TO_CPU_E) &&
       (cntrlPcktInfoPtr->isMcRpfFail == 0))
    {
        doRouteHa = GT_TRUE;
    }
    __LOG_PARAM(doRouteHa);

    isRouted = descrPtr->packetCmd <= SKERNEL_EXT_PKT_CMD_MIRROR_TO_CPU_E &&
               (descrPtr->ipm == 0 ?
               (doRouteHa == GT_TRUE) :
               (!(mllEn == GT_FALSE || cntrlPcktInfoPtr->isMcRpfFail == 1)));
    ...
    */
    ...
    if (isRouted == 1 && inUcMcNonRoutedExceptionPacketCounter)
    {
        inUcMcNonRoutedExceptionPacketCounter = 0;
        __LOG_PARAM(inUcMcNonRoutedExceptionPacketCounter);
    }
    ...
    if(inUcMcNonRoutedExceptionPacketCounter == 0)
    {
        ...
        */
        ...
        __LOG_PARAM(cntrlPcktInfoPtr->ipvNextHopPacketCmd);
        if(cntrlPcktInfoPtr->ipvFinalPacketCmd == HW_ROUTER_PACKET_COMMAND_ROUTE_AND_MIRROR_TO_CPU_E &&
           cntrlPcktInfoPtr->bridgePacketCmd   == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E)
        {
            /* do behavior according to : tests in JIRA : CPSS-15683 */
            /* emulate JIRA : IPVX-329 : [BM][SCT] Router counter 'inUcTrappedMirrorPkts' issue*/
            /* issue 'warning' to the log to notify that this is not the expected behavior */
            __LOG(("WARNING : 'soft drop' from bridge with 'bridge/route + mirror_to_cpu' from router , are counted as 'inUcMcNonRoutedNonExceptionPacketCounter' \n"));
            inUcMcNonRoutedNonExceptionPacketCounter = 1;
        }
    }
    else
    {
    ...
    */
    ...
    {
        if(cntrlPcktInfoPtr->ipvFinalPacketCmd != HW_ROUTER_PACKET_COMMAND_TRAP_TO_CPU_E &&
           cntrlPcktInfoPtr->bridgePacketCmd   == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E)
        {
            /* do behavior according to : tests in JIRA : CPSS-15683 */
            /* emulate JIRA : IPVX-329 : [BM][SCT] Router counter 'inUcTrappedMirrorPkts' issue*/
            /* issue 'warning' to the log to notify that this is not the expected behavior */
            __LOG(("WARNING : 'soft drop' from bridge with 'bridge/route + mirror_to_cpu' from router , are NOT counted as 'inUcMcTrappedMirroredPacketCounter' \n"));
        }
        else
        {
    ...
    */
    if(cntrlPcktInfoPtr->isMcRpfFail || cntrlPcktInfoPtr->isMcRpfBidirFail)
    {
        ...
        /* it shouldn't update by packets trapped by MLL command  */
        if(cntrlPcktInfoPtr->isMcRpfFailCmdFromMll)
        {
            inUcMcTrappedMirroredPacketCounter = 0;
        }
    }
    ...
    */
    ...
    if(outUnicastPacketCounter &&
       cntrlPcktInfoPtr->ipvFinalPacketCmd == HW_ROUTER_PACKET_COMMAND_ROUTE_AND_MIRROR_TO_CPU_E &&
       cntrlPcktInfoPtr->bridgePacketCmd   == SKERNEL_EXT_PKT_CMD_SOFT_DROP_E)
    {
        /* do behavior according to : tests in JIRA : CPSS-15683 */
        __LOG(("WARNING : 'soft drop' from bridge with 'bridge/route + mirror_to_cpu' from router , are NOT counted as 'outUnicastPacketCounter' \n"));
        outUnicastPacketCounter = 0;
    }

    __LOG_PARAM(outUnicastPacketCounter);


    if(isValidFdbPointerNextHop == GT_TRUE)
    {
        fdbCounterSet = counterSet;/* from NH */
    }
    else
    if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        /* the counterSetIndex not comes from the FDB entry , but comes from
           global config in the IPVX unit */
        smemRegFldGet(devObjPtr ,
            SMEM_SIP5_25_IPVX_ROUTER_ADDITIONAL_CONTROL_3_REG(devObjPtr),
            3,3, &fdbCounterSet);
        __LOG(("Sip7 : 'fdbCounterSet' (ipvx unit global config) : [%d] \n",fdbCounterSet));
        if(fdbCounterSet > 3)
        {
            __LOG(("Fdb Counter Set [%d] considered as 'not bound'(still allow possible count on source interface) \n",
                counterSet));
            /* still allow possible count on source interface */
        }
    }
    ...
    {
        fdbCounterSet = fdbDipLookupInfo.counterSetIndex;
        if(fdbDipLookupInfo.counterSetIndex == 3)/* 2 bits value come from the FDB entry , value 3 means 'no count' */
        {
            fdbCounterSet = 4;/* No management counter set associated with this route entry */

            if(isValidFdbPointerNextHop == GT_FALSE)
            {
                __LOG(("FDB entry : No management counter set associated with this route entry (from FDB) \n"));
            }
        }
    }
...
)
{
    ...
    GT_U32 * regPtr;                /* Register entry pointer                      */
    GT_U32 * regPtr1;               /* Register entry pointer                      */
    ...
    /* it shouldn't update by packets by MLL command  */
    if(cntrlPcktInfoPtr->isMcRpfFailCmdFromMll)
    {
        __LOG(("Packet dropped by MLL should not be counted by the IPvX unit \n"));
        return;
    }
    ...
    __LOG(("check cntset_mode = [%d] \n", cntset_mode));

    doCount = 0;
    if (cntset_mode == 0)
    {
        __LOG(("update on any of the drop reasons \n"));
        dropNamePtr = "CountAllDropReasons";
        doCount = 1;
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipHeaderCmd))
    {
        if(cntset_mode == 1)
        {
            dropNamePtr = "ipHeaderCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipDaMismatchCmd))
    {
        if(cntset_mode == 2)
        {
            dropNamePtr = "ipDaMismatchCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipIllegalAddrCmd))
    {
        if(cntset_mode == 3)
        {
            dropNamePtr = "ipIllegalAddrCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipvAllZeroCmd))
    {
        if(cntset_mode == 4)
        {
            dropNamePtr = "ipvAllZeroCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipSaMismatchCmd))
    {
        if(cntset_mode == 5)
        {
            dropNamePtr = "ipSaMismatchCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipvUcRpfRailCmd))
    {
        if(cntset_mode == 6)
        {
            dropNamePtr = "ipvUcRpfRailCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipvRouteEntry03Cmd))
    {
        if(cntset_mode == 7)
        {
            dropNamePtr = "ipvRouteEntry03Cmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipvMcRpfFailCmd))
    {
        if(cntset_mode == 8)
        {
            dropNamePtr = "ipvMcRpfFailCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipvHopLimitExceededFailCmd))
    {
        if(cntset_mode == 9)
        {
            dropNamePtr = "ipvHopLimitExceededFailCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipvRouteMtuExcceededFailCmd))
    {
        if(cntset_mode == 10)
        {
            dropNamePtr = "ipvRouteMtuExcceededFailCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipvOptionHbhOptionFailCmd))
    {
        if(cntset_mode == 11)
        {
            dropNamePtr = "ipvOptionHbhOptionFailCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipv6ScopeFailCmd))
    {
        if(cntset_mode == 13)
        {
            dropNamePtr = "ipv6ScopeFailCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipvSipFilterCmd))
    {
        if(cntset_mode == 14)
        {
            dropNamePtr = "ipvSipFilterCmd";
            doCount = 1;
        }
    }
    else if (IS_ROUTER_DROP_MAC(cntrlPcktInfoPtr->ipvAccessCmd))
    {
        if(cntset_mode == 15)
        {
            dropNamePtr = "ipvAccessCmd";
            doCount = 1;
        }
    }
    else
    ...
    if(doCount)
    {
        ...
        if (SMEM_CHT_IS_SIP7_GET(devObjPtr))
        {
            ...
            if (*regPtr==0)
            {
                regPtr1 = smemMemGet(devObjPtr, SMEM_CHT2_ROUTER_DROP_COUNTER1_REG(devObjPtr));
                (*regPtr1)++;
            }
            SCIB_SEM_SIGNAL;
        }
...
)
{
    ...
    GT_U32   matchIndexArr[SNET_CHT2_TCAM_FDB_SEARCH];
    ...
    matchIndexArr[2] = translationDataPtr[2] = SNET_CHT2_IP_ROUT_NO_MATCH_INDEX_CNS;
    ...
    if (devObjPtr->supportEArch && isLpmEnabled)
    {
        if (SMEM_CHT_IS_SIP7_GET(devObjPtr))
        {
            isSipLookupPerformed = snetAasLpm(devObjPtr, descrPtr, matchIndexArr, &isPbr, &priority, &ipSecurChecksInfo);
            if (descrPtr->indirectNhAccess == 1)
            {
                localDescrPtr->indirectNhAccess = 1;
            }

            if ((isPbr == GT_TRUE) || (descrPtr->ttiRedirectCmd==PCL_TTI_ACTION_REDIRECT_CMD_LTT_ROUTER_E))
            {
    ...
    __LOG_PARAM(ipSecurChecksInfo.sipFromEcmpOrQosBlock);
    /* The SIP/SA Check is not supported if The SIP is associated with multiple Route entries (ECMP or QoS block).*/
    if(ipSecurChecksInfo.sipFromEcmpOrQosBlock == 0)
    {
...
)
{
    ...
    GT_U32  translationDataPtr[SNET_CHT2_TCAM_FDB_SEARCH];/* pointer to Route next hop */
    ...
    translationDataPtr[1] = translationDataPtr[2] = SNET_CHT2_IP_ROUT_NO_MATCH_INDEX_CNS;
...
)
{
    ...
    GT_U32               isSipLookupPerformed = 1; /* enabled by default*/
    SNET_SIP6_LPM_MEM_LEAF_STC  sipLpmLeaf;
    SNET_LPM_MEM_ENTRY_STC      sipLpmData_sip5;
    GT_U32              matchIndexArr[2];
    ...
    SNET_ROUTE_SECURITY_CHECKS_INFO_STC ipSecurChecksInfo = {0};
    GT_BOOL             isScibSemTaken = GT_FALSE;
    GT_BOOL             doRoutingDecision=GT_FALSE;

    memset(&sipLpmLeaf, 0, sizeof(SNET_SIP6_LPM_MEM_LEAF_STC));
    memset(&sipLpmData_sip5, 0, sizeof(SNET_LPM_MEM_ENTRY_STC));

    translationDataPtr[0]=matchIndexArr[0] = SNET_CHT2_IP_ROUT_NO_MATCH_INDEX_CNS;
    translationDataPtr[1]=matchIndexArr[1] = SNET_CHT2_IP_ROUT_NO_MATCH_INDEX_CNS;
    ...
    /*
        fix for JIRA : CPSS-14060 : [WM][L3] IPv4/6 link-local Multicast packets
        with mirror to CPU are not subjected to routing

        The FS mentioned that :
        IPv4/6 link-local Multicast packets range (224.0.0.0/24 and FF02::/16 respectively), by definition,
        must not be routed. However, the Router engine does not explicitly preclude IPv4/6 link-local
        Multicast from being routed. To prevent Pv4/6 link-local Multicast packets from being routed (for
        example, by matching the default Multicast prefix in the router LPM), explicit LPM entries must be
        configured for the link-local Multicast prefixes. As the Bridge engine offers a mechanism for mirroring
        these packets to the CPU (refer to Section 9.8.8.3, IPv4/6 Control Protocols Running Over
        Link-Local Multicast) the route entry command for these two prefixes is typically configured to
        BRIDGE.
    */
    ...
    else
    {
        ...
        /* UC RPF Check for bridged ipv4/ipv6, ARP and FCOE Packets */
        if (descrPtr->routed==0)/* bridge services done only if the packet was not routed by the previous device */
        {
            SNET_CHEETAH2_L3_CNTRL_PACKET_INFO cntrlPcktInfo; /* local router enginePacket command  */
            ...
            if((descrPtr->isIp)||(descrPtr->isFcoe)||(descrPtr->arp))
            {
                if((descrPtr->ipm==0)&&(descrPtr->bypassBridge == 0)&&((descrPtr->macDaPtr[0] & 0x1) == 0)) /* supported only for Unicast */
                {
                    if (devObjPtr->supportEArch && isLpmEnabled)
                    {
                        __LOG(("Check If SIP Lookup is Performed \n"));

                        if (SMEM_CHT_IS_SIP7_GET(devObjPtr))
                        {
                            isSipLookupPerformed = snetSip7LpmUcSipLookup(devObjPtr, descrPtr, matchIndexArr, &sipLpmLeaf, &ipSecurChecksInfo);
                        }
                        else
                        {
                            if (SMEM_CHT_IS_SIP6_GET(devObjPtr))
                            {
                                isSipLookupPerformed = snetFalconLpmUcSipLookup(devObjPtr, descrPtr, matchIndexArr, &sipLpmLeaf, &ipSecurChecksInfo);
                            }
                            else
                            {
                                if(isLpmEnabled_test)
                                ...
                                /* do lpm search */
                                isSipLookupPerformed = snetLion3LpmUcSipLookup(devObjPtr, descrPtr, matchIndexArr, &sipLpmData_sip5, &ipSecurChecksInfo);
                            }
                        }
                        __LOG_PARAM(isSipLookupPerformed);
                    }
                       ...
                       ! descrPtr->ipm ) /* unicast only */
                    {
                        ...
                        sipNextHopIndex = translationDataPtr[1];
                        sipAddr = snetIpvxNextHopAddrGet(devObjPtr, descrPtr, sipNextHopIndex);
                        ...
                        snetCht2SipFiltering(devObjPtr, descrPtr, &ipSecurChecksInfo,
                                             sipNextHopEntryPtr, sipNextHopIndex, GT_TRUE, &cntrlPcktInfo);
                        __LOG(("Unicast IPv4/6 Packet RPF check"));
                        snetCht3URpfCheck(devObjPtr, descrPtr, translationDataPtr, &ipSecurChecksInfo,
                                                    0/*TBD*/, 0/*TBD*/, GT_TRUE, &cntrlPcktInfo);

                        __LOG(("Unicast SIP/SA Packet check"));
                        snetCht3SipSaCheck(devObjPtr, descrPtr,&ipSecurChecksInfo,
                                           sipNextHopEntryPtr, sipNextHopIndex , GT_TRUE, &cntrlPcktInfo);
                    }
                    else
                    {
                        __LOG(("SIP Lookup is NOT Performed \n"));
                    }
                    if (isScibSemTaken == GT_TRUE)
                    {
                        SCIB_SEM_SIGNAL;
            ...
            if (doRoutingDecision==GT_TRUE)
            {
                __LOG(("Routing decision"));
                snetCht2L3iCommandResolve(devObjPtr, descrPtr, &cntrlPcktInfo, &localDescr, GT_FALSE);

                /* count drops */
                snetCht2L3iDropCounters(devObjPtr, descrPtr, &cntrlPcktInfo);
            }
        }
    }
}
...
)
{
    ...
    GT_U32  sipTrgDev;
    GT_U32  sipTargetIsVPort;        /* SIP7 : is trg vPort */
    GT_U32  sipTrgVPort;             /* SIP7 : trg vPort */
    GT_U32  sipPacketCmd;
    ...
    {
        smemRegFldGet(devObjPtr, SMEM_CHT2_L3_ROUTE_GLB_CONTROL_REG(devObjPtr), 9 + offsetShift, 1, &rpf_check_fld);
    }
    else
    {
    ...
    if (ipSecurChecksInfoPtr->rpfCheckMode == SNET_RPF_VLAN_BASED_E)
    {
        ...
        {
            __LOG_PARAM(ipSecurChecksInfoPtr->sipNumberOfPaths);
            __LOG_PARAM(ipSecurChecksInfoPtr->sipBaseRouteEntryIndex);
            ...
            if (ucRpfEcmpCheckEn == 1)
            {
                ...
                for (ii = 0; ii <= ipSecurChecksInfoPtr->sipNumberOfPaths; ii++)
                {
                    if (SMEM_CHT_IS_SIP5_GET(devObjPtr))
                    {
                        nextHopVid = snetFieldValueGet(rpfNextHopEntryPtr, ii*13, 13);
                    }
                    else
                    {
                    ...
                    __LOG(("UC RPF vlan%d[%d] descrPtr->eVid[%d] \n", ii, nextHopVid, descrPtr->eVid));
            ...
            else
            {
                ...
                {
                    rpfCheckFail = GT_TRUE;
                    __LOG(("sipLttNumberOfPaths != 0, ucRpfEcmpCheckEn == 0 : rpf Check Fail : due to eVid mismatch : descrPtr->eVid[0x%x] != nextHopVid[0x%x] \n",
                        descrPtr->eVid, nextHopVid));
                }
                /* SIP5 : option to check VID1 too*/
                else if(vid1UnicastRoutingEn && (descrPtr->vid1 != nextHopVid1))
                {
                    rpfCheckFail = GT_TRUE;
                    __LOG(("ipLttNumberOfPaths != 0, ucRpfEcmpCheckEn == 0 : rpf Check Fail : due to VID1 mismatch : descrPtr->vid1[0x%x] != nextHopVid1[0x%x] \n",
                        descrPtr->vid1, nextHopVid1));
                }
            }
        }
         ...
         (ipSecurChecksInfoPtr->sipNumberOfPaths == 0) )
    {
        ...
        if (sipUseVidx == 0)  /* packet forwarded to trunk or port */
        {
            ...
            if(descrPtr->srcIsVPort)/* sip7 */
            {
                __LOG(("packet src is vPort \n"));

                sipTargetIsVPort = SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(devObjPtr, nextHopIpActionPtr,
                    routeIndexPtr[1], SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_TARGET_IS_VPORT);
                sipTrgVPort = SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(devObjPtr, nextHopIpActionPtr,
                    routeIndexPtr[1], SMEM_SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_TARGET_VPORT);

                __LOG_PARAM(sipTargetIsVPort);
                __LOG_PARAM(sipTrgVPort);

                if (!((sipTargetIsVPort == 1) &&
                      (descrPtr->trgVPort == sipTrgVPort)))
                {
                    rpfCheckFail = GT_TRUE;
                }
            }
    ...
    if (rpfCheckFail)
    {
        ...
        if (checkDoneFromBridgeServices==GT_TRUE)
        {
            /* update bridge exception counters */
            snetCht2L3iBridgeExceptionCounters(devObjPtr);
        }
        ...
        else
        {
            ...
            regAddr = ((descrPtr->isIPv4)||(descrPtr->arp)) ?
...
/**
* @internal snetCht3SipSaCheck function
* @endinternal
*
* @brief   Unicast SIP/SA Packet check
*
* @param[in] devObjPtr                - (pointer to) device object.
* @param[in] descrPtr                 - (pointer to) frame data buffer Id
* @param[in] ipSecurChecksInfoPtr     - routing security checks information
...
{
    DECLARE_FUNC_NAME(snetCht3SipSaCheck);
    ...
    GT_U32              offsetShift =  SMEM_SIP6_10_L3_ROUTE_GLB_CONTROL_REG_OFFSET_SHIFT(devObjPtr);
    GT_BIT              isIpv6 = (descrPtr->isIPv4 || descrPtr->isFcoe || descrPtr->arp) ? 0 : 1;
    ...
    {
        smemRegFldGet(devObjPtr, SMEM_CHT2_L3_ROUTE_GLB_CONTROL_REG(devObjPtr), 12 + offsetShift, 1, &sip_check_fld);
    }
    else
    {
        ...
        ((descrPtr->ipServiceFlag == GT_TRUE) || (( descrPtr->ipServiceFlag == GT_FALSE && sip_check_fld))))
    {
        ...
        /* indication for Tunnel Start */
        nextHopFieldName = SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_START_OF_TUNNEL;
        isSipTs = SMEM_CHT_IS_SIP5_GET(devObjPtr) ?
               SMEM_SIP5_IPVX_NEXT_HOP_FIELD_GET(devObjPtr, sipNextHopEntryPtr, sipNextHopIndex, nextHopFieldName) :
               SMEM_U32_GET_FIELD(sipNextHopEntryPtr[1], 17, 1);
        __LOG_PARAM(isSipTs);

        /* SA mismatch is checked if not TS */
        if(isSipTs == 0)
        {
            nextHopFieldName = SMEM_SIP5_IPVX_NEXT_HOP_TABLE_FIELDS_ARP_PTR;
...
/**
* @internal lion3IpvxLocalDevSrcEportBitsSet function
* @endinternal
*
* @brief   Set the value relate to the <localDevSrcEPort> from
*          the IPvX ePort table
*
* @param[in] devObjPtr                - (pointer to) device object.
...
*
*/
void  lion3IpvxLocalDevSrcEportBitsSet(
    IN SKERNEL_DEVICE_OBJECT        *devObjPtr,
    IN GT_U32                       ePort,
...
)
{
    ...
    finalStartBit = startBitPtr[fieldName] + (ePort % 16) * numBitsPerEPort;

    snetFieldValueSet(smemMemGet(devObjPtr,SMEM_LION2_IPVX_INGRESS_EPORT_TBL_MEM(devObjPtr, ePort)), finalStartBit,numBits, value);
...
)
{
    if(SMEM_CHT_IS_SIP7_GET(devObjPtr))
    {
        LION3_TABLES_FORMAT_INIT_MAC(
            ...
            sip7IpvxNextHopTableFieldsFormat, sip5IpvxNextHopFieldsTableNames);

        snetAasIpvxTablesFormatInit(devObjPtr);
    }
    else
    {

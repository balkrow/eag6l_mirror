...
)
{
    ...
    __LOG_NO_LOCATION_META_DATA__WITH_SCIB_LOCK(("table[%s] entryIndex[%d] fieldName[%s] got value[0x%x]",
...
)
{
    ...
    __LOG_NO_LOCATION_META_DATA__WITH_SCIB_LOCK(("table[%s] entryIndex[%d] fieldName[%s] subFieldOffset[%d] subFieldNumOfBits[%d] got value[0x%x]",
                  tableName ? tableName : "unknown",
                  entryIndex,
...
)
{
    ...
    __LOG_NO_LOCATION_META_DATA__WITH_SCIB_LOCK(("table[%s] entryIndex[%d] fieldName[%s] SET to value[0x%x]",
                  tableName ? tableName : "unknown",
                  entryIndex,
                  fieldsNamesArr ? fieldsNamesArr[fieldIndex] : "unknown",
                  actualUsedValue));
...
)
{
    ...
    __LOG_NO_LOCATION_META_DATA__WITH_SCIB_LOCK(("table[%s] entryIndex[%d] fieldName[%s] subFieldOffset[%d] subFieldNumOfBits[%d] SET value[0x%x]",
                  tableName ? tableName : "unknown",
                  entryIndex,
                  fieldsNamesArr ? fieldsNamesArr[parentFieldIndex] : "unknown",
                  subFieldOffset,

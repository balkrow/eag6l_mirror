...
/* AAS */
#define SEAHAWK_DEVICES_MAC  \
SKERNEL_AAS

#define SEAHAWK_2_TILES_DEVICES_MAC  \
SKERNEL_AAS_2_TILES
...
/* AAS devices */
const static  SKERNEL_DEVICE_TYPE aas_legalDevTypes[] =
{   SEAHAWK_DEVICES_MAC, END_OF_TABLE };

/* AAS devices */
const static  SKERNEL_DEVICE_TYPE aas_2_tiles_legalDevTypes[] =
{   SEAHAWK_2_TILES_DEVICES_MAC, END_OF_TABLE };
...
/* 48 */    SKERNEL_PORT_STATE_MTI_CPU_E ,
/* 49 */    SKERNEL_PORT_STATE_MTI_CPU_E ,
/* 50 */    SKERNEL_PORT_STATE_MTI_CPU_E ,
/* 51 */    SKERNEL_PORT_STATE_MTI_CPU_E ,
/* 52 */    SKERNEL_PORT_STATE_MTI_CPU_E ,
/* 53 */    SKERNEL_PORT_STATE_MTI_CPU_E ,
/* 54 */    SKERNEL_PORT_STATE_MTI_CPU_E ,

};

/* The AAS_NUM_OF_MAC ports is 81. But global numOfPorts==numSlans is 88.
 * APIs checks 'global port' vs numOfPorts (or numSlans) and gets portInfo from array[88]
 */
#define  AAS_NUM_OF_MAC_PORTS_CNS       (80+1)
#define  AAS_NUM_OF_GDMA_PORTS_CNS      (3)
#define  AAS_NUM_OF_LOOPBACK_PORTS_CNS  (4)
#define  AAS_NUM_OF_PORTS_CNS       (AAS_NUM_OF_MAC_PORTS_CNS + AAS_NUM_OF_GDMA_PORTS_CNS + AAS_NUM_OF_LOOPBACK_PORTS_CNS)

#define AAS_GOP_MAC_400  \
    SKERNEL_PORT_STATE_MTI_400_E,SKERNEL_PORT_STATE_MTI_50_E ,\
    SKERNEL_PORT_STATE_MTI_100_E,SKERNEL_PORT_STATE_MTI_50_E ,\
    SKERNEL_PORT_STATE_MTI_200_E,SKERNEL_PORT_STATE_MTI_50_E ,\
    SKERNEL_PORT_STATE_MTI_100_E,SKERNEL_PORT_STATE_MTI_50_E

#define AAS_GOP_MAC_CPU  \
    SKERNEL_PORT_STATE_NOT_EXISTS_E,SKERNEL_PORT_STATE_NOT_EXISTS_E ,\
    SKERNEL_PORT_STATE_NOT_EXISTS_E,SKERNEL_PORT_STATE_NOT_EXISTS_E

#define AAS_GOP_PORTS   \
    AAS_GOP_MAC_400,    \
    AAS_GOP_MAC_400,    \
    AAS_GOP_MAC_CPU


const static  SKERNEL_PORT_STATE_ENT aas_Ports[AAS_NUM_OF_PORTS_CNS] =
{
    AAS_GOP_PORTS,/* 0..19*/
    AAS_GOP_PORTS,/*20..39*/
    AAS_GOP_PORTS,/*40..59*/
    AAS_GOP_PORTS,/*60..79*/
    SKERNEL_PORT_STATE_NOT_EXISTS_E, /*SKERNEL_PORT_STATE_MTI_CPU_E*/ /*80*/
    SKERNEL_PORT_STATE_NOT_EXISTS_E,  /*81*/
    SKERNEL_PORT_STATE_NOT_EXISTS_E,  /*82*/
    SKERNEL_PORT_STATE_NOT_EXISTS_E,  /*83*/
    SKERNEL_PORT_STATE_NOT_EXISTS_E,  /*84*/
    SKERNEL_PORT_STATE_NOT_EXISTS_E,  /*85*/
    SKERNEL_PORT_STATE_NOT_EXISTS_E,  /*86*/
    SKERNEL_PORT_STATE_NOT_EXISTS_E   /*87*/
};

#define  AAS_2_TILES_NUM_OF_MAC_PORTS_CNS ((2*80)+1)/*161*/
const static  SKERNEL_PORT_STATE_ENT aas_2_tiles_Ports[AAS_2_TILES_NUM_OF_MAC_PORTS_CNS] =
{
    /*Tile 0*/
    AAS_GOP_PORTS,/* 0..19*/
    AAS_GOP_PORTS,/*20..39*/
    ...
    /*Tile 1*/
    AAS_GOP_PORTS,/* 80..89 */
    AAS_GOP_PORTS,/*100..119*/
    AAS_GOP_PORTS,/*120..139*/
    AAS_GOP_PORTS,/*140..159*/
    SKERNEL_PORT_STATE_MTI_CPU_E/*160*/
};
...
const static SIM_SUPPORTED_TYPES_STC simSupportedTypes[] =
{
    ...
    /* support for the AAS */
    {SKERNEL_AAS_FAMILY, AAS_NUM_OF_PORTS_CNS, aas_legalDevTypes, NULL, NULL, aas_Ports},

    /* support for the AAS with 2 tiles */
    {SKERNEL_AAS_FAMILY, AAS_2_TILES_NUM_OF_MAC_PORTS_CNS, aas_2_tiles_legalDevTypes, NULL, NULL, aas_2_tiles_Ports},
...
static SMAIN_DEV_NAME_STC    smainDevNameDb[] =
{
    ...
    /* generic AAS (non GM device) - DX device */
    {SMAIN_NO_GM_DEVICE, "seahawk"          , SKERNEL_AAS        , AAS_NUM_OF_PORTS_CNS        , NO_CPU_GMII_PORT_CNS},
    {SMAIN_NO_GM_DEVICE, "seahawk_2_tiles"  , SKERNEL_AAS_2_TILES, AAS_2_TILES_NUM_OF_MAC_PORTS_CNS, NO_CPU_GMII_PORT_CNS},

    /* generic AAS (GM device) - DX device */
    {GOLDEN_MODEL, "seahawk_gm"       , SKERNEL_AAS, AAS_NUM_OF_PORTS_CNS, NO_CPU_GMII_PORT_CNS},
...
)
{
    ...
    case SKERNEL_DXCH_B0  :  /* generic DXCH_B0  8K FDB*/
        skernelFatalError(" devLegacyRevInfoSet: non supported CH1 legacy device " );
        break;
    ...
    case SKERNEL_DXCH2:
        skernelFatalError(" devLegacyRevInfoSet: non supported CH2 legacy device " );
        break;
    ...
    case SKERNEL_DXCH3_XG   :
        skernelFatalError(" devLegacyRevInfoSet: non supported CH3 legacy device " );
        break;
    case SKERNEL_XCAT2_24_AND_4:
        skernelFatalError(" devLegacyRevInfoSet: non supported xCAT2 legacy device " );
        break;
    ...
    case SKERNEL_LION_PORT_GROUP_12:
        skernelFatalError(" devLegacyRevInfoSet: non supported Lion1 legacy device " );
    default:
        break;
    }
...
static GT_U32   sleepTimeDebug = 500;
GT_STATUS wmResetSleepTimeDebugSet(GT_U32   mili)
{
    sleepTimeDebug = mili;
...
)
{
    ...
    while(1)
    {
        ...
        if(deviceObjPtr->softResetNewDevicePtr)
        {
            ...
            /* allow other tasks to wait on the suspended queue,pool , before we
               flush it , as still used buffer will fail later on sbufFree(...) :

                if ( allocBufPtr->state == SBUF_BUF_STATE_FREE_E ) {
                    sUtilsFatalError("sbufFree : Warning buffer already free\n") ;
                }
            */
            SIM_OS_MAC(simOsSleep)(sleepTimeDebug);
            ...
            /* No need to free already freed buffer */
            allowBuffFree = 0;
        }
        ...
        else if (bufferId->srcType == SMAIN_SRC_TYPE_CPU_E)
        {
            switch(bufferId->dataType)
            {
                ...
                case SMAIN_MSG_TYPE_FDB_UPLOAD_E:
                    if(!simLogTreatDumpDaemonAsProcessing)
                    {
                        /* this is default mode as FDB dump may generate a lot of info to LOG
                           and therefore to slow down the processing of the WM side */
                        SET_TASK_TYPE_MAC(SIM_OS_TASK_PURPOSE_TYPE_PP_AGING_DAEMON_E);
                    }
                    else
                    {
                        /* allow FDB upload to send LOG info , like 'processing' daemon */
                        SET_TASK_TYPE_MAC(SIM_OS_TASK_PURPOSE_TYPE_PP_PIPE_PROCESSING_DAEMON_E);
                        simLogPacketFrameUnitSet(SIM_LOG_FRAME_UNIT___ALLOW_ALL_UNITS___E);/* wild card for LOG without the unit filter */
                        simLogPacketFrameCommandSet(SIM_LOG_FRAME_COMMAND_TYPE_GENERAL_E);
                    }
                ...
                case SMAIN_MSG_TYPE_CNC_FAST_DUMP_E:
                    if(!simLogTreatDumpDaemonAsProcessing)
                    {
                        /* this is default mode as CNC dump may generate a lot of info to LOG
                           and therefore to slow down the processing of the WM side */
                        SET_TASK_TYPE_MAC(SIM_OS_TASK_PURPOSE_TYPE_PP_AGING_DAEMON_E);
                    }
                    else
                    {
                        /* allow CNC dump to send LOG info , like 'processing' daemon */
                        SET_TASK_TYPE_MAC(SIM_OS_TASK_PURPOSE_TYPE_PP_PIPE_PROCESSING_DAEMON_E);
                        simLogPacketFrameUnitSet(SIM_LOG_FRAME_UNIT___ALLOW_ALL_UNITS___E);/* wild card for LOG without the unit filter */
                        simLogPacketFrameCommandSet(SIM_LOG_FRAME_COMMAND_TYPE_GENERAL_E);
                    }
                ...
                case SMAIN_MSG_TYPE_GENERIC_FUNCTION_E:
                    ...
                    if(dataPtr)
                    {
                        ...
                        (*genMsgFunc)(deviceObjPtr,bufferId,dataPtr,dataSize);
                    }
                    break;
...
)
{
    ...
    */
    ...
    if(deviceObjPtr->numOfCoreDevs)
    {
       ...
       /* Select either CM3 FW simulation mode or MicroInit
        * Simulation mode. The CM3 FW option will make shared
        * memory out of the SRAMs without active write callbacks
        * and without calling MicroInit initialization functions.
        * The MicroInit mode has active write callbacks for writing
        * to SRAM or Confi processor register and will invoke the
        * MicroInit initialization functions when Confi Processor
        * is started.  */

    sprintf(keyStr, "dev%u_cm_fw_mode", devId);
    if(SIM_OS_MAC(simOsGetCnfValue)(devInfoSection, keyStr,
                                    FILE_MAX_LINE_LENGTH_CNS, param_str))
    {
        sscanf(param_str, "%u", &deviceObjPtr->cmFwSim);
    }
    else
    {
        /* Default value is MicroInit simulation (backward
           compatibility mode) */
        deviceObjPtr->cmFwSim = 0;
    }
...
)
{
    ...
    memset(deviceObjPtr->timer1StartAddrs, 0, sizeof(deviceObjPtr->timer1StartAddrs));
    ...
    deviceObjPtr->timer1TaskStarted = 0;
    deviceObjPtr->timer1Running = 0;
...
)
{
    ...
    for(jj = 0 ; jj < deviceObjPtr->numOfCoreDevs; jj++)
    {
        ...
        if(deviceObjPtr->softResetOldDevicePtr)
        {
            /* Set softResetOldDevicePtr device for soft resetting
...
)
{
    ...
    do
    {
        ...
        */
        ...
        if(prevAddr == nextAddr)
        {
            ...
            simulationPrintf("WARNING : Capability : breaking endless loop of same address [0x%x] \n",
                prevAddr);
            break;
        }
    ...
    do
    {
        ...
        */
        ...
        {
            /* break the 'endless loop' */
            simulationPrintf("WARNING : Enhanced Capability : breaking endless loop of same address [0x%x]\n",
                prevAddr);
            break;
        }
    }while(nextAddr);
...
)
{
    ...
    if(devObjPtr->shellDevice == GT_TRUE &&
       devObjPtr->coreDevInfoPtr &&
       devObjPtr->deviceFamily == SKERNEL_LION2_PORT_GROUP_SHARED_FAMILY)
    {
        /* support lion2/Hooper init called from skernelInit() */
        /* to update of 0x38 address , during 'first init' (that is not after soft-reset) */
    ...
    if(devObjPtr->portGroupSharedDevObjPtr)  /* Support lion2/Hooper */
    {
        /* 1. support Lion2 after soft reset , allow appDemo to not wait till timeout ,
           to continue after sort reset
           2. with the additional code above for 'shellDevice' , it supports update during the first init too
        */
        for(ii = 0; ii < devObjPtr->portGroupSharedDevObjPtr->
            numOfCoreDevs; ii++)
        {
            deviceId = devObjPtr->portGroupSharedDevObjPtr->coreDevInfoPtr[ii].
                devObjPtr->deviceId;
            scibPciRegRead(deviceId,WM_DEVICE_READY_FOR_ACCESS_BY_CPU_REG_ADDR,1,&value);
            value |= 0x80000000;
            scibPciRegWrite(deviceId,WM_DEVICE_READY_FOR_ACCESS_BY_CPU_REG_ADDR,1,&value);
        }
    }
    else
    {
...
)
{
    ...
    */
    ...
    if(softResetExcludePci == 1)
    {
        ...
        /* BAR0 is 'start' of PCIe-MAC ... need to be copied separately */
        {
            ...
            /* check if need to override values from the registers file
                and change was done after previous init , so it is not in the 'old memory'
                but the new memory need to be with it.
                see use of the debug function : debug_wmForceSpecificDeviceInfo(...)
            */
            if(GT_OK == scibSpecificDeviceInfoGet(newDeviceObjPtr->deviceId,&devInfo))
            {
                if(devInfo.pciDeviceId != 0xFFFF)
                {
                    memPtr = smemDevFindInUnitChunk(newDeviceObjPtr, SKERNEL_MEMORY_READ_BAR0_E,
                        0x0, 1,(GT_UINTPTR)(void*)&newDevMemInfoPtr->BAR0_UnitMem);

                    regValue = *memPtr;
                    /* set the <device_id> */
                    regValue = ((GT_U32)devInfo.pciDeviceId << 16) | (regValue & 0xFFFF);
                ...
                {
                    memPtr = smemDevFindInUnitChunk(newDeviceObjPtr, SKERNEL_MEMORY_READ_BAR0_E,
                        0x8, 1,(GT_UINTPTR)(void*)&newDevMemInfoPtr->BAR0_UnitMem);

                    regValue = *memPtr;
                    /* set the <revision> */
                    regValue =  (regValue & 0xFFFFFFF0) | devInfo.revision;
    ...
    __LOG(("wait for all threads (other than skernel task) to replace old device with new device \n"));
    ...
    if(multiCore)
    {
        for(ii = 0; ii < oldMainDeviceObjPtr->numOfCoreDevs; ii++)
        {
            ...
            if(iterDeviceObjPtr == oldDeviceObjPtr)
            {
                /* not needed on activated core , as this core is running current
                   code in context of the skernel task*/
                continue;
            }

            __LOG(("flush the queue of core [%d]\n",ii));
            squeFlush(iterDeviceObjPtr->queueId);
            __LOG(("flush the pool of core [%d] \n",ii));
            sbufPoolFlush(iterDeviceObjPtr->bufPool);
    ...
    /* wait for all threads (other than skernel task) to replace old device
    with new device */
    ...
    if(multiCore)
    {
        do
        {
            ...
            /* numThreadsOnMe can not be '0' for current core running current
            thread*/
    ...
    */
    ...
    if(shellDevObjPtr)
    {
        for(ii = 0; ii < shellDevObjPtr->numOfCoreDevs; ii++)
        {
            ...
            if(iterDevObjPtr == newDeviceObjPtr)
            {
                /* this core is treated after this loop */
                continue;
            }
            /* no flush needed as it was done on the cores in skernel task by code under :
                if(deviceObjPtr->softResetNewDevicePtr)
                {
                    ...
                    squeFlush(deviceObjPtr->queueId);
...
)
{
    ...
    /* we are before smemInit(...) so we can't use :
        mgUnitOffset = UNIT_BASE_ADDR_GET_ALLOW_NON_EXIST_UNIT_MAC(deviceObjPtr,UNIT_MG) */
    switch(deviceObjPtr->deviceFamily)
    {
        case SKERNEL_FALCON_FAMILY:
            mgUnitOffset = 0x1D000000;
            break;
        case SKERNEL_IRONMAN_FAMILY:
        case SKERNEL_PHOENIX_FAMILY:
        /*case SKERNEL_AC5_FAMILY: the reg file uses the 'old MG' in offset 0x0 */
            mgUnitOffset = simIronmanMgBaseAddr/*0x7f900000*/;
            break;
        case SKERNEL_HARRIER_FAMILY:
        case SKERNEL_HAWK_FAMILY:
            mgUnitOffset = simHawkMgBaseAddr/*0x3c200000*/;
            break;
        case SKERNEL_AAS_FAMILY:
            mgUnitOffset = simAasMgBaseAddr;
            break;
        default:
            mgUnitOffset = 0x0;
            break;
    ...
    retVal =
        smainMemAdditionalAddrDefaultGet(deviceObjPtr, devId, mgUnitOffset + 0x4c, &regData);
    if(retVal == GT_OK)
    {
    ...
    /* check if need to override values from the registers file */
    retVal = scibSpecificDeviceInfoGet(deviceObjPtr->deviceId,&devInfo);
    if(retVal == GT_OK)
    {
        if(devInfo.revision <= 0xF)
        {
            /* override value from the registers file */
            revision = devInfo.revision;
        }
    }
...
)
{
    ...
    SIM_OS_MAC(simOsSemWait)(slanDownSemaphore,SIM_OS_WAIT_FOREVER);
    /* support Linux when running without the 'slanConnector_Linux'
       and needed for the 'link down' indication on this port */
    unbindDone = slanInfoPrt->slanName[0] ? GT_TRUE : GT_FALSE;
    slanInfoPrt->slanName[0] = 0; /* before the unbind , make sure no one try to send packet to this port */
    SIM_OS_MAC(simOsSemSignal)(slanDownSemaphore);
...
/**
* @internal smainTimer1Task function
* @endinternal
*
* @brief   MG Timer1 simulation main task
*
* @param[in] tgDataPtr                - pointer to the traffic generator data.
*/
GT_VOID smainTimer1Task
(
    IN SKERNEL_DEVICE_OBJECT * deviceObjPtr
)
{
    GT_U32  i, ii, tstart, tend;
    GT_U32  localTimer1StartAddrs[SIM_MAX_NUM_OF_MG];
    GT_U32  timer1Regs[6], timer1RatioReg, mgMiscReg;
    GT_U16  timer1CurCnt, timerAddVal, timer1Val;
    SKERNEL_DEVICE_OBJECT *devObjPtr = deviceObjPtr;
    ...
    while (1)
    {
        tstart = SIM_OS_MAC(simOsTickGet)();
        do /* skernelSleep seem to return sooner than 10ms */
        {
            devObjPtr = skernelSleep(devObjPtr, 10);
            tend = SIM_OS_MAC(simOsTickGet)();
        }
        while ( (tend - tstart) < 10);

        SCIB_SEM_TAKE;
        /* Get a copy of the registers of the active timers */
        memcpy(localTimer1StartAddrs, devObjPtr->timer1StartAddrs,
               sizeof(localTimer1StartAddrs));
        SCIB_SEM_SIGNAL;

        for (i = 0; i < SIM_MAX_NUM_OF_MG; i++)
        { /* Iterate the CM instances */
            if (localTimer1StartAddrs[i] != 0)
            { /* Handle an active timers */

                smemSetCurrentMgUnitIndex(devObjPtr,i);

                for (ii = 0x400; ii < 0x418; ii += 4)
                { /* copy the current timer1 state registers */
                    smemRegGet(devObjPtr,
                               (localTimer1StartAddrs[i] & 0xfffff000) | ii,
                               &timer1Regs[(ii - 0x400) / 4]);
                }

                if (!timer1Regs[4])
                    continue; /* Timer stopped - skip it */

                if (timer1Regs[5] & 0xd)
                    continue; /* Timer reset - skip it */

                /* get timer1 ratio register */
                smemRegGet(devObjPtr,
                           (localTimer1StartAddrs[i] & 0xfffff000) | 0x350,
                           &timer1RatioReg);

                /* get MG misc register */
                smemRegGet(devObjPtr,
                           (localTimer1StartAddrs[i] & 0xfffff000) | 0x54,
                           &mgMiscReg);

                timer1CurCnt = (timer1Regs[3] << 8) | timer1Regs[2]; /* MSB + LSB of current counter */
                timer1Val = (timer1Regs[1] << 8) | timer1Regs[0]; /* MSB + LSB  of timer expiration period */
                /* we wait 10ms and evry 2.5 units are 1uS, hence 25K/ratio reg is the counter change */
                timerAddVal = (25000 / timer1RatioReg);
                if (!timerAddVal)
                    timerAddVal = 1; /* increment by at least 1 - this will ensure timer will trigger after 10 simulation seconds */
                timer1CurCnt += timerAddVal;

                /* write back timer1 current counter registers: */
                smemRegSet(devObjPtr,
                           (localTimer1StartAddrs[i] & 0xfffff000) | 0x408,
                           timer1CurCnt & 0xff); /* write LSB of timer1 current counter */
                smemRegSet(devObjPtr,
                           (localTimer1StartAddrs[i] & 0xfffff000) | 0x40c,
                           timer1CurCnt >> 8); /* write MSB of timer1 current counter */
                if (timer1CurCnt > timer1Val)
                {

                    /* write zeroed timer1 current counter registers: */
                    smemRegSet(devObjPtr,
                               (localTimer1StartAddrs[i] & 0xfffff000) | 0x408,
                               0); /* write LSB of timer1 current counter */
                    smemRegSet(devObjPtr,
                               (localTimer1StartAddrs[i] & 0xfffff000) | 0x40c,
                               0); /* write MSB of timer1 current counter */
                    smemRegSet(devObjPtr,
                               (localTimer1StartAddrs[i] & 0xfffff000) | 0x410,
                               0); /* write timer1 start register */

                    if (mgMiscReg & 0x1) /* watchdog enabled? */
                    {
                        /* generate interrupt so the external CM process can be notified to terminate itself.
                         * Thus we slightly incorrectly simulate as we ignore the interrupt mask bit of the timer mechanism.
                         * A more accurate simulation would add a registration of the external CM process pid and would send a signal to it to terminate
                         */
                        smemRegSet(devObjPtr,
                               (localTimer1StartAddrs[i] & 0xfffff000) | 0x418,
                               0x1); /* write watchdog indication to fake register  */
                        snetChtDoInterruptInMgInAllTrees(devObjPtr,
                            ...
                            BIT_4, /* Service CPU Second Timer Interrupt */
                            0 /* don't care */);
...
)
{
    ...
    if (!deviceObjPtr->timer1TaskStarted)
    {
        deviceObjPtr->smemInitPhaseSemaphore = SIM_OS_MAC(simOsSemCreate)(0,1);

        taskHandle = SIM_OS_MAC(simOsTaskCreate)(GT_TASK_PRIORITY_ABOVE_NORMAL,
                          (unsigned (__TASKCONV *)(void*))smainTimer1Task,
                          (void *) deviceObjPtr);
        if (taskHandle == NULL)
        {
            skernelFatalError(" skernelInit: cannot create MG timer1 "\
                              " task for device %u", deviceObjPtr->deviceId);
        }
        /* wait for semaphore */
        SIM_OS_MAC(simOsSemWait)(deviceObjPtr->smemInitPhaseSemaphore, SIM_OS_WAIT_FOREVER);
        ...
        SCIB_SEM_TAKE;
        deviceObjPtr->numThreadsOnMe++;
        /* Set task state in database */
        deviceObjPtr->timer1TaskStarted = GT_TRUE;
        SCIB_SEM_SIGNAL;
...
static const char* mifUnitNames[SMEM_CHT_PORT_MTI_MIF_TYPE___last___E]={
     STR(SMEM_CHT_PORT_MTI_MIF_TYPE_8_E)
    ,STR(SMEM_CHT_PORT_MTI_MIF_TYPE_32_E)
    ,STR(SMEM_CHT_PORT_MTI_MIF_TYPE_128_E)
};
/**
* @internal skernelPortMifInfoPrint function
* @endinternal
*
* @brief   function to print TXDMA mif info
*
* @param[in] simDeviceId - the WM device ID (as exists in the INI file)
* @param[in] txDmaGlobalPortNum - txDma Global Port Num
*
*/
void skernelPortMifInfoPrint(
    IN GT_U32   simDeviceId,
    IN GT_U32   txDmaGlobalPortNum
)
{
    SKERNEL_DEVICE_OBJECT       *devObjPtr;
    SKERNEL_PORT_MIF_INFO_STC   *mifInfoPtr;
    GT_U32   mif;

    devObjPtr = smemTestDeviceIdToDevPtrConvert(simDeviceId);

    mifInfoPtr = &devObjPtr->portsArr[txDmaGlobalPortNum].mifInfo[0];

    simForcePrintf("WM device [%d] txDmaGlobalPortNum[%d] , info: \n",
        simDeviceId,txDmaGlobalPortNum);

    for(mif = 0 ; mif< SMEM_CHT_PORT_MTI_MIF_TYPE___last___E ; mif++)
    {
        if(mifInfoPtr->txEnabled && (mifInfoPtr->mifType == mif))
        {
            simForcePrintf("WM device [%d] txDmaGlobalPortNum[%d] , mifUnitName[%s]: Tx enabled ,txMacNum[%d],egress_isPreemptiveChannel[%s]\n",
                simDeviceId,txDmaGlobalPortNum,mifUnitNames[mif],
                mifInfoPtr->txMacNum,
                mifInfoPtr->egress_isPreemptiveChannel?"Y":"N");
            simForcePrintf("");
        }
        else
        {
            simForcePrintf("WM device [%d] txDmaGlobalPortNum[%d] , mifUnitName[%s]: Tx DISABLED \n",
                simDeviceId,txDmaGlobalPortNum,mifUnitNames[mif]);
        }
    }
}
...
*
*/
void skernelPortMifInfoPrintNotValid(
    IN GT_U32   simDeviceId
)
{
    SKERNEL_DEVICE_OBJECT       *devObjPtr;
    ...
    for(ii = 0 ; ii < devObjPtr->portsNumber; ii++)
    {
        mifInfoPtr = &devObjPtr->portsArr[ii].mifInfo[0];
        valid = 0;

        for(id = 0 ; id< SKERNEL_PORT_MIF_INFO_MAX_CNS ; id++,mifInfoPtr++)
        {
            if(mifInfoPtr->txEnabled)
            {
                valid = 1;
                break;
            }
        ...
        if(valid == 0)
        {
            simForcePrintf("WM device [%d] txDmaGlobalPortNum[%d] mif Tx DISABLED \n",
                simDeviceId,ii);
        }
    }

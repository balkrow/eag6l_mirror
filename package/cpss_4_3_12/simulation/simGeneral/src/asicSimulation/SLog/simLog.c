...
/* allow daemon of dump memory (CNC/FDB upload) to be treated as 'processing deamon' */
GT_BOOL simLogTreatDumpDaemonAsProcessing        = GT_FALSE;
...
static char  *unisNameArr[SIM_LOG_FRAME_UNIT___ALLOW_ALL_UNITS___E + 1] =
{
    ...
    STR(SIM_LOG_FRAME_UNIT_MIF_E),
    STR(SIM_LOG_FRAME_UNIT_CTSU_E),
    STR(SIM_LOG_FRAME_UNIT_LMU_E),
    STR(SIM_LOG_FRAME_UNIT_PORT_MAC_EGRESS_E),
    STR(SIM_LOG_FRAME_UNIT_MG_TO_CPU_E),
    STR(SIM_LOG_FRAME_UNIT_GDMA_TO_CPU_E),
    ...
    STR(SIM_LOG_FRAME_UNIT_MPCL_E),
    STR(SIM_LOG_FRAME_UNIT_EMX_E),

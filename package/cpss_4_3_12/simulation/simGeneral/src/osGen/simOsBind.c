...
SIM_OS_SOCKET_EXTRACT_PORT_FROM_SOCKET_ADDR_FUN SIM_OS_MAC(osSocketExtractPortFromSocketAddr)  = FORCE_CAST fatalErrorBind;
...
SIM_OS_SHARED_MEM_OPEN_AND_MAP_FUN  SIM_OS_MAC(simOsSharedMemOpenAndMap)      = FORCE_CAST fatalErrorBind;
...
)
{
    ...
    BIND_LEVEL_FUNC(processes,simOsSharedMemOpenAndMap);

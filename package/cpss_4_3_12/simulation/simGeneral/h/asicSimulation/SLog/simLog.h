...
#define __LOG_WORDS_ARRAY(_pointer, num_words)                 \
    /* add LOG info */                                         \
    if(simLogIsOpenFlag)                                       \
    {                                                          \
        GT_U32  ii;                                            \
        __LOG(("[%s] with num of words[%d] \n",                \
            #_pointer , num_words));                           \
...
typedef enum{
    ...
    SIM_LOG_FRAME_UNIT_MIF_E,
    SIM_LOG_FRAME_UNIT_CTSU_E,
    SIM_LOG_FRAME_UNIT_LMU_E,
    SIM_LOG_FRAME_UNIT_PORT_MAC_EGRESS_E,
    SIM_LOG_FRAME_UNIT_MG_TO_CPU_E,
    SIM_LOG_FRAME_UNIT_GDMA_TO_CPU_E,
    ...
    SIM_LOG_FRAME_UNIT_MPCL_E,
    SIM_LOG_FRAME_UNIT_EMX_E,
...
extern GT_BOOL simLogTreatDumpDaemonAsProcessing;

...
/**
********************************************************************************
* @file simOsBindProcess.h
*
* @brief Operating System wrapper. Process facility.
*
...
#ifndef __simOsBindProcessh
#define __simOsBindProcessh
...
typedef GT_U32  GT_PROCESS_ID;

/* shared memory key type */
typedef GT_U32  GT_SH_MEM_KEY;
/* shared memory ID type */
typedef GT_UINTPTR  GT_SH_MEM_ID;
/* signal Id type signed var */
typedef int GT_SIGNAL_ID;

/*bmp of flags*/
typedef GT_U32  GT_FLAGS;

typedef void * GT_PROCESS_HANDLE;

/* function to handle this needed signal */
typedef void (*PROCESS_HADLER_FUN)(GT_SIGNAL_ID signalId);

#define  SHARED_MEM_READ            0x00000400
#define  SHARED_MEM_WRITE           0x00000200
#define  SHARED_MEM_READ_ONLY       0x00010000
#define  SHARED_MEM_RND             0x00020000
#define  SHARED_MEM_REMAP           0x00040000
#define  SHARED_MEM_LOCK            11
#define  SHARED_MEM_UNLOCK          12
#define  SHARED_MEM_STAT            13
#define  SHARED_MEM_INFO            14
...
*/
typedef GT_STATUS (*SIM_OS_SHARED_MEM_GET_FUN)/* linux shmget , win32 CreateFileMapping,OpenFileMappings    */
(
...
*/
typedef void * (*SIM_OS_SHARED_MEM_ATTACH_FUN)/* linux shmat , win32 MapViewOfFile*/
(
...
*/
typedef GT_STATUS (*SIM_OS_PROCESS_ID_GET_FUN)/* linux-getpid ,win32 GetCurrentProcessId,OpenProcess     */
(
...
*
*******************************************************************************/
typedef GT_STATUS (*SIM_OS_PROCESS_NOTIFY_FUN) /*linux - kill , win32 - PostMessage */
(
...
*/
typedef GT_STATUS (*SIM_OS_PROCESS_HANDLER_FUN)         /* linux - sigaction , win32- task that wait for events/messages */
(
...
*
*******************************************************************************/
typedef GT_STATUS (*SIM_OS_SHARED_MEM_OPEN_AND_MAP_FUN)
(
...
*    structure that hold the "os process" functions needed be bound to SIM.
*
*/
typedef struct{
    SIM_OS_SHARED_MEM_GET_FUN           simOsSharedMemGet;
    ...
    SIM_OS_PROCESS_NOTIFY_FUN           simOsProcessNotify;
    SIM_OS_PROCESS_HANDLER_FUN          simOsProcessHandler;
    SIM_OS_SHARED_MEM_OPEN_AND_MAP_FUN  simOsSharedMemOpenAndMap;

}SIM_OS_FUNC_BIND_PROCESS_STC;

extern    SIM_OS_SHARED_MEM_GET_FUN           SIM_OS_MAC(simOsSharedMemGet);
extern    SIM_OS_SHARED_MEM_ATTACH_FUN        SIM_OS_MAC(simOsSharedMemAttach);

extern    SIM_OS_PROCESS_ID_GET_FUN           SIM_OS_MAC(simOsProcessIdGet);
extern    SIM_OS_PROCESS_NOTIFY_FUN           SIM_OS_MAC(simOsProcessNotify);
extern    SIM_OS_PROCESS_HANDLER_FUN          SIM_OS_MAC(simOsProcessHandler);
extern    SIM_OS_SHARED_MEM_OPEN_AND_MAP_FUN  SIM_OS_MAC(simOsSharedMemOpenAndMap);

#ifdef __cplusplus
}
#endif

#endif  /* __simOsBindProcessh */

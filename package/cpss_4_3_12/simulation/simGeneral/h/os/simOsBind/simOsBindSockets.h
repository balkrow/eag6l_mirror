...
/*******************************************************************************
* osSocketExtractPortFromSocketAddr()
*
* DESCRIPTION:
*       Extracts the port from sockaddr_in structure.
*
* INPUTS:
*       sockAddr    - pointer to sockaddr_in.
*       port        - pointer to port in GT_U16 format to be filled by the
*                     routine.
*
* OUTPUTS:
*       None
...
*
*******************************************************************************/
typedef GT_STATUS (*SIM_OS_SOCKET_EXTRACT_PORT_FROM_SOCKET_ADDR_FUN)
(
    IN  GT_VOID*   sockAddr,
    OUT GT_U16*    port
);
...
typedef struct{
    ...
    SIM_OS_SOCKET_EXTRACT_PORT_FROM_SOCKET_ADDR_FUN osSocketExtractPortFromSocketAddr;
...
extern SIM_OS_SOCKET_EXTRACT_PORT_FROM_SOCKET_ADDR_FUN SIM_OS_MAC(osSocketExtractPortFromSocketAddr);

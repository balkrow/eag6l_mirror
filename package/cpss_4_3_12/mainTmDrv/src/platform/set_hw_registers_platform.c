...
int set_hw_shaping_status(tm_handle hndl, enum tm_level level)
{
    ...
    case Q_LEVEL:
        ...
        TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueuePerConf, TM_Sched_QueuePerConf)
        if (rc) break;
        ...
        /* write register */
        TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueuePerConf, TM_Sched_QueuePerConf)
        break;
    case A_LEVEL:
        /* reset register reserved fields */
        TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlPerConf, TM_Sched_AlvlPerConf)
        if (rc) break;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlPerConf, TM_Sched_AlvlPerConf)
        break;
    case B_LEVEL:
        /* reset register reserved fields */
        TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlPerConf, TM_Sched_BlvlPerConf)
        if (rc) break;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlPerConf, TM_Sched_BlvlPerConf)
        break;
    case C_LEVEL:
        /* reset register reserved fields */
        TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlPerConf, TM_Sched_ClvlPerConf)
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlPerConf, TM_Sched_ClvlPerConf)
        break;
    case P_LEVEL:
        /* reset register reserved fields */
        TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortPerConf, TM_Sched_PortPerConf)
        if (rc) break;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortPerConf, TM_Sched_PortPerConf)
        break;
    default:
        break;
    }
...
int get_hw_shaping_status(tm_handle hndl, enum tm_level level , struct tm_level_periodic_params *periodic_params )
{
    int rc = -ERANGE;
    ...
    case Q_LEVEL:
        ...
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_GET(TM_Sched_QueuePerConf, DecEn,           periodic_params->shaper_dec , (uint8_t))
        TM_REGISTER_GET(TM_Sched_QueuePerConf, PerEn ,          periodic_params->per_state , (uint8_t))
        break;
    case A_LEVEL:
        TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlPerConf, TM_Sched_AlvlPerConf)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_GET(TM_Sched_AlvlPerConf, DecEn ,       periodic_params->shaper_dec , (uint8_t))
        TM_REGISTER_GET(TM_Sched_AlvlPerConf, PerEn ,       periodic_params->per_state , (uint8_t))
        break;
    case B_LEVEL:
        TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlPerConf, TM_Sched_BlvlPerConf)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_GET(TM_Sched_BlvlPerConf, DecEn ,       periodic_params->shaper_dec , (uint8_t))
        TM_REGISTER_GET(TM_Sched_BlvlPerConf, PerEn ,       periodic_params->per_state , (uint8_t))
        break;
    case C_LEVEL:
        TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlPerConf, TM_Sched_ClvlPerConf)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_GET(TM_Sched_ClvlPerConf, DecEn ,       periodic_params->shaper_dec , (uint8_t))
        TM_REGISTER_GET(TM_Sched_ClvlPerConf ,PerEn ,       periodic_params->per_state , (uint8_t))
        break;
    case P_LEVEL:
        TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortPerConf, TM_Sched_PortPerConf)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_GET(TM_Sched_PortPerConf, DecEn ,       periodic_params->shaper_dec , (uint8_t))
        TM_REGISTER_GET(TM_Sched_PortPerConf, PerEn ,       periodic_params->per_state , (uint8_t))
    }
out:
    COMPLETE_HW_WRITE
    return rc;
...
int set_hw_node_shaping_ex(tm_handle hndl, enum tm_level level, uint32_t node_ind, struct tm_shaping_profile *profile)
{
    ...
    case Q_LEVEL:
        ...
        /* profile assignment */
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueTokenBucketTokenEnDiv, node_ind, TM_Sched_QueueTokenBucketTokenEnDiv)
        if (rc) goto out;
        /* assign register fields */
...
*/
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueTokenBucketTokenEnDiv, node_ind, TM_Sched_QueueTokenBucketTokenEnDiv)
        if (rc) goto out;

        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueTokenBucketBurstSize, node_ind,  TM_Sched_QueueTokenBucketBurstSize)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueTokenBucketBurstSize, node_ind,  TM_Sched_QueueTokenBucketBurstSize)
        if (rc) goto out;
        break;
    ...
    case A_LEVEL:
        ...
        /* profile assignment */
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlTokenBucketTokenEnDiv, node_ind, TM_Sched_AlvlTokenBucketTokenEnDiv)
        if (rc) goto out;
        /* assign register fields */
...
*/
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlTokenBucketTokenEnDiv, node_ind, TM_Sched_AlvlTokenBucketTokenEnDiv)
        if (rc) goto out;

        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlTokenBucketBurstSize, node_ind, TM_Sched_AlvlTokenBucketBurstSize)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlTokenBucketBurstSize, node_ind, TM_Sched_AlvlTokenBucketBurstSize)
        if (rc) goto out;
        break;
    case B_LEVEL:
        ...
        /* profile assignment */
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlTokenBucketTokenEnDiv, node_ind, TM_Sched_BlvlTokenBucketTokenEnDiv)
        if (rc) goto out;
        /* assign register fields */
...
*/
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlTokenBucketTokenEnDiv, node_ind, TM_Sched_BlvlTokenBucketTokenEnDiv)
        if (rc) goto out;
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlTokenBucketBurstSize, node_ind,  TM_Sched_BlvlTokenBucketBurstSize)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlTokenBucketBurstSize, node_ind,  TM_Sched_BlvlTokenBucketBurstSize)
        if (rc) goto out;
        break;
    case C_LEVEL:
        ...
        /* profile assignment */
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlTokenBucketTokenEnDiv, node_ind, TM_Sched_ClvlTokenBucketTokenEnDiv)
        if (rc) goto out;
        /* assign register fields */
...
*/
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlTokenBucketTokenEnDiv, node_ind, TM_Sched_ClvlTokenBucketTokenEnDiv)
        if (rc) goto out;
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlTokenBucketBurstSize, node_ind, TM_Sched_ClvlTokenBucketBurstSize)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlTokenBucketBurstSize, node_ind, TM_Sched_ClvlTokenBucketBurstSize)
        if (rc) goto out;
        break;
    default:
        rc = -EFAULT;
...
int set_hw_port_shaping(tm_handle hndl, uint8_t port_ind)
{
    ...
    if (port_ind < ctl->tm_total_ports)
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortTokenBucketTokenEnDiv , port_ind , TM_Sched_PortTokenBucketTokenEnDiv)
        if (rc) goto out;
        /* assign register fields */
...
*/
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortTokenBucketTokenEnDiv , port_ind , TM_Sched_PortTokenBucketTokenEnDiv)
        if (rc) goto out;

        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortTokenBucketBurstSize , port_ind , TM_Sched_PortTokenBucketBurstSize)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortTokenBucketBurstSize , port_ind , TM_Sched_PortTokenBucketBurstSize)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE

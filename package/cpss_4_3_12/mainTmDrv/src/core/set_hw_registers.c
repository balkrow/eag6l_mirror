...
int set_hw_dwrr_limit(tm_handle hndl)
{
    ...
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDWRRBytesPerBurstsLimit,TM_Sched_PortDWRRBytesPerBurstsLimit)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_Sched_PortDWRRBytesPerBurstsLimit, limit , ctl->dwrr_bytes_burst_limit)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDWRRBytesPerBurstsLimit,TM_Sched_PortDWRRBytesPerBurstsLimit)
...
int set_hw_gen_conf(tm_handle hndl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortExtBPEn, TM_Sched_PortExtBPEn);
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_Sched_PortExtBPEn , En , ctl->port_ext_bp_en);
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortExtBPEn, TM_Sched_PortExtBPEn)
out:
    COMPLETE_HW_WRITE;
    return rc;
}
...
int set_hw_max_dp_mode(tm_handle hndl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.WREDMaxProbModePerColor,TM_Drop_WREDMaxProbModePerColor)
    if (rc) goto out;
    /* assign register fields */
    for (i=0; i<3; i++)
    {
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.WREDMaxProbModePerColor,TM_Drop_WREDMaxProbModePerColor)
out:
    COMPLETE_HW_WRITE
    return rc;
}
                        ...
                        const tm_wred_vec curve_red)
{
    ...
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueREDCurve_Color[0], TM_Drop_QueueREDCurve_Color)
    if (rc) goto out;
    ...
    for (i = 0; i < 32; i++)
    {
        ...
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueREDCurve_Color[0], ind, TM_Drop_QueueREDCurve_Color)
        if (rc)  goto out;

        TM_REGISTER_SET(TM_Drop_QueueREDCurve_Color, Prob, curve_yellow[i])
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueREDCurve_Color[1], ind, TM_Drop_QueueREDCurve_Color)
        if (rc) goto out;

        TM_REGISTER_SET(TM_Drop_QueueREDCurve_Color, Prob, curve_red[i])
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueREDCurve_Color[2], ind,TM_Drop_QueueREDCurve_Color);
        if (rc) goto out;
    }
...
int __set_hw_queues_wred_curve(tm_handle hndl, uint8_t *prob_array, uint8_t curve_ind)
{
    ...
    for (i=0; i<32; i++)
    {
        ...
        for (j=0; j<3; j++)
        {
            ...
            TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueREDCurve_Color[j], ind ,TM_Drop_QueueREDCurve_Color)
            if (rc) goto out;
        }
    }
out:
                        ...
                        const tm_wred_vec curve_red)
{
    ...
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlREDCurve_Color[0], TM_Drop_AlvlREDCurve_Color)
    if (rc)  goto out;
    ...
    for (i = 0; i < 32; i++)
    {
        ...
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlREDCurve_Color[0], ind, TM_Drop_AlvlREDCurve_Color)
        if (rc) goto out;

        TM_REGISTER_SET(TM_Drop_AlvlREDCurve_Color, Prob, curve_yellow[i])
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlREDCurve_Color[1], ind, TM_Drop_AlvlREDCurve_Color)
        if (rc) goto out;

        TM_REGISTER_SET(TM_Drop_AlvlREDCurve_Color, Prob, curve_red[i])
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlREDCurve_Color[2], ind, TM_Drop_AlvlREDCurve_Color)
        if (rc) goto out;
    }
...
int __set_hw_a_nodes_wred_curve(tm_handle hndl, uint8_t *prob_array, uint8_t curve_ind)
{
    ...
    for (i=0; i<32; i++)
    {
        ...
        {
            /* reset register reserved fields */
            TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlREDCurve_Color[j], ind ,TM_Drop_AlvlREDCurve_Color)
            if (rc) goto out;
            /* assign register fields */
            TM_REGISTER_SET(TM_Drop_AlvlREDCurve_Color , Prob , prob_array[i])
            /* write register */
            TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlREDCurve_Color[j], ind ,TM_Drop_AlvlREDCurve_Color)
            if (rc) goto out;
        }
    }
out:
...
int __set_hw_b_nodes_wred_curve(tm_handle hndl, const uint8_t *prob_array, uint8_t curve_ind)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlREDCurve_Table[curve_ind], i ,TM_Drop_BlvlREDCurve_Table);
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Drop_BlvlREDCurve_Table , Prob , prob_array[i]);
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlREDCurve_Table[curve_ind], i ,TM_Drop_BlvlREDCurve_Table);
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int __set_hw_c_nodes_wred_curve(tm_handle hndl, const uint8_t *prob_array, uint8_t cos, uint8_t curve_ind)
{
    ...
    for (i=0; i<32; i++)
    {
        ind = curve_ind*32 + i;
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlREDCurve_CoS[cos], ind ,TM_Drop_ClvlREDCurve_CoS)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Drop_ClvlREDCurve_CoS , Prob , prob_array[i])
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlREDCurve_CoS[cos], ind ,TM_Drop_ClvlREDCurve_CoS)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int __set_hw_ports_wred_curve(tm_handle hndl, const uint8_t *prob_array)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortREDCurveG,i,TM_Drop_PortREDCurveG)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Drop_PortREDCurveG , Prob , prob_array[i])
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortREDCurveG, i, TM_Drop_PortREDCurveG)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
                                  ...
                                  uint8_t cos)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortREDCurve_CoS[cos],i,TM_Drop_PortREDCurve_CoS)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Drop_PortREDCurve_CoS , Prob , prob_array[i]);
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortREDCurve_CoS[cos],i,TM_Drop_PortREDCurve_CoS)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int tm_get_hw_wred_curve(tm_handle hndl, enum tm_level level, uint8_t cos, uint8_t curve_ind, uint8_t *prob_array)
{
    ...
    for (i = 0; i < 32; i++)
    {
        ...
        {
        case Q_LEVEL:
            TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueREDCurve_Color[0], ind , TM_Drop_QueueREDCurve_Color)
            if (rc) goto out;
            /* get register value */
            TM_REGISTER_GET(TM_Drop_QueueREDCurve_Color , Prob , prob_array[i], (uint8_t))
            break;
        case A_LEVEL:
            TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlREDCurve_Color[0], ind , TM_Drop_AlvlREDCurve_Color)
            if (rc) goto out;
            /* get register value */
            TM_REGISTER_GET(TM_Drop_AlvlREDCurve_Color , Prob , prob_array[i], (uint8_t))
            break;
        case B_LEVEL:
            TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlREDCurve_Table[0], ind , TM_Drop_BlvlREDCurve_Table)
            if (rc) goto out;
            /* get register value */
            TM_REGISTER_GET(TM_Drop_BlvlREDCurve_Table , Prob , prob_array[i], (uint8_t))
            break;
        case C_LEVEL:
            TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlREDCurve_CoS[cos], ind , TM_Drop_ClvlREDCurve_CoS)
            if (rc) goto out;
            /* get register value */
            TM_REGISTER_GET(TM_Drop_ClvlREDCurve_CoS , Prob , prob_array[i], (uint8_t))
            break;
        case P_LEVEL:
            if ((cos != (uint8_t)TM_INVAL) && (cos < 8))
            {
                TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortREDCurve_CoS[cos], ind , TM_Drop_PortREDCurve_CoS)
                if (rc) goto out;
                /* get register value */
            ...
            {
                TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortREDCurveG, ind , TM_Drop_PortREDCurveG)
                if (rc) goto out;
                /* get register value */
...
int __set_hw_queue_drop_profile(tm_handle hndl, struct tm_drop_profile *profile, uint32_t prof_ind)
{
    ...
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDParams , prof_ind , TM_Drop_QueueDropPrfWREDParams)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDParams , prof_ind , TM_Drop_QueueDropPrfWREDParams)
    if (rc) goto out;
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDScaleRatio, prof_ind, TM_Drop_QueueDropPrfWREDScaleRatio)
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDScaleRatio, prof_ind, TM_Drop_QueueDropPrfWREDScaleRatio)
    if (rc) goto out;
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDMinThresh, prof_ind,TM_Drop_QueueDropPrfWREDMinThresh)
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDMinThresh, prof_ind,TM_Drop_QueueDropPrfWREDMinThresh)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDDPRatio, prof_ind, TM_Drop_QueueDropPrfWREDDPRatio)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDDPRatio, prof_ind, TM_Drop_QueueDropPrfWREDDPRatio)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfTailDrpThresh, prof_ind, TM_Drop_QueueDropPrfTailDrpThresh)
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfTailDrpThresh, prof_ind, TM_Drop_QueueDropPrfTailDrpThresh)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int __set_hw_a_nodes_drop_profile(tm_handle hndl, struct tm_drop_profile *profile,  uint32_t prof_ind)
{
    ...
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDParams, prof_ind, TM_Drop_AlvlDropPrfWREDParams)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDParams, prof_ind, TM_Drop_AlvlDropPrfWREDParams)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDScaleRatio, prof_ind, TM_Drop_AlvlDropPrfWREDScaleRatio)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDScaleRatio, prof_ind, TM_Drop_AlvlDropPrfWREDScaleRatio)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDMinThresh, prof_ind, TM_Drop_AlvlDropPrfWREDMinThresh)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDMinThresh, prof_ind, TM_Drop_AlvlDropPrfWREDMinThresh)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDDPRatio, prof_ind, TM_Drop_AlvlDropPrfWREDDPRatio)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDDPRatio, prof_ind, TM_Drop_AlvlDropPrfWREDDPRatio)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfTailDrpThresh, prof_ind,TM_Drop_AlvlDropPrfTailDrpThresh)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfTailDrpThresh, prof_ind,TM_Drop_AlvlDropPrfTailDrpThresh)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int __set_hw_b_nodes_drop_profile(tm_handle hndl, struct tm_drop_profile *profile, uint32_t prof_ind)
{
    ...
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDParams, prof_ind, TM_Drop_BlvlDropPrfWREDParams)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDParams, prof_ind, TM_Drop_BlvlDropPrfWREDParams)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDScaleRatio, prof_ind,TM_Drop_BlvlDropPrfWREDScaleRatio)
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDScaleRatio, prof_ind,TM_Drop_BlvlDropPrfWREDScaleRatio)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDMinThresh, prof_ind, TM_Drop_BlvlDropPrfWREDMinThresh)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDMinThresh, prof_ind, TM_Drop_BlvlDropPrfWREDMinThresh)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDDPRatio, prof_ind, TM_Drop_BlvlDropPrfWREDDPRatio)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDDPRatio, prof_ind, TM_Drop_BlvlDropPrfWREDDPRatio)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfTailDrpThresh, prof_ind, TM_Drop_BlvlDropPrfTailDrpThresh)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfTailDrpThresh, prof_ind, TM_Drop_BlvlDropPrfTailDrpThresh)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int __set_hw_c_nodes_drop_profile(tm_handle hndl, struct tm_drop_profile *profile, uint8_t cos, uint32_t prof_ind)
{
    ...
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDParams_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfWREDParams_CoS)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDParams_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfWREDParams_CoS)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDScaleRatio_CoS[cos], prof_ind,  TM_Drop_ClvlDropPrfWREDScaleRatio_CoS)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDScaleRatio_CoS[cos], prof_ind,  TM_Drop_ClvlDropPrfWREDScaleRatio_CoS)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDMinThresh_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfWREDMinThresh_CoS);
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDMinThresh_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfWREDMinThresh_CoS)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDDPRatio_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfWREDDPRatio_CoS)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDDPRatio_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfWREDDPRatio_CoS)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfTailDrpThresh_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfTailDrpThresh_CoS)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfTailDrpThresh_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfTailDrpThresh_CoS)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int __set_hw_ports_drop_profile(tm_handle hndl, struct tm_drop_profile *profile, uint32_t prof_ind, uint8_t port_ind)
{
    ...
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDParamsG, port_ind,TM_Drop_PortDropPrfWREDParamsG)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDParamsG, port_ind,TM_Drop_PortDropPrfWREDParamsG)
    if (rc) goto out;
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDScaleRatioG, port_ind, TM_Drop_PortDropPrfWREDScaleRatioG)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDScaleRatioG, port_ind, TM_Drop_PortDropPrfWREDScaleRatioG)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDMinThreshG, port_ind, TM_Drop_PortDropPrfWREDMinThreshG)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDMinThreshG, port_ind, TM_Drop_PortDropPrfWREDMinThreshG)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDDPRatioG, port_ind, TM_Drop_PortDropPrfWREDDPRatioG)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDDPRatioG, port_ind, TM_Drop_PortDropPrfWREDDPRatioG)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfTailDrpThreshG, port_ind,  TM_Drop_PortDropPrfTailDrpThreshG)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfTailDrpThreshG, port_ind,  TM_Drop_PortDropPrfTailDrpThreshG)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int __set_hw_ports_drop_profile_cos(tm_handle hndl, struct tm_drop_profile *profile, uint8_t cos, uint32_t port_ind)
{
    ...
    TM_CTL(ctl, hndl);
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDParams_CoS[cos] , port_ind , TM_Drop_PortDropPrfWREDParams_CoS)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDParams_CoS[cos] , port_ind , TM_Drop_PortDropPrfWREDParams_CoS);
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDScaleRatio_CoS[cos] , port_ind , TM_Drop_PortDropPrfWREDScaleRatio_CoS);
    if (rc) goto out;
    /* assign register fields */
    ...
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDScaleRatio_CoS[cos] , port_ind , TM_Drop_PortDropPrfWREDScaleRatio_CoS);
    /* write register */
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDMinThresh_CoS[cos] , port_ind , TM_Drop_PortDropPrfWREDMinThresh_CoS);
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDMinThresh_CoS[cos] , port_ind , TM_Drop_PortDropPrfWREDMinThresh_CoS);
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDDPRatio_CoS[cos] , port_ind , TM_Drop_PortDropPrfWREDDPRatio_CoS);
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDDPRatio_CoS[cos] , port_ind , TM_Drop_PortDropPrfWREDDPRatio_CoS);
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfTailDrpThresh_CoS[cos] , port_ind , TM_Drop_PortDropPrfTailDrpThresh_CoS);
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfTailDrpThresh_CoS[cos] , port_ind , TM_Drop_PortDropPrfTailDrpThresh_CoS);
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE;
    return rc;
...
int set_hw_aging_status(tm_handle hndl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AgingUpdEnable , TM_Drop_AgingUpdEnable)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_Drop_AgingUpdEnable , En , ctl->aging_status)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AgingUpdEnable , TM_Drop_AgingUpdEnable)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int set_hw_tm2tm_channels(tm_handle hndl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMElementsPerEgTMLevel, TM_TM2TM_TMtoTMElementsPerEgTMLevel)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMElementsPerEgTMLevel, TM_TM2TM_TMtoTMElementsPerEgTMLevel)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMEgTMLevelMap, TM_TM2TM_TMtoTMEgTMLevelMap)
    if (rc) goto out;
    /* assign register fields */
    /* write register */
    ...
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMEgTMLevelMap, TM_TM2TM_TMtoTMEgTMLevelMap)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TM2TMGenModePerLevel, TM_TM2TM_TM2TMGenModePerLevel)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TM2TMGenModePerLevel, TM_TM2TM_TM2TMGenModePerLevel)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMEgTMBPLevelMap, TM_TM2TM_TMtoTMEgTMBPLevelMap)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMEgTMBPLevelMap, TM_TM2TM_TMtoTMEgTMBPLevelMap)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMBaseOffsetPerIngTMLevel, TM_TM2TM_TMtoTMBaseOffsetPerIngTMLevel)
    if (rc) goto out;
    /* assign register fields */
    ...
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMBaseOffsetPerIngTMLevel, TM_TM2TM_TMtoTMBaseOffsetPerIngTMLevel)
    /* write register */
    if (rc) goto out;
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TM2TMXonXoffThresh, TM_TM2TM_TM2TMXonXoffThresh)
    if (rc) goto out;
    /* assign register fields */
    ...
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TM2TMXonXoffThresh, TM_TM2TM_TM2TMXonXoffThresh)
    /* write register */
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
...
int set_hw_drop_aqm_mode(tm_handle hndl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.WREDDropProbMode, TM_Drop_WREDDropProbMode)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.WREDDropProbMode, TM_Drop_WREDDropProbMode)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.DPSource, TM_Drop_DPSource);
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.DPSource, TM_Drop_DPSource)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int get_hw_drop_resolution(tm_handle hndl, uint8_t *p_resolution_mask)
{
    int rc =  -EFAULT;
    int value = 0;
    ...
    *p_resolution_mask = 0;
    ...
    /* assign register fields */
    TM_REGISTER_GET(TM_Drop_WREDDropProbMode , Port , value , (int))
    *p_resolution_mask += (value << P_LEVEL);
    TM_REGISTER_GET(TM_Drop_WREDDropProbMode , Clvl , value , (int))
    *p_resolution_mask += (value << C_LEVEL);
    TM_REGISTER_GET(TM_Drop_WREDDropProbMode , Blvl , value , (int))
    *p_resolution_mask += (value << B_LEVEL);
    TM_REGISTER_GET(TM_Drop_WREDDropProbMode , Alvl , value , (int))
    *p_resolution_mask += (value << A_LEVEL);
    TM_REGISTER_GET(TM_Drop_WREDDropProbMode , Queue, value , (int))
    *p_resolution_mask += (value << Q_LEVEL);
...
int set_hw_tm2tm_aqm_mode(tm_handle hndl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.RemoteDPMode, TM_TM2TM_RemoteDPMode)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.RemoteDPMode, TM_TM2TM_RemoteDPMode)
    if (rc) goto out;
...
int set_hw_periodic_scheme(tm_handle hndl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortPerRateShpPrms, TM_Sched_PortPerRateShpPrms)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortPerRateShpPrms, TM_Sched_PortPerRateShpPrms)
    if (rc) goto out;
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlPerRateShpPrms, TM_Sched_ClvlPerRateShpPrms)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlPerRateShpPrms, TM_Sched_ClvlPerRateShpPrms)
    if (rc) goto out;
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlPerRateShpPrms, TM_Sched_BlvlPerRateShpPrms)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlPerRateShpPrms, TM_Sched_BlvlPerRateShpPrms)
    if (rc) goto out;
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlPerRateShpPrms, TM_Sched_AlvlPerRateShpPrms)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlPerRateShpPrms, TM_Sched_AlvlPerRateShpPrms)
    if (rc) goto out;
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueuePerRateShpPrms, TM_Sched_QueuePerRateShpPrms)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueuePerRateShpPrms, TM_Sched_QueuePerRateShpPrms)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ScrubSlotAlloc, TM_Sched_ScrubSlotAlloc)
    if (rc) goto out;
    /* assign register fields */
    /* write register */
    ...
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ScrubSlotAlloc, TM_Sched_ScrubSlotAlloc)
    if (rc) goto out;
...
int set_hw_node_mapping(tm_handle hndl, enum tm_level lvl, uint32_t index)
{
    ...
    case P_LEVEL:
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortRangeMap , index , TM_Sched_PortRangeMap)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortRangeMap , index , TM_Sched_PortRangeMap)
        break;
    case C_LEVEL:
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvltoPortAndBlvlRangeMap , index , TM_Sched_ClvltoPortAndBlvlRangeMap)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvltoPortAndBlvlRangeMap , index , TM_Sched_ClvltoPortAndBlvlRangeMap)
        break;
    case B_LEVEL:
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BLvltoClvlAndAlvlRangeMap , index , TM_Sched_BLvltoClvlAndAlvlRangeMap)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BLvltoClvlAndAlvlRangeMap , index , TM_Sched_BLvltoClvlAndAlvlRangeMap)
        break;
    case A_LEVEL:
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ALvltoBlvlAndQueueRangeMap , index , TM_Sched_ALvltoBlvlAndQueueRangeMap)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ALvltoBlvlAndQueueRangeMap , index , TM_Sched_ALvltoBlvlAndQueueRangeMap)
        break;
    case Q_LEVEL:
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueAMap , index , TM_Sched_QueueAMap)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_QueueAMap , Alvl , ctl->tm_queue_array[index].mapping.nodeParent)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueAMap , index , TM_Sched_QueueAMap)
        break;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_queue_drop_profile_ptr(tm_handle hndl, uint32_t queue_ind)
{
    ...
    if (queue_ind < ctl->tm_total_queues)
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropProfPtr , entry , TM_Drop_QueueDropProfPtr)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropProfPtr , entry , TM_Drop_QueueDropProfPtr)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_queue_params(tm_handle hndl, uint32_t queue_ind)
{
   ...
   TM_REGISTER_VAR(TM_Sched_QueueQuantum)
    ...
    if (queue_ind < ctl->tm_total_queues)
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueQuantum , queue_ind , TM_Sched_QueueQuantum)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_QueueQuantum , Quantum , queue->dwrr_quantum)
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueQuantum , queue_ind , TM_Sched_QueueQuantum)
        /* write register */
        if (rc) goto out;
...
int get_hw_queue_params(tm_handle hndl, uint32_t index, struct queue_hw_data_t *queue_hw_data)
{
    int rc = -EFAULT;
    ...
    if (index < ctl->tm_total_queues)
    {
        ...
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_QueueAMap, Alvl, queue_hw_data->parent_a_node, (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueEligPrioFuncPtr, index, TM_Sched_QueueEligPrioFuncPtr);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_QueueEligPrioFuncPtr, Ptr, queue_hw_data->elig_prio_func_ptr, (uint8_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueQuantum, index, TM_Sched_QueueQuantum);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_QueueQuantum, Quantum, queue_hw_data->dwrr_quantum, (uint16_t));
        ...
        {
        case 0:
            TM_REGISTER_GET(TM_Drop_QueueDropProfPtr, ProfPtr0, queue_hw_data->wred_profile_ref, (uint8_t));
            break;
        case 1:
            TM_REGISTER_GET(TM_Drop_QueueDropProfPtr, ProfPtr1, queue_hw_data->wred_profile_ref, (uint8_t));
            break;
        case 2:
            TM_REGISTER_GET(TM_Drop_QueueDropProfPtr, ProfPtr2, queue_hw_data->wred_profile_ref, (uint8_t));
            break;
        case 3:
            TM_REGISTER_GET(TM_Drop_QueueDropProfPtr, ProfPtr3, queue_hw_data->wred_profile_ref, (uint8_t));
            break;
        }
    }
    return rc;
...
int set_hw_a_node_drop_profile_ptr(tm_handle hndl, uint32_t node_ind)
{
    ...
    if (node_ind < ctl->tm_total_a_nodes)
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropProfPtr , entry , TM_Drop_AlvlDropProfPtr);
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropProfPtr , entry , TM_Drop_AlvlDropProfPtr)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_a_node_params(tm_handle hndl, uint32_t node_ind)
{
    ...
    if (node_ind < ctl->tm_total_a_nodes)
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlQuantum , node_ind , TM_Sched_AlvlQuantum)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_AlvlQuantum , Quantum , node->dwrr_quantum)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlQuantum , node_ind , TM_Sched_AlvlQuantum)
        if (rc) goto out;

        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlDWRRPrioEn , node_ind , TM_Sched_AlvlDWRRPrioEn)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_AlvlDWRRPrioEn , En , node->dwrr_enable_per_priority_mask)
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlDWRRPrioEn , node_ind , TM_Sched_AlvlDWRRPrioEn)
        /* write register */
        if (rc) goto out;
...
int get_hw_a_node_params(tm_handle hndl, uint32_t index, struct a_node_hw_data_t *a_node_hw_data)
{
    int rc = -EFAULT;
    ...
    if (index < ctl->tm_total_a_nodes)
    {
        ...
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_ALvltoBlvlAndQueueRangeMap, Blvl, a_node_hw_data->parent_b_node, (uint16_t));
        TM_REGISTER_GET(TM_Sched_ALvltoBlvlAndQueueRangeMap, QueueHi, a_node_hw_data->last_child_queue, (uint16_t));
        TM_REGISTER_GET(TM_Sched_ALvltoBlvlAndQueueRangeMap, QueueLo, a_node_hw_data->first_child_queue, (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlEligPrioFuncPtr, index, TM_Sched_AlvlEligPrioFuncPtr);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_AlvlEligPrioFuncPtr, Ptr, a_node_hw_data->elig_prio_func_ptr, (uint8_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlQuantum, index, TM_Sched_AlvlQuantum);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_AlvlQuantum, Quantum, a_node_hw_data->dwrr_quantum, (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlDWRRPrioEn, index, TM_Sched_AlvlDWRRPrioEn);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_AlvlDWRRPrioEn, En, a_node_hw_data->dwrr_priority, (uint8_t));
        ...
        {
        case 0:
            TM_REGISTER_GET(TM_Drop_AlvlDropProfPtr, ProfPtr0, a_node_hw_data->wred_profile_ref, (uint8_t));
            break;
        case 1:
            TM_REGISTER_GET(TM_Drop_AlvlDropProfPtr, ProfPtr1, a_node_hw_data->wred_profile_ref, (uint8_t));
            break;
        case 2:
            TM_REGISTER_GET(TM_Drop_AlvlDropProfPtr, ProfPtr2, a_node_hw_data->wred_profile_ref, (uint8_t));
            break;
        case 3:
            TM_REGISTER_GET(TM_Drop_AlvlDropProfPtr, ProfPtr3, a_node_hw_data->wred_profile_ref, (uint8_t));
            break;
        }
    }
    return rc;
...
int set_hw_b_node_drop_profile_ptr(tm_handle hndl, uint32_t node_ind)
{
    ...
    if (node_ind < ctl->tm_total_b_nodes)
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropProfPtr , entry , TM_Drop_BlvlDropProfPtr);
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropProfPtr , entry , TM_Drop_BlvlDropProfPtr)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_b_node_params(tm_handle hndl, uint32_t node_ind)
{
    ...
    if (node_ind < ctl->tm_total_b_nodes)
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlQuantum , node_ind , TM_Sched_BlvlQuantum)
        if (rc) goto out;
        /* assign register fields */
        /* write register */
        TM_REGISTER_SET(TM_Sched_BlvlQuantum , Quantum , node->dwrr_quantum)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlQuantum , node_ind , TM_Sched_BlvlQuantum)
        if (rc) goto out;

        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlDWRRPrioEn , node_ind , TM_Sched_BlvlDWRRPrioEn)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_BlvlDWRRPrioEn , En , node->dwrr_enable_per_priority_mask)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlDWRRPrioEn , node_ind , TM_Sched_BlvlDWRRPrioEn)
        if (rc) goto out;
...
int get_hw_b_node_params(tm_handle hndl, uint32_t index, struct b_node_hw_data_t *b_node_hw_data)
{
    int rc = -EFAULT;
    ...
    if (index < ctl->tm_total_b_nodes)
    {
        ...
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_BLvltoClvlAndAlvlRangeMap, Clvl, b_node_hw_data->parent_c_node, (uint16_t));
        TM_REGISTER_GET(TM_Sched_BLvltoClvlAndAlvlRangeMap, AlvlHi, b_node_hw_data->last_child_a_node, (uint16_t));
        TM_REGISTER_GET(TM_Sched_BLvltoClvlAndAlvlRangeMap, AlvlLo, b_node_hw_data->first_child_a_node, (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlEligPrioFuncPtr, index, TM_Sched_BlvlEligPrioFuncPtr);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_BlvlEligPrioFuncPtr, Ptr, b_node_hw_data->elig_prio_func_ptr, (uint8_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlQuantum, index, TM_Sched_BlvlQuantum);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_BlvlQuantum, Quantum, b_node_hw_data->dwrr_quantum, (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlDWRRPrioEn, index, TM_Sched_BlvlDWRRPrioEn);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_BlvlDWRRPrioEn, En, b_node_hw_data->dwrr_priority, (uint8_t));
        ...
        {
        case 0:
            TM_REGISTER_GET(TM_Drop_BlvlDropProfPtr, ProfPtr0, b_node_hw_data->wred_profile_ref, (uint16_t));
            break;
        case 1:
            TM_REGISTER_GET(TM_Drop_BlvlDropProfPtr, ProfPtr1, b_node_hw_data->wred_profile_ref, (uint16_t));
            break;
        case 2:
            TM_REGISTER_GET(TM_Drop_BlvlDropProfPtr, ProfPtr2, b_node_hw_data->wred_profile_ref, (uint16_t));
            break;
        case 3:
            TM_REGISTER_GET(TM_Drop_BlvlDropProfPtr, ProfPtr3, b_node_hw_data->wred_profile_ref, (uint16_t));
            break;
        case 4:
            TM_REGISTER_GET(TM_Drop_BlvlDropProfPtr, ProfPtr4, b_node_hw_data->wred_profile_ref, (uint16_t));
            break;
        case 5:
            TM_REGISTER_GET(TM_Drop_BlvlDropProfPtr, ProfPtr5, b_node_hw_data->wred_profile_ref, (uint16_t));
            break;
        case 6:
            TM_REGISTER_GET(TM_Drop_BlvlDropProfPtr, ProfPtr6, b_node_hw_data->wred_profile_ref, (uint16_t));
            break;
        case 7:
            TM_REGISTER_GET(TM_Drop_BlvlDropProfPtr, ProfPtr7, b_node_hw_data->wred_profile_ref, (uint16_t));
            break;
        default:
            rc = -EINVAL;
            break;
...
int set_hw_c_node_drop_profile_ptr(tm_handle hndl, uint32_t node_ind , uint8_t cos)
{
    ...
    if ((node_ind < ctl->tm_total_c_nodes) && (cos < TM_WRED_COS))
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropProfPtr_CoS[cos] , entry , TM_Drop_ClvlDropProfPtr_CoS)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropProfPtr_CoS[cos] , entry , TM_Drop_ClvlDropProfPtr_CoS)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_c_node_params(tm_handle hndl, uint32_t node_ind)
{
    ...
    if (node_ind < ctl->tm_total_c_nodes)
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlQuantum , node_ind , TM_Sched_ClvlQuantum)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_ClvlQuantum , Quantum , node->dwrr_quantum)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlQuantum , node_ind , TM_Sched_ClvlQuantum)
        if (rc) goto out;

        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlDWRRPrioEn , node_ind , TM_Sched_ClvlDWRRPrioEn)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_ClvlDWRRPrioEn , En , node->dwrr_enable_per_priority_mask)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlDWRRPrioEn , node_ind , TM_Sched_ClvlDWRRPrioEn)
        if (rc) goto out;
...
int get_hw_c_node_params(tm_handle hndl, uint32_t index, struct c_node_hw_data_t *c_node_hw_data)
{
    int rc = -EFAULT;
    int i;
    int entry;
    ...
    if (index < ctl->tm_total_c_nodes)
    {
        ...
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_ClvltoPortAndBlvlRangeMap, Port, c_node_hw_data->parent_port, (uint8_t));
        TM_REGISTER_GET(TM_Sched_ClvltoPortAndBlvlRangeMap, BlvlHi, c_node_hw_data->last_child_b_node, (uint16_t));
        TM_REGISTER_GET(TM_Sched_ClvltoPortAndBlvlRangeMap, BlvlLo, c_node_hw_data->first_child_b_node, (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlEligPrioFuncPtr, index, TM_Sched_ClvlEligPrioFuncPtr);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_ClvlEligPrioFuncPtr, Ptr, c_node_hw_data->elig_prio_func_ptr, (uint8_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlQuantum, index, TM_Sched_ClvlQuantum);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_ClvlQuantum, Quantum, c_node_hw_data->dwrr_quantum, (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlDWRRPrioEn, index, TM_Sched_ClvlDWRRPrioEn);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_ClvlDWRRPrioEn, En, c_node_hw_data->dwrr_priority, (uint8_t));
        ...
        for (i = 0; i < TM_WRED_COS; i++)
        {
            TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropProfPtr_CoS[i], entry, TM_Drop_ClvlDropProfPtr_CoS);
            if (rc) return rc;
            switch (ind)
            {
            case 0:
                TM_REGISTER_GET(TM_Drop_ClvlDropProfPtr_CoS, ProfPtr0,  c_node_hw_data->wred_profile_ref[i], (uint8_t));
                break;
            case 1:
                TM_REGISTER_GET(TM_Drop_ClvlDropProfPtr_CoS, ProfPtr1, c_node_hw_data->wred_profile_ref[i], (uint8_t));
                break;
            case 2:
                TM_REGISTER_GET(TM_Drop_ClvlDropProfPtr_CoS, ProfPtr2, c_node_hw_data->wred_profile_ref[i], (uint8_t));
                break;
            case 3:
                TM_REGISTER_GET(TM_Drop_ClvlDropProfPtr_CoS, ProfPtr3, c_node_hw_data->wred_profile_ref[i], (uint8_t));
                break;
            case 4:
                TM_REGISTER_GET(TM_Drop_ClvlDropProfPtr_CoS, ProfPtr4, c_node_hw_data->wred_profile_ref[i], (uint8_t));
                break;
            case 5:
                TM_REGISTER_GET(TM_Drop_ClvlDropProfPtr_CoS, ProfPtr5, c_node_hw_data->wred_profile_ref[i], (uint8_t));
                break;
            case 6:
                TM_REGISTER_GET(TM_Drop_ClvlDropProfPtr_CoS, ProfPtr6, c_node_hw_data->wred_profile_ref[i], (uint8_t));
                break;
            case 7:
                TM_REGISTER_GET(TM_Drop_ClvlDropProfPtr_CoS, ProfPtr7, c_node_hw_data->wred_profile_ref[i], (uint8_t));
                break;
            }
        }
    }
...
int set_hw_port_scheduling(tm_handle hndl, uint8_t port_ind)
{
    ...
    if (port_ind < ctl->tm_total_ports)
    {
        ...
        /* DWRR for Port */
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortQuantumsPriosLo , port_ind , TM_Sched_PortQuantumsPriosLo)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortQuantumsPriosLo , port_ind , TM_Sched_PortQuantumsPriosLo)
        if (rc) goto out;

        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortQuantumsPriosHi , port_ind , TM_Sched_PortQuantumsPriosHi)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortQuantumsPriosHi , port_ind , TM_Sched_PortQuantumsPriosHi)
        if (rc) goto out;

        /* DWRR for C-nodes in Port's range */
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDWRRPrioEn , port_ind , TM_Sched_PortDWRRPrioEn)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_PortDWRRPrioEn ,En , port->dwrr_enable_per_priority_mask)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDWRRPrioEn , port_ind , TM_Sched_PortDWRRPrioEn)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int get_hw_port_params(tm_handle hndl, uint32_t index, struct port_hw_data_t *port_hw_data)
{
    int rc = -EFAULT;
    ...
    if (index < ctl->tm_total_ports)
    {
        ...
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_PortRangeMap, Hi, port_hw_data->last_child_c_node, (uint16_t));
        TM_REGISTER_GET(TM_Sched_PortRangeMap, Lo, port_hw_data->first_child_c_node, (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortEligPrioFuncPtr, index, TM_Sched_PortEligPrioFuncPtr);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_PortEligPrioFuncPtr, Ptr, port_hw_data->elig_prio_func_ptr, (uint8_t));

        /* DWRR for Port */
        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortQuantumsPriosLo, index, TM_Sched_PortQuantumsPriosLo);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_PortQuantumsPriosLo, Quantum0, port_hw_data->dwrr_quantum[0], (uint16_t));
        TM_REGISTER_GET(TM_Sched_PortQuantumsPriosLo, Quantum1, port_hw_data->dwrr_quantum[1], (uint16_t));
        TM_REGISTER_GET(TM_Sched_PortQuantumsPriosLo, Quantum2, port_hw_data->dwrr_quantum[2], (uint16_t));
        TM_REGISTER_GET(TM_Sched_PortQuantumsPriosLo, Quantum3, port_hw_data->dwrr_quantum[3], (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortQuantumsPriosHi, index, TM_Sched_PortQuantumsPriosHi);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_PortQuantumsPriosHi, Quantum4, port_hw_data->dwrr_quantum[4], (uint16_t));
        TM_REGISTER_GET(TM_Sched_PortQuantumsPriosHi, Quantum5, port_hw_data->dwrr_quantum[5], (uint16_t));
        TM_REGISTER_GET(TM_Sched_PortQuantumsPriosHi, Quantum6, port_hw_data->dwrr_quantum[6], (uint16_t));
        TM_REGISTER_GET(TM_Sched_PortQuantumsPriosHi, Quantum7, port_hw_data->dwrr_quantum[7], (uint16_t));

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDWRRPrioEn, index, TM_Sched_PortDWRRPrioEn);
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Sched_PortDWRRPrioEn, En, port_hw_data->dwrr_priority, (uint8_t));
...
int set_hw_tree_deq_status(tm_handle hndl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.TreeDeqEn, TM_Sched_TreeDeqEn)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_Sched_TreeDeqEn , En , ctl->tree_deq_status)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.TreeDeqEn, TM_Sched_TreeDeqEn )
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int set_hw_tree_dwrr_priority(tm_handle hndl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.TreeDWRRPrioEn, TM_Sched_TreeDWRRPrioEn)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_Sched_TreeDWRRPrioEn , PrioEn , ctl->tree_dwrr_enable_per_priority_mask)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.TreeDWRRPrioEn, TM_Sched_TreeDWRRPrioEn)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int set_hw_install_queue(tm_handle hndl, uint32_t index)
{
    ...
    TM_CTL(ctl, hndl)
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.QueueInstallCmd, TM_QMgr_QueueInstallCmd)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_QMgr_QueueInstallCmd , Queue , index)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.QueueInstallCmd, TM_QMgr_QueueInstallCmd)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int set_hw_uninstall_queue(tm_handle hndl, uint32_t index)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.QueueRemoveCmd, TM_QMgr_QueueRemoveCmd)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_QMgr_QueueRemoveCmd , Queue , index)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.QueueRemoveCmd, TM_QMgr_QueueRemoveCmd)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int set_hw_node_elig_prio_function_ex(tm_handle hndl, enum tm_level node_level, uint32_t node_index,uint8_t elig_prio_func_ptr)
{
    ...
    case P_LEVEL:
        ...
        {
            /* reset register reserved fields */
            TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortEligPrioFuncPtr , node_index , TM_Sched_PortEligPrioFuncPtr)
            if (rc) break;
            /* assign register fields */
            TM_REGISTER_SET(TM_Sched_PortEligPrioFuncPtr , Ptr , elig_prio_func_ptr)
            /* write register */
            TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortEligPrioFuncPtr , node_index , TM_Sched_PortEligPrioFuncPtr)
        }
        break;
    case C_LEVEL:
        ...
        {
            /* reset register reserved fields */
            TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlEligPrioFuncPtr , node_index , TM_Sched_ClvlEligPrioFuncPtr)
            if (rc) break;
            /* assign register fields */
            TM_REGISTER_SET(TM_Sched_ClvlEligPrioFuncPtr , Ptr , elig_prio_func_ptr)
            /* write register */
            TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlEligPrioFuncPtr , node_index , TM_Sched_ClvlEligPrioFuncPtr)
        }
        break;
    case B_LEVEL:
        ...
        {
            /* reset register reserved fields */
            TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlEligPrioFuncPtr , node_index , TM_Sched_BlvlEligPrioFuncPtr)
            if (rc) break;
            /* assign register fields */
            TM_REGISTER_SET(TM_Sched_BlvlEligPrioFuncPtr , Ptr , elig_prio_func_ptr)
            /* write register */
            TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlEligPrioFuncPtr , node_index , TM_Sched_BlvlEligPrioFuncPtr)
        }
        break;
    case A_LEVEL:
        ...
        {
        /* reset register reserved fields */
            TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlEligPrioFuncPtr , node_index , TM_Sched_AlvlEligPrioFuncPtr)
            if (rc) break;
            /* assign register fields */
            TM_REGISTER_SET(TM_Sched_AlvlEligPrioFuncPtr , Ptr , elig_prio_func_ptr)
            /* write register */
            TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlEligPrioFuncPtr , node_index , TM_Sched_AlvlEligPrioFuncPtr)
        }
        break;
    case Q_LEVEL:
        ...
        {
            /* reset register reserved fields */
            TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueEligPrioFuncPtr , node_index , TM_Sched_QueueEligPrioFuncPtr)
            if (rc) break;
            /* assign register fields */
            TM_REGISTER_SET(TM_Sched_QueueEligPrioFuncPtr , Ptr , elig_prio_func_ptr)
            /* write register */
            TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueEligPrioFuncPtr , node_index , TM_Sched_QueueEligPrioFuncPtr)
        }
        break;
    }
    COMPLETE_HW_WRITE
...
int set_hw_disable_ports(tm_handle hndl, uint32_t total_ports)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortEligPrioFuncPtr , i , TM_Sched_PortEligPrioFuncPtr)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_PortEligPrioFuncPtr , Ptr , TM_ELIG_DEQ_DISABLE)  /* DeQ disable function ID */
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortEligPrioFuncPtr , i , TM_Sched_PortEligPrioFuncPtr)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_q_elig_prio_func_entry(tm_handle hndl, uint16_t func_offset)
{
    ...
    /* reset register reserved fields */
    TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueEligPrioFunc, func_offset, TM_Sched_QueueEligPrioFunc)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueEligPrioFunc, func_offset, TM_Sched_QueueEligPrioFunc)
    if (rc)
        goto out;
...
int set_hw_a_lvl_elig_prio_func_entry(tm_handle hndl, uint16_t func_offset)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlEligPrioFunc_Entry, func_offset + i*64, TM_Sched_AlvlEligPrioFunc_Entry)
        if (rc) goto out;
        /* assign register fields */
        ...
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlEligPrioFunc_Entry, func_offset + i*64 ,TM_Sched_AlvlEligPrioFunc_Entry)
        /* write register */
        if (rc) goto out;
    }
out:
...
int set_hw_b_lvl_elig_prio_func_entry(tm_handle hndl, uint16_t func_offset)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlEligPrioFunc_Entry, func_offset + i*64 ,TM_Sched_BlvlEligPrioFunc_Entry);
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlEligPrioFunc_Entry, func_offset + i*64 ,TM_Sched_BlvlEligPrioFunc_Entry)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_c_lvl_elig_prio_func_entry(tm_handle hndl, uint16_t func_offset)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlEligPrioFunc_Entry, func_offset + i*64,TM_Sched_ClvlEligPrioFunc_Entry);
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlEligPrioFunc_Entry, func_offset + i*64 ,TM_Sched_ClvlEligPrioFunc_Entry);
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE;
...
int set_hw_p_lvl_elig_prio_func_entry(tm_handle hndl, uint16_t func_offset)
{
    ...
    {   /* Entry ID */
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortEligPrioFunc_Entry, func_offset + i*64 ,TM_Sched_PortEligPrioFunc_Entry)
        if (rc) goto out;
        /* assign register fields */
        /* write register */
        ...
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortEligPrioFunc_Entry , func_offset + i*64 ,TM_Sched_PortEligPrioFunc_Entry);
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_port_deficit_clear(tm_handle hndl, uint8_t index)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDefPrioHi, index, TM_Sched_PortDefPrioHi)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDefPrioHi, index, TM_Sched_PortDefPrioHi)
        if (rc) goto out;
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDefPrioLo, index, TM_Sched_PortDefPrioLo)
        if (rc) goto out;
        /* assign register fields */
        ...
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDefPrioLo, index, TM_Sched_PortDefPrioLo)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_c_node_deficit_clear(tm_handle hndl, uint32_t index)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.CLvlDef, index, TM_Sched_CLvlDef)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_CLvlDef , Deficit , 0x1)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.CLvlDef, index, TM_Sched_CLvlDef)
        if (rc) goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_b_node_deficit_clear(tm_handle hndl, uint32_t index)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlDef, index, TM_Sched_BlvlDef)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_BlvlDef , Deficit , 0x1)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlDef, index, TM_Sched_BlvlDef)
        if (rc)  goto out;
    }
out:
    COMPLETE_HW_WRITE
...
int set_hw_a_node_deficit_clear(tm_handle hndl, uint32_t index)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlDef, index, TM_Sched_AlvlDef)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_AlvlDef , Deficit , 0x1)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlDef, index, TM_Sched_AlvlDef)
        if (rc)
          goto out;
    }
out:
...
int set_hw_queue_deficit_clear(tm_handle hndl, uint32_t index)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueDef, index, TM_Sched_QueueDef)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_Sched_QueueDef , Deficit , 0x1)
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueDef, index, TM_Sched_QueueDef)
        if (rc)
          goto out;
    }
out:
...
int get_hw_flush_queue_status(tm_handle hndl, uint32_t index, uint8_t * status)
{
    ...
    if (index < ctl->tm_total_queues)
    {
        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.QueueFlush, index, TM_QMgr_QueueFlush)
        if (rc) goto out;
...
int set_hw_flush_queue(tm_handle hndl, uint32_t index, uint8_t block_en)
{
    ...
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.QueueFlush, index, TM_QMgr_QueueFlush)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_QMgr_QueueFlush, Flush, 1) /* enable */
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.QueueFlush, index, TM_QMgr_QueueFlush)
        if (rc) goto out;
...
int get_hw_flush_port_status(tm_handle hndl, uint32_t index, uint8_t * status)
{
    ...
    if (index < ctl->tm_total_ports)
    {
        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.PortFlush, index, TM_QMgr_PortFlush)
        if (rc) goto out;
...
int set_hw_flush_port(tm_handle hndl, uint32_t index, uint8_t block_en)
{
    ...
    if (index < ctl->tm_total_ports)
    {
        ...
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.PortFlush, index, TM_QMgr_PortFlush)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_QMgr_PortFlush, Flush, 1) /* enable */
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.PortFlush, index, TM_QMgr_PortFlush)
        if (rc) goto out;
                       ...
                       struct tm_delta_range *range)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.TMtoTMDPCoSSel, TM_Drop_TMtoTMDPCoSSel)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_Drop_TMtoTMDPCoSSel , CDPCoSSel , cos_sel)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.TMtoTMDPCoSSel, TM_Drop_TMtoTMDPCoSSel)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.ExtHeadersSize,  TM_TM2TM_ExtHeadersSize)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_TM2TM_ExtHeadersSize , Size , ext_hdr->size)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.ExtHeadersSize,  TM_TM2TM_ExtHeadersSize)
    if (rc) goto out;

    for (i = 0; i < 4; i++)
    {
        /* reset register reserved fields */
        TM_RESET_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.ExtHeadersContent, i, TM_TM2TM_ExtHeadersContent)
        if (rc) goto out;
        /* assign register fields */
        TM_REGISTER_SET(TM_TM2TM_ExtHeadersContent,Headers, ext_hdr->content[i])
        /* write register */
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.ExtHeadersContent, i, TM_TM2TM_ExtHeadersContent)
        if (rc) goto out;
    }
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMPktStructure, TM_TM2TM_TMtoTMPktStructure)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMPktStructure, TM_TM2TM_TMtoTMPktStructure)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMHeader, TM_TM2TM_TMHeader)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_TM2TM_TMHeader , Header , 0x1)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMHeader, TM_TM2TM_TMHeader)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.Delta2PrioMap, TM_TM2TM_Delta2PrioMap)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.Delta2PrioMap, TM_TM2TM_Delta2PrioMap)
    if (rc)  goto out;
...
int set_hw_dp_remote_resp(tm_handle hndl, enum tm2tm_channel remote_lvl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.RespRemoteDPSel, TM_TM2TM_RespRemoteDPSel)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_TM2TM_RespRemoteDPSel , DPSel , remote_lvl)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.RespRemoteDPSel, TM_TM2TM_RespRemoteDPSel)
    if (rc) goto out;
...
int set_hw_dp_local_resp(tm_handle hndl, uint8_t port_dp, enum tm_level local_lvl)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.RespLocalDPSel, TM_Drop_RespLocalDPSel)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_Drop_RespLocalDPSel , DPSel , local_lvl)
    TM_REGISTER_SET(TM_Drop_RespLocalDPSel , PortDPSel , port_dp)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.RespLocalDPSel, TM_Drop_RespLocalDPSel)
    if (rc)
      goto out;
...
int get_hw_dp_local_resp(tm_handle hndl, uint8_t * port_dp, enum tm_level  *local_lvl)
{
    ...
    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.RespLocalDPSel, TM_Drop_RespLocalDPSel)
    if (rc) goto out;
    /* assign register fields */
                     ...
                     uint8_t tm_port)
{
    ...
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.TMtoTMPktGenQuantum, TM_Drop_TMtoTMPktGenQuantum)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_Drop_TMtoTMPktGenQuantum , Quantum , quantum)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.TMtoTMPktGenQuantum, TM_Drop_TMtoTMPktGenQuantum)
    if (rc) goto out;
    ...
    */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.QmapHeaderCont, TM_TM2TM_QmapHeaderCont)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.ContHeader , TM_TM2TM_ContHeader)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_TM2TM_ContHeader , LnCard , ctrl_hdr)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.ContHeader , TM_TM2TM_ContHeader)
    if (rc) goto out;

    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMPort , TM_TM2TM_TMPort)
    if (rc) goto out;
    /* assign register fields */
    TM_REGISTER_SET(TM_TM2TM_TMPort , Port , tm_port)
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMPort , TM_TM2TM_TMPort)
    if (rc) goto out;
...
int set_hw_tm2tm_enable(tm_handle hndl)
{
    ...
    TM_CTL(ctl, hndl)
    /* reset register reserved fields */
    TM_RESET_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMEn, TM_TM2TM_TMtoTMEn)
    if (rc) goto out;
    /* assign register fields */
    ...
    /* write register */
    TM_WRITE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).TM2TM.TMtoTMEn, TM_TM2TM_TMtoTMEn)
    if (rc) goto out;
out:
    COMPLETE_HW_WRITE
    return rc;
...
int set_hw_port_sms_attr_pbase(tm_handle hndl, uint8_t index)
{
  ...
  check if it exists in SN
    ...
    rc = tm_table_entry_write(TM_ENV(ctl), (void*)&PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).RCB.SMSPortAttrPBase, index, &p_attr);
    if (rc)
      goto out;
...
int set_hw_port_sms_attr_qmap_pars(tm_handle hndl, uint8_t index)
{
  ...
  check if it exists in SN
    ...
    q_map.QmapStrip = 0;
    q_map.Offs = 0;
    rc = tm_table_entry_write(TM_ENV(ctl), (void*)&PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).RCB.SMSPortAttrQmapPars, index, &q_map);
    if (rc)
      goto out;
...
int set_hw_queue_cos(tm_handle hndl, uint32_t index, uint8_t cos)
{
    ...
    if (index < ctl->tm_total_queues)
    {
        ...
        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueCoSConf, entry, TM_Drop_QueueCoSConf)
        if (rc)   goto out;
        switch (offset)
        {
        ...
        TM_WRITE_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueCoSConf, entry, TM_Drop_QueueCoSConf)
    }
out:
    COMPLETE_HW_WRITE
    return rc;
...
int get_hw_gen_params(tm_handle hndl)
{
    ...
    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.MinPkgSize,  TM_QMgr_MinPkgSize)
    if (rc)  return rc;
    TM_REGISTER_GET(TM_QMgr_MinPkgSize, Size , ctl->min_pkg_size, (uint16_t) ) /* no casting */
    ctl->min_pkg_size *= 64;

   /* Read Port Chuncks Emit */
    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.PortChunksEmitPerSel,  TM_QMgr_PortChunksEmitPerSel)
    if (rc)
      return rc;
                     ...
                     struct tm_port_status *tm_status)
{
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortShpBucketLvls, index , TM_Sched_PortShpBucketLvls)
    if (rc) return rc;
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDefPrioHi, index , TM_Sched_PortDefPrioHi)
    if (rc)
        return rc;
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.PortDefPrioLo, index , TM_Sched_PortDefPrioLo)
    if (rc)
        return rc;
                       ...
                       struct tm_node_status *tm_status)
{
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ClvlShpBucketLvls, index , TM_Sched_ClvlShpBucketLvls)
    if (rc)
        return rc;
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.CLvlDef, index , TM_Sched_CLvlDef)
    if (rc)
        return rc;
                       ...
                       struct tm_node_status *tm_status)
{
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlShpBucketLvls, index , TM_Sched_BlvlShpBucketLvls)
    if (rc)
        return rc;
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.BlvlDef, index , TM_Sched_BlvlDef)
    if (rc)
        return rc;
                       ...
                       struct tm_node_status *tm_status)
{
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlShpBucketLvls, index , TM_Sched_AlvlShpBucketLvls)
    if (rc)
        return rc;
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.AlvlDef, index , TM_Sched_AlvlDef)
    if (rc)
        return rc;
                       ...
                       struct tm_node_status *tm_status)
{
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueShpBucketLvls, index , TM_Sched_QueueShpBucketLvls)
    if (rc)
        return rc;
    ...
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.QueueDef, index , TM_Sched_QueueDef)
    if (rc)
        return rc;
                      ...
                      uint32_t * av_q_length)
{
    ...
    {
    case Q_LEVEL:
        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueAvgQueueLength,index,TM_Drop_QueueAvgQueueLength)
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_Drop_QueueAvgQueueLength, AQL , *av_q_length ,  (uint32_t) )  /* casting to uint32_t */

        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.QueueLength,index,TM_QMgr_QueueLength)
        if (rc)
            return rc;
        TM_REGISTER_GET(TM_QMgr_QueueLength, Len , *inst_q_length ,  (uint32_t) )  /* casting to uint32_t */
        break;
    case A_LEVEL:
        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlInstAndAvgQueueLength,index,TM_Drop_AlvlInstAndAvgQueueLength)
        if (rc)
            return rc;
        ...
        break;
    case B_LEVEL:
        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlInstAndAvgQueueLength,index,TM_Drop_BlvlInstAndAvgQueueLength)
        if (rc)
            return rc;
        ...
        break;
    case C_LEVEL:
        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlInstAndAvgQueueLength,index,TM_Drop_ClvlInstAndAvgQueueLength)
        if (rc)
            return rc;
        ...
        GT_ATTR_FALLTHROUGH;
    case P_LEVEL:
        TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortInstAndAvgQueueLength,index,TM_Drop_PortInstAndAvgQueueLength)
        if (rc)
            return rc;
...
int get_hw_qmr_errors(tm_handle hndl, struct tm_error_info *info)
{
    ...
    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.ErrCnt , TM_QMgr_ErrCnt)
    if (rc)
        return rc;
    TM_REGISTER_GET(TM_QMgr_ErrCnt , Cnt , info->error_counter ,  (uint16_t) )  /* casting to uint16_t */

    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.ExcCnt , TM_QMgr_ExcCnt);
    if (rc)
        return rc;
...
int get_hw_bap_errors(tm_handle hndl, struct tm_error_info *info)
{
    ...
    for(i=0; i<4; i++)
    {
    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).BAP[i].ErrCnt, TM_BAP_ErrCnt)
        if (rc)
        return rc;
    ...
    for(i=0; i<4;i++)
    {
    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).BAP[i].ExcCnt, TM_BAP_ExcCnt);
        if (rc)
        return rc;
...
int get_hw_rcb_errors(tm_handle hndl, struct tm_error_info *info)
{
    ...
    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).RCB.ErrCnt , TM_RCB_ErrCnt)
    if (rc)
        return rc;
    TM_REGISTER_GET(TM_RCB_ErrCnt , Cnt , info->error_counter ,(uint16_t) )  /* casting to uint16_t */

    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).RCB.ExcCnt , TM_RCB_ExcCnt);
    if (rc)
        return rc;
...
int get_hw_sched_errors(tm_handle hndl, struct tm_error_info *info)
{
    ...
    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ErrCnt , TM_Sched_ErrCnt)
    if (rc)
        return rc;
    TM_REGISTER_GET(TM_Sched_ErrCnt , Cnt , info->error_counter ,(uint16_t) )  /* casting to uint16_t */

    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ExcCnt , TM_Sched_ExcCnt)
    if (rc)
        return rc;
...
int get_hw_drop_errors(tm_handle hndl, struct tm_error_info *info)
{
    ...
    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ErrCnt , TM_Drop_ErrCnt)
    if (rc)
        return rc;
    TM_REGISTER_GET(TM_Drop_ErrCnt , Cnt , info->error_counter ,(uint16_t) )  /* casting to uint16_t */

    TM_READ_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ExcCnt,TM_Drop_ExcCnt)
    if (rc)
        return rc;
...
int get_hw_tm_units_status(tm_handle hndl, struct tm_units_error_status_info *units_error)
{
    ...
    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.ErrStus), &data);
    if (rc)
        return rc;

    /*tm_printf("PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.ErrStus: 0x%0x 0x%0x\n", data[0], data[1]);*/

    units_error->qmgr_status = data.l[0];

    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Sched.ErrStus), &data);
    if (rc)
        return rc;

    units_error->sched_status = data.l[0];

    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ErrStus), &data);
    if (rc)
        return rc;

    units_error->drop_status = data.l[0];

    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).RCB.ErrStus), &data);
    if (rc)
        return rc;

    units_error->rcb_status = data.l[0];
...
int get_hw_tm_bap_unit_status(tm_handle hndl, int bap_num, struct tm_bap_unit_error_status_info *bap_unit_errors)
{
    ...
    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).BAP[bap_num].ErrStus), &data);
    if (rc)
        return rc;

    bap_unit_errors->bap_status = data.l[0];
...
/**
 */
int get_hw_qmr_num_pkts_to_unins_queue(tm_handle hndl, GT_U64 * counter_address)
{
    int rc =  -EFAULT;
    TM_CTL(ctl, hndl)
    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).QMgr.UninstalledQueueDrpPktCnt), counter_address);
    return rc;
}
...
int get_hw_rcb_get_num_pkts_to_sms(tm_handle hndl,  GT_U64 * counter_address)
{
    int rc =  -EFAULT;
    TM_CTL(ctl, hndl)
    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).RCB.NonErrToSMSPktCnt), counter_address);
    return rc;
}


int get_hw_rcb_get_num_num_crc_err_pkts_to_sms(tm_handle hndl,   GT_U64 * counter_address)
{
    int rc =  -EFAULT;
    TM_CTL(ctl, hndl)
    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).RCB.CRCErrPktCnt), counter_address);
    return rc;
}

int get_hw_rcb_get_num_errs_from_sms_to_dram(tm_handle hndl,  GT_U64 * counter_address)
{
    int rc =  -EFAULT;
    TM_CTL(ctl, hndl)
    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).RCB.SMSErrPasPktCnt), counter_address);
    return rc;
}

int get_hw_rcb_get_num_port_flush_drp_pkts(tm_handle hndl,  GT_U64 * counter_address)
{
    int rc =  -EFAULT;
    TM_CTL(ctl, hndl)
    rc = tm_register_read(TM_ENV(ctl), REGISTER_ADDRESS_ARG(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).RCB.PortFlushDrpDataPktCnt), counter_address);
    return rc;
}
...
int tm_get_hw_queue_drop_profile(tm_handle hndl, uint32_t prof_ind, struct tm_drop_profile *profile)
{
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDParams , prof_ind , TM_Drop_QueueDropPrfWREDParams)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDScaleRatio, prof_ind, TM_Drop_QueueDropPrfWREDScaleRatio)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDMinThresh, prof_ind,TM_Drop_QueueDropPrfWREDMinThresh)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfWREDDPRatio, prof_ind, TM_Drop_QueueDropPrfWREDDPRatio)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.QueueDropPrfTailDrpThresh, prof_ind, TM_Drop_QueueDropPrfTailDrpThresh)
    if (rc) goto out;
    /* get register fields */
...
int tm_get_hw_a_nodes_drop_profile(tm_handle hndl, uint32_t prof_ind, struct tm_drop_profile *profile)
{
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDParams , prof_ind , TM_Drop_AlvlDropPrfWREDParams)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDScaleRatio, prof_ind, TM_Drop_AlvlDropPrfWREDScaleRatio)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDMinThresh, prof_ind,TM_Drop_AlvlDropPrfWREDMinThresh)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfWREDDPRatio, prof_ind, TM_Drop_AlvlDropPrfWREDDPRatio)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.AlvlDropPrfTailDrpThresh, prof_ind, TM_Drop_AlvlDropPrfTailDrpThresh)
    if (rc) goto out;
    /* get register fields */
...
int tm_get_hw_b_nodes_drop_profile(tm_handle hndl, uint32_t prof_ind, struct tm_drop_profile *profile)
{
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDParams , prof_ind , TM_Drop_BlvlDropPrfWREDParams)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDScaleRatio, prof_ind, TM_Drop_BlvlDropPrfWREDScaleRatio)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDMinThresh, prof_ind,TM_Drop_BlvlDropPrfWREDMinThresh)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfWREDDPRatio, prof_ind, TM_Drop_BlvlDropPrfWREDDPRatio)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.BlvlDropPrfTailDrpThresh, prof_ind, TM_Drop_BlvlDropPrfTailDrpThresh)
    if (rc) goto out;
    /* get register fields */
...
int tm_get_hw_c_nodes_drop_profile(tm_handle hndl, uint8_t cos, uint32_t prof_ind, struct tm_drop_profile *profile)
{
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDParams_CoS[cos], prof_ind , TM_Drop_ClvlDropPrfWREDParams_CoS)
    if (rc) goto out;
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDScaleRatio_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfWREDScaleRatio_CoS)
    if (rc) goto out;
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDMinThresh_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfWREDMinThresh_CoS);
    if (rc) goto out;
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfWREDDPRatio_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfWREDDPRatio_CoS)
    if (rc) goto out;
    ...
    /* reset register reserved fields */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.ClvlDropPrfTailDrpThresh_CoS[cos], prof_ind, TM_Drop_ClvlDropPrfTailDrpThresh_CoS)
    if (rc) goto out;
...
int tm_get_hw_ports_drop_profile_cos(tm_handle hndl, uint8_t cos, uint32_t prof_ind, struct tm_drop_profile *profile)
{
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDParams_CoS[cos], prof_ind , TM_Drop_PortDropPrfWREDParams_CoS)
    if (rc) goto out;
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDScaleRatio_CoS[cos], prof_ind, TM_Drop_PortDropPrfWREDScaleRatio_CoS)
    if (rc) goto out;
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDMinThresh_CoS[cos], prof_ind, TM_Drop_PortDropPrfWREDMinThresh_CoS);
    if (rc) goto out;
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDDPRatio_CoS[cos], prof_ind, TM_Drop_PortDropPrfWREDDPRatio_CoS)
    if (rc) goto out;
    ...
    /* reset register reserved fields */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfTailDrpThresh_CoS[cos], prof_ind, TM_Drop_PortDropPrfTailDrpThresh_CoS)
    if (rc) goto out;
...
int tm_get_hw_ports_drop_profile(tm_handle hndl, uint32_t prof_ind, struct tm_drop_profile *profile)
{
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDParamsG, prof_ind,TM_Drop_PortDropPrfWREDParamsG)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDScaleRatioG, prof_ind, TM_Drop_PortDropPrfWREDScaleRatioG)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDMinThreshG, prof_ind,TM_Drop_PortDropPrfWREDMinThreshG)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfWREDDPRatioG, prof_ind, TM_Drop_PortDropPrfWREDDPRatioG)
    if (rc) goto out;
    /* get register fields */
    ...
    /* read register */
    TM_READ_TABLE_REGISTER(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).Drop.PortDropPrfTailDrpThreshG, prof_ind, TM_Drop_PortDropPrfTailDrpThreshG)
    if (rc) goto out;
    /* get register fields */

...
int tm_lib_sw_init(tm_handle hEnv, tm_handle *htm, struct tm_lib_init_params *init_params_PTR)
{
   ...
   /* Get general parameters : LAD frequency,  dwrr params  - they are readed from H/W resources*/
    ...
    tm_memset(ctl->tm_port_array, 0, sizeof(struct tm_port) * ctl->tm_total_ports);
    ...
    tm_memset(ctl->tm_c_node_array, 0, sizeof(struct tm_c_node) * ctl->tm_total_c_nodes);
    ...
    tm_memset(ctl->tm_b_node_array, 0, sizeof(struct tm_b_node) * ctl->tm_total_b_nodes);
    ...
    tm_memset(ctl->tm_a_node_array, 0, sizeof(struct tm_a_node) * ctl->tm_total_a_nodes);
    ...
    tm_memset(ctl->tm_queue_array, 0, sizeof(struct tm_queue) * ctl->tm_total_queues);
    ...
    tm_memset(ctl->tm_shaping_profiles, 0, sizeof(struct tm_shaping_profile) * total_shap_profiles);
    ...
    tm_memset(ctl->tm_q_lvl_drop_profiles, 0, sizeof(struct tm_drop_profile) * TM_NUM_QUEUE_DROP_PROF);
    ...
    tm_memset(ctl->tm_a_lvl_drop_profiles, 0, sizeof(struct tm_drop_profile) * TM_NUM_A_NODE_DROP_PROF);
    ...
    tm_memset(ctl->tm_b_lvl_drop_profiles, 0, sizeof(struct tm_drop_profile) * TM_NUM_B_NODE_DROP_PROF);
    for (i=0; i<TM_WRED_COS; i++)
    {
        ...
        tm_memset(ctl->tm_c_lvl_drop_profiles[i], 0, sizeof(struct tm_drop_profile) * TM_NUM_C_NODE_DROP_PROF);
    }
    ...
    tm_memset(ctl->tm_p_lvl_drop_profiles, 0, sizeof(struct tm_drop_profile) * ctl->tm_total_ports);
    for (i=0; i<TM_WRED_COS; i++)
    {
        ...
        tm_memset(ctl->tm_p_lvl_drop_profiles_cos[i], 0, sizeof(struct tm_drop_profile) * ctl->tm_total_ports);
    }
    ...
    tm_memset(ctl->tm_wred_q_lvl_curves, 0, sizeof(struct tm_wred_curve) * TM_NUM_WRED_QUEUE_CURVES);
    ...
    tm_memset(ctl->tm_wred_a_lvl_curves, 0, sizeof(struct tm_wred_curve) * TM_NUM_WRED_A_NODE_CURVES);
    ...
    tm_memset(ctl->tm_wred_b_lvl_curves, 0, sizeof(struct tm_wred_curve) * TM_NUM_WRED_B_NODE_CURVES);
    for (i=0; i<TM_WRED_COS; i++)
    {
        ...
        tm_memset(ctl->tm_wred_c_lvl_curves[i], 0, sizeof(struct tm_wred_curve) * TM_NUM_WRED_C_NODE_CURVES);
    }
    ...
    tm_memset(ctl->tm_wred_ports_curves, 0, sizeof(struct tm_wred_curve) * TM_NUM_WRED_PORT_CURVES);
    for (i=0; i<TM_WRED_COS; i++)
    {
        ...
        tm_memset(ctl->tm_wred_ports_curves_cos[i], 0, sizeof(struct tm_wred_curve) * TM_NUM_WRED_PORT_CURVES);
    }
    ...
    tm_memset(ctl->tm_q_lvl_drop_prof_ptr, 0, sizeof(uint16_t) * ctl->tm_total_queues);
    ...
    tm_memset(ctl->tm_a_lvl_drop_prof_ptr, 0, sizeof(uint16_t) * ctl->tm_total_a_nodes);
    ...
    tm_memset(ctl->tm_b_lvl_drop_prof_ptr, 0, sizeof(uint16_t) * ctl->tm_total_b_nodes);
    for (i=0; i<TM_WRED_COS; i++)
    {
        ...
        tm_memset(ctl->tm_c_lvl_drop_prof_ptr[i], 0, sizeof(uint8_t) * ctl->tm_total_c_nodes);
    }
    ...
    tm_memset(ctl->tm_p_lvl_drop_prof_ptr, 0, sizeof(uint8_t) * ctl->tm_total_ports);
    for (i=0; i<TM_WRED_COS; i++)
    {
        ...
        tm_memset(ctl->tm_p_lvl_drop_prof_ptr_cos[i], 0, sizeof(uint8_t) * ctl->tm_total_ports);
    }

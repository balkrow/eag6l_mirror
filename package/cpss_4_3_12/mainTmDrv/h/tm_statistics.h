 ...
 */
int tm_qmr_get_num_pkts_to_unins_queue(tm_handle hndl, GT_U64 * num_pkts_to_unins_queue);
 ...
 */
int tm_rcb_get_num_pkts_to_sms(tm_handle hndl,  GT_U64 * num_pkts_to_sms);
 ...
 *   @retval TM_HW_GET_RCB_PKT_STAT_FAILED if read from HW fails.
 */
int tm_rcb_get_num_crc_err_pkts_to_sms(tm_handle hndl,  GT_U64 * num_crc_err_pkts_to_sms);
 ...
 *   @retval TM_HW_GET_RCB_PKT_STAT_FAILED if read from HW fails.
 */
int tm_rcb_get_num_errs_from_sms_to_dram(tm_handle hndl,  GT_U64 * num_errs_from_sms_to_dram);
 ...
 *   @retval TM_HW_GET_RCB_PKT_STAT_FAILED if read from HW fails.
 */
int tm_rcb_get_num_port_flush_drp_pkts(tm_handle hndl,  GT_U64 * num_port_flush_drp_pkts);

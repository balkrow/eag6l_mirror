...
int  allocate_reserved_a_node_at_index(struct tm_ctl *ctl,  uint32_t index, uint32_t parent_index,   uint32_t children_range, uint32_t first_child_in_range, tm_node_status_t * old_node_status);

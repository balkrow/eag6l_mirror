...
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_NET_IPV4_MC_DIP_NOT_FOUND_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_NET_IPV4_UC_DIP_NOT_FOUND_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_NET_IPV6_MC_DIP_NOT_FOUND_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_NET_IPV6_UC_DIP_NOT_FOUND_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_NET_IPV4_UC_SIP_NOT_FOUND_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_NET_IPV6_UC_SIP_NOT_FOUND_E),

...
const MV_HWS_COMPHY_REG_FIELD_STC mvHwsComphyN5XC56GP5X4PinToRegMapSdw[] =
{
    ...
    /* N5XC56GP5X4_PIN_PLL_READY_TX0   = 103*/ {SDW_LANE_STATUS_0               ,2                     ,1},
    /* N5XC56GP5X4_PIN_PLL_READY_TX1   = 104 */{SDW_LANE_STATUS_0               ,2                     ,1},
    /* N5XC56GP5X4_PIN_PLL_READY_TX2   = 105 */{SDW_LANE_STATUS_0               ,2                     ,1},
    /* N5XC56GP5X4_PIN_PLL_READY_TX3   = 106 */{SDW_LANE_STATUS_0               ,2                     ,1},
    /* N5XC56GP5X4_PIN_PLL_READY_RX0   = 107 */{SDW_LANE_STATUS_0               ,3                     ,1},
    /* N5XC56GP5X4_PIN_PLL_READY_RX1   = 108 */{SDW_LANE_STATUS_0               ,3                     ,1},
    /* N5XC56GP5X4_PIN_PLL_READY_RX2   = 109 */{SDW_LANE_STATUS_0               ,3                     ,1},
    /* N5XC56GP5X4_PIN_PLL_READY_RX3   = 110 */{SDW_LANE_STATUS_0               ,3                     ,1},
    /* N5XC56GP5X4_PIN_RESET_TX0       = 111 */{SDW_LANE_CONTROL_1              ,2                     ,1},
    /* N5XC56GP5X4_PIN_RESET_TX1       = 112 */{SDW_LANE_CONTROL_1              ,2                     ,1},
    /* N5XC56GP5X4_PIN_RESET_TX2       = 113 */{SDW_LANE_CONTROL_1              ,2                     ,1},
    /* N5XC56GP5X4_PIN_RESET_TX3       = 114 */{SDW_LANE_CONTROL_1              ,2                     ,1},
    /* N5XC56GP5X4_PIN_RESET_RX0       = 115 */{SDW_LANE_CONTROL_1              ,3                     ,1},
    /* N5XC56GP5X4_PIN_RESET_RX1       = 116 */{SDW_LANE_CONTROL_1              ,3                     ,1},
    /* N5XC56GP5X4_PIN_RESET_RX2       = 117 */{SDW_LANE_CONTROL_1              ,3                     ,1},
    /* N5XC56GP5X4_PIN_RESET_RX3       = 118 */{SDW_LANE_CONTROL_1              ,3                     ,1},
    /* N5XC56GP5X4_PIN_RESET_ACK_TX0   = 119 */{SDW_LANE_STATUS_4               ,14                    ,1},
    /* N5XC56GP5X4_PIN_RESET_ACK_TX1   = 120 */{SDW_LANE_STATUS_4               ,14                    ,1},
    /* N5XC56GP5X4_PIN_RESET_ACK_TX2   = 121 */{SDW_LANE_STATUS_4               ,14                    ,1},
    /* N5XC56GP5X4_PIN_RESET_ACK_TX3   = 122 */{SDW_LANE_STATUS_4               ,14                    ,1},
    /* N5XC56GP5X4_PIN_RESET_ACK_RX0   = 123 */{SDW_LANE_STATUS_4               ,15                    ,1},
    /* N5XC56GP5X4_PIN_RESET_ACK_RX1   = 124 */{SDW_LANE_STATUS_4               ,15                    ,1},
    /* N5XC56GP5X4_PIN_RESET_ACK_RX2   = 125 */{SDW_LANE_STATUS_4               ,15                    ,1},
    /* N5XC56GP5X4_PIN_RESET_ACK_RX3   = 126 */{SDW_LANE_STATUS_4               ,15                    ,1},
    /* N5XC56GP5X4_PIN_RSRVD_INPUT_RX0 = 127 */{SDW_LANE_CONTROL_5              ,16                   ,16},
    /* N5XC56GP5X4_PIN_RSRVD_INPUT_RX1 = 128 */{SDW_LANE_CONTROL_5              ,16                   ,16},
    /* N5XC56GP5X4_PIN_RSRVD_INPUT_RX2 = 129 */{SDW_LANE_CONTROL_5              ,16                   ,16},
    /* N5XC56GP5X4_PIN_RSRVD_INPUT_RX3 = 130 */{SDW_LANE_CONTROL_5              ,16                   ,16},
    /* N5XC56GP5X4_PIN_MCU_LOCAL_ACK0  = 131 */{SDW_LANE_STATUS_4               ,17                    ,1},
    /* N5XC56GP5X4_PIN_MCU_LOCAL_ACK1  = 132 */{SDW_LANE_STATUS_4               ,17                    ,1},
    /* N5XC56GP5X4_PIN_MCU_LOCAL_ACK2  = 133 */{SDW_LANE_STATUS_4               ,17                    ,1},
    /* N5XC56GP5X4_PIN_MCU_LOCAL_ACK3  = 134 */{SDW_LANE_STATUS_4               ,17                    ,1},
    /* N5XC56GP5X4_PIN_MCU_LOCAL_STA0  = 135 */{SDW_LANE_STATUS_5               ,0                    ,32},
    /* N5XC56GP5X4_PIN_MCU_LOCAL_STA1  = 136 */{SDW_LANE_STATUS_5               ,0                    ,32},
    /* N5XC56GP5X4_PIN_MCU_LOCAL_STA2  = 137 */{SDW_LANE_STATUS_5               ,0                    ,32},
    /* N5XC56GP5X4_PIN_MCU_LOCAL_STA3  = 138 */{SDW_LANE_STATUS_5               ,0                    ,32},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_REQ0 = 139 */{SDW_LANE_CONTROL_6              ,16                    ,1},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_REQ1 = 140 */{SDW_LANE_CONTROL_6              ,16                    ,1},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_REQ2 = 141 */{SDW_LANE_CONTROL_6              ,16                    ,1},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_REQ3 = 142 */{SDW_LANE_CONTROL_6              ,16                    ,1},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_CMD0 = 143 */{SDW_LANE_CONTROL_8               ,0                   ,32},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_CMD1 = 144 */{SDW_LANE_CONTROL_8               ,0                   ,32},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_CMD2 = 145 */{SDW_LANE_CONTROL_8               ,0                   ,32},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_CMD3 = 146 */{SDW_LANE_CONTROL_8               ,0                   ,32},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_STA0 = 147 */{SDW_LANE_CONTROL_7               ,0                   ,32},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_STA1 = 148 */{SDW_LANE_CONTROL_7               ,0                   ,32},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_STA2 = 149 */{SDW_LANE_CONTROL_7               ,0                   ,32},
    /* N5XC56GP5X4_PIN_MCU_REMOTE_STA3 = 150 */{SDW_LANE_CONTROL_7               ,0                   ,32}
};
#define NA      NA_16BIT
#define NA_S    NA_16BIT_SIGNED
/** COMPHY_12nm_Serdes_Init_rev0.15 */
...
{/**                                                                                        __
    ...
    {_1_25G,                {.txComphyC56G={0, 0, 63, 0, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA, 5, 4,NA,NA,NA_S}}},
    {_1_25G_SR_LR,          {.txComphyC56G={0, 0, 51, 0, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA, 5, 4,NA,NA,NA_S}}},
    ...
    {_5_15625G,             {.txComphyC56G={0, 5, 58, 0, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
    ...
    {_10_3125G_SR_LR,       {.txComphyC56G={0, 1, 44,12, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
    {_12_1875G,             {.txComphyC56G={0, 0, 63, 0, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
    {_20_625G,              {.txComphyC56G={0, 0, 63, 0, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
    ...
    {_26_5625G,             {.txComphyC56G={0, 0, 63, 0, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
    {_26_5625G_SR_LR,       {.txComphyC56G={0, 4, 56, 3, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
    {_26_5625G_PAM4,        {.txComphyC56G={0, 0, 59, 3, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
    {_26_5625G_PAM4_SR_LR,  {.txComphyC56G={0, 0, 56, 7, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
    {_28_125G,              {.txComphyC56G={0, 1, 58, 4, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
    {_28_125G_PAM4,         {.txComphyC56G={0, 0, 59, 3, 0}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},

    {LAST_MV_HWS_SERDES_SPEED,{.txComphyC56G={NA_8BIT_SIGNED,NA_8BIT_SIGNED,NA_8BIT_SIGNED,NA_8BIT_SIGNED,NA_8BIT_SIGNED}},{.rxComphyC56G={NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA,NA_S}}},
};
#else
{
    {0}
...
{
    {NULL, 0,  0, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes0Data }},
    {NULL, 1,  1, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes1Data }},
    {NULL, 2,  2, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes2Data }},
    {NULL, 3,  3, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes3Data }},
    {NULL, 4,  0, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes4Data }},
    {NULL, 5,  1, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes5Data }},
    {NULL, 6,  2, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes6Data }},
    {NULL, 7,  3, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes7Data }},
    {NULL, 8,  0, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes8Data }},
    {NULL, 9,  1, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes9Data }},
    {NULL, 10, 2, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes10Data}},
    {NULL, 11, 3, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes11Data}},
    {NULL, 12, 0, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes12Data}},
    {NULL, 13, 1, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes13Data}},
    {NULL, 14, 2, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes14Data}},
    {NULL, 15, 3, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes15Data}},
    {NULL, 16, 0, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes16Data}},
    {NULL, 17, 1, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes17Data}},
    {NULL, 18, 2, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes18Data}},
    {NULL, 19, 3, COM_PHY_N5XC56GP5X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&harrierSerdes19Data}},
};
...
static GT_STATUS hwsHarrierSerdesGetClockAndInit
(
    GT_U8 devNum,
...
GT_STATUS hwsHarrierPortsParamsSupModesMapSet
(
    GT_U8 devNum
)
{
...
#if !defined (MV_HWS_REDUCED_BUILD) || defined (HARRIER_DEV_SUPPORT)
/*******************************************************************************
* hwsSerdesIfClose
*
* DESCRIPTION:

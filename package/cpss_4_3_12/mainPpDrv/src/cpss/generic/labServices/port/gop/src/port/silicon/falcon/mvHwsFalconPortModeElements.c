...
const MV_HWS_PORT_INIT_PARAMS hwsFalconPort0SupModes[] = {
    ...
    { _107GBase_KR4, MTI_MAC_100,   0,     MTI_PCS_100,        0,   RS_FEC,         _27_5G,          NA_NUM,   {0,0,0,0,0,0,0,0},   4,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF|RS_FEC},
...
const MV_HWS_PORT_INIT_PARAMS hwsFalconSpeedsUpTo10GigaLanesUpTo1SupModes[] = {
    ...
    { _10GBase_SR_LR,MTI_CPU_MAC,     0,     MTI_CPU_PCS,      0,    FEC_OFF,        _10_3125G,   NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _20BIT_ON, FEC_OFF|FC_FEC},
    { NON_SUP_MODE,  MAC_NA,      NA_NUM,  PCS_NA,        NA_NUM,   FEC_OFF,        SPEED_NA,        NA_NUM,   {0,0,0,0,0,0,0,0},   0,    XAUI_MEDIA,   _10BIT_ON, FEC_NA}
};
...
)
{
    ...
    switch(PRV_HWS_NUMBER_OF_RAVENS)
    {

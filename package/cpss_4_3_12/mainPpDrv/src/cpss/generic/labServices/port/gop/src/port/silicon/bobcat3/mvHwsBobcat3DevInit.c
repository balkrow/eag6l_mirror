...
)
{
    ...
    GT_U32 bobcat3SerdesToAvagoMap[BOBCAT3_MAX_AVAGO_SERDES_NUMBER] =
    {
    /* laneNum   SBC_Serdes */
     /* [0]  */      2,
     /* [1]  */      3,
    ...
    hwsDeviceSpecInfo[devNum].avagoSerdesInfo.serdesToAvagoMapPtr = (GT_U32*) hwsOsMallocFuncPtr(sizeof(GT_U32)*BOBCAT3_MAX_AVAGO_SERDES_NUMBER);
    if(NULL==hwsDeviceSpecInfo[devNum].avagoSerdesInfo.serdesToAvagoMapPtr)
    {
        return GT_OUT_OF_CPU_MEM;
    }

    hwsOsMemCopyFuncPtr(hwsDeviceSpecInfo[devNum].avagoSerdesInfo.serdesToAvagoMapPtr,bobcat3SerdesToAvagoMap,sizeof(GT_U32)*BOBCAT3_MAX_AVAGO_SERDES_NUMBER);

    hwsDeviceSpecInfo[devNum].avagoSerdesInfo.avagoToSerdesMapPtr = (GT_U32*) hwsOsMallocFuncPtr(sizeof(GT_U32)*BOBCAT3_SERDES_MAP_ARR_SIZE);
    if(NULL==hwsDeviceSpecInfo[devNum].avagoSerdesInfo.avagoToSerdesMapPtr)
    {
        return GT_OUT_OF_CPU_MEM;
    }

    hwsOsMemCopyFuncPtr(hwsDeviceSpecInfo[devNum].avagoSerdesInfo.avagoToSerdesMapPtr,bobcat3AvagoToSerdesMap,sizeof(GT_U32)*BOBCAT3_SERDES_MAP_ARR_SIZE);

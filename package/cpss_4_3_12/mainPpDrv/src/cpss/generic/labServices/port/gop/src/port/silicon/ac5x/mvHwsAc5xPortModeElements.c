...
const MV_HWS_PORT_INIT_PARAMS hwsPhoenixPort0SupModes[] = {
    ...
    { _1000Base_SX,  MTI_USX_MAC,   0,     MTI_USX_PCS_LOW_SPEED, 0,   FEC_OFF,        _1_25G,          NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF   },
    ...
    { _12GBaseR,     MTI_USX_MAC,   0,     MTI_USX_PCS,           0,   FEC_OFF,        _12_1875G,       NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF|FC_FEC},
...
const MV_HWS_PORT_INIT_PARAMS hwsPhoenixPort48SupModes[] = {
    ...
    { _1000Base_SX,  MTI_CPU_MAC,   0,     MTI_CPU_SGPCS,       0,   FEC_OFF,        _1_25G,          NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF   },
    ...
    { _12GBaseR,     MTI_CPU_MAC,   0,     MTI_CPU_PCS,         0,   FEC_OFF,        _12_1875G,       NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF|FC_FEC},
...
const MV_HWS_PORT_INIT_PARAMS hwsPhoenixPort50SupModes[] = {
    ...
    { _1000Base_SX,  MTI_MAC_100,   0,     MTI_PCS_LOW_SPEED,   0,   FEC_OFF,        _1_25G,          NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF   },
    ...
    { _12GBaseR,     MTI_MAC_100,   0,     MTI_PCS_50,          0,   FEC_OFF,        _12_1875G,       NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF|FC_FEC},
    { _48GBaseR4,    MTI_MAC_100,   0,     MTI_PCS_50,          0,   FEC_OFF,        _12_1875G,       NA_NUM,   {0,0,0,0,0,0,0,0},   4,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF|FC_FEC},
    { NON_SUP_MODE,  MAC_NA,      NA_NUM,  PCS_NA,         NA_NUM,   FEC_OFF,        SPEED_NA,        NA_NUM,   {0,0,0,0,0,0,0,0},   0,    XAUI_MEDIA,   _10BIT_ON, FEC_NA}
};
...
const MV_HWS_PORT_INIT_PARAMS hwsPhoenixPort51SupModes[] = {
    ...
    { _12GBaseR,     MTI_MAC_100,   0,     MTI_PCS_25,          0,   FEC_OFF,        _12_1875G,       NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF|FC_FEC},
    { NON_SUP_MODE,  MAC_NA,      NA_NUM,  PCS_NA,         NA_NUM,   FEC_OFF,        SPEED_NA,        NA_NUM,   {0,0,0,0,0,0,0,0},   0,    XAUI_MEDIA,   _10BIT_ON, FEC_NA}
};
...
GT_STATUS hwsPhoenixPortElementsDbInit
(
    GT_U8 devNum
)
{

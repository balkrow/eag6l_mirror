...
const MV_HWS_REG_ADDR_FIELD_STC hawkMtiRsFecUnitsDb[] = {
  ...
  /*120*/  {/*baseAddr*/ 0x0290,  /*offsetFormula*/ 0x0, /*fieldStart*/  0, /*fieldLen*/ 10 }, /*RSFEC_VENDOR_ALIGN_STATUS */
    ...
    /* p0_FEC_ABILITY */
  /*121*/  {/*baseAddr*/ 0x300,  /*offsetFormula*/ 0x20, /*fieldStart*/  0, /*fieldLen*/ 1 }, /*P0_BASE_R_FEC_ABILITY */
  /*122*/  {/*baseAddr*/ 0x300,  /*offsetFormula*/ 0x20, /*fieldStart*/  1, /*fieldLen*/ 1 }, /*P0_BASE_R_FEC_ERROR_INDICATION_ABILITY */
  /*123*/  {/*baseAddr*/ 0x300,  /*offsetFormula*/ 0x20, /*fieldStart*/  2, /*fieldLen*/ 14 }, /*P0_RESERVED_ABILITY */

    /* p0_FEC_CONTROL */
  /*124*/  {/*baseAddr*/ 0x304,  /*offsetFormula*/ 0x20, /*fieldStart*/  0, /*fieldLen*/ 1 }, /*P0_FEC_ENABLE */
  /*125*/  {/*baseAddr*/ 0x304,  /*offsetFormula*/ 0x20, /*fieldStart*/  1, /*fieldLen*/ 1 }, /*P0_ENABLE_ERROR_INDICATION */
  /*126*/  {/*baseAddr*/ 0x304,  /*offsetFormula*/ 0x20, /*fieldStart*/  2, /*fieldLen*/ 14 }, /*P0_RESERVED_CONTROL */

    /* p0_FEC_STATUS */
  /*127*/  {/*baseAddr*/ 0x308,  /*offsetFormula*/ 0x20, /*fieldStart*/  0, /*fieldLen*/ 1 }, /*P0_FEC_LOCKED_VIRTUAL_LANE_0 */
  /*128*/  {/*baseAddr*/ 0x308,  /*offsetFormula*/ 0x20, /*fieldStart*/  1, /*fieldLen*/ 1 }, /*P0_FEC_LOCKED_VIRTUAL_LANE_1 */
  /*129*/  {/*baseAddr*/ 0x308,  /*offsetFormula*/ 0x20, /*fieldStart*/  2, /*fieldLen*/ 14 }, /*P0_RESERVED_STATUS */

    /* p0_VL0_CCW_LO */
  /*130*/  {/*baseAddr*/ 0x30c,  /*offsetFormula*/ 0x20, /*fieldStart*/  0, /*fieldLen*/ 16 }, /*P0_CORRECTED_FEC_CODEWORDS_0 */

    /* p0_VL0_NCCW_LO */
  /*131*/  {/*baseAddr*/ 0x310,  /*offsetFormula*/ 0x20, /*fieldStart*/  0, /*fieldLen*/ 16 }, /*P0_UNCORRECTED_FEC_CODEWORDS_0 */

    /* p0_VL1_CCW_LO */
  /*132*/  {/*baseAddr*/ 0x314,  /*offsetFormula*/ 0x20, /*fieldStart*/  0, /*fieldLen*/ 16 }, /*P0_CORRECTED_FEC_CODEWORDS_1 */

    /* p0_VL1_NCCW_LO */
  /*133*/  {/*baseAddr*/ 0x318,  /*offsetFormula*/ 0x20, /*fieldStart*/  0, /*fieldLen*/ 16 }, /*P0_UNCORRECTED_FEC_CODEWORDS_1 */

    /* p0_COUNTER_HI */
  /*134*/  {/*baseAddr*/ 0x31c,  /*offsetFormula*/ 0x20, /*fieldStart*/  0, /*fieldLen*/ 16 }, /*P0_UPPER_COUNTER_BITS */

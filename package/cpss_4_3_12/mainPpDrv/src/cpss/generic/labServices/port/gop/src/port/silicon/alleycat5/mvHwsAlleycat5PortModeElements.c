...
static const MV_HWS_PORT_INIT_PARAMS hwsAlleycat5Port0SupModes[] = {
 /* port mode,                MAC Type   Mac Num     PCS Type    PCS Num    FEC       Speed    FirstLane   LanesList  LanesNum   Media       10Bit       FecSupported */
  ...
  {_1000Base_SX,             GEMAC_NET_X, 0,         GPCS_NET,      0,      FEC_OFF,  _1_25G,  NA_NUM,     {0,0,0,0},    1,     XAUI_MEDIA,  _10BIT_ON,  FEC_OFF         },
...
static const MV_HWS_PORT_INIT_PARAMS hwsAlleycat5Port24SupModes[] = {
  ...
  {_1000Base_SX,              GEMAC_X,    24,        GPCS_NET,      24,     FEC_OFF,  _1_25G,    NA_NUM,   {6,0,0,0},   1,      XAUI_MEDIA,  _10BIT_ON, FEC_OFF         },
...
static const MV_HWS_PORT_INIT_PARAMS hwsAlleycat5Port25SupModes[] = {
  ...
  {_1000Base_SX,              GEMAC_X,    25,        GPCS_NET,      25,     FEC_OFF,  _1_25G,    NA_NUM,   {7,0,0,0},   1,      XAUI_MEDIA,  _10BIT_ON, FEC_OFF         },
...
static const MV_HWS_PORT_INIT_PARAMS hwsAlleycat5Port26SupModes[] = {
  ...
  {_1000Base_SX,              GEMAC_X,    26,        GPCS_NET,      26,     FEC_OFF,  _1_25G,    NA_NUM,   {8,0,0,0},  1,       XAUI_MEDIA,  _10BIT_ON, FEC_OFF         },
...
static const MV_HWS_PORT_INIT_PARAMS hwsAlleycat5Port27SupModes[] = {
  ...
  {_1000Base_SX,              GEMAC_X,    27,        GPCS_NET,      27,     FEC_OFF,  _1_25G,    NA_NUM,   {9,0,0,0},  1,       XAUI_MEDIA,  _10BIT_ON, FEC_OFF         },
...
static const MV_HWS_PORT_INIT_PARAMS hwsAlleycat5Port28SupModes[] = {
  ...
  {_1000Base_SX,              GEMAC_X,    28,        GPCS_NET,   28,        FEC_OFF,  _1_25G,    NA_NUM,   {10,0,0,0},  1,       XAUI_MEDIA,  _10BIT_ON, FEC_OFF         },
...
static const MV_HWS_PORT_INIT_PARAMS hwsAlleycat5Port29SupModes[] = {
  ...
  {_1000Base_SX,              GEMAC_X,    29,        GPCS_NET,   29,        FEC_OFF,  _1_25G,    NA_NUM,   {11,0,0,0},  1,        XAUI_MEDIA,  _10BIT_ON, FEC_OFF         },
        ...
        for (portMode = 0; portMode < hwsDeviceSpecInfo[devNum].lastSupPortMode; portMode++)
        {
            ...
            if ((portNum % 4) != 0)
            {
                if(   curPortParams[portMode].portStandard == SGMII
                   ...
                   || curPortParams[portMode].portStandard == _1000Base_SX
    ...
    if (phyPortNum < MV_AC5_NW_PORT_START)
    {
        ...
        else if ((phyPortNum % 4) != 0)
        {
            if(   portParams->portStandard == SGMII
               ...
               || HWS_2500_MODE_CHECK(portParams->portStandard)
               || HWS_1000BASE_MODE_CHECK(portParams->portStandard) )
            {
                portParams->numOfActLanes = 0;
...
)
{
    ...
    if (phyPortNum < MV_AC5_NW_PORT_START)
    {
        if ((phyPortNum % 4) != 0)
        {
            if(   portMode == SGMII
               || portMode == SGMII2_5
               || HWS_2500_MODE_CHECK(portMode)
               || HWS_1000BASE_MODE_CHECK(portMode) )
            {

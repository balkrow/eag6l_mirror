...
const MV_HWS_REG_ADDR_FIELD_STC mvHwsIronmanMtipMac10GUnitsDb[] = {
  ...
  /*64*/  {/*baseAddr*/ 0x40,  /*offsetFormula*/ 0x0, /*fieldStart*/ 28, /*fieldLen*/ 4 }, /*PCH_RX_SUBPORT */
    ...
    /* TX_IPG_LENGTH */
  /*65*/  {/*baseAddr*/ 0x44,  /*offsetFormula*/ 0x0, /*fieldStart*/  0, /*fieldLen*/ 1 }, /*ENABLE_SHORT_IPG */
  /*66*/  {/*baseAddr*/ 0x44,  /*offsetFormula*/ 0x0, /*fieldStart*/  1, /*fieldLen*/ 1 }, /*CMP_ALLOW_SHORT_IPG */
  ...
  /*69*/  {/*baseAddr*/ 0x44,  /*offsetFormula*/ 0x0, /*fieldStart*/  6, /*fieldLen*/ 2 }, /*TXIPG_RESERVED76 */
  ...
  /*85*/  {/*baseAddr*/ 0x80,  /*offsetFormula*/ 0x0, /*fieldStart*/ 20, /*fieldLen*/ 1 }, /*TS_SFD_ENA */
    ...
    /* TSU_CONTROL */
  /*86*/  {/*baseAddr*/ 0xa4,  /*offsetFormula*/ 0x0, /*fieldStart*/  0, /*fieldLen*/ 1 }, /*TSU_TX_ENA */
  /*87*/  {/*baseAddr*/ 0xa4,  /*offsetFormula*/ 0x0, /*fieldStart*/  1, /*fieldLen*/ 1 }, /*MODULO_SEL */
  /*88*/  {/*baseAddr*/ 0xa4,  /*offsetFormula*/ 0x0, /*fieldStart*/  2, /*fieldLen*/ 1 }, /*TSU_RX_ENA */
  /*89*/  {/*baseAddr*/ 0xa4,  /*offsetFormula*/ 0x0, /*fieldStart*/  3, /*fieldLen*/ 1 }, /*TSU_TX_NO_MUX_ON_TS */
  /*90*/  {/*baseAddr*/ 0xa4,  /*offsetFormula*/ 0x0, /*fieldStart*/  4, /*fieldLen*/ 1 }, /*TSU_RX_NO_MUX_ON_TS */
  /*91*/  {/*baseAddr*/ 0xa4,  /*offsetFormula*/ 0x0, /*fieldStart*/ 16, /*fieldLen*/ 12 }, /*BLOCK_TIME */
};

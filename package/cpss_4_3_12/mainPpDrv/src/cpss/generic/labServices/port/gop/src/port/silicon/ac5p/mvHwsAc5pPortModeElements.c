...
const MV_HWS_PORT_INIT_PARAMS hwsHawkPort0SupModes[] = {
    ...
    { _1000Base_SX,  MTI_MAC_100_BR,0,     MTI_PCS_LOW_SPEED,   0,   FEC_OFF,        _1_25G,          NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF   },
    ...
    { _40GBase_KR2,  MTI_MAC_100_BR,0,     MTI_PCS_100,         0,   RS_FEC,         _20_625G,        NA_NUM,   {0,0,0,0,0,0,0,0},   2,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF|FC_FEC|RS_FEC},
...
const MV_HWS_PORT_INIT_PARAMS hwsHawkCpuPortSupModes[] = {
    ...
    { _1000Base_SX,  MTI_CPU_MAC,   105,     MTI_CPU_SGPCS,  105,      FEC_OFF,        _1_25G,          NA_NUM,   {0,0,0,0,0,0,0,0},   1,    XAUI_MEDIA,   _40BIT_ON, FEC_OFF   },

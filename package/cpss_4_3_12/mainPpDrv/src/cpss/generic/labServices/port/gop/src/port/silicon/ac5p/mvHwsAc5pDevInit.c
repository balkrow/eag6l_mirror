...
const MV_HWS_COMPHY_REG_FIELD_STC mvHwsComphyC112GX4PinToRegMapSdw[] =
{
    ...
    /* C112GX4_PIN_RX_TRAIN_COMPLETE0 = 45  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,4 /*SDW_LANE_STATUS_1               ,0*/                     ,1},
    /* C112GX4_PIN_RX_TRAIN_COMPLETE1 = 46  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,4 /*SDW_LANE_STATUS_1               ,0*/                     ,1},
    /* C112GX4_PIN_RX_TRAIN_COMPLETE2 = 47  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,4 /*SDW_LANE_STATUS_1               ,0*/                     ,1},
    /* C112GX4_PIN_RX_TRAIN_COMPLETE3 = 48  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,4 /*SDW_LANE_STATUS_1               ,0*/                     ,1},
    /* C112GX4_PIN_RX_TRAIN_FAILED0   = 49  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,3 /*SDW_LANE_STATUS_1               ,1*/                     ,1},
    /* C112GX4_PIN_RX_TRAIN_FAILED1   = 50  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,3 /*SDW_LANE_STATUS_1               ,1*/                     ,1},
    /* C112GX4_PIN_RX_TRAIN_FAILED2   = 51  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,3 /*SDW_LANE_STATUS_1               ,1*/                     ,1},
    /* C112GX4_PIN_RX_TRAIN_FAILED3   = 52  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,3 /*SDW_LANE_STATUS_1               ,1*/                     ,1},
    ...
    /* C112GX4_PIN_TX_TRAIN_COMPLETE0 = 57  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,6 /*SDW_LANE_STATUS_1               ,2*/                     ,1},
    /* C112GX4_PIN_TX_TRAIN_COMPLETE1 = 58  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,6 /*SDW_LANE_STATUS_1               ,2*/                     ,1},
    /* C112GX4_PIN_TX_TRAIN_COMPLETE2 = 59  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,6 /*SDW_LANE_STATUS_1               ,2*/                     ,1},
    /* C112GX4_PIN_TX_TRAIN_COMPLETE3 = 60  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,6 /*SDW_LANE_STATUS_1               ,2*/                     ,1},
    /* C112GX4_PIN_TX_TRAIN_FAILED0   = 61  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,5 /*SDW_LANE_STATUS_1               ,3*/                     ,1},
    /* C112GX4_PIN_TX_TRAIN_FAILED1   = 62  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,5 /*SDW_LANE_STATUS_1               ,3*/                     ,1},
    /* C112GX4_PIN_TX_TRAIN_FAILED2   = 63  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,5 /*SDW_LANE_STATUS_1               ,3*/                     ,1},
    /* C112GX4_PIN_TX_TRAIN_FAILED3   = 64  */ {SDW_INTERNAL_REG_OFFSET + 0x2c20,5 /*SDW_LANE_STATUS_1               ,3*/                     ,1},
...
#define NA NA_16BIT
/** COMPHY_12nm_Serdes_Init_rev0.32 */
const MV_HWS_SERDES_TXRX_TUNE_PARAMS ac5pTxRxTuneParams[] =
#ifndef WIN32
{/*
                                             PRE2 PRE MAIN POST                CURRENT1 RL1_SEL RL1_EXSEL RES1_SEL CAP1_SEL CL1_SEL EN_MID_FREQ CS1_MID RS1_MID RF_CTRL RL1_TIA_SEL RL1_TIA_EXTRA HPF_RSEL_1ST CURRENT_TIA_SEL RL2_TUNE RL2_SEL RS2_SEL CURRENT2_SEL	CAP2_SEL HPF_RSEL_2ND SELMUFI SELMUFF SELMUPI SELMUPF  MIN_CAP1 MAX_CAP1 MIN_RES1 MAX_RES1 SQUELCH	*/
    {_1_25G,                {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={  0,       0,      0,       14,      15,      0,         0,        0,      0,      1,       0,           0,            0,            0,           3,      0,     13,         0,        15,         0,        4,       5,      4,      1,      NA,      NA,      NA,      NA,      11}}},
    {_1_25G_SR_LR,          {.txComphyC112G={ 0 , 0 , 47,  0}},{.rxComphyC112G={ NA,      NA,     NA,       14,      15,     NA,        NA,       NA,     NA,      1,      NA,          NA,           NA,           NA,           3,      0,     13,         0,        15,        NA,        4,       5,      4,      1,      NA,      NA,      NA,      NA,      11}}},
    {_2_578125,             {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={ NA,      NA,     NA,       13,      15,     NA,        NA,       NA,     NA,      1,      NA,          NA,           NA,           NA,           3,      1,     12,         1,        15,        NA,        4,       5,      4,      1,      NA,      NA,      NA,      NA,      11}}},
    {_3_125G,               {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={  0,       0,      0,       13,      15,      0,         0,        0,      0,      1,       0,           0,            0,            0,           3,      1,     12,         1,        15,         0,        4,       5,      4,      1,      NA,      NA,      NA,      NA,      11}}},
    {_5G,                   {.txComphyC112G={ 0 , 0 , 45,  0}},{.rxComphyC112G={  1,       1,      0,       12,      15,      0,         0,        0,      0,      2,       1,           0,            0,            1,           3,      8,      0,         8,        15,         0,        4,       5,      4,      2,      NA,      NA,      NA,      NA,      11}}},
    {_5_15625G,             {.txComphyC112G={ 0 , 6 , 55,  0}},{.rxComphyC112G={  6,       6,      0,       12,      15,      0,         0,        0,      0,      2,       6,           0,            0,            6,           3,      8,      0,         8,        15,         0,        4,       5,      4,      2,      NA,      NA,      NA,      NA,      11}}},
    {_6_25G,                {.txComphyC112G={ 0 , 6 , 55,  0}},{.rxComphyC112G={  6,       6,      0,       12,      15,      0,         0,        0,      0,      2,       6,           0,            0,            6,           3,      8,      0,         8,        15,         0,        4,       5,      4,      2,      NA,      NA,      NA,      NA,      11}}},
    {_10G,                  {.txComphyC112G={ 0 , 0 , 61,  2}},{.rxComphyC112G={ 15,      15,      0,        6,       0,      0,         1,        0,      0,      4,      12,           0,            0,           12,           3,     15,      0,        15,         0,         0,        4,       5,      4,      3,      NA,      NA,      NA,      NA,      11}}},
    {_10_3125G,             {.txComphyC112G={ 0 , 0 , 61,  2}},{.rxComphyC112G={ 15,      15,      0,        6,       0,      0,         1,        0,      0,      4,      12,           0,            0,           12,           3,     15,      0,        15,         0,         0,        4,       5,      4,      3,      NA,      NA,      NA,      NA,      11}}},
    {_10_3125G_SR_LR,       {.txComphyC112G={ 0 , 0 , 42,  7}},{.rxComphyC112G={ 15,      15,      0,        6,       0,      0,         1,        0,      0,      4,      12,           0,            0,           12,           3,     15,      0,        15,         0,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      11}}},
    {_12_1875G,             {.txComphyC112G={ 0 , 0 , 61,  2}},{.rxComphyC112G={ 15,      15,      0,        6,       0,      0,         1,        0,      0,      4,      12,           0,            0,           12,           3,     15,      0,        15,         0,         0,        4,       5,      4,      3,      NA,      NA,      NA,      NA,      11}}},
    {_12_5G,                {.txComphyC112G={ 0 , 0 , 61,  2}},{.rxComphyC112G={ 15,      15,      0,        6,       0,      0,         1,        0,      0,      4,      12,           0,            0,           12,           3,     15,      0,        15,         0,         0,        4,       5,      4,      3,      NA,      NA,      NA,      NA,      11}}},
    {_12_8906G,             {.txComphyC112G={ 0 , 0 , 61,  2}},{.rxComphyC112G={ 15,      15,      0,        6,       0,      0,         1,        0,      0,      4,      12,           0,            0,           12,           3,     15,      0,        15,         0,         0,        4,       5,      4,      3,      NA,      NA,      NA,      NA,      11}}},
    {_20_625G,              {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      11}}},
    {_25_78125G,            {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      11}}},
    {_25_78125G_SR_LR,      {.txComphyC112G={ 0 , 0 , 59,  4}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      13}}},
    {_26_5625G,             {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      11}}},
    {_26_5625G_SR_LR,       {.txComphyC112G={ 0 , 0 , 59,  4}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      13}}},
    {_27_34375G,            {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      11}}},
    {_27_5G,                {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      11}}},
    {_26_5625G_PAM4,        {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      4}}},
    {_26_5625G_PAM4_SR_LR,  {.txComphyC112G={ 0 , 0 , 59,  4}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      5}}},
    {_28_125G,              {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      11}}},
    {_28_125G_PAM4,         {.txComphyC112G={ 0 , 0 , 63,  0}},{.rxComphyC112G={ 15,      15,      0,        5,      31,      0,         1,        3,      3,      9,      12,           0,            0,           12,           3,      3,      0,         3,        15,         0,        4,       4,      4,      4,      NA,      NA,      NA,      NA,      4}}},

    {LAST_MV_HWS_SERDES_SPEED,{.txComphyC112G={NA_8BIT_SIGNED, NA_8BIT_SIGNED, NA_8BIT_SIGNED, NA_8BIT_SIGNED}},{.rxComphyC112G={ NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT,  NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT,  NA_16BIT,  NA_16BIT,  NA_16BIT, NA_16BIT, NA_16BIT,  NA_16BIT,  NA_16BIT,  NA_16BIT, NA_16BIT, NA_8BIT}}},
};
#else
{
    {0}
...
{
    {NULL, 0,  0, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes0Data }},
    {NULL, 1,  1, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes1Data }},
    {NULL, 2,  2, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes2Data }},
    {NULL, 3,  3, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes3Data }},
    {NULL, 4,  0, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes4Data }},
    {NULL, 5,  1, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes5Data }},
    {NULL, 6,  2, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes6Data }},
    {NULL, 7,  3, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes7Data }},
    {NULL, 8,  0, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes8Data }},
    {NULL, 9,  1, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes9Data }},
    {NULL, 10, 2, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes10Data}},
    {NULL, 11, 3, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes11Data}},
    {NULL, 12, 0, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes12Data}},
    {NULL, 13, 1, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes13Data}},
    {NULL, 14, 2, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes14Data}},
    {NULL, 15, 3, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes15Data}},
    {NULL, 16, 0, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes16Data}},
    {NULL, 17, 1, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes17Data}},
    {NULL, 18, 2, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes18Data}},
    {NULL, 19, 3, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes19Data}},
    {NULL, 20, 0, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes20Data}},
    {NULL, 21, 1, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes21Data}},
    {NULL, 22, 2, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes22Data}},
    {NULL, 23, 3, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes23Data}},
    {NULL, 24, 0, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes24Data}},
    {NULL, 25, 1, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes25Data}},
    {NULL, 26, 2, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes26Data}},
    {NULL, 27, 3, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes27Data}},
    {NULL, 28, 0, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes28Data}},
    {NULL, 29, 1, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes29Data}},
    {NULL, 30, 2, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes30Data}},
    {NULL, 31, 3, COM_PHY_C112GX4, {NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes31Data}},
    {NULL, 32, 0, COM_PHY_C28GP4X1,{NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM,NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5pSerdes32Data}}
};
...
static GT_STATUS hwsHawkSerdesGetClockAndInit
(
    GT_U8 devNum,
...
GT_STATUS hwsHawkPortsParamsSupModesMapSet
(
    GT_U8 devNum
)
{
...
)
{
    ...
    {
        rc = mvHwsGlobalMacToLocalIndexConvert(devNum, portNum, _10GBase_KR, &convertIdx);
        if (rc == GT_OK)
        {
#ifndef AC5P_DEV_SUPPORT
...
#ifndef AC5P_DEV_SUPPORT
        rc = mvHwsGlobalMacToLocalIndexConvert(devNum, portNum, _10G_OUSGMII, &convertIdx);
        if (rc == GT_OK)
        {

...
MV_HWS_REG_ADDR_FIELD_STC hawkRsfecStatisticsUnitsDb[] = {
  ...
  /*33*/  {/*baseAddr*/ 0x0070,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*TOTAL_CW_RECEIVED */

    /* TOTAL_CODEWORDS_CORRECT */
  /*34*/  {/*baseAddr*/ 0x0074,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*TOTAL_CW_CORRECT */

    /* TOTATL_CODEWORDS_CORRECTED */
  /*35*/  {/*baseAddr*/ 0x0078,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*TOTAL_CW_CORRECTED */

    /* TOTATL_CODEWORDS_UNCORRECTABLE */
  /*36*/  {/*baseAddr*/ 0x007c,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*TOTATL_CW_UNCORRECTABLE */

    /* CODEWORDS_CORRECTED_1SE */
  /*37*/  {/*baseAddr*/ 0x0080,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_1SE */

    /* CODEWORDS_CORRECTED_2SE */
  /*38*/  {/*baseAddr*/ 0x0084,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_2SE */

    /* CODEWORDS_CORRECTED_3SE */
  /*39*/  {/*baseAddr*/ 0x0088,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_3SE */

    /* CODEWORDS_CORRECTED_4SE */
  /*40*/  {/*baseAddr*/ 0x008C,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_4SE */

    /* CODEWORDS_CORRECTED_5SE */
  /*41*/  {/*baseAddr*/ 0x0090,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_5SE */

    /* CODEWORDS_CORRECTED_6SE */
  /*42*/  {/*baseAddr*/ 0x0094,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_6SE */

    /* CODEWORDS_CORRECTED_7SE */
  /*43*/  {/*baseAddr*/ 0x0098,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_7SE */

    /* CODEWORDS_CORRECTED_8SE */
  /*44*/  {/*baseAddr*/ 0x009C,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_8SE */

    /* CODEWORDS_CORRECTED_9SE */
  /*45*/  {/*baseAddr*/ 0x00A0,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_9SE */

    /* CODEWORDS_CORRECTED_10SE */
  /*46*/  {/*baseAddr*/ 0x00A4,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_10SE */

    /* CODEWORDS_CORRECTED_11SE */
  /*47*/  {/*baseAddr*/ 0x00A8,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_11SE */

    /* CODEWORDS_CORRECTED_12SE */
  /*48*/  {/*baseAddr*/ 0x00AC,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_12SE */

    /* CODEWORDS_CORRECTED_13SE */
  /*49*/  {/*baseAddr*/ 0x00B0,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_13SE */

    /* CODEWORDS_CORRECTED_14SE */
  /*50*/  {/*baseAddr*/ 0x00B4,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_14SE */

    /* CODEWORDS_CORRECTED_15SE */
  /*51*/  {/*baseAddr*/ 0x00B8,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*CW_CORRECTED_15SE */

    /* TOTAL_SYMBOLS_ERROR_CORRECTED */
  /*52*/  {/*baseAddr*/ 0x00BC,  /*offsetFormula*/ 0x50, /*fieldStart*/  0, /*fieldLen*/ 32 }, /*TOTAL_SYMBOLS_ERROR_CORRECTED */

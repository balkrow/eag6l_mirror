...
#else
extern GT_STATUS prvCpssDxChSerdesRefClockTranslateCpss2Hws(IN  GT_U8 devNum,OUT MV_HWS_REF_CLOCK_SUP_VAL *refClockPtr);
#endif
...
extern const MV_HWS_REG_ADDR_FIELD_STC ac5xRsfecStatisticsUnitsDb[];
...
/* C28GP4X1_PIN_RX_TRAIN_COMPLETE0  = 18 */ {SDW_INTERNAL_REG_OFFSET + 0x2600,24 /*SDW_LANE_STATUS_1               ,0*/                     ,1},
/* C28GP4X1_PIN_RX_TRAIN_FAILED0    = 19 */ {SDW_INTERNAL_REG_OFFSET + 0x2600,23 /*SDW_LANE_STATUS_1               ,1*/                     ,1},
/* C28GP4X1_PIN_TX_TRAIN_ENABLE0    = 20 */ {SDW_LANE_CONTROL_3              ,1                     ,1},
/* C28GP4X1_PIN_TX_TRAIN_COMPLETE0  = 21 */ {SDW_INTERNAL_REG_OFFSET + 0x2600,11  /*SDW_LANE_STATUS_1               ,2*/                     ,1},
/* C28GP4X1_PIN_TX_TRAIN_FAILED0    = 22 */ {SDW_INTERNAL_REG_OFFSET + 0x2600,27 /*SDW_LANE_STATUS_1               ,3*/                     ,1},
...
#define NA NA_16BIT
/** COMPHY_12nm_Serdes_Init_rev0.31 */
const MV_HWS_SERDES_TXRX_TUNE_PARAMS ac5xTxRxTuneParams[] =
#ifndef WIN32
{
    /* SerDes speed                              PRE PEAK POST                 DATA_RATE RES1_SEL RES2_SEL CAP1_SEL CAP2_SEL MIN_CAP MIN_CAP_N SELMUFI SELMUFF SELMUPI SELMUPF MID_L_TH_K MID_S_TH_K MID_L_TH_C MID_L_TH_S SUMF_MID_ADPTV_EN DFE_RES_H_TH_INIT DFE_RES_H_TH_END SUMF_BOOST_TARGET_C_0 SUMF_BOOST_TARGET_C_1 SUMF_BOOST_TARGET_C_2 MIDPOINT_PHASE_OS_0 MIDPOINT_PHASE_OS_1 MIDPOINT_PHASE_OS_2  MIN_CAP1 MAX_CAP1 MIN_RES1 MAX_RES1 Squelch_TH */
#if 1/*[#249] RX serdes paramset 수정, balkrow, 2025-01-23*/
    {_1_25G,                   {.txComphyC28GP4={ 0,  0,   0}}, {.rxComphyC28GP4={2,       6,        0,      12,      15,      0,       0,        4,     5,       3,      2,       9,         8,       2,          0,            NA,               40,                50,                  200,                300,                  300,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       10}}},
#endif
    {_1_25G_SR_LR,             {.txComphyC28GP4={ 0, 10,   0}}, {.rxComphyC28GP4={2,       6,        0,      12,      15,      0,       0,        4,     5,       3,      2,       9,         8,       2,          0,            NA,               40,                50,                  NA,                NA,                  NA,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       10}}},
    {_3_125G,                  {.txComphyC28GP4={ 0,  0,   0}}, {.rxComphyC28GP4={3,       6,        0,      12,      15,      0,       0,        4,     5,       3,      2,       9,         8,       2,          0,            NA,               40,                50,                  NA,                NA,                  NA,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       10}}},
    {_2_578125,                {.txComphyC28GP4={ 0,  0,   0}}, {.rxComphyC28GP4={2,       6,        0,      12,      15,      0,       0,        4,     5,       3,      2,       9,         8,       2,          0,            NA,               40,                50,                  NA,                NA,                  NA,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       10}}},
    {_5G,                      {.txComphyC28GP4={ 0,  9,   2}}, {.rxComphyC28GP4={7,      11,        4,       8,       0,      0,       0,        2,     2,       3,      3,       9,         8,       2,          0,            NA,               40,                50,                  NA,                NA,                  NA,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       10}}},
    {_5_15625G,                {.txComphyC28GP4={ 4,  0,   0}}, {.rxComphyC28GP4={4,       6,        0,      12,      15,      0,       0,        4,     5,       3,      2,       9,         8,       2,          0,            NA,               40,                50,                  NA,                NA,                  NA,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       10}}},
    {_10G,                     {.txComphyC28GP4={ 0,  0,   1}}, {.rxComphyC28GP4={7,      11,        4,       8,       0,      0,       0,        2,     2,       3,      3,       9,         8,       2,          0,            NA,               50,                50,                  NA,                NA,                  NA,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       7}}},
    {_10_3125G,                {.txComphyC28GP4={ 0,  0,   1}}, {.rxComphyC28GP4={7,      11,        4,       8,       0,      0,       0,        2,     2,       3,      3,       9,         8,       2,          0,            NA,               50,                50,                  NA,                NA,                  NA,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       7}}},
    {_10_3125G_SR_LR,          {.txComphyC28GP4={ 1,  8,   4}}, {.rxComphyC28GP4={7,      11,        4,       8,       0,      0,       0,        2,     2,       3,      3,       9,         8,       2,          0,            NA,               40,                50,                  NA,                NA,                  NA,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       7}}},
    {_12_1875G,                {.txComphyC28GP4={ 0,  0,   1}}, {.rxComphyC28GP4={7,      11,        4,       8,       0,      0,       0,        2,     2,       3,      3,       9,         8,       2,          0,            NA,               50,                50,                  NA,                NA,                  NA,                  NA,                   NA,                   NA,          NA,      NA,      NA,      NA,       7}}},
    {_20_625G,                 {.txComphyC28GP4={ 0,  0,   0}}, {.rxComphyC28GP4={12,      6,        0,      12,      15,      0,       0,        2,     2,       2,      3,       9,         8,       2,          0,             1,               NA,                NA,                 171,               229,                 229,                   0,                    6,                    6,          NA,      NA,      NA,      NA,       7}}},
#if 1/*[#249] RX serdes paramset 수정, balkrow, 2025-01-23*/
    {_25_78125G,               {.txComphyC28GP4={ 0,  0,   0}}, {.rxComphyC28GP4={12,      6,        0,      12,      15,      0,       0,        2,     2,       2,      3,       9,         8,       2,          0,             1,               NA,                NA,                 200,               300,                 300,                   0,                    6,                    6,          NA,      NA,      NA,      NA,       7}}},
#endif
    {_25_78125G_SR_LR,         {.txComphyC28GP4={ 8,  8,   2}}, {.rxComphyC28GP4={12,      6,        0,      12,      15,      0,       0,        2,     2,       2,      3,       9,         8,       2,          0,             1,               NA,                NA,                 229,               229,                 229,                   6,                    6,                    6,          NA,      NA,      NA,      NA,       7}}},
    {_26_5625G,                {.txComphyC28GP4={ 0,  0,   0}}, {.rxComphyC28GP4={12,      6,        0,      12,      15,      0,       0,        2,     2,       2,      3,       9,         8,       2,          0,             1,               NA,                NA,                 171,               229,                 229,                   0,                    6,                    6,          NA,      NA,      NA,      NA,       7}}},
    {_26_5625G_SR_LR,          {.txComphyC28GP4={ 8,  8,   2}}, {.rxComphyC28GP4={12,      6,        0,      12,      15,      0,       0,        2,     2,       2,      3,       9,         8,       2,          0,             1,               NA,                NA,                 229,               229,                 229,                   6,                    6,                    6,          NA,      NA,      NA,      NA,       7}}},
    {_28_125G,                 {.txComphyC28GP4={ 0,  0,   0}}, {.rxComphyC28GP4={12,      6,        0,      12,      15,      0,       0,        2,     2,       2,      3,       9,         8,       2,          0,             1,               NA,                NA,                 171,               229,                 229,                   0,                    6,                    6,          NA,      NA,      NA,      NA,       7}}},

    {LAST_MV_HWS_SERDES_SPEED, {.txComphyC28GP4={ NA_8BIT,  NA_8BIT,  NA_8BIT}}, {.rxComphyC28GP4={NA_16BIT, NA_16BIT,  NA_16BIT,  NA_16BIT, NA_16BIT,  NA_16BIT,  NA_16BIT,  NA_16BIT,  NA_16BIT,   NA_16BIT,   NA_16BIT,   NA_16BIT,    NA_16BIT,   NA_16BIT,   NA_16BIT,   NA_16BIT,   NA_16BIT,  NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT, NA_16BIT_SIGNED}}},
};
#else
{
    {0}
...
{
    {NULL, 0,  0, COM_PHY_C28GP4X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes0Data}},
    {NULL, 1,  1, COM_PHY_C28GP4X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes1Data}},
    {NULL, 2,  2, COM_PHY_C28GP4X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes2Data}},
    {NULL, 3,  3, COM_PHY_C28GP4X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes3Data}},
    {NULL, 4,  0, COM_PHY_C28GP4X1, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes4Data}},
    {NULL, 5,  0, COM_PHY_C28GP4X1, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes5Data}},
    {NULL, 6,  0, COM_PHY_C28GP4X1, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes6Data}},
    {NULL, 7,  0, COM_PHY_C28GP4X1, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes7Data}},
    {NULL, 8,  0, COM_PHY_C28GP4X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes8Data}},
    {NULL, 9,  1, COM_PHY_C28GP4X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes9Data}},
    {NULL, 10, 2, COM_PHY_C28GP4X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes10Data}},
    {NULL, 11, 3, COM_PHY_C28GP4X4, {NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM, NA_NUM}, {(MV_HWS_COMPHY_SERDES_DATA*)&ac5xSerdes11Data}},
};
/************************* pre-declaration ***********************************************/
...
)
{
    ...
    rc += mvHwsRegDbInit(devNum, MTI_RSFEC_STATISTICS_UNIT, ac5xRsfecStatisticsUnitsDb);
    rc += mvHwsRegDbInit(devNum, MTI_USX_RSFEC_STATISTICS_UNIT, hawkRsfecStatisticsUnitsDb);
    rc += mvHwsRegDbInit(devNum, MTI_CPU_RSFEC_STATISTICS_UNIT, hawkRsfecStatisticsUnitsDb);
...
GT_STATUS hwsPhoenixPortsParamsSupModesMapSet
(
    GT_U8 devNum
)
{
...
)
{
    ...
    PRV_SHARED_LAB_SERVICES_DIR_AC5X_DEV_INIT_SRC_GLOBAL_VAR(hwsInitDone)[devNum] = GT_TRUE;
        ...
        /******************************************************/
        /* Power reduction feature - MTI EXT units reset      */
        /******************************************************/

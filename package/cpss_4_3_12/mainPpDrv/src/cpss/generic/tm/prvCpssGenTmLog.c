...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_INOUT_GT_U32_PTR_curveIndexPtr = {
     "curveIndexPtr", PRV_CPSS_LOG_PARAM_INOUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_INOUT_GT_U32_PTR_profileIndPtr = {
     "profileIndPtr", PRV_CPSS_LOG_PARAM_INOUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_INOUT_GT_U32_PTR_profileIndexPtr = {
     "profileIndexPtr", PRV_CPSS_LOG_PARAM_INOUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_detailed = {
     "detailed", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_BOOL)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_currNodeIndex = {
     "currNodeIndex", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_funcIndex = {
     "funcIndex", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U64_HEX_PTR_regAddrPtr = {
     "regAddrPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U64_HEX)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_firstChildIndexPtr = {
     "firstChildIndexPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_lastChildIndexPtr = {
     "lastChildIndexPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_parentIndexPtr = {
     "parentIndexPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmShapingProfileByIndexCreate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_TM_LEVEL_ENT_level,
    &DX_IN_CPSS_TM_SHAPING_PROFILE_PARAMS_STC_PTR_profileStrPtr,
    &DX_INOUT_GT_U32_PTR_profileIndPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmDropProfileByIndexCreate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_TM_LEVEL_ENT_level,
    &DX_IN_GT_U32_cos,
    &DX_IN_CPSS_TM_DROP_PROFILE_PARAMS_STC_PTR_profileStcPtr,
    &DX_INOUT_GT_U32_PTR_profileIndexPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmDropWredTraditionalCurveByIndexCreate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_TM_LEVEL_ENT_level,
    &DX_IN_GT_U32_cos,
    &DX_IN_GT_U32_maxProbability,
    &DX_INOUT_GT_U32_PTR_curveIndexPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmDropWredCurveByIndexCreate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_TM_LEVEL_ENT_level,
    &DX_IN_GT_U32_cos,
    &DX_IN_GT_U32_PTR_probabilityArr,
    &DX_INOUT_GT_U32_PTR_curveIndexPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmNodeMappingInfoRead_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_TM_LEVEL_ENT_level,
    &DX_IN_GT_U32_currNodeIndex,
    &DX_OUT_GT_U32_PTR_parentIndexPtr,
    &DX_OUT_GT_U32_PTR_firstChildIndexPtr,
    &DX_OUT_GT_U32_PTR_lastChildIndexPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmEligPrioFuncDump_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_TM_LEVEL_ENT_level,
    &DX_IN_GT_U32_funcIndex,
    &DX_IN_GT_BOOL_detailed
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssTmCtlWriteRegister_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U64_HEX_PTR_regAddrPtr,
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTmLogLibDb[] = {
    ...
    {"cpssTmDropWredCurveByIndexCreate", 5, cpssTmDropWredCurveByIndexCreate_PARAMS, NULL},
    {"cpssTmDropWredTraditionalCurveByIndexCreate", 5, cpssTmDropWredTraditionalCurveByIndexCreate_PARAMS, NULL},
    {"cpssTmDropProfileByIndexCreate", 5, cpssTmDropProfileByIndexCreate_PARAMS, NULL},
    ...
    {"cpssTmEligPrioFuncDump", 4, cpssTmEligPrioFuncDump_PARAMS, NULL},
    ...
    {"cpssTmNodeMappingInfoRead", 6, cpssTmNodeMappingInfoRead_PARAMS, NULL},
    ...
    {"cpssTmShapingProfileByIndexCreate", 4, cpssTmShapingProfileByIndexCreate_PARAMS, NULL},

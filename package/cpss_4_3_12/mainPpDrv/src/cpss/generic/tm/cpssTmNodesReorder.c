...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
                                      CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);

    ret = tm_nodes_switch(PRV_CPSS_PP_MAC(devNum)->tmInfo.tmHandle, (enum tm_level)level,
                         (uint16_t)nodeAIndex,
                         (uint16_t)nodeBIndex);

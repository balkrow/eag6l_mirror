...
{
    int       i = 0;
    GT_STATUS *tmToCpssErrCodes = &PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(tmToCpssErrCodes)[0];
    GT_STATUS *tmToCpssErrCodesNeg = &PRV_SHARED_GENERIC_TM_DIR_GLOBAL_VAR_GET(tmToCpssErrCodesNeg)[0];

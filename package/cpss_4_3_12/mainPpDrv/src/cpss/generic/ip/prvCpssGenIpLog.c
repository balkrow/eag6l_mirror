...
const char * const prvCpssLogEnum_CPSS_IPV6_MLL_SELECTION_RULE_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_IPV6_PREFIX_SCOPE_ENT[]  =
{
...
const char * const prvCpssLogEnum_CPSS_IP_CNT_SET_ENT[]  =
{
    "CPSS_IP_CNT_SET0_E",
    "CPSS_IP_CNT_SET1_E",
    "CPSS_IP_CNT_SET2_E",
...
const char * const prvCpssLogEnum_CPSS_IP_SITE_ID_ENT[]  =
{
    "CPSS_IP_SITE_ID_INTERNAL_E",
    "CPSS_IP_SITE_ID_EXTERNAL_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_IP_SITE_ID_ENT);
const char * const prvCpssLogEnum_CPSS_IP_UNICAST_MULTICAST_ENT[]  =
{
    "CPSS_IP_UNICAST_E",
    "CPSS_IP_MULTICAST_E"
};
...
void prvCpssLogParamFunc_CPSS_IP_CNT_SET_ENT_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,

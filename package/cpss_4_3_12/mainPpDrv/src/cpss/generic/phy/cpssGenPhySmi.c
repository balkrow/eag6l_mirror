...
/**
* @internal phy1340Init function
* @endinternal
*
* @brief   This function implements the WA for the 88E1340.
*
...
* @param[in] smiWriteRegister         - pointer SMI Write implementation
*
...
/**
* @internal phy154xMInit function
* @endinternal
*
* @brief   This function implements initialization required for the 154<n>M PHYs.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] devNum                   - Device Number.
* @param[in] portNum                  - Port Number.
* @param[in] smiReadRegister          - pointer SMI Read implementation
* @param[in] smiWriteRegister         - pointer SMI Write implementation
*
* @retval GT_OK                    - on success.
* @retval GT_FAIL                  - otherwise.
...
/**
* @internal phy168xInit function
* @endinternal
*
* @brief   This function implements initialization required for the 168x PHYs.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
/**
* @internal phyLockUpprevent function
* @endinternal
*
* @brief   This function implements the WA for the 88E1112 SERDES lock-up erratum
...
* @param[in] devNum                   - Device Number.
* @param[in] portNum                  - Port Number.
* @param[in] smiReadRegister          - Read function
* @param[in] smiWriteRegister         - Write function
*
* @retval GT_OK                    - on success.
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal phy1149GigabitVodSet function
* @endinternal
*
* @brief   This function implements the WA for the 88E1149 revision C1 gigabit VOD
...
* @param[in] devNum                   - Device Number.
* @param[in] portNum                  - Port Number.
* @param[in] vodRegValue              - value to be set in Vod register
* @param[in] smiWriteRegister         - pointer SMI Write implementation
*
* @retval GT_OK                    - on success.
* @retval GT_FAIL                  - otherwise.
...
/**
* @internal phyTypeGet function
* @endinternal
*
* @brief   Gets the PHY type.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
* @param[in] smiReadRegister          - Read function
*
* @param[out] isMarvellPhyPtr          - GT_TRUE - phy type is Marvell
*                                      GT_FALSE - phy type is not Marvell
* @param[out] phyTypePtr               - PHY type
*
* @retval GT_OK                    - on success or current phy is not 88E1149.
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal prvCpssGenPhyErrataInitFix function
* @endinternal
*
* @brief   This function implements the WA for phys during the initialization.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
)
{
    ...
    status = cpssSystemRecoveryStateGet(&tempSystemRecovery_Info);
    if (status != GT_OK)
    {
        return status;
    }
...
/**
* @internal prvCpssPhyRegWriteErrataFix function
* @endinternal
*
* @brief   Implement PHY register write workarounds.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] devNum                   - Device Number.
* @param[in] portNum                  - Port Number.
* @param[in] regPhy                   - phy's register address
* @param[in] data                     - value to be set
* @param[in] smiWriteRegister         - pointer to relevant SMI write implementation
*
* @retval GT_OK                    - on success.
* @retval GT_FAIL                  - otherwise.
*/
...
/**
* @internal prvCpssFixPhy1240SgmiiLockUpErrata function
* @endinternal
*
* @brief   This function implements the WA for the 88E1240 SGMII lock-up issue per
*         port.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on access to phy other then 1240.
*/
...
/**
* @internal prvCpssFixPhy1340BgaInitErrata function
* @endinternal
*
* @brief   This function implements the WA for the 88E1340 BGA package init sequence
*         per port.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
...
* @retval GT_FAIL                  - otherwise.
* @retval GT_HW_ERROR              - on hardware error
* @retval GT_NOT_APPLICABLE_DEVICE - on access to phy other then 1340.
*/
...
/**
* @internal internal_cpssPhyErrataWaExecute function
* @endinternal
*

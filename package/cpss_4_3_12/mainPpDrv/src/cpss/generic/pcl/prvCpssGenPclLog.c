...
const char * const prvCpssLogEnum_CPSS_PCL_DIRECTION_ENT[]  =
{
...
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_PCL_LOOKUP_NUMBER_ENT[]  =
...
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_PCL_RULE_SIZE_ENT[]  =

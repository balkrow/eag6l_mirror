...
const char * const prvCpssLogEnum_CPSS_PORT_TX_POOL_MODE_ENT[]  =
{
    "CPSS_PORT_TX_POOL_MODE_TWO_LOSSY_E",
    "CPSS_PORT_TX_POOL_MODE_ONE_LOSSY_TWO_LOSLESS_E",
    "CPSS_PORT_TX_POOL_MODE_FOUR_LOSSLESS_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_PORT_TX_POOL_MODE_ENT);
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, poolLimitEnable);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, queueExp);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFunc_CPSS_PORT_TX_POOL_MODE_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_PORT_TX_POOL_MODE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_PORT_TX_POOL_MODE_ENT);
}
void prvCpssLogParamFunc_CPSS_PORT_TX_POOL_MODE_ENT_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,

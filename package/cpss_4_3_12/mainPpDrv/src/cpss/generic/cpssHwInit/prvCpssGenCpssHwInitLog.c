...
void prvCpssLogParamFuncStc_CPSS_LED_PARALLEL_CONFIG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_LED_PARALLEL_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, ledParallelModeEnable);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, ledParallelBitConfigArr, CPSS_LED_BIT_SELECTORS_MAX_NUM_CNS, CPSS_LED_PARALLEL_BIT_CONFIG_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_LED_PARALLEL_BIT_CONFIG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_LED_PARALLEL_BIT_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, dataBitSelector);
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, ledClockPosEdgeModeEnable);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFunc_CPSS_LED_PARALLEL_CONFIG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_LED_PARALLEL_CONFIG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_LED_PARALLEL_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}

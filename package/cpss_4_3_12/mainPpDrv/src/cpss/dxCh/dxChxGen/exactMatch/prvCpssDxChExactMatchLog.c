...
const char * const prvCpssLogEnum_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT);
const char * const prvCpssLogEnum_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT);
const char * const prvCpssLogEnum_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT);
...
const char * const prvCpssLogEnum_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_ENT);
...
void prvCpssLogParamFuncStc_CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, superKeyTwoByteUnitsOffsets, CPSS_DXCH_EXACT_MATCH_MUX_KEY_BYTE_PAIRS_OFFSET_VAL_CNS, GT_U8);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, serialEmProfileId);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, serialEmKeyType, CPSS_DXCH_EXACT_MATCH_SERIAL_EM_KEY_TYPE_ENT);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, serialEmEnableUDB28VlanTagKey);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, serialEmEnableUDB29VlanTagKey);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, serialEmPclId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, overwriteExpandedActionGenericAction);
    PRV_CPSS_LOG_STC_32_HEX_MAC(valPtr, genericActionMask);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, overwriteExpandedActionGenericAction);
    PRV_CPSS_LOG_STC_32_HEX_MAC(valPtr, genericActionMask);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, overwriteQosModel);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, overwriteTtlModel);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, overwriteQosMappingMode);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, overwriteStopMpls);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFunc_CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
void prvCpssLogParamFunc_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
void prvCpssLogParamFunc_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT);
}
void prvCpssLogParamFunc_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT);
}
void prvCpssLogParamFunc_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC_PTR_emMuxTableLineCfgPtr = {
     "emMuxTableLineCfgPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC_PTR_serialEmProfileParamsPtr = {
     "serialEmProfileParamsPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT_packetType = {
     "packetType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT_serialEmType = {
     "serialEmType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT_emUnitNum = {
     "emUnitNum", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_emProfileId = {
     "emProfileId", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_emUnitNum = {
     "emUnitNum", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_numBitsInData = {
     "numBitsInData", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC_PTR_emMuxTableLineCfgPtr = {
     "emMuxTableLineCfgPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC_PTR_serialEmProfileParamsPtr = {
     "serialEmProfileParamsPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_portProfileIdPtr = {
     "portProfileIdPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT_packetType,
    &DX_IN_GT_U32_portProfileId,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT_serialEmType,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC_PTR_serialEmProfileParamsPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_PACKET_TYPE_ENT_packetType,
    &DX_IN_GT_U32_portProfileId,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_TYPE_ENT_serialEmType,
    &DX_OUT_CPSS_DXCH_EXACT_MATCH_SERIAL_EM_ENTRY_STC_PTR_serialEmProfileParamsPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchHashCrcMultiResultsByParamsCalc_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT_emUnitNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_KEY_STC_PTR_entryKeyPtr,
    &DX_OUT_GT_U32_PTR_numberOfElemInCrcMultiHashArrPtr,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchActivityBitEnableSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT_emUnitNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT_lookupNum,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchPortGroupEntryInvalidate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT_emUnitNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT_lookupNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchPortGroupEntryStatusGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT_emUnitNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT_lookupNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchActivityBitEnableGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT_emUnitNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT_lookupNum,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchProfileMuxTableLineSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT_emUnitNum,
    &DX_IN_GT_U32_emProfileId,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC_PTR_emMuxTableLineCfgPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchProfileMuxTableLineGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_UNIT_NUM_ENT_emUnitNum,
    &DX_IN_GT_U32_emProfileId,
    &DX_OUT_CPSS_DXCH_EXACT_MATCH_MUX_TABLE_LINE_CFG_STC_PTR_emMuxTableLineCfgPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchSerialEmPortProfileIdSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_NUM_portNum,
    &DX_IN_GT_U32_portProfileId
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchSerialEmPortProfileIdGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_NUM_portNum,
    &DX_OUT_GT_U32_PTR_portProfileIdPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchPortGroupAutoLearnFlowIdParamSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_emUnitNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChExactMatchLogLibDb[] = {
    {"cpssDxChExactMatchTtiProfileIdModePacketTypeSet", 6, cpssDxChExactMatchTtiProfileIdModePacketTypeSet_PARAMS, NULL},
    ...
    {"cpssDxChExactMatchTtiPortProfileIdModePortSet", 6, cpssDxChExactMatchTtiPortProfileIdModePortSet_PARAMS, NULL},
    {"cpssDxChExactMatchTtiPortProfileIdModePortGet", 5, cpssDxChExactMatchTtiPortProfileIdModePortGet_PARAMS, NULL},
    {"cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet", 7, cpssDxChExactMatchTtiPortProfileIdModePortPacketTypeSet_PARAMS, NULL},
    ...
    {"cpssDxChExactMatchPclProfileIdSet", 8, cpssDxChExactMatchPclProfileIdSet_PARAMS, NULL},
    {"cpssDxChExactMatchPclProfileIdGet", 7, cpssDxChExactMatchPclProfileIdGet_PARAMS, NULL},
    {"cpssDxChExactMatchClientLookupSet", 4, cpssDxChExactMatchClientLookupSet_PARAMS, NULL},
    {"cpssDxChExactMatchClientLookupGet", 4, cpssDxChExactMatchClientLookupGet_PARAMS, NULL},
    {"cpssDxChExactMatchActivityBitEnableSet", 4, cpssDxChExactMatchActivityBitEnableSet_PARAMS, NULL},
    {"cpssDxChExactMatchActivityBitEnableGet", 4, cpssDxChExactMatchActivityBitEnableGet_PARAMS, NULL},
    {"cpssDxChExactMatchActivityStatusGet", 7, cpssDxChExactMatchActivityStatusGet_PARAMS, NULL},
    {"cpssDxChExactMatchProfileKeyParamsSet", 4, cpssDxChExactMatchProfileKeyParamsSet_PARAMS, NULL},
    {"cpssDxChExactMatchProfileKeyParamsGet", 4, cpssDxChExactMatchProfileKeyParamsGet_PARAMS, NULL},
    {"cpssDxChExactMatchProfileDefaultActionSet", 6, cpssDxChExactMatchProfileDefaultActionSet_PARAMS, NULL},
    {"cpssDxChExactMatchProfileDefaultActionGet", 6, cpssDxChExactMatchProfileDefaultActionGet_PARAMS, NULL},
    {"cpssDxChExactMatchExpandedActionSet", 6, cpssDxChExactMatchExpandedActionSet_PARAMS, NULL},
    {"cpssDxChExactMatchExpandedActionGet", 6, cpssDxChExactMatchExpandedActionGet_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupEntrySet", 9, cpssDxChExactMatchPortGroupEntrySet_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupEntryGet", 10, cpssDxChExactMatchPortGroupEntryGet_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupEntryInvalidate", 5, cpssDxChExactMatchPortGroupEntryInvalidate_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupEntryStatusGet", 6, cpssDxChExactMatchPortGroupEntryStatusGet_PARAMS, NULL},
    {"cpssDxChExactMatchHashCrcMultiResultsByParamsCalc", 5, cpssDxChExactMatchHashCrcMultiResultsByParamsCalc_PARAMS, NULL},
    {"cpssDxChExactMatchRulesDump", 6, cpssDxChExactMatchRulesDump_PARAMS, NULL},
    ...
    {"cpssDxChExactMatchAutoLearnLookupSet", 3, cpssDxChExactMatchAutoLearnLookupSet_PARAMS, NULL},
    {"cpssDxChExactMatchAutoLearnLookupGet", 3, cpssDxChExactMatchAutoLearnLookupGet_PARAMS, NULL},
    {"cpssDxChExactMatchAutoLearnProfileDefaultActionSet", 7, cpssDxChExactMatchAutoLearnProfileDefaultActionSet_PARAMS, NULL},
    {"cpssDxChExactMatchAutoLearnProfileDefaultActionGet", 7, cpssDxChExactMatchAutoLearnProfileDefaultActionGet_PARAMS, NULL},
    {"cpssDxChExactMatchAutoLearnProfileDefaultActionEnableSet", 4, cpssDxChExactMatchAutoLearnProfileDefaultActionEnableSet_PARAMS, NULL},
    {"cpssDxChExactMatchAutoLearnProfileDefaultActionEnableGet", 4, cpssDxChExactMatchAutoLearnProfileDefaultActionEnableGet_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupAutoLearnFlowIdParamSet", 4, cpssDxChExactMatchPortGroupAutoLearnFlowIdParamSet_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupAutoLearnFlowIdParamGet", 4, cpssDxChExactMatchPortGroupAutoLearnFlowIdParamGet_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupAutoLearnFlowIdAllocStatusGet", 4, cpssDxChExactMatchPortGroupAutoLearnFlowIdAllocStatusGet_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupAutoLearnEntryGetNext", 5, cpssDxChExactMatchPortGroupAutoLearnEntryGetNext_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupAutoLearnCollisionKeyParamsGet", 4, cpssDxChExactMatchPortGroupAutoLearnCollisionKeyParamsGet_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupAutoLearnEntryRecycleGet", 5, cpssDxChExactMatchPortGroupAutoLearnEntryGetNext_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupAutoLearnEntryRecycleTrigger", 3, cpssDxChExactMatchPortGroupAutoLearnEntryRecycleTrigger_PARAMS, NULL},
    {"cpssDxChExactMatchPortGroupAutoLearnFailCountersGet", 4, cpssDxChExactMatchPortGroupAutoLearnFailCountersGet_PARAMS, NULL},
    {"cpssDxChExactMatchSerialEmPortProfileIdSet", 3, cpssDxChExactMatchSerialEmPortProfileIdSet_PARAMS, NULL},
    {"cpssDxChExactMatchSerialEmPortProfileIdGet", 3, cpssDxChExactMatchSerialEmPortProfileIdGet_PARAMS, NULL},
    {"cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet", 5, cpssDxChExactMatchSerialEmProfileIdMappingTableEntrySet_PARAMS, NULL},
    {"cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet", 5, cpssDxChExactMatchSerialEmProfileIdMappingTableEntryGet_PARAMS, NULL},
    {"cpssDxChExactMatchProfileMuxTableLineSet", 4, cpssDxChExactMatchProfileMuxTableLineSet_PARAMS, NULL},
    {"cpssDxChExactMatchProfileMuxTableLineGet", 4, cpssDxChExactMatchProfileMuxTableLineGet_PARAMS, NULL},
    {"prvCpssDxChExactMatchHashCrcMultiResultsByParamsCalcExt", 6, prvCpssDxChExactMatchHashCrcMultiResultsByParamsCalcExt_PARAMS, NULL},
    {"prvCpssDxChExactMatchHashCrcMultiResultsByParamsCalc", 5, prvCpssDxChExactMatchHashCrcMultiResultsByParamsCalc_PARAMS, NULL},
};

 ...
 */
static const GT_U32 bitsTotake[3][8] ={
...
* @param[in] numBitsInData         - max number of bits in the entry key
*                                    SIP6 : PRV_CPSS_DXCH_EXACT_MATCH_HASH_DATA_SIZE_VALUE_CNS
*                                    SIP7 : PRV_CPSS_DXCH_SIP7_EXACT_MATCH_HASH_DATA_SIZE_VALUE_CNS
...
)
{
   ...
   switch (entryKeyPtr->keySize)
   {
       ...
       case CPSS_DXCH_EXACT_MATCH_KEY_SIZE_47B_E:
           ...
           break;
       case CPSS_DXCH_EXACT_MATCH_KEY_SIZE_21B_E:
           exactMatchKeysize = 21;
           break;
       case CPSS_DXCH_EXACT_MATCH_KEY_SIZE_37B_E:
           exactMatchKeysize = 37;
           break;
       case CPSS_DXCH_EXACT_MATCH_KEY_SIZE_53B_E:
           exactMatchKeysize = 53;
           break;
       default:
   ...
   keySize = (entryKeyPtr->keySize > 3)?(entryKeyPtr->keySize-3):entryKeyPtr->keySize;
   numOfBanks = (((numOfBanks / (((GT_U32)keySize)+1))) * (((GT_U32)keySize)+1));

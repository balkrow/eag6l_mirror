...
const char * const prvCpssLogEnum_CPSS_DXCH_PTP_TAI_CLOCK_FREQ_ENT[]  =
{
    ...
    "CPSS_DXCH_PTP_TAI_CLOCK_FREQ_LAST_E"
};
...
const char * const prvCpssLogEnum_CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT[]  =
{
    "CPSS_DXCH_PTP_TAI_SER_GEN_MODE_DISABLED_E",
    "CPSS_DXCH_PTP_TAI_SER_GEN_MODE_SERIAL_GEN_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT);
const char * const prvCpssLogEnum_CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT[]  =
{
    "CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_DISABLED_E",
    "CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_SERIAL_RECEPTION_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT);
...
)
{
    ...
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, entryValid);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, isPtpException);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, packetFormat, CPSS_DXCH_PTP_TS_PACKET_TYPE_ENT);
...
void prvCpssLogParamFunc_CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT);
}
void prvCpssLogParamFunc_CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT);
}
void prvCpssLogParamFunc_CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT_serGenerationMode = {
     "serGenerationMode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT_serReceptionMode = {
     "serReceptionMode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT_PTR_serGenerationModePtr = {
     "serGenerationModePtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT_PTR_serReceptionModePtr = {
     "serReceptionModePtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_crcErrorCounterPtr = {
     "crcErrorCounterPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpTaiSerialGenerationModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_ID_STC_PTR_taiIdPtr,
    &DX_IN_CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT_serGenerationMode
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpTaiSerialReceptionModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_ID_STC_PTR_taiIdPtr,
    &DX_IN_CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT_serReceptionMode
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpTaiSerialGenerationModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_ID_STC_PTR_taiIdPtr,
    &DX_OUT_CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT_PTR_serGenerationModePtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpTaiSerialReceptionModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_ID_STC_PTR_taiIdPtr,
    &DX_OUT_CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT_PTR_serReceptionModePtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpPortMacTsCrcErrorCounterDbgGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_OUT_GT_U32_PTR_crcErrorCounterPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPtpLogLibDb[] = {
    ...
    {"cpssDxChPtpPortPhyTsEnableSet", 3, prvCpssLogGenDevNumPortNumEnable_PARAMS, NULL},
    {"cpssDxChPtpPortPhyTsEnableGet", 3, prvCpssLogGenDevNumPortNumEnablePtr_PARAMS, NULL},
    {"cpssDxChPtpTaiSerialGenerationModeSet", 3, cpssDxChPtpTaiSerialGenerationModeSet_PARAMS, NULL},
    {"cpssDxChPtpTaiSerialGenerationModeGet", 3, cpssDxChPtpTaiSerialGenerationModeGet_PARAMS, NULL},
    {"cpssDxChPtpTaiSerialReceptionModeSet", 3, cpssDxChPtpTaiSerialReceptionModeSet_PARAMS, NULL},
    {"cpssDxChPtpTaiSerialReceptionModeGet", 3, cpssDxChPtpTaiSerialReceptionModeGet_PARAMS, NULL},
    {"cpssDxChPtpTaiSerRxFrameLatencyDbgGet", 5, cpssDxChPtpTaiSerRxFrameLatencyDbgGet_PARAMS, NULL},
    {"cpssDxChPtpTaiTodStepDbgSet", 3, cpssDxChPtpTaiTodStepDbgSet_PARAMS, NULL},
    {"cpssDxChPtpTaiSelectDbgSet", 4, cpssDxChPtpTaiSelectDbgSet_PARAMS, NULL},
    {"cpssDxChPtpPortMacTsCrcErrorCounterDbgGet", 3, cpssDxChPtpPortMacTsCrcErrorCounterDbgGet_PARAMS, NULL},
};

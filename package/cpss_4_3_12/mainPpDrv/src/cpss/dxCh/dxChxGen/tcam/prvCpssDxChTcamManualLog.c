...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_tcamPatternPtr = {
     "tcamPatternPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_tcamMaskPtr = {
     "tcamMaskPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_tcamPatternPtr = {
     "tcamPatternPtr", PRV_CPSS_LOG_PARAM_OUT_E, prvCpssLogParamFunc_GT_U32_ARRAY_sizeSet
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_tcamMaskPtr = {
     "tcamMaskPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_tcamKeyPtr = {
     "tcamKeyPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_tcamKeyPtr = {
     "tcamKeyPtr", PRV_CPSS_LOG_PARAM_OUT_E,  prvCpssLogParamFunc_GT_U32_ARRAY_sizeSet
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamPortGroupRuleWrite_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_IN_GT_BOOL_valid,
    &DX_IN_CPSS_DXCH_TCAM_RULE_SIZE_ENT_ruleSize,
    &DX_IN_GT_U32_ARRAY_tcamPatternPtr,
    &DX_IN_GT_U32_ARRAY_tcamMaskPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamPortGroupRuleRead_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_OUT_GT_BOOL_PTR_validPtr,
    &DX_OUT_CPSS_DXCH_TCAM_RULE_SIZE_ENT_PTR_ruleSizePtr,
    &DX_OUT_GT_U32_ARRAY_tcamPatternPtr,
    &DX_OUT_GT_U32_ARRAY_tcamMaskPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamPortGroupCpuLookupTriggerSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_group,
    &DX_IN_CPSS_DXCH_TCAM_RULE_SIZE_ENT_size,
    &DX_IN_GT_U32_ARRAY_tcamKeyPtr,
    &DX_IN_GT_U32_subKeyProfile
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamPortGroupCpuLookupTriggerGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_group,
    &DX_OUT_CPSS_DXCH_TCAM_RULE_SIZE_ENT_PTR_sizePtr,
    &DX_OUT_GT_U32_ARRAY_tcamKeyPtr,
    &DX_OUT_GT_U32_PTR_subKeyProfilePtr
};

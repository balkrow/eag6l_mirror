...
const char * const prvCpssLogEnum_CPSS_DXCH_TCAM_CLIENT_ENT[]  =
{
    ...
    "CPSS_DXCH_TCAM_MPCL_E",
    "CPSS_DXCH_TCAM_IPE_E"
};
...
void prvCpssLogParamFuncStc_CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, subKeySizes, 4, CPSS_DXCH_TCAM_RULE_SIZE_ENT);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, subKeyMuxTableLineIndexes, 4, GT_U32);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, subKeyMuxTableLineOffsets, 4, GT_U32);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, sharedMuxTableLineIndex);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, sharedMuxTableLineOffset);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFunc_CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC_PTR_tcamLookupProfileCfgPtr = {
     "tcamLookupProfileCfgPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_tcamClientGroup = {
     "tcamClientGroup", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC_PTR_tcamLookupProfileCfgPtr = {
     "tcamLookupProfileCfgPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamClientGroupLookupMuxTableLineSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_tcamClientGroup,
    &DX_IN_GT_U32_entryIndex,
    &DX_IN_CPSS_DXCH_TCAM_LOOKUP_MUX_TABLE_LINE_CFG_STC_PTR_tcamLookupMuxTableLineCfgPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamClientGroupLookupMuxTableLineGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_tcamClientGroup,
    &DX_IN_GT_U32_entryIndex,
    &DX_OUT_CPSS_DXCH_TCAM_LOOKUP_MUX_TABLE_LINE_CFG_STC_PTR_tcamLookupMuxTableLineCfgPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamClientGroupLookupProfileCfgSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_tcamClientGroup,
    &DX_IN_GT_U32_tcamProfileId,
    &DX_IN_CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC_PTR_tcamLookupProfileCfgPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTcamClientGroupLookupProfileCfgGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_tcamClientGroup,
    &DX_IN_GT_U32_tcamProfileId,
    &DX_OUT_CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC_PTR_tcamLookupProfileCfgPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTcamLogLibDb[] = {
    ...
    {"cpssDxChTcamClientGroupLookupMuxTableLineSet", 4, cpssDxChTcamClientGroupLookupMuxTableLineSet_PARAMS, NULL},
    {"cpssDxChTcamLookupMuxTableLineGet", 3, cpssDxChTcamLookupMuxTableLineGet_PARAMS, NULL},
    {"cpssDxChTcamClientGroupLookupMuxTableLineGet", 4, cpssDxChTcamClientGroupLookupMuxTableLineGet_PARAMS, NULL},
    {"cpssDxChTcamClientGroupLookupProfileCfgSet", 4, cpssDxChTcamClientGroupLookupProfileCfgSet_PARAMS, NULL},
    {"cpssDxChTcamClientGroupLookupProfileCfgGet", 4, cpssDxChTcamClientGroupLookupProfileCfgGet_PARAMS, NULL},
};

...
#include <cpss/dxCh/dxChxGen/pha/private/prvCpssDxChPpaFwImageInfo_Ac5pImage02.h>
...
/* IFA Template Index */
#define PRV_CPSS_DXCH_PHA_THREAD_IFA_TEMPLATE_INDEX_CNS              1
/* max number of flows supported by IFA */
#define PRV_CPSS_DXCH_PHA_THREAD_IFA_FLOW_INDEX_CNS                  512
/* required number of PPATHREADsIfaConfWords */
#define PRV_CPSS_DXCH_PPA_THREAD_IFA_CONF_WORDS_CNS                  2
/* starting index for IFA flow entry in PHA shared memory */
#define PRV_CPSS_DXCH_PPA_THREAD_SHARED_MEMORY_START_INDEX_CNS       391
/* starting offset of ECN counting entry in PHA shared memory */
#define PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_START_OFFSET_CNS   0x61C
/* starting index of ECN counting entry in PHA shared memory */
#define PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_START_INDEX_CNS    (PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_START_OFFSET_CNS >> 2)
/* Max ports supported for ECN counting in PHA shared memory
 * PHA shared memory size is 8KB. Each ECN counting entry is of size for 4B.
 * Therefore, total entries supported are 8KB / 4B = 2K.
 * Each port supports 8 queues. Therefore, total ports supported are 2K / 8 =  256.
 * Max ports supported can be calculated as:
 * 256 - ((ECNCountingStartOffset >> 5) + ((ECNCountingStartOffset & 31) == 0 ? 0 : 1))).
 */
#define PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_MAX_PORTS_CNS    207

/* Max queues supported for ECN counting in PHA shared memory */
#define PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_MAX_QUEUES_CNS    8
...
{                  /* Thread address */               /* latency */ /* headerWindowAnchore */ /* headerWindowSize */
   ...
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,      42     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 56 THR_Clear_Outgoing_Mtag_Cmd                         */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     156     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 57 THR_SFLOW_V5_ENT0_FORMAT1_RAW_PACKET_E              */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,      25     ,    Outer_L3_Start       ,     EXPAND_32B  }      /* 58 THR_IPSEC_PTP                                       */
   ...
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,      76     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 66 THR_enhanced_sFlow                                  */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,      20     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 67 THR_Forward_DSA_Routed_Clear                        */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     107     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 68 THR_Erspan_TypeI_Ipv4                               */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     141     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 69 THR_Erspan_TypeI_Ipv6                               */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,      53     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 70 THR_Radio_Header                                    */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     283     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 71 THR_IFA_Header                                      */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     238     ,    Outer_L3_Start       ,     EXPAND_32B  }      /* 72 THR_IFA_Ingress_Metadata                            */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     332     ,    Outer_L3_Start       ,     EXPAND_48B  }      /* 73 THR_IFA_Transit_Metadata                            */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,      22     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 74 THR_IFA_Egress_Node_Mirror                          */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     332     ,    Outer_L3_Start       ,     EXPAND_48B  }      /* 75 THR_IFA_Egress_Metadata                             */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     101     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 76 THR_Copy_Flow_ID_to_Trg_Phy_Port                    */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,      39     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 77 Reserved ID for thread THR77                        */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,      21     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 78 Reserved ID for thread THR78                        */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     125     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 79 Reserved ID for thread THR79                        */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,      47     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 80 THR_ECN_COUNTING                                    */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     235     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 81 THR_Erspan_TypeIII_SameDevMirroring_IPv4            */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     109     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 82 THR_Erspan_TypeIII_SameDevMirroring_IPv6_FirstPass  */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     217     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 83 THR_Erspan_TypeIII_SameDevMirroring_IPv6_SecondPass */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     115     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 84 THR84_Erspan_TypeIII_OrigDevMirroring */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     156     ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 85 THR85_Erspan_TypeIII_TrgDevMirroring_IPv4_Tagged */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     158     ,    Outer_L2_Start       ,     EXPAND_48B  }      /* 86 THR86_Erspan_TypeIII_TrgDevMirroring_IPv4_Untagged */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     211     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 87 THR87_Erspan_TypeIII_TrgDevMirroring_IPv6_Tagged */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     212     ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 88 THR88_Erspan_TypeIII_TrgDevMirroring_IPv6_Untagged */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     0       ,    Outer_L2_Start       ,     EXPAND_64B  }      /* 89 TBD: Add THR89 Dummy Value */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     22      ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 90 THR90_Router_SA_Modification */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     38      ,    Outer_L3_Start       ,     EXPAND_32B  }      /* 91 THR91_INQA_ECN */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     31      ,    Outer_L3_Start       ,     EXPAND_32B  }      /* 92 THR92_VXLAN_DCI_VNI_Remapping */
   ,{PRV_CPSS_DXCH_PHA_INVALID_FW_THREAD_ADDRESS_CNS ,     64      ,    Outer_L2_Start       ,     EXPAND_32B  }      /* 93 THR93_MPLS_LSR_In_Stacking_System_Thread */
} ;
...
#define FW_CASE_LIKE_AC5P                                               \
    /*'case ' by the caller*/CPSS_PP_FAMILY_DXCH_AC5P_E:                \
              ...
              case CPSS_PP_FAMILY_DXCH_AAS_E/* ' :' by the caller' */
...
)
{
    ...
    switch(PRV_CPSS_PP_MAC(devNum)->devFamily)
    {
        ...
        case FW_CASE_LIKE_AC5P:
            ...
            /* For Image02 */
            fwImageInfoArr[6] = (PRV_CPSS_DXCH_PHA_FW_IMAGE_VERSION_INFO_STC*)&fwImageVersionAc5pImage02;
            fwImageInfoArr[7] = (PRV_CPSS_DXCH_PHA_FW_IMAGE_VERSION_INFO_STC*)&fwImageVersionAc5pImage02;
            fwImageInfoArr[8] = (PRV_CPSS_DXCH_PHA_FW_IMAGE_VERSION_INFO_STC*)&fwImageVersionAc5pImage02;
            ...
            /* For Image02 */
            fwImemArr[6] = (GT_U32*)prvCpssDxChPpaFwImemAc5pImage02;
            fwImemSizeArr[6] = sizeof(prvCpssDxChPpaFwImemAc5pImage02)/sizeof(prvCpssDxChPpaFwImemAc5pImage02[0]);
            fwImemArr[7] = (GT_U32*)prvCpssDxChPpaFwImemAc5pImage02;
            fwImemSizeArr[7] = sizeof(prvCpssDxChPpaFwImemAc5pImage02)/sizeof(prvCpssDxChPpaFwImemAc5pImage02[0]);
            fwImemArr[8] = (GT_U32*)prvCpssDxChPpaFwImemAc5pImage02;
            fwImemSizeArr[8] = sizeof(prvCpssDxChPpaFwImemAc5pImage02)/sizeof(prvCpssDxChPpaFwImemAc5pImage02[0]);
            ...
            /* For Image02 */
            fwThreadAddArr[6] = (GT_U32*)phaFwThreadsPcAddressAc5pImage02;
            fwThreadAddArr[7] = (GT_U32*)phaFwThreadsPcAddressAc5pImage02;
            fwThreadAddArr[8] = (GT_U32*)phaFwThreadsPcAddressAc5pImage02;
            ...
            /* For Image02 */
            fwAcclCmdArr[6] = (GT_U32*)phaFwAccelCmdsAc5pImage02;
            fwAcclCmdArr[7] = (GT_U32*)phaFwAccelCmdsAc5pImage02;
            fwAcclCmdArr[8] = (GT_U32*)phaFwAccelCmdsAc5pImage02;
            break;
...
)
{
    ...
    switch(PRV_CPSS_PP_MAC(devNum)->devFamily)
    {
        ...
        case FW_CASE_LIKE_AC5P:
            ...
            /* Get fw versions for Image02 image */
            fwVerArr[6] = fwImageVersionAc5pImage02.imageVersion;
            fwVerArr[7] = fwImageVersionAc5pImage02.imageVersion;
            fwVerArr[8] = fwImageVersionAc5pImage02.imageVersion;
            break;
    ...
    switch(threadType)
    {
        ...
        case CPSS_DXCH_PHA_THREAD_TYPE_CLEAR_OUTGOING_MTAG_COMMAND_E:
            *firmwareThreadIdPtr = THR_ID_56;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_SFLOW_V5_ENT0_FORMAT1_RAW_PACKET_E:
            *firmwareThreadIdPtr = THR_ID_57;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IPSEC_PTP_E:
        ...
        case CPSS_DXCH_PHA_THREAD_TYPE_ENHANCED_SFLOW_FILL_REMAIN_IPV6_E:
            *firmwareThreadIdPtr = THR_ID_63;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_FORWARD_DSA_ROUTED_CLEAR_E:
            *firmwareThreadIdPtr = THR_ID_67;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_ERSPAN_TYPE_I_SAME_DEV_IPV4_E:
            *firmwareThreadIdPtr = THR_ID_68;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_ERSPAN_TYPE_I_SAME_DEV_IPV6_E:
            *firmwareThreadIdPtr = THR_ID_69;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_RADIO_HEADER_ADD_E:
            *firmwareThreadIdPtr = THR_ID_70;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_INGRESS_HEADER_E:
            *firmwareThreadIdPtr = THR_ID_71;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_INGRESS_METADATA_E:
            *firmwareThreadIdPtr = THR_ID_72;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_TRANSIT_METADATA_E:
            *firmwareThreadIdPtr = THR_ID_73;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_EGRESS_MIRROR_E:
            *firmwareThreadIdPtr = THR_ID_74;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_EGRESS_METADATA_E:
            *firmwareThreadIdPtr = THR_ID_75;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_COPY_FLOW_ID_TO_TRG_PHY_PORT_E:
            *firmwareThreadIdPtr = THR_ID_76;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_RESERVED_1_0_E:
            *firmwareThreadIdPtr = THR_ID_77;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_RESERVED_1_1_E:
            *firmwareThreadIdPtr = THR_ID_78;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_RESERVED_1_2_E:
            *firmwareThreadIdPtr = THR_ID_79;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_ECN_COUNTING_E:
            *firmwareThreadIdPtr = THR_ID_80;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_ERSPAN_TYPE_III_SAME_DEV_IPV4_E:
            *firmwareThreadIdPtr = THR_ID_81;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_ERSPAN_TYPE_III_SAME_DEV_IPV6_FIRST_PASS_E:
            *firmwareThreadIdPtr = THR_ID_82;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_ERSPAN_TYPE_III_SAME_DEV_IPV6_SECOND_PASS_E:
            *firmwareThreadIdPtr = THR_ID_83;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_CC_ERSPAN_TYPE_III_ORIG_DEV_E:
            *firmwareThreadIdPtr = THR_ID_84;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_CC_ERSPAN_TYPE_III_TRG_DEV_IPV4_TAGGED_E:
            *firmwareThreadIdPtr = THR_ID_85;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_CC_ERSPAN_TYPE_III_TRG_DEV_IPV4_UNTAGGED_E:
            *firmwareThreadIdPtr = THR_ID_86;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_CC_ERSPAN_TYPE_III_TRG_DEV_IPV6_TAGGED_E:
            *firmwareThreadIdPtr = THR_ID_87;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_CC_ERSPAN_TYPE_III_TRG_DEV_IPV6_UNTAGGED_E:
            *firmwareThreadIdPtr = THR_ID_88;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_ROUTER_SA_MODIFICATION_E:
            *firmwareThreadIdPtr = THR_ID_90;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_INQA_ECN_E:
            *firmwareThreadIdPtr = THR_ID_91;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_VXLAN_DCI_VNI_REMAP_E:
            *firmwareThreadIdPtr = THR_ID_92;
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_E:
            *firmwareThreadIdPtr = THR_ID_93;
            break;
        default:
...
)
{
    ...
    switch(PRV_CPSS_PP_MAC(devNum)->devFamily)
    {
        ...
        case FW_CASE_LIKE_AC5P:
            ...
            {   /* Ac5p PHA firmware image 02 */
                fwImemDataArrStart          = (GT_U32*)prvCpssDxChPpaFwImemAc5pImage02;
                fmImemDataArrSize           = PRV_CPSS_DXCH_PPA_FW_IMAGE_SIZE_AC5P_IMAGE02;
                fwThreadsPcAddressArrStart  = (GT_U32*)phaFwThreadsPcAddressAc5pImage02;
                PRV_CPSS_DXCH_PP_MAC(devNum)->phaInfo.fwVersionInfo = fwImageVersionAc5pImage02;
                fwAccelCmdsArrStart         = (GT_U32*)phaFwAccelCmdsAc5pImage02;
            }
            else
            {   /* Wrong PHA firmware image ID */
                CPSS_LOG_ERROR_AND_RETURN_MAC(GT_NOT_SUPPORTED,"PHA fw image ID[%d] is not supported", PRV_CPSS_DXCH_PP_MAC(devNum)->phaInfo.phaFwImageId);
...
/**
* @internal parseIfaEgressNodeMirrorTemplate function
* @endinternal
*
* @brief  parse IFA egress node mirror thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Ironman.
*
* @param[in] dataPtr[0]     -  holds the IFA egress node mirror analyzer index
*
* @param[out] ifaEgressNodeMirrorPtr   - (pointer to) the IFA egress node mirror analyzer index info.
*
* @retval NONE
*/
static GT_VOID parseIfaEgressNodeMirrorTemplate
(
    IN   GT_U32 dataPtr[/*1*/],
    OUT  CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_EGRESS_NODE_MIRROR_STC  *ifaEgressNodeMirrorPtr
)
{
    ifaEgressNodeMirrorPtr->ifaAnalyzerIndex = (GT_U8)((dataPtr[0] & 0x7) - 1);
}

/**
* @internal buildIfaEgressNodeMirrorTemplate function
* @endinternal
*
* @brief  build IFA egress node mirror thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Ironman.
*
* @param[in] ifaEgressNodeMirrorPtr - (pointer to) the IFA egress node mirror analyzer index info.
*
* @param[out] dataPtr[0]     -  holds the IFA egress node mirror analyzer index
*
* @retval GT_OUT_OF_RANGE        -  on out of range egress port drop counting mode/metadata insert sequence
* @retval GT_OK                  -  on success
*/
static GT_STATUS buildIfaEgressNodeMirrorTemplate
(
    IN CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_EGRESS_NODE_MIRROR_STC  *ifaEgressNodeMirrorPtr,
    OUT GT_U32 dataPtr[/*1*/]
)
{
    /* Check parameter is valid */
    CPSS_DATA_CHECK_MAX_MAC(ifaEgressNodeMirrorPtr->ifaAnalyzerIndex, BIT_3-1);

    dataPtr[0] = (ifaEgressNodeMirrorPtr->ifaAnalyzerIndex) + 1;
    return GT_OK;
}

/**
* @internal parseIfaIngressHeaderTemplate function
* @endinternal
*
* @brief  parse IFA ingress header thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Ironman.
*
* @param[in] dataPtr[0]          -  holds the IFA ingress header flags[7:0],
*                                   telemetery action vector [23:8]
*             dataPtr[1]         -  holds the IFA ingress header telemetery request vector [23:8]
*             dataPtr[2]         -  holds the IFA ingress header probe market 2
*             dataPtr[3]         -  holds the IFA ingress header probe market 1
*
* @param[out] ifaIngressHeaderPtr   - (pointer to) the IFA ingress header info.
*
* @retval NONE
*/
static GT_VOID parseIfaIngressHeaderTemplate
(
    IN   GT_U32                                         dataPtr[/*4*/],
    OUT  CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_HEADER_STC  *ifaIngressHeaderPtr
)
{
    ifaIngressHeaderPtr->flags                  =  U32_GET_FIELD_MAC(dataPtr[0],  0,  8);
    ifaIngressHeaderPtr->telemetryActionVector  =  U32_GET_FIELD_MAC(dataPtr[0],  8,  16);
    ifaIngressHeaderPtr->telemetryRequestVector =  U32_GET_FIELD_MAC(dataPtr[1],  8,  16);
    ifaIngressHeaderPtr->probeMarker2           =  dataPtr[2];
    ifaIngressHeaderPtr->probeMarker1           =  dataPtr[3];
}

/**
* @internal buildIfaIngressHeaderTemplate function
* @endinternal
*
* @brief  build IFA ingress header thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Ironman.
*
* @param[in] ifaIngressHeaderPtr - (pointer to) the IFA ingress header info.
*
* @param[out] dataPtr[0]         -  holds the IFA ingress header flags[7:0],
*                                   telemetery action vector [23:8]
*             dataPtr[1]         -  holds the IFA ingress header telemetery request vector [23:8]
*             dataPtr[2]         -  holds the IFA ingress header probe market 2
*             dataPtr[3]         -  holds the IFA ingress header probe market 1
*
* @retval GT_BAD_PARAM           -  on wrong flag value
* @retval GT_OK                  -  on success
*/
static GT_STATUS buildIfaIngressHeaderTemplate
(
    IN  CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_HEADER_STC  *ifaIngressHeaderPtr,
    OUT GT_U32                                         dataPtr[/*4*/]
)
{
    /* Check parameter is valid */
    if(ifaIngressHeaderPtr->flags & BIT_2 ||
       ifaIngressHeaderPtr->flags & BIT_0)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "Bad flag value[0x%x]",ifaIngressHeaderPtr->flags);
    }

    dataPtr[0] = (ifaIngressHeaderPtr->flags |
                  ifaIngressHeaderPtr->telemetryActionVector << 8);
    dataPtr[1] = ifaIngressHeaderPtr->telemetryRequestVector << 8;
    dataPtr[2] = ifaIngressHeaderPtr->probeMarker2;
    dataPtr[3] = ifaIngressHeaderPtr->probeMarker1;
    return GT_OK;
}

/**
* @internal parseIfaMetadataTemplate function
* @endinternal
*
* @brief  parse IFA metadata thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Ironman.
*
* @param[in]  dataPtr[3]         -  holds the IFA metadata device ID
*
* @param[out] ifaMetadataPtr     - (pointer to) the IFA metadata info.
*
* @retval NONE
*/
static GT_VOID parseIfaMetadataTemplate
(
    IN   GT_U32                                          dataPtr[/*4*/],
    OUT  CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_METADATA_STC *ifaMetadataPtr
)
{
    ifaMetadataPtr->deviceId                   = dataPtr[3];
}

/**
* @internal buildIfaMetadataTemplate function
* @endinternal
*
* @brief  build IFA metadata thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Ironman.
*
* @param[in] ifaMetadataPtr      - (pointer to) the IFA metadata template info.
*
* @param[out] dataPtr[3]         -  holds the IFA metadata device ID
*
* @retval GT_OK                  -  on success
*/
static GT_STATUS buildIfaMetadataTemplate
(
    IN  CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_METADATA_STC  *ifaMetadataPtr,
    OUT GT_U32                                           dataPtr[/*4*/]
)
{
    /* Check parameter is valid */

    dataPtr[3] = ifaMetadataPtr->deviceId;
    return GT_OK;
}

/**
* @internal parseClearOutgoingMtagCmdTemplate function
* @endinternal
*
* @brief  parse clear outgoing mtag cmd thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; AC5P; AC5X; Harrier; Ironman.
*
* @param[in]  dataPtr[0]                  -  holds the clear outgoing mtag cmd reTrapMode
*
* @param[out] clearOutgoingMtagCmdPtr     - (pointer to) the clear outgoing mtag cmd info.
*
* @retval NONE
*/
static GT_VOID parseClearOutgoingMtagCmdTemplate
(
    IN   GT_U32                                                          dataPtr[/*4*/],
    OUT  CPSS_DXCH_PHA_THREAD_INFO_TYPE_CLEAR_OUTGOING_MTAG_COMMAND_STC  *clearOutgoingMtagCmdPtr
)
{
    clearOutgoingMtagCmdPtr->reTrapMode = (dataPtr[3] == 0) ?
                                          CPSS_DXCH_PHA_RE_TRAP_MODE_USE_FLOW_ID_FOR_PORT_E :
                                          CPSS_DXCH_PHA_RE_TRAP_MODE_USE_COPY_RESERVED_FOR_VID_E;
}

/**
* @internal buildClearOutgoingMtagCmdTemplate function
* @endinternal
*
* @brief  build clear outgoing mtag cmd thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; AC5P; AC5X; Harrier; Ironman.
*
* @param[in] clearOutgoingMtagCmdPtr      - (pointer to) the clear outgoing mtag cmd template info.
*
* @param[out] dataPtr[0]                  -  holds the clear outgoing mtag cmd reTrapMode
*
* @retval GT_OK                           -  on success
*/
static GT_STATUS buildClearOutgoingMtagCmdTemplate
(
    IN  CPSS_DXCH_PHA_THREAD_INFO_TYPE_CLEAR_OUTGOING_MTAG_COMMAND_STC  *clearOutgoingMtagCmdPtr,
    OUT GT_U32                                                          dataPtr[/*4*/]
)
{
    /* Check parameter is valid */
    if(clearOutgoingMtagCmdPtr->reTrapMode >= CPSS_DXCH_PHA_RE_TRAP_MODE_LAST_E)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, " [clearOutgoingMtagCmdPtr->reTrapMode] "
                                      "must be in [0..%d] but got[0x%x]",
                                      CPSS_DXCH_PHA_RE_TRAP_MODE_USE_COPY_RESERVED_FOR_VID_E);
    }

    dataPtr[3] = clearOutgoingMtagCmdPtr->reTrapMode;
    return GT_OK;
}

/**
* @internal parseCopyFlowIdToTrgPhyPortTemplate function
* @endinternal
*
* @brief  parse copy flow id to trg phy port thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; AC5P; AC5X; Harrier; Ironman.
*
* @param[in]  dataPtr[0]                    -  holds the copy flow id to trg phy port reTrapMode
*
* @param[out] copyFlowIdToTrgPhyPortPtr     - (pointer to) the copy flow id to trg phy port info.
*
* @retval NONE
*/
static GT_VOID parseCopyFlowIdToTrgPhyPortTemplate
(
    IN   GT_U32                                                           dataPtr[/*4*/],
    OUT  CPSS_DXCH_PHA_THREAD_INFO_TYPE_COPY_FLOW_ID_TO_TRG_PHY_PORT_STC  *copyFlowIdToTrgPhyPortPtr
)
{
    copyFlowIdToTrgPhyPortPtr->reTrapMode = (dataPtr[3] == 0) ?
                                            CPSS_DXCH_PHA_RE_TRAP_MODE_USE_FLOW_ID_FOR_PORT_E :
                                            CPSS_DXCH_PHA_RE_TRAP_MODE_USE_COPY_RESERVED_FOR_VID_E;
}

/**
* @internal buildCopyFlowIdToTrgPhyPortTemplate function
* @endinternal
*
* @brief  build copy flow id to trg phy port thread template from the user info
*
* @note   APPLICABLE DEVICES:      Falcon.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; AC5P; AC5X; Harrier; Ironman.
*
* @param[in] copyFlowIdToTrgPhyPortPtr      - (pointer to) the copy flow id to trg phy port template info.
*
* @param[out] dataPtr[0]                    -  holds the copy flow id to trg phy port reTrapMode
*
* @retval GT_OK                             -  on success
*/
static GT_STATUS buildCopyFlowIdToTrgPhyPortTemplate
(
    IN  CPSS_DXCH_PHA_THREAD_INFO_TYPE_COPY_FLOW_ID_TO_TRG_PHY_PORT_STC  *copyFlowIdToTrgPhyPortPtr,
    OUT GT_U32                                                           dataPtr[/*4*/]
)
{
    /* Check parameter is valid */
    if(copyFlowIdToTrgPhyPortPtr->reTrapMode >= CPSS_DXCH_PHA_RE_TRAP_MODE_LAST_E)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, " [copyFlowIdToTrgPhyPortPtr->reTrapMode] "
                                      "must be in [0..%d] but got[0x%x]",
                                      CPSS_DXCH_PHA_RE_TRAP_MODE_USE_COPY_RESERVED_FOR_VID_E);
    }

    dataPtr[3] = copyFlowIdToTrgPhyPortPtr->reTrapMode;
    return GT_OK;
}

/**
* @internal parseMplsLsrInStackingSystemTemplate function
* @endinternal
*
* @brief  parse MPLS LSR in Stacking system thread template from the user info
*
* @note   APPLICABLE DEVICES:      AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; Ironman.
*
* @param[in]  dataPtr[3]                    -  holds the MPLS LSR in Stacking system ownHwDevNum and targetDevSelectBit
*
* @param[out] mplsLsrInStackingSystemPtr    - (pointer to) the MPLS LSR in Stacking system info.
*
* @retval NONE
*/
static GT_VOID parseMplsLsrInStackingSystemTemplate
(
    IN   GT_U32                                                          dataPtr[/*4*/],
    OUT  CPSS_DXCH_PHA_THREAD_INFO_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_STC  *mplsLsrInStackingSystemPtr
)
{
    mplsLsrInStackingSystemPtr->targetDevSelectBit = U32_GET_FIELD_MAC(dataPtr[3],  21,  1);
    mplsLsrInStackingSystemPtr->ownHwDevNum        = U32_GET_FIELD_MAC(dataPtr[3],  22,  10);
}

/**
* @internal buildMplsLsrInStackingSystemTemplate function
* @endinternal
*
* @brief  build MPLS LSR in Stacking system thread template from the user info
*
* @note   APPLICABLE DEVICES:      AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; Ironman.
*
* @param[in]  mplsLsrInStackingSystemPtr    - (pointer to) the MPLS LSR in Stacking system template info.
*
* @param[out] dataPtr[3]                    -  holds the MPLS LSR in Stacking system ownHwDevNum and targetDevSelectBit
*
* @retval GT_OK                             -  on success
*/
static GT_STATUS buildMplsLsrInStackingSystemTemplate
(
    IN  CPSS_DXCH_PHA_THREAD_INFO_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_STC  *mplsLsrInStackingSystemPtr,
    OUT GT_U32                                                          dataPtr[/*4*/]
)
{
    /* Check ownHwDevNum is valid */
    CPSS_DATA_CHECK_MAX_MAC(mplsLsrInStackingSystemPtr->ownHwDevNum, BIT_10);

    /* Check targetDevSelectBit is valid */
    CPSS_DATA_CHECK_MAX_MAC(mplsLsrInStackingSystemPtr->targetDevSelectBit, BIT_1);

    dataPtr[3] = (mplsLsrInStackingSystemPtr->ownHwDevNum << 22) | (mplsLsrInStackingSystemPtr->targetDevSelectBit << 21);
...
)
{
    ...
    CPSS_DXCH_PHA_THREAD_INFO_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_STC      *mplsLsrInStackingSystemPtr;
    ...
    switch(extType)
    {
        ...
        case CPSS_DXCH_PHA_THREAD_TYPE_ENHANCED_SFLOW_E:
            ...
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_INGRESS_HEADER_E:
            rc = buildIfaIngressHeaderTemplate(&extInfoPtr->ifaHeader, &PPAThreadsConf2Words[0]);
            if(rc != GT_OK)
            {
                return rc;
            }
        ...
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_TRANSIT_METADATA_E:
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_EGRESS_METADATA_E:
            rc = buildIfaMetadataTemplate(&extInfoPtr->ifaMetadata, &PPAThreadsConf2Words[0]);
            if(rc != GT_OK)
            {
                return rc;
            }
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_EGRESS_MIRROR_E:
            rc = buildIfaEgressNodeMirrorTemplate(&extInfoPtr->ifaEgressNodeMirror, &templateArr[0]);
            if(rc != GT_OK)
            {
                return rc;
            }
            ...
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_CLEAR_OUTGOING_MTAG_COMMAND_E:
            rc = buildClearOutgoingMtagCmdTemplate(&extInfoPtr->clearOutgoingMtagCmd, &PPAThreadsConf2Words[0]);
            if(rc != GT_OK)
            {
                return rc;
            }
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_COPY_FLOW_ID_TO_TRG_PHY_PORT_E:
            rc = buildCopyFlowIdToTrgPhyPortTemplate(&extInfoPtr->copyFlowIdToTrgPhyPort, &PPAThreadsConf2Words[0]);
            if(rc != GT_OK)
            {
                return rc;
            }
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_E:
            mplsLsrInStackingSystemPtr = &extInfoPtr->mplsLsrInStackingSystem;

            /* check and build specific info */
            rc = buildMplsLsrInStackingSystemTemplate(mplsLsrInStackingSystemPtr, &PPAThreadsConf2Words[0]);
            if(rc != GT_OK)
            {
                return rc;
            }
...
)
{
    ...
    CPSS_DXCH_PHA_THREAD_INFO_TYPE_VXLAN_GBP_SOURCE_GROUP_POLICY_ID_STC *vxlanGbpSourceGroupPolicyIdPtr;
    CPSS_DXCH_PHA_THREAD_INFO_TYPE_SRV6_COC32_GSID_STC               *srv6Coc32GsidCommonPrefixPtr;
    CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_HEADER_STC                    *ifaHeaderPtr;
    CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_METADATA_STC                  *ifaMetadataPtr;
    CPSS_DXCH_PHA_THREAD_INFO_TYPE_CLEAR_OUTGOING_MTAG_COMMAND_STC   *clearOutgoingMtagCmdPtr;
    CPSS_DXCH_PHA_THREAD_INFO_TYPE_COPY_FLOW_ID_TO_TRG_PHY_PORT_STC  *copyFlowIdToTrgPhyPortPtr;
    CPSS_DXCH_PHA_THREAD_INFO_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_STC   *mplsLsrInStackingSystemPtr;
    ...
    *extTypePtr = extType;
    ...
    switch(extType)
    {
        ...
        case CPSS_DXCH_PHA_THREAD_TYPE_ENHANCED_SFLOW_E:
            ...
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_INGRESS_HEADER_E:
            ifaHeaderPtr = &extInfoPtr->ifaHeader;

            /* parse HW info to SW info */
            parseIfaIngressHeaderTemplate(&PPAThreadsConf2Words[0], ifaHeaderPtr);
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_INGRESS_METADATA_E:
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_TRANSIT_METADATA_E:
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_EGRESS_METADATA_E:
            ifaMetadataPtr = &extInfoPtr->ifaMetadata;

            /* parse HW info to SW info */
            parseIfaMetadataTemplate(&PPAThreadsConf2Words[0], ifaMetadataPtr);
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_IFA_EGRESS_MIRROR_E:
            parseIfaEgressNodeMirrorTemplate(&PPAThreadsConf2Words[0], &extInfoPtr->ifaEgressNodeMirror);
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_CLEAR_OUTGOING_MTAG_COMMAND_E:
            clearOutgoingMtagCmdPtr = &extInfoPtr->clearOutgoingMtagCmd;

            /* parse HW info to SW info */
            parseClearOutgoingMtagCmdTemplate(&PPAThreadsConf2Words[0], clearOutgoingMtagCmdPtr);
            break;
        case CPSS_DXCH_PHA_THREAD_TYPE_COPY_FLOW_ID_TO_TRG_PHY_PORT_E:
            copyFlowIdToTrgPhyPortPtr = &extInfoPtr->copyFlowIdToTrgPhyPort;

            /* parse HW info to SW info */
            parseCopyFlowIdToTrgPhyPortTemplate(&PPAThreadsConf2Words[0], copyFlowIdToTrgPhyPortPtr);
            break;

        case CPSS_DXCH_PHA_THREAD_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_E:
            mplsLsrInStackingSystemPtr = &extInfoPtr->mplsLsrInStackingSystem;

            /* parse MPLS LSR in Stacking syatem info */
            parseMplsLsrInStackingSystemTemplate(&PPAThreadsConf2Words[0], mplsLsrInStackingSystemPtr);
            break;
...
)
{
    ...
    switch(infoType)
    {
        ...
        case CPSS_DXCH_PHA_SOURCE_PORT_ENTRY_TYPE_ERSPAN_TYPE_II_E:
            ...
            break;
        case CPSS_DXCH_PHA_SOURCE_PORT_ENTRY_TYPE_IFA_E:
            hwValue = portInfoPtr->ifaSourcePort.portId;
            if (hwValue > 0xFFFF )
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE,
                        "IFA Port Index must be in range 0..65535 and not [%d] \n",
                        hwValue);
            }
            break;
        default:
    ...
    *infoTypePtr = infoType;
    ...
    switch(infoType)
    {
        ...
        case CPSS_DXCH_PHA_SOURCE_PORT_ENTRY_TYPE_ERSPAN_TYPE_II_E:
            ...
            break;
        case CPSS_DXCH_PHA_SOURCE_PORT_ENTRY_TYPE_IFA_E:
            portInfoPtr->ifaSourcePort.portId = hwValue;
            break;
        default:
...
)
{
    ...
    switch(infoType)
    {
        ...
        case CPSS_DXCH_PHA_TARGET_PORT_ENTRY_TYPE_ERSPAN_TYPE_II_E:
            ...
            break;
        case CPSS_DXCH_PHA_TARGET_PORT_ENTRY_TYPE_IFA_E:
            hwValue = portInfoPtr->ifaTargetPort.portId;
            if (hwValue > 0xFFFF )
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE,
                        "IFA Port Index must be in range 0..65535 and not [%d] \n",
    ...
    *infoTypePtr = infoType;
    ...
    switch(infoType)
    {
        ...
        case CPSS_DXCH_PHA_TARGET_PORT_ENTRY_TYPE_ERSPAN_TYPE_II_E:
            ...
            break;
        case CPSS_DXCH_PHA_TARGET_PORT_ENTRY_TYPE_IFA_E:
            portInfoPtr->ifaTargetPort.portId = hwValue;
            break;
        default:
...
)
{
    ...
    erspanIpv6Ptr->hwId                         = U32_GET_FIELD_MAC(dataPtr[10],  20, 6);
...
)
{
    ...
    erspanIpv4Ptr->hwId                         = U32_GET_FIELD_MAC(dataPtr[5],  20, 6);
...
)
{
    ...
    /* ERSPAN HW id bits [25:20] ingress session id bits [19:10], egress session id bits [9:0] */
    dataPtr[10] = (erspanIpv6Ptr->hwId << 20) |
                  (erspanIpv6Ptr->ingressSessionId << 10) |
...
)
{
    ...
    /* ERSPAN HW id bits [25:20] ingress session id bits [19:10], egress session id bits [9:0] */
    dataPtr[5]  = (erspanIpv4Ptr->hwId << 20) |
                  (erspanIpv4Ptr->ingressSessionId << 10) |
...
/**
* @internal buildIfaSharedMemoryTemplate function
* @endinternal
*
* @brief  build 2 words of IFA flow entry from the info
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Ironman.
*
* @param[in] ifaPtr          - (pointer to) the IFA flow entry info.
*
* @param[out] dataPtr[2]     - the 2 words that hold the needed IFA flow entry format for PHA shared memory
*
* @retval GT_OK              - on success
*/
static GT_STATUS buildIfaSharedMemoryTemplate
(
    IN  CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC                      *ifaPtr,
...
)
{
    ...
    /* Check parameter is valid */
    CPSS_DATA_CHECK_MAX_MAC(ifaPtr->ctrl,  BIT_5);

    cpssOsMemSet(&dataPtr[0], 0, sizeof(GT_U32)*PRV_CPSS_DXCH_PPA_THREAD_IFA_CONF_WORDS_CNS);

    /* Check parameter is valid */
    /* dataPtr[0] bits [15:0] : Max Length
     *            bits [31:16]: Sender Handle */
    dataPtr[0] = (ifaPtr->senderHandle << 16) |
                 (ifaPtr->maxLength);

    /* dataPtr[1] bits [7:0]   : Hop Limit
     *            bits [15:8]  : Egress Port
     *            bits [20:16] : Ctrl
     *            bits [22:21] : Rep  */
    dataPtr[1]  = (ifaPtr->hopLimit) |
                  (ifaPtr->egressPort << 8) |
                  (ifaPtr->ctrl << 16) |
                  (ifaPtr->rep << 21);
...
/**
* @internal parseIfaSharedMemoryTemplate function
* @endinternal
*
* @brief  parse 2 words of IFA flow entry from the PHA shared memory info
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Ironman.
*
* @param[in] dataPtr[2]         - the 2 words that hold the needed IFA PHA Shared Memory format
*
* @param[out] ifaPtr            - (pointer to) IFA flow entry info.
*
* @retval GT_OK               - on success
*/
static GT_STATUS parseIfaSharedMemoryTemplate
(
    IN  GT_U32                                                dataPtr[/*2*/],
    OUT CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC                      *ifaPtr
)
{
    GT_U8  value;

    ifaPtr->maxLength                           = U32_GET_FIELD_MAC(dataPtr[0],  0,  16);
    ifaPtr->senderHandle                        = U32_GET_FIELD_MAC(dataPtr[0],  16, 16);

    ifaPtr->hopLimit                            = U32_GET_FIELD_MAC(dataPtr[1],  0,  8);
    ifaPtr->egressPort                          = U32_GET_FIELD_MAC(dataPtr[1],  8,  8);
    ifaPtr->ctrl                                = U32_GET_FIELD_MAC(dataPtr[1],  16, 5);

    value = 0;
    value = U32_GET_FIELD_MAC(dataPtr[1], 21, 2);
    switch(value)
    {
        case 0:
            ifaPtr->rep = CPSS_DXCH_PHA_IFA_REP_TYPE_NONE_E;
        break;

        case 1:
            ifaPtr->rep = CPSS_DXCH_PHA_IFA_REP_TYPE_PORT_E;
        break;

        case 2:
            ifaPtr->rep = CPSS_DXCH_PHA_IFA_REP_TYPE_NEXT_HOP_E;
        break;

        case 3:
            ifaPtr->rep = CPSS_DXCH_PHA_IFA_REP_TYPE_PORT_NEXT_HOP_E;
        break;
...
)
{
    ...
    CPSS_DATA_CHECK_MAX_MAC(erspanPtr->hwId,             BIT_6);
...
)
{
    ...
    if(erspanDevId >= BIT_10)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE,
            "ERSPAN Device id must be in range 0-[%d] and not [%d] \n",
            BIT_10 - 1, erspanDevId);
    }
...
)
{
    ...
    *erspanDevIdPtr = (entryVal >> 16) & 0x3FF;
...
/**
* @internal internal_cpssDxChPhaSharedMemoryIfaEntrySet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChPhaSharedMemoryIfaEntrySet
(
    IN GT_U8                                               devNum,
    IN GT_U32                                              entryId,
...
{
    GT_STATUS                                                           rc = GT_OK;
    GT_U32                                                              PPAThreadsConfWords[PRV_CPSS_DXCH_PPA_THREAD_IFA_CONF_WORDS_CNS];/*shared memory table: 2 words */
    GT_U32                                                              entryIndex;
    GT_U32                                                              iter;
    GT_U32                                                              portMacNum;
    GT_BOOL                                                             isCpuPort;
    CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC                                    ifaEntry;
    ...
    /**************************************/
    PRV_CPSS_DXCH_PHA_LIB_INIT_CHECK_MAC(devNum);
    CPSS_NULL_PTR_CHECK_MAC(ifaEntryPtr);

    /* Only Mode 0 (no replication requested) is supported now.
     * Rest of the modes to be supported in subsequent phases.
     */
    if (ifaEntryPtr->rep > CPSS_DXCH_PHA_IFA_REP_TYPE_NONE_E)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, " Replication Mode requested must be 0 but got[0x%x]",
                                      ifaEntryPtr->rep);
    }
    if(entryId >=PRV_CPSS_DXCH_PHA_THREAD_IFA_FLOW_INDEX_CNS)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM,
            "entry index must be in range 0-511 and not [%d] \n",
            entryId);
    }

    ifaEntry = *ifaEntryPtr;
    /**************************************/
    /* start to :                         */
    /* check validity of INPUT parameters */
    /* and convert to HW values           */
    ...
    if (ifaEntry.egressPort >= PRV_CPSS_DXCH_MAX_PHY_PORT_NUMBER_MAC(devNum))
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE,
            "physical port index must be in range 0-1023 and not [%d] \n",
            ifaEntry.egressPort);
    }
    rc = cpssDxChPortPhysicalPortMapIsCpuGet(devNum, ifaEntry.egressPort, &isCpuPort);
    if(rc != GT_OK || isCpuPort == GT_TRUE)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM,"physical port is a CPU port");
    }
    if(prvCpssDxChPortRemotePortCheck(devNum, ifaEntry.egressPort))
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM,"physical port is not a remote port");
    }
    /* Get Global MAC from physical port using port mapping DB */
    PRV_CPSS_DXCH_PORT_NUM_OR_CPU_PORT_CHECK_AND_MAC_NUM_GET_MAC(devNum,ifaEntry.egressPort,portMacNum);
    ifaEntry.egressPort = portMacNum;

    /* check and build specific info */
    rc = buildIfaSharedMemoryTemplate(&ifaEntry, &PPAThreadsConfWords[0]);
    if(rc != GT_OK)
    {
        return rc;
    }

    entryIndex = PRV_CPSS_DXCH_PPA_THREAD_SHARED_MEMORY_START_INDEX_CNS +
                 (entryId * PRV_CPSS_DXCH_PPA_THREAD_IFA_CONF_WORDS_CNS);

    /* set the entry in shared memory table indexed by the flow index location */
    for(iter = 0; iter < PRV_CPSS_DXCH_PPA_THREAD_IFA_CONF_WORDS_CNS; iter++)
    {
        rc = prvCpssDxChWriteTableEntry(devNum,CPSS_DXCH_SIP6_TABLE_PHA_SHARED_DMEM_E,
            (entryIndex+iter),&PPAThreadsConfWords[iter]);
        if(rc != GT_OK)
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPhaSharedMemoryIfaEntrySet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, entryId , ifaEntryPtr));

    rc = internal_cpssDxChPhaSharedMemoryIfaEntrySet(devNum, entryId , ifaEntryPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, entryId , ifaEntryPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
/**
* @internal internal_cpssDxChPhaSharedMemoryIfaEntryGet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChPhaSharedMemoryIfaEntryGet
(
    IN  GT_U8                                               devNum,
    IN  GT_U32                                              entryId,
...
)
{
    ...
    /* parse HW info to SW info */
    rc = parseIfaSharedMemoryTemplate(&PPAThreadsConfWords[0], ifaEntryPtr);
    /* convert global MAC to local port */
    ppPort = ifaEntryPtr->egressPort;
    prvCpssDxChPortPhysicalPortMapReverseMappingGet(devNum, PRV_CPSS_DXCH_PORT_TYPE_MAC_E, ppPort, &portNum);
    ifaEntryPtr->egressPort = portNum;
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPhaSharedMemoryIfaEntryGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, entryId , ifaEntryPtr));

    rc = internal_cpssDxChPhaSharedMemoryIfaEntryGet(devNum, entryId , ifaEntryPtr);
...
/**
* @internal internal_cpssDxChPhaSharedMemoryEcnCounterGet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE     - on not applicable device
*/
static GT_STATUS internal_cpssDxChPhaSharedMemoryEcnCounterGet
(
    IN  GT_U8                           devNum,
    IN  GT_PHYSICAL_PORT_NUM            portNum,
    IN  GT_U32                          queueNum,
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_AC5X_E | CPSS_AC5P_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_AAS_E);
    PHA_UNIT_CHECK(devNum);
    ...
    /**************************************/
    PRV_CPSS_DXCH_PHA_LIB_INIT_CHECK_MAC(devNum);
    CPSS_NULL_PTR_CHECK_MAC(ecnCountPtr);

    if(portNum >= PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_MAX_PORTS_CNS)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM,
            "port number must be in range 0-%d and not [%d] \n",
            (PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_MAX_PORTS_CNS - 1), portNum);
    }

    if(queueNum >= PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_MAX_QUEUES_CNS)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM,
            "queue number must be in range 0-%d and not [%d] \n",
            (PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_MAX_QUEUES_CNS - 1), queueNum);
    }

    /* For ECN counting, there are number of queues = 8 entries for a port.
     * Therefore, the baseIndex is calculated as portNum * 8 queues.
     * As PHA memory is shared between different threads
     * we must add ECN counting start index to get actual baseIndex.
     * entryIndex will be calculated by adding queueNum with baseIndex.
     */
    baseIndex = (portNum << 3) + PRV_CPSS_DXCH_PHA_SHARED_MEMORY_ECN_COUNTING_START_INDEX_CNS;
    entryIndex = baseIndex + queueNum;
    ...
    /* loop on all port groups to get counter value */
    PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_MAC(devNum, portGroupId)
    {
        ...
        if(rc != GT_OK)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(rc,
                "Failed to get count for portGroupId [%d] and entryIndex [%d] \n",
                portGroupId, entryIndex);
        }

        /* Summarise values from all port groups */
        tempValue.l[0] = entryValue;
        tempResult = prvCpssMathAdd64(tempResult, tempValue);
    }
    PRV_CPSS_GEN_PP_END_LOOP_PORT_GROUPS_MAC(devNum, portGroupId)

    ecnCountPtr->l[0] = tempResult.l[0];
    ecnCountPtr->l[1] = tempResult.l[1];
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPhaSharedMemoryEcnCounterGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portNum, queueNum, ecnCountPtr));

    rc = internal_cpssDxChPhaSharedMemoryEcnCounterGet(devNum, portNum, queueNum, ecnCountPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portNum, queueNum, ecnCountPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
/**
* @internal internal_cpssDxChPhaSharedMemoryEcnCounterReset function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE     - on not applicable device
*/
static GT_STATUS internal_cpssDxChPhaSharedMemoryEcnCounterReset
(
    IN GT_U8                           devNum,
    IN GT_PHYSICAL_PORT_NUM            portNum,
    IN GT_U32                          queueNum
)
{
    ...
    GT_U32                             baseIndex;
    GT_U32                             entryIndex;
    GT_U32                             entryValue = 0; /* To reset counter */
    ...
    if(rc != GT_OK)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(rc, "Failed to reset count for entryIndex [%d] \n", entryIndex);
    }
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPhaSharedMemoryEcnCounterReset);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portNum, queueNum));

    rc = internal_cpssDxChPhaSharedMemoryEcnCounterReset(devNum, portNum, queueNum);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portNum, queueNum));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);

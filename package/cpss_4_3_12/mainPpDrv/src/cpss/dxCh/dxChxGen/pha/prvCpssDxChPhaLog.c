...
const char * const prvCpssLogEnum_CPSS_DXCH_PHA_IFA_REP_TYPE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_PHA_IFA_REP_TYPE_ENT);
const char * const prvCpssLogEnum_CPSS_DXCH_PHA_RE_TRAP_MODE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_PHA_RE_TRAP_MODE_ENT);
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxLength);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, senderHandle);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, hopLimit);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, ctrl);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, rep, CPSS_DXCH_PHA_IFA_REP_TYPE_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, egressPort);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, ifaSourcePort, CPSS_DXCH_PHA_PORT_ENTRY_TYPE_IFA_PORT_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, rawFormat);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, erspanSameDevMirror, CPSS_DXCH_PHA_PORT_ENTRY_TYPE_ERSPAN_SAME_DEV_MIRROR_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, ifaTargetPort, CPSS_DXCH_PHA_PORT_ENTRY_TYPE_IFA_PORT_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, enhancedSflow, CPSS_DXCH_PHA_THREAD_INFO_TYPE_ENHANCED_SFLOW_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, ifaEgressNodeMirror, CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_EGRESS_NODE_MIRROR_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, ifaHeader, CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_HEADER_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, ifaMetadata, CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_METADATA_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, clearOutgoingMtagCmd, CPSS_DXCH_PHA_THREAD_INFO_TYPE_CLEAR_OUTGOING_MTAG_COMMAND_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, copyFlowIdToTrgPhyPort, CPSS_DXCH_PHA_THREAD_INFO_TYPE_COPY_FLOW_ID_TO_TRG_PHY_PORT_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, mplsLsrInStackingSystem, CPSS_DXCH_PHA_THREAD_INFO_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, hwId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PHA_PORT_ENTRY_TYPE_IFA_PORT_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PHA_PORT_ENTRY_TYPE_IFA_PORT_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, portId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PHA_THREAD_INFO_TYPE_CLEAR_OUTGOING_MTAG_COMMAND_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PHA_THREAD_INFO_TYPE_CLEAR_OUTGOING_MTAG_COMMAND_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, reTrapMode, CPSS_DXCH_PHA_RE_TRAP_MODE_ENT);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_PHA_THREAD_INFO_TYPE_COPY_FLOW_ID_TO_TRG_PHY_PORT_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PHA_THREAD_INFO_TYPE_COPY_FLOW_ID_TO_TRG_PHY_PORT_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, reTrapMode, CPSS_DXCH_PHA_RE_TRAP_MODE_ENT);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_PHA_THREAD_INFO_TYPE_ENHANCED_SFLOW_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PHA_THREAD_INFO_TYPE_ENHANCED_SFLOW_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, srcModId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_EGRESS_NODE_MIRROR_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_EGRESS_NODE_MIRROR_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, ifaAnalyzerIndex);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_HEADER_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_HEADER_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, flags);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, telemetryRequestVector);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, telemetryActionVector);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, probeMarker1);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, probeMarker2);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_METADATA_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PHA_THREAD_INFO_TYPE_IFA_METADATA_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, deviceId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PHA_THREAD_INFO_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PHA_THREAD_INFO_TYPE_MPLS_LSR_IN_STACKING_SYSTEM_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, ownHwDevNum);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, targetDevSelectBit);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFunc_CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC_PTR_ifaEntryPtr = {
     "ifaEntryPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_entryId = {
     "entryId", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC_PTR_ifaEntryPtr = {
     "ifaEntryPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U64_PTR_ecnCountPtr = {
     "ecnCountPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U64)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPhaSharedMemoryEcnCounterReset_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U32_queueNum
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPhaSharedMemoryEcnCounterGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U32_queueNum,
    &DX_OUT_GT_U64_PTR_ecnCountPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPhaSharedMemoryIfaEntrySet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_entryId,
    &DX_IN_CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC_PTR_ifaEntryPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPhaSharedMemoryIfaEntryGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_entryId,
    &DX_OUT_CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC_PTR_ifaEntryPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPhaLogLibDb[] = {
    ...
    {"cpssDxChPhaSharedMemoryIfaEntrySet", 3, cpssDxChPhaSharedMemoryIfaEntrySet_PARAMS, NULL},
    {"cpssDxChPhaSharedMemoryIfaEntryGet", 3, cpssDxChPhaSharedMemoryIfaEntryGet_PARAMS, NULL},
    {"cpssDxChPhaSharedMemoryEcnCounterGet", 4, cpssDxChPhaSharedMemoryEcnCounterGet_PARAMS, NULL},
    {"cpssDxChPhaSharedMemoryEcnCounterReset", 3, cpssDxChPhaSharedMemoryEcnCounterReset_PARAMS, NULL},
};

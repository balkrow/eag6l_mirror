...
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_DXCH_PAIR_READ_WRITE_FORM_ENT[]  =
{PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_PAIR_READ_WRITE_FIRST_ONLY_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_PAIR_READ_WRITE_SECOND_NEXT_POINTER_ONLY_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_PAIR_READ_WRITE_WHOLE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_PAIR_READ_WRITE_SECOND_ONLY_E)
};
PRV_CPSS_LOG_STC_ENUM_MAP_ARRAY_SIZE_MAC(CPSS_DXCH_PAIR_READ_WRITE_FORM_ENT);
...
const char * const prvCpssLogEnum_CPSS_DXCH_GENERIC_RANGE_PROFILE_MODE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_GENERIC_RANGE_PROFILE_MODE_ENT);
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_GENERIC_CLASSIFICATION_PARAMS_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, mask, CPSS_DXCH_MAX_LOOKUP_CNS*2, GT_U8);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, lsbLocation, CPSS_DXCH_MAX_LOOKUP_CNS, GT_U32);
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_GENERIC_RANGE_CLASSIFICATION_PARAMS_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, valid);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, lookupIndex);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, profileMode, CPSS_DXCH_GENERIC_RANGE_PROFILE_MODE_ENT);
    ...
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, matchId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_GENERIC_CLASSIFICATION_PARAMS_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_GENERIC_CLASSIFICATION_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_GENERIC_RANGE_CLASSIFICATION_PARAMS_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_GENERIC_RANGE_CLASSIFICATION_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
)
{
    ...
    PRV_CPSS_LOG_ENUM_MAP_MAC(namePtr, paramVal, CPSS_DXCH_PAIR_READ_WRITE_FORM_ENT);
}

...
typedef enum
{
    ...
    ,PRV_CPSS_DXCH_AAS_E              /* AAS - single tile */
    ,PRV_CPSS_DXCH_AAS_2_TILES_E      /* AAS - dual   tile */
    ...
    *ppPtr = PRV_CPSS_DXCH_INVALID_E;
    switch (pDev->genInfo.devFamily)
    {
        ...
        case  CPSS_PP_FAMILY_DXCH_AAS_E:
             *ppPtr =  PRV_CPSS_PP_MAC(devNum)->multiPipe.numOfTiles == 2 ?
                PRV_CPSS_DXCH_AAS_2_TILES_E : PRV_CPSS_DXCH_AAS_E;
             return GT_OK;
        default:
        {
            *ppPtr = PRV_CPSS_DXCH_INVALID_E;
...
#define _1_TILE_UNITS_OFFSET       (PRV_CPSS_DXCH_UNIT_DISTANCE_BETWEEN_TILES_CNS)
/* AAS 2 tiles : smi0,1 are in tile 0 and smi2,3 are in tile 1 */
#define AAS_4_SMI_UNITS_MAC      PRV_CPSS_DXCH_UNIT_SMI_0_E,PRV_CPSS_DXCH_UNIT_SMI_1_E, \
                                    PRV_CPSS_DXCH_UNIT_SMI_0_E+_1_TILE_UNITS_OFFSET,PRV_CPSS_DXCH_UNIT_SMI_1_E+_1_TILE_UNITS_OFFSET,PRV_CPSS_DXCH_UNIT_LAST_E
...
static const PRV_CPSS_DXCH_PP_SMI_INFO_STC prvCpssSMIInfoArr[] =
{
    ...
    ,{ PRV_CPSS_DXCH_AAS_E,         { 2,          { 0,1,     (GT_U32)CPSS_PHY_SMI_INTERFACE_INVALID_E }, { 0,1 ,    (GT_U32)CPSS_PHY_SMI_INTERFACE_INVALID_E } , {STANDARD_2_SMI_UNITS_MAC}}}
    ,{ PRV_CPSS_DXCH_AAS_2_TILES_E, { 4,          { 0,1,2,3, (GT_U32)CPSS_PHY_SMI_INTERFACE_INVALID_E }, { 0,1,2,3, (GT_U32)CPSS_PHY_SMI_INTERFACE_INVALID_E } ,  {AAS_4_SMI_UNITS_MAC }}}
    ...
    if(PRV_CPSS_SIP_5_CHECK_MAC(devNum))
    {
        if(PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.gop_lms.notSupported == GT_TRUE)
        {
            switch(PRV_CPSS_PP_MAC(devNum)->devFamily)
            {
                ...
                break;
                default:/* All other sip5,6,7 devices */
                    regStructBaseAdr = (GT_U32*)(&regsAddrVer1->GOP.SMI[instance]);
                    drvPtr = &prv_dxCh_BobK_SMI.genDrv;
                break;
            }

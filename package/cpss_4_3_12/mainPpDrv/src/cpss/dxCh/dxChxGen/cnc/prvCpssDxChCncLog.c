...
const char * const prvCpssLogEnum_CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT);
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, clientEnable);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, clientSelect, CPSS_DXCH_CNC_CLIENT_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, clientOffset);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, indexRangesBmp, GT_U64);
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DMA_QUEUE_CFG_STC_PTR_cncCfgPtr = {
     "cncCfgPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DMA_QUEUE_CFG_STC)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC_PTR_clientsConfigPtr = {
     "clientsConfigPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT_indexMode = {
     "indexMode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_clientIndex = {
     "clientIndex", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_cncUnitId = {
     "cncUnitId", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC_PTR_clientsConfigPtr = {
     "clientsConfigPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT_PTR_indexModePtr = {
     "indexModePtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChCncEgressPacketTypePassDropClientIndexModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT_indexMode
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChCncBlockSharedClientConfigSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_blockNum,
    &DX_IN_GT_U32_clientIndex,
    &DX_IN_CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC_PTR_clientsConfigPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChCncBlockSharedClientConfigGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_blockNum,
    &DX_IN_GT_U32_clientIndex,
    &DX_OUT_CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC_PTR_clientsConfigPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChCncUploadInit_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_cncUnitId,
    &DX_IN_CPSS_DMA_QUEUE_CFG_STC_PTR_cncCfgPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChCncEgressPacketTypePassDropClientIndexModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT_PTR_indexModePtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChCncLogLibDb[] = {
    ...
    {"cpssDxChCncBlockSharedClientConfigSet", 4, cpssDxChCncBlockSharedClientConfigSet_PARAMS, NULL},
    {"cpssDxChCncBlockSharedClientConfigGet", 4, cpssDxChCncBlockSharedClientConfigGet_PARAMS, NULL},
    {"cpssDxChCncEgressPacketTypePassDropClientIndexModeSet", 2, cpssDxChCncEgressPacketTypePassDropClientIndexModeSet_PARAMS, NULL},
    {"cpssDxChCncEgressPacketTypePassDropClientIndexModeGet", 2, cpssDxChCncEgressPacketTypePassDropClientIndexModeGet_PARAMS, NULL},
    {"cpssDxChCncUploadInit", 3, cpssDxChCncUploadInit_PARAMS, NULL},
};

...
#define PRV_CPSS_DXCH_CNC_BLOCK_SHARED_CLIENT_CNS 3
...
)
{
    ...
    trgCounterPtr->packetCount =
        prvCpssMathAdd64(
            trgCounterPtr->packetCount, addCounter2Ptr->packetCount);

    trgCounterPtr->byteCount =
        prvCpssMathAdd64(
            trgCounterPtr->byteCount, addCounter2Ptr->byteCount);
    if ( format == CPSS_DXCH_CNC_COUNTER_FORMAT_MODE_5_E)
    {
        trgCounterPtr->maxValue =
            ((prvCpssMathCompare64(trgCounterPtr->maxValue, addCounter2Ptr->maxValue) > 0)
                 ? trgCounterPtr->maxValue : addCounter2Ptr->maxValue);
    }
...
)
{
        ...
        devNum, portGroupsBmp, portGroupId)
    {
        ...
        /* add values of counter into counterPtr */
...
)
{
    ...
    /* sip7 : map 'application CNC blockIndex' to actual HW block index                 */
    if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        GT_U32  blockNum_afterMapping;/* allow MACRO LESS_CHECK_MAC to pring error on
            'blockNum_afterMapping' instead of blockNum , so 'CPSS ERROR LOG' will give
            clear error */
        /* check validity to access the array */
        LESS_CHECK_MAC(blockNum,64);
        blockNum_afterMapping = PRV_CPSS_DXCH_PP_HW_INFO_CNC_MAC(devNum).sip7_cnc_mapToActualBlocksUsed[blockNum];
        /* check validity that the CNC block was mapped to actual memory (0..63) and not GT_NA or other 'error' */
        LESS_CHECK_MAC(blockNum_afterMapping,64);

        blockNum = blockNum_afterMapping;
    }
...
/**
* @struct CLIENT_HW_INDEX_TO_ENUM_STC
 *
 * @brief The correlation between HW index to the SW client enum .
*/
typedef struct{
    /** the HW index of the client */
    GT_U32                      hwIndex;
    /** the SW enum value of the client */
    CPSS_DXCH_CNC_CLIENT_ENT    client;
}CLIENT_HW_INDEX_TO_ENUM_STC;
/** Ironman (sip6.30) : correlation between HW index to the SW client enum */
static const CLIENT_HW_INDEX_TO_ENUM_STC sip_6_30_client_HwIndexToEnum[] =
{
     { 0  ,CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_0_E                        }
    ,{ 1  ,CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_1_E                        }
    ,{ 2  ,CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_0_E       }
    ,{ 3  ,CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_1_E       }
    ,{ 4  ,CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_0_E       }
    ,{ 5  ,CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_1_E       }
    ,{ 6  ,CPSS_DXCH_CNC_CLIENT_EGRESS_VLAN_EGRESS_FILTER_PASS_DROP_E   }
    ,{ 7  ,CPSS_DXCH_CNC_CLIENT_L2L3_INGRESS_VLAN_E                     }
    ,{ 8  ,CPSS_DXCH_CNC_CLIENT_INGRESS_SRC_EPORT_E                     }
    ,{ 9  ,CPSS_DXCH_CNC_CLIENT_INGRESS_VLAN_PASS_DROP_E                }
    ,{10  ,CPSS_DXCH_CNC_CLIENT_PACKET_TYPE_PASS_DROP_E                 }
    ,{11  ,CPSS_DXCH_CNC_CLIENT_EGRESS_VLAN_PASS_DROP_E                 }
    ,{12  ,CPSS_DXCH_CNC_CLIENT_EGRESS_QUEUE_PASS_DROP_E                }
    ,{13  ,CPSS_DXCH_CNC_CLIENT_ARP_TABLE_ACCESS_E                      }
    ,{14  ,CPSS_DXCH_CNC_CLIENT_TUNNEL_START_E                          }
    ,{15  ,CPSS_DXCH_CNC_CLIENT_EGRESS_TRG_EPORT_E                      }
    ,{16  ,CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_0_E                 }
    ,{17  ,CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_1_E                 }
    ,{18  ,CPSS_DXCH_CNC_CLIENT_EGRESS_PACKET_TYPE_PASS_DROP_E          }
    ,{30  ,CPSS_DXCH_CNC_CLIENT_QUEUE_STAT_E                            }
    ,{31  ,CPSS_DXCH_CNC_CLIENT_PORT_STAT_E                             }

    ,{GT_NA,CPSS_DXCH_CNC_CLIENT_LAST_E} /* must be last */
};

/** AAS (sip7) : correlation between HW index to the SW client enum */
static const CLIENT_HW_INDEX_TO_ENUM_STC sip_7_client_HwIndexToEnum[] =
{
     {0    , CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_0_E                      }
    ,{1    , CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_1_E                      }
    ,{2    , CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_2_E                      }
    ,{3    , CPSS_DXCH_CNC_CLIENT_TTI_PARALLEL_3_E                      }
    ,{7    , CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_0_E     }
    ,{8    , CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_1_E     }
    ,{9    , CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_2_E     }
    ,{10   , CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_PARALLEL_3_E     }
    ,{11   , CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_0_E     }
    ,{12   , CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_1_E     }
    ,{13   , CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_2_E     }
    ,{14   , CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_3_E     }
    ,{28   , CPSS_DXCH_CNC_CLIENT_EGRESS_VLAN_EGRESS_FILTER_PASS_DROP_E }
    ,{24   , CPSS_DXCH_CNC_CLIENT_L2L3_INGRESS_VLAN_E                   }
    ,{23   , CPSS_DXCH_CNC_CLIENT_INGRESS_SRC_EPORT_E                   }
    ,{26   , CPSS_DXCH_CNC_CLIENT_INGRESS_VLAN_PASS_DROP_E              }
    ,{25   , CPSS_DXCH_CNC_CLIENT_PACKET_TYPE_PASS_DROP_E               }
    ,{31   , CPSS_DXCH_CNC_CLIENT_EGRESS_VLAN_PASS_DROP_E               }
    ,{32   , CPSS_DXCH_CNC_CLIENT_EGRESS_QUEUE_PASS_DROP_E              }
    ,{37   , CPSS_DXCH_CNC_CLIENT_ARP_TABLE_ACCESS_E                    }
    ,{35   , CPSS_DXCH_CNC_CLIENT_TUNNEL_START_E                        }
    ,{36   , CPSS_DXCH_CNC_CLIENT_EGRESS_TRG_EPORT_E                    }
    ,{19   , CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_0_E               }
    ,{20   , CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_1_E               }
    ,{21   , CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_2_E               }
    ,{22   , CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_3_E               }
    ,{41   , CPSS_DXCH_CNC_CLIENT_EGRESS_PACKET_TYPE_PASS_DROP_E        }
    ,{29   , CPSS_DXCH_CNC_CLIENT_QUEUE_STAT_E                          }
    ,{30   , CPSS_DXCH_CNC_CLIENT_PORT_STAT_E                           }
    ,{40   , CPSS_DXCH_CNC_CLIENT_PHA_E                                 }
...
{
    GT_U32  ii;
    const CLIENT_HW_INDEX_TO_ENUM_STC *infoPtr;

    if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        infoPtr =  sip_7_client_HwIndexToEnum;
    }
    else
    {
        infoPtr =  sip_6_30_client_HwIndexToEnum;
    }
    ...
    switch(client)
    {
        ...
        case CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_0_1_E:
            client = CPSS_DXCH_CNC_CLIENT_INGRESS_PCL_LOOKUP_1_PARALLEL_0_E;
            break;
        case CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_E:
            client = CPSS_DXCH_CNC_CLIENT_EGRESS_PCL_PARALLEL_0_E;
            break;
        default:
            break;
    }
    ...
    for(ii = 0; infoPtr[ii].hwIndex != GT_NA; ii++)
    {
        if(infoPtr[ii].client == client)
        {
            *clientIdPtr = infoPtr[ii].hwIndex;
            return GT_OK;
        }
    }

    CPSS_LOG_ERROR_AND_RETURN_ON_ENUM_MAC(client);

}

/**
* @internal sip_6_30_ClientIndexToClientEnum function
* @endinternal
*
* @brief   sip_6_30: The function returns client enum for client index.
*
* @note   APPLICABLE DEVICES:      Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier.
*
* @param[in]  clientId                - client index
* @param[out] clientPtr               - (pointer to) CNC client
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameters
*/
static GT_STATUS sip_6_30_ClientIndexToClientEnum
(
    IN    GT_U8                     devNum,
    IN    GT_U32                    clientId,
    OUT   CPSS_DXCH_CNC_CLIENT_ENT  *clientPtr
)
{
    GT_U32  ii;
    const CLIENT_HW_INDEX_TO_ENUM_STC *infoPtr;
    ...
    for(ii = 0; infoPtr[ii].hwIndex != GT_NA; ii++)
    {
        if(infoPtr[ii].hwIndex == clientId)
        {
            *clientPtr = infoPtr[ii].client;
            return GT_OK;
        }
    }

    CPSS_LOG_ERROR_AND_RETURN_ON_ENUM_MAC(clientId);
}
...
)
{
    ...
    GT_U32      hwClientMask = PRV_CPSS_SIP_7_CHECK_MAC(devNum) ? 0x3F/*64 clients*/ : 0x1F/*31 clients*/;
    ...
    {
        rc = sip_6_30_BlockClientToBitMask(devNum,client,&hwClient);
        if(rc != GT_OK)
        {
            return rc;
        }
        ...
        for(clientIndex = 0 ;clientIndex < 3; clientIndex++)
        {
            ...
            if(((value >> 4) & hwClientMask) == hwClient)
            {
                /* we have a match */
...
)
{
    ...
    if (PRV_CPSS_SIP_5_CHECK_MAC(devNum) == GT_TRUE)
    {
        ...
        {
            numOfBits = PRV_CPSS_SIP_7_CHECK_MAC(devNum) ? 4 : 3; /* 4 or 3 bits each field */
...
*                                      NOTE: this is array of 2 GT_U32 in next devices:
...
)
{
    ...
    *numOfCounterValuesPtr = 0;
    ...
    for (ii = 0; (ii < cncMaxCnt); ii++)
    {
        ...
        /* add values of cuppPortGroupCounter into counterValuesPtr[ii] */
        rc = prvCpssDxChCncCountersAdd(devNum,format,
            &counterValuesPtr[ii],
            &cuppPortGroupCounter);
        if (rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    if (descCtrlPtr->blockSize == 0)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_NOT_INITIALIZED, "CNC upload queue not initialized");
    }
...
)
{
    ...
    switch (cncUnit)
    {
        case CPSS_DXCH_CNC_COUNTING_ENABLE_UNIT_TTI_E:
            if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                regAddr = PRV_DXCH_REG1_UNIT_TTI_LU_MAC(devNum).generalRegs.ttiLuGlobalConfig;
                bitOffset = 25;
            }
            else if(PRV_CPSS_SIP_5_CHECK_MAC(devNum) == GT_TRUE)
            {
...
)
{
    ...
    if (PRV_CPSS_SIP_5_CHECK_MAC(devNum) == GT_TRUE)
    {
        ...
        if (PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
        {
            ...
            {
                data = 1 | (clientId << 4)/*bits 4..8 or 4..9 in SIP7 */;
            }
...
)
{
    ...
    if (PRV_CPSS_SIP_5_CHECK_MAC(devNum) == GT_TRUE)
    {
        ...
        if (PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
        {
            ...
            clientIdMask = PRV_CPSS_SIP_7_CHECK_MAC(devNum) ? 0x3f : 0x1f;

            *updateEnablePtr = ((data & 1) == 0) ? GT_FALSE : GT_TRUE;
            read_clientId    = (data >> 4) & clientIdMask; /*bits 4..8 or 4..9 in SIP7*/
...
)
{
    ...
    *indexNumPtr = 0;
    ...
    if (PRV_CPSS_SIP_5_CHECK_MAC(devNum) == GT_TRUE)
    {
        /* convert blockNum to CNC Unit and block inside unit. */
        if (GT_OK != prvCpssDxChCncMultiUnitsBlockUnitGet(
            devNum, blockNum, &unitNum, &blockInUnit))
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
            ...
            devNum, portGroupsBmp, portGroupId)
        {
            ...
            {
                /* The wraparound status is managed by internal FIFO in AC5P, AC5X, Harrier.
                   Access to the FIFO is done by single register per CNC block. */
                regAddr = PRV_DXCH_REG1_UNIT_CNC_MAC(devNum, unitNum).perBlockRegs.
                        wraparound.CNCBlockWraparoundStatusReg[blockInUnit][0];

                /* limit loop by size of output arrays */
                for (i = 0; i < maxIndexes; i++)
                {
                    ...
                    indexesArr[*indexNumPtr] = (data >> 1) & 0x03FF;
            ...
            {
                mask = PRV_CPSS_SIP_7_CHECK_MAC(devNum) ? 0x7FFF :0x0FFF;
                ...
                for (i = 0; (i < 4); i++)
                {
                    ...
                    for (j = 0; (j < 2); j++, data = (data >> 16))
                    {
                        if (data & 1)
                        {
                            indexesArr[*indexNumPtr] = (data >> 1) & mask;
                            if (portGroupIdArr != NULL)
                            {
                                portGroupIdArr[*indexNumPtr] = portGroupId;
                            }
...
/**
* @internal cncSelectorSet function
* @endinternal
*
...
*
*/
static GT_STATUS cncSelectorSet
(
    IN  GT_U8                       devNum,
    IN  GT_PORT_GROUPS_BMP          portGroupsBmp,
    IN  GT_U32                      blockNum
...
)
{
    ...
    /* the feature needs separated AU and FU message queues */
    if (PRV_CPSS_DXCH_PP_MAC(devNum)->moduleCfg.fuqUseSeparate
    ...
    if(PRV_CPSS_DXCH_GDMA_SUPPORTED_MAC(devNum))
    {
        ...
        rc = cpssDxChCncPortGroupCounterFormatGet(devNum, portGroupsBmp,
            blockNum, &format);
        if (rc != GT_OK)
        {
            return rc;
        ...
        /* there is no sharing between the FDB upload operation and the CNC dump operation */
        /* let the GDMA logic to check the ability to trigger new dump on the unit         */
        rc = prvCpssDxChGdmaCncBeforeDumpTrigger(devNum,
            portGroupsBmp,inProcessBlocksBmp,format,unitNum);
        if (rc != GT_OK)
        {
            return rc;
        }

        /* loop on all port groups to set the configuration */
        PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_IN_BMP_MAC(
            devNum, portGroupsBmp, portGroupId)
        {
    ...
    rc = cncSelectorSet(devNum,portGroupsBmp,blockNum);
    if(rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    if(PRV_CPSS_DXCH_GDMA_SUPPORTED_MAC(devNum))
    {
        return prvCpssDxChGdmaCncUploadedBlockGet(devNum,portGroupsBmp,
            numOfCounterValuesPtr,format,counterValuesPtr);
    }
...
)
{
    ...
    {
        PRV_CPSS_DXCH_SIP_7_QUEUE_DROP_PROFILE_CHECK_MAC(profileSet);
...
)
{
    ...
    SIP6_PREQ_PORT_PROFILE_FIELD_SET_MAC(devNum,regData,SIP6_PREQ_PORT_PROFILE_TABLE_FIELDS_PORT_STATUS_LIMIT_E,portLimit);
...
)
{
    ...
    SIP6_PREQ_PORT_PROFILE_FIELD_GET_MAC(devNum,regData,SIP6_PREQ_PORT_PROFILE_TABLE_FIELDS_PORT_STATUS_LIMIT_E,*portLimitPtr);
...
/**
* @internal internal_cpssDxChCncBlockSharedClientConfigSet function
* @endinternal
*
* @brief   The function binds/unbinds the selected shared client to/from a counter block.
*
* @note   APPLICABLE DEVICES:      Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier.
*
...
* @param[in] blockNum                 - CNC block number
*                                      valid range see in datasheet of specific device.
* @param[in] clientIndex              - CNC shared client index
*                                       (APPLICABLE RANGES: 0..2)
* @param[in] clientsConfigPtr         -(pointer to) CNC block shared clients configiration
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameters
* @retval GT_HW_ERROR              - on hardware error
* @retval GT_OUT_OF_RANGE          - on out off range CNC shared client offset
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*
*/
static GT_STATUS internal_cpssDxChCncBlockSharedClientConfigSet
(
    IN  GT_U8                                          devNum,
    IN  GT_U32                                         blockNum,
    IN  GT_U32                                         clientIndex,
    IN  CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC *clientsConfigPtr
)
{
    GT_BOOL   clientEnable; /* flag to denote cnc shared client enable status */
    GT_U32    hwClient;     /* hw client id for the cnc client                */
    GT_U32    unitNum;      /* cnc unit instance                              */
    GT_U32    blockInUnit;  /* cnc block number                               */
    GT_U32    regAddr1;     /* register1 address of the unit                  */
    GT_U32    regAddr2;     /* register2 address of the unit                  */
    ...
    PRV_CPSS_DXCH_CNC_BLOCK_INDEX_VALID_CHECK_MAC(devNum, blockNum);
    CPSS_NULL_PTR_CHECK_MAC(clientsConfigPtr);
    if(clientIndex >= PRV_CPSS_DXCH_CNC_BLOCK_SHARED_CLIENT_CNS)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    ...
    regAddr1 = PRV_DXCH_REG1_UNIT_CNC_MAC(devNum, unitNum).perBlockRegs.
              clientEnable.CNCBlockConfigReg0[blockInUnit][clientIndex];

    clientEnable = BOOL2BIT_MAC(clientsConfigPtr->clientEnable);
    /* CNC block shared client register description:
     * clientEnable [1:0] | hwClient [8:4] | clientOffset [25:16]
     */
    rc = prvCpssHwPpSetRegField(devNum, regAddr1, 0, 1, clientEnable);
    if(rc != GT_OK)
    {
        return rc;
    }
    ...
    if(clientEnable == 1)
    {
        if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            if(clientsConfigPtr->clientOffset >= BIT_13)/* in 128 bits mode only 12 bits used */
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, LOG_ERROR_NO_MSG);
            }
        }
        else
        if(clientsConfigPtr->clientOffset >= BIT_10)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, LOG_ERROR_NO_MSG);
        }

        rc = sip_6_30_BlockClientToBitMask(devNum,clientsConfigPtr->clientSelect, &hwClient);
        if(rc != GT_OK)
        {
            return rc;
        }

        rc = prvCpssHwPpSetRegField(devNum, regAddr1, 4, PRV_CPSS_SIP_7_CHECK_MAC(devNum) ? 6 : 5, hwClient);
        if(rc != GT_OK)
        {
            return rc;
        }

        rc = prvCpssHwPpSetRegField(devNum, regAddr1, 16, PRV_CPSS_SIP_7_CHECK_MAC(devNum) ? 13 : 10, clientsConfigPtr->clientOffset);
        if(rc != GT_OK)
        {
            return rc;
        }
        /* enable to update indexes
         * [(x+32*%i)*1024] to [(x+1+32*%i)*(1024)-1]
         * where x is 32 bits
         */
        for (i = 0; (i < 2); i++)
        {
            regAddr2 = PRV_DXCH_REG1_UNIT_CNC_MAC(devNum, unitNum).perBlockRegs.
                rangeCount.CNCBlockRangeCountEnable[i][blockInUnit][clientIndex];

            rc   = prvCpssHwPpWriteRegister(devNum, regAddr2, clientsConfigPtr->indexRangesBmp.l[i]);
            if(rc != GT_OK)
            {
                return rc;
            }
    ...
    else /* CNC shared client disable mode */
    {
        /* if CNC shared client is disabled at the respective index then other
         * fields have no meaning as CNC does not process them.
         */
        rc = prvCpssHwPpSetRegField(devNum, regAddr1, 4, 5, 0/* cnc hw client */);
        if(rc != GT_OK)
        {
            return rc;
        }
        rc = prvCpssHwPpSetRegField(devNum, regAddr1, 16, 10, 0/* client offset */);
        if(rc != GT_OK)
        {
            return rc;
        }
        for (i = 0; (i < 2); i++)
        {
            ...
            rc   = prvCpssHwPpWriteRegister(devNum, regAddr2, 0);
            if(rc != GT_OK)
            {
                return rc;
            }
...
/**
* @internal cpssDxChCncBlockSharedClientConfigSet function
* @endinternal
*
* @brief   The function binds/unbinds the selected shared client to/from a counter block.
*
...
*
*/
GT_STATUS cpssDxChCncBlockSharedClientConfigSet
(
    IN  GT_U8                                          devNum,
    IN  GT_U32                                         blockNum,
    IN  GT_U32                                         clientIndex,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChCncBlockSharedClientConfigSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, blockNum, clientIndex, clientsConfigPtr));

    rc = internal_cpssDxChCncBlockSharedClientConfigSet(devNum, blockNum, clientIndex, clientsConfigPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, blockNum, clientIndex, clientsConfigPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
/**
* @internal internal_cpssDxChCncBlockSharedClientConfigGet function
* @endinternal
*
* @brief   The function gets bind/unbind of the selected shared client to a counter block.
*
* @note   APPLICABLE DEVICES:      Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier.
*
...
* @param[in] clientIndex              - CNC shared client index
*                                       (APPLICABLE RANGES: 0..2)
* @param[out] clientsConfigPtr        - (pointer to) CNC block shared clients configiration
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameters
* @retval GT_HW_ERROR              - on hardware error
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChCncBlockSharedClientConfigGet
(
    IN  GT_U8                                          devNum,
    IN  GT_U32                                         blockNum,
    IN  GT_U32                                         clientIndex,
    OUT CPSS_DXCH_CNC_BLOCK_SHARED_CLIENTS_CONFIG_STC *clientsConfigPtr
)
{
    GT_U32                   unitNum;      /* cnc unit instance                              */
    GT_U32                   blockInUnit;  /* cnc block number                               */
    GT_U32                   regAddr;      /* register address of the unit                   */
    GT_U32                   data;         /* register data                                  */
    GT_U32                   i;            /* loop iterator                                  */
    GT_STATUS                rc = GT_OK;   /* return code                                    */
    GT_U32                   hwClientMask; /* HW client mask (mask on num of bits needed)    */
    ...
    hwClientMask = PRV_CPSS_SIP_7_CHECK_MAC(devNum) ? 0x3F/*64 clients*/ : 0x1F/*31 clients*/;
    ...
    cpssOsMemSet(clientsConfigPtr,0,sizeof(*clientsConfigPtr));
    ...
    clientsConfigPtr->clientEnable = ((data & 1) == 0) ? GT_FALSE : GT_TRUE;
    rc = sip_6_30_ClientIndexToClientEnum(devNum,((data >> 4) & hwClientMask), &(clientsConfigPtr->clientSelect));
    if(rc != GT_OK)
    {
        return rc;
    }
    clientsConfigPtr->clientOffset = (PRV_CPSS_SIP_7_CHECK_MAC(devNum) ? ((data >> 16) & 0x1FFF) : ((data >> 16) & 0x3FF));
    ...
    for (i = 0; (i < 2); i++)
    {
        ...
        rc   = prvCpssHwPpReadRegister(devNum, regAddr, &(clientsConfigPtr->indexRangesBmp.l[i]));
        if(rc != GT_OK)
        {
            return rc;
        }
...
/**
* @internal cpssDxChCncBlockSharedClientConfigGet function
* @endinternal
*
* @brief   The function gets bind/unbind of the selected shared client to a counter block.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChCncBlockSharedClientConfigGet
(
    IN  GT_U8                                          devNum,
    IN  GT_U32                                         blockNum,
    IN  GT_U32                                         clientIndex,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChCncBlockSharedClientConfigGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, blockNum, clientIndex, clientsConfigPtr));

    rc = internal_cpssDxChCncBlockSharedClientConfigGet(devNum, blockNum, clientIndex, clientsConfigPtr);
...
/**
* @internal internal_cpssDxChCncEgressPacketTypePassDropClientIndexModeSet function
* @endinternal
*
* @brief   The function sets CNC index mode for Egress Packet Type Pass/Drop CNC client.
*
* @note   APPLICABLE DEVICES:      Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier.
*
* @param[in] devNum                   - device number
* @param[in] indexMode                - index mode
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameters
* @retval GT_HW_ERROR              - on hardware error
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChCncEgressPacketTypePassDropClientIndexModeSet
(
    IN  GT_U8                                                     devNum,
    IN  CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT    indexMode
)
{
    GT_U32 data;             /* data              */
    GT_U32 regAddr;          /* register address  */
    ...
    switch (indexMode)
    {
        case CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CMD_AND_CODE_E:
            data = 0;
            break;
        case CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CODE_ONLY_E:
            data = 1;
            break;
        default: CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
/**
* @internal cpssDxChCncEgressPacketTypePassDropClientIndexModeSet function
* @endinternal
*
* @brief   The function sets CNC index mode for Egress Packet Type Pass/Drop CNC client.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChCncEgressPacketTypePassDropClientIndexModeSet
(
    IN  GT_U8                                                     devNum,
    IN  CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT    indexMode
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChCncEgressPacketTypePassDropClientIndexModeSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, indexMode));

    rc = internal_cpssDxChCncEgressPacketTypePassDropClientIndexModeSet(devNum, indexMode);
...
/**
* @internal internal_cpssDxChCncEgressPacketTypePassDropClientIndexModeGet function
* @endinternal
*
* @brief   The function gets CNC index mode for Egress Packet Type Pass/Drop CNC client.
*
* @note   APPLICABLE DEVICES:      Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier.
*
* @param[in] devNum                   - device number
*
* @param[out] indexModePtr            - (pointer to)index mode
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameters
* @retval GT_BAD_PTR               - on null pointer
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChCncEgressPacketTypePassDropClientIndexModeGet
(
    IN   GT_U8                                                     devNum,
    OUT  CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT   *indexModePtr
)
{
    GT_STATUS rc;            /* return code       */
    GT_U32    data;          /* data              */
    ...
    *indexModePtr = (data == 0) ? CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CMD_AND_CODE_E :
                                  CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_CODE_ONLY_E;

    return GT_OK;
}

/**
* @internal cpssDxChCncEgressPacketTypePassDropClientIndexModeGet function
* @endinternal
*
* @brief   The function gets CNC index mode for Egress Packet Type Pass/Drop CNC client.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChCncEgressPacketTypePassDropClientIndexModeGet
(
    IN   GT_U8                                                     devNum,
    OUT  CPSS_DXCH_CNC_EGRESS_PACKET_TYPE_CLIENT_INDEX_MODE_ENT   *indexModePtr
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChCncEgressPacketTypePassDropClientIndexModeGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, indexModePtr));

    rc = internal_cpssDxChCncEgressPacketTypePassDropClientIndexModeGet(devNum, indexModePtr);
...
/**
* @internal internal_cpssDxChCncUploadInit function
* @endinternal
*
* @brief   Initialize the CNC upload DMA queue info. Should be
*         used once (per CNC unit) before first cpssDxChCncBlockUploadTrigger call
*         for the block in the unit.
*         1. the memory split evenly between all port groups of the device.
*         2. the CPSS also use some of this memory for descriptors management ,
*            so not all of this DMA goes directly for the upload.
*
...
* @param[in] cncUnitId             - The CNC unit id.(local to the port group)
*                                    Each cncUnitId hold 16 blocks , so for device
*                                    with 64 CNC blocks (per port group) , there
*                                    are 4 CNC Units (0..3)
* @param[in] cncCfgPtr             - (pointer to) DMA queue configuration.
*
* @retval GT_OK                    - on success,
* @retval GT_BAD_PTR               - on NULL pointer
* @retval GT_BAD_PARAM             - invalid cncUnitId.
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device.
*/
static GT_STATUS internal_cpssDxChCncUploadInit
(
    IN GT_U8                  devNum,
    IN GT_U32                 cncUnitId,
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
        CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E |
    ...
    if(cncUnitId >= PRV_CPSS_DXCH_PP_HW_INFO_CNC_MAC(devNum).cncUnits)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "cncUnitId[%d] >= max[%d]",
            cncUnitId,
            PRV_CPSS_DXCH_PP_HW_INFO_CNC_MAC(devNum).cncUnits);
    }

    rc = prvCpssDxChGdmaCncMsgInit(devNum,cncUnitId,
        cncCfgPtr,
        _4K/*maxNum16BMsgPerCncQueue --> max size allowed (64KB) , that is 1/2 single CNC dump */);

    return rc ;
}

/**
* @internal cpssDxChCncUploadInit function
* @endinternal
*
* @brief   Initialize the CNC upload DMA queue info. Should be
*         used once (per CNC unit) before first cpssDxChCncBlockUploadTrigger call
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device.
*/
GT_STATUS cpssDxChCncUploadInit
(
    IN GT_U8                  devNum,
    IN GT_U32                 cncUnitId,
    IN CPSS_DMA_QUEUE_CFG_STC *cncCfgPtr
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChCncUploadInit);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, cncUnitId , cncCfgPtr));

    rc = internal_cpssDxChCncUploadInit(devNum, cncUnitId , cncCfgPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, cncUnitId , cncCfgPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);

...
GT_VOID  prvCpssDxChCfgPort88e1690ObjFuncInit(CPSS_MACDRV_OBJ_STC* macPhy88e1690ObjPtr)
{
...
CPSS_MACDRV_OBJ_STC* prvCpssDxChCfgPort88e1690ObjInit(void)
{
    ...
    macPhy88e1690ObjPtr->phyMacType = CPSS_DXCH_CFG_REMOTE_PHY_MAC_TYPE_88E1690_E;

    /* object function init */
    prvCpssDxChCfgPort88e1690ObjFuncInit(macPhy88e1690ObjPtr);

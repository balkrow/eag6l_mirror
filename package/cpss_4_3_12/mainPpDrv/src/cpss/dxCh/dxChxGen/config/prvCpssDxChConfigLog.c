...
const char * const prvCpssLogEnum_CPSS_DXCH_PP_CONFIG_EM_AUTO_LEARN_MODE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_PP_CONFIG_EM_AUTO_LEARN_MODE_ENT);
const char * const prvCpssLogEnum_CPSS_DXCH_PP_CONFIG_EM_CLIENT_TYPE_ENT[]  =
{
    "CPSS_DXCH_PP_CONFIG_EM_CLIENT_TYPE__NOT_CONNECTED__E",
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_PP_CONFIG_EM_CLIENT_TYPE_ENT);
...
)
{
    ...
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, sharedTablesSizeInfo, CPSS_DXCH_PP_CONFIG_SHARED_TABLES_SIZE_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PP_CONFIG_SHARED_TABLES_SIZE_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PP_CONFIG_SHARED_TABLES_SIZE_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numPrefixesForLPM);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForFDB);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEmUnitsNeeded);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, emUnits, CPSS_DXCH_PP_CONFIG_SHARED_MAX_NUM_EM_UNITS_E, CPSS_DXCH_PP_CONFIG_SHARED_EM_UNIT_STC);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForARP);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForTS);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForHF0);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForHF1);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForIpfixOrBilling);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForMetering);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numOfCncBlocks);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForIpeState0);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForIpeState1);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PP_CONFIG_SHARED_EM_UNIT_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PP_CONFIG_SHARED_EM_UNIT_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, singleTableUsedForThe2Clients);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, autoLearnMode, CPSS_DXCH_PP_CONFIG_EM_AUTO_LEARN_MODE_ENT);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, clientInfoArr, 2, CPSS_DXCH_PP_CONFIG_EM_CLIENT_INFO_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_PP_CONFIG_EM_CLIENT_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PP_CONFIG_EM_CLIENT_INFO_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, clientType, CPSS_DXCH_PP_CONFIG_EM_CLIENT_TYPE_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numEntriesForClient);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChConfigLogLibDb[] = {
    ...
    {"cpssDxChCfgAuqFuqDisable", 1, prvCpssLogGenDevNum_PARAMS, NULL},
    {"cpssDxChCfgServiceCpuDisable", 1, prvCpssLogGenDevNum_PARAMS, NULL},
};

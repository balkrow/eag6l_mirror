 ...
 */
typedef GT_STATUS (*FUNCP_FGT_CPSS_READ_MII)
(
    GT_CPSS_QD_DEV          *dev,
    GT_U8                   phyAddr,
    GT_U8                   miiReg,
...
typedef GT_STATUS (*FUNCP_FGT_CPSS_WRITE_MII)
(
    GT_CPSS_QD_DEV          *dev,
    GT_U8                   phyAddr,
    GT_U8                   miiReg,
...
typedef GT_STATUS (*FUNCP_FGT_CPSS_GENERAL_ACTION_MII)
(
    GT_VOID *
);
...
*
*******************************************************************************/
typedef void (*FUNCP_FGT_CPSS_GLOBAL_PROTECTION)
(
...
#ifdef SHARED_MEMORY
typedef GT_U32 FGT_CPSS_READ_MII;
typedef GT_U32 FGT_CPSS_WRITE_MII;
typedef GT_U32 FGT_CPSS_GLOBAL_PROTECTION;

#else
typedef FUNCP_FGT_CPSS_READ_MII FGT_CPSS_READ_MII;
typedef FUNCP_FGT_CPSS_WRITE_MII FGT_CPSS_WRITE_MII;
typedef FUNCP_FGT_CPSS_GLOBAL_PROTECTION FGT_CPSS_GLOBAL_PROTECTION;

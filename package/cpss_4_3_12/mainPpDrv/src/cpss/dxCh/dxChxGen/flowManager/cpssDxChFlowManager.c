...
#define PRV_SHARED_FLOW_MANAGER_DB_VAR_SET(_var,_value)\
      PRV_SHARED_GLOBAL_VAR_SET(mainPpDrvMod.flowMgrDir._var,_value)

#define PRV_SHARED_FLOW_MANAGER_DB_VAR_GET(_var)\
      (CPSS_DXCH_FLOW_MNG_PTR)PRV_SHARED_GLOBAL_VAR_GET(mainPpDrvMod.flowMgrDir._var)
...
)
{
    ...
    PRV_CPSS_CHECK_SDMA_RX_Q_MAC(devNum, flowMngDbPtr->cpssFwCfg.rxSdmaQ);
    PRV_CPSS_CHECK_SDMA_TX_Q_MAC(devNum, flowMngDbPtr->cpssFwCfg.txSdmaQ);
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E |
                                          CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);

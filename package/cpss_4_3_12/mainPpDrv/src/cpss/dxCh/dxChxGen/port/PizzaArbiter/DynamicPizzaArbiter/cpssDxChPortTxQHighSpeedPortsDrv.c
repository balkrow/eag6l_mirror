...
/**
********************************************************************************
* @file cpssDxChPortTxQHighSpeedPortsDrv.c
*
...
/**
* @internal internal_cpssDxChPortDynamicPATxQHighSpeedPortGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPortDynamicPATxQHighSpeedPortDumpGet function
* @endinternal
*
* @brief   get list of txQ ports that are declared as high speed
*

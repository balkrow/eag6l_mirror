...
const char * const prvCpssLogEnum_CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT);
...
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_PORT_MAPPING_TYPE_SERDES_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_PORT_MAPPING_TYPE_LOOPBACK_E),
...
const char * const prvCpssLogEnum_CPSS_DXCH_TXQ_SHAPER_LEVEL_ENT[]  =
{
    "CPSS_DXCH_TXQ_SHAPER_LEVEL_QUEUE_E",
    "CPSS_DXCH_TXQ_SHAPER_LEVEL_PHYS_PORT_E",
    "CPSS_DXCH_TXQ_SHAPER_LEVEL_CSCD_PORT_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_TXQ_SHAPER_LEVEL_ENT);
const char * const prvCpssLogEnum_CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT[]  =
{
    "CPSS_DXCH_TXQ_SHAPER_TYPE_CIR_E",
    "CPSS_DXCH_TXQ_SHAPER_TYPE_EIR_E",
    "CPSS_DXCH_TXQ_SHAPER_TYPE_LAST_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT);
...
const char * const prvCpssLogEnum_CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_ENT);
...
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_ENT[]  =
{PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_BOTH_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_NEG_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_POS_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_LAST_E)
};
PRV_CPSS_LOG_STC_ENUM_MAP_ARRAY_SIZE_MAC(CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_ENT);
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_FCFEC_STATUS_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, fcLocked);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, modesAdvertiseArr, CPSS_DXCH_PORT_AP_IF_ARRAY_SIZE_CNS, CPSS_PORT_MODE_SPEED_STC);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, fecAbilityArr, CPSS_DXCH_PORT_AP_IF_ARRAY_SIZE_CNS, CPSS_DXCH_PORT_FEC_MODE_ENT);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, fecRequestedArr, CPSS_DXCH_PORT_AP_IF_ARRAY_SIZE_CNS, CPSS_DXCH_PORT_FEC_MODE_ENT);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY2_MAC(valPtr, upperMatrix, CPSS_DXCH_PORT_EOM_VOLT_RANGE_CNS, CPSS_DXCH_PORT_EOM_PHASE_RANGE_CNS,  GT_U32);
    PRV_CPSS_LOG_STC_TYPE_ARRAY2_MAC(valPtr, lowerMatrix, CPSS_DXCH_PORT_EOM_VOLT_RANGE_CNS, CPSS_DXCH_PORT_EOM_PHASE_RANGE_CNS,  GT_U32);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, hqosId, CPSS_DXCH_PORT_HQOS_EXTRA_LEVELS_MAX_CNS, GT_U32);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PORT_PREEMPTION_STATUS_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, enabled);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, txVerify, CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_ENT);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, asmErrDetected);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, smdErrDetected);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, verifyFrameRx);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, responceFrameRx);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PORT_SERDES_MAP_INFO_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, portNum);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, macNum);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, serdesNum);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, polarityTx);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, polarityRx);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, ser, CPSS_DXCH_PORT_MAX_LANE_PER_PORT_CNS, GT_FLOAT64);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, totalSer);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, serTimeInterval);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_TXQ_SHAPER_OUTPUT_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, outRate);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, inAccuracyPercent);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, inAccuracyFracPercent);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, roundDown);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, effectiveBurst);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, dividerExp);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, tokenResolution);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, token);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_ENUM_MAP_MAC(valPtr, roundMode, CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, errorPercent);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, burstOptimization);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, slice_enable, TxQ_TOTAL_AVAIBLE_SLICES_CNS, GT_BOOL);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, slice_occupied_by, TxQ_TOTAL_AVAIBLE_SLICES_CNS, GT_U32);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, cpu_port_type, CPSS_DXCH_CPUPORT_TYPE_ENT);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, cpu_port_sliceId, CPSS_PA_NUMBER_OF_CPU_SLICES+1, GT_U32);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, cpu_port_slice_is_enable, CPSS_PA_NUMBER_OF_CPU_SLICES+1, GT_BOOL);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, cpu_port_slice_occupied_by, CPSS_PA_NUMBER_OF_CPU_SLICES+1, GT_U32);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, portConfArr, PIZZA_MAX_PORTS_PER_PORTGROUP_CNS, CPSS_DXCH_PORT_PIZZA_CFG_SLICE_LIST_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_SET_FIELD_VAL_PTR_MAC(CPSS_DXCH_PORT_PIZZA_CFG_SLICE_LIST_STC*, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_FCFEC_STATUS_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_FCFEC_STATUS_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_PORT_PREEMPTION_STATUS_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_PREEMPTION_STATUS_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_PORT_SERDES_MAP_INFO_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_PORT_SERDES_MAP_INFO_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_TXQ_SHAPER_LEVEL_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_TXQ_SHAPER_LEVEL_ENT);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_TXQ_SHAPER_OUTPUT_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_TXQ_SHAPER_OUTPUT_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_INOUT_GT_U32_PTR_infoArraySizePtr = {
     "infoArraySizePtr", PRV_CPSS_LOG_PARAM_INOUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_INOUT_GT_U8_PTR_maxLanesNum = {
     "maxLanesNum", PRV_CPSS_LOG_PARAM_INOUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U8)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT_action = {
     "action", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TXQ_SHAPER_LEVEL_ENT_level = {
     "level", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TXQ_SHAPER_LEVEL_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT_type = {
     "type", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC_PTR_algParamsPtr = {
     "algParamsPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_PM_PORT_ANP_FUNC_ENT_anpFunc = {
     "anpFunc", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_PM_PORT_ANP_FUNC_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_PM_PORT_ANP_PARAM_STC_PTR_anpParamPtr = {
     "anpParamPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_PM_PORT_ANP_PARAM_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_PORT_MAC_MTI_COUNTER_ENT_cntrName = {
     "cntrName", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_PORT_MAC_MTI_COUNTER_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_PORT_SERDES_RX_INIT_MODE_ENT_rxInitMode = {
     "rxInitMode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_PORT_SERDES_RX_INIT_MODE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_PORT_TX_POOL_MODE_ENT_mode = {
     "mode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_PORT_TX_POOL_MODE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_autoComputeOtherPool = {
     "autoComputeOtherPool", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_BOOL)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_enablePrint = {
     "enablePrint", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_BOOL)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_layer2CutThrough = {
     "layer2CutThrough", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_BOOL)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_printEnable = {
     "printEnable", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_BOOL)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_PHYSICAL_PORT_NUM_configPortNum = {
     "configPortNum", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_PHYSICAL_PORT_NUM)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_PHYSICAL_PORT_NUM_resourcePortNum = {
     "resourcePortNum", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_PHYSICAL_PORT_NUM)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_pauseQuanta = {
     "pauseQuanta", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_pool2AvailableBuffers = {
     "pool2AvailableBuffers", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_pool3AvailableBuffers = {
     "pool3AvailableBuffers", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_poolId = {
     "poolId", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_portNum = {
     "portNum", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_rateInKb = {
     "rateInKb", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_mode = {
     "mode", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U8)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_MV_HWS_SERDES_EOM_IN_PARAMS_UNT_PTR_eomInParams = {
     "eomInParams", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(MV_HWS_SERDES_EOM_IN_PARAMS_UNT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_ANP_INFO_STC_PTR_anpInfoArr = {
     "anpInfoArr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_ANP_INFO_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_FCFEC_STATUS_STC_PTR_fcFecStatusPtr = {
     "fcFecStatusPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_FCFEC_STATUS_STC)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT_PTR_actionPtr = {
     "actionPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PORT_PREEMPTION_STATUS_STC_PTR_statusPtr = {
     "statusPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PORT_PREEMPTION_STATUS_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PORT_SERDES_MAP_INFO_STC_PTR_portMapInfoInfoArray = {
     "portMapInfoInfoArray", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PORT_SERDES_MAP_INFO_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TXQ_SHAPER_OUTPUT_STC_PTR_outputPtr = {
     "outputPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TXQ_SHAPER_OUTPUT_STC)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC_PTR_algParamsPtr = {
     "algParamsPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_PORTS_BMP_STC_PTR_portsLinkUpBmpPtr = {
     "portsLinkUpBmpPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_PORTS_BMP_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_PORT_SERDES_AUTO_TUNE_STATUS_ENT_PTR_rxInitStatusPtr = {
     "rxInitStatusPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_PORT_SERDES_AUTO_TUNE_STATUS_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_PORT_TX_POOL_MODE_ENT_PTR_modePtr = {
     "modePtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_PORT_TX_POOL_MODE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_BOOL_PTR_layer2CutThroughPtr = {
     "layer2CutThroughPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_BOOL)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_BOOL_PTR_noMacPtr = {
     "noMacPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_BOOL)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_pauseQuantaPtr = {
     "pauseQuantaPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_pool2AvailableBuffersPtr = {
     "pool2AvailableBuffersPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_pool3AvailableBuffersPtr = {
     "pool3AvailableBuffersPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_profileSetPtr = {
     "profileSetPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U8_PTR_modePtr = {
     "modePtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U8)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_MV_HWS_SERDES_EOM_OUT_PARAMS_UNT_PTR_eomOutParams = {
     "eomOutParams", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(MV_HWS_SERDES_EOM_OUT_PARAMS_UNT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortAnpInfoGet_PARAMS[] =  {
    ...
    &DX_INOUT_GT_U8_PTR_maxLanesNum,
    &DX_OUT_CPSS_ANP_INFO_STC_PTR_anpInfoArr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxQShaperCalculationGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT_type,
    &DX_IN_CPSS_DXCH_TXQ_SHAPER_LEVEL_ENT_level,
    &DX_IN_GT_U32_rateInKb,
    &DX_OUT_CPSS_DXCH_TXQ_SHAPER_OUTPUT_STC_PTR_outputPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxQShaperAlgorithmParamsSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT_type,
    &DX_IN_CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC_PTR_algParamsPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxQShaperAlgorithmParamsGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT_type,
    &DX_OUT_CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC_PTR_algParamsPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortRejectPacketConfigSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortArrayLinkStatusGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PORTS_BMP_STC_PTR_portsBmpPtr,
    &DX_OUT_CPSS_PORTS_BMP_STC_PTR_portsLinkUpBmpPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxQPoolModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PORT_TX_POOL_MODE_ENT_mode
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxTailDropGlobalParamsSet_PARAMS[] =  {
    ...
    &DX_IN_GT_U32_pool2AvailableBuffers,
    &DX_IN_GT_U32_pool3AvailableBuffers
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortEgressLoopbackSpeedSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_configPortNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_resourcePortNum,
    &DX_IN_CPSS_PORT_SPEED_ENT_speed
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortAnpCall_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_CPSS_PM_PORT_ANP_FUNC_ENT_anpFunc,
    &DX_IN_CPSS_PM_PORT_ANP_PARAM_STC_PTR_anpParamPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMacMtiCounterGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_CPSS_PORT_MAC_MTI_COUNTER_ENT_cntrName,
    &DX_OUT_GT_U64_PTR_cntrValuePtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortPcsResetGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_CPSS_PORT_PCS_RESET_MODE_ENT_mode,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortSerdesRxInit_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_CPSS_PORT_SERDES_RX_INIT_MODE_ENT_rxInitMode,
    &DX_OUT_CPSS_PORT_SERDES_AUTO_TUNE_STATUS_ENT_PTR_rxInitStatusPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortPhysicalSerdesMappingsGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_BOOL_enablePrint,
    &DX_INOUT_GT_U32_PTR_infoArraySizePtr,
    &DX_OUT_CPSS_DXCH_PORT_SERDES_MAP_INFO_STC_PTR_portMapInfoInfoArray
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortSerdesSignalDetectMaskSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortSerdesEomMatrixGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U32_laneNum,
    &DX_IN_GT_BOOL_printEnable,
    &DX_IN_MV_HWS_SERDES_EOM_IN_PARAMS_UNT_PTR_eomInParams,
    &DX_OUT_MV_HWS_SERDES_EOM_OUT_PARAMS_UNT_PTR_eomOutParams
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxBindPortQueueToDpSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U32_queueOffset,
    &DX_IN_GT_U32_profileSet
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxBindPortQueueToDpGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U32_queueOffset,
    &DX_OUT_GT_U32_PTR_profileSetPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortFlowControPauseQuantaSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U32_tc,
    &DX_IN_GT_U32_pauseQuanta
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortFlowControPauseQuantaGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U32_tc,
    &DX_OUT_GT_U32_PTR_pauseQuantaPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortSerdesLaneSwappingModeSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U8_mode
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxQMinimalRateEnableSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U8_tcQueue,
    &DX_IN_GT_BOOL_enable,
    &DX_IN_CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT_action
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxQMinimalRateEnableGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_IN_GT_U8_tcQueue,
    &DX_OUT_GT_BOOL_PTR_enablePtr,
    &DX_OUT_CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT_PTR_actionPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChFcFecStatusGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_OUT_CPSS_DXCH_FCFEC_STATUS_STC_PTR_fcFecStatusPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxPreemptionStatusGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_OUT_CPSS_DXCH_PORT_PREEMPTION_STATUS_STC_PTR_statusPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortPhysicalPortMapWithoutMacGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_OUT_GT_BOOL_PTR_noMacPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortSerdesLaneSwappingModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PHYSICAL_PORT_NUM_portNum,
    &DX_OUT_GT_U8_PTR_modePtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortDpDebugCpToRxCountingConfigSet_PARAMS[] =  {
    ...
    &DX_IN_GT_BOOL_layer2CutThrough
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortDpDebugCpToRxCountingConfigGet_PARAMS[] =  {
    ...
    &DX_OUT_GT_BOOL_PTR_layer2CutThroughPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxPoolBuffNumberGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_poolId,
    &DX_OUT_GT_U32_PTR_numPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxSharedPoolLimitsSet_PARAMS[] =  {
    ...
    &DX_IN_GT_BOOL_autoComputeOtherPool
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxQShapingCreditAccumulationEnableSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_portNum,
    &DX_IN_GT_U32_queueOffset,
    &DX_IN_GT_BOOL_enable
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxQShapingCreditAccumulationEnableGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_portNum,
    &DX_IN_GT_U32_queueOffset,
    &DX_OUT_GT_BOOL_PTR_enablePtr
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortRejectPacketConfigGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxQPoolModeGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_CPSS_PORT_TX_POOL_MODE_ENT_PTR_modePtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPortTxTailDropGlobalParamsGet_PARAMS[] =  {
    ...
    &DX_OUT_GT_U32_PTR_pool2AvailableBuffersPtr,
    &DX_OUT_GT_U32_PTR_pool3AvailableBuffersPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPortLogLibDb[] = {
    ...
    {"cpssDxChPortAnpInfoGet", 4, cpssDxChPortAnpInfoGet_PARAMS, NULL},
    {"cpssDxChPortAnpCall", 4, cpssDxChPortAnpCall_PARAMS, NULL},
    {"cpssDxChFcFecStatusGet", 3, cpssDxChFcFecStatusGet_PARAMS, NULL},
    {"cpssDxChPortArrayLinkStatusGet", 3, cpssDxChPortArrayLinkStatusGet_PARAMS, NULL},
    {"cpssDxChPortFlowControPauseQuantaSet", 4, cpssDxChPortFlowControPauseQuantaSet_PARAMS, NULL},
    {"cpssDxChPortFlowControPauseQuantaGet", 4, cpssDxChPortFlowControPauseQuantaGet_PARAMS, NULL},
    {"cpssDxChPortRejectPacketConfigSet", 3, cpssDxChPortRejectPacketConfigSet_PARAMS, NULL},
    {"cpssDxChPortRejectPacketConfigGet", 3, cpssDxChPortRejectPacketConfigGet_PARAMS, NULL},
    ...
    {"cpssDxChPortDpDebugCpToRxCountingConfigSet", 12, cpssDxChPortDpDebugCpToRxCountingConfigSet_PARAMS, NULL},
    {"cpssDxChPortDpDebugCpToRxCountingConfigGet", 12, cpssDxChPortDpDebugCpToRxCountingConfigGet_PARAMS, NULL},
    ...
    {"cpssDxChPortEgressLoopbackSpeedSet", 4, cpssDxChPortEgressLoopbackSpeedSet_PARAMS, NULL},
    ...
    {"cpssDxChPortPhysicalPortMapWithoutMacGet", 3, cpssDxChPortPhysicalPortMapWithoutMacGet_PARAMS, NULL},
    ...
    {"cpssDxChPortPacketBufferAgingTimeoutSet", 2, prvCpssLogGenDevNumTimeout_PARAMS, NULL},
    {"cpssDxChPortPacketBufferAgingTimeoutGet", 2, prvCpssLogGenDevNumTimeoutPtr_PARAMS, NULL},
    ...
    {"cpssDxChPortPcsResetGet", 4, cpssDxChPortPcsResetGet_PARAMS, NULL},
    ...
    {"cpssDxChPortSerdesLaneSwappingModeSet", 3, cpssDxChPortSerdesLaneSwappingModeSet_PARAMS, NULL},
    {"cpssDxChPortSerdesLaneSwappingModeGet", 3, cpssDxChPortSerdesLaneSwappingModeGet_PARAMS, NULL},
    ...
    {"cpssDxChPortSerdesEomMatrixGet", 6, cpssDxChPortSerdesEomMatrixGet_PARAMS, NULL},
    ...
    {"cpssDxChPortSerdesGrayCodeEnableSet", 4, prvCpssLogGenDevNumPortNumLaneNumEnable_PARAMS, NULL},
    {"cpssDxChPortSerdesGrayCodeEnableGet", 4, prvCpssLogGenDevNumPortNumLaneNumEnablePtr_PARAMS, NULL},
    {"cpssDxChPortSerdesPreCodeEnableSet", 4, prvCpssLogGenDevNumPortNumLaneNumEnable_PARAMS, NULL},
    {"cpssDxChPortSerdesPreCodeEnableGet", 4, prvCpssLogGenDevNumPortNumLaneNumEnablePtr_PARAMS, NULL},
    ...
    {"cpssDxChPortSerdesRxInit", 4, cpssDxChPortSerdesRxInit_PARAMS, NULL},
    {"cpssDxChPortSerdesSignalDetectMaskSet", 3, cpssDxChPortSerdesSignalDetectMaskSet_PARAMS, NULL},
    {"cpssDxChPortPhysicalSerdesMappingsGet", 5, cpssDxChPortPhysicalSerdesMappingsGet_PARAMS, NULL},
    ...
    {"cpssDxChMacMtiCounterGet", 4, cpssDxChMacMtiCounterGet_PARAMS, NULL},
    ...
    {"cpssDxChPortTxSharedPoolLimitsSet", 5, cpssDxChPortTxSharedPoolLimitsSet_PARAMS, NULL},
    ...
    {"cpssDxChPortTxTailDropGlobalParamsSet", 7, cpssDxChPortTxTailDropGlobalParamsSet_PARAMS, NULL},
    {"cpssDxChPortTxTailDropGlobalParamsGet", 7, cpssDxChPortTxTailDropGlobalParamsGet_PARAMS, NULL},
    ...
    {"cpssDxChPortTxQMinimalRateEnableSet", 5, cpssDxChPortTxQMinimalRateEnableSet_PARAMS, NULL},
    {"cpssDxChPortTxQMinimalRateEnableGet", 5, cpssDxChPortTxQMinimalRateEnableGet_PARAMS, NULL},
    ...
    {"cpssDxChPortTxPreemptionStatusGet", 3, cpssDxChPortTxPreemptionStatusGet_PARAMS, NULL},
    {"cpssDxChPortTxQShapingCreditAccumulationEnableSet", 4, cpssDxChPortTxQShapingCreditAccumulationEnableSet_PARAMS, NULL},
    {"cpssDxChPortTxQShapingCreditAccumulationEnableGet", 4, cpssDxChPortTxQShapingCreditAccumulationEnableGet_PARAMS, NULL},
    {"cpssDxChPortTxQPoolModeSet", 2, cpssDxChPortTxQPoolModeSet_PARAMS, NULL},
    {"cpssDxChPortTxQPoolModeGet", 2, cpssDxChPortTxQPoolModeGet_PARAMS, NULL},
    {"cpssDxChPortTxQPermissiveShaperModeEnableGet", 2, prvCpssLogGenDevNumEnablePtr_PARAMS, NULL},
    {"cpssDxChPortTxQPermissiveShaperModeEnableSet", 2, prvCpssLogGenDevNumEnable_PARAMS, NULL},
    {"cpssDxChPortTxPoolBuffNumberGet", 3, cpssDxChPortTxPoolBuffNumberGet_PARAMS, NULL},
    {"cpssDxChPortTxQSpPrecedenceEnableSet", 2, prvCpssLogGenDevNumEnable_PARAMS, NULL},
    {"cpssDxChPortTxQSpPrecedenceEnableGet", 2, prvCpssLogGenDevNumEnablePtr_PARAMS, NULL},
    {"cpssDxChPortTxQShaperAlgorithmParamsSet", 3, cpssDxChPortTxQShaperAlgorithmParamsSet_PARAMS, NULL},
    {"cpssDxChPortTxQShaperAlgorithmParamsGet", 3, cpssDxChPortTxQShaperAlgorithmParamsGet_PARAMS, NULL},
    {"cpssDxChPortTxQShaperCalculationGet", 5, cpssDxChPortTxQShaperCalculationGet_PARAMS, NULL},
    {"cpssDxChPortTxBindPortQueueToDpSet", 4, cpssDxChPortTxBindPortQueueToDpSet_PARAMS, NULL},
    {"cpssDxChPortTxBindPortQueueToDpGet", 4, cpssDxChPortTxBindPortQueueToDpGet_PARAMS, NULL},

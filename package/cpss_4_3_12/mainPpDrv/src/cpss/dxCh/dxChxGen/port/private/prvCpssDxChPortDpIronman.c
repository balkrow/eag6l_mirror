...
/* maximal number of channels supported by units */
#define PRV_IRONMAN_MAX_CHANNELS_NUM_CNS 64
/* size of array */
...
)
{
    ...
    /*preemptionSupported = prvCpssSip6TxqPreemptionCapableDeviceGet(devNum);*/
...
typedef struct
{
    ...
    GT_U32 serdesUsage;
    /** speed In Mbps - speeds 10M, 100M, 1G treated as the same speed */
    GT_U32 speedInMbps;
    /** the size of speed range relevant to the filter               */
    /** range from (speedInMbps - speedRangeSizeDown) to speedInMbps */
    GT_U32 speedRangeSizeDown;
    /** (1 << 2) - Express, (1 << 1)) - Preemptive, (1 << 0) - regular  */
    GT_U32 preemptionModeBmp;
    /** option flags mask*/
    GT_U32 optionFlagsMask;
    /** option flags pattern */
    GT_U32 optionFlagsPattern;
} PRV_IRONMAN_PCA_ARBITER_RESOURCE_FILTER_STC;

/**
* @struct PRV_IRONMAN_PCA_ARBITER_RESOURCE_KEY_STC
 *
 * @brief List of parameters of channels that must be matched with filter to share the same resource.
 * @brief for members of the same channel group.
*/
typedef struct
{
    /* device number needed to extract per-device options */
    GT_U8 devNum;
    /** serdesUsage: 32 - Octo, 64 - Quadro, 256 - single MAC per serdes. */
    /** Measured in units of 1/256 of serdes lane sharing.                */
    /** 0 in this field means "any"                                       */
    GT_U32 serdesUsage;
    /** speed In Mbps - speeds 10M, 100M, 1G treated as the same speed b*/
    GT_U32 speedInMbps;
    /** 2 - Express, 1 - Preemptive, 0 - regular  */
    GT_U32 preemptionMode;
} PRV_IRONMAN_PCA_ARBITER_RESOURCE_KEY_STC;
...
/* Channel Groups Quadro mode channels without preemption 2.5G,1G,100M,10M */
/* and 2.5G with preemption                                                */
...
/* Channel Groups Quadro mode channels with preemption 1G,100M,10M */
...
/* Channel Groups Single mode channels with preemption 2.5G,1G */
...
/* Channel Groups Single mode channels with preemption 5G */
...
/* mask and pattern for option flag High Latency 1G 8 ports per SERDES */
/* flag is on */
#define HL_8X1G PRV_CPSS_DXCH_SIP6_30_DP_8X1G_LOW_LATENCY_EXP_2_5G_E, \
    PRV_CPSS_DXCH_SIP6_30_DP_8X1G_LOW_LATENCY_EXP_2_5G_E
/* lag is off */
#define NO_HL_8X1G PRV_CPSS_DXCH_SIP6_30_DP_8X1G_LOW_LATENCY_EXP_2_5G_E, 0
...
{
    {{32,  999, 998, 7/*express,preemptive,regular*/, 0, 0/*flags mask and pattern*/},
        SIZE_OF_ARR(prvCpssDxChPortDpIronmanPcaPizzaArbiter8ChannelsBmpArr),
        prvCpssDxChPortDpIronmanPcaPizzaArbiter8ChannelsBmpArr},
    {{32, 1000, 0, 3/*preemptive,regular*/, 0, 0/*flags mask and pattern*/},
        SIZE_OF_ARR(prvCpssDxChPortDpIronmanPcaPizzaArbiter8ChannelsBmpArr),
        prvCpssDxChPortDpIronmanPcaPizzaArbiter8ChannelsBmpArr},
    {{32, 1000, 0, 4/*express*/, NO_HL_8X1G/*flags mask and pattern*/},
        SIZE_OF_ARR(prvCpssDxChPortDpIronmanPcaPizzaArbiter8ChannelsBmpArr),
        prvCpssDxChPortDpIronmanPcaPizzaArbiter8ChannelsBmpArr},
    {{32, 1000, 0, 4/*express*/, HL_8X1G/*flags mask and pattern*/},
        SIZE_OF_ARR(prvCpssDxChPortDpIronmanPcaPizzaArbiter4ChannelsBmpArr),
        prvCpssDxChPortDpIronmanPcaPizzaArbiter4ChannelsBmpArr},
    {{64, 2500, 0, 7/*express,preemptive,regular*/, 0, 0/*flags mask and pattern*/},
        SIZE_OF_ARR(prvCpssDxChPortDpIronmanPcaPizzaArbiter4ChannelsBmpArr),
        prvCpssDxChPortDpIronmanPcaPizzaArbiter4ChannelsBmpArr},
    {{64, 1000, 999, 1/*regular*/, 0, 0/*flags mask and pattern*/},
        SIZE_OF_ARR(prvCpssDxChPortDpIronmanPcaPizzaArbiter4ChannelsBmpArr),
        prvCpssDxChPortDpIronmanPcaPizzaArbiter4ChannelsBmpArr},
    {{64, 1000, 999, 6/*express,preemptive*/, 0, 0/*flags mask and pattern*/},
    ...
    {{256, 2500, 0, 6/*express,preemptive*/, 0, 0/*flags mask and pattern*/},
    ...
    {{256, 1000, 999, 6/*express,preemptive*/, 0, 0/*flags mask and pattern*/},
        SIZE_OF_ARR(prvCpssDxChPortDpIronmanPcaPizzaArbiter2_0ChannelsBmpArr),
        prvCpssDxChPortDpIronmanPcaPizzaArbiter2_0ChannelsBmpArr},
    {{256, 5000, 0, 6/*express,preemptive*/, 0, 0/*flags mask and pattern*/},
...
/* Table of conversion Channel Filer to Resource member group offsets */
...
{
    {{ 32, 999, 998, 7/*express,preemptive,regular*/, 0, 0/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x000001EF, 1}, /* bypass possible SD members 4,9,14,19 */
    {{ 32, 1000, 0, 7/*express,preemptive,regular*/, NO_HL_8X1G/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x000001EF, 1}, /* bypass possible SD members 4,9,14,19 */
    {{ 32, 1000, 0, 1/*regular*/, HL_8X1G/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x000001EF, 1}, /* bypass possible SD members 4,9,14,19 */
    {{ 32, 1000, 0, 2/*preemptive*/, HL_8X1G/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x000000FF, 0},
    {{ 32, 1000, 0, 4/*express*/, HL_8X1G/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x0000000F, 0},
    {{ 64, 2500, 0, 7/*express,preemptive,regular*/, 0, 0/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x0000000F, 0},
    {{ 64, 1000, 999, 1/*regular*/, 0, 0/*flags mask and pattern*/},
        {0x00FFFFFF, 0x00000000}, 0x0000000F, 0}, /* ch0-23  - members0-3 */
    {{ 64, 1000, 999, 1/*regular*/, 0, 0/*flags mask and pattern*/},
        {0xFF000000, 0x0000FFFF}, 0x000000F0, 0}, /* ch24-47 - members4-7 */
    {{ 64, 1000, 999, 6/*express,preemptive*/, 0, 0/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x000000FF, 0},
    {{256, 2500, 0, 6/*express,preemptive*/, 0, 0/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x00000003, 0},
    {{256, 1000, 999, 6/*express,preemptive*/, 0, 0/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x00000003, 0},
    {{256, 5000, 0, 6/*express,preemptive*/, 0, 0/*flags mask and pattern*/},
        {0xFFFFFFFF, 0xFFFFFFFF}, 0x00000003, 0}
...
{
    {{  0,  999, 998, 7/*express,preemptive,regular*/, 0, 0/*flags mask and pattern*/}, 0x00000001},
    {{  0,  1000,  0, 7/*express,preemptive,regular*/, NO_HL_8X1G/*flags mask and pattern*/}, 0x00000401},
    {{ 32,  1000,  0, 1/*regular*/, HL_8X1G/*flags mask and pattern*/}, 0x00000401},
    {{ 32,  1000,  0, 2/*preemptive*/, HL_8X1G/*flags mask and pattern*/}, 0x00000101},
    {{ 32,  1000,  0, 4/*express*/, HL_8X1G/*flags mask and pattern*/}, 0x00011111},
    {{ 64,  1000,  0, 7/*express,preemptive,regular*/, HL_8X1G/*flags mask and pattern*/}, 0x00000401},
    {{256,  1000,  0, 7/*express,preemptive,regular*/, HL_8X1G/*flags mask and pattern*/}, 0x00000401},
    {{  0,  2500,  0, 7/*express,preemptive,regular*/, 0, 0/*flags mask and pattern*/}, 0x00011111},
    {{  0,  5000,  0, 7/*express,preemptive,regular*/, 0, 0/*flags mask and pattern*/}, 0x00055555},
    {{  0, 10000,  0, 7/*express,preemptive,regular*/, 0, 0/*flags mask and pattern*/}, 0x000FFFFF}
};
...
/**
* @internal prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelKeyGet function
* @endinternal
*
...
* @param[out] channelResourceKeyPtr    - (pointer to) key of channel values from DB
*
* @retval - none
*/
static void prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelKeyGet
(
    IN    GT_U8                                    devNum,
    IN    GT_U32                                   channel,
    OUT   PRV_IRONMAN_PCA_ARBITER_RESOURCE_KEY_STC *channelResourceKeyPtr
)
{
    ...
    channelResourceKeyPtr->devNum          = devNum;
    channelResourceKeyPtr->preemptionMode  =
        (channelCfgPtr[channel].preemptiveModeActivated
         ? (channelCfgPtr[channel].isPreemptive ? 1/*preemptive*/ : 2/*express*/)
         : 0/*regular*/);
    channelResourceKeyPtr->speedInMbps             = channelCfgPtr[channel].speedInMbps;
    channelResourceKeyPtr->serdesUsage             = channelCfgPtr[channel].serdesUsage;
}

/**
* @internal prvCpssDxChPortDpIronmanPcaPizzaArbiterNewChannelKeyGet function
* @endinternal
*
...
* @retval - none
*/
static void prvCpssDxChPortDpIronmanPcaPizzaArbiterNewChannelKeyGet
(
    IN    GT_U8                                    devNum,
...
{
    channelResourceKeyPtr->devNum          = devNum;
    channelResourceKeyPtr->speedInMbps     = channelInfoPtr->speedInMbps;
    channelResourceKeyPtr->serdesUsage     = channelInfoPtr->serdesUsage;
    channelResourceKeyPtr->preemptionMode  =
        ((channelInfoPtr->preemptiveModeActivated != GT_FALSE)
         ? ((channelInfoPtr->isPreemptive != GT_FALSE) ? 1/*preemptive*/ : 2/*express*/)
         : 0/*regular*/);
}

/**
* @internal prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelFilterMatch function
* @endinternal
*
* @brief    Check that filter matches the key.
*
* @note   APPLICABLE DEVICES:     Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon;  AC5P; AC5X; Harrier.
*
* @param[in] channelResourceFilterPtr - (pointer to) filter of channel values from DB
* @param[in] channelResourceKeyPtr    - (pointer to) key of channel values from DB
*
* @retval - 1 - match; 0 - not match
*/
static int prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelFilterMatch
(
    IN    const PRV_IRONMAN_PCA_ARBITER_RESOURCE_FILTER_STC *channelResourceFilterPtr,
    IN    const PRV_IRONMAN_PCA_ARBITER_RESOURCE_KEY_STC    *channelResourceKeyPtr
)
{
    GT_U32 optionFlags;

    optionFlags =
        PRV_CPSS_DXCH_PP_MAC(channelResourceKeyPtr->devNum)
            ->port.sip6_30_dpInfoPtr[0]->optionFlagsBmp;

    /* filter not relevan to option flags */
    if ((channelResourceFilterPtr->optionFlagsMask & optionFlags)
        != channelResourceFilterPtr->optionFlagsPattern) return 0;

    if (channelResourceKeyPtr->speedInMbps
        > channelResourceFilterPtr->speedInMbps) return 0;

    if ((channelResourceKeyPtr->speedInMbps
         + channelResourceFilterPtr->speedRangeSizeDown)
        < channelResourceFilterPtr->speedInMbps) return 0;

    if ((channelResourceFilterPtr->serdesUsage != 0) &&
        (channelResourceFilterPtr->serdesUsage
        != channelResourceKeyPtr->serdesUsage)) return 0;

    /* one of filters built for channel - one from the list to check matching */
    if ((channelResourceFilterPtr->preemptionModeBmp
        & (1 << channelResourceKeyPtr->preemptionMode)) == 0) return 0;
    return 1;
}
...
(
    IN    PRV_IRONMAN_PCA_ARBITER_RESOURCE_KEY_STC *channelResourceKeyPtr,
    IN    GT_U32                                   channel,
...
)
{
    ...
    for (i = 0; (i < arrSize); i++)
    {
        ...
        if (prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelFilterMatch(
            &(groupListPtr->filter), channelResourceKeyPtr) == 0) continue;
...
)
{
    ...
    *canShareWithSdmaPtr = 0;
    ...
    if (channel >= PRV_IRONMAN_MAX_CHANNELS_NUM_CNS)
    {
        /* should not happen. Caller guaranties that but need fix Klocwork warning. */
        return;
    }
    ...
    {
        if (prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelFilterMatch(
            &(prvCpssDxChPortDpIronmanPcaPizzaArbiterSpeedToMembersBaseBmp[i].filter),
            channelResourceKeyPtr) == 0) continue;
        baseMembersBmp =
    ...
    for (i = 0; (i < arrSize); i++)
    {
        ...
        if (prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelFilterMatch(
            &(resourceMembersPtr->filter), channelResourceKeyPtr) == 0) continue;
...
)
{
    ...
    PRV_IRONMAN_PCA_ARBITER_RESOURCE_KEY_STC newChannelKey;
    PRV_IRONMAN_PCA_ARBITER_RESOURCE_KEY_STC foundChannelKey;
    GT_U32   resourceMembersBmp;
    GT_U32   canShareWithSdma;
    GT_U32   newChannelGroup[2];
    GT_U32   foundChannelGroup[2];
    GT_U32   resourceAllocated;

    channelNum = channelInfoPtr->channelNum;
    if (channelNum >= PRV_IRONMAN_MAX_CHANNELS_NUM_CNS)
    {
        /* IronMan logic below supports up to 64 channels */
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    arbiterShadowPtr =
    ...
    for (slot = 0; (slot < PRV_IRONMAN_PIZZA_CYCLES_NUM_CNS); slot++)
    {
        ...
        if (index >= PRV_IRONMAN_ARBITER_RESOURCES_NUM_CNS)
        {
            /* should never happen */
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_FAIL, LOG_ERROR_NO_MSG);
        }
    ...
    prvCpssDxChPortDpIronmanPcaPizzaArbiterNewChannelKeyGet(
        devNum, channelInfoPtr, &newChannelKey);

    prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelGroupGet(
        &newChannelKey, channelNum, newChannelGroup);

    prvCpssDxChPortDpIronmanPcaPizzaArbiterResourceMembersBmpGet(
        &newChannelKey, newChannelGroup, channelNum,
    ...
    for (index = 0; (index < PRV_IRONMAN_ARBITER_RESOURCES_NUM_CNS); index++)
    {
        ...
        /* check being members of the same group calulating */
        /* and comparing group of the found channel with    */
        /* the group of the new channel                     */
        /* The found channel can present in group bitmap of */
        /* the new channel, but not be a member of it's     */
        /* group having different parameters as speed.      */

        prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelKeyGet(
            devNum, channel, &foundChannelKey);
        if (foundChannelKey.serdesUsage != newChannelKey.serdesUsage) continue;
        if (foundChannelKey.speedInMbps != newChannelKey.speedInMbps) continue;

        prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelGroupGet(
            &foundChannelKey, channel, foundChannelGroup);
        if (foundChannelGroup[0] != newChannelGroup[0]) continue;
        if (foundChannelGroup[1] != newChannelGroup[1]) continue;
...
* @retval GT_BAD_PARAM             - on bad parameter value
* @retval GT_BAD_STATE             - other channel slots overlapped
* @retval GT_FAIL                  - on failure of algorithm
*/
...
)
{
    ...
    for (slot = 0; (slot < PRV_IRONMAN_PIZZA_CYCLES_NUM_CNS); slot++)
    {
        ...
        /* resourceInMapIndexArr array boundary check */
        if (resIndex >= PRV_IRONMAN_ARBITER_RESOURCES_NUM_CNS)
        {
            /* should not happen */
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_FAIL, LOG_ERROR_NO_MSG);
        }
        ...
        /* resourcesMapArr array boundary check */
        if (resIndexInMap >= PRV_IRONMAN_MAX_CHANNEL_RESOURCES_CNS)
        {
            /* should not happen */
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_FAIL, LOG_ERROR_NO_MSG);
        }
        ...
        /*skip check due to already configured HW */
    ...
    channelCfgPtr[channelInfoPtr->channelNum].isPreemptive = BOOL2BIT_MAC(channelInfoPtr->isPreemptive);
...
)
{
    ...
    for (channel = 0; (channel < PRV_IRONMAN_CHANNELS_NUM_CNS); channel++)
    {
        ...
        channelCfgPtr[channel].isPreemptive = 0;
...
)
{
    ...
    channelCfgPtr[channelInfoPtr->channelNum].isPreemptive = 0;
    regAddr = regsAddrPtr->PCA_PZ_ARBITER[0][0].channelEnable[channelInfoPtr->channelNum];
    rc = prvCpssDrvHwPpReadRegister(devNum, regAddr, &regData);
    if (rc != GT_OK)
    {
...
)
{
    ...
    channelBmp[0] = 0;
    channelBmp[1] = 0;
    for (channel = 0; (channel < PRV_IRONMAN_MAX_CHANNELS_NUM_CNS); channel++)
    {
        regAddr = regsAddrPtr->PCA_PZ_ARBITER[0][0].channelEnable[channel];
        rc = prvCpssDrvHwPpReadRegister(devNum, regAddr, &regData);
        if (rc != GT_OK)
...
/*
dpwip_max_bytes for several speeds           profile(0-14)
          MACSec Enabled    MACSec Disabled
0.01M     100                 5              12
0.1M      115                 5              11
1G        165               125              10
2.5G      260               180               9
...
10G       645               485               7
*/
static const GT_U32 prvCpssDxChPortDpIronmanDpTxDWIP_StartProfile = 7;
static const GT_U32 prvCpssDxChPortDpIronmanDpTxDWIP_MacSecEnabled_thresholdArr[] =
{ /*7*/645, /*8*/370, /*9*/260, /*10*/165, /*11*/115, /*12*/100 };
static const GT_U32 prvCpssDxChPortDpIronmanDpTxDWIP_MacSecDisabled_thresholdArr[] =
{ /*7*/485, /*8*/255, /*9*/180, /*10*/125, /*11*/5, /*12*/5 };

/**
* @internal prvCpssDxChPortDpIronmanDpTxDWIPConfigure function
* @endinternal
*
* @brief    Configue TX_DMA Profiles DP-Work-in-process related values.
*
* @note   APPLICABLE DEVICES:     Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon;  AC5P; AC5X; Harrier.
*
* @param[in] devNum                 - physical device number
* @param[in] macSecEnable           - is MACSec enable
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on bad parameter value
*/
GT_STATUS prvCpssDxChPortDpIronmanDpTxDWIPConfigure
(
    IN    GT_U8                                devNum,
    IN    GT_BOOL                              macSecEnable
)
{
    PRV_CPSS_DXCH_PP_REGS_ADDR_VER1_STC *regsAddrPtr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum);
    GT_STATUS rc;
    ...
    if (macSecEnable != GT_FALSE)
    {
        /* MACSEC enabled */
        arrSize =
            (sizeof(prvCpssDxChPortDpIronmanDpTxDWIP_MacSecEnabled_thresholdArr)
             / sizeof(prvCpssDxChPortDpIronmanDpTxDWIP_MacSecEnabled_thresholdArr[0]));
        arrPtr = prvCpssDxChPortDpIronmanDpTxDWIP_MacSecEnabled_thresholdArr;
    }
    else
    {
        /* MACSEC disabled */
        arrSize =
            (sizeof(prvCpssDxChPortDpIronmanDpTxDWIP_MacSecDisabled_thresholdArr)
             / sizeof(prvCpssDxChPortDpIronmanDpTxDWIP_MacSecDisabled_thresholdArr[0]));
        arrPtr = prvCpssDxChPortDpIronmanDpTxDWIP_MacSecDisabled_thresholdArr;
    }
    for (cnt = 0; (cnt < arrSize); cnt++)
    {
        profile = prvCpssDxChPortDpIronmanDpTxDWIP_StartProfile + cnt;
        regData = arrPtr[cnt];
        regAddr = regsAddrPtr->sip6_txDMA[0].configs.speedProfileConfigs.dpWipThreshold[profile];
        rc = prvCpssDrvHwPpWriteRegister(devNum, regAddr, regData);
        if (rc != GT_OK)
        {
            return rc;
...
)
{
    ...
    /* Ironman only fixes of default register values - not relevant for other projects */
    /* Profiles 0-2 not supported by HW                                                */
    for (profile = 3; (profile < 15); profile++)
    {
        regAddr = regsAddrPtr->sip6_txDMA[0].configs.speedProfileConfigs.sdqThresholdBytes[profile];
        rc = prvCpssDrvHwPpReadRegister(devNum, regAddr, &regData);
        if (rc != GT_OK)
        {
            return rc;
    ...
    macSecEnable =
        (PRV_SHARED_GLOBAL_VAR_CPSS_DRIVER_PP_CONFIG(devNum)->enabledMacSecDpBitmap != 0)
        ? GT_TRUE : GT_FALSE;
    rc = prvCpssDxChPortDpIronmanDpTxDWIPConfigure(devNum,macSecEnable);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    interPktGap = (24 * 8 * 32); /* default */
    if (speedInMbps >= 12000)
    {
        interPktGap = (20 * 8 * 32); /* speedup */
    }
    ...
    regAddr = regsAddrPtr->sip6_txFIFO[0].configs.channelConfigs.speedProfile[channelNum];
    rc = prvCpssDrvHwPpReadRegister(devNum, regAddr, &regData);
    if (rc != GT_OK)
    {
        return rc;
...
)
{
    ...
    {
        bitOffset = 2;
        regAddr = regsAddrPtr->sip6_rxDMA[0].configs.channelConfig.channelGeneralConfigs[channelNum];
    }
    else
    {
        bitOffset = 0;
...
)
{
    GT_STATUS              rc;
    CPSS_SYSTEM_RECOVERY_INFO_STC           tempSystemRecovery_Info; /* holds system recovery information */
    GT_BOOL                systemUnderRecovery = GT_FALSE;
    ...
    systemUnderRecovery = ((tempSystemRecovery_Info.systemRecoveryProcess == CPSS_SYSTEM_RECOVERY_PROCESS_HA_E ||
                            tempSystemRecovery_Info.systemRecoveryProcess == CPSS_SYSTEM_RECOVERY_PROCESS_HITLESS_STARTUP_E) &&
                           tempSystemRecovery_Info.systemRecoveryState != CPSS_SYSTEM_RECOVERY_COMPLETION_STATE_E) ? GT_TRUE :GT_FALSE ;

    /*skip under recovery*/
    if (systemUnderRecovery == GT_FALSE)
    {
    ...
    /*stop here*/
    if (systemUnderRecovery == GT_TRUE)
    {
        return GT_OK;
    }
...
)
{
    ...
    else
    {
        ...
        channelInfoPtr->preemptiveModeActivated = GT_FALSE;
        /* try to obtain preemption anyway */
...
/* list of cases for Low Latency */
static const PRV_IRONMAN_PCA_ARBITER_RESOURCE_FILTER_STC
    prvCpssDxChPortDpIronmanRxLowLatencyArr[] =
{
    { 32, 1000, 0, 7/*express,preemptive,regular*/, HL_8X1G/*flags mask and pattern*/}
};
static const GT_U32 prvCpssDxChPortDpIronmanRxLowLatencyArrSize =
    (sizeof(prvCpssDxChPortDpIronmanRxLowLatencyArr)
     / sizeof(prvCpssDxChPortDpIronmanRxLowLatencyArr[0]));
...
)
{
    ...
    PRV_IRONMAN_PCA_ARBITER_RESOURCE_KEY_STC channelResourceKey;
    GT_U32                                   ii;
    GT_U32     globalDmaNum;
    ...
    if (channelInfo.speedInMbps <=  5000)
        {minCtByteCount = 0x101;}
    else
        {minCtByteCount = 0x100;}

    prvCpssDxChPortDpIronmanPcaPizzaArbiterNewChannelKeyGet(
        devNum, &channelInfo, &channelResourceKey);

    for (ii = 0; (ii < prvCpssDxChPortDpIronmanRxLowLatencyArrSize); ii++)
    {
        if (prvCpssDxChPortDpIronmanPcaPizzaArbiterChannelFilterMatch(
            &(prvCpssDxChPortDpIronmanRxLowLatencyArr[ii]), &channelResourceKey))
        {
            minCtByteCount = 0x100;
            break;
        }
    ...
    rc = prvCpssDxChHwPpDmaLocalNumInDpToGlobalNumConvert(
        devNum, 0/*unitIndex*/, channelInfo.channelNum, &globalDmaNum);
    if (rc != GT_OK)
    {
        return rc;
    }
    ...
    /* source physical port should be configured also for not preemptive      */
    ...
    if (channelInfo.preemptiveModeActivated)
    {
        ...
        if (preemptiveInfo.speedInMbps <=  5000)
            {minCtByteCount = 0x101;}
        else
            {minCtByteCount = 0x100;}

        prvCpssDxChPortDpIronmanPcaPizzaArbiterNewChannelKeyGet(
            devNum, &preemptiveInfo, &channelResourceKey);
        ...
        rc = prvCpssDxChHwPpDmaLocalNumInDpToGlobalNumConvert(
            devNum, 0/*unitIndex*/, preemptiveInfo.channelNum, &globalDmaNum);
        if (rc != GT_OK)
        {
            return rc;
        }
        ...
        /*cut through should be disabled on preemptive channel*/
        rc = prvCpssDxChCutThroughSip6RxChannelEnableSet(
            devNum, globalDmaNum, GT_FALSE/*enable*/);
        if (rc != GT_OK)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(
                rc,"error in prvCpssDxChCutThroughSip6RxChannelEnableSet globalDmaNum %d\n",
                globalDmaNum);
        }
...
)
{
    ...
    /*under system recovery return here */
    if (systemUnderRecovery == GT_TRUE )
    {
        return GT_OK;
    }
...
)
{
    ...
    rc = prvCpssDxChPortDpIronmanPortMiscConfigure(
        devNum, portNum, ifMode, portSpeed);
    if (rc != GT_OK)
    {
        return rc;
    }
...
/**
* @internal prvCpssDxChPortDpIronmanOptionFlagsBmpSet function
* @endinternal
*
* @brief    Set bitmap of option flags.
*
* @note   APPLICABLE DEVICES:     Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon;  AC5P; AC5X; Harrier.
*
* @param[in] devNum                 - physical device number
* @param[in] optionFlagsBmp         - bitmap of option flags.
*
* @retval none
*/
void prvCpssDxChPortDpIronmanOptionFlagsBmpSet
(
    IN    GT_U8                  devNum,
    IN    GT_U32                 optionFlagsBmp
)
{
    PRV_CPSS_DXCH_PP_MAC(devNum)->port.sip6_30_dpInfoPtr[0]->optionFlagsBmp = optionFlagsBmp;
}

/**
* @internal prvCpssDxChPortDpIronmanOptionFlagsBmpGet function
* @endinternal
*
* @brief    Get bitmap of option flags.
*
* @note   APPLICABLE DEVICES:     Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon;  AC5P; AC5X; Harrier.
*
* @param[in]  devNum                 - physical device number
*
* @retval    - bitmap of option flags.
*/
GT_U32 prvCpssDxChPortDpIronmanOptionFlagsBmpGet
(
    IN    GT_U8                  devNum
)
{
    return PRV_CPSS_DXCH_PP_MAC(devNum)->port.sip6_30_dpInfoPtr[0]->optionFlagsBmp;
}

/* DP_WIP disable/enable */
/**
* @internal prvCpssDxChPortDpIronmanPortDWIPEnableSet function
* @endinternal
*
* @brief    Enable/disable DWIP feature on the port.
*
* @note   APPLICABLE DEVICES:     Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon;  AC5P; AC5X; Harrier.
*
...
* @retval GT_BAD_STATE             - other channel slots overlapped
*/
GT_STATUS prvCpssDxChPortDpIronmanPortDWIPEnableSet
(
    IN    GT_U8                                devNum,
    IN    GT_PHYSICAL_PORT_NUM                 portNum,
    IN    GT_BOOL                              enable
)
{
    ...
    regAddr = regsAddrPtr->sip6_txDMA[0].configs.channelConfigs.rateLimiterEnable[channelInfo.channelNum];
    rc = prvCpssDrvHwPpReadRegister(devNum, regAddr, &regOldData);
    if (rc != GT_OK)
    {
        return rc;
    }
    if (enable == GT_FALSE)
    {
        regNewData = regOldData & (~ (1 << 3));
    }
    else
    {
        regNewData = regOldData | (1 << 3);
    }
    if (regNewData != regOldData)
    {
        rc = prvCpssDrvHwPpWriteRegister(devNum, regAddr, regNewData);
        if (rc != GT_OK)
        {
            return rc;
        }
    ...
    if (GT_FALSE != channelInfo.preemptiveModeActivated)
    {
        ...
        regAddr = regsAddrPtr->sip6_txDMA[0].configs.channelConfigs.rateLimiterEnable[preemptiveInfo.channelNum];
        rc = prvCpssDrvHwPpReadRegister(devNum, regAddr, &regOldData);
        if (rc != GT_OK)
        {
            return rc;

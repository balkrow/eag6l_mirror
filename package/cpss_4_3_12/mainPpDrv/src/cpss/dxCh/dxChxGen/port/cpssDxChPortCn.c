...
)
{
    ...
    GT_U32 alphaHwValue;
    GT_U32 tableIndex ;
    GT_U32 hwArray[11]; /* AAS devices have 11 words for the entry */
...
)
{
    ...
    /*sanity*/
    if(profileSet>=PRV_CPSS_DXCH_SIP_5_PORT_TX_DROP_PROFILE_MAX_NUM_CNS)
    {
         CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
)
{
    ...
    if(PRV_CPSS_SIP_6_CHECK_MAC(devNum) == GT_TRUE)
    {
        ...
        rc = prvCpssHwPpSetRegField(devNum, regAddr, offset, size, fbCalcCfgPtr->fbLsb);
...
)
{
    ...
    if(PRV_CPSS_SIP_6_CHECK_MAC(devNum) == GT_TRUE)
    {
        ...
        else
        {
            regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->PREQ.fbMin;
            rc = prvCpssHwPpReadRegister(devNum, regAddr, &value);
            fbCalcCfgPtr->fbLsb = U32_GET_FIELD_MAC(value, 20, 4);
        }
...
)
{
    ...
    if (availableBuff >=(GT_U32)(1<<size))
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, LOG_ERROR_NO_MSG);
    }
    ...
    /* <CN Available Buffers> register   */
    return prvCpssHwPpSetRegField(devNum, regAddr, 0, size,
                                  availableBuff);
}
...
)
{
  ...
  /* Set <cn_available_buffs> field of */
  /* <CN Available Buffers> register   */
  rc = prvCpssHwPpGetRegField(devNum, regAddr, 0, size, &regValue);
  if (rc != GT_OK)
  {
    return rc;
  }
...
{
    GT_U32  regAddr;    /* register address */
    GT_U32  maxVal,fieldLenght;
    GT_U32  numberOfPools;
    ...
    regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->PREQ.qcnPoolAvailableBuffers[poolNum];

    /* Set <cn_pool_available_buffs> field of */
    /* <CN Pool Available Buffers> register   */
    return prvCpssHwPpSetRegField(devNum, regAddr, 0, fieldLenght,
                                  poolAvailableBuff);
}
...
)
{
  ...
  /* Set <cn_pool_available_buffs> field of */
  /* <CN Pool Available Buffers> register   */
  rc = prvCpssHwPpGetRegField(devNum, regAddr, 0, fieldLenght, &regValue);
  if (rc != GT_OK)
  {
    return rc;
  }
...
)
{
    ...
    thresholdNumOfBits = (PRV_CPSS_SIP_7_CHECK_MAC(devNum))?23:20;
    ...
    SIP6_PREQ_PORT_PROFILE_FIELD_SET_MAC(devNum,regData,SIP6_PREQ_PORT_PROFILE_TABLE_FIELDS_CN_AWARE_E,value);
    SIP6_PREQ_PORT_PROFILE_FIELD_SET_MAC(devNum,regData,SIP6_PREQ_PORT_PROFILE_TABLE_FIELDS_QCN_LIMIT_E,cnProfileCfgPtr->threshold);
    SIP6_PREQ_PORT_PROFILE_FIELD_SET_MAC(devNum,regData,SIP6_PREQ_PORT_PROFILE_TABLE_FIELDS_PORT_QCN_DYNAMIC_FACTOR_E,alphaHwValue);
...
)
{
    ...
    SIP6_PREQ_PORT_PROFILE_FIELD_GET_MAC(devNum,regData,SIP6_PREQ_PORT_PROFILE_TABLE_FIELDS_CN_AWARE_E,value);
    SIP6_PREQ_PORT_PROFILE_FIELD_GET_MAC(devNum,regData,SIP6_PREQ_PORT_PROFILE_TABLE_FIELDS_QCN_LIMIT_E,cnProfileCfgPtr->threshold);
    SIP6_PREQ_PORT_PROFILE_FIELD_GET_MAC(devNum,regData,SIP6_PREQ_PORT_PROFILE_TABLE_FIELDS_PORT_QCN_DYNAMIC_FACTOR_E,alphaHwValue);

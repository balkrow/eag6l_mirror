...
/**
********************************************************************************
* @file cpssDxChPortInterlaken.c
*
* @brief CPSS DxCh implementation for Interlaken port configuration.
*
* @version   16
********************************************************************************
*/
...
/**
* @internal prvCpssDxChPortIlknPrMemInit function
* @endinternal
*
* @brief   Init internal DB for PR memory management.
*
...
* @retval GT_NO_RESOURCE           - not enough free memory
* @retval GT_BAD_STATE             - algorithm failed
*/
...
/**
* @internal prvCpssDxChPortIlknPrChunkAlloc function
* @endinternal
*
* @brief   Allocate chunk of PR memory.
*
* @note   APPLICABLE DEVICES:      Bobcat2.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
* @param[in] channelId                - channel number;
* @param[in] size                     -  of required memory.
*
* @param[out] offsetPtr                - offset of chunk in memory
*
* @retval GT_OK                    - on success
* @retval GT_NO_RESOURCE           - not enough free memory
* @retval GT_BAD_STATE             - algorithm failed
...
/**
* @internal prvCpssDxChPortIlknPrChunkFree function
* @endinternal
*
* @brief   Free chunk of PR memory and also try some defragmentation.
*
* @note   APPLICABLE DEVICES:      Bobcat2.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
...
*
* @retval GT_OK                    - on success
* @retval GT_NOT_FOUND             - chunk of channel not found
*/
...
/**
* @internal internal_cpssDxChPortInterlakenCounterGet function
* @endinternal
*
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_LION2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);
...
/**
* @internal internal_cpssDxChPortIlknChannelSpeedResolutionSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPortIlknChannelSpeedResolutionGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPortIlknChannelSpeedSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPortIlknChannelSpeedGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChPortIlknChannelEnableSet function
* @endinternal
*
...
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameter
* @retval GT_NOT_INITIALIZED       - channel speed not defined yet
* @retval GT_HW_ERROR              - on hardware error
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*
* @note Pay attention: can't enable channel which speed not configured yet.
*
*/
...
/**
* @internal internal_cpssDxChPortIlknChannelEnableGet function
* @endinternal
*

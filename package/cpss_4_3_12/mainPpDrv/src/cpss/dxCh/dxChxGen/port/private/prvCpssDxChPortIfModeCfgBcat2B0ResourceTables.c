...
/* added support of 5000 speed                                */
/* all values interpolated from neighbours in the same tables */

/*-------------------------------------------------------*
 * Bobcat2 B0 Generated Tables Start                     *
 *-------------------------------------------------------*/
static const PRV_CPSS_DXCH_SPEED_PLACE_STC prv_speedPlaceArr[] =
{
    ...
    ,{ CPSS_PORT_SPEED_20000_E  ,  20000,   6 }
    ,{ CPSS_PORT_SPEED_40000_E  ,  40000,   7 }
    ,{ CPSS_PORT_SPEED_47200_E  ,  48000,   8 }
    ,{ CPSS_PORT_SPEED_100G_E   , 100000,   9 }
};

static const PRV_CPSS_DXCH_CORECLOCK_PLACE_STC prv_coreClockPlaceArr[] =
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_TxQDescriptorCredit_Arr[6][10] =
{
     {      0,   1000,   2500,   5000,  10000,  12000,  20000,  40000,  48000, 100000 }
    ,{    175,      3,      5,      7,     12,     11,     19,     33,     32,     59 }
    ,{    250,      2,      3,      5,      8,      7,     13,     23,     22,     42 }
    ,{    360,      2,      3,      4,      7,      6,     10,     17,     16,     30 }
    ,{    400,      2,      3,      4,      6,      6,      9,     15,     15,     27 }
    ,{    520,      2,      3,      4,      5,      5,      8,     13,     12,     21 }
};
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_burstAlmostFullThreshold_Arr[6][10] =
{
     {      0,   1000,   2500,   5000,  10000,  12000,  20000,  40000,  48000, 100000 }
    ,{    175,      2,      3,      5,      7,      7,     11,     18,     21,     39 }
    ,{    250,      2,      2,      3,      4,      5,      7,     12,     15,     27 }
    ,{    360,      2,      2,      3,      4,      4,      6,      9,     11,     20 }
    ,{    400,      2,      2,      3,      4,      4,      5,      8,     10,     18 }
    ,{    520,      2,      2,      2,      3,      3,      4,      7,      8,     14 }
};
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_burstFullThreshold_Arr[6][10] =
{
     {      0,   1000,   2500,   5000,  10000,  12000,  20000,  40000,  48000, 100000 }
    ,{    175,      3,      5,      7,     12,     11,     19,     33,     32,     59 }
    ,{    250,      2,      3,      5,      8,      7,     13,     23,     22,     42 }
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_TxFIFOHeaderCreditThreshold_Arr[6][10] =
{
     {      0,   1000,   2500,   5000,  10000,  12000,  20000,  40000,  48000, 100000 }
    ,{    175,      5,     10,     25,     49,     48,     96,    190,    185,    385 }
    ,{    250,      3,      8,     18,     34,     33,     68,    134,    130,    270 }
    ,{    360,      2,      5,     14,     24,     24,     47,     93,     90,    187 }
    ,{    400,      2,      5,     12,     22,     21,     43,     84,     82,    169 }
    ,{    520,      2,      4,      9,     18,     17,     33,     66,     63,    130 }
};
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_TxFIFOPayloadCreditThreshold_Arr[6][10] =
{
     {      0,   1000,   2500,   5000,  10000,  12000,  20000,  40000,  48000, 100000 }
    ,{    175,      7,     13,     27,     58,     59,    113,    223,    224,    465 }
    ,{    250,      5,     11,     21,     41,     41,     80,    157,    158,    326 }
    ,{    360,      4,      7,     14,     29,     30,     56,    110,    110,    226 }
    ,{    400,      4,      7,     13,     27,     27,     51,     99,    100,    205 }
    ,{    520,      4,      6,     11,     22,     22,     40,     78,     77,    158 }
};
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXFIFO_SCDMA_PayloadStartTransmThreshold_Arr[6][10] =
{
     {      0,   1000,   2500,   5000,  10000,  12000,  20000,  40000,  48000, 100000 }
    ,{    175,      2,      3,      5,      9,     11,     17,     33,     39,     80 }
    ,{    250,      2,      3,      4,      7,      8,     12,     23,     28,     56 }
    ,{    360,      2,      2,      3,      5,      6,      9,     17,     20,     39 }
    ,{    400,      2,      2,      3,      5,      6,      8,     15,     18,     36 }
    ,{    520,      2,      2,      2,      4,      5,      7,     12,     14,     28 }
};
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 ETH_TXFIFO_SCDMA_PayloadStartTransmThreshold_Arr[6][10] =
{
     {      0,   1000,   2500,   5000,  10000,  12000,  20000,  40000,  48000, 100000 }
    ,{    175,    240,    240,    240,    240,    240,    240,    240,    240,    240 }
    ,{    250,    240,    240,    240,    240,    240,    240,    240,    240,    240 }
    ,{    360,    240,    240,    240,    240,    240,    240,    240,    240,    240 }
    ,{    400,    240,    240,    240,    240,    240,    240,    240,    240,    240 }
    ,{    520,    240,    240,    240,    240,    240,    240,    240,    240,    240 }
};
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_TxQDescriptorCredit_gran_1G_Arr[131][6] =
{
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_burstAlmostFullThreshold_gran_1G_Arr[131][6] =
{
     {      0,    175,    250,    360,    400,    520 }
    ,{   1000,      4,      4,      4,      4,      3 }
    ,{   2000,      5,      5,      5,      5,      3 }
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_burstFullThreshold_gran_1G_Arr[131][6] =
{
     {      0,    175,    250,    360,    400,    520 }
    ,{   1000,      7,      6,      6,      6,      4 }
    ,{   2000,      9,      9,      8,      8,      6 }
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_TxFIFOHeaderCreditThreshold_gran_1G_Arr[131][6] =
{
     {      0,    175,    250,    360,    400,    520 }
    ,{   1000,      6,      4,      4,      4,      2 }
    ,{   2000,     10,      8,      5,      5,      5 }
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXDMA_SCDMA_TxFIFOPayloadCreditThreshold_gran_1G_Arr[131][6] =
{
     {      0,    175,    250,    360,    400,    520 }
    ,{   1000,      8,      6,      6,      6,      4 }
    ,{   2000,     13,     11,      7,      7,      7 }
 ...
 *-----------------------------------------------------------------------------------*/
static const GT_U32 TXFIFO_SCDMA_PayloadStartTransmThreshold_gran_1G_Arr[131][6] =
{
     {      0,    175,    250,    360,    400,    520 }
    ,{   1000,      2,      2,      2,      2,      2 }
    ,{   2000,      3,      3,      2,      2,      2 }
...
)
{
    ...
    for (i = 0 ; i < sizeof(prv_speedPlaceArr)/sizeof(prv_speedPlaceArr[0]); i ++)
    {
        ...
        {
            speedIdx = i+1;
            speedMbps = prv_speedPlaceArr[i].speedMbps;
            break;
        }
    }
...
GT_STATUS prvCpssDxChBcat2_B0_Port_TxQManualCreditSet
(
...
{
    PRV_SHARED_PRV_DB_VAR(prv_txqPortManualCredit.portNum)     = portNum;
    PRV_SHARED_PRV_DB_VAR(prv_txqPortManualCredit.speed)       = speed;
    PRV_SHARED_PRV_DB_VAR(prv_txqPortManualCredit.txqCredits)  = txqCredits;
    return GT_OK;
}
...
)
{
     ...
     *----------------------------------------------------------------------------*/
    PRV_DXCH_BCAT2_RESOURCE_LIST_Append(
        resConfigPtr,BC2_PORT_FLD_RXDMA_IfWidth, portMapShadowPtr->portMap.rxDmaNum,
        PRV_SHARED_PRV_DB_VAR(prvSpeed_2_rxDmaIFWidth_ARR[speed]));
    if (portMapShadowPtr->portMap.trafficManagerEn == GT_FALSE)
    {
         ...
         *------------------------------------------------------------------------------*/
        if (portNum == PRV_SHARED_PRV_DB_VAR(prv_txqPortManualCredit.portNum)
             && speed == PRV_SHARED_PRV_DB_VAR(prv_txqPortManualCredit.speed))
        {
            PRV_DXCH_BCAT2_RESOURCE_LIST_Append(
                resConfigPtr,BC2_PORT_FLD_TXDMA_SCDMA_TxQDescriptorCredit,
                portMapShadowPtr->portMap.txDmaNum,
                PRV_SHARED_PRV_DB_VAR(prv_txqPortManualCredit.txqCredits));
        }
        else
        {
        ...
        *--------------------------------------------------------*/
        ...
        {
            PRV_DXCH_BCAT2_RESOURCE_LIST_Append(
                resConfigPtr,BC2_PORT_FLD_TXFIFO_IfWidth,
                portMapShadowPtr->portMap.txFifoPortNum,
                PRV_SHARED_PRV_DB_VAR(prvSpeed_2_txFifoOutGoungBusWidth_ARR[speed]));
        }
        else /* CPU (DMA-72) has 8B out-going bus width  */
        {
            PRV_DXCH_BCAT2_RESOURCE_LIST_Append(
                resConfigPtr,BC2_PORT_FLD_TXFIFO_IfWidth,
                portMapShadowPtr->portMap.txFifoPortNum,
                PRV_CPSS_TxFIFO_OutGoungBusWidth_8B_E);
        }
        PRV_DXCH_BCAT2_RESOURCE_LIST_Append(
            resConfigPtr,BC2_PORT_FLD_TXFIFO_payloadThreshold,
            portMapShadowPtr->portMap.txFifoPortNum,
            TXFIFO_SCDMA_PayloadStartTransmThreshold_Arr[coreClockIdx][speedIdx]);
    }
    else
    {
#if 0
        ...
        *--------------------------------------------------------*/
        if (portMapShadowPtr->portMap.mappingType == CPSS_DXCH_PORT_MAPPING_TYPE_ETHERNET_MAC_E)
        {
            ...
            PRV_DXCH_BCAT2_RESOURCE_LIST_Append(
                resConfigPtr, BC2_PORT_FLD_Eth_TXFIFO_IfWidth,          ethTxFifoMapping,
                PRV_SHARED_PRV_DB_VAR(prvSpeed_2_ethTxFifoOutGoungBusWidth_ARR[speed]));
            PRV_DXCH_BCAT2_RESOURCE_LIST_Append(
                resConfigPtr, BC2_PORT_FLD_Eth_TXFIFO_shifterThreshold, ethTxFifoMapping,
                PRV_SHARED_PRV_DB_VAR(prvSpeed_2_ethTxFifoShifterThreshold_ARR[speed]));
            PRV_DXCH_BCAT2_RESOURCE_LIST_Append(
                resConfigPtr, BC2_PORT_FLD_Eth_TXFIFO_payloadThreshold, ethTxFifoMapping,
                ETH_TXFIFO_SCDMA_PayloadStartTransmThreshold_Arr[coreClockIdx][speedIdx]);
        }
#if 0
        /*----------------------------------------------
...
static const PRV_CPSS_DXCH_BC2_SPEED_2_RES_STC prv_bc2_B0_speed2resourceInitList[] =
{
...
)
{
    ...
    {
        PRV_SHARED_PRV_DB_VAR(prvSpeed_2_rxDmaIFWidth_ARR[i]) = PRV_CPSS_DXCH_INVALID_RESOURCE_CNS;
        PRV_SHARED_PRV_DB_VAR(prvSpeed_2_txFifoOutGoungBusWidth_ARR[i])  = PRV_CPSS_DXCH_INVALID_RESOURCE_CNS;
        PRV_SHARED_PRV_DB_VAR(prvSpeed_2_ethTxFifoShifterThreshold_ARR[i]) = PRV_CPSS_DXCH_INVALID_RESOURCE_CNS;
        PRV_SHARED_PRV_DB_VAR(prvSpeed_2_ethTxFifoOutGoungBusWidth_ARR[i]) = PRV_CPSS_DXCH_INVALID_RESOURCE_CNS;
    }
    for (i = 0 ; prv_bc2_B0_speed2resourceInitList[i].speed != CPSS_PORT_SPEED_NA_E; i++)
    {
        PRV_SHARED_PRV_DB_VAR(prvSpeed_2_rxDmaIFWidth_ARR             [prv_bc2_B0_speed2resourceInitList[i].speed]) =
            prv_bc2_B0_speed2resourceInitList[i].rxDmaIfWidth;
        PRV_SHARED_PRV_DB_VAR(prvSpeed_2_txFifoOutGoungBusWidth_ARR   [prv_bc2_B0_speed2resourceInitList[i].speed]) =
            prv_bc2_B0_speed2resourceInitList[i].txFifoOutGoingBusWidth;
        PRV_SHARED_PRV_DB_VAR(prvSpeed_2_ethTxFifoShifterThreshold_ARR[prv_bc2_B0_speed2resourceInitList[i].speed]) =
            prv_bc2_B0_speed2resourceInitList[i].ethTxFifoShifterThreshold;
        PRV_SHARED_PRV_DB_VAR(prvSpeed_2_ethTxFifoOutGoungBusWidth_ARR[prv_bc2_B0_speed2resourceInitList[i].speed]) =
            prv_bc2_B0_speed2resourceInitList[i].ethTxFifoOutGoingBusWidth;
    }
    return GT_OK;
}

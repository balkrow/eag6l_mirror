...
/**
* @internal prvCpssDxChPortSyncEtherRecoveryClkConfigSetForSip6_30 function
* @endinternal
*
* @brief   Function configures the recovery clock enable/disable state and sets
*         its source portNum.
...
*
*/
static GT_STATUS prvCpssDxChPortSyncEtherRecoveryClkConfigSetForSip6_30
(
    IN  GT_U8                                           devNum,
    IN  CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK_TYPE_ENT recoveryClkType,
    IN  GT_BOOL                                         enable,
...
{
    GT_STATUS                   rc;           /* returned status */
    GT_U32                      regField = 0;     /* register field */
    GT_U32                      regValue;
    GT_U32                      serdes;         /* loop index */
    GT_U32                      serdesIdx;      /* current serdes index */
    GT_U32                      maxSerdesNumber;/* maximal serdes number */
    ...
    if (GT_FALSE == enable)
    {
        /* Write 1 to <rcvrd_clk0_local_clk_disabled> or <rcvrd_clk1_local_clk_disabled> */
        if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK0_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK0_LOCAL_CLK_DISABLED_E;
        }
        else if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK1_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK1_LOCAL_CLK_DISABLED_E;
        }
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdesIdx].serdesNum, SERDES_UNIT, regField, 1, NULL));

        /* Write 0 to <sync_e0_mux_sel> or <sync_e1_mux_sel> */
        if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK0_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_SYNC_E0_MUX_SEL_E;
        }
        else if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK1_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_SYNC_E1_MUX_SEL_E;
        }
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdesIdx].serdesNum, SERDES_UNIT, regField, 0, NULL));

        /* Write 0 to <sync_e0_lane_sel> or <sync_e1_lane_sel> */
        if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK0_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_SYNC_E0_LANE_SEL_E;
        }
        else if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK1_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_SYNC_E1_LANE_SEL_E;
        }
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdesIdx].serdesNum, SERDES_UNIT, regField, 0, NULL));
    }
    else /* GT_TRUE == enable */
    {
        for ( serdes = 0 ; serdes < maxSerdesNumber ; serdes++ )
        {
            ...
            /* Read <sync_e0_mux_sel> or <sync_e1_mux_sel> */
            if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK0_E == recoveryClkType)
            {
                regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_SYNC_E0_MUX_SEL_E;
            }
            ...
            CHECK_STATUS(genUnitRegisterFieldGet(devNum, 0, hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdesIdx].serdesNum, SERDES_UNIT, regField, &regValue, NULL));
            if (regValue != 0)
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_STATE, LOG_ERROR_NO_MSG);
            }
        ...
        /* Write to <sync_e0_lane_sel> or <sync_e1_lane_sel> */
        if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK0_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_SYNC_E0_LANE_SEL_E;
        }
        ...
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdesIdx].serdesNum, SERDES_UNIT, regField,
                                                                            hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdesIdx].internalLane, NULL));

        /* Write 1 to <sync_e0_mux_sel> or <sync_e1_mux_sel> */
        if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK0_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_SYNC_E0_MUX_SEL_E;
        }
        ...
        /* Write 1 to <rcvrd_clk0_local_clk_div_reset_> or <rcvrd_clk1_local_clk_div_reset_> */
        if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK0_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK0_LOCAL_CLK_DIV_RESET__E;
        }
        else if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK1_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK1_LOCAL_CLK_DIV_RESET__E;
        }
        CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdesIdx].serdesNum, SERDES_UNIT, regField, 1, NULL));

        /* Write 0 to <rcvrd_clk0_local_clk_disabled> or <rcvrd_clk1_local_clk_disabled> */
        if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK0_E == recoveryClkType)
        {
            regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK0_LOCAL_CLK_DISABLED_E;
        }
...
)
{
    ...
    {
        return prvCpssDxChPortSyncEtherRecoveryClkConfigSetForSip6_30(devNum,
                                                                      recoveryClkType,
                                                                      enable,
                                                                      portNum,
                                                                      laneNum);
...
/**
* @internal prvCpssDxChPortSyncEtherRecoveryClkConfigGetForSip6_30 function
* @endinternal
*
* @brief   Function gets the recovery clock enable/disable state and its source
*         portNum.
...
*
*/
static GT_STATUS prvCpssDxChPortSyncEtherRecoveryClkConfigGetForSip6_30
(
    IN  GT_U8                                           devNum,
    IN  CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK_TYPE_ENT recoveryClkType,
    OUT GT_BOOL                                         *enablePtr,
    ...
    *enablePtr = GT_FALSE;
    ...
    for (portNum = 0; portNum < CPSS_MAX_PORTS_NUM_CNS; portNum++)
    {
        ...
        for (serdes = 0; serdes < portParams.numActiveLanes; serdes++)
        {
            ...
            CHECK_STATUS(genUnitRegisterFieldGet(devNum, 0, hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdes].serdesNum, SERDES_UNIT, regField, &regValue, NULL));

            if (regValue != 0)
            {
                /* Read <sync_e0_lane_sel> or <sync_e1_lane_sel> */
                if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLK0_E == recoveryClkType)
                {
                    regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_SYNC_E0_LANE_SEL_E;
                }
                ...
                *enablePtr = GT_TRUE;
                ...
                /* global serdes index calculate */
                regValue = regValue + (portParams.activeLaneList[serdes] & 0xFFFFFFFC);
...
)
{
    ...
    if(PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
    {
        return prvCpssDxChPortSyncEtherRecoveryClkConfigGetForSip6_30(
                            devNum,recoveryClkType,enablePtr,portNumPtr,laneNumPtr);
    }
...
/**
* @internal prvCpssDxChPortSyncEtherRecoveryClkDividerValueSetForSip6_30 function
* @endinternal
*
* @brief   Function sets recovery clock divider value.
*
...
* @retval GT_NOT_SUPPORTED         - on not supported port type
*/
static GT_STATUS prvCpssDxChPortSyncEtherRecoveryClkDividerValueSetForSip6_30
(
    IN  GT_U8                                               devNum,
    IN  GT_PHYSICAL_PORT_NUM                                portNum,
    IN  GT_U32                                              laneNum,
...
)
{
    ...
    /* Write 1 to <rcvrd_clk0_local_clk_disabled> or <rcvrd_clk1_local_clk_disabled> */
    if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLOCK_SELECT_0_E == clockSelect)
    {
        regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK0_LOCAL_CLK_DISABLED_E;
    }
    else if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLOCK_SELECT_1_E == clockSelect)
    {
        regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK1_LOCAL_CLK_DISABLED_E;
    }
    CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdesIdx].serdesNum, SERDES_UNIT, regField, 1, NULL));

    /* Write regValue to  <rcvrd_clk0_div> or <rcvrd_clk1_div> */
    if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLOCK_SELECT_0_E == clockSelect)
    {
        regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK0_DIV_E;
    }
    else if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLOCK_SELECT_1_E == clockSelect)
    {
        regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK1_DIV_E;
    }
    CHECK_STATUS(genUnitRegisterFieldSet(devNum, 0, hwsDeviceSpecInfo[devNum].serdesInfo.serdesesDb[serdesIdx].serdesNum, SERDES_UNIT, regField, regValue, NULL));
...
)
{
    ...
    if(PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
    {
        return prvCpssDxChPortSyncEtherRecoveryClkDividerValueSetForSip6_30(
...
/**
* @internal prvCpssDxChPortSyncEtherRecoveryClkDividerValueGetForSip6_30 function
* @endinternal
*
* @brief   Function gets recovery clock divider value.
*
...
* @retval GT_NOT_SUPPORTED         - on not supported port type
*/
static GT_STATUS prvCpssDxChPortSyncEtherRecoveryClkDividerValueGetForSip6_30
(
    IN  GT_U8                                               devNum,
    IN  GT_PHYSICAL_PORT_NUM                                portNum,
    IN  GT_U32                                              laneNum,
...
)
{
    ...
    /* Read <rcvrd_clk0_div> or <rcvrd_clk1_div> */
    if (CPSS_DXCH_PORT_SYNC_ETHER_RECOVERY_CLOCK_SELECT_0_E == clockSelect)
    {
        regField = IRONMAN_SDW_COMMON_GENERAL_CONTROL_1_RCVRD_CLK0_DIV_E;
    }
...
)
{
    ...
    if(PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
    {
        return prvCpssDxChPortSyncEtherRecoveryClkDividerValueGetForSip6_30(

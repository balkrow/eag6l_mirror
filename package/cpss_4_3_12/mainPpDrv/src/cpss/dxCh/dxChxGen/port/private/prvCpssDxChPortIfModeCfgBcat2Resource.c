...
{
    GT_U32 coreClock;
    const PRV_CPSS_SPEED_2_CREDIT_STC * listPtr;
}PRV_CPSS_CORECLOCK_2_SPEED2CREDIT_STC;


static const PRV_CPSS_SPEED_2_CREDIT_STC clock_175_MHz_speed_2_creditList[] =
{
...
static const PRV_CPSS_SPEED_2_CREDIT_STC clock_250_MHz_speed_2_creditList[] =
{
...
static const PRV_CPSS_SPEED_2_CREDIT_STC clock_360_MHz_speed_2_creditList[] =
{
     {   CPSS_PORT_SPEED_10_E,    2 }
    ,{  CPSS_PORT_SPEED_100_E,    2 }
    ,{ CPSS_PORT_SPEED_1000_E,    2 }
...
static const PRV_CPSS_SPEED_2_CREDIT_STC clock_520_MHz_speed_2_creditList[] =
{
     {   CPSS_PORT_SPEED_10_E,    2 }
    ,{  CPSS_PORT_SPEED_100_E,    2 }
    ,{ CPSS_PORT_SPEED_1000_E,    2 }
...
static const PRV_CPSS_CORECLOCK_2_SPEED2CREDIT_STC clock_MHz_2_speed2creditList_List[] =
{
...
)
{
    ...
    const PRV_CPSS_CORECLOCK_2_SPEED2CREDIT_STC * clock2listPtr;
    const PRV_CPSS_SPEED_2_CREDIT_STC           * speed2creditListPtr;
...
/**
* @internal prvCpssDxChPort_Bcat2A0_ResourcesConfig function
* @endinternal
*

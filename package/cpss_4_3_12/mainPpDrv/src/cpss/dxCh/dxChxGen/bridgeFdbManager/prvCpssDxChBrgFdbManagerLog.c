...
)
{
    ...
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, vportInfo, CPSS_DXCH_BRG_FDB_MANAGER_VPORT_MODE_INFO_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_BRG_FDB_MANAGER_VPORT_MODE_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_BRG_FDB_MANAGER_VPORT_MODE_INFO_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, enableVPortMode);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfPhyPortsToUse);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, maxNumOfVPortsToUse);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_deleteEntry = {
     "deleteEntry", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_BOOL)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_getAgeStatusFromHw = {
     "getAgeStatusFromHw", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_BOOL)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_indexesNumToCheck = {
     "indexesNumToCheck", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChBrgFdbManagerEntryGet_PARAMS[] =  {
    &DX_IN_GT_U32_fdbManagerId,
    &DX_IN_GT_BOOL_getAgeStatusFromHw,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChBrgFdbManagerEntryTempGetNext_PARAMS[] =  {
    &DX_IN_GT_U32_fdbManagerId,
    &DX_IN_GT_BOOL_getFirst,
    &DX_INOUT_GT_U32_PTR_entryIndexPtr,
    &DX_IN_GT_U32_indexesNumToCheck,
    &DX_OUT_CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_STC_PTR_entryPtr,
    &DX_IN_GT_BOOL_deleteEntry
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChBridgeFdbManagerLogLibDb[] = {
    ...
    {"cpssDxChBrgFdbManagerEntryGet", 3, cpssDxChBrgFdbManagerEntryGet_PARAMS, NULL},
    {"cpssDxChBrgFdbManagerEntryGetNext", 4, cpssDxChBrgFdbManagerEntryGetNext_PARAMS, NULL},
    ...
    {"cpssDxChBrgFdbManagerEntryTempGetNext", 6, cpssDxChBrgFdbManagerEntryTempGetNext_PARAMS, NULL},
};

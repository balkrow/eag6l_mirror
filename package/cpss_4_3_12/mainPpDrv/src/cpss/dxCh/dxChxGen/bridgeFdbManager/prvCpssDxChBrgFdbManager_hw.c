...
)
{
    ...
    else    /* sip7*/
    {
        ...
        else /* MAC/IPMC-ipv4/IPMC-ipv6 in CNC mode (non-XOR mode) */
        {
            supportFidBit15 = 1;
        }
    }
    ...
    /* age */
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_AGE_E, hwValue);
    ...
    /* MAC address */
    SIPx_FDB_HW_ENTRY_FIELD_MAC_ADDR_GET_MAC(hwDataArr, macAddr);
    cpssOsPrintf("Field Name - [mac], Field Value -[%d:%d:%d:%d:%d:%d]\n",
            macAddr[0], macAddr[1], macAddr[2], macAddr[3], macAddr[4], macAddr[5]);

    /* SA cmd */
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_SA_CMD_E, hwValue);
    cpssOsPrintf("Field Name - [SA CMD], Field Value -[%d]\n", hwValue);

    /* static */
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_IS_STATIC_E, hwValue);
    cpssOsPrintf("Field Name - [IS static], Field Value -[%d]\n", hwValue);

    /* DA cmd */
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_DA_CMD_E, hwValue);
    cpssOsPrintf("Field Name - [DA CMD], Field Value -[%d]\n", hwValue);

    /* Device ID */
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_DEV_ID_E, hwValue);
    cpssOsPrintf("Field Name - [Device ID], Field Value -[%d]\n", hwValue);

    /* SA Access Level */
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_SA_ACCESS_LEVEL_E, hwValue);
    cpssOsPrintf("Field Name - [SA Access], Field Value -[%d]\n", hwValue);

    /* DA Access Level */
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_DA_ACCESS_LEVEL_E, hwValue);
    ...
    if(fdbManagerPtr->entryAttrInfo.macEntryMuxingMode == CPSS_DXCH_BRG_FDB_MANAGER_MAC_ENTRY_MUXING_MODE_TAG1_VID_E)
    {
        ...
        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_ORIG_VID1_6_1_E, hwValue1);
        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_ORIG_VID1_11_7_E, hwValue2);
        cpssOsPrintf("Field Name - [VID1], Field Value -[%d:%d:%d]\n", hwValue, hwValue1, hwValue2);
    }
    else /* SRC ID */
    {
        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_SOURCE_ID_0_E, hwValue);
        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_SOURCE_ID_2_1_E, hwValue1);
        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_SOURCE_ID_6_3_E, hwValue2);
        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_SOURCE_ID_11_7_E, hwValue3);
        cpssOsPrintf("Field Name - [SRC_ID], Field Value -[%d:%d:%d:%d]\n", hwValue, hwValue1, hwValue2, hwValue3);
    }

    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_USER_DEFINED_10_7_E, hwValue);
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_USER_DEFINED_6_5_E, hwValue1);
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_USER_DEFINED_4_1_E, hwValue2);
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_USER_DEFINED_0_E, hwValue3);
    ...
    /* VIDX */
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_VIDX_E, hwValue);
    if(CPSS_GEN_SIP_7_E == genSip)
    {
        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr,SIP7_FDB_FDB_TABLE_FIELDS_VIDX_16_E,hwValue1);
        hwValue |= hwValue1 << 16;/* bit 16 */
    }
    cpssOsPrintf("Field Name - [vidx], Field Value -[%d]\n", hwValue);

    /* VIDX */
    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_IS_TRUNK_E, hwValue);
    cpssOsPrintf("Field Name - [IsTrunk], Field Value -[%d]\n", hwValue);
    if(hwValue)
    {
        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_TRUNK_NUM_E, hwValue);
        cpssOsPrintf("Field Name - [Trunk NO], Field Value -[%d]\n", hwValue);
    }
    else
    {
        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_EPORT_NUM_E, hwValue);
...
/**
* @internal prvCpssDxChFdbManagerAacAndFdbReadyStatusCheck function
* @endinternal
*
* @brief   Checks FDB HW access status before next AAC operation.
*
...
*
*/
static GT_STATUS prvCpssDxChFdbManagerAacAndFdbReadyStatusCheck
(
    IN GT_U8                    devNum
)
{
    ...
    /* FDB indirect access data register */
    regAddr = PRV_DXCH_REG1_UNIT_FDB_MAC(devNum).FDBCore.FDBIndirectAccess.FDBIndirectAccessCtrl;
...
)
{
    ...
    /* Check that FDB entry data is ready to be read */
    rc = prvCpssDxChFdbManagerAacAndFdbReadyStatusCheck(devNum);
    if(rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    /* sip7 not need the convert as for sip7 the convert done inside prvCpssDxChPortGroupWriteTableEntryMasked(...)
       and must not happen twice ! */
    if(!PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
...
)
{
    switch(fdbManagerPtr->entryAttrInfo.shadowType)
    {
        ...
        case CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_E:
            ...
            if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                *hwFormatType = PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP7_E;
            }
            else
            if(PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
            {
                *hwFormatType = PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP6_10_E;
            }
...
)
{
    ...
    SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(SIP_OF_HW(fdbManagerPtr),hwDataArr,
...
)
{
    ...
    switch(dstInterface_type)
    {
        case CPSS_INTERFACE_PORT_E:
            ...
            isVPort = IS_FDB_MANAGER_PORT_IN_VPORT_RANGE(fdbManagerPtr,dstInterfacePtr->devPort.portNum);
            break;
    ...
    if (isMacEntry)
    {
        /* multiple */
        hwValue = multiple;
        SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(genSip,hwDataArr,
        ...
        {/* bit40MacAddr=0 and entry is PORT or TRUNK */
            ...
            if(isVPort)
            {
                ...
                SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(genSip,hwDataArr,
                    ...
                    hwValue);
                hwValue = portTrunk & 0x3FFF;/*14 bits*/
                SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(genSip,hwDataArr,
    ...
    if (multiple == 1)
    {
        if(CPSS_GEN_SIP_7_E == genSip)
        {
            hwValue = vidx >> 16;/* bit 16 */
            SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(genSip,hwDataArr,
                SIP7_FDB_FDB_TABLE_FIELDS_VIDX_16_E,
                hwValue);

            /* VIDX */
            hwValue = vidx & 0xFFFF;/* bits 0..15 */
        }
        else
        {
            /* VIDX */
...
)
{
    ...
    hwValue = dbEntryKeyPtr->nhDataHwIndex % fdbManagerPtr->numOfBanks;
    SIP5_FDB_HW_ENTRY_FIELD_SET_MAC(hwKeyArr,
            SIP5_FDB_FDB_TABLE_FIELDS_NH_DATA_BANK_NUM_E,
            hwValue);

    /* set key hwIndex number in Data part of ipv6 (Used in case of HA) */
    hwValue = dbEntryDataPtr->keyHwIndex;
    SIP5_FDB_HW_ENTRY_FIELD_SET_MAC(hwDataArr,
            SIP5_FDB_FDB_TABLE_FIELDS_NH_KEY_HW_INDEX_E,
            hwValue);
    ...
    SIP5_FDB_HW_ENTRY_FIELD_SET_MAC( hwKeyArr,
            ...
            hwValue);
    hwValue = ((dbEntryDataPtr->ipAddr_127_106 << 10) | dbEntryKeyPtr->ipAddr_105_96);
    SIP5_FDB_HW_ENTRY_FIELD_SET_MAC( hwKeyArr,
...
)
{
    ...
    if(supportFidBit15)
    {
        hwValue = dbEntryPtr->fid >> 15;/* bit 15 */
        SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(genSip,hwDataArr,
                        SIP7_FDB_FDB_TABLE_FIELDS_FID_15_E,
                        hwValue);

        /* FID : bits 0..14 */
        hwValue = dbEntryPtr->fid & 0x7FFF;
    }
    else
    {
        /* FID */
    ...
    /* MAC address */
    SIPx_FDB_HW_ENTRY_FIELD_MAC_ADDR_SET_MAC(genSip,hwDataArr,
        dbEntryPtr->macAddr_low_32,
        dbEntryPtr->macAddr_high_16);
...
)
{
    ...
    /*SIP*/
    hwValue = dbEntryPtr->sipAddr;
    SIPx_FDB_HW_ENTRY_FIELD_SIP_ADDR_SET_MAC(genSip,hwDataArr,
        hwValue);

    /*DIP*/
    hwValue = dbEntryPtr->dipAddr;
    SIPx_FDB_HW_ENTRY_FIELD_DIP_ADDR_SET_MAC(genSip,hwDataArr,
        hwValue);
...
)
{
       ...
       CPSS_DXCH_BRG_FDB_MANAGER_UC_ROUTING_TYPE_NEXT_HOP_INFO_FULL_IN_FDB_ARP_PTR_E)
    {
        ...
        */
        ...
        if(genSip == CPSS_GEN_SIP_7_E)
        {
            hwValue = dbEntryPtr->ipUcCommonInfo.nextHopVlanId>>15;  /* bit 15 */
            SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(genSip,hwDataArr,
                SIP7_FDB_FDB_TABLE_FIELDS_UC_ROUTE_NEXT_HOP_EVLAN_15_E,
                hwValue);

            hwValue = dbEntryPtr->ipUcCommonInfo.nextHopVlanId & 0x7FFF ;/* first 15 bits */
        }
        else
        {
...
)
{
       ...
       CPSS_DXCH_BRG_FDB_MANAGER_UC_ROUTING_TYPE_NEXT_HOP_INFO_FULL_IN_FDB_ARP_PTR_E)
    {
        ...
        */
        ...
        if(genSip == CPSS_GEN_SIP_7_E)
        {
            hwValue = dbEntryDataPtr->ipUcCommonInfo.nextHopVlanId>>15;  /* bit 15 */
            SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(genSip,hwDataArr,
                SIP7_FDB_FDB_TABLE_FIELDS_UC_ROUTE_NEXT_HOP_EVLAN_15_E,
                hwValue);

            hwValue = dbEntryDataPtr->ipUcCommonInfo.nextHopVlanId & 0x7FFF ;/* first 15 bits */
        }
        else
        {
    ...
    /* valid */
    hwValue = 1;
    SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(genSip,hwKeyArr,
        SIP6_FDB_FDB_TABLE_FIELDS_VALID_E,
        hwValue);
...
)
{
    ...
    switch(fdbManagerPtr->entryAttrInfo.shadowType)
    {
        ...
        case CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_E:
        case CPSS_DXCH_BRG_FDB_MANAGER_SHADOW_TYPE_SIP5_SIP6_HYBRID_E:
            if(fdbManagerPtr->hwDeviceTypesBitmap &
               (PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP6_E |
                PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP6_10_E |
...
)
{
    ...
    return internal_writeFdbTableEntry(devNum, dbEntryExtPtr->hwIndex, hwDataExtPtr,
                                       calcInfoPtr->nhDataBankNumArr[calcInfoPtr->selectedBankId],
                                       updateHwBankCounterAction);
}
...
*/
    ...
    if(IS_FDB_MANAGER_FOR_SIP_4(fdbManagerPtr) == GT_FALSE)
    {
...
* @param[in] updateHwEnable        - enable HW write
*                                      GT_TRUE  - Update entry in HW
*                                      GT_FALSE - skip entry update in HW
* @param[out] agedOutPtr           - (pointer to) the aged-out status.
*                                    GT_TRUE  - Entry is aged-out
*                                    GT_FALSE - Entry is not aged-out
*
    ...
    *agedOutPtr = GT_TRUE;
    ...
    while(rc == GT_OK)
    {
        ...
        if(PRV_CPSS_PP_MAC(devNum)->multiPipe.numOfTiles > 1)
        {
            ...
            if((*agedOutPtr == GT_FALSE) && (updateHwEnable == GT_TRUE))
            {
                ...
                if(*agedOutPtr == GT_TRUE)
                {
                    ...
                    if(hwValue == 1)
                    {
                        *agedOutPtr = GT_FALSE;
                        ...
                        {
                            /* Age bit detected "Refresh" in one of the tile/device
                             * Return as no HW update required */
                            UNLOCK_DEV_NUM(devNum);
                            return GT_OK;
                        }
                    }
...
)
{
    ...
    switch(hwFormatType)
    {
        ...
        case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP7_E:
            hwDataArr    = &fdbManagerPtr->tempInfo.sip6_hwFormatWords[0];
            hwDataExtArr = &fdbManagerPtr->tempInfo.sip6_ipv6Ext_hwFormatWords[0];
            compareSize  = SIP7_FDB_ENTRY_WORDS_SIZE_CNS*4;
            break;
        case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP5_20_E:
    ...
    if(dbEntryPtr->hwFdbEntryType == PRV_CPSS_DXCH_FDB_MANAGER_HW_FDB_ENTRY_TYPE_MAC_ADDR_E)
    {
        ...
        switch(hwFormatType)
        {
            ...
            case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP7_E:
                ...
                SIPx_FDB_HW_ENTRY_FIELD_SET_MAC(genSip,hwData,
                        SIP6_FDB_FDB_TABLE_FIELDS_SP_UNKNOWN_E, hwValue_dummy);
                break;
            default:
                CPSS_LOG_ERROR_AND_RETURN_ON_ENUM_MAC(fdbManagerPtr->entryAttrInfo.shadowType);
...
)
{
    ...
    {
        nhDataHwIndex   = (PRV_FDB_MANAGER_IS_SHADOW_SIP6_MAC(fdbManagerPtr))?
            dbEntryPtr->hwIndex + 1 :
            dbEntryPtr->specificFormat.prvIpv6UcKeyEntryFormat.nhDataHwIndex;
        dbIndexExt      = fdbManagerPtr->indexArr[nhDataHwIndex].entryPointer;
        ...
        for(tileId = 0; tileId < numOfTiles; tileId++)
        {
            ...
            else
            {
                ...
                switch(hwFormatType)
                {
                    ...
                    case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP6_10_E:
                    case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP7_E:
                        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwData, SIP6_FDB_FDB_TABLE_FIELDS_VALID_E, hwValue);
                        SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwData, SIP6_FDB_FDB_TABLE_FIELDS_SP_UNKNOWN_E, hwValue_spUnknown);
                        break;
                    default:
                        CPSS_LOG_ERROR_AND_RETURN_ON_ENUM_MAC(fdbManagerPtr->entryAttrInfo.shadowType);
                }
...
/*
* @internal prvCpssDxChBrgFdbManagerHwTempEntryReadByIndex function
* @endinternal
*
* @brief   The function reads the temp HW entry by index from all device
*
* @param[in] fdbManagerPtr          - (pointer to) the FDB manager
* @param[in] hwIndex                - HW index to read entry from FDB
* @param[out] entryPtr              - (pointer to) FDB temp SP entry format with full info (if not NULL)
* @param[out] tempEntryFoundPtr     - (pointer to) temp entry found status
*                                       GT_TRUE - temp entry found for HW index
*                                       GT_FALSE - temp entry not found for HW index
* @param[in]  deleteEntry           - specifies wether to flush HW index from all tiles if SP entry is found
*
* @retval GT_OK                     - on success.
* @retval GT_FAIL                   - on failure.
* @retval GT_BAD_PARAM              - wrong parameter
...
*
*/
GT_STATUS prvCpssDxChBrgFdbManagerHwTempEntryReadByIndex
(
    IN  PRV_CPSS_DXCH_FDB_MANAGER_DB_INSTANCE_INFO_STC *fdbManagerPtr,
    IN  GT_U32                                          hwIndex,
    OUT CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_STC            *entryPtr,
    OUT GT_BOOL                                        *tempEntryFoundPtr,
    IN GT_BOOL                                          deleteEntry
)
{
    GT_STATUS                                           rc;                 /* return code */
    GT_U32                                              tileId;             /* tile ID used in iterator */
    GT_U32                                              numOfTiles;         /* number of tiles used in iterator */
    GT_U8                                               devNum;             /* device number */
    GT_U32                                              portGroupId;        /* port group ID */
    GT_U32                                              hwValue_valid;      /* the HW entry 'Valid' bit */
    GT_U32                                              hwValue_spUnknown;  /* the HW entry 'SP unknown' bit */
    GT_U32                                              hwValue_skip;       /* the HW entry 'Skip' bit */
    PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_ENT    hwFormatType;       /* device HW format type */
    GT_U32                                             *hwDataArr    = &fdbManagerPtr->tempInfo.sip6_hwFormatWords[0];
                                                                            /* HW entry data */
    GT_U32                                              entryType;          /* FDB HW entry type */
    CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_STC                 tempSpEntry;        /* FDB data structure for SP entry */
    CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_STC                *tempSpEntryPtr = NULL;
                                                                            /* Pointer to FDB data structure for SP entry */
    GT_U32                                              numOfSpEntries;     /* Number of SP entries */

    GT_U32                                              hwEntryWords[FDB_ENTRY_WORDS_SIZE_CNS];
                                                                            /* HW entry data  */
    GT_U32                                             *hwEntryWordsPtr;    /* pointer to HW entry data */
    CPSS_GEN_SIP_ENT    genSip = SIP_OF_HW(fdbManagerPtr);

    *tempEntryFoundPtr = GT_FALSE;
    ...
    while(rc == GT_OK)
    {
        ...
        numOfSpEntries = 0;
        hwEntryWordsPtr = NULL;

        cpssOsMemCpy(hwEntryWords, fdbManagerPtr->hwEntryForFlush, FDB_ENTRY_WORDS_SIZE_CNS * sizeof(GT_U32));
        ...
        for(tileId = 0; tileId < numOfTiles; tileId++)
        {
            ...
            /* Set 'skip' valid by default, used in legacy HASH mode */
            hwValue_skip = 0;
            ...
            {
                case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP4_E:
                    hwValue_valid           = U32_GET_FIELD_MAC(hwDataArr[0], 0, 1);
                    hwValue_skip            = U32_GET_FIELD_MAC(hwDataArr[0], 1, 1);
                    hwValue_spUnknown       = U32_GET_FIELD_MAC(hwDataArr[3], 2, 1);
                    break;
                case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP5_E:
                case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP5_20_E:
                    SIP5_FDB_HW_ENTRY_FIELD_GET_MAC(hwDataArr, SIP5_FDB_FDB_TABLE_FIELDS_VALID_E, hwValue_valid);
                    /* Check skip 'bit' for legacy HASH mode */
                    if(fdbManagerPtr->capacityInfo.hwCapacity.numOfHashes == 1)
                    {
                        SIP5_FDB_HW_ENTRY_FIELD_GET_MAC(hwDataArr, SIP5_FDB_FDB_TABLE_FIELDS_SKIP_E, hwValue_skip);
                    }
                    SIP5_FDB_HW_ENTRY_FIELD_GET_MAC(hwDataArr, SIP5_FDB_FDB_TABLE_FIELDS_SP_UNKNOWN_E, hwValue_spUnknown);
                    break;
                case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP6_E:
                case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP6_10_E:
                case PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP7_E:
                    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_VALID_E, hwValue_valid);
                    /* Check skip 'bit' for legacy HASH mode */
                    if(hwFormatType!=PRV_CPSS_DXCH_BRG_FDB_MANAGER_HW_FORMAT_TYPE_SIP7_E)/* not valid field in sip7 */
                    {
                        if(fdbManagerPtr->capacityInfo.hwCapacity.numOfHashes == 1)
                        {
                            SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_SKIP_E, hwValue_skip);
                        }
                    }
                    else    /* sip7*/
                    {
                    ...
                    SIPx_FDB_HW_ENTRY_FIELD_GET_MAC(genSip,hwDataArr, SIP6_FDB_FDB_TABLE_FIELDS_SP_UNKNOWN_E, hwValue_spUnknown);
                    break;
                default:
                    UNLOCK_DEV_NUM(devNum);
                    CPSS_LOG_ERROR_AND_RETURN_ON_ENUM_MAC(fdbManagerPtr->entryAttrInfo.shadowType);
            ...
            if(entryType > PRV_CPSS_DXCH_FDB_MANAGER_HW_FDB_ENTRY_TYPE_IPV6_MCAST_E)
            {
                /* No SP entries for IPv4/6 UC types */
                hwValue_spUnknown = 0;
            }

            if(hwValue_valid == 1 && hwValue_skip == 0) /* Valid entry */
            {
                if(hwValue_spUnknown == 0) /* non-SP entry */
                {
                    if(deleteEntry) /* Save entry to override possible SP entry */
                    {
                        if(hwEntryWordsPtr == NULL)
                        {
                            hwEntryWordsPtr = hwEntryWords;

                            /* Save first valid HW entry */
                            cpssOsMemCpy(hwEntryWordsPtr, hwDataArr, FDB_ENTRY_WORDS_SIZE_CNS * sizeof(GT_U32));
                        }
                    }
                }
                else /* SP Entry */
                {
                    if(tempSpEntryPtr == NULL)
                    {
                        tempSpEntryPtr = &tempSpEntry;

                        /* Save first SP entry in FDB manager format */
                        rc = prvCpssDxChFdbManagerDbBuildDbFormatFromHwEntry(fdbManagerPtr, hwFormatType, tempSpEntryPtr);
                        if(rc != GT_OK)
                        {
                            UNLOCK_DEV_NUM(devNum);
                            return rc;
                    ...
                    /* Increment number of SP entries */
                    numOfSpEntries++;
                }
            }
        }
        ...
        if(numOfSpEntries)
        {
            /* One or more SP entries found */
            if(deleteEntry)
            {
                rc = internal_writeFdbTableEntry(
                    devNum, hwIndex, hwEntryWords, 0, UPDATE_HW_BANK_COUNTER_ACTION_NONE_E);
                if(rc != GT_OK)
                {
                    return rc;
                }
            ...
            if(entryPtr && tempSpEntryPtr)
            {
                cpssOsMemCpy(entryPtr, tempSpEntryPtr, sizeof(CPSS_DXCH_BRG_FDB_MANAGER_ENTRY_STC));
            }

            *tempEntryFoundPtr = GT_TRUE;
        }

        rc = prvCpssDxChFdbManagerDbDeviceIteratorGetNext(fdbManagerPtr, GT_FALSE, &devNum);
    }

    return (rc == GT_NO_MORE) ? GT_OK : rc;
}

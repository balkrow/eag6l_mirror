...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, txDsaTag, CPSS_IPFIX_MANAGER_TX_DSA_TAG_LEN_IN_WORDS_CNS, GT_U32);
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChIpfixManagerLogLibDb[] = {
    ...
    {"cpssDxChIpfixManagerDataGet", 3, cpssDxChIpfixManagerEntryDelete_PARAMS, NULL},
    {"cpssDxChIpfixManagerDataGetAll", 1, prvCpssLogGenDevNum_PARAMS, NULL},

...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChNstLogLibDb[] = {
    ...
    {"cpssDxChNstRouterAccessMatrixCmdSet", 5, cpssDxChNstRouterAccessMatrixCmdSet_PARAMS, NULL},
    {"cpssDxChNstRouterAccessMatrixCmdGet", 5, cpssDxChNstRouterAccessMatrixCmdGet_PARAMS, NULL},

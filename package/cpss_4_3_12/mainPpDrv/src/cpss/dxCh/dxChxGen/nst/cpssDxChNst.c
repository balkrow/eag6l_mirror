...
*         the packet is assigned a command.
*
...
* @param[in] protocolStack            - Protocol (IPv4, Ipv6, FCoE) relevant if isBridge=GT_FALSE
...
*                                       for isBridge=GT_FALSE
*                                       APPLICABLE VALUES:
*                                       CPSS_PACKET_CMD_FORWARD_E;
*                                       CPSS_PACKET_CMD_DROP_SOFT_E.
*                                       CPSS_PACKET_CMD_DROP_HARD_E;
*                                       for isBridge=GT_TRUE
*                                       APPLICABLE VALUES:
*                                       CPSS_PACKET_CMD_FORWARD_E;
...
)
{
    ...
    GT_U32    hwValueOfCmd = 0;   /* Hardware value of command  */
...
)
{
    ...
    GT_U32    hwValueOfCmd = 0;   /* Hardware value of command  */
    GT_STATUS rc;                 /* return value */
    GT_U32    hwValueOfCmdIpv4;   /* Hardware value of command IPv4 */
    GT_U32    hwValueOfCmdIpv6;   /* Hardware value of command IPv6 */
    GT_U32    hwValueOfCmdFcoe;   /* Hardware value of command Fcoe */
    ...
    else    /* eArch */
    {
           ...
           (protocolStack == CPSS_IP_PROTOCOL_ALL_E))
        {
            ...
            hwValueOfCmd = hwValueOfCmdIpv6;
            if((protocolStack == CPSS_IP_PROTOCOL_IPV4V6_E) || (protocolStack == CPSS_IP_PROTOCOL_ALL_E))
            {
                if(hwValueOfCmdIpv4 != hwValueOfCmdIpv6)
                {
                    CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
                }
            }
           ...
           (protocolStack == CPSS_IP_PROTOCOL_ALL_E))
        {
            ...
            hwValueOfCmd = hwValueOfCmdFcoe;
            if(protocolStack == CPSS_IP_PROTOCOL_ALL_E)
            {
                if(hwValueOfCmdFcoe != hwValueOfCmdIpv4)
                {
                    CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
                }
            }
...
)
{
    ...
    return prvCpssDxChNstAccessMatrixCmdSet(devNum,saAccessLevel,daAccessLevel,
                                            GT_TRUE, CPSS_IP_PROTOCOL_ALL_E, command);
...
)
{
    ...
    return prvCpssDxChNstAccessMatrixCmdGet(devNum,saAccessLevel,daAccessLevel,
                                            GT_TRUE, CPSS_IP_PROTOCOL_ALL_E,commandPtr);
}
...
*                                       xCat3, AC5, Lion2: 0...7
*                                       Bobcat2 and Above: 0...63
* @param[in] protocolStack            - Type of protocol (Ipv4, Ipv6, FCoE, All)
*                                       Ignored for: xCat3, AC5, Lion2
* @param[in] command                  -  assigned to a packet
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on wrong devNum, saAccessLevel, daAccessLevel.
...
)
{
    ...
    return prvCpssDxChNstAccessMatrixCmdSet(devNum,sipAccessLevel,dipAccessLevel,
                                            GT_FALSE, protocolStack, command);
}
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, sipAccessLevel, dipAccessLevel, protocolStack, command));

    rc = internal_cpssDxChNstRouterAccessMatrixCmdSet(devNum, sipAccessLevel, dipAccessLevel, protocolStack, command);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, sipAccessLevel, dipAccessLevel, protocolStack, command));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    return prvCpssDxChNstAccessMatrixCmdGet(devNum,sipAccessLevel,dipAccessLevel,
                                            GT_FALSE, protocolStack, commandPtr);
}
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, sipAccessLevel, dipAccessLevel, protocolStack, commandPtr));

    rc = internal_cpssDxChNstRouterAccessMatrixCmdGet(devNum, sipAccessLevel, dipAccessLevel, protocolStack, commandPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, sipAccessLevel, dipAccessLevel, protocolStack, commandPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);

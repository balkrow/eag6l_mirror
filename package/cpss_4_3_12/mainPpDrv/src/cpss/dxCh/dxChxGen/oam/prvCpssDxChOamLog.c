...
const char * const prvCpssLogEnum_CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT[]  =
{
    "CPSS_DXCH_OAM_EXCEPTION_STATUS_PASS_E",
    "CPSS_DXCH_OAM_EXCEPTION_STATUS_FAIL_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT);
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, keepaliveAgingStormSuppressEnable);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, invalidHashKeepaliveStormSuppressEnable);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, megLevelStormSuppressEnable);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, sourceInterfaceStormSuppressEnable);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, txPeriodStormSuppressEnable);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, keepaliveAgingStatus, CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, megLevelStatus, CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, sourceInterfaceStatus, CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, txPeriodStatus, CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, hashVerificationStatus, CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, ignoreBadKeepAliveInAgingEnable);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, locDetectionDisable);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, protectionRdiState);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, protectionOnRdiEnable);
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC_PTR_exceptionCommandPtr = {
     "exceptionCommandPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC_PTR_exceptionCommandPtr = {
     "exceptionCommandPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChOamExceptionRecoveryConfigSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_OAM_STAGE_TYPE_ENT_stage,
    &DX_IN_CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT_exceptionType,
    &DX_IN_CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC_PTR_exceptionCommandPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChOamExceptionRecoveryConfigGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_OAM_STAGE_TYPE_ENT_stage,
    &DX_IN_CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT_exceptionType,
    &DX_OUT_CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC_PTR_exceptionCommandPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChOamLogLibDb[] = {
    ...
    {"cpssDxChOamExceptionRecoveryConfigSet", 4, cpssDxChOamExceptionRecoveryConfigSet_PARAMS, NULL},
    {"cpssDxChOamExceptionRecoveryConfigGet", 4, cpssDxChOamExceptionRecoveryConfigGet_PARAMS, NULL},
    {"cpssDxChOamExceptionSuppressConfigSet", 4, cpssDxChOamExceptionRecoveryConfigSet_PARAMS, NULL},
    {"cpssDxChOamExceptionSuppressConfigGet", 4, cpssDxChOamExceptionRecoveryConfigGet_PARAMS, NULL},

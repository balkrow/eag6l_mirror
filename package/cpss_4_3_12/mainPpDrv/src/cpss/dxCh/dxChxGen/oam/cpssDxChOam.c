...
)
{
    ...
    GT_U32 srcIsVPort;              /* sip7 : Source interface is vPort ? */
    ...
    switch(entryPtr->sourceInterface.type)
    {
        case CPSS_INTERFACE_PORT_E:
            srcIsVPort = PRV_CPSS_DXCH_IS_VPORT(devNum,entryPtr->sourceInterface.devPort.portNum);
            if(srcIsVPort)
            {
                localDevSrcEPortTrunk = entryPtr->sourceInterface.devPort.portNum;
                PRV_CPSS_DXCH_VPORT_FIELD_CHECK_MAC(devNum,entryPtr->sourceInterface.devPort.portNum);
            }
            else
            {
                localDevSrcEPortTrunk = entryPtr->sourceInterface.devPort.portNum;
    ...
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_OAM_OPCODE_PARSING_ENABLE_E                ,
                               BOOL2BIT_MAC(entryPtr->opcodeParsingEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_LM_COUNTER_CAPTURE_ENABLE_E                ,
                               BOOL2BIT_MAC(entryPtr->lmCounterCaptureEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_DUAL_ENDED_LM_ENABLE_E                     ,
                               BOOL2BIT_MAC(entryPtr->dualEndedLmEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_LM_COUNTING_MODE_E                         ,
                                lmCountingMode);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_CHECK_ENABLE_E                   ,
                               BOOL2BIT_MAC(entryPtr->megLevelCheckEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_E                                ,
                                entryPtr->megLevel);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_KEEPALIVE_AGING_ENABLE_E                   ,
                               BOOL2BIT_MAC(entryPtr->keepaliveAgingEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_AGE_STATE_E                                ,
                                entryPtr->ageState);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_AGING_PERIOD_INDEX_E                       ,
                                entryPtr->agingPeriodIndex);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_AGING_THRESHOLD_E                          ,
                                entryPtr->agingThreshold);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_HASH_VERIFY_ENABLE_E                       ,
                               BOOL2BIT_MAC(entryPtr->hashVerifyEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_LOCK_HASH_VALUE_ENABLE_E                   ,
                               BOOL2BIT_MAC(entryPtr->lockHashValueEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_FLOW_HASH_E                                ,
                                entryPtr->flowHash);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_OAM_PTP_OFFSET_INDEX_E                     ,
                                entryPtr->oamPtpOffsetIndex);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_TIMESTAMP_ENABLE_E                         ,
                               BOOL2BIT_MAC(entryPtr->timestampEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_PACKET_COMMAND_PROFILE_E                   ,
                                entryPtr->packetCommandProfile);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_CPU_CODE_OFFSET_E                          ,
                                entryPtr->cpuCodeOffset);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_CHECK_ENABLE_E            ,
                               BOOL2BIT_MAC(entryPtr->sourceInterfaceCheckEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_IS_TRUNK_E                          ,
                                srcIsTrunk);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_CHECK_MODE_E              ,
                                srcInterfaceCheckMode);
    if(!srcIsVPort)
    {
        SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_ORIG_DEV_SRC_EPORT_OR_ORIG_DEV_SRC_TRUNK_E ,
                                    localDevSrcEPortTrunk);
    }
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_ENABLE_PROTECTION_LOC_UPDATE_E             ,
                               BOOL2BIT_MAC(entryPtr->protectionLocUpdateEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_DETECTION_ENABLE_E        ,
                               BOOL2BIT_MAC(entryPtr->excessKeepaliveDetectionEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_PERIOD_COUNTER_E          ,
                                entryPtr->excessKeepalivePeriodCounter);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_PERIOD_THRESHOLD_E        ,
                                entryPtr->excessKeepalivePeriodThreshold);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_MESSAGE_COUNTER_E         ,
                                entryPtr->excessKeepaliveMessageCounter);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_MESSAGE_THRESHOLD_E       ,
                                entryPtr->excessKeepaliveMessageThreshold);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_RDI_CHECK_ENABLE_E                         ,
                               BOOL2BIT_MAC(entryPtr->rdiCheckEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_RDI_STATUS_E                               ,
                                entryPtr->rdiStatus);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_PERIOD_CHECK_ENABLE_E                      ,
                               BOOL2BIT_MAC(entryPtr->periodCheckEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_KEEPALIVE_TX_PERIOD_FIELD_E                ,
                                entryPtr->keepaliveTxPeriod);
    ...
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_KEEPALIVE_AGING_STORM_SUPPRESS_EN_E        ,
                                BOOL2BIT_MAC(entryPtr->keepaliveAgingStormSuppressEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_INVALID_HASH_KEEPALIVE_STORM_SUPPRESS_EN_E ,
                                BOOL2BIT_MAC(entryPtr->invalidHashKeepaliveStormSuppressEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_STORM_SUPPRESS_EN_E              ,
                                BOOL2BIT_MAC(entryPtr->megLevelStormSuppressEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_STORM_SUPPRESS_EN_E       ,
                                BOOL2BIT_MAC(entryPtr->sourceInterfaceStormSuppressEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_TX_PERIOD_STORM_SUPPRESS_EN_E              ,
                                BOOL2BIT_MAC(entryPtr->txPeriodStormSuppressEnable));

    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_HASH_VERIFICATION_STATUS_E                 ,
                                entryPtr->hashVerificationStatus);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_TX_PERIOD_STATUS_E                         ,
                                entryPtr->txPeriodStatus);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_STATUS_E                  ,
                                entryPtr->sourceInterfaceStatus);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_STATUS_E                         ,
                                entryPtr->megLevelStatus);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_KEEPALIVE_AGING_STATUS_E                   ,
                                entryPtr->keepaliveAgingStatus);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_IGNORE_BAD_KEEPALIVE_IN_AGING_EN_E         ,
                                BOOL2BIT_MAC(entryPtr->ignoreBadKeepAliveInAgingEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_LOC_DETECTION_ENABLE_E                     ,
                                (entryPtr->locDetectionDisable)?0:1);
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_PROTECTION_ON_RDI_ENABLE_E                 ,
                                BOOL2BIT_MAC(entryPtr->protectionOnRdiEnable));
    SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_PROTECTION_RDI_STATE_E                     ,
                                BOOL2BIT_MAC(entryPtr->protectionRdiState));
    ...
    if(!srcIsTrunk)
    {
        SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP7_OAM_TABLE_FIELDS_SRC_IS_VPORT_E ,
                                    srcIsVPort);
    }

    if(srcIsVPort)
    {
        SIP5_OAM_ENTRY_FIELD_SET_MAC(devNum,hwDataPtr,SIP7_OAM_TABLE_FIELDS_SRC_VPORT_E ,
                                    localDevSrcEPortTrunk);
    }
    /* missing support for next fields :
...
)
{
    ...
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_OAM_OPCODE_PARSING_ENABLE_E                ,
                               regValue);
    entryPtr->opcodeParsingEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_LM_COUNTER_CAPTURE_ENABLE_E                ,
                               regValue);
    entryPtr->lmCounterCaptureEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_DUAL_ENDED_LM_ENABLE_E                     ,
                               regValue);
    entryPtr->dualEndedLmEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_LM_COUNTING_MODE_E                         ,
                                regValue);
    switch (regValue)
    {
        case 0:
    ...
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_CHECK_ENABLE_E                   ,
                               regValue);
    entryPtr->megLevelCheckEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_E                                ,
                                entryPtr->megLevel);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_KEEPALIVE_AGING_ENABLE_E                   ,
                               regValue);
    entryPtr->keepaliveAgingEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_AGE_STATE_E                                ,
                                entryPtr->ageState);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_AGING_PERIOD_INDEX_E                       ,
                                entryPtr->agingPeriodIndex);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_AGING_THRESHOLD_E                          ,
                                entryPtr->agingThreshold);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_HASH_VERIFY_ENABLE_E                       ,
                               regValue);
    entryPtr->hashVerifyEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_LOCK_HASH_VALUE_ENABLE_E                   ,
                               regValue);
    entryPtr->lockHashValueEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_FLOW_HASH_E                                ,
                                entryPtr->flowHash);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_OAM_PTP_OFFSET_INDEX_E                     ,
                                entryPtr->oamPtpOffsetIndex);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_TIMESTAMP_ENABLE_E                         ,
                               regValue);
    entryPtr->timestampEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_PACKET_COMMAND_PROFILE_E                   ,
                                entryPtr->packetCommandProfile);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_CPU_CODE_OFFSET_E                          ,
                                entryPtr->cpuCodeOffset);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_CHECK_ENABLE_E            ,
                               regValue);
    entryPtr->sourceInterfaceCheckEnable = BIT2BOOL_MAC(regValue);

    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_IS_TRUNK_E                          ,
                                srcIsTrunk);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_CHECK_MODE_E              ,
                                srcInterfaceCheckMode);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_ORIG_DEV_SRC_EPORT_OR_ORIG_DEV_SRC_TRUNK_E ,
                                localDevSrcEPortTrunk);
    ...
    else
    {
        if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP7_OAM_TABLE_FIELDS_SRC_IS_VPORT_E   ,
                                srcIsVPort);
        }
        else
        {
        ...
        {
            /* vPort */
            SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP7_OAM_TABLE_FIELDS_SRC_VPORT_E   ,
                                entryPtr->sourceInterface.devPort.portNum);
        }
        else
        {
            /* Port */
    ...
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_ENABLE_PROTECTION_LOC_UPDATE_E             ,
                               regValue);
    entryPtr->protectionLocUpdateEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_DETECTION_ENABLE_E        ,
                               regValue);
    entryPtr->excessKeepaliveDetectionEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_PERIOD_COUNTER_E          ,
                                entryPtr->excessKeepalivePeriodCounter);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_PERIOD_THRESHOLD_E        ,
                                entryPtr->excessKeepalivePeriodThreshold);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_MESSAGE_COUNTER_E         ,
                                entryPtr->excessKeepaliveMessageCounter);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_MESSAGE_THRESHOLD_E       ,
                                entryPtr->excessKeepaliveMessageThreshold);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_RDI_CHECK_ENABLE_E                         ,
                               regValue);
    entryPtr->rdiCheckEnable = BIT2BOOL_MAC(regValue);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_RDI_STATUS_E                               ,
                                entryPtr->rdiStatus);
    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_PERIOD_CHECK_ENABLE_E                      ,
                               regValue);
    entryPtr->periodCheckEnable = BIT2BOOL_MAC(regValue);

    SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_KEEPALIVE_TX_PERIOD_FIELD_E                ,
                                entryPtr->keepaliveTxPeriod);

    if(PRV_CPSS_SIP_5_15_CHECK_MAC(devNum))
    {
        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_KEEPALIVE_AGING_STORM_SUPPRESS_EN_E        ,
                regValue);
        entryPtr->keepaliveAgingStormSuppressEnable = BIT2BOOL_MAC(regValue);

        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_INVALID_HASH_KEEPALIVE_STORM_SUPPRESS_EN_E ,
                regValue);
        entryPtr->invalidHashKeepaliveStormSuppressEnable = BIT2BOOL_MAC(regValue);

        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_STORM_SUPPRESS_EN_E              ,
                regValue);
        entryPtr->megLevelStormSuppressEnable = BIT2BOOL_MAC(regValue);

        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_STORM_SUPPRESS_EN_E       ,
                regValue);
        entryPtr->sourceInterfaceStormSuppressEnable = BIT2BOOL_MAC(regValue);

        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_TX_PERIOD_STORM_SUPPRESS_EN_E              ,
                regValue);
        entryPtr->txPeriodStormSuppressEnable = BIT2BOOL_MAC(regValue);

        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_HASH_VERIFICATION_STATUS_E                 ,
                entryPtr->hashVerificationStatus);
        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_TX_PERIOD_STATUS_E                         ,
                entryPtr->txPeriodStatus);
        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_STATUS_E                  ,
                entryPtr->sourceInterfaceStatus);
        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_STATUS_E                         ,
                entryPtr->megLevelStatus);
        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_KEEPALIVE_AGING_STATUS_E                   ,
                entryPtr->keepaliveAgingStatus);
        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_IGNORE_BAD_KEEPALIVE_IN_AGING_EN_E         ,
                regValue);
        entryPtr->ignoreBadKeepAliveInAgingEnable = BIT2BOOL_MAC(regValue);
        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_LOC_DETECTION_ENABLE_E                     ,
                regValue);
        entryPtr->locDetectionDisable = (regValue)?GT_FALSE:GT_TRUE;
        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_PROTECTION_ON_RDI_ENABLE_E                 ,
                regValue);
        entryPtr->protectionOnRdiEnable = BIT2BOOL_MAC(regValue);
        SIP5_OAM_ENTRY_FIELD_GET_MAC(devNum,hwDataPtr,SIP5_OAM_TABLE_FIELDS_PROTECTION_RDI_STATE_E                     ,
                regValue);
        entryPtr->protectionRdiState = BIT2BOOL_MAC(regValue);
    }
    return GT_OK;
}
...
)
{
    ...
    return prvCpssDxChOamEntryToSwConvert(devNum,hwDataArr, entryPtr);
}
...
)
{
    ...
    switch(exceptionType)
    {
        ...
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_SUMMARY_E:
            regAddr = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).summaryExceptionCntr;
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
)
{
    ...
    switch(exceptionType)
    {
        ...
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_TX_PERIOD_E:
            ...
            break;
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_SUMMARY_E:
            regAddr = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).summaryExceptionGroupStatus[0];
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    ...
    numOfWordsToRead =
        (PRV_CPSS_DXCH_PP_MAC(devNum)->fineTuning.tableSize.oamEntriesNum > _1K)?
        CPSS_DXCH_OAM_GROUP_STATUS_SIZE_IN_WORDS_CNS:1;
    PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_IN_BMP_MAC(
            devNum, portGroupsBmp, portGroupId)
    {
        /* Read OAM exception group status */
        rc = prvCpssHwPpPortGroupReadRam(devNum, portGroupId, regAddr,
                numOfWordsToRead, &groupStatus[0]);
        if(rc != GT_OK)
        {
            return rc;
        }

        for (ii = 0; ii < numOfWordsToRead; ii++)
        {
...
)
{
    ...
    switch(command)
    {
        case CPSS_PACKET_CMD_DROP_HARD_E:
            ...
            break;
        case CPSS_PACKET_CMD_DROP_SOFT_E:
            if ((stage == CPSS_DXCH_OAM_STAGE_TYPE_EGRESS_E) && (!PRV_CPSS_SIP_6_CHECK_MAC(devNum)))
            {
...
/**
* @internal prvCpssDxChOamExceptionRecoveryAddressGet function
* @endinternal
*
* @brief   Gets the register details & offset for the exception type in the resister
*
...
* @param[in] stage                 - OAM  type.
* @param[in] exceptionType         - OAM exception type.
*                                    Valid exceptionType are:
*                                       1. KEEPALIVE_AGING
*                                       2. KEEPALIVE_INVALID_HASH
*                                       3. MEG_LEVEL
*                                       4. SOURCE_INTERFACE
*                                       5. TX Period
* @param[out] regAddrPtr           - (pointer to) resister address
* @param[out] startOffsetPtr       - (pointer to) start offset for the exception type in the resister
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on bad parameters.
*/
static GT_STATUS prvCpssDxChOamExceptionRecoveryAddressGet
(
    IN  GT_U8                                       devNum,
    IN  CPSS_DXCH_OAM_STAGE_TYPE_ENT                stage,
    IN  CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT            exceptionType,
    OUT GT_U32                                      *regAddrPtr,
    OUT GT_U32                                      *startOffsetPtr
)
{
    switch(exceptionType)
    {
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_KEEPALIVE_INVALID_HASH_E:
            *regAddrPtr     = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).recoveryPacketCommandConfig1;
            *startOffsetPtr = 0;
            break;
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_KEEPALIVE_AGING_E:
            *regAddrPtr     = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).recoveryPacketCommandConfig1;
            *startOffsetPtr = 11;
            break;
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_MEG_LEVEL_E:
            *regAddrPtr     = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).recoveryPacketCommandConfig2;
            *startOffsetPtr = 0;
            break;
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_SOURCE_INTERFACE_E:
            *regAddrPtr     = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).recoveryPacketCommandConfig2;
            *startOffsetPtr = 11;
            break;
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_TX_PERIOD_E:
            *regAddrPtr     = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).recoveryPacketCommandConfig3;
            *startOffsetPtr = 0;
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
...
/**
* @internal prvCpssDxChOamExceptionSuppressAddressGet function
* @endinternal
*
* @brief   Gets the register details & offset for the exception type in the resister
*
...
* @retval GT_BAD_PARAM             - on bad parameters.
*/
static GT_STATUS prvCpssDxChOamExceptionSuppressAddressGet
(
    IN  GT_U8                                       devNum,
    IN  CPSS_DXCH_OAM_STAGE_TYPE_ENT                stage,
    IN  CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT            exceptionType,
...
)
{
    ...
    {
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_KEEPALIVE_INVALID_HASH_E:
            *regAddrPtr     = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).exceptionSupressionConfig1;
            *startOffsetPtr = 11;
            break;
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_TX_PERIOD_E:
            *regAddrPtr     = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).exceptionSupressionConfig1;
            *startOffsetPtr = 0;
            break;
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_MEG_LEVEL_E:
            *regAddrPtr     = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).exceptionSupressionConfig2;
            *startOffsetPtr = 11;
            break;
        case CPSS_DXCH_OAM_EXCEPTION_TYPE_SOURCE_INTERFACE_E:
            *regAddrPtr     = PRV_DXCH_REG1_UNIT_OAM_MAC(devNum,stage).exceptionSupressionConfig2;
...
/**
* @internal prvCpssDxChOamPacketCommandToDsaCode function
* @endinternal
*
* @brief   Convert packet command to DSA CPU code
*
* @note   APPLICABLE DEVICES:      Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  Bobcat2; xCat3; AC5; Lion2.
*
* @param[in] devNum                - device number.
* @param[in] stage                 - OAM  type.
* @param[in] exceptionCommandPtr   - (pointer to)exception command.
* @param[out] cpuCodePtr           - (pointer to) DSA CPU code
* @param[out] pktCommandPtr        - (pointer to) HW value of packet command
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on bad parameters.
*/
static GT_STATUS prvCpssDxChOamPacketCommandToDsaCode
(
    IN  GT_U8                                            devNum,
    IN  CPSS_DXCH_OAM_STAGE_TYPE_ENT                     stage,
    IN  CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC      *exceptionCommandPtr,
    OUT PRV_CPSS_DXCH_NET_DSA_TAG_CPU_CODE_ENT          *cpuCodePtr,
    OUT GT_U32                                          *pktCommandPtr
)
{
    GT_STATUS       rc;
    CPSS_NULL_PTR_CHECK_MAC(exceptionCommandPtr);

    PRV_CPSS_CONVERT_PACKET_CMD_TO_HW_VAL_MAC((*pktCommandPtr), exceptionCommandPtr->command);

    /* SIP_5 - EOAM supports only Forward & Drop */
    if((!PRV_CPSS_SIP_6_CHECK_MAC(devNum)) && (stage == CPSS_DXCH_OAM_STAGE_TYPE_EGRESS_E))
    {
        switch(exceptionCommandPtr->command)
        {
            case CPSS_PACKET_CMD_FORWARD_E:
            case CPSS_PACKET_CMD_DROP_HARD_E:
                break;
    ...
    switch(exceptionCommandPtr->command)
    {
        ...
        case CPSS_PACKET_CMD_DROP_HARD_E:
        case CPSS_PACKET_CMD_DROP_SOFT_E:
            rc = prvCpssDxChNetIfCpuToDsaCode(exceptionCommandPtr->cpuCode, cpuCodePtr);
            if (rc != GT_OK)
            {
                return rc;
            }
            break;
        case CPSS_PACKET_CMD_FORWARD_E:
            *cpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_RESERVED_0_E;
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
/**
* @internal prvCpssDxChOamDsaCodeToPacketCommand function
* @endinternal
*
* @brief   Convert DSA CPU Code to packet command
*
* @note   APPLICABLE DEVICES:      Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  Bobcat2; xCat3; AC5; Lion2.
*
* @param[in] devNum                - device number.
* @param[in] regAddr               - resister address.
* @param[in] startOffset           - start offset of the resister
* @param[out] exceptionCommandPtr  - (pointer to) exception command
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on bad parameters.
*/
static GT_STATUS prvCpssDxChOamDsaCodeToPacketCommand
(
    IN GT_U8                                            devNum,
    IN  GT_U32                                          regAddr,
    IN  GT_U32                                          startOffset,
    OUT CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC     *exceptionCommandPtr
)
{
    GT_STATUS                                   rc;
    PRV_CPSS_DXCH_NET_DSA_TAG_CPU_CODE_ENT      cpuCode;
    ...
    pktCommand = U32_GET_FIELD_MAC(regData, startOffset, 3);
    startOffset += 3;
    cpuCode = U32_GET_FIELD_MAC(regData, startOffset, 8);

    PRV_CPSS_CONVERT_HW_VAL_TO_PACKET_CMD_MAC(exceptionCommandPtr->command, pktCommand);
    ...
    switch(exceptionCommandPtr->command)
    {
        ...
        case CPSS_PACKET_CMD_DROP_SOFT_E:
            ...
            break;
        case CPSS_PACKET_CMD_FORWARD_E:
            exceptionCommandPtr->cpuCode = CPSS_NET_UNDEFINED_CPU_CODE_E;
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
/**
* @internal internal_cpssDxChOamExceptionRecoveryConfigSet function
* @endinternal
*
* @brief  Configures OAM exception recovery.
*
* @note   APPLICABLE DEVICES:      Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  Bobcat2; xCat3; AC5; Lion2.
*
...
*                                       4. SOURCE_INTERFACE
*                                       5. TX_PERIOD
* @param[in] exceptionCommandPtr   - (pointer to)OAM exception recovery configuration.
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on wrong device/stage/exceptionType.
* @retval GT_BAD_PTR               - one of the parameters is NULL pointer.
* @retval GT_HW_ERROR              - on writing to HW error.
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChOamExceptionRecoveryConfigSet
(
    IN GT_U8                                            devNum,
    IN CPSS_DXCH_OAM_STAGE_TYPE_ENT                     stage,
    IN CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT                 exceptionType,
...
)
{
    ...
    rc = prvCpssDxChOamPacketCommandToDsaCode(devNum, stage, exceptionCommandPtr, &cpuCode, &pktCommand);
    if (rc != GT_OK)
    {
        return rc;
    }

    rc = prvCpssDxChOamExceptionRecoveryAddressGet(devNum, stage, exceptionType, &regAddr, &startOffset);
    if (rc != GT_OK)
    {
        return rc;
    }

    return prvCpssHwPpSetRegField(devNum, regAddr, startOffset, 11,
            ((cpuCode << 3) | pktCommand));
}

/**
* @internal cpssDxChOamExceptionRecoveryConfigSet function
* @endinternal
*
* @brief  Configures OAM exception recovery.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChOamExceptionRecoveryConfigSet
(
    IN GT_U8                                            devNum,
    IN CPSS_DXCH_OAM_STAGE_TYPE_ENT                     stage,
    IN CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT                 exceptionType,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChOamExceptionRecoveryConfigSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, stage, exceptionType, exceptionCommandPtr));

    rc = internal_cpssDxChOamExceptionRecoveryConfigSet(devNum, stage, exceptionType, exceptionCommandPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, stage, exceptionType, exceptionCommandPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
/**
* @internal internal_cpssDxChOamExceptionRecoveryConfigGet function
* @endinternal
*
* @brief  Gets OAM exception recovery.
*
* @note   APPLICABLE DEVICES:      Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  Bobcat2; xCat3; AC5; Lion2.
*
...
*                                       4. SOURCE_INTERFACE
*                                       5. TX_PERIOD
* @param[out] exceptionCommandPtr - (pointer to)OAM exception recovery configuration.
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on wrong device/stage/exceptionType.
* @retval GT_BAD_PTR               - one of the parameters is NULL pointer.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChOamExceptionRecoveryConfigGet
(
    IN  GT_U8                                            devNum,
    IN  CPSS_DXCH_OAM_STAGE_TYPE_ENT                     stage,
    IN  CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT                 exceptionType,
...
)
{
    ...
    return prvCpssDxChOamDsaCodeToPacketCommand(devNum, regAddr, startOffset, exceptionCommandPtr);
}

/**
* @internal cpssDxChOamExceptionRecoveryConfigGet function
* @endinternal
*
* @brief  Gets OAM exception recovery.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChOamExceptionRecoveryConfigGet
(
    IN  GT_U8                                            devNum,
    IN  CPSS_DXCH_OAM_STAGE_TYPE_ENT                     stage,
    IN  CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT                 exceptionType,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChOamExceptionRecoveryConfigGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, stage, exceptionType, exceptionCommandPtr));

    rc = internal_cpssDxChOamExceptionRecoveryConfigGet(devNum, stage, exceptionType, exceptionCommandPtr);
...
/**
* @internal internal_cpssDxChOamExceptionSuppressConfigSet function
* @endinternal
*
* @brief  Configures OAM exception suppression.
*
* @note   APPLICABLE DEVICES:      Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  Bobcat2; xCat3; AC5; Lion2.
*
...
* @param[in] exceptionType         - OAM exception type.
*                                    Valid exceptionType are:
*                                       1. KEEPALIVE_INVALID_HASH
*                                       2. MEG_LEVEL
*                                       3. SOURCE_INTERFACE
*                                       4. TX_PERIOD
* @param[in] exceptionCommandPtr   - (pointer to)OAM exception suppress command configuration.
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on wrong device/stage/exceptionType.
* @retval GT_BAD_PTR               - one of the parameters is NULL pointer.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS internal_cpssDxChOamExceptionSuppressConfigSet
(
    IN GT_U8                                            devNum,
    IN CPSS_DXCH_OAM_STAGE_TYPE_ENT                     stage,
    IN CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT                 exceptionType,
...
)
{
    ...
    rc = prvCpssDxChOamExceptionSuppressAddressGet(devNum, stage, exceptionType, &regAddr, &startOffset);
    if (rc != GT_OK)
    {
        return rc;
    }
...
/**
* @internal cpssDxChOamExceptionSuppressConfigSet function
* @endinternal
*
* @brief  Configures OAM exception suppression.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChOamExceptionSuppressConfigSet
(
    IN GT_U8                                            devNum,
    IN CPSS_DXCH_OAM_STAGE_TYPE_ENT                     stage,
    IN CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT                 exceptionType,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChOamExceptionSuppressConfigSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, stage, exceptionType, exceptionCommandPtr));

    rc = internal_cpssDxChOamExceptionSuppressConfigSet(devNum, stage, exceptionType, exceptionCommandPtr);
...
/**
* @internal internal_cpssDxChOamExceptionSuppressConfigGet function
* @endinternal
*
* @brief  Gets OAM exception suppression.
*
* @note   APPLICABLE DEVICES:      Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  Bobcat2; xCat3; AC5; Lion2.
*
...
*                                       3. SOURCE_INTERFACE
*                                       4. TX_PERIOD
* @param[out] exceptionCommandPtr  - (pointer to)OAM exception suppress command configuration.
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on wrong device/stage/exceptionType.
* @retval GT_BAD_PTR               - one of the parameters is NULL pointer.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS internal_cpssDxChOamExceptionSuppressConfigGet
(
    IN GT_U8                                            devNum,
    IN CPSS_DXCH_OAM_STAGE_TYPE_ENT                     stage,
    IN CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT                 exceptionType,
...
/**
* @internal cpssDxChOamExceptionSuppressConfigGet function
* @endinternal
*
* @brief  Gets OAM exception suppression.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChOamExceptionSuppressConfigGet
(
    IN GT_U8                                            devNum,
    IN CPSS_DXCH_OAM_STAGE_TYPE_ENT                     stage,
    IN CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT                 exceptionType,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChOamExceptionSuppressConfigGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, stage, exceptionType, exceptionCommandPtr));

    rc = internal_cpssDxChOamExceptionSuppressConfigGet(devNum, stage, exceptionType, exceptionCommandPtr);

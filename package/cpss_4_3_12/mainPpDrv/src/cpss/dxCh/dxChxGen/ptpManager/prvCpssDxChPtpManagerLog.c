...
void prvCpssLogParamFuncStc_CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, refClockSource, CPSS_DXCH_PTP_REF_CLOCK_SELECT_ENT);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, refClockFrequency, CPSS_DXCH_PTP_TAI_CLOCK_FREQ_ENT);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, nanoSeconds);
...
void prvCpssLogParamFunc_CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
void prvCpssLogParamFunc_CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC_PTR_ptpRefClockConfPtr = {
     "ptpRefClockConfPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC_PTR_updateValuePtr = {
     "updateValuePtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_REF_CLOCK_SELECT_ENT_refClockSource = {
     "refClockSource", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_PTP_REF_CLOCK_SELECT_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_32_fracNanoSeconds = {
     "fracNanoSeconds", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_32_updateValue = {
     "updateValue", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_gracefullStep = {
     "gracefullStep", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpManagerPtpInit_PARAMS[] =  {
    ...
    &DX_IN_CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC_PTR_ptpRefClockConfPtr,
    &DX_IN_CPSS_NET_RX_CPU_CODE_ENT_cpuCode
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpManagerDbgPtpPLLConfig_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_REF_CLOCK_SELECT_ENT_refClockSource,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpManagerTodValueUpdate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_NUMBER_ENT_taiNumber,
    &DX_IN_CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC_PTR_updateValuePtr,
    &DX_IN_CPSS_DXCH_PTP_TOD_COUNTER_FUNC_ENT_function,
    &DX_IN_GT_U32_gracefullStep,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpManagerSlaveSerActivate_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_NUMBER_ENT_taiNumber,
    &DX_IN_GT_U32_nanoSeconds,
    &DX_IN_GT_32_fracNanoSeconds
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpManagerTaiTodStepGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_DXCH_PTP_TAI_NUMBER_ENT_taiNumber,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPtpManagerPhyTodValueGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_CPSS_DXCH_PTP_MANAGER_CAPTURE_TOD_VALUE_STC_PTR_todValueEntry0Ptr,
    &DX_OUT_CPSS_DXCH_PTP_MANAGER_CAPTURE_TOD_VALUE_STC_PTR_todValueEntry1Ptr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPtpManagerLogLibDb[] = {
    {"cpssDxChPtpManagerPtpInit", 7, cpssDxChPtpManagerPtpInit_PARAMS, NULL},
    ...
    {"cpssDxChPtpManagerTriggerGenerate", 5, cpssDxChPtpManagerTriggerGenerate_PARAMS, NULL},
    ...
    {"cpssDxChPtpManagerTaiTodStepGet", 3, cpssDxChPtpManagerTaiTodStepGet_PARAMS, NULL},
    {"cpssDxChPtpManagerPhyTodValueGet", 3, cpssDxChPtpManagerPhyTodValueGet_PARAMS, NULL},
    {"cpssDxChPtpManagerPhyCaptureTodValueSet", 1, prvCpssLogGenDevNum_PARAMS, NULL},
    {"cpssDxChPtpManagerSlaveSerActivate", 4, cpssDxChPtpManagerSlaveSerActivate_PARAMS, NULL},
    {"cpssDxChPtpManagerMasterSerActivate", 2, cpssDxChPtpManagerCaptureTodValueSet_PARAMS, NULL},
    {"cpssDxChPtpManagerDbgPtpPLLConfig", 4, cpssDxChPtpManagerDbgPtpPLLConfig_PARAMS, NULL},
};

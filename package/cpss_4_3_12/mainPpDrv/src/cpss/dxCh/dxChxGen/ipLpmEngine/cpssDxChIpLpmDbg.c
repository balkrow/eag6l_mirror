...
)
{
    ...
    {
        return prvCpssDxChLpmRamDbgDumpSip7(devNum, vrId, lpmProtocol, prefixType);
    }
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            ...
            {
                return prvCpssDxChLpmRamDbgDbHwMemPrintSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow));
            }
            else
            {
...
)
{
    ...
    if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        return prvCpssDxChLpmRamDbgHwValidationSip7(devNum, vrId, lpmProtocol, prefixType);
    }
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            ...
            if(lpmDbPtr->shadowType==PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                return prvCpssDxChLpmRamDbgShadowValidityCheckSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            ...
            if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                return prvCpssDxChLpmRamDbgHwShadowSyncValidityCheckSip7(devNum,
...
)
{
    ...
    if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        rc = prvCpssDxChLpmRamDbgHwValidationSip7(devNum, vrId, lpmProtocol, prefixType);
    }
    else
    {
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            ...
            if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                rc = prvCpssDxChLpmRamDbgShadowValidityCheckSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                             vrId, protocolBitmap, prefixType, returnOnFailure);
            }
            else
            {
            ...
            if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                rc = prvCpssDxChLpmRamDbgHwShadowSyncValidityCheckSip7(devNum,
                                                               (PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                               vrId, protocolBitmap, prefixType, returnOnFailure);
            }
            else
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if(lpmDbPtr->shadowType==PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                prvCpssDxChLpmDbgHwOctetPerBlockPrintSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow));
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if(lpmDbPtr->shadowType==PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                prvCpssDxChLpmDbgHwBlockInfoPrintSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow));
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if(lpmDbPtr->shadowType==PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                prvCpssDxChLpmDbgHwOctetPerProtocolPrintSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC *)(lpmDbPtr->shadow));
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if(lpmDbPtr->shadowType==PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                prvCpssDxChLpmDbgHwOctetPerProtocolPrintLpmLinesCountersSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow));
            }
            else
            {
...
/**
* @internal internal_cpssDxChIpLpmDbgPrintLpmNodesStatistics function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChIpLpmDbgPrintLpmNodesStatistics
(
    IN GT_U32                           lpmDbId,
    IN GT_U32                           vrId,
    IN CPSS_IP_PROTOCOL_STACK_ENT       protocol,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if(lpmDbPtr->shadowType==PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                return prvCpssDxChLpmRamDbgPrintLpmNodesStatisticsSip7(vrId, protocol, prefixType, (PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow));
            }
            else
            {
                return prvCpssDxChLpmRamDbgPrintLpmNodesStatistics(vrId, protocol, prefixType, (PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow));
            }
...
/**
* @internal cpssDxChIpLpmDbgPrintLpmNodesStatistics function
* @endinternal
*
* @brief   print statistics of LPM nodes for given vrf, protocol, prefix type.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChIpLpmDbgPrintLpmNodesStatistics
(
    IN GT_U32                           lpmDbId,
    IN GT_U32                           vrId,
    IN CPSS_IP_PROTOCOL_STACK_ENT       protocol,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChIpLpmDbgPrintLpmNodesStatistics);

    CPSS_API_LOCK_DEVICELESS_MAC(PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, lpmDbId, vrId, protocol, prefixType));

    rc = internal_cpssDxChIpLpmDbgPrintLpmNodesStatistics(lpmDbId, vrId, protocol, prefixType);

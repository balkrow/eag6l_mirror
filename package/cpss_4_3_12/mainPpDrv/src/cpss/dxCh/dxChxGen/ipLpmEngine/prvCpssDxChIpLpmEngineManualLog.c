...
)
{
    ...
    shadowType = (inOutParamInfoPtr->paramKey.paramKeyArr[1] == PRV_CPSS_LOG_PARAM_IN_E) ?
          ...
          ((inOutParamInfoPtr->paramKey.paramKeyArr[0] == 0) ? CPSS_DXCH_IP_LPM_RAM_SIP5_SHADOW_E :
              *(CPSS_DXCH_IP_LPM_SHADOW_TYPE_ENT*)inOutParamInfoPtr->paramKey.paramKeyArr[0]);
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U8_ARRAY_devListArr1 = {
     "devListArr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U8)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U8_ARRAY_devListArray = {
     "devListArray", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U8)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_linesToReserveArray = {
     "linesToReserveArray", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_pclIdArray = {
     "pclIdArray", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_defaultIpv4RuleIndexArray = {
     "defaultIpv4RuleIndexArray", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_defaultIpv6RuleIndexArray = {
     "defaultIpv6RuleIndexArray", PRV_CPSS_LOG_PARAM_OUT_E,  prvCpssLogParamFunc_GT_U32_ARRAY_sizeSet1
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_ARRAY_pclIdArray = {
     "pclIdArray", PRV_CPSS_LOG_PARAM_OUT_E,  prvCpssLogParamFunc_GT_U32_ARRAY_sizeSet2
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpLpmDBDevListAdd_PARAMS[] =  {
    &DX_IN_GT_U32_lpmDBId,
    &DX_IN_GT_U8_ARRAY_devListArr1,
    &DX_IN_GT_U32_numOfDevs
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpLpmDBDevListGet_PARAMS[] =  {
    &DX_IN_GT_U32_lpmDbId,
    &DX_INOUT_GT_U32_PTR_numOfDevsPtr,
    &DX_OUT_GT_U8_ARRAY_devListArray
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpLpmPolicyBasedRoutingDefaultMcSet_PARAMS[] =  {
    &DX_IN_GT_U32_lpmDBId,
    &DX_IN_GT_U32_pclIdArrayLen,
    &DX_IN_GT_U32_ARRAY_pclIdArray
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpLpmPolicyBasedRoutingDefaultMcGet_PARAMS[] =  {
    &DX_IN_GT_U32_lpmDBId,
    &DX_OUT_GT_BOOL_PTR_defaultMcUsedPtr,
    &DX_OUT_CPSS_IP_PROTOCOL_STACK_ENT_PTR_protocolStackPtr,
    &DX_OUT_GT_U32_ARRAY_defaultIpv4RuleIndexArray,
    &DX_INOUT_GT_U32_PTR_defaultIpv4RuleIndexArrayLenPtr,
    &DX_OUT_GT_U32_ARRAY_defaultIpv6RuleIndexArray,
    &DX_INOUT_GT_U32_PTR_defaultIpv6RuleIndexArrayLenPtr,
    &DX_OUT_GT_U32_ARRAY_pclIdArray,
    &DX_INOUT_GT_U32_PTR_pclIdArrayLenPtr
};

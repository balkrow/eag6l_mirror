...
#define CPSS_MAX_VRF_ID_CHECK_MAC(_shadowType,_vrId)\
    if (_shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)\
    {\
        if (_vrId >= BIT_15)\
        {\
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (shadowType == CPSS_DXCH_IP_LPM_RAM_SIP7_SHADOW_E)
            {
            ...
            if (shadowType == CPSS_DXCH_IP_LPM_RAM_SIP7_SHADOW_E)
            {
                numberOfBytesInLpmLine = PRV_CPSS_DXCH_LPM_RAM_SIP7_SIZE_OF_LPM_ENTRY_IN_BYTES_CNS;
                /* calculate LPM netto without PBR, fill lpm blocks number  and fill lpm block sizes in lines*/
                retVal = prvCpssDxChLpmRamSip7FillCfg(&memoryCfgPtr->ramDbCfg,&ramMemoryCfg);
                if (retVal != GT_OK)
                {
            ...
            if (shadowType == CPSS_DXCH_IP_LPM_RAM_SIP7_SHADOW_E)
            {
                ...
                retVal = prvCpssDxChLpmRamDbCreateSip7(&ramLpmDbPtr, protocolBitmap,&ramMemoryCfg);
            }
            else
            {
                if (shadowType == CPSS_DXCH_IP_LPM_RAM_SIP6_SHADOW_E)
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                rc = prvCpssDxChLpmRamDbDeleteSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow));
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmShadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                rc = prvCpssDxChLpmRamDbConfigGetSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                ...
                for(i=0;i<ramMemoryCfg.lpmRamConfigInfoNumOfElements;i++)
                {
                        ...
                        (!CPSS_QUIRKS_DXCH_IRONMAN_PEX_DEVICES_CHECK_MAC(ramMemoryCfg.lpmRamConfigInfo[i].devType)))
                    {
                        ...
                        case PRV_CPSS_DXCH_CFG_SHARED_TABLE_MODE_MID_HIGH_L3_MID_LOW_L2_NO_EM_MAX_ARP_E:
                            ...
                            break;
                        case PRV_CPSS_DXCH_CFG_SHARED_TABLE_MODE_AC5P_32K_L2_256K_EM_64K_ARP_E:
                            memoryCfgPtr->ramDbCfg.lpmRamConfigInfo[i].sharedMemCnfg = CPSS_DXCH_CFG_SHARED_TABLE_MODE_AC5P_32K_L2_256K_EM_64K_ARP_E;
                            break;
                        case PRV_CPSS_DXCH_CFG_SHARED_TABLE_MODE_FALCON_64K_L2_32K_EM_96K_ARP_E:
                            memoryCfgPtr->ramDbCfg.lpmRamConfigInfo[i].sharedMemCnfg = CPSS_DXCH_CFG_SHARED_TABLE_MODE_FALCON_64K_L2_32K_EM_96K_ARP_E;
                            break;
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamDbDevListAddSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                       devListArr, numOfDevs);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamDbDevListRemoveSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                           devListArr, numOfDevs);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                   return prvCpssDxChLpmRamDbDevListGetSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
...
)
{
    ...
    /* in sip7 Increase the VRF-ID from 4K (12bits) to 32K(15bits) */
    CPSS_MAX_VRF_ID_CHECK_MAC((lpmDbPtr->shadowType),vrId);

    lpmHw = prvCpssDxChLpmGetHwType(lpmDbPtr->shadowType);
    switch (lpmHw)
    {
    case PRV_CPSS_DXCH_LPM_HW_TCAM_E:
            retVal = prvCpssDxChLpmConvertIpVrConfigToTcamVrConfig(lpmDbPtr->shadowType,
    ...
    case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            ...
            retVal = prvCpssDxChLpmConvertIpVrConfigToRamVrConfig(vrConfigPtr, &ramVrConfig);
            if (retVal != GT_OK)
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(retVal, LOG_ERROR_NO_MSG);
            }
            ...
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamVirtualRouterAddSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                            vrId, &ramVrConfig);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        case PRV_CPSS_DXCH_LPM_HW_TCAM_E:
            ...
            retVal = prvCpssDxChLpmConvertTcamVrConfigToIpVrConfig(lpmDbPtr->shadowType,
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamVirtualRouterGetSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                            vrId, &ramVrConfig);
            }
            else
            {
            ...
            retVal = prvCpssDxChLpmConvertRamVrConfigToIpVrConfig(&ramVrConfig, vrConfigPtr);
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamVirtualRouterDelSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow), vrId);
            }
            else
            {
...
)
{
    ...
    retVal = prvCpssDxChLpmConvertIpRouteEntryToLpmRouteEntry(lpmDbPtr->shadowType,
                                                              nextHopInfoPtr,
                                                              &routeEntryInfo);
    if (retVal != GT_OK)
    {
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4UcPrefixAddSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                              vrId, *ipAddrPtr, prefixLen,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4UcPrefixBulkAddSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                           ipv4PrefixArrayLen,
                                                           ipv4PrefixArrayPtr,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4UcPrefixDelSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                          vrId, *ipAddrPtr, prefixLen);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4UcPrefixBulkDelSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                              ipv4PrefixArrayLen,
                                                              ipv4PrefixArrayPtr);
            }
            else
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4UcPrefixesFlushSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                                  vrId);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4UcPrefixSearchSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                                 vrId, *ipAddrPtr, prefixLen,
    ...
    retVal = prvCpssDxChLpmConvertLpmRouteEntryToIpRouteEntry(lpmDbPtr->shadowType,
                                                              &routeEntryInfo,
                                                              nextHopInfoPtr);
    return retVal;
}
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4UcPrefixGetNextSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                              vrId, ipAddrPtr,
                                                              prefixLenPtr,
                                                              &(routeEntryInfo.routeEntry));
            }
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4UcPrefixGetSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
...
)
{
    ...
    lpmHw = prvCpssDxChLpmGetHwType(lpmDbPtr->shadowType);
    retVal =  prvCpssDxChLpmConvertIpLttEntryToLpmRouteEntry(lpmHw, mcRouteLttEntryPtr, &routeEntry);
    if (retVal != GT_OK)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4McEntryAddSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                          vrId, *ipGroupPtr,
                                                          ipGroupPrefixLen, *ipSrcPtr,
                                                          ipSrcPrefixLen, &routeEntry,
                                                          override,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4McEntryDelSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow), vrId,
                                                         *ipGroupPtr, ipGroupPrefixLen,
                                                         *ipSrcPtr, ipSrcPrefixLen);
            }
            else
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4McEntriesFlushSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                             vrId);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4McEntryGetNextSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                             vrId,
                                                              ipGroupPtr,
                                                              ipGroupPrefixLenPtr,
                                                              ipSrcPtr,
    ...
    retVal = prvCpssDxChLpmConvertLpmRouteEntryToIpLttEntry(lpmHw, &routeEntry, mcRouteLttEntryPtr);
    return retVal;
}
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4McEntryGetSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                          vrId,
                                                          *ipGroupPtr,
                                                          ipGroupPrefixLen,
                                                          *ipSrcPtr,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6UcPrefixAddSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                           vrId,
                                                           *ipAddrPtr,
                                                           prefixLen,
                                                           &(routeEntryInfo.routeEntry),
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            ...
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6UcPrefixBulkAddSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                              ipv6PrefixArrayLen,
                                                              ipv6PrefixArrayPtr,
                                                              defragmentationEnable);
            }
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6UcPrefixDelSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                           vrId, *ipAddrPtr, prefixLen);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6UcPrefixBulkDelSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                           ipv6PrefixArrayLen,
                                                           ipv6PrefixArrayPtr);
            }
            else
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6UcPrefixesFlushSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow), vrId);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6UcPrefixSearchSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                             vrId, *ipAddrPtr, prefixLen,
                                                             &(routeEntryInfo.routeEntry));
            }
            else
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6UcPrefixGetNextSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                               vrId,
                                                               ipAddrPtr,
                                                               prefixLenPtr,
                                                               &(routeEntryInfo.routeEntry));
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6UcPrefixGetSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                             vrId, *ipAddrPtr, prefixLenPtr,
                                                             &(routeEntryInfo.routeEntry));
            }
            else
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                routeEntry.isIpv6Mc = GT_TRUE;
                retVal = prvCpssDxChLpmRamIpv6McEntryAddSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                          vrId,
                                                          *ipGroupPtr,
                                                          ipGroupPrefixLen,
                                                          *ipSrcPtr,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6McEntryDelSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                          vrId, *ipGroupPtr,
                                                          ipGroupPrefixLen,
                                                          *ipSrcPtr, ipSrcPrefixLen);
            }
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv6McEntriesFlushSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow), vrId);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            ...
            {
                routeEntry.isIpv6Mc = GT_TRUE;
                retVal = prvCpssDxChLpmRamIpv6McEntryGetNextSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                              vrId,
                                                              ipGroupPtr,
                                                              ipGroupPrefixLenPtr,
                                                              ipSrcPtr,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            ...
            {
                routeEntry.isIpv6Mc = GT_TRUE;
                retVal = prvCpssDxChLpmRamIpv6McEntryGetSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                          vrId,
                                                          *ipGroupPtr,
                                                          ipGroupPrefixLen,
                                                          *ipSrcPtr,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamFcoePrefixAddSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamFcoePrefixDelSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                           vrId, *fcoeAddrPtr, prefixLen);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamFcoePrefixAddBulkSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamFcoePrefixDelBulkSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                               fcoeAddrPrefixArrayLen,
                                                               fcoeAddrPrefixArrayPtr);
            }
            else
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamFcoePrefixesFlushSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),vrId);
            }
            else
            {
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamFcoePrefixSearchSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                             vrId, *fcoeAddrPtr, prefixLen,
                                                             &(routeEntryInfo.routeEntry));
            }
            else
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamFcoePrefixGetSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamFcoePrefixGetNextSip7((PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                           vrId,
                                                           fcoeAddrPtr,
                                                           prefixLenPtr,
                                                           &(routeEntryInfo.routeEntry));
...
*
* @note   APPLICABLE DEVICES:      Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                return prvCpssDxChIpLpmRamIpv4UcPrefixActivityStatusGetSip7(
                            vrId,
                            ipAddrPtr->arIP,
                            prefixLen,
                            clearActivity,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                return prvCpssDxChIpLpmRamIpv6UcPrefixActivityStatusGetSip7(
                            vrId,
                            ipAddrPtr->arIP,
                            prefixLen,
                            clearActivity,
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                return prvCpssDxChIpLpmRamIpv4McEntryActivityStatusGetSip7(
                            vrId,
                            &(ipGroupPtr->arIP[0]),
                            ipGroupPrefixLen,
                            &(ipSrcPtr->arIP[0]),
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                return prvCpssDxChIpLpmRamIpv6McEntryActivityStatusGetSip7(
                            vrId,
                            ipGroupPtr->arIP,
                            ipGroupPrefixLen,
                            ipSrcPtr->arIP,
...
)
{
    ...
    while (retVal == GT_OK)
    {
        ...
        else
        {
            if (lpmDbPtr->shadowType == PRV_CPSS_DXCH_LPM_RAM_SIP7_SHADOW_E)
            {
                retVal = prvCpssDxChLpmRamIpv4UcPrefixGetNextSip7(lpmDbPtr1,
                                                      vrId, &ipAddr,
                                                      &prefixLength,
                                                      &(routeEntryInfo.routeEntry));
            }
...
/**
* @internal internal_cpssDxChIpLpmValidityCheck function
* @endinternal
*
* @brief   This function validate the LPM in accordance with LpmValidityAction (shadow or hw validation or
*          synchronization between the shadow and HW of the LPM)
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChIpLpmValidityCheck
(
...
)
{
    ...
    switch (lpmHw)
    {
        ...
        case PRV_CPSS_DXCH_LPM_HW_RAM_E:
            ...
            {
                return prvCpssDxChLpmRamDbgValidityCheckSip7(devNum,(PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                        vrId, protocol, prefixType, validityAction, returnOnFailure);
            }
            else
            {
               return prvCpssDxChLpmRamDbgValidityCheck(devNum,(PRV_CPSS_DXCH_LPM_RAM_SHADOWS_DB_STC*)(lpmDbPtr->shadow),
                                                        vrId, protocol, prefixType, validityAction, returnOnFailure);
            }
...
/**
* @internal cpssDxChIpLpmValidityCheck function
* @endinternal
*
* @brief   This function validate the LPM in accordance with LpmValidityAction (shadow or hw validation or
*          synchronization between the shadow and HW of the LPM)
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChIpLpmValidityCheck
(
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChIpLpmValidityCheck);

    CPSS_API_LOCK_DEVICELESS_MAC(PRV_CPSS_FUNCTIONALITY_LPM_MANAGER_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, lpmDBId, devNum, vrId, protocol, prefixType, validityAction, returnOnFailure));

    rc = internal_cpssDxChIpLpmValidityCheck(lpmDBId, devNum, vrId, protocol, prefixType, validityAction, returnOnFailure);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, lpmDBId, devNum, vrId, protocol, prefixType, validityAction, returnOnFailure));
    CPSS_API_UNLOCK_DEVICELESS_MAC(PRV_CPSS_FUNCTIONALITY_LPM_MANAGER_CNS);

...
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_IP_LPM_RAM_SIP7_SHADOW_E),
...
const char * const prvCpssLogEnum_CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT);
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, treatIpv4ClassEasNonRegularUc);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, defIpv4ClassENextHopInfo, CPSS_DXCH_IP_TCAM_ROUTE_ENTRY_INFO_UNT);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFunc_CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT_validityAction = {
     "validityAction", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpLpmValidityCheck_PARAMS[] =  {
    &DX_IN_GT_U32_lpmDBId,
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_vrId,
    &DX_IN_CPSS_IP_PROTOCOL_STACK_ENT_protocol,
    &DX_IN_CPSS_UNICAST_MULTICAST_ENT_prefixType,
    &DX_IN_CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT_validityAction,
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChIpLpmEngineLogLibDb[] = {
    ...
    {"cpssDxChIpLpmValidityCheck", 7, cpssDxChIpLpmValidityCheck_PARAMS, NULL},
    ...
    {"cpssDxChIpLpmDbgPrintLpmNodesStatistics", 4, cpssDxChIpLpmDbgPatTriePrint_PARAMS, NULL},
};

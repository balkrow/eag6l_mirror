...
static const PRV_CPSS_BOOT_CH_PORT_MODE_TO_SPEED_AND_MODE_IF_STC portModeToSpeedAndModeIf[] =
{
    ...
    {_50GBase_KR2_C,        CPSS_PORT_INTERFACE_MODE_KR2_C_E,           CPSS_PORT_SPEED_50000_E},
    {_50GBase_CR2_C,        CPSS_PORT_INTERFACE_MODE_CR2_C_E,           CPSS_PORT_SPEED_50000_E},
...
)
{
    ...
    CPSS_PORT_INTERFACE_MODE_ENT    ifMode;
    CPSS_PORT_SPEED_ENT             speed;
    CPSS_DXCH_PORT_FEC_MODE_ENT     fecMode = CPSS_DXCH_PORT_FEC_MODE_DISABLED_E;
    ...
    if(GT_OK == rc)
    {
        ...
        */
        ...
        /*get fec mode , in case of ap mode +link down fec is disable*/
        if (!(portInfoPtr->apMode && portInfoPtr->isLinkUp == GT_FALSE))
        {
        ...
        switch (fecMode)
        {
            case CPSS_DXCH_PORT_BOTH_FEC_MODE_ENABLED_E:
                portInfoPtr->fecMode = CPSS_PORT_BOTH_FEC_MODE_ENABLED_E;
                break;
            case CPSS_DXCH_PORT_FEC_MODE_DISABLED_E:
                portInfoPtr->fecMode = CPSS_PORT_FEC_MODE_DISABLED_E;
                break;
            case CPSS_DXCH_PORT_FEC_MODE_ENABLED_E:
                portInfoPtr->fecMode = CPSS_PORT_FEC_MODE_ENABLED_E;
                break;
            case CPSS_DXCH_PORT_RS_FEC_544_514_MODE_ENABLED_E:
                portInfoPtr->fecMode = CPSS_PORT_RS_FEC_544_514_MODE_ENABLED_E;
                break;
            case CPSS_DXCH_PORT_RS_FEC_MODE_ENABLED_E:
                portInfoPtr->fecMode = CPSS_PORT_RS_FEC_MODE_ENABLED_E;
                break;

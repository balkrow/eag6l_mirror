...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChCscdLogLibDb[] = {
    ...
    {"cpssDxChCscdPortForceNewForwardOrFromCpuDsaEnableSet", 3, prvCpssLogGenDevNumPortNumEnable_PARAMS, NULL},
    {"cpssDxChCscdPortForceNewForwardOrFromCpuDsaEnableGet", 3, prvCpssLogGenDevNumPortNumEnablePtr_PARAMS, NULL},
};

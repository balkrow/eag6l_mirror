...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_errorLatchDataPtr = {
     "errorLatchDataPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_protWinIdxPtr = {
     "protWinIdxPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_spByteIndexPtr = {
     "spByteIndexPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPpuDauProtectedWindowErrorLatchDataGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_GT_U32_PTR_protWinIdxPtr,
    &DX_OUT_GT_U32_PTR_errorLatchDataPtr,
    &DX_OUT_GT_U32_PTR_spByteIndexPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPpuLogLibDb[] = {
    ...
    {"cpssDxChPpuDauProtectedWindowErrorLatchDataGet", 4, cpssDxChPpuDauProtectedWindowErrorLatchDataGet_PARAMS, NULL},

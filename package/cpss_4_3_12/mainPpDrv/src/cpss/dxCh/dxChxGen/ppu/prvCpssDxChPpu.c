...
)
{
    ...
    GT_U32                   dummy;
    GT_U32                   hwTtiActionArray[12];  /* TTI_ACTION_TYPE_2_SIZE_CNS = 12 */
        ...
        else
        {
            ...
            else
            {
                ...
                U32_SET_FIELD_IN_ENTRY_MAC(hwData, offset + 31, 5,
                        ppuActionEntryPtr->rotActionEntry[i].setBitsOffset);
    ...
    for(i = 0; i < CPSS_DXCH_PPU_KSTG_ROTS_MAX_CNS; i++)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                ppuActionEntryPtr->rotActionEntry[i].setBitsOffset = regData & BIT_MASK_MAC(5);
...
/**
* @internal  prvCpssDxChPpuDauProtectedWindowErrorLatchDataGet function
* @endinternal
*
...
*
*/
GT_STATUS prvCpssDxChPpuDauProtectedWindowErrorLatchDataGet
(
    IN   GT_U8                                       devNum,
...
)
{
    ...
    /* get register address for DAU protected window error Latch data */
    regAddr = PRV_DXCH_REG1_UNIT_PPU_MAC(devNum).dau.dauProtWinLatchData;

    /* read DAU protected window error latch data */
    rc = prvCpssHwPpReadRegister(devNum, regAddr, &regData);

    *protWinIdxPtr     = U32_GET_FIELD_MAC(regData,
                                           CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_WIN_IDX_OFFSET,
                                           CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_WIN_IDX_SIZE);
    *errorLatchDataPtr = U32_GET_FIELD_MAC(regData,
                                           CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_DATA_OFFSET,
                                           CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_DATA_SIZE);
    *spByteIndexPtr    = U32_GET_FIELD_MAC(regData,
                                           CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_SP_INDEX_OFFSET,
                                           CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_SP_INDEX_OFFSET);

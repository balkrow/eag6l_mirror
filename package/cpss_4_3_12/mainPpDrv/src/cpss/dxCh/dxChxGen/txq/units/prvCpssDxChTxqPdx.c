...
#define PDX2PDX_INTERFACE_OFFSET_MAC(_devNum,_X)    prvCpssDxChTxqPdxInterfaceMapGetOffset(_devNum,_X)
/*macro that get size of specific PDX2PDX_INTERFACE*/
#define PDX2PDX_INTERFACE_FIELD_SIZE_MAC(_devNum,_X)    prvCpssDxChTxqPdxInterfaceMapGetFieldSize(_devNum,_X)
...
#define PRV_PDX_SIP_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName) \
     (PRV_CPSS_SIP_7_CHECK_MAC(_dev)?TXQ_AAS_PDX_##_fieldName:TXQ_IRONMAN_PDX_##_fieldName)


#define PRV_PDX_SIP_6_20_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName) \
     (PRV_CPSS_SIP_6_30_CHECK_MAC(_dev)? \
     PRV_PDX_SIP_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName):TXQ_HARRIER_PDX_##_fieldName)
...
static GT_U32 prvCpssDxChTxqPdxInterfaceMapGetOffset
(
    GT_U8  devNum,
    GT_U32 interfaceId
)
{
    ...
    {
       CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "prvCpssDxChTxqPdxInterfaceMapGetOffset - can not be used for SIP7");
    }
...
static GT_U32 prvCpssDxChTxqPdxInterfaceMapGetFieldSize
(
    GT_U8  devNum,
    GT_U32 interfaceId
)
{
    ...
    if(GT_FALSE == PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
     ...
     {
       CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "prvCpssDxChTxqPdxInterfaceMapGetFieldSize - can not be used for SIP7");
     }
...
)
{
    ...
    */
    ...
    {
        U32_SET_FIELD_MASKED_MAC(regValue, PDX2PDX_INTERFACE_OFFSET_MAC(devNum,i),
                     PDX2PDX_INTERFACE_FIELD_SIZE_MAC(devNum,i),
                     connectedPdxId[i]);
    }
...
)
{
    ...
    if(GT_FALSE==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        TXQ_SIP_6_CHECK_QUEUE_GROUP_NUM_MAC(devNum, index);
    }
    ...
    if(GT_FALSE==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        ...
        {
          offset = TXQ_PDX_ITX_QCX_QGRPMAP_QUEUE_BASE_FIELD_OFFSET;
          size = TXQ_PDX_ITX_QCX_QGRPMAP_QUEUE_BASE_FIELD_SIZE;
        }
        else if(GT_FALSE == PRV_CPSS_SIP_6_15_CHECK_MAC(devNum))
        {
          offset = TXQ_HAWK_PDX_QCX_QGRPMAP_QUEUE_BASE_FIELD_OFFSET;
          size = TXQ_HAWK_PDX_QCX_QGRPMAP_QUEUE_BASE_FIELD_SIZE;
        }
        else if(GT_FALSE == PRV_CPSS_SIP_6_20_CHECK_MAC(devNum))
        {
          offset = TXQ_PHOENIX_PDX_QCX_QGRPMAP_QUEUE_BASE_FIELD_OFFSET;
          size = TXQ_PHOENIX_PDX_QCX_QGRPMAP_QUEUE_BASE_FIELD_SIZE;
        }
        else if(GT_FALSE == PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
        {
          offset = TXQ_HARRIER_PDX_QCX_QGRPMAP_QUEUE_BASE_FIELD_OFFSET;
          size = TXQ_HARRIER_PDX_QCX_QGRPMAP_QUEUE_BASE_FIELD_SIZE;
        }
        else
        {
          offset = TXQ_IRONMAN_PDX_QCX_QGRPMAP_QUEUE_BASE_FIELD_OFFSET;
          size = TXQ_IRONMAN_PDX_QCX_QGRPMAP_QUEUE_BASE_FIELD_SIZE;
        }
        ...
        if(GT_FALSE == PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
        {
            if(GT_FALSE == PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
            {
              offset = TXQ_PDX_ITX_QCX_QGRPMAP_QUEUE_PDX_INDEX_FIELD_OFFSET;
              size = TXQ_PDX_ITX_QCX_QGRPMAP_QUEUE_PDX_INDEX_FIELD_SIZE;
            }
            else if(GT_FALSE == PRV_CPSS_SIP_6_15_CHECK_MAC(devNum))
            {
              offset = TXQ_HAWK_PDX_QCX_QGRPMAP_QUEUE_PDX_INDEX_FIELD_OFFSET;
              size = TXQ_HAWK_PDX_QCX_QGRPMAP_QUEUE_PDX_INDEX_FIELD_SIZE;
            }
            else if(GT_FALSE == PRV_CPSS_SIP_6_20_CHECK_MAC(devNum))
            {
              offset = TXQ_PHOENIX_PDX_QCX_QGRPMAP_QUEUE_PDX_INDEX_FIELD_OFFSET;
              size = TXQ_PHOENIX_PDX_QCX_QGRPMAP_QUEUE_PDX_INDEX_FIELD_SIZE;
            }
            else
            {
              offset = TXQ_HARRIER_PDX_QCX_QGRPMAP_QUEUE_PDX_INDEX_FIELD_OFFSET;
              size = TXQ_HARRIER_PDX_QCX_QGRPMAP_QUEUE_PDX_INDEX_FIELD_SIZE;
            }
        ...
        if(GT_FALSE == PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
        {
          offset = TXQ_PDX_ITX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_OFFSET;
          size = TXQ_PDX_ITX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_SIZE;
        }
        else if(GT_FALSE == PRV_CPSS_SIP_6_15_CHECK_MAC(devNum))
        {
          offset = TXQ_HAWK_PDX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_OFFSET;
          size = TXQ_HAWK_PDX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_SIZE;
        }
        else if(GT_FALSE == PRV_CPSS_SIP_6_20_CHECK_MAC(devNum))
        {
          offset = TXQ_PHOENIX_PDX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_OFFSET;
          size = TXQ_PHOENIX_PDX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_SIZE;
        }
        else if(GT_FALSE == PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
        {
          offset = TXQ_HARRIER_PDX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_OFFSET;
          size = TXQ_HARRIER_PDX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_SIZE;
        }
        else
        {
          offset = TXQ_IRONMAN_PDX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_OFFSET;
          size = TXQ_IRONMAN_PDX_QCX_QGRPMAP_QUEUE_PDS_INDEX_FIELD_SIZE;
        }
    ...
    if(GT_FALSE == PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
    {
      offset = TXQ_PDX_ITX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_OFFSET;
      size = TXQ_PDX_ITX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_SIZE;
    }
    else if(GT_FALSE == PRV_CPSS_SIP_6_15_CHECK_MAC(devNum))
    {
      offset = TXQ_HAWK_PDX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_OFFSET;
      size = TXQ_HAWK_PDX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_SIZE;
    }
    else if(GT_FALSE == PRV_CPSS_SIP_6_20_CHECK_MAC(devNum))
    {
      offset = TXQ_PHOENIX_PDX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_OFFSET;
      size = TXQ_PHOENIX_PDX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_SIZE;
    }
    else if(GT_FALSE == PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
    {
      offset = TXQ_HARRIER_PDX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_OFFSET;
      size = TXQ_HARRIER_PDX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_SIZE;
    }
    else if(GT_FALSE == PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
      offset = TXQ_IRONMAN_PDX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_OFFSET;
      size = TXQ_IRONMAN_PDX_QCX_QGRPMAP_DP_CORE_LOCAL_TRG_PORT_FIELD_SIZE;
    }
    else
    {
        offset = TXQ_AAS_PDX_DX_TRG_PORT_MAP_0_DP_CORE_LOCAL_TRG_PORT_FIELD_OFFSET;
        size = TXQ_AAS_PDX_DX_TRG_PORT_MAP_0_DP_CORE_LOCAL_TRG_PORT_FIELD_SIZE;
    }
    ...
    rc = prvCpssSip6TxqPdxTableLogInit(&tableLog,0,
        CPSS_DXCH_SIP6_TXQ_PDX_DX_QGRPMAP_E,"Queue_Group_Map",index);
    if (rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    if(GT_FALSE==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        ...
        else /* the field is not valid for this device */
        {
    ...
    {
        txPortMapPtr->queueBase =0;
        txPortMapPtr->queuePdxIndex =0;
        txPortMapPtr->queuePdsIndex = 0;
    }
...
/**
* @internal prvCpssDxChTxqSip7PdxQueueRenamingEnableSet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssDxChTxqSip7PdxQueueRenamingEnableSet
(
    IN GT_U8   devNum,
    IN GT_BOOL enable
)
{
    GT_U32      regAddr,offset,size,i;
    ...
    rc = prvCpssSip6TxqPdxLogInit(&log,"Renaming_Enable");
    if (rc != GT_OK)
    {
      return rc;
    }

    offset = TXQ_AAS_PDX_RENAMING_ENABLE_QUEUE_RENAMING_EN_FIELD_OFFSET;
    size   = TXQ_AAS_PDX_RENAMING_ENABLE_QUEUE_RENAMING_EN_FIELD_SIZE;

    regAddr =PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.pdx.Renaming_Enable;
...
/**
* @internal prvCpssDxChTxqSip7PdxQueueRenamingEnableGet function
* @endinternal
*
* @brief   Enable/disable "queue renaming" feature
*
...
*
* @param[in] devNum               - device number
* @param[in] tileNum              - tile number(Applicable range 0..1)
* @param[out] enable              - (pointer to) Enable/disable "queue renaming" feature
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - wrong sdq number.
* @retval GT_HW_ERROR              - on writing to HW error.
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssDxChTxqSip7PdxQueueRenamingEnableGet
(
    IN GT_U8    devNum,
    IN GT_U32   tileNum,
    OUT GT_BOOL  *enablePtr
...
{
    GT_U32      regAddr,offset,size,value;
    ...
    rc = prvCpssSip6TxqRegisterFieldRead(devNum,tileNum,regAddr,offset,size,&value);
    if(rc!=GT_OK)
    {
      CPSS_LOG_ERROR_AND_RETURN_MAC(rc, " prvCpssSip6TxqRegisterFieldWrite  failed \n");
    }
...
GT_STATUS prvCpssDxChTxqSip7PdxDpMappingSet
(
    IN GT_U8    devNum,
    IN GT_U32    tileToUpdate
)
{
    GT_U32 tileNum,dpNum,i,j;
    PRV_CPSS_DXCH_TXQ_SIP_6_REG_LOG_STC log;
    GT_STATUS rc;
    ...
    rc = prvCpssSip6TxqPdxLogInit(&log,"pds_msg_map_pds_id");
    if (rc != GT_OK)
    {
      return rc;
    }

    PRV_CPSS_NUM_OF_TILE_GET_MAC(devNum,tileNum);
    dpNum = MAX_DP_IN_TILE(devNum);
    ...
    rc = prvCpssSip6TxqRegisterFieldRead(devNum,tileToUpdate,regAddr,0,32,&regValue);
    if(rc!=GT_OK)
    {
      CPSS_LOG_ERROR_AND_RETURN_MAC(rc, " prvCpssSip6TxqRegisterFieldRead  failed \n");
    }
    ...
    for(i=0;i<tileNum;i++)
    {
        for(j=0;j<dpNum;j++)
        {
           globalPdsId = PRV_TXQ_PDS_GLOBAL_ID_MAC(devNum,i,j);
           offset = size*globalPdsId;
    ...
    rc = prvCpssSip6TxqRegisterFieldWrite(devNum,tileToUpdate,&log,regAddr,0,32,regValue);
    if(rc!=GT_OK)
    {
      CPSS_LOG_ERROR_AND_RETURN_MAC(rc, " prvCpssSip6TxqRegisterFieldWrite  failed \n");
    }
    ...
    rc = prvCpssSip6TxqPdxLogInit(&log,"pds_msg_map_pdx_id");
    if (rc != GT_OK)
    {
      return rc;
    }

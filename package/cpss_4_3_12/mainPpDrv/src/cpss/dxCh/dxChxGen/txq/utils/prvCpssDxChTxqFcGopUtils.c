...
typedef struct{
    ...
    GT_U32                  regAddrEmacMtiCpu;
    GT_U32                  regAddrUsx;
    GT_U32                  regAddrEmacUsx;

} PRV_TXQ_GOP_UTILS_REGISTER_PARAMS_STC;


#define PRV_TXQ_GOP_UTILS_ADDR_DB_RESET_MAC(_addrDb) \
    do\
    {\
      _addrDb.regAddrMti100 = PRV_CPSS_SW_PTR_ENTRY_UNUSED;\
      _addrDb.regAddrMti400 = PRV_CPSS_SW_PTR_ENTRY_UNUSED;\
      _addrDb.regAddrMtiCpu = PRV_CPSS_SW_PTR_ENTRY_UNUSED;\
      _addrDb.regAddrUsx = PRV_CPSS_SW_PTR_ENTRY_UNUSED;\
      _addrDb.regAddrEmacMti100 = PRV_CPSS_SW_PTR_ENTRY_UNUSED;\
      _addrDb.regAddrEmacUsx = PRV_CPSS_SW_PTR_ENTRY_UNUSED;\
      _addrDb.regAddrEmacMtiCpu = PRV_CPSS_SW_PTR_ENTRY_UNUSED;\
    }while(0)
...
#define PRV_TXQ_GOP_UTILS_ADDR_DB_INIT_COMMAND_CONFIG(_devNum,_portMacNum,_addrDb) \
    do\
    {\
       PRV_TXQ_GOP_UTILS_ADDR_DB_RESET_MAC(_addrDb);\
      ...
      _addrDb.regAddrEmacUsx = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(_devNum)->GOP.MTI[_portMacNum].MTI_USX_MAC.EMAC.emac_commandConfig;\
      _addrDb.regAddrEmacMtiCpu = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(_devNum)->GOP.MTI[_portMacNum].MTI_CPU_MAC.EMAC.emac_commandConfig;\
    }while(0);
...
#define PRV_TXQ_GOP_UTILS_ADDR_DB_INIT_MAC0_MAC(_devNum,_portMacNum,_addrDb) \
    ...
    {\
      ...
      _addrDb.regAddrEmacUsx = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(_devNum)->GOP.MTI[_portMacNum].MTI_USX_MAC.EMAC.emac_macAddr0;\
      _addrDb.regAddrEmacMtiCpu = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(_devNum)->GOP.MTI[_portMacNum].MTI_CPU_MAC.EMAC.emac_macAddr0;\
    }while(0);
...
#define PRV_TXQ_GOP_UTILS_ADDR_DB_INIT_MAC1_MAC(_devNum,_portMacNum,_addrDb) \
    ...
    {\
      ...
      _addrDb.regAddrEmacUsx = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(_devNum)->GOP.MTI[_portMacNum].MTI_USX_MAC.EMAC.emac_macAddr1;\
      _addrDb.regAddrEmacMtiCpu = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(_devNum)->GOP.MTI[_portMacNum].MTI_CPU_MAC.EMAC.emac_macAddr1;\
    }while(0);
...
)
{
   ...
   if(regAddrDbPtr->regAddrEmacMtiCpu != PRV_CPSS_SW_PTR_ENTRY_UNUSED)
   {
       regDataArray[PRV_CPSS_PORT_MTI_CPU_E].regAddr = regAddrDbPtr->regAddrEmacMtiCpu;
       regDataArray[PRV_CPSS_PORT_MTI_CPU_E].fieldData = fieldData;
       regDataArray[PRV_CPSS_PORT_MTI_CPU_E].fieldOffset = fieldOffset;
       regDataArray[PRV_CPSS_PORT_MTI_CPU_E].fieldLength = fieldLength;
   }
   ...
   if(regAddrDbPtr->regAddrEmacUsx != PRV_CPSS_SW_PTR_ENTRY_UNUSED)
   {
       regDataArray[PRV_CPSS_PORT_MTI_USX_E].regAddr = regAddrDbPtr->regAddrEmacUsx;
       regDataArray[PRV_CPSS_PORT_MTI_USX_E].fieldData = fieldData;
       regDataArray[PRV_CPSS_PORT_MTI_USX_E].fieldOffset = fieldOffset;
       regDataArray[PRV_CPSS_PORT_MTI_USX_E].fieldLength = fieldLength;
   }
...
)
{
    ...
    GT_U32 portMacNum; /* MAC number */
    GT_STATUS rc = GT_OK;
    GT_U32 maxSize = (GT_U32)(1<<PRV_PFC_MTI_X_PAUSE_QUANTA_REG_PAUSE_QUANTA_FIELD_SIZE)-1;

    if(pauseQuanta>maxSize)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "pauseQuanta %d out of range 0x%x",pauseQuanta,
            maxSize);
    }

    PRV_CPSS_DXCH_MAC_IN_PHY_PORT_NUM_OR_CPU_PORT_CHECK_AND_MAC_NUM_GET_MAC(devNum, portNum, portMacNum);

    PRV_TXQ_GOP_UTILS_ADDR_DB_RESET_MAC(addrDb);
    ...
    case 1:
        ...
        addrDb.regAddrEmacMtiCpu = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_CPU_MAC.EMAC.emac_cl01PauseQuanta;

        addrDb.regAddrUsx    = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_MAC.cl01PauseQuanta;
        addrDb.regAddrEmacUsx= PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_MAC.EMAC.emac_cl01PauseQuanta;
        break;
    case 2:
    case 3:
    ...
    )
{
    ...
    case 1:
        ...
        addrDb.regAddrEmacMtiCpu = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_CPU_MAC.EMAC.emac_cl01QuantaThresh;

        addrDb.regAddrUsx    = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_MAC.cl01QuantaThresh;
        addrDb.regAddrEmacUsx= PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_MAC.EMAC.emac_cl01QuantaThresh;
...
)
{
        ...
        GT_U32                          tcBitVector=0xFF;
        GT_BOOL                         statisticMode = GT_FALSE;
        ...
        if(currentFcMode== CPSS_DXCH_PORT_FC_MODE_DISABLE_E)
        {
            /*check if this is a statistic mode*/
            rc = prvCpssSip6TxqPfcStatisticModeGet(devNum,tileNum,dpNum,localdpPortNum,&statisticMode);
            if(rc!=GT_OK)
            {
              CPSS_LOG_ERROR_AND_RETURN_MAC(rc, "prvCpssSip6TxqPfcStatisticModeGet failed for localPort %d",localdpPortNum);
            }

            if(GT_TRUE==statisticMode)
            {
                currentFcMode = CPSS_DXCH_PORT_FC_MODE_INGRESS_BUFFER_STATISTICS_E;
            }
        }
        ...
        if(fcMode!= CPSS_DXCH_PORT_FC_MODE_DISABLE_E)
        {
            ...
            if((entry.entryType ==PRV_CPSS_PFCC_CFG_ENTRY_TYPE_BUBBLE)||
                (entry.pfcMessageTrigger == GT_FALSE)/*current mode is statistic*/||
                (fcMode == CPSS_DXCH_PORT_FC_MODE_INGRESS_BUFFER_STATISTICS_E/*required mode is statistic*/))
            {
                ...
                else if(fcMode == CPSS_DXCH_PORT_FC_MODE_INGRESS_BUFFER_STATISTICS_E)
                {
                    tcBitVector = 0xFF;
                }
                ...
                if(0==tcBitVector)
                {
                    /*if flow control is configured then at least one tc should be enabled in order to configure triger*/
                    tcBitVector = 0xFF;
                }

                rc = prvCpssFalconTxqPffcTableSyncSet(devNum,tileNum,dpNum,localdpPortNum,tcBitVector,
                    /*on statistic do not trigger*/(fcMode != CPSS_DXCH_PORT_FC_MODE_INGRESS_BUFFER_STATISTICS_E));
            }

        }
        else
        {
             rc = prvCpssFalconTxqPffcTableSyncSet(devNum,tileNum,dpNum,localdpPortNum,0,GT_FALSE);
        }
        ...
        if((fcMode != CPSS_DXCH_PORT_FC_MODE_INGRESS_BUFFER_STATISTICS_E)||
            (currentFcMode != CPSS_DXCH_PORT_FC_MODE_DISABLE_E))
        {
            if(fcMode == CPSS_DXCH_PORT_FC_MODE_INGRESS_BUFFER_STATISTICS_E)
            {
                fcMode = CPSS_DXCH_PORT_FC_MODE_DISABLE_E;
            }
           ...
           if(rc!=GT_OK)
            ...
            /*Extra messures in order to avoid corner cases.
                       Disable zero override of enabled SDQ TCs in case of CPSS_DXCH_PORT_FC_MODE_PFC_E.
                       Clear sync otherwise.
                    */
            rc = prvCpssDxChPortSip6PfcSyncMac(devNum,tileNum,dpNum,localdpPortNum,portNum,
                    (fcMode == CPSS_DXCH_PORT_FC_MODE_PFC_E)?GT_FALSE:GT_TRUE);
            if(rc!=GT_OK)
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(rc, " prvCpssDxChPortSip6PfcSyncMac  failed for portNum  %d  ",portNum);
            }
...
)
{
    ...
    if(*fcModePtr== CPSS_DXCH_PORT_FC_MODE_DISABLE_E)
    {
        /*check if this is a statistic mode*/
        rc = prvCpssSip6TxqPfcStatisticModeGet(devNum,tileNum,dpNum,localdpPortNum,&statisticMode);
        if(rc!=GT_OK)
        ...
        if(GT_TRUE==statisticMode)
        {
            *fcModePtr = CPSS_DXCH_PORT_FC_MODE_INGRESS_BUFFER_STATISTICS_E;
        }
    }
...
)
{
    ...
    /*always take from EMAC,if not available fall to PMAC*/

    switch(tc)
    {
    case 0:
    case 1:
        regAddrMti100 = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI100_MAC.EMAC.emac_cl01PauseQuanta;
        ...
        regAddrMtiCpu = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_CPU_MAC.EMAC.emac_cl01PauseQuanta;
        ...
        regAddrUsx    = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_MAC.EMAC.emac_cl01PauseQuanta;
...
)
{
    ...
    case 0:
    case 1:
        regAddrMti100 = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI100_MAC.EMAC.emac_cl01QuantaThresh;
        if(PRV_CPSS_SW_PTR_ENTRY_UNUSED == regAddrMti100)
        {
        ...
        regAddrMtiCpu = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_CPU_MAC.EMAC.emac_cl01QuantaThresh;
        if(PRV_CPSS_SW_PTR_ENTRY_UNUSED == regAddrMtiCpu)
        {
            regAddrMtiCpu = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_CPU_MAC.cl01QuantaThresh;
        }

        regAddrUsx    = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_MAC.EMAC.emac_cl01QuantaThresh;
        if(PRV_CPSS_SW_PTR_ENTRY_UNUSED == regAddrUsx)
        {
...
)
{
    ...
    else if (macType == PRV_CPSS_PORT_MTI_USX_E)
    {
        ...
        if(PRV_CPSS_SW_PTR_ENTRY_UNUSED == regAddr)
        {
            /*try emac_rxPauseStatus*/
            regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_MAC.EMAC.emac_rxPauseStatus;
            if(PRV_CPSS_SW_PTR_ENTRY_UNUSED == regAddr)
            {
                 CPSS_LOG_ERROR_AND_RETURN_MAC(GT_NOT_SUPPORTED, LOG_ERROR_NO_MSG);
            }
...
/**
* @internal prvCpssDxChPortSip6PauseOverrideSet function
* @endinternal
*
* @brief   This sets the   value that  will be transmitted to the RX FCU as the value of the priority
*
* @note   APPLICABLE DEVICES:     Falcon; AC5P; AC5X; Harrier; Ironman
* @note  NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
* @param[in] devNum           -PP's device number.
* @param[in] portNum          -physical port number
* @param[in] ctrl             -low 16 bits of Port<<%n>> Pause Override.Per-priority override control.
* @param[in] value            -high  16 bits of Port<<%n>> Pause Override.Per priority override value.
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PTR               - on NULL ptr
* @retval GT_HW_ERROR              - if write failed
*/
static GT_STATUS prvCpssDxChPortSip6PauseOverrideSet
(
    IN  GT_U8                    devNum,
    IN  GT_PHYSICAL_PORT_NUM     portNum,
    IN  GT_U32                   ctrl,
...
)
{
    ...
    /*
         0-15   =  Per-priority override control.
                    bit[N] = 1: the pause value for priority N is taken from pause_override_val[N]

        16 -31  = Per priority override value.

        When the corresponding control is set, this value will be transmitted to the RX FCU as the value of the priority.
    ...
    */
    ...
    regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_EXT.pauseOverride;
    ...
    regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_EXT.segPauseOverride;
    if(regAddr != PRV_CPSS_SW_PTR_ENTRY_UNUSED)
    {
        regDataArray[PRV_CPSS_PORT_MTI_400_E].regAddr = regAddr;
        regDataArray[PRV_CPSS_PORT_MTI_400_E].fieldData = value;
        regDataArray[PRV_CPSS_PORT_MTI_400_E].fieldLength = 32;
        regDataArray[PRV_CPSS_PORT_MTI_400_E].fieldOffset = 0;
    }

    regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_CPU_EXT.pauseOverride;
    if(regAddr != PRV_CPSS_SW_PTR_ENTRY_UNUSED)
    {
        regDataArray[PRV_CPSS_PORT_MTI_CPU_E].regAddr = regAddr;
        regDataArray[PRV_CPSS_PORT_MTI_CPU_E].fieldData = value;
        regDataArray[PRV_CPSS_PORT_MTI_CPU_E].fieldLength = 32;
        regDataArray[PRV_CPSS_PORT_MTI_CPU_E].fieldOffset = 0;
    }

    regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_EXT.pauseOverride;
    if(regAddr != PRV_CPSS_SW_PTR_ENTRY_UNUSED)
    {
        regDataArray[PRV_CPSS_PORT_MTI_USX_E].regAddr = regAddr;
        regDataArray[PRV_CPSS_PORT_MTI_USX_E].fieldData = value;
        regDataArray[PRV_CPSS_PORT_MTI_USX_E].fieldLength = 32;
...
/**
* @internal prvCpssDxChPortSip6PauseOverrideGet function
* @endinternal
*
* @brief   This gets the value of  Port<<%n>> Pause Override register
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman
* @note  NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
* @param[in] devNum           -PP's device number.
* @param[in] portNum          -physical port number
* @param[out] valuePtr        -(pointer to) value of register
* @param[out] regAddrPtr      -(pointer to) adress of register
*
* @retval GT_OK               - on success
* @retval GT_BAD_PTR          - on NULL ptr
* @retval GT_HW_ERROR         - if write failed
*/
GT_STATUS prvCpssDxChPortSip6PauseOverrideGet
(
    IN  GT_U8                    devNum,
    IN  GT_PHYSICAL_PORT_NUM     portNum,
    OUT  GT_U32                  *valuePtr,
...
/**
* @internal prvCpssSip6TxqPfcMacRxResponceControlEnableSet  function
* @endinternal
*
* @brief   Configure which TC can be changed by PFC NW messages .
*               TC set to 1 in ctrl are overriden to 0 .
*               TC set to 0 in ctrl are not overriden.
*
...
* @param[in] portNum                 - physical port number
* @param[in] ctrl                    - When the corresponding control bit is set,
 *                                     zero value will be transmitted to the RX FCU as the value of the priority.
*
* @retval GT_OK                    - on success
...
*/
GT_STATUS prvCpssSip6TxqPfcMacRxResponceControlEnableSet
(
    IN GT_U8   devNum,
    IN  GT_PHYSICAL_PORT_NUM     portNum,
    IN GT_U32  ctrl
)
{
    ...
    rc = prvCpssDxChPortSip6PauseOverrideSet(devNum,portNum,ctrl,0);
    if(rc!=GT_OK)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(rc, LOG_ERROR_NO_MSG);
    }
...
)
{
    ...
    {
        /* AAS */
        rc = prvCpssDxChPortDpAasPortMifPfcEnableSet(
            devNum, portMacNum,
...
)
{
    ...
    {
        /* AAS */
        rc = prvCpssDxChPortDpAasPortMifPfcEnableGet(
            devNum, portMacNum,
      ...
      if(PRV_CPSS_PP_MAC(devNum)->devFamily == CPSS_PP_FAMILY_DXCH_IRONMAN_E)
       {
           ...
           {
               regAddr0 = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_MAC.BR.brCntrl;
               regAddr1 = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_USX_MAC.BR.brStatus ;
           }
           else if(macType == PRV_CPSS_PORT_MTI_CPU_E)
           {
               regAddr0 = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_CPU_MAC.BR.brCntrl;
               regAddr1 = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->GOP.MTI[portMacNum].MTI_CPU_MAC.BR.brStatus ;
           }
           else
           {
               regAddr0 = PRV_CPSS_SW_PTR_ENTRY_UNUSED;
...
* @param[in] devNum           - device number.
* @param[in] portNum          - physical port number
* @param[out] txFiFoEmptyPtr          (Pointer to)  MAC fifo Tx idle status
* @param[out] rxFiFoEmptyPtr        - (Pointer to)  MAC fifo Rx idle status
...
(
    IN  GT_U8                    devNum,
    IN  GT_PHYSICAL_PORT_NUM     portNum,
    OUT  GT_BOOL                  *txFiFoEmptyPtr,
    OUT  GT_BOOL                  *rxFiFoEmptyPtr,
    OUT  GT_BOOL                  *txIdlePtr
)
{
    GT_U32 regAddr;
    GT_U32 value=0;
    ...
    PRV_CPSS_PORT_TYPE_ENT macType;
    GT_STATUS rc = GT_OK;
    GT_U32   emacTxFifoEmpty = 1,pmacTxFifoEmpty;
    GT_U32   emacRxFifoEmpty = 1,pmacRxFifoEmpty;
         ...
         (tempSystemRecovery_Info.systemRecoveryProcess != CPSS_SYSTEM_RECOVERY_PROCESS_FAST_BOOT_E ) )
    {
        ...
        *txFiFoEmptyPtr = GT_TRUE;
        *rxFiFoEmptyPtr = GT_TRUE;
        *txIdlePtr =  GT_TRUE;
        return GT_OK;
    }
    ...
    if(rc == GT_OK)
    {
       pmacTxFifoEmpty = U32_GET_FIELD_MAC(value,PRV_PFC_MTI_X_COMMAND_TX_FIFO_IDLE_STATUS_FIELD_OFFSET,
         PRV_PFC_MTI_X_COMMAND_TX_FIFO_IDLE_STATUS_FIELD_SIZE);
       pmacRxFifoEmpty= U32_GET_FIELD_MAC(value,PRV_PFC_MTI_X_COMMAND_RX_FIFO_IDLE_STATUS_FIELD_OFFSET,
         PRV_PFC_MTI_X_COMMAND_RX_FIFO_IDLE_STATUS_FIELD_SIZE);

       if(GT_TRUE==PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
       {
            *txIdlePtr = BIT2BOOL_MAC(U32_GET_FIELD_MAC(value,PRV_PFC_MTI_X_COMMAND_TX_IS_IDLE_STATUS_FIELD_OFFSET,
         PRV_PFC_MTI_X_COMMAND_TX_IS_IDLE_STATUS_FIELD_SIZE));
       }
       else
       {
            *txIdlePtr = GT_TRUE;
       ...
       {
            emacTxFifoEmpty = U32_GET_FIELD_MAC(value,PRV_PFC_MTI_X_COMMAND_EMAC_TX_FIFO_IDLE__STATUS_FIELD_OFFSET,
             PRV_PFC_MTI_X_COMMAND_EMAC_TX_FIFO_IDLE__STATUS_FIELD_SIZE);

            emacRxFifoEmpty = U32_GET_FIELD_MAC(value,PRV_PFC_MTI_X_COMMAND_EMAC_RX_FIFO_IDLE_STATUS_FIELD_OFFSET,
             PRV_PFC_MTI_X_COMMAND_EMAC_RX_FIFO_IDLE_STATUS_FIELD_SIZE);
        }

#ifndef ASIC_SIMULATION
        *txFiFoEmptyPtr = BIT2BOOL_MAC((pmacTxFifoEmpty&emacTxFifoEmpty));
        *rxFiFoEmptyPtr = BIT2BOOL_MAC((pmacRxFifoEmpty&emacRxFifoEmpty));
#else
/*simulation does not support this*/
        ...
        *txIdlePtr =  GT_TRUE;
/*avoid warning*/
        emacTxFifoEmpty &=emacRxFifoEmpty;
        pmacTxFifoEmpty &=pmacRxFifoEmpty;
#endif
...
/**
* @internal prvCpssDxChPortSip6PreemptionStatusGet  function
* @endinternal
*
* @brief   Get preemption  status of  physical port.
*
* @note   APPLICABLE DEVICES: AC5P; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:   xCat3; AC5;  Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2;Falcon;AC5X;
*
* @param[in] devNum                  - physical device number
* @param[in] portNum                 - physical port number
* @param[out] statusPtr           - (pointer to)preemption status
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_BAD_PARAM             - on wrong device number, profile set or
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssDxChPortSip6PreemptionStatusGet
(
   IN  GT_U8                            devNum,
   IN  GT_PHYSICAL_PORT_NUM             portNum,
   OUT CPSS_DXCH_PORT_PREEMPTION_STATUS_STC * statusPtr
)
{
    GT_STATUS rc;
    PRV_TXQ_GOP_UTILS_BR_PARAMS_STC brData;
    ...
    if(GT_FALSE == brData.paramValid)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_FAIL, "Failed to get br params for device %d port %d",devNum,portNum);
    }

    tmp = U32_GET_FIELD_MAC(brData.status,0,3);

    switch(tmp)
    {
        case 0:
          statusPtr->txVerify = CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_UNKNOWN_E;
          break;
        case 1:
          statusPtr->txVerify = CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_INIT_E;
          break;
        case 2:
          statusPtr->txVerify = CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_VERIFYING_E;
          break;
         case 3:
          statusPtr->txVerify = CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_OK_E;
          break;
         case 4:
          statusPtr->txVerify = CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_FAILED_E;
          break;
         case 5:
          statusPtr->txVerify = CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_DISABLED_E;
          break;
        default:
         CPSS_LOG_ERROR_AND_RETURN_MAC(GT_FAIL, "Failed to get txVerify status for device %d port %d .Got invalid value %d",devNum,portNum,tmp);
          break;
    }

    tmp = U32_GET_FIELD_MAC(brData.status,4,1);
    statusPtr->asmErrDetected = BIT2BOOL_MAC(tmp);

    tmp = U32_GET_FIELD_MAC(brData.status,5,1);
    statusPtr->smdErrDetected= BIT2BOOL_MAC(tmp);

    tmp = U32_GET_FIELD_MAC(brData.status,6,1);
    statusPtr->verifyFrameRx= BIT2BOOL_MAC(tmp);

    tmp = U32_GET_FIELD_MAC(brData.status,7,1);
    statusPtr->responceFrameRx= BIT2BOOL_MAC(tmp);

    tmp = U32_GET_FIELD_MAC(brData.control,
        PRV_PFC_MTI_X_COMMAND_TX_PREEMPT_EN_FIELD_OFFSET,PRV_PFC_MTI_X_COMMAND_TX_PREEMPT_EN_FIELD_SIZE);
    statusPtr->enabled= BIT2BOOL_MAC(tmp);

    return GT_OK;

}
/**
* @internal prvCpssDxChPortSip6PfcSyncMac function
* @endinternal
*
* @brief This function sync SDQ PFC responce enable bitmap with MAC override of PFC responce
*
* @note  APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman
* @note  NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
...
* @param[in] dpNum             - the local number of SDQ (APPLICABLE RANGES:0..7).
* @param[in] localdpPortNum    - local port.
* @param[in] portNum           - physical port number
* @param[in] clear             - if equal GT_TRUE then the sync is clear and MAC override is not synced with SDQ,GT_FALSE otherwise.
*
* @retval GT_OK               - on success
* @retval GT_BAD_PTR          - on NULL ptr
* @retval GT_HW_ERROR         - if write failed
*/
GT_STATUS prvCpssDxChPortSip6PfcSyncMac
(
   IN  GT_U8                            devNum,
   IN  GT_U32                           tileNum,
   IN  GT_U32                           dpNum,
   IN  GT_U32                           localdpPortNum,
   IN  GT_PHYSICAL_PORT_NUM             portNum,
   IN  GT_BOOL                          clear
)
{
    ...
    GT_STATUS rc;
    GT_U32    enableBmp,macCtrl = 0;

    if(GT_FALSE==clear)
    {
        rc = prvCpssFalconTxqSdqPfcControlEnableBitmapGet(devNum,tileNum,dpNum,localdpPortNum,&enableBmp);
        if(rc!=GT_OK)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(rc, " prvCpssFalconTxqSdqPfcControlEnableBitmapGet  failed for portNum  %d  ",portNum);
        }

        /*Only enabled TC are not overriden*/
        macCtrl=(~enableBmp)&0xFFFF;
    }

    rc =prvCpssSip6TxqPfcMacRxResponceControlEnableSet(devNum,portNum,macCtrl);
    if(rc!=GT_OK)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(rc, " prvCpssSip6TxqPfcMacRxResponceControlEnableSet  failed for portNum  %d  ",portNum);
    }

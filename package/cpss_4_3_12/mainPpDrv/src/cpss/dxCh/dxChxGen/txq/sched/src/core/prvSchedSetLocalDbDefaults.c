...
#define GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(_name,_prio) \
                                 QUEUE_ELIG_FUNCTION(_name,\
                                 Q_ENTRY(POS_MIN_TB,POS_MAX_TB) = ELIGIBLE( SHED_PRIO_7, SHED_PRIO_7 , USE_MIN_TB,     USE_MAX_TB),\
                                 Q_ENTRY(POS_MIN_TB,NEG_MAX_TB) = ELIGIBLE( _prio, PROP_PRIO_0 , USE_MIN_TB,     NOT_USE_MAX_TB),\
                                 Q_ENTRY(NEG_MIN_TB,POS_MAX_TB) = NOT_ELIGIBLE,\
                                 Q_ENTRY(NEG_MIN_TB,NEG_MAX_TB) = NOT_ELIGIBLE)

#define GUARANTEED_BW_TYPE_0_WITH_SHAPING_ELIG_FUNC(_name) \
                                 GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(_name,SHED_PRIO_0)



/*Type 0 return to priority 0 after garanteed BW is reached
    Type 1  return to original priority  after guaranteed BW is reached
*/


#define GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(_name,_prio) \
                                 QUEUE_ELIG_FUNCTION(_name,\
                                 Q_ENTRY(POS_MIN_TB,POS_MAX_TB) = ELIGIBLE( SHED_PRIO_7, PROP_PRIO_0 , NOT_USE_MIN_TB,     USE_MAX_TB),\
                                 Q_ENTRY(POS_MIN_TB,NEG_MAX_TB) = ELIGIBLE( _prio, PROP_PRIO_0 , NOT_USE_MIN_TB,     NOT_USE_MAX_TB),\
...
#define GUARANTEED_BW_TYPE_0_NO_SHAPING_ELIG_FUNC(_name) \
                                 GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(_name,SHED_PRIO_0)
...
int prvSchedInitDefaultQueueEligPrioFuncTable(struct tm_elig_prio_func_queue *func_table,int bucketForShaping)
{
 ...
 /*minimal BW with shaping*/
    ...
    /*0*/GUARANTEED_BW_TYPE_0_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q0_MIN_BW_TYPE0_WITH_SHAPING)
    /*1*/GUARANTEED_BW_TYPE_0_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q1_MIN_BW_TYPE0_WITH_SHAPING)
    /*2*/GUARANTEED_BW_TYPE_0_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q2_MIN_BW_TYPE0_WITH_SHAPING)
    /*3*/GUARANTEED_BW_TYPE_0_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q3_MIN_BW_TYPE0_WITH_SHAPING)
    /*4*/GUARANTEED_BW_TYPE_0_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q4_MIN_BW_TYPE0_WITH_SHAPING)
    /*5*/GUARANTEED_BW_TYPE_0_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q5_MIN_BW_TYPE0_WITH_SHAPING)
    /*6*/GUARANTEED_BW_TYPE_0_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q6_MIN_BW_TYPE0_WITH_SHAPING)
    /*7*/GUARANTEED_BW_TYPE_0_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q7_MIN_BW_TYPE0_WITH_SHAPING)

     /*TYPE1*/

    /*0*/GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q0_MIN_BW_TYPE1_WITH_SHAPING,SHED_PRIO_0)
    /*1*/GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q1_MIN_BW_TYPE1_WITH_SHAPING,SHED_PRIO_1)
    /*2*/GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q2_MIN_BW_TYPE1_WITH_SHAPING,SHED_PRIO_2)
    /*3*/GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q3_MIN_BW_TYPE1_WITH_SHAPING,SHED_PRIO_3)
    /*4*/GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q4_MIN_BW_TYPE1_WITH_SHAPING,SHED_PRIO_4)
    /*5*/GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q5_MIN_BW_TYPE1_WITH_SHAPING,SHED_PRIO_5)
    /*6*/GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q6_MIN_BW_TYPE1_WITH_SHAPING,SHED_PRIO_6)
    /*7*/GUARANTEED_BW_TYPE_1_WITH_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q7_MIN_BW_TYPE1_WITH_SHAPING,SHED_PRIO_7)
  ...
  if(0==bucketForShaping)
  {
    ...
    /*0*/GUARANTEED_BW_TYPE_0_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q0_MIN_BW_TYPE0)
    /*1*/GUARANTEED_BW_TYPE_0_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q1_MIN_BW_TYPE0)
    /*2*/GUARANTEED_BW_TYPE_0_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q2_MIN_BW_TYPE0)
    /*3*/GUARANTEED_BW_TYPE_0_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q3_MIN_BW_TYPE0)
    /*4*/GUARANTEED_BW_TYPE_0_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q4_MIN_BW_TYPE0)
    /*5*/GUARANTEED_BW_TYPE_0_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q5_MIN_BW_TYPE0)
    /*6*/GUARANTEED_BW_TYPE_0_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q6_MIN_BW_TYPE0)
    /*7*/GUARANTEED_BW_TYPE_0_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q7_MIN_BW_TYPE0)

    /*TYPE1*/

    /*0*/GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q0_MIN_BW_TYPE1,SHED_PRIO_0)
    /*1*/GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q1_MIN_BW_TYPE1,SHED_PRIO_1)
    /*2*/GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q2_MIN_BW_TYPE1,SHED_PRIO_2)
    /*3*/GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q3_MIN_BW_TYPE1,SHED_PRIO_3)
    /*4*/GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q4_MIN_BW_TYPE1,SHED_PRIO_4)
    /*5*/GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q5_MIN_BW_TYPE1,SHED_PRIO_5)
    /*6*/GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q6_MIN_BW_TYPE1,SHED_PRIO_6)
    /*7*/GUARANTEED_BW_TYPE_1_NO_SHAPING_ELIG_FUNC(PRV_SCHED_ELIG_Q7_MIN_BW_TYPE1,SHED_PRIO_7)
  }
  else
  {
     /*minimal BW no shaping use minimum backet*/
    /*0*/GUARANTEED_BW_NO_SHAPING_USE_MIN_BUCKET_ELIG_FUNC(PRV_SCHED_ELIG_Q0_MIN_BW_TYPE0)
    /*1*/GUARANTEED_BW_NO_SHAPING_USE_MIN_BUCKET_ELIG_FUNC(PRV_SCHED_ELIG_Q1_MIN_BW_TYPE0)
    /*2*/GUARANTEED_BW_NO_SHAPING_USE_MIN_BUCKET_ELIG_FUNC(PRV_SCHED_ELIG_Q2_MIN_BW_TYPE0)
    /*3*/GUARANTEED_BW_NO_SHAPING_USE_MIN_BUCKET_ELIG_FUNC(PRV_SCHED_ELIG_Q3_MIN_BW_TYPE0)
    /*4*/GUARANTEED_BW_NO_SHAPING_USE_MIN_BUCKET_ELIG_FUNC(PRV_SCHED_ELIG_Q4_MIN_BW_TYPE0)
    /*5*/GUARANTEED_BW_NO_SHAPING_USE_MIN_BUCKET_ELIG_FUNC(PRV_SCHED_ELIG_Q5_MIN_BW_TYPE0)
    /*6*/GUARANTEED_BW_NO_SHAPING_USE_MIN_BUCKET_ELIG_FUNC(PRV_SCHED_ELIG_Q6_MIN_BW_TYPE0)
    /*7*/GUARANTEED_BW_NO_SHAPING_USE_MIN_BUCKET_ELIG_FUNC(PRV_SCHED_ELIG_Q7_MIN_BW_TYPE0)
  }

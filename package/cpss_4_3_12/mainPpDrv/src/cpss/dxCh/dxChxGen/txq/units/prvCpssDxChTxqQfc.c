...
#include <cpss/dxCh/dxChxGen/txq/private/regFiles/seahawk/pipe/prvCpssAasTxqQfcRegFile.h>
...
#define PRV_QFC_SIP_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName) \
    (PRV_CPSS_SIP_7_CHECK_MAC(_dev)?TXQ_AAS_QFC_##_fieldName:TXQ_IRONMAN_QFC_##_fieldName)

#define PRV_QFC_SIP_6_20_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName) \
    (PRV_CPSS_SIP_6_30_CHECK_MAC(_dev)?\
    (PRV_QFC_SIP_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName)):TXQ_HARRIER_QFC_##_fieldName)
...
/*Macro for fileds discontinued for SIP 7*/

#define PRV_QFC_SIP_6_20_UNTIL_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName) \
    (PRV_CPSS_SIP_6_30_CHECK_MAC(_dev)?TXQ_IRONMAN_QFC_##_fieldName:TXQ_HARRIER_QFC_##_fieldName)

#define PRV_QFC_SIP_6_15_UNTIL_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName) \
    (PRV_CPSS_SIP_6_20_CHECK_MAC(_dev)? \
     (PRV_QFC_SIP_6_20_UNTIL_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName)):TXQ_PHOENIX_QFC_##_fieldName)


#define PRV_QFC_SIP_6_10_UNTIL_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName) \
    (PRV_CPSS_SIP_6_15_CHECK_MAC(_dev)?\
     (PRV_QFC_SIP_6_15_UNTIL_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName)):TXQ_HAWK_QFC_##_fieldName)

#define TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(_dev,_fieldName) (PRV_CPSS_SIP_6_10_CHECK_MAC(_dev)?\
    (PRV_QFC_SIP_6_10_UNTIL_6_30_DEV_DEP_FIELD_GET_MAC(_dev,_fieldName)):\
    (TXQ_QFC_##_fieldName))
...
#define PRV_QFC_FIELD_SET_EXCLUDE_SIP7_MAC(_devNum,_name,_rawData,_valueToSet)    U32_SET_FIELD_MASKED_MAC(_rawData,\
                                                     TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(_devNum, _name##_FIELD_OFFSET),\
                                                     TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(_devNum, _name##_FIELD_SIZE),\
                                                     _valueToSet)
...
#define PRV_QFC_FIELD_FROM_VALUE_GET_WITH_TYPE_EXCLUDE_SIP_7_MAC(_devNum,_name,_rawData,_valueToGet,_type) _valueToGet =(_type) U32_GET_FIELD_MAC(_rawData,\
                                                     TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(_devNum, _name##_FIELD_OFFSET),\
                                                     TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(_devNum, _name##_FIELD_SIZE))
...
#define PRV_QFC_FIELD_GET_FROM_VALUE_EXCLUDE_SIP7_MAC(_devNum,_name,_rawData,_valueToGet) PRV_QFC_FIELD_FROM_VALUE_GET_WITH_TYPE_EXCLUDE_SIP_7_MAC(_devNum,_name,_rawData,_valueToGet,GT_U32)
...
)
{
    ...
    PRV_CPSS_DXCH_TXQ_SIP_6_REG_LOG_STC log;
    GT_U32 maxPbAvailebleBuffersFiledSize;
    ...
    {
        maxPbAvailebleBuffersFiledSize = ((GT_U32)1<<TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(devNum,GLOBAL_PFC_CONF_PB_AVAILABLE_BUFFERS_FIELD_SIZE))-1;
    }
    else
    {
        maxPbAvailebleBuffersFiledSize = ((GT_U32)1<<TXQ_AAS_QFC_PB_AVAILABLE_BUFFERS_CONF_PB_AVAILABLE_BUFFERS_FIELD_SIZE)-1;
    }

    if(cfgPtr->pbAvailableBuffers>maxPbAvailebleBuffersFiledSize)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "pbAvailableBuffers  is too big %d ,max is %d",cfgPtr->pbAvailableBuffers,maxPbAvailebleBuffersFiledSize);
    }
    ...
    if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        PRV_QFC_FIELD_SET_EXCLUDE_SIP7_MAC(devNum,GLOBAL_PFC_CONF_PB_AVAILABLE_BUFFERS,regValue,cfgPtr->pbAvailableBuffers);
    }
    ...
    {
        rc = prvCpssSip6TxqQfcLogInit(&log,qfcNum,"pb_available_buffers_conf");
        if (rc != GT_OK)
        {
          return rc;
        }
        ...
        regAddr = PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[qfcNum].pb_available_buffers_conf;

        U32_SET_FIELD_MASKED_MAC(regValue,
            TXQ_AAS_QFC_PB_AVAILABLE_BUFFERS_CONF_PB_AVAILABLE_BUFFERS_FIELD_OFFSET,
            TXQ_AAS_QFC_PB_AVAILABLE_BUFFERS_CONF_PB_AVAILABLE_BUFFERS_FIELD_SIZE,
...
)
{
    ...
    if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        PRV_QFC_FIELD_GET_FROM_VALUE_EXCLUDE_SIP7_MAC(devNum,GLOBAL_PFC_CONF_PB_AVAILABLE_BUFFERS,regValue,cfgPtr->pbAvailableBuffers);
    }
    else
    {
        regAddr = PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[qfcNum].pb_available_buffers_conf;
        ...
        PRV_QFC_DEV_SPEC_FIELD_GET_WITH_TYPE_MAC(TXQ_AAS_QFC_PB_AVAILABLE_BUFFERS_CONF_PB_AVAILABLE_BUFFERS,
            regValue,cfgPtr->pbAvailableBuffers,GT_U32);
    }
...
{
    /*
            regValue[0] = global_tc_%tc_pfc_threshold
            regValue[1] = TC_%tc_PFC_Hysteresis_Conf
            regValue[2] = global_tc_%tc_pfc_guaranteed_threshold -SIP7 only.
        */
    GT_U32 regValue[3] = {0,0,0},numberOfTiles;
    GT_STATUS rc = GT_OK;
    GT_U32 regAddr,i,j;
    PRV_CPSS_DXCH_TXQ_SIP_6_REG_LOG_STC log;
    ...
    if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        maxThresholdValue = ((GT_U32)1<<TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(devNum,GLOBAL_TC_PFC_THRESHOLD_GLOBAL_TC_PFC_GUR_THRESHOLD_FIELD_SIZE))-1;
    }
    else
    {
        maxThresholdValue = ((GT_U32)1<<TXQ_AAS_QFC_GLOBAL_TC_PFC_GUARANTEED_THRESHOLD_GLOBAL_TC_PFC_GUR_THRESHOLD_FIELD_SIZE)-1;
    }
    ...
    if(enable == GT_TRUE)
    {
      ...
      if(thresholdCfgPtr->guaranteedThreshold>maxThresholdValue)
      {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "guaranteedThreshold  is too big %d ,max is %d",thresholdCfgPtr->guaranteedThreshold,maxThresholdValue);
      }
    ...
    if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        PRV_QFC_FIELD_SET_EXCLUDE_SIP7_MAC(devNum,GLOBAL_TC_PFC_THRESHOLD_GLOBAL_TC_PFC_GUR_THRESHOLD,
                                    regValue[0],thresholdCfgPtr->guaranteedThreshold);
    }
    else
    {
        U32_SET_FIELD_MASKED_MAC(regValue[2],TXQ_AAS_QFC_GLOBAL_TC_PFC_GUARANTEED_THRESHOLD_GLOBAL_TC_PFC_GUR_THRESHOLD_FIELD_OFFSET,
                                          TXQ_AAS_QFC_GLOBAL_TC_PFC_GUARANTEED_THRESHOLD_GLOBAL_TC_PFC_GUR_THRESHOLD_FIELD_SIZE,
    ...
    for(i=0;i<numberOfTiles;i++)
    {
       for(j=0;j<MAX_DP_IN_TILE(devNum);j++)
       {
        ...
        if(GT_TRUE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            log.regName = "global_tc_pfc_guaranteed_threshold";

            regAddr = PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[j].global_tc_pfc_guaranteed_threshold[tc];

            rc = prvCpssSip6TxqRegisterFieldWrite(devNum,i,&log,regAddr,0,32,regValue[2]);
            if(rc!=GT_OK)
            {
                return rc;
            }
...
)
{
       ...
       if(rc == GT_OK)
       {
        ...
        if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
           PRV_QFC_FIELD_GET_FROM_VALUE_EXCLUDE_SIP7_MAC(devNum,GLOBAL_TC_PFC_THRESHOLD_GLOBAL_TC_PFC_GUR_THRESHOLD,regValue,thresholdCfgPtr->guaranteedThreshold);
        }
        else
        {
           regAddr = PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[dp].global_tc_pfc_guaranteed_threshold[tc];
           regAddr+=tileOffset;
           rc = prvCpssHwPpReadRegister(devNum,regAddr,&regValue);
           if(rc!=GT_OK)
           {
           ...
           PRV_QFC_DEV_SPEC_FIELD_GET_WITH_TYPE_MAC(TXQ_AAS_QFC_GLOBAL_TC_PFC_GUARANTEED_THRESHOLD_GLOBAL_TC_PFC_GUR_THRESHOLD,
            regValue,thresholdCfgPtr->guaranteedThreshold,GT_U32);
        }
       }
...
)
{
        ...
        if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            maxThresholdValue = ((GT_U32)1<<TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(devNum,PORT_TC_PFC_THRESHOLD_PORT_0_TC_PFC_GUR_THRESHOLD_FIELD_SIZE))-1;
        }
        else
        {
            maxThresholdValue = ((GT_U32)1<<TXQ_AAS_QFC_PORT_TC_PFC_GUARANTEED_THRESHOLD_PORT_0_TC_PFC_GUR_THRESHOLD_FIELD_SIZE)-1;
        }

        if(thresholdCfgPtr->guaranteedThreshold>maxThresholdValue)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "guaranteedThreshold  is too big %d",thresholdCfgPtr->guaranteedThreshold);
        }



        rc = prvCpssSip6TxqQfcLogInit(&log,qfcNum,"port_tc_pfc_threshold");
        if (rc != GT_OK)
        {
          return rc;
        }
        ...
        if(GT_FALSE==enable)
        {
            if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                PRV_QFC_FIELD_SET_EXCLUDE_SIP7_MAC(devNum,PORT_TC_PFC_THRESHOLD_PORT_0_TC_PFC_GUR_THRESHOLD,regValue,maxThresholdValue);
            }
            ...
            if(GT_TRUE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                ...
                U32_SET_FIELD_MASKED_MAC(regValue,TXQ_AAS_QFC_PORT_TC_PFC_GUARANTEED_THRESHOLD_PORT_0_TC_PFC_GUR_THRESHOLD_FIELD_OFFSET,
                                              TXQ_AAS_QFC_PORT_TC_PFC_GUARANTEED_THRESHOLD_PORT_0_TC_PFC_GUR_THRESHOLD_FIELD_SIZE,
                                              maxThresholdValue);

               rc = prvCpssSip6TxqQfcLogInit(&log,qfcNum,"port_tc_pfc_guaranteed_threshold");
               if (rc != GT_OK)
               {
                 return rc;
               }
               ...
               regAddr = PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[qfcNum].port_tc_pfc_guaranteed_threshold[localPort*8+tc];
        ...
        if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            PRV_QFC_FIELD_SET_EXCLUDE_SIP7_MAC(devNum,PORT_TC_PFC_THRESHOLD_PORT_0_TC_PFC_GUR_THRESHOLD,regValue,thresholdCfgPtr->guaranteedThreshold);
        }
...
)
{
        ...
        if(rc == GT_OK)
        {
            if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                PRV_QFC_FIELD_GET_FROM_VALUE_EXCLUDE_SIP7_MAC(devNum,PORT_TC_PFC_THRESHOLD_PORT_0_TC_PFC_GUR_THRESHOLD,regValue,thresholdCfgPtr->guaranteedThreshold);
            }
            ...
            if(GT_TRUE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                ...
                if(rc == GT_OK)
                {
                    PRV_QFC_DEV_SPEC_FIELD_GET_WITH_TYPE_MAC(TXQ_AAS_QFC_PORT_TC_PFC_GUARANTEED_THRESHOLD_PORT_0_TC_PFC_GUR_THRESHOLD,
                        regValue,thresholdCfgPtr->guaranteedThreshold,GT_U32);
                }
            }
        }
...
)
{
        ...
        if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            maxThresholdValue = ((GT_U32)1<<TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(devNum,PORT_PFC_THRESHOLD_PORT_PFC_GUR_THRESHOLD_FIELD_SIZE))-1;
        }
        else
        {
            maxThresholdValue = ((GT_U32)1<<TXQ_AAS_QFC_PORT_PFC_GUARANTEED_THRESHOLD_PORT_PFC_GUR_THRESHOLD_FIELD_SIZE)-1;
        }

        maxXonOffsetValue = ((GT_U32)1<<PRV_QFC_DEV_DEP_FIELD_GET_MAC(devNum,TC_PFC_HYSTERESIS_CONF_TC_XON_OFFSET_VALUE_FIELD_SIZE))-1;
        ...
        if(hysteresisCfgPtr->xonOffsetValue>maxXonOffsetValue)
        {
          CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "xonOffsetValue  is too big %d , max is  %d",hysteresisCfgPtr->xonOffsetValue,maxXonOffsetValue);
        }
        ...
        if(GT_FALSE==enable)
        {
            if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                PRV_QFC_FIELD_SET_EXCLUDE_SIP7_MAC(devNum,PORT_PFC_THRESHOLD_PORT_PFC_GUR_THRESHOLD,regValue,maxThresholdValue);
            }
            ...
            if(GT_TRUE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                rc = prvCpssSip6TxqQfcLogInit(&log,qfcNum,"port_pfc_guaranteed_threshold");
                if (rc != GT_OK)
                {
                  return rc;
                }

                U32_SET_FIELD_MASKED_MAC(regValue,TXQ_AAS_QFC_PORT_PFC_GUARANTEED_THRESHOLD_PORT_PFC_GUR_THRESHOLD_FIELD_OFFSET,
                                              TXQ_AAS_QFC_PORT_PFC_GUARANTEED_THRESHOLD_PORT_PFC_GUR_THRESHOLD_FIELD_SIZE,
                                              maxThresholdValue);

                regAddr = PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[qfcNum].port_pfc_guaranteed_threshold[localPort];
                rc = prvCpssSip6TxqRegisterFieldWrite(devNum,tileNum,&log,regAddr,0,32,regValue);
                if (rc != GT_OK)
                {
                  return rc;
        ...
        if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            PRV_QFC_FIELD_SET_EXCLUDE_SIP7_MAC(devNum,PORT_PFC_THRESHOLD_PORT_PFC_GUR_THRESHOLD,regValue,thresholdCfgPtr->guaranteedThreshold);
        }
...
)
{
        ...
        if(rc == GT_OK)
        {
            if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                PRV_QFC_FIELD_GET_FROM_VALUE_EXCLUDE_SIP7_MAC(devNum,PORT_PFC_THRESHOLD_PORT_PFC_GUR_THRESHOLD,regValue,thresholdCfgPtr->guaranteedThreshold);
            }
            ...
            if(GT_TRUE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                ...
                PRV_QFC_DEV_SPEC_FIELD_GET_WITH_TYPE_MAC(TXQ_AAS_QFC_PORT_PFC_GUARANTEED_THRESHOLD_PORT_PFC_GUR_THRESHOLD,
                    regValue,thresholdCfgPtr->guaranteedThreshold,GT_U32);
...
)
{
    ...
    if(GT_TRUE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
       CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM,"Enabling uburst profile not supported for SIP7 devices\n");
    }
    ...
    /*find equivalent to UBURST_MAP_UBURST_ENABLE*/

    rc = prvCpssSip6TxqRegisterFieldWrite(devNum,tileNum,&log,regAddr,
        TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(devNum,UBURST_MAP_UBURST_ENABLE_FIELD_OFFSET),
        TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(devNum,UBURST_MAP_UBURST_ENABLE_FIELD_SIZE),
        enable?1:0);
...
)
{
    ...
    if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        ...
        log.regIndex = queueNum;
        offset = TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(devNum,UBURST_MAP_UBURST_PROFILE_FIELD_OFFSET);
        size = TXQ_QFC_EXCLUDE_SIP7_FIELD_GET(devNum,UBURST_MAP_UBURST_PROFILE_FIELD_SIZE);


        rc = prvCpssSip6TxqRegisterFieldWrite(devNum,tileNum,&log,regAddr,
            offset,size,profileNum);
    }
    else
    {
        if(profileNum>=CPSS_DXCH_SIP_7_MAX_UBURST_PROFILE_NUM_MAC)
        {
          CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
        }

        table= CPSS_DXCH_SIP7_TXQ_QFC_LOGICAL_Q_TO_PROFILE_MAPPING_TABLE_E + qfcNum + tileNum * CPSS_DXCH_SIP_7_MAX_LOCAL_QFC_NUM_MAC;

        offset = TXQ_AAS_QFC_LOGICAL_Q_TO_PROFILE_MAPPING_TABLE_QMAP_PROFILE_0_FIELD_SIZE*(queueNum&3);
        size = TXQ_AAS_QFC_LOGICAL_Q_TO_PROFILE_MAPPING_TABLE_QMAP_PROFILE_0_FIELD_SIZE;

        /*Each entry contain 4 queues*/
        rc = prvCpssDxChWriteTableEntryField(devNum,
                                    table,
                                    queueNum>>2,
                                    PRV_CPSS_DXCH_TABLE_WORD_INDICATE_GLOBAL_BIT_CNS,offset,size,profileNum);
...
)
{
    ...
    else
    {
      ...
      rc = prvCpssDxChReadTableEntryField(devNum,
                                       table,
                                       queueNum>>2,
                                       PRV_CPSS_DXCH_TABLE_WORD_INDICATE_GLOBAL_BIT_CNS,offset,size,profileNumPtr);
    }
...
)
{
    ...
    GT_U32 i,j,regAddr;
    PRV_CPSS_DXCH_TXQ_SIP_6_REG_LOG_STC log;
    GT_U32  maxProfileNum;

    maxProfileNum = (GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))?
        CPSS_DXCH_SIP_6_MAX_UBURST_PROFILE_NUM_MAC:CPSS_DXCH_SIP_7_MAX_UBURST_PROFILE_NUM_MAC;

    if(profileNum>=maxProfileNum)
    {
      CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
)
{
    ...
    if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        PRV_QFC_FIELD_SET_EXCLUDE_SIP7_MAC(devNum,HR_COUNTERS_INDIRECT_READ_ACCESS_HR_COUNTER_INDIRECT_ACCESS_VAL_VALID,data,0);
    }
    ...
    if(GT_TRUE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        ...
        rc = prvCpssSip6TxqQfcLogInit(&log,qfcNum,"HR_Counters_Indirect_Read_Access_Data");
        if (rc != GT_OK)
        {
          return rc;
        }

        regAddr =  PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[qfcNum].HR_Counters_Indirect_Read_Access_Data;

        U32_SET_FIELD_MASKED_MAC(regValue,TXQ_AAS_QFC_HR_COUNTERS_INDIRECT_READ_ACCESS_DATA_HR_COUNTER_INDIRECT_ACCESS_VAL_VALID_FIELD_OFFSET,
            TXQ_AAS_QFC_HR_COUNTERS_INDIRECT_READ_ACCESS_DATA_HR_COUNTER_INDIRECT_ACCESS_VAL_VALID_FIELD_SIZE,
            0);
        rc = prvCpssSip6TxqRegisterFieldWrite(devNum,tileNum,&log,regAddr,0,32,data);
        if(rc!=GT_OK)
        {
    ...
    while(counter <PRV_MAX_QFC_BUSY_WAIT_CYCLE_MAC)
    {
     ...
     if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
     {
        PRV_QFC_FIELD_GET_FROM_VALUE_EXCLUDE_SIP7_MAC(devNum,HR_COUNTERS_INDIRECT_READ_ACCESS_HR_COUNTER_INDIRECT_ACCESS_VAL_VALID,regValue,dataValid);
     }
     else
     {
        PRV_QFC_DEV_SPEC_FIELD_GET_WITH_TYPE_MAC(TXQ_AAS_QFC_HR_COUNTERS_INDIRECT_READ_ACCESS_DATA_HR_COUNTER_INDIRECT_ACCESS_VAL_VALID,
            regValue,dataValid,GT_U32);
     }
#endif
         ...
         if(dataValid == GT_TRUE)
         {
            ...
            *hrCountValPtr =0;/* Yet not implemented in golden model */
            ...
            if(GT_FALSE ==PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                PRV_QFC_FIELD_GET_FROM_VALUE_EXCLUDE_SIP7_MAC(devNum,HR_COUNTERS_INDIRECT_READ_ACCESS_HR_COUNTER_INDIRECT_ACCESS_VAL,regValue,*hrCountValPtr);
            }
            else
            {
                PRV_QFC_DEV_SPEC_FIELD_GET_WITH_TYPE_MAC(TXQ_AAS_QFC_HR_COUNTERS_INDIRECT_READ_ACCESS_DATA_HR_COUNTER_INDIRECT_ACCESS_VAL,
                    regValue,*hrCountValPtr,GT_U32);
            }
#endif
         }
         else
...
/**
* @internal prvCpssSip7TxqQfcPeriodTimerConfigGet function
* @endinternal
*
* @brief   Get timer value for counting period  at snapshot mode .
*  Snapshot mode maintains a live counter and mirrors some of the counter bits to the counter
*  reflection at the first counting event in a new counting period.
*
...
* @param[in] tileNum               - The number of tile (Applicable range 0..3)
* @param[in] qfcNum                - data path index
* @param[in] timerId               - The index of timer (Applicable range 0..3)
* @param[out] timerRatePtr          - (pointer to) a period configuration (in Clock Cycles x 128).
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssSip7TxqQfcPeriodTimerConfigGet
(
    IN GT_U8 devNum,
    IN GT_U32 tileNum,
    IN GT_U32 qfcNum,
    IN GT_U32 timerId,
    OUT GT_U32 *timerRatePtr
)
{

    TXQ_SIP_6_CHECK_TILE_NUM_MAC(tileNum);
    TXQ_SIP_6_CHECK_LOCAL_QFC_NUM_MAC(qfcNum);
    CPSS_NULL_PTR_CHECK_MAC(timerRatePtr);
    if(timerId>PRV_MAX_QFC_SNAPSHOT_TIMERS_CNS)
    {
      CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "Snapshot timer [%d] must be less than [%d]",timerId,PRV_MAX_QFC_SNAPSHOT_TIMERS_CNS);
    }

    return prvCpssSip6TxqRegisterFieldRead(devNum,
                 tileNum,
                 PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[qfcNum].period_timer_config[timerId],
                 TXQ_AAS_QFC_PERIOD_TIMER_CONFIG_TIMER_RATE_FIELD_OFFSET,
                 TXQ_AAS_QFC_PERIOD_TIMER_CONFIG_TIMER_RATE_FIELD_SIZE,
                 timerRatePtr);
}

/**
* @internal prvCpssSip7TxqQfcPeriodTimerConfigSet function
* @endinternal
*
* @brief   Set timer value for counting period  at snapshot mode .
*  Snapshot mode maintains a live counter and mirrors some of the counter bits to the counter
*  reflection at the first counting event in a new counting period.
*
* @note   APPLICABLE DEVICES: AAS
...
* @param[in] qfcNum                - data path index
* @param[in] timerId               - The index of timer (Applicable range 0..3)
* @param[in] timerRate             - a period configuration (in Clock Cycles x 128).
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssSip7TxqQfcPeriodTimerConfigSet
(
    IN GT_U8 devNum,
    IN GT_U32 tileNum,
    IN GT_U32 qfcNum,
...
)
{
    ...
    /*timerRate value validation will be done at prvCpssSip6TxqRegisterFieldWrite*/

    rc = prvCpssSip6TxqQfcLogInit(&log,qfcNum,"period_timer_config");
    if (rc != GT_OK)
    {
        return rc;
    }

    log.regIndex = timerId;
...
/**
* @internal prvCpssSip7TxqQfcProfileAverageCoefficientSet function
* @endinternal
*
* @brief   Set the coefficient that support WRED based on average queue length.
*          Important for deep buffer queues where WRED is used for congestion signalling.
*          TXQ maintains per queue average queue length.
*          Average calculation is based on the previous Qave and the current Qlength.
*
* @note   APPLICABLE DEVICES: AAS
* @note   NOT APPLICABLE DEVICES:   xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman..
*
...
* @param[in] tileNum               - The number of tile (Applicable range 0..3)
* @param[in] qfcNum                - data path index
* @param[in] profileId             - QFC profile index (Applicable range 0..127)
* @param[in] averageCoefficient    - Averaging Coefficient .
*                                    Qaverage =  old_Qaverage*(1-2^-<Averaging Coefficient>) + Qlength*2^-<Averaging Coefficient>.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssSip7TxqQfcProfileAverageCoefficientSet
(
    IN GT_U8 devNum,
    IN GT_U32 tileNum,
    IN GT_U32 qfcNum,
    IN GT_U32 profileId,
    IN GT_U32 averageCoefficient
)
{
    PRV_CPSS_DXCH_TXQ_SIP_6_REG_LOG_STC log;
    GT_STATUS rc;
    ...
    if(profileId>=CPSS_DXCH_SIP_7_MAX_UBURST_PROFILE_NUM_MAC)
    {
      CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }

    /*averageCoefficient value validation will be done at prvCpssSip6TxqRegisterFieldWrite*/

    rc = prvCpssSip6TxqQfcLogInit(&log,qfcNum,"Rate_average_profile");
    if (rc != GT_OK)
    {
        return rc;
    }

    log.regIndex = profileId;

    /*
    Defines the log2 of the average coefficient for the moving average
    computation .
    For example, if the value is 5, then the moving average is computed such that
    the current latency has a weight of 2^(-5), and the previous average has a weight of
    1-2^(-5)
    ...
    */
    ...
    return prvCpssSip6TxqRegisterFieldWrite(devNum,
                 tileNum,&log,
                 PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[qfcNum].Rate_average_profile[profileId],
                 TXQ_AAS_QFC_RATE_AVERAGE_PROFILE_PROFILE_AVERAGE_COEFFICIENT_FIELD_OFFSET,
                 TXQ_AAS_QFC_RATE_AVERAGE_PROFILE_PROFILE_AVERAGE_COEFFICIENT_FIELD_SIZE,
                 averageCoefficient);
}

/**
* @internal prvCpssSip7TxqQfcProfileAverageCoefficientGet function
* @endinternal
*
* @brief   Get the coefficient that support WRED based on average queue length.
*          Important for deep buffer queues where WRED is used for congestion signalling.
*          TXQ maintains per queue average queue length.
*          Average calculation is based on the previous Qave and the current Qlength.
*
...
* @param[in] qfcNum                - data path index
* @param[in] profileId             - QFC profile index (Applicable range 0..127)
* @param[out] averageCoefficientPtr   - (pointer to) Averaging Coefficient .
*                                    Qaverage =  old_Qaverage*(1-2^-<Averaging Coefficient>) + Qlength*2^-<Averaging Coefficient>.
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - wrong sdq number.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssSip7TxqQfcProfileAverageCoefficientGet
(
    IN GT_U8 devNum,
    IN GT_U32 tileNum,
    IN GT_U32 qfcNum,
    IN GT_U32 profileId,
    OUT GT_U32 *averageCoefficientPtr
)
{

    CPSS_NULL_PTR_CHECK_MAC(averageCoefficientPtr);
    TXQ_SIP_6_CHECK_TILE_NUM_MAC(tileNum);
    TXQ_SIP_6_CHECK_LOCAL_QFC_NUM_MAC(qfcNum);
    ...
    return prvCpssSip6TxqRegisterFieldRead(devNum,
                 ...
                 TXQ_AAS_QFC_RATE_AVERAGE_PROFILE_PROFILE_AVERAGE_COEFFICIENT_FIELD_OFFSET,
                 TXQ_AAS_QFC_RATE_AVERAGE_PROFILE_PROFILE_AVERAGE_COEFFICIENT_FIELD_SIZE,
                 averageCoefficientPtr);
}


/**
* @internal prvCpssSip7TxqQfcProfileTimerConfigureSet function
* @endinternal
*
* @brief   Set QFC profile to timer binding.
*
* @note   APPLICABLE DEVICES: AAS
* @note   NOT APPLICABLE DEVICES:   xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman..
*
...
* @param[in] qfcNum                - data path index
* @param[in] profileId             - QFC profile index (Applicable range 0..127)
* @param[in] timerId               - Snapshot timer ID. Note timer id=4 means free running mode
*

*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - wrong qfc number.
* @retval GT_HW_ERROR              - on writing to HW error.
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssSip7TxqQfcProfileTimerConfigureSet
(
    IN GT_U8 devNum,
    IN GT_U32 tileNum,
    IN GT_U32 qfcNum,
...
)
{
    ...
    if(timerId>PRV_QFC_FREE_RUNNING_TIMER_ID_CNS)
    {
      CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "Snapshot timer [%d] must be less than [%d]",timerId,PRV_MAX_QFC_SNAPSHOT_TIMERS_CNS);
    }
    ...
    return prvCpssSip6TxqRegisterFieldWrite(devNum,
                 tileNum,&log,
                 PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[qfcNum].Rate_average_profile[profileId],
                 TXQ_AAS_QFC_RATE_AVERAGE_PROFILE_PROFILE_PERIOD_TIMER_ID_FIELD_OFFSET,
                 TXQ_AAS_QFC_RATE_AVERAGE_PROFILE_PROFILE_PERIOD_TIMER_ID_FIELD_SIZE,
                 timerId);
}


/**
* @internal prvCpssSip7TxqQfcProfileTimerConfigureGet function
* @endinternal
*
* @brief   Get QFC profile to timer binding.
*
* @note   APPLICABLE DEVICES: AAS
* @note   NOT APPLICABLE DEVICES:   xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman..
*
...
* @param[in] qfcNum                - data path index
* @param[in] profileId             - QFC profile index (Applicable range 0..127)
* @param[out] timerIdPtr           -(pointer to) Snapshot timer ID. Note timer id=4 means free running mode
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssSip7TxqQfcProfileTimerConfigureGet
(
    IN GT_U8 devNum,
    IN GT_U32 tileNum,
    IN GT_U32 qfcNum,
    IN GT_U32 profileId,
    OUT GT_U32 *timerIdPtr
)
{

    TXQ_SIP_6_CHECK_TILE_NUM_MAC(tileNum);
    TXQ_SIP_6_CHECK_LOCAL_QFC_NUM_MAC(qfcNum);
    CPSS_NULL_PTR_CHECK_MAC(timerIdPtr);
...
* @endinternal
*
* @brief   Set QFC profile counter shift. Only 16 bits of 32 bit counter are reflected.
*          This function select which of 32 buts are reflected.
*          For example shift=0 reflect bit 0 until bit 15,
*          shift=1 reflect bit 1 until bit 16
*
*
* @note   APPLICABLE DEVICES: AAS
* @note   NOT APPLICABLE DEVICES:   xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman..
...
* @param[in] qfcNum                - data path index
* @param[in] profileId             - QFC profile index (Applicable range 0..127)
* @param[in] shift                 - Number of shifted bits
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssSip7TxqQfcProfileRateCounterShiftSet
(
    IN GT_U8 devNum,
    IN GT_U32 tileNum,
    IN GT_U32 qfcNum,
...
)
{
    ...
    /*shift value validation will be done at prvCpssSip6TxqRegisterFieldWrite*/
    ...
    return prvCpssSip6TxqRegisterFieldWrite(devNum,
                 tileNum,&log,
                 PRV_CPSS_DXCH_PP_MAC(devNum)->regsAddrVer1.TXQ.qfc[qfcNum].Rate_average_profile[profileId],
                 TXQ_AAS_QFC_RATE_AVERAGE_PROFILE_PROFILE_RATE_SHIFT_FIELD_OFFSET,
                 TXQ_AAS_QFC_RATE_AVERAGE_PROFILE_PROFILE_RATE_SHIFT_FIELD_SIZE,
                 shift);
}


/**
* @internal prvCpssSip7TxqQfcProfileRateCounterShiftGet function
* @endinternal
*
* @brief   Get QFC profile counter shift. Only 16 bits of 32 bit counter are reflected.
*
*
*
* @note   APPLICABLE DEVICES: AAS
...
* @param[in] qfcNum                - data path index
* @param[in] profileId             - QFC profile index (Applicable range 0..127)
* @param[out] shiftPtr             - (pointer to)Number of shifted bits
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssSip7TxqQfcProfileRateCounterShiftGet
(
    IN GT_U8 devNum,
    IN GT_U32 tileNum,
    IN GT_U32 qfcNum,
...
)
{
    ...
    TXQ_SIP_6_CHECK_TILE_NUM_MAC(tileNum);
    TXQ_SIP_6_CHECK_LOCAL_QFC_NUM_MAC(qfcNum);
    CPSS_NULL_PTR_CHECK_MAC(shiftPtr);

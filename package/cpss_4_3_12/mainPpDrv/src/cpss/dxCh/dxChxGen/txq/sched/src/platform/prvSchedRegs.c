...
static void prvSchedInitAdressStruct_Sip_7
(
...
)
{
    ...
    SET_REG_ADDRESS(addressSpace.Sched.Port_Pizza_Last_Slice, 0x00000000, 0x00000320+schedulerOffset)    /* Port Pizza Last Slice */
    ...
    SET_REG_ADDRESS(addressSpace.Sched.PPerCtlConf_Addr, 0x00000000, 0x00000180+schedulerOffset)    /* Port Periodic Configuration */
    SET_REG_ADDRESS(addressSpace.Sched.PPerRateShap_Addr, 0x00000000, 0x00000188+schedulerOffset)    /* Port Periodic Rate Shaping Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.CPerCtlConf_Addr, 0x00000000, 0x00000160+schedulerOffset)    /* C-level Periodic Configuration */
    SET_REG_ADDRESS(addressSpace.Sched.CPerRateShap_Addr, 0x00000000, 0x00000168+schedulerOffset)    /* C Level Periodic Rate Shaping Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.BPerCtlConf_Addr, 0x00000000, 0x00000140+schedulerOffset)    /* B-Level Periodic Configuration */
    SET_REG_ADDRESS(addressSpace.Sched.BPerRateShap_Addr, 0x00000000, 0x00000148+schedulerOffset)    /* B level Periodic Rate Shaping Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.APerCtlConf_Addr, 0x00000000, 0x00000120+schedulerOffset)    /* A-Level Periodic Configuration */
    SET_REG_ADDRESS(addressSpace.Sched.APerRateShap_Addr, 0x00000000, 0x00000128+schedulerOffset)    /* A Level Periodic Rate Shaping Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.QPerCtlConf_Addr, 0x00000000, 0x00000100+schedulerOffset)    /* Queue Periodic Configuration */
    SET_REG_ADDRESS(addressSpace.Sched.QPerRateShap_Addr, 0x00000000, 0x00000108+schedulerOffset)    /* Queue Level Periodic Rate Shaping Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.Global_Cfg, 0x00000000, 0x00000080+schedulerOffset)    /* Global Config */
    SET_REG_ADDRESS(addressSpace.Sched.PPerRateShapInt_Addr, 0x00000000, 0x00000190+schedulerOffset)    /* Port Periodic Rate Shaping Internal Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.CPerRateShapInt_Addr, 0x00000000, 0x00000170+schedulerOffset)    /* C-level Periodic Rate Shaping Internal Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.BPerRateShapInt_Addr, 0x00000000, 0x00000150+schedulerOffset)    /* B-level Periodic Rate Shaping Internal Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.APerRateShapInt_Addr, 0x00000000, 0x00000130+schedulerOffset)    /* A-level Periodic Rate Shaping Internal Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.QPerRateShapInt_Addr, 0x00000000, 0x00000110+schedulerOffset)    /* Queue Periodic Rate Shaping Internal Parameters */
    ...
    SET_REG_ADDRESS(addressSpace.Sched.Debug_Read_index, 0x00000000, 0x0002c040+schedulerOffset)    /* Debug Read index */
    SET_REG_ADDRESS(addressSpace.Sched.Plast_Addr, 0x00000000, 0x00020880+schedulerOffset)    /* Tree Status */
    SET_REG_ADDRESS(addressSpace.Sched.PPerStatus_Addr, 0x00000000, 0x00020890+schedulerOffset)    /* Port Periodic Status */
    SET_REG_ADDRESS(addressSpace.Sched.CPerStatus_Addr, 0x00000000, 0x00021480+schedulerOffset)    /* C Level Periodic Status */
    SET_REG_ADDRESS(addressSpace.Sched.BPerStatus_Addr, 0x00000000, 0x00022880+schedulerOffset)    /* B Level Periodic Status */
    SET_REG_ADDRESS(addressSpace.Sched.APerStatus_Addr, 0x00000000, 0x00028180+schedulerOffset)    /* A Level Periodic Status */
    SET_REG_ADDRESS(addressSpace.Sched.PortEligPrioFunc_Entry, 0x00000000, 0x00005000+schedulerOffset)    /* Port Elig Prio Function Table */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlEligPrioFunc_Entry, 0x00000000, 0x00002000+schedulerOffset)    /* C-Level Elig Prio Function Table */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlEligPrioFunc_Entry, 0x00000000, 0x00003000+schedulerOffset)    /* B-Level Elig Prio Function Table */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlEligPrioFunc_Entry, 0x00000000, 0x00004000+schedulerOffset)    /* A-Level Elig Prio Function Table */
    SET_REG_ADDRESS(addressSpace.Sched.QueueEligPrioFunc, 0x00000000, 0x00001800+schedulerOffset)    /* Queue Elig Prio Function Table */
    SET_REG_ADDRESS(addressSpace.Sched.PortQuantumsPriosLo, 0x00000000, 0x00000c00+schedulerOffset)    /* Port DWRR State Or Pizza Slices */
    SET_REG_ADDRESS(addressSpace.Sched.PortRangeMap, 0x00000000, 0x00000800+schedulerOffset)    /* Port Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.PlvlTokenBucketMapping, 0x00000000, 0x00001000+schedulerOffset)    /* Port Token Bucket - Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.Queuemapping, 0x00000000, 0x00100000+schedulerOffset)    /* Queue Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.QueueTokenBucketTokenEnDiv, 0x00000000, 0x00180000+schedulerOffset)    /* Queue Token Bucket - Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.QueueQuantum, 0x00000000, 0x00200000+schedulerOffset)    /* Queue DWRR State */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlTokenBucketMapping, 0x00000000, 0x00080000+schedulerOffset)    /* A-Level Token Bucket - Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlQuantum, 0x00000000, 0x000c0000+schedulerOffset)    /* A-Level DWRR State */
    SET_REG_ADDRESS(addressSpace.Sched.ALvltoBlvlAndQueueRangeMap, 0x00000000, 0x00040000+schedulerOffset)    /* A-Level Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlTokenBucketMapping, 0x00000000, 0x002a0000+schedulerOffset)    /* B-Level Token Bucket - Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlQuantum, 0x00000000, 0x002c0000+schedulerOffset)    /* B-Level DWRR State */
    SET_REG_ADDRESS(addressSpace.Sched.BLvltoClvlAndAlvlRangeMap, 0x00000000, 0x00280000+schedulerOffset)    /* B-Level Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlTokenBucketMapping, 0x00000000, 0x00018000+schedulerOffset)    /* C-level Token Bucket - Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlQuantum, 0x00000000, 0x00010000+schedulerOffset)    /* C-Level DWRR State */
    SET_REG_ADDRESS(addressSpace.Sched.ClvltoPortAndBlvlRangeMap, 0x00000000, 0x00008000+schedulerOffset)    /* C-Level Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.PortShpBucketLvls, 0x00000000, 0x0002a078+schedulerOffset)    /* Port Shaper Bucket Levels */
    SET_REG_ADDRESS(addressSpace.Sched.PortShaperBucketNeg, 0x00000000, 0x0002a000+schedulerOffset)    /* Port Shaper Bucket Negative */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlShpBucketLvls, 0x00000000, 0x0002a0f8+schedulerOffset)    /* C-Level Shaper Bucket Levels */
    SET_REG_ADDRESS(addressSpace.Sched.CLevelShaperBucketNeg, 0x00000000, 0x0002a080+schedulerOffset)    /* C-Level Shaper Bucket Negative */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlShpBucketLvls, 0x00000000, 0x0002a1f8+schedulerOffset)    /* B-Level Shaper Bucket Levels */
    SET_REG_ADDRESS(addressSpace.Sched.BLevelShaperBucketNeg, 0x00000000, 0x0002a100+schedulerOffset)    /* B-Level Shaper Bucket Negative */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlShpBucketLvls, 0x00000000, 0x0002a3f8+schedulerOffset)    /* A-Level Shaper Bucket Levels */
    SET_REG_ADDRESS(addressSpace.Sched.ALevelShaperBucketNeg, 0x00000000, 0x0002a200+schedulerOffset)    /* A-Level Shaper Bucket Negative */
    SET_REG_ADDRESS(addressSpace.Sched.QueueShpBucketLvls, 0x00000000, 0x0002a7f8+schedulerOffset)    /* Queue Shaper Bucket Level */
    SET_REG_ADDRESS(addressSpace.Sched.QueueShaperBucketNeg, 0x00000000, 0x0002a400+schedulerOffset)    /* Queue Shaper Bucket Negative */
    SET_REG_ADDRESS(addressSpace.Sched.PortNodeState, 0x00000000, 0x00020000+schedulerOffset)    /* Port Node State */
    SET_REG_ADDRESS(addressSpace.Sched.PortMyQ, 0x00000000, 0x00020400+schedulerOffset)    /* Port  MyQ */
    SET_REG_ADDRESS(addressSpace.Sched.PortRRDWRRStatus01, 0x00000000, 0x00020900+schedulerOffset)    /* Port RR/DWRR 01 Status */
    SET_REG_ADDRESS(addressSpace.Sched.PortRRDWRRStatus23, 0x00000000, 0x00020908+schedulerOffset)    /* Port RR/DWRR 23 Status */
    SET_REG_ADDRESS(addressSpace.Sched.PortRRDWRRStatus45, 0x00000000, 0x00020910+schedulerOffset)    /* Port RR/DWRR 45 Status */
    SET_REG_ADDRESS(addressSpace.Sched.PortRRDWRRStatus67, 0x00000000, 0x00020918+schedulerOffset)    /* Port RR/DWRR 67 Status */
    SET_REG_ADDRESS(addressSpace.Sched.PortWFS, 0x00000000, 0x00020800+schedulerOffset)    /* Port Wait For Scrub */
    SET_REG_ADDRESS(addressSpace.Sched.PortBPFromQMgr, 0x00000000, 0x00020840+schedulerOffset)    /* Port Back-Pressure From Queue Manager */
    SET_REG_ADDRESS(addressSpace.Sched.QueueNodeState, 0x00000000, 0x00030000+schedulerOffset)    /* Queue Node State */
    ...
    SET_REG_ADDRESS(addressSpace.Sched.QueueL0ClusterStateHi, 0x00000000, 0x00029208+schedulerOffset)    /* Queue L0 Cluster Hi State */
    SET_REG_ADDRESS(addressSpace.Sched.QueueL1ClusterStateLo, 0x00000000, 0x00029210+schedulerOffset)    /* Queue L1 Cluster Lo State */
    SET_REG_ADDRESS(addressSpace.Sched.QueueL1ClusterStateHi, 0x00000000, 0x00029218+schedulerOffset)    /* Queue L1 Cluster Hi State */
    SET_REG_ADDRESS(addressSpace.Sched.QueueL2ClusterStateLo, 0x00000000, 0x00029220+schedulerOffset)    /* Queue L2 Cluster Lo State */
    SET_REG_ADDRESS(addressSpace.Sched.QueueL2ClusterStateHi, 0x00000000, 0x00029228+schedulerOffset)    /* Queue L2 Cluster Hi State */
    SET_REG_ADDRESS(addressSpace.Sched.QueuePerStatus, 0x00000000, 0x0002c000+schedulerOffset)    /* Queue Periodic Status */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlNodeState, 0x00000000, 0x00020c00+schedulerOffset)    /* C Level Node State */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlMyQ, 0x00000000, 0x00021000+schedulerOffset)    /* C Level MyQ */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlRRDWRRStatus01, 0x00000000, 0x00021600+schedulerOffset)    /* C Level RR/DWRR 01 Status */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlRRDWRRStatus23, 0x00000000, 0x00021608+schedulerOffset)    /* C Level RR/DWRR 23 Status */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlRRDWRRStatus45, 0x00000000, 0x00021610+schedulerOffset)    /* C Level RR/DWRR 45 Status */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlRRDWRRStatus67, 0x00000000, 0x00021618+schedulerOffset)    /* C Level RR/DWRR 67 Status */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlWFS, 0x00000000, 0x00021400+schedulerOffset)    /* C Level Wait For Scrub */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlL0ClusterStateLo, 0x00000000, 0x00021408+schedulerOffset)    /* C Level L0 Cluster Lo State */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlL0ClusterStateHi, 0x00000000, 0x00021410+schedulerOffset)    /* C Level L0 Cluster Hi State */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlNodeState, 0x00000000, 0x00021800+schedulerOffset)    /* B Level Node State */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlMyQ, 0x00000000, 0x00022000+schedulerOffset)    /* B Level MyQ */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlRRDWRRStatus01, 0x00000000, 0x00022900+schedulerOffset)    /* B Level RR/DWRR 01 Status */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlRRDWRRStatus23, 0x00000000, 0x00022908+schedulerOffset)    /* B Level RR/DWRR 23 Status */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlRRDWRRStatus45, 0x00000000, 0x00022910+schedulerOffset)    /* B Level RR/DWRR 45 Status */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlRRDWRRStatus67, 0x00000000, 0x00022918+schedulerOffset)    /* B Level RR/DWRR 67 Status */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlWFS, 0x00000000, 0x00022800+schedulerOffset)    /* B Level Wait For Scrub */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlL0ClusterStateLo, 0x00000000, 0x00022808+schedulerOffset)    /* B Level L0 Cluster Lo State */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlL0ClusterStateHi, 0x00000000, 0x00022810+schedulerOffset)    /* B Level L0 Cluster Hi State */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlL1ClusterStateLo, 0x00000000, 0x00022818+schedulerOffset)    /* B Level L1 Cluster Lo State */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlL1ClusterStateHi, 0x00000000, 0x00022820+schedulerOffset)    /* B Level L1 Cluster Hi State */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlNodeState, 0x00000000, 0x00024000+schedulerOffset)    /* A Level Node State */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlMyQ, 0x00000000, 0x00026000+schedulerOffset)    /* A Level MyQ */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlRRDWRRStatus01, 0x00000000, 0x00028200+schedulerOffset)    /* A Level RR/DWRR 01 Status */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlRRDWRRStatus23, 0x00000000, 0x00028208+schedulerOffset)    /* A Level RR/DWRR 23 Status */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlRRDWRRStatus45, 0x00000000, 0x00028210+schedulerOffset)    /* A Level RR/DWRR 45 Status */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlRRDWRRStatus67, 0x00000000, 0x00028218+schedulerOffset)    /* A Level RR/DWRR 67 Status */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlWFS, 0x00000000, 0x00028000+schedulerOffset)    /* A Level Wait For Scrub */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlL0ClusterStateLo, 0x00000000, 0x00028100+schedulerOffset)    /* A Level L0 Cluster Lo State */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlL0ClusterStateHi, 0x00000000, 0x00028108+schedulerOffset)    /* A Level L0 Cluster Hi State */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlL1ClusterStateLo, 0x00000000, 0x00028110+schedulerOffset)    /* A Level L1 Cluster Lo State */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlL1ClusterStateHi, 0x00000000, 0x00028118+schedulerOffset)    /* A Level L1 Cluster Hi State */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlL2ClusterStateLo, 0x00000000, 0x00028120+schedulerOffset)    /* A Level L2 Cluster Lo State */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlL2ClusterStateHi, 0x00000000, 0x00028128+schedulerOffset)    /* A Level L2 Cluster Hi State */
...
)
{
    ...
    SET_REG_ADDRESS(addressSpace.Sched.PPerCtlConf_Addr, 0x00000000, 0x00000300+schedulerOffset)    /* Port Periodic Configuration */
    SET_REG_ADDRESS(addressSpace.Sched.PPerRateShap_Addr, 0x00000000, 0x00000308+schedulerOffset)    /* Port Periodic Rate Shaping Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.PPerRateShapInt_Addr, 0x00000000, 0x00000310+schedulerOffset)    /* Port Periodic Rate Shaping Internal Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.Port_Pizza_Last_Slice, 0x00000000, 0x00000320+schedulerOffset)    /* Port Pizza Last Slice */
    ...
    SET_REG_ADDRESS(addressSpace.Sched.QPerRateShapInt_Addr, 0x00000000, 0x0000b410+schedulerOffset)    /* Queue Periodic Rate Shaping Internal Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.APerCtlConf_Addr, 0x00000000, 0x00005a00+schedulerOffset)    /* A-Level Periodic Configuration */
    SET_REG_ADDRESS(addressSpace.Sched.APerRateShap_Addr, 0x00000000, 0x00005a08+schedulerOffset)    /* A Level Periodic Rate Shaping Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.APerRateShapInt_Addr, 0x00000000, 0x00005a10+schedulerOffset)    /* A-level Periodic Rate Shaping Internal Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.BPerCtlConf_Addr, 0x00000000, 0x00005800+schedulerOffset)    /* B-Level Periodic Configuration */
    SET_REG_ADDRESS(addressSpace.Sched.BPerRateShap_Addr, 0x00000000, 0x00005808+schedulerOffset)    /* B level Periodic Rate Shaping Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.BPerRateShapInt_Addr, 0x00000000, 0x00005810+schedulerOffset)    /* B-level Periodic Rate Shaping Internal Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.CPerCtlConf_Addr, 0x00000000, 0x00001800+schedulerOffset)    /* C-level Periodic Configuration */
    SET_REG_ADDRESS(addressSpace.Sched.CPerRateShap_Addr, 0x00000000, 0x00001808+schedulerOffset)    /* C Level Periodic Rate Shaping Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.CPerRateShapInt_Addr, 0x00000000, 0x00001810+schedulerOffset)    /* C-level Periodic Rate Shaping Internal Parameters */
    SET_REG_ADDRESS(addressSpace.Sched.Identity_Addr, 0x00000000, 0x00000028+schedulerOffset)    /* Identity */
    SET_REG_ADDRESS(addressSpace.Sched.ScrubSlots_Addr, 0x00000000, 0x00000038+schedulerOffset)    /* Scrubbing Slots Allocation */
    SET_REG_ADDRESS(addressSpace.Sched.TreeDeqEn_Addr, 0x00000000, 0x00000048+schedulerOffset)    /* Tree Dequeue Enable */
    SET_REG_ADDRESS(addressSpace.Sched.PDWRREnReg, 0x00000000, 0x00000050+schedulerOffset)    /* Tree DWRR Priority Enable for Port Scheduling */
    ...
    SET_REG_ADDRESS(addressSpace.Sched.PortEligPrioFunc_Entry, 0x00000000, 0x00000400+schedulerOffset)    /* Port Elig Prio Function Table */
    SET_REG_ADDRESS(addressSpace.Sched.PortTokenBucketTokenEnDiv, 0x00000000, 0x00001000+schedulerOffset)    /* Port Token Bucket - Tokens Enable and Divider */
    SET_REG_ADDRESS(addressSpace.Sched.PortTokenBucketBurstSize, 0x00000000, 0x00001400+schedulerOffset)    /* Port Token Bucket - Burst Size */
    SET_REG_ADDRESS(addressSpace.Sched.PortQuantumsPriosLo, 0x00000000, 0x00000c00+schedulerOffset)    /* Port DWRR State Or Pizza Slices */
    SET_REG_ADDRESS(addressSpace.Sched.PortRangeMap, 0x00000000, 0x00000800+schedulerOffset)    /* Port Mapping */
    ...
    SET_REG_ADDRESS(addressSpace.Sched.Queuemapping, 0x00000000, 0x0000c000+schedulerOffset)    /* Queue Mapping */
    ...
    SET_REG_ADDRESS(addressSpace.Sched.AlvlEligPrioFunc_Entry, 0x00000000, 0x00005c00+schedulerOffset)    /* A-Level Elig Prio Function Table */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlTokenBucketTokenEnDiv, 0x00000000, 0x00007000+schedulerOffset)    /* A-Level Token Bucket - Tokens Enable and Divider */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlTokenBucketBurstSize, 0x00000000, 0x00008000+schedulerOffset)    /* A-Level Token Bucket - Burst Size */
    SET_REG_ADDRESS(addressSpace.Sched.AlvlQuantum, 0x00000000, 0x00009000+schedulerOffset)    /* A-Level DWRR State */
    SET_REG_ADDRESS(addressSpace.Sched.ALvltoBlvlAndQueueRangeMap, 0x00000000, 0x00006000+schedulerOffset)    /* A-Level Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlEligPrioFunc_Entry, 0x00000000, 0x00005000+schedulerOffset)    /* B-Level Elig Prio Function Table */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlTokenBucketTokenEnDiv, 0x00000000, 0x00003800+schedulerOffset)    /* B-Level Token Bucket - Tokens Enable and Divider */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlTokenBucketBurstSize, 0x00000000, 0x00004000+schedulerOffset)    /* B-Level Token Bucket - Burst Size */
    SET_REG_ADDRESS(addressSpace.Sched.BlvlQuantum, 0x00000000, 0x00004800+schedulerOffset)    /* B-Level DWRR State */
    SET_REG_ADDRESS(addressSpace.Sched.BLvltoClvlAndAlvlRangeMap, 0x00000000, 0x00003000+schedulerOffset)    /* B-Level Mapping */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlEligPrioFunc_Entry, 0x00000000, 0x00001c00+schedulerOffset)    /* C-Level Elig Prio Function Table */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlTokenBucketTokenEnDiv, 0x00000000, 0x00002800+schedulerOffset)    /* C-level Token Bucket - Tokens Enable and Divider */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlTokenBucketBurstSize, 0x00000000, 0x00002c00+schedulerOffset)    /* C-level Token Bucket - Burst Size */
    SET_REG_ADDRESS(addressSpace.Sched.ClvlQuantum, 0x00000000, 0x00002400+schedulerOffset)    /* C-Level DWRR State */
    SET_REG_ADDRESS(addressSpace.Sched.ClvltoPortAndBlvlRangeMap, 0x00000000, 0x00002000+schedulerOffset)    /* C-Level Mapping */
...
)
{
    ...
    {
        prvSchedInitAdressStruct_Sip_7(schedulerOffset,addressSpacePtr);
        return;
    }

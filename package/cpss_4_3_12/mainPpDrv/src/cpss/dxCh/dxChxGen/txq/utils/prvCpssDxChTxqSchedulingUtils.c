...
)
{
    ...
    GT_U32  wrrGroupBmpRestore;
    GT_U32  wrrEnableBmpRestore;
    GT_STATUS rc;
    ...
    wrrGroupBmpRestore = *wrrGroupBmpPtr;
    wrrEnableBmpRestore = *wrrEnableBmpPtr;
    ...
    {
        /*restore on failure*/
        *wrrGroupBmpPtr = wrrGroupBmpRestore;
        *wrrEnableBmpPtr = wrrEnableBmpRestore;
    }
    return rc;
...
/**
* @internal prvCpssSip6TxqUtilsSpPrecedenceSet function
* @endinternal
*
...
*
* @param[in] devNum                -physical device number
* @param[in] spPrecedence                -if equals GT_TRUE SP queues always are scheduled first then WRR groups,
*                                   otherwise queue offset is treated as queue priority.
*
*
*
*/
GT_VOID prvCpssSip6TxqUtilsSpPrecedenceSet
(
    IN GT_U8 devNum,
    IN GT_BOOL spPrecedence
)
{
    PRV_CPSS_TXQ_PER_DEVICE_DB_MAC(devNum).spPrecedence = spPrecedence;
}
/**
* @internal prvCpssSip6TxqUtilsSpPrecedenceGet function
* @endinternal
*
...
*
*
* @retval sp priority precedence mode .
*                                   if equals GT_TRUE SP queues always are scheduled first then WRR groups,
*                                   otherwise queue offset is treated as queue priority.
*/
GT_BOOL prvCpssSip6TxqUtilsSpPrecedenceGet
(
    IN GT_U8 devNum
)
{
    return PRV_CPSS_TXQ_PER_DEVICE_DB_MAC(devNum).spPrecedence;
}

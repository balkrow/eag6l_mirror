...
const PRV_CPSS_ENUM_STRING_VALUE_PAIR_STC prvCpssLogEnum_map_CPSS_DXCH_LPM_NEXT_POINTER_TYPE_ENT[]  =
{PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_REGULAR_NODE_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_COMPRESSED_1_NODE_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_COMPRESSED_2_NODE_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_ROUTE_ENTRY_NEXT_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_ECMP_ENTRY_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_QOS_ENTRY_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_COMPRESSED_NODE_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_COMPRESSED_UP_TO_7_RANGES_1_LEAF_NODE_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_COMPRESSED_UP_TO_5_RANGES_2_LEAVES_NODE_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_COMPRESSED_3_RANGES_3_LEAVES_NODE_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_MULTIPATH_ENTRY_PTR_TYPE_E),
PRV_CPSS_LOG_ENUM_NAME_AND_VALUE_MAC(CPSS_DXCH_LPM_RAM_TRIE_PTR_TYPE_E)
};
PRV_CPSS_LOG_STC_ENUM_MAP_ARRAY_SIZE_MAC(CPSS_DXCH_LPM_NEXT_POINTER_TYPE_ENT);
...
)
{
    ...
    PRV_CPSS_LOG_STC_ENUM_MAP_MAC(valPtr, entryType, CPSS_DXCH_LPM_NEXT_POINTER_TYPE_ENT);
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, isIpv6Mc);
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, assignSmallBankToOctet0);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_ENUM_MAP_MAC(namePtr, paramVal, CPSS_DXCH_LPM_NEXT_POINTER_TYPE_ENT);
}

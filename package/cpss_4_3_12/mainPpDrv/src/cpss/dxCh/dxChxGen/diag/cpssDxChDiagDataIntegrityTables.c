...
static const CPSS_DXCH_TABLE_ENT  hwTablesNoNeedShadowArr[] = {
    ...
    */
    ...
    /* SMU ROC counters changed by device. so no shadow support */
...
/*  removed because not memory in the device .. it is 'registers'
    ...
    { CPSS_DXCH_LOGICAL_TABLE_TX_QUEUE_CONFIG_E, {
        ...
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+1,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+2,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+3,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+4,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+5,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+6,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+7,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+8,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+9,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+10,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+11,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+12,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+13,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+14,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+15,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+16,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+17,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+18,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+19,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+20,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+21,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+22,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+23,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+24,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+25,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+26,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+27,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+28,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+29,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+30,
        CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E+31,
        LAST_VALID_TABLE_CNS }  },

    { CPSS_DXCH_LOGICAL_TABLE_STREAM_QVB_E, {
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+1,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+2,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+3,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+4,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+5,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+6,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+7,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+8,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+9,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+10,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+11,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+12,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+13,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+14,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+15,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+16,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+17,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+18,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+19,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+20,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+21,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+22,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+23,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+24,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+25,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+26,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+27,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+28,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+29,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+30,
        CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG_E+31,
        LAST_VALID_TABLE_CNS }  },
...
)
{
    ...
    if(PRV_CPSS_SIP_6_30_CHECK_MAC(devNum) &&
       (hwTableType == CPSS_DXCH_SIP6_TXQ_SDQ_QUEUE_CFG_E))
    {
        /* tables implemented by RAM in IronMan */
        return GT_TRUE;
    }
    ...
    /* the HW table are not supported for SIP7*/
    if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        if(hwTableType >=CPSS_DXCH_SIP6_30_TABLE_TXQ_PDS_NEXT_DESC_E &&
                hwTableType <= CPSS_DXCH_SIP6_30_TABLE_TXQ_PDS_READ_POINTER_E)
        {
            /* the HW table is not valid for this device */
            return GT_FALSE;
        }
...
)
{
    ...
    entrySizeInWords =PRV_CPSS_ACCESS_TABLE_INFO_PTR(devNum)[tableType].entrySize;
...
/**
* @internal prvCpssDxChDiagShmAtomicHwEntryClear function
* @endinternal
*
* @brief   Atomic clear of SBM RAM mapped to FDB via SHM indirect access registers
*          using AAC engine of CNM.
*          Used for recover damaged memory lines.
*
* @note   APPLICABLE DEVICES:      Falcon
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; AC5X; Harrier; Ironman; AC5P; AAS.
*
* @param[in] devNum                - device number
* @param[in] tile                  - tile number for Falcon
* @param[in] sbmIndex              - index of SMB memory
* @param[in] lineIndex             - line index inside SMB memory
*
* @retval GT_OK                    - on success
...
*
*/
static GT_STATUS prvCpssDxChDiagShmAtomicHwEntryClear
(
    IN  GT_U8                    devNum,
    IN  GT_U32                   tile,
    IN  GT_U32                   sbmIndex,
...
)
{
    ...
    GT_U32      fdbRegAddr;    /* register address of FDB thresholds */
    GT_U32      smbRegAddr;    /* register address of SMB access control */
    GT_U32      hwValue;    /* value to write to the register */
    GT_U32      ii;         /* work index */
    GT_U32      tileRegAddrOffset;    /* tile register address offset */
    GT_U32      savedFdbFifoThresholds;  /* saved Fdb Fifo Thresholds */
    GT_U32      setFdbFifoThresholds;    /* set Fdb Fifo Thresholds */
    /* write sequence : */
    /* 1. [0]   set FdbFifoThresholds to 0 to stop FDB access */
    /* 2. [1]   configure - trigger SHM debug write access */
    /* 3. [3]   disable SHM debug write access */
    /* 4. [4]   restore FdbFifoThresholds */
    GT_U32      regAddrArr[4]; /*registers addresses for atomic write */
    GT_U32      regDataArr[4]; /*registers data for atomic write */

    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_BOBCAT2_E |
        CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E |
        CPSS_ALDRIN2_E |CPSS_AC5X_E | CPSS_AC5P_E | CPSS_HARRIER_E | CPSS_AAS_E);

    regsAddrPtr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum);
    tileRegAddrOffset = FALCON_TILE_OFFSET_CNS * tile;

    /* clear SHM debug_access_write_data registers */
    for (ii = 0; (ii < 4); ii++)
    {
        regAddr = regsAddrPtr->SHM.debug_access_write_data[ii] + tileRegAddrOffset;
    ...
    fdbRegAddr = PRV_DXCH_REG1_UNIT_FDB_MAC(devNum).FDBCore.Debug.FdbFifoThresholds + tileRegAddrOffset;
    rc = prvCpssDrvHwPpReadRegister(devNum, fdbRegAddr, &savedFdbFifoThresholds);
    if (rc != GT_OK)
    {
        return rc;
    }
    /*MT INT PIPE INPUT FIFO Threshold set to 0 bits [19:16]*/
    setFdbFifoThresholds = savedFdbFifoThresholds & 0xFFF0FFFF;
    regAddrArr[0] = fdbRegAddr;
    regDataArr[0] = setFdbFifoThresholds;    /*set*/
    smbRegAddr = regsAddrPtr->SHM.debug_access_conf + tileRegAddrOffset;
    /* SBMType2 == (0 << 14) */
    hwValue = 0x1 | (0 << 14) | (sbmIndex << 8) | (lineIndex << 16);
    regAddrArr[1] = smbRegAddr;
    regDataArr[1] = hwValue; /*trigger*/
    regAddrArr[2] = smbRegAddr;
    regDataArr[2] = 0;       /*cleanup*/
    /* restore FDB Thresholds */
    regAddrArr[3] = fdbRegAddr;
    regDataArr[3] = savedFdbFifoThresholds;  /*restore*/

    return prvCpssDxChHwAacRegistersIndirectWrite(
        devNum, PRV_CPSS_DXCH_AAC_CHANNEL_DLB_AND_PHA_E/*channel*/,
        4 /*numOfRegs*/, regAddrArr, regDataArr);
}

/* debug function for use from command line */
GT_STATUS prvCpssDxChDiagShmAtomicHwEntryClear_debugTest
(
    IN  GT_U8                    devNum,
    IN  GT_U32                   tile,
    IN  GT_U32                   sbmIndex,
    IN  GT_U32                   lineIndex,
    IN  GT_U32                   repeatNumber
)
{
    GT_STATUS rc;
    GT_U32    cnt;
    for (cnt = 0; (cnt < repeatNumber); cnt++)
    {
        rc = prvCpssDxChDiagShmAtomicHwEntryClear(
            devNum, tile, sbmIndex, lineIndex);
        if (rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    GT_U32                      sbmIndex;
    GT_U32                      lineIndex;
    GT_U32                      hwTableEntryIndex1;
    CPSS_DXCH_TABLE_ENT         tableId;
    GT_U32                      clientOffset;
    GT_U32                      fdbBankSize;
    GT_U32                      numBitsPerBank;
    GT_U32                      bankIdx;
    GT_U32                      portGroupsBmp1;


    hwTableEntryIndex1 = hwTableEntryIndex;
    if ((PRV_CPSS_PP_MAC(devNum)->devFamily == CPSS_PP_FAMILY_DXCH_FALCON_E)
        && (hwTableType == CPSS_DXCH_TABLE_FDB_E))
    {
        /* remove special bit */
        hwTableEntryIndex1 = hwTableEntryIndex
    ...
    {
        fdbBankSize = 8192;
        /* hwTableEntryIndex1 already calculated */

        /* hwTableEntryIndex for FDB contains bank number in LSBs and line_in_bank in MSB */
        /*sbmIndex*/
        numBitsPerBank = PRV_CPSS_DXCH_PP_MAC(devNum)->bridge.fdbNumOfBitsPerBank;
        bankIdx = (hwTableEntryIndex1 & ((1 << numBitsPerBank) - 1));
        for (sbmIndex = 0; (sbmIndex < 36); sbmIndex++)
        {
            rc = prvCpssDxChCfgSharedTablesType2BlockTableIdGet(
                devNum, sbmIndex, 0/*smbBlockPort*/, &tableId, &clientOffset);
            if (GT_OK != rc)
            {
                return rc;
            }
            if ((tableId == CPSS_DXCH_TABLE_FDB_E)
                && (clientOffset == bankIdx))
            {
                break; /* sbmIndex found*/
            }
        }
        if (sbmIndex >= 36)
        {
        ...
        /* lineIndex */
        lineIndex =
            fdbBankSize /* jump over memories 0-3 to memories 4-5 */
            + ((hwTableEntryIndex1 >> numBitsPerBank) & (fdbBankSize - 1));

        /* to support CPSS_PORT_GROUP_UNAWARE_MODE_CNS value */
        ...
        {
            portGroupsBmp1 = portGroupsBmp &
                PRV_CPSS_PP_MAC(devNum)->portGroupsInfo.activePortGroupsBmp;
        }
        for (tile = 0; (tile < PRV_CPSS_PP_MAC(devNum)->multiPipe.numOfTiles); tile++)
        {
            /* 2 port groups per tile (Falcon) */
            if ((portGroupsBmp1 & (3 << (2 * tile))) == 0) continue;
...
{
    GT_U32 maxNumOfEntries = PRV_CPSS_ACCESS_TABLE_INFO_PTR(devNum)[hwTable].maxNumOfEntries;
    ...
    entrySizeInBytes = 4 * PRV_CPSS_ACCESS_TABLE_INFO_PTR(devNum)[hwTable].entrySize;
...
)
{
    ...
    if(PRV_CPSS_SIP_6_CHECK_MAC(devNum))
    {
        ...
        if((hwTable >= (CPSS_DXCH_SIP6_TXQ_PDS_DATA_STORAGE_E + 0) &&
           ...
           (hwTable >= CPSS_DXCH_SIP6_30_TABLE_TXQ_PDS_NEXT_DESC_E &&
            hwTable <= CPSS_DXCH_SIP6_30_TABLE_TXQ_PDS_READ_POINTER_E  ) ||
           (hwTable >= CPSS_DXCH_SIP6_30_TXQ_SDQ_PORT_QBV_STATE_E &&
            hwTable <= CPSS_DXCH_SIP6_30_TXQ_SDQ_PORT_QBV_STATE_LAST_E ) ||
            /* counters changed by the Device on traffic so no shadow support */
            ...
            if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                switch(index)
                {
                    ...
                    */
                    ...
                    case CPSS_DXCH_SIP7_TABLE_IPE_STATE_T0_E:
                    case CPSS_DXCH_SIP7_TABLE_IPE_STATE_T1_E:
                        continue;
                    default:
                        break;
                }
...
)
{
    ...
    entrySize = PRV_CPSS_ACCESS_TABLE_INFO_PTR(devNum)[tableType].entrySize;

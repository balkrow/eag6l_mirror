...
/**
********************************************************************************
* @file cpssDxChDiagDescriptor.c
*
* @brief Diag Descriptor APIs for CPSS.
*
* @version   15
********************************************************************************
*/
...
/**
* @enum PRV_CPSS_DXCH_DIAG_OPERATION_TYPE_ENT
*
* @brief This enum defines operation types for condition fields.
*/
typedef enum{

    /** Perform OR with next condition. */
    PRV_CPSS_DXCH_DIAG_OPERATION_TYPE_OR_E,

    /** Perform OR and continue sequence. */
    PRV_CPSS_DXCH_DIAG_OPERATION_TYPE_OR_SEQ_E,

    /** Perform AND with next condition. */
...
/**
* @enum PRV_CPSS_DXCH_DIAG_CONDITION_TYPE_ENT
*
* @brief This enum defines condition types for condition fields.
*/
typedef enum{

    /** @brief The HW value should be
...
/**
* @struct PRV_CPSS_DXCH_DIAG_CONDITION_STC
*
* @brief used to describe condition field information.
*/
typedef struct{
    ...
    /** condition field offset */
    GT_U32 fieldOffset;

    /** condition field length */
    GT_U32 fieldLength;
...
/**
* @struct PRV_CPSS_DXCH_DIAG_HW_DESCR_STC
*
* @brief used to describe private DB for HW to SW conversion.
*/
typedef struct{
    ...
    /** @brief SW field offset for splitted fields.
     *  condDataPtr - pointer to condition data.
     */
    GT_U32 swFieldOffset;

    const PRV_CPSS_DXCH_DIAG_CONDITION_STC *condDataPtr;

} PRV_CPSS_DXCH_DIAG_HW_DESCR_STC;

/*  WR DMA To TTI */
static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcat2wrdma2tti[] =
{
...
/* TTI To PCL */
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_PacketCmd_NOT_FromCPU[] =
{
    COND_MAC(LAST, 179, 3, 7, DIFFER) /* (PacketCmd != FromCPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_PacketCmd_FromCPU[] =
{
    COND_MAC(LAST, 179, 3, 7, EQUAL) /* (PacketCmd == FromCPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_UseVIDX_0[] =
{
    COND_MAC(LAST, 232 + 0, 1, 0, EQUAL) /* (<UseVIDX> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_UseVIDX_0_AND_TrgIsTrunk_0[] =
{
    COND_MAC(AND, 232 + 0, 1, 0, EQUAL), /* (<UseVIDX> == 0) */
    COND_MAC(LAST, 232 + 1, 1, 0, EQUAL) /* (<TrgIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_UseVIDX_0_AND_TrgIsTrunk_1[] =
{
    COND_MAC(AND, 232 + 0, 1, 0, EQUAL), /* (<UseVIDX> == 0) */
    COND_MAC(LAST, 232 + 1, 1, 1, EQUAL) /* (<TrgIsTrunk> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_UseVIDX_1[] =
{
    COND_MAC(LAST, 232 + 0, 1, 1, EQUAL) /* (<UseVIDX> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_OutLIF_Type_MLL[] =
{
    COND_MAC(LAST, 232 + 15, 2, 0, EQUAL) /* (<OutLIF_Type> == MLL) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_OutLIF_Type_Tunnel[] =
{
    COND_MAC(LAST, 232 + 15, 2, 1, EQUAL) /* (<OutLIF_Type> == Tunnel) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_OutLIF_Type_LinkLayer[] =
{
    COND_MAC(LAST, 232 + 15, 2, 2, EQUAL) /* (<OutLIF_Type> == LinkLayer) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_RedirectCmd_4[] =
{
    COND_MAC(LAST, 190, 3, 4, EQUAL) /* (<RedirectCmd> == 4) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_RedirectCmd_2[] =
{
    COND_MAC(LAST, 190, 3, 2, EQUAL) /* (<RedirectCmd> == 2) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_RedirectCmd_3[] =
{
    COND_MAC(LAST, 190, 3, 3, EQUAL) /* (<RedirectCmd> == 3) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_RedirectCmd_5[] =
{
    COND_MAC(LAST, 190, 3, 5, EQUAL) /* (<RedirectCmd> == 5) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_PacketCmd_FromCPU_AND_UseVIDX_1[] =
{
    COND_MAC(AND, 179, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(LAST, 232 + 0, 1, 1, EQUAL) /* (<UseVIDX> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_PacketCmd_NOT_FromCPU_AND_OrigIsTrunk_1[] =
{
    COND_MAC(AND, 179, 3, 7, DIFFER), /* (<PacketCmd> != FromCPU) */
    COND_MAC(LAST, 304, 1, 1, EQUAL) /* (<OrigIsTrunk> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_PacketCmd_NOT_FromCPU_AND_OrigIsTrunk_0[] =
{
    COND_MAC(AND, 179, 3, 7, DIFFER), /* (<PacketCmd> != FromCPU) */
    COND_MAC(LAST, 304, 1, 0, EQUAL) /* (<OrigIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_PacketCmd_FromCPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_1[] =
{
    COND_MAC(AND, 179, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_PacketCmd_FromCPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_0[] =
{
    COND_MAC(AND, 179, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(AND, 232 + 0, 1, 1, EQUAL), /* (<UseVIDX> == 1) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_PacketCmd_FromCPU_AND_UseVIDX_0[] =
{
    COND_MAC(AND, 179, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(LAST, 232 + 0, 1, 1, EQUAL) /* (<UseVIDX> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_IsIPv4_ForKey_0[] =
{
    COND_MAC(LAST, 973, 1, 0, EQUAL) /* (<IsIPv4_ForKey> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_IsIPv4_ForKey_1[] =
{
    COND_MAC(LAST, 973, 1, 1, EQUAL) /* (<IsIPv4_ForKey> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_QCNPacket_1[] =
{
    COND_MAC(LAST, 1134, 1, 1, EQUAL) /* (<QCNPacket> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_tti2pcl_QCNPacket_0[] =
{
    COND_MAC(LAST, 1134, 1, 0, EQUAL) /* (<QCNPacket> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcat2tti2pcl[] =
{
    FLD_MAC(FIRSTBUFFER, 0, 14),
    FLD_MAC(MDB, 14, 1),
    FLD_MAC(BANK, 15, 1),
...
/* PCL to Bridge */
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_TunnelTerminated_TT[] =
{
    COND_MAC(LAST, 40, 1, 1, EQUAL) /* (<TunnelTerminated> == TT) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_TunnelTerminated_NoTT_AND_IsPTP_FALSE[] =
{
    COND_MAC(AND, 40, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT */
    COND_MAC(LAST, 42, 1, 0, EQUAL), /*  <IsPTP>==FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_TunnelTerminated_NoTT_AND_IsPTP_TRUE[] =
{
    COND_MAC(AND, 40, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT */
    COND_MAC(LAST, 42, 1, 1, EQUAL), /*  <IsPTP>==TRUE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_PacketCmd_NOT_FromCPU[] =
{
    COND_MAC(LAST, 89, 3, 7, DIFFER) /* (<PacketCmd> != FromCPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_PacketCmd_FromCPU[] =
{
    COND_MAC(LAST, 89, 3, 7, EQUAL) /* (<PacketCmd> == FromCPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_UseVIDX_0[] =
{
    COND_MAC(LAST, 95, 1, 0, EQUAL) /* (UseVIDX == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_UseVIDX_1[] =
{
    COND_MAC(LAST, 95, 1, 1, EQUAL) /* (<UseVIDX> ==1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_UseVIDX_0_AND_TargetIsTrunk_0[] =
{
    COND_MAC(AND, 95, 1, 0, EQUAL), /* (<UseVIDX> ==0) */
    COND_MAC(LAST, 96, 1, 0, EQUAL) /* (<TargetIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_UseVIDX_0_AND_TargetIsTrunk_1[] =
{
    COND_MAC(AND, 95, 1, 0, EQUAL), /* (<UseVIDX> ==0) */
    COND_MAC(LAST, 96, 1, 1, EQUAL) /* (<TargetIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_PacketCmd_FromCPU_AND_UseVIDX_1[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(LAST, 95, 1, 1, EQUAL) /* (<UseVIDX> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_PacketCmd_FromCPU_AND_UseVIDX_0[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(LAST, 95, 1, 0, EQUAL) /* (<UseVIDX> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_PacketCmd_NOT_FromCPU_AND_OrigIsTrunk_0[] =
{
    COND_MAC(AND, 89, 3, 7, DIFFER), /* (<PacketCmd> != FromCPU) */
    COND_MAC(LAST, 117, 1, 0, EQUAL) /* (<OrigIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_PacketCmd_NOT_FromCPU_AND_OrigIsTrunk_1[] =
{
    COND_MAC(AND, 89, 3, 7, DIFFER), /* (<PacketCmd> != FromCPU) */
    COND_MAC(LAST, 117, 1, 1, EQUAL) /* (<OrigIsTrunk> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_PacketCmd_FromCPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_1[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_PacketCmd_FromCPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_0[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(AND, 95, 1, 1, EQUAL), /* (<UseVIDX> == 1) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_TunnelStart_1[] =
{
    COND_MAC(LAST, 139, 1, 1, EQUAL) /* (<TunnelStart> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_TunnelStart_NOT_1[] =
{
    COND_MAC(LAST, 139, 1, 1, DIFFER) /* (<TunnelStart> != 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_RouteToEntry_1[] =
{
    COND_MAC(LAST, 206, 1, 1, EQUAL) /* (<RouteToEntry> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_RouteToEntry_NOT_1[] =
{
    COND_MAC(LAST, 206, 1, 1, DIFFER) /* (<RouteToEntry> != 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_IsPTP_FALSE[] =
{
    COND_MAC(LAST, 42, 1, 0, EQUAL) /* (<IsPTP> == FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_pcl2l2i_IsPTP_TRUE[] =
{
    COND_MAC(LAST, 42, 1, 1, EQUAL) /* (<IsPTP> == TRUE) */
};


static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcat2pcl2l2i[] =
{
    FLD_MAC(FIRSTBUFFER, 0, 14),
    FLD_MAC(MDB, 14, 1),
    FLD_MAC(BANK, 15, 1),
...
/* Bridge to Router */
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_TunnelTerminated_TT[] =
{
    COND_MAC(LAST, 40, 1, 1, EQUAL) /* (<TunnelTerminated> == TT) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_TunnelTerminated_NoTT_IsPTP_FALSE[] =
{
    COND_MAC(AND, 40, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT  */
    COND_MAC(LAST, 42, 1, 0, EQUAL) /* <IsPTP>==FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_TunnelTerminated_NoTT_IsPTP_TRUE[] =
{
    COND_MAC(AND, 40, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT  */
    COND_MAC(LAST, 42, 1, 1, EQUAL) /* <IsPTP>==TRUE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_PacketCmd_NOT_FromCPU[] =
{
    COND_MAC(LAST, 89, 3, 7, DIFFER) /* (<PacketCmd> != FromCPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_PacketCmd_FromCPU[] =
{
    COND_MAC(LAST, 89, 3, 7, EQUAL) /* (<PacketCmd> == FromCPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_UseVIDX_0[] =
{
    COND_MAC(LAST, 95, 1, 0, EQUAL) /* (UseVIDX == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_UseVIDX_1[] =
{
    COND_MAC(LAST, 95, 1, 1, EQUAL) /* (<UseVIDX> ==1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_UseVIDX_0_AND_TargetIsTrunk_0[] =
{
    COND_MAC(AND, 95, 1, 0, EQUAL), /* (<UseVIDX> == 0) */
    COND_MAC(LAST, 96, 1, 0, EQUAL) /* (<TargetIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_UseVIDX_0_AND_TargetIsTrunk_1[] =
{
    COND_MAC(AND, 95, 1, 0, EQUAL), /* (<UseVIDX> == 0) */
    COND_MAC(LAST, 96, 1, 1, EQUAL) /* (<TargetIsTrunk> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_PacketCmd_FromCPU_AND_UseVIDX_1[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(LAST, 95, 1, 1, EQUAL) /* (<UseVIDX> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_PacketCmd_NOT_FromCPU_AND_OrigIsTrunk_1[] =
{
    COND_MAC(AND, 89, 3, 7, DIFFER), /* (<PacketCmd> != FromCPU) */
    COND_MAC(LAST, 117, 1, 1, EQUAL) /* (<OrigIsTrunk> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_PacketCmd_NOT_FromCPU_AND_OrigIsTrunk_0[] =
{
    COND_MAC(AND, 89, 3, 7, DIFFER), /* (<PacketCmd> != FromCPU) */
    COND_MAC(LAST, 117, 1, 0, EQUAL) /* (<OrigIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_PacketCmd_FromCPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_1[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(AND, 95, 1, 1, EQUAL), /* (<UseVIDX> == 1) */
    COND_MAC(LAST, 117, 1, 1, EQUAL) /* (<ExcludeIsTrunk> == 1) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_PacketCmd_FromCPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_0[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(AND, 95, 1, 1, EQUAL), /* (<UseVIDX> == 1) */
    COND_MAC(LAST, 117, 1, 0, EQUAL) /* (<ExcludeIsTrunk> ==0) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_PacketCmd_FromCPU_AND_UseVIDX_0_AND_MLLEn_0[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL),  /* (<PacketCmd> == FromCPU) */
    COND_MAC(LAST, 95, 1, 0, EQUAL)  /* (<UseVIDX> == 0) */
     /* (<MLLEn> == 0) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_TunnelStart_1[] =
{
    COND_MAC(LAST, 139, 1, 1, EQUAL) /* (<TunnelStart> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_TunnelStart_NOT_1[] =
{
    COND_MAC(LAST, 139, 1, 1, DIFFER) /* (<TunnelStart> != 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_RouteToEntry_1[] =
{
    COND_MAC(LAST, 206, 1, 1, EQUAL) /* (<RouteToEntry> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_RouteToEntry_NOT_1[] =
{
    COND_MAC(LAST, 206, 1, 1, DIFFER) /* (<RouteToEntry> != 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_IsPTP_FALSE[] =
{
    COND_MAC(LAST, 42, 1, 0, EQUAL) /* (<IsPTP> == FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_l2i2rtr_IsPTP_TRUE[] =
{
    COND_MAC(LAST, 42, 1, 1, EQUAL) /* (<IsPTP> == TRUE) */
};

static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcat2l2i2rtr[] =
{
    FLD_MAC(FIRSTBUFFER, 0, 14),
    FLD_MAC(MDB, 14, 1),
    FLD_MAC(BANK, 15, 1),
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_TunnelTerminated_TT[] =
{
    COND_MAC(LAST, 40, 1, 1, EQUAL) /* (<TunnelTerminated> == TT) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_TunnelTerminated_NoTT_IsPTP_FALSE[] =
{
    COND_MAC(AND, 40, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT  */
    COND_MAC(LAST, 42, 1, 0, EQUAL) /* <IsPTP>==FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_TunnelTerminated_NoTT_IsPTP_TRUE[] =
{
    COND_MAC(AND, 40, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT  */
    COND_MAC(LAST, 42, 1, 1, EQUAL) /* <IsPTP>==TRUE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_PacketCmd_NOT_FromCPU[] =
{
    COND_MAC(LAST, 89, 3, 7, DIFFER) /* (<PacketCmd> != FromCPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_PacketCmd_FromCPU[] =
{
    COND_MAC(LAST, 89, 3, 7, EQUAL) /* (<PacketCmd> == FromCPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_UseVIDX_1[] =
{
    COND_MAC(LAST, 95, 1, 1, EQUAL) /* (<UseVIDX> ==1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_UseVIDX_0[] =
{
    COND_MAC(LAST, 95, 1, 0, EQUAL) /* (<UseVIDX> ==0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_UseVIDX_0_AND_TargetIsTrunk_0[] =
{
    COND_MAC(AND, 95, 1, 0, EQUAL), /* (<UseVIDX> ==0) */
    COND_MAC(LAST, 96, 1, 0, EQUAL) /* (<TargetIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_UseVIDX_0_AND_TargetIsTrunk_1[] =
{
    COND_MAC(AND, 95, 1, 0, EQUAL), /* (<UseVIDX> ==0) */
    COND_MAC(LAST, 96, 1, 1, EQUAL) /* (<TargetIsTrunk> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_PacketCmd_FromCPU_AND_UseVIDX_1[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(LAST, 95, 1, 1, EQUAL) /* (<UseVIDX> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_PacketCmd_NOT_FromCPU_AND_OrigIsTrunk_0[] =
{
    COND_MAC(AND, 89, 3, 7, DIFFER), /* (<PacketCmd> != FromCPU) */
    COND_MAC(LAST, 117, 1, 0, EQUAL) /* (<OrigIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_PacketCmd_NOT_FromCPU_AND_OrigIsTrunk_1[] =
{
    COND_MAC(AND, 89, 3, 7, DIFFER), /* (<PacketCmd> != FromCPU) */
    COND_MAC(LAST, 117, 1, 1, EQUAL) /* (<OrigIsTrunk> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_PacketCmd_FromCPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_1[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(AND, 95, 1, 1, EQUAL), /* (<UseVIDX> == 1) */
    COND_MAC(LAST, 117, 1, 1, EQUAL) /* (<ExcludeIsTrunk> == 1) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_PacketCmd_FromCPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_0[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(AND, 95, 1, 1, EQUAL), /* (<UseVIDX> == 1) */
    COND_MAC(LAST, 117, 1, 0, EQUAL) /* (<ExcludeIsTrunk> ==0) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_PacketCmd_FromCPU_AND_UseVIDX_0[] =
{
    COND_MAC(AND, 89, 3, 7, EQUAL), /* (<PacketCmd> == FromCPU) */
    COND_MAC(LAST, 95, 1, 0, EQUAL), /* (<UseVIDX> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_MLLEn_1[] =
{
    COND_MAC(LAST, 200, 1, 1, EQUAL) /* (<MLLEn> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_MLLEn_0_AND_TunnelStart_1[] =
{
    COND_MAC(AND, 200, 1, 0, EQUAL), /* (<MLLEn> == 0) */
    COND_MAC(LAST, 139, 1, 1, EQUAL) /* (<TunnelStart> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_MLLEn_0_AND_TunnelStart_0[] =
{
    COND_MAC(AND, 200, 1, 0, EQUAL), /* (<MLLEn> == 0) */
    COND_MAC(LAST, 139, 1, 0, EQUAL) /* (<TunnelStart> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_IsPTP_FALSE[] =
{
    COND_MAC(LAST, 42, 1, 0, EQUAL) /* (<IsPTP> == FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_plr_outgoing_IsPTP_TRUE[] =
{
    COND_MAC(LAST, 42, 1, 1, EQUAL) /* (<IsPTP> == TRUE) */
};

static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcat2plr_outgoing[] =
{
    FLD_MAC(FIRSTBUFFER, 0, 14),
    FLD_MAC(MDB, 14, 1),
    FLD_MAC(BANK, 15, 1),
...
/* Pre-egress to TXQ */
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_TunnelTerminated_TT[] =
{
    COND_MAC(LAST, 40, 1, 1, EQUAL) /* (<TunnelTerminated> == TT) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_TunnelTerminated_NoTT_IsPTP_FALSE[] =
{
    COND_MAC(AND, 40, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT  */
    COND_MAC(LAST, 42, 1, 0, EQUAL) /* <IsPTP>==FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_TunnelTerminated_NoTT_IsPTP_TRUE[] =
{
    COND_MAC(AND, 40, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT  */
    COND_MAC(LAST, 42, 1, 1, EQUAL) /* <IsPTP>==TRUE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FROM_CPU[] =
{
    COND_MAC(LAST, 86, 2, 1, EQUAL) /* (<OutGoingMtagCmd> == FROM_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_NOT_FROM_CPU[] =
{
    COND_MAC(LAST, 86, 2, 1, DIFFER) /* (<OutGoingMtagCmd> != FROM_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_TO_TARGET_SNIFFER_AND_QCN_True[] =
{
    COND_MAC(AND, 86, 2, 2, EQUAL), /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
    COND_MAC(LAST, 80, 1, 1, EQUAL) /* (<QCN> == True) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_NOT_TO_TARGET_SNIFFER_OR_QCN_False[] =
{
    COND_MAC(OR, 86, 2, 2, DIFFER), /* (<OutGoingMtagCmd> != TO_TARGET_SNIFFER) */
    COND_MAC(LAST, 80, 1, 0, EQUAL) /* (<QCN> == False) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_TO_TARGET_SNIFFER[] =
{
    COND_MAC(LAST, 86, 2, 2, EQUAL) /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_NOT_TO_TARGET_SNIFFER[] =
{
    COND_MAC(LAST, 86, 2, 2, DIFFER) /* (<OutGoingMtagCmd> != TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FORWARD[] =
{
    COND_MAC(LAST, 86, 2, 3, EQUAL) /* (<OutGoingMtagCmd> == FORWARD) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FORWARD_AND_OrigIsTrunk_0[] =
{
    COND_MAC(AND, 86, 2, 3, EQUAL), /* (<OutGoingMtagCmd> == FORWARD) */
    COND_MAC(LAST, 97, 1, 0, EQUAL) /* (<OrigIsTrunk> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FORWARD_AND_OrigIsTrunk_1[] =
{
    COND_MAC(AND, 86, 2, 3, EQUAL), /* (<OutGoingMtagCmd> == FORWARD) */
    COND_MAC(LAST, 97, 1, 1, EQUAL) /* (<OrigIsTrunk> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FORWARD_AND_UseVIDX_1[] =
{
    COND_MAC(AND, 86, 2, 3, EQUAL), /* (<OutGoingMtagCmd> == FORWARD) */
    COND_MAC(LAST, 112, 1, 1, EQUAL) /* (<UseVIDX> ==1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FORWARD_AND_UseVIDX_0[] =
{
    COND_MAC(AND, 86, 2, 3, EQUAL), /* (<OutGoingMtagCmd> == FORWARD) */
    COND_MAC(LAST, 112, 1, 0, EQUAL) /* (<UseVIDX> ==0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FROM_CPU_AND_UseVIDX_1[] =
{
    COND_MAC(AND, 86, 2, 1, EQUAL), /* (<OutGoingMtagCmd> == FROM_CPU) */
    COND_MAC(LAST, 112, 1, 1, EQUAL) /* (<UseVIDX> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FROM_CPU_AND_UseVIDX_0[] =
{
    COND_MAC(AND, 86, 2, 1, EQUAL), /* (<OutGoingMtagCmd> == FROM_CPU) */
    COND_MAC(LAST, 112, 1, 0, EQUAL) /* (<UseVIDX> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_TO_CPU[] =
{
    COND_MAC(LAST, 86, 2, 0, EQUAL) /* (<OutGoingMtagCmd> == TO_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_SrcTrg_1_AND_OutGoingMtagCmd_TO_CPU[] =
{
    COND_MAC(AND, 112, 1, 1, EQUAL), /* (<SrcTrg> == 1) */
    COND_MAC(LAST, 86, 2, 0, EQUAL) /* (<OutGoingMtagCmd> == TO_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_SrcTrg_0_AND_OutGoingMtagCmd_TO_CPU[] =
{
    COND_MAC(AND, 112, 1, 0, EQUAL), /* (<SrcTrg> == 0) */
    COND_MAC(LAST, 86, 2, 0, EQUAL) /* (<OutGoingMtagCmd> == TO_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FROM_CPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_1[] =
{
    COND_MAC(AND, 86, 2, 1, EQUAL), /* (<OutGoingMtagCmd> == FROM_CPU) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_OutGoingMtagCmd_FROM_CPU_AND_UseVIDX_1_AND_ExcludeIsTrunk_0[] =
{
    COND_MAC(AND, 86, 2, 1, EQUAL), /* (<OutGoingMtagCmd> == FROM_CPU) */
    COND_MAC(AND, 112, 1, 1, EQUAL), /* (<UseVIDX> == 1) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_UseVIDX_1_AND_OutGoingMtagCmd_TO_TARGET_SNIFFER[] =
{
    COND_MAC(AND, 112, 1, 1, EQUAL), /* (<UseVIDX> == 1) */
    COND_MAC(LAST, 86, 2, 2, EQUAL) /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_UseVIDX_0_AND_OutGoingMtagCmd_TO_TARGET_SNIFFER[] =
{
    COND_MAC(AND, 112, 1, 0, EQUAL), /* (<UseVIDX> == 0) */
    COND_MAC(LAST, 86, 2, 2, EQUAL) /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_RxSniff_Rx_AND_OutGoingMtagCmd_TO_TARGET_SNIFFER[] =
{
    COND_MAC(AND, 111, 1, 1, EQUAL), /* (<RxSniff> == Rx) */
    COND_MAC(LAST, 86, 2, 2, EQUAL) /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_RxSniff_Tx_AND_OutGoingMtagCmd_TO_TARGET_SNIFFER[] =
{
    COND_MAC(AND, 111, 1, 0, EQUAL), /* (<RxSniff> == Tx) */
    COND_MAC(LAST, 86, 2, 2, EQUAL) /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_TunnelStart_1[] =
{
    COND_MAC(LAST, 139, 1, 1, EQUAL) /* (<TunnelStart> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_TunnelStart_0[] =
{
    COND_MAC(LAST, 139, 1, 0, EQUAL) /* (<TunnelStart> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_IsPTP_FALSE[] =
{
    COND_MAC(LAST, 42, 1, 0, EQUAL) /* (<IsPTP> == FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_IsPTP_TRUE[] =
{
    COND_MAC(LAST, 42, 1, 1, EQUAL) /* (<IsPTP> == TRUE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_QCNPacket_1[] =
{
    COND_MAC(LAST, 201, 1, 1, EQUAL) /* (<QCNPacket> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_QCNPacket_NOT_1[] =
{
    COND_MAC(LAST, 201, 1, 1, DIFFER) /* (<QCNPacket> != 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_TunnelTerminated_NoTT[] =
{
    COND_MAC(LAST, 40, 1, 0, EQUAL) /* (<TunnelTerminated> == NoTT) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_RxSniff_Tx[] =
{
    COND_MAC(LAST, 111, 1, 0, EQUAL) /* (<RxSniff> == Tx) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_eq2txq_TunnelStart_NOT_1[] =
{
    COND_MAC(LAST, 139, 1, 1, DIFFER) /* (<TunnelStart> != 1) */
};

static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcateq2txq[] =
{
    FLD_MAC(FIRSTBUFFER, 0, 14),
    FLD_MAC(MDB, 14, 1),
    FLD_MAC(BANK, 15, 1),
...
static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcat2eq2txq[] =
{
    FLD_MAC(FIRSTBUFFER, 0, 14),
    FLD_MAC(MDB, 14, 1),
    FLD_MAC(BANK, 15, 1),
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_TunnelTerminated_TT[] =
{
    COND_MAC(LAST, 40, 1, 1, EQUAL) /* (<TunnelTerminated> == TT) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_TunnelTerminated_NoTT[] =
{
    COND_MAC(LAST, 40, 1, 0, EQUAL) /* (<TunnelTerminated> == NoTT) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_FROM_CPU[] =
{
    COND_MAC(LAST, 70, 2, 1, EQUAL) /* (<OutGoingMtagCmd> == FROM_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_NOT_FROM_CPU[] =
{
    COND_MAC(LAST, 70, 2, 1, DIFFER) /* (<OutGoingMtagCmd> != FROM_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_TO_TARGET_SNIFFER_AND_CCFC_True[] =
{
    COND_MAC(AND, 70, 2, 2, EQUAL), /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
    COND_MAC(LAST, 72, 1, 1, EQUAL) /* (<CCFC> == True) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_Not_TO_TARGET_SNIFFER_OR_CCFC_False[] =
{
    COND_MAC(OR, 70, 2, 2, DIFFER), /* (<OutGoingMtagCmd> != TO_TARGET_SNIFFER) */
    COND_MAC(LAST, 72, 1, 0, EQUAL) /* (<CCFC> == False) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_FORWARD_OR_OutGoingMtagCmd_FROM_CPU[] =
{
    COND_MAC(OR, 70, 2, 3, EQUAL),   /* (<OutGoingMtagCmd> == FORWARD) */
    COND_MAC(LAST, 70, 2, 1, EQUAL), /* (<OutGoingMtagCmd> == FROM_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_FORWARD_OR_OutGoingMtagCmd_FROM_CPU_AND_useVidx0[] =
{
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_FORWARD_OR_OutGoingMtagCmd_FROM_CPU_AND_useVidx1[] =
{
    COND_MAC(AND, 70, 2, 3, EQUAL),    /* (<OutGoingMtagCmd> == FORWARD) */
    COND_MAC(OR_SEQ, 70, 2, 1, EQUAL), /* (<OutGoingMtagCmd> == FROM_CPU) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_TO_CPU[] =
{
    COND_MAC(LAST, 70, 2, 0, EQUAL) /* (<OutGoingMtagCmd> == TO_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_TO_CPU_AND_srcTrg0[] =
{
    COND_MAC(AND, 70, 2, 0, EQUAL), /* (<OutGoingMtagCmd> == TO_CPU) */
    COND_MAC(LAST, 86, 1, 0, EQUAL) /* (<srcTrg> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_TO_CPU_AND_srcTrg1[] =
{
    COND_MAC(AND, 70, 2, 0, EQUAL), /* (<OutGoingMtagCmd> == TO_CPU) */
    COND_MAC(LAST, 86, 1, 1, EQUAL) /* (<srcTrg> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_TO_TARGET_SNIFFER[] =
{
    COND_MAC(LAST, 70, 2, 2, EQUAL) /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_TO_TARGET_SNIFFER_AND_srcTrg0[] =
{
    COND_MAC(AND, 70, 2, 2, EQUAL), /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
    COND_MAC(LAST, 86, 1, 0, EQUAL) /* (<srcTrg> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_OutGoingMtagCmd_TO_TARGET_SNIFFER_AND_srcTrg1[] =
{
    COND_MAC(AND, 70, 2, 2, EQUAL), /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
    COND_MAC(LAST, 86, 1, 1, EQUAL) /* (<srcTrg> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_TunnelStart_1[] =
{
    COND_MAC(LAST, 113, 1, 1, EQUAL) /* (<TunnelStart> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_txq2rddma_TunnelStart_NOT_1[] =
{
    COND_MAC(LAST, 113, 1, 1, DIFFER) /* (<TunnelStart> != 1) */
};

static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcat_txq2rddma[] =
{
    FLD_MAC(FIRSTBUFFER, 0, 14),
    FLD_MAC(MDB, 14, 1),
    FLD_MAC(BANK, 15, 1),
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_TunnelTerminated_TT[] =
{
    COND_MAC(LAST, 24, 1, 1, EQUAL) /* (<TunnelTerminated> == TT) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_TunnelTerminated_NoTT_IsPTP_FALSE[] =
{
    COND_MAC(AND, 24, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT  */
    COND_MAC(LAST, 26, 1, 0, EQUAL) /* <IsPTP>==FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_TunnelTerminated_NoTT_IsPTP_TRUE[] =
{
    COND_MAC(AND, 24, 1, 0, EQUAL), /* (<TunnelTerminated> == NoTT  */
    COND_MAC(LAST, 26, 1, 1, EQUAL) /* <IsPTP>==TRUE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_OutGoingMtagCmd_FROM_CPU[] =
{
    COND_MAC(LAST, 54, 2, 1, EQUAL) /* (<OutGoingMtagCmd> == FROM_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_OutGoingMtagCmd_NOT_FROM_CPU[] =
{
    COND_MAC(LAST, 54, 2, 1, DIFFER) /* (<OutGoingMtagCmd> != FROM_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_OutGoingMtagCmd_TO_TARGET_SNIFFER_AND_QCN_True[] =
{
    COND_MAC(AND, 54, 2, 2, EQUAL), /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
    COND_MAC(LAST, 56, 1, 1, EQUAL) /* (<QCN> == True) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_OutGoingMtagCmd_NOT_TO_TARGET_SNIFFER_OR_QCN_False[] =
{
    COND_MAC(OR, 54, 2, 2, DIFFER), /* (<OutGoingMtagCmd> != TO_TARGET_SNIFFER) */
    COND_MAC(LAST, 56, 1, 0, EQUAL) /* (<QCN> == False) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_OutGoingMtagCmd_FORWARD_OR_OutGoingMtagCmd_FROM_CPU[] =
{
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_OutGoingMtagCmd_FORWARD_OR_OutGoingMtagCmd_FROM_CPU_AND_UseVidx_1[] =
{
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_OutGoingMtagCmd_FORWARD_OR_OutGoingMtagCmd_FROM_CPU_AND_UseVidx_0[] =
{
    COND_MAC(AND, 54, 2, 0, DIFFER), /* (<OutGoingMtagCmd> != TO_CPU) */
    COND_MAC(AND, 54, 2, 2, DIFFER), /* (<OutGoingMtagCmd> != TO_TARGET_SNIFFER) */
...
static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_OutGoingMtagCmd_TO_CPU[] =
{
    COND_MAC(LAST, 54, 2, 0, EQUAL) /* (<OutGoingMtagCmd> == TO_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_SrcTrg_1_AND_OutGoingMtagCmd_TO_CPU[] =
{
    COND_MAC(AND, 70, 1, 1, EQUAL), /* (<SrcTrg> ==1) */
    COND_MAC(LAST, 54, 2, 0, EQUAL) /* (<OutGoingMtagCmd> == TO_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_SrcTrg_0_AND_OutGoingMtagCmd_TO_CPU[] =
{
    COND_MAC(AND, 70, 1, 0, EQUAL), /* (<SrcTrg> ==0) */
    COND_MAC(LAST, 54, 2, 0, EQUAL) /* (<OutGoingMtagCmd> == TO_CPU) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_OutGoingMtagCmd_TO_TARGET_SNIFFER[] =
{
    COND_MAC(LAST, 54, 2, 2, EQUAL) /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_RxSniff_1_AND_OutGoingMtagCmd_TO_TARGET_SNIFFER[] =
{
    COND_MAC(AND, 70, 1, 1, EQUAL), /* (<RxSniff> ==1) */
    COND_MAC(LAST, 54, 2, 2, EQUAL) /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_RxSniff_0_AND_OutGoingMtagCmd_TO_TARGET_SNIFFER[] =
{
    COND_MAC(AND, 70, 1, 0, EQUAL), /* (<RxSniff> ==0) */
    COND_MAC(LAST, 54, 2, 2, EQUAL) /* (<OutGoingMtagCmd> == TO_TARGET_SNIFFER) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_TunnelStart_1[] =
{
    COND_MAC(LAST, 97, 1, 1, EQUAL) /* (<TunnelStart> == 1) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_TunnelStart_0[] =
{
    COND_MAC(LAST, 97, 1, 0, EQUAL) /* (<TunnelStart> == 0) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_IsPTP_FALSE[] =
{
    COND_MAC(LAST, 26, 1, 0, EQUAL) /* (<IsPTP> == FALSE) */
};

static const PRV_CPSS_DXCH_DIAG_CONDITION_STC cond_rddma2ha_IsPTP_TRUE[] =
{
    COND_MAC(LAST, 26, 1, 1, EQUAL) /* (<IsPTP> == TRUE) */
};
...
static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcat2rddma2ha[] =
{
...
static const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC xcat2eplr2epcl[] =
{
    FLD_MAC(PKTCMD, 0, 1),
...
/**
* @internal prvCpssDxChDiagDescriptorRawGet function
* @endinternal
*
...
* @param[in,out] rawDataLengthPtr     - in : pointer to descriptor raw (HW)
*                                            data length (bytes).
*                                       out: pointer to actual descriptor raw (HW)
*                                            data length (bytes).
*
...
/**
* @internal internal_cpssDxChDiagDescriptorRawGet function
* @endinternal
*
* @brief   Get the descriptor information in raw (HW) format
*
...
/**
* @internal cpssDxChDiagDescriptorRawGet function
* @endinternal
*
* @brief   Get the descriptor information in raw (HW) format
*
...
/**
* @internal internal_cpssDxChDiagDescriptorPortGroupRawGet function
* @endinternal
*
* @brief   Get the descriptor information in raw (HW) format
*
...
/**
* @internal cpssDxChDiagDescriptorPortGroupRawGet function
* @endinternal
*
* @brief   Get the descriptor information in raw (HW) format
*
...
/**
* @internal internal_cpssDxChDiagDescriptorRawSizeGet function
* @endinternal
*
...
/**
* @internal cpssDxChDiagDescriptorRawSizeGet function
* @endinternal
*
* @brief   Get the descriptor raw (HW) size.
*
...
/**
* @internal internal_cpssDxChDiagDescriptorGet function
* @endinternal
*
...
/**
* @internal cpssDxChDiagDescriptorGet function
* @endinternal
*
* @brief   Get the descriptor information.
*
...
/**
* @internal internal_cpssDxChDiagDescriptorPortGroupGet function
* @endinternal
*
* @brief   Get the descriptor information.
*
...
)
{
    ...
    GT_U32      i;              /* iterator */
    GT_U32      ii;             /* iterator */
    const PRV_CPSS_DXCH_DIAG_HW_DESCR_STC *hwDescr; /* pointer to descriptor in HW format */
    ...
    for(i = 0; i < fieldsNum; i++)
    {
        ...
        if(validField == GT_TRUE)
        {
            ...
            if (index >= CPSS_DXCH_DIAG_DESCRIPTOR_FIELD_TYPE_LAST_E)
            {
...
/**
* @internal cpssDxChDiagDescriptorPortGroupGet function
* @endinternal
*
* @brief   Get the descriptor information.
*

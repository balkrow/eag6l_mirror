...
)
{
    ...
    for(lookupNum=0;lookupNum<CPSS_DXCH_EXACT_MATCH_LOOKUP_LAST_E;lookupNum++)
    {
        ...
        if(lookupEnable==GT_TRUE)
        {
            ...
            /* set lookup client */
            rc = prvCpssDxChExactMatchPortGroupClientLookupSet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                               portGroupsBmp,
            ...
            for(i=0;i<lookupClientMappingsNum;i++)
            {
                ...
                {
                    rc = prvCpssDxChExactMatchPortGroupTtiProfileIdModePacketTypeSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                                                     newPortGroupsBmp,
                ...
                else
                {
                    ...
                    rc = prvCpssDxChExactMatchPortGroupPclProfileIdSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                                        newPortGroupsBmp,
                                                                        direction,
                ...
                {
                    /* set key params */
                    rc = prvCpssDxChExactMatchPortGroupProfileKeyParamsSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                                           portGroupsBmp,
                                                                           profileIdVal,
                    ...
                    rc = prvCpssDxChExactMatchPortGroupProfileDefaultActionSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                                               portGroupsBmp,
                                                                               profileIdVal,
...
)
{
    ...
    for (expandedActionIndex=0;expandedActionIndex<CPSS_DXCH_EXACT_MATCH_MANAGER_EXPANDED_ACTION_ENTRIES_NUM_CNS;expandedActionIndex++)
    {
        ...
        {
            rc = prvCpssDxChExactMatchPortGroupExpandedActionSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, portGroupsBmp, expandedActionIndex,
...
)
{
    ...
    while(rc == GT_OK)
    {
        ...
        rc = cpssDxChExactMatchPortGroupEntryInvalidate(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                        CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,portGroupsBmp,hwIndex);
...
)
{
    ...
    */
    ...
    {
        /* set capacity info */
        rc = prvCpssDxChCfgEmSizeSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, exactMatchManagerPtr->capacityInfo.hwCapacity.numOfHwIndexes);
        if(rc != GT_OK)
        {
            return rc;
        }
        ...
        /* set aging info */
        rc = prvCpssDxChExactMatchPortGroupActivityBitEnableSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E, CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                                portGroupsBmp, exactMatchManagerPtr->agingInfo.agingRefreshEnable);
        if(rc != GT_OK)
        {
            return rc;
        }
...
)
{
    ...
    case 2: /* CPSS_DXCH_TTI_REDIRECT_TO_ROUTER_LOOKUP_E */
        ...
        rc = prvCpssDxChLpmLeafEntryCalcLpmHwIndexFromSwIndex(devNum, dbEntryPtr->redirectPtr, &hwValue);
        if (rc != GT_OK)
        {
            return rc;
        }
    ...
    case 0: /* CPSS_DXCH_TTI_NO_REDIRECT_E */
        ...
        SIP6_TTI_HW_ENTRY_FIELD_SET_MAC(devNum,hwDataArr,
                                ...
                                hwValue);
        break;
    case 6:/* CPSS_DXCH_TTI_ASSIGN_GENERIC_ACTION_E */
        if (!PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
        }
        hwValue = dbEntryPtr->redirectPtr; /* hold genericAction */
        SIP6_TTI_HW_ENTRY_FIELD_SET_MAC(devNum,hwDataArr,
    ...
    else
    {
        if(hwValue)
        {
            if (PRV_CPSS_DXCH_IS_VPORT(devNum,dbEntryPtr->sourceEPort))
            {
                hwValue = 2;/*ASSIGN_SRC_VPORT*/
            }
            else
            {
                hwValue = 1;/*ASSIGN_SRC_EPORT*/
            }
        }
        SIP6_TTI_HW_ENTRY_FIELD_SET_MAC(devNum,hwDataArr,
...
)
{
    ...
    switch(dbEntryPtr->redirectCmd)
    {
        ...
        case 2:/*CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_ROUTER_E*/
            ...
            if(((GT_U32)(dbEntryPtr->redirectPtr)) >= PRV_CPSS_DXCH_PP_MAC(devNum)->moduleCfg.ip.maxNumOfPbrEntries)
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "leafIndex[%d] must be less than maxNumOfPbrEntries[%d]",
                    (dbEntryPtr->redirectPtr), PRV_CPSS_DXCH_PP_MAC(devNum)->moduleCfg.ip.maxNumOfPbrEntries);
            }
            prvCpssDxChLpmLeafEntryCalcLpmHwIndexFromSwIndex(devNum,dbEntryPtr->redirectPtr,&hwValue);
      ...
      case 7: /*CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_ECMP_E*/
        ...
        case 8: /*CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_ECMP_AND_ASSIGN_VRF_ID_E*/
            ...
            break;
        case 9:/* CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_ASSIGN_GENERIC_ACTION_E */
            if (!PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
            }
            ...
            hwValue = dbEntryPtr->redirectPtr;
            SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,hwDataArr,
...
)
{
    ...
    for(ii = 0 ; ii < numOfPairs ; ii++)
    {
        ...
        rc = prvCpssDxChExactMatchIndexValidity(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,dbEntryPtr->hwIndex,(CPSS_DXCH_EXACT_MATCH_KEY_SIZE_ENT)(dbEntryPtr->hwExactMatchKeySize));
        if (rc  != GT_OK)
        {
            EM_UNLOCK_DEV_NUM(pairListArr[ii].devNum);
...
)
{
    ...
    for(ii = 0 ; ii < numOfPairs ; ii++)
    {
        ...
        /* check that the hwIndex is suppoted in the currect device */
        /* check validity of Exact Match Entry index */
        rc = prvCpssDxChExactMatchIndexValidity(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
...
)
{
          ...
          prvCpssDxChExactMatchManagerDbEntryIteratorGetNext(exactMatchManagerPtr,getFirst,&dbEntryPtr))
    {
        ...
        rc = cpssDxChExactMatchPortGroupEntryInvalidate(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                        CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                        portGroupsBmp,dbEntryPtr->hwIndex);
        if(rc != GT_OK)
        {
            return rc;
        }
...
{
    GT_STATUS rc;
    GT_U32    hwActionArray[PRV_CPSS_DXCH_EXACT_MATCH_DEFAULT_ACTION_MAX_SIZE_CNS];
    GT_U32    dbActionArray[PRV_CPSS_DXCH_EXACT_MATCH_DEFAULT_ACTION_MAX_SIZE_CNS];
...
)
{
    ...
    for(lookupNum=0;lookupNum<CPSS_DXCH_EXACT_MATCH_LOOKUP_LAST_E;lookupNum++)
    {
        ...
        if(lookupEnable==GT_TRUE)
        {
            EM_LOCK_DEV_NUM(devNum)
            /* get lookup client */
            rc = prvCpssDxChExactMatchPortGroupClientLookupGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                               portGroupsBmp,
                                                               (CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT)lookupNum,
                                                               &hwLookupClient);
            if (rc != GT_OK)
            ...
            for(i=0;i<lookupClientMappingsNum;i++)
            {
                ...
                {
                    /* get key params */
                    rc = prvCpssDxChExactMatchPortGroupProfileKeyParamsGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                                           portGroupsBmp,
                                                                           hwProfileId,
                                                                           &hwKeyParams);
                    if (rc != GT_OK)
                    ...
                    rc = prvCpssDxChExactMatchPortGroupProfileDefaultActionGet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                                               portGroupsBmp,
                                                                               hwProfileId,
...
)
{
    ...
    while(rc == GT_OK)
    {
        ...
        /* *************************************************************************** */
        regAddr = PRV_CPSS_DXCH_DEV_REGS_VER1_MAC(devNum)->EM[CPSS_DXCH_EXACT_MATCH_UNIT_0_E].EMGlobalConfiguration.EMGlobalConfiguration1;
...
)
{
    ...
    for(hwIndex = 0; hwIndex<exactMatchManagerPtr->capacityInfo.hwCapacity.numOfHwIndexes; /* hwIndex change according to the keySize of the entry*/ )
    {
        ...
        EM_LOCK_DEV_NUM(devNum);
        rc = cpssDxChExactMatchPortGroupEntryGet(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E,CPSS_DXCH_EXACT_MATCH_LOOKUP_FIRST_E,
                                                 portGroupsBmp,hwIndex,&isValid,&actionType,&action,&entry,&expandedActionIndex);
        EM_UNLOCK_DEV_NUM(devNum);
        if(rc != GT_OK)
        {
...
)
{
    ...
    regData = PRV_DXCH_REG1_UNIT_EM_MAC(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E).EMIndirectAccess.EMIndirectAccessData[0];
    ...
    regData = PRV_DXCH_REG1_UNIT_EM_MAC(devNum,CPSS_DXCH_EXACT_MATCH_UNIT_0_E).EMIndirectAccess.EMIndirectAccessControl;
...
/**
* @internal prvCpssDxChExactMatchManagerHwProfileEntryUpdateDevice function
* @endinternal
*
* @brief  This function update profile configration for a single device.
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
...
* @param[in] profileEntryParamsPtr      - (pointer to) the Exact Match Manager profile config.
*
* @retval GT_OK              - on success
* @retval other              - unexpected error
*
...
*
*/
GT_STATUS   prvCpssDxChExactMatchManagerHwProfileEntryUpdateDevice
(
    IN GT_U8                                                    devNum,
    IN GT_PORT_GROUPS_BMP                                       portGroupsBmp,
    IN  GT_U32                                                  profileId,
...
)
{
    ...
    rc = prvCpssDxChExactMatchPortGroupProfileKeyParamsSet(devNum,
                                                           ...
                                                           portGroupsBmp,
                                                           profileId,
                                                           &profileEntryParamsPtr->keyParams);
    if (rc != GT_OK)
    {
        return rc;
    }
    ...
    rc = prvCpssDxChExactMatchPortGroupProfileDefaultActionSet(devNum, CPSS_DXCH_EXACT_MATCH_UNIT_0_E,
                                                               ...
                                                               &profileEntryParamsPtr->defaultAction,
                                                               profileEntryParamsPtr->defaultActionEn);
    if (rc != GT_OK)
    {
        return rc;
    }
...
/**
* @internal prvCpssDxChExactMatchManagerHwProfileEntryUpdate function
* @endinternal
*
* @brief This function update profile entry configuration to the
*        HW. This API overrite the configuration done in the
...
*
*/
GT_STATUS   prvCpssDxChExactMatchManagerHwProfileEntryUpdate
(
   IN PRV_CPSS_DXCH_EXACT_MATCH_MANAGER_DB_INSTANCE_INFO_STC  *exactMatchManagerPtr,
   IN GT_U32                                                  profileId
)
{
    ...
    while(rc == GT_OK)
    {
        rc = prvCpssDxChExactMatchManagerHwProfileEntryUpdateDevice(devNum,
                                                                 portGroupsBmp,
                                                                 profileId,
...
/**
* @internal prvCpssDxChExactMatchManagerHwLookupUpdateDevice function
* @endinternal
*
* @brief  This function update lookup configration for a single device.
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
...
* @param[in] lookupEntryParamsPtr  - (pointer to) the Exact Match Manager
*                                    Lookup config.
*
* @retval GT_OK              - on success
* @retval other              - unexpected error
...
*
*/
GT_STATUS   prvCpssDxChExactMatchManagerHwLookupUpdateDevice
(
    IN GT_U8                                                    devNum,
    IN GT_PORT_GROUPS_BMP                                       portGroupsBmp,
...
/**
* @internal prvCpssDxChExactMatchManagerHwLookupUpdate function
* @endinternal
*
* @brief This function update Lookup configuration to the HW.
*        This API overrite the configuration done in the Exact
...
*
*/
GT_STATUS  prvCpssDxChExactMatchManagerHwLookupUpdate
(
   IN PRV_CPSS_DXCH_EXACT_MATCH_MANAGER_DB_INSTANCE_INFO_STC  *exactMatchManagerPtr,
   IN CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT                         lookupNum
)
{
    ...
    while(rc == GT_OK)
    {
        rc = prvCpssDxChExactMatchManagerHwLookupUpdateDevice(devNum,
                                                              portGroupsBmp,
                                                              lookupNum,

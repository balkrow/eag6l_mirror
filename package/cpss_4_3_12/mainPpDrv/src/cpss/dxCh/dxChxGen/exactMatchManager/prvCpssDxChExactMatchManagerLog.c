...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, checkAgeKeySizeEntries, CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E, GT_BOOL);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, pattern, CPSS_DXCH_EXACT_MATCH_MANAGER_MAX_KEY_SIZE_CNS, GT_U8);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, mask, CPSS_DXCH_EXACT_MATCH_MANAGER_MAX_KEY_SIZE_CNS, GT_U8);
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, deleteAgeoutKeySizeEntries, CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E, GT_BOOL);
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, actionMatchWaEnable);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, ttiClientKeySizeEntriesArray, CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E, GT_U32);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, ipcl0ClientKeySizeEntriesArray, CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E, GT_U32);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, ipcl1ClientKeySizeEntriesArray, CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E, GT_U32);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, ipcl2ClientKeySizeEntriesArray, CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E, GT_U32);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, epclClientKeySizeEntriesArray, CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E, GT_U32);
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, dbHashFreeListCheckEnable);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, dbHashIndexArrayCheckEnable);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, deleteKeySizeEntries, CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E, GT_BOOL);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, pattern, CPSS_DXCH_EXACT_MATCH_MANAGER_MAX_KEY_SIZE_CNS, GT_U8);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, mask, CPSS_DXCH_EXACT_MATCH_MANAGER_MAX_KEY_SIZE_CNS, GT_U8);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, userDefinedPattern);
    PRV_CPSS_LOG_STC_32_HEX_MAC(valPtr, userDefinedMask);
...
void prvCpssLogParamFunc_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
void prvCpssLogParamFunc_CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC_PTR_lookupEntryParamsPtr = {
     "lookupEntryParamsPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC_PTR_profileEntryParamsPtr = {
     "profileEntryParamsPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC_PTR_lookupEntryParamsPtr = {
     "lookupEntryParamsPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC_PTR_profileEntryParamsPtr = {
     "profileEntryParamsPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchManagerLookupUpdate_PARAMS[] =  {
    &DX_IN_GT_U32_exactMatchManagerId,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT_lookupNum,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC_PTR_lookupEntryParamsPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchManagerProfileEntryUpdate_PARAMS[] =  {
    &DX_IN_GT_U32_exactMatchManagerId,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT_lookupNum,
    &DX_IN_GT_U32_profileId,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC_PTR_profileEntryParamsPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchManagerLookupGet_PARAMS[] =  {
    &DX_IN_GT_U32_exactMatchManagerId,
    &DX_IN_CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT_lookupNum,
    &DX_OUT_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC_PTR_lookupEntryParamsPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChExactMatchManagerProfileEntryGet_PARAMS[] =  {
    &DX_IN_GT_U32_exactMatchManagerId,
    &DX_IN_GT_U32_profileId,
    &DX_OUT_CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC_PTR_profileEntryParamsPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChExactMatchManagerLogLibDb[] = {
    ...
    {"cpssDxChExactMatchManagerProfileEntryUpdate", 4, cpssDxChExactMatchManagerProfileEntryUpdate_PARAMS, NULL},
    {"cpssDxChExactMatchManagerProfileEntryGet", 3, cpssDxChExactMatchManagerProfileEntryGet_PARAMS, NULL},
    {"cpssDxChExactMatchManagerLookupUpdate", 3, cpssDxChExactMatchManagerLookupUpdate_PARAMS, NULL},
    {"cpssDxChExactMatchManagerLookupGet", 3, cpssDxChExactMatchManagerLookupGet_PARAMS, NULL},
};

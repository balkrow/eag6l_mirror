...
/**
********************************************************************************
* @file cpssDxChMultiPortGroup.c
*
* @brief The file hold API for building infrastructure of the connections between
...
/**
* @internal multiPortGroupConfigSetParametersCheck function
* @endinternal
*
* @brief   check parameter for function cpssDxChMultiPortGroupConfigSet(...)
*
...
)
{
    ...
    {
        PRV_CPSS_DXCH_PHY_PORT_CHECK_MAC(devNum,uplinkPortsArr[ii]);
    ...
    for( kk = 0 ; kk < ringInfoNum ; kk++ ,currRingInfoPtr++)
    {
        ...
        for(ii = 0 ; ii < currRingInfoPtr->numOfRingPorts ; ii++)
        {
            ...
            PRV_CPSS_DXCH_PHY_PORT_CHECK_MAC(devNum,currRingInfoPtr->ringPortsPtr[ii]);
...
/**
* @internal ringPortConfigSet function
* @endinternal
*
* @brief   function to set 'ring port' for cpssDxChMultiPortGroupConfigSet(...)
*
* @note   APPLICABLE DEVICES:      Lion2.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
* @param[in] devNum                   - the device number
* @param[in] ringPort                 - port to set as 'ring port'
*
* @retval GT_OK                    - on success
* @retval GT_HW_ERROR              - on hardware error
*                                       COMMENTS
...
)
{
    ...
    rc = cpssDxChCscdPortTypeSet(
        devNum,ringPort,CPSS_PORT_DIRECTION_BOTH_E,
...
/**
* @internal multiPortGroupLookupNotFoundConfig function
* @endinternal
*
* @brief   function handle 2 APIs in the same time:
...
/**
* @internal trunkCascadeTrunkPortsSet function
* @endinternal
*
* @brief   This function sets the 'cascade' trunk with the specified 'Local ports'
...
/**
* @internal multiPortGroupConfigSet function
* @endinternal
*
* @brief   function to set mode for cpssDxChMultiPortGroupConfigSet(...)
*
* @note   APPLICABLE DEVICES:      Lion2.
...
)
{
    ...
    CPSS_DXCH_MULTI_PORT_GROUP_LOOKUP_NOT_FOUND_STC   lookupNotFoundinfo; /*the setting for the
    ...
    cpssOsMemSet(&lookupNotFoundinfo, 0, sizeof(CPSS_DXCH_MULTI_PORT_GROUP_LOOKUP_NOT_FOUND_STC));
...
/**
* @internal internal_cpssDxChMultiPortGroupConfigSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupTrunkSrcPortHashMappingSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupPortLookupEnableSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupPortLookupEnableGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupPortRingEnableSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupPortRingEnableGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupLookupNotFoundTableSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupLookupNotFoundTableGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupBridgeUnknownDaMaskEnableSet function
* @endinternal
*
...
)
{
    ...
    else
    {
        ...
        {
            /* not support more than 8 port groups */
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
        }
...
/**
* @internal internal_cpssDxChMultiPortGroupBridgeUnknownDaMaskEnableGet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupFdbModeSet function
* @endinternal
*
...
/**
* @internal internal_cpssDxChMultiPortGroupFdbModeGet function
* @endinternal
*

...
/*UNIT_LED_MAC_100G_0 */    ,{PRV_CPSS_DXCH_UNIT_LED_4_E          ,0xA8800000     , 4   *     _1K}
    ...
    ,{PRV_CPSS_DXCH_UNIT_SDW0_0_E         ,0xA9000000     ,512   *    _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW5_0_E         ,0xA8C00000     ,512   *    _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW4_0_E         ,0xA9400000     ,512   *    _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW4_1_E         ,0xA9500000     ,512   *    _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW4_2_E         ,0xA9600000     ,512   *    _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW4_3_E         ,0xA9700000     ,512   *    _1K}
    /* mif USX*/
...
)
{
    ...
    switch (unitId)
    {
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_CPU_RSFEC_STATISTICS_E:
...
GT_STATUS prvCpssPhoenixNonSharedHwInfoFuncPointersSet
(
    IN  GT_U8   devNum
)
{
    ...
    PRV_HW_REG_TO_UNIT_ID(devNum)  = prvCpssDxChPhoenixHwRegAddrToUnitIdConvert;
    PRV_DMA_DP_LOCAL_TO_GLOBAL_NUM_CONVERT_GET_NEXT(devNum) = prvCpssPhoenixDmaLocalNumInDpToGlobalNumConvert_getNext;
    PRV_OFFSET_FROM_FIRST_INSTANCE_GET(devNum)= prvCpssPhoenixOffsetFromFirstInstanceGet;
    PRV_CPSS_UNIT_ID_SIZE_IN_BYTE_GET(devNum)= prvCpssPhoenixUnitIdSizeInByteGet;
...
)
{
    ...
    GT_U32  frameLatencyArrPhoenix[] =  {0x797,0x797,0x797,0x795,0x794,0x796,0x796,0x796,0x794,0x794};
    GT_U32  frameLatencyFracArrPhoenix[] =  {0xBC, 0xBC, 0xBC, 0xD5, 0x00, 0x30, 0x30, 0x30, 0x00, 0x20};

    const CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC delayArrPhoenix[] = {
         ...
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_25G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_RS_FEC_528_514_MODE_ENABLED_E, 0, 0}
    };

    const CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC delayCpuArrPhoenix[] = {
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_10G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 272, 0},
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_25G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 244, 96},
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_25G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_RS_FEC_528_514_MODE_ENABLED_E, 152, 0}
    };

    const CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC delay100GArrPhoenix[] = {
          {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_10G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 0, 0},
          {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_25G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 0, 0},
          {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_25G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_RS_FEC_528_514_MODE_ENABLED_E, 0, 0}
    };
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.parametericTables.numEntriesIpclConfig = _4K + 128;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.parametericTables.numEntriesEpclConfig = _4K + 128;

    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.egfInfo.numBitsPerPort = 7;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.frameLatencyArr = (GT_U32 *)cpssOsMalloc((PRV_CPSS_NUM_OF_TAI_IN_PHOENIX_CNS-1)*sizeof(GT_U32));
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.frameLatencyFracArr = (GT_U32 *)cpssOsMalloc((PRV_CPSS_NUM_OF_TAI_IN_PHOENIX_CNS-1)*sizeof(GT_U32));
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.fracNanoSeconds = 0.25;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPortArr = (CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC *)cpssOsMalloc((sizeof(delayArrPhoenix) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC))*sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC));
    cpssOsMemCpy(PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPortArr,delayArrPhoenix, sizeof(delayArrPhoenix));
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPortArrNumElements  = sizeof(delayArrPhoenix) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC);
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayCpuPortArr = (CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC *)cpssOsMalloc((sizeof(delayCpuArrPhoenix) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC))*sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC));
    cpssOsMemCpy(PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayCpuPortArr,delayCpuArrPhoenix, sizeof(delayCpuArrPhoenix));
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayCpuPortArrNumElements  = sizeof(delayCpuArrPhoenix) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC);
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delay100GPortArr = (CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC *)cpssOsMalloc((sizeof(delay100GArrPhoenix) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC))*sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC));
    cpssOsMemCpy(PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delay100GPortArr,delay100GArrPhoenix, sizeof(delay100GArrPhoenix));
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delay100GPortArrNumElements  = sizeof(delay100GArrPhoenix) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC);

    /* PLL configuration */
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].K = 2;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].M = 0;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].N = 319;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].vcoBand = 10;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].lpfCtrl = 9;

    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].K = 2;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].M = 1;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].N = 319;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].vcoBand = 10;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].lpfCtrl = 9;

    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].K = 2;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].M = 1;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].N = 255;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].vcoBand = 10;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].lpfCtrl = 8;

    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_156_25_FREQ_E].K = 2;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_156_25_FREQ_E].M = 3;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_156_25_FREQ_E].N = 81;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_156_25_FREQ_E].vcoBand = 10;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_156_25_FREQ_E].lpfCtrl = 5;

    /* code moved from : prvCpssDxChDfxPipesBmpGet() */
    /* AC5X: pipes 0, 1, 2, 3, 4 */
    PRV_CPSS_PP_MAC(devNum)->diagInfo.dfxPipesBmp = 0x1F;

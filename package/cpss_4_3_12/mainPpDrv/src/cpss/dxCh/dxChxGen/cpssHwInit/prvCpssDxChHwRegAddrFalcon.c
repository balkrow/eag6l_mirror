...
static const SPECIAL_DMA_PORTS_STC falcon_12_8_SpecialDma_ports[]= {
   ...
   /*279*/{ MG4_SERVED_DP/*11*/,FALCON_PORTS_PER_DP_CNS/*localPortInDp*/,2/*pipeIndex*/,GT_NA/*localPortInPipe*/},/*CPU SDMA MG 4*/
...
)
{
    ...
    if(localDmaNumInDp >= PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.multiDataPath.info[localDpIndexInTile].dataPathNumOfPorts)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM,
            "localDmaNumInDp[%d] must not be '>=' than [%d]",
            localDmaNumInDp,PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.multiDataPath.info[localDpIndexInTile].dataPathNumOfPorts);
    }
...
GT_STATUS prvCpssFalconNonSharedHwInfoFuncPointersSet
(
    IN  GT_U8   devNum
)
{
    ...
    PRV_HW_REG_TO_UNIT_ID(devNum)= prvCpssDxChFalconHwRegAddrToUnitIdConvert;
    PRV_DMA_DP_LOCAL_TO_GLOBAL_NUM_CONVERT_GET_NEXT(devNum)= prvCpssFalconDmaLocalNumInDpToGlobalNumConvert_getNext;
    PRV_OFFSET_FROM_FIRST_INSTANCE_GET(devNum)= falconOffsetFromFirstInstanceGet;
    PRV_CPSS_UNIT_ID_SIZE_IN_BYTE_GET(devNum) = prvCpssFalconUnitIdSizeInByteGet;
...
)
{
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.parametericTables.numEntriesIpclConfig = _4K + _1K;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.egfInfo.shtRegisterOffset = 0x000b0000;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.fracNanoSeconds = 0.5;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].N = 99;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].vcoBand = 2;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].lpfCtrl = 5;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].N = 49;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].vcoBand = 2;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].lpfCtrl = 4;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].N = 39;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].vcoBand = 2;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].lpfCtrl = 3;

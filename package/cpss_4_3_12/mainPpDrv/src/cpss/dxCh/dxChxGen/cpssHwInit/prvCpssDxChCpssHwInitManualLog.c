...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_ARRAY_additionalInfoBmpArr = {
     "additionalInfoBmpArr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_ARRAY_MAC(GT_U32)
};

const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChHwPpImplementWaInit_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_U32_numOfWa,
    &DX_IN_CPSS_DXCH_IMPLEMENT_WA_ENT_PTR_waArr,
    &DX_IN_GT_U32_ARRAY_additionalInfoBmpArr
};

...
GT_STATUS  prvCpssHawkNonSharedHwInfoFuncPointersSet
(
    IN  GT_U8   devNum
)
{
    ...
    PRV_HW_REG_TO_UNIT_ID(devNum)  = prvCpssDxChHawkHwRegAddrToUnitIdConvert;
    PRV_DMA_DP_LOCAL_TO_GLOBAL_NUM_CONVERT_GET_NEXT(devNum)= prvCpssHawkDmaLocalNumInDpToGlobalNumConvert_getNext;
    PRV_OFFSET_FROM_FIRST_INSTANCE_GET(devNum)= prvCpssHawkOffsetFromFirstInstanceGet;
    PRV_CPSS_UNIT_ID_SIZE_IN_BYTE_GET(devNum)= prvCpssHawkUnitIdSizeInByteGet;
...
)
{
    ...
    const CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC delayArrHawk[] = {
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_10G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 322, 0},
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_25G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 243, 0},
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_25G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_RS_FEC_528_514_MODE_ENABLED_E, 155, 0},
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_100G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_4LANE_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 116, 0}
    };
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.parametericTables.numEntriesEpclConfig = _4K + _1K;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.frameLatencyArr = (GT_U32 *)cpssOsMalloc((PRV_CPSS_NUM_OF_TAI_IN_HAWK_CNS-1)*sizeof(GT_U32));
    cpssOsMemCpy(PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.frameLatencyArr, frameLatencyArrHawk, sizeof(frameLatencyArrHawk));
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.frameLatencyFracArr = (GT_U32 *)cpssOsMalloc((PRV_CPSS_NUM_OF_TAI_IN_HAWK_CNS-1)*sizeof(GT_U32));
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPortArr = (CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC *)cpssOsMalloc((sizeof(delayArrHawk) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC))*sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC));
    cpssOsMemCpy(PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPortArr,delayArrHawk, sizeof(delayArrHawk));
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPortArrNumElements  = sizeof(delayArrHawk) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC);
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].N = 159;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].vcoBand = 4;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_10_FREQ_E].lpfCtrl = 7;

    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].K = 2;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].M = 0;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].N = 79;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].vcoBand = 4;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_20_FREQ_E].lpfCtrl = 5;

    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].K = 2;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].M = 0;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].N = 63;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].vcoBand = 4;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_25_FREQ_E].lpfCtrl = 4;

    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.pllConfig[CPSS_DXCH_PTP_156_25_FREQ_E].K = 3;
    ...
    PRV_CPSS_PP_MAC(devNum)->diagInfo.dfxPipesBmp = 0xFF;

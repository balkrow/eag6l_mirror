...
/* There are up to 4 LED servers/units in Ironman */
/*
...
*/
#define PRV_CPSS_DXCH_IRONMAN_LED_UNIT_NUM_CNS                           4
...
/*  ,{PRV_CPSS_DXCH_UNIT_EM_E                         ,0x05000000,      4  * _1M }*/
    ...
    ,{PRV_CPSS_DXCH_UNIT_PCA_LMU_0_E                  ,0x91080000,     64  * _1K }
    ...
    ,{PRV_CPSS_DXCH_UNIT_MG_E            ,PRV_CPSS_IRONMAN_MG0_BASE_ADDRESS_CNS+MG_SIZE*0,MG_SIZE } /*0x7F900000*/
    ,{PRV_CPSS_DXCH_UNIT_MG_0_1_E        ,PRV_CPSS_IRONMAN_MG0_BASE_ADDRESS_CNS+MG_SIZE*1,MG_SIZE } /*0x7FA00000*/
    ,{PRV_CPSS_DXCH_UNIT_MG_0_2_E        ,PRV_CPSS_IRONMAN_MG0_BASE_ADDRESS_CNS+MG_SIZE*2,MG_SIZE } /*0x7FB00000*/
    ...
    ,{PRV_CPSS_DXCH_UNIT_CNM_RUNIT_E     ,0x7F000000      ,     64  * _1K }
    ,{PRV_CPSS_DXCH_UNIT_CNM_ADDR_DECODER_E   ,0x80400000      ,     9 * 64  * _1K }

    /* LED USX + CPU */
    ,{PRV_CPSS_DXCH_UNIT_LED_0_E                ,0x98700000      ,       1  *  _1M}
    ,{PRV_CPSS_DXCH_UNIT_LED_1_E                ,0x99700000      ,       1  *  _1M}
    ,{PRV_CPSS_DXCH_UNIT_LED_2_E                ,0x93700000      ,       1  *  _1M}
    ,{PRV_CPSS_DXCH_UNIT_LED_3_E                ,0x92200000      ,       1  *  _1M}


    /* 10G MAC BR */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_BR_0_E     ,0x98000000            ,64  *  _1K} /* ports  0..7 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_BR_1_E     ,0x99000000            ,64  *  _1K} /* ports  8..15 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_BR_2_E     ,0x93000000            ,64  *  _1K} /* ports 16..23 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_BR_3_E     ,0x91600000            ,64  *  _1K} /* ports 48 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_BR_4_E     ,0x91700000            ,64  *  _1K} /* ports 49 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_BR_5_E     ,0x91800000            ,64  *  _1K} /* ports 50 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_BR_6_E     ,0x91900000            ,64  *  _1K} /* ports 51 */

    /* 10G MAC NON-BR */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_NON_BR_0_E ,0x98100000            ,64  *  _1K} /* ports 24..31 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_NON_BR_1_E ,0x99100000            ,64  *  _1K} /* ports 32..39 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_NON_BR_2_E ,0x93100000            ,64  *  _1K} /* ports 40..47 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_NON_BR_3_E ,0x98200000            ,64  *  _1K} /* ports 52 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_NON_BR_4_E ,0x99200000            ,64  *  _1K} /* ports 53 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_NON_BR_5_E ,0x93200000            ,64  *  _1K} /* ports 54 */

    /* 10G PCS x1 (sinlge port) */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x1_0_E     ,0x91A00000            ,64  *  _1K} /* port   48 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x1_1_E     ,0x91B00000            ,64  *  _1K} /* port   49 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x1_2_E     ,0x91C00000            ,64  *  _1K} /* port   50 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x1_3_E     ,0x91D00000            ,64  *  _1K} /* port   51 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x1_4_E     ,0x98500000            ,64  *  _1K} /* ports  52 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x1_5_E     ,0x99500000            ,64  *  _1K} /* ports  53 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x1_6_E     ,0x93500000            ,64  *  _1K} /* ports  54 */

    /* 10G PCS x8 (8 port) */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x8_0_E     ,0x98300000            ,64  *  _1K} /* ports  0..7 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x8_1_E     ,0x99300000            ,64  *  _1K} /* ports  8..15 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x8_2_E     ,0x93300000            ,64  *  _1K} /* ports 16..23 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x8_3_E     ,0x98400000            ,64  *  _1K} /* ports 24..31 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x8_4_E     ,0x99400000            ,64  *  _1K} /* ports 32..39 */
    ,{PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x8_5_E     ,0x93400000            ,64  *  _1K} /* ports 40..47 */
    ...
    /*ANP*/
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_0_E      ,0x98800000     ,64   *     _1M}  /*ANP USX*/ /* ports  0..7 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_1_E      ,0x98900000     ,64   *     _1M}  /*ANP USX*/
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_2_E      ,0x99800000     ,64   *     _1M}  /*ANP USX*/ /* ports  8..15 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_3_E      ,0x99900000     ,64   *     _1M}  /*ANP USX*/
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_4_E      ,0x93800000     ,64   *     _1M}  /*ANP USX*/ /* ports 16..23 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_5_E      ,0x93900000     ,64   *     _1M}  /*ANP USX*/
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_6_E      ,0x98A00000     ,64   *     _1M}  /*ANP USX*/ /* ports 24..31 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_7_E      ,0x98B00000     ,64   *     _1M}  /*ANP USX*/
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_8_E      ,0x99A00000     ,64   *     _1M}  /*ANP USX*/ /* ports 32..39 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_9_E      ,0x99B00000     ,64   *     _1M}  /*ANP USX*/
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_10_E     ,0x93A00000     ,64   *     _1M}  /*ANP USX*/ /* ports 40..47 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_USX_11_E     ,0x93B00000     ,64   *     _1M}  /*ANP USX*/

    ,{PRV_CPSS_DXCH_UNIT_ANP_CPU_0_E      ,0x91E00000     ,64   *     _1M}  /*ANP CPU*/ /* port   48 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_CPU_1_E      ,0x91F00000     ,64   *     _1M}  /*ANP CPU*/ /* port   49 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_CPU_2_E      ,0x92000000     ,64   *     _1M}  /*ANP CPU*/ /* port   50 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_CPU_3_E      ,0x92100000     ,64   *     _1M}  /*ANP CPU*/ /* port   51 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_CPU_4_E      ,0x98C00000     ,64   *     _1M}  /*ANP CPU*/ /* ports  52 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_CPU_5_E      ,0x99C00000     ,64   *     _1M}  /*ANP CPU*/ /* ports  53 */
    ,{PRV_CPSS_DXCH_UNIT_ANP_CPU_6_E      ,0x93C00000     ,64   *     _1M}  /*ANP CPU*/ /* ports  54 */

    ,{PRV_CPSS_DXCH_UNIT_SDW0_E           ,0x99D00000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW1_E           ,0x99D80000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW2_E           ,0x99E00000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW3_E           ,0x99E80000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW4_E           ,0x99F00000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW5_E           ,0x99F80000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW6_E           ,0x9A000000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW7_E           ,0x91300000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW8_E           ,0x91380000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW9_E           ,0x91400000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW10_E          ,0x91480000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW11_E          ,0x91500000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_SDW12_E          ,0x91580000     ,512  *     _1K}
    ...
    ,{PRV_CPSS_DXCH_UNIT_PCA_PGC_RX_E     ,0x90B00000     ,512  *     _1K}
    ,{PRV_CPSS_DXCH_UNIT_PCA_PGC_TX_E     ,0x90D00000     ,512  *     _1K}
...
)
{
    ...
    switch (unitId)
    {
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_CPU_MAC_E:
            if(portMacNum < 24)
            {
                unitId = HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_MAC_BR_E;
            }
            else if(portMacNum < 48)
            {
                unitId = HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_MAC_NON_BR_E;
            }
            else if(portMacNum < 52)
            {
                unitId = HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_MAC_BR_E;
            }
            else
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_USX_EXT_E:
            unitId = HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PORT_EXT_E;
            break;
    ...
    switch (unitId)
    {
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_MAC_BR_E:
            if(portMacNum < 24) /* MAC 10G BR unit */
            {
                macInfoPtr->ciderUnit        = portMacNum / 8;          /* BR: 0,1,2 */
                macInfoPtr->ciderIndexInUnit = portMacNum % 8;
            }
            else if(portMacNum < 48) /* MAC 10G unit */
            {
                return /* not error for the LOG */ GT_OUT_OF_RANGE;
            }
            else if(portMacNum < 52)
            {
                macInfoPtr->ciderUnit        = 3 + (portMacNum - 48);   /* BR: 3,4,5,6 */
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_MAC_NON_BR_E:
            if(portMacNum < 24) /* MAC 10G BR unit */
            {
                return /* not error for the LOG */ GT_OUT_OF_RANGE;
            }
            ...
            {
                macInfoPtr->ciderUnit        = (portMacNum % 24) / 8;   /* NON-BR: 0,1,2*/
                macInfoPtr->ciderIndexInUnit = portMacNum % 8;
            }
            else if(portMacNum < 52)
            {
            ...
            {
                macInfoPtr->ciderUnit        = 3 + (portMacNum - 52);   /* NON-BR: 3,4,5 */
                macInfoPtr->ciderIndexInUnit = 0;
            }
            break;

        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PORT_EXT_E:
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_GLOBAL_EXT_E:
            ...
            if(unitId == HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_GLOBAL_EXT_E)
            {
                macInfoPtr->ciderIndexInUnit = 0;
            }
            break;
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_AN_CPU_E:
            if(portMacNum >= 48)
            {
                macInfoPtr->ciderUnit        = portMacNum - 48;   /* CPU: 0,1,2,3,4,5,6*/
                macInfoPtr->ciderIndexInUnit = 0;
            }
            else
            {
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_AN_USX_O_E:
        case HWS_UNIT_BASE_ADDR_TYPE_ANP_USX_O_E:
        case HWS_UNIT_BASE_ADDR_TYPE_ANP_USX_E:

            if(portMacNum < 48)
            {
                macInfoPtr->ciderUnit        = (portMacNum / 8) * 2;   /* USX: 0..2..4..10*/
                macInfoPtr->ciderIndexInUnit = 0;

                if((HWS_UNIT_BASE_ADDR_TYPE_ANP_USX_E == unitId)||
                   (HWS_UNIT_BASE_ADDR_TYPE_AN_USX_E == unitId))
                {
                    macInfoPtr->ciderUnit += (portMacNum % 8) / 4;
                }
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_LPCS_GENERAL_E:
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_LPCS_PORT_E:
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_BASER_E:
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_FCFEC_E:
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_EXT_E:
            if(portMacNum < 48)
            {
                macInfoPtr->ciderUnit        = portMacNum / 8;
                macInfoPtr->ciderIndexInUnit = portMacNum % 8;
            }
            else
            {
                macInfoPtr->ciderUnit        = (portMacNum - 48);
                macInfoPtr->ciderIndexInUnit = 0;
            }
            break;
...
)
{
    ...
    {
        baseAddr   = prvCpssDxChHwUnitBaseAddrGet(devNum, (PRV_CPSS_DXCH_UNIT_SDW0_E + portNum), NULL);
        return baseAddr;
    }
    ...
    switch(unitId)
    {
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_MAC_BR_E:
            if((portNum < 24) ||
               ((portNum >=48) && (portNum < 52)))
            {
                baseAddr = prvCpssDxChHwUnitBaseAddrGet(devNum, (PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_BR_0_E + macInfo.ciderUnit), NULL);
            }
            else
            {
                return PRV_CPSS_SW_PTR_ENTRY_UNUSED;
            }
            baseAddr += 0x3000 + macInfo.ciderIndexInUnit * 0x1000;
            return baseAddr;
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_MAC_NON_BR_E:
            ...
            {
                baseAddr = prvCpssDxChHwUnitBaseAddrGet(devNum, (PRV_CPSS_DXCH_UNIT_MTI_10G_MAC_NON_BR_0_E + macInfo.ciderUnit), NULL);
            }
            baseAddr += 0x3000 + macInfo.ciderIndexInUnit * 0x1000;
            return baseAddr;
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PORT_EXT_E:
            ...
            baseAddr += 0x100 + macInfo.ciderIndexInUnit * 0x100;
            return baseAddr;

        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_LPCS_GENERAL_E:
            if(portNum < 48)
            {
                baseAddr = prvCpssDxChHwUnitBaseAddrGet(devNum, (PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x8_0_E + macInfo.ciderUnit), NULL);
            }
            else
            {
                baseAddr = prvCpssDxChHwUnitBaseAddrGet(devNum, (PRV_CPSS_DXCH_UNIT_MTI_10G_PCS_x1_0_E + macInfo.ciderUnit), NULL);
            }
            return (baseAddr + 0x1000);
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_LPCS_PORT_E:
            ...
            return (baseAddr + 0x1000 + 0x80 * macInfo.ciderIndexInUnit);
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_BASER_E:
            ...
            return (baseAddr + 0x2000 + 0x100 * macInfo.ciderIndexInUnit);
        ...
        case HWS_UNIT_BASE_ADDR_TYPE_MTI_10G_PCS_FCFEC_E:
            ...
            return (baseAddr + 0x3000 + 0x1000 * (macInfo.ciderIndexInUnit / 4)/*SD_NUM: 0..1*/);
        ...
        devs_ironman_l_common,
        {
            NULL,  /*enhancedInfoPtr*/
            {
               ...
               12*_1K,/*6K@20B*//* GT_U32 tunnelTerm;         */
                                 /*                           */
                /* tunnel section                             */
                (_8K/*ARPs*//4),   /*GT_U32  tunnelStart;     */
        /*_8K*/AUTO_CALC_FIELD_CNS,/*GT_U32  routerArp;       */
                                 /*                           */
                /* ip section                                 */
...
static const GT_U32 ironmanTables_size = sizeof(ironmanTables)/sizeof(ironmanTables[0]);
...
GT_STATUS prvCpssIronmanNonSharedHwInfoFuncPointersSet
(
    IN  GT_U8   devNum
)
{
    ...
    PRV_HW_REG_TO_UNIT_ID(devNum) = prvCpssDxChIronmanHwRegAddrToUnitIdConvert;
    PRV_DMA_DP_LOCAL_TO_GLOBAL_NUM_CONVERT_GET_NEXT(devNum)= prvCpssIronmanDmaLocalNumInDpToGlobalNumConvert_getNext;
    PRV_OFFSET_FROM_FIRST_INSTANCE_GET(devNum)= prvCpssIronmanOffsetFromFirstInstanceGet;
    PRV_CPSS_UNIT_ID_SIZE_IN_BYTE_GET(devNum)= prvCpssIronmanUnitIdSizeInByteGet;
...
)
{
    ...
    const CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC delayArrIronmanPort2Phy[] = { /* CPSS_TBD_BOOKMARK_IRONMAN */
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_10G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 0, 0},
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_25G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 0, 0}
    };

    const CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC delayArrIronman[] = { /* CPSS_TBD_BOOKMARK_IRONMAN */
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_10G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 0, 0},
         {CPSS_DXCH_PTP_MANAGER_PORT_SPEED_25G_E, CPSS_DXCH_PTP_MANAGER_PORT_INTERFACE_MODE_DEFAULT_E, CPSS_DXCH_PTP_MANAGER_PORT_FEC_MODE_DISABLED_E, 0, 0}
    };
    ...
    PRV_CPSS_DXCH_PP_HW_INFO_SERDES_MAC(devNum).sip6LanesNumInDev = 13/*10G*/;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.multiDataPath.sip6TxNumOfSpeedProfiles = MAX_SPEED_PROFILE_NUM_IRONMAN_CNS;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.tcam.numOfTcamProfiles      = 32;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.tcam.numOfTcamMuxTableLines = 24;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.tcam.numOfSubKeys1_3        = 1;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.tti.TTI_ip2me_numEntries = 8;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.lmuInfo.numLmuUnits = 1;/* single LMU unit */
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.parametericTables.numEntriesIpclConfig = _4K + 64;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.parametericTables.numEntriesEpclConfig = _4K + 64;

    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.egfInfo.numBitsPerPort = 6;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.egfInfo.shtRegisterOffset = 0x00100000;
    ...
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.frameLatencyArr = NULL;
    ...
    /* Ironman-M internal PHY link delay; the link delay from switch to PHY. */
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.phyDelayInfo.phyPpsLinkDelay = 10;
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.phyDelayInfo.phyPulseLinkDelay = 8;

    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPortArr = (CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC *)cpssOsMalloc((sizeof(delayArrIronman) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC))*sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC));
    cpssOsMemCpy(PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPortArr,delayArrIronman, sizeof(delayArrIronman));
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPortArrNumElements  = sizeof(delayArrIronman) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC);
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPhyPortArr = (CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC *)cpssOsMalloc((sizeof(delayArrIronmanPort2Phy) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC))*sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC));
    cpssOsMemCpy(PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPhyPortArr,delayArrIronmanPort2Phy, sizeof(delayArrIronmanPort2Phy));
    PRV_CPSS_DXCH_PP_MAC(devNum)->hwInfo.ptpInfo.delayPhyPortArrNumElements  = sizeof(delayArrIronmanPort2Phy) / sizeof(CPSS_DXCH_PTP_MANAGER_DB_DELAYS_STC);
    ...
    for(ii = 0 ;ii < PRV_CPSS_DXCH_PP_MAC(devNum)->port.numRegularPorts;ii++)
    {
      if((ii < 24) || ((ii >= 48)&&(ii<=51)))
      {
        PRV_CPSS_PP_MAC(devNum)->phyPortInfoArray[ii].preemptionSupported = GT_TRUE;
      }
    }

    /* code moved from : prvCpssDxChDfxPipesBmpGet() */
    /* Ironman: pipes 0..2 */
    PRV_CPSS_PP_MAC(devNum)->diagInfo.dfxPipesBmp = 0x07;

...
#define PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_SET(_var,_value)\
      PRV_NON_SHARED_GLOBAL_VAR_SET(mainPpDrvMod.dxChCpssHwInit.tablesSrc._var,_value)

#define PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(_var)\
      PRV_NON_SHARED_GLOBAL_VAR_GET(mainPpDrvMod.dxChCpssHwInit.tablesSrc._var)

#define PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT \
      PRV_NON_SHARED_GLOBAL_VAR_GET(mainPpDrvMod.dxChCpssHwInit.tablesSrc.prvDxChTableCpssHwAccessObj)
...
#define PRV_CPSS_DXCH_DEV_TBLS_MAC(devNum)  \
    (PRV_CPSS_ACCESS_TABLE_INFO_PTR(devNum))
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip5TtiDefaultEportTableFieldsFormat[SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC( 155,   2, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_EVLAN_EXTENSION_E),
    PRV_CPSS_FIELD_MAC( 157,   10, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_GENERIC_RANGE_SOURCE_PORT_PROFILE_E),
    PRV_CPSS_FIELD_MAC( 167,   3, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_SERIAL_EM_PORT_PROFILE_ID_E),
    PRV_CPSS_FIELD_MAC( 170,   10, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_GENERIC_CLASSIFICATION_FIELD_DEFAULT_VALUE_E),
    PRV_CPSS_FIELD_MAC( 182,   2, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_SERIAL_EM1_LOOKUP_KEY_MODE_E),
    PRV_CPSS_FIELD_MAC( 184,   2, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_SERIAL_EM2_LOOKUP_KEY_MODE_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_MIDWAY_PCL_CFG_MODE_E), /*not presernt*/
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_EXCESSIVE_L2_TAG_EXCEPTION_ENABLE_E), /*not presernt*/
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_INGRESS_CASCASDE_DLB_ENABLE_E), /*not presernt*/
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRUST_QOS_MAPPING_TABLE_INDEX_EXTENSION_E) /*not presernt*/
};

/*AAS*/
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip7TtiDefaultEportTableFieldsFormat[SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS___LAST_VALUE___E] =
{
    PRV_CPSS_FIELD_MAC(   0,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_PROT_BASED_QOS_EN_E),
    PRV_CPSS_FIELD_MAC(   1,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_PROT_BASED_VLAN_EN_E),
    PRV_CPSS_FIELD_MAC(   2,  12, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_DEF_TAG1_VLAN_ID_E),
    ...
    PRV_CPSS_FIELD_MAC(  59,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRUST_EXP_E),
    PRV_CPSS_FIELD_MAC(  60,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRUST_DSCP_E),
    PRV_CPSS_FIELD_MAC(  61,   2, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRUST_UP_E),
    PRV_CPSS_FIELD_MAC(  71,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_MAP_DSCP_TO_DSCP_E),
    PRV_CPSS_FIELD_MAC(  63,   4, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRUST_QOS_MAPPING_TABLE_INDEX_E),
    PRV_CPSS_FIELD_MAC(  67,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_PORT_MODIFY_DSCP_E),
    PRV_CPSS_FIELD_MAC(  68,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_PORT_MODIFY_UP_E),
    PRV_CPSS_FIELD_MAC(  69,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_PORT_QOS_PRECEDENCE_E),
    PRV_CPSS_FIELD_MAC(  70,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_NESTED_VLAN_ACCESS_PORT_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_OVERSIZE_UNTAGGED_PKTS_FILTER_EN_E), /*not present */
    PRV_CPSS_FIELD_MAC(  72,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRILL_ENGINE_EN_E),
    PRV_CPSS_FIELD_MAC(  73,  12, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRILL_INGRESS_OUTER_VID0_E),
    PRV_CPSS_FIELD_MAC(  85,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_TTI_802_1AH_PASSENGER_STAG_IS_TAG0_1_E),
    PRV_CPSS_FIELD_MAC(  86,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_IPV4_6_TOTAL_LENGTH_DEDUCTION_EN_E),
    ...
    PRV_CPSS_FIELD_MAC(  88,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_OAM_LINK_LAYER_LOOPBACK_EN_E),
    PRV_CPSS_FIELD_MAC(  89,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_UP_CFI_TO_QOS_TABLE_SELECT_MODE_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_LOOKUP0_PCL_CFG_MODE_E), /*not present */
    PRV_CPSS_FIELD_MAC(  92,   2, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_LOOKUP1_PCL_CFG_MODE_E),
    PRV_CPSS_FIELD_MAC(  94,   2, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_LOOKUP2_PCL_CFG_MODE_E),
    PRV_CPSS_FIELD_MAC(  96,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_ASSIGN_VF_ID_EN_E),
    PRV_CPSS_FIELD_MAC(  97,   1, SIP5_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRUST_L2_QOS_TAG0_OR_TAG1_E),
    ...
    PRV_CPSS_FIELD_MAC( 149,   1, SIP6_30_TTI_DEFAULT_EPORT_TABLE_FIELDS_PRT_TREAT_WRONG_LAN_ID_AS_RCT_EXISTS_E),
    PRV_CPSS_FIELD_MAC( 150,   5, SIP6_30_TTI_DEFAULT_EPORT_TABLE_FIELDS_LSDU_CONSTANT_E),
    PRV_CPSS_FIELD_MAC( 155,   3, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_EVLAN_EXTENSION_E),
    PRV_CPSS_FIELD_MAC( 158,   10, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_GENERIC_RANGE_SOURCE_PORT_PROFILE_E),
    PRV_CPSS_FIELD_MAC( 168,   3, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_SERIAL_EM_PORT_PROFILE_ID_E),
    PRV_CPSS_FIELD_MAC( 171,   10, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_GENERIC_CLASSIFICATION_FIELD_DEFAULT_VALUE_E),
    PRV_CPSS_FIELD_MAC( 183,   2, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_SERIAL_EM1_LOOKUP_KEY_MODE_E),
    PRV_CPSS_FIELD_MAC( 185,   2, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_SERIAL_EM2_LOOKUP_KEY_MODE_E),
    PRV_CPSS_FIELD_MAC(  90,   2, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_MIDWAY_PCL_CFG_MODE_E),
    PRV_CPSS_FIELD_MAC( 181,   1, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_EXCESSIVE_L2_TAG_EXCEPTION_ENABLE_E),
    PRV_CPSS_FIELD_MAC( 182,   1, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_INGRESS_CASCASDE_DLB_ENABLE_E),
    PRV_CPSS_FIELD_MAC( 187,   3, SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRUST_QOS_MAPPING_TABLE_INDEX_EXTENSION_E)
};
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip7TtiEportAttributesTableFieldsFormat[SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS___LAST_VALUE___E] =
{
    PRV_CPSS_FIELD_MAC(   0,   3, SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS_ING_TAG0_TPID_PROFILE_E),
    PRV_CPSS_FIELD_MAC(   3,   3, SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS_ING_TAG1_TPID_PROFILE_E),
    PRV_CPSS_FIELD_MAC(   6,   2, SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS_NUM_OF_TAGS_TO_POP_E),
    PRV_CPSS_FIELD_MAC(   8,   1, SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS_ING_POLICY_EN_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS_DIS_IPCL0_FOR_ROUTED_E), /*not presernt*/
    PRV_CPSS_FIELD_MAC(   9,   1, SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS_TRUST_L2_QOS_TAG0_OR_TAG1_E),
    PRV_CPSS_FIELD_MAC(  10,   1, SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS_OVERRIDE_MASK_HASH_EN_E),
    PRV_CPSS_FIELD_MAC(  11,   4, SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS_HASH_MASK_INDEX_E),
    PRV_CPSS_FIELD_MAC(  15,   1, SIP5_TTI_EPORT_ATTRIBUTES_TABLE_FIELDS_PHY_SRC_MC_FILTERING_EN_E)
};
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip5L2iIngressVlanTableFieldsFormat[SIP5_L2I_INGRESS_VLAN_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_L2I_INGRESS_VLAN_TABLE_FIELDS_ENABLE_TRAP_MIRROR_ARP_BC_WITH_MY_IP_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_L2I_INGRESS_VLAN_TABLE_FIELDS_GRATUITOUS_ARP_REPLY_BC_TO_CPU_EN_E)
};
...
/*static*/ const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip5FdbFdbTableFieldsFormat[SIP5_10_FDB_FDB_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC(  20,  20, SIP5_FDB_FDB_TABLE_FIELDS_NH_KEY_HW_INDEX_E),
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip5L2MllTableFieldsFormat[SIP5_L2_MLL_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_L2_MLL_TABLE_FIELDS_USE_VPORT_0_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_L2_MLL_TABLE_FIELDS_VPORT_0_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_L2_MLL_TABLE_FIELDS_USE_VPORT_1_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_L2_MLL_TABLE_FIELDS_VPORT_1_E)
};
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip5IpMllTableFieldsFormat[SIP5_IP_MLL_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_IP_MLL_TABLE_FIELDS_DISABLE_MAC_SA_MODIFICATION_0_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_IP_MLL_TABLE_FIELDS_USE_VPORT_0_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_IP_MLL_TABLE_FIELDS_VPORT_0_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_IP_MLL_TABLE_FIELDS_DISABLE_MAC_SA_MODIFICATION_1_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_IP_MLL_TABLE_FIELDS_USE_VPORT_1_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_IP_MLL_TABLE_FIELDS_VPORT_1_E)
};
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip6HaTunnelStartTableFieldsFormat[SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS____LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC(  0,    0, SIP7_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_RESERVED_3_E),
    PRV_CPSS_FIELD_MAC(  0,    0, SIP7_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_MAC_SA_INDEX_E),
    PRV_CPSS_FIELD_MAC(  0,    0, SIP7_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_NUMBER_OF_SEGMENTS_E)
};

static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip7HaTunnelStartTableFieldsFormat[SIP5_HA_TUNNEL_START_TABLE_FIELDS____LAST_VALUE___E] =
{
    PRV_CPSS_FIELD_MAC( 0  , 3   ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_TUNNEL_TYPE_E),
    PRV_CPSS_FIELD_MAC( 3  , 1   ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_UP_MARKING_MODE_E),
    PRV_CPSS_FIELD_MAC( 4  , 3   ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_UP_E),
    ...
    PRV_CPSS_FIELD_MAC( 8  , 12  ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_VID_E),
    PRV_CPSS_FIELD_MAC( 20 , 8   ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_TTL_E),
    PRV_CPSS_FIELD_MAC( 0  , 0   ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_RETAIN_INNER_CRC_E),
    PRV_CPSS_FIELD_MAC( 28 , 2   ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_RESERVED_E),
    PRV_CPSS_FIELD_MAC( 28 , 1   ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_B_SA_ASSIGN_MODE_E),
    PRV_CPSS_FIELD_MAC( 28 , 2   ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_GRE_KEY_MODE_E),
    PRV_CPSS_FIELD_MAC( 30 , 2   ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_PROTOCOL_E),
    PRV_CPSS_FIELD_MAC( 32 , 48  ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_NEXT_HOP_MAC_DA_E),
    PRV_CPSS_FIELD_MAC( 80 , 16  ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_GRE_PROTOCOL_E),
    PRV_CPSS_FIELD_MAC( 80 , 16  ,SIP5_HA_TUNNEL_START_TABLE_FIELDS_RESERVED_1_E),
    ...
    PRV_CPSS_FIELD_MAC(  82,   1, SIP5_HA_TUNNEL_START_TABLE_FIELDS_PUSH_ELI_AND_EL_AFTER_LABEL_2_E),
    PRV_CPSS_FIELD_MAC(  83,   1, SIP5_HA_TUNNEL_START_TABLE_FIELDS_PUSH_ELI_AND_EL_AFTER_LABEL_3_E),
    PRV_CPSS_FIELD_MAC( 190,   8, SIP7_HA_TUNNEL_START_TABLE_FIELDS_IPV4_MAC_SA_INDEX_E),
    PRV_CPSS_FIELD_MAC( 384,   8, SIP7_HA_TUNNEL_START_TABLE_FIELDS_IPV6_MAC_SA_INDEX_E),
    PRV_CPSS_FIELD_MAC( 392,   4, SIP7_HA_TUNNEL_START_TABLE_FIELDS_NUMBER_OF_SEGMENTS_E),
    /* MPLS vPort TSE */
    PRV_CPSS_FIELD_MAC(   3,   2, SIP7_HA_TUNNEL_START_TABLE_FIELDS_TAG0_QOS_MARKING_MODE_E),
    PRV_CPSS_FIELD_MAC(   5,   2, SIP7_HA_TUNNEL_START_TABLE_FIELDS_TAG1_QOS_MARKING_MODE_E),
    PRV_CPSS_FIELD_MAC(   7,   3, SIP7_HA_TUNNEL_START_TABLE_FIELDS_UP0_E),
    PRV_CPSS_FIELD_MAC(  10,   1, SIP7_HA_TUNNEL_START_TABLE_FIELDS_DEI0_E),
    PRV_CPSS_FIELD_MAC(  11,   3, SIP7_HA_TUNNEL_START_TABLE_FIELDS_UP1_E),
    PRV_CPSS_FIELD_MAC(  14,   1, SIP7_HA_TUNNEL_START_TABLE_FIELDS_DEI1_E),
    PRV_CPSS_FIELD_MAC(  15,   8, SIP7_HA_TUNNEL_START_TABLE_FIELDS_THREAD_ID_E),
    PRV_CPSS_FIELD_MAC(  23,   6, SIP7_HA_TUNNEL_START_TABLE_FIELDS_ANALYZER_INDEX_E),
    PRV_CPSS_FIELD_MAC(  29,   2, SIP7_HA_TUNNEL_START_TABLE_FIELDS_EGRESS_MIRROR_MODE_E),
    PRV_CPSS_FIELD_MAC(  31,   1, SIP7_HA_TUNNEL_START_TABLE_FIELDS_RAW_LABELS_E),
    PRV_CPSS_FIELD_MAC(  32,   3, SIP7_HA_TUNNEL_START_TABLE_FIELDS_MPLS_ETHERTYPE_SELECT_E),
    PRV_CPSS_FIELD_MAC(  35,  19, SIP7_HA_TUNNEL_START_TABLE_FIELDS_CNC_PTR_E),
    PRV_CPSS_FIELD_MAC(  54,   4, SIP7_HA_TUNNEL_START_TABLE_FIELDS_FLOW_ID_OR_GCF_PROFILE_ID_E),
    PRV_CPSS_FIELD_MAC(  58,  32, SIP7_HA_TUNNEL_START_TABLE_FIELDS_FLOW_ID_OR_GCF_BITS_E),
    PRV_CPSS_FIELD_MAC(  90,   4, SIP7_HA_TUNNEL_START_TABLE_FIELDS_NUMBER_OF_LABELS_E),
    PRV_CPSS_FIELD_MAC(  94,   4, SIP7_HA_TUNNEL_START_TABLE_FIELDS_LAST_QOS_UNIFORM_LABEL_E),
    PRV_CPSS_FIELD_MAC(  98,   3, SIP7_HA_TUNNEL_START_TABLE_FIELDS_GLOBAL_EXP_MAPPING_TBL_INDEX_E),
    PRV_CPSS_FIELD_MAC( 101,   4, SIP7_HA_TUNNEL_START_TABLE_FIELDS_LAST_TTL_UNIFORM_LABEL_E),
    PRV_CPSS_FIELD_MAC( 105,   4, SIP7_HA_TUNNEL_START_TABLE_FIELDS_CW_INDEX_E),
    PRV_CPSS_FIELD_MAC( 109,   1, SIP7_HA_TUNNEL_START_TABLE_FIELDS_FLOW_LABEL_INSERTION_E),
    /* MPLS vPort Labels */
    PRV_CPSS_FIELD_MAC( 110, 510, SIP7_HA_TUNNEL_START_TABLE_FIELDS_MPLS_VPORT_LABELS_E),

};

static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip7HaTunnelStartGenericTableFieldsFormat[SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS____LAST_VALUE___E] =
{
    PRV_CPSS_FIELD_MAC(   0,   3, SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_TUNNEL_TYPE_E),
    PRV_CPSS_FIELD_MAC(   3,   1, SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_UP_MARKING_MODE_E),
    PRV_CPSS_FIELD_MAC(   4,   3, SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_UP_E),
    ...
    PRV_CPSS_FIELD_MAC(  20,   3, SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_GENERIC_TUNNEL_START_TYPE_E),
    PRV_CPSS_FIELD_MAC(  23,   5, SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_RESERVED_1_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_RETAIN_INNER_CRC_E),
    PRV_CPSS_FIELD_MAC(  28,   2, SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_RESERVED_2_E),
    PRV_CPSS_FIELD_MAC(  32,  48, SIP6_HA_TUNNEL_START_TABLE_GENERIC_FILEDS_MAC_DA_E),
    PRV_CPSS_FIELD_MAC(  80,  16, SIP6_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_ETHER_TYPE_E),
    PRV_CPSS_FIELD_MAC(  382, 2, SIP7_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_RESERVED_3_E),
    PRV_CPSS_FIELD_MAC(  384, 8, SIP7_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_MAC_SA_INDEX_E),
    PRV_CPSS_FIELD_MAC(  392, 4, SIP7_HA_TUNNEL_START_TABLE_GENERIC_FIELDS_NUMBER_OF_SEGMENTS_E)
};
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip5HaGenTunnelStartProfileTableFieldsFormat[SIP5_HA_GEN_TUNNEL_START_PROFILE_TABLE_FIELDS____LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC( 0,     0, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_IPV6_SHR_ROUTING_TYPE_E),
    PRV_CPSS_FIELD_MAC( 0,     0, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_IPV6_SHR_MODE_E),
    PRV_CPSS_FIELD_MAC( 0,     0, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_THREAD_ID_E),
    PRV_CPSS_FIELD_MAC( 0,     0, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_EGRESS_MIRRORING_MODE_E),
    PRV_CPSS_FIELD_MAC( 0,     0, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_IP_PROTOCOL_E),
    PRV_CPSS_FIELD_MAC( 0,     0, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_UDP_DST_PORT_E),
    PRV_CPSS_FIELD_MAC( 0,     0, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_GRE_PROTOCOL_E),
    PRV_CPSS_FIELD_MAC( 0,     0, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_SRV6_PACKET_EDITOR_MODE_E)
};

static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip7HaGenTunnelStartProfileTableFieldsFormat[SIP5_HA_GEN_TUNNEL_START_PROFILE_TABLE_FIELDS____LAST_VALUE___E] =
{
    PRV_CPSS_FIELD_MAC(   0,   4, SIP5_HA_GEN_TUNNEL_START_PROFILE_TABLE_FIELDS_TEMPLATE_BYTE0_BIT0_E),
    PRV_CPSS_FIELD_MAC(   4,   4, SIP5_HA_GEN_TUNNEL_START_PROFILE_TABLE_FIELDS_TEMPLATE_BYTE0_BIT1_E),
    PRV_CPSS_FIELD_MAC(   8,   4, SIP5_HA_GEN_TUNNEL_START_PROFILE_TABLE_FIELDS_TEMPLATE_BYTE0_BIT2_E),
    ...
    PRV_CPSS_FIELD_MAC( 529,   5, SIP5_HA_GEN_TUNNEL_START_PROFILE_TABLE_FIELDS_PROFILE_DIP_MODE_E),
    PRV_CPSS_FIELD_MAC( 534,   3, SIP5_HA_GEN_TUNNEL_START_PROFILE_TABLE_FIELDS_CONTROL_WORD_INDEX_E),
    PRV_CPSS_FIELD_MAC( 537,   8, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_IPV6_SHR_ROUTING_TYPE_E),
    PRV_CPSS_FIELD_MAC( 545,   1, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_IPV6_SHR_MODE_E),
    PRV_CPSS_FIELD_MAC( 546,   8, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_THREAD_ID_E),
    PRV_CPSS_FIELD_MAC( 554,   2, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_EGRESS_MIRRORING_MODE_E),
    PRV_CPSS_FIELD_MAC( 556,   7, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_IP_PROTOCOL_E),
    PRV_CPSS_FIELD_MAC( 556,   16, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_UDP_DST_PORT_E),
    PRV_CPSS_FIELD_MAC( 556,   16, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_GRE_PROTOCOL_E),
    PRV_CPSS_FIELD_MAC( 572,   1, SIP7_HA_GENERIC_TS_PROFILE_TABLE_FIELDS_SRV6_PACKET_EDITOR_MODE_E)
};
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip5_20HaEPort1TableFieldsFormat[SIP5_HA_EPORT_TABLE_1_FIELDS____LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC(  46,  16, SIP6_30_HA_EPORT_TABLE_1_FIELDS_NAT_PTR_E)
};
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip5_20IpvxRouterNextHopTableFieldsFormat[SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC(   9,  12, SIP6_10_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TARGET_EPG_E), /* In SIP 6.30 changed from 9 to 12 bits */
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TARGET_IS_VPORT_E),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TARGET_VPORT_E)

};

static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip7IpvxRouterNextHopTableFieldsFormat[SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS___LAST_VALUE___E] =
{
    PRV_CPSS_FIELD_MAC(   0,   3, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_COMMAND_E),
    PRV_CPSS_FIELD_MAC(   3,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_BYPASS_TTL_OPTIONS_OR_HOP_EXTENSION_E),
    PRV_CPSS_FIELD_MAC(   4,   2, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_CPU_CODE_INDEX_E),
    PRV_CPSS_FIELD_MAC(   6,   6, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_INGRESS_MIRROR_TO_ANALYZER_INDEX_E),
    PRV_CPSS_FIELD_MAC(  12,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_QOS_PROFILE_PRECEDENCE_E),
    PRV_CPSS_FIELD_MAC(  13,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_QOS_PROFILE_MARKING_EN_E),
    PRV_CPSS_FIELD_MAC(  14,   7, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_QOS_PROFILE_INDEX_E),
    PRV_CPSS_FIELD_MAC(  21,   2, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_MODIFY_DSCP_E),
    PRV_CPSS_FIELD_MAC(  23,   2, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_MODIFY_UP_E),
    PRV_CPSS_FIELD_MAC(  28,  16, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_MC_RPF_EVLAN_E),
    PRV_CPSS_FIELD_MAC(  28,   6, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_MC_RPF_EVLAN_MRST_INDEX_E),
    PRV_CPSS_FIELD_MAC(  0,    0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_RESERVED_28_34_E),
    PRV_CPSS_FIELD_MAC(  0,    0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_RESERVED_35_47_E),
    PRV_CPSS_FIELD_MAC(  51,   3, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_MULTICAST_INGRESS_VLAN_CHECK_FAIL_CMD_E),
    PRV_CPSS_FIELD_MAC(  54,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_MULTICAST_RPF_FAIL_CMD_MODE_E),
    PRV_CPSS_FIELD_MAC(  0,   0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_RESERVED_52_E),
    PRV_CPSS_FIELD_MAC(  55,  18, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_INTERNAL_MLL_PTR_E),
    PRV_CPSS_FIELD_MAC(  0,   0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_EXTERNAL_MLL_PTR_MSB_BITS_15_13_E),
    PRV_CPSS_FIELD_MAC(  0,   0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_RESERVED_72_74_E),
    PRV_CPSS_FIELD_MAC(  78,   2, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_MULTICAST_INGRESS_VLAN_CHECK_E),
    PRV_CPSS_FIELD_MAC(  80,   18, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_EXTERNAL_MLL_PTR_E),
    PRV_CPSS_FIELD_MAC(  0,    0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_IPV6_MULTICAST_RESERVED_90_E),
    PRV_CPSS_FIELD_MAC( 106,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_IPV6_MULTICAST_DEST_SITE_ID_E),
    PRV_CPSS_FIELD_MAC( 107,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_IPV6_MULTICAST_SCOPE_CHECK_EN_E),
    PRV_CPSS_FIELD_MAC(  12,  12, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_NEXT_HOP_VID1_E),
    PRV_CPSS_FIELD_MAC(  0,   0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_RESERVED_21_E),
    PRV_CPSS_FIELD_MAC(  28,  16, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_NEXT_HOP_EVLAN_E),
    PRV_CPSS_FIELD_MAC(  44,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_USE_VIDX_E),
    PRV_CPSS_FIELD_MAC(  45,  17, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_EVIDX_E),
    PRV_CPSS_FIELD_MAC(  0,   0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_RESERVED_52_59_E),
    PRV_CPSS_FIELD_MAC(  45,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TARGET_IS_TRUNK_E),
    PRV_CPSS_FIELD_MAC(  47,  15, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TRG_EPORT_E),
    PRV_CPSS_FIELD_MAC(  62,  10, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TRG_DEV_E),
    PRV_CPSS_FIELD_MAC(  46,  12, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TRG_TRUNK_ID_E),
    PRV_CPSS_FIELD_MAC(  0,  0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_RESERVED_49_59_E),
    PRV_CPSS_FIELD_MAC(  72,   6, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_DIP_ACCESS_LEVEL_E),
    PRV_CPSS_FIELD_MAC(  78,   6, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_SIP_ACCESS_LEVEL_E),
    PRV_CPSS_FIELD_MAC(  84,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_START_OF_TUNNEL_E),
    PRV_CPSS_FIELD_MAC(  85,  20, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_ARP_PTR_E),
    PRV_CPSS_FIELD_MAC(  85,  19, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TUNNEL_PTR_E),
    PRV_CPSS_FIELD_MAC(  0,   0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_RESERVED_88_E),
    PRV_CPSS_FIELD_MAC(  104,  1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_UNICAST_TS_IS_NAT_E),
    PRV_CPSS_FIELD_MAC(  105,  1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_UNICAST_TUNNEL_TYPE_E),
    PRV_CPSS_FIELD_MAC(  106,  1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_UNICAST_DEST_SITE_ID_E),
    PRV_CPSS_FIELD_MAC(  107,  1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_UNICAST_SCOPE_CHECK_EN_E),
    PRV_CPSS_FIELD_MAC(  108,  3, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_COUNTER_SET_INDEX_E),
    PRV_CPSS_FIELD_MAC(  111,  3, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_MTU_INDEX_E),
    PRV_CPSS_FIELD_MAC(  114,  1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_ARP_BC_TRAP_MIRROR_EN_E),
    PRV_CPSS_FIELD_MAC(  115,  1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_APP_SPECIFIC_CPU_CODE_EN_E),
    PRV_CPSS_FIELD_MAC(  0,   0, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_RESERVED_101_E),
    PRV_CPSS_FIELD_MAC( 116,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_SIP_FILTER_EN_E),
    PRV_CPSS_FIELD_MAC( 117,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_DEC_TTL_OR_HOP_COUNT_E),
    PRV_CPSS_FIELD_MAC( 118,   1, SIP5_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_ICMP_REDIRECT_EXCEP_MIRROR_E),
    PRV_CPSS_FIELD_MAC(  12,  16, SIP6_10_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TARGET_EPG_E),
    PRV_CPSS_FIELD_MAC(  46,   1, SIP7_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TARGET_IS_VPORT_E),
    PRV_CPSS_FIELD_MAC(  47,  18, SIP7_IPVX_ROUTER_NEXTHOP_TABLE_FIELDS_TARGET_VPORT_E),
    PRV_CPSS_FIELD_MAC(  128,  1, SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_NHE_ROW_MODE),
    PRV_CPSS_FIELD_MAC(  0,    8, SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_0_MODE),
    PRV_CPSS_FIELD_MAC(  8,    18,SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_0_MODE),
    PRV_CPSS_FIELD_MAC(  26,   8, SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_1_MODE),
    PRV_CPSS_FIELD_MAC(  34,   18,SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_1_MODE),
    PRV_CPSS_FIELD_MAC(  52,   8, SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_2_MODE),
    PRV_CPSS_FIELD_MAC(  60,   18,SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_2_MODE),
    PRV_CPSS_FIELD_MAC(  78,   8, SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_PROFILE_NUMBER_3_MODE),
    PRV_CPSS_FIELD_MAC(  86,   18,SIP7_IPVX_NEXT_HOP_TABLE_FIELDS_L3NHE_ENTRY_TERGET_VPORT_3_MODE)
};
...
static const PRV_CPSS_ENTRY_FORMAT_TABLE_STC prvCpssDxChSip5OamTableFieldsFormat[SIP5_OAM_TABLE_FIELDS___LAST_VALUE___E] =
{
    ...
    PRV_CPSS_FIELD_MAC(  23,  12, SIP5_OAM_TABLE_FIELDS_FLOW_HASH_E                                ),
    PRV_CPSS_FIELD_MAC(  35,   7, SIP5_OAM_TABLE_FIELDS_OAM_PTP_OFFSET_INDEX_E                     ),
    PRV_CPSS_FIELD_MAC(  42,   1, SIP5_OAM_TABLE_FIELDS_TIMESTAMP_ENABLE_E                         ),
    PRV_CPSS_FIELD_MAC(  43,   3, SIP5_OAM_TABLE_FIELDS_PACKET_COMMAND_PROFILE_E                   ),
    PRV_CPSS_FIELD_MAC(  46,   2, SIP5_OAM_TABLE_FIELDS_CPU_CODE_OFFSET_E                          ),
    PRV_CPSS_FIELD_MAC(  48,   1, SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_CHECK_ENABLE_E            ),
    PRV_CPSS_FIELD_MAC(  49,   1, SIP5_OAM_TABLE_FIELDS_SOURCE_IS_TRUNK_E                          ),
    PRV_CPSS_FIELD_MAC(  50,   1, SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_CHECK_MODE_E              ),
    PRV_CPSS_FIELD_MAC(  51,  17, SIP5_OAM_TABLE_FIELDS_ORIG_DEV_SRC_EPORT_OR_ORIG_DEV_SRC_TRUNK_E ),
    PRV_CPSS_FIELD_MAC(  68,   1, SIP5_OAM_TABLE_FIELDS_ENABLE_PROTECTION_LOC_UPDATE_E             ),
    PRV_CPSS_FIELD_MAC(  69,   1, SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_DETECTION_ENABLE_E        ),
    PRV_CPSS_FIELD_MAC(  70,   4, SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_PERIOD_COUNTER_E          ),
    PRV_CPSS_FIELD_MAC(  74,   4, SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_PERIOD_THRESHOLD_E        ),
    PRV_CPSS_FIELD_MAC(  78,   3, SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_MESSAGE_COUNTER_E         ),
    PRV_CPSS_FIELD_MAC(  81,   3, SIP5_OAM_TABLE_FIELDS_EXCESS_KEEPALIVE_MESSAGE_THRESHOLD_E       ),
    PRV_CPSS_FIELD_MAC(  84,   1, SIP5_OAM_TABLE_FIELDS_RDI_CHECK_ENABLE_E                         ),
    PRV_CPSS_FIELD_MAC(  85,   1, SIP5_OAM_TABLE_FIELDS_RDI_STATUS_E                               ),
    PRV_CPSS_FIELD_MAC(  86,   1, SIP5_OAM_TABLE_FIELDS_PERIOD_CHECK_ENABLE_E                      ),
    PRV_CPSS_FIELD_MAC(  87,   3, SIP5_OAM_TABLE_FIELDS_KEEPALIVE_TX_PERIOD_FIELD_E                ),
    PRV_CPSS_FIELD_MAC(  90,   1, SIP5_OAM_TABLE_FIELDS_PROTECTION_ON_RDI_ENABLE_E                 ),
    PRV_CPSS_FIELD_MAC(  91,   1, SIP5_OAM_TABLE_FIELDS_PROTECTION_RDI_STATE_E                     ),
    PRV_CPSS_FIELD_MAC(  92,   1, SIP5_OAM_TABLE_FIELDS_IGNORE_BAD_KEEPALIVE_IN_AGING_EN_E         ),
    PRV_CPSS_FIELD_MAC(  93,   1, SIP5_OAM_TABLE_FIELDS_LOC_DETECTION_ENABLE_E                     ),
    PRV_CPSS_FIELD_MAC(  94,   1, SIP5_OAM_TABLE_FIELDS_TX_PERIOD_STORM_SUPPRESS_EN_E              ),
    PRV_CPSS_FIELD_MAC(  95,   1, SIP5_OAM_TABLE_FIELDS_INVALID_HASH_KEEPALIVE_STORM_SUPPRESS_EN_E ),
    PRV_CPSS_FIELD_MAC(  96,   1, SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_STORM_SUPPRESS_EN_E       ),
    PRV_CPSS_FIELD_MAC(  97,   1, SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_STORM_SUPPRESS_EN_E              ),
    PRV_CPSS_FIELD_MAC(  98,   1, SIP5_OAM_TABLE_FIELDS_KEEPALIVE_AGING_STORM_SUPPRESS_EN_E        ),
    PRV_CPSS_FIELD_MAC(  99,   1, SIP5_OAM_TABLE_FIELDS_HASH_VERIFICATION_STATUS_E                 ),
    PRV_CPSS_FIELD_MAC( 100,   1, SIP5_OAM_TABLE_FIELDS_TX_PERIOD_STATUS_E                         ),
    PRV_CPSS_FIELD_MAC( 101,   1, SIP5_OAM_TABLE_FIELDS_SOURCE_INTERFACE_STATUS_E                  ),
    PRV_CPSS_FIELD_MAC( 102,   1, SIP5_OAM_TABLE_FIELDS_MEG_LEVEL_STATUS_E                         ),
    PRV_CPSS_FIELD_MAC( 103,   1, SIP5_OAM_TABLE_FIELDS_KEEPALIVE_AGING_STATUS_E                   ),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_OAM_TABLE_FIELDS_KEEPALIVE_RECOVERY_IRQ_EN_E                ),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_OAM_TABLE_FIELDS_SRC_IS_VPORT_E                             ),
    PRV_CPSS_FIELD_MAC(   0,   0, SIP7_OAM_TABLE_FIELDS_SRC_VPORT_E                                )
};
...
static GT_STATUS aasInitTable(GT_U8 devNum);
...
)
{
    ...
    switch(tableType)
    {
        ...
        case CPSS_DXCH_SIP5_TABLE_L2_MLL_E:
            ...
            break;
        case CPSS_DXCH_SIP7_TABLE_IP_MLL_BIER_E:
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_IP_MLL_BIER_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_L2_MLL_BIER_E:
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_L2_MLL_BIER_E;
            break;
        ...
        case CPSS_DXCH_SIP5_TABLE_EGRESS_OAM_E:
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_OAM_E;
            break;
        ...
        /* SIP7 EXACT MATCH */
        case CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_1_E:
        case CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_2_E:
        case CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_3_E:
        case CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_4_E:
        case CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_5_E:
        case CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_6_E:
        case CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_7_E:
        case CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_REDUCED_E:
        ...
        case CPSS_DXCH_SIP6_30_TABLE_SMU_IRF_COUNTING_E   :
            ...
            break;
        case CPSS_DXCH_SIP6_30_TABLE_SMU_SGC_TABLE_SET_TIME_CONFIGURATIONS_E:
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_SMU_SGC_TABLE_SET_TIME_CONFIGURATIONS_E;
            break;
        case CPSS_DXCH_SIP6_30_TABLE_SMU_SGC_TIME_SLOT_ATTRIBUTES_E:
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_SMU_SGC_TIME_SLOT_ATTRIBUTES_E;
            break;
        ...
        case CPSS_DXCH_SIP7_TABLE_HA_SRC_EPORT_1_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_HA_SRC_EPORT_1_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_HA_SRC_EPORT_2_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_HA_SRC_EPORT_2_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_HA_SRC_PHYSICAL_PORT_2_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_HA_SRC_PHYSICAL_PORT_2_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_HA_TARGET_CIRCUITS_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_HA_TARGET_CIRCUITS_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_HA_ANALYZERS_TARGET_CIRCUITS_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_HA_ANALYZERS_TARGET_CIRCUITS_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_HA_QUEUE_MAPPING_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_HA_QUEUE_MAPPING_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_HA_QOS_MAPPING_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_HA_QOS_MAPPING_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_HA_HEADER_FIELDS_0_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_HA_HEADER_FIELDS_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_HA_HEADER_FIELDS_1_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_HA_HEADER_FIELDS_E;
            break;
        case CPSS_DXCH_SIP7_TABLE_IPVX_ROUTER_L3NHE_PROFILE_E    :
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_IPVX_ROUTER_L3NHE_PROFILE_E;
            break;
            /* Sip 7 : IPE */
        case CPSS_DXCH_SIP7_TABLE_IPE_STATE_ADDRESS_PROFILE_E   :
             tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_IPE_STATE_ADDRESS_PROFILE_E;
            break;
            /* Sip 7 : PPU for IPE */
        case CPSS_DXCH_SIP7_TABLE_PPU_FOR_IPE_ACTION_TABLE_0_E:
        case CPSS_DXCH_SIP7_TABLE_PPU_FOR_IPE_ACTION_TABLE_1_E:
        case CPSS_DXCH_SIP7_TABLE_PPU_FOR_IPE_ACTION_TABLE_2_E:
        case CPSS_DXCH_SIP7_TABLE_PPU_FOR_IPE_ACTION_TABLE_3_E:
            tableFormat = PRV_CPSS_DXCH_TABLE_FORMAT_PPU_FOR_IPE_ACTION_E;
            break;
        case CPSS_DXCH_SIP7_EGF_QAG_QUEUE_MAP_TABLE_E:
            tableFormat =  PRV_CPSS_DXCH_TABLE_FORMAT_EGF_QAG_QUEUE_MAP_E;
            break;
        default:
            return NULL;
    }
...
)
{
    ...
    if (PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(dxChXcat3TablesInfoPtr))
    {
    ...
    PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_SET(dxChXcat3TablesInfoPtr, tableInfoPtr);
...
#define GET_TEMP_TABLES_PER_FAMILY_ARR  \
    PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(tempTablesPerFamilyArr)

#define GET_INIT_TABLES_PER_FAMILY_ARR  \
    PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(tablesDbInitPreFamily)
...
)
{
    ...
    CPSS_PP_FAMILY_TYPE_ENT             devFamily; /* family of devices */
    GT_STATUS   rc = GT_OK;
    ...
    switch(devFamily)
    {
        ...
        case CPSS_PP_FAMILY_DXCH_XCAT3_E:
            ...
            accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(dxChXcat3TablesInfoPtr);
        ...
        case CPSS_PP_FAMILY_DXCH_LION2_E:
            ...
            accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(lion2TablesInfoPtr);
        ...
        case CPSS_PP_FAMILY_DXCH_BOBCAT3_E:
            ...
            accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat3TablesInfoPtr);
        ...
        case CPSS_PP_FAMILY_DXCH_ALDRIN2_E:
            ...
            accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(aldrin2TablesInfoPtr);
        ...
        case CPSS_PP_FAMILY_DXCH_FALCON_E:
            ...
            accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(falconTablesInfoPtr);
        ...
        case CPSS_PP_FAMILY_DXCH_AC5P_E:
            ...
            accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(hawkTablesInfoPtr);
        ...
        case CPSS_PP_FAMILY_DXCH_AC5X_E:
            ...
            accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(phoenixTablesInfoPtr);
        ...
        case CPSS_PP_FAMILY_DXCH_HARRIER_E:
            ...
            accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(harrierTablesInfoPtr);
        ...
        case CPSS_PP_FAMILY_DXCH_BOBCAT2_E:
            if (PRV_CPSS_PP_MAC(devNum)->devSubFamily == CPSS_PP_SUB_FAMILY_BOBCAT2_BOBK_E)
            {
                ...
                accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr);
            ...
            else
            {
                ...
                accessTableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat2TablesInfoPtr);
        ...
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            ...
            accessTableInfoPtr  = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(ironman_L_TablesInfoPtr);
            accessTableInfoSize = ironman_L_TableInfoSize;
            break;
        case CPSS_PP_FAMILY_DXCH_AAS_E:
            rc = aasInitTable(devNum);
            if (rc != GT_OK)
            {
                return rc;
            }
            accessTableInfoPtr  = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(aas_TablesInfoPtr);
            accessTableInfoSize = aas_TableInfoSize;
            break;
        default:
    ...
    PRV_CPSS_ACCESS_TABLE_INFO_PTR(devNum) = accessTableInfoPtr;
    PRV_CPSS_DXCH_PP_MAC(devNum)->accessTableInfoSize = accessTableInfoSize;

    SET_TABLES_DB_DONE_MAC(devFamily);
...
)
{
    ...
    fieldLength = 32;
    tableInfoPtr = &(PRV_CPSS_ACCESS_TABLE_INFO_PTR(devNum)[tableType]);
...
)
{
    ...
    if (PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(lion2TablesInfoPtr))
    {
        /* table is already set */
        return GT_OK;
    }
    ...
    PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_SET(lion2TablesInfoPtr, sharedTableInfoPtr);
...
)
{
    ...
    if (PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat2TablesInfoPtr) == NULL)
    {
        rc = allocTableInfo(bobcat2TableInfoSize,
            &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat2TablesInfoPtr),
            directAccessBobcat2TableInfoSize,
            &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat2TableInfoPtr));
        if(rc != GT_OK)
        {
            return rc;
        }

        {
            ...
            /* allocate shared global table */
            tableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat2TableInfoPtr);
...

        {
            ...
            /* allocate shared global table */
            tableInfoPtr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat2TablesInfoPtr);
            ...
            for(ii = 0; (ii < bobcat2TableInfoSize); ii++)
            {
                    ...
                    && ((const GT_CHAR*)(tableInfoPtr[ii].readTablePtr) < endPtr))
                {
                    tableInfoPtr[ii].readTablePtr = (GT_VOID*)
                        ((const GT_CHAR*)PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat2TableInfoPtr)
    ...
    if (PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat2B0TablesInfo_overrideA0Ptr) == NULL)
    {
        ...
        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_SET(bobcat2B0TablesInfo_overrideA0Ptr, tableInfoPtr);
...
)
{
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr,
            ...
            prvCpssDxChSip7TtiDefaultEportTableFieldsFormat);
    }
    else
    {
        BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr,
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr ,
            ...
            prvCpssDxChSip7TtiEportAttributesTableFieldsFormat);
    }
    else
    {
        BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr ,
    ...
    BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr ,
        ...
        prvCpssDxChSip5OamTableFieldsFormat);
    ...
    else
    {
        ...
        if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr,
                ...
                prvCpssDxChSip7HaTunnelStartTableFieldsFormat);

            BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr,
                PRV_CPSS_DXCH_TABLE_FORMAT_GENERIC_TUNNEL_START_E,
                prvCpssDxChSip7HaTunnelStartGenericTableFieldsFormat);

            BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr ,
                PRV_CPSS_DXCH_TABLE_FORMAT_HA_GENERIC_TS_PROFILE_E ,
                prvCpssDxChSip7HaGenTunnelStartProfileTableFieldsFormat);
        }
        else
        {
            BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr ,
        ...
        if(PRV_CPSS_SIP_5_20_CHECK_MAC(devNum))
        {
            ...
            if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr ,
                PRV_CPSS_DXCH_TABLE_FORMAT_IPVX_ROUTER_NEXT_HOP_E ,
                prvCpssDxChSip7IpvxRouterNextHopTableFieldsFormat);
            }
            else
            {
                BIND_FIELDS_FORMAT_TO_TABLE_MAC(initTablesFormatPtr ,
...
)
{
    ...
    if (PRV_CPSS_SIP_5_15_CHECK_MAC(devNum))
    {
        if (PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr) == NULL)
        {
            rc = allocTableInfo(bobkTableInfoSize,
                &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr),
                directAccessBobkTableInfoSize,
                &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobkTableInfoPtr));
            if(rc != GT_OK)
            {
                return rc;
            }
    ...
    if (PRV_CPSS_SIP_5_10_CHECK_MAC(devNum))
    {
            ...
            ii++)
        {
            ...
            /* override the direct access info with B0 specifics */
            PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(
        ...
        for(ii = 0;
            ...
            ii++)
        {
            globalIndex = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat2B0TablesInfo_overrideA0Ptr)[ii].globalIndex;
            ...
            /* override the direct access info with B0 specifics */
            PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat2TablesInfoPtr)[localIndex] =
                PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat2B0TablesInfo_overrideA0Ptr)[ii].tableInfo;
        }
    }
...
)
{
    ...
    PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[ii].maxNumOfEntries =
        BOBK_NUM_IPLR_METERS_MAC;
    PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[ii].entrySize =
    ...
    PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[ii].maxNumOfEntries = 0;
    PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[ii].entrySize =
        BITS_TO_WORDS_MAC(BOBK_POLICER_METERING_CONFIG_BITS_SIZE_CNS);
...
)
{
    ...
    if (PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobkTableInfo_initDone) == GT_TRUE)
    {
    ...
    PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobkTableInfo_initDone) = GT_TRUE;
        ...
        ii++)
    {
        ...
        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[ii] =
            PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat2TablesInfoPtr)[ii];
    }
        ...
        ii++)
    {
        ...
        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobkTableInfoPtr)[ii] =
            PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat2TableInfoPtr)[ii];
    }
        ...
        ii++)
    {
        ...
        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobkTableInfoPtr)[localIndex] =
            directAccessBobkTableInfo_new[ii].directAccessInfo;

        /* bind 'direct table info' to the 'table info' */
        globalIndex =
            PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobkTableInfoPtr)[localIndex].globalIndex;

        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[globalIndex].readAccessType =
        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[globalIndex].writeAccessType =
            PRV_CPSS_DXCH_DIRECT_ACCESS_E;
        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[globalIndex].readTablePtr =
        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[globalIndex].writeTablePtr =
            &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobkTableInfoPtr)[
    ...
    {
        tableInfoPtr = &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[ii];
           ...
           tableInfoPtr->readTablePtr != NULL)
        {
            ...
            if(directAccessPtr >=
               &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat2TableInfoPtr)[0] &&
               directAccessPtr <=
               &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat2TableInfoPtr)[
                    lastIndexIn_directAccessBobcat2TableInfo+1])
            {
                offsetIn_directAccessBobcat2TableInfo =
                    (GT_U32)((GT_CHAR*)directAccessPtr -
                             (GT_CHAR*)PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat2TableInfoPtr));
           ...
           tableInfoPtr->writeTablePtr != NULL)
        {
            ...
            if(directAccessPtr >= &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat2TableInfoPtr)[0] &&
               directAccessPtr <= &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat2TableInfoPtr)[
                    lastIndexIn_directAccessBobcat2TableInfo+1])
            {
                offsetIn_directAccessBobcat2TableInfo =
                    (GT_U32)((GT_CHAR*)directAccessPtr -
        ...
        ii++)
    {
        ...
        /* override the direct access info with bobk specifics */
        tblInfoPtr = &PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobkTablesInfoPtr)[localIndex];
        ...
        ii++)
    {
        ...
        for(jj = 0 ;
            ...
            jj++)
        {
            if (PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobkTableInfoPtr)[
                jj].globalIndex == globalIndex)
            {
                    ...
                    directAccessBobkTableInfo_overrideBobcat2[ii].directAccessInfo.baseAddress)
                {
                    ...
                    baseAddr = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobkTableInfoPtr)[
...
)
{
    ...
    CPSS_PP_FAMILY_TYPE_ENT devFamily; /* family of device */

    devFamily = PRV_CPSS_PP_MAC(devNum)->devFamily;

    /* array size check */
    if (devFamily >= CPSS_PP_FAMILY_END_DXCH_E)
    {
        /* should never happen */
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_FAIL, LOG_ERROR_NO_MSG);
    }

    if(GET_TABLES_DB_DONE_MAC(devFamily))
    {
...
)
{
    ...
    if(!tablesInfoArr)
    {
        ...
        {
            PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(bobcat3TablesInfoPtr)            = tablesInfoArr;
            PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(directAccessBobcat3TableInfoPtr) = directAccessTableInfoArr;
        }
    }
...
)
{
    ...
    if(!tablesInfoArr)
    {
        ...
        {
            PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(aldrin2TablesInfoPtr)            = tablesInfoArr;
            PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(aldrin2directAccessTableInfoPtr) = directAccessTableInfoArr;
        }
    }
...
/* declarations of tables and sizes from templates Tables Info DBs */
extern const PRV_CPSS_DXCH_TABLES_INFO_EXT_STC prvCpssDxChFalcon_tablesInfoArr[];
extern const GT_U32 prvCpssDxChFalcon_tablesInfoArrSize;
extern const PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC prvCpssDxChFalcon_directInfoArr[];
extern const GT_U32 prvCpssDxChFalcon_directInfoArrSize;

extern const PRV_CPSS_DXCH_TABLES_INFO_EXT_STC prvCpssDxChAc5p_tablesInfoArr[];
extern const GT_U32 prvCpssDxChAc5p_tablesInfoArrSize;
extern const PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC prvCpssDxChAc5p_directInfoArr[];
extern const GT_U32 prvCpssDxChAc5p_directInfoArrSize;

extern const PRV_CPSS_DXCH_TABLES_INFO_EXT_STC prvCpssDxChAc5x_tablesInfoArr[];
extern const GT_U32 prvCpssDxChAc5x_tablesInfoArrSize;
extern const PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC prvCpssDxChAc5x_directInfoArr[];
extern const GT_U32 prvCpssDxChAc5x_directInfoArrSize;

extern const PRV_CPSS_DXCH_TABLES_INFO_EXT_STC prvCpssDxChHarrier_tablesInfoArr[];
extern const GT_U32 prvCpssDxChHarrier_tablesInfoArrSize;
extern const PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC prvCpssDxChHarrier_directInfoArr[];
extern const GT_U32 prvCpssDxChHarrier_directInfoArrSize;

extern const PRV_CPSS_DXCH_TABLES_INFO_EXT_STC prvCpssDxChIronMan_tablesInfoArr[];
extern const GT_U32 prvCpssDxChIronMan_tablesInfoArrSize;
extern const PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC prvCpssDxChIronMan_directInfoArr[];
extern const GT_U32 prvCpssDxChIronMan_directInfoArrSize;

extern const PRV_CPSS_DXCH_TABLES_INFO_EXT_STC prvCpssDxChAas_tablesInfoArr[];
extern const GT_U32 prvCpssDxChAas_tablesInfoArrSize;
extern const PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC prvCpssDxChAas_directInfoArr[];
extern const GT_U32 prvCpssDxChAas_directInfoArrSize;

/**
* @internal tableInfoFromTemplateInit function
* @endinternal
*
* @brief   allocate and init tables info DB
*
* @param[in] tableInfoEntriesNum - number of entries in output DB
* @param[in] templateTablesInfoArray - input template with tables info
* @param[in] templateTablesInfoSize - number of entries in templateTablesInfoArray
* @param[in] templateDirectInfoArray - input template with direct access info
* @param[in] templateDirectInfoSize - number of entries in direct access info
*
* @retval - pointer to DB or NULL
*/
static PRV_CPSS_DXCH_TABLES_INFO_STC* tableInfoFromTemplateInit
(
     IN GT_U32 tableInfoEntriesNum,
     IN const PRV_CPSS_DXCH_TABLES_INFO_EXT_STC templateTablesInfoArray[],
     IN GT_U32 templateTablesInfoSize,
     IN const PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC templateDirectInfoArray[],
     IN GT_U32 templateDirectInfoSize
)
{
    GT_U32                          tablesInfoSize;  /* size of tables info in bytes */
    GT_U32                          directInfoSize;  /* size of direct info in bytes */
    GT_U32                          ii;             /* iterator */
    PRV_CPSS_DXCH_TABLES_INFO_STC*  tablesInfoArr;  /* pointer to allocated tables info */
    PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC* directInfoArr; /* pointer to allocated direct info */
    GT_UINTPTR                      directTemplateBasePtr; /* base address of direct info in template */
    GT_UINTPTR                      directDbBasePtr;       /* base address of direct info in DB */
    PRV_CPSS_DXCH_TABLES_INFO_STC*  tablesEntryPtr;  /* pointer to entry in DB */

    /* make single allocation for both Table Info and Direct Info */
    tablesInfoSize = tableInfoEntriesNum * sizeof(PRV_CPSS_DXCH_TABLES_INFO_STC);
    directInfoSize = templateDirectInfoSize * sizeof(PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC);

    tablesInfoArr = cpssOsMalloc(tablesInfoSize + directInfoSize);
    if (tablesInfoArr == NULL)
    {
        return tablesInfoArr;
    }

    /* direct info array is after tables info one */
    directInfoArr = (PRV_CPSS_DXCH_TABLES_INFO_DIRECT_STC* )(tablesInfoArr + tableInfoEntriesNum);
    directDbBasePtr = (GT_UINTPTR)directInfoArr;
    directTemplateBasePtr = (GT_UINTPTR)templateDirectInfoArray;

    /* init table info */
    for(ii = 0; ii < tableInfoEntriesNum; ii++)
    {
        tablesInfoArr[ii].maxNumOfEntries = 0;
    }

    /* copy direct info from template to DB */
    for(ii = 0; ii < templateDirectInfoSize; ii++)
    {
        directInfoArr[ii] = templateDirectInfoArray[ii];
    }

    for (ii = 0; ii < templateTablesInfoSize; ii++)
    {
        /* pointer on final DB entry */
        tablesEntryPtr = tablesInfoArr +  templateTablesInfoArray[ii].globalIndex;

        /* copy context */
        *tablesEntryPtr = templateTablesInfoArray[ii].tableInfo;

        /* fix direct or indirect entry pointer to be in DB Direct info table but not in
           template one */
        if (tablesEntryPtr->readAccessType == PRV_CPSS_DXCH_DIRECT_ACCESS_E)
        {
            /* We wish to initialize at runtime inorded not to use indexing at macro.
             So we assume that  prvCpssDxChAas_tablesInfoArr and  prvCpssDxChAas_directInfoArr
             are added at the same order so
             prvCpssDxChAas_tablesInfoArr[i]->readTablePtr = prvCpssDxChAas_directInfoArr[i]
            */
            if(NULL==tablesEntryPtr->readTablePtr )
            {
                tablesEntryPtr->readTablePtr  = templateDirectInfoArray+ii;
            }

            tablesEntryPtr->readTablePtr  = (GT_VOID *)((GT_UINTPTR)tablesEntryPtr->readTablePtr -
                                              directTemplateBasePtr + directDbBasePtr);
            tablesEntryPtr->writeTablePtr = tablesEntryPtr->readTablePtr;
        }
    }
...
{
    GT_STATUS                       rc;            /* return code */
    PRV_CPSS_DXCH_TABLES_INFO_STC*  tablesInfoArr; /* pointer to DB in Global Shared DB */
    ...
    tablesInfoArr            = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(falconTablesInfoPtr);

    if(!tablesInfoArr)
    {
        tablesInfoArr = tableInfoFromTemplateInit(falconTableInfoSize,
                                                  prvCpssDxChFalcon_tablesInfoArr,
                                                  prvCpssDxChFalcon_tablesInfoArrSize,
                                                  prvCpssDxChFalcon_directInfoArr,
                                                  prvCpssDxChFalcon_directInfoArrSize);
        if (tablesInfoArr == NULL)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_CPU_MEM, LOG_ERROR_NO_MSG);
        }

        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(falconTablesInfoPtr) = tablesInfoArr;
    }
...
)
{
    ...
    tablesInfoArr            = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(hawkTablesInfoPtr);

    if(!tablesInfoArr)
    {
        tablesInfoArr = tableInfoFromTemplateInit(hawkTableInfoSize,
                                                  prvCpssDxChAc5p_tablesInfoArr,
                                                  prvCpssDxChAc5p_tablesInfoArrSize,
                                                  prvCpssDxChAc5p_directInfoArr,
                                                  prvCpssDxChAc5p_directInfoArrSize);
        if (tablesInfoArr == NULL)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_CPU_MEM, LOG_ERROR_NO_MSG);
        }

        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(hawkTablesInfoPtr) = tablesInfoArr;
    }
...
)
{
    ...
    tablesInfoArr            = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(phoenixTablesInfoPtr);

    if(!tablesInfoArr)
    {
        tablesInfoArr = tableInfoFromTemplateInit(phoenixTableInfoSize,
                                                  prvCpssDxChAc5x_tablesInfoArr,
                                                  prvCpssDxChAc5x_tablesInfoArrSize,
                                                  prvCpssDxChAc5x_directInfoArr,
                                                  prvCpssDxChAc5x_directInfoArrSize);
        if (tablesInfoArr == NULL)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_CPU_MEM, LOG_ERROR_NO_MSG);
        }

        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(phoenixTablesInfoPtr) = tablesInfoArr;
    }
...
)
{
    ...
    tablesInfoArr            = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(harrierTablesInfoPtr);

    if(!tablesInfoArr)
    {
        tablesInfoArr = tableInfoFromTemplateInit(harrierTableInfoSize,
                                                  prvCpssDxChHarrier_tablesInfoArr,
                                                  prvCpssDxChHarrier_tablesInfoArrSize,
                                                  prvCpssDxChHarrier_directInfoArr,
                                                  prvCpssDxChHarrier_directInfoArrSize);
        if (tablesInfoArr == NULL)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_CPU_MEM, LOG_ERROR_NO_MSG);
        }

        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(harrierTablesInfoPtr) = tablesInfoArr;
    }
...
)
{
    ...
    tablesInfoArr            = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(ironman_L_TablesInfoPtr);


    if(!tablesInfoArr)
    {
        tablesInfoArr = tableInfoFromTemplateInit(ironman_L_TableInfoSize,
                                                  prvCpssDxChIronMan_tablesInfoArr,
                                                  prvCpssDxChIronMan_tablesInfoArrSize,
                                                  prvCpssDxChIronMan_directInfoArr,
                                                  prvCpssDxChIronMan_directInfoArrSize);
        if (tablesInfoArr == NULL)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_CPU_MEM, LOG_ERROR_NO_MSG);
        }

        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(ironman_L_TablesInfoPtr) = tablesInfoArr;
    }
...
/**
* @internal prvCpssCheckDuplications function
* @endinternal
*
* @brief  This function verify that each entry contain unique globalIndex.
*
...
*
* @param[in] arrPtr                   - Array of tables.
* @param[in] size                     - Size of array
* @param[out] duplicationIndexPtr      - (Pointer to) global index that appear more than once.
*
* return GT_TRUE in case each entry has unique globalIndex ,GT_FALSE otherwise
*
*/
static GT_BOOL prvCpssCheckDuplications
(
    IN  const PRV_CPSS_DXCH_TABLES_INFO_EXT_STC * arrPtr,
    IN  const GT_U32 size,
    OUT GT_U32       *duplicationIndexPtr
)
{
    GT_U32 i,index;
    GT_BOOL exist[CPSS_DXCH_TABLE_LAST_E+1];

    cpssOsMemSet(exist,GT_FALSE,sizeof(GT_BOOL)*CPSS_DXCH_TABLE_LAST_E);

    for(i=0;i<size;i++)
    {
        index = arrPtr[i].globalIndex;

        if(GT_TRUE == exist[index])
        {
            *duplicationIndexPtr = index;
            return GT_FALSE;
        }
...
/**
* @internal aasInitTable function
* @endinternal
*
* @brief   init the AAS tables info
*
* @param[in] devNum                   - device number
*                                       NONE
*/
static GT_STATUS aasInitTable
(
     IN GT_U8 devNum
)
{
    ...
    rc = initTablesDbSip7(devNum);
    if(rc != GT_OK)
    {
        return rc;
    }

    tablesInfoArr            = PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(aas_TablesInfoPtr);


    if(!tablesInfoArr)
    {
        if(GT_FALSE == prvCpssCheckDuplications(prvCpssDxChAas_tablesInfoArr,prvCpssDxChAas_tablesInfoArrSize,&duplicationIndex))
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_FAIL, "prvCpssDxChAas_tablesInfoArr contain table %d more than once.",duplicationIndex);
        }

        tablesInfoArr = tableInfoFromTemplateInit(aas_TableInfoSize,
                                                  prvCpssDxChAas_tablesInfoArr,
                                                  prvCpssDxChAas_tablesInfoArrSize,
                                                  prvCpssDxChAas_directInfoArr,
                                                  prvCpssDxChAas_directInfoArrSize);
        if (tablesInfoArr == NULL)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_CPU_MEM, LOG_ERROR_NO_MSG);
        }

        PRV_NON_SHARED_HW_INIT_TABLES_DB_VAR_GET(aas_TablesInfoPtr) = tablesInfoArr;
    }
    ...
    *portGroupIdPtr = CPSS_PORT_GROUP_UNAWARE_MODE_CNS;
    ...
    switch(tableType)
    {
        case CPSS_DXCH_SIP5_TABLE_TCAM_PCL_TTI_ACTION_E:
            ...
            /* the CPSS APIs call CPSS_DXCH_SIP5_TABLE_TCAM_PCL_TTI_ACTION_E with index that
               was calculated for entry number = {floor_num[3:0], array_addr[7:0], bank[3:0]}

               but in sip7 : entry number = {floor_num[3:0], array_addr[7:0], bank[3:1]}
            */
            *updatedEntryIndexPtr = entryIndex >> 1;
            return;
        ...
        case CPSS_DXCH_TABLE_FDB_E:
            ...
            /* sip7 : direct uses same 'address calculation' as indirect for sip6/sip7 */
            {
...
)
{
    ...
    */
    ...
    if(PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryWriteFunc != NULL)
    {

       status = PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryWriteFunc(
    ...
    if(PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryWriteFunc != NULL)
    {
       ...
       PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryWriteFunc(
                                                  devNum, tmpPortGroupId,
                                                  tableType,
                                                  orig_entryIndex,
                                                  orig_entryValuePtr,
...
)
{
    ...
    if(PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryReadFunc != NULL)
    {
       status = PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryReadFunc(
    ...
    if ((status == GT_OK) && (readFromShadow == GT_TRUE))
    {
        status = prvCpssDxChPortGroupReadTableEntry_fromShadow(
            devNum, portGroupId, tableType, orig_entryIndex, entryValuePtr);
        if (status != GT_OK)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(
                status, "tableType[%d] read from shadow error , orig entry index[%d]", tableType, orig_entryIndex);
        }
    }
    ...
    if(PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryReadFunc != NULL)
    {
       PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryReadFunc(
                                                  devNum, tmpPortGroupId, tableType,
                                                  orig_entryIndex, entryValuePtr, originPortGroupId,
...
)
{
    ...
    /* Check if HW access required. */
    if(PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryFieldReadFunc != NULL)
    {
       status = PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryFieldReadFunc(
                                                  devNum, tmpPortGroupId, tableType,
    ...
    {
        status = prvCpssDxChPortGroupReadTableEntry_fromShadow(
            devNum, portGroupId, tableType, orig_entryIndex, entryMemoBufArr);
        if (status != GT_OK)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(
                status, "tableType[%d] read from shadow error , orig entry index[%d]", tableType, orig_entryIndex);
    ...
    if(PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryFieldReadFunc != NULL)
    {
       PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryFieldReadFunc(
                                                  devNum, tmpPortGroupId, tableType,
                                                  entryIndex, fieldWordNum, fieldOffset,
                                                  fieldLength,fieldValuePtr, originPortGroupId,
                                                  CPSS_DRV_HW_ACCESS_STAGE_POST_E, status);
...
)
{
    ...
    /* Check if HW access required. */
    if(PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryFieldWriteFunc != NULL)
    {
       status = PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryFieldWriteFunc(
                                                  devNum, tmpPortGroupId, tableType,
                                                  entryIndex, fieldWordNum, fieldOffset,
    ...
    if(PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryFieldWriteFunc != NULL)
    {
       PRV_NON_SHARED_REG_GLOBAL_TABLE_ACCESS_OBJECT.hwAccessTableEntryFieldWriteFunc(
                                                      devNum, tmpPortGroupId, tableType,
                                                      entryIndex, fieldWordNum, fieldOffset,
                                                      fieldLength,fieldValue, originPortGroupId,
                                                      CPSS_DRV_HW_ACCESS_STAGE_POST_E, status);
...
)
{
    ...
    switch(tableType)
    {
        ...
        case CPSS_DXCH_SIP5_TABLE_EQ_EPORT_TO_LOC_MAPPING_E:
            numBitsPerEntry = ( PRV_CPSS_SIP_7_CHECK_MAC(devNum)    ? 14 :
                                PRV_CPSS_SIP_6_30_CHECK_MAC(devNum) ?  7 :
                                PRV_CPSS_SIP_6_10_CHECK_MAC(devNum) ? 11 :
        ...
        case CPSS_DXCH_LION_TABLE_STG_INGRESS_E:
            ...
            {
                /* sip6_30 : ironman supports only 64 ports     */
                /* sip7 and above also support only single mode */
        ...
        case CPSS_DXCH_SIP5_TABLE_EGRESS_EGF_QAG_EGRESS_VLAN_E:
            ...
            if(PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
            {
                GT_U32  numPorts = 1 + PRV_CPSS_DXCH_MAX_PHY_PORT_NUMBER_MAC(devNum);
                /* there are 16 ports per line , each vlan hold x ports */
                numEntriesPerLine  = FRACTION_INDICATION_CNS | (numPorts / 16);
            }
            else
        ...
        case CPSS_DXCH_SIP5_25_TABLE_IPVX_ROUTER_ECMP_POINTER_E:
            ...
            {
                numBitsPerEntry   = 18;/* 18 bits per entry */
            }
            else
            {
        ...
        case CPSS_DXCH_SIP6_TABLE_IPVX_ECMP_E:
            ...
            if(PRV_CPSS_SIP_7_CHECK_MAC(devNum)==GT_TRUE)
            {
                numBitsPerEntry   = 32; /* 32 bits per entry */
            }
            else
            {
        ...
        case CPSS_DXCH_SIP6_TABLE_PBR_E:
            ...
            if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                numBitsPerEntry = 26;   /* 26 bits per entry */
            }
            else
            {
        ...
        case CPSS_DXCH_SIP5_TABLE_L2_MLL_E:
            ...
            numBitsPerEntry   = 185;/* 185 bits per entry */
            numEntriesPerLine = 4;  /* 4 entries in line */
            break;
        case CPSS_DXCH_SIP7_TABLE_IP_MLL_BIER_E:
        case CPSS_DXCH_SIP7_TABLE_L2_MLL_BIER_E:
            ...
            numBitsPerEntry   = 740;/* 740 bits per entry */
            numEntriesPerLine = 1;  /* 1 entries in line */
            break;
        default:
            return GT_FALSE;
    }
...
)
{
    ...
    */
    if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        /* since in SIP7 the read/write to the LPM MEM is done in indirect call mechanism
           we set the PBR base address to the same as the LPM base address
           the read/write to the correct place will be done by setting the bankId
           register to fit the PBR bank*/
        directTablePtr->baseAddress = prvCpssDxChHwUnitBaseAddrGet(devNum,PRV_CPSS_DXCH_UNIT_LPM_E,NULL);/* LPM baseline */
    }
    else
    {

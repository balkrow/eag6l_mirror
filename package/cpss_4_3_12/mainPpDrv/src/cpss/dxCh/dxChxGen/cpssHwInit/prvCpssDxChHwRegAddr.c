...
)
{
    ...
    {
        addrPtr->sdmaRegs.txSdmaSmallPacketReject = 0x000028F0;
    }
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_BOBCAT2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E |
...
/**
* @internal ac5CnmAddrDecoderInit function
* @endinternal
*
* @brief   This function initializes the Address Decoder registers struct for AC5 devices
*
* @note   APPLICABLE DEVICES:      AC5.
* @note   NOT APPLICABLE DEVICES:  xCat3; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
...
*
*/
static void ac5CnmAddrDecoderInit
(
    IN  GT_U8 devNum
)
{
    GT_U32 instance, window, base;
    PRV_CPSS_DXCH_PP_REGS_ADDR_STC *addrPtr = PRV_CPSS_DXCH_DEV_REGS_MAC(devNum);
    ...
    /*
        ...
        GIC  – 0x8048_0000
    */
    /*0x80400100 + (n * 0x10000) + (i * 0x18) */
    for (instance = 0; (instance < 9); instance++)
    {
        for (window = 0; (window < 16); window++)
        {
            base = 0x80400100 + (instance * 0x10000) + (window * 0x18);
            addrPtr->ADDR_DECODER[instance].WIN_CTRL[window].winAttrAndSizeHigh   = base;
            addrPtr->ADDR_DECODER[instance].WIN_CTRL[window].winSizeLow           = base + 0x04;
            addrPtr->ADDR_DECODER[instance].WIN_CTRL[window].winBaseAndRemapHigh  = base + 0x08;
            addrPtr->ADDR_DECODER[instance].WIN_CTRL[window].winBaseLow           = base + 0x0C;
            addrPtr->ADDR_DECODER[instance].WIN_CTRL[window].winRemapLow          = base + 0x10;
            addrPtr->ADDR_DECODER[instance].WIN_CTRL[window].winAxiAttr           = base + 0x14;
...
)
{
    ...
    if(PRV_CPSS_PP_MAC(devNum)->devFamily == CPSS_PP_FAMILY_DXCH_AC5_E)
    {
        ...
        regsAddrPtr->globalRegs.coprocessor.serviceCpuGlobalConfiguration = 0x7f900500;
    }
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_BOBCAT2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E |
                                          CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E | CPSS_CAELUM_E| CPSS_ALDRIN_E | CPSS_AC3X_E);
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_BOBCAT2_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E
                                          | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E | CPSS_CAELUM_E| CPSS_ALDRIN_E | CPSS_AC3X_E);
...
)
{
    ...
    */
    ...
    if(!PRV_CPSS_SIP_7_CHECK_MAC(devNum) ||
        PRV_CPSS_PP_MAC(devNum)->isGmDevice)/*the GM still have the MG unit */
    {
        /* set generic registers of MG unit */
        bobcat2GlobalRegsInit(regsAddrPtr);
        /* set SDMA registers of MG unit */
        cheetaSdmaRegsInit(devNum,regsAddrPtr);
    }

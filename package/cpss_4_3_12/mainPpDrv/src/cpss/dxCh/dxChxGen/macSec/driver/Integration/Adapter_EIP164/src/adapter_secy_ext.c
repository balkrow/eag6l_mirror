        ...
        const unsigned int DeviceId)
{
    ...
    /* SecY_Device_Config_Get */
    {
        ...
        DeviceParams.SARetireConf_p = &SARetire;
        ...
        Log_FormattedMessage("SARetire Prescale=%u Timeout=%d\n",
                             SARetire.TimerPrescale, SARetire.SATimeout);
    ...
    /* SecY_Channel_PacketsInflight_Get */
    {
        ...
        for (i=0; i<SECY_CHANNEL_WORDS; i++)
            Log_FormattedMessage("PacketsInflight Mask[%u]=%u\n",
                                 i, Mask.ch_bitmask[i]);
    }
        ...
        const bool fAllChannels)
{
    ...
    else
    {
        ...
        Log_FormattedMessage(
            "fLowLatencyBypass=%d fLatencyEnable=%d latency=%d shouldsecure=%d\n",
            ChannelParams.fLowLatencyBypass,
            ChannelParams.fLatencyEnable,
            ChannelParams.Latency,
            ChannelParams.fShouldSecure);
        ...
        Log_FormattedMessage(
            "StatCtrl SeqNrThreshold=%u SeqNrThreshold6=(lo=%u hi=%u)\n",

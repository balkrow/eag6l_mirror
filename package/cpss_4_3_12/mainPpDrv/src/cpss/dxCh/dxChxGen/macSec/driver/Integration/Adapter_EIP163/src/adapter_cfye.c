        ...
        const CfyE_Device_t * const Device_p)
{
    ...
    if (Device_p->Control_p)
    {
        ...
        if (DevCtrl_p->Exceptions_p)
        {
            ...
            DeviceEx.DropAction = (GT_U32)DevCtrl_p->Exceptions_p->DropAction;
            ...
            DeviceEx.ECCDropAction = (GT_U32)DevCtrl_p->Exceptions_p->ECCDropAction;
            DeviceEx.fShouldSecure      = DevCtrl_p->Exceptions_p->fShouldSecure;
    ...
    if (Device_p->CP_p)
    {
        ...
        DeviceCP.CPMatchSubMask     = CtrlPkt_p->CPMatchSubMask;
        ...
        CfyE_Device_t * const Device_p)
{
    ...
    if (DevCtrl_p)
    {
        ...
        if (DevCtrl_p->Exceptions_p)
        {
            DevCtrl_p->Exceptions_p->DropAction = (GT_U32)DeviceEx.DropAction;
            ...
            DevCtrl_p->Exceptions_p->ECCDropAction = (GT_U32)DeviceEx.ECCDropAction;
            DevCtrl_p->Exceptions_p->fShouldSecure = DeviceEx.fShouldSecure;
        }
    }
    ...
    if (CtrlPkt_p)
    {
        ...
        CtrlPkt_p->CPMatchSubMask = DeviceCP.CPMatchSubMask;

...
#define EIP164_IOAREA_REQUIRED_SIZE               (sizeof(void*)+10*sizeof(int))
...
typedef struct
{
    ...
    /** How to drop packets when no valid vPort */
    EIP164_DropType_t VPInvDropType;

    /** How to drop packets when uncorrectable ECC error occurs on flow RAM */
    EIP164_DropType_t FLInvDropType;

    /** Always bypass control packets */
    bool fBypassControlPkts;

...
const char * const prvCpssLogEnum_CPSS_DXCH_MACSEC_POLICY_MODE_ENT[]  =
{
    "CPSS_DXCH_MACSEC_POLICY_MODE_MUST_SECURE_E",
    "CPSS_DXCH_MACSEC_POLICY_MODE_SHOULD_SECURE_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_MACSEC_POLICY_MODE_ENT);
...
)
{
    ...
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, policyMode, CPSS_DXCH_MACSEC_POLICY_MODE_ENT);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, data, CPSS_DXCH_MACSEC_CLASSIFY_RULE_NON_CTRL_WORD_COUNT_CNS, GT_U32);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, dataMask, CPSS_DXCH_MACSEC_CLASSIFY_RULE_NON_CTRL_WORD_COUNT_CNS, GT_U32_HEX);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, policy, CPSS_DXCH_MACSEC_CLASSIFY_RULE_POLICY_STC);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, preemptionClass, CPSS_PORT_PREEMPTION_CLASS_ENT);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, inPktsSANotInUse, GT_U64);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_MACSEC_SECY_SA_HANDLE_newSaHandle = {
     "newSaHandle", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_MACSEC_SECY_SA_HANDLE)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_PORT_PREEMPTION_CLASS_ENT_preemptionClass = {
     "preemptionClass", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_PORT_PREEMPTION_CLASS_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMacSecClassifyRuleAddIndex_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_MACSEC_UNIT_BMP_unitBmp,
    &DX_IN_CPSS_DXCH_MACSEC_DIRECTION_ENT_direction,
    &DX_IN_CPSS_DXCH_MACSEC_CLASSIFY_VPORT_HANDLE_vPortHandle,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMacSecPortSecyDump_PARAMS[] =  {
    ...
    &DX_IN_CPSS_PORT_PREEMPTION_CLASS_ENT_preemptionClass,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMacSecSecySaSwitch_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_MACSEC_UNIT_BMP_unitBmp,
    &DX_IN_CPSS_DXCH_MACSEC_SECY_SA_HANDLE_activeSaHandle,
    &DX_IN_CPSS_DXCH_MACSEC_SECY_SA_HANDLE_newSaHandle
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChMacSecLogLibDb[] = {
    ...
    {"cpssDxChMacSecClassifyRuleAddIndex", 7, cpssDxChMacSecClassifyRuleAddIndex_PARAMS, NULL},
    ...
    {"cpssDxChMacSecPortClassifyStatisticsGet", 6, cpssDxChMacSecPortClassifyStatisticsGet_PARAMS, NULL},
    ...
    {"cpssDxChMacSecSecySaSwitch", 4, cpssDxChMacSecSecySaSwitch_PARAMS, NULL},
    ...
    {"cpssDxChMacSecPortSecyDump", 6, cpssDxChMacSecPortSecyDump_PARAMS, NULL},
    ...
    {"cpssDxChMacSecPortClassifyDump", 6, cpssDxChMacSecPortSecyDump_PARAMS, NULL},
    ...
    {"cpssDxChMacSecSecyStatisticsSaClear", 4, cpssDxChMacSecSecySaRemove_PARAMS, NULL},
};

...
const char * const prvCpssLogEnum_CPSS_DXCH_HFT_ENTRY_TYPE_ENT[]  =
{
    "CPSS_DXCH_HFT_GENERIC_E",
    "CPSS_DXCH_HFT_GENERIC_EXT_E",
    "CPSS_DXCH_HFT_MPLS_E",
    "CPSS_DXCH_HFT_MPLS_EXT_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_HFT_ENTRY_TYPE_ENT);
const char * const prvCpssLogEnum_CPSS_DXCH_HFT_TABLE_ENT[]  =
{
    "CPSS_DXCH_HFT_TABLE_0_E",
    "CPSS_DXCH_HFT_TABLE_1_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_HFT_TABLE_ENT);
...
const char * const prvCpssLogEnum_CPSS_DXCH_TUNNEL_START_VLAN_QOS_MARK_MODE_ENT[]  =
{
    "CPSS_DXCH_TUNNEL_START_VLAN_QOS_MARK_INGRESS_ASSIGNMENT_E",
    "CPSS_DXCH_TUNNEL_START_VLAN_QOS_MARK_TUNNEL_BASED_E",
    "CPSS_DXCH_TUNNEL_START_VLAN_QOS_MARK_CIRCUIT_BASED_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_TUNNEL_START_VLAN_QOS_MARK_MODE_ENT);
const char * const prvCpssLogEnum_CPSS_DXCH_TUNNEL_START_MPLS_EXP_MAPPING_MODE_ENT[]  =
{
    "CPSS_DXCH_TUNNEL_START_MPLS_EXP_MAPPING_GLOBAL_E",
    "CPSS_DXCH_TUNNEL_START_MPLS_EXP_MAPPING_INTERFACE_E",
    "CPSS_DXCH_TUNNEL_START_MPLS_EXP_MAPPING_CUSTOM_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_TUNNEL_START_MPLS_EXP_MAPPING_MODE_ENT);
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_HFT_CONFIG_UNT *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, mplsLabelCfg, CPSS_DXCH_HFT_MPLS_LABEL_CONFIG_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, mplsLabelExtCfg, CPSS_DXCH_HFT_MPLS_LABEL_EXTENDED_CONFIG_STC);
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_HFT_MPLS_LABEL_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, hftCommonCfg, CPSS_DXCH_HFT_COMMON_CONFIG_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, mplsLabelStackCfg, CPSS_DXCH_TUNNEL_START_MPLS_LABEL_STACK_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_HFT_MPLS_LABEL_EXTENDED_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, hftCommonCfg, CPSS_DXCH_HFT_COMMON_CONFIG_STC);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, gcfBits5To47, 2, GT_U32);
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_TUNNEL_START_VPORT_MPLS_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, tag0QosMarkMode, CPSS_DXCH_TUNNEL_START_VLAN_QOS_MARK_MODE_ENT);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, tag1QosMarkMode, CPSS_DXCH_TUNNEL_START_VLAN_QOS_MARK_MODE_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, up0);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, dei0);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, up1);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, dei1);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, threadId);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, analyzerIndex);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, egressMirrorMode, CPSS_DXCH_MIRROR_EGRESS_MODE_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, rawLabels);
    PRV_CPSS_LOG_STC_32_HEX_MAC(valPtr, mplsEthertypeSelect);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, cncPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, flowOrGcfProfileId);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, flowOrGcfBits);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, mplsLabelStackCfg, CPSS_DXCH_TUNNEL_START_MPLS_LABEL_STACK_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_HFT_COMMON_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, subType);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, analyzerIndex);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, egressMirrorMode, CPSS_DXCH_MIRROR_EGRESS_MODE_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, subThreadId);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, cncPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, gcfProfileId);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, gcfBits0To4);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_TUNNEL_START_MPLS_LABEL_STACK_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, lastQosUniformLabel);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, globaExplMappingTableIndex);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, lastTtlUniformLabel);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, cwIndex);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, flowLabelInsertion);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numOfLabels);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, mplsLabels, CPSS_DXCH_TUNNEL_START_VPORT_MPLS_LABELS_CNS, CPSS_DXCH_TUNNEL_START_MPLS_LABEL_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_TUNNEL_START_MPLS_LABEL_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, expMappingMode, CPSS_DXCH_TUNNEL_START_MPLS_EXP_MAPPING_MODE_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, label);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, exp);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, ttl);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, isElOrEliInsertion);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_HFT_CONFIG_UNT*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_HFT_CONFIG_UNT_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_HFT_ENTRY_TYPE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_HFT_ENTRY_TYPE_ENT);
}
...
{
    PRV_CPSS_LOG_SET_PARAM_VAL_MAC(CPSS_DXCH_HFT_TABLE_ENT, paramVal);
    PRV_CPSS_LOG_ENUM_MAC(namePtr, paramVal, CPSS_DXCH_HFT_TABLE_ENT);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_HFT_CONFIG_UNT_PTR_configPtr = {
     "configPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_HFT_CONFIG_UNT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_HFT_ENTRY_TYPE_ENT_hftEntryType = {
     "hftEntryType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_HFT_ENTRY_TYPE_ENT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_HFT_TABLE_ENT_hftTableId = {
     "hftTableId", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DXCH_HFT_TABLE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_HFT_CONFIG_UNT_PTR_configPtr = {
     "configPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_HFT_CONFIG_UNT)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_HFT_ENTRY_TYPE_ENT_PTR_hftEntryTypePtr = {
     "hftEntryTypePtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_HFT_ENTRY_TYPE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTunnelStartHftPortGroupEntrySet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_entryIndex,
    &DX_IN_CPSS_DXCH_HFT_TABLE_ENT_hftTableId,
    &DX_IN_CPSS_DXCH_HFT_ENTRY_TYPE_ENT_hftEntryType,
    &DX_IN_CPSS_DXCH_HFT_CONFIG_UNT_PTR_configPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChTunnelStartHftPortGroupEntryGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_entryIndex,
    &DX_IN_CPSS_DXCH_HFT_TABLE_ENT_hftTableId,
    &DX_OUT_CPSS_DXCH_HFT_ENTRY_TYPE_ENT_PTR_hftEntryTypePtr,
    &DX_OUT_CPSS_DXCH_HFT_CONFIG_UNT_PTR_configPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChTunnelLogLibDb[] = {
    ...
    {"cpssDxChTunnelStartHftPortGroupEntrySet", 6, cpssDxChTunnelStartHftPortGroupEntrySet_PARAMS, NULL},
    {"cpssDxChTunnelStartHftPortGroupEntryGet", 6, cpssDxChTunnelStartHftPortGroupEntryGet_PARAMS, NULL},
};

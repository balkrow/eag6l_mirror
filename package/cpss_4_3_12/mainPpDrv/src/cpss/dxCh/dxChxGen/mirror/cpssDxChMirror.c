...
* @param[in] index                    - Analyzer destination interface index.
...
)
{
    ...
    if(index > CPSS_DXCH_MIRROR_ANALYZER_MAX_INDEX_MAC(devNum))
    {
...
*                                      (APPLICABLE RANGES: xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman 0..6)
*                                      (APPLICABLE RANGES: AAS 0..62)
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - wrong device, mirrPort.
...
)
{
    ...
    GT_U32      fieldLength;
    GT_U32      steps; /* Table field length */
    ...
    if(PRV_CPSS_DXCH_XCAT_FAMILY_CHECK_MAC(devNum))
    {
           ...
           (mode != CPSS_DXCH_MIRROR_TO_ANALYZER_FORWARDING_HOP_BY_HOP_E))
        {
            ...
            {
                fieldLength = PRV_CPSS_SIP_7_CHECK_MAC(devNum)? 6 : 3;
                steps = PRV_CPSS_SIP_7_CHECK_MAC(devNum)? 12 : 4;
                offset = (mirrPort % 8) * steps; /* 8 ports in entry, in steps of 4/12 bits */
...
* @param[in] index                    -  of analyzer interface.
*                                      (APPLICABLE RANGES: xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman 0..6)
*                                      (APPLICABLE RANGES: AAS 0..62)
...
)
{
    ...
    if(PRV_CPSS_SIP_5_CHECK_MAC(devNum) == GT_TRUE)
    {
        ...
        rc = prvCpssHwPpPortGroupSetRegField(
            devNum, portGroupId, regAddr, 0, dataLength, regData);
    ...
    else
    {
        ...
        /* additional check for static analyzers like Klocwork */
        if(index >= MAX_NUM_ANALYZERS_SIP4_CNS)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
        }
        ...
        rc = prvCpssHwPpPortGroupSetRegField(
            devNum, portGroupId, regAddr, 0, 20, regData);
    }
...
)
{
    ...
    rc = internal_cpssDxChMirrorAnalyzerInterfaceSet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, interfacePtr);
...
/**
* @internal internal_cpssDxChMirrorPortGroupAnalyzerInterfaceSet function
* @endinternal
*
* @brief   This function sets analyzer interface.
*
...
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - wrong device, index, interface type or portGroupsBmp.
* @retval GT_HW_ERROR              - on writing to HW error.
* @retval GT_BAD_PTR               - on NULL pointer
* @retval GT_OUT_OF_RANGE          - on wrong port or device number in interfacePtr.
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupAnalyzerInterfaceSet
(
    IN GT_U8                                     devNum,
...
)
{
    ...
    {
        rc = internal_cpssDxChMirrorAnalyzerInterfaceSet(
            devNum, portGroupId, index, interfacePtr);
        if (rc != GT_OK)
        {
            return rc;
        }
...
/**
* @internal cpssDxChMirrorPortGroupAnalyzerInterfaceSet function
* @endinternal
*
* @brief   This function sets analyzer interface.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupAnalyzerInterfaceSet
(
    IN GT_U8                                     devNum,
    IN GT_PORT_GROUPS_BMP                        portGroupsBmp,
    IN GT_U32                                    index,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChMirrorPortGroupAnalyzerInterfaceSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, interfacePtr));

    rc = internal_cpssDxChMirrorPortGroupAnalyzerInterfaceSet(
        devNum, portGroupsBmp, index, interfacePtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portGroupsBmp, index, interfacePtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    rc = internal_cpssDxChMirrorAnalyzerInterfaceGet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, interfacePtr);
...
/**
* @internal internal_cpssDxChMirrorPortGroupAnalyzerInterfaceGet function
* @endinternal
*
* @brief   This function gets analyzer interface.
*
...
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - wrong device, index or portGroupsBmp.
* @retval GT_HW_ERROR              - on writing to HW error.
* @retval GT_BAD_PTR               - on NULL pointer
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupAnalyzerInterfaceGet
(
    IN  GT_U8                                     devNum,
    IN  GT_PORT_GROUPS_BMP                        portGroupsBmp,
    IN  GT_U32                                    index,
...
)
{
    ...
    return internal_cpssDxChMirrorAnalyzerInterfaceGet(
        devNum, portGroupId, index, interfacePtr);
}

/**
* @internal cpssDxChMirrorPortGroupAnalyzerInterfaceGet function
* @endinternal
*
* @brief   This function gets analyzer interface.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupAnalyzerInterfaceGet
(
    IN  GT_U8                                     devNum,
    IN  GT_PORT_GROUPS_BMP                        portGroupsBmp,
    IN  GT_U32                                    index,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChMirrorPortGroupAnalyzerInterfaceGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, interfacePtr));

    rc = internal_cpssDxChMirrorPortGroupAnalyzerInterfaceGet(
        devNum, portGroupsBmp, index, interfacePtr);
...
)
{
    ...
    return prvCpssHwPpSetRegField(devNum, regAddr, 2, fieldLength, regData);
}
...
)
{
    ...
    GT_U32      regData;       /* register data */
    GT_STATUS   rc;            /* return code */
    GT_U32      fieldLength;   /* reg field length */
    ...
    rc = prvCpssHwPpGetRegField(devNum, regAddr, 2, fieldLength, &regData);
    if(rc != GT_OK)
    {
        return rc;
    }
...
)
{
    ...
    return prvCpssHwPpSetRegField(devNum, regAddr, fieldOffset, fieldLength, regData);
}
...
)
{
    ...
    rc = prvCpssHwPpGetRegField(devNum, regAddr, fieldOffset, fieldLength, &regData);
    if(rc != GT_OK)
    {
        return rc;
    }
...
* @note   NOT APPLICABLE DEVICES:  Lion2; Bobcat2; Caelum; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; Aldrin; AC3X; AAS.
*
* @param[in] devNum                   - device number
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum,
           CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);
...
)
{
    ...
    if((index >  CPSS_DXCH_MIRROR_ANALYZER_MAX_INDEX_MAC(devNum)) || (egressMirroringMode != CPSS_DXCH_MIRROR_EGRESS_TAIL_DROP_E && egressMirroringMode != CPSS_DXCH_MIRROR_EGRESS_CONGESTION_E))
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        fieldOffset = (egressMirroringMode == CPSS_DXCH_MIRROR_EGRESS_TAIL_DROP_E) ? 0 : 6;
        fieldLength = 6;
    }
    else
    {
...
* @param[in] portGroupId              - The port group id. relevant only to 'multi-port-groups'
*                                      devices. Supports value CPSS_PORT_GROUP_UNAWARE_MODE_CNS
* @param[in] index                    - Analyzer interface index.
*                                       (APPLICABLE RANGES: Falcon; AC5P; AC5X; Harrier; Ironman 0..6)
*                                       (APPLICABLE RANGES: AAS 0..62)
...
)
{
    ...
    /* writing <IngressStatMirroringToAnalyzerPortEn> field */
    rc = prvCpssHwPpPortGroupSetRegField(
        devNum, portGroupId, regAddr, 0, 1, regData);
    if(rc != GT_OK)
        return rc;
    ...
    rc = prvCpssHwPpPortGroupWriteRegister(
        devNum, portGroupId, regAddr, ratio);
...
)
{
    ...
    rc = internal_cpssDxChMirrorRxStatMirrorToAnalyzerIndexAndRatioSet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, enable, ratio);
...
/**
* @internal internal_cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet function
* @endinternal
*
* @brief  This function sets Ingress statistical Mirroring
*         to the Ingress Analyzer Port including ratio per analyzer index.
...
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - wrong device or index or portGroupsBmp.
* @retval GT_HW_ERROR              - on writing to HW error.
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet
(
    IN GT_U8                  devNum,
    IN GT_PORT_GROUPS_BMP     portGroupsBmp,
    IN GT_U32                 index,
...
)
{
    ...
    {
        rc = internal_cpssDxChMirrorRxStatMirrorToAnalyzerIndexAndRatioSet(
            devNum, portGroupId, index, enable, ratio);
        if (rc != GT_OK)
        {
            return rc;
        }
...
/**
* @internal cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet function
* @endinternal
*
* @brief  This function sets Ingress statistical Mirroring
*         to the Ingress Analyzer Port including ratio per analyzer index.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet
(
    IN GT_U8                  devNum,
    IN GT_PORT_GROUPS_BMP     portGroupsBmp,
    IN GT_U32                 index,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(
        funcId, cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, enable, ratio));

    rc = internal_cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet(
        devNum, portGroupsBmp, index, enable, ratio);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portGroupsBmp, index, enable, ratio));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    rc = prvCpssHwPpPortGroupReadRegister(
        devNum, portGroupId, regAddr, ratioPtr);
    if(rc != GT_OK)
        return rc;
...
)
{
    ...
    rc = internal_cpssDxChMirrorRxStatMirrorToAnalyzerIndexAndRatioGet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, enablePtr, ratioPtr);
...
/**
* @internal internal_cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet function
* @endinternal
*
* @brief  This function gets Ingress statistical Mirroring
*         to the Ingress Analyzer Port including ratio per analyzer index.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet
(
    IN GT_U8                  devNum,
    IN  GT_PORT_GROUPS_BMP    portGroupsBmp,
    IN GT_U32                 index,
...
)
{
    ...
    return internal_cpssDxChMirrorRxStatMirrorToAnalyzerIndexAndRatioGet(
        devNum, portGroupId, index, enablePtr, ratioPtr);
}

/**
* @internal cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet function
* @endinternal
*
* @brief  This function gets Ingress statistical Mirroring
*         to the Ingress Analyzer Port including ratio per analyzer index.
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet
(
    IN GT_U8                  devNum,
    IN  GT_PORT_GROUPS_BMP    portGroupsBmp,
    IN GT_U32                 index,
...
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(
        funcId, cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, enablePtr, ratioPtr));

    rc = internal_cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet(
        devNum, portGroupsBmp, index, enablePtr, ratioPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portGroupsBmp, index, enablePtr, ratioPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    rc = internal_cpssDxChMirrorTxStatMirrorToAnalyzerIndexRatioSet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, ratio);
...
/**
* @internal internal_cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet function
* @endinternal
*
* @brief  This function sets Egress statistical Mirroring ratio to the Egress Analyzer Port.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet
(
    IN GT_U8                devNum,
    IN GT_PORT_GROUPS_BMP   portGroupsBmp,
    IN GT_U32               index,
...
)
{
    ...
    {
        rc = internal_cpssDxChMirrorTxStatMirrorToAnalyzerIndexRatioSet(
            devNum, portGroupId, index, ratio);
        if (rc != GT_OK)
        {
            return rc;
        }
...
/**
* @internal cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet function
* @endinternal
*
* @brief  This function sets Egress statistical Mirroring ratio to the Egress Analyzer Port.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet
(
    IN GT_U8                devNum,
    IN GT_PORT_GROUPS_BMP   portGroupsBmp,
    IN GT_U32               index,
...
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(
        funcId, cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, ratio));

    rc = internal_cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet(
        devNum, portGroupsBmp, index, ratio);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portGroupsBmp, index, ratio));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    rc = internal_cpssDxChMirrorTxStatMirrorToAnalyzerIndexRatioGet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, ratioPtr);
...
/**
* @internal internal_cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet function
* @endinternal
*
* @brief  This function gets Egress statistical Mirroring ratio to the Egress Analyzer Port.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet
(
    IN  GT_U8                devNum,
    IN  GT_PORT_GROUPS_BMP   portGroupsBmp,
    IN  GT_U32               index,
...
)
{
    ...
    return internal_cpssDxChMirrorTxStatMirrorToAnalyzerIndexRatioGet(
        devNum, portGroupId, index, ratioPtr);
}
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet
(
    IN  GT_U8                devNum,
    IN  GT_PORT_GROUPS_BMP   portGroupsBmp,
    IN  GT_U32               index,
...
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(
        funcId, cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, ratioPtr));

    rc = internal_cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet(
        devNum, portGroupsBmp, index, ratioPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portGroupsBmp, index, ratioPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    rc = prvCpssHwPpPortGroupSetRegField(
        devNum, portGroupId, regAddr, 26, 1, regData);
...
)
{
    ...
    rc = internal_cpssDxChMirrorToAnalyzerTruncateSet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, truncate);
...
/**
* @internal internal_cpssDxChMirrorPortGroupToAnalyzerTruncateSet function
* @endinternal
*
* @brief  This function sets if to truncate TO_ANALYZER packets per analyzer index.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupToAnalyzerTruncateSet
(
    IN GT_U8               devNum,
    IN GT_PORT_GROUPS_BMP  portGroupsBmp,
    IN GT_U32              index,
...
)
{
    ...
    {
        rc = internal_cpssDxChMirrorToAnalyzerTruncateSet(
            devNum, portGroupId, index, truncate);
        if (rc != GT_OK)
        {
            return rc;
        }
...
/**
* @internal cpssDxChMirrorPortGroupToAnalyzerTruncateSet function
* @endinternal
*
* @brief  This function sets if to truncate TO_ANALYZER packets per analyzer index.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupToAnalyzerTruncateSet
(
    IN GT_U8               devNum,
    IN GT_PORT_GROUPS_BMP  portGroupsBmp,
    IN GT_U32              index,
...
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(
        funcId, cpssDxChMirrorPortGroupToAnalyzerTruncateSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, truncate));

    rc = internal_cpssDxChMirrorPortGroupToAnalyzerTruncateSet(
        devNum, portGroupsBmp, index, truncate);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, iportGroupsBmp, ndex, truncate));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    rc = internal_cpssDxChMirrorToAnalyzerTruncateGet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, truncatePtr);
...
/**
* @internal internal_cpssDxChMirrorPortGroupToAnalyzerTruncateGet function
* @endinternal
*
* @brief  This function gets truncate field per analyzer index.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupToAnalyzerTruncateGet
(
    IN  GT_U8             devNum,
    IN GT_PORT_GROUPS_BMP portGroupsBmp,
    IN  GT_U32            index,
...
)
{
    ...
    return internal_cpssDxChMirrorToAnalyzerTruncateGet(
        devNum, portGroupId, index, truncatePtr);
}

/**
* @internal cpssDxChMirrorPortGroupToAnalyzerTruncateGet function
* @endinternal
*
* @brief  This function gets truncate field per analyzer index.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupToAnalyzerTruncateGet
(
    IN  GT_U8             devNum,
    IN GT_PORT_GROUPS_BMP portGroupsBmp,
    IN  GT_U32            index,
...
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(
        funcId, cpssDxChMirrorPortGroupToAnalyzerTruncateGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, truncatePtr));

    rc = internal_cpssDxChMirrorPortGroupToAnalyzerTruncateGet(
        devNum, portGroupsBmp, index, truncatePtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portGroupsBmp, index, truncatePtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    rc = prvCpssHwPpPortGroupSetRegField(
        devNum, portGroupId, regAddr, 27, 1, regData);
...
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(
        funcId, cpssDxChMirrorTreatEgressMirroredAsIngressMirroredEnableSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, index, enable));

    rc = internal_cpssDxChMirrorTreatEgressMirroredAsIngressMirroredEnableSet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, enable);
...
/**
* @internal internal_cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet function
* @endinternal
*
* @brief  This function sets if this field is set to Enable for this Analyzer Index
*         the egress mirrored copy is treated as if was ingress mirrored,
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet
(
    IN GT_U8               devNum,
    IN GT_PORT_GROUPS_BMP  portGroupsBmp,
    IN GT_U32              index,
...
)
{
    ...
    {
        rc = internal_cpssDxChMirrorTreatEgressMirroredAsIngressMirroredEnableSet(
            devNum, portGroupId, index, enable);
        if (rc != GT_OK)
        {
            return rc;
        }
...
/**
* @internal cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet function
* @endinternal
*
* @brief  This function sets if this field is set to Enable for this Analyzer Index
*         the egress mirrored copy is treated as if was ingress mirrored,
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet
(
    IN GT_U8               devNum,
    IN GT_PORT_GROUPS_BMP  portGroupsBmp,
    IN GT_U32              index,
...
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(
        funcId, cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, enable));

    rc = internal_cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet(
        devNum, portGroupsBmp, index, enable);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portGroupsBmp, index, enable));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    rc = internal_cpssDxChMirrorTreatEgressMirroredAsIngressMirroredEnableGet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, index, enablePtr);
...
/**
* @internal internal_cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet function
* @endinternal
*
* @brief  This function gets "Treat_Egress_Mirrored_as_Ingress_Mirrored" field per analyzer index.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE    - on not applicable device
*/
static GT_STATUS internal_cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet
(
    IN  GT_U8               devNum,
    IN  GT_PORT_GROUPS_BMP  portGroupsBmp,
    IN  GT_U32              index,
...
)
{
    ...
    return internal_cpssDxChMirrorTreatEgressMirroredAsIngressMirroredEnableGet(
        devNum, portGroupId, index, enablePtr);
}

/**
* @internal cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet function
* @endinternal
*
* @brief  This function gets "Treat_Egress_Mirrored_as_Ingress_Mirrored" field per analyzer index.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE    - on not applicable device
*/
GT_STATUS cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet
(
    IN  GT_U8               devNum,
    IN  GT_PORT_GROUPS_BMP  portGroupsBmp,
    IN  GT_U32              index,
...
)
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(
        funcId, cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, index, enablePtr));

    rc = internal_cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet(
        devNum, portGroupsBmp, index, enablePtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, portGroupsBmp, index, enablePtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    switch(configPtr->mode)
    {
        ...
        case CPSS_DXCH_MIRROR_ON_DROP_MODE_MIRROR_TO_ANALYZER_E:
            if(configPtr->analyzerIndex > CPSS_DXCH_MIRROR_ANALYZER_MAX_INDEX_MAC(devNum))
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, LOG_ERROR_NO_MSG);
            }

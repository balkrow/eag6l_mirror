...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupAnalyzerInterfaceSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_IN_CPSS_DXCH_MIRROR_ANALYZER_INTERFACE_STC_PTR_interfacePtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_IN_GT_BOOL_enable
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_IN_GT_BOOL_enable,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupToAnalyzerTruncateSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_IN_GT_BOOL_truncate
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_IN_GT_U32_ratio
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupAnalyzerInterfaceGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_OUT_CPSS_DXCH_MIRROR_ANALYZER_INTERFACE_STC_PTR_interfacePtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_OUT_GT_BOOL_PTR_enablePtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_OUT_GT_BOOL_PTR_enablePtr,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupToAnalyzerTruncateGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_OUT_GT_BOOL_PTR_truncatePtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_IN_GT_U32_index,
    &DX_OUT_GT_U32_PTR_ratioPtr
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChMirrorLogLibDb[] = {
    ...
    {"cpssDxChMirrorPortGroupAnalyzerInterfaceSet", 4, cpssDxChMirrorPortGroupAnalyzerInterfaceSet_PARAMS, NULL},
    {"cpssDxChMirrorAnalyzerInterfaceGet", 3, cpssDxChMirrorAnalyzerInterfaceGet_PARAMS, NULL},
    {"cpssDxChMirrorPortGroupAnalyzerInterfaceGet", 4, cpssDxChMirrorPortGroupAnalyzerInterfaceGet_PARAMS, NULL},
    ...
    {"cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet", 5, cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioSet_PARAMS, NULL},
    {"cpssDxChMirrorRxStatMirrorToAnalyzerIndexAndRatioGet", 4, cpssDxChMirrorRxStatMirrorToAnalyzerIndexAndRatioGet_PARAMS, NULL},
    {"cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet", 5, cpssDxChMirrorPortGroupRxStatMirrorToAnalyzerIndexAndRatioGet_PARAMS, NULL},
    {"cpssDxChMirrorTxStatMirrorToAnalyzerIndexRatioSet", 3, cpssDxChMirrorTxStatMirrorToAnalyzerIndexRatioSet_PARAMS, NULL},
    {"cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet", 4, cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioSet_PARAMS, NULL},
    {"cpssDxChMirrorTxStatMirrorToAnalyzerIndexRatioGet", 3, cpssDxChMirrorTxStatMirrorToAnalyzerIndexRatioGet_PARAMS, NULL},
    {"cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet", 4, cpssDxChMirrorPortGroupTxStatMirrorToAnalyzerIndexRatioGet_PARAMS, NULL},
    {"cpssDxChMirrorToAnalyzerTruncateSet", 3, cpssDxChMirrorToAnalyzerTruncateSet_PARAMS, NULL},
    {"cpssDxChMirrorPortGroupToAnalyzerTruncateSet", 4, cpssDxChMirrorPortGroupToAnalyzerTruncateSet_PARAMS, NULL},
    {"cpssDxChMirrorToAnalyzerTruncateGet", 3, cpssDxChMirrorToAnalyzerTruncateGet_PARAMS, NULL},
    {"cpssDxChMirrorPortGroupToAnalyzerTruncateGet", 4, cpssDxChMirrorPortGroupToAnalyzerTruncateGet_PARAMS, NULL},
    ...
    {"cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet", 4, cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableSet_PARAMS, NULL},
    {"cpssDxChMirrorTreatEgressMirroredAsIngressMirroredEnableGet", 3, prvCpssLogGenDevNumIndexEnablePtr_PARAMS, NULL},
    {"cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet", 4, cpssDxChMirrorPortGroupTreatEgressMirroredAsIngressMirroredEnableGet_PARAMS, NULL},

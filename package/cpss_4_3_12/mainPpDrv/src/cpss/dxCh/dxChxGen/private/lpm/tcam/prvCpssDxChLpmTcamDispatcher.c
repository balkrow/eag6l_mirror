...
)
{
    ...
    {
        PRV_CPSS_DXCH_LPM_TCAM_ENTRIES_HANDLER_ALLOC_METHOD_ENT tempTcamHandlerAllocMethod;
        switch (tcamHandlerAllocMethod)
        {
        case PRV_CPSS_DXCH_LPM_TCAM_MGM_ALLOC_MIN_E:
            tempTcamHandlerAllocMethod = PRV_CPSS_DXCH_LPM_TCAM_ENTRIES_HANDLER_ALLOC_MIN_E;
            break;
        case PRV_CPSS_DXCH_LPM_TCAM_MGM_ALLOC_MID_E:
            tempTcamHandlerAllocMethod = PRV_CPSS_DXCH_LPM_TCAM_ENTRIES_HANDLER_ALLOC_MID_E;
            break;
        case PRV_CPSS_DXCH_LPM_TCAM_MGM_ALLOC_MAX_E:
            tempTcamHandlerAllocMethod = PRV_CPSS_DXCH_LPM_TCAM_ENTRIES_HANDLER_ALLOC_MAX_E;
            break;
        default:

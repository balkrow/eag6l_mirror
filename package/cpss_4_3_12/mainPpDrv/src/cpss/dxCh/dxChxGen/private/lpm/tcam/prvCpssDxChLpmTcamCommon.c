...
)
{
    ...
    doNothingRuleAction.egressPolicy = CPSS_PCL_DIRECTION_INGRESS_E;
...
)
{
    ...
    retVal = prvCpssDxChLpmConvertLpmRouteEntryToIpLttEntry(PRV_CPSS_DXCH_LPM_HW_TCAM_E,
...
)
{
    ...
    status = prvCpssDxChLpmConvertIpLttEntryToLpmRouteEntry(PRV_CPSS_DXCH_LPM_HW_TCAM_E,
...
/**
 * @internal prvCpssDxChLpmTcamCallbacksBind function
 * @endinternal
 *
 ...
 *
 */
GT_VOID * prvCpssDxChLpmTcamCallbacksBind
(
    GT_VOID
)
{

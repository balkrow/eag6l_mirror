...
const GT_CHAR_PTR packetAnalyzerFieldToIdebugFieldArr[PRV_CPSS_DXCH_PACKET_ANALYZER_FIELD_REGULAR_LAST_E+1] = {
    ...
    "dummy_field_16",
    "dummy_field_17",
    "dummy_field_last"  /*CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_LAST_E*/
};
...
const char* paFieldStrArr[PRV_CPSS_DXCH_PACKET_ANALYZER_FIELD_REGULAR_LAST_E+1] = {
    ...
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_EGRESS_MAC_DA_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_EGRESS_MAC_SA_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_1_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_2_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_3_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_4_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_5_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_6_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_7_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_8_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_9_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_10_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_11_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_12_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_13_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_14_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_15_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_16_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_17_E",
    "CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_LAST_E"
};
...
const CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_ENT IronManPipelineOrderStage  [PRV_CPSS_DXCH_PACKET_ANALYZER_NUM_OF_STAGES_IRONMAN_CNS] = {
...
static const PRV_CPSS_DXCH_PACKET_ANALYZER_STAGE_INTERFACE_STC     IronManFixedBoundInterfaceArr[PRV_CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_ALL_REGULAR_STAGES_LAST_E+1] =
{
    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_TTI_E */
    {{"iml_epcl_ha_macro_hbu","hbuing2tti_desc",4},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_PCL_E */
    {{"iml_tcam_tti_pcl_macro_tti_desc","tti2pcl_desc",0},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_BRIDGE_E */
    {{"iml_tcam_tti_pcl_macro_pcl_desc","pcl2l2i_desc" ,7},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_ROUTER_E */
    {{"iml_l2i_ipvx_macro_l2i_desc","l2i2ipvx_desc",1},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_OAM_E */
    {{"iml_l2i_ipvx_macro_ipvx","ipvx2ioam_desc",3},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_POLICER_E */
    {{"iml_eq_mll_macro_eft_desc","iplr02iplr1_desc",6},GT_FALSE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_MLL_E */
    {{"iml_eq_mll_macro_mll_eq_desc","iplr12mll_desc",1},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_INGRESS_PRE_E_QUEUE_E */
    {{"iml_eq_mll_macro_mll_eq_desc","mll2eq_desc",4},GT_FALSE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_FILTER_E */
    {{"iml_eq_mll_macro_eft_desc","eq2eft_desc",2},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_TRANSMIT_QUEUE_E */
    {{"iml_epcl_ha_macro_epcl_desc","erep2hbuegr_desc",3},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_HEADER_ALTERATION_E */
    {{"iml_epcl_ha_macro_eft","qag2ha_desc",6},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_OAM_E */
    {{"iml_epcl_ha_macro_sht_erep_ermrk","preq2eoam_desc",6},GT_FALSE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_PCL_E */
    {{"iml_epcl_ha_macro_sht_erep_ermrk","ha2ekgen_desc",3},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_POLICER_E */
    {{"empty","empty - eoam2eplr_desc",0},GT_FALSE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_TIMESTAMP_E */
    {{"iml_epcl_ha_macro_eplr_desc","eplr2psu_desc",1},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_MAC_E */
    {{"iml_txq_macro_sdq","pdx2pdsi_desc",2},GT_TRUE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_PHA_E */
    {{"iml_epcl_ha_macro_epcl_desc","ermrk2phal_desc",4},GT_FALSE},

    /* CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_EGRESS_PRE_REPLICATION_E */
    {{"empty","empty - pha2erep_desc",0},GT_FALSE}};
    ...
    *sizePtr =  PRV_CPSS_DXCH_PACKET_ANALYZER_LOOKUP_STAGES_ALL_REGULAR_STAGES_LAST_E+1;
    ...
    switch(PRV_CPSS_PP_MAC(devNum)->devFamily)
    {
         ...
         case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
             cpssOsMemCpy(boundedInterfacesArrPtr, IronManFixedBoundInterfaceArr, sizeof(IronManFixedBoundInterfaceArr));
             break;
         default:
...
)
{
    ...
    switch(PRV_CPSS_PP_MAC(devNum)->devFamily)
    {
        ...
        case CPSS_PP_FAMILY_DXCH_HARRIER_E:
            ...
            break;
        case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
            for (ii = 0 ;ii<PRV_CPSS_DXCH_PACKET_ANALYZER_NUM_OF_STAGES_IRONMAN_CNS; ii++)
            {
                if (stageId == IronManPipelineOrderStage[ii])
                    return GT_TRUE;
            }
            break;
        default:
    ...
    switch(PRV_CPSS_PP_MAC(devNum)->devFamily)
    {
         ...
         case CPSS_PP_FAMILY_DXCH_HARRIER_E:
             ...
             *stageIdPtr = HarrierPipelineOrderStage[calcIndex];
             break;
          case CPSS_PP_FAMILY_DXCH_IRONMAN_E:
             if (calcIndex >= PRV_CPSS_DXCH_PACKET_ANALYZER_NUM_OF_STAGES_IRONMAN_CNS)
             {
                 CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "(index - offset) is out of bound ");
             }
             *stageIdPtr = IronManPipelineOrderStage[calcIndex];
             break;
         default:
             CPSS_LOG_ERROR_AND_RETURN_MAC(GT_NOT_SUPPORTED,"Error: Device family is not supported for iDebug");
             break;

...
const char * const prvCpssLogEnum_CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_TYPE_ENT[]  =
{
    "CPSS_DXCH_VIRTUAL_TCAM_MOVABLE_E",
    "CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_CPSS_ALLOCATED_E",
    "CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_APP_ALLOCATED_E"
};
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_TYPE_ENT);
...
)
{
    ...
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, tcamSpaceUnmovable, CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_TYPE_ENT);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, allocationSpaceArrSize);
    PRV_CPSS_LOG_STC_STC_PTR_MAC(valPtr, allocationSpaceArr, CPSS_DXCH_VIRTUAL_TCAM_SPACE_SEGMENT_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}

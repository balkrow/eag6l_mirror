...
)
{
    GT_STATUS rc;             /* return code      */
    GT_U32    regAddr;        /* register address */
    GT_U32    regIdx = 0;         /* register index   */
    GT_U32    offset;         /* field offset     */
...
* @endinternal
*
* @brief   The function sets mode of index calculation in Queue Id Bit Select Table
*         for TO CPU packets.
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; Aldrin; AC3X.
*
* @param[in] devNum                   - device number
* @param[in] toCpuMode                - mode of index calculation in
...
* @endinternal
*
* @brief   The function gets mode of index calculation in Queue Id Bit Select Table
*         for TO CPU packets.
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; Aldrin; AC3X.
...
* @param[in] devNum                   - device number
*
* @param[out] toCpuModePtr             - (pointer to)mode of index calculation in
*                                      Queue Id Bit Select Table for TO CPU packets.
...
*
* @param[in] devNum                   - device number
* @param[in] mcMode                   - mode of index calculation in
...
* @param[in] devNum                   - device number
*
* @param[out] mcModePtr                - (pointer to)mode of index calculation in
*                                      Queue Id Bit Select Table for Multicast packets.
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameters

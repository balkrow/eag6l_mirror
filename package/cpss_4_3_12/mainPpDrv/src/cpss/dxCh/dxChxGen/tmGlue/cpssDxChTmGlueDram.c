...
/**
********************************************************************************
* @file cpssDxChTmGlueDram.c
*
* @brief TM related DRAM APIs
*
* @version   10
********************************************************************************
*/
...
static const GT_U8 prvCpssDxChTmGlueDramInitSteps = 0;
...
/**
* @internal prvCpssDxChTmGlueDramConvertConfiguration function
* @endinternal
*
* @brief   Convert CPSS DRAM Configuration structure to HWS DRAM topology mapping.
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; Aldrin; AC3X.
*
* @param[in] cpssDramCfgPtr           - (pointer to) CPSS DRAM configurations.
*
* @param[out] mvHwsTopologyPtr         - (pointer to) HWS DRAM topology mappings.
*
...
)
{
    ...
    MV_HWS_SPEED_BIN        speedBin;   /* DRAM bin*/
    MV_HWS_MEM_SIZE         memorySize; /* DRAM size */
    MV_HWS_DDR_FREQ         memoryFreq; /* DRAM frequency */
    GT_U8                   nextInterface;
    ...
    {
        if((bus >= MAX_BUS_NUM) || (bus >= CPSS_DXCH_TM_GLUE_DRAM_INF_BUS_CNS))
        {
...
/**
* @internal prvCpssDxChTmGlueDramConvertAlgorithmParameters function
* @endinternal
*
* @brief   Convert CPSS DRAM Configuration algorithm structure to HWS algorithm
*         parameters.
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; Aldrin; AC3X.
*
* @param[in] cpssDramAlgoPtr          - (pointer to) CPSS DRAM algorithm configurations.
*
* @param[out] mvHwsAlgoParamsPtr       - (pointer to) HWS DRAM algorithm parameters.
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameter
*/
...
)
{
    ...
    {
        mvHwsAlgoParamsPtr->algoFlowMask = (
            ...
            PBS_RX_MASK_BIT |
                        ...
                        CENTRALIZATION_TX_MASK_BIT); /*0x3150f1;*/
    }
    else
    {
...
/**
* @internal internal_cpssDxChTmGlueDramInit function
* @endinternal
*
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E |  CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E | CPSS_ALDRIN_E | CPSS_AC3X_E);
    ...
    if (PRV_CPSS_DXCH_PP_MAC(devNum)->extMemory.mvHwsDevTopologyMapPtr == NULL)
    {
        ...
        rc = cpssTmCtlWriteRegister( devNum,  &(PRV_SHARED_TM_PLATFORM_DIR_GLOBAL_VAR_GET(TM).BAP[2].BAPPHYReadPath), &regData);
        if (rc) return rc;
        */
...
/**
* @internal internal_cpssDxChTmGlueDramInitFlagsSet function
* @endinternal
*

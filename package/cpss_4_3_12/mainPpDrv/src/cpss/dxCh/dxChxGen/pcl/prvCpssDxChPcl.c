...
/* max number of flow indexes supported by IFA */
#define PRV_CPSS_DXCH_PHA_THREAD_IFA_FLOW_INDEX_CNS          512

/* macros for PHA Thread VXLAN DCI VNI REMAP */
#define PRV_CPSS_DXCH_PHA_THREAD_VXLAN_DCI_VNI_REMAP_MAX_VNI_CNS    0xFFFFFF
...
/* SIP7 related */
/* ingress UDB only key 10 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_INGRESS_UDB_ONLY_10_sip7[] =
{
    /*udb 0-9*/
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[0],      0,   80),
    CPSS_FORMAT_CONVERT_FIELD_INFO_END_MAC
...
/* ingress UDB only key 20 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_INGRESS_UDB_ONLY_20_sip7[] =
{
    /*udb 0-19*/
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[0],      0,   160),
    CPSS_FORMAT_CONVERT_FIELD_INFO_END_MAC
...
/* ingress UDB only key 30 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_INGRESS_UDB_ONLY_30_sip7[] =
{
    /*udb 0-29*/
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[0],      0,   240),
    CPSS_FORMAT_CONVERT_FIELD_INFO_END_MAC
...
/* ingress UDB only key 40 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_INGRESS_UDB_ONLY_40_sip7[] =
{
    /*udb 0-39*/
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[0],        0,   240),
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[30],     240,    80),
...
/* ingress UDB only key 50 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_INGRESS_UDB_ONLY_50_sip7[] =
{
    /*udb 0-49*/
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[0],        0,   240),
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[30],     240,   160),
...
/* ingress UDB only key 60 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_INGRESS_UDB_ONLY_60_sip7[] =
{
    /*udb 0-49*/
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[0],        0,   240),
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[30],     240,   240),
...
/* ingress UDB only key 80 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_INGRESS_UDB_ONLY_80_sip7[] =
{
    /*udb 0-69*/
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[0],          0,   240),
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[30],       240,   240),
    I_FAS_MAC(F_INGR_UDB_ONLY,   udb[60],       480,   160),
    CPSS_FORMAT_CONVERT_FIELD_INFO_END_MAC
};

/* egress UDB only key 10 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_EGRESS_UDB_ONLY_10_sip7[] =
{
    /*udb 0-9*/
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[0],      0,   80),
    CPSS_FORMAT_CONVERT_FIELD_INFO_END_MAC
...
/* egress UDB only key 20 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_EGRESS_UDB_ONLY_20_sip7[] =
{
    /*udb 0-19*/
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[0],      0,   160),
    CPSS_FORMAT_CONVERT_FIELD_INFO_END_MAC
...
/* egress UDB only key 30 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_EGRESS_UDB_ONLY_30_sip7[] =
{
    /*udb 0-29*/
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[0],      0,   240),
    CPSS_FORMAT_CONVERT_FIELD_INFO_END_MAC
...
/* egress UDB only key 40 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_EGRESS_UDB_ONLY_40_sip7[] =
{
    /*udb 0-39*/
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[0],        0,   240),
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[30],     240,    80),
...
/* egress UDB only key 50 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_EGRESS_UDB_ONLY_50_sip7[] =
{
    /*udb 0-49*/
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[0],        0,   240),
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[30],     240,   160),
...
/* egress UDB only key 60 bytes */
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_EGRESS_UDB_ONLY_60_sip7[] =
{
    /*udb 0-49*/
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[0],        0,   240),
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[30],     240,   240),
...
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC fmtFld_EGRESS_UDB_ONLY_80_sip7[] =
{
    /*udb 0-59*/
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[0],        0,   240),
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[30],     240,   240),
    I_FAS_MAC(F_EGR_UDB_ONLY,   udb[60],     480,   160),
    CPSS_FORMAT_CONVERT_FIELD_INFO_END_MAC
};
...
/* AAS and above MPCL */
static const PRV_PCL_CFG_LOOKUP_POS_STC prvCpssDxChPclCfgTblHwSip7MidwayPos =
{
    0,     1,     /*enableLookupOff/len   */
    1,    12,     /*pclIdOff/Len          */
    0xFF,  0,     /*nonIpKeyTypeOff/Len   */    /* not-relevant*/
    0xFF,  0,     /*ipv4KeyTypeOff/Len    */    /* not-relevant*/
    0xFF,  0,     /*ipv6KeyTypeOff/Len    */    /* not-relevant*/
    0xFF,  0,     /*dualLookupOff/Len     */    /* not-relevant*/
    0xFF,  0,     /*pclIdL01Off/Len       */    /* not-relevant*/
    13,    1,     /*udbKeyBitmapEnable/Len*/
    0xFF,  0,     /*tcamSegmentMode/Len   */
    14,    4,     /*exactMatchLookupSubProfileIdOff/Len*/
    0xFF,  0      /*pclIdExtensionOff/Len sip6_10 */ /* not-relevant */
};

/* AAS and above EPCL */
static const PRV_PCL_CFG_LOOKUP_POS_STC prvCpssDxChPclCfgTblHwSip7EgrPos =
{
    0,     1,     /*enableLookupOff/len   */
    1,    10,     /*pclIdOff/Len          */
    0xFF,  0,     /*nonIpKeyTypeOff/Len   */    /* not-relevant*/
    ...
    0xFF,  0,     /*dualLookupOff/Len     */    /* not-relevant*/
    0xFF,  0,     /*pclIdL01Off/Len       */    /* not-relevant*/
    14,    1,     /*udbKeyBitmapEnable/Len*/
    11,    3,     /*tcamSegmentMode/Len   */
    15,    4,     /*exactMatchLookupSubProfileIdOff/Len*/
    0xFF,  0      /*pclIdExtensionOff/Len sip6_10 */ /* not-relevant */
};
...
static const CPSS_FORMAT_CONVERT_FIELD_INFO_STC* const fmtFldArr_sip7[] = {
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_STD_NOT_IP_E                  */   /*0*/
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_STD_IP_L2_QOS_E               */   /*1*/
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_STD_IPV4_L4_E                 */   /*2*/
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_STD_IPV6_DIP_E                */   /*3*/
        ...
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_STD_UDB_E                     */   /*13*/
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_EXT_UDB_E                     */   /*14*/
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_STD_IPV4_ROUTED_ACL_QOS_E     */   /*15*/
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_EXT_IPV4_PORT_VLAN_QOS_E      */   /*16*/
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_ULTRA_IPV6_PORT_VLAN_QOS_E    */   /*17*/
        NULL, /*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_ULTRA_IPV6_ROUTED_ACL_QOS_E   */   /*18*/
        NULL,/*CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_EXT_IPV4_RACL_VACL_E            */   /*19*/
        NULL,/*CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_ULTRA_IPV6_RACL_VACL_E          */   /*20*/
        fmtFld_INGRESS_UDB_ONLY_10_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_10_E*/   /*21*/
        fmtFld_INGRESS_UDB_ONLY_20_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_20_E*/   /*22*/
        fmtFld_INGRESS_UDB_ONLY_30_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_30_E*/   /*23*/
        fmtFld_INGRESS_UDB_ONLY_40_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_40_E*/   /*24*/
        fmtFld_INGRESS_UDB_ONLY_50_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_50_E*/   /*25*/
        fmtFld_INGRESS_UDB_ONLY_60_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_60_E*/   /*26*/
        fmtFld_EGRESS_UDB_ONLY_10_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_10_E */   /*27*/
        fmtFld_EGRESS_UDB_ONLY_20_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_20_E */   /*28*/
        fmtFld_EGRESS_UDB_ONLY_30_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_30_E */   /*29*/
        fmtFld_EGRESS_UDB_ONLY_40_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_40_E */   /*30*/
        fmtFld_EGRESS_UDB_ONLY_50_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_50_E */   /*31*/
        fmtFld_EGRESS_UDB_ONLY_60_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_60_E */   /*32*/
        fmtFld_INGRESS_UDB_ONLY_60_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_60_NO_FIXED_FIELDS_E*/   /*33*/
        fmtFld_INGRESS_UDB_ONLY_80_sip7,/*CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_80_E*/   /*34*/
        fmtFld_EGRESS_UDB_ONLY_60_sip7,/* CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_60_NO_FIXED_FIELDS_E */ /*35*/
        fmtFld_EGRESS_UDB_ONLY_80_sip7 /* CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_80_E */ /*36*/
};
...
/* macro to get value to field of (IPCL) SIP6_IPCL_ACTION entry format in buffer */
/* _fieldName of type SIP6_IPCL_ACTION_TABLE_FIELDS_ENT */
#define SIP6_IPCL_ACTION_FIELD_GET_MAC(_dev,_hwDataArr,_fieldName,_value)       \
        U32_GET_FIELD_BY_ID_MAC(_hwDataArr,                                     \
        PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_IPCL_ACTION_E].fieldsInfoPtr, \
        _fieldName,                                                             \
        _value)
...
/* macro to set value to field of (MPCL) SIP7_MPCL_ACTION entry format in buffer */
/* _fieldName of type SIP7_MPCL_ACTION_TABLE_FIELDS_ENT */
#define SIP7_MPCL_ACTION_FIELD_SET_MAC(_dev,_hwDataArr,_fieldName,_value)       \
        U32_SET_FIELD_BY_ID_MAC(_hwDataArr,                                     \
        PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_MPCL_ACTION_E].fieldsInfoPtr, \
        _fieldName,                                                             \
        _value)

/* macro to get value to field of (MPCL) SIP7_MPCL_ACTION entry format in buffer */
/* _fieldName of type SIP7_MPCL_ACTION_TABLE_FIELDS_ENT */
#define SIP7_MPCL_ACTION_FIELD_GET_MAC(_dev,_hwDataArr,_fieldName,_value)       \
        U32_GET_FIELD_BY_ID_MAC(_hwDataArr,                                     \
        PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_MPCL_ACTION_E].fieldsInfoPtr, \
        _fieldName,                                                             \
        _value)

/* macro to get specific mask value of a field in MPCL Action */
#define SIP7_MPCL_ACTION_FIELD_SPECIFIC_MAX_VAL_GET_MAC(_dev,_fieldName,_fieldMask, _value)             \
        U32_GET_FIELD_MAX_VAL_BY_ID_MAC(                                                                \
        PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_MPCL_ACTION_E].fieldsInfoPtr,            \
        _fieldName,                                                                                     \
        _value);                                                                                        \
...
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
*
...
* @note   NOT APPLICABLE DEVICES:  Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
*
...
)
{
    ...
    if (swActionPtr->egressPolicy == CPSS_PCL_DIRECTION_EGRESS_E)
    {
...
)
{
        ...
        case CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_OUT_IF_E:
            ...
            switch (swActionPtr->redirect.data.outIf.outInterface.type)
            {
                case CPSS_INTERFACE_PORT_E:
                    ...
                    isVPort = PRV_CPSS_DXCH_IS_VPORT(devNum,swActionPtr->redirect.data.outIf.outInterface.devPort.portNum);
                    if(isVPort)
                    {
                        value = 1;
                        SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                            SIP7_IPCL_ACTION_TABLE_FIELDS_USE_TARGET_VPORT_E,
                            value);

                            value = swActionPtr->redirect.data.outIf.outInterface.devPort.portNum;
                        SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                            SIP7_IPCL_ACTION_TABLE_FIELDS_TRG_VPORT_E,
                            value);
                    }
                    else
                    {
    ...
    case CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_ROUTER_E:
            ...
            if (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == 0)
            {
                if(GT_TRUE == PRV_CPSS_DXCH_ERRATA_GET_MAC(
                    devNum, PRV_CPSS_DXCH_BOBCAT2_PBR_PACKETS_TREATED_AS_UNKNOWN_DA_WA_E)){
                    SIP5_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        ...
        case CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_REPLACE_MAC_SA_E:
            ...
            if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                ...
                SIP6_IPCL_ACTION_FIELD_SET_MAC(
                    devNum, hwActionPtr,
                    SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_31_0_E,
                    value);
                /* MAC_SA_47_32 - 16 bits */
                value = 0x0000FFFF &
                    (swActionPtr->redirect.data.modifyMacSa.macSa.arEther[1]
                    | (swActionPtr->redirect.data.modifyMacSa.macSa.arEther[0] << 8));
                SIP6_IPCL_ACTION_FIELD_SET_MAC(
                    devNum, hwActionPtr,
                    SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_47_32_E,
                    value);
            }
        ...
        case CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_ROUTER_AND_ASSIGN_VRF_ID_E:
            ...
            rc = prvCpssDxChLpmLeafEntryCalcLpmHwIndexFromSwIndex(devNum,swActionPtr->redirect.data.routerLttIndex,&value);
            if (rc != GT_OK)
            {
                return rc;
            }
    ...
    if(useIpclProfileIndexAndEnablers == GT_TRUE)
    {
        ...
        {
            value =
                (swActionPtr->lookupConfig.mpclOverrideConfigIndex ==
                 CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E) ? 1 : 0;
            SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                SIP7_IPCL_ACTION_TABLE_FIELDS_MIDWAY_LOOKUP_MODE_E,
                value);
        }
    }
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        value = BOOL2BIT_MAC(swActionPtr->cancelDrop);
        SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_IPCL_ACTION_TABLE_FIELDS_CANCEL_DROP_E,
            value);
    }
    ...
    isVPort = PRV_CPSS_DXCH_IS_VPORT(devNum,swActionPtr->sourcePort.sourcePortValue);
    if (isVPort)
    {
        value = BOOL2BIT_MAC(swActionPtr->sourcePort.assignSourcePortEnable);
        SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_IPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_ASSIGN_EN_E,
            value);

        value = swActionPtr->sourcePort.sourcePortValue;
        SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_IPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_E,
            value);
    }
    else
    {
        if(PRV_CPSS_DXCH_PP_MAC(devNum)->vportInfo.useVPortMode == GT_TRUE &&
           swActionPtr->sourcePort.assignSourcePortEnable == GT_TRUE)
        {
            /* the limit needed to not collide with : assignSourceVPortProfileEnable == GT_TRUE
                that need to use the same field of SIP5_IPCL_ACTION_TABLE_FIELDS_SRC_EPORT_E
                this system not need to work with ePorts so , not expected to reassign to new srcePort
            */

            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM,
                "'vPort mode' : not allow assignSourcePortEnable == GT_TRUE with sourcePortValue[%d] that is not in 'vPort range' ",
                    swActionPtr->sourcePort.sourcePortValue);
        }
    ...
    if(PRV_CPSS_DXCH_PP_MAC(devNum)->vportInfo.useVPortMode == GT_TRUE &&
        swActionPtr->sourcePort.assignSourceVPortProfileEnable == GT_TRUE)
    {
        /* the 'src eport' field hold the 'vPort profile' !!! */
        value = swActionPtr->sourcePort.sourceVPortProfileValue;
        SIP5_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP5_IPCL_ACTION_TABLE_FIELDS_SRC_EPORT_E,
            value);

        CPSS_TBD_BOOKMARK_AAS
        /* Cider not defined yet the field for <assignSourceVPortProfileEnable> */
    }
    ...
    if (PRV_CPSS_SIP_6_CHECK_MAC(devNum))
    {
        ...
        if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            value = BOOL2BIT_MAC(swActionPtr->exactMatchDisable);
            SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                SIP7_IPCL_ACTION_TABLE_FIELDS_DISABLE_EM_LOOKUP_E,
                value);
        }
    ...
    if (PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
    {
        ...
        /* Assign Tag1 from UDBs. Use copyUdb starting from IronMan */
        value = PRV_CPSS_SIP_6_30_CHECK_MAC(devNum) ?
                    BOOL2BIT_MAC(swActionPtr->vlan.ingress.copyUdb) :
                    BOOL2BIT_MAC(swActionPtr->vlan.ingress.updateTag1FromUdb);
        SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
    ...
    /* From SIP7, <copyReserved> action is obsoleted */
    if(!PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
...
/**
* @internal sip7PclTcamRuleMidwayActionSw2HwConvert function
* @endinternal
*
* @brief   Converts TCAM Midway Action from SW to HW format - AAS
*
...
* @retval GT_OUT_OF_RANGE          - one of the parameters is out of range.
*/
static GT_STATUS sip7PclTcamRuleMidwayActionSw2HwConvert
(
    IN  GT_U8                         devNum,
    IN  CPSS_DXCH_PCL_ACTION_STC      *swActionPtr,
    OUT GT_U32                        *hwActionPtr
)
{
    ...
    if (0 == PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_NOT_APPLICABLE_DEVICE, LOG_ERROR_NO_MSG);
    }
    /* clear */
    ...
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_COMMAND_E,
        value);
    ...
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_CPU_CODE_E,
        value);
    ...
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_MIRROR_TO_ANALYZER_PORT_E,
        value);
    ...
    switch(swActionPtr->redirect.redirectCmd)
    {
        ...
        case CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_OUT_IF_E:
            ...
            switch (swActionPtr->redirect.data.outIf.outInterface.type)
            {
                case CPSS_INTERFACE_PORT_E:
                    value = 0;
                    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                        SIP7_MPCL_ACTION_TABLE_FIELDS_USE_VIDX_E,
                        value);

                    value = 0;
                    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                        SIP7_MPCL_ACTION_TABLE_FIELDS_IS_TRUNK_E,
                        value);
                    ...
                    if(isVPort)
                    {
                        value = 1;
                        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                            SIP7_MPCL_ACTION_TABLE_FIELDS_USE_TARGET_VPORT_E,
                            value);

                            value = swActionPtr->redirect.data.outIf.outInterface.devPort.portNum;
                        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                            SIP7_MPCL_ACTION_TABLE_FIELDS_TRG_VPORT_E,
                            value);
                    }
                    else
                    {
                        value = swActionPtr->redirect.data.outIf.outInterface.devPort.portNum;
                        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                            SIP7_MPCL_ACTION_TABLE_FIELDS_TRG_PORT_E,
                            value);

                        value = swActionPtr->redirect.data.outIf.outInterface.devPort.hwDevNum;
                        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                            SIP7_MPCL_ACTION_TABLE_FIELDS_TARGET_DEVICE_E,
                            value);
                    }
                ...
                case  CPSS_INTERFACE_TRUNK_E:
                    ...
                    value = swActionPtr->redirect.data.outIf.outInterface.trunkId;
                    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                        SIP7_MPCL_ACTION_TABLE_FIELDS_TRUNK_ID_E,
                        value);
                    break;
                ...
                case CPSS_INTERFACE_VID_E:
                    ...
                    value = (swActionPtr->redirect.data.outIf.outInterface.type == CPSS_INTERFACE_VID_E) ?
                        ...
                        swActionPtr->redirect.data.outIf.outInterface.vidx;
                    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                        SIP7_MPCL_ACTION_TABLE_FIELDS_VIDX_E,
                        value);
                    break;
                default:
                    CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
            ...
            value = BOOL2BIT_MAC(swActionPtr->redirect.data.outIf.tunnelStart);
            SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                SIP7_MPCL_ACTION_TABLE_FIELDS_TUNNEL_START_E,
                value);
            ...
            if (value)/* tunnel start */
            {
                ...
                value = swActionPtr->redirect.data.outIf.tunnelPtr;
                SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                    SIP7_MPCL_ACTION_TABLE_FIELDS_TUNNEL_POINTER_E,
                    value);
                ...
                SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                    SIP7_MPCL_ACTION_TABLE_FIELDS_TUNNEL_START_PASSENGER_TYPE_E,
                    value);
            ...
            else    /*ARP pointer*/
            {
                ...
                value = swActionPtr->redirect.data.outIf.arpPtr;
                SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                    SIP7_MPCL_ACTION_TABLE_FIELDS_ARP_POINTER_E,
                    value);
            }

            value = BOOL2BIT_MAC(swActionPtr->redirect.data.outIf.modifyMacSa);
            SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                SIP7_MPCL_ACTION_TABLE_FIELDS_MODIFY_MAC_SA_E,
                value);
        ...
        case CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_ASSIGN_GENERIC_ACTION_E:
            ...
            SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
                SIP7_MPCL_ACTION_TABLE_FIELDS_GENERIC_ACTION_E,
                value);
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    ...
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_REDIRECT_COMMAND_E,
        redirectCmd);

    /* EPCL CFG table index force */
    value =
        (swActionPtr->lookupConfig.epclOverrideConfigIndex ==
         CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E) ? 1 : 0;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_EPCL_LOOKUP_MODE_E,
        value);

    value = swActionPtr->lookupConfig.ipclConfigIndex;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_EPCL_CONFIGURATION_INDEX_E,
        value);


    value = BOOL2BIT_MAC(swActionPtr->matchCounter.enableMatchCount);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_ACTIVATE_COUNTER_E,
        value);

    value = swActionPtr->matchCounter.matchCounterIndex;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_COUNTER_INDEX_E,
        value);
    ...
    if (usePolicer != GT_FALSE)
    {
        ...
        value = policerMeterEn;
        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_ACTIVATE_METER_E,
            value);

        value = policerCounterEn;
        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_BIND_TO_POLICER_COUNTER_E,
            value);

        value = swActionPtr->policer.policerId;
        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_POLICER_PTR_E,
            value);
    }

    value = BOOL2BIT_MAC(swActionPtr->sourceId.assignSourceId);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_SET_SST_ID_E,
        value);

    value = swActionPtr->sourceId.sourceIdValue;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_SST_ID_E,
        value);

    value = BOOL2BIT_MAC(swActionPtr->actionStop);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_ACTION_STOP_E,
        value);

    value = BOOL2BIT_MAC(swActionPtr->cancelDrop);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_CANCEL_DROP_E,
        value);

    value = BOOL2BIT_MAC(swActionPtr->vlan.ingress.nestedVlan);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_EN_NESTED_VLAN_E,
        value);
    ...
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_VLAN_COMMAND_E,
        value);

    value = swActionPtr->vlan.ingress.vlanId;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_VID0_E,
        value);

    value = BOOL2BIT_MAC(swActionPtr->qos.ingress.profileAssignIndex);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_QOS_PROFILE_MARKING_ENABLE_E,
        value);

    value = swActionPtr->qos.ingress.profileIndex;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_QOS_PROFILE_E,
        value);
    ...
    PRV_CPSS_PCL_CONVERT_ATTR_MODIFY_TO_HW_VAL_MAC(
        value, swActionPtr->qos.ingress.modifyDscp);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_MODIFY_DSCP_E,
        value);
    ...
    PRV_CPSS_PCL_CONVERT_ATTR_MODIFY_TO_HW_VAL_MAC(
        value, swActionPtr->qos.ingress.modifyUp);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_MODIFY_UP_E,
        value);

    value = BOOL2BIT_MAC(swActionPtr->mirror.mirrorTcpRstAndFinPacketsToCpu);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_ENABLE_MIRROR_TCP_RST_OR_FIN_E,
        value);

    value = BOOL2BIT_MAC(swActionPtr->redirect.data.outIf.modifyMacDa);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_MODIFY_MAC_DA_E,
        value);
    ...
    if(swActionPtr->redirect.redirectCmd != CPSS_DXCH_PCL_ACTION_REDIRECT_CMD_OUT_IF_E)
    {
        ...
        /*value = 0;
        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_SET_EGRESS_FILTER_REGISTERED_E,
            value);*/
    }
    ...
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_VLAN1_CMD_E,
        value);
    ...
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_UP1_CMD_E,
        value);

    value = swActionPtr->vlan.ingress.vlanId1;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_VID1_E,
        value);

    value = swActionPtr->qos.ingress.up1;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_UP1_E,
        value);

    value = swActionPtr->flowId;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_FLOW_ID_E,
        value);

    value = BOOL2BIT_MAC(swActionPtr->oam.timeStampEnable);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_TIMESTAMP_EN_E,
        value);

    value = swActionPtr->oam.offsetIndex;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_OFFSET_INDEX_E,
        value);

    value = BOOL2BIT_MAC(swActionPtr->oam.oamProcessEnable);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_OAM_PROCESSING_EN_E,
        value);

    value = swActionPtr->oam.oamProfile;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_OAM_PROFILE_E,
        value);
    ...
    if (isVPort)
    {
        value = BOOL2BIT_MAC(swActionPtr->sourcePort.assignSourcePortEnable);
        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_ASSIGN_EN_E,
            value);

        value = swActionPtr->sourcePort.sourcePortValue;
        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_E,
            value);
    }
    else
    {
        ...
        {
            /* the limit needed to not collide with : assignSourceVPortProfileEnable == GT_TRUE
                that need to use the same field of SIP7_MPCL_ACTION_TABLE_FIELDS_SRC_EPORT_E
                this system not need to work with ePorts so , not expected to reassign to new srcePort
            */
        ...
        value = BOOL2BIT_MAC(swActionPtr->sourcePort.assignSourcePortEnable);
        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_ASSIGN_SRC_EPORT_EN_E,
            value);

        value = swActionPtr->sourcePort.sourcePortValue;
        SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_SRC_EPORT_E,
            value);
    }
    ...
    value = BOOL2BIT_MAC(swActionPtr->triggerInterrupt);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_TRIGGER_INTERRUPT_EN_E,
        value);

    value = BOOL2BIT_MAC(swActionPtr->latencyMonitor.monitoringEnable);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_LATENCY_MONITORING_ENABLE_E,
        value);

    value = swActionPtr->latencyMonitor.latencyProfile;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_LATENCY_PROFILE_E,
        value);

    value = swActionPtr->ipfixEnable;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_IPFIX_ENABLE_E,
        value);

    /* cfi0 */
    PRV_CPSS_PCL_CONVERT_ATTR_CFI_TO_HW_VAL_MAC(value, swActionPtr->vlan.ingress.cfi0);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_TAG0_DEI_CFI_VALUE_E,
            value);

    /* cfi1 */
    PRV_CPSS_PCL_CONVERT_ATTR_CFI_TO_HW_VAL_MAC(value, swActionPtr->vlan.ingress.cfi1);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
            SIP7_MPCL_ACTION_TABLE_FIELDS_TAG1_DEI_CFI_VALUE_E,
            value);

    /* Assign Tag1 from UDBs. Use copyUdb starting from IronMan */
    value = BOOL2BIT_MAC(swActionPtr->vlan.ingress.copyUdb);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_ASSIGN_TAG1_FROM_UDBS_E,
        value);

    /* Assign Trigger Hash Cnc Client */
    value = BOOL2BIT_MAC(swActionPtr->triggerHashCncClient);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
       SIP7_MPCL_ACTION_TABLE_FIELDS_FLOW_TRACK_ENABLE_E,
       value);

    value = BOOL2BIT_MAC(swActionPtr->copyReserved.assignEnable);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
       SIP7_MPCL_ACTION_TABLE_FIELDS_IPCL_RESERVED_EN_E,
       value);
    copyReservedMask = BIT_19;
    if (swActionPtr->copyReserved.copyReserved >= copyReservedMask)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, LOG_ERROR_NO_MSG);
    }

    value = swActionPtr->copyReserved.copyReserved << 1;
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
       SIP7_MPCL_ACTION_TABLE_FIELDS_IPCL_TO_TXQ_RESERVED_E,
       value);

    value = BOOL2BIT_MAC(swActionPtr->exactMatchDisable);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_DISABLE_EM_LOOKUP_E,
        value);

    value = BOOL2BIT_MAC(
        swActionPtr->headerAlterationOptions.routerTtlDecrementDisable);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_CANCEL_DECREMENT_TTL_E,
        value);

    value = BOOL2BIT_MAC(
        swActionPtr->headerAlterationOptions.routerMacSaAssignmentDisable);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_CANCEL_ROUTE_HA_E,
        value);

    value = BOOL2BIT_MAC(
        swActionPtr->headerAlterationOptions.routerMacDaAndIpHeaderModificationsDisable);
    SIP7_MPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_CANCEL_ROUTED_E,
        value);
...
)
{
    ...
    if (PRV_CPSS_SIP_6_CHECK_MAC(devNum))
    {
        ...
        switch(swActionPtr->epclPhaInfo.phaThreadType)
        {
            ...
            case CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ENHANCED_SFLOW_E:
                ...
                break;
            case CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_IFA_E:
                /******************************************/
                /* check that the PHA LIB was initialized */
                /******************************************/
                PRV_CPSS_DXCH_PHA_LIB_INIT_CHECK_MAC(devNum);
                value = 1;
                if(swActionPtr->epclPhaInfo.phaThreadUnion.epclIfaFlow.flowId >= PRV_CPSS_DXCH_PHA_THREAD_IFA_FLOW_INDEX_CNS)
                {
                    CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, "flow index must be in range 0-511 and not [%d]\n",
                                                  swActionPtr->epclPhaInfo.phaThreadUnion.epclIfaFlow.flowId);
                }
                value2 = swActionPtr->epclPhaInfo.phaThreadUnion.epclIfaFlow.flowId;
                break;
            case CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ROUTER_SA_MODIFICATION_E:
                /******************************************/
                /* check that the PHA LIB was initialized */
                /******************************************/
                PRV_CPSS_DXCH_PHA_LIB_INIT_CHECK_MAC(devNum);
                ...
                value2 = swActionPtr->epclPhaInfo.phaThreadUnion.epclRouterSaModification.macSaLsb;
                break;
            case CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_VXLAN_DCI_VNI_REMAP_E:
                /******************************************/
                /* check that the PHA LIB was initialized */
                /******************************************/
                PRV_CPSS_DXCH_PHA_LIB_INIT_CHECK_MAC(devNum);
                value = 1;
                if(swActionPtr->epclPhaInfo.phaThreadUnion.epclVxlanVni.vxlanVni >
                   PRV_CPSS_DXCH_PHA_THREAD_VXLAN_DCI_VNI_REMAP_MAX_VNI_CNS)
                {
                    CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, "VNI must be in range 0-%d and not [%d]\n",
                                                  PRV_CPSS_DXCH_PHA_THREAD_VXLAN_DCI_VNI_REMAP_MAX_VNI_CNS,
                                                  swActionPtr->epclPhaInfo.phaThreadUnion.epclVxlanVni.vxlanVni);
                }

                value2 = swActionPtr->epclPhaInfo.phaThreadUnion.epclVxlanVni.vxlanVni;
                break;
    ...
    */
    ...
    /* the field not implemented in SIP7 */
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == 0)
    {
        value = swActionPtr->oam.offsetIndex;
        SIP5_EPCL_ACTION_FIELD_SET_MAC(devNum,hwActionPtr,
...
)
{
    ...
    if (PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_ENABLED_MAC(devNum) == GT_TRUE)
    {
        if(swActionPtr->egressPolicy != CPSS_PCL_DIRECTION_EGRESS_E)
        {
            ...
            if (swActionPtr->egressPolicy == CPSS_PCL_DIRECTION_MIDWAY_E)
            {
                return sip7PclTcamRuleMidwayActionSw2HwConvert(devNum,
    ...
    if ((swActionPtr->policer.policerEnable != CPSS_DXCH_PCL_POLICER_DISABLE_ALL_E)  &&
       (swActionPtr->egressPolicy != CPSS_PCL_DIRECTION_EGRESS_E)   &&
       (swActionPtr->ipUcRoute.doIpUcRoute == GT_FALSE) )
    {
        /* policer enable */
        hwActionPtr[2] |= 1;
...
)
{
    ...
    if (pclExpandedActionOriginPtr->overwriteExpandedActionEgressInterface==GT_TRUE)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    SIP6_IPCL_ACTION_FIELD_SPECIFIC_MAX_VAL_GET_MAC(devNum,
                                                                    SIP6_IPCL_ACTION_TABLE_FIELDS_TRG_PORT_E,
                                                                    ((pclExpandedActionOriginPtr->egressInterfaceMask) & 0xFFFF),
                                                                    value);
                    SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,
                                                   exactMatchReducedHwMaskArray,
                                                   SIP6_IPCL_ACTION_TABLE_FIELDS_TRG_PORT_E,
                                                   value);
                    /* Mask must include the first byte since the isTrunk bit  and the useVidx bit are located
                       ...
                       is no issue, all bytes are taken */
                    if (((pclExpandedActionOriginPtr->egressInterfaceMask & 0xFFFF) != 0) &&
                        ((pclExpandedActionOriginPtr->egressInterfaceMask & 0xFFFF) <= value) &&
                        ((pclExpandedActionOriginPtr->egressInterfaceMask & 0x3F)==0))
                    {
                        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
                    }
                    ...
                    if((pclExpandedActionOriginPtr->egressInterfaceMask == 0) ||
                       (((pclExpandedActionOriginPtr->egressInterfaceMask) >> 16) & 0xFFFF))
                    {
                        SIP6_IPCL_ACTION_FIELD_SPECIFIC_MAX_VAL_GET_MAC(devNum,
    ...
    if (pclExpandedActionOriginPtr->overwriteExpandedActionMacSa==GT_TRUE)
    {
        ...
        {
            GT_U32 macSa_31_0  =
                pclExpandedActionOriginPtr->macSa_27_0_Mask |
                ((pclExpandedActionOriginPtr->macSa_47_28_Mask & 0xF) << 28);
            GT_U32 macSa_47_32 =
                ((pclExpandedActionOriginPtr->macSa_47_28_Mask >> 4) & 0xFFFF);
            SIP6_IPCL_ACTION_FIELD_SPECIFIC_MAX_VAL_GET_MAC(
                devNum, SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_31_0_E,
                (macSa_31_0), value);
            SIP6_IPCL_ACTION_FIELD_SET_MAC(
                devNum,exactMatchReducedHwMaskArray,
                SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_31_0_E,
                value);
            SIP6_IPCL_ACTION_FIELD_SPECIFIC_MAX_VAL_GET_MAC(
                devNum, SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_47_32_E,
                (macSa_47_32), value);
            SIP6_IPCL_ACTION_FIELD_SET_MAC(
                devNum,exactMatchReducedHwMaskArray,
                SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_47_32_E,
        ...
        {
            SIP6_IPCL_ACTION_FIELD_SPECIFIC_MAX_VAL_GET_MAC(
                devNum, SIP6_IPCL_ACTION_TABLE_FIELDS_MAC_SA_27_0_E,
                (pclExpandedActionOriginPtr->macSa_27_0_Mask), value);
            SIP6_IPCL_ACTION_FIELD_SET_MAC(
                devNum,exactMatchReducedHwMaskArray,
                SIP6_IPCL_ACTION_TABLE_FIELDS_MAC_SA_27_0_E,
                value);
            SIP6_IPCL_ACTION_FIELD_SPECIFIC_MAX_VAL_GET_MAC(
                devNum, SIP6_IPCL_ACTION_TABLE_FIELDS_MAC_SA_47_28_E,
                (pclExpandedActionOriginPtr->macSa_47_28_Mask), value);
            SIP6_IPCL_ACTION_FIELD_SET_MAC(
                devNum,exactMatchReducedHwMaskArray,
    ...
    if (PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
    {
        if (pclExpandedActionOriginPtr->overwriteExpandedActionGenericAction == GT_TRUE)
        {
            SIP6_IPCL_ACTION_FIELD_SPECIFIC_MAX_VAL_GET_MAC(devNum, SIP6_30_IPCL_ACTION_TABLE_FIELDS_GENERIC_ACTION_E,(pclExpandedActionOriginPtr->genericActionMask), value);
            SIP6_IPCL_ACTION_FIELD_SET_MAC(devNum,exactMatchReducedHwMaskArray,
                                       SIP6_30_IPCL_ACTION_TABLE_FIELDS_GENERIC_ACTION_E,
                                       value);
        }
    ...
    /* From SIP7, <copyReserved> action is obsoleted */
    if (pclExpandedActionOriginPtr->overwriteExpendedActionCopyReserved==GT_TRUE && (!PRV_CPSS_SIP_7_CHECK_MAC(devNum)))
    {
...
)
{
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == 0)
    {
        if (pclExpandedActionOriginPtr->overwriteExpandedActionOamOffsetIndex==GT_TRUE)
        {
            SIP6_EPCL_ACTION_FIELD_SPECIFIC_MAX_VAL_GET_MAC(
                devNum, SIP5_EPCL_ACTION_TABLE_FIELDS_TIME_STAMP_OFFSET_INDEX_E,
                (pclExpandedActionOriginPtr->oamOffsetIndexMask), value);
            SIP5_EPCL_ACTION_FIELD_SET_MAC(
                devNum,exactMatchReducedHwMaskArray,
                SIP5_EPCL_ACTION_TABLE_FIELDS_TIME_STAMP_OFFSET_INDEX_E, value);
        }
    }
    /* the field not implemented in SIP7 */
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == 0)
    {
        ...
        {
            SIP6_EPCL_ACTION_FIELD_MAX_VAL_GET_MAC(
                devNum, SIP5_EPCL_ACTION_TABLE_FIELDS_CHANNEL_TYPE_TO_OPCODE_MAPPING_EN_E, value);
            SIP5_EPCL_ACTION_FIELD_SET_MAC(
                devNum,exactMatchReducedHwMaskArray,
                SIP5_EPCL_ACTION_TABLE_FIELDS_CHANNEL_TYPE_TO_OPCODE_MAPPING_EN_E, value);
        }
    }
...
)
{
    ...
    *flowIdFoundPtr = GT_FALSE;
    ...
    if(logicFormatPtr->egressPolicy != CPSS_PCL_DIRECTION_EGRESS_E)
    {
        ...
        if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            /* flow-id is in bits [192..210]                 W=(192/8)/4=6 */
            U32_SET_FIELD_MAC(value, 0, 19, exactMatchReducedHwMaskArray[6]);
            if (value != 0)
            {
                /* flow-id should be set in the reduced action */
                *flowIdLocationByteStartPtr = 24; /* 192/8 */
    ...
    else
    {
        ...
        if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            /* flow-id is in bits [56..74]                  (56/8)/4=7/4=1+3/4 */
            U32_SET_FIELD_MAC(value, 0, 19, exactMatchReducedHwMaskArray[1] >> 24);
            if (value != 0)
            {
                /* flow-id should be set in the reduced action */
                *flowIdLocationByteStartPtr = 7; /* 56/8 */
                *flowIdFoundPtr = GT_TRUE;
                *flowIdLocationBitStartInBytePtr = 0;
            }
        }
...
)
{
    ...
    swActionPtr->egressPolicy = CPSS_PCL_DIRECTION_INGRESS_E;
    swActionPtr->ipUcRoute.doIpUcRoute = GT_FALSE;
    ...
    PRV_CPSS_PCL_CONVERT_HW_VAL_TO_ATTR_ASSIGN_MAC(
...
)
{
    ...
    switch(value)
    {
        ...
        case 1:
            ...
            if(value == 0)
            {
                ...
                {/*port*/
                    if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
                    {
                        SIP6_IPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
                            SIP7_IPCL_ACTION_TABLE_FIELDS_USE_TARGET_VPORT_E,
                            value);
                        isVPort = value;
                    }
                    ...
                    if(isVPort)
                    {
                        ...
                        swActionPtr->redirect.data.outIf.outInterface.devPort.hwDevNum = CPSS_PARAM_NOT_USED_CNS;
                    }
                    else
                    {
                        SIP5_IPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
            ...
            {  /*vidx/vid*/
                ...
                else
                {
                    ...
                    swActionPtr->redirect.data.outIf.outInterface.vidx = value;
                }
            }
        ...
        case 6:
            ...
            if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                SIP6_IPCL_ACTION_FIELD_GET_MAC(
                     devNum, hwActionPtr,
                     SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_31_0_E,
                     value);
                ...
                swActionPtr->redirect.data.modifyMacSa.macSa.arEther[2] = (GT_U8)((value >> 24) & 0xFF);
                SIP6_IPCL_ACTION_FIELD_GET_MAC(
                     devNum, hwActionPtr,
                     SIP7_IPCL_ACTION_TABLE_FIELDS_MAC_SA_47_32_E,
                     value);
                swActionPtr->redirect.data.modifyMacSa.macSa.arEther[1]  = (GT_U8)(value & 0xFF);
                swActionPtr->redirect.data.modifyMacSa.macSa.arEther[0]  = (GT_U8)((value >> 8) & 0xFF);
            }
            else if (!PRV_CPSS_SIP_5_20_CHECK_MAC(devNum))
            {
                SIP5_IPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
    ...
    if(useIpclProfileIndexAndEnablers == GT_TRUE)
    {
        ...
        if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            SIP6_IPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
                SIP7_IPCL_ACTION_TABLE_FIELDS_MIDWAY_LOOKUP_MODE_E,
                value);
            swActionPtr->lookupConfig.mpclOverrideConfigIndex = value ?
                CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E :
                CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_RETAIN_E;
        }
    }
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        SIP6_IPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
            SIP7_IPCL_ACTION_TABLE_FIELDS_CANCEL_DROP_E,
            value);
        swActionPtr->cancelDrop = BIT2BOOL_MAC(value);
    }
    ...
    if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        ...
        if(swActionPtr->sourcePort.assignSourcePortEnable == GT_TRUE && isVPort)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_STATE,
                "src interface assign can't be ePort and vPort together");
        }

        CPSS_TBD_BOOKMARK_AAS
        /* Cider not defined yet the field for <assignSourceVPortProfileEnable> */
        swActionPtr->sourcePort.assignSourceVPortProfileEnable = GT_FALSE;

        SIP5_IPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
            SIP5_IPCL_ACTION_TABLE_FIELDS_SRC_EPORT_E,
            value);
        swActionPtr->sourcePort.sourceVPortProfileValue = value;
    }
    else
    {
        isVPort = 0;
    ...
    if (PRV_CPSS_SIP_6_CHECK_MAC(devNum))
    {
        ...
        if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            SIP6_IPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
                SIP7_IPCL_ACTION_TABLE_FIELDS_DISABLE_EM_LOOKUP_E,
                value);
            swActionPtr->exactMatchDisable = BIT2BOOL_MAC(value);
        }
    ...
    if (PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
    {
        ...
        if(PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
        {
            /* Use copyUdb starting from IronMan */
            swActionPtr->vlan.ingress.copyUdb = BIT2BOOL_MAC(value);
        }
        else
        {
...
/**
* @internal sip7PclTcamRuleMidwayActionHw2SwConvert function
* @endinternal
*
* @brief   Converts TCAM Midway Action from HW to SW format - AAS
*
* @note   APPLICABLE DEVICES:      AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
...
* @retval GT_BAD_STATE             - one of the values not supported.
*/
static GT_STATUS sip7PclTcamRuleMidwayActionHw2SwConvert
(
    IN  GT_U8                         devNum,
    IN  GT_U32                        *hwActionPtr,
    OUT CPSS_DXCH_PCL_ACTION_STC      *swActionPtr
)
{
    ...
    GT_BOOL usePolicer = GT_TRUE;
    GT_U32  policerMeterEn , policerCounterEn;
    GT_U32  isVPort;/* support for vPort*/
    ...
    /* convert packet command */
    SIP7_MPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_COMMAND_E,
        value);
    PRV_CPSS_CONVERT_HW_VAL_TO_PACKET_CMD_MAC(
        swActionPtr->pktCmd,value);
    ...
    SIP7_MPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
        SIP7_MPCL_ACTION_TABLE_FIELDS_EPCL_LOOKUP_MODE_E,
        value);
    swActionPtr->lookupConfig.epclOverrideConfigIndex = value ?
        CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_OVERRIDE_E :
        CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_RETAIN_E;
    ...
    SIP7_MPCL_ACTION_FIELD_GET_MAC(devNum,hwActionPtr,
       SIP7_MPCL_ACTION_TABLE_FIELDS_IPCL_TO_TXQ_RESERVED_E,
       value);
    swActionPtr->copyReserved.copyReserved = value >> 1;
...
)
{
    ...
    */
            ...
            */
            ...
            switch(swActionPtr->epclPhaInfo.phaThreadType)
            {
                ...
                case CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ENHANCED_SFLOW_E:
                    ...
                    break;
                case CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_IFA_E:
                    swActionPtr->epclPhaInfo.phaThreadUnion.epclIfaFlow.flowId = value;
                    break;
                case CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ROUTER_SA_MODIFICATION_E:
                    swActionPtr->epclPhaInfo.phaThreadUnion.epclRouterSaModification.macSaLsb = value;
                    break;
                case CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_VXLAN_DCI_VNI_REMAP_E:
                    swActionPtr->epclPhaInfo.phaThreadUnion.epclVxlanVni.vxlanVni = value;
                    break;
    ...
    {
        case 0:
            swActionPtr->qos.egress.modifyDscp = CPSS_DXCH_PCL_ACTION_EGRESS_DSCP_EXP_CMD_KEEP_E;
            break;
        case 1:
            swActionPtr->qos.egress.modifyDscp = CPSS_DXCH_PCL_ACTION_EGRESS_DSCP_EXP_CMD_MODIFY_OUTER_E;
            break;
        case 2:
            swActionPtr->qos.egress.modifyDscp = CPSS_DXCH_PCL_ACTION_EGRESS_DSCP_EXP_CMD_MODIFY_INNER_E;
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_STATE, LOG_ERROR_NO_MSG);
    }
...
)
{
    ...
    if (PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_ENABLED_MAC(devNum) == GT_TRUE)
    {
        if (direction == CPSS_PCL_DIRECTION_MIDWAY_E)
        {
            /*MPCL*/
            return sip7PclTcamRuleMidwayActionHw2SwConvert(
    ...
    swActionPtr->egressPolicy = direction;
...
)
{
    ...
    GT_U32                              fmtFldArrSize; /* array size */
    ...
    if (PRV_CPSS_SIP_5_CHECK_MAC(devNum))
    {
        if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        {
            fmtFldArrPtr = fmtFldArr_sip7;
            fmtFldArrSize = sizeof(fmtFldArr_sip7) / sizeof(fmtFldArr_sip7[0]);
        }
        else if (PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
        {
            ...
            fmtFldArrSize = sizeof(fmtFldArr_sip6_10) / sizeof(fmtFldArr_sip6_10[0]);
        }
        else
        {
            ...
            fmtFldArrSize = sizeof(fmtFldArr_sip5) / sizeof(fmtFldArr_sip5[0]);
        }
    ...
    else
    {
        switch(PRV_CPSS_PP_MAC(devNum)->devFamily)
        {
            case CPSS_PP_FAMILY_DXCH_LION2_E:
                ...
                fmtFldArrSize = sizeof(fmtFldArr_Lion2) / sizeof(fmtFldArr_Lion2[0]);
                switch (ruleFormat)
                {
            ...
            case CPSS_PP_FAMILY_DXCH_XCAT3_E:
                ...
                fmtFldArrSize = sizeof(fmtFldArr_xcat) / sizeof(fmtFldArr_xcat[0]);
                break;
            case CPSS_PP_FAMILY_DXCH_AC5_E:
                fmtFldArrPtr = fmtFldArr_AC5;
                fmtFldArrSize = sizeof(fmtFldArr_AC5) / sizeof(fmtFldArr_AC5[0]);
                break;
           default:
                CPSS_LOG_ERROR_AND_RETURN_MAC(GT_NOT_SUPPORTED, LOG_ERROR_NO_MSG);
        }
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        switch (direction)
        {
            ...
            case CPSS_PCL_DIRECTION_MIDWAY_E:
                ...
                *posPtrPtr = &prvCpssDxChPclCfgTblHwSip7MidwayPos;
                break;
            case CPSS_PCL_DIRECTION_EGRESS_E:
                /* ignore lookup number */
                *posPtrPtr = &prvCpssDxChPclCfgTblHwSip7EgrPos;
                break;
            default: CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
        }
    }
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_EGRESS_E:
            *tableIdPtr = CPSS_DXCH2_TABLE_EGRESS_PCL_CONFIG_E;
            break;
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            *tableIdPtr = CPSS_DXCH_SIP7_TABLE_MIDWAY_PCL_CONFIG_E;
            break;
        default: CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    ...
    *portGroupIdPtr = CPSS_PORT_GROUP_UNAWARE_MODE_CNS;
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            ...
            regAddr = PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclPolicyGlobalConfig;
            break;
        case CPSS_PCL_DIRECTION_EGRESS_E:
...
* @note   NOT APPLICABLE DEVICES:  Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
*
* @param[in] devNum                   - device number
* @param[in] portGroupId              - The port group Id. relevant only to 'multi-port-groups' devices.
*                                      supports value CPSS_PORT_GROUP_UNAWARE_MODE_CNS
...
*
* @note   APPLICABLE DEVICES:      Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.

...
static const UDB_RANGE_PER_ANCHORS_STC sip6_10_epcl_UdbRangePerAnchorArr[] =
{
    ...
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L4_E,          */ {0,  0, 0, 0},  /* not applicable */
    /*CPSS_DXCH_PCL_OFFSET_INVALID_E             */ {0,  PRV_CPSS_DXCH_EPCL_SIP_6_10_UDB_MAX_NUMBER_CNS, 178, 127}
};

static const UDB_RANGE_PER_ANCHORS_STC sip6_30_epcl_UdbRangePerAnchorArr[] =
{
    /*CPSS_DXCH_PCL_OFFSET_L2_E,                 */ {0,  PRV_CPSS_DXCH_EPCL_SIP_6_10_UDB_MAX_NUMBER_CNS, 159, 127},
    /*CPSS_DXCH_PCL_OFFSET_L3_E,                 */ {0,  0, 0, 0},
    /*CPSS_DXCH_PCL_OFFSET_L4_E,                 */ {0,  PRV_CPSS_DXCH_EPCL_SIP_6_10_UDB_MAX_NUMBER_CNS, 159, 127},
    ...
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L2_E,          */ {0,  PRV_CPSS_DXCH_EPCL_SIP_6_10_UDB_MAX_NUMBER_CNS, 62, 18},
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L3_MINUS_2_E,  */ {0,  PRV_CPSS_DXCH_EPCL_SIP_6_10_UDB_MAX_NUMBER_CNS, 56, 64},
    /*CPSS_DXCH_PCL_OFFSET_METADATA_E,           */ {0,  PRV_CPSS_DXCH_EPCL_SIP_6_10_UDB_MAX_NUMBER_CNS, 178, 128},
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L4_E,          */ {0,  0, 0, 0},  /* not applicable */
    /*CPSS_DXCH_PCL_OFFSET_INVALID_E             */ {0,  PRV_CPSS_DXCH_EPCL_SIP_6_10_UDB_MAX_NUMBER_CNS, 178, 127}
};
...
static const UDB_RANGE_PER_ANCHORS_STC sip6_10_ipcl_UdbRangePerAnchorArr[] =
{
    ...
    /*CPSS_DXCH_PCL_OFFSET_INVALID_E             */ {0, CPSS_DXCH_PCL_UDB_MAX_NUMBER_CNS, 178, 127}
};

static const UDB_RANGE_PER_ANCHORS_STC sip6_30_ipcl_UdbRangePerAnchorArr[] =
{
    /*CPSS_DXCH_PCL_OFFSET_L2_E,                 */ {0,  CPSS_DXCH_PCL_UDB_MAX_NUMBER_CNS, 159, 127},
    /*CPSS_DXCH_PCL_OFFSET_L3_E,                 */ {0,  0, 0, 0},
    /*CPSS_DXCH_PCL_OFFSET_L4_E,                 */ {0,  CPSS_DXCH_PCL_UDB_MAX_NUMBER_CNS, 159, 127},
    ...
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L2_E,          */ {0,  CPSS_DXCH_PCL_UDB_MAX_NUMBER_CNS, 62, 18},
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L3_MINUS_2_E,  */ {0,  CPSS_DXCH_PCL_UDB_MAX_NUMBER_CNS, 56, 64},
    /*CPSS_DXCH_PCL_OFFSET_METADATA_E,           */ {30, 66,                              179, 116},
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L4_E,          */ {0,  CPSS_DXCH_PCL_UDB_MAX_NUMBER_CNS, 24, 8},
    /*CPSS_DXCH_PCL_OFFSET_INVALID_E             */ {0, CPSS_DXCH_PCL_UDB_MAX_NUMBER_CNS, 255, 127}
};

/* related to both IPCL,MPCL and to EPCL */
static const UDB_RANGE_PER_ANCHORS_STC sip7_pcl_UdbRangePerAnchorArr[] =
{
    /*CPSS_DXCH_PCL_OFFSET_L2_E,                 */ {0,  60, 255, 255},
    /*CPSS_DXCH_PCL_OFFSET_L3_E,                 */ {0,  0,  0,   0  },
    /*CPSS_DXCH_PCL_OFFSET_L4_E,                 */ {0,  60, 255, 255},
    /*CPSS_DXCH_PCL_OFFSET_IPV6_EXT_HDR_E,       */ {0,  0,  0,   0  },  /* not applicable */
    /*CPSS_DXCH_PCL_OFFSET_TCP_UDP_COMPARATOR_E, */ {0,  0,  0,   0  },  /* not applicable */
    /*CPSS_DXCH_PCL_OFFSET_L3_MINUS_2_E,         */ {0,  60, 255, 255},
    /*CPSS_DXCH_PCL_OFFSET_MPLS_MINUS_2_E,       */ {0,  60, 255, 255},
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L2_E,          */ {0,  60, 65,  255},
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L3_MINUS_2_E,  */ {0,  60, 79,  255},
    /*CPSS_DXCH_PCL_OFFSET_METADATA_E,           */ {12, 60, 179, 165}, /* limited only by size of metadata */
    /*CPSS_DXCH_PCL_OFFSET_TUNNEL_L4_E,          */ {0,  60, 23,  0  }, /* not applicable to EPCL */
    /*CPSS_DXCH_PCL_OFFSET_INVALID_E             */ {0,  60, 255, 255}
};
...
)
{
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        devNum, CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E
        | CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_AC5P_E
    ...
    if(PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_ENABLED_MAC(devNum) == GT_TRUE)
    {
        switch (direction)
        {
            ...
            case CPSS_PCL_DIRECTION_MIDWAY_E:
                ...
                {
                    /* only for SIP_7 and above devices */
                    CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
                }
                PRV_CPSS_DXCH_DEFAULT_EPORT_CHECK_MAC(devNum,portNum);
                bitPos = SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_MIDWAY_PCL_CFG_MODE_E;
    ...
    if (PRV_CPSS_DXCH_PP_HW_INFO_E_ARCH_ENABLED_MAC(devNum) == GT_TRUE)
    {
        switch (direction)
        {
            case CPSS_PCL_DIRECTION_INGRESS_E:
                ...
                /* read value to pre-tti-lookup-ingress-eport table */
                rc = prvCpssDxChReadTableEntryField(devNum,
                                            CPSS_DXCH_SIP5_TABLE_PRE_TTI_LOOKUP_INGRESS_EPORT_E,
                                            portNum,
                                            PRV_CPSS_DXCH_TABLE_WORD_INDICATE_FIELD_NAME_CNS,
...
)
{
    ...
    rc = internal_cpssDxChPclIngressPolicyEnable(
        devNum, CPSS_PCL_DIRECTION_INGRESS_E, enable);
...
)
{
    ...
    rc = internal_cpssDxChPclIngressPolicyEnableGet(
        devNum, CPSS_PCL_DIRECTION_INGRESS_E, enablePtr);
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPclMidwayPolicyEnable);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, enable));

    rc = internal_cpssDxChPclIngressPolicyEnable(
        devNum, CPSS_PCL_DIRECTION_MIDWAY_E, enable);
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPclMidwayPolicyEnableGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, enablePtr));

    rc = internal_cpssDxChPclIngressPolicyEnableGet(
        devNum, CPSS_PCL_DIRECTION_MIDWAY_E, enablePtr);
...
)
{
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == 0)
    {
        /* the direction parameter value ignored for not SIP7 devices */
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, udbErrorCmd));

    rc = internal_cpssDxChPclInvalidUdbCmdSet(devNum, direction, udbErrorCmd);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, direction, udbErrorCmd));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, udbErrorCmdPtr));

    rc = internal_cpssDxChPclInvalidUdbCmdGet(devNum, direction, udbErrorCmdPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, direction, udbErrorCmdPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        devNum, CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E
...
)
{
    ...
    if ((PRV_CPSS_SIP_7_CHECK_MAC(devNum))
        && ((GT_U32)ruleFormat < (GT_U32)CPSS_DXCH_PCL_RULE_FORMAT_LAST_E))
    {
        switch (ruleFormat)
        {
            ...
            case CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_60_NO_FIXED_FIELDS_E: /*same as UDB_60*/
            case CPSS_DXCH_PCL_RULE_FORMAT_INGRESS_UDB_80_E:
            case CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_60_NO_FIXED_FIELDS_E: /*same as UDB_60*/
            case CPSS_DXCH_PCL_RULE_FORMAT_EGRESS_UDB_80_E:
                break;
            default:
                /* give indications that test using PCL rules , that on AAS not yet operational */
                /* we need this warning to know that test may fail on traffic that need to match
                   this rule but can't */
                cpssOsPrintf("'PCL rule set' : AAS not supporting PCL match yet , so test will probably fail \n");
                break;
        }
    }
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == GT_FALSE)
    {
        ...
        if ((egressRule == GT_FALSE) && (CPSS_PCL_DIRECTION_EGRESS_E == actionPtr->egressPolicy))
        {
...
)
{
    ...
    egressRule  = GT_FALSE;
    ruleSizeVal = 0;
    /* For SIP7 rules INGRESS and EGRESS UDB_ONLY */
    /* formats can be used for any direction.     */
    /* Take direction from output action variable */
    direction = actionPtr->egressPolicy;
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == GT_FALSE)
    {
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        ...
        CPSS_BOBCAT3_E | CPSS_AC3X_E | CPSS_ALDRIN2_E | CPSS_FALCON_E
        | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);
...
)
{
    ...
    {
        /* not needed to split PCL-ID field */
    }
...
)
{
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            ...
            tableId = CPSS_DXCH_SIP7_TABLE_MIDWAY_PCL_CONFIG_E;
            break;
        default: CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
)
{
    ...
    if(PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        udbRangePerAnchorPtr = sip7_pcl_UdbRangePerAnchorArr;
    }
    else if(PRV_CPSS_SIP_6_30_CHECK_MAC(devNum))
    {
        if (direction == CPSS_PCL_DIRECTION_INGRESS_E)
        {
            udbRangePerAnchorPtr = sip6_30_ipcl_UdbRangePerAnchorArr;
        }
        else
        {
            udbRangePerAnchorPtr = sip6_30_epcl_UdbRangePerAnchorArr;
        }
    }
    else if(PRV_CPSS_SIP_6_10_CHECK_MAC(devNum))
    {
    ...
    /*
         ...
         0x7 = Tunnel L4; this is the start of the original packet’s tunnel L4 header, If packet was not tunnel-start this anchor is invalid
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E
...
)
{
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        ...
        /* channelType => OAMOpcode table */
        regAddr =
            PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclOAMConfigs.mpclChannelTypeOAMOpcode[channelTypeProfile - 1];
        ...
        regAddr =
            PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclOAMConfigs.mpclRBitAssignmentEnable;
...
)
{
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            ...
            regAddr =
                PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclOAMConfigs.mpclOAMMEGLevelModeConfigs;
            break;
...
)
{
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            ...
            regAddr =
                PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclOAMConfigs.mpclOAMRDIConfigs;
            break;
...
)
{
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            regAddr =
                PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclOAMConfigs.mpclOAMRFlagConfigs;
            break;
        default: CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, oamProfile, rFlagMask, rFlagPattern));

    rc = internal_cpssDxChPclOamRFlagMatchingSet(
        devNum, direction, oamProfile,
        rFlagMask, rFlagPattern);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, direction, oamProfile, rFlagMask, rFlagPattern));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, oamProfile, rFlagMaskPtr, rFlagPatternPtr));

    rc = internal_cpssDxChPclOamRFlagMatchingGet(
        devNum, direction, oamProfile,
        rFlagMaskPtr, rFlagPatternPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, direction, oamProfile, rFlagMaskPtr, rFlagPatternPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_FALCON_E | CPSS_AC5P_E
        | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E
        | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);
...
)
{
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            regAddr =
                PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclPolicyLookupGlobalConfig;
            break;
        default: CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
)
{
    ...
    rc = internal_cpssDxChPclSourceIdMaskSet(devNum, direction, lookupNum, mask);
...
)
{
    ...
    rc = internal_cpssDxChPclSourceIdMaskGet(devNum, direction, lookupNum, maskPtr);
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E |
        CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E | CPSS_ALDRIN2_E | CPSS_AC5P_E
        | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);
...
)
{
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            ...
            regAddr = PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclExactMatchProfileIdMapEntry[index];
            return prvCpssHwPpSetRegField(devNum, regAddr, 8, 6, tcamProfileId);
...
)
{
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            ...
            tableName = CPSS_DXCH_SIP7_TABLE_MIDWAY_PCL_SOURCE_PORT_CONFIG_E;
            tableOffset = 0;
            break;
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portNum, direction, lookupNum, portPclId2));
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portNum, direction, lookupNum, portPclId2Ptr));
...
)
{
    ...
    if(direction == CPSS_PCL_DIRECTION_MIDWAY_E)
    {
        ...
        regAddr = PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclFlowIdActionAssignmentModeConfig;
    }
    else
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum,  direction, lookupNum, hitNum , mode));
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, lookupNum, hitNum , modePtr));
...
)
{
    ...
    if(direction == CPSS_PCL_DIRECTION_MIDWAY_E)
    {
        regAddr = PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclPolicyGlobalConfigExt1;
    }
    else
    if(direction == CPSS_PCL_DIRECTION_EGRESS_E)
    {
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, maxNum));
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, maxNumPtr));
...
)
{
    ...
    switch (direction)
    {
        ...
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            regAddr = PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclPolicyLookupGlobalConfig;
            break;
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, lookupNum, epgConfigPtr));

    rc = internal_cpssDxChPclEpgConfigSet(devNum, direction, lookupNum, epgConfigPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, direction, lookupNum, epgConfigPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    rc = internal_cpssDxChPclEpgConfigGet(devNum, direction, lookupNum, epgConfigPtr);
...
)
{
    ...
    switch (direction)
    {
        case CPSS_PCL_DIRECTION_INGRESS_E:
            ...
            if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
            {
                regAddr = PRV_DXCH_REG1_UNIT_PCL_MAC(devNum).policyGlobalConfig_ext1[hwStage];
            }
            else
            {
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, lookupNum, hitNum, genericActionMode));

    rc = internal_cpssDxChPclGenericActionModeSet(
        devNum, direction, lookupNum, hitNum, genericActionMode);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, direction, lookupNum, hitNum, genericActionMode));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, lookupNum, hitNum, genericActionModePtr));

    rc = internal_cpssDxChPclGenericActionModeGet(
        devNum, direction, lookupNum, hitNum, genericActionModePtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, direction, lookupNum, hitNum, genericActionModePtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
)
{
    ...
    else if(direction == CPSS_PCL_DIRECTION_MIDWAY_E)
    {
        ...
        /* Get register address of Middle maxSduSizeProfile */
        regAddr = PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclMaxSduSizeProfile[profileNum];
    }
...
)
{
    ...
    else if(direction == CPSS_PCL_DIRECTION_MIDWAY_E)
    {
        ...
        /* Get register address of Middle maxSduSizeProfile */
        regAddr = PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclMaxSduException;
    }
    else if(direction == CPSS_PCL_DIRECTION_EGRESS_E)
    {
...
/**
* @internal internal_cpssDxChPclLookupActionModifiedFieldsSelectSet function
* @endinternal
*
...
*
* @param[in] devNum                        - device number
* @param[in] portGroupsBmp                 - bitmap of port groups used for access to PCL units.
*                                            CPSS_PORT_GROUP_UNAWARE_MODE_CNS used to specify all PCL units.
*                                            The parameter reserved for future big devices.
*                                            For all devices having one PCL unit unit the parameter ignored.
...
*
*/
static GT_STATUS internal_cpssDxChPclLookupActionModifiedFieldsSelectSet
(
    IN GT_U8                                                   devNum,
    IN GT_PORT_GROUPS_BMP                                      portGroupsBmp,
    IN CPSS_PCL_DIRECTION_ENT                                  direction,
...
)
{
    ...
    GT_U32        regAmount;       /* Amount of registers */
    GT_U32        fieldIndex;      /* Field Index inside register */
    GT_U32        lookupIndex;     /* Index of lookup */
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_CAELUM_E |
        CPSS_ALDRIN_E | CPSS_BOBCAT3_E | CPSS_AC3X_E | CPSS_ALDRIN2_E | CPSS_FALCON_E |
        CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E);
    PRV_CPSS_MULTI_PORT_GROUPS_BMP_CHECK_MAC(devNum, portGroupsBmp);
    CPSS_NULL_PTR_CHECK_MAC(actionModifiedFieldsSelectPtr);

    for (fieldIndex = 0; (fieldIndex < CPSS_DXCH_PCL_INGRESS_ACTION_MODIFIED_DATA_SELECTION_SIZE_CNS); fieldIndex++)
    {
        value = actionModifiedFieldsSelectPtr->bytePairOffsets[fieldIndex];
        if (value >= 24)
        {
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, LOG_ERROR_NO_MSG);
        }
    ...
    lookupIndex = 0; /* aviod compiler warning */
    switch (direction)
    {
        case CPSS_PCL_DIRECTION_INGRESS_E:
            switch (lookupNum)
    ...
    regAmount = CPSS_DXCH_PCL_INGRESS_ACTION_MODIFIED_DATA_SELECTION_SIZE_CNS / 5;
    PRV_CPSS_GEN_PP_START_LOOP_PORT_GROUPS_IN_BMP_MAC(
        devNum, portGroupsBmp, portGroupId)
    {
        for (regIndex = 0; (regIndex < regAmount); regIndex++)
        {
            regMask = 0;
            regData = 0;
            switch (direction)
            {
                case CPSS_PCL_DIRECTION_INGRESS_E:
                    regAddr =
                        PRV_DXCH_REG1_UNIT_PCL_MAC(devNum).actionModifiedFieldsSelect[lookupIndex][regIndex];
                    break;
                case CPSS_PCL_DIRECTION_MIDWAY_E:
                    regAddr =
                        PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclActionModifiedFieldsSelect[regIndex];
                    break;
                default:
                    CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
            }
            ...
            {
                value = actionModifiedFieldsSelectPtr->bytePairOffsets[(regIndex * 5) + fieldIndex];
                regMask |= (0x1F  << (5 * fieldIndex));
                regData |= (value << (5 * fieldIndex));
            }
            rc = prvCpssHwPpPortGroupWriteRegBitMask(
                devNum, portGroupId, regAddr, regMask, regData);
            if (rc != GT_OK)
            {
                CPSS_LOG_ERROR_AND_RETURN_MAC(rc, LOG_ERROR_NO_MSG);
            }
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPclLookupActionModifiedFieldsSelectSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, lookupNum, actionModifiedFieldsSelectPtr));

    rc = internal_cpssDxChPclLookupActionModifiedFieldsSelectSet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, direction, lookupNum, actionModifiedFieldsSelectPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC((funcId, rc, devNum, direction, lookupNum, actionModifiedFieldsSelectPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
/**
* @internal internal_cpssDxChPclLookupActionModifiedFieldsSelectGet function
* @endinternal
*
...
*
*/
static GT_STATUS internal_cpssDxChPclLookupActionModifiedFieldsSelectGet
(
    IN  GT_U8                                                   devNum,
    IN  GT_PORT_GROUPS_BMP                                      portGroupsBmp,
    IN  CPSS_PCL_DIRECTION_ENT                                  direction,
...
)
{
    ...
    for (regIndex = 0; (regIndex < regAmount); regIndex++)
    {
        ...
        for (fieldIndex = 0; (fieldIndex < 5); fieldIndex++)
        {
            value = ((regData >> (5 * fieldIndex)) & 0x1F);
            actionModifiedFieldsSelectPtr->bytePairOffsets[(regIndex * 5) + fieldIndex] = (GT_U8)value;
        }
    }
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPclLookupActionModifiedFieldsSelectGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, direction, lookupNum, actionModifiedFieldsSelectPtr));

    rc = internal_cpssDxChPclLookupActionModifiedFieldsSelectGet(
        devNum, CPSS_PORT_GROUP_UNAWARE_MODE_CNS, direction, lookupNum, actionModifiedFieldsSelectPtr);
...
/**
* @internal internal_cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigSet function
* @endinternal
*
...
* @retval GT_HW_ERROR              - on hardware error
*/
static GT_STATUS internal_cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigSet
(
    IN  GT_U8                                      devNum,
    IN  CPSS_PCL_DIRECTION_ENT                     direction,
    IN  CPSS_PCL_LOOKUP_NUMBER_ENT                 lookupNum,
...
)
{
    GT_STATUS   rc;          /* return code       */
    GT_U32      regAddr;     /* register address  */
    GT_U32      lookup;      /* lookup number  */
    GT_U32      hwValue1;    /* data in HW format */
    GT_U32      hwValue2;    /* data in HW format */
    GT_U32      hwValue;     /* data in HW format */
    GT_U32      hwMask;      /* data in HW format */

    /* check parameters */
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_BOBCAT3_E |
          CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_ALDRIN2_E);
    CPSS_NULL_PTR_CHECK_MAC(udbValuesBmpCfgPtr);

    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == 0)
    {
        return internal_cpssDxChPclUserDefinedByteValuesBitmapExpansionModeSet(
            devNum, udbValuesBmpCfgPtr->udb49ValsBmpMode);
    }
    ...
    switch (direction)
    {
        case CPSS_PCL_DIRECTION_INGRESS_E:
            ...
            regAddr = PRV_DXCH_REG1_UNIT_PCL_MAC(devNum).policyGlobalConfig_ext1[lookup];
            break;
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            regAddr = PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclPolicyGlobalConfigExt1;
            break;
    ...
    switch (udbValuesBmpCfgPtr->udb49ValsBmpStart)
    {
        case CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_4_E:
            hwValue1 = 0;
            break;
        case CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_14_E:
            hwValue1 = 1;
            break;
        case CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_24_E:
            hwValue1 = 2;
            break;
        case CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_34_E:
            hwValue1 = 3;
            break;
        case CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_44_E:
            hwValue1 = 4;
            break;
        case CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_54_E:
            hwValue1 = 5;
            break;
        case CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_88_E:
            hwValue1 = 6;
            break;
        case CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_104_E:
            hwValue1 = 7;
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    ...
    switch (udbValuesBmpCfgPtr->udb49ValsBmpMode)
    {
        case CPSS_DXCH_PCL_UDB_VALUES_BITMAP_MODE_8_BYTES_E:
            hwValue2 = 2;
            break;
    ...
    switch (direction)
    {
        case CPSS_PCL_DIRECTION_INGRESS_E:
            hwMask  =  (7 << 29) | (3 << 27);
            hwValue = (hwValue1 << 29) | (hwValue2 << 27);
            break;
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            hwMask  =  (7 << 22) | (3 << 13);
            hwValue = (hwValue1 << 22) | (hwValue2 << 13);
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    rc = prvCpssHwPpWriteRegBitMask(devNum, regAddr, hwMask, hwValue);
    if (rc != GT_OK)
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(rc, LOG_ERROR_NO_MSG);
    }
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC(
        (funcId, devNum, direction, lookupNum, udbValuesBmpCfgPtr));

    rc = internal_cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigSet(
        devNum, direction, lookupNum, udbValuesBmpCfgPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC(
        (funcId, rc, devNum, direction, lookupNum, udbValuesBmpCfgPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
/**
* @internal internal_cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigGet function
* @endinternal
*
* @brief   Get the User Defined Byte (UDB) Values bitmap expansion start byte and mode.
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
...
* @retval GT_HW_ERROR              - on hardware error
*/
static GT_STATUS internal_cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigGet
(
    IN  GT_U8                                      devNum,
    IN  CPSS_PCL_DIRECTION_ENT                     direction,
    IN  CPSS_PCL_LOOKUP_NUMBER_ENT                 lookupNum,
...
)
{
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == 0)
    {
        return internal_cpssDxChPclUserDefinedByteValuesBitmapExpansionModeGet(
            devNum, &(udbValuesBmpCfgPtr->udb49ValsBmpMode));
    }
    ...
    {
        case CPSS_PCL_DIRECTION_INGRESS_E:
            hwValue1 = (hwValue >> 29) & 7;
            hwValue2 = (hwValue >> 27) & 3;
            break;
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            hwValue1 = (hwValue >> 22) & 7;
            hwValue2 = (hwValue >> 13) & 3;
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    ...
    {
        case 0:
            udbValuesBmpCfgPtr->udb49ValsBmpStart = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_4_E;
            break;
        case 1:
            udbValuesBmpCfgPtr->udb49ValsBmpStart = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_14_E;
            break;
        case 2:
            udbValuesBmpCfgPtr->udb49ValsBmpStart = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_24_E;
            break;
        case 3:
            udbValuesBmpCfgPtr->udb49ValsBmpStart = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_34_E;
            break;
        case 4:
            udbValuesBmpCfgPtr->udb49ValsBmpStart = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_44_E;
            break;
        case 5:
            udbValuesBmpCfgPtr->udb49ValsBmpStart = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_54_E;
            break;
        case 6:
            udbValuesBmpCfgPtr->udb49ValsBmpStart = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_88_E;
            break;
        case 7:
            udbValuesBmpCfgPtr->udb49ValsBmpStart = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_BYTE_104_E;
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_STATE, LOG_ERROR_NO_MSG);
    }
    ...
    {
        case 2:
            udbValuesBmpCfgPtr->udb49ValsBmpMode = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_MODE_8_BYTES_E;
            break;
        case 1:
            udbValuesBmpCfgPtr->udb49ValsBmpMode = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_MODE_16_BYTES_E;
            break;
        case 0:
            udbValuesBmpCfgPtr->udb49ValsBmpMode = CPSS_DXCH_PCL_UDB_VALUES_BITMAP_MODE_32_BYTES_E;
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_STATE, LOG_ERROR_NO_MSG);
    }
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigGet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC(
        (funcId, devNum, lookupNum, direction, udbValuesBmpCfgPtr));

    rc = internal_cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigGet(
        devNum, direction, lookupNum, udbValuesBmpCfgPtr);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC(
        (funcId, rc, devNum, lookupNum, direction, udbValuesBmpCfgPtr));
    CPSS_API_UNLOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
 ...
 /**
* @internal prvCpssDxChPclParallelLookupDropCancelEnableRegAddrGet function
* @endinternal
*
* @brief   Get register address to enable cancel hard or soft drop command from action of other paralell lookup.
*
* @note   APPLICABLE DEVICES:      AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
...
* @param[out] regAddrPtr                    (pointer to)register address.
* @param[out] bitOffsetPtr                  (pointer to)bit offset.
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong parameter
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
* @retval GT_HW_ERROR              - on hardware error
*/
static GT_STATUS prvCpssDxChPclParallelLookupDropCancelEnableRegAddrGet
(
    IN  GT_U8                           devNum,
    IN  CPSS_PCL_DIRECTION_ENT          direction,
    IN  CPSS_PCL_LOOKUP_NUMBER_ENT      lookupNum,
...
{
    GT_U32 lookup;
    /* bits order <0,1> <0,2> <0,3> <1,2> <1,3>, <2,3>      */
    /* for hard drop bits[21:16], for soft drop bits[27:22] */
    const GT_U8 relBitOffsetArr[]=
    {
        /*<0,1>*/0,   /*<0,2>*/1,   /*<0,3>*/2,
        /*<**>*/0xFF, /*<1,2>*/3,   /*<1,3>*/4,
        /*<**>*/0xFF, /*<**>*/0xFF, /*<1,3>*/5
    };
    const GT_U8 relBitOffsetLine = 3;
    GT_U32 relBitOffsetIdx;
    GT_U32 bitOffsetBaseForSoft; /* index of first bit in register that enables/disables cancel for Hard Drop */
    GT_U32 bitOffsetBaseForHard; /* index of first bit in register that enables/disables cancel for Soft Drop */

    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(
        devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E | CPSS_BOBCAT2_E | CPSS_BOBCAT3_E |
        CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_ALDRIN2_E |
        CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E);

    if (parallelLookupWithDrop >= 4) /* 1 - 3 */
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    if (parallelLookupWithDropCancel >= parallelLookupWithDrop) /* 0 - 2 */
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
    switch (direction)
    {
        case CPSS_PCL_DIRECTION_INGRESS_E:
            ...
            *regAddrPtr =
                PRV_DXCH_REG1_UNIT_PCL_MAC(devNum).policyGlobalConfig[lookup];
            bitOffsetBaseForHard = 15;
            bitOffsetBaseForSoft = 21;
            break;
        case CPSS_PCL_DIRECTION_MIDWAY_E:
            *regAddrPtr =
                PRV_DXCH_REG1_UNIT_MPCL_MAC(devNum).mpclPolicyLookupGlobalConfig;
            bitOffsetBaseForHard = 16;
            bitOffsetBaseForSoft = 22;
            break;
        case CPSS_PCL_DIRECTION_EGRESS_E:
            /* TBD - not found in cider, copied from MPCL */
            *regAddrPtr =
                PRV_DXCH_REG1_UNIT_EPCL_MAC(devNum).egressPolicyGlobalConfig_ext_1;
            bitOffsetBaseForHard = 16;
            bitOffsetBaseForSoft = 22;
            break;
        default:
    ...
    /* bits order <0,1> <0,2> <0,3> <1,2> <1,3>, <2,3>      */
    /* for hard drop bits[20:15], for soft drop bits[26:21] (IPCL)*/
    /* for hard drop bits[21:16], for soft drop bits[27:22] (MPCL, EPCL)*/
    relBitOffsetIdx =
        (relBitOffsetLine * parallelLookupWithDropCancel)
        + (parallelLookupWithDrop - 1);
    switch (cancelDropType)
    {
        case CPSS_DROP_MODE_HARD_E:
            *bitOffsetPtr = bitOffsetBaseForHard + relBitOffsetArr[relBitOffsetIdx];
            break;
        case CPSS_DROP_MODE_SOFT_E:
            *bitOffsetPtr = bitOffsetBaseForSoft + relBitOffsetArr[relBitOffsetIdx];
            break;
        default:
            CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }
...
/**
* @internal internal_cpssDxChPclParallelLookupDropCancelEnableSet function
* @endinternal
*
...
* @retval GT_HW_ERROR              - on hardware error
*/
static GT_STATUS internal_cpssDxChPclParallelLookupDropCancelEnableSet
(
    IN  GT_U8                           devNum,
    IN  CPSS_PCL_DIRECTION_ENT          direction,
    IN  CPSS_PCL_LOOKUP_NUMBER_ENT      lookupNum,
...
)
{
    ...
    rc = prvCpssDxChPclParallelLookupDropCancelEnableRegAddrGet(
        devNum, direction, lookupNum, cancelDropType,
        parallelLookupWithDropCancel, parallelLookupWithDrop,
        &regAddr, &bitOffset);
    if (rc != GT_OK)
    {
        return rc;
    ...
    rc = prvCpssHwPpSetRegField(
        devNum, regAddr, bitOffset, 1, data);
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPclParallelLookupDropCancelEnableSet);

    CPSS_API_LOCK_MAC(devNum, PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC(
        (funcId, devNum, direction, lookupNum, cancelDropType,
         parallelLookupWithDropCancel, parallelLookupWithDrop, enable));

    rc = internal_cpssDxChPclParallelLookupDropCancelEnableSet(
        devNum, direction, lookupNum, cancelDropType,
         parallelLookupWithDropCancel, parallelLookupWithDrop, enable);

    CPSS_LOG_API_EXIT_MAC(funcId, rc);
    CPSS_APP_SPECIFIC_CB_MAC(
        (funcId, rc, devNum, direction, lookupNum, cancelDropType,
         parallelLookupWithDropCancel, parallelLookupWithDrop, enable));
    CPSS_API_UNLOCK_MAC(devNum, PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
...
/**
* @internal internal_cpssDxChPclParallelLookupDropCancelEnableGet function
* @endinternal
*
...
* @retval GT_HW_ERROR              - on hardware error
*/
static GT_STATUS internal_cpssDxChPclParallelLookupDropCancelEnableGet
(
    IN  GT_U8                           devNum,
    IN  CPSS_PCL_DIRECTION_ENT          direction,
    IN  CPSS_PCL_LOOKUP_NUMBER_ENT      lookupNum,
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChPclParallelLookupDropCancelEnableGet);

    CPSS_API_LOCK_MAC(devNum, PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC(
        (funcId, devNum, direction, lookupNum, cancelDropType,
         parallelLookupWithDropCancel, parallelLookupWithDrop, enablePtr));

    rc = internal_cpssDxChPclParallelLookupDropCancelEnableGet(
        devNum, direction, lookupNum, cancelDropType,
         parallelLookupWithDropCancel, parallelLookupWithDrop, enablePtr);

...
const char * const prvCpssLogEnum_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_ENT[]  =
{
...
PRV_CPSS_LOG_STC_ENUM_ARRAY_SIZE_MAC(CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_ENT);
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, bytePairOffsets, CPSS_DXCH_PCL_INGRESS_ACTION_MODIFIED_DATA_SELECTION_SIZE_CNS, GT_U8);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, udb49ValsBmpStart, CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_ENT);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, udb49ValsBmpMode, CPSS_DXCH_PCL_UDB_VALUES_BITMAP_MODE_ENT);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PCL_ACTION_HEADER_ALTERATION_OPTIONS_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, routerTtlDecrementDisable);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, routerMacSaAssignmentDisable);
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, routerMacDaAndIpHeaderModificationsDisable);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, mpclOverrideConfigIndex, CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_ENT);
    PRV_CPSS_LOG_STC_ENUM_MAC(valPtr, epclOverrideConfigIndex, CPSS_DXCH_PCL_LOOKUP_CONFIG_INDEX_ENT);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, udb, CPSS_DXCH_PCL_UDB_ONLY_RULE_MAX_SIZE_CNS, GT_U8);
...
)
{
    ...
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, epclEnhancedSflow, CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ENHANCED_SFLOW_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, epclIfaFlow, CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_IFA_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, epclRouterSaModification, CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ROUTER_SA_MODIFICATION_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, epclVxlanVni, CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_VXLAN_DCI_VNI_REMAP_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ENHANCED_SFLOW_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_IPV4_MAC(valPtr, agentIpAddr);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_IFA_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, flowId);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ROUTER_SA_MODIFICATION_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, macSaLsb);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_VXLAN_DCI_VNI_REMAP_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, vxlanVni);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DROP_MODE_TYPE_ENT_cancelDropType = {
     "cancelDropType", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_DROP_MODE_TYPE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC_PTR_actionModifiedFieldsSelectPtr = {
     "actionModifiedFieldsSelectPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC_PTR_udbValuesBmpCfgPtr = {
     "udbValuesBmpCfgPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_parallelLookupWithDrop = {
     "parallelLookupWithDrop", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_parallelLookupWithDropCancel = {
     "parallelLookupWithDropCancel", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(GT_U32)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC_PTR_actionModifiedFieldsSelectPtr = {
     "actionModifiedFieldsSelectPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC_PTR_udbValuesBmpCfgPtr = {
     "udbValuesBmpCfgPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPclParallelLookupDropCancelEnableSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PCL_DIRECTION_ENT_direction,
    &DX_IN_CPSS_PCL_LOOKUP_NUMBER_ENT_lookupNum,
    &DX_IN_CPSS_DROP_MODE_TYPE_ENT_cancelDropType,
    &DX_IN_GT_U32_parallelLookupWithDropCancel,
    &DX_IN_GT_U32_parallelLookupWithDrop,
    &DX_IN_GT_BOOL_enable
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPclParallelLookupDropCancelEnableGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PCL_DIRECTION_ENT_direction,
    &DX_IN_CPSS_PCL_LOOKUP_NUMBER_ENT_lookupNum,
    &DX_IN_CPSS_DROP_MODE_TYPE_ENT_cancelDropType,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPclLookupActionModifiedFieldsSelectSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PCL_DIRECTION_ENT_direction,
    &DX_IN_CPSS_PCL_LOOKUP_NUMBER_ENT_lookupNum,
    &DX_IN_CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC_PTR_actionModifiedFieldsSelectPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PCL_DIRECTION_ENT_direction,
    &DX_IN_CPSS_PCL_LOOKUP_NUMBER_ENT_lookupNum,
    &DX_IN_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC_PTR_udbValuesBmpCfgPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPclLookupActionModifiedFieldsSelectGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PCL_DIRECTION_ENT_direction,
    &DX_IN_CPSS_PCL_LOOKUP_NUMBER_ENT_lookupNum,
    &DX_OUT_CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC_PTR_actionModifiedFieldsSelectPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_PCL_DIRECTION_ENT_direction,
    &DX_IN_CPSS_PCL_LOOKUP_NUMBER_ENT_lookupNum,
    &DX_OUT_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC_PTR_udbValuesBmpCfgPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChPclLogLibDb[] = {
    ...
    {"cpssDxChPclMidwayPolicyEnable", 2, prvCpssLogGenDevNumEnable_PARAMS, NULL},
    {"cpssDxChPclMidwayPolicyEnableGet", 2, prvCpssLogGenDevNumEnablePtr_PARAMS, NULL},
    ...
    {"cpssDxChPclInvalidUdbCmdSet", 3, cpssDxChPclInvalidUdbCmdSet_PARAMS, NULL},
    {"cpssDxChPclInvalidUdbCmdGet", 3, cpssDxChPclInvalidUdbCmdGet_PARAMS, NULL},
    ...
    {"cpssDxChPclOamRFlagMatchingSet", 5, cpssDxChPclOamRFlagMatchingSet_PARAMS, NULL},
    {"cpssDxChPclOamRFlagMatchingGet", 5, cpssDxChPclOamRFlagMatchingGet_PARAMS, NULL},
    ...
    {"cpssDxChPclSourceIdMaskSet", 4, cpssDxChPclSourceIdMaskSet_PARAMS, NULL},
    {"cpssDxChPclSourceIdMaskGet", 4, cpssDxChPclSourceIdMaskGet_PARAMS, NULL},
    ...
    {"cpssDxChPclCopyReservedMaskSet", 4, cpssDxChPclSourceIdMaskSet_PARAMS, NULL},
    {"cpssDxChPclCopyReservedMaskGet", 4, cpssDxChPclSourceIdMaskGet_PARAMS, NULL},
    ...
    {"cpssDxChPclEpgConfigSet", 4, cpssDxChPclEpgConfigSet_PARAMS, NULL},
    {"cpssDxChPclEpgConfigGet", 4, cpssDxChPclEpgConfigGet_PARAMS, NULL},
    {"cpssDxChPclGenericActionModeSet", 5, cpssDxChPclGenericActionModeSet_PARAMS, NULL},
    {"cpssDxChPclGenericActionModeGet", 5, cpssDxChPclGenericActionModeGet_PARAMS, NULL},
    ...
    {"cpssDxChPclLookupActionModifiedFieldsSelectSet", 4, cpssDxChPclLookupActionModifiedFieldsSelectSet_PARAMS, NULL},
    {"cpssDxChPclLookupActionModifiedFieldsSelectGet", 4, cpssDxChPclLookupActionModifiedFieldsSelectGet_PARAMS, NULL},
    {"cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigSet", 4, cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigSet_PARAMS, NULL},
    {"cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigGet", 4, cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigGet_PARAMS, NULL},
    {"cpssDxChPclParallelLookupDropCancelEnableSet", 7, cpssDxChPclParallelLookupDropCancelEnableSet_PARAMS, NULL},
    {"cpssDxChPclParallelLookupDropCancelEnableGet", 7, cpssDxChPclParallelLookupDropCancelEnableGet_PARAMS, NULL},
};

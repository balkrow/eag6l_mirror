...
)
{
    ...
    regAddr = PRV_CPSS_DXCH_DEV_RESET_AND_INIT_CONTROLLER_REGS_MAC(devNum)->DFXServerUnitsDeviceSpecificRegs.deviceCtrl14;
...
/**
* @internal prvCpssDxChNetIfXcat3MiiConfig function
* @endinternal
*
* @brief   Configure the CPU port in SGMII mode.
*
...
/**
* @internal prvCpssDxChNetIfXcat3MsysMiiConfig function
* @endinternal
*
* @brief   Configure the MSYS CPU port.
*
* @param[in] devNum                   - device number
*
* @retval GT_OK                    - on success,
...
/**
* @internal prvCpssDxChCpuPortMiiConfig function
* @endinternal
*
* @brief   Configure the CPU port in MII/RGMII mode.
*
* @param[in] devNum                   - device number
*
* @retval GT_OK                    - on success,
...
/**
* @internal prvCpssDxChNetIfLion2MiiConfig function
* @endinternal
*
* @brief   Configure CPU port for RGMII support on Lion2
*
* @param[in] devNum                   - device number
*
* @retval GT_OK                    - on success,

        ...
        switch (cpuCode)
        {
            ...
            case CPSS_NET_STATIC_ADDR_MOVED_E:
                *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_STATIC_ADDR_MOVED_E;
                break;
            case CPSS_NET_MAC_SPOOF_E:
                *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SPOOF_E;
                break;

            case CPSS_NET_PHA_FW_DROP_E:
                *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_PHA_FW_DROP_E;
                break;
...
)
{
    ...
    switch (dsaCpuCode)
    {
        ...
        case PRV_CPSS_DXCH_NET_DSA_TAG_STATIC_ADDR_MOVED_E:
            *cpuCodePtr = CPSS_NET_STATIC_ADDR_MOVED_E;
            break;
        case PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SPOOF_E:
            *cpuCodePtr = CPSS_NET_MAC_SPOOF_E;
            break;

        case PRV_CPSS_DXCH_NET_DSA_TAG_PHA_FW_DROP_E:
            *cpuCodePtr = CPSS_NET_PHA_FW_DROP_E;
            break;

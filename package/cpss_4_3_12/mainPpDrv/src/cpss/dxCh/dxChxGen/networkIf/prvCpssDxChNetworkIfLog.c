...
void prvCpssLogParamFuncStc_CPSS_DXCH_NETIF_GDMA_CPU_PORTS_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_NETIF_GDMA_CPU_PORTS_INFO_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, toCpuInfo, CPSS_DXCH_NETIF_GDMA_TO_CPU_INFO_STC);
    PRV_CPSS_LOG_STC_STC_MAC(valPtr, fromCpuInfo, CPSS_DXCH_NETIF_GDMA_FROM_CPU_INFO_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_NETIF_GDMA_FROM_CPU_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_NETIF_GDMA_FROM_CPU_INFO_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numOfValidPorts);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, portsInfo, CPSS_DXCH_NETIF_GDMA_FROM_CPU_MAX_PORTS_CNS, CPSS_DXCH_NETIF_GDMA_FROM_CPU_PORT_INFO_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_NETIF_GDMA_TO_CPU_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_NETIF_GDMA_TO_CPU_INFO_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numOfValidPorts);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, portsInfo, CPSS_DXCH_NETIF_GDMA_TO_CPU_MAX_PORTS_CNS, CPSS_DXCH_NETIF_GDMA_TO_CPU_PORT_INFO_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_BOOL_MAC(valPtr, bypassQueueEnable);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_NETIF_GDMA_FROM_CPU_PORT_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_NETIF_GDMA_FROM_CPU_PORT_INFO_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, cpuPortNumber);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, firstQueue);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numOfQueues);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, gdmaUnitId);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, gdmaFirstQueue);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_NETIF_GDMA_TO_CPU_PORT_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_NETIF_GDMA_TO_CPU_PORT_INFO_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, cpuPortNumber);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, firstQueue);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numOfQueues);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, numOfGdmaUnits);
    PRV_CPSS_LOG_STC_TYPE_ARRAY_MAC(valPtr, gdmaUnitInfoArr, CPSS_DXCH_NETIF_GDMA_TO_CPU_MAX_GDMA_UNITS_CNS, CPSS_DXCH_NETIF_GDMA_TO_CPU_GDMA_UNIT_INFO_STC);
    prvCpssLogStcLogEnd(contextLib, logType);
}
void prvCpssLogParamFuncStc_CPSS_DXCH_NETIF_GDMA_TO_CPU_GDMA_UNIT_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_NETIF_GDMA_TO_CPU_GDMA_UNIT_INFO_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, gdmaUnitId);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, gdmaFirstQueue);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, gdmaNumOfQueues);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFunc_CPSS_DXCH_NETIF_GDMA_CPU_PORTS_INFO_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_NETIF_GDMA_CPU_PORTS_INFO_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_NETIF_GDMA_CPU_PORTS_INFO_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_NETIF_GDMA_CPU_PORTS_INFO_STC_PTR_infoPtr = {
     "infoPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_NETIF_GDMA_CPU_PORTS_INFO_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChNetIfGdmaCpuPortsInfoGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_CPSS_DXCH_NETIF_GDMA_CPU_PORTS_INFO_STC_PTR_infoPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChNetworkIfLogLibDb[] = {
    ...
    {"cpssDxChNetIfGdmaCpuPortsInfoGet", 2, cpssDxChNetIfGdmaCpuPortsInfoGet_PARAMS, NULL},

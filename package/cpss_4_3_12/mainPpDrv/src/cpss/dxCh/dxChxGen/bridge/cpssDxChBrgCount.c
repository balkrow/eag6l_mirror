...
)
{
    ...
    case CPSS_DXCH_BRG_DROP_CNTR_UREG_L2_NON_IPV4_BC_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_NON_IPV4_BROADCAST_PACKET_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_IPV6_ICMP_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_IPV6_ICMP_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_MIRROR_IPV4_RIPV1_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_MIRROR_IPV4_RIPV1_TO_CPU_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_IPV6_NEIGHBOR_SOLICITATION_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_IPV6_NEIGHBOR_SOLICITATION_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_PROPRIETARY_MCAST_MAC_RANGE_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_CISCO_MCAST_MAC_RANGE_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_MAC_SPOOF_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SPOOF_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_MAC_SA_MOVED_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SA_MOVED_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_MAC_SA_IS_DA_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SA_IS_DA_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_SIP_IS_DIP_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_SIP_IS_DIP_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_TCP_UDP_SPORT_IS_DPORT_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_TCP_UDP_SPORT_IS_DPORT_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_TCP_FIN_WITHOUT_ACK_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_TCP_FIN_WITHOUT_ACK_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_TCP_WITHOUT_FULL_HEADER_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_DSA_TCP_WITHOUT_FULL_HEADER_E;
        break;
    case CPSS_DXCH_BRG_DROP_CNTR_ARP_CPU_CODE_E:
        *dsaCpuCodePtr = PRV_CPSS_DXCH_NET_DSA_TAG_ARP_CPU_CODE_E;
        break;
    default:
...
)
{
    ...
    case PRV_CPSS_DXCH_NET_DSA_TAG_NON_IPV4_BROADCAST_PACKET_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_UREG_L2_NON_IPV4_BC_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_IPV6_ICMP_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_IPV6_ICMP_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_MIRROR_IPV4_RIPV1_TO_CPU_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_MIRROR_IPV4_RIPV1_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_IPV6_NEIGHBOR_SOLICITATION_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_IPV6_NEIGHBOR_SOLICITATION_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_CISCO_MCAST_MAC_RANGE_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_PROPRIETARY_MCAST_MAC_RANGE_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SPOOF_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_MAC_SPOOF_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SA_MOVED_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_MAC_SA_MOVED_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SA_IS_DA_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_MAC_SA_IS_DA_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_SIP_IS_DIP_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_SIP_IS_DIP_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_TCP_UDP_SPORT_IS_DPORT_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_TCP_UDP_SPORT_IS_DPORT_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_TCP_FIN_WITHOUT_ACK_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_TCP_FIN_WITHOUT_ACK_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_DSA_TCP_WITHOUT_FULL_HEADER_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_TCP_WITHOUT_FULL_HEADER_E;
        break;
    case PRV_CPSS_DXCH_NET_DSA_TAG_ARP_CPU_CODE_E:
        *dropModePtr = CPSS_DXCH_BRG_DROP_CNTR_ARP_CPU_CODE_E;
        break;
    default:
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, LOG_ERROR_NO_MSG);
    }

...
*                                       CPSS_PACKET_CMD_MIRROR_TO_CPU_E,
*                                       CPSS_PACKET_CMD_TRAP_TO_CPU_E.
*                                       CPSS_PACKET_CMD_DROP_HARD_E(Invalid for: xCat3; AC5; Lion2).
*                                       CPSS_PACKET_CMD_DROP_SOFT_E(Invalid for: xCat3; AC5; Lion2).
*
* @retval GT_OK                    - on success.
* @retval GT_FAIL                  - on error.
* @retval GT_HW_ERROR              - on hardware error
...
* @note   NOT APPLICABLE DEVICES:  Lion2; AAS.
*
* @param[in] devNum                - device number
...
)
{
    ...
    PRV_CPSS_DXCH_DEV_CHECK_MAC(devNum);
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_FALCON_E | CPSS_AC5X_E  | CPSS_AC5P_E | CPSS_HARRIER_E  | CPSS_IRONMAN_E  | CPSS_AAS_E);
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_XCAT3_E | CPSS_AC5_E | CPSS_LION2_E |
                                          CPSS_FALCON_E | CPSS_AC5X_E  | CPSS_AC5P_E | CPSS_HARRIER_E  | CPSS_IRONMAN_E  | CPSS_AAS_E);

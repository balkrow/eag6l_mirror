...
/**
* @internal internal_cpssDxChBrgSecurBreachPortGroupGlobalDropCntrSet function
* @endinternal
*
* @brief Sets value of security breach global drop counter.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
*                                   is set then function returns GT_BAD_PARAM.
*                                   value CPSS_PORT_GROUP_UNAWARE_MODE_CNS is supported.
* @param[in] dropCnt               - secure breach global drop counter
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
static GT_STATUS internal_cpssDxChBrgSecurBreachPortGroupGlobalDropCntrSet
(
    IN  GT_U8                devNum,
    IN  GT_PORT_GROUPS_BMP   portGroupsBmp,
    IN  GT_U32               dropCnt
)
{
    ...
    /************************************/
    /* Set Security Breach Global Drop Counter */
    /************************************/
    ...
    {
        regAddr = PRV_CPSS_DXCH_DEV_REGS_MAC(devNum)->bridgeRegs.bridgeGlobalSecurBreachDropCounter;
    }
...
/**
* @internal cpssDxChBrgSecurBreachPortGroupGlobalDropCntrSet function
* @endinternal
*
* @brief Sets value of security breach global drop counter.
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChBrgSecurBreachPortGroupGlobalDropCntrSet
(
    IN  GT_U8                devNum,
    IN  GT_PORT_GROUPS_BMP   portGroupsBmp,
    IN  GT_U32               dropCnt
...
{
    GT_STATUS rc;
    CPSS_LOG_FUNC_VARIABLE_DECLARE_MAC(funcId, cpssDxChBrgSecurBreachPortGroupGlobalDropCntrSet);

    CPSS_API_LOCK_MAC(devNum,PRV_CPSS_FUNCTIONALITY_CONFIGURATION_CNS);
    CPSS_LOG_API_ENTER_MAC((funcId, devNum, portGroupsBmp, dropCnt));

    rc = internal_cpssDxChBrgSecurBreachPortGroupGlobalDropCntrSet(devNum, portGroupsBmp, dropCnt);

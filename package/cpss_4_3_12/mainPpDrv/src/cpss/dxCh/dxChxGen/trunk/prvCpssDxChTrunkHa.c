...
*
* @note   APPLICABLE DEVICES:      Aldrin;Aldrin2; Falcon;AC5; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; Bobcat2; Caelum;AC3X;
*
...
*         with data from HW
*         note: in case of sip4 device function returns GT_OK without any sync
*
* @note   APPLICABLE DEVICES:      Aldrin;Aldrin2; Falcon;AC5; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; Bobcat2; Caelum;AC3X;
*
...
/***********member table**************************************************************************************************************/
            if (trunkType == CPSS_TRUNK_TYPE_REGULAR_E)/*cascade ports skip this part*/
            {
                ...
                if (PRV_CPSS_DEV_TRUNK_INFO_MAC(devNum)->trunksArray[trunkId].policy ==
                        CPSS_TRUNK_LOAD_BALANCE_POLICY_RESILIENT_E)
                {
                    CPSS_LOG_INFORMATION_MAC("\nTrunk Is Resilient .trunkId %d ", trunkId);
                    goto fixTrunk_lbl;
                }

...
)
{
    ...
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, epgAssignedToLeafNode);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFuncStc_CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
{
    PRV_CPSS_LOG_START_FIELD_STC_MAC(CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC *, valPtr);
    PRV_CPSS_LOG_UNUSED_MAC(inOutParamInfoPtr);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, l2NatSrcIdSize);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, l2NatSrcIdLsb);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
)
{
    ...
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, sipPrefixLen);
    PRV_CPSS_LOG_STC_NUMBER_MAC(valPtr, dipPrefixLen);
    prvCpssLogStcLogEnd(contextLib, logType);
}
...
void prvCpssLogParamFunc_CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
{
    PRV_CPSS_LOG_START_PARAM_STC_MAC(CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC*, paramVal);
    prvCpssLogParamFuncStc_CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC_PTR(contextLib, logType, namePtr, paramVal, inOutParamInfoPtr);
}
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC_PTR_l2NatGlobalCfgPtr = {
     "l2NatGlobalCfgPtr", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_IP_CNT_SET_ENT_countSetIndex = {
     "countSetIndex", PRV_CPSS_LOG_PARAM_IN_E,  PRV_CPSS_LOG_FUNC_TYPE_MAC(CPSS_IP_CNT_SET_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC_PTR_l2NatGlobalCfgPtr = {
     "l2NatGlobalCfgPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_IP_CNT_SET_ENT_PTR_countSetIndexPtr = {
     "countSetIndexPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(CPSS_IP_CNT_SET_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U64_PTR_dropPktsPtr = {
     "dropPktsPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_MAC(GT_U64)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpFdbRouteCounterSetIndexSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_IP_CNT_SET_ENT_countSetIndex
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpNatL2GlobalConfigSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_IP_NAT_TYPE_ENT_natType,
    &DX_IN_CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC_PTR_l2NatGlobalCfgPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpNatL2GlobalConfigGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_IP_NAT_TYPE_ENT_natType,
    &DX_OUT_CPSS_DXCH_IP_NAT_L2_GLOBAL_CONFIG_STC_PTR_l2NatGlobalCfgPtr
};
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpEcmpUcRpfAccessLevelSet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_IP_PROTOCOL_STACK_ENT_protocolStack,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpEcmpUcRpfAccessLevelGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_CPSS_IP_PROTOCOL_STACK_ENT_protocolStack,
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpPortGroupMultiTargetQueueFullDropCntGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_IN_GT_PORT_GROUPS_BMP_portGroupsBmp,
    &DX_OUT_GT_U32_PTR_dropPktsPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpFdbRouteCounterSetIndexGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_CPSS_IP_CNT_SET_ENT_PTR_countSetIndexPtr
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChIpDropCntGet_PARAMS[] =  {
    &DX_IN_GT_U8_devNum,
    &DX_OUT_GT_U64_PTR_dropPktsPtr
};
...
static const PRV_CPSS_LOG_FUNC_ENTRY_STC prvCpssDxChIpLogLibDb[] = {
    ...
    {"cpssDxChIpDropCntGet", 2, cpssDxChIpDropCntGet_PARAMS, NULL},
    ...
    {"cpssDxChIpEcmpUcRpfAccessLevelSet", 3, cpssDxChIpEcmpUcRpfAccessLevelSet_PARAMS, NULL},
    {"cpssDxChIpEcmpUcRpfAccessLevelGet", 3, cpssDxChIpEcmpUcRpfAccessLevelGet_PARAMS, NULL},
    ...
    {"cpssDxChIpPortGroupMultiTargetQueueFullDropCntGet", 3, cpssDxChIpPortGroupMultiTargetQueueFullDropCntGet_PARAMS, NULL},
    ...
    {"cpssDxChIpFdbRouteCounterSetIndexSet", 2, cpssDxChIpFdbRouteCounterSetIndexSet_PARAMS, NULL},
    {"cpssDxChIpFdbRouteCounterSetIndexGet", 2, cpssDxChIpFdbRouteCounterSetIndexGet_PARAMS, NULL},
    {"cpssDxChIpUcBypassRouterforIgmpOrMldPacketsSet", 2, prvCpssLogGenDevNumEnable_PARAMS, NULL},
    {"cpssDxChIpUcBypassRouterforIgmpOrMldPacketsGet", 2, prvCpssLogGenDevNumEnablePtr_PARAMS, NULL},
    ...
    {"cpssDxChIpNatL2GlobalConfigSet", 3, cpssDxChIpNatL2GlobalConfigSet_PARAMS, NULL},
    {"cpssDxChIpNatL2GlobalConfigGet", 3, cpssDxChIpNatL2GlobalConfigGet_PARAMS, NULL},
};

...
*                                       or mappingTableIndex > 71 (APPLICABLE DEVICES : AAS)
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
...
)
{
    ...
    PRV_CPSS_NOT_APPLICABLE_DEV_CHECK_MAC(devNum, CPSS_BOBCAT2_E | CPSS_CAELUM_E | CPSS_ALDRIN_E | CPSS_AC3X_E | CPSS_BOBCAT3_E |
                                          CPSS_ALDRIN2_E | CPSS_FALCON_E | CPSS_AC5P_E | CPSS_AC5X_E | CPSS_HARRIER_E | CPSS_IRONMAN_E | CPSS_AAS_E);
...
)
{
    ...
    if ((mappingTableIndex >= PRV_CPSS_DXCH_COS_INGRESS_MAPPING_TRUST_TABLE_SIZE_SIP5_CNS)
        && (PRV_CPSS_SIP_7_CHECK_MAC(devNum) == 0))
    {
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, LOG_ERROR_NO_MSG);
    }
    if (mappingTableIndex >= PRV_CPSS_DXCH_COS_INGRESS_MAPPING_TRUST_TABLE_SIZE_SIP7_CNS)
    {
        /*AAS*/
        CPSS_LOG_ERROR_AND_RETURN_MAC(GT_OUT_OF_RANGE, LOG_ERROR_NO_MSG);
    }

    /* write entry to pre-tti-lookup-ingress-eport Table  - trust mapping tables index */
    rc = prvCpssDxChWriteTableEntryField(devNum,
                                         CPSS_DXCH_SIP5_TABLE_PRE_TTI_LOOKUP_INGRESS_EPORT_E,
                                         portNum,
                                         PRV_CPSS_DXCH_TABLE_WORD_INDICATE_FIELD_NAME_CNS,
    ...
    {
        /* write entry to pre-tti-lookup-ingress-eport Table  - trust mapping tables index extension */
        rc = prvCpssDxChWriteTableEntryField(
            devNum,
            CPSS_DXCH_SIP5_TABLE_PRE_TTI_LOOKUP_INGRESS_EPORT_E,
            portNum,
            PRV_CPSS_DXCH_TABLE_WORD_INDICATE_FIELD_NAME_CNS,
            SIP7_TTI_DEFAULT_EPORT_TABLE_FIELDS_TRUST_QOS_MAPPING_TABLE_INDEX_EXTENSION_E, /* field name */
            PRV_CPSS_DXCH_TABLES_WORD_INDICATE_AUTO_CALC_LENGTH_CNS,
            (mappingTableIndex >> 4));
        if(rc != GT_OK)
        {
...
)
{
    ...
    /* read entry from pre-tti-lookup-ingress-eport Table  - trust mapping tables index */
    rc = prvCpssDxChReadTableEntryField(devNum,
                                         CPSS_DXCH_SIP5_TABLE_PRE_TTI_LOOKUP_INGRESS_EPORT_E,
                                         portNum,
                                         PRV_CPSS_DXCH_TABLE_WORD_INDICATE_FIELD_NAME_CNS,
    ...
    if (PRV_CPSS_SIP_7_CHECK_MAC(devNum))
    {
        /* read entry to pre-tti-lookup-ingress-eport Table  - trust mapping tables index extension */
        rc = prvCpssDxChReadTableEntryField(
            devNum,
            CPSS_DXCH_SIP5_TABLE_PRE_TTI_LOOKUP_INGRESS_EPORT_E,
            portNum,
        ...
        *mappingTableIndexPtr |= (hwValue << 4);
    }

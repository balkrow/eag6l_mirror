...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_LOOKUP_ENT_lookupNum;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_profileSet;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC * const prvCpssLogGenDevNumPortNumLaneNumEnable_PARAMS[];
extern const PRV_CPSS_LOG_FUNC_PARAM_STC * const prvCpssLogGenDevNumPortNumLaneNumEnablePtr_PARAMS[];
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC * const prvCpssLogGenDevNumTimeout_PARAMS[];
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC * const prvCpssLogGenDevNumTimeoutPtr_PARAMS[];

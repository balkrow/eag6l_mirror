...
typedef struct{
    ...
    /** Destination interface : port/trunk/vidx/vlan */
...
typedef struct{
     ...
     *    (APPLICABLE RANGES: xCat3, AC5, Lion2 0..0xF)
     *    (APPLICABLE RANGES: Bobcat2, Caelum, Bobcat3, Aldrin2, Aldrin, AC3X 0..0xFF)
     *    (APPLICABLE RANGES: Falcon, AC5P, AC5X, Harrier, Ironman 0..0x7FF)
     *  NOTE: For SIP6 devices, userDefined[10:1] in HW = userDefined, Bit_0 in HW is reserved
     */
    GT_U32 userDefined;

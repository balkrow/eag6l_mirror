...
typedef enum{
    ...
    */
    ...
    /** IP_NOT_FOUND CPU codes overlaps with user defined byte.
     *  These codes will be generated by the asic while trying to
     *  search a prefix in a non-existent virtual router */

    /** ipv4 multicast DIP not found */
    CPSS_NET_IPV4_MC_DIP_NOT_FOUND_E            = CPSS_NET_USER_DEFINED_8_E,

    /** ipv4 unicast DIP not found */
    CPSS_NET_IPV4_UC_DIP_NOT_FOUND_E            = CPSS_NET_USER_DEFINED_9_E,

    /** ipv6 multicast DIP not found */
    CPSS_NET_IPV6_MC_DIP_NOT_FOUND_E            = CPSS_NET_USER_DEFINED_10_E,

    /** ipv6 unicast DIP not found */
    CPSS_NET_IPV6_UC_DIP_NOT_FOUND_E            = CPSS_NET_USER_DEFINED_11_E,

    /** ipv4 unicast SIP not found */
    CPSS_NET_IPV4_UC_SIP_NOT_FOUND_E            = CPSS_NET_USER_DEFINED_12_E,

    /** ipv6 unicast SIP not found */
    CPSS_NET_IPV6_UC_SIP_NOT_FOUND_E            = CPSS_NET_USER_DEFINED_13_E,

...
typedef struct{
    ...
    CPSS_PORT_TX_TAIL_DROP_DBA_ALPHA_ENT dp2QueueAlpha;
     ...
     /** @brief if equal GT_FALSE pool limit ignored ,otherwise pool limit considered
     *  (APPLICABLE DEVICES: AAS)
     */
    GT_BOOL poolLimitEnable;
    /* @brief Common exponent factor for all queue related limits.
        Limits factored by Queue limit factored by 2^Queue exp(4) :
                1. Queue limit .
                2. QCN Guranteed Limit .
                3. CN length max limit.
                4. Tail Drop WRED size.
                5. Tail Drop Guaranteed limit.
...
typedef enum{
    ...
    /** @brief Drop Profile Set #17
    *  (APPLICABLE DEVICES: AAS)
    */
    CPSS_PORT_TX_DROP_PROFILE_17_E,

    /** @brief Drop Profile Set #18
    *  (APPLICABLE DEVICES: AAS)
    */
    CPSS_PORT_TX_DROP_PROFILE_18_E,

    /** @brief Drop Profile Set #19
    *  (APPLICABLE DEVICES: AAS)
    */
    CPSS_PORT_TX_DROP_PROFILE_19_E,

     /** @brief Drop Profile Set #20
      *  (APPLICABLE DEVICES: AAS)
     */
    CPSS_PORT_TX_DROP_PROFILE_20_E,

    /** @brief Drop Profile Set #21
      *  (APPLICABLE DEVICES: AAS)
     */
    CPSS_PORT_TX_DROP_PROFILE_21_E,

    /** @brief Drop Profile Set #22
     *  (APPLICABLE DEVICES: AAS)
     */
    CPSS_PORT_TX_DROP_PROFILE_22_E,

    /** @brief Drop Profile Set #23
     *  (APPLICABLE DEVICES: AAS)
     */
    CPSS_PORT_TX_DROP_PROFILE_23_E,

    /** @brief Drop Profile Set #24
     *  (APPLICABLE DEVICES: AAS)
     */
    CPSS_PORT_TX_DROP_PROFILE_24_E,

    /** @brief Drop Profile Set #25
     *  (APPLICABLE DEVICES: AAS)
     */
    CPSS_PORT_TX_DROP_PROFILE_25_E,

    /** @brief Drop Profile Set #26
     *  (APPLICABLE DEVICES: AAS)
     */
    CPSS_PORT_TX_DROP_PROFILE_26_E,

    /** @brief Drop Profile Set #27
    *  (APPLICABLE DEVICES: AAS)
    */
    CPSS_PORT_TX_DROP_PROFILE_27_E,

    /** @brief Drop Profile Set #28
    *  (APPLICABLE DEVICES: AAS)
    */
    CPSS_PORT_TX_DROP_PROFILE_28_E,

    /** @brief Drop Profile Set #29
    *  (APPLICABLE DEVICES: AAS)
    */
    CPSS_PORT_TX_DROP_PROFILE_29_E,

    /** @brief Drop Profile Set #30
    *  (APPLICABLE DEVICES: AAS)
    */
    CPSS_PORT_TX_DROP_PROFILE_30_E,

    /** @brief Drop Profile Set #31
    *  (APPLICABLE DEVICES: AAS)
    */
    CPSS_PORT_TX_DROP_PROFILE_31_E,

    /** @brief Drop Profile Set #32
    *  (APPLICABLE DEVICES: AAS)
    */

    CPSS_PORT_TX_DROP_PROFILE_32_E,
...
/**
* @enum CPSS_PORT_TX_POOL_MODE_ENT
 *
 * @brief Defines operation mode of egress pools.
*/
typedef enum{

    /** @brief Two Lossy  pools (default mode)
     */
    CPSS_PORT_TX_POOL_MODE_TWO_LOSSY_E,
    /** @brief  One Lossy pool & Two Lossless pools.Pool 1 - Reserved for lossy TCs in the TD algorithm (set Th to max)
     */
    CPSS_PORT_TX_POOL_MODE_ONE_LOSSY_TWO_LOSLESS_E,
   /** @brief  Four Lossless pools (TD uses PB and not pool)
     */
    CPSS_PORT_TX_POOL_MODE_FOUR_LOSSLESS_E
} CPSS_PORT_TX_POOL_MODE_ENT;

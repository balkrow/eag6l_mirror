...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PORT_TX_DROP_MCAST_PRIORITY_ENT);
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PORT_TX_POOL_MODE_ENT);
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PORT_TX_TAIL_DROP_DBA_ALPHA_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PORT_TX_TAIL_DROP_RESOURCE_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PORT_TX_WRR_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PORT_TX_WRR_MTU_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_PORT_TX_TAIL_DROP_PROBABILITY_ENT);

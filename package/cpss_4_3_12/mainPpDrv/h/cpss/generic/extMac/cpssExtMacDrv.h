...
#ifdef SHARED_MEMORY
#define PRV_CPSS_PHY_MAC_OBJ(devNum,portNum) cpssMacDrvObjGet(devNum,portNum)
...
/*
 * typedef: GT_STATUS (*CPSS_MACDRV_MAC_AUTONEG_SET_FUNC)
 *
 * Description: defines Autoneg set callback for MACPHY object
 *
 * INPUTS:
 *   GT_U8                   devNum   - device number
 *   GT_PHYSICAL_PORT_NUM    portNum  - port number
 *   GT_BOOL                 anEnable - AN enable/disable
 *   GT_U32                  capabilites - Auto Negotiation bitmap values
...
/*29*/CPSS_MACDRV_MRU_GET_FUNC                    macDrvMacMRUGetFunc;
      CPSS_MACDRV_MAC_AUTONEG_SET_FUNC            macDrvMacAutonegSetFunc;
...
#ifdef SHARED_MEMORY
CPSS_MACDRV_OBJ_STC * cpssMacDrvObjGet
(
    IN  GT_U8     devNum,
    IN  GT_PHYSICAL_PORT_NUM     portNum
);

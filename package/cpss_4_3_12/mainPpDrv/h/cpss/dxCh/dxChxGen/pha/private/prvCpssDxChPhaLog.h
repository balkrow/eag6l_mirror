...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_PHA_IFA_REP_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_PHA_RE_TRAP_MODE_ENT);
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC_PTR_ifaEntryPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_entryId;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PHA_IFA_FLOW_ENTRY_STC_PTR_ifaEntryPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U64_PTR_ecnCountPtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChPhaSharedMemoryIfaEntrySet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPhaSharedMemoryIfaEntryGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPhaSharedMemoryEcnCounterGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPhaSharedMemoryEcnCounterReset_E
};

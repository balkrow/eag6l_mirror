...
typedef struct{
    ...
    /** @brief
     *  - GT_TRUE  - bypass FDB SA and DA lookups.
     *  - GT_FALSE - No bypass FDB SA and DA lookups.
     *   (APPLICABLE_DEVICES: AAS)
     */
    GT_BOOL bypassFdbLookup;

    /** @brief
     *  - GT_TRUE  - bypass MPCL lookup.
     *  - GT_FALSE - No bypass MPCL lookup.
     *   (APPLICABLE_DEVICES: AAS)
     */
    GT_BOOL bypassMidwayPcl;

    /** @brief
     *  - GT_TRUE  - bypass IPE unit.
     *  - GT_FALSE - No bypass bypass IPE unit.
     *   (APPLICABLE_DEVICES: AAS)
     */
    GT_BOOL bypassIpe;

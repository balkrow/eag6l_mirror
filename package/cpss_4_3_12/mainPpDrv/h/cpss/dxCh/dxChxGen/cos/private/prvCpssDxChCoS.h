...
/* size of ingress trusted values mapping tables */
#define PRV_CPSS_DXCH_COS_INGRESS_MAPPING_TRUST_TABLE_SIZE_SIP5_CNS 12
#define PRV_CPSS_DXCH_COS_INGRESS_MAPPING_TRUST_TABLE_SIZE_SIP7_CNS 72

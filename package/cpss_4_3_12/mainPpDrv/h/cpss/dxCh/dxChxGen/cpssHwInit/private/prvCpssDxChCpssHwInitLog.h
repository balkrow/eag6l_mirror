...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_DMA_MEM_TYPE_ENT);
...
void prvCpssLogParamFuncStc_CPSS_DXCH_HW_PP_DMA_CONFIGURE_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_HW_PP_DMA_RESERVE_RESOURCES_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PP_PHASE1_VPORT_MODE_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PP_PHASE1_VPORT_MODE_INFO_STC_FDB_LEARN_PRIORITY_INFO_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_HW_PP_DMA_CONFIGURE_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_HW_PP_DMA_RESERVE_RESOURCES_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_HW_PP_DMA_CONFIGURE_STC_PTR_dmaCfgPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_HW_PP_DMA_RESERVE_RESOURCES_STC_PTR_dmaReserveResourcesPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_HW_PP_SOFT_RESET_OPTIONS_ENT_softResetType;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_LED_PARALLEL_CONFIG_STC_PTR_ledParallelConfigPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_PTR_ledSerialOutputBitMapArr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_reorderMapArraySize;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_LED_PARALLEL_CONFIG_STC_PTR_ledParallelConfigPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_ledSerialOutputBitMapArr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChHwPpDmaConfigSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChHwPpDmaReserveResourcesSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChHwPpSoftResetSkipParamsAndTrigger_E,
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChLedParallelConfigSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChLedParallelConfigGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChLedStreamReorderMapSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChLedStreamReorderMapGet_E
};

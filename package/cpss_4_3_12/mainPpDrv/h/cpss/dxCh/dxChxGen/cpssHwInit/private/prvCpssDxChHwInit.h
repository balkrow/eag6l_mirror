...
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Bobcat2; Caelum; Bobcat3; Aldrin; AC3X; Aldrin2; Falcon; AC5P; AC5X; Ironman.
*
* @param[in] devNum                   - the device number
* @param[in] portGroupId              - The port group id. relevant only to 'multi-port-groups'
*                                      devices. Supports value CPSS_PORT_GROUP_UNAWARE_MODE_CNS
...
* @endinternal
*
* @brief   Check if register address is duplicated in AAS devices.
*
...
/**
* @internal prvCpssDxChCheckIsHwDidHwReset function
* @endinternal
*
* @brief Checks the current contents of the MG_0_1 user defined register
*    writes not-zero value into it to mark that reset needed
*    for the next boot. This rerister cleared by reset.
*
* @note   APPLICABLE DEVICES:      AC5; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; xCat3; Lion2; Bobcat2.
*
* @param[in] devNum - device number
* @retval GT_TRUE   - the device does not support such MG unit or not zer in the register
* @retval GT_FALSE  - the register read and zero found in it
*
*/
GT_BOOL prvCpssDxChCheckIsHwDidHwReset
(
    IN GT_U8 devNum
);

/**
* @internal prvCpssDxChDeviceDidResetConfig function
* @endinternal
*
* @brief configure device to be in state after HW Reset or Soft reset of Switch
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman.
...
*
*/
GT_STATUS prvCpssDxChDeviceDidResetConfig
(
    IN GT_U8 devNum
);

/**
* @struct PRV_CPSS_DXCH_BRG_FDB_LEARN_PRIORITY_VPORT_GLOBAL_INFO_STC
*
...
}PRV_CPSS_DXCH_BRG_FDB_LEARN_PRIORITY_VPORT_GLOBAL_INFO_STC;


/**
* @internal prvCpssDxChBrgFdbLearnPriorityVPortGlobalInfoSet function
* @endinternal
*
* @brief   Set Learn priority global info for vPorts.
*          needed for : MAC Spoof Protection
*
* @note   APPLICABLE DEVICES: AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
* @param[in] devNum                - device number
* @param[in] configPtr             - (pointer to) the global info about vPorts
*
* @retval GT_OK                    - on success.
...
*
*/
GT_STATUS prvCpssDxChBrgFdbLearnPriorityVPortGlobalInfoSet
(
    IN GT_U8                    devNum,
    IN PRV_CPSS_DXCH_BRG_FDB_LEARN_PRIORITY_VPORT_GLOBAL_INFO_STC *configPtr
);

/**
 * @internal prvCpssDxChPhyRefClkOutEnable function
 * @endinternal
 *
 * @brief  enable/disable phy refClk Tx Pu/Oe
 *
 * @note   APPLICABLE DEVICES:      Ironman-L.
 * @note   NOT APPLICABLE DEVICES:  Lion2; xCat3; AC5; Bobcat2;
 *                                   Caelum; Aldrin; Aldrin2; AC3X;
 *                                   Bobcat3; Falcon; AC5P;
 *                                   AC5X; Harrier; AAS; Ironman-M.
 *
 * @param[in] devNum                - device number
 * @param[in] refClkCfgEnum         - enum for the enable/disable of the ref clk values:
 *                                     0x00 Pu disable, Oe disable
 *                                     0x01 Pu disable, Oe enable
 *                                     0x10 Pu enable,  Oe disable
 *                                     0x11 Pu enable,  Oe enable
 *
 * @retval GT_OK                    - on success.
 * @retval GT_NOT_SUPPORTED         - the device not supported by CPSS
 ...
 * @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
 */
GT_STATUS prvCpssDxChPhyRefClkOutEnable
(
    IN GT_U8                              devNum,
    IN CPSS_PHY_REF_CLK_PU_OE_CFG_ENT     refClkCfgEnum
);

/**
* @internal prvCpssDxChHwAacRegistersIndirectWrite function
* @endinternal
*
* @brief   Write a sequence of register data using AAC method.
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; Lion2; AC5; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
* @param[in] devNum                   - device number
* @param[in] channel                  - AAC channel number
* @param[in] numOfRegs                - number of pairs of register address and data
* @param[in] regAddrArr               - (pointer to) array of registers addresses.
* @param[in] regDataArr               - (pointer to) array of registers data.
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on bad parameter error
* @retval GT_BAD_PTR               - one of the parameters is NULL pointer
...
*
*/
GT_STATUS prvCpssDxChHwAacRegistersIndirectWrite
(
    IN GT_U8                    devNum,
    IN GT_U32                   channel,
    IN GT_U32                   numOfRegs,

...
typedef enum {
    ...
    ,SIP7_FDB_AU_MSG_TABLE_FIELDS_USE_VPORT_E
    ,SIP7_FDB_AU_MSG_TABLE_FIELDS_VPORT_0_13_E
    ,SIP7_FDB_AU_MSG_TABLE_FIELDS_VPORT_14_17_E
    ...
    ,SIP7_FDB_AU_MSG_TABLE_FIELDS_VIDX_16_E
...
typedef enum {
    ...
    ,SIP6_IPCL_ACTION_TABLE_FIELDS_IPCL_RESERVED_EN_E /*GROUPS_ID enable*/
    ,SIP6_IPCL_ACTION_TABLE_FIELDS_IPCL_TO_TXQ_RESERVED_E /*GROUPS_ID*/
    ...
    /* new fields in sip7 */
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_TRG_VPORT_E  = SIP6_10_IPCL_ACTION_TABLE_FIELDS___LAST_VALUE___E
    ...
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_FORCE_DP_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_DISABLE_EM_LOOKUP_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_CANCEL_DROP_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_ASSIGN_CMD_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_VALUE_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_SR_V6_PSP_ENABLE_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_DECREMENT_TTL_ENABLE_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_SR_V6_SET_PASSENGER_END_NODE_TYPE_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_ASSIGN_EN_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_CONTROL_ENABLE_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_LOOPBACK_SELECTOR_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_DISABLE_E
    ,SIP7_IPCL_ACTION_TABLE_FIELDS_SOURCE_VPORT_PROFILE_ASSIGN_EN_E

    ,SIP7_IPCL_ACTION_TABLE_FIELDS___LAST_VALUE___E/* used for array size */

}SIP6_IPCL_ACTION_TABLE_FIELDS_ENT;

/*
 * Typedef: enum SIP7_MPCL_ACTION_TABLE_FIELDS_ENT
 *
 * Description:
 *      enumeration to hold fields of MPCL Action table.
 *
 *
 */
typedef enum {
    ...
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_BYPASS_INGRESS_AND_EGRESS_FILTERING_E
    ...
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_ASSIGN_CMD_E
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_GEN_CLASSIFY_VALUE_E
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_ASSIGN_EPCL_UDB_PKT_TYPE_E
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_EPCL_UDB_PKT_TYPE_VALUE_E
    ...
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_CONTROL_ENABLE_E
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_LOOPBACK_SELECTOR_E
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_EGRESS_FORWARD_DISABLE_E
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_FORCE_DP_E
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_DISABLE_EM_LOOKUP_E
    ,SIP7_MPCL_ACTION_TABLE_FIELDS_VLAN_PRECEDENCE_E

    ,SIP7_MPCL_ACTION_TABLE_FIELDS___LAST_VALUE___E/* used for array size */
}SIP7_MPCL_ACTION_TABLE_FIELDS_ENT;
...
typedef enum {
    ...
    ,SIP6_30_FDB_FDB_TABLE_FIELDS_UC_ROUTE_EPG_STREAM_ID_E
...
#define SIP6_CONVERT_HW_SA_PACKET_CMD_TO_SW_VAL_MAC(_devNum, _cmd, _val)      \
    switch (_val)                                                             \
    {                                                                         \
        default:/*can't get here on 1 bit field*/                            \
        case 0:                                                               \
        ...
        case 1:                                                               \
            _cmd =                                                            \
                ((PRV_CPSS_DXCH_PP_MAC(_devNum)->bridge.sip6FdbSaDropCommand  \
...
#define SIP6_CONVERT_HW_DA_PACKET_CMD_TO_SW_VAL_MAC(_devNum, _cmd, _val)      \
    switch (_val)                                                             \
    {                                                                         \
        default:/*can't get here on 2 bits field*/                            \
        case 0:                                                               \
        ...
        case 3:                                                               \
            _cmd =                                                            \
                ((PRV_CPSS_DXCH_PP_MAC(_devNum)->bridge.sip6FdbDaDropCommand  \
                  == CPSS_MAC_TABLE_SOFT_DROP_E)                              \
                 ? CPSS_PACKET_CMD_DROP_SOFT_E                                \
                 : CPSS_PACKET_CMD_DROP_HARD_E);                              \
            break;                                                            \
...
#define SIP6_EXACT_MATCH_ENTRY_FIELD_REDUCED_ACTION_SET_MAC(_dev,_hwDataArr,_reduceActionBytes,_expandedActionIndex)\
    if (PRV_CPSS_SIP_7_CHECK_MAC(_dev))                                                                     \
    {                                                                                                       \
        REDUCED_ACTION_SIP7_SET_FIELD_BY_ID_MAC(_hwDataArr,                                                 \
            PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_EXACT_MATCH_E].fieldsInfoPtr,            \
            SIP5_EXACT_MATCH_TABLE_FIELDS_REDUCE_ACTION_E,                                                  \
...
#define SIP6_EXACT_MATCH_ENTRY_FIELD_REDUCED_ACTION_GET_MAC(_dev,_hwDataArr,_reduceActionBytes,_expandedActionIndex)\
    if (PRV_CPSS_SIP_7_CHECK_MAC(_dev))                                                                     \
    {                                                                                                       \
        REDUCED_ACTION_SIP7_GET_FIELD_BY_ID_MAC(_hwDataArr,                                                 \
            PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_EXACT_MATCH_E].fieldsInfoPtr,            \
            SIP5_EXACT_MATCH_TABLE_FIELDS_REDUCE_ACTION_E,                                                  \
            _reduceActionBytes,_expandedActionIndex)                                                        \
    }                                                                                                       \
...
#define SIP6_EXACT_MATCH_ENTRY_FIELD_KEY_ONLY_SET_MAC(_dev,_hwDataArr,_keyPatternBytes)                     \
    if (PRV_CPSS_SIP_7_CHECK_MAC(_dev))                                                                     \
    {                                                                                                       \
        KEY_ONLY_SIP7_SET_FIELD_BY_ID_MAC(_hwDataArr,                                                       \
            PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_EXACT_MATCH_E].fieldsInfoPtr,            \
            SIP6_EXACT_MATCH_TABLE_FIELDS_KEY_ONLY_E,                                                       \
            _keyPatternBytes)                                                                               \
    }                                                                                                       \
...
#define SIP6_EXACT_MATCH_ENTRY_FIELD_KEY_ONLY_GET_MAC(_dev,_hwDataArr,_keyPatternBytes)                     \
    if (PRV_CPSS_SIP_7_CHECK_MAC(_dev))                                                                     \
    {                                                                                                       \
        KEY_ONLY_SIP7_GET_FIELD_BY_ID_MAC(_hwDataArr,                                                       \
            PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_EXACT_MATCH_E].fieldsInfoPtr,            \
            SIP6_EXACT_MATCH_TABLE_FIELDS_KEY_ONLY_E,                                                       \
            _keyPatternBytes)                                                                               \
    }                                                                                                       \
...
/* macro to set value to field of PREQ_PORT_PROFILE  format in buffer */
#define SIP6_PREQ_PORT_PROFILE_FIELD_SET_MAC(_dev,_hwDataArr,_fieldName,_value)    \
    U32_SET_FIELD_BY_ID_MAC(_hwDataArr,                             \
        PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_PREQ_PORT_PROFILE_E].fieldsInfoPtr, \
        _fieldName,                                                 \
        _value)

/* macro to get field value of PREQ_PORT_PROFILE format in buffer */
#define SIP6_PREQ_PORT_PROFILE_FIELD_GET_MAC(_dev,_hwDataArr,_fieldName,_value)    \
    U32_GET_FIELD_BY_ID_MAC(_hwDataArr,                             \
        PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_PREQ_PORT_PROFILE_E].fieldsInfoPtr, \
        _fieldName,                                                 \
        _value)
...
/* macro to set value to field of PREQ_PORT_PROFILE  format in buffer */
#define SIP6_PREQ_PROFILE_FIELD_SET_MAC(_dev,_hwDataArr,_fieldName,_value)    \
    U32_SET_FIELD_BY_ID_MAC(_hwDataArr,                             \
        PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_PREQ_PROFILES_E].fieldsInfoPtr, \
        _fieldName,                                                 \
        _value)

/* macro to get field value of PREQ_PORT_PROFILE format in buffer */
#define SIP6_PREQ_PROFILE_FIELD_GET_MAC(_dev,_hwDataArr,_fieldName,_value)    \
    U32_GET_FIELD_BY_ID_MAC(_hwDataArr,                             \
        PRV_TABLE_FORMAT_INFO(_dev)[PRV_CPSS_DXCH_TABLE_FORMAT_PREQ_PROFILES_E].fieldsInfoPtr, \
        _fieldName,                                                 \
        _value)

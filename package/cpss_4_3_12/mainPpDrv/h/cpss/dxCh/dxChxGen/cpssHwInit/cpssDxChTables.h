...
#define CPSS_DXCH_SIP7_MAX_PDS_UNITS_PER_DEVICE_MAC 8
#define CPSS_DXCH_SIP7_MAX_SDQ_UNITS_PER_DEVICE_MAC 8
#define CPSS_DXCH_SIP7_MAX_QFC_UNITS_PER_DEVICE_MAC 8
...
#define PRV_TABLE_INFO_PTR_GET_MAC(_devNum, _tableType) \
 (&PRV_CPSS_ACCESS_TABLE_INFO_PTR(_devNum)[_tableType])
...
typedef enum
{
    ...
    PRV_CPSS_DXCH_TXQ_MULTIPLE_TABLE(CPSS_DXCH_SIP6_15_TXQ_SDQ_PORT_PFC_STATE,CPSS_DXCH_SIP6_MAX_SDQ_UNITS_PER_DEVICE_MAC),
    ...
    PRV_CPSS_DXCH_TXQ_MULTIPLE_TABLE(CPSS_DXCH_SIP6_30_TXQ_SDQ_QBV_CFG,CPSS_DXCH_SIP6_MAX_SDQ_UNITS_PER_DEVICE_MAC),
    PRV_CPSS_DXCH_TXQ_MULTIPLE_TABLE(CPSS_DXCH_SIP6_30_TXQ_SDQ_PORT_QBV_STATE,CPSS_DXCH_SIP6_MAX_SDQ_UNITS_PER_DEVICE_MAC),
    ...
    CPSS_DXCH_SIP7_TABLE_HA_ARP_E,/* ARP table that is not 'muxed' with 'tunnel start' CPSS_DXCH2_TABLE_TUNNEL_START_CONFIG_E */
    CPSS_DXCH_SIP7_TABLE_MIDWAY_PCL_CONFIG_E,
    CPSS_DXCH_SIP7_TABLE_MIDWAY_PCL_SOURCE_PORT_CONFIG_E,
    CPSS_DXCH_SIP7_TABLE_VRF_COMMON_E, /* hold info for ipv4,ipv6,fcoe */
    /* EXACT MATCH TABLES*/
    CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_1_E,
    CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_2_E,
    CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_3_E,
    CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_REDUCED_E,

    PRV_CPSS_DXCH_TXQ_MULTIPLE_TABLE(CPSS_DXCH_SIP7_TXQ_PDS_QUEUE_TO_PROFILE_MAP,CPSS_DXCH_SIP7_MAX_PDS_UNITS_PER_DEVICE_MAC),
    PRV_CPSS_DXCH_TXQ_MULTIPLE_TABLE(CPSS_DXCH_SIP7_TXQ_PDS_FLEXE_CHANNEL_MAP,CPSS_DXCH_SIP7_MAX_PDS_UNITS_PER_DEVICE_MAC),
    PRV_CPSS_DXCH_TXQ_MULTIPLE_TABLE(CPSS_DXCH_SIP7_TXQ_PSI_QUEUE_TO_QUEUE,2),
    PRV_CPSS_DXCH_TXQ_MULTIPLE_TABLE(CPSS_DXCH_SIP7_TXQ_SDQ_QUEUE_TO_PROFILE_MAP,CPSS_DXCH_SIP7_MAX_SDQ_UNITS_PER_DEVICE_MAC),
    PRV_CPSS_DXCH_TXQ_MULTIPLE_TABLE(CPSS_DXCH_SIP7_TXQ_SDQ_QUEUE_TO_PORT_MAP,CPSS_DXCH_SIP7_MAX_SDQ_UNITS_PER_DEVICE_MAC),
    PRV_CPSS_DXCH_TXQ_MULTIPLE_TABLE(CPSS_DXCH_SIP7_TXQ_QFC_LOGICAL_Q_TO_PROFILE_MAPPING_TABLE,CPSS_DXCH_SIP7_MAX_QFC_UNITS_PER_DEVICE_MAC),

    /* Sip 7- PPU for IPE  */
    CPSS_DXCH_SIP7_TABLE_PPU_FOR_IPE_ACTION_TABLE_0_E,
    CPSS_DXCH_SIP7_TABLE_PPU_FOR_IPE_ACTION_TABLE_1_E,
    CPSS_DXCH_SIP7_TABLE_PPU_FOR_IPE_ACTION_TABLE_2_E,
    CPSS_DXCH_SIP7_TABLE_PPU_FOR_IPE_ACTION_TABLE_3_E,


    /* IPE */
    CPSS_DXCH_SIP7_TABLE_IPE_STATE_ADDRESS_PROFILE_E,
    CPSS_DXCH_SIP7_TABLE_IPE_ICT_E,
    CPSS_DXCH_SIP7_TABLE_IPE_STATE_DATA_CMD_PROFILE_E,
    CPSS_DXCH_SIP7_TABLE_IPE_DPO_E,
    CPSS_DXCH_SIP7_TABLE_IPE_DPI_E,
    CPSS_DXCH_SIP7_TABLE_IPE_STATE_T0_E,
    CPSS_DXCH_SIP7_TABLE_IPE_STATE_T1_E,
    /* EQ */
    CPSS_DXCH_SIP7_TABLE_VPORT_MAPPING_E,

    CPSS_DXCH_SIP7_TABLE_EQ_HECMP_STATUS_VECTOR_E,
    CPSS_DXCH_SIP7_TABLE_EQ_HECMP_LTT_MEM_E,
    CPSS_DXCH_SIP7_TABLE_EQ_HECMP_ECMP_MEM_E,
    CPSS_DXCH_SIP7_TABLE_EQ_TRUNK_ECMP_E, /* dedicated table instead of - CPSS_DXCH_SIP5_TABLE_EQ_L2_ECMP_E */

    /* HA tables */
    CPSS_DXCH_SIP7_TABLE_HA_SRC_EPORT_1_E,
    CPSS_DXCH_SIP7_TABLE_HA_SRC_EPORT_2_E,
    CPSS_DXCH_SIP7_TABLE_HA_SRC_PHYSICAL_PORT_2_E,
    CPSS_DXCH_SIP7_TABLE_HA_TARGET_CIRCUITS_E,
    CPSS_DXCH_SIP7_TABLE_HA_ANALYZERS_TARGET_CIRCUITS_E,
    CPSS_DXCH_SIP7_TABLE_HA_QUEUE_MAPPING_E,
    CPSS_DXCH_SIP7_TABLE_HA_QOS_MAPPING_E,
    CPSS_DXCH_SIP7_TABLE_HA_HEADER_FIELDS_0_E,
    CPSS_DXCH_SIP7_TABLE_HA_HEADER_FIELDS_1_E,
    /* IPVX Tables */
    CPSS_DXCH_SIP7_TABLE_IPVX_ROUTER_L3NHE_PROFILE_E,
    CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_4_E,
    CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_5_E,
    CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_6_E,
    CPSS_DXCH_SIP7_TABLE_EXACT_MATCH_7_E,
    ...
    /* SIP7 - EGF-EFT */
    CPSS_DXCH_SIP7_EGF_EFT_EVLAN_E,

    /* SIP7 MLL BIER tables */
    CPSS_DXCH_SIP7_TABLE_IP_MLL_BIER_E,
    CPSS_DXCH_SIP7_TABLE_L2_MLL_BIER_E,

    /* SIP7 HBU tables */
    CPSS_DXCH_SIP7_TABLE_HBU_PORT_MAPPING_E,

    CPSS_DXCH_SIP7_TABLE_LAST_E,     /* AAS   */
...
typedef enum
{
    ...
    /** @brief
     *  physical port logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_PHYSICAL_PORT_E,
    /** @brief
     *  port isolation logical table
     */
    ...
    /** @brief
     *  VLAN translation logical table
     */
    ...
    /** @brief
     *  IPvX router access matrix logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_IPVX_ROUTER_ACCESS_MATRIX_E,
    /** @brief
     *  TM queue map CPU code to TC logical table
     */
    ...
    /** @brief
     *  ARP logical table - one of three parts of physical
     *  Tunnel-Start/ARP/NAT Table.
     */
    CPSS_DXCH_LOGICAL_TABLE_ARP_E,
    /** @brief
     *  NAT logical table - one of three parts of physical
     *  Tunnel-Start/ARP/NAT Table.
     */
    CPSS_DXCH_LOGICAL_TABLE_NAT_E,
    /** @brief
     *  generic tunnel start profile logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_GENERIC_TUNNEL_START_PROFILE_E,
    /** @brief
     *  CN sample intervals logical table
     */
    ...
    /** @brief
     *  PFC LLFC counters logical table
     */
    ...
    /** @brief
     *  tail drop queues multicast buffers counters logical table
     */
    ...
    /** @brief
     *  mac2me logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_MAC2ME_E,
    /** @brief
     *  TTI udb config logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_TTI_UDB_CONFIG_E,
    /** @brief
     *  PTP domain logical table
     */
    ...
    /** @brief
     *  OAM LM offset logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_OAM_LM_OFFSET_E,
    /** @brief
     *  egress policer remarking logical table
     */
    ...
    /** @brief
     *  TTI QoS map DSCP to DSCP logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_TTI_QOS_MAP_DSCP_TO_DSCP_E,
    /** @brief
     *  egress remarking QoS DSCP map logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_EGRESS_REMARKING_QOS_DSCP_MAP_E,
    /** @brief
     *  egress remarking QoS TC DP map logical table
     */
    ...
    /** @brief
     *  port MAC counters logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_PORT_MAC_COUNTERS_E,
    /** @brief
     *  exact match auto learn entry index logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_EXACT_MATCH_AUTO_LEARNED_ENTRY_INDEX_E,
    /** @brief
     *  programmable parser unit action logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_PPU_ACTION_TABLE_E,
    /** @brief
     *  ingress policer stage 0 IPFIX first n packets logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_INGRESS_POLICER_0_IPFIX_FIRST_N_PACKETS_E,
    /** @brief
     *  ingress policer stage 1 IPFIX first n packets logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_INGRESS_POLICER_1_IPFIX_FIRST_N_PACKETS_E,
    /** @brief
     *  egress policer IPFIX first n packets logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_EGRESS_POLICER_IPFIX_FIRST_N_PACKETS_E,
    /** @brief
     *  stream configuration logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_STREAM_E,
    /** @brief
     *  stream gate control logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_STREAM_GATE_E,
    /** @brief
     *  stream QVB logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_STREAM_QVB_E,
    /** @brief
     *  stream SRF history buffer logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_STREAM_SRF_HISTORY_BUFFER_E,
    /** @brief
     *  stream SRF Zero bit vector logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_STREAM_SRF_ZERO_BIT_VECTOR_E,
    /** @brief
     *  TXQ configuration logical table
     */
    CPSS_DXCH_LOGICAL_TABLE_TX_QUEUE_CONFIG_E,
    /** @brief
     *  packet data logical table with ECC protection
     */
    CPSS_DXCH_LOGICAL_INTERNAL_TABLE_PACKET_DATA_ECC_E,
    /** @brief
     *  packet data logical table with parity protection
     */
    CPSS_DXCH_LOGICAL_INTERNAL_TABLE_PACKET_DATA_PARITY_E,
    /** @brief
     *  descriptors control logical table with ECC protection
     */
    CPSS_DXCH_LOGICAL_INTERNAL_TABLE_DESCRIPTORS_CONTROL_ECC_E,
    /** @brief
     *  descriptors control logical table with parity protection
     */
    CPSS_DXCH_LOGICAL_INTERNAL_TABLE_DESCRIPTORS_CONTROL_PARITY_E,
    /** @brief
     *  packet data control logical table with ECC protection
     */
    CPSS_DXCH_LOGICAL_INTERNAL_TABLE_PACKET_DATA_CONTROL_ECC_E,
    /** @brief
     *  packet data control logical table with parity protection
     */
    CPSS_DXCH_LOGICAL_INTERNAL_TABLE_PACKET_DATA_CONTROL_PARITY_E,
    /** @brief
     *  PHA scratch pad logical table
     */
    CPSS_DXCH_LOGICAL_INTERNAL_TABLE_PHA_RAM_E,
    /** @brief
     *  MG configuration processor logical table
     */
    CPSS_DXCH_LOGICAL_INTERNAL_TABLE_CM3_RAM_E,
    /** @brief
     *  management logical table
     */

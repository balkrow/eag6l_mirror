...
#define PRV_CPSS_DXCH_CAELUM_LED_IF_0_PORTS_NUM_CNS                   12
#define PRV_CPSS_DXCH_CAELUM_LED_IF_1_PORTS_NUM_CNS                   12
#define PRV_CPSS_DXCH_CAELUM_LED_IF_2_PORTS_NUM_CNS                   12
#define PRV_CPSS_DXCH_CAELUM_LED_IF_3_PORTS_NUM_CNS                   12
#define PRV_CPSS_DXCH_CAELUM_LED_IF_4_PORTS_NUM_CNS                   13

#define PRV_CPSS_DXCH_CAELUM_LED_IF_PORTS_TYPE_CONF_REG_NUM_CNS        1
#define PRV_CPSS_DXCH_CAELUM_LED_IF_PORTS_IND_POLARITY_REG_NUM_CNS     3
#define PRV_CPSS_DXCH_CAELUM_LED_IF_4_PORTS_IND_POLARITY_REG_NUM_CNS   4

...
********************************************************************************
* prvCpssDxChSip7LpmRamMngDefrag.h
*
* DESCRIPTION:
*       Definitions of the SIP7 LPM Defrag algorithm
*
* DEPENDENCIES:
*       None.
*
...
#ifndef __prvCpssDxChSip7LpmMngDefragh
#define __prvCpssDxChSip7LpmMngDefragh
...
*                                      all blocked mapped
* @param[in] bankIndex                - the index of the bank to shrink
* @param[in] neededMemoryBlocksSizes  - new memory size that
*                                       should be allocated
...
#endif /* __prvCpssDxChSip7LpmMngDefragh */

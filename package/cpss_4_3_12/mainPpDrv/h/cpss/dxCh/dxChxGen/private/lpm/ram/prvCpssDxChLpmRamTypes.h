...
/* the lower possible value of IPv4 UC first octet */
#define PRV_CPSS_DXCH_LPM_RAM_START_OF_IPV4_UC_ADDRESS_SPACE_CNS   (0)


/* the higher possible value of IPv4 UC first octet */
#define PRV_CPSS_DXCH_LPM_RAM_END_OF_IPV4_UC_ADDRESS_SPACE_CNS   (223)
...
/* the lower possible value of IPv6 UC first octet */
#define PRV_CPSS_DXCH_LPM_RAM_START_OF_IPV6_UC_ADDRESS_SPACE_CNS   (0)

/* the higher possible value of IPv6 UC first octet */
#define PRV_CPSS_DXCH_LPM_RAM_END_OF_IPV6_UC_ADDRESS_SPACE_CNS   (254)
...
#ifdef GM_USED
#define PRV_CPSS_DXCH_LPM_RAM_TOTAL_BLOCKS_SIZE_INCLUDING_GAP_SIP7_CNS _16K
#else
#define PRV_CPSS_DXCH_LPM_RAM_TOTAL_BLOCKS_SIZE_INCLUDING_GAP_SIP7_CNS _256K
#endif
...
/* size of SIP7 LPM entry in bits */
#define PRV_CPSS_DXCH_LPM_RAM_SIP7_SIZE_OF_LPM_ENTRY_IN_BITS_CNS        (132)
#define PRV_CPSS_DXCH_LPM_RAM_SIP7_SIZE_OF_LPM_ENTRY_IN_WORDS_CNS       (8)/* only 5 words is used but we need to work with 8 to fit the address alignment */
#define PRV_CPSS_DXCH_LPM_RAM_SIP7_SIZE_OF_LPM_ENTRY_DATA_IN_WORDS_CNS  (5)/* only 5 words is used  */
#define PRV_CPSS_DXCH_LPM_RAM_SIP7_SIZE_OF_LPM_ENTRY_IN_BYTES_CNS       32 /* only 132 bits used but bytes should be according to address alignment */

#ifdef GM_USED
#define PRV_CPSS_DXCH_LPM_RAM_SIP7_MAX_PBR_SIZE_IN_LPM_LINES_CNS        _16K
#else
#define PRV_CPSS_DXCH_LPM_RAM_SIP7_MAX_PBR_SIZE_IN_LPM_LINES_CNS        _128K
#endif

#define PRV_CPSS_DXCH_LPM_RAM_SIP7_MAX_PBR_SIZE_MIN_LPM_MODE_IN_LPM_LINES_CNS _5K

#define SIP7_MIN_NUMBER_OF_BIT_VECTOR_RANGES_CNS     12
#define SIP7_MAX_NUMBER_OF_COMPRESSED_RANGES_CNS     11
#define PRV_CPSS_DXCH_SIP7_LPM_MAX_RANGES_IN_COMPRESSED_NODE_E   11

/* max group of nodes size in words  */
#define PRV_CPSS_DXCH_LPM_RAM_SIP7_MAX_GROUP_OF_NODES_SIZE_IN_WORDS_CNS  \
                (PRV_CPSS_DXCH_LPM_RAM_FALCON_MAX_GROUP_OF_NODES_SIZE_IN_LPM_LINES_CNS*\
                PRV_CPSS_DXCH_LPM_RAM_SIP7_SIZE_OF_LPM_ENTRY_IN_WORDS_CNS )

#define PRV_CPSS_DXCH_LPM_RAM_SIP7_MAX_SIZE_OF_BUCKET_IN_BYTES_CNS           \
    (PRV_CPSS_DXCH_LPM_RAM_FALCON_MAX_SIZE_OF_BUCKET_IN_LPM_LINES_CNS *        \
     PRV_CPSS_DXCH_LPM_RAM_SIP7_SIZE_OF_LPM_ENTRY_IN_BYTES_CNS)


#define PRV_CPSS_DXCH_LPM_RAM_GET_SIP7_LPM_SIZE_FROM_DMM_MAC(handler)    (DMM_GET_SIZE_SIP7(handler)>> 5)
#define PRV_CPSS_DXCH_LPM_RAM_GET_SIP7_LPM_OFFSET_FROM_DMM_MAC(handler)  (DMM_GET_OFFSET_SIP7(handler)>> 5)

#define PRV_CPSS_DXCH_LPM_RAM_NUM_OF_MEMORIES_SIP7_CNS 48
 ...
 *      bulkGonStat           - hw update gon status
...
typedef struct PRV_CPSS_DXCH_LPM_RAM_BUCKET_SHADOW_STCT
{
    ...
    PRV_CPSS_DXCH_LPM_RAM_BUCKET_HW_UPDATE_STATUS_ENT   bulkGonStat[6];
 ...
 *      defIpv4ClassERouteEntry       - the route entry info associated with the E class default.
 *
 *
 */
typedef struct PRV_CPSS_DXCH_LPM_RAM_VR_CONFIG_STCT
{
    ...
    PRV_CPSS_DXCH_LPM_ROUTE_ENTRY_POINTER_STC  defIpv4ClassERouteEntry;
 ...
 *      treatIpv4ClassEasNonRegularUc   - show if E class handled as regular unicast or
 *                                        as special range with it's own default
 *
 */
...
*/typedef enum{
    ...
    PRV_CPSS_DXCH_CFG_SHARED_TABLE_MODE_AC5P_32K_L2_256K_EM_64K_ARP_E,
    PRV_CPSS_DXCH_CFG_SHARED_TABLE_MODE_FALCON_64K_L2_32K_EM_96K_ARP_E
...
{
    GT_U32                                              numOfBlocks;
    GT_U32                                              blocksSizeArray[PRV_CPSS_DXCH_LPM_RAM_NUM_OF_MEMORIES_SIP7_CNS];
    ...
    GT_U64                                              smallBanksIndexesBitMap;/* GT_U64 since in AAS we have 48 banks and not 30 */
    GT_U64                                              bigBanksIndexesBitMap;  /* GT_U64 since in AAS we have 48 banks and not 30 */
 ...
 *      defaultAddrForHeadOfTrie - By default head of the trie points here.
...
typedef struct PRV_CPSS_DXCH_LPM_RAM_SHADOW_STCT
{
    ...
    GT_U32                                       lpmRamConfigInfoNumOfElements;
    GT_U32                                       maxNumOfPbrEntries;
    PRV_CPSS_DXCH_LPM_RAM_MEM_INFO_STC           lpmMemInfoArray[PRV_CPSS_DXCH_LPM_PROTOCOL_LAST_E][PRV_CPSS_DXCH_LPM_RAM_NUM_OF_MEMORIES_SIP7_CNS];
    ...
    PRV_CPSS_DXCH_LPM_RAM_OCTETS_TO_BLOCK_MAPPING_STC   tempLpmRamOctetsToBlockMappingUsedForReconstractPtr[PRV_CPSS_DXCH_LPM_RAM_NUM_OF_MEMORIES_SIP7_CNS];
    ...
    GT_UINTPTR                                   defaultAddrForHeadOfTrie;
    ...
    PRV_CPSS_DXCH_LPM_RAM_MEM_MODE_ENT           lpmMemMode;
    PRV_CPSS_DXCH_LPM_RAM_PENDING_BLOCK_TO_UPDATE_STC   pendingBlockToUpdateArr[PRV_CPSS_DXCH_LPM_RAM_NUM_OF_MEMORIES_SIP7_CNS];
    PRV_CPSS_DXCH_LPM_ADDRESS_COUNTERS_INFO_STC         protocolCountersPerBlockArr[PRV_CPSS_DXCH_LPM_RAM_NUM_OF_MEMORIES_SIP7_CNS];
    GT_U32                                              globalMemoryBlockTakenArr[PRV_CPSS_DXCH_LPM_RAM_NUM_OF_MEMORIES_SIP7_CNS];
 ...
 *      isIpv6Mc               - is this configuration for ipv6 MC
 *                              (APPLICALBE DEVICES: AC5P)
...
typedef struct PRV_CPSS_DXCH_LPM_COMPRESSED_STCT
{
     ...
     *           offset fields
     *           foe SIP7 one more range was added to compress node
    */
    GT_U8   ranges1_9[SIP7_MAX_NUMBER_OF_COMPRESSED_RANGES_CNS];
    /** @brief - child nodes types associated with each range
    */
    GT_U8   childNodeTypes0_9[SIP7_MAX_NUMBER_OF_COMPRESSED_RANGES_CNS];

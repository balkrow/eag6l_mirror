...
#define PRV_CPSS_DXCH_LPM_RAM_OCTET_TO_BLOCK_MAPPING_SET_MAC(shadowPtr,protocol,octet,block)\
...
#define PRV_CPSS_DXCH_LPM_RAM_OCTET_TO_BLOCK_MAPPING_CLEAR_MAC(shadowPtr,protocol,octet,block)\
    (shadowPtr->lpmRamOctetsToBlockMappingPtr[block].octetsToBlockMappingBitmap[protocol] &= ~(1<<octet))

/* clear bit in the temp_octet_to_block bitmap used for reconstruct */
#define PRV_CPSS_DXCH_TEMP_LPM_RAM_OCTET_TO_BLOCK_MAPPING_CLEAR_MAC(shadowPtr,protocol,octet,block)\
...
#define PRV_CPSS_DXCH_LPM_RAM_IS_BLOCK_USED_BY_OCTET_IN_PROTOCOL_GET_MAC(shadowPtr,protocol,octet,block)\
...
#define PRV_CPSS_DXCH_LPM_RAM_IS_BLOCK_USED_BY_PROTOCOL_GET_MAC(shadowPtr,protocol,block)\
 ...
 *      prefixBulkAdd             - GT_TRUE: adding IPV4/6 prefix bulk
 *                                  GT_FALSE: other operation
 *
 */
typedef struct
{
     ...
     GT_BOOL                                      isRootNode;
     GT_BOOL                                      isSrcRootNode;                /* Src Root node */
     GT_BOOL                                      isDestRootNode;             /* Dest Root node */

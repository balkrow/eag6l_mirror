...
/*
 * Typedef: struct PRV_CPSS_DXCH_LPM_RAM_DBG_LEAF_STAT_STCT
 *
 * Description: shows created lpm nodes and leaves statistic.
 *
 * Fields:
 *      numberOfEmbLeaf71Nodes                  - number of embedded leaves nodes with 1 leaf and till 7 ranges
 *      numberOfEmbLeaf52Nodes                  - number of embedded leaves nodes with 2 leaf and till 5 ranges
 *      numberOfEmbLeaf33Nodes                  - number of embedded leaves nodes with 3 leaf and  3 ranges
 *      numberOfCompressNodes                   - number of compressed nodes
 *      numberOfRegularNodes                    - number of regular nodes
 *      totalNumberOfLeaves                     - total number of created leaves
 *      numberOfDefaultLeaves                   - number of leaves pointed to default next hop
 *      numberOfInsertedLeaves                  - number of leaves pointed to inserted next hop
 *      totalLeaveLinesNumber                   - number of LPM lines occupied by leaves
 *      totalUnusedLeafPlacesNumber             - number of positions in leaf lines not used by leaves
 *      totalLeavesInEmbLeavesNodes             - number of leaves in embedded nodes
 *      numberOfDefaultLeavesInEmbLeavesNodes   - number of default leaves in embedded nodes.
 *      numberOfInsertedLeavesInEmbLeavesNodes  - number of inserted leaves in embedded nodes.
 *      numberOfDefaultLeavesInEmbLeavesNodes   - number of default leaves in embedded nodes.
 *      numberOfDefaultLeavesInEmbLeavesNodes   - number of default leaves in embedded nodes.
 *      numberOfDefaultLeavesInEmbLeavesNodes   - number of default leaves in embedded nodes.
 *      numberOfDefaultLeavesInEmbLeavesNodes   - number of default leaves in embedded nodes.
...
typedef struct PRV_CPSS_DXCH_LPM_RAM_DBG_LEAF_STAT_STCT
{
    GT_U32 numberOfEmbLeaf71Nodes;
    GT_U32 numberOfEmbLeaf52Nodes;
    GT_U32 numberOfEmbLeaf33Nodes;
    GT_U32 numberOfCompressNodes;
    GT_U32 numberOfRegularNodes;
    GT_U32 totalNumberOfLeaves;
    GT_U32 numberOfDefaultLeaves;
    GT_U32 numberOfInsertedLeaves;
    GT_U32 totalLeaveLinesNumber;
    GT_U32 totalUnusedLeafPlacesNumber;
    GT_U32 totalLeavesInEmbLeavesNodes;
    GT_U32 numberOfDefaultLeavesInEmbLeavesNodes;
    GT_U32 numberOfInsertedLeavesInEmbLeavesNodes;
} PRV_CPSS_DXCH_LPM_RAM_DBG_LEAF_STAT_STC;

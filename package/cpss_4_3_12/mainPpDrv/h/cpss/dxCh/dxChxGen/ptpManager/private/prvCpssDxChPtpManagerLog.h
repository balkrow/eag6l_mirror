...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_MANAGER_REF_CLOCK_CFG_STC_PTR_ptpRefClockConfPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_MANAGER_TOD_COUNT_STC_PTR_updateValuePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_REF_CLOCK_SELECT_ENT_refClockSource;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_32_fracNanoSeconds;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_32_updateValue;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_gracefullStep;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChPtpManagerTaiTodStepGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpManagerPhyTodValueGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpManagerPhyCaptureTodValueSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpManagerSlaveSerActivate_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpManagerMasterSerActivate_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpManagerDbgPtpPLLConfig_E
};

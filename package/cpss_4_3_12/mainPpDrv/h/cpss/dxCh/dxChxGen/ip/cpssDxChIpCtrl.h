...
*                                    drop counter mode.
*                                    Note: for AAS the counter is cleared on read
*
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
...
*
* @param[in] devNum                   - the device number
* @param[in] enable                   - enable / disable ECMP/Qos unicast RPF check
*
* @retval GT_OK                    - on success
* @retval GT_NOT_INITIALIZED       - The library was not initialized.
* @retval GT_FAIL                  - on error
...
/**
* @internal cpssDxChIpEcmpUcRpfAccessLevelSet function
* @endinternal
*
* @brief  Set the SIP Access Level for IPv4/IPv6 Unicast packets
*         where SIP is associated with ECMP block, and Unicast
*         RPF with ECMP is enabled.
*         Note : To Enable ECMP Unicast RPF Check use API :
...
* @param[in] devNum                   - the device number
* @param[in] protocolStack            - whether to set for ipv4/v6 or both
* @param[in] accessLevel              - The SIP Access Level.
*
* @retval GT_OK                    - on success
* @retval GT_NOT_INITIALIZED       - The library was not initialized.
* @retval GT_BAD_PARAM             - Illegal parameter in function called
...
*
*/
GT_STATUS cpssDxChIpEcmpUcRpfAccessLevelSet
(
    IN GT_U8                            devNum,
    IN CPSS_IP_PROTOCOL_STACK_ENT       protocolStack,
...
/**
* @internal cpssDxChIpEcmpUcRpfAccessLevelGet function
* @endinternal
*
* @brief  Get the SIP Access Level for IPv4/IPv6 Unicast packets
*         where SIP is associated with ECMP block, and Unicast
*         RPF with ECMP is enabled.
*         Note : To get ECMP Unicast RPF Check use API :
...
*
*/
GT_STATUS cpssDxChIpEcmpUcRpfAccessLevelGet
(
    IN  GT_U8                               devNum,
    IN  CPSS_IP_PROTOCOL_STACK_ENT          protocolStack,
...
/**
* @internal cpssDxChIpFdbRouteCounterSetIndexSet function
* @endinternal
*
* @brief   Set the FDB Route 'Counter Set' Index , for FDB routing.
*
...
*
* @param[in] devNum                - device number
* @param[in] countSetIndex         - the 'Counter Set' Index (see CPSS_IP_CNT_SET_ENT)
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on wrong input parameters
* @retval GT_HW_ERROR              - failed to write to hardware
...
/**
* @internal cpssDxChIpFdbRouteCounterSetIndexGet function
* @endinternal
*
* @brief   Get the FDB Route 'Counter Set' Index , for FDB routing.
*
* @note   APPLICABLE DEVICES:      AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
* @param[in] devNum                - device number
* @param[out] countSetIndexPtr     - (pointer to) the 'Counter Set' Index (see CPSS_IP_CNT_SET_ENT)
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on wrong input parameters
* @retval GT_BAD_PTR               - on NULL pointer
...
/**
* @internal cpssDxChIpUcRpfAccessLevelSet function
* @endinternal
*
* @brief  Set the SIP Access Level for IPv4/IPv6 Unicast packets
*         where SIP is associated with ECMP block, and Unicast
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChIpUcRpfAccessLevelSet
(
    IN GT_U8                            devNum,
    IN CPSS_IP_PROTOCOL_STACK_ENT       protocolStack,
    IN GT_U32                           accessLevel
...
/**
* @internal cpssDxChIpUcRpfAccessLevelGet function
* @endinternal
*
* @brief  Get the SIP Access Level for IPv4/IPv6 Unicast packets
*         where SIP is associated with ECMP block, and Unicast
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChIpUcRpfAccessLevelGet
(
    IN  GT_U8                               devNum,
    IN  CPSS_IP_PROTOCOL_STACK_ENT          protocolStack,
    OUT GT_U32                              *accessLevelPtr
...
/**
* @internal cpssDxChIpUcBypassRouterforIgmpOrMldPacketsSet function
* @endinternal
*
* @brief   Enable/Disabe bypassing router for IGMP/MLD packets.
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2;
*
* @param[in] devNum                - the device number
* @param[in] enable                - GT_FALSE - Disable bypassing router for IGMP/MLD packets
*                                    GT_TRUE  - Enable bypassing router for IGMP/MLD packets
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - Illegal parameter in function called
* @retval GT_FAIL                  - on error
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
...
/**
* @internal cpssDxChIpUcBypassRouterforIgmpOrMldPacketsGet function
* @endinternal
*
* @brief   Get status of bypassing router for IGMP/MLD packets.
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2;
*
* @param[in] devNum                - the device number
* @param[out] enablePtr            - (pointer to) status of bypasing router for IGMP/MLD packets
*                                    GT_FALSE - Disable bypassing router for IGMP/MLD packets
*                                    GT_TRUE  - Enable bypassing router for IGMP/MLD packets
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - Illegal parameter in function called

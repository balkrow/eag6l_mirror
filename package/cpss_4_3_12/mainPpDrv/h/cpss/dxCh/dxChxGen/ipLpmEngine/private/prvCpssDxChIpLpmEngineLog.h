...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT);
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_IP_LPM_VALIDITY_TYPE_ENT_validityAction;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChIpLpmValidityCheck_E,
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChIpLpmDbgPrintLpmNodesStatistics_E
};

...
/* number of stages in iron man */
#define PRV_CPSS_DXCH_PACKET_ANALYZER_NUM_OF_STAGES_IRONMAN_CNS          16
...
#define PRV_CPSS_DXCH_PACKET_ANALYZER_FIELD_REGULAR_LAST_E                      CPSS_DXCH_PACKET_ANALYZER_FIELD_DUMMY_FIELD_LAST_E

...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT);
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT_serGenerationMode;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT_serReceptionMode;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT_PTR_serGenerationModePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT_PTR_serReceptionModePtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_crcErrorCounterPtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChPtpPortPhyTsEnableSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpPortPhyTsEnableGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpTaiSerialGenerationModeSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpTaiSerialGenerationModeGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpTaiSerialReceptionModeSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPtpTaiSerialReceptionModeGet_E,
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChPtpPortMacTsCrcErrorCounterDbgGet_E
};

...
/* fixing typo from older cpss versions */
#define isPtpExeption isPtpException
...
typedef struct{
     ...
     *  It ranges from -2^29 to (2^29) nanosecond fractions,representing the range
     *  -0.125 ns to 0.125 ns.
     *  (APPLICABLE DEVICES: Ironman)
     */
...
/**
* @enum CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT
 *
 * @brief This enum defines serial generation mode.
 * External output interface used for generating a serial signal (PTP_SER_RX) at a configurable clock rate.
 * (APPLICABLE DEVICES: AAS)
*/
typedef enum{

    /** @brief Unit does not generate an external serial signal.
     */
    CPSS_DXCH_PTP_TAI_SER_GEN_MODE_DISABLED_E,

    /** @brief Unit generates an external serial signal,
     *  driving a serial generation derivative of the internal TOD Counter.
     */
    CPSS_DXCH_PTP_TAI_SER_GEN_MODE_SERIAL_GEN_E,

} CPSS_DXCH_PTP_TAI_SER_GEN_MODE_ENT;

/**
* @enum CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT
 *
 * @brief This enum defines serial reception mode.
 * it determines whether the TOD is updated according to the incoming PTP_SER_RX or not.
 * (APPLICABLE DEVICES: AAS)
*/
typedef enum{

    /** @brief Unit does not receive an external serial signal.
     */
    CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_DISABLED_E,

    /** @brief Update phase of TOD counter according to an external serial input.
     */
    CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_SERIAL_RECEPTION_E

} CPSS_DXCH_PTP_TAI_SER_RECEPTION_MODE_ENT;

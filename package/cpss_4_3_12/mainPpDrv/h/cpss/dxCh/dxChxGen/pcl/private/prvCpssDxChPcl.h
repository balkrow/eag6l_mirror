...
#define PRV_CPSS_PCL_CONVERT_HW_VAL_TO_ATTR_MODIFY_MAC(_cmd, _val)      \
    ...
    {                                                                   \
        ...
        case 2:                                                         \
            ...
            break;                                                      \
        default:                                                        \
            _cmd =  (CPSS_PACKET_ATTRIBUTE_MODIFY_TYPE_ENT)(_val);      \
    }

/* Convert hardware value to Attribute modify QoS command */
#define PRV_CPSS_PCL_CONVERT_HW_VAL_TO_ATTR_ASSIGN_MAC(_cmd, _val)      \
    switch (_val)                                                       \
    {                                                                   \
        case 0:                                                         \
        ...
        case 3:                                                         \
            ...
            break;                                                      \
        default:                                                        \
            _cmd =  (CPSS_PACKET_ATTRIBUTE_ASSIGN_CMD_ENT)(_val);       \
    }
...
#define PRV_DXCH_IPCL_CONF_TBL_ROW_NUMBER_CNS(dev)   \
        (GT_U32)(                                    \
        PRV_CPSS_DXCH_PP_MAC(dev)->hwInfo.parametericTables.numEntriesIpclConfig ?        \
            PRV_CPSS_DXCH_PP_MAC(dev)->hwInfo.parametericTables.numEntriesIpclConfig :    \
...
#define PRV_DXCH_EPCL_CONF_TBL_ROW_NUMBER_CNS(dev)    \
        (GT_U32)(                                     \
        PRV_CPSS_DXCH_PP_MAC(dev)->hwInfo.parametericTables.numEntriesEpclConfig ?     \
            PRV_CPSS_DXCH_PP_MAC(dev)->hwInfo.parametericTables.numEntriesEpclConfig : \
        PRV_CPSS_SIP_5_20_CHECK_MAC(dev) ? (_4K + 512) : /*4608*/ \
        PRV_CPSS_SIP_5_CHECK_MAC(dev)    ? (_4K + 256) : /*4352*/ \
            (_4K + 64))/*4160*/

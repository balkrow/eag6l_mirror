...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_PCL_UDB_VALUES_BITMAP_START_ENT);
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PCL_ACTION_HEADER_ALTERATION_OPTIONS_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ENHANCED_SFLOW_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_IFA_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_ROUTER_SA_MODIFICATION_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_PCL_ACTION_EGRESS_PHA_THREAD_VXLAN_DCI_VNI_REMAP_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DROP_MODE_TYPE_ENT_cancelDropType;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC_PTR_actionModifiedFieldsSelectPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC_PTR_udbValuesBmpCfgPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_parallelLookupWithDrop;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_parallelLookupWithDropCancel;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PCL_LOOKUP_ACTION_MODIFIED_FIELDS_SELECT_STC_PTR_actionModifiedFieldsSelectPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_PCL_UDB_VALUES_BITMAP_CONFIG_STC_PTR_udbValuesBmpCfgPtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChPclMidwayPolicyEnable_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPclMidwayPolicyEnableGet_E,
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChPclLookupActionModifiedFieldsSelectSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPclLookupActionModifiedFieldsSelectGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPclUserDefinedByteValuesBitmapExpansionConfigGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPclParallelLookupDropCancelEnableSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChPclParallelLookupDropCancelEnableGet_E
};

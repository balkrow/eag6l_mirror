...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_LOOKUP_NUM_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_LOOKUP_TYPE_ENT);
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_NON_FORWARDING_LABEL_TYPE_ENT);
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_EXP_4_EGRESS_SELECTION_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_EXP_4_QOS_SELECTION_MODE_ENT);
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_QOS_MAPPING_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_QOS_MODEL_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_QOS_MODEL_SELECTION_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_QOS_TRUST_FIELDS_SELECTION_MODE_ENT);
...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_TRUST_QOS_MAPPING_TABLE_SELECTION_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_TRUST_UP_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_TTL_MODEL_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_TTL_MODEL_SELECTION_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_TTI_TTL_SELECTION_MODE_ENT);
...
void prvCpssLogParamFuncStc_CPSS_DXCH_TTI_NON_FORWARDING_LABEL_QOS_PARAMS_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_TTI_QOS_ACTION_RESOLUTION_PARAMS_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_TTI_RANGE_CHECK_BYTE_PAIR_CFG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_TTI_TTL_ACTION_RESOLUTION_PARAMS_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_TTI_LOOKUP_NUM_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_TTI_LOOKUP_TYPE_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_TTI_NON_FORWARDING_LABEL_QOS_PARAMS_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_TTI_NON_FORWARDING_LABEL_TYPE_ENT(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_TTI_QOS_ACTION_RESOLUTION_PARAMS_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_TTI_RANGE_CHECK_BYTE_PAIR_CFG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_TTI_TTL_ACTION_RESOLUTION_PARAMS_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_GENERIC_CLASSIFICATION_PARAMS_STC_PTR_genClassifictionParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_GENERIC_RANGE_CLASSIFICATION_PARAMS_STC_PTR_rangeClassifictionParamsPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_LOOKUP_NUM_ENT_lookupNum;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_LOOKUP_TYPE_ENT_lookupType;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_NON_FORWARDING_LABEL_QOS_PARAMS_STC_PTR_qosParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_NON_FORWARDING_LABEL_TYPE_ENT_labelType;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_QOS_ACTION_RESOLUTION_PARAMS_STC_PTR_qosActionResolutionParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_RANGE_CHECK_BYTE_PAIR_CFG_STC_PTR_bytePairCfgPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TTI_TTL_ACTION_RESOLUTION_PARAMS_STC_PTR_ttlActionResolutionParamsPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_NET_RX_CPU_CODE_ENT_boSExcpDropCode;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_NET_RX_CPU_CODE_ENT_code;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_PACKET_CMD_ENT_boSExcpCmd;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_bytePairIndex;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_cpuCodeBase;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_defaultValue;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_lsbLocation;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_rangeClassifictionIndex;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_srcPortProfileId;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_GENERIC_CLASSIFICATION_PARAMS_STC_PTR_genClassifictionParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_GENERIC_RANGE_CLASSIFICATION_PARAMS_STC_PTR_rangeClassifictionParamsPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TTI_NON_FORWARDING_LABEL_QOS_PARAMS_STC_PTR_qosParamsPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TTI_QOS_ACTION_RESOLUTION_PARAMS_STC_PTR_qosActionResolutionParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TTI_RANGE_CHECK_BYTE_PAIR_CFG_STC_PTR_bytePairCfgPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TTI_TTL_ACTION_RESOLUTION_PARAMS_STC_PTR_ttlActionResolutionParamsPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_NET_RX_CPU_CODE_ENT_PTR_boSExcpDropCodePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_NET_RX_CPU_CODE_ENT_PTR_codePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_PACKET_CMD_ENT_PTR_boSExcpCmdPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_defaultValuePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_extensionHeaderValuePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_lsbLocationPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_srcPortProfileIdPtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericRangeSrcPortProfileIdSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericRangeSrcPortProfileIdGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericRangeBytePairCfgSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericRangeBytePairCfgGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericRangeParamsSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericRangeParamsGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericClassificationLsbLocationSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericClassificationLsbLocationGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericClassificationDefaultValueSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericClassificationDefaultValueGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericClassificationParamsSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiGenericClassificationParamsGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiEliExceptionCmdSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiEliExceptionCmdGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiNonForwardingLabelQosAttributesSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiNonForwardingLabelQosAttributesGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiQosActionResolutionTableEntrySet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiQosActionResolutionTableEntryGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiTtlActionResolutionTableEntrySet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTtiTtlActionResolutionTableEntryGet_E
};

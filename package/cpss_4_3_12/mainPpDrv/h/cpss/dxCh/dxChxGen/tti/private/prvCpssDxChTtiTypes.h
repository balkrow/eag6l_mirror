...
typedef enum {
    ...
    TTI_META_DATA_FIELDS_SIP6_30_LAST_VALUE_E,
    /* SIP7 META_DATA_FIELDS */
    TTI_META_DATA_FIELDS_GENERIC_CLASSIFICATION_7_0_E,
    TTI_META_DATA_FIELDS_GENERIC_CLASSIFICATION_15_8_E,

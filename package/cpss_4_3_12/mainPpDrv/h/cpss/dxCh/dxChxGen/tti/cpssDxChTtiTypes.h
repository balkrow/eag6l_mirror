...
typedef struct{
    ...
    /** destination IP Prefix length in bits (APPLICABLE RANGES: IPv4:0..32, IPv6:0..128) */
    GT_U32 prefixLength;
...
/**
* @enum CPSS_DXCH_TTI_TRUST_UP_ENT
* @brief Trust UP mode for TTI Action.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum {
    /* @brief Do not trust L2 UP */
    CPSS_DXCH_TTI_DO_NOT_TRUST_L2_UP_E = GT_FALSE,
    /* @brief Trust L2 UP. If TT, this is the inner ETH UP. */
    CPSS_DXCH_TTI_TRUST_L2_UP_E = GT_TRUE,
    /* @brief Trust outer Ethernet UP only, even if TT. */
    CPSS_DXCH_TTI_TRUST_L2_OUTER_ETH_UP_E
} CPSS_DXCH_TTI_TRUST_UP_ENT;

/**
* @enum CPSS_DXCH_TTI_LOOKUP_TYPE_ENT
*
* @brief TTI Lookup type.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Parallel Lookup */
    CPSS_DXCH_TTI_PARALLEL_LOOKUP_E,
    /* Serial EM Lookup */
    CPSS_DXCH_TTI_SERIAL_EM_LOOKUP_E
} CPSS_DXCH_TTI_LOOKUP_TYPE_ENT;

/**
* @enum CPSS_DXCH_TTI_LOOKUP_NUM_ENT
*
* @brief TTI Lookup type.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Lookup 0 */
    CPSS_DXCH_TTI_LOOKUP_NUM_0_E,
    /* Lookup 1 */
    CPSS_DXCH_TTI_LOOKUP_NUM_1_E,
    /* Lookup 2 */
    CPSS_DXCH_TTI_LOOKUP_NUM_2_E,
    /* Lookup 3 */
    CPSS_DXCH_TTI_LOOKUP_NUM_3_E
} CPSS_DXCH_TTI_LOOKUP_NUM_ENT;

/**
* @enum CPSS_DXCH_TTI_QOS_MODEL_ENT
*
* @brief TTI QoS Model.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Uniform model */
    CPSS_DXCH_TTI_QOS_UNIFORM_MODEL_E,
    /* Pipe model */
    CPSS_DXCH_TTI_QOS_PIPE_MODEL_E,
    /* Short Pipe model */
    CPSS_DXCH_TTI_QOS_SHORT_PIPE_MODEL_E
} CPSS_DXCH_TTI_QOS_MODEL_ENT;

/**
* @enum CPSS_DXCH_TTI_TTL_MODEL_ENT
*
* @brief TTI TTL Model.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Uniform model */
    CPSS_DXCH_TTI_TTL_UNIFORM_MODEL_E,
    /* Pipe model */
    CPSS_DXCH_TTI_TTL_PIPE_MODEL_E,
    /* Short Pipe model */
    CPSS_DXCH_TTI_TTL_SHORT_PIPE_MODEL_E
} CPSS_DXCH_TTI_TTL_MODEL_ENT;

/**
* @enum CPSS_DXCH_TTI_QOS_MAPPING_MODE_ENT
*
* @brief TTI QoS Mapping Mode.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* QoS Profile Mode
     * Map QoS Field to QoS Profile */
    CPSS_DXCH_TTI_QOS_PROFILE_MODE_E,
    /* TC-DP Mode
     * Map QoS Field to TC_DP*/
    CPSS_DXCH_TTI_TC_DP_MODE_E
} CPSS_DXCH_TTI_QOS_MAPPING_MODE_ENT;

/**
* @enum CPSS_DXCH_TTI_NON_FORWARDING_LABEL_TYPE_ENT
*
* @brief MPLS Non-Forwarding Label Type
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Entropy Labels: ELI + EL */
    CPSS_DXCH_TTI_ELI_LABEL_E,
    /* Explicit Null Labels */
    CPSS_DXCH_TTI_EXPLICIT_NULL_LABEL_E
} CPSS_DXCH_TTI_NON_FORWARDING_LABEL_TYPE_ENT;

/**
* @enum CPSS_DXCH_TTI_QOS_MODEL_SELECTION_MODE_ENT *
* @brief TTI QoS Model Selection Mode
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Previous QoS Model */
    CPSS_DXCH_TTI_QOS_MODEL_PREVIOUS_E,
    /* Current QoS Model */
    CPSS_DXCH_TTI_QOS_MODEL_CURRENT_E
} CPSS_DXCH_TTI_QOS_MODEL_SELECTION_MODE_ENT;

/**
* @enum CPSS_DXCH_TTI_TRUST_QOS_MAPPING_TABLE_SELECTION_MODE_ENT *
* @brief TTI Trust QoS Mapping table Selection Mode.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Previous Trust QoS Mapping table */
    CPSS_DXCH_TTI_TRUST_QOS_MAPPING_TABLE_PREVIOUS_E,
    /* Current Trust QoS Mapping table */
    CPSS_DXCH_TTI_TRUST_QOS_MAPPING_TABLE_CURRENT_E
} CPSS_DXCH_TTI_TRUST_QOS_MAPPING_TABLE_SELECTION_MODE_ENT;

/**
* @enum CPSS_DXCH_TTI_QOS_TRUST_FIELDS_SELECTION_MODE_ENT *
* @brief TTI QoS Trust Fields Selection Mode.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Previous QoS Trust Fields Selection Mode */
    CPSS_DXCH_TTI_QOS_TRUST_FIELDS_SELECTION_PREVIOUS_E,
    /* Current QoS Trust Fields Selection Mode */
    CPSS_DXCH_TTI_QOS_TRUST_FIELDS_SELECTION_CURRENT_E
} CPSS_DXCH_TTI_QOS_TRUST_FIELDS_SELECTION_MODE_ENT;

/**
* @enum CPSS_DXCH_TTI_EXP_4_QOS_SELECTION_MODE_ENT *
* @brief TTI EXP4QOS Selection Mode
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Previous EXP4QoS Selection Mode */
    CPSS_DXCH_TTI_EXP_4_QOS_SELECTION_PREVIOUS_E,
    /* Current EXP4QoS Selection Mode */
    CPSS_DXCH_TTI_EXP_4_QOS_SELECTION_CURRENT_E,
    /* Next EXP4QoS Selection Mode */
    CPSS_DXCH_TTI_EXP_4_QOS_SELECTION_NEXT_E
} CPSS_DXCH_TTI_EXP_4_QOS_SELECTION_MODE_ENT;

/**
* @enum CPSS_DXCH_TTI_EXP_4_EGRESS_SELECTION_MODE_ENT *
* @brief TTI EXP4Egress Selection Mode.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Previous EXP4Egress Selection Mode */
    CPSS_DXCH_TTI_EXP_4_EGRESS_SELECTION_PREVIOUS_E,
    /* Current EXP4Egress Selection Mode */
    CPSS_DXCH_TTI_EXP_4_EGRESS_SELECTION_CURRENT_E,
    /* Next EXP4Egress Selection Mode */
    CPSS_DXCH_TTI_EXP_4_EGRESS_SELECTION_NEXT_E
}CPSS_DXCH_TTI_EXP_4_EGRESS_SELECTION_MODE_ENT;

/**
* @enum CPSS_DXCH_TTI_TTL_MODEL_SELECTION_MODE_ENT *
* @brief TTI TTL Model Selection Mode.
*        (APPLICABLE DEVICES: AAS)
*/
typedef enum{
    /* Previous TTL Model */
    CPSS_DXCH_TTI_TTL_MODEL_PREVIOUS_E,
    /* Current TTL Model */
    CPSS_DXCH_TTI_TTL_MODEL_CURRENT_E
} CPSS_DXCH_TTI_TTL_MODEL_SELECTION_MODE_ENT;

/**
* @enum CPSS_DXCH_TTI_TTL_SELECTION_MODE_ENT *
 * @brief TTI TTL Selection Mode.
*/
typedef enum{
    /* Previous <Selected TTL> */
    CPSS_DXCH_TTI_TTL_SELECT_PREVIOUS_E,
    /* Current Layer TTL */
    CPSS_DXCH_TTI_TTL_SELECT_CURRENT_E,
    /* Next Layer TTL */
    CPSS_DXCH_TTI_TTL_SELECT_NEXT_E
} CPSS_DXCH_TTI_TTL_SELECTION_MODE_ENT;
...
typedef struct{
     ...
     *  REDIRECT_TO_EGRESS. The packet is forwarded to a port/trunk/vidx/vlan
     ...
     *  CPSS_DXCH_TTI_VLAN_MODIFY_UNTAGGED_E
     *  CPSS_DXCH_TTI_VLAN_MODIFY_ALL_E
     *  For DEVICES: Lion2; xCat3; AC5: Relevant if <mplsCommand> == CPSS_DXCH_TTI_MPLS_NOP_CMD_E
     */
     ...
     *  SIP7: 2 bit field
     *    CPSS_DXCH_TTI_DO_NOT_TRUST_L2_UP_E(0) - do not trust L2 UP
     *    CPSS_DXCH_TTI_TRUST_L2_UP_E(1) - Trust L2 UP. If TT, this is the inner ETH UP
     *    CPSS_DXCH_TTI_TRUST_L2_OUTER_ETH_UP_E(2) - Trust outer ETH UP only, even if TT
     */
    CPSS_DXCH_TTI_TRUST_UP_ENT trustUp;
     ...
     *  (APPLICABLE DEVICES: Bobcat2; Caelum; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman, Aldrin, AC3X, AAS),
     *  (APPLICABLE RANGES: Bobcat2; Caelum; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman, Aldrin, AC3X 0..6).
    ...
    /** @brief Enable assignment of Source ePort/vPort number from this entry (vPort in 'vPort mode')
     *  GT_FALSE- Disabled
     *  GT_TRUE - Enabled - New source ePort/vPort number
     *  is taken from TTI Action Entry<Source ePort/vPort>.
     *
     *  (APPLICABLE DEVICES: Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL sourceEPortAssignmentEnable;

    /** @brief Source ePort/vPort number assigned by TTI entry (vPort in 'vPort mode')
     *  when <Source ePort/vPort Assignment Enable> = Enabled
     *  NOTE: Overrides any previous assignment of source ePort/vPort number.
     *
     *  (APPLICABLE DEVICES: Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     ...
     *  (APPLICABLE RANGES: AAS 0..512K-1)
     *
     *  @brief The flow ID assigned to the packet.
     ...
     *  Action<Group IDs> is assigned to the packet's Source
     *  Group-ID Note: relevant when Redirect_Command !=
     *  Egress_Interface
     */
     ...
     *  Action<Group IDs> is assigned to the packet's Source
     *  Group-ID (9 bits) and to the packet's Destination Group-ID
     *  (3lsbs). Usually used for Source Group-ID assignment, The
     *  next modules (IPCL, FDB, Router) would set the Destination
     *  Group-ID (And override the 3 lsbs set by this action).Bits
     *  [11:0] are used as Group IDs
     *
     ...
     */
     ...
     /** @brief TTI QoS Model
     *  User defined QoS model (CPSS_DXCH_TTI_QOS_MODEL_ENT)
     *  (APPLICABLE DEVICES: AAS)
     *  (APPLICABLE RANGES: 0..2)
     */
     CPSS_DXCH_TTI_QOS_MODEL_ENT  qosModel;

     /** @brief TTI TTL Model
     *  User defined TTL model (CPSS_DXCH_TTI_TTL_MODEL_ENT)
     *  (APPLICABLE DEVICES: AAS)
     *  (APPLICABLE RANGES: 0..2)
     */
     CPSS_DXCH_TTI_TTL_MODEL_ENT  ttlModel;

     /** @brief TTI QoS Mapping Mode
     *  QoS profile Mode (CPSS_DXCH_TTI_QOS_MAPPING_MODE_ENT)
     *  (APPLICABLE DEVICES: AAS)
     *  (APPLICABLE RANGES: 0..2)
     */
     CPSS_DXCH_TTI_QOS_MAPPING_MODE_ENT  qosMappingMode;

     /** @brief TTI Stop Mpls
     * GT_TRUE - Action Resolution logic ignores subsequent Actions
     *            that have <MPLS Command> != NULL
     * GT_FALSE - Don't modify the Action
     *  (APPLICABLE DEVICES: AAS)
     */
     GT_BOOL  stopMpls;
...
/**
 * @struct CPSS_DXCH_TTI_RANGE_CHECK_BYTE_PAIR_CFG_STC
 *
 * @brief Range Check Byte Pair Configuration
 *       (APPLICABLE DEVICES: AAS)
*/
typedef struct{

    /** @brief Range Check Enable/Disable */
    GT_BOOL enable;

    /** @brief Range Check Anchor Type for the Range Byte-Pair */
    CPSS_DXCH_TTI_OFFSET_TYPE_ENT anchorType;

    /** @brief Range Check Anchor byte offset
     *  (APPLICABLE RANGES: 0..255) */
    GT_U32 byteOffset;

    /** @brief The mask applied to the Range Byte-Pair,
     *  network order */
    GT_U8 mask[2];

} CPSS_DXCH_TTI_RANGE_CHECK_BYTE_PAIR_CFG_STC;

/**
 * @struct CPSS_DXCH_TTI_NON_FORWARDING_LABEL_QOS_PARAMS_STC
 *
 * @brief QOS Attributes for Non-forwarding label
 *        (APPLICABLE DEVICES: AAS)
*/
typedef struct{
    /* @brief user defined QOS Model(2b)
     * Uniform Model, Pipe Model, Short Pipe Model.
     */
    CPSS_DXCH_TTI_QOS_MODEL_ENT qosModel;
    /* @brief user defined TTL Model(2b)
     * Uniform Model, Pipe Model, Short Pipe Model.
     */
    CPSS_DXCH_TTI_TTL_MODEL_ENT ttlModel;
    /* @brief Index to Select QoS Mapping Table(7b)
     * Applicable ranges: 0-127
     */
    GT_U32 qosMappingTableIndex;
    /* @brief Trust EXP Flag (1b) */
    GT_BOOL trustExpFlag;
    /* @brief Trust UP Flag (2b)
     * 0 - do not trust L2 UP
     * 1 - Trust L2 UP. If TT, this is the inner Ethernet UP.
     * 2 - Trust outer Ethernet UP only, even if TT.
     */
    CPSS_DXCH_TTI_TRUST_UP_ENT trustUpFlag;
} CPSS_DXCH_TTI_NON_FORWARDING_LABEL_QOS_PARAMS_STC;

/**
 * @struct CPSS_DXCH_TTI_QOS_ACTION_RESOLUTION_PARAMS_STC
 *
 * @brief QoS Action Resolution parameters
 *        (APPLICABLE DEVICES: AAS)
*/
typedef struct{
    /* @brief Next QoS Model Selection Mode */
    CPSS_DXCH_TTI_QOS_MODEL_SELECTION_MODE_ENT nextQosModelSelectionMode;
    /* @brief Next Trust QoS Mapping Table Selection Mode */
    CPSS_DXCH_TTI_TRUST_QOS_MAPPING_TABLE_SELECTION_MODE_ENT nextQosMappingTableSelectionMode;
    /* @brief Next QoS Trust Fields Selection Mode */
    CPSS_DXCH_TTI_QOS_TRUST_FIELDS_SELECTION_MODE_ENT nextQosTrustFieldsSelectionMode;
    /* @brief Next EXP4QoS Selection Mode */
    CPSS_DXCH_TTI_EXP_4_QOS_SELECTION_MODE_ENT nextExp4QosSelectionMode;
    /* @brief Next EXP4Egress Selection Mode */
    CPSS_DXCH_TTI_EXP_4_EGRESS_SELECTION_MODE_ENT nextExp4EgressSelectionMode;
} CPSS_DXCH_TTI_QOS_ACTION_RESOLUTION_PARAMS_STC;

/**
 * @struct CPSS_DXCH_TTI_TTL_ACTION_RESOLUTION_PARAMS_STC
 *
 * @brief TTL Action Resolution parameters
 *        (APPLICABLE DEVICES: AAS)
*/
typedef struct{
    /* @brief Next TTL Model Selection Mode(1b) */
    CPSS_DXCH_TTI_TTL_MODEL_SELECTION_MODE_ENT nextTTLModelSelectionMode;
    /* @brief Next TTL Selection Mode(2b) */
    CPSS_DXCH_TTI_TTL_SELECTION_MODE_ENT nextTTLSelectionMode;
} CPSS_DXCH_TTI_TTL_ACTION_RESOLUTION_PARAMS_STC;

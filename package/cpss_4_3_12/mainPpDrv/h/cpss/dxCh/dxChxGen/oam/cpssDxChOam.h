...
/**
* @enum CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT
 *
 * @brief Enumeration for OAM exception status
*/
typedef enum{

    /** Exception not detected */
    CPSS_DXCH_OAM_EXCEPTION_STATUS_PASS_E,

    /** Exception detected */
    CPSS_DXCH_OAM_EXCEPTION_STATUS_FAIL_E

} CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT;
...
typedef struct{
    ...
    /** @brief When enabled, exception storms are suppressed
     *  for 'keepalive aging' exception type.
     *   GT_FALSE - Exception storms are not suppressed.
     *   GT_TRUE  - Exception storms are suppressed.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL keepaliveAgingStormSuppressEnable;

    /** @brief When enabled, exception storms are suppressed
     *  for 'Invalid hash keepalive' exception type.
     *   GT_FALSE - Exception storms are not suppressed.
     *   GT_TRUE  - Exception storms are suppressed.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL invalidHashKeepaliveStormSuppressEnable;

    /** @brief When enabled, exception storms are suppressed
     *  for 'MEG level' exception type.
     *   GT_FALSE - Exception storms are not suppressed.
     *   GT_TRUE  - Exception storms are suppressed.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL megLevelStormSuppressEnable;

    /** @brief When enabled, exception storms are suppressed
     *  for 'Source interface' exception type.
     *   GT_FALSE - Exception storms are not suppressed.
     *   GT_TRUE  - Exception storms are suppressed.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL sourceInterfaceStormSuppressEnable;

    /** @brief When enabled, exception storms are suppressed
     *  for 'Tx period' exception type.
     *   GT_FALSE - Exception storms are not suppressed.
     *   GT_TRUE  - Exception storms are suppressed.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL txPeriodStormSuppressEnable;

    /** @brief Represents the previous state of Keepalive Aging for this flow.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT keepaliveAgingStatus;

    /** @brief Represents the previous state of MEG Level Status for this flow.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT megLevelStatus;

    /** @brief Represents the previous state of source interface Status for this flow.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT sourceInterfaceStatus;

    /** @brief Represents the previous state of TX period Status for this flow.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT txPeriodStatus;

    /** @brief Represents the previous state of hash verification Status for this flow.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    CPSS_DXCH_OAM_EXCEPTION_STATUS_ENT hashVerificationStatus;

    /** @brief status of
     *      GT_TRUE - A packet that fails the hash verification does not cause the <Aging State> to be cleared.
     *      GT_FALSE- A keepalive message causes the <Aging State> to be cleared regardless of the hash verification.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL ignoreBadKeepAliveInAgingEnable;

    /** @brief status of LOC detection,
     *      GT_TRUE  - LOC detection is disabled, but other keepalive mechanisms
     *          (excess detection, RDI detection, period verification, hash verification) may be enabled.
     *      GT_FALSE - Loss Of Continuity (LOC) detection is enabled for this entry.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL locDetectionDisable;

    /** @brief It indicates that the RDI bit is set and
     *         that <Protection on RDI Enable> is enabled for this flow.
     *      GT_TRUE  - protection RDI state is enabled  for this entry.
     *      GT_FALSE - protection RDI state is disabled for this entry.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL protectionRdiState;

    /** @brief It indicates Remote Defect Indication (RDI) from a peer MEP
     *         triggers protection switching; when the RDI bit is set the LOC table in the
     *          EQ indicates that the flow is down, and the protecting path will be used.
     *
     *      GT_TRUE  - protection on RDI is enabled  for this entry.
     *      GT_FALSE - protection on RDI is disabled for this entry.
     *          (excess detection, RDI detection, period verification, hash verification) may be enabled.
     *  (APPLICABLE DEVICES: Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman)
     */
    GT_BOOL protectionOnRdiEnable;
 ...
 *
 * @brief Structure of 'OAM exception recovery' and 'OAM exception suppress'.
*/
typedef struct{
    ...
    /** OAM exception packet CPU code */
    CPSS_NET_RX_CPU_CODE_ENT cpuCode;

} CPSS_DXCH_OAM_EXCEPTION_COMMAND_CONFIG_STC;
...
(
    ...
    IN  CPSS_DXCH_OAM_STAGE_TYPE_ENT            stage,
    IN  CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT        exceptionType,
    OUT GT_U32                                  groupStatusArr[CPSS_DXCH_OAM_GROUP_STATUS_SIZE_IN_WORDS_CNS] /*maxArraySize=2*/
);
...
(
    ...
    IN  CPSS_DXCH_OAM_STAGE_TYPE_ENT            stage,
    IN  CPSS_DXCH_OAM_EXCEPTION_TYPE_ENT        exceptionType,
    OUT GT_U32                                  groupStatusArr[CPSS_DXCH_OAM_GROUP_STATUS_SIZE_IN_WORDS_CNS] /*maxArraySize=16*/
);
...
*                                       4. SOURCE_INTERFACE
*                                       5. TX_PERIOD
* @param[in] exceptionCommandPtr   - (pointer to)OAM exception recovery command configuration.
*
* @retval GT_OK                    - on success.
...
*                                       4. SOURCE_INTERFACE
*                                       5. TX_PERIOD
* @param[out] exceptionCommandPtr  - (pointer to)OAM exception recovery command configuration.
*
* @retval GT_OK                    - on success.
* @retval GT_BAD_PARAM             - on wrong device/stage/exceptionType.
* @retval GT_BAD_PTR               - one of the parameters is NULL pointer.

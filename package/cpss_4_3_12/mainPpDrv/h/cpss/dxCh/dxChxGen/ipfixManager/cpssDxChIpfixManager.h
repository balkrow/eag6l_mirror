...
#define CPSS_IPFIX_MANAGER_TX_DSA_TAG_LEN_IN_WORDS_CNS 4
#define CPSS_IPFIX_MANAGER_TX_DSA_TAG_LEN_CNS 16
...
typedef struct{
    ...
    GT_U32      txDsaTag[CPSS_IPFIX_MANAGER_TX_DSA_TAG_LEN_IN_WORDS_CNS];

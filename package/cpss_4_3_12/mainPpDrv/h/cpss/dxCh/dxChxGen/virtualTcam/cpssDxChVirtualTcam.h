...
/**
* @enum CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_TYPE_ENT
 *
 * @brief vTCAM movability type.
*/
typedef enum{

    /** regular movable vTCAM.
     *  The TCAM space is defined by order of vTCAM creation.
     *  First created vTCAM get space with lower rule indexes.
     */
    CPSS_DXCH_VIRTUAL_TCAM_MOVABLE_E = GT_FALSE,

    /** unmovable vTCAM without Application TCAM space definition.
     *  The TCAM space is defined by order of vTCAM creation.
     *  First created vTCAM get space with lower rule indexes. */
    CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_CPSS_ALLOCATED_E = GT_TRUE,

    /** unmovable vTCAM with Application TCAM space definition.
     *  CPSS allocates vTCAM in the space specified by Application. */
    CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_APP_ALLOCATED_E

} CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_TYPE_ENT;
...
typedef struct{
    ...
    */
     ...
     *  For such cases this variable should be specified by one of ..._UNMOVABLE_...
     *  types of enum (see description of it's members).
     *  Use CPSS_DXCH_VIRTUAL_TCAM_MOVABLE_E for movable (i.e. regular) vTCAM.
     */
    CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_TYPE_ENT tcamSpaceUnmovable;

    /** @Brief Size of allocation Array of TCAM memory segments
     *  relevant only if tcamSpaceUnmovable == CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_APP_ALLOCATED_E
     */
    GT_U32                                   allocationSpaceArrSize;

    /** @Brief Pointer to allocation Array of TCAM memory segments
     *  relevant only if tcamSpaceUnmovable == CPSS_DXCH_VIRTUAL_TCAM_UNMOVABLE_APP_ALLOCATED_E
     *  Application must provide this array in ascending order of base TCAM rows.
     */
    CPSS_DXCH_VIRTUAL_TCAM_SPACE_SEGMENT_STC *allocationSpaceArr;

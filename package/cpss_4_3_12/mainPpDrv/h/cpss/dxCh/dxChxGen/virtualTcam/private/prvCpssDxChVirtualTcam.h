...
/*
 * Typedef: function cmpFunc
 *
 * Description:
 *     This Callback Function called used for AVL tree comparison
 *
 *
 * INPUTS:
 * @param[in]  elem_PTR1              - First element
 * @param[in]  elem_PTR1              - Second element
 *
 *
 */
typedef GT_COMP_RES (*cmpFunc)(void* elem_PTR1,void* elem_PTR2);

...
#define PRV_DXCH_MACSEC_CNV_CPSS_TO_SAB_DIRECTION_MAC(_cpssDir, _sabDir)\
        switch (_cpssDir)                                               \
        {                                                               \
            default:                                                    \
                _sabDir = (GT_U32)_cpssDir;                             \
                break;                                                  \
            case CPSS_DXCH_MACSEC_DIRECTION_INGRESS_E:                  \
                _sabDir = SAB_DIRECTION_INGRESS;                        \
                break;                                                  \
            case CPSS_DXCH_MACSEC_DIRECTION_EGRESS_E:                   \
                _sabDir = SAB_DIRECTION_EGRESS;                         \
                break;                                                  \
        }

#define PRV_DXCH_MACSEC_CNV_CPSS_TO_SECY_SA_ACTION_MAC(_cpssAction, _saAction)\
        switch (_cpssAction)                                                  \
        {                                                                     \
            default:                                                          \
                _saAction = (GT_U32)_cpssAction;                              \
                break;                                                        \
            case CPSS_DXCH_MACSEC_SECY_SA_ACTION_BYPASS_E:                    \
                _saAction = SECY_SA_ACTION_BYPASS;                            \
                break;                                                        \
            case CPSS_DXCH_MACSEC_SECY_SA_ACTION_DROP_E:                      \
                _saAction = SECY_SA_ACTION_DROP;                              \
                break;                                                        \
            case CPSS_DXCH_MACSEC_SECY_SA_ACTION_INGRESS_E:                   \
                _saAction = SECY_SA_ACTION_INGRESS;                           \
                break;                                                        \
            case CPSS_DXCH_MACSEC_SECY_SA_ACTION_EGRESS_E:                    \
                _saAction = SECY_SA_ACTION_EGRESS;                            \
                break;                                                        \
            case CPSS_DXCH_MACSEC_SECY_SA_ACTION_CRYPT_AUTH_E:                \
                _saAction = SECY_SA_ACTION_CRYPT_AUTH;                        \
                break;                                                        \
        }

#define PRV_DXCH_MACSEC_CNV_SECY_SA_ACTION_TO_CPSS_MAC(_saAction, _cpssAction)\
        switch (_saAction)                                                    \
        {                                                                     \
            default:                                                          \
                _cpssAction = (GT_U32)_saAction;                              \
                break;                                                        \
            case SECY_SA_ACTION_BYPASS:                                       \
                _cpssAction = CPSS_DXCH_MACSEC_SECY_SA_ACTION_BYPASS_E;       \
                break;                                                        \
            case SECY_SA_ACTION_DROP:                                         \
                _cpssAction = CPSS_DXCH_MACSEC_SECY_SA_ACTION_DROP_E;         \
                break;                                                        \
            case SECY_SA_ACTION_INGRESS:                                      \
                _cpssAction = CPSS_DXCH_MACSEC_SECY_SA_ACTION_INGRESS_E;      \
                break;                                                        \
            case SECY_SA_ACTION_EGRESS:                                       \
                _cpssAction = CPSS_DXCH_MACSEC_SECY_SA_ACTION_EGRESS_E;       \
                break;                                                        \
            case SECY_SA_ACTION_CRYPT_AUTH:                                   \
                _cpssAction = CPSS_DXCH_MACSEC_SECY_SA_ACTION_CRYPT_AUTH_E;   \
                break;                                                        \
        }

#define PRV_DXCH_MACSEC_CNV_CPSS_TO_SECY_PORT_MAC(_cpssPort, _secyPort) \
        switch (_cpssPort)                                              \
        {                                                               \
            default:                                                    \
                _secyPort = (GT_U32)_cpssPort;                          \
                break;                                                  \
            case CPSS_DXCH_MACSEC_SECY_PORT_COMMON_E:                   \
                _secyPort = SECY_PORT_COMMON;                           \
                break;                                                  \
            case CPSS_DXCH_MACSEC_SECY_PORT_CONTROLLED_E:               \
                _secyPort = SECY_PORT_CONTROLLED;                       \
                break;                                                  \
            case CPSS_DXCH_MACSEC_SECY_PORT_UNCONTROLLED_E:             \
                _secyPort = SECY_PORT_UNCONTROLLED;                     \
                break;                                                  \
        }

#define PRV_DXCH_MACSEC_CNV_SECY_PORT_TO_CPSS_MAC(_secyPort, _cpssPort) \
        switch (_secyPort)                                              \
        {                                                               \
            default:                                                    \
                _cpssPort = (GT_U32)_secyPort;                          \
                break;                                                  \
            case SECY_PORT_COMMON:                                      \
                _cpssPort = CPSS_DXCH_MACSEC_SECY_PORT_COMMON_E;        \
                break;                                                  \
            case SECY_PORT_CONTROLLED:                                  \
                _cpssPort = CPSS_DXCH_MACSEC_SECY_PORT_CONTROLLED_E;    \
                break;                                                  \
            case SECY_PORT_UNCONTROLLED:                                \
                _cpssPort = CPSS_DXCH_MACSEC_SECY_PORT_UNCONTROLLED_E;  \
                break;                                                  \
        }

#define PRV_DXCH_MACSEC_CNV_CPSS_TO_SECY_FRAME_VALID_MAC(_cpssFrameValid, _secyFrameValid) \
        switch (_cpssFrameValid)                                                           \
        {                                                                                  \
            default:                                                                       \
                _secyFrameValid = (GT_U32)_cpssFrameValid;                                 \
                break;                                                                     \
            case CPSS_DXCH_MACSEC_SECY_FRAME_VALIDATE_DISABLE_E:                           \
                _secyFrameValid = SECY_FRAME_VALIDATE_DISABLE;                             \
                break;                                                                     \
            case CPSS_DXCH_MACSEC_SECY_FRAME_VALIDATE_CHECK_E:                             \
                _secyFrameValid = SECY_FRAME_VALIDATE_CHECK;                               \
                break;                                                                     \
            case CPSS_DXCH_MACSEC_SECY_FRAME_VALIDATE_STRICT_E:                            \
                _secyFrameValid = SECY_FRAME_VALIDATE_STRICT;                              \
                break;                                                                     \
        }

#define PRV_DXCH_MACSEC_CNV_SECY_FRAME_VALID_TO_CPSS_MAC(_secyFrameValid, _cpssFrameValid) \
        switch (_secyFrameValid)                                                           \
        {                                                                                  \
            default:                                                                       \
                _cpssFrameValid = (GT_U32)_secyFrameValid;                                 \
                break;                                                                     \
            case SECY_FRAME_VALIDATE_DISABLE:                                              \
                _cpssFrameValid = CPSS_DXCH_MACSEC_SECY_FRAME_VALIDATE_DISABLE_E;          \
                break;                                                                     \
            case SECY_FRAME_VALIDATE_CHECK:                                                \
                _cpssFrameValid = CPSS_DXCH_MACSEC_SECY_FRAME_VALIDATE_CHECK_E;            \
                break;                                                                     \
            case SECY_FRAME_VALIDATE_STRICT:                                               \
                _cpssFrameValid = CPSS_DXCH_MACSEC_SECY_FRAME_VALIDATE_STRICT_E;           \
                break;                                                                     \
        }

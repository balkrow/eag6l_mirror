...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_MACSEC_POLICY_MODE_ENT);
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_MACSEC_SECY_SA_HANDLE_newSaHandle;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_PORT_PREEMPTION_CLASS_ENT_preemptionClass;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChMacSecClassifyRuleAddIndex_E,
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChMacSecSecySaSwitch_E,
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChMacSecSecyStatisticsSaClear_E
};

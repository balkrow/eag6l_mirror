...
typedef enum
{
    ...
    CPSS_DXCH_LPM_MULTIPATH_ENTRY_PTR_TYPE_E =10,
    CPSS_DXCH_LPM_RAM_TRIE_PTR_TYPE_E = 255
 ...
 *      assignSmallBankToOctet0 - allocate small LPM bank for octet 0.
 *                                By default, big bank is allocated for octet0. May be
 *                                used to increase capacity when small number of vrf-ids are to
 *                                be used
 *                                (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier. Ignored for other devices)
 *
 */
typedef struct CPSS_DXCH_LPM_RAM_CONFIG_STCT
{
    ...
    GT_BOOL                                         assignSmallBankToOctet0;

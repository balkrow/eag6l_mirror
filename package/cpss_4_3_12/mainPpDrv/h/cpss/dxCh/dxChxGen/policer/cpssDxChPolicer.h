...
typedef struct{
    ...
    /** @brief Determine whether counting is performed
     *  GT_TRUE:  Counting is performed
     *  GT_FALSE: Counting is not performed
     *  APPLICABLE DEVICES: Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman
     *  NOT APPLICABLE DEVICES: AAS.
     *
     *  Note: <countingEnable> configuration is obsoleted from SIP7 devices
     */

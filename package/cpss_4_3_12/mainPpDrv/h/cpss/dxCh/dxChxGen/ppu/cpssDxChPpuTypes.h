...
/* K_stg key generation profile table entry max byte select value */
#define CPSS_DXCH_PPU_KSTG_KEY_GEN_PROFILE_BYTE_SELECT_MAX_VALUE_CNS  0x3E
...
/* PPU max loopbacks */
#define CPSS_DXCH_PPU_MAX_LOOPBACK_NUM_CNS 7
...
/* PPU DAU protectd window latch window index bit field offset */
#define CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_WIN_IDX_OFFSET 0

/* PPU DAU protectd window latch window index bit field size */
#define CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_WIN_IDX_SIZE 3

/* PPU DAU protectd window latch data bit field offset */
#define CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_DATA_OFFSET 3

/* PPU DAU protectd window latch data bit field size */
#define CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_DATA_SIZE 8

/* PPU DAU protectd window latch SP Byte index bit field offset */
#define CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_SP_INDEX_OFFSET 11

/* PPU DAU protectd window latch SP Byte index bit field size */
#define CPSS_DXCH_PPU_DAU_PROT_WIN_LATCH_SP_INDEX_SIZE 5
...
typedef struct {
    ...
    /** counter set select
     * 0x0 = DONOT_SET; Do not SET counter; ;
     * 0x1 = SET; Set counter to the value defined under COUNTER_SET_VAL; */
    GT_BOOL counterSet;

...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_STREAM_EGRESS_PORT_RECONFIG_CHANNEL_TYPE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_STREAM_SGC_GATE_STATE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_STREAM_SGC_TABLE_SET_REMAINING_BITS_RESOLUTION_ENT);
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_INOUT_CPSS_DXCH_STREAM_EGREESS_PORT_BIND_ENTRY_STC_PTR_bindEntryPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_CNC_BYTE_COUNT_MODE_ENT_irfMode;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_STREAM_EGREESS_PORT_BIND_ENTRY_STC_PTR_bindEntryPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_STREAM_EGRESS_TIME_SLOT_INFO_STC_PTR_timeSlotInfoArr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_STREAM_EXCEPTION_TYPE_ENT_type;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_STREAM_SGC_GATE_INFO_STC_PTR_gateParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_STREAM_SGC_GATE_RECONFIG_TIME_STC_PTR_gateReconfigTimeParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_STREAM_SGC_GLOBAL_CONFIG_STC_PTR_globalParamsPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_gate;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_gateId;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_imxProfilesNum;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_slotsNum;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_tableSet;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_tableSetId;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_STREAM_EGRESS_TIME_SLOT_INFO_STC_PTR_timeSlotInfoArr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_STREAM_IRF_COUNTERS_ENTRY_STC_PTR_irfCountersPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_STREAM_SGC_GATE_INFO_STC_PTR_gateParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_STREAM_SGC_GATE_RECONFIG_TIME_STC_PTR_gateReconfigTimeParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_STREAM_SGC_GLOBAL_CONFIG_STC_PTR_globalParamsPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_gatePtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U32_PTR_tableSetPtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChStreamSgcGlobalConfigSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamSgcGlobalConfigGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamSgcGateConfigSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamSgcGateConfigGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamSgcTimeBasedGateReConfigSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamSgcTimeBasedGateReConfigGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamSgcTimeBasedGateReConfigComplete_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamEgressTableSetConfigSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamEgressTableSetConfigGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamEgressPortBindSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamEgressPortBindGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamEgressPortBindComplete_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamEgressPortUnbindSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamEgressPortQueueGateSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChStreamEgressPortQueueGateGet_E
};

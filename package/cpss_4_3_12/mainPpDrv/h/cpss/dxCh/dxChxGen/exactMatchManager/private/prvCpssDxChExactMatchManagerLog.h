...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC_PTR_lookupEntryParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_STC_PTR_lookupPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC_PTR_profileEntryParamsPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_CONFIG_STC_PTR_lookupEntryParamsPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_EXACT_MATCH_MANAGER_LOOKUP_STC_PTR_lookupPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_EXACT_MATCH_MANAGER_PROFILE_ENTRY_PARAMS_STC_PTR_profileEntryParamsPtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChExactMatchManagerProfileEntryUpdate_E,
    PRV_CPSS_LOG_FUNC_cpssDxChExactMatchManagerProfileEntryGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChExactMatchManagerLookupUpdate_E,
    PRV_CPSS_LOG_FUNC_cpssDxChExactMatchManagerLookupGet_E
};

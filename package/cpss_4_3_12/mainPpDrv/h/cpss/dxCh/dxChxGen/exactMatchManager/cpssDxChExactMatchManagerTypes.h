...
typedef struct{
    ...
    /** @brief: enable software workaround that fix possible incorrect action selection.
...
typedef struct{
     ...
     */
    GT_BOOL deleteKeySizeEntries[CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E];
    ...
    GT_U8          mask[CPSS_DXCH_EXACT_MATCH_MANAGER_MAX_KEY_SIZE_CNS];
...
typedef struct{
     ...
     */
    GT_BOOL checkAgeKeySizeEntries[CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E];
     ...
     */
    GT_BOOL deleteAgeoutKeySizeEntries[CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E];
...
typedef struct
{
    ...
    GT_U32 ttiClientKeySizeEntriesArray[CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E];
    GT_U32 ipcl0ClientKeySizeEntriesArray[CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E];
    GT_U32 ipcl1ClientKeySizeEntriesArray[CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E];
    GT_U32 ipcl2ClientKeySizeEntriesArray[CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E];
    GT_U32 epclClientKeySizeEntriesArray[CPSS_DXCH_EXACT_MATCH_MANAGER_KEY_SIZE_LAST_E];
...
typedef struct
{
    ...
    /* @brief : Indicates Exact Match manager to check - Database Hash Free List */
    GT_BOOL         dbHashFreeListCheckEnable;

    /* @brief : Indicates Exact Match manager to check - Database Conflict Entries List */
    GT_BOOL         dbHashIndexArrayCheckEnable ;
...
typedef enum
{
    ...
    /* @brief : Indicates Exact Match manager "Hash Free List check" test failed - 1st pointer invalid */
    CPSS_DXCH_EXACT_MATCH_MANAGER_DB_CHECKS_HASH_FREE_LIST_1ST_PTR_INVALID_E,
    /* @brief : Indicates Exact Match manager "Hash Free List check" test failed - Get Next failed(List corrupted) */
    CPSS_DXCH_EXACT_MATCH_MANAGER_DB_CHECKS_HASH_FREE_LIST_GETNEXT_PTR_INVALID_E,
    /* @brief : Indicates Exact Match manager "Hash Free List check" test failed - List number mismatch */
    CPSS_DXCH_EXACT_MATCH_MANAGER_DB_CHECKS_HASH_FREE_LIST_ENTRIES_NUM_MISMATCH_E,

    /* @brief : Indicates Exact Match manager "hash index array check" test failed - key size is invalid */
    CPSS_DXCH_EXACT_MATCH_MANAGER_DB_CHECKS_HASH_ENTRY_KEY_SIZE_INVALID_E,
    /* @brief : Indicates Exact Match manager "hash index array check" test failed - 1st pointer invalid */
    CPSS_DXCH_EXACT_MATCH_MANAGER_DB_CHECKS_HASH_ENTRY_LIST_1ST_PTR_INVALID_E,
    /* @brief : Indicates Exact Match manager "hash index array check" test failed - Get Next failed(List corrupted) */
    CPSS_DXCH_EXACT_MATCH_MANAGER_DB_CHECKS_HASH_ENTRY_LIST_GETNEXT_PTR_INVALID_E,
    /* @brief : Indicates Exact Match manager "Hash index array check" test failed - List number mismatch */
    CPSS_DXCH_EXACT_MATCH_MANAGER_DB_CHECKS_HASH_ENTRY_LIST_ENTRIES_NUM_MISMATCH_E,
    /* @brief : Indicates Exact Match manager "Hash index array check" test failed - found actual conflict */

...
typedef struct{
    ...
    /** @brief Ingress Analyzer Mirror Index
    ...
    /** @brief Egress Analyzer Mirror Index
     *  (APPLICABLE DEVICES: Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS)
     *  (APPLICABLE RANGES: Bobcat2, Caelum, Aldrin, AC3X, Bobcat3, Aldrin2, Falcon, AC5P, AC5X, Harrier, Ironman 0..6)
     *  (APPLICABLE RANGES: AAS 0..62)
     */
    ...
    /** @brief IPv4 MC/BC packets - Mirror to Analyzer Index
     *  (APPLICABLE DEVICES: Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS)
     *  (APPLICABLE RANGES: Bobcat2, Caelum, Aldrin, AC3X, Bobcat3, Aldrin2, Falcon, AC5P, AC5X, Harrier, Ironman 0..6)
     *  (APPLICABLE RANGES: AAS 0..62)
     */
    ...
    /** @brief IPv6 MC packets - Mirror to Analyzer Index
     *  (APPLICABLE DEVICES: Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS)
     *  (APPLICABLE RANGES: Bobcat2, Caelum, Aldrin, AC3X, Bobcat3, Aldrin2, Falcon, AC5P, AC5X, Harrier, Ironman 0..6)
     *  (APPLICABLE RANGES: AAS 0..62)
     */
...
*                                      GT_TRUE - enable
*                                      GT_FALSE - disable
* @param[in] txAnalyzerIndex          - Tx Analyzer index, relevant only if mirrToTxAnalyzerEn == GT_TRUE
*                                       (APPLICABLE RANGES: Bobcat2, Caelum, Aldrin, AC3X, Bobcat3, Aldrin2, Falcon, AC5P, AC5X, Harrier, Ironman 0..6)
*                                       (APPLICABLE RANGES: AAS 0..62)
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error.

...
typedef enum{
     ...
     */
    CPSS_DXCH_BRG_DROP_CNTR_MAC_SA_MOVED_E,

    /** @brief ARP CPU code
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_ARP_CPU_CODE_E,

    /** @brief MAC SA is DA
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_MAC_SA_IS_DA_E,

    /** @brief Source IP (SIP) is Destination IP (DIP)
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_SIP_IS_DIP_E,

    /** @brief TCP/UDP Source port is destination port
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_TCP_UDP_SPORT_IS_DPORT_E,

    /** @brief TCP flags has FIN but no ACK
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_TCP_FIN_WITHOUT_ACK_E,

    /** @brief IPv6 ICMP packet dropped.
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_IPV6_ICMP_E,

    /** @brief TCP has no full header
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_TCP_WITHOUT_FULL_HEADER_E,

    /** @brief IPv4 RIPv1 packet dropped.
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_MIRROR_IPV4_RIPV1_E,

    /** @brief IPv6 neighbor
     *  solicitation packet dropped.
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_IPV6_NEIGHBOR_SOLICITATION_E,

    /** @brief A Multicast packet with a MAC DA in the proprietary
     * 01-00-0c-XX-XX-XX dropped.
     * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
     */
    CPSS_DXCH_BRG_DROP_CNTR_PROPRIETARY_MCAST_MAC_RANGE_E,

    /** @brief MAC Spoof Protection Event
    * APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
    */
    CPSS_DXCH_BRG_DROP_CNTR_MAC_SPOOF_E

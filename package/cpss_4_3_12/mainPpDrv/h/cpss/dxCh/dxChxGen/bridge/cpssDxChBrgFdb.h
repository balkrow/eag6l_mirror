...
/**
* @struct CPSS_DXCH_BRG_FDB_PORT_CONFIG_STC
*
* @brief     Bridge FDB port configurations parameters
*/
typedef struct
{
    /**@brief Enables or disables Automatic Learning on this port
     *          GT_FALSE - Automatic learning is disabled
     *          GT_TRUE  - Automatic learning is enabled  */
    GT_BOOL    autoLearnEnable;

    /**@brief Enables or disables sending new address messages to the CPU
     *          GT_FALSE - New address messages are not sent to the CPU
     *          GT_TRUE  - New address messages are sent to the CPU  */
    GT_BOOL    naMsgToCpuEnable;

    /**@brief The bridge forwarding decision for packets with unknown Source Address
     *        Only relevant in controlled address learning mode (autoLearnEnable = GT_FALSE) */
    CPSS_PORT_LOCK_CMD_ENT unkSrcAddrCmd;

} CPSS_DXCH_BRG_FDB_PORT_CONFIG_STC;
...
/**
* @struct CPSS_DXCH_BRG_FDB_SP_CONFIG_STC
*
* @brief     Bridge FDB Storm Prevention configurations parameters
*/
typedef struct
{
    /** @brief Enables or disables fast aging of SP entries
     *          GT_FALSE - Fast aging of SP entries is disabled.
     *                     In this mode, SP entries are treated as regular entries for aging process
     *          GT_TRUE  - Fast aging of SP entries is enabled.
     *                     In this mode, SP entries are aged in the first pass, and
     *                     filtering aging by FID is disabled. */
    GT_BOOL    spEntryFastAgeEnable;

    /** @brief Enable/disable creating SP entries even if NA messages are disabled.
     *          GT_FALSE - Creating SP entries is disabled when NA messages to CPU are disabled
     *          GT_TRUE  - Creating SP entries is enabled even if NA messages to CPU are disabled  */
    GT_BOOL    spLearnEnableNaToCpu;

} CPSS_DXCH_BRG_FDB_SP_CONFIG_STC;
...
/**
* @internal cpssDxChBrgFdbPortConfigSet function
* @endinternal
*
* @brief Bridge FDB configurations per port
*        - Enable/disable learning of new source MAC addresses for packets
*          received on specified port
...
* @param[in] configPtr             - (pointer to) bridge FDB port configuratios parameters
*
...
*
* @note To support full synchronization between ASIC FDB and host CPU the settings of auto learn
*       and NA messages are done together as an atomic operation
*/
...
*
* @param[in] devNum                - device number
* @param[in] mode                  - hash function mode
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_HW_ERROR              - on hardware error
...
* @param[in] devNum                - device number
*
* @param[out] modePtr              - (pointer to) hash function mode
*
* @retval GT_OK                    - on success
* @retval GT_HW_ERROR              - on hardware error
* @retval GT_BAD_PARAM             - wrong devNum or mode
...
/**
* @internal cpssDxChBrgFdbSizeSet function
* @endinternal
*
* @brief   function to set the FDB size.
*          Note: API should be called after cpssDxChCfgPpLogicalInit and before cpssDxChBrgFdbInit
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
...
*                                      (Applicable values are in HW specification documents)
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
...
/**
* @internal cpssDxChBrgFdbSpConfigSet function
* @endinternal
*
* @brief  Sets Bridge FDB Storm Prevention configurations
*         - Enable/disable fast aging SP FDB entries.
*         - Enable/disable creating SP entries irrespective to NA messages to CPU are enabled or not.
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2.
*
* @param[in] devNum                - device number
* @param[in] spConfigPtr           - (pointer to) SP configuration structure
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_HW_ERROR              - on hardware error
...
/**
* @internal cpssDxChBrgFdbSpConfigGet function
* @endinternal
*
* @brief  Gets Bridge FDB Storm Prevention configurations
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2.
*
* @param[in]  devNum               - device number
*
* @param[out] spConfigPtr          - (pointer to) SP configuration structure
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_HW_ERROR              - on hardware error
...
/**
* @internal cpssDxChBrgFdbMcAddrDelEnableSet function
* @endinternal
*
* @brief  Sets enable/disable removal of MC address during the aging process
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2.
*
* @param[in] devNum                - device number
* @param[in] enable                - enable/disable removal of MC address during the aging process
*                                    when GT_TRUE  - remove of MC address during the aging process
*                                    when GT_FALSE - do not remove of MC address during the aging process
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_HW_ERROR              - on hardware error
...
/**
* @internal cpssDxChBrgFdbMcAddrDelEnableGet function
* @endinternal
*
* @brief  Gets enable/disable removal of MC address during the aging process
*
* @note   APPLICABLE DEVICES:      Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman; AAS.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2.
*
* @param[in]  devNum               - device number
*
* @param[out] enablePtr            - (pointer to) enable/disable removal of MC address during the aging process
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_HW_ERROR              - on hardware error

...
typedef struct{
    ...
    /** @brief Enable/Disable L2 NAT processing
     *  GT_TRUE: enable
     *  GT_FALSE: disable
     *  APPLICABLE DEVICES: Ironman.
     *  Note: In case <l2NatEnable>==GT_TRUE, <tunnelStart> and
     *  <modifyMacDa> must be set to GT_FALSE.
     */
    GT_BOOL l2NatEnable;

    /** @brief Pointer to NAT table entry.
     *  valid if case <l2NatEnable>==GT_TRUE.
     *  APPLICABLE DEVICES: Ironman.
     */
    GT_U32 natPtr;

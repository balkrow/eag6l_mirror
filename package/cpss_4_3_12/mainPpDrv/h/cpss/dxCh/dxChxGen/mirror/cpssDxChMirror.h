...
#define  CPSS_DXCH_MIRROR_ANALYZER_MAX_INDEX_MAC(_devNum)  \
         ((PRV_CPSS_SIP_7_CHECK_MAC(_devNum))? 62 : 6)
...
typedef struct{
    ...
    /** @brief Analyzer index
     *  (APPLICABLE RANGES: AC5P; AC5X; Harrier; Ironman 0..6)

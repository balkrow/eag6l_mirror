...
typedef struct{
    ...
    PRV_DXCH_TXQ_SIP6_PREEMTION_PORT_TYPE_ENT  preemptionType;
...
/**
* @struct PRV_CPSS_DXCH_TXQ_SIP_7_B_NODE
 *
 * @brief Describe list of B node connected to local port
*/
typedef struct{

    /** @brief Index of B node in TM tree
     *  bNodeIndex      - Information regarding Anodes connected to this B node.
     */
    GT_U32 bNodeIndex;

    GT_U32 aNodeListSize;

    PRV_CPSS_DXCH_TXQ_SIP_6_A_NODE **aNodePtrList;/*list of pointers to A nodes*/

    GT_U32 subServiceGroup;

} PRV_CPSS_DXCH_TXQ_SIP_7_B_NODE;

/**
* @struct PRV_CPSS_DXCH_TXQ_SIP_7_C_NODE
 *
 * @brief Describe list of B node connected to local port
*/
typedef struct{

    /** @brief Index of C node in TM tree
     *  cNodeIndex      - Information regarding B nodes connected to this C node.
     */
    GT_U32 cNodeIndex;

    GT_U32 bNodeListSize;

    PRV_CPSS_DXCH_TXQ_SIP_7_B_NODE *bNodeList;
    GT_U32 serviceGroup;

} PRV_CPSS_DXCH_TXQ_SIP_7_C_NODE;
...
typedef struct{
     ...
     */
    prvShedEligFuncQueue  eligiblePrioFuncId;
...
/**
* @struct PRV_CPSS_DXCH_TXQ_SIP_7_ADD_REMOTE_PORT_IN_PARAMS_STC
 *
 * @brief Adding port parameters
*/
typedef struct{
    ...
    GT_U32 cscdPort;
    GT_U32 hqosId[CPSS_DXCH_PORT_HQOS_EXTRA_LEVELS_MAX_CNS];

} PRV_CPSS_DXCH_TXQ_SIP_7_ADD_REMOTE_PORT_IN_PARAMS_STC;

/**
* @struct PRV_CPSS_DXCH_TXQ_SIP_7_ADD_REMOTE_PORT_OUT_PARAMS_STC
 *
 * @brief Adding port output parameters for debug
*/
typedef struct{
    ...
    GT_U32 cNodeInd;
    GT_U32 bNodeInd;
    GT_U32 newAnodeStart;
    GT_U32 newAnodeEnd;
    GT_U32 oldAnodeStart;
    GT_U32 oldAnodeEnd;

} PRV_CPSS_DXCH_TXQ_SIP_7_ADD_REMOTE_PORT_OUT_PARAMS_STC;

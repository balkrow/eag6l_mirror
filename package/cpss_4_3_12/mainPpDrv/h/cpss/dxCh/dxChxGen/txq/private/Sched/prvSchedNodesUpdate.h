...
typedef enum{
    ...
    PRV_CPSS_NODE_UPDATE_TYPE_QUANTUM_E = 0,

    PRV_CPSS_NODE_UPDATE_TYPE_ELIG_FUNC_E,

    PRV_CPSS_NODE_UPDATE_TYPE_ALL_E,

} PRV_CPSS_NODE_UPDATE_TYPE_ENT;
...
int prvCpssSchedUpdateNodeTypeB(PRV_CPSS_SCHED_HANDLE hndl, uint32_t b_node_index,
                     struct sched_b_node_params *b_params,PRV_CPSS_NODE_UPDATE_TYPE_ENT updateType);

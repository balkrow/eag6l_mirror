...
#define		PDQ_SIP_6_30_PortQuantumsPriosLo(operation, ...) \
    ...
    TM_REG_ROW_##operation( Quantum, 0, 12 , 0x10, __VA_ARGS__)\

#define		PDQ_SIP_6_30_Port_Pizza_Slice(operation, ...) \
    TM_REG_ROW_##operation( slice3_port_id, 18, 6 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( slice2_port_id, 12, 6 , 0x1, __VA_ARGS__)\
    TM_REG_ROW_##operation( slice1_port_id, 6, 6 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( slice0_port_id, 0, 6 , 0x10, __VA_ARGS__)\


#define		PDQ_SIP_6_30_PortRangeMap(operation, ...) \
    TM_REG_ROW_##operation( pdwrr_en, 16, 8 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( pfunc_ptr, 12, 4 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( chigh, 6, 6 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( clow, 0, 6 , 0x0, __VA_ARGS__)\
...
#define		PDQ_SIP_6_30_Queuemapping(operation, ...) \
    TM_REG_ROW_##operation( alvl, 6, 6 , 0x0, __VA_ARGS__)\
...
#define		PDQ_SIP_6_30_ALvltoBlvlAndQueueRangeMap(operation, ...) \
    TM_REG_ROW_##operation( Blvl, 30, 6 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( adwrr_en, 22, 8 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( afunc_ptr, 18, 4 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( qhigh, 9, 9 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( qlow, 0, 9 , 0x0, __VA_ARGS__)\
...
#define		PDQ_SIP_6_30_BLvltoClvlAndAlvlRangeMap(operation, ...) \
    TM_REG_ROW_##operation( clvl, 24, 6 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( bdwrr_en, 16, 8 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( bfunc_ptr, 12, 4 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( ahigh, 6, 6 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( alow, 0, 6 , 0x0, __VA_ARGS__)\
...
#define		PDQ_SIP_6_30_ClvltoPortAndBlvlRangeMap(operation, ...) \
    TM_REG_ROW_##operation( port, 24, 6 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( cdwrr_en, 16, 8 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( cfunc_ptr, 12, 4 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( bhigh, 6, 6 , 0x0, __VA_ARGS__)\
    TM_REG_ROW_##operation( blow, 0, 6 , 0x0, __VA_ARGS__)\

...
#define HQOS_PHASE_1_LIMITATION
#define PRV_TXQ_SIP_6_TOKEN_BUCKET_NUM 2

#define PRV_TBD_AAS

/*Debug

((PRV_CPSS_DXCH_PP_CONFIG_STC*)(cpssSharedGlobalVarsPtr->commonMod.genericHwInitDir.prvCpssPpConfig[devNum]))->port.txQDeviceConfig

*/
#define PRV_CPSS_TXQ_PER_DEVICE_DB_MAC(_devNum) PRV_CPSS_DXCH_PP_MAC(_devNum)->port.txQDeviceConfig
...
/*Minus one due to cascade port*/
#define PRV_CPSS_DXCH_FALCON_TXQ_MAX_REMOTE_PORT_MAC(_dev)  (PRV_CPSS_DXCH_PP_MAC(_dev)->hwInfo.multiDataPath.pdxNumQueueGroups-1)
...
#define  PRV_CPSS_DEFAULT_ELIG_FUNC_FOR_NODE(_TC)  CPSS_PDQ_SCHED_ELIG_N_FP##_TC##_E
#define  PRV_CPSS_DEFAULT_ELIG_FUNC_FOR_NODE_WITH_SHAPING(_TC) CPSS_PDQ_SCHED_ELIG_N_MIN_SHP_FP##_TC##_E
...
#define  PRV_CPSS_DEFAULT_ELIG_FUNC_FOR_Q_NODE(_TC)  PRV_SCHED_ELIG_Q_PRIO##_TC
...
#define PRV_CPSS_DXCH_SIP6_TXQ_MAX_NUM_OF_SUPPORTED_SPEEDS_CNS             16
#define PRV_CPSS_DXCH_SIP7_TXQ_DYNAMIC_PROFILE_SPEED_CNS             0x0



#define PRV_CPSS_DXCH_SIP6_TXQ_ALL_Q_MAC             0xFF

#define TXQ_IS_PREEMPTIVE_DEVICE(_devNum) (prvCpssSip6TxqPreemptionCapableDeviceGet(_devNum))

#define TXQ_IS_QBV_CAPABLE_DEVICE(_devNum) (prvCpssSip6TxqQbvCapableDeviceGet(_devNum))

#define TXQ_IS_DEEP_BUFFER_CAPABLE_DEVICE(_devNum) (0!=(PRV_CPSS_TXQ_PER_DEVICE_DB_MAC(_devNum).capabilitiesBmp&\
                                                     (1<< PRV_CPSS_DXCH_TXQ_SIP_7_FEATURE_DEEP_BUFFER_E)))

#define TXQ_IS_DYNAMIC_THR_CAPABLE_DEVICE(_devNum) (0!=(PRV_CPSS_TXQ_PER_DEVICE_DB_MAC(_devNum).capabilitiesBmp&\
                                                     (1<< PRV_CPSS_DXCH_TXQ_SIP_7_PDS_DYNAMIC_THRS_E)))
...
/*SIP 7 maximal PDS  per tile number*/
#define CPSS_DXCH_SIP_7_MAX_LOCAL_PDS_NUM_MAC     4

/*SIP 7 maximal SDQ  per tile number*/
#define CPSS_DXCH_SIP_7_MAX_LOCAL_SDQ_NUM_MAC     4


/*SIP 7 maximal QFC  per tile number*/
#define CPSS_DXCH_SIP_7_MAX_LOCAL_QFC_NUM_MAC     4
...
/*SIP 6 maximal  number of profiles at PDS ,needed for array size declaration .SIP6 -16 ,SIP7 - 256*/
#define CPSS_DXCH_SIP_6_MAX_PDS_PROFILE_NUM_ALL_DEVICES                      256

#define CPSS_DXCH_SIP_7_MAX_SDQ_PROFILE_NUM_ALL_DEVICES                      256
...
/*Profiles reserved for deep buffer RX/TX*/
#define PRV_PDS_SIP_7_RESERVED_TX_PROFILE_IND_CNS 0
#define PRV_PDS_SIP_7_RESERVED_RX_PROFILE_IND_CNS 1

#define PRV_PDS_SIP_7_RESERVED_TX_QUEUE_TO_EPB_IND_CNS 0
#define PRV_PDS_SIP_7_RESERVED_RX_QUEUE_TO_EPB_IND_CNS 1


#define PRV_PDS_SIP_6_PROFILE_MAX_MAC 16
#define PRV_PDS_SIP_7_PROFILE_MAX_MAC 256

#define PRV_SDQ_SIP_7_PROFILE_MAX_MAC 256


#define PDS_PROFILE_MAX_MAC(_devNum) ((PRV_CPSS_SIP_7_CHECK_MAC(_devNum)==GT_FALSE)? \
                                            PRV_PDS_SIP_6_PROFILE_MAX_MAC:\
                                            (PRV_PDS_SIP_7_PROFILE_MAX_MAC))

#define SDQ_PROFILE_MAX_MAC 256


#define PRV_CPSS_DXCH_CIDER_INFO_SIZE 5

/* Number of Time slots per table set */
#define PRV_CPSS_DXCH_STREAM_EGRESS_TIME_SLOTS_NUM_CNS        256
#define PRV_CPSS_DXCH_STREAM_EGRESS_TABLESET_NUM_CNS(_devNum)       ((PRV_CPSS_SIP_7_CHECK_MAC(_devNum))?12:29)


#define PRV_CPSS_MAX_LEVELS_NUM_CNS     SCHED_P_LEVEL+1

#define PRV_DXCH_TXQ_SCHED_TREE_MODE_GET(_devNum)  (PRV_CPSS_DXCH_PP_MAC(_devNum)->port.txQDeviceConfig.treeMode)
...
#define PRV_TXQ_SIP6_30_PIZZA_SLICE_PER_LINE 4
#define PRV_TXQ_SIP6_30_PIZZA_MAX_LINE_NUM 128
#define PRV_TXQ_SIP6_30_PIZZA_MAX_SLICE_NUM (PRV_TXQ_SIP6_30_PIZZA_SLICE_PER_LINE*PRV_TXQ_SIP6_30_PIZZA_MAX_LINE_NUM)
#define PRV_TXQ_SIP6_30_PIZZA_EMPTY_SLICE_VALUE_CNS 63
#define PRV_TXQ_SIP_7_PIZZA_EMPTY_SLICE_VALUE_CNS 127


#define PRV_TXQ_SIP6_30_PIZZA_SLICE_CHUNK_SIZE PRV_TXQ_SIP6_30_PIZZA_SLICE_PER_LINE
#define PRV_TXQ_SIP6_30_PIZZA_SLICE_WIDTH_IN_BITS 6
#define PRV_TXQ_SIP_7_PIZZA_SLICE_WIDTH_IN_BITS 7

#define PRV_TXQ_PIZZA_SLICE_WIDTH_IN_BITS(_devNum) \
    (PRV_CPSS_SIP_7_CHECK_MAC(_devNum)?\
       PRV_TXQ_SIP_7_PIZZA_SLICE_WIDTH_IN_BITS:PRV_TXQ_SIP6_30_PIZZA_SLICE_WIDTH_IN_BITS)

#define PRV_TXQ_PIZZA_EMPTY_SLICE_VALUE_CNS(_devNum) \
        (PRV_CPSS_SIP_7_CHECK_MAC(_devNum)?\
           PRV_TXQ_SIP_7_PIZZA_EMPTY_SLICE_VALUE_CNS:PRV_TXQ_SIP6_30_PIZZA_EMPTY_SLICE_VALUE_CNS)


#define PRV_TXQ_SIP6_30_PIZZA_SLICE_MIN_GAP_CNS 3

#define PRV_TXQ_PDS_GLOBAL_ID_MAC(_devNum,_tile,_dp) (_tile*(MAX_DP_IN_TILE(_devNum))+_dp)

#define PRV_TXQ_SIP_7_MAX_DPDS_PER_DEVICE_NUM_CNS 2
...
*/
  ...
  typedef enum{
     ...
     /** indication 'per device' if 802.3BR preemption supported by the device */
      PRV_CPSS_DXCH_TXQ_SIP_6_FEATURE_PREEMPTION_E,

      /** indication 'per device' if 802.1Qbv Time aware shapers   supported by the device */
      PRV_CPSS_DXCH_TXQ_SIP_6_FEATURE_QBV_E,

      /**Deep buffering feature*/
      PRV_CPSS_DXCH_TXQ_SIP_7_FEATURE_DEEP_BUFFER_E,

      /**Dynamic PDS thresholds*/
      PRV_CPSS_DXCH_TXQ_SIP_7_PDS_DYNAMIC_THRS_E,

      PRV_CPSS_DXCH_TXQ_SIP_6_FEATURE_LAST_E

  } PRV_CPSS_DXCH_TXQ_SIP_6_CAPABILITY_ENT;
...
/**
* @enum PRV_CPSS_DXCH_TXQ_SCHEDULING_TREE_MODE_ENT
 *
 * @brief Scheduling tree mode.
*/
typedef enum{
    /** @brief Only two scheduling levels are used out of five.
     */
    PRV_CPSS_DXCH_TXQ_SCHEDULING_TREE_MODE_REDUCED_E,
    /** @brief  All  scheduling levels are used .
     */
    PRV_CPSS_DXCH_TXQ_SCHEDULING_TREE_MODE_FULL_E
} PRV_CPSS_DXCH_TXQ_SCHEDULING_TREE_MODE_ENT;
...
/**
* @enum PRV_CPSS_DXCH_SIP7_TXQ_EPB_TYPE_ENT
 *
 * @brief Indicates spillover profile type.
*/
typedef enum{
    /** @brief Spillover is dissbled
     */
    PRV_CPSS_DXCH_SIP7_TXQ_EPB_TYPE_DISABLE,
    /** @brief Spillover is enabled (mailbox priority is low)
     */
    PRV_CPSS_DXCH_SIP7_TXQ_EPB_TYPE_ENABLE_LP_E,

     /** @brief Spillover is enabled (mailbox priority is high)
      */

    PRV_CPSS_DXCH_SIP7_TXQ_EPB_TYPE_ENABLE_HP_E

} PRV_CPSS_DXCH_SIP7_TXQ_EPB_TYPE_ENT;
...
typedef struct
{
   ...
   */
   ...
   /** @brief Spillover to external PB type (relevant for SIP7 devices).
   */

     PRV_CPSS_DXCH_SIP7_TXQ_EPB_TYPE_ENT    spillOver;

} PRV_CPSS_DXCH_SIP6_TXQ_PDS_QUEUE_PROFILE_STC;

/**
* @struct PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_ENT
*
* @brief SDQ profile attribute
*/

typedef enum{

  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_FIRST_E,

   /** Profile_Q_Aging_Credit_Threshold*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_TH_AGING_E=PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_FIRST_E,

  /** Profile_Q_High_Credit_Threshold*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_TH_HIGH_E,

  /** Profile_Q_Low_Credit_Threshold*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_TH_LOW_E,

  /** Profile_Q_Neg_Credit_Threshold*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_TH_NEG_E,

  /**Profile_Queue_TC*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_TC_E,

  /**Profile_Q_Semi_Elig_Threshold*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_SEMI_ELIG_E,

  /** Profile_QCN_Div_Factor*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_QCN_DIV_FACTOR_E,

  /** Profile_Queue_Prio*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_PRIO_E,

  /** Profile_queue_gate*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_QBV_GATE_E,

  /** Profile_Queue_AVB_en*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_AVB_EN_E,



  /**must be last*/
  PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_LAST_E

} PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_ENT;



typedef struct
{
    GT_U32                                                   data[PRV_CPSS_DXCH_TXQ_SIP_7_SDQ_PROFILE_ATTRIBUTE_LAST_E];

    GT_U32                                                   numberOfBindedQueues;

} PRV_CPSS_DXCH_SIP7_TXQ_SDQ_QUEUE_PROFILE_STC;


/**
* @enum PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_TYPE_ENT
 *
 * @brief Indicates spillover profile type.
*/
typedef enum{
    /** @brief Indicates if this profile is designated to NPDS queue
     */
    PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_TYPE_NPDS_E,
    /** @brief Indicates if this profile is designated to the special RxQueue.
        (Queue containing all traffic returning from EPB on DRAM Datapath).
     */
    PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_TYPE_DPDS_RX_E,

     /** @brief Indicates if this profile is designated to the special TxQueue.
    (Queue containing all traffic going to EPB on DRAM Datapath).
     */
    PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_TYPE_DPDS_TX_E

} PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_TYPE_ENT;


/**
* @struct PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_STC
 *
 * @brief The profile parameters regarding external packet buffer (EPB) spillover profile.
...
{
    /** @brief
    *   Indicates spillover profile type.
    */
    PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_TYPE_ENT type;

    /** @brief
    *   Selects if the queues mapped to this profile will perform spillover to PB or EPB.
        Note [1]  : for EPB spillover the Long Queue Enable should also be set.
        Note [2]  :This variable only relevant in case type equals PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_TYPE_NPDS_E .

    */
     GT_BOOL    epbSpilloverEnable;

     /** @brief
    *   Holds the mailbox ID that will be used by all the queues mapped to this profile.
        The Profile holds a mailbox ID per DRAM in the system
        Selection between DRAM's is done by dynamic DRAM load balancing
        Note  :This variable only relevant in case type equals PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_TYPE_NPDS_E .

    */

     GT_U32     mailBoxId[PRV_TXQ_SIP_7_MAX_DPDS_PER_DEVICE_NUM_CNS];

} PRV_CPSS_DXCH_SIP7_TXQ_EPB_QUEUE_PROFILE_STC;


typedef struct
{
    /** @brief
    *   Enables dynamic thresholds for copyback decision.
    */
    GT_BOOL copybackEnable;

    /** @brief
    *   Enables dynamic thresholds for spillover decision.

    */
     GT_BOOL    spilloverEnable ;

     /** @brief
    *   Enables dynamic thresholds for open decision

    */

     GT_BOOL     openLongEnable;

}
PRV_CPSS_DXCH_SIP7_TXQ_PDS_DYN_THR_ENABLE_STC;
...
typedef struct{
    ...
    /*SIP 7 data*/
    PRV_CPSS_DXCH_TXQ_SIP_7_C_NODE *cNodeList;
    GT_U32                          cNodeListSize;
...
typedef struct{
    ...
    GT_U32                                       numOfQPerDp[MAX_DP_PER_TILE_CNS];
    ...
    PRV_CPSS_TXQ_RESOURCE_RANGE_STC       *pdqResources[PRV_CPSS_MAX_LEVELS_NUM_CNS];

    PRV_CPSS_TXQ_RESOURCE_RANGE_STC       *sdqResources[MAX_DP_PER_TILE_CNS];
...
typedef struct{
    ...
    GT_BOOL schedLogParseInRequests;
    GT_BOOL schedLogParseOutRequests;
...
/**
* @enum PRV_CPSS_DXCH_TXQ_SDQ_TO_PDQ_MAPPING_RESOLUTION_ENT
 *
 * @brief SDQ to PDQ mapping resolution
*/
typedef enum{
    /** @brief SDQ port is mapped to PDQ range start. (SIP6 mode)
     */
    PRV_CPSS_DXCH_TXQ_SDQ_TO_PDQ_MAPPING_RESOLUTION_PORT_E,
    /** @brief  SDQ queue  is mapped to PDQ queue . (SIP7mode)
     */
    PRV_CPSS_DXCH_TXQ_SDQ_TO_PDQ_MAPPING_RESOLUTION_QUEUE_E
} PRV_CPSS_DXCH_TXQ_SDQ_TO_PDQ_MAPPING_RESOLUTION_ENT;

/**
* @struct PRV_CPSS_DXCH_TXQ_DEVICE_CONFIGURATION
 *
 * @brief General configuration of txq parameters per device
*/
typedef struct{
    /** GT_TRUE if tx library  is  initialized ,GT_FALSE otherwise*/
    GT_BOOL                                         txLibInitDone;
    PRV_CPSS_DXCH_TXQ_SCHEDULING_TREE_MODE_ENT      treeMode;
    CPSS_PORT_TX_POOL_MODE_ENT                      poolMode;
    GT_BOOL                                         logEnable;
    GT_BOOL                                         logShapingResults;
        /*
            Pool 1 TD limit.
            Related to PRV_CPSS_DXCH_FALCON_FOUR_TXQ_POOLS_SUPPORT_E.
        */
    GT_U32                                pool1Th;
      /*
            Global TC PFC limit.
    ...
    PRV_CPSS_DXCH_TXQ_SIP_6_SCHED_DBG_STC schedDbg;
      ...
      /** @brief Running index of group of queues.Required for mapping in case of
         GOQ_ALLOCATION_ALG != PRV_CPSS_DXCH_GOQ_ALLOCATION_ALG_TYPE_EQUAL_PHYSICAL_PORT_E.
    *   (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman)
    */

    GT_U32                                qroupOfQIterator;
    ...
    /** @brief Global index of queues .Needed for smart binding CNC counter to queue.
      ...
      */
      ...
      CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC shaperAlgCfg[PRV_TXQ_SIP_6_TOKEN_BUCKET_NUM];

         /** @brief If equal GT_TRUE then even if calculated shaper rate is above accuracy error,
              GT_OK is returned instead of GT_SHAPER_GRANULARITY_OUT_OF_RANGE.
              Shaper will return the closest result possible to requested.
              Accepteble accuracy is ignored.
              Otherwise  GT_SHAPER_GRANULARITY_OUT_OF_RANGE will be rturned in such case.
      *       (APPLICABLE DEVICES: Falcon; AC5P; AC5X; Harrier; Ironman)
      */
      GT_BOOL   permissiveShaperMode;

      PRV_CPSS_TXQ_RESOURCE_RANGE_STC * cncResources;

         /** @brief If equal GT_TRUE then PDS long queue profile parameters and
                    length adjust profile parameters are part of the same profile,
                    GT_FALSE otherwise
              *
              */
      GT_BOOL                           pdsProfilesCombined;

     /** @brief If equal GT_TRUE then PDS long queue profile  are supported by device,
                GT_FALSE otherwise
              *
              */

      GT_BOOL                           pdsLongQueueProfilesSupported;

      GT_U32                            capabilitiesBmp;

     /** @brief Describes the method used to comnect SDQ to PDQ.
     */

      PRV_CPSS_DXCH_TXQ_SDQ_TO_PDQ_MAPPING_RESOLUTION_ENT sdqToPdqMappingResolutioin;

      GT_U32 preemptionEnableShadow[PORTS_BMP_NUM_CNS];

         /** @brief Shadow of txq sdq profies.
        *   (APPLICABLE DEVICES: AAS)
        */
      PRV_CPSS_DXCH_SIP7_TXQ_SDQ_QUEUE_PROFILE_STC sdqProfiles[CPSS_DXCH_SIP_7_MAX_SDQ_PROFILE_NUM_ALL_DEVICES];

} PRV_CPSS_DXCH_TXQ_DEVICE_CONFIGURATION;
...
} PRV_CPSS_TXQ_NPDS2DPDS_CONNECTION_STC;
...
/**
* @internal prvCpssFalconTxqPffcTableExplicitSet function
* @endinternal
*
...
*
* @param[in] devNum                   - physical device number
* @param[in] mode                     -operation mode of egress pools
*
*
* @retval GT_OK                    - on success
...
(
    IN GT_U8     devNum,
    IN CPSS_PORT_TX_POOL_MODE_ENT *poolModePtr
);
...
*
* @param[in] devNum                - physical device number
* @param[in] paramsPtr           -(pointer to *)add parameters
* @param[out] paramsPtr           -(pointer to *)new PDQ base of added port
*
*
* @retval GT_OK                    - on success
* @retval GT_NOT_SUPPORTED         - in case errata is not enabled for this device

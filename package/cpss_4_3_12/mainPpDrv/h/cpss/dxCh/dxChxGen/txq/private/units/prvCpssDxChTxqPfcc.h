...
#define PRV_CPSS_DXCH_SIP_7_PFCC_CFG_TABLE_SIZE       210

#define PRV_SIP_6_EGF_QAG_TC_DP_MAPPER_SIZE _4K
#define PRV_SIP_7_EGF_QAG_TC_DP_MAPPER_SIZE _1K


#define PRV_CPSS_DXCH_FALCON_TXQ_PFCC_MASTER_TILE_MAC 0

#define PFCC_SIP_6_30_TABLE_SIZE_GET_MAC(_dev) (PRV_CPSS_SIP_7_CHECK_MAC(_dev)?\
   PRV_CPSS_DXCH_SIP_7_PFCC_CFG_TABLE_SIZE:PRV_CPSS_DXCH_SIP_6_30_PFCC_CFG_TABLE_SIZE )

#define PFCC_SIP_6_20_TABLE_SIZE_GET_MAC(_dev) (PRV_CPSS_SIP_6_30_CHECK_MAC(_dev)?\
   PFCC_SIP_6_30_TABLE_SIZE_GET_MAC(_dev):PRV_CPSS_DXCH_SIP_6_20_PFCC_CFG_TABLE_SIZE)

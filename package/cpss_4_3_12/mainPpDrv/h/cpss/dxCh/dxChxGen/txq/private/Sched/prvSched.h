...
typedef struct{
    ...
    uint8_t   resolution;
    double    out_accuracy;
    uint32_t  effectiveBurst;
    GT_U32    token_resolution_multiplyer;
} PRV_DXCH_TXQ_SIP_6_SHAPER_OUTPUT_STC;


typedef struct{
    PRV_CPSS_SCHED_HANDLE           hndl;
    double                          bw_in_tokens;
    GT_U32                          burst_size_bytes;
    GT_U32                          token_resolution_multiplyer;
    uint8_t                         divider_res_exp;
    GT_U32                          tbNum;
} PRV_DXCH_TXQ_SIP_6_SHAPER_INPUT_STC;

...
/* TX_IS_IDLE
*/
#define      PRV_PFC_MTI_X_COMMAND_TX_IS_IDLE_STATUS_FIELD_OFFSET         8

#define      PRV_PFC_MTI_X_COMMAND_TX_IS_IDLE_STATUS_FIELD_SIZE           1
...
#define      PRV_PFC_MTI_X_COMMAND_TX_PREEMPT_EN_FIELD_OFFSET         0

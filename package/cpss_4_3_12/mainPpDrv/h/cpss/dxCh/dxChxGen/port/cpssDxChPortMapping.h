...
typedef enum{
    ...
    /** Internal Loopback - like TYPE_ETHERNET but with No MAC */
...
#define CPSS_DXCH_PORT_HQOS_EXTRA_LEVELS_MAX_CNS      2
...
typedef struct{
 ...
 /** @brief Hierarchical Quality of Service (HQoS)
     *  Local hierarchical  id used for multi-level queue-based scheduling mechanism.
     *  (APPLICABLE DEVICES: Seahawk)

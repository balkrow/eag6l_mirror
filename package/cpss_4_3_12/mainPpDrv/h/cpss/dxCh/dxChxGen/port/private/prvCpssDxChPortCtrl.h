...
* @param[in] operationsData           - port operations data
...
/**
* @internal prvCpssDxChRsFecStatusGet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssDxChRsFecStatusGet
(
    IN GT_U8    devNum,
    IN GT_U32   portNum,
...
/**
* @internal prvCpssDxChPortOamUpMepWaAttachTailDropProfileToPort function
* @endinternal
*
* @brief   This function is called in the event of a LINK-DOWN event. It will then attach the reserved tail-drop profile
*          to the OAM UP-MEP egress port to drop all the packets that were passing the EGF by the preq engine. 
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
* @param[in] devNum                - physical device number
* @param[in] portNum               - physical port number that represent the OAM UP-MEP egress port
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong port number or device
* @retval GT_HW_ERROR              - on hardware error
...
*
*/
GT_STATUS prvCpssDxChPortOamUpMepWaAttachTailDropProfileToPort
(
    IN  GT_U8  devNum,
    IN  GT_PHYSICAL_PORT_NUM  portNum
);
...
/**
* @internal prvCpssDxChPortOamUpMepWaDetachTailDropProfileFromPort function
* @endinternal
*
* @brief   This function is called in the event of a LINK-UP event. It will then detach the reserved tail-drop profile
*          from the OAM UP-MEP egress port and restore the previous tail-drop profile from the db.
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
...
*
*/
GT_STATUS prvCpssDxChPortOamUpMepWaDetachTailDropProfileFromPort
(
    IN  GT_U8  devNum,
    IN  GT_PHYSICAL_PORT_NUM  portNum
);
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS prvCpssDxChPortLinkStatusGet
(
    IN  GT_U8     devNum,
    IN  GT_PHYSICAL_PORT_NUM     portNum,
    OUT GT_BOOL   *isLinkUpPtr

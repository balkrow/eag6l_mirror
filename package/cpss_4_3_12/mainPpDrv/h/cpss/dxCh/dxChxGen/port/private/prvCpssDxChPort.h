...
/* XLG entry size when using conversion from MTI */
#define PRV_CPSS_XLG_MIB_COUNTERS_ENTRY_SIZE_VER_2_CNS (37*2)

/* The size of XLG ports MAC MIB counters entry in words */
#define PRV_CPSS_XLG_MIB_COUNTERS_ENTRY_SIZE_CNS PRV_CPSS_XLG_MIB_COUNTERS_ENTRY_SIZE_VER_2_CNS

/* MTI SIP6 MIB counters: 43(RX) + 34(TX) */
/* common for SIP6 and SIP7 - taken in to account that SIP7 has less counters then SIP6 */
#define PRV_CPSS_MTI_MIB_COUNTERS_ENTRY_SIZE_CNS    (PRV_CPSS_MTI_RX_LAST_E+PRV_CPSS_MTI_TX_LAST_E)

/* get the actual counters entry in words , for the device */
#define PRV_CPSS_XLG_MIB_COUNTERS_ENTRY_SIZE_GET(devNum)    \
    ( PRV_CPSS_SIP_6_CHECK_MAC(devNum) ? PRV_CPSS_XLG_MIB_COUNTERS_ENTRY_SIZE_VER_2_CNS : \
...
#define PRV_CPSS_DXCH_SIP_5_PORT_TX_DROP_PROFILE_MAX_MAC(_devNum)                     \
      ((!PRV_CPSS_SIP_7_CHECK_MAC(_devNum)) ? CPSS_PORT_TX_DROP_PROFILE_16_E : CPSS_PORT_TX_DROP_PROFILE_32_E)


#define PRV_CPSS_DXCH_PORT_TX_DROP_PROFILE_MAX_MAC(_devNum)                     \
   ((!PRV_CPSS_SIP_5_CHECK_MAC(_devNum)) ? CPSS_PORT_TX_DROP_PROFILE_8_E : PRV_CPSS_DXCH_SIP_5_PORT_TX_DROP_PROFILE_MAX_MAC(_devNum))
...
#define PRV_CPSS_DXCH_SIP_7_PORT_QUEUE_TX_DROP_PROFILE_MAX_MAC 1024


/* check the Drop Profile set range */
#define PRV_CPSS_DXCH_SIP_7_QUEUE_DROP_PROFILE_CHECK_MAC(profileSet) \
        if (profileSet >=PRV_CPSS_DXCH_SIP_7_PORT_QUEUE_TX_DROP_PROFILE_MAX_MAC) \
             CPSS_LOG_ERROR_AND_RETURN_MAC(GT_BAD_PARAM, "Profile value %d is out of range .Max value is %d",PRV_CPSS_DXCH_SIP_7_PORT_QUEUE_TX_DROP_PROFILE_MAX_MAC)

...
#define CPSS_DXCH_PORT_MAX_LANE_PER_PORT_CNS 8
...
typedef enum{
    ...
    /** Disable Flow control - SIP6 only*/
    CPSS_DXCH_PORT_FC_MODE_DISABLE_E,

    /** Flow control disabled only statistics regarding ingress buffers is gathered,no FC frame generation is triggered*/
    CPSS_DXCH_PORT_FC_MODE_INGRESS_BUFFER_STATISTICS_E
...
typedef struct {
    ...
    /** @brief Symbol error Rate on each lanes*/
    GT_FLOAT64 ser[CPSS_DXCH_PORT_MAX_LANE_PER_PORT_CNS];
    /** @brief Symbol error Rate */
    GT_FLOAT64 totalSer;
    /** @brief Symbol error Rate time interval*/
    GT_FLOAT64 serTimeInterval;
} CPSS_DXCH_RSFEC_STATUS_STC;


/**
* @struct CPSS_DXCH_FCFEC_STATUS_STC
 *
 * @brief FC Fec Status Params.
*/
typedef struct {

    /** @brief FC fec lock status */
    GT_BOOL fcLocked;

} CPSS_DXCH_FCFEC_STATUS_STC;
 ...
 * the <TX Config Reg> data for Auto-Negotiation.
*/
typedef struct{
...
/**
* @enum CPSS_DXCH_PORT_PCS_RESET_MODE_ENT
 *
...
typedef enum{
    ...
    /** 88E1781 PHY (Used for Ironman integrated PHY) */
    CPSS_DXCH_PHY_MAC_TYPE_88E1781_E,
...
*       2.For SIP6 devices equivalent to this API  are
*        (Tx  mode -cpssDxChPortFlowControlModeSet,
*            Tx  threshold -cpssDxChPortPfcPortThresholdSet,
*          Rx -cpssDxChPortPfcResponceEnableSet.
*         )
*
...
*       First callback can set doPpMacConfig TRUE or FALSE. If the return value
*       is TRUE the switch MAC will be configured.
*       2.For SIP6 devices equivalent to this APIs  are
*        (Tx  mode -cpssDxChPortFlowControlModeGet,
*            Tx  threshold -cpssDxChPortPfcPortThresholdGet,
*          Rx -cpssDxChPortPfcResponceEnableGet.
*         )
*
*/
...
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
* @note   NOT APPLICABLE DEVICES:  Falcon; AC5P; AC5X; Harrier; Ironman; ASS.
*
* @param[in] devNum                   - physical device number
* @param[in] portNum                  - physical port number
...
*                                      (APPLICABLE RANGES: 0..511) (APPLICABLE DEVICES xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2)
...
*                                       other setting are
*                                       discarded
*                                      (APPLICABLE RANGES: 1-8,12,20,28,36,44,52,60) (APPLICABLE DEVICES Falcon; AC5P; AC5X; Harrier; Ironman)
*                                       for short preamble (When set, the IPG is limited to 8 bytes) - HW value '1'
*                                       for regular preamble - available options 12+8*n (12,20,28...)
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_HW_ERROR              - on hardware error
...
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier.
...
*       is TRUE the switch MAC will be configured
*
*       2. For the following devices Falcon, AC5P, AC5X, Harrier for 200G/400G port modes the feature is always enabled.
*/
...
/**
 * @internal prvCpssDxChPortPcsResetSetWrapper function
 * @endinternal
 *
 ...
 * @return GT_STATUS
 */
GT_STATUS prvCpssDxChPortPcsResetSetWrapper
(
    IN  GT_SW_DEV_NUM                  devNum,
    IN  GT_PHYSICAL_PORT_NUM           portNum,
...
* @param[in] optionsArrayLen           length of options array
*       (must be 0 if == NULL)
*
...
/**
* @internal cpssDxChPortSerdesEomGet function
* @endinternal
*
...
* @param[in] devNum                   - device number
* @param[in] portNum                  - port number (not-CPU)
* @param[out] enablePtr               - Pointer to the result
*       argument
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on hardware error
...
*
* @note   APPLICABLE DEVICES:       AC3X; Aldrin; Bobcat3; Aldrin2; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:   xCat3; AC5; Lion2; Bobcat2; Caelum; Falcon.
*
* @param[in] devNum                   - system device number
* @param[in] portNum                  - port number
*
...
/**
* @internal cpssDxChFcFecStatusGet function
* @endinternal
*
* @brief   FC FEC status collector.
*
...
* @param[in] portNum                  - physical port number
*
* @param[out] fcFecStatusPtr          - FC FEC status
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - wrong devNum or port
* @retval GT_BAD_PTR               - one of the parameters is NULL pointer
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChFcFecStatusGet
(
    IN  GT_U8                           devNum,
    IN  GT_PHYSICAL_PORT_NUM            portNum,
    OUT CPSS_DXCH_FCFEC_STATUS_STC      *fcFecStatusPtr
);
...
/**
* @internal prvCpssDxChPortPtpParamsSetWrapper function
* @endinternal
*
* @brief   Set PTP parametrs for specific physical port.
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
...
*
*/
GT_STATUS prvCpssDxChPortPtpParamsSetWrapper
(
    IN  GT_SW_DEV_NUM                        devNum,
    IN  GT_PHYSICAL_PORT_NUM                 portNum
);
...
* @param[in] devNum                - physical device number
* @param[in] portNum               - physical port number, CPU port number
* @param[inout] maxLanesNum        - pointer to maximal lanes number
* @param[out] anpInfoArr           - anp structure array
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong port number or device
* @retval GT_HW_ERROR              - on hardware error
...
(
    IN                          GT_SW_DEV_NUM        devNum,
    IN                          GT_PHYSICAL_PORT_NUM portNum,
    INOUT  GT_U8                *maxLanesNum,
    OUT CPSS_ANP_INFO_STC       anpInfoArr[] /*arrSizeVarName=maxLanesNum*/
);
...
/**
* @internal cpssDxChPortAnpCall function
* @endinternal
*
* @brief   ANP functions executer.
*
* @note   APPLICABLE DEVICES:  AC5P, AC5X; Harrier; Ironman
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2;
*         Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P;
...
* @param[in] devNum                   - physical device number
* @param[in] portNum                  - physical port number, CPU port number
* @param[in] anpFunc                  - anp function id
* @param[in] anpParamPtr               - anp function parameters
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong port number or device
* @retval GT_HW_ERROR              - on hardware error
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortAnpCall
(
    IN  GT_U8                           devNum,
    IN  GT_PHYSICAL_PORT_NUM            portNum,
    IN  CPSS_PM_PORT_ANP_FUNC_ENT       anpFunc,
    IN  CPSS_PM_PORT_ANP_PARAM_STC      *anpParamPtr
);

/**
* @internal cpssDxChPortArrayLinkStatusGet function
* @endinternal
*
* @brief   Gets Link Status of given port array on specified device.
*
* @note   APPLICABLE DEVICES:      xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:  None.
*
* @param[in] devNum                   - physical device number
* @param[in] portsBmpPtr              - (pointer to) port bitmap
*
* @param[out] portsLinkUpBmpPtr       - (pointer to) port link up bitmap
*                                           '1' for link up, '0' otherwise
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - on wrong port number or device
* @retval GT_BAD_PTR               - one of the parameters is NULL pointer
...
*
*/
GT_STATUS cpssDxChPortArrayLinkStatusGet
(
    IN  GT_U8                   devNum,
    IN  CPSS_PORTS_BMP_STC      *portsBmpPtr,
    OUT CPSS_PORTS_BMP_STC      *portsLinkUpBmpPtr
);
...
/**
* @internal cpssDxChPortFlowControPauseQuantaSet function
* @endinternal
*
...
* @param[in] portNum          -physical port number
* @param[in] tc               -Traffic class(APPLICABLE DEVICES:Falcon; AC5P; AC5X; Harrier)
* @param[in] pauseQuanta      -Pause quanta in 512 bit-time
* @retval GT_OK               - on success
* @retval GT_BAD_PTR          - on NULL ptr
* @retval GT_HW_ERROR         - if write failed
*/
GT_STATUS cpssDxChPortFlowControPauseQuantaSet
(
    IN  GT_U8                               devNum,
    IN  GT_PHYSICAL_PORT_NUM                portNum,
    IN  GT_U32                              tc,
...
/**
* @internal cpssDxChPortFlowControPauseQuantaGet function
* @endinternal
*
...
* @param[in] portNum          -physical port number
* @param[in] tc               -Traffic class(APPLICABLE DEVICES:Falcon; AC5P; AC5X; Harrier)
* @param[out] pauseQuantaPtr   -(poinetr to)Pause quanta in 512 bit-time
* @retval GT_OK               - on success
* @retval GT_BAD_PTR          - on NULL ptr
* @retval GT_HW_ERROR         - if write failed
*/
GT_STATUS cpssDxChPortFlowControPauseQuantaGet
(
    IN  GT_U8                               devNum,
    IN  GT_PHYSICAL_PORT_NUM                portNum,
    IN  GT_U32                              tc,
    OUT GT_U32                              *pauseQuantaPtr
);

/**
* @internal cpssDxChPortRejectPacketConfigSet function
* @endinternal
*
* @brief   Set packet configurations for the rejected packets due to
*          GOP (bad CRC, MRU, MACSEC error) or
*          incorrect Rx configuration in MIF and MAC (channel-disable,
*          graceful-disable, clock-disable)
*
...
*
* @param[in] devNum                   - device number
* @param[in] command                  - packet command assigned to the packet in case it is rejected
*                                       APPLICABLE VALUES: CPSS_PACKET_CMD_FORWARD_E;
*                                                          CPSS_PACKET_CMD_TRAP_TO_CPU_E;
*                                                          CPSS_PACKET_CMD_DROP_HARD_E.
* @param[in] cpuCode                  - CPU code assigned to the packet if packet command is TRAP or HARD
*
* @retval GT_OK                    - on success
...
*
*/
GT_STATUS cpssDxChPortRejectPacketConfigSet
(
    IN  GT_U8                               devNum,
    IN  CPSS_PACKET_CMD_ENT                 command,
    IN  CPSS_NET_RX_CPU_CODE_ENT            cpuCode
...
/**
* @internal cpssDxChPortRejectPacketConfigGet function
* @endinternal
*
* @brief   Get packet configurations for the rejected packets due to
*          GOP (bad CRC, MRU, MACSEC error) or
*          incorrect Rx configuration in MIF and MAC (channel-disable,
*          graceful-disable, clock-disable)
*
...
*
* @param[in] devNum                   - device number
* @param[out] commandPtr              - (pointer to) packet command assigned to the packet in case it is rejected
* @param[out] cpuCodePtr              - (pointer to) CPU code assigned to the rejected packet if packet command is TRAP or HARD
*
* @retval GT_OK                    - on success
* @retval GT_BAD_PARAM             - one of the input parameters is not valid
* @retval GT_HW_ERROR              - on hardware error
...
*
*/
GT_STATUS cpssDxChPortRejectPacketConfigGet
(
    IN   GT_U8                               devNum,
    OUT  CPSS_PACKET_CMD_ENT                 *commandPtr,
    OUT  CPSS_NET_RX_CPU_CODE_ENT            *cpuCodePtr

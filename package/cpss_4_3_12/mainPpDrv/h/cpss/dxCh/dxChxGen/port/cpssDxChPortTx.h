...
/**
 * @enum CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_ENT
 *
 * @brief Indicates the current status of the verification according to clause
30.14.1.2 of the 802.3br specification
 */
typedef enum {

  /* unknown (during reset)*/
  CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_UNKNOWN_E,

  /* initial (when preemption is disabled) */
  CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_INIT_E,

  /* verifying*/
  CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_VERIFYING_E,

    /* succeeded*/
  CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_OK_E,

  /*failed*/
  CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_FAILED_E,

  /*disabled (if preempt verification is disabled) */
  CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_DISABLED_E,

} CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_ENT;


/**
 * @struct CPSS_DXCH_PORT_PREEMPTION_STATUS_STC
 *
 * @brief Preemption status for the selected port
*
 * (APPLICABLE DEVICES: AC5P;Harrier; Ironman)
 */
    typedef struct
    {
        /*MAC BR preemption enable status*/
        GT_BOOL   enabled;
        CPSS_DXCH_MAC_PREEMPTION_TX_VERIFY_STATUS_ENT     txVerify;
        /*Seen RX assembly error. Cleared on read*/
        GT_BOOL asmErrDetected;
        /*Seen invalid SMD. Cleared on read.*/
        GT_BOOL smdErrDetected;
        /*Seen good or bad VERIFY frame. Cleared on read*/
        GT_BOOL verifyFrameRx;
        /* Seen good or bad RESPONSE frame. Cleared on read.*/
        GT_BOOL responceFrameRx;

    } CPSS_DXCH_PORT_PREEMPTION_STATUS_STC;

/**
 * @enum CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT
 *
 * @brief Action to be taken after guaranteed bandwidth is reached.
 */
    typedef enum{

    /**@brief After guaranteed  BW threshold is reached queue will receive priority 0*/
        CPSS_DXCH_PORT_TX_GUARANTEED_BANDWITH_REACHED_ACTION_SET_PRIORITY_TO_ZERO_E,

     /**@brief After guaranteed  BW threshold is reached queue will receive priority that was configured before guaranteed  BW threshold was applied.
                  Note : Not applicable for Ironman*/
        CPSS_DXCH_PORT_TX_GUARANTEED_BANDWITH_REACHED_ACTION_SET_PRIORITY_TO_ORIGINAL_E

    } CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT;


/**
* @enum CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_ENT
 *
 * @brief The converted rate rounding type
*/
typedef enum{
    /** @brief The converted rate will be calculated as a result of an upward, or downward rounding.
     */
    CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_BOTH_E,
    /** @brief  The converted rate will be calculated as a result of  downward rounding only.
     */
    CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_NEG_E,
   /** @brief  The converted rate will be calculated as a result of  upward rounding only.
     */
    CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_POS_E,
    CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_LAST_E=CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_POS_E
} CPSS_DXCH_TXQ_SHAPER_ROUND_MODE_ENT;




/**
* @enum CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC
 *
 * @brief Shaper algorithm relevant parameters.
 *  Same configuration both for CIR and EIR
*/
...
typedef struct{
    ...
    /** @brief The converted rate rounding type
     ...
     /** @brief Absolute value of permitted  error range in percent [0 -9]
       */
      GT_U32    errorPercent;
   /** @brief Whether or not to perform burst size adoptation trading accuracy.
       */
      GT_BOOL   burstOptimization;

} CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC;


/**
* @enum CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT
*
* @brief
*     The type of information rate (commited or excess )
*/
typedef enum{
    CPSS_DXCH_TXQ_SHAPER_TYPE_CIR_E,
    CPSS_DXCH_TXQ_SHAPER_TYPE_EIR_E,
    CPSS_DXCH_TXQ_SHAPER_TYPE_LAST_E
} CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT;

/**
* @enum CPSS_DXCH_TXQ_SHAPER_LEVEL_ENT
*
* @brief
*     The level on which shaper is performed
*/

typedef enum{
    CPSS_DXCH_TXQ_SHAPER_LEVEL_QUEUE_E,
    CPSS_DXCH_TXQ_SHAPER_LEVEL_PHYS_PORT_E,
    CPSS_DXCH_TXQ_SHAPER_LEVEL_CSCD_PORT_E
} CPSS_DXCH_TXQ_SHAPER_LEVEL_ENT;

/**
* @enum CPSS_DXCH_TXQ_SHAPER_OUTPUT_STC
*
* @brief
*     Information regarding the effective shaper values
*/
typedef struct{
  ...
  /** @brief Actual rate
       */
    GT_U32                          outRate;
    /** @brief Integer part of inaccuracy
       */
    GT_U32                          inAccuracyPercent;
/** @brief Floating part of inaccuracy (3 digits)
       */
    GT_U32                          inAccuracyFracPercent;
    /** @brief if equal GT_TRUE then rounding down was performed ,GT_FALSE otherwise
           */

    GT_BOOL                         roundDown;

    /** @brief burst size given per cycle,token bucket size must be bigger then this value
           */
    GT_U32                          effectiveBurst;

    /** @brief Frequency divider exponent used .Frequency can be divided by 2^dividerExp
           */
    GT_U32                          dividerExp;
    /** @brief Burst  given per cycle = token * tokenResolution.
           */
    GT_U32                          tokenResolution;
        /** @brief Burst  given per cycle = token * tokenResolution.
           */
    GT_U32                          token;
} CPSS_DXCH_TXQ_SHAPER_OUTPUT_STC;
...
* @param[in]  pool2AvailableBuffers    - Pool 2 amount of available buffers for dynamic buffers allocation
*                                        (APPLICABLE DEVICES:      AAS)
* @param[in]  pool3AvailableBuffers    - Pool 3 amount of available buffers for dynamic buffers allocation
*                                       (APPLICABLE DEVICES:      AAS)
...
(
    ...
    IN    GT_U32                                    pool2AvailableBuffers,
    IN    GT_U32                                    pool3AvailableBuffers
);
 ...
 *                                          for dynamic buffers allocation
 * @param[out]  pool2AvailableBuffers     - (pointer to) Pool 2 amount of available buffers
 *                                          for dynamic buffers allocation
 *                                          (APPLICABLE DEVICES:      AAS)
 * @param[out]  pool3AvailableBuffers     - (pointer to) Pool 3 amount of available buffers
 *                                          for dynamic buffers allocation
 *                                          (APPLICABLE DEVICES:      AAS)
 *
 * @retval GT_OK                       - on success
...
(
    ...
    OUT   GT_U32                                 *pool2AvailableBuffersPtr,
    OUT   GT_U32                                 *pool3AvailableBuffersPtr
);
/**
...
* @param[in] action                        -Action to be taken after guaranteed bandwidth is reached.(Note : action
*                                                            CPSS_DXCH_PORT_TX_GUARANTEED_BANDWITH_REACHED_ACTION_SET_PRIORITY_TO_ORIGINAL_E
*                                                            is not applicable for Ironman)
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_BAD_PARAM             - on wrong port number or device
...
(
    ...
    IN  GT_U8                               tcQueue,
    IN  GT_BOOL                             enable,
    IN  CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT action
);
/**
...
*                                                           GT_FALSE,  commited rate  on this traffic queue
* @param[out] actionPtr                  -(pointer to)Action to be taken after guaranteed bandwidth is reached.
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_BAD_PARAM             - on wrong port number or device
...
(
    ...
    IN   GT_U8                tcQueue,
    OUT  GT_BOOL             *enablePtr,
    OUT  CPSS_DXCH_MIN_BW_REACHED_ACTION_ENT *actionPtr
);
...
* @note   NOT APPLICABLE DEVICES: xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X;AAS.
*
* @param[in] devNum                   - physical device number
...
/**
* @internal cpssDxChPortTxPreemptionStatusGet  function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxPreemptionStatusGet
(
    IN  GT_U8                                   devNum,
    IN  GT_PHYSICAL_PORT_NUM                    portNum,
...
/**
* @internal cpssDxChPortTxQShapingCreditAccumulationEnableSet function
* @endinternal
*
* @brief       Enable/Disable credit accumulation. Required for 802.1.Q 8.6.8.2 (previously 802.1Qav)
...
GT_STATUS cpssDxChPortTxQShapingCreditAccumulationEnableSet
(
    IN GT_U8    devNum,
    IN GT_U32   portNum,
...
/**
* @internal cpssDxChPortTxQShapingCreditAccumulationEnableGet function
* @endinternal
*
...
GT_STATUS cpssDxChPortTxQShapingCreditAccumulationEnableGet
(
    IN GT_U8    devNum,
    IN GT_U32   portNum,
    IN GT_U32   queueOffset,
...
/**
* @internal cpssDxChPortTxQPoolModeSet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxQPoolModeSet
(
    IN GT_U8                        devNum,
    IN CPSS_PORT_TX_POOL_MODE_ENT   mode
);

/**
* @internal cpssDxChPortTxQPoolModeGet function
* @endinternal
*
...
*
* @param[in] devNum                - physical device number
* @param[out] modePtr               -(pointer to) operation mode of egress pools
*
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxQPoolModeGet
(
    IN GT_U8                        devNum,
...
/**
* @internal cpssDxChPortTxQPermissiveShaperModeEnableSet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxQPermissiveShaperModeEnableSet
(
    IN GT_U8                        devNum,
    IN GT_BOOL                      enable
);
...
/**
* @internal cpssDxChPortTxQPermissiveShaperModeEnableGet function
* @endinternal
*
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxQPermissiveShaperModeEnableGet
(
    IN GT_U8                        devNum,
    OUT GT_BOOL                      *enablePtr
);
/**
* @internal cpssDxChPortTxPoolBuffNumberGet
* @endinternal
*
* @brief  Get number of buffers per specific pool.
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier; Ironman.
* @note   NOT APPLICABLE DEVICES:   xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
* @param[in] devNum         - physical device number
* @param[in] poolId         - Pool ID [0..3] .Number of available pools may vary depending on pool mode.
*                             CPSS_PORT_TX_POOL_MODE_TWO_LOSSY_E - Pool 0 and Pool 1 are availeble.
*                             CPSS_PORT_TX_POOL_MODE_ONE_LOSSY_TWO_LOSLESS_E - Pool 0 -3 are available(Note that Pool 1 is reserved ,but can be querried)
*                             CPSS_PORT_TX_POOL_MODE_FOUR_LOSSLESS_E - Pool 0-3 are available
...
*
*/
GT_STATUS cpssDxChPortTxPoolBuffNumberGet
(
    IN  GT_U8       devNum,
    IN  GT_U32      poolId,
    OUT GT_U32      *numPtr
...
/**
* @internal cpssDxChPortTxQSpPrecedenceEnableSet function
* @endinternal
*
* @brief Set operation mode of arbitration in case SP+DWRR mixed mode.
*
*  If enable equal GT_TRUE then   SP queues always are scheduled first then WRR groups,i.e
...
*  Scheduling priority of WRR group will be equal to lowest queue index that participate
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxQSpPrecedenceEnableSet
(
    IN GT_U8                        devNum,
    IN GT_BOOL                      enable
);
...
/**
* @internal cpssDxChPortTxQSpPrecedenceEnableGet function
* @endinternal
*
* @brief Get operation mode of arbitration in case SP+DWRR mixed mode.
*
*  If enable equal GT_TRUE then   SP queues always are scheduled first then WRR groups,i.e
*  traffic in queues marked as strict_priority always takes precedens before wrr queues.
*  Otherwise  queue offset is treated as queue priority.
...
*
* @param[in] devNum                -physical device number
* @param[out] enablePtr            -(pointer to)sp priority precedence mode .
*                                   if equals GT_TRUE SP queues always are scheduled first then WRR groups,
*                                   otherwise queue offset is treated as queue priority.
*
*
* @retval GT_OK                    - on success
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxQSpPrecedenceEnableGet
(
    IN GT_U8                        devNum,
    OUT GT_BOOL                     *enablePtr
);
...
/**
* @internal cpssDxChPortTxQShaperAlgorithmParamsSet function
* @endinternal
*
* @brief Set shaper algorithm parameters.
*
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier;Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5;  Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
* @param[in] devNum              - physical device number
* @param[in] type                       -shaper rate type(commited or excess)
* @param[in] algParamsPtr        -(pointer to) shaper algorithm parameters.
*
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxQShaperAlgorithmParamsSet
(
    IN GT_U8                                    devNum,
    IN CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT       type,
    IN CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC   * algParamsPtr
);
/**
* @internal cpssDxChPortTxQShaperAlgorithmParamsGet function
* @endinternal
*
* @brief Get shaper algorithm parameters.
*
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier;Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5;  Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
* @param[in] devNum              - physical device number
* @param[out] algParamsPtr       -(pointer to) shaper algorithm parameters.
*
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxQShaperAlgorithmParamsGet
(
    IN GT_U8                                    devNum,
    IN CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT       type,
    OUT CPSS_DXCH_TXQ_SIP_6_SHAPER_ALG_CFG_STC   *algParamsPtr
);


/**
* @internal cpssDxChPortTxQShaperCalculationGet function
* @endinternal
*
* @brief Based on required  shaper  rate, API  would return what will be the configured
*        value in the hardware, and effective burst size.
*
*
* @note   APPLICABLE DEVICES:      Falcon; AC5P; AC5X; Harrier;Ironman.
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5;  Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2.
*
* @param[in] devNum         -physical device number
* @param[in] type           -rate type (CIR/EIR)
* @param[in] level          -level on which shaper is applied(port/queue/cascade port)
* @param[in] rateInKb       -rate in kilobyte
* @param[in] outputPtr      -actual shaper parameters that would be programmed into the HW.
*
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
...
* @retval GT_NOT_APPLICABLE_DEVICE - on not applicable device
*/
GT_STATUS cpssDxChPortTxQShaperCalculationGet
(
    IN GT_U8 devNum,
    IN CPSS_DXCH_TXQ_SHAPER_RATE_TYPE_ENT type,
...
* @endinternal
*
* @brief   Bind a queue offset of physical Port to a specific Drop Profile Set.
*
...
* @param[in] devNum                   - Physical device number
* @param[in] portNum                  - Physical or CPU port number
* @param[in] queueOffset              - Queue offset form first queue
* @param[in] profileSet               - The Profile Set in which the Traffic
*                                       Class Drop Parameters is associated[Applicable range 0..1023]
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_BAD_PARAM             - on wrong port number or device
* @retval GT_HW_ERROR              - on hardware error
*/
GT_STATUS cpssDxChPortTxBindPortQueueToDpSet
(
    IN  GT_U8                               devNum,
    IN  GT_PHYSICAL_PORT_NUM                portNum,
    IN  GT_U32                              queueOffset,
...
/**
* @internal cpssDxChPortTxBindPortQueueToDpGet function
* @endinternal
*
* @brief   Get the a port queue offset binding  to a specific Drop Profile Set.
*
* @note   APPLICABLE DEVICES: AAS
* @note   NOT APPLICABLE DEVICES:  xCat3; AC5; Lion2; Bobcat2; Caelum; Aldrin; AC3X; Bobcat3; Aldrin2; Falcon; AC5P; AC5X; Harrier; Ironman.
*
...
* @retval GT_HW_ERROR              - on hardware error
*/
GT_STATUS cpssDxChPortTxBindPortQueueToDpGet
(
    IN  GT_U8                               devNum,
    IN  GT_PHYSICAL_PORT_NUM                portNum,
    IN  GT_U32                              queueOffset,
    OUT GT_U32                              *profileSetPtr
);

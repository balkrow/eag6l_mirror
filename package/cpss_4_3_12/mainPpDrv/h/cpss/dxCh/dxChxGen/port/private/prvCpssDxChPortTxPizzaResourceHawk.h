...
/**
* @enum PRV_CPSS_DXCH_PIZZA_ARBITER_SPEED_SHAPER_DATA_STC
 *
 * @brief the structure describes entry of speedId shaper data used in PB
*/
typedef struct{
    /** speed Id, Low 0xFFFFFFFF for entry marking end of table */
    GT_U32             speedIdLow;
    /** speed Id High */
    GT_U32             speedIdHigh;
    /** shaper Reorder Enable */
    GT_U32             shaperReorderEnable;
    /** shaper Reorder Enable */
    GT_U32             shaperMergeEnable;
} PRV_CPSS_DXCH_PIZZA_ARBITER_SPEED_SHAPER_DATA_STC;
...
typedef struct{
    ...
    /* 0xFFFFFFFF means leave as copied from original profile */
...
typedef struct{
    ...
    const PRV_CPSS_DXCH_PIZZA_ARBITER_SPEED_SHAPER_DATA_STC *speedShaperOptionsPtr;
...
typedef struct{
    ...
    /** pointer to array of channel speed Shaper Data register addresses */
    const GT_U32       *channelSpeedShaperDataRegAddrArrPtr;
    /** channel speed Shaper Merge field position */
    GT_U32             channelSpeedShaperMergeFldPos;
    /** channel speed Shaper Merge field length */
    GT_U32             channelSpeedShaperMergeFldLen;
    /** channel speed Shaper Reorder field position */
    GT_U32             channelSpeedShaperReorderFldPos;
    /** channel speed Shaper Reorder field length */
    GT_U32             channelSpeedShaperReorderFldLen;

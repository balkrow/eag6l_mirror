...
/* number of analyzers for mirroring in SIP4 generation of devices */
#define MAX_NUM_ANALYZERS_SIP4_CNS  7

/* 128 registers for per port register */
#define PORTS_NUM_SIP_4_CNS       CPSS_MAX_SIP_4_PORTS_NUM_CNS
...
/* for device that supports 128 ports bmp , uses 7 words . CPU port at bit '63' */
...
#define PORTS_BMP_NUM_SIP_4_CNS   ((PORTS_NUM_SIP_4_CNS + 31) / 32)
...
/* AC5 , sip6 with 9 , sip7 with 11 */
#define MAX_UNITS_ADDR_DECODER  11

/*
Number of possible pools in the system(depends on configurations)
*/

#define SIP6_SHARED_TOTAL_POOLS_NUM_CNS(_devNum)    \
   (\
     (GT_FALSE == PRV_CPSS_SIP_7_CHECK_MAC(_devNum))?\
        (((NULL==(PRV_CPSS_DXCH_PP_MAC(_devNum)->port.tileConfigsPtr))||PRV_CPSS_TXQ_PER_DEVICE_DB_MAC(_devNum).poolMode==CPSS_PORT_TX_POOL_MODE_TWO_LOSSY_E)?2 : \
         4):4\
    )

/*maximal number supported by HW*/
#define SIP6_TXQ_PFCC_SHARED_MAX_POOLS_NUM_CNS 4

#define SIP6_SHARED_TAIL_DROP_POOLS_NUM_CNS     2
#define SIP7_SHARED_TAIL_DROP_POOLS_NUM_CNS     SIP6_TXQ_PFCC_SHARED_MAX_POOLS_NUM_CNS



#define SIP6_SHARED_REGULAR_TD_POOLS_NUM_CNS 2
...
/**
* @struct PRV_CPSS_DXCH_PORT_MAC_REGS_ADDR_STC
 *
...
typedef struct{
    ...
    /** FC DSA tag Register3 */
    GT_U32 fcDsaTag3;

    /** CCFC FC Timer Register */
    GT_U32 ccfcFcTimer;

    /** XLG PCS common control register */
    GT_U32 pcs40GCommonCtrl;

    /** XLG PCS common status register */
    GT_U32 pcs40GCommonStatus;

    /** XLG PCS gear box (state machine) status register */
    GT_U32 pcs40GGearBoxStatus;

    /** FEC DEC Status register */
    GT_U32 pcs40GFecDecStatus;

    /** @brief "Periodic Priority Flow Control" Control register
     *  Notes:
...
struct dxch_perPortRegs
{
    ...
    GT_U32 macQsgmiiStatus;     /* MAC QSGMII Status Register */
    ...
    GT_U32 symbolErrors[PRV_CPSS_DXCH_LION2_NUM_LANES_CNS];     /* Symbol Error Counter Register */
...
typedef struct
{
    ...
    struct _bufferMng
    {
        struct _eqBlkCfgRegs
        {
            ...
            GT_U32          analyzerPortGlobalConfig; /* Analyzer Port Global
                                                     ...
                                                     For xCat3 and above */
            GT_U32          mirrorInterfaceParameterReg[MAX_NUM_ANALYZERS_SIP4_CNS]; /* Mirror Interface
                                                            Parameter Register.
                                                       For xCat3 and above */
            GT_U32          portTxMirrorIndex[14]; /* Port Egress Mirror Index
                                                        For xCat3 and above */
            ...
            GT_U32  ingressDropCntrConfReg;   /* Ingress Drop Counter Configuration Register */
        ...
        GT_U32  txdmaPortBurstLimitThresholds[PORTS_NUM_SIP_4_CNS]; /* Port%p Burst Limit Thresholds */
    ...
    struct _sdmaRegs
    {
        ...
        GT_U32  txSdmaSmallPacketReject;  /* Tx SDMA small packet reject */
    }sdmaRegs;
    ...
    struct _macRegs                 /* mac related */
    {
        ...
        struct { /* new xCat3 and above registers */
    ...
    struct _pcl
    {
        ...
        /* AC5 only - uses 2 PCL: tcams */
        GT_U32 tcamPatternBaseArr[2];
        GT_U32 tcamPatternParityBaseArr[2];
        GT_U32 tcamMaskParityBaseArr[2];
        GT_U32 actionTableBaseArr[2];
        GT_U32 tcamConfigRegister0Arr[2];
        GT_U32 tccErrorInformation[2];
        ...
        GT_U32 epclCfgTblAccess[PORTS_BMP_NUM_SIP_4_CNS];
        GT_U32 epclEnPktNonTs[PORTS_BMP_NUM_SIP_4_CNS];
        GT_U32 epclEnPktTs[PORTS_BMP_NUM_SIP_4_CNS];
        GT_U32 epclEnPktToCpu[PORTS_BMP_NUM_SIP_4_CNS];
        GT_U32 epclEnPktFromCpuData[PORTS_BMP_NUM_SIP_4_CNS];
        GT_U32 epclEnPktFromCpuControl[PORTS_BMP_NUM_SIP_4_CNS];
        GT_U32 epclEnPktToAnalyzer[PORTS_BMP_NUM_SIP_4_CNS];
       ...
       /* CNC relted registers */
        ...
        GT_U32 eplrPortBasedMetering[PORTS_BMP_NUM_SIP_4_CNS];   /* Egress Policer Port Based Metering */
    ...
    struct _cncRegs
    {
        ...
        /* metal fix : used only in AC5 device */
        GT_U32  CNCMetalFixRegister;
    }cncRegs[2];/*AC5 supports 2 CNC units */
    ...
    struct {/* EQ - pre egress */
        struct {
            GT_U32  multiCoreLookup0;
            GT_U32  multiCoreLookupInfo[8];/* support 16 src port groups */
        }multiCoreLookup;
        struct {
            GT_U32  dualDevIdAndLossyDropConfig;
        }globalConfig;
    ...
    struct _haRegs
    {
        ...
        /* local ports bmp */
        GT_U32 cscdHeadrInsrtConf[LOCAL_PORTS_BMP_NUM_CNS];/*ports bmp */     /* Cascading and Header Insertion Configuration */
        /* local ports bmp */
        GT_U32 eggrDSATagTypeConf[LOCAL_PORTS_BMP_NUM_CNS];/*ports bmp */     /* Egress DSA Tag Type Configuration */
        /* local ports bmp */
        GT_U32 invalidCrcModeConfigReg[LOCAL_PORTS_BMP_NUM_CNS];/*ports bmp *//* Invalid CRC Mode Configuration Register */

        GT_U32 trunkNumConfigReg[PORTS_NUM_SIP_4_CNS / 4];/* 4 ports in register */
                                        /* 32 - for Lion2 (for 128 ports)
                                           7  - for xcat3, AC5  (for 28 ports)
                                           4 bits per port
        ...
        GT_U32 routerMacSaBaseReg[2]; /* router Mac SA Base Regs 0&1            */
                ...
                /* local ports bmp */
        GT_U32 routerHdrAltEnMacSaModifyReg[LOCAL_PORTS_BMP_NUM_CNS];/*ports bmp */
                                            /* router Header Alteration enable*/
                                            /* Mac SA modification           */
        /* local ports bmp */
        GT_U32 routerDevIdModifyEnReg[LOCAL_PORTS_BMP_NUM_CNS];/*ports bmp */
                                            /* Device ID Modification Enable */

        /* local ports bmp */
        GT_U32 routerHdrAltMacSaModifyMode[PORTS_BMP_NUM_SIP_4_CNS*2];
                                                /* 2 - for xcat/ch1,2,3 */
                                                /* 4 - for lion B */
                                                /* 2 bits per port */
        ...
        /* local ports bmp */
        GT_U32 haVlanTransEnReg[LOCAL_PORTS_BMP_NUM_CNS];/*ports bmp *//* Vlan Translation Enable Register */
        ...
        GT_U32 toAnalyzerVlanAddConfig[LOCAL_PORTS_BMP_NUM_CNS];/*ports bmp */ /* TO ANALYZER VLAN Adding Configuration Registers */
        ...
        GT_U32  bridgeEgressPortTag0TpidSelect[LOCAL_PORTS_NUM_CNS/8];/*8 ports in register*/  /* Egress port Tag0 TPID select register */
        GT_U32  bridgeEgressPortTag1TpidSelect[LOCAL_PORTS_NUM_CNS/8];/*8 ports in register*/  /* Egress port Tag1 TPID select register */
        GT_U32  miscConfig; /* Misc Configuration Register */
        GT_U32  mirrorToAnalyzerHeaderConfReg[LOCAL_PORTS_BMP_NUM_CNS];/*ports bmp */ /* Mirror to Analyzer Header Configuration Register */
        GT_U32  ptpTimeStampPortEnReg[LOCAL_PORTS_BMP_NUM_CNS]; /* Egress Timestamping port enable */
        ...
        GT_U32  keepVlan1Reg[LOCAL_PORTS_NUM_CNS/4]; /* 4 ports in register */ /* Keep Vlan1 Registers */

        GT_U32  coreRingConfiguration[2];
        GT_U32  erspanEntryWord1[8];
                            ...
                            GT_U32  tunnelStartEgressPortTagTpidSelect[PORTS_NUM_SIP_4_CNS/8];/*8 ports in register*/  /* Tunnel Start Egress port Tag TPID select register */
    ...
    struct/*txqVer1*/
    {
        struct{/*egr*/
            ...
            struct{/*mcFifoConfig*/
                ...
                GT_U32  distributionMask[MC_FIFO_NUM_CNS][PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
            }mcFifoConfig;

            struct{/*devMapTableConfig*/
                GT_U32  addrConstruct;
                GT_U32  localSrcPortMapOwnDevEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  localTrgPortMapOwnDevEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  secondaryTargetPortTable[PORTS_NUM_SIP_4_CNS];/*port*/
            }devMapTableConfig;

            struct{/*filterConfig*/
                GT_U32  globalEnables;
                GT_U32  unknownUcFilterEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  unregisteredMcFilterEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  unregisteredBcFilterEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  mcLocalEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  ipmcRoutedFilterEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  ucSrcIdFilterEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  oamLoopbackFilterEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  egrCnEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  egrCnFcEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
        ...
        struct{/*queue*/
            struct{/*distributor*/
                ...
                GT_U32  stackRemapEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  controlTcRemapEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  dataTcRemapEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  dpToCfiRemapEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  fromCpuForwardRestricted[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  bridgedForwardRestricted[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
                GT_U32  routedForwardRestricted[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
            }distributor;
            ...
            struct{/*tailDrop*/
                struct{/*config*/
                    GT_U32  config;
                    GT_U32  byteCount;
                    GT_U32  portEnqueueEnable[PORTS_NUM_SIP_4_CNS];/*port*/
                    GT_U32  tailDropCnProfile[PORTS_NUM_SIP_4_CNS];/*port*/
                ...
                struct{/*counters*/
                    ...
                    GT_U32  portDescCounter[PORTS_NUM_SIP_4_CNS];/*port*/
                    GT_U32  portBuffersCounter[PORTS_NUM_SIP_4_CNS];/*port*/
                    GT_U32  tcSharedDescCounter[TC_NUM_CNS];/*TC*/
                    GT_U32  tcSharedBuffersCounter[TC_NUM_CNS];/*TC*/

                    GT_U32  qMainDesc[PORTS_NUM_SIP_4_CNS][TC_NUM_CNS];/*port*//*TC*/
                    GT_U32  qMainBuff[PORTS_NUM_SIP_4_CNS][TC_NUM_CNS];/*port*//*TC*/
                }counters;
            ...
            struct{/*congestNotification*/
                ...
                GT_U32 cnEnCnFrameTx[PORTS_BMP_NUM_SIP_4_CNS]; /* ports bmp */
                GT_U32 cnFcEn[PORTS_BMP_NUM_SIP_4_CNS];/* ports bmp */
        ...
        struct{/*dq*/
            struct{/*global*/
                ...
                struct{/*flushTrig*/
                    GT_U32  portTxqFlushTrigger[PORTS_NUM_SIP_4_CNS];/* local port emulated as global port !!! */
                }flushTrig;
            ...
            struct{/*scheduler*/
                struct{/*config*/
                    ...
                    GT_U32  portRequestMaskSelector[PORTS_NUM_SIP_4_CNS];/* local port emulated as global port !!! */
                }config;
                ...
                struct{/*priorityArbiterWeights*/
                    ...
                    GT_U32  portSchedulerProfile[PORTS_NUM_SIP_4_CNS];/* local port emulated as global port !!! */
            ...
            struct{/*shaper*/
                ...
                GT_U32  portDequeueEnable[PORTS_NUM_SIP_4_CNS];/* local port emulated as global port !!! */
            }shaper;
    ...
    struct{/* dfxUnits*/
        struct{/* server */
            ...
            GT_U32  genSkipInitMatrix2;
            GT_U32  genSkipInitMatrix8;
            GT_U32  genSkipInitMatrix9;
            GT_U32  genSkipInitMatrix11;
            GT_U32  regsConfSkipInitMatrix;
    ...
    }packGenConfig[18]; /* four packet generators per port group for Lion2; one packet generator per port group for xCat3. */
    ...
    /*  Relevant for AC5 only
        CPU  – 0x8040_0000
        CoreSight Trace – 0x8041_0000
        AMB2 – 0x8042_0000
        AMB3 – 0x8043_0000
        iNIC – 0x8044_0000
        XOR0 – 0x8045_0000

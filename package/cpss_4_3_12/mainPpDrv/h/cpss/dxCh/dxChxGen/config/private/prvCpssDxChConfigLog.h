...
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_PP_CONFIG_EM_AUTO_LEARN_MODE_ENT);
PRV_CPSS_LOG_STC_ENUM_DECLARE_MAC(CPSS_DXCH_PP_CONFIG_EM_CLIENT_TYPE_ENT);
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChCfgAuqFuqDisable_E,
    PRV_CPSS_LOG_FUNC_cpssDxChCfgServiceCpuDisable_E
};

...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_deleteEntry;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_getAgeStatusFromHw;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_indexesNumToCheck;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChBrgFdbManagerEntryTempGetNext_E
};

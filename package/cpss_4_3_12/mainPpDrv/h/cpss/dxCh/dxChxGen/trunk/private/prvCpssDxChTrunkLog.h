...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_TRUNK_POLICY_STC_PTR_policyInfoPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_TRUNK_POLICY_STC_PTR_policyInfoPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_BOOL_PTR_triggerDonePtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChTrunkMemberDisabledAdd_E,
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChTrunkEcmpTableSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTrunkEcmpTableGet_E,
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChTrunkDbCascadePolicyInfoSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTrunkDbCascadePolicyInfoGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTrunkDbPolicyInfoSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTrunkDbPolicyInfoGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTrunkCascadePortAdd_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTrunkCascadePortRemove_E
};

...
/**
********************************************************************************
* @file cpssDxChDiagDataIntegrity.h
*
* @brief Diag Data Integrity module APIs for CPSS DxCh.
*
* @version   6
********************************************************************************
*/
...
typedef enum{
    ...
    /** EQ Logical Target Mapping Table (a.k.a. Virtual Port Mapping) */
    ...
    /** @brief last memory for Bobcat2 devices
     *  Caelum memories
     */
    ...
    /** CIP AMB ram WR */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CIP_AMB_RAM_WR_E,

    /** CG RX FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CG_CG_RX_FIFO_E,

    /** CG TX FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CG_CG_TX_FIFO_E,

    /** CG Deskew */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CG_DESKEW_MEM_E,

    /** CG DP Delay */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CG_DP_DELAY_MEM_E,

    /** CG RS FEC */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CG_RS_FEC_MEM_E,

    /** CG RX Preamble */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CG_RX_PREAMBLE_MEM_E,

    /** CG RX Sync FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CG_RX_SYNC_FIFO_E,

    /** CG TX Preamble */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CG_TX_PREAMBLE_MEM_E,

    /** CG TX Sync FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CG_TX_SYNC_FIFO_E,

    /** DIP DP IA OS Burst FIFO memory */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DIP_DP_IA_OS_BURST_FIFO_RAM_E,

    /** EGF QAG eVIDX Activity Status */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EGF_QAG_EVIDX_ACTIVITY_STATUS_E,

    /** EGF QAG Port Enq Attributes */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EGF_QAG_PORT_ENQ_ATTRIBUTES_E,

    /** EGF QAG Port Source Attributes */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EGF_QAG_PORT_SOURCE_ATTRIBUTES_E,

    /** EGF QAG Port Target Attributes */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EGF_QAG_PORT_TARGET_ATTRIBUTES_E,

    /** EGF QAG TC DP Mapper */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EGF_QAG_TC_DP_MAPPER_E,

    /** EGF QAG VOQ Mapper */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EGF_QAG_VOQ_MAPPER_E,

    /** HA Header Lat FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_HA_HEADER_LAT_FIFO_E,

    /** IPLR QOS Remarking table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IPLR_QOS_REMARKING_TABLE_INGRESS_E,

    /** IPVX STG13 Desc FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IPVX_STG13_DESC_FIFO_E,

    /** LPM mem Basic */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_LPM_MEM_BASIC_E,

    /** PEX2 Tx Data */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PEX2_TXDATA_E,

    /** Policer Counting Engine Lanency FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_COUNTING_ENGINE_LATENCY_FIFO_E,

    /** Policer Counting Table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_COUNTING_TBL_E,

    /** Policer Metering Configuration Table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_METERING_CONF_TBL_E,

    /** Policer Metering Sign Table (even) */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_METERING_SIGN_TBL_EVEN_E,

    /** Policer Metering Sign Table (odd) */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_METERING_SIGN_TBL_ODD_E,

    /** Policer Metering TB Table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_METERING_TB_TBL_E,

    /** TCAM Action 2P */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TCAM_ACTION_2P_E,

    /** TTI Physical Port Attribures 2 */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TTI_PHY_PORT_ATTRIBUTES_2_E,

    /** TXDMA BC CT */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXDMA_BC_CT_E,

    /** TXDMA BC FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXDMA_BC_FIFO_E,

    /** TXDMA Inprog BC FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXDMA_INPROG_BC_FIFO_E,

    /** TXDMA Inprog CT Start */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXDMA_INPROG_CT_START_FIFO_E,

    /** TXDMA Inprog Next BC FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXDMA_INPROG_NEXT_BC_FIFO_E,

    /** TXDMA Inprog Valid BC FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXDMA_INPROG_VALID_BC_FIFO_E,

    /** TXDMA Valid BC CT */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXDMA_VALID_BC_CT_E,

    /** TXDMA Valid FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXDMA_VALID_BC_FIFO_E,

    /** TXQ BMX Data Base */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXQ_BMX_DATA_BASE_E,

    /** TXQ BMX Free Entry FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXQ_BMX_FREE_ENTRY_FIFO_E,

    /** TXQ DQ Port Map */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXQ_DQ_TTI_PORT_MAP_E,
    ...
    /** TXQ Q High Threshold Cross */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXQ_Q_HIGH_THRESHOLD_CROSS_E,

    /** TXQ Q Low Threshold Cross */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXQ_Q_LOW_THRESHOLD_CROSS_E,

    /** BMA Multicast counters */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_BMA_MC_COUNTERS_FLOOR_BANK_E,

    /** last memory for Bobcat3 devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_BOBCAT3_LAST_E,

    /** IPVx Routing ECMP QoS Indirect table  */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IPVX_ECMP_QOS_INDIRECT_TABLE_E = CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_BOBCAT3_LAST_E,

    /** TXDMA Payload Reorder related FIFO  */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXDMA_PAYLOAD_REORDER_MEM_IDDB_FREE_ID_FIFO_E,

    /** TXDMA Header Reorder related FIFO  */
    ...
    /** MUnit memory */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MUNIT_MUNIT_E,

    /** TxQ Port and Traffic Class Buffers Statistic */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXQ_Q_QUEUE_TXQ_BS_E,

    /** TxQ Port Buffers Statistic */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXQ_Q_PORT_TXQ_BS_E,

    /** TTI Port2Queue Translation */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TTI_PORT2QUEUE_TRANSLATION_E,

    /** eVLAN to VRF-ID Mapping (a.k.a. Bridge VRF-ID Table in AC5) */
    ...
    /** Target Physical Port Mapping */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPCL_TRG_PHY_PORT_MAPPING_TABLE_E,

    /** Source Physical Port Mapping */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPCL_SRC_PHY_PORT_MAPPING_TABLE_E,

    /** QoS Attributes  */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_QOS_ATTRIBUTES_TBL_E,

    /** Port Profile Configurations */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PREQ_PROFILES_TABLE_E,
    ...
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EQ_PORT_MIRROR_INDEX_E,

    /** Path Utilization */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EQ_PATH_UTILIZATION_TABLE_E,

    /** IPLR Port Attributes */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_PORT_ATTRIBUTES_TBL_E,

    /** Data Path RX DMA unit RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DP_RX_PB_TAIL_ID_MEM_E,
    ...
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DP_RX_REPLY_TAIL_PB_ID_MEM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DP_RX_PCM_MEM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DP_RX_PACM_MEM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DP_RX_PACKET_HEAD_FIFO_MEM_E,
    ...
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DP_RX_RX_LOCAL_IDS_FIFO_MEM_E,

    /** Ingress Aggregator RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IA_OS_MEM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IA_LS_MEM_E,

    /** Header buffers RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_HBU_HEADER_BUFFER_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_HBU_FHF_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_HBU_CMT_E,

    /** PHA scratchpad RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SIP_PPA_PPN_SCRATCHPAD_E,
    /** PHA instructions memory */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SIP_PPA_IMEM_BANK_E,
    /** PHA shared memory*/
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SIP_PPA_SHARED_DMEM_E,
    /** PHA thread configuration 1 table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SIP_PHA_PPA_THREADS_CONF1_TABLE_E,
    /** PHA thread configuration 2 table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SIP_PHA_PPA_THREADS_CONF2_TABLE_E,
    /** PHA source port table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SIP_PHA_SOURCE_PORT_METADATA_TABLE_E,
    /** PHA bypass buffer for headers */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SIP_PHA_BYPASS_BUFFER_HEADER_BANK_E,
    /** PHA bypass buffer for descriptors */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SIP_PHA_BYPASS_BUFFER_DESC_E,
    /** PHA target port table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SIP_PHA_TARGET_PORT_METADATA_TABLE_E,

    /** IPvX ECMP table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IPVX_ECMP_E,

    /** Exact Match input NA FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EM_IN_NA_FIFO_E,
    /** Exact Match output update FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EM_OUT_UPDATE_FIFO_E,

    /** Shared Memory Type2 banks */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SHM_TYPE2_SBM_DATA_E,
    /** Shared Memory Type2 XOR RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SHM_TYPE2_SBM_XOR_DATA_E,

    /** Data path TX DMA empty tags RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXD_EMPTY_TAGS_E,
    /** Data path TX FIFO buffer memory */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXF_WORD_BUFFER_MEM_E,

    /** Packet Buffer control memories */
    ...
    /** TxQ PDX RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDX_QGRPMAP_E,
    ...
    /** Shared Memory Type 1 RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SHM_TYPE1_SBM_DATA_E,

    /** LPM aging table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SHM_LPM_AGING_E,

    /** TxQ PDS RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_DATA_STORAGE_0_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_DATA_STORAGE_1_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_FREE_NEXT_FIFO_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_FRAG_TAIL_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_FRAG_HEAD_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_FREE_PID_FIFO_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_CNTRS_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_NEXT_TBL_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_PID_TBL_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_HEAD_HEAD_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_HEAD_TAIL_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_TAIL_TAIL_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_TAIL_HEAD_E,

    /** TxQ SDQ RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_SEL_LIST_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_QTABLE_CFG_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_CREDIT_BALANCE_E,

    /** Control and Management SRAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CNM_SRAM_E,

    /** Accelerated Access Controller RAM */
    ...
    /** TxQ QFC RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_QFC_QL_CNTRS_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_QFC_PFC_CNTRS_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_QFC_PFC_MIRR_CNTRS_E,

    /** Port MAC statistics */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MTIP_MAC_STAT_TX_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MTIP_MAC_STAT_RX_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MTIP_MAC_STAT_CAPTURE_E,

    /** Latency Monitoring unit configuration */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_LMU_LMUCFG_E,
    /** Latency Monitoring unit statistics */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_LMU_LMUSTAT_E,

   /** last memory for Falcon devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_FALCON_LAST_E,

    /** Ingress ECID table in AC5 devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_VLT_INGRESS_ECID_TABLE_E,

    /** TxQ Counters Limit table in AC5 devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TXQ_TXQ_COUNTERS_LIMIT_E,

    /** LP Egress VLAN member table in AC5 devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EQ_VLAN_MEMBER_TABLE_E,

    /** VLAN mapping table in AC5 devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EQ_VLAN_EGRESS_MAP_TABLE_E,

    /** L2 MLL Pointer Map in AC5 devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MLL_STG0_TABLE_PTR_MAP_E,

    /** Buffers Management MDB managment table in AC5 devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_BM_MDB_CLEAR_INC_E,

    /** LMS MAC MIB Counters in AC5 devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_LMS_COUNTERS_RFT_E,

    /** policy TCAM #1 in AC5 devices */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_POLICY_TCAM_1_E,

    /** Port MAC and PCS RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_USX_MAC_U_TSTM_E = CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_FALCON_LAST_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_USX_MAC_U_RSTM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_USX_MAC_U_CSTM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_USX_MAC_U_TXD_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_USX_PCS_U_F91M_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_USX_PCS_U_F91DM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_100_MAC_U_TSTM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_100_MAC_U_RSTM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_100_PCS_U_RSFEC_FRM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MTIP_CPU_PCS_F91M_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MTIP_CPU_MAC_FIFO_TX_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MTIP_400BR_PCS_QUAD_DESKEW_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MTIP_400BR_PCS_CD_MFD_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MTIP_400BR_MAC_QUAD_PMAC_TXD_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_MTIP_400BR_MAC_QUAD_TXD_E,
    ...
    /** SERDES controller RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDW_PRAM16K_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDW_SRAM64K_E,

    /** Exact Match table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DDM_EM_DATA_E,

    /** Auto Learned EM Entry Index Table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EM_AL_EM_E,

    /** LPM small RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DDM_LPM_LAST_DATA_E,

    /** Programmable Parser Action table  */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PPU_ACTION_TABLE_E,

    /** Programmable Parser buffer for descriptor  */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PPU_DESCRIPTOR_BUFFER_E,

    /** Programmable Parser DAU profiles  */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PPU_DAU_PROFILES_E,

    /** PreQ Target Physical Port Table */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PREQ_TARGET_PHYSICAL_PORT_TABLE_E,

    /** MACSec Ingress Transformer RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_IBUF_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_GEN_HKEY_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_GHASH_E,
    /** MACSec Ingress Transformer statistics RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_STAT_SA_RAM0_E,
    ...
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_STAT_IFC0_RAM0_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_STAT_IFC1_RAM0_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_STAT_RXCAM_RAM_E,

    /** MACSec Ingress Transformer SA RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_SA_REC_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_SC_SA_RAM_E,

    /** MACSec Ingress Transformer AES RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_AES_DATA_NXT_E,

    /** MACSec Ingress Transformer Flow RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_FLOW_RAM_0_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_ING_FLOW_RAM_1_E,

    /** MACSec Egress Transformer RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_IBUF_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_GEN_HKEY_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_GHASH_E,
    /** MACSec Egress Transformer statistics RAMs */
    ...
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_STAT_IFC1_RAM0_E,
    /** MACSec Egress Transformer SA RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_SA_REC_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_SC_SA_RAM_E,
    /** MACSec Egress Transformer AES RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_AES_DATA_NXT_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_AES_DATA_E,
    /** MACSec Egress Transformer Flow RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_FLOW_RAM_0_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP164_EGR_FLOW_RAM_1_E,

    /** MACSec Egress Classifier statistics RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_EGR_STAT_TCAM_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_EGR_STAT_CHAN_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_EGR_MTT_STAT_RAM_E,
    /** MACSec Egress Classifier RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_EGR_DPIPE_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_EGR_FLOW_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_EGR_TPOL_RAM_E,

    /** MACSec Ingress Classifier statistics RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_ING_STAT_TCAM_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_ING_STAT_CHAN_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_ING_MTT_STAT_RAM_E,
    /** MACSec Ingress Classifier RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_ING_DPIPE_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_ING_FLOW_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_ING_TPOL_RAM_E,

    /** PCA unit Shared FIFO */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PCA_SFF_RAM_E,

    /** IPFIX First N packets RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PLR_IPFIX_1ST_N_PACKETS_E,

    /** CNM and CPU RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_G_RAM_RX_FIFO_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_G_RAM_TX_FIFO_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDHC31_DP512X64_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_XOR_DP64X128_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_XOR_DP40X128_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CCI_SNOOP_FILTER_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CPE_DATA_WRITE_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_GIC_GICD_LPI_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_GIC_ITS_V_CACHE_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DDRPHY_DCCM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DDRPHY_ICCM_E,
    ...
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DSU_CORINTH_SCU_SF_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DSU_CORINTH_L3_DATA_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DSU_CORINTH_L3D_TAG_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_DSU_CORINTH_L3_VICTIM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_CORESIGHT_CSTB_E,

    /** PCI Express RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PCIE_GEN3_EP_X1_U_RAM_1P_RBUF_E,
    ...
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PCIE_GEN3_EP_X1_U_IB_RREQ_ORDR_RAM_E,

    /** New in Harrier - Egress Filter Unit VLAN Queue Offset Map */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EGF_QAG_VLAN_Q_OFFSET_MAPPING_E,

    /** New in Harrier - TxQ PDS unit RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_NXT_BMX_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDS_PID_BMX_E,

     /** New in Harrier - PCI_e unit RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PCIE_GEN3_EP_X1_U_SRAM_40960X32_E,

    /** New RAMs in IronMan - Start */
    /** MACSec Egress Classifier RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_EGR_IBUF0_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_EGR_IBUF1_RAM_E,

    /** MACSec Ingress Classifier RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_ING_IBUF0_RAM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_IP163_ING_IBUF1_RAM_E,

    /** Data Path TX Cell Buffer RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_TX_CELL_BUFFER_MEM_E,

    /** TxQ RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDSL_LL_NEXT_DESC_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PDSL_LL_FREE_ID_FIFO_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SDQ_QBV_CFG_E,

    /** Pre Queuing unit Stream Mapping RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PREQ_STREAM_MAPPING_TABLE_E,
    /** Pre Queuing unit SRF Config RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PREQ_SRF_CONFIG_TABLE_E,
    /** Pre Queuing unit SRF Counters RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PREQ_SRF_COUNTERS_TABLE_E,
    /** Pre Queuing unit Daemons RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PREQ_DAEMONS_TABLE_E,
    /** Pre Queuing unit History Buffer RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_PREQ_HISTORY_BUFFER_TABLE_E,

    /** Stream Unit - SNG IRF RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SMU_SNG_IRF_TABLE_E,
    /** Stream Unit - IRF Counters RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SMU_IRF_COUNTERS_TABLE_E,
    /** Stream Unit - SGC Interval Max RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SMU_SGC_INTERVAL_MAX_TABLE_E,
    /** Stream Unit - SGC Table Set Time Configurations RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SMU_SGC_TABLE_SET_TIME_CONFIGURATIONS_TABLE_E,
    /** Stream Unit - SGC Time To Advance RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SMU_SGC_TIME_TO_ADVANCE_TABLE_E,
    /** Stream Unit - SGC Octet Counters RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SMU_SGC_OCTET_COUNTERS_TABLE_E,
    /** Stream Unit - SGC Time Slot Attributes RAM */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_SMU_SGC_TIME_SLOT_ATTRIBUTES_TABLE_E,

    /** Port MAC RAMs */
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_MAC_BR_U_TSTM_E,
    CPSS_DXCH_DIAG_DATA_INTEGRITY_MEM_TYPE_EPI_MAC_BR_U_RSTM_E,

    /** New RAMs in IronMan - End */
...
/* max size of logical entries in location */
#define CPSS_DXCH_LOGICAL_IN_LOCATION_MAX_CNS 5
...
typedef struct{
    ...
    /** entry index
    * For Falcon FDB table when damaged entries of banks 4 and 5
    *
    * NOTE: Applicable for FDB table (CPSS_DXCH_TABLE_FDB_E) in Falcon devices.
    * Special bit CPSS_DXCH_DIAG_DATA_INTEGRITY_INTERNAL_RAM_FLAG_BIT_CNS in hwTableEntryIndex
    * is set to indicate internal Data 4 or Data 5 RAMs in Super Memory Bank (SBM).
    * Such error may be fixed by either
    * by call of cpssDxChBrgFdbManagerEntryRewrite if FDB Manager is used
    * or by call of cpssDxChDiagDataIntegrityTableEntryFix.
    */
    GT_U32 hwTableEntryIndex;

} CPSS_DXCH_HW_INDEX_INFO_STC;

/* bit in hwTableEntryIndex for marking damaged entries of internal            */
/* Data 4 or Data 5 RAMs in Super Memory Bank (SBM) that is used for FDB table */
#define CPSS_DXCH_DIAG_DATA_INTEGRITY_INTERNAL_RAM_FLAG_BIT_CNS  31

/**
* @struct CPSS_DXCH_LOGICAL_TABLE_INFO_STC
*
* @brief A struct to hold logical location information
*/
typedef struct{

    /** type of the logical table */
...
} CPSS_DXCH_LOGICAL_TABLE_INFO_STC;
...
typedef struct{
    ...
    /** @brief number of logical tables,
     *  max size is defined in CPSS_DXCH_LOGICAL_IN_LOCATION_MAX_CNS
     *  logicalTableInfo    - logical table information
     */
    GT_U32 numOfLogicalTables;

    CPSS_DXCH_LOGICAL_TABLE_INFO_STC logicaTableInfo[CPSS_DXCH_LOGICAL_IN_LOCATION_MAX_CNS];

} CPSS_DXCH_LOGICAL_INDEX_INFO_STC;
...
typedef union{
    ...
    /** logical info */
    CPSS_DXCH_LOGICAL_INDEX_INFO_STC logicalEntryInfo;

    /** ram info */
    CPSS_DXCH_RAM_INDEX_INFO_STC ramEntryInfo;
...
typedef struct{
    ...
    CPSS_DXCH_LOCATION_ENT type;

    /** union CPSS_DXCH_LOCATION_UNT */
    CPSS_DXCH_LOCATION_UNT info;
...
typedef struct{
    ...
    /** @brief if use tcamMemLocation instead of ramEntryInfo.memLocation.
     *  NOTE: isMppmInfoValid, isTcamInfoValid can't be GT_TRUE
     *  simultaneously
     */
    GT_BOOL isTcamInfoValid;

    /** MPPM memory location indexws */
    CPSS_DIAG_DATA_INTEGRITY_MPPM_MEMORY_LOCATION_STC mppmMemLocation;

    /** TCAM Memory location indexes */
    CPSS_DIAG_DATA_INTEGRITY_TCAM_MEMORY_LOCATION_STC tcamMemLocation;

} CPSS_DXCH_LOCATION_FULL_INFO_STC;
...
typedef struct{
    ...
    /** memory location */
    CPSS_DXCH_LOCATION_FULL_INFO_STC location;
...
(
    ...
    OUT CPSS_DXCH_DIAG_DATA_INTEGRITY_EVENT_STC     eventsArr[], /*arrSizeVarName=eventsNumPtr*/

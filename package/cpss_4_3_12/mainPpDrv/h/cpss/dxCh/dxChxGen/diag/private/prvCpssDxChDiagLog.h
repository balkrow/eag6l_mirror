...
void prvCpssLogParamFuncStc_CPSS_DXCH_DIAG_PG_CONFIG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFuncStc_CPSS_DXCH_DIAG_PG_PROFILE_CONFIG_STC_PTR
(
    IN CPSS_LOG_LIB_ENT         contextLib,
    IN CPSS_LOG_TYPE_ENT        logType,
    IN GT_CHAR_PTR              namePtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_DIAG_PG_CONFIG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
void prvCpssLogParamFunc_CPSS_DXCH_DIAG_PG_PROFILE_CONFIG_STC_PTR(
    IN CPSS_LOG_LIB_ENT            contextLib,
    IN CPSS_LOG_TYPE_ENT           logType,
    IN GT_CHAR_PTR                 namePtr,
    IN va_list                   * argsPtr,
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_DIAG_PG_CONFIG_STC_PTR_configPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_DIAG_PG_PROFILE_CONFIG_STC_PTR_configPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_BOOL_start;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_packetGeneratorIndex;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_DIAG_PG_CONFIG_STC_PTR_configPtr;
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_DIAG_PG_PROFILE_CONFIG_STC_PTR_configPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_GT_U64_PTR_errorCntrPtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChDiagPacketGeneratorProfileConfigSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChDiagPacketGeneratorProfileConfigGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChDiagPacketGeneratorConfigSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChDiagPacketGeneratorConfigGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChDiagPacketGeneratorTransmitStart_E,
    PRV_CPSS_LOG_FUNC_cpssDxChDiagPacketGeneratorStatisticGet_E
};

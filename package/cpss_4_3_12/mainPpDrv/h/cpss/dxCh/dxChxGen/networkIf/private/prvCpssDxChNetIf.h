...
typedef enum{
     ...
     */
    PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SA_MOVED_E                            = 4,

    /** ARP CPU code */
    PRV_CPSS_DXCH_NET_DSA_TAG_ARP_CPU_CODE_E                            = 5,
    ...
    /** MAC SA is DA */
    PRV_CPSS_DXCH_NET_DSA_TAG_MAC_SA_IS_DA_E                            = 7,
    ...
    /** Source IP (SIP) is Destination IP (DIP) */
    PRV_CPSS_DXCH_NET_DSA_TAG_SIP_IS_DIP_E                              = 9,
    ...
    PRV_CPSS_DXCH_NET_DSA_TAG_TCP_UDP_SPORT_IS_DPORT_E                  = 11,

    /** TCP flags has FIN but no ACK     */
    PRV_CPSS_DXCH_NET_DSA_TAG_TCP_FIN_WITHOUT_ACK_E                     = 12,
    ...
    /** IPv6 ICMP packet. */
    PRV_CPSS_DXCH_NET_DSA_TAG_IPV6_ICMP_E                               = 14,

    /** TCP has no full header */
    PRV_CPSS_DXCH_NET_DSA_TAG_DSA_TCP_WITHOUT_FULL_HEADER_E             = 15,
     ...
     *  range for any application specific purpose.
     */
    PRV_CPSS_DXCH_NET_DSA_TAG_LAST_USER_DEFINED_E                       = 255,

    /** DSA TAG CPU codes 200-205 will be overlapping with
     *  user defined CPU codes
     */

    /** @brief Packet is dropped in Router engine as the
     *  IPV4 multicast DIP is not found in LPM table and
     * default rule is not configured.
     */
    PRV_CPSS_DXCH_NET_DSA_TAG_IPV4_MC_DIP_NOT_FOUND_E                   = 200,

     /** @brief Packet is dropped in Router engine as the
     *  IPV4 unicast DIP is not found in LPM table and
     * default rule is not configured.
     */
    PRV_CPSS_DXCH_NET_DSA_TAG_IPV4_UC_DIP_NOT_FOUND_E                   = 201,

     /** @brief Packet is dropped in Router engine as the
     *  IPV6 multicast DIP is not found in LPM table and
     * default rule is not configured.
     */
    PRV_CPSS_DXCH_NET_DSA_TAG_IPV6_MC_DIP_NOT_FOUND_E                   = 202,

     /** @brief Packet is dropped in Router engine as the
     *  IPV6 unicast DIP is not found in LPM table and
     * default rule is not configured.
     */
    PRV_CPSS_DXCH_NET_DSA_TAG_IPV6_UC_DIP_NOT_FOUND_E                   = 203,

    /** @brief Packet is dropped in Router engine as the
    *  IPV4 unicast SIP is not found in LPM table and
    * default rule is not configured.
    */
    PRV_CPSS_DXCH_NET_DSA_TAG_IPV4_UC_SIP_NOT_FOUND_E                   = 204,

    /** @brief Packet is dropped in Router engine as the
    *  IPV6 unicast SIP is not found in LPM table and
    * default rule is not configured.
    */
    PRV_CPSS_DXCH_NET_DSA_TAG_IPV6_UC_SIP_NOT_FOUND_E                   = 205,

    /** one more than the last */
    PRV_CPSS_DXCH_NET_DSA_TAG_MAX_E = PRV_CPSS_DXCH_NET_DSA_TAG_LAST_USER_DEFINED_E + 1
...
typedef struct{
    ...
    /** number of RX (to CPU packets) SDMA/GDMA queues */
    GT_U32 numOfRxQueues;

    /** number of TX (from CPU packets) SDMA/GDMA queues */
    GT_U32 numOfTxQueues;

...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_NETIF_GDMA_CPU_PORTS_INFO_STC_PTR_infoPtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChNetIfGdmaCpuPortsInfoGet_E,

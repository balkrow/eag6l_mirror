...
typedef struct
{
    ...
    GT_U64  reminder[CPSS_DXCH_TAM_HISTOGRAM_BIN_VALUES]; /** Holds the fraction part of the calculated histogram percentage */
...
typedef struct
{
    ...
    CPSS_DXCH_TAM_COUNTER_ID_STC counter; /** Counter info */

} CPSS_DXCH_TAM_THRESHOLD_BREACH_EVENT_STC;

/** length of string */
#define CPSS_DXCH_TAM_PID_LEN_CNS 12
...
{
    /** Package Name */
    GT_CHAR productName[CPSS_DXCH_TAM_PID_LEN_CNS];
    /** Packet Processor Name */
    GT_CHAR ppName[CPSS_DXCH_TAM_PID_LEN_CNS];
    /** Release Version Label */
    GT_CHAR releaseVersionLabel[CPSS_DXCH_TAM_PID_LEN_CNS];
    /** API Version */
    GT_CHAR apiVersion[CPSS_DXCH_TAM_PID_LEN_CNS];
} CPSS_DXCH_TAM_PID_STC;

/** maximum number of CNC blocks */
#define CPSS_DXCH_TAM_MAX_CNC_BLOCKS_CNS 16

/**
* @struct CPSS_DXCH_TAM_PARAMS_STC
*
* @brief TAM parameters
*/
typedef struct
{
    /** Service CPU Id */
    ...
    /** CNC block Ids */
    GT_U32                 cncBlockId[CPSS_DXCH_TAM_MAX_CNC_BLOCKS_CNS];
}CPSS_DXCH_TAM_PARAMS_STC;
...
*
* @param[in]  devNum                - physical device number.
* @param[out] enablePtr             - pointer to enable/disable TAM flag
*
* @retval GT_OK                    - on success
* @retval GT_FAIL                  - on error
* @retval GT_BAD_PARAM             - on wrong device number
...
*
* @param[in] devNum                - physical device number.
* @param[out] tamPidPtr            - pointer to CPSS_DXCH_TAM_PID structure which includes the Product Name,

...
#define CPSS_DXCH_TCAM_MAX_NUM_FLOORS_CNS  24 /* AAS has 24 floors */
...
typedef enum
{
    /** @brief TCAM client ingress policy 0 (first lookup) */
    CPSS_DXCH_TCAM_IPCL_0_E,

    /** @brief TCAM client ingress policy 1 (second lookup) */
    CPSS_DXCH_TCAM_IPCL_1_E,

    /** @brief TCAM client ingress policy 2 (third lookup)
     * (APPLICABLE DEVICES: Bobcat2; Caelum; Aldrin; AC3X; BobCat3; Aldrin2)
     *  */
    CPSS_DXCH_TCAM_IPCL_2_E,

    /** @brief TCAM client egress policy */
    CPSS_DXCH_TCAM_EPCL_E,

    /** @brief TCAM client tunnel termination */
    CPSS_DXCH_TCAM_TTI_E,

    /** @brief TCAM client Midway PCL
     * (APPLICABLE DEVICES: AAS)
     *  */
    CPSS_DXCH_TCAM_MPCL_E,

    /** @brief TCAM client Ingess Programable Engine
     * (APPLICABLE DEVICES: AAS)
     * */
...
/**
* @struct CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC
 *
*  @brief Configuration per Parallel Lookups Profile
*
*/
typedef struct{
    ...
    /** @brief Sizes of subkeys for parallel lookups 0-3 */
    CPSS_DXCH_TCAM_RULE_SIZE_ENT subKeySizes[4];

    /** @brief Mux Table Line Indexes for parallel lookups 0-3 (APPLICABLE RANGES: 0..47)
     *  0-value means that key will be built without muxing
     *  subKeyMuxTableLineIndexes[0] APPLICABLE DEVICES: AAS */
    GT_U32 subKeyMuxTableLineIndexes[4];

    /** @brief Mux Table Line Offsets for parallel lookups 0-3 (APPLICABLE RANGES: 0..5) in 10-byte resolution
     * @brief subKeyMuxTableLineOffsets[0] APPLICABLE DEVICES: AAS */
    GT_U32 subKeyMuxTableLineOffsets[4];

    /** @brief shared Mux Table Line Index for all subkeys (APPLICABLE RANGES: 0..47)
     *  0-value means that key will be built without muxing
     * APPLICABLE DEVICES: AAS */
    GT_U32 sharedMuxTableLineIndex;

    /** @brief shared Mux Table Line Offset for all subkeys (APPLICABLE RANGES: 0..5) in 10-byte resolution
     * APPLICABLE DEVICES: AAS */
...
typedef struct{
     ...
     *  (APPLICABLE RANGES: AC5P; AC5X; Harrier; Ironman 0..39)
     *  (APPLICABLE RANGES: AAS 0..59) */

...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC_PTR_tcamLookupProfileCfgPtr;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_IN_GT_U32_tcamClientGroup;
...
extern const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_DXCH_TCAM_CLIENT_GROUP_LOOKUP_PROFILE_CFG_STC_PTR_tcamLookupProfileCfgPtr;
...
enum {
    ...
    PRV_CPSS_LOG_FUNC_cpssDxChTcamClientGroupLookupMuxTableLineSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTcamLookupMuxTableLineGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTcamClientGroupLookupMuxTableLineGet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTcamClientGroupLookupProfileCfgSet_E,
    PRV_CPSS_LOG_FUNC_cpssDxChTcamClientGroupLookupProfileCfgGet_E
};

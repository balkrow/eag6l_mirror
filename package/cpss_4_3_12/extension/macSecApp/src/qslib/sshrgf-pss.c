/**
   ...
   @copyright
   Copyright (c) 2005 - 2013, Rambus Inc. All rights reserved.
...
const SshRGFDefStruct ssh_rgf_pss_md2_def = { DEFPSS("md2") };
const SshRGFDefStruct ssh_rgf_pss_md2_no_hash_def = { DEFPSSDIGEST("md2") };

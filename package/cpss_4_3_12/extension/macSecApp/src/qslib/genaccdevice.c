/**
   ...
   @copyright
   Copyright (c) 2008 - 2013, Rambus Inc. All rights reserved.
...
#undef ENABLE_EXTERNALKEY_DUMMY_PROVIDER
                                   ...
                                   void *context)
{
  ...
  if (modexp_ctx->op_registered)
    ssh_operation_unregister(modexp_ctx->op);
  modexp_ctx->op_registered = 0;
                                   ...
                                   void *context)
{
  ...
  if (crt_ctx->op_registered)
    ssh_operation_unregister(crt_ctx->op);
  crt_ctx->op_registered = 0;

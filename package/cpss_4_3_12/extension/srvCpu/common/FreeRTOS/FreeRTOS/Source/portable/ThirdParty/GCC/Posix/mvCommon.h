...
#define _160K       0X00028000
#define _192K       0x00030000
#define _256K       0x00040000
#define _384K       0x00060000
...
/* defines taken from booton to support Sflash driver */
#define MV_REG_READ(offset)             \
        *((volatile unsigned int*)(INTER_REGS_BASE | (offset)))

#define MV_REG_WRITE(offset, val)    \
        *((volatile unsigned int*)(INTER_REGS_BASE | (offset))) = val
...
#define MV_MEMIO32_WRITE(addr, data)   \
    writeRegister(iICGetSimulationSocket(), addr, data)

#define MV_MEMIO32_READ(addr)          \
    readRegisterInline(iICGetSimulationSocket(), addr)

#define cm3_internal_win_conf_write( val )  \
	    writeRegister(iICGetSimulationSocket(), (MG_BASE | REG_MBUS_SYSTEM_INT_WINDOW_CONFIG ), (val))
#endif

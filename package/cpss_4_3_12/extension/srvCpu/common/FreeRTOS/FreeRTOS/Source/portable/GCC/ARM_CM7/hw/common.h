...
/* "Mbus clock" in terms of SoC department. MNG_CLK in IAS. */
...
#elif defined (CONFIG_AAS)
#define CONFIG_SYS_TCLK     ( 600000000 ) /* SeaHawk */
#endif
...
#define SCPU_SRAM_BASE  (0x01200000) /* shared SRAM is 4MB, so for now, as a temporarily bypass/fix, arbitarily set this to midpoint of SRAM. TODO: permanent solution will be to set to DTCM of CM7. */
#define CNM_SRAM_BASE   (0x01000000)

/* Register access macros */
#define MSS_REGS_BASE 0x5C600000 /* Seahawk RUNIT base */

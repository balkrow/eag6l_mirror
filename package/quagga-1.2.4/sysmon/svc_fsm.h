typedef enum {
	...
	SVC_EVT_FPGA_SWITCH_WAIT,
	SVC_EVT_FPGA_SWITCH_WAIT_EXP,
	SVC_EVT_FPGA_SWITCH_SUCCESS,
	SVC_EVT_FPGA_SWITCH_FAIL,
	SVC_EVT_FPGA_SWITCH_TRY_EXP,
	SVC_EVT_FPGA_UPDATE_SUCCESS,
	SVC_EVT_FPGA_UPDATE_PASS,
	SVC_EVT_FPGA_UPDATE_FAIL,
#endif
	SVC_EVT_MAX
} SVC_EVT;
...
typedef enum {
	...
	SVC_ST_FPGA_UPDATE,
	SVC_ST_FPGA_SWITCH,
	SVC_ST_FPGA_SWITCH_WAIT,
	SVC_ST_FPGA_SWITCH_CONFIRM,
	SVC_ST_FPGA_SWITCH_FAILURE,
	SVC_ST_FPGA_UPDATE_FAILURE,
#endif
#if 1/*[#56] register update timer 수정, balkrow, 2023-06-13 */

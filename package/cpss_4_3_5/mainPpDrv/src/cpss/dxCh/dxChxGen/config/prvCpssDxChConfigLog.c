...
const PRV_CPSS_LOG_FUNC_PARAM_STC DX_OUT_CPSS_PP_PHASE2_UPLOAD_QUEUE_TYPE_ENT_PTR_PTR_prevCpssInit_fuqUseSeparatePtrPtr = {
     "prevCpssInit_fuqUseSeparatePtrPtr", PRV_CPSS_LOG_PARAM_OUT_E,  PRV_CPSS_LOG_FUNC_TYPE_PTR_PTR_MAC(CPSS_PP_PHASE2_UPLOAD_QUEUE_TYPE_ENT)
};
...
const PRV_CPSS_LOG_FUNC_PARAM_STC * const cpssDxChCfgDevDbInfoGet_PARAMS[] =  {
    ...
    &DX_OUT_CPSS_PP_PHASE2_UPLOAD_QUEUE_TYPE_ENT_PTR_PTR_prevCpssInit_fuqUseSeparatePtrPtr,

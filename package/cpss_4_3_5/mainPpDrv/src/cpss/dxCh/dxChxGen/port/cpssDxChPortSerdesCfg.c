...
)
{
    ...
    else
    {
        ...
        if(!PRV_CPSS_SIP_6_10_CHECK_MAC(devNum) && 
           ((portMode == QSGMII)||(ifMode == CPSS_PORT_INTERFACE_MODE_MLG_40G_10G_40G_10G_E)))
        {
...
)
{
    ...
    *numOfSerdesLanesPtr = 0 ;
    ...
    else
    {
        ...
        if(!PRV_CPSS_SIP_6_10_CHECK_MAC(devNum) && ((CPSS_PORT_IF_MODE_QSGMII_USX_QUSGMII_CHECK_MAC(ifMode)) ||
...
)
{
    ...
    if(!PRV_CPSS_SIP_6_10_CHECK_MAC(devNum) && ((CPSS_PORT_IF_MODE_QSGMII_USX_QUSGMII_CHECK_MAC(PRV_CPSS_DXCH_PORT_IFMODE_MAC(devNum, portMacMap)))))
    {

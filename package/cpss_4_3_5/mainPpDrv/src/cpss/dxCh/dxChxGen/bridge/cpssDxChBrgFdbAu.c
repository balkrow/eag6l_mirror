...
)
{
                        ...
                        enabled == GT_FALSE))
    {
       ...
       {
            return prvDxChBrgFdbAuFuMsgBlockGet(devNum,MESSAGE_QUEUE_PRIMARY_FUQ_E,numOfFuPtr,fuMessagesPtr, NULL, NULL);
       }
       else
       {
            return prvDxChBrgFdbAuFuMsgBlockGet(devNum,MESSAGE_QUEUE_PRIMARY_AUQ_E,numOfFuPtr,fuMessagesPtr, NULL, NULL);
       }
    }
    else
    {
...
)
{
    ...
    {
        return
          prvDxChBrgFdbAuFuMsgBlockGet(devNum,MESSAGE_QUEUE_PRIMARY_AUQ_E,numOfAuPtr,auMessagesPtr, NULL, NULL);
    }
    else
    {
        return

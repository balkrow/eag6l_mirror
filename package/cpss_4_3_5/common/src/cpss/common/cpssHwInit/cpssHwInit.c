...
)
{
    ...
    if (dmaInfo->fuqUseSeparate != CPSS_PP_PHASE2_UPLOAD_QUEUE_SHARED_WITH_AUQ_E)
    {
...
)
{
    ...
    if(HWINIT_GLOVAR(sysGenGlobalInfo.reInitializationDbPtr[devNum].dmaInfo.fuqUseSeparate) 
...
(
    ...
    OUT CPSS_PP_PHASE2_UPLOAD_QUEUE_TYPE_ENT*  *fuqUseSeparatePtrPtr,

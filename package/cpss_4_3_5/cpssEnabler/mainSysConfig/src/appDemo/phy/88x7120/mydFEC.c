...
)
{
    ...
    *pcs_lane = 0;
    ...
    {
        MYD_DBG_ERROR("mydGetRxPCSLaneMapping: Not applicable to 25G mdoe \n");
        return MYD_FAIL;        
    }
...
/*******************************************************************************
 MYD_STATUS mydGetRsFecUnCorrectedCwCntr
    Read the RS-FEC Unorrected Code Word Counter
*******************************************************************************/
MYD_STATUS mydGetRsFecUnCorrectedCwCntr
(
    IN MYD_DEV_PTR pDev,
...
/*******************************************************************************
 MYD_STATUS mydSetRsFecSERControl
    To control signalling of errors and degraded SER
*******************************************************************************/
MYD_STATUS mydSetRsFecSERControl
(
    IN MYD_DEV_PTR pDev,
...
/*******************************************************************************
 MYD_STATUS mydGetRsFecSERControl
    To read setting of signalling of errors and degraded SER bits
*******************************************************************************/
MYD_STATUS mydGetRsFecSERControl
(
    IN MYD_DEV_PTR pDev,

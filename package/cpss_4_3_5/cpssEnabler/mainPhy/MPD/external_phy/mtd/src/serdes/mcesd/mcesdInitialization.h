...
/**
@brief  This function cleans up memory allocated by mcesdLoadDriver

@param[in] devPtr - pointer to MCESD_DEV initialized by mcesdLoadDriver() call

@note This function should be called only after successful execution of mcesdLoadDriver().

...
#include <mpdTypes.h>
/*
MTD_STATIC unsigned short macValList[256];
MTD_STATIC unsigned short sysmacValList[256];
*/
...
MTD_VOID mtd_ptp_1step_print_sysmac_statistics (MTD_U16 port, MTD_UINT *sysmacValList)
{
    ...
    MPD_UNUSED_PARAM(port);
    MPD_UNUSED_PARAM(sysmacValList);

    ...
    switch (resetType)
    {
        ...
        case MYD_CHIP_HW_RESET:
            ...
            for (portIndex=0; portIndex<pDev->portCount; portIndex++)
            {
                ...
                mydMemSet(pDev->hostConfig[portIndex], 0, (sizeof(MYD_MODE_CONFIG)*MYD_NUM_LANES));
                mydMemSet(pDev->lineConfig[portIndex], 0, (sizeof(MYD_MODE_CONFIG)*MYD_NUM_LANES));

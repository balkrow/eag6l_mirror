...
/*  */
extern MTD_U16 mtd_ptp_1step_base_addr[];
...
MTD_STATUS mtd_clear_bits (MTD_U16 port, MTD_U16 addr, unsigned int data);

MTD_STATUS mtd_ptp_msec_set_link_down_reset(MTD_U16 port, int flag);

unsigned int _mtd_ptp_read_reg (MTD_U16 port, MTD_U16 addr);
unsigned int mtd_ptp_read_reg (MTD_U16 port, MTD_U16 addr);

/* unsigned int _mtd_ptp_readcheck_reg (MTD_U16 port, MTD_U16 addr); */
unsigned int mtd_ptp_readcheck_reg (MTD_U16 port, MTD_U16 addr);

MTD_STATUS _mtd_ptp_write_reg (MTD_U16 port, MTD_U16 addr, unsigned int data);
MTD_STATUS mtd_ptp_write_reg (MTD_U16 port, MTD_U16 addr, unsigned int data);

/* MTD_STATUS _mtd_ptp_writecheck_reg(MTD_U16 port, MTD_U16 addr, unsigned int data); */
MTD_STATUS mtd_ptp_writecheck_reg(MTD_U16 port, MTD_U16 addr, unsigned int data);

void mtd_ptp_1step_print_reg (MTD_U16 port, MTD_U16 addr);
/* Set bits by ORing new value with old value */
MTD_STATUS mtd_set_bits (MTD_U16 port, MTD_U16 addr, unsigned int data);
...
/* Read lut entry */
MTD_STATUS mtd_read_lut_entry (MTD_U16 port, MTD_64 *lut_key, MTD_64 *lut_valid, MTD_32 *lut_key_upper, MTD_32 *lut_valid_upper, MTD_64 *lut_action, 
...
/* memory test */
MTD_STATUS mtd_ptp_1step_write_unique_check (MTD_U16 port, MTD_U16 addr, int range, unsigned int mask);
...
MTD_STATUS mtd_ptp_lut_update (MTD_U16 port, MTD_U64 delete_lut_key , 

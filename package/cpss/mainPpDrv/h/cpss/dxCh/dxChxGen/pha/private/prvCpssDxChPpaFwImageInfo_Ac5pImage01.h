...
/**
 *******************************************************************************
 * @file prvCpssDxChPpaFwImageInfo_Ac5pImage01.h
 *
...
#ifndef __prvCpssDxChPpaFwImageInfo_Ac5pImage01_h
#define __prvCpssDxChPpaFwImageInfo_Ac5pImage01_h
...
const GT_U32 phaFwAccelCmdsAc5pImage01[FW_ACCEL_CMDS_MAX_NUM_CNS] = {
   ...
   ,0x001ba4c0 /* SHIFTLEFT_28_BYTES_THR46_SFLOW_IPv4_LEN28_FROM_PKT_IPv4_Header__version, offset = 0x0214 */
   ,0x4682c305 /* COPY_BITS_THR46_SFLOW_IPv4_CONST_0x5_LEN3_TO_PKT_sflow_ipv4_header__version_PLUS29, offset = 0x0218 */
   ,0x4780c701 /* COPY_BITS_THR46_SFLOW_IPv4_CONST_0x1_LEN1_TO_PKT_sflow_ipv4_header__agent_ip_version_PLUS31, offset = 0x021c */
   ,0x0003c80c /* COPY_BYTES_THR46_SFLOW_IPv4_CFG_sflow_ipv4_template__agent_ip_address_LEN4_TO_PKT_sflow_ipv4_header__agent_ip_address, offset = 0x0220 */
   ,0x0003cc54 /* COPY_BYTES_THR46_SFLOW_IPv4_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_sflow_ipv4_header__sub_agent_id, offset = 0x0224 */
   ,0x0003d074 /* COPY_BYTES_THR46_SFLOW_IPv4_DESC_phal2ppa__lm_counter_LEN4_TO_PKT_sflow_ipv4_header__sequence_number, offset = 0x0228 */
   ,0x4780db01 /* COPY_BITS_THR46_SFLOW_IPv4_CONST_0x1_LEN1_TO_PKT_sflow_ipv4_header__samples_number_PLUS31, offset = 0x022c */
   /* 082100a6 CSUM_LOAD_OLD_THR46_SFLOW_IPv4_LEN2_FROM_PKT_IPv4_Header__total_length, offset = 0x01c0 */
   ,0x540fa61c /* ADD_BITS_THR46_SFLOW_IPv4_CONST_0x1C_LEN16_TO_PKT_IPv4_Header__total_length, offset = 0x0230 */
   /* 080100a6 CSUM_LOAD_NEW_THR46_SFLOW_IPv4_LEN2_FROM_PKT_IPv4_Header__total_length, offset = 0x01c8 */
   /* 082100ae CSUM_LOAD_OLD_THR46_SFLOW_IPv4_LEN2_FROM_PKT_IPv4_Header__header_checksum, offset = 0x01cc */
   /* c00fae00 CSUM_STORE_IP_THR46_SFLOW_IPv4_TO_PKT_IPv4_Header__header_checksum, offset = 0x01d0 */
   ,0x540fbc1c /* ADD_BITS_THR46_SFLOW_IPv4_CONST_0x1C_LEN16_TO_PKT_udp_header__Length, offset = 0x0234 */
   ,0x001f98c0 /* SHIFTLEFT_40_BYTES_THR47_SFLOW_IPv6_LEN32_FROM_PKT_IPv6_Header__version, offset = 0x0238 */
   ,0x000fb8e0 /* SHIFTLEFT_40_BYTES_THR47_SFLOW_IPv6_LEN16_FROM_PKT_IPv6_Header__version_PLUS32, offset = 0x023c */
   ,0x4682cb05 /* COPY_BITS_THR47_SFLOW_IPv6_CONST_0x5_LEN3_TO_PKT_sflow_ipv6_header__version_PLUS29, offset = 0x0240 */
   ,0x4701cf02 /* COPY_BITS_THR47_SFLOW_IPv6_CONST_0x2_LEN2_TO_PKT_sflow_ipv6_header__agent_ip_version_PLUS30, offset = 0x0244 */
   ,0x000fd000 /* COPY_BYTES_THR47_SFLOW_IPv6_CFG_sflow_ipv6_template__agent_ip_address_127_96_LEN16_TO_PKT_sflow_ipv6_header__agent_ip_address_127_96, offset = 0x0248 */
   ,0x0003e054 /* COPY_BYTES_THR47_SFLOW_IPv6_DESC_phal2ppa__pha_metadata3_LEN4_TO_PKT_sflow_ipv6_header__sub_agent_id, offset = 0x024c */
   ,0x0003e474 /* COPY_BYTES_THR47_SFLOW_IPv6_DESC_phal2ppa__lm_counter_LEN4_TO_PKT_sflow_ipv6_header__sequence_number, offset = 0x0250 */
   ,0x4780ef01 /* COPY_BITS_THR47_SFLOW_IPv6_CONST_0x1_LEN1_TO_PKT_sflow_ipv6_header__samples_number_PLUS31, offset = 0x0254 */
   ,0x540f9c28 /* ADD_BITS_THR47_SFLOW_IPv6_CONST_0x28_LEN16_TO_PKT_IPv6_Header__payload_length, offset = 0x0258 */
   ,0x540fc428 /* ADD_BITS_THR47_SFLOW_IPv6_CONST_0x28_LEN16_TO_PKT_udp_header__Length, offset = 0x025c */
   ,0x0409c64d /* COPY_BITS_THR48_SRV6_Best_Effort_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_IPv6_Header__dip3_low, offset = 0x0260 */
   ,0x0001c2c6 /* COPY_BYTES_THR48_SRV6_Best_Effort_PKT_IPv6_Header__dip3_low_LEN2_TO_PKT_IPv6_Header__dip2_low, offset = 0x0264 */
   ,0x0409ae4d /* COPY_BITS_THR49_SRV6_Source_Node_1_CONTAINER_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_IPv6_Header__dip3_low, offset = 0x0268 */
   ...
   ,0x0409ea4d /* COPY_BITS_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_no_vlan__IPv6_Header__dip3_low, offset = 0x026c */
   ,0x0409ee4d /* COPY_BITS_THR51_SRV6_Source_Node_Second_Pass_3_CONTAINER_OFFSET8_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_with_vlan__IPv6_Header__dip3_low, offset = 0x0270 */
   ...
   /* 0409ea4d COPY_BITS_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_no_vlan__IPv6_Header__dip3_low, offset = 0x026c */
   /* 0409ee4d COPY_BITS_THR52_SRV6_Source_Node_Second_Pass_2_CONTAINER_OFFSET24_DESC_phal2ppa__copy_reserved_PLUS8_LEN10_TO_PKT_with_vlan__IPv6_Header__dip3_low, offset = 0x0270 */
   ...
   ,0x05674c6d /* COPY_BITS_THR61_save_target_port_info_DESC_phal2ppa__trg_dev_PLUS2_LEN8_TO_DESC_phal2ppa__copy_reserved_PLUS2, offset = 0x0274 */
   ,0x05074d6f /* COPY_BITS_THR61_save_target_port_info_DESC_phal2ppa__trg_phy_port_PLUS2_LEN8_TO_DESC_phal2ppa__copy_reserved_PLUS10, offset = 0x0278 */
   ,0x0001d754 /* COPY_BYTES_THR62_enhanced_sFlow_fill_remain_IPv4_DESC_phal2ppa__pha_metadata3_LEN2_TO_PKT_enhanced_sflow_rx_ts_shim_header__ip_high, offset = 0x027c */
   ,0x080500d0 /* CSUM_LOAD_NEW_THR62_enhanced_sFlow_fill_remain_IPv4_LEN6_FROM_PKT_enhanced_sflow_rx_ts_shim_header__rx_timestamp_47_32, offset = 0x0280 */
   ,0x080300d6 /* CSUM_LOAD_NEW_THR62_enhanced_sFlow_fill_remain_IPv4_LEN4_FROM_PKT_enhanced_sflow_rx_ts_shim_header__reserved, offset = 0x0284 */
   ,0xc00fce00 /* CSUM_STORE_IP_THR62_enhanced_sFlow_fill_remain_IPv4_TO_PKT_enhanced_sflow_rx_ts_shim_header__checksum_PLUS2, offset = 0x0288 */
   ,0x0001e556 /* COPY_BYTES_THR62_enhanced_sFlow_fill_remain_IPv4_DESC_phal2ppa__pha_metadata1_LEN2_TO_PKT_enhanced_sflow_tx_ts_shim_header__ip_low, offset = 0x028c */
   ,0x080500de /* CSUM_LOAD_NEW_THR62_enhanced_sFlow_fill_remain_IPv4_LEN6_FROM_PKT_enhanced_sflow_tx_ts_shim_header__tx_timestamp_47_32, offset = 0x0290 */
   ,0x080300e4 /* CSUM_LOAD_NEW_THR62_enhanced_sFlow_fill_remain_IPv4_LEN4_FROM_PKT_enhanced_sflow_tx_ts_shim_header__reserved, offset = 0x0294 */
   ,0xc00fdc00 /* CSUM_STORE_IP_THR62_enhanced_sFlow_fill_remain_IPv4_TO_PKT_enhanced_sflow_tx_ts_shim_header__checksum_PLUS2, offset = 0x0298 */
   ,0x44806001 /* COPY_BITS_THR62_enhanced_sFlow_fill_remain_IPv4_CONST_0x1_LEN1_TO_DESC_phal2ppa__egress_checksum_mode, offset = 0x029c */
   ,0x540fb82c /* ADD_BITS_THR62_enhanced_sFlow_fill_remain_IPv4_CONST_0x2C_LEN16_TO_PKT_udp_header__Length, offset = 0x02a0 */
   ,0x082100a2 /* CSUM_LOAD_OLD_THR62_enhanced_sFlow_fill_remain_IPv4_LEN2_FROM_PKT_IPv4_Header__total_length, offset = 0x02a4 */
   ,0x540fa22c /* ADD_BITS_THR62_enhanced_sFlow_fill_remain_IPv4_CONST_0x2C_LEN16_TO_PKT_IPv4_Header__total_length, offset = 0x02a8 */
...
#endif	/* __prvCpssDxChPpaFwImageInfo_Ac5pImage01_h */

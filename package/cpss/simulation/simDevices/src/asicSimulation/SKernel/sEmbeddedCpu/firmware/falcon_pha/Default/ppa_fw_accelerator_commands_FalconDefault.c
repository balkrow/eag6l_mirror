...
/*
 * ppa_fw_accelerator_commands_FalconDefault.c
 *
...
ACCEL_INFO_STC accelInfoArrFalconDefault[] =
{
...
/*************** THR59_SLS_Test *******************/
    ,{ FALCON_ENUM_NAME_AND_VALUE( COPY_BYTES_THR59_SLS_Test_PKT_IPv4_Header__version_LEN2_TO_CFG_HA_Table_reserved_space__reserved_0_OFFSET),              59}
    ,{ FALCON_ENUM_NAME_AND_VALUE( COPY_BYTES_THR59_SLS_Test_PKT_IPv4_Header__version_PLUS2_LEN2_TO_CFG_HA_Table_reserved_space__reserved_0_PLUS2_OFFSET),  59}
    ,{ FALCON_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR59_SLS_Test_LEN8_FROM_PKT_IPv4_Header__version_OFFSET),                                                 59}
    ,{ FALCON_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR59_SLS_Test_LEN2_FROM_PKT_IPv4_Header__version_PLUS8_OFFSET),                                           59}
    ,{ FALCON_ENUM_NAME_AND_VALUE( CSUM_LOAD_NEW_THR59_SLS_Test_LEN8_FROM_PKT_IPv4_Header__version_PLUS12_OFFSET),                                          59}
    ,{ FALCON_ENUM_NAME_AND_VALUE( CSUM_STORE_IP_THR59_SLS_Test_TO_PKT_IPv4_Header__header_checksum_OFFSET),                                                59}

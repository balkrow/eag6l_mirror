...
struct thr65_Erspan_TypeII_SameDevMirroring_Ipv6_in_hdr {
    ...
    struct {
        uint32_t dummy:32;               /* offset:512 */
    } RSPAN_tag_dummy; /* 4B */
    struct {
        uint32_t Ingress_E_CID_base:12;  /* offset:564 */
        uint32_t E_DEI:1;                /* offset:563 */
        uint32_t E_PCP:3;                /* offset:560 */
        uint32_t TPID:16;                /* offset:544 */
        uint32_t E_CID_ext:8;            /* offset:600 */
        uint32_t Ingress_E_CID_ext:8;    /* offset:592 */
        uint32_t E_CID_base:12;          /* offset:580 */
        uint32_t GRP:2;                  /* offset:578 */
        uint32_t Reserved:1;             /* offset:577 */
        uint32_t Direction:1;            /* offset:576 */
    } etag; /* 8B */
    struct {

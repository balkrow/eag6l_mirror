/*************************************************************************
* /local/store/cpss_regression/tmp/all_common_noppdrv_lua_c_type_wrappers.c
*
* DESCRIPTION:
*       A lua type wrapper
...
*
* COMMENTS:
*       Generated at Mon Jan 31 21:31:01 2022
*       /local/store/cpss_regression/cpss/mainLuaWrapper/scripts/make_type_wrapper.py -i /local/store/cpss_regression/tmp/type_info_file_px -p /local/store/cpss_regression/cpss/mainLuaWrapper/scripts/already_implemented.lst -X /local/store/cpss_regression/cpss/mainLuaWrapper/scripts/excludelist -C /local/store/cpss_regression/cpss -M /local/store/cpss_regression/cpss/mainLuaWrapper/scripts/lua_C_mapping -N -F NONE -I common -I mainPxDrv -o /local/store/cpss_regression/tmp/all_common_noppdrv_lua_c_type_wrappers.c
*

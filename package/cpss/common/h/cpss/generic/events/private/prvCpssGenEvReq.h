...
STR(CPSS_PP_PORT_LANE_SQ_EVENT_E),                        /* 634 */             \
                                                                                \
STR(CPSS_PP_HSR_PRP_PNT_NUM_OF_READY_ENTRIES_E),          /* 635 */             \
STR(CPSS_PP_STREAM_LATENT_ERROR_E),                       /* 636 */             \
/**************************** SRVCPU EVENTS *******************************/    \
STR(CPSS_SRVCPU_IPC_E),                                   /* 637 */             \
STR(CPSS_SRVCPU_PORT_LINK_STATUS_CHANGED_E),              /* 638 */             \
STR(CPSS_SRVCPU_PORT_802_3_AP_E),                         /* 639 */             \
STR(CPSS_SRVCPU_PORT_REMOTE_FAULT_TX_CHANGE_E)           ,/* 640 */             \
STR(CPSS_SRVCPU_PORT_AP_DISABLE_E)                       ,/* 641 */             \
STR(CPSS_SRVCPU_RESERVED_5)                              ,/* 642 */             \
STR(CPSS_SRVCPU_RESERVED_6)                              ,/* 643 */             \
STR(CPSS_SRVCPU_RESERVED_7)                              ,/* 644 */             \
STR(CPSS_SRVCPU_RESERVED_8)                              ,/* 645 */             \
STR(CPSS_SRVCPU_RESERVED_9)                              ,/* 646 */             \
                                                                                \
/************************** Xbar events ***********************************/    \
                                                                                \
STR(CPSS_XBAR_HG_LANE_SYNCH_CHANGE_E),                    /* 647 */             \
STR(CPSS_XBAR_HG_LANE_COMMA_ALIGN_CHANGE_E),              /* 648 */             \
STR(CPSS_XBAR_GPORT_INVALID_TRG_DROP_CNT_INC_E),          /* 649 */             \
STR(CPSS_XBAR_GPORT_DIAG_CELL_RX_CNTR_INC_E),             /* 650 */             \
STR(CPSS_XBAR_MISC_E),                                    /* 651 */             \
STR(CPSS_XBAR_HG_PING_RECEIVED_E),                        /* 652 */             \
STR(CPSS_XBAR_HOST_RX_FIFO_PEND_E),                       /* 653 */             \
STR(CPSS_XBAR_HOST_SEND_CELL_E),                          /* 654 */             \
STR(CPSS_XBAR_HG_ALIGNMENT_LOCK_CHANGE_E),                /* 655 */             \
STR(CPSS_XBAR_HG_PING_E),                                 /* 656 */             \
STR(CPSS_XBAR_SD_INV_ADDR_E),                             /* 657 */             \
STR(CPSS_XBAR_SXBAR_INV_ADDR_E),                          /* 658 */             \
STR(CPSS_XBAR_S_INV_ADDR_E),                              /* 659 */             \
STR(CPSS_XBAR_G_INV_ADDR_E),                              /* 660 */             \
STR(CPSS_XBAR_MC_INV_ADDR_E),                             /* 661 */             \
                                                                                \
/************************** Fa events *************************************/    \
                                                                                \
STR(CPSS_FA_UC_PRIO_BUF_FULL_E),                          /* 662 */             \
STR(CPSS_FA_MC_PRIO_BUF_FULL_E),                          /* 663 */             \
STR(CPSS_FA_UC_RX_BUF_FULL_E),                            /* 664 */             \
STR(CPSS_FA_MC_RX_BUF_FULL_E),                            /* 665 */             \
STR(CPSS_FA_WD_FPORT_GRP_E),                              /* 666 */             \
STR(CPSS_FA_MC_WD_EXP_E),                                 /* 667 */             \
STR(CPSS_FA_GLBL_DESC_FULL_E),                            /* 668 */             \
STR(CPSS_FA_MAC_UPD_THRS_E),                              /* 669 */             \
STR(CPSS_FA_DROP_DEV_EN_E),                               /* 670 */             \
STR(CPSS_FA_MISC_I2C_TIMEOUT_E),                          /* 671 */             \
STR(CPSS_FA_MISC_STATUS_E),                               /* 672 */             \
                                                                                \
/************************** DRAGONITE events *********************************/ \
                                                                                \
STR(CPSS_DRAGONITE_PORT_ON_E),                            /* 673 */             \
STR(CPSS_DRAGONITE_PORT_OFF_E),                           /* 674 */             \
STR(CPSS_DRAGONITE_DETECT_FAIL_E),                        /* 675 */             \
STR(CPSS_DRAGONITE_PORT_FAULT_E),                         /* 676 */             \
STR(CPSS_DRAGONITE_PORT_UDL_E),                           /* 677 */             \
STR(CPSS_DRAGONITE_PORT_FAULT_ON_STARTUP_E),              /* 678 */             \
STR(CPSS_DRAGONITE_PORT_PM_E),                            /* 679 */             \
STR(CPSS_DRAGONITE_POWER_DENIED_E),                       /* 680 */             \
STR(CPSS_DRAGONITE_OVER_TEMP_E),                          /* 681 */             \
STR(CPSS_DRAGONITE_TEMP_ALARM_E),                         /* 682 */             \
STR(CPSS_DRAGONITE_DEVICE_FAULT_E),                       /* 683 */             \
STR(CPSS_DRAGONITE_OVER_CONSUM_E),                        /* 684 */             \
STR(CPSS_DRAGONITE_VMAIN_LOW_AF_E),                       /* 685 */             \
STR(CPSS_DRAGONITE_VMAIN_LOW_AT_E),                       /* 686 */             \
STR(CPSS_DRAGONITE_VMAIN_HIGH_E),                         /* 687 */             \
STR(CPSS_DRAGONITE_READ_EVENT_E),                         /* 688 */             \
STR(CPSS_DRAGONITE_WRITE_EVENT_E),                        /* 689 */             \
STR(CPSS_DRAGONITE_ERROR_E)                               /* 690 */
